...
- [ ] **Step 1: Add the failing intent tests**
...
- [ ] **Step 3: Add the run-intent enum and state field**
...
- [ ] **Step 4: Add helper methods for all non-netlist callers**
...
- [ ] **Step 5: Replace Netlist Run request gating**
...
- [ ] **Step 3: Implement manual source composition**
...
- [ ] **Step 4: Implement frequency and analysis conversion helpers**
...
- [ ] **Step 5: Implement queue building**
...
- [ ] **Step 1: Add controller tests for manual deck startup**
...
- [ ] **Step 3: Extract queue selection**
...
- [ ] **Step 4: Branch netlist composition by intent**
...
- [ ] **Step 5: Retire manual analysis appending**
...
- [ ] **Step 5: Promote baseline on successful manual deck completion**
...
- [ ] **Step 6: Compute diff pips from snapshots**
...
- [ ] **Step 1: Add range annotation tests**
...
- [ ] **Step 5: Make slider range prefer annotations**
...
- [ ] **Step 6: Add reset-to-last-run action**
...
- [ ] **Step 1: Extract Bode summary math tests**
...
- [ ] **Step 3: Move crossing math into shared module**
...
- [ ] **Step 5: Render mini Bode and "As tuned"**
...
- [ ] **Step 6: Point docbar delta chips at the same summary**
...
- [ ] **Step 1: Add diagnostic type tests**
...
- [ ] **Step 3: Implement line-column mapping**
...
- [ ] **Step 4: Replace the old diagnostic struct**
...
- [ ] **Step 5: Make highlighting span-aware**
...
- [ ] **Step 6: Render strip severity and fix labels**
...
- [ ] **Step 2: Register module and run failing tests**
...
- [ ] **Step 3: Implement a lightweight editor source scanner**
...
- [ ] **Step 4: Add unknown-reference lint tests**
...
- [ ] **Step 6: Merge lints into parse diagnostics**
...
- [ ] **Step 1: Keep UI progress state current**
...
- [ ] **Step 2: Add docbar progress rendering helper**
...
- [ ] **Step 4: Run full UI library tests**
