//! App-side binding of authored SOA rules to concrete terminal layouts.

use super::terminals::{TerminalLayout, TerminalLayouts};
use super::*;
pub use rspice_simulation_contract::soa_rule::SoaRuleConfig;

trait SoaRuleExecution {
    fn scope_matches(&self, element: &Element) -> bool;
    fn matches(&self, element: &Element, layouts: &TerminalLayouts) -> bool;
}

impl SoaRuleExecution for SoaRuleConfig {
    fn scope_matches(&self, element: &Element) -> bool {
