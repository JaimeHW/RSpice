...
fn parse_run_plan(
    ...
    let allowed = [
        "op", "tran", "ac", "dc", "noise", "pz", "sens", "mc", "pss", "stb", "temp", "hb", "sp",
        "pac", "pnoise", "pxf", "pstb", "xf", "corner", "envelope", "fourier", "opt", "soa",
        "disto", "qpss", "hbsp", "hbnoise", "psp", "qpac", "qpnoise", "qpxf", "tnoise", "dcmatch",
    ];
