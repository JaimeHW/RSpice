...
use crate::product::{AnalysisInstanceId, ProjectId};
...
use rspice_simulation_contract::plan_model::{AnalysisInstance, SimulationPlan};
...
impl SimSetupState {
    ...
    pub(crate) fn migrate_legacy_analysis_plan(
        ...
        let plan =
            rspice_simulation_contract::legacy_plan_migration::migrate_schema3_analysis_plan(
                project_id,
                &self.enabled,
                &self.listed,
                &self.analysis_order,
