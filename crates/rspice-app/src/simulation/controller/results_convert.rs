...
use crate::state::{
    ...
    PstbStabilityClassificationEvidence, TransferFunctionAccuracyEvidence,
    ...
    pub(in crate::simulation) fn convert_to_analysis_result_with_metadata_owned(
        ...
        let mut retained = match sim_result {
            ...
            SimulationResult::SensitivityStudy { evidence } => {
                sensitivity_result::analysis_result(analysis_type, label, evidence)
            }
