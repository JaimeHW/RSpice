...
impl PlanDependencySourceContext for AnalysisDependencyRepairContext {
    fn periodic_sources(&self) -> Result<&[String], String> {
        AnalysisDependencyRepairContext::periodic_sources(self)
    }

    fn availability_error(&self) -> Option<&str> {
        AnalysisDependencyRepairContext::availability_error(self)
    }

    fn validate_pss_sources(&self, draft: &PssDialogState) -> Result<(), String> {
        AnalysisDependencyRepairContext::validate_pss_sources(self, draft)
    }
}
