...
impl Instance {
	...
	pub const TERMINAL_NAMES: [&str; 2] = ["n1", "n2"];
	pub const TERMINALS: [GeneratedExternalTerminalDescriptor; 2] = [GeneratedExternalTerminalDescriptor { name: "n1", current_parameter: "in1" }, GeneratedExternalTerminalDescriptor { name: "n2", current_parameter: "in2" }];
	...
	pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "383fa18ea76cfa4a93023b22cc9474e7d55036f3e2b726c3bebbbf2e0c218881";
