	...
	fn new_box_with_simulation_parameters(simulation_parameters: &GeneratedSimulationParameters) -> Box<Self> {
		...
		unsafe {
			...
			const DEFAULTS: [f64; 143] = [
				...
				1e-40, 0.0, 0.0, 1.0, 0.0, 0.16, 0.0,
			];
...
const PARAMETER_LOOKUP_NAMES: [&str; 145] = [
	"aavl", "ab", "ac", "acbl", "acx", "ae", "aepi", "aepiex", "aex", "aexavl", "af", "afn", "aqbo", "avgcb", "avgeb", "axi",
	"bavl", "cavl", "cbco", "cbeo", "cjc", "cje", "dais", "davl", "deg", "dta", "dtemp", "dtmax", "dvgte", "eavl", "exavl", "exmod",
	"exphi", "frevcb", "ftaun", "ibf", "ibfs", "ibi", "ibinbr", "ibinbrqs", "ibinbrs", "ibis", "ibr", "ibx", "ihc", "ihcavl", "ik", "ikbx",
	"ionexavl", "is", "isibrel", "issr", "istat", "itoavl", "izcb", "izeb", "kavl", "kbtbt", "kc", "ke", "kf", "kfn", "ktat", "mc",
	"minr", "mlf", "mlfs", "mlr", "mtau", "mult", "nbi", "nbis", "nex", "nff", "nfibrel", "nfr", "nzcb", "nzeb", "p0starlim", "pbrcb",
	"pc", "pe", "pwlim", "rbc", "rbv", "rcbli", "rcblx", "rcc", "rcv", "re", "scrcv", "sfh", "swavl", "swgemlim", "swib1", "swjbrcb",
	"swqex", "swvchc", "swvjunc", "taub", "taue", "tauex", "taur", "tbavl", "tepi", "tnff", "tnfr", "tref", "trise", "tvgcb", "tvgeb", "type",
	"vavl", "vbrcb", "vbtbt", "vdc", "vdcavl", "vdcctc", "vdcex", "vde", "vef", "ver", "version", "vexlim", "vgb", "vgbnbr", "vgbnbrqs", "vgbnbrs",
	"vgc", "vgcx", "vge", "vgj", "vgknbr", "vgzcb", "vgzeb", "vknbr", "vtat", "vzmin", "wavl", "xcjc", "xcje", "xext", "xp", "xqb",
	"xrec",
];

const PARAMETER_LOOKUP_INDICES: [u16; 145] = [
	39, 97, 101, 103, 102, 96, 98, 99, 100, 50, 125, 126, 95, 117, 114, 62, 42, 40, 77, 68, 69, 64, 120, 48, 91, 0, 0, 124, 119, 49, 7, 5,
	6, 82, 131, 19, 21, 15, 24, 27, 25, 17, 30, 28, 61, 47, 11, 29, 51, 8, 132, 14, 138, 41, 35, 33, 129, 142, 130, 94, 127, 128, 140, 75,
	137, 20, 22, 31, 84, 1, 16, 18, 90, 9, 133, 10, 36, 34, 135, 81, 71, 66, 136, 54, 55, 58, 57, 56, 59, 53, 60, 46, 38, 52, 23, 83,
	78, 72, 73, 86, 85, 89, 88, 123, 87, 121, 122, 4, 0, 118, 115, 3, 45, 80, 141, 63, 43, 70, 79, 65, 13, 12, 2, 134, 104, 106, 105, 107,
	109, 111, 110, 112, 108, 116, 113, 26, 139, 37, 44, 76, 67, 32, 74, 93, 92,
];
...
const PARAMETER_DUAL_SCOPE_FLAGS: [bool; 143] = [
...
const PARAMETER_MIN_BOUNDS: [u16; 143] = [
	...
	1, 1, 1, 1, 1, 10, 21, 1, 1, 1, 1, 1, 0, 1, 0,
];

const PARAMETER_MAX_BOUNDS: [u16; 143] = [
	...
	0, 5, 16, 5, 0, 0, 22, 23, 23, 0, 0, 0, 0, 0, 0,
];
...
const PARAMETER_EXCLUDED_BOUNDS: [&[u16]; 143] = [
	&[], &[], &[], &[1], &[], &[], &[], &[],
	&[], &[], &[], &[], &[], &[], &[], &[],
	&[], &[], &[], &[], &[], &[], &[], &[],
	&[], &[], &[], &[], &[], &[], &[], &[],
...
pub struct Instance {
	...
	model_param_given: Box<[bool; 143]>,
	pub(crate) multiplicity: f64,
	pub(crate) stamp_state: Box<StampState<9, 0>>,
	pub(crate) time: f64,
	pub(crate) timestep: f64,
	pub(crate) ddt_coefficients: GeneratedDdtCoefficients,
	pub(crate) canonical_reactive: Box<[f64; 87]>,
...
impl Instance {
	...
	pub const TERMINALS: [GeneratedVerilogATerminalDescriptor; 3] = [GeneratedVerilogATerminalDescriptor { name: "c", direction: GeneratedVerilogATerminalDirection::InOut, discipline: "electrical", current_parameter: "ic" }, GeneratedVerilogATerminalDescriptor { name: "b", direction: GeneratedVerilogATerminalDirection::InOut, discipline: "electrical", current_parameter: "ib" }, GeneratedVerilogATerminalDescriptor { name: "e", direction: GeneratedVerilogATerminalDirection::InOut, discipline: "electrical", current_parameter: "ie" }];
	pub const PARAMETER_DESCRIPTORS: [P; 143] = [
	...
	pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "f3f8a60b7ffebd4d0c19b61e5ab85cb8c0ec582624529ee10c211f9c2fcede67";
	...
	pub fn apply_parameters(&mut self, assignments: &[GeneratedParameterAssignment<'_>]) -> Result<(), String> {
		...
		for assignment in assignments {
			...
			let Some(index) = parameter_index_for_name(lower.as_str()) else {
				return Err(format!("unknown parameter '{}' for generated Verilog-A model 'bjtd505_va'", assignment.name));
			};
