...
pub(crate) const PARAMETER_MODEL_FLAGS: [bool; 143] = [
...
pub(crate) type CanonicalModelValues = [f64; 102];
pub struct Instance {
    pub nodes: [usize; 11],
    ...
    pub(crate) canonical_staged: Box<[f64; 197]>,
...
impl Instance {
    ...
    pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "0e2a992777b07ccd031c292144bbde145661a91af82798810f278b7885b86c0d";
