	...
	fn new_box_with_simulation_parameters(simulation_parameters: &GeneratedSimulationParameters) -> Box<Self> {
		...
		unsafe {
			...
			const DEFAULTS: [f64; 160] = [
				...
				1e-40, 1e-40, 0.0, 0.0, 1.0, 0.0, 0.16, 0.0,
			];
...
pub struct Instance {
	...
	pub(crate) canonical_reactive: Box<[f64; 130]>,
}
...
impl Instance {
	...
	pub const VARIABLE_COUNT: usize = 634;
	pub const DDT_STATE_COUNT: usize = 11;
	pub const IDT_STATE_COUNT: usize = 0;
	pub const IDTMOD_STATE_COUNT: usize = 0;
	pub const ACCEPTED_STATE_SHAPE_IDENTITY: GeneratedVerilogAAcceptedStateShapeIdentity = GeneratedVerilogAAcceptedStateShapeIdentity::from_bytes([133, 85, 84, 11, 81, 148, 164, 162, 202, 53, 190, 179, 105, 221, 177, 34, 151, 238, 236, 82, 21, 114, 5, 87, 183, 54, 147, 47, 93, 212, 136, 171]);
	...
	pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "0130a57dd1dfbd9c8b1c8d2f300047a286a92a86b23abf02d8f059cadc2221c8";
	...
	pub fn capture_rollback_state(&self) -> GeneratedVerilogARollbackState {
		let mut values = Vec::with_capacity(59);
	...
	pub fn restore_rollback_state(&mut self, state: &GeneratedVerilogARollbackState) {
		debug_assert_eq!(state.values.len(), 59);
