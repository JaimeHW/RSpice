...
impl Instance {
	...
	pub const TERMINAL_NAMES: [&str; 3] = ["n1", "n2", "dt"];
	pub const TERMINALS: [GeneratedExternalTerminalDescriptor; 3] = [GeneratedExternalTerminalDescriptor { name: "n1", current_parameter: "in1" }, GeneratedExternalTerminalDescriptor { name: "n2", current_parameter: "in2" }, GeneratedExternalTerminalDescriptor { name: "dt", current_parameter: "idt" }];
	...
	pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "a3e3038fe59153891f024dff78bcae51a4d1d310463622083e36029bdbee9c4f";
