...
/// Maximum number of pages accepted by a hardcopy plan or worker response.
pub const MAX_PREVIEW_PAGES: u32 = 10_000;
...
impl SchematicHardcopySetup {
    ...
    #[expect(
        ...
        reason = "preserve the existing schematic output constructor during extraction"
    )]
    pub const fn new(
        extent: SchematicHardcopyExtent,
        outside_content: OutsideSheetContentPolicy,
