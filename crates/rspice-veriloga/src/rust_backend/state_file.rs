...
pub(super) fn generate_state_file_with_extensions(
    ...
    out.push_str(&format!(
        "use {}::{{GeneratedDdtCoefficients, GeneratedVerilogAPersistentState, GeneratedVerilogARollbackState, boxed_zero_bool_array, boxed_zero_f64_array{parameter_alias_installer}}};\n",
