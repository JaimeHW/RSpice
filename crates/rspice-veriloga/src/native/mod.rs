...
pub use abi::{
    ...
    rspice_laplace_step_native, rspice_limexp, rspice_limit, rspice_slew_state_native,
    rspice_table_lookup, rspice_timer_state_native, rspice_transition_state_native,
