...
use crate::native::abi::{
    ...
    rspice_cross_state_native, rspice_ddt_derivative_native, rspice_ddt_jacobian_native,
    rspice_ddt_state_native, rspice_default_limit_native, rspice_dynamic_variable_slot_native,
    rspice_exp, rspice_hypot, rspice_idt_jacobian_native, rspice_idt_state_native,
    rspice_idtmod_state_native, rspice_integer_operation_native, rspice_laplace_derivative_native,
    ...
    rspice_native_dynamic_variable_error, rspice_native_loop_limit_error,
    ...
    rspice_sinh, rspice_slew_derivative_native, rspice_slew_state_native,
    rspice_table_derivative_native, rspice_table_lookup_native, rspice_tan, rspice_tanh,
    rspice_timer_state_native, rspice_transition_derivative_native, rspice_transition_state_native,
};
...
impl FunctionCompiler {
    ...
    fn emit_op(&mut self, op: NativeOp, prepared: &mut PreparedInstruction) -> JitResult<()> {
        ...
        match op {
            ...
            NativeOp::DdtDerivativeState(state_id) => self.emit_operand_context_helper(
                prepared,
                2,
                state_id,
                rspice_ddt_derivative_native as *const () as usize,
            )?,
