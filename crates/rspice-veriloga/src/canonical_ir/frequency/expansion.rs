//! Polynomial frequency expansion used by the optional Rust-source emitter.

use std::collections::{BTreeMap, BTreeSet, VecDeque};

use super::validation_factor;
use crate::canonical_ir::cfg::{
    CfgBinaryOp, CfgFunction, CfgInstruction, CfgTerminator, CfgUnaryOp, CfgValue, CfgValueKind,
    CfgValueType,
};
use crate::canonical_ir::{BlockId, ShapeId, ValueId};
...
struct Expansion<'a> {
    ...
    constants: BTreeMap<Option<ShapeId>, ValueId>,
