...
use rspice_veriloga::canonical_ir::{
    BranchId, BranchUnknownId, CANONICAL_IR_SCHEMA_VERSION, ContributionId, EquationId, ExprId,
    ModuleId, NodeId, ParamId, PortId, SourceId, StateId, VariableId,
};
use rspice_veriloga::canonical_ir::{
...
fn metadata_digest_is_stable_and_hex_encoded() {
    ...
    assert_eq!(metadata.schema_version, CANONICAL_IR_SCHEMA_VERSION);
...
fn artifact_dump_is_deterministic_and_contains_phase_summaries() {
    ...
    assert!(first.contains(&format!("schema_version={CANONICAL_IR_SCHEMA_VERSION}")));
