...
module compact_expression_direct_store_product_division_helpers(p, n);
    ...
    analog begin
        ...
        I(p, n) <+ prod2 + prod3 + off_lhs + off_rhs + off_den + ratio + value_ratio + inputs_ratio + product3_ratio + product_ratio3;
    end
endmodule
"#
}
...
module compact_expression_direct_store_mixed_index_product_helpers(p, n);
    ...
    analog begin
        ...
        I(p, n) <+ add_iaa + add_aia + add_aai
                 ...
                 + div_ratio_iiaa + div_value_ratio_iaa + div_inputs_ratio_iiaa + div_product3_ratio_iiiaa
