...
/// An explicit failed/stale disposition bound to the current model source.
pub struct QualificationVectorDispositionInput<'a> {
    pub disposition_id: String,
    pub suite_id: &'a str,
    pub vector_id: &'a str,
    pub current_source: &'a ModelSourceEvidenceBinding,
    pub cause: QualificationVectorDispositionCause,
    pub required_action: QualificationVectorRequiredAction,
    pub reason: String,
}
...
impl ModelQualificationState {
    ...
    pub fn record_vector_disposition_atomically(
        &mut self,
        input: QualificationVectorDispositionInput<'_>,
    ) -> QualificationResult<QualificationVectorDisposition> {
        let QualificationVectorDispositionInput {
            disposition_id,
            suite_id,
            vector_id,
            current_source,
