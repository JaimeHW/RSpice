...
impl std::error::Error for IntegerRuntimeError {}

/// Apply the Verilog-AMS real-to-integer conversion.
pub fn real_to_integer(value: f64) -> Result<i32, IntegerRuntimeError> {
    if !value.is_finite() {
...
pub fn integer_neg(value: f64) -> Result<f64, IntegerRuntimeError> {
...
pub fn shift_count(value: f64) -> Result<u32, IntegerRuntimeError> {
