...
mod hierarchy_path;
pub(crate) use hierarchy_path::{remap_instance_probes, remap_instance_probes_many};
...
pub use simulation::{
    ...
    PoleZeroRootSetEvidence, PoleZeroSpectrumCertificate, PreparedModelQualification,
    ...
    SoaViolationEvidence, SoaViolationSeverityEvidence, SpecificationVerdict,
    SpecificationVerdictStatus, TransferFunctionAccuracyEvidence,
