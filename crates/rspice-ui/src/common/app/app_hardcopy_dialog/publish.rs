...
use crate::common::hardcopy_print::discover_native_printers;
#[cfg(target_arch = "wasm32")]
use crate::common::hardcopy_print::{
...
thread_local! {
    static PRINTER_DISCOVERY: std::cell::RefCell<Option<
        std::sync::mpsc::Receiver<Result<
            crate::common::hardcopy_print::PrinterDiscoveryReport,
            String,
        >>,
    >> = const { std::cell::RefCell::new(None) };
...
fn apply_open_resolved(
    ...
    if (workflow == HardcopyWorkflow::Print
        ...
        && crate::common::hardcopy_print::native_print_platform_support()
            == crate::common::hardcopy_print::NativePrintPlatformSupport::Available
    {
...
fn metadata_for(
    ...
    metadata.set_publication_timestamp(HardcopyPublicationTimestamp::from_unix_seconds(
        crate::common::time_compat::unix_epoch().as_secs(),
    )?);
...
pub(super) fn refresh_printer_catalog(app: &mut RSpiceApp) {
    if crate::common::hardcopy_print::native_print_platform_support()
        != crate::common::hardcopy_print::NativePrintPlatformSupport::Available
    {
...
pub(super) fn select_printer_capabilities(
    ...
    suggested: Option<crate::common::hardcopy_print::PrinterDriverSettingsSuggestion>,
) {
    ...
    let raster_geometry = match crate::common::hardcopy_print::resolve_native_printer_mode(
        &capabilities,
        &selected_paper_id,
        resolution,
        orientation,
...
fn record_print_failure(
    app: &mut RSpiceApp,
    plan: &HardcopyPlan,
    error: crate::common::hardcopy_print::HardcopyPrintError,
    pages_completed: u32,
) -> String {
...
mod tests {
    ...
    fn app_state_clone_drops_runtime_hardcopy_authority_and_payloads() {
        ...
        app.state.dialogs.hardcopy.printer_report =
            Some(crate::common::hardcopy_print::PrinterDiscoveryReport::default());
    ...
    fn selected_export_name_receives_the_contract_extension() {
        ...
        crate::common::file_actions::ensure_file_extension(&mut path, "pdf");
