...
use super::app_dialog_state::{CreateHierarchyDialogState, CreateHierarchyPortDraft};
use super::app_hierarchy_reference_impact::validate_hierarchy_reference_impact;
use super::app_project_design_history::{
...
use super::{AppState, ConsoleMessage, RSpiceApp, SchematicEditAuthority};
...
impl RSpiceApp {
    pub(super) fn render_create_hierarchy_dialog(&mut self, ctx: &Context) {
