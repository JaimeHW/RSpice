pub(in crate::common::app) mod export_image;
pub(in crate::common::app) mod file;
pub(in crate::common::app) mod property_edit;
pub(in crate::common::app) mod workspace;
...
impl RSpiceApp {
    ...
    pub(in crate::common::app) fn handle_shortcuts(&mut self, ctx: &Context) {
    ...
    pub(in crate::common::app) fn execute_shortcut_command(&mut self, command: ShortcutCommand) {
        ...
        match command {
            ...
            ShortcutCommand::ObjectProperties => {
                crate::common::app::open_selected_object_properties(&mut self.state);
            }
            ShortcutCommand::Cancel => {
                if self.state.dialogs.move_selection.armed {
                    crate::common::app::cancel_armed_move_selection(&mut self.state);
                } else if self.state.dialogs.stretch_selection.armed {
                    crate::common::app::cancel_armed_stretch_selection(&mut self.state);
                } else if self.state.dialogs.array_selection.armed {
                    crate::common::app::cancel_armed_array_selection(&mut self.state);
            ...
            ShortcutCommand::DescendHierarchy => {
                crate::common::app::open_descend_hierarchy_dialog(&mut self.state);
            }
    ...
    pub(in crate::common::app) fn action_edit_copy(&mut self) {
        crate::schematic::view::sheet_visibility::retain_selection_on_active_sheet(&mut self.state);
        self.state.copy_active_schematic_selection();
    }

    pub(in crate::common::app) fn action_edit_paste(&mut self) {
    ...
    pub(in crate::common::app) fn action_edit_cut(&mut self) {
        crate::common::app::open_cut_selection_dialog(&mut self.state);
    }

    pub(in crate::common::app) fn action_edit_delete(&mut self) {
        crate::common::app::open_delete_selection_dialog(&mut self.state);
    }

    pub(in crate::common::app) fn action_edit_select_all(&mut self) {
        crate::common::app::open_select_all_dialog(&mut self.state);
    }
}
...
mod shortcut_ownership_tests {
    ...
    fn object_properties_shortcut_dispatches_bus_and_guards_dirty_cancel() {
        ...
        let Some(crate::common::app::ObjectPropertiesDraft::Bus(draft)) =
