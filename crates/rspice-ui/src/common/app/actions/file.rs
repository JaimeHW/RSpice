...
impl RSpiceApp {
    ...
    pub(in crate::common::app) fn handle_confirmation_response(
        &mut self,
    ...
    pub(in crate::common::app) fn handle_save_continuation_event(
        &mut self,
    ...
    pub(in crate::common::app) fn begin_close_project_after_save(&mut self) {
    ...
    pub(in crate::common::app) fn execute_pending_action(
        &mut self,
    ...
    pub(in crate::common::app) fn action_file_save(&mut self) -> bool {
