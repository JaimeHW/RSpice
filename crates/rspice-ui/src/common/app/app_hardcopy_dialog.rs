...
pub(crate) enum HardcopySubflowSnapshot {
    Printer {
        ...
        printer_capabilities: Option<crate::common::hardcopy_print::PrinterCapabilitySnapshot>,
        paper: PaperDraft,
    },
    CustomPaper {
        paper: PaperDraft,
...
pub(crate) struct HardcopyDialogState {
    ...
    pub(crate) printer_report: Option<crate::common::hardcopy_print::PrinterDiscoveryReport>,
    pub(crate) printer_capabilities:
        Option<crate::common::hardcopy_print::PrinterCapabilitySnapshot>,
    ...
    pub(crate) busy: bool,
    pub(crate) cancellation: crate::common::hardcopy_print::HardcopyCancellationToken,
...
/// Project transactions clone [`crate::common::app::AppState`]. A modal
...
impl HardcopyDialogState {
    ...
    fn from_setup(setup: HardcopySetup) -> Self {
        ...
        Self {
            ...
            busy: false,
            cancellation: crate::common::hardcopy_print::HardcopyCancellationToken::default(),
            last_receipt: None,
            error: None,
        }
    }
    ...
    pub(crate) fn open(
        ...
        draft.busy = false;
        draft.cancellation = crate::common::hardcopy_print::HardcopyCancellationToken::default();
