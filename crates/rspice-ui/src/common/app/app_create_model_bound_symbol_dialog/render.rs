...
use super::super::app_mockup_review::{configure_field_validation, field_label};
use super::super::{ConsoleMessage, RSpiceApp};
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_create_model_bound_symbol_dialog(
        &mut self,
        ctx: &Context,
    ) {
