...
use super::app_instance_catalog::{
...
use super::{AppState, ConsoleMessage, RSpiceApp, ReplaceInstanceOpen, SchematicEditAuthority};
...
impl RSpiceApp {
    pub(super) fn render_replace_instance_dialog(&mut self, ctx: &Context) {
