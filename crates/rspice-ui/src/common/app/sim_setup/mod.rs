...
pub(in crate::common::app) mod analysis_drafts;
pub(in crate::common::app) mod dialogs;
pub(in crate::common::app) mod plan_catalog;
...
pub struct SimSetupState {
    ...
    #[serde(default)]
    pub active_plan_name: crate::common::app::SimulationPlanName,
    /// Immutable source identity and revision when the active plan is a clone.
    #[serde(default)]
    pub active_plan_lineage: crate::common::app::SimulationPlanLineage,
    /// Complete inactive plans retained in deterministic catalog order.
    #[serde(default)]
    pub inactive_plans: Vec<crate::common::app::StoredSimulationPlan>,
