...
impl RSpiceApp {
    pub(super) fn commit_design_management_subflow(
                ...
                == MoveHierarchyEffect::CreateChildCell
        {
            ...
            if !super::super::app_create_hierarchy_dialog::create_hierarchy_available(&self.state) {
                return Err(
            ...
            super::super::close_design_management_dialog_route(&mut self.state);
            super::super::app_create_hierarchy_dialog::open_create_hierarchy_dialog(
                &mut self.state,
            );
            return Ok(());
        }
        ...
        let (tab, receipt) = match page {
            ...
            DesignManagementPage::MoveSelection => {
                ...
                let connectivity =
                    super::super::app_create_hierarchy_dialog::selected_component_sheet_move_plan(
                        &self.state,
                    )?;
