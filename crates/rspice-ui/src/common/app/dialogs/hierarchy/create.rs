...
use crate::common::app::design_history::{
...
use crate::common::app::dialogs::state::{CreateHierarchyDialogState, CreateHierarchyPortDraft};
use crate::common::app::schematic::hierarchy_reference_impact::validate_hierarchy_reference_impact;
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_create_hierarchy_dialog(&mut self, ctx: &Context) {
...
pub(in crate::common::app) fn selected_component_sheet_move_plan(
    state: &AppState,
