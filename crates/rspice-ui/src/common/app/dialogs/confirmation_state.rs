...
pub struct ConfirmationDialogState {
    ...
    pub(crate) pending_recent_kind: Option<crate::common::app::RecentKind>,
...
pub(crate) struct PendingConfirmationContinuation {
    ...
    pub(crate) recent_kind: Option<crate::common::app::RecentKind>,
...
impl ConfirmationDialogState {
    ...
    pub(crate) fn show_recent(
        ...
        kind: crate::common::app::RecentKind,
    ) {
        self.visible = true;
