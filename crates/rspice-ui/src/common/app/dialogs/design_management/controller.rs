...
impl RSpiceApp {
    pub(in crate::common::app) fn render_design_management_dialog(&mut self, ctx: &Context) {
        ...
        match choice {
            ...
            DialogChoice::Ghost | DialogChoice::Cancelled => {
                if dirty && !discard {
                    ...
                    crate::common::app::close_design_management_dialog_route(&mut self.state);
                } else {
    ...
    fn handle_design_management_body_action(&mut self, action: DesignManagementBodyAction) {
        match action {
            ...
            DesignManagementBodyAction::OpenConfigurationSets => {
                ...
                self.state.dialogs.design_management.close_and_discard();
                crate::common::app::close_design_management_dialog_route(&mut self.state);
                crate::common::app::open_configuration_sets_dialog(&mut self.state);
            }
            DesignManagementBodyAction::OpenConfigurationBinding => {
                ...
                self.state.dialogs.design_management.close_and_discard();
                crate::common::app::close_design_management_dialog_route(&mut self.state);
                crate::common::app::open_configuration_binding_dialog(&mut self.state);
            }
        }
    }
