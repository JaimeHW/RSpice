...
use crate::common::app::publish_symbol_definition_candidate;
...
fn bound_symbol_references(state: &crate::common::app::AppState) -> Vec<CellViewRef> {
...
mod tests {
    ...
    fn review_only_svg_import_keeps_real_geometry_without_an_executable_contract() {
        let mut app = crate::common::app::AppState::default();
