...
use crate::common::app::dialogs::review_primitives::{
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_array_selection_dialog(&mut self, ctx: &Context) {
...
mod tests {
    ...
    fn restored_mockup_shell_contract_is_exact() {
        ...
        assert_eq!(
            crate::common::app::dialogs::review_primitives::PURPOSE_HEIGHT,
            35.0
        );
