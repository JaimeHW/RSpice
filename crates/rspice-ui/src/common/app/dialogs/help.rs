...
use crate::common::app::{HelpCenterPage, RSpiceApp, session::shortcuts::ShortcutCategory};
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_help_center_dialog(&mut self, ctx: &Context) {
    ...
    pub(in crate::common::app) fn render_about_dialog(&mut self, ctx: &Context) {
    ...
    pub(in crate::common::app) fn render_shortcuts_help_dialog(&mut self, ctx: &Context) {
