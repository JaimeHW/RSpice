...
impl RSpiceApp {
    pub(in crate::common::app) fn render_hardcopy_dialog(&mut self, ctx: &Context) {
        ...
        match body_action {
            ...
            BodyAction::DriverProperties => {
                #[cfg(target_os = "windows")]
                {
                    ...
                    match crate::common::hardcopy_print::show_native_printer_properties(
                        &printer_id,
                        None,
                    ) {
                        Ok(crate::common::hardcopy_print::PrinterDriverPropertiesOutcome::Accepted {
                            capabilities,
                            suggestion,
                        }) => {
                        ...
                        Ok(crate::common::hardcopy_print::PrinterDriverPropertiesOutcome::Cancelled) => {}
                        Err(error) => {
...
fn apply_printer_job(
    ...
    let geometry = crate::common::hardcopy_print::resolve_native_printer_mode(
        capabilities,
        paper_id,
        dpi,
        orientation,
...
fn reconcile_native_printer_job(draft: &mut HardcopyDialogState) -> bool {
    ...
    let Ok(geometry) = crate::common::hardcopy_print::resolve_native_printer_mode(
        capabilities,
        &paper_id,
