...
use crate::common::app::session::shortcut_library::{
...
pub(in crate::common::app) const ENGINEERING_PROFILE_HELP: &str = "Sets the discipline context reported by capability discovery and the availability matrix. Deep links and project documents remain available.";
pub(in crate::common::app) const CAPABILITY_MATRIX_HELP: &str = "See installed, licensed, preview and profile-hidden capabilities without duplicating their settings.";

#[derive(Debug, Default)]
pub(in crate::common::app) struct PreferencePageActions {
    pub(in crate::common::app) open_capability_matrix: bool,
    pub(in crate::common::app) open_resolved_preference_policy: bool,
    pub(in crate::common::app) open_workspace_layout_manager: bool,
    pub(in crate::common::app) open_shortcut_editor: bool,
    pub(in crate::common::app) open_shortcut_import: bool,
    pub(in crate::common::app) open_shortcut_export: bool,
    pub(in crate::common::app) open_resolved_shortcut_policy: bool,
    pub(in crate::common::app) shortcut_policy_candidate:
        Option<crate::workbench::ShortcutPreferences>,
    pub(in crate::common::app) updated_profile_label: Option<&'static str>,
}

impl RSpiceApp {
    pub(in crate::common::app) fn render_preferences_dialog(&mut self, ctx: &Context) {
...
pub(in crate::common::app) fn normalize_autosave_minutes(minutes: u8) -> u8 {
    match minutes {
        2 | 5 | 10 => minutes,
        0..=3 => 2,
        4..=7 => 5,
...
pub(in crate::common::app) fn engineering_profile_detail(
...
mod tests {
    ...
    fn shortcut_policy_persistence_failure_keeps_live_state_unchanged_and_recovers_controls() {
        ...
        app.state.shortcut_library_persistence =
            crate::common::app::session::shortcut_library::ShortcutLibraryPersistenceRuntime::Unavailable(
