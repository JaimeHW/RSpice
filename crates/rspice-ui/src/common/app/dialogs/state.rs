...
pub(crate) struct EngineeringTableDialogState {
    ...
    pub(crate) saved_import_token: Option<crate::common::browser_file_import::TextImportToken>,
...
pub(crate) struct CheckAndSaveDialogState {
    ...
    pub(crate) report: Option<
        crate::common::app::dialogs::check_and_save_validation::CheckAndSaveValidationReport,
    >,
    pub(crate) validation_error: Option<String>,
...
impl CheckAndSaveDialogState {
    pub(crate) fn open(
        &mut self,
        report: crate::common::app::dialogs::check_and_save_validation::CheckAndSaveValidationReport,
    ) {
        *self = Self {
            open: true,
            report: Some(report),
...
pub(crate) struct NamedNetObjectPropertiesDraft {
    pub(crate) original: crate::common::app::NamedNetTarget,
    pub(crate) name: String,
}
...
pub(crate) enum RenameSelectionTarget {
    ...
    NamedNet(crate::common::app::NamedNetTarget),
    Bus(crate::state::Bus),
}
...
impl ObjectPropertiesDialogState {
    ...
    pub(crate) fn open_named_net(
        &mut self,
        target: crate::common::app::NamedNetTarget,
        design_execution_epoch: u64,
        active_schematic_epoch: u64,
        topology_version: u64,
        view_path: String,
...
pub struct DialogState {
    ...
    pub(crate) hardcopy: crate::common::app::HardcopyDialogState,
    ...
    pub(crate) workspace_layout_manager:
        crate::common::app::dialogs::preferences::workspace_layout_manager::WorkspaceLayoutManagerState,

    /// Transactional shortcut import/export workflows.
    pub(crate) shortcut_portability: crate::common::app::dialogs::preferences::shortcut_portability_dialogs::ShortcutPortabilityDialogsState,
    ...
    pub(crate) selection_workflow: crate::common::app::SelectionWorkflowDialogState,
    ...
    pub interaction: crate::common::app::InteractionState,
