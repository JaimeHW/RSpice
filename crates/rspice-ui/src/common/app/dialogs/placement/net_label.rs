...
use crate::common::app::dialogs::schematic_command::{field_label, read_only_value, snap_label};
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_net_label_dialog(&mut self, ctx: &Context) {
