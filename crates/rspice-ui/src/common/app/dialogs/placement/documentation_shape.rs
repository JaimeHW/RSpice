...
use crate::common::app::{AppState, DocumentationShapeDialogState, RSpiceApp};
...
impl RSpiceApp {
    pub(in crate::common::app) fn render_documentation_shape_dialog(&mut self, ctx: &Context) {
