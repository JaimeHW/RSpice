...
//! Browser builds already persist the complete [`super::AppState`] through
...
pub(super) fn restore_global_veriloga_library(
...
pub(super) fn save_global_veriloga_library(
