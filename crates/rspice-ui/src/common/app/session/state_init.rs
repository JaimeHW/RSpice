use crate::common::app::{AnalysisWorkspaceState, AppState, DialogState};
...
pub(in crate::common::app) fn default_analysis_viewers() -> AnalysisWorkspaceState {
...
pub(in crate::common::app) fn default_app_state() -> AppState {
    ...
    let sim_setup = crate::common::app::SimSetupState::new();
    ...
    AppState {
        ...
        library_manager,
        workspace,
        project_lifecycle: crate::common::project_lifecycle::ProjectLifecycleState::default(),
        ...
        shortcut_resolver: crate::common::app::session::shortcuts::ShortcutResolverState::default(),
        shortcut_library_persistence:
            crate::common::app::session::shortcut_library::ShortcutLibraryPersistenceRuntime::default(),
