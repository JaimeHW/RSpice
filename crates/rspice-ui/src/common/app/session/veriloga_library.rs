...
//! Browser builds already persist the complete [`crate::common::app::AppState`] through
...
pub(in crate::common::app) const VERILOGA_LIBRARY_NAME: &str = "veriloga";
#[cfg(not(target_arch = "wasm32"))]
...
pub(in crate::common::app) fn restore_global_veriloga_library(
...
pub(in crate::common::app) fn save_global_veriloga_library(
