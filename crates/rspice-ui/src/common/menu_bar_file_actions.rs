...
pub(super) fn action_file_open(state: &mut AppState) {
    let io = crate::common::file_workflow::NativeFileWorkflowIo;
    action_file_open_with_io(state, &io);
}
...
pub(super) fn action_file_save(state: &mut AppState) {
    let io = crate::common::file_workflow::NativeFileWorkflowIo;
    let _ = action_file_save_with_io(state, &io);
}
...
pub(super) fn action_file_save_as(state: &mut AppState) {
    let io = crate::common::file_workflow::NativeFileWorkflowIo;
    let _ = action_file_save_as_with_io(state, &io);
}
