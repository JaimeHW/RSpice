...
//!
//! # Why a held row is classified at all
//!
...
//! the same hiding this module exists to remove. That classification is
//! [`card_device`], shared with every other reader of the same table, and a
//! test beside it holds the mirror to the generator's own source.
...
use crate::state::model_library::{
    ModelLibrary, ModelLibraryManager, ModelSourceAuthority, PackModelHit, SUBCIRCUIT_CLASS,
    card_device,
};
