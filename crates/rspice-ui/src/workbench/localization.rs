...
define_messages! {
    ...
    EditorAccessibleOneDiagnostic => "One {severity} diagnostic on this line, {code}: {message}.",
    EditorAccessibleManyDiagnostics => "{count} diagnostics on this line; strongest severity {strongest}. First, {first_severity} {code}: {message}.",
    ...
    DiagnosticCurrentnessCurrent => "current",
    DiagnosticCurrentnessStaleSource => "stale source",
    DiagnosticCurrentnessStaleEnvironment => "stale environment",
    DiagnosticCurrentnessStalePermissions => "stale permissions",
    DiagnosticCurrentnessSupersededValidation => "superseded validation",
    CodeDiagnosticPosition => "{path}:{line}:{column} | {code} | {currentness}",
    CodeDiagnosticIdentity => "{path} | {code} | {currentness}",
    CodeDiagnosticLine => "{path}:{line} | {code} | {currentness}",
    CodeDiagnosticOpenLocation => "Open {path} at line {line}",
    CodeDiagnosticAccessibleLabel => "{severity}: {message}. {metadata}",
    CodeDiagnosticSourceUnavailable => "The diagnostic source '{path}' is no longer in the current source closure.",
    CodeDiagnosticMissingLine => "The diagnostic has no source line to reveal.",
    EditorToggleBreakpoint => "Toggle breakpoint on line {line}",
    NetlistSourceDocuments => "Source documents",
    NetlistGeneratedAuthority => "generated",
    NetlistProjectAuthority => "project",
    NetlistComparisonAuthority => "comparison",
    NetlistUnresolvedAuthority => "unresolved",
    NetlistExternalReadOnlyAuthority => "external · read-only",
    NetlistVendorReadOnlyAuthority => "vendor · read-only",
    NetlistTechnologyReadOnlyAuthority => "technology package · read-only",
    NetlistStandardReadOnlyAuthority => "standard library · read-only",
    NetlistRelinkSourcePermission => "Relink source or permission…",
    NetlistRelinkUnresolvedHint => "Click to relink this dependency into the authenticated source closure.",
    ...
    NetlistCreateNarrowOverride => "Create a narrow generated-source override",
    NetlistCreateOwnedProjectRequired => "Open a project before creating owned Netlist source.",
    NetlistCreateOwnedReadOnly => "The project is open read-only; owned Netlist source cannot be created.",
    NetlistCreateOwnedLease => "{holder} holds the Netlist write lease; owned source creation is disabled.",
    NetlistCreateOwnedExecutionActive => "Owned Netlist source cannot be created while a simulation execution owns the project.",
    ...
    NetlistDiagnosticsMore => "{count} additional diagnostics are available in Problems.",
    ProblemAccessibleLabel => "{status}: {message}. Source: {source}.",
    ProblemOpenSource => "Open {source}",
    ...
    NetlistNavigatorReadOnly => "read-only",
    NetlistNavigatorAddedLines => "Added lines",
    NetlistNavigatorRemovedLines => "Removed lines",
    NetlistNavigatorChangedHunks => "Changed hunks",
    NetlistNavigatorRoot => "root",
    NetlistNavigatorParameters => "Parameters",
    NetlistNavigatorGlobals => "Global nodes & parameters",
    NetlistNavigatorFunctions => "Functions & macros",
    NetlistNavigatorOptions => "Options",
    NetlistNavigatorInstances => "Instances",
    NetlistNavigatorSubcircuits => "Subcircuits & hierarchy",
    NetlistNavigatorModels => "Model bindings",
    NetlistNavigatorAnalyses => "Analyses",
    NetlistNavigatorMeasurements => "Measurements",
    NetlistNavigatorOutputs => "Save & output probes",
    NetlistNavigatorConditionals => "Conditionals",
    NetlistNavigatorControls => "Control directives",
    ...
    CodeSourceImportProjectFile => "Import project file…",
    CodeSourceSaveCopy => "Save a copy…",
    CodeSourceHistoryCompare => "History & compare…",
    CodeSourceNewFile => "New file…",
    CodeSourceRename => "Rename…",
    CodeSourceMove => "Move…",
    CodeSourceDuplicate => "Duplicate…",
    CodeSourceDelete => "Delete…",
    CodeSourceRootDeleteBlocked => "The bundle root cannot be deleted; replace or rename it instead.",
    CodeSourceEntryRoleFixed => "The Automation entry role is permanently bound to the bundle root.",
    CodeSourceEnvironmentLockMutationBlocked => "The managed environment lock is read-only. Reassign its role or duplicate it before changing the source graph.",
    CodeSourceProjectReadOnly => "The project is open read-only. Source editing and qualification-history changes are unavailable.",
    CodeSourceCopyFailed => "Source copy failed",
    CodeSourceHistoryUnavailable => "Source history unavailable",
    CodeSourceActionUnavailable => "Source-file action unavailable",
    CodeSourceCreateWorkspace => "Create source workspace…",
    CodeSourceImportRoot => "Import root source…",
    CodeSourceWorkspaceEyebrow => "PROJECT SOURCE · NEW WORKSPACE",
    ...
    CodeSourceWorkspaceDescription => "Create a project-owned source closure with portable logical paths and explicit semantic role bindings.",
    CodeSourceWorkspaceRootPath => "Root source path",
    CodeSourceWorkspaceBuildProfilePath => "Build-profile path",
    CodeSourceWorkspaceRunPlanPath => "Run-plan path",
    CodeSourceWorkspaceEnvironmentLockPath => "Environment-lock path",
    CodeSourceWorkspacePermissionPath => "Permission-manifest path",
    CodeSourceWorkspaceNetlistPath => "Run-plan netlist source",
    CodeSourceWorkspaceVerilogANote => "The editable root and its explicit build-profile role can be renamed or expanded without relying on demonstration filenames.",
    CodeSourceWorkspaceAutomationNote => "Paths are suggestions only. The four execution roles are persisted explicitly and continue to identify documents after a rename or move.",
    CodeSourceAutomationRole => "Automation role",
    CodeSourceRoleUnassigned => "Unassigned",
    CodeSourceRoleRunPlan => "Run plan",
    CodeSourceRoleEnvironmentLock => "Environment lock",
    CodeSourceRolePermissionManifest => "Permission manifest",
    ...
    CodeHistoryNoRetainedComparison => "No retained revision is available for comparison.",
    CodeHistoryEyebrow => "PROJECT SOURCE · RETAINED HISTORY",
    CodeHistoryTitle => "History & compare",
    CodeHistoryRestore => "Restore bundle",
    CodeHistoryDescription => "Compare the selected file with a retained project revision. Restore applies the complete authenticated source graph: all files, roles, and dependency edges.",
    CodeHistorySource => "Source",
    CodeHistoryCurrentRevision => "Current bundle revision",
    CodeHistoryRetainedRevision => "Retained revision",
    CodeHistoryNoRetained => "No retained revisions",
    CodeHistoryRevision => "Revision {revision}",
    CodeHistoryRevisionFileSingular => "Revision {revision} · {count} file · {digest} · {root}",
    CodeHistoryRevisionFiles => "Revision {revision} · {count} files · {digest} · {root}",
    CodeHistoryRestoreNotice => "Restore is non-destructive in the journal: the current graph is retained and the restored graph becomes a new monotonic revision.",
    CodeHistoryStale => "The source graph changed after this dialog opened. Close and reopen history before restoring.",
    CodeHistoryUnifiedDiff => "Unified diff",
    CodeSourceTransactionEyebrow => "PROJECT SOURCE · EXACT TRANSACTION",
    CodeSourceCreateTitle => "Create project source file",
    CodeSourceRenameTitle => "Rename project source file",
    CodeSourceMoveTitle => "Move project source file",
    CodeSourceDuplicateTitle => "Duplicate project source file",
    CodeSourceDeleteTitle => "Delete project source file",
    CodeSourceCreatePrimary => "Create file",
    CodeSourceRenamePrimary => "Rename file",
    CodeSourceMovePrimary => "Move file",
    CodeSourceDuplicatePrimary => "Duplicate file",
    CodeSourceDeletePrimary => "Delete file",
    CodeSourceCreateDescription => "Create a project-owned source and bind it to the selected importer in one validated source-graph transaction.",
    CodeSourceRenameDescription => "Rename the exact source while migrating role bindings, dependency edges, and Verilog-A include references atomically.",
    CodeSourceMoveDescription => "Move the exact source to another project-relative directory while migrating role bindings, dependency edges, and Verilog-A include references atomically.",
    CodeSourceDuplicateDescription => "Create an exact project-owned copy. The new document is immediately part of the authenticated source closure.",
    CodeSourceDeleteDescription => "Delete the exact non-root source only if no role or downstream dependency would become invalid.",
    CodeSourceLanguage => "Language",
    CodeSourceBundleRevision => "Bundle revision",
    CodeSourceDeleteWarning => "This operation cannot be undone after the project is saved.",
    CodeSourceLogicalPath => "Project-relative logical path",
    CodeSearchReplaceMatchSingular => "Replace {count} match",
    CodeSearchReplaceMatches => "Replace {count} matches",
    CodeSearchReviewReplacement => "Review replacement",
    CodeSearchEyebrow => "PROJECT SOURCE · BOUNDED SEARCH",
    CodeSearchTitle => "Find and replace in source bundle",
    CodeSearchDescription => "Search the exact authenticated source closure. Replacement is previewed, revision-checked, and committed atomically across editable project files.",
    CodeSearchFindHint => "Find in source bundle",
    CodeSearchSelection => "Selection",
    CodeSearchCurrentDocument => "Current document",
    CodeSearchOpenDocuments => "Open documents",
    CodeSearchActiveLanguage => "Active-language project sources",
    ...
    CodeSearchIncludeGenerated => "Include generated references",
    CodeSearchReplaceWith => "Replace with",
    CodeSearchCurrentBundleMatchSingular => "{count} match in the current {language} bundle",
    CodeSearchCurrentBundleMatches => "{count} matches in the current {language} bundle",
    CodeSearchLimitExceeded => "Search limit exceeded: {limit}",
    CodeSearchShowingFirst => "Showing first {limit}",
    CodeSearchReadOnlyMatchSingular => "{count} match in governed read-only files will remain unchanged.",
    CodeSearchReadOnlyMatches => "{count} matches in governed read-only files will remain unchanged.",
    CodeSearchReviewCommit => "Review the complete bounded result list, then commit the replacement.",
    CodeSearchEnterText => "Enter text to search this bundle.",
    CodeSearchNoMatches => "No matches in the exact current bundle.",
    CodeSearchReadOnlySuffix => "read-only",
    ...
    AutomationArtifactExportAccessible => "Export {artifact}. Output type: {kind}.",
    AutomationArtifactUnavailable => "{artifact} is unavailable. Run the current Automation workspace successfully to produce this {kind} artifact.",
