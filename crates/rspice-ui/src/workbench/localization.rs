...
define_messages! {
    ...
    StimulusDeleteWithAdopters => "Delete definition · {count} placed source(s) keep their cards",
    StimulusRevert => "Revert draft",
    StimulusApply => "Apply",
    StimulusDraftNotApplied => "draft · not applied",
    StimulusUndoAvailable => "Undo steps this draft back",
    StimulusDraftErrors => "draft · {count} error(s)",
    ...
    StimulusRealization => "Realization · {count} adopter(s)",
    ...
    StimulusAuditAdvisories => "{count} advisory(ies)",
    StimulusAuditErrors => "{count} error(s)",
