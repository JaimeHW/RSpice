...
impl Command {
    ...
    pub const fn spec(self) -> CommandSpec {
        match self {
            ...
            Self::ExportPublicationSnapshot => spec(
                "export-publication-snapshot",
                "Export publication snapshot…",
                "File",
            ),
            Self::LiveSession => spec("live-session", "Live session…", "File"),
            ...
            Self::NextSheet => spec("next-sheet", "Next sheet", "Design"),
            Self::PreviousSheet => spec("previous-sheet", "Previous sheet", "Design"),
            Self::NewSheet => spec("new-sheet", "New sheet", "Design"),
            Self::DeleteSheet => spec("delete-sheet", "Delete active sheet", "Design"),
