...
fn consume_accesskit_text_selection(
    ui: &Ui,
    editor_id: egui::Id,
...
fn update_accesskit_text_state(
    ui: &Ui,
    editor_id: egui::Id,
    response: &Response,
    model: &TextDocumentModel,
...
pub(crate) fn label_text_edit_accessibility(
    response: &Response,
...
pub(crate) fn bounded_accessible_text(source: &str, maximum_chars: usize) -> String {
...
mod tests {
    ...
    fn accessible_text_is_whitespace_normalized_and_strictly_bounded() {
        assert_eq!(bounded_accessible_text(" alpha\n\tbeta ", 32), "alpha beta");
        let bounded = bounded_accessible_text(&"x".repeat(10_000), 64);
