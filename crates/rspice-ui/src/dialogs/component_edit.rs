...
fn get_type_fields(
    ...
    match comp_type {
        ...
        ComponentType::CurrentSourceSin => (
            ...
            "0 1m 1k 0 0 0",
            "SIN Parameters",
            "IO IA FREQ TD THETA PHI",
            true,
        ),
        ComponentType::CurrentSourcePwl => (
            "PWL",
            "0 0 1n 0 2n 1m 3n 1m 4n 0",
            "Time-Value Pairs",
            "t1 i1 t2 i2 ...",
            true,
        ),
...
fn get_type_name(comp_type: ComponentType) -> &'static str {
    match comp_type {
        ...
        ComponentType::SaturableInductor => "Saturable Inductor",
        ComponentType::VoltageSourcePwl => "PWL Voltage Source",
        ComponentType::VoltageSourceExp => "Exponential Voltage Source",
        ComponentType::VoltageSourceSffm => "SFFM Voltage Source",
        ComponentType::CurrentSourceAc => "AC Current Source",
        ComponentType::CurrentSourcePulse => "Pulse Current Source",
        ComponentType::CurrentSourceSin => "Sine Current Source",
        ComponentType::CurrentSourcePwl => "PWL Current Source",
        ComponentType::CurrentSourceExp => "Exponential Current Source",
        ComponentType::CurrentSourceNoise => "Noise Current Source",
