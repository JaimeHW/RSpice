...
impl PropertyRegistry {
    pub(super) fn register_passive_components(&mut self) {
    ...
    pub(super) fn register_sources(&mut self) {
        // DC Voltage Source
    ...
    pub(super) fn register_semiconductors(&mut self) {
    ...
    pub(super) fn register_controlled_sources(&mut self) {
        self.register_vcvs();
        self.register_vccs();
        self.register_ccvs();
        self.register_cccs();
    ...
    pub(super) fn register_vcvs(&mut self) {
        let mut sheet = PropertySheet::new();
    ...
    pub(super) fn register_vccs(&mut self) {
        let mut sheet = PropertySheet::new();
    ...
    pub(super) fn register_ccvs(&mut self) {
        let mut sheet = PropertySheet::new();
    ...
    pub(super) fn register_cccs(&mut self) {
        let mut sheet = PropertySheet::new();
