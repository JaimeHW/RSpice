...
mod tests {
    ...
    // -------------------------------------------------------------------------
    // WireSegment Construction Tests
    // -------------------------------------------------------------------------
    ...
    #[test]
    fn test_segment_length_horizontal() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert_eq!(seg.length(), 10);
    }

    #[test]
    fn test_segment_length_vertical() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(0, 5));
        assert_eq!(seg.length(), 5);
    }

    #[test]
    fn test_segment_length_diagonal() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(3, 4));
        assert_eq!(seg.length(), 7); // Manhattan distance
    }

    #[test]
    fn test_segment_euclidean_length() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(3, 4));
    ...
    fn test_segment_midpoint() {
        ...
        assert_eq!(seg.midpoint(), Point::new(5, 5));
    }

    #[test]
    fn test_segment_midpoint_odd() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(5, 5));
        assert_eq!(seg.midpoint(), Point::new(2, 2)); // Integer division
    }
    ...
    #[test]
    fn test_segment_is_zero_length() {
    ...
    #[test]
    fn test_segment_bounding_box_normal() {
        let seg = WireSegment::new(Point::new(1, 2), Point::new(5, 8));
        let (min, max) = seg.bounding_box();
        assert_eq!(min, Point::new(1, 2));
        assert_eq!(max, Point::new(5, 8));
    }

    #[test]
    fn test_segment_bounding_box_reversed() {
        let seg = WireSegment::new(Point::new(5, 8), Point::new(1, 2));
        let (min, max) = seg.bounding_box();
        assert_eq!(min, Point::new(1, 2));
        assert_eq!(max, Point::new(5, 8));
    }
    ...
    #[test]
    fn test_segment_contains_point_horizontal() {
        let seg = WireSegment::new(Point::new(0, 5), Point::new(10, 5));
        assert!(seg.contains_point(Point::new(5, 5)));
        assert!(seg.contains_point(Point::new(0, 5)));
        assert!(seg.contains_point(Point::new(10, 5)));
        assert!(!seg.contains_point(Point::new(5, 6)));
        assert!(!seg.contains_point(Point::new(11, 5)));
    }
    ...
    fn test_segment_contains_point_vertical() {
        let seg = WireSegment::new(Point::new(5, 0), Point::new(5, 10));
        assert!(seg.contains_point(Point::new(5, 5)));
        assert!(seg.contains_point(Point::new(5, 0)));
        assert!(seg.contains_point(Point::new(5, 10)));
        assert!(!seg.contains_point(Point::new(6, 5)));
    }

    #[test]
    fn test_segment_contains_point_diagonal() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 10));
        assert!(seg.contains_point(Point::new(5, 5)));
    ...
    #[test]
    fn test_segment_contains_point_zero_length() {
        let seg = WireSegment::new(Point::new(5, 5), Point::new(5, 5));
        assert!(seg.contains_point(Point::new(5, 5)));
        assert!(!seg.contains_point(Point::new(5, 6)));
    }
    ...
    #[test]
    fn test_segment_distance_to_point_on_segment() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert!((seg.distance_to_point(Point::new(5, 0))).abs() < 0.001);
    }

    #[test]
    fn test_segment_distance_to_point_perpendicular() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert!((seg.distance_to_point(Point::new(5, 3)) - 3.0).abs() < 0.001);
    }

    #[test]
    fn test_segment_distance_to_point_beyond_endpoint() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        // Point beyond end, closest point is endpoint
        let dist = seg.distance_to_point(Point::new(13, 4));
        assert!((dist - 5.0).abs() < 0.001); // Distance to (10, 0) = sqrt(9+16) = 5
    }
    ...
    #[test]
    fn test_segment_closest_point_on_segment() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert_eq!(seg.closest_point(Point::new(5, 3)), Point::new(5, 0));
    }

    #[test]
    fn test_segment_closest_point_at_start() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert_eq!(seg.closest_point(Point::new(-5, 0)), Point::new(0, 0));
    }

    #[test]
    fn test_segment_closest_point_at_end() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        assert_eq!(seg.closest_point(Point::new(15, 0)), Point::new(10, 0));
    }
    ...
    #[test]
    fn test_segment_intersection_no_cross() {
    ...
    #[test]
    fn test_segment_intersection_parallel_same_line() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(5, 0));
        let seg2 = WireSegment::new(Point::new(3, 0), Point::new(10, 0));
        // Should find overlap at shared point
        let result = seg1.intersection(&seg2);
    ...
    fn test_segment_intersection_t_junction() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        let seg2 = WireSegment::new(Point::new(5, 0), Point::new(5, 10));
        assert_eq!(seg1.intersection(&seg2), Some(Point::new(5, 0)));
    }
    ...
    #[test]
    fn test_segment_overlaps_false_parallel() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        let seg2 = WireSegment::new(Point::new(0, 1), Point::new(10, 1));
        assert!(!seg1.overlaps(&seg2));
    }

    #[test]
    fn test_segment_overlaps_false_disjoint() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(5, 0));
        let seg2 = WireSegment::new(Point::new(10, 0), Point::new(15, 0));
        assert!(!seg1.overlaps(&seg2));
    }
    ...
    #[test]
    fn test_segment_direction_horizontal() {
        let seg = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
    ...
    #[test]
    fn test_segment_direction_vertical() {
    ...
    #[test]
    fn test_segment_direction_zero_length() {
        let seg = WireSegment::new(Point::new(5, 5), Point::new(5, 5));
        let (dx, dy) = seg.direction();
        assert!(dx.abs() < 0.001);
        assert!(dy.abs() < 0.001);
    ...
    #[test]
    fn test_segment_shares_endpoint_start_start() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        let seg2 = WireSegment::new(Point::new(0, 0), Point::new(0, 10));
        assert!(seg1.shares_endpoint(&seg2));
        assert_eq!(seg1.shared_endpoint(&seg2), Some(Point::new(0, 0)));
    }

    #[test]
    fn test_segment_shares_endpoint_end_start() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
    ...
    #[test]
    fn test_segment_shares_endpoint_none() {
        let seg1 = WireSegment::new(Point::new(0, 0), Point::new(10, 0));
        let seg2 = WireSegment::new(Point::new(20, 0), Point::new(20, 10));
        assert!(!seg1.shares_endpoint(&seg2));
        assert_eq!(seg1.shared_endpoint(&seg2), None);
    }
    ...
    #[test]
    fn test_hit_result_is_hit_vertex() {
        let result = WireHitResult::Vertex {
            index: 0,
            point: Point::new(0, 0),
            distance: 1.0,
        };
    ...
    #[test]
    fn test_hit_result_is_hit_segment() {
        let result = WireHitResult::Segment {
            index: 0,
    ...
    #[test]
    fn test_hit_result_is_hit_none() {
        assert!(!WireHitResult::None.is_hit());
    }

    #[test]
    fn test_hit_result_distance() {
        let vertex = WireHitResult::Vertex {
            index: 0,
            point: Point::new(0, 0),
            distance: 3.5,
        };
        assert!((vertex.distance() - 3.5).abs() < 0.001);
        ...
        assert!((segment.distance() - 2.5).abs() < 0.001);

        assert!(WireHitResult::None.distance().is_infinite());
    }

    #[test]
    fn test_hit_result_point() {
        let vertex = WireHitResult::Vertex {
            index: 0,
            point: Point::new(5, 5),
            distance: 1.0,
        ...
        let segment = WireHitResult::Segment {
            index: 0,
            closest_point: Point::new(7, 0),
            distance: 2.0,
            segment: WireSegment::new(Point::new(0, 0), Point::new(10, 0)),
        };
        assert_eq!(segment.point(), Some(Point::new(7, 0)));

        assert_eq!(WireHitResult::None.point(), None);
    }
}
