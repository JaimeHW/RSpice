...
pub struct DialogState {
    ...
    // --- Harmonic Balance (HB) ---
    pub hb_state: super::simulation_dialog::hb::HbDialogState,
    // --- S-Parameter ---
    pub sp_state: super::simulation_dialog::sp::SpDialogState,
    // --- PAC (Periodic AC) ---
    pub pac_state: super::simulation_dialog::pac::PacDialogState,
    // --- PNoise (Periodic Noise) ---
    pub pnoise_state: super::simulation_dialog::pnoise::PnoiseDialogState,
    // --- PXF (Periodic Transfer) ---
    pub pxf_state: super::simulation_dialog::pxf::PxfDialogState,
    // --- PSTB (Periodic Stability) ---
    pub pstb_state: super::simulation_dialog::pstb::PstbDialogState,
    // --- XF (Transfer Function) ---
    pub xf_state: super::simulation_dialog::xf::XfDialogState,
    // --- Corner Analysis ---
    pub corner_state: super::simulation_dialog::corner::CornerDialogState,
    // --- Envelope Transient ---
    pub envelope_state: super::simulation_dialog::envelope::EnvelopeDialogState,
    // --- Fourier ---
    pub fourier_state: super::simulation_dialog::fourier::FourierDialogState,
    // --- DC Operating Point ---
    pub op_state: super::simulation_dialog::op::OpDialogState,
    // --- Pole-Zero ---
    pub pz_state: super::simulation_dialog::pz::PzDialogState,
    // --- Sensitivity ---
    pub sens_state: super::simulation_dialog::sens::SensDialogState,
    // --- Monte Carlo ---
    pub mc_state: super::simulation_dialog::mc::McDialogState,
    // --- PSS ---
    pub pss_state: super::simulation_dialog::pss::PssDialogState,
    // --- STB ---
...
pub struct RSpiceApp {
    ...
    pub symbol_library: Option<super::symbol_library::SymbolLibrary>,
}
...
impl RSpiceApp {
    ...
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        // Load symbol library
        let symbol_library = match super::symbol_library::SymbolLibrary::load_embedded() {
            Ok(lib) => {
...
impl eframe::App for RSpiceApp {
    ...
    fn update(&mut self, ctx: &Context, _frame: &mut eframe::Frame) {
        ...
        CentralPanel::default()
            ...
            .show(ctx, |ui| {
                super::schematic_view::render_schematic_view(
                    ui,
                    &mut self.state,
...
impl RSpiceApp {
    ...
    fn render_waveform_panel(&mut self, ui: &mut Ui) {
        ...
        super::waveform::render_waveform_panel(ui, &mut self.state);
    }
}
