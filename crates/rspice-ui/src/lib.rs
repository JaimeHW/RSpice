...
/// Prepared, immutable project-library publication artifact. Persist
/// `artifact_bytes()` durably before passing the candidate to
/// [`RSpiceApp::commit_project_library_publication`].
#[derive(Debug, Clone)]
