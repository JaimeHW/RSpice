...
class SimulationResult:
    ...
    def scalars(self) -> list[ResultScalar]: ...
    def device_observables(self) -> list[DeviceObservable]: ...
    def document(self) -> Any: ...
    def saved_signals(self, netlist: Netlist) -> list[ProjectedSignal]: ...
    ...
    @property
    def device_operating_points(self) -> list[DeviceOperatingPoint] | None: ...
    @property
    def has_device_operating_points(self) -> bool: ...
...
class FftResult:
    ...
    def document(self) -> Any: ...
    @property
    def status(self) -> Literal["complete", "incomplete-history"]: ...
    @property
    def incomplete_history(self) -> tuple[float, float] | None: ...
    @property
...
class CompressedTransientResult:
    @property
    def current_impulses(self) -> list[CurrentImpulseTrace] | None: ...
    def signals(self) -> list[SignalDescriptor]: ...
    def scalars(self) -> list[ResultScalar]: ...
    def device_observables(self) -> list[DeviceObservable]: ...
    def document(self) -> Any: ...
    ...
    def channel_availability(self, name: str) -> str: ...
    def channel_absence(self, name: str) -> list[str | None]: ...
    @property
    def digital_trace_names(self) -> list[str]: ...
    def digital_trace(self, name: str) -> list[tuple[float, str, str]]: ...
    def digital_buses(self) -> list[DigitalBus]: ...
    def bus_events(self, name: str) -> list[BusEvent]: ...
    @property
    def real_trace_names(self) -> list[str]: ...
    def real_trace(self, name: str) -> list[tuple[float, float]]: ...
    @property
    def fourier_results(self) -> list[FourierResult]: ...
    @property
...
class TransientResult:
    ...
    def fourier_of(
        self, spec: str, fundamental: float, num_harmonics: int = 9
    ) -> FourierResult: ...
    def fourier_current(
    ...
    def saved_signals(self, netlist: Netlist) -> list[ProjectedSignal]: ...
    def digital_nodes(self) -> list[str]: ...
    def digital_events(self, node: str) -> list[DigitalEvent]: ...
    def digital_buses(self) -> list[DigitalBus]: ...
    def bus_events(self, name: str) -> list[BusEvent]: ...
    @property
    def real_trace_names(self) -> list[str]: ...
    def real_trace(self, name: str) -> list[tuple[float, float]]: ...
    def to_vcd(self) -> str: ...
    def write_vcd(self, path: str | os.PathLike[str]) -> None: ...
    @property
...
class DcSweepResult:
    ...
    def device_operating_points_at(
        self, index: int
    ) -> list[DeviceOperatingPoint] | None: ...
    @property
    def has_device_operating_points(self) -> bool: ...
...
class DcMatchContributor:
    ...
    def scope(self) -> str: ...
    @property
    def sigma_parameter(self) -> float: ...
    @property
...
class DcMatchResult:
    ...
    @property
    def sigma_process(self) -> float: ...
    @property
    def sigma_multiplier(self) -> float: ...
    @property
    def evaluated_contributors(self) -> int: ...
    @property
    def quoted_sigma(self) -> float: ...
    @property
    def contributors(self) -> list[DcMatchContributor]: ...
    def signals(self) -> list[SignalDescriptor]: ...
    def scalars(self) -> list[ResultScalar]: ...
    def device_observables(self) -> list[DeviceObservable]: ...
    def document(self) -> Any: ...
    def __len__(self) -> int: ...
    def get(self, instance: str, parameter: str | None = None) -> DcMatchContributor: ...
    def top(self, count: int = 10) -> list[DcMatchContributor]: ...

@final
class AcSensitivity:
    """Derived arrays contain NaN at unavailable samples; reason arrays identify why."""
    @property
    def normalized_unavailability(self) -> list[str | None]: ...
    @property
    def magnitude_unavailability(self) -> list[str | None]: ...
    @property
    def phase_unavailability(self) -> list[str | None]: ...
    @property
    def phase_degrees_unavailability(self) -> list[str | None]: ...
    @property
    def db_unavailability(self) -> list[str | None]: ...
    @property
...
class ElementSensitivity:
    @property
    def normalized_unavailability(self) -> str | None: ...
    @property
    def vector_name(self) -> str: ...
    @property
    def element(self) -> str: ...
    ...
    @property
    def percent_per_percent(self) -> float | None: ...
    def __reduce__(self) -> tuple[Any, tuple[Any, ...]]: ...
...
class PxfResult:
    ...
    def frequencies(self) -> npt.NDArray[np.float64]: ...
    @property
    def output_frequencies(self) -> npt.NDArray[np.float64]: ...
    @property
    def transfer(self) -> npt.NDArray[np.complex128]: ...
    @property
    def magnitude_db(self) -> npt.NDArray[np.float64]: ...
    @property
    def phase_degrees(self) -> npt.NDArray[np.float64]: ...
    @property
    def group_delay(self) -> list[tuple[float, float]]: ...
    @property
    def fundamental_frequency(self) -> float: ...
    @property
    def input_sideband(self) -> int: ...
    @property
    def output_sideband(self) -> int: ...
    @property
    def max_sideband(self) -> int: ...
    @property
    ...
    @property
    def peak_gain_db(self) -> float | None: ...
    @property
    def peak_gain_frequency(self) -> float | None: ...
    @property
    def bandwidth_3db(self) -> float | None: ...
    @property
    def unity_gain_frequency(self) -> float | None: ...
    @property
    def dc_gain(self) -> ComplexValue | None: ...
...
class PstbResult:
    ...
    def fundamental_frequency(self) -> float: ...
    @property
    def probe_instance(self) -> str: ...
    @property
    def probe_state_index(self) -> int | None: ...
    @property
    def probe_state_projection(self) -> list[tuple[int, float]]: ...
    @property
    def multipliers(self) -> npt.NDArray[np.complex128]: ...
    @property
    def exponents(self) -> npt.NDArray[np.complex128]: ...
    @property
    def magnitudes(self) -> npt.NDArray[np.float64]: ...
    @property
    def phase_degrees(self) -> npt.NDArray[np.float64]: ...
    @property
    def stability_margins_db(self) -> npt.NDArray[np.float64]: ...
    @property
    def mode_damping(self) -> npt.NDArray[np.float64]: ...
    @property
    def mode_frequencies_hz(self) -> npt.NDArray[np.float64]: ...
    @property
    def probe_participation(self) -> npt.NDArray[np.float64]: ...
    @property
    def unstable_modes(self) -> list[bool]: ...
    @property
    def num_unstable(self) -> int: ...
    @property
    def max_multiplier_magnitude(self) -> float: ...
    @property
    def min_stability_margin_db(self) -> float | None: ...
    @property
    def subharmonics(self) -> list[int]: ...
    @property
    def trivial_multiplier_index(self) -> int | None: ...
    @property
    def stability_threshold(self) -> float: ...
    @property
    def detect_subharmonics(self) -> bool: ...
    @property
...
class EnvelopeResult:
    ...
    def document(self) -> Any: ...
    @property
    def carrier(self) -> HbResult: ...
    @property
    def continued_transient(self) -> TransientResult: ...
    @property
...
class RunReport:
    ...
    @property
    def pss(self) -> PssResult | None: ...
    @property
    def pac(self) -> PacResult | None: ...
    @property
    def pxf(self) -> PxfResult | None: ...
    @property
    def pstb(self) -> PstbResult | None: ...
    @property
    def pnoise(self) -> PeriodicNoiseResult | None: ...
    @property
    def oscillator_noise(self) -> OscillatorNoiseResult | None: ...
    @property
    def envelope(self) -> EnvelopeResult | None: ...
    @property
    ...
    @property
    def dcmatch(self) -> DcMatchResult | None: ...
    @property
    ...
    @property
    def all_pss(self) -> list[PssResult]: ...
    @property
    def all_pac(self) -> list[PacResult]: ...
    @property
    def all_pxf(self) -> list[PxfResult]: ...
    @property
    def all_pstb(self) -> list[PstbResult]: ...
    @property
    def all_pnoise(self) -> list[PeriodicNoiseResult]: ...
    @property
    def all_oscillator_noise(self) -> list[OscillatorNoiseResult]: ...
    @property
    def all_envelope(self) -> list[EnvelopeResult]: ...
    @property
    ...
    @property
    def all_dcmatch(self) -> list[DcMatchResult]: ...
    @property
