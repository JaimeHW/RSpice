...
impl PacConfig {
    ...
    pub fn resolved_sidebands(&self) -> (i32, i32) {
...
pub fn optional_tolerance(text: &str, label: &str) -> Result<Option<f64>, String> {
    let trimmed = text.trim();
    if trimmed.is_empty() {
        return Ok(None);
    }
...
pub fn optional_tolerance_text(value: Option<f64>) -> String {
