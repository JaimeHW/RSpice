...
use rspice_app_types::product::{
    CaptureGroupId, ObjectRevision, RevisionError, SavedOutputId, SimulationPlanId,
};
...
pub fn validate_plan_groups(
    plan_id: SimulationPlanId,
    groups: &[CaptureGroup],
    identities: &mut HashMap<CaptureGroupId, SimulationPlanId>,
...
impl CaptureGroup {
    ...
    #[must_use]
    pub fn cloned_for_new_plan(&self, output_map: &HashMap<SavedOutputId, SavedOutputId>) -> Self {
        Self {
            id: CaptureGroupId::new(),
            revision: ObjectRevision::INITIAL,
...
mod tests {
    use super::*;
    use crate::saved_output::SavedOutputCompatibility;
