...
pub(crate) fn carrier_frequency_context(
    dependent: bool,
    frequency: Value,
...
pub(crate) fn minimum_pss_interval(
    expr: &Expr,
    context: &Context<'_>,
...
pub(crate) fn finite_fourier_degree(
    expr: &Expr,
    period: Value,
    context: &Context<'_>,
) -> Option<Value> {
...
pub(crate) fn needs_time_features(expr: &Expr, period: Value, context: &Context<'_>) -> bool {
...
pub(crate) fn max_authored_tone_cycles(expr: &Expr, period: Value, context: &Context<'_>) -> Value {
...
pub(crate) fn time_increment_with_state(
    expr: &Expr,
    period: Value,
    context: &Context<'_>,
    autonomous: bool,
