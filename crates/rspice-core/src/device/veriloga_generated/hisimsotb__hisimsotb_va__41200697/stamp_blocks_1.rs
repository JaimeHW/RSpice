...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if ((s.b[978] && (!s.b[980])) && s.b[984]) {
            ...
            s.store_ad_value(290, A::add_scaled_inputs3(s.ad_value(427), 1.0, s.ad_value(428), 1.0, A::div(s.ad_value(422), A::scale(s.ad_value(421), 3.0)), -1.0));
