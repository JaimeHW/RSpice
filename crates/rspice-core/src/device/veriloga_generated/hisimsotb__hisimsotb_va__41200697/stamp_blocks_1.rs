...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if (((!s.b[956]) && s.b[957]) && (!s.b[960])) {
            ...
            s.store_mul_ad_product_lhs_mixed_ai(946, A::mul3(A::exp(s.ad_value(938)), s.ad_value(940), s.ad_value(943)), 947, 947);
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if ((!s.b[968]) && (!s.b[970])) {
            ...
            s.store_mul_product3_mixed_aiii(257, A::exp(s.ad_value(278)), 280, 248, 248, 1.0);
            ...
            s.store_div_ad_rhs(257, 257, A::sub_from_scalar(1.0, A::exp_div_scaled_inputs(s.ad_value(123), -1.0, s.ad_value(629), 1.0)));
        }
        ...
        if ((!s.b[971]) && (!s.b[973])) {
            s.store_scale_ad(280, A::div_from_scalar(s.v[628], s.ad_value(245)), (1.6021918e-19 * s.v[466]));
            s.store_mul_product3_mixed_aiii(258, A::exp(s.ad_value(278)), 280, 249, 249, 1.0);
            s.store_div_scaled_value_offset_denominator(258, s.ad_value(258), 1.0, A::exp(A::mul(s.ad_value(120), s.ad_value(51))), 1.0, 1.0);
            s.store_div_ad_rhs(258, 258, A::sub_from_scalar(1.0, A::exp_div_scaled_inputs(s.ad_value(123), -1.0, s.ad_value(629), 1.0)));
        }
    ...
    if s.b[978] {
        ...
        s.store_scalar(399, assign18050_e22022);
    ...
    if s.b[978] {
        ...
        s.store_scalar(400, assign18060_e22030);
    ...
    if s.b[978] {
        ...
        s.store_scalar(402, assign18070_e22040);
    ...
    if s.b[978] {
        ...
        s.store_scalar(403, assign18080_e22050);
    ...
    if s.b[978] {
        ...
        s.store_scalar(419, assign18310_e22251);
    ...
    if ((s.b[978] && (!s.b[980])) && s.b[987]) {
        ...
        s.store_scalar(379, assign19210_e23430);
    ...
    if ((((s.b[978] && (!s.b[980])) && s.b[987]) && (!s.b[990])) && s.b[992]) {
        ...
        (s.v[379],)
            ...
            s.store_scalar(379, assign19230_body29_e23959);
            if ((s.b[978] && (!s.b[980])) && s.b[987]) {
    ...
    if s.b[978] {
        ...
        s.store_scalar(399, assign19440_e24177);
    ...
    if s.b[978] {
        ...
        s.store_scalar(400, assign19450_e24185);
    ...
    if s.b[978] {
        ...
        s.store_scalar(402, assign19460_e24195);
    ...
    if s.b[978] {
        ...
        s.store_scalar(403, assign19470_e24205);
    ...
    if s.b[978] {
        ...
        s.store_scalar(419, assign19700_e24406);
    ...
    if ((s.b[978] && (!s.b[997])) && s.b[1004]) {
        ...
        s.store_scalar(379, assign20600_e25585);
    ...
    if ((((s.b[978] && (!s.b[997])) && s.b[1004]) && (!s.b[1007])) && s.b[1009]) {
        ...
        (s.v[379],)
            ...
            s.store_scalar(379, assign20620_body29_e26114);
            if ((s.b[978] && (!s.b[997])) && s.b[1004]) {
                s.store_offset(62, 62, 1.0);
            }
        }
    ...
    if s.b[978] {
        ...
        s.store_scalar(194, assign20830_e26334);
    ...
    if s.b[978] {
        ...
        s.store_scalar(194, assign20870_e26378);
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if s.b[1031] {
            ...
            s.store_mul_product3_indices(1049, 1042, 279, 1048, 1047, 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_22(
        ...
        if s.b[1058] {
            ...
            s.store_mul_product3_indices(1076, 1069, 279, 1075, 1074, 1.0);
        }
