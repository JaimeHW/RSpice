...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_scalar(649, 2.0);s.store_scalar(650, 0.1);s.store_scalar(651, 0.1);s.store_scalar(514, 0.0);s.store_scalar(574, 0.0);s.store_scalar(237, 1e-12);s.store_scalar(28, 500.0);s.store_scalar(29, 200.0);s.store_scalar(32, 0.002);s.store_scalar(38, p.p24);s.store_scalar(46, 1.0);s.store_scalar(36, 1.0);s.store_scalar(305, 0.0);s.store_scalar(306, 0.0);s.store_scalar(307, 0.0);s.store_scalar(308, 0.0);s.store_scalar(309, 0.0);s.store_scalar(310, 0.0);s.store_scalar(312, 0.0);s.store_scalar(314, 0.0);s.store_scalar(311, 0.0);s.store_scalar(313, 0.0);s.store_scalar(207, 0.0);s.store_scalar(209, 0.0);s.store_scalar(531, 0.0);s.store_scalar(528, 0.0);s.store_scalar(585, 0.0);s.store_scalar(588, 0.0);s.store_scalar(523, 0.0);s.store_scalar(576, 0.0);s.store_scalar(555, 0.0);s.store_scalar(556, 0.0);s.store_scalar(322, 0.0);s.store_scalar(327, 0.0);s.store_scalar(329, 0.0);s.store_scalar(330, 0.0);s.store_scalar(331, 0.0);s.store_scalar(334, 0.0);s.store_scalar(336, 0.0);s.store_scalar(337, 0.0);s.store_scalar(345, 0.0);s.store_scalar(383, 0.0);s.store_scalar(385, 0.5);s.store_scalar(441, 0.0);s.store_scalar(442, 0.0);s.store_scalar(390, 0.0);s.store_scalar(558, 0.0);s.store_scalar(405, 0.0);s.store_scalar(406, 0.0);s.store_scalar(397, 0.0);s.store_scalar(398, 0.0);s.store_scalar(414, 0.0);s.store_scalar(34, 0.0);s.store_scalar(35, 0.0);s.store_scalar(292, 0.0);s.store_scalar(16, 0.0);s.store_scalar(60, 0.0);s.store_scalar(58, 0.0);s.store_scalar(74, 1.0);s.store_scalar(85, 0.0);s.store_scalar(91, 0.0);s.store_scalar(93, 0.0);s.store_scalar(94, 0.0);s.store_scalar(151, 0.0);s.store_scalar(158, 0.0);s.store_scalar(159, 0.0);s.store_scalar(160, 0.0);s.store_scalar(185, 0.0);s.store_scalar(189, 1.0);s.store_scalar(193, 0.0);s.store_scalar(196, 0.0);s.store_scalar(197, 0.0);s.store_scalar(221, 0.0);s.store_scalar(222, 0.0);s.store_scalar(146, 0.0);s.store_scalar(260, 0.0);s.store_scalar(89, 0.0);s.store_scalar(230, 0.0);s.store_scalar(231, 0.0);s.store_scalar(233, 0.0);s.store_scalar(234, 0.0);s.store_scalar(235, 0.0);s.store_scalar(236, 0.0);s.store_scalar(240, 0.0);s.store_scalar(55, 0.0);s.store_scalar(77, 0.0);s.store_scalar(339, 0.0);s.store_scalar(388, 0.0);s.store_scalar(316, 0.0);s.b[517] = param_given[172];s.store_scalar(517, if s.b[517] { 1.0 } else { 0.0 });s.b[518] = param_given[173];s.store_scalar(518, if s.b[518] { 1.0 } else { 0.0 });s.b[519] = param_given[174];s.store_scalar(519, if s.b[519] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_1(
        ...
        s.b[463] = param_given[9];s.store_scalar(463, if s.b[463] { 1.0 } else { 0.0 });s.store_scalar(394, 1.0);s.store_scalar(446, (if param_given[177] { p.p177 } else { (5000000000.0 / (p.p227 * p.p230)) }));s.b[660] = ((s.v[446] < (2.0 + 0.1)) && (0.1 >= 0.0));s.store_scalar(660, if s.b[660] { 1.0 } else { 0.0 });
        if s.b[660] {s.store_scalar(638, ((2.0 + 0.1) - s.v[446]));s.store_square(642, 638);s.store_scalar(643, (0.1 * 0.1));s.store_scalar(644, 1.0);s.store_scalar(645, 1.0);}
        let (t0,) = {
    if s.b[660] {
        (0.0,)
    } else {
    ...
    if s.b[660] {
        ...
        s.store_scalar(648, t1);
        if s.b[660] {s.store_scalar(220, 0.0);s.store_scalar(646, 0.0);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_add(220, 644, 645);s.copy_ad(646, 220);}
    ...
    if ((s.b[660] && s.b[661]) && s.b[662]) {
        ...
        s.store_scalar(648, t2);s.b[663] = (2.0 == 2.0);s.store_scalar(663, if s.b[663] { 1.0 } else { 0.0 });
        let (t3,) = {
    if (((s.b[660] && s.b[661]) && (!s.b[662])) && s.b[663]) {
        ...
        s.store_scalar(648, t3);s.b[664] = (2.0 == 4.0);s.store_scalar(664, if s.b[664] { 1.0 } else { 0.0 });
        let (t4,) = {
    if ((((s.b[660] && s.b[661]) && (!s.b[662])) && (!s.b[663])) && s.b[664]) {
        ...
        s.store_scalar(648, t4);s.b[665] = (2.0 == 8.0);s.store_scalar(665, if s.b[665] { 1.0 } else { 0.0 });
        let (t5,) = {
    ...
    if (s.b[660] && s.b[661]) {
        ...
        s.store_scalar(647, t6);let mut ta: usize = 0;
        while {
            let t9: f64 = if ((s.b[660] && s.b[661]) && (s.v[647] < s.v[648])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;assert!(ta <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (s.b[660] && s.b[661]) {s.store_sqrt(646, 646);}
            let (t8,) = {
    if (s.b[660] && s.b[661]) {
        let t7: f64 = (s.v[647] + 1.0);
        (t7,)
    } else {
        (s.v[647],)
    }
};
            s.store_scalar(647, t8);
        }
        ...
        s.store_scalar(613, (p.p34 * 0.01));s.store_scalar(614, (p.p59 / 1e-6));s.store_scalar(615, (p.p101 * 0.01));s.store_scalar(616, (p.p192 / 1e-6));s.store_scalar(617, (p.p219 * 0.01));s.store_scalar(619, (p.p220 / 0.0001));s.store_scalar(620, (p.p230 / 1e-6));s.store_scalar(621, (p.p231 / 1e-6));s.store_scalar(622, (p.p237 * 0.01));s.store_scalar(623, (p.p238 / 0.01));s.store_scalar(624, (p.p40 / 1e-6));s.store_scalar(625, (p.p236 / 1e-6));s.store_scalar(627, (p.p197 / 0.01));s.store_scalar(630, (p.p306 / 1e-6));s.store_scalar(631, (p.p307 / 1e-6));s.store_scalar(626, (p.p189 * 10000.0));s.store_scalar(452, (p.p147 / 1e-6));s.store_scalar(628, (p.p196 / 10.0));s.store_scalar(445, (p.p222 + 273.15));s.store_scalar(447, (p.p9 + 273.15));s.store_scalar(509, p.p41);s.store_scalar(510, p.p42);s.store_scalar(277, p.p0);s.store_scalar(456, (p.p1 / p.p5));s.store_scalar(375, (s.v[277] * 1000000.0));s.store_scalar(376, (s.v[456] * 1000000.0));s.store_scalar(377, (s.v[376] * s.v[375]));s.store_scalar(279, (p.p62 / ((s.v[377]) as f64).powf(p.p63)));s.store_scalar(133, (s.v[277] + s.v[279]));s.store_scalar(134, (s.v[456] + s.v[279]));s.store_scalar(482, (p.p64 / ((s.v[377]) as f64).powf(p.p65)));s.store_scalar(279, (1.0 + (p.p148 / (((s.v[133] * 1000000.0)) as f64).powf(p.p149))));s.store_scalar(280, (1.0 + (p.p150 / (((s.v[134] * 1000000.0)) as f64).powf(p.p151))));s.store_scalar(452, ((s.v[452] * s.v[279]) * s.v[280]));s.store_scalar(279, (1.0 + (p.p154 / (((s.v[133] * 1000000.0)) as f64).powf(p.p155))));s.store_scalar(280, (1.0 + (p.p156 / (((s.v[134] * 1000000.0)) as f64).powf(p.p157))));s.store_scalar(453, ((p.p152 * s.v[279]) * s.v[280]));s.store_scalar(511, ((2.0 * s.v[453]) * p.p153));s.store_scalar(124, ((s.v[456] - (2.0 * s.v[509])) - s.v[511]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_2(
        ...
        s.store_scalar(512, ((s.v[456] - (2.0 * s.v[510])) - s.v[511]));s.store_scalar(466, (s.v[124] * p.p5));s.store_scalar(513, (s.v[512] * p.p5));s.store_scalar(467, (s.v[622] / (s.v[394] * s.v[466])));s.store_scalar(468, (s.v[623] * (s.v[394] * s.v[513])));s.store_scalar(278, (s.v[630] * ((p.p11 + (p.p304 * p.p12)) + (p.p305 * p.p13))));s.store_scalar(620, (s.v[620] + s.v[278]));s.store_scalar(638, ((s.v[620] - (1000000000000000.0 / 1e-6)) - (0.01 / 1e-6)));s.store_scalar(639, ((4.0 * (1000000000000000.0 / 1e-6)) * (0.01 / 1e-6)));
        if (!(s.v[639] > 0.0)) {s.store_scalar(639, (-s.v[639]));}
        s.store_sqrt_offset_input(639, 639, (s.v[638] * s.v[638]));s.store_offset_scaled(620, 639, 0.5, ((((s.v[638]) * (0.5))) + ((1000000000000000.0 / 1e-6))));s.store_scalar(278, (s.v[631] * ((p.p11 + (p.p304 * p.p12)) + (p.p305 * p.p13))));s.store_scalar(614, (s.v[614] + s.v[278]));s.store_scalar(638, ((s.v[614] - (1000000000000000.0 / 1e-6)) - (0.01 / 1e-6)));s.store_scalar(639, ((4.0 * (1000000000000000.0 / 1e-6)) * (0.01 / 1e-6)));
        if (!(s.v[639] > 0.0)) {s.store_scalar(639, (-s.v[639]));}
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (s.b[666] && (s.v[514] < p.p5)) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
        ...
        s.store_scalar(280, (1.0 + (p.p190 / ((s.v[376]) as f64).powf(p.p191))));s.store_div_from_scalar(281, s.v[616], 620);s.store_offset(638, 281, (((-s.v[280])) + ((-0.01))));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_3(
        ...
        let ctx_temp = ctx.temperature();let nv4 = ctx.node_voltage(nodes[4]);s.store_scale(639, 281, (4.0 * 0.01));
        ...
        s.store_scale(126, 457, 1.6021918e-19);s.store_scale(472, 126, 1.034943e-10);s.store_scale(473, 472, 2.0);s.store_scale(474, 462, (1.6021918e-19 * 1.034943e-10));s.store_scalar(475, (p.p239 * ((s.v[375]) as f64).powf((-p.p242))));s.store_scalar(476, (p.p243 * ((s.v[375]) as f64).powf((-p.p244))));s.store_scalar(477, (p.p246 * (((s.v[375] + p.p248)) as f64).powf((-p.p247))));s.b[669] = ((s.v[277] <= (2.0 * p.p58)) && (p.p58 > 0.0));s.store_scalar(669, if s.b[669] { 1.0 } else { 0.0 });
        ...
        if s.b[670] {s.store_scalar(279, (p.p3 + (s.v[124] / (3.0 * p.p2))));s.store_scale(484, 279, (p.p48 * 1.0 / (((p.p2 * (s.v[277] - p.p4)) * p.p5))));}
        s.b[671] = (s.v[484] > 0.001);s.store_scalar(671, if s.b[671] { 1.0 } else { 0.0 });
        if (s.b[670] && s.b[671]) {s.store_div_from_scalar(484, s.v[394], 484);}
        if (s.b[670] && (!s.b[671])) {s.store_scalar(484, (s.v[394] * 1000.0));}
        if (!s.b[670]) {s.store_scalar(484, (s.v[394] * 1000.0));}
    ...
    if s.b[673] {
        ...
        s.store_scalar(575, td);
        if s.b[673] {s.store_scalar(412, 1.0);s.store_scalar(413, 0.0);s.copy_ad(49, 540);s.copy_ad(48, 541);s.copy_ad(47, 542);s.copy_ad(42, 543);s.copy_ad(41, 544);s.copy_ad(40, 545);}
        let (tf,) = {
    if (!s.b[673]) {
        let te: f64 = (-1.0);
        (te,)
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        s.store_square(121, 120);s.store_div_from_scalar(122, 1.0, 120);s.store_scalar(464, (1.6021918e-19 / (1.3806226e-23 * s.v[445])));s.store_scaled_powf_ad(629, A::scale(s.ad_value(374), 1.0 / (s.v[445])), p.p202, p.p201);s.store_scalar(676, (((p.p249 * (1.0 + (p.p95 / ((s.v[376]) as f64).powf(p.p96)))) * (1.0 + (p.p97 / ((s.v[375]) as f64).powf(p.p98)))) * (1.0 + (p.p99 / ((s.v[377]) as f64).powf(p.p100)))));s.store_scalar(677, (((p.p276 * (1.0 + (p.p277 / ((s.v[376]) as f64).powf(p.p278)))) * (1.0 + (p.p281 / ((s.v[375]) as f64).powf(p.p282)))) * (1.0 + (p.p279 / ((s.v[377]) as f64).powf(p.p280)))));s.b[681] = (s.v[458] > 0.0);s.store_scalar(681, if s.b[681] { 1.0 } else { 0.0 });
        if s.b[681] {s.store_scalar(678, (1.0 / (1.0 + p.p163)));s.store_powf_ad(679, A::div_from_scalar(p.p162, s.ad_value(458)), p.p164);s.store_scalar(680, (((p.p162 / s.v[459])) as f64).powf(p.p164));s.store_div_scaled_offset_numerator(676, A::mul(s.ad_value(678), s.ad_value(679)), s.v[676], s.v[676], A::offset(A::mul(s.ad_value(678), s.ad_value(680)), 1.0), 1.0);s.store_div_scaled_offset_numerator(677, A::mul(s.ad_value(678), s.ad_value(679)), s.v[677], s.v[677], A::offset(A::mul(s.ad_value(678), s.ad_value(680)), 1.0), 1.0);}
    ...
    if s.b[689] {
        ...
        if s.b[689] {s.store_scalar(220, 0.0);s.store_scalar(646, 0.0);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_mul(644, 644, 642);s.store_mul(645, 645, 643);s.store_add(220, 644, 645);s.copy_ad(646, 220);}
    ...
    if ((s.b[689] && s.b[690]) && s.b[691]) {
        ...
        s.store_scalar(648, t12);s.b[692] = (4.0 == 2.0);s.store_scalar(692, if s.b[692] { 1.0 } else { 0.0 });
        let (t13,) = {
    if (((s.b[689] && s.b[690]) && (!s.b[691])) && s.b[692]) {
        ...
        s.store_scalar(648, t13);s.b[693] = (4.0 == 4.0);s.store_scalar(693, if s.b[693] { 1.0 } else { 0.0 });
        let (t14,) = {
    if ((((s.b[689] && s.b[690]) && (!s.b[691])) && (!s.b[692])) && s.b[693]) {
        ...
        s.store_scalar(648, t14);s.b[694] = (4.0 == 8.0);s.store_scalar(694, if s.b[694] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if (s.b[689] && s.b[690]) {
        ...
        if (!(s.v[639] > 0.0)) {s.store_scalar(639, (-s.v[639]));}
        s.store_sqrt_square_add(639, 638, 639);s.store_offset_scaled_div(284, 638, 639, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(88, 638, 0.5, 639, 0.5, 0.1);s.store_div(279, 51, 88);s.copy_ad(638, 279);
    }
    #[inline(never)]
    ...
    if (!s.b[703]) {
        ...
        s.store_scalar(37, t1c);s.store_add_scaled_inputs3_sqrt_third_mixed_iia(275, 129, 1.0, 138, 1.0, A::mul_scaled_lhs(s.ad_value(126), (2.0 * 1.034943e-10), s.ad_value(129)), 1.0 / (s.v[273]));s.b[704] = (s.v[37] == 0.0);s.store_scalar(704, if s.b[704] { 1.0 } else { 0.0 });
        ...
        if (!s.b[704]) {s.store_add_scaled_inputs3_offset_indices(283, 52, 1.0, 50, (-1.0), 275, -1.0, p.p194);s.store_sqrt_square_offset(639, 283, ((4.0 * 0.0001) * 0.0001));s.store_offset_scaled_div(281, 283, 639, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(280, 283, 0.5, 639, 0.5, (1e-10 * 0.0001));}
        ...
        if ((!s.b[704]) && s.b[707]) {s.store_scalar(269, 0.0);}
        let (t1d,) = {
    if ((!s.b[704]) && s.b[707]) {
        (0.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_sqrt(135, 131);s.b[708] = (p.p58 != 0.0);s.store_scalar(708, if s.b[708] { 1.0 } else { 0.0 });
        ...
        if s.b[709] {s.store_sqrt_add_scaled_square_product(280, 279, 1.0, 278, 288, (4.0 * 0.005));s.store_add_scaled_inputs4_indices(281, 288, 1.0, 279, 0.5, 280, 0.5, 138, -1.0);s.store_mul_ad_product_lhs_mixed_ai(282, A::div_from_scalar(4.0, s.ad_value(381)), 122, 122);s.store_offset_mul(283, 120, 281, (-1.0));s.store_offset_mul(279, 283, 282, 1.0);s.store_sqrt_square_offset(639, 279, ((4.0 * 0.001) * 0.001));s.store_offset_scaled_div(285, 279, 639, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(279, 279, 0.5, 639, 0.5, (1e-10 * 0.001));}
        ...
        s.store_div_from_scalar_offset_input(281, 1.0, 270, (s.v[626] / s.v[124]));s.store_sub(283, 271, 281);s.store_offset_mul(84, 150, 283, (p.p104 / s.v[376]));s.store_add_scaled_inputs4_offset_indices(80, 82, 1.0, 266, 1.0, 84, 1.0, 83, 1.0, s.v[482]);let t1e: f64 = (s.v[265] - s.v[80]);s.store_scalar(78, t1e);s.b[713] = (p.p75 == 0.0);s.store_scalar(713, if s.b[713] { 1.0 } else { 0.0 });
        let (t1f,) = {
    if s.b[713] {
        (0.0,)
    } else {
    ...
    if (!s.b[713]) {
        ...
        s.store_scalar(36, t20);s.b[714] = (s.v[36] == 0.0);s.store_scalar(714, if s.b[714] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (!s.b[714]) {s.store_scale(267, 267, s.v[479]);s.store_offset_sub_from_scalar_ad(638, 1.0, s.ad_value(267), (-0.05));s.store_scalar(639, (4.0 * 0.05));}
        if (!s.b[714]) {
            if (s.v[639] > 0.0) {
            } else {
                s.store_neg(639, 639);
        ...
        s.store_add_scaled_inputs4_indices(53, 52, 1.0, 138, (-1.0), 80, 1.0, 267, -1.0);s.copy_ad(76, 53);s.store_mul_ln_mixed_ia(298, 122, A::div(s.ad_value(471), s.ad_value(462)));let t21: f64 = (s.v[138] - s.v[80]);let t22: f64 = (t21 + s.v[267]);s.store_scalar(54, t22);s.store_mul(144, 141, 271);s.store_square(145, 144);
        ...
        if (!s.b[718]) {s.store_mul_square_lhs(279, 439, 120);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_10(
        s: &mut Scratch,
    ) {
        if (!s.b[718]) {s.store_mul_square_lhs(280, 141, 120);s.store_neg_ad(281, A::add_scaled_inputs(s.ad_value(122), 1.0, s.ad_value(440), 2.0));s.store_offset_div(282, 280, 279, 1.0);s.store_scaled_square(283, 141, (s.v[295] * s.v[295]));s.store_add_scaled_products_indices(284, 283, 120, 1.0, 281, 282, (-2.0));}
        if (!s.b[718]) {
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        let mut t28: usize = 0;
        while {
            let t27: f64 = if s.v[62] < s.v[28] { 1.0 } else { 0.0 };
            t27 != 0.0
        } {
            t28 += 1;assert!(t28 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");s.copy_ad(279, 439);s.store_mul(280, 120, 331);s.store_exp_neg_input(281, 280);s.b[720] = (s.v[331] > 1e-8);s.store_scalar(720, if s.b[720] { 1.0 } else { 0.0 });
            ...
            s.copy_ad(331, 284);s.store_scalar(330, s.v[282]);s.store_primal_offset(62, 62, 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        if s.b[724] {s.store_mul_ad_product_rhs_mixed_ia(283, 278, 281, A::sub(A::mul_scaled_rhs(A::offset(s.ad_value(280), (0.5 * s.v[536])), s.ad_value(296), -1.0), s.ad_value(440)));s.store_div(327, 283, 282);}
        let (t2a,) = {
    if s.b[724] {
        let t29: f64 = (s.v[54] + s.v[327]);
        (t29,)
    } else {
        (s.v[54],)
    }
        ...
        if s.b[724] {s.store_sub_scaled_inputs(53, 53, 1.0, 327, p.p298);s.copy_ad(76, 53);}
        s.b[725] = (s.v[33] >= 1.0);s.store_scalar(725, if s.b[725] { 1.0 } else { 0.0 });
        if s.b[725] {s.store_scalar(305, s.v[695]);s.store_scalar(306, s.v[696]);s.store_offset(307, 440, s.v[697]);}
        let (t2f,) = {
    if s.b[725] {
        let t2b: f64 = (-s.v[296]);let t2c: f64 = (t2b * s.v[536]);let t2d: f64 = (t2c / 2.0);let t2e: f64 = (t2d + s.v[122]);
        (t2e,)
    } else {
        (s.v[328],)
    }
};
        s.store_scalar(328, t2f);
        let (t32,) = {
    if s.b[725] {
        let t30: f64 = (s.v[330] * s.v[536]);let t31: f64 = (s.v[328] - t30);
        (t31,)
    } else {
        (s.v[329],)
    }
};
        s.store_scalar(329, t32);s.b[726] = (s.v[440] < 0.0);s.store_scalar(726, if s.b[726] { 1.0 } else { 0.0 });
        if ((!s.b[725]) && s.b[726]) {s.store_scalar(55, 0.0);s.store_scalar(62, 1.0);}
        let mut t34: usize = 0;
        while {
            let t33: f64 = if (((!s.b[725]) && s.b[726]) && (s.v[62] <= s.v[28])) { 1.0 } else { 0.0 };
            t33 != 0.0
        } {
            t34 += 1;assert!(t34 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
    ...
    if ((!s.b[725]) && s.b[730]) {
        ...
        s.store_scalar(292, t37);
        if ((!s.b[725]) && s.b[730]) {s.copy_ad(332, 334);s.store_sqrt_div_scaled_inputs(279, 332, ((2.0 * 1.034943e-10) / 1.6021918e-19), 471, 1.0);s.store_scaled_square(278, 439, (s.v[293] * s.v[293]));}
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        let mut t39: usize = 0;
        while {
            let t38: f64 = if ((((!s.b[725]) && s.b[730]) && s.b[734]) && (s.v[62] < s.v[28])) { 1.0 } else { 0.0 };
            t38 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        let mut t3b: usize = 0;
        while {
            let t3a: f64 = if ((((!s.b[725]) && s.b[730]) && (!s.b[734])) && (s.v[62] < s.v[28])) { 1.0 } else { 0.0 };
            t3a != 0.0
        } {
