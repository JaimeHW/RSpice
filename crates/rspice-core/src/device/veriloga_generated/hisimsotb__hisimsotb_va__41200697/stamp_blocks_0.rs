...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        if s.b[660] {
            ...
            s.store_ad_value(278, A::div_scaled_product(s.ad_value(645), s.ad_value(646), 0.1, A::offset(s.ad_value(220), 1e-50), 1.0));
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        while {
            ...
            if s.b[666] {
                s.store_ad_value(279, A::add_scaled_inputs3(s.ad_value(279), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(514), (p.p8 + p.p0), (p.p6 + (0.5 * p.p0)))), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(514), (p.p8 + p.p0), (p.p7 + (0.5 * p.p0)))), 1.0));
        ...
        if s.b[667] {
            ...
            s.store_ad_value(461, A::div_scaled_product(s.ad_value(460), A::offset(A::mul(s.ad_value(279), s.ad_value(280)), 1.0), 1.0, A::offset(A::mul(s.ad_value(279), s.ad_value(281)), 1.0), 1.0));
            ...
            s.store_ad_value(620, A::div_scaled_product(s.ad_value(620), A::offset(A::mul(s.ad_value(279), s.ad_value(280)), 1.0), 1.0, A::offset(A::mul(s.ad_value(279), s.ad_value(281)), 1.0), 1.0));
        }
        ...
        s.store_ad_value(279, A::add_scaled_inputs3(s.ad_value(281), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        ...
        if (!s.b[668]) {
            s.store_ad_value(457, A::add_scaled_inputs3(s.ad_value(461), 1.0, s.ad_value(461), ((p.p58 - s.v[277]) * 1.0 / (p.p58)), s.ad_value(471), (-((p.p58 - s.v[277]) * 1.0 / (p.p58)))));
        }
        ...
        if s.b[669] {
            s.store_sub_ad_lhs(560, A::add_scaled_inputs3(s.ad_value(461), 2.0, s.ad_value(461), (-(s.v[277] * 1.0 / (p.p58))), s.ad_value(471), (-(-(s.v[277] * 1.0 / (p.p58))))), 471);
        ...
        if s.b[681] {
            ...
            s.store_div_ad(676, A::scaled_offset(A::mul(s.ad_value(678), s.ad_value(679)), 1.0, s.v[676]), A::offset(A::mul(s.ad_value(678), s.ad_value(680)), 1.0));
            s.store_div_ad(677, A::scaled_offset(A::mul(s.ad_value(678), s.ad_value(679)), 1.0, s.v[677]), A::offset(A::mul(s.ad_value(678), s.ad_value(680)), 1.0));
        }
        ...
        s.store_ad_value(162, A::div_scaled_inputs(s.ad_value(480), (s.v[613] * 0.01), A::sub_scaled_inputs(A::add_scaled_product(A::scale_offset(s.ad_value(279), (0.4 * 0.01), (1.8 * 0.01)), 1.0, s.ad_value(279), s.ad_value(279), (0.1 * 0.01)), 1.0, A::sub_from_scalar(1.0, s.ad_value(279)), (s.v[615] * s.v[280])), 1.0));
        ...
        if s.b[683] {
            ...
            s.store_sub_from_scalar_ad(280, p.p38, A::add_scaled_inputs(s.ad_value(638), 0.5, s.ad_value(639), 0.5));
        }
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[689] {
            ...
            s.store_ad_value(286, A::div_scaled_product3(s.ad_value(281), s.ad_value(645), s.ad_value(646), 1.0, A::offset(s.ad_value(220), 1e-50), 1.0));
        ...
        s.store_offset_mul_ad(639, s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::scale_offset(s.ad_value(638), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0))), (1.0 / 24.0))), (1.0 / 6.0))), (1.0 / 2.0)), 1.0);

        s.store_offset_mul_ad(640, s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::offset(A::mul(s.ad_value(638), A::scale_offset(s.ad_value(638), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0))), (1.0 / 8.0))), (1.0 / 3.0)), (1.0 / 2.0));

        s.store_div_from_scalar(73, p.p216, 639);

        s.store_ad_value(280, A::div_scaled_inputs(s.ad_value(640), (-2.0), A::square(s.ad_value(639)), 1.0));
        ...
        s.store_ad_value(87, A::add_scaled_product(s.ad_value(280), 1.0, s.ad_value(279), A::sub_from_scalar(1.0, s.ad_value(290)), 1.0));
        ...
        s.store_div_from_scalar_add_ad(290, 1.0, A::add_scaled_inputs3(A::offset(s.ad_value(638), 1.0), 1.0, s.ad_value(639), 1.0, s.ad_value(640), 1.0), s.ad_value(641));

        s.store_mul_ad_affine_product_lhs(278, A::add_scaled_inputs3(A::scale_offset(s.ad_value(638), 2.0, 1.0), 1.0, s.ad_value(639), 3.0, s.ad_value(640), 4.0), s.ad_value(290), -1.0, 0.0, 290);
        ...
        s.store_ad_value(275, A::add_scaled_inputs3(s.ad_value(129), 1.0, s.ad_value(138), 1.0, A::sqrt(A::mul_scaled_lhs(s.ad_value(126), (2.0 * 1.034943e-10), s.ad_value(129))), 1.0 / (s.v[273])));
        ...
        if (!s.b[704]) {
            s.store_offset_ad(283, A::add_scaled_inputs3(s.ad_value(52), 1.0, s.ad_value(50), (-1.0), s.ad_value(275), -1.0), p.p194);
        ...
        if (!s.b[704]) {
            s.store_sqrt_square_add(639, 638, 639);
            s.store_offset_scaled_div(284, 638, 639, 0.5, 0.5);
            s.store_ad_value(280, A::add_scaled_inputs3(A::div_from_scalar(1.0, s.ad_value(282)), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        ...
        s.store_sub_from_scalar_ad(382, 0.5, A::add_scaled_inputs(s.ad_value(638), 0.5, s.ad_value(639), 0.5));

        s.store_sqrt_mul(150, 473, 129);

        s.store_add_ad_lhs(265, A::add_scaled_product(A::add(s.ad_value(129), s.ad_value(138)), 1.0, s.ad_value(150), s.ad_value(271), 1.0), 380);
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_offset_ad(279, A::sub_scaled_inputs(s.ad_value(130), s.v[278], s.ad_value(382), 1.0), (-0.001));

        s.store_sqrt_ad(280, A::add_scaled_inputs(A::square(s.ad_value(279)), 1.0, s.ad_value(130), ((4.0 * s.v[278]) * 0.001)));

        s.store_sub_ad_rhs(131, 130, A::add_scaled_inputs3(s.ad_value(130), s.v[278], s.ad_value(279), (-0.5), s.ad_value(280), (-0.5)));
        ...
        if s.b[708] {
            ...
            s.store_ad_value(79, A::add_scaled_product(A::add(s.ad_value(136), s.ad_value(138)), 1.0, s.ad_value(278), s.ad_value(271), 1.0));
        ...
        if s.b[709] {
            s.store_sqrt_ad(280, A::add_scaled_product(A::square(s.ad_value(279)), 1.0, s.ad_value(278), s.ad_value(288), (4.0 * 0.005)));
            s.store_sub_ad_lhs(281, A::add_scaled_inputs3(s.ad_value(288), 1.0, s.ad_value(279), 0.5, s.ad_value(280), 0.5), 138);
        ...
        if s.b[709] {
            ...
            s.store_ad_value(140, A::add_scaled_inputs3(s.ad_value(129), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
            s.store_ad_value(130, A::add_scaled_inputs3(s.ad_value(129), 1.0, s.ad_value(140), p.p297, s.ad_value(129), (-p.p297)));
        }
        ...
        s.store_ad_value(283, A::add_scaled_inputs3(A::scale_offset(s.ad_value(131), (p.p71 / s.v[277]), p.p69), 1.0, s.ad_value(71), p.p70, s.ad_value(593), p.p250));
        ...
        s.store_offset_add_ad(80, A::add_scaled_inputs3(s.ad_value(82), 1.0, s.ad_value(266), 1.0, s.ad_value(84), 1.0), s.ad_value(83), s.v[482]);
        ...
        if (((!s.b[714]) && (!s.b[715])) && s.b[716]) {
            ...
            s.store_offset_mul_ad(267, s.ad_value(281), A::offset(A::mul(s.ad_value(281), A::scale_offset(s.ad_value(281), (1.0 / 27.0), (1.0 / 3.0))), 1.0), 1.0);
        }

        if (((!s.b[714]) && (!s.b[715])) && (!s.b[716])) {
            s.store_offset_mul_ad(284, s.ad_value(281), A::offset(A::mul(s.ad_value(281), A::scale_offset(s.ad_value(281), (4.0 * 0.148148111111111), (3.0 * 0.0402052934513951))), (2.0 * (1.0 / 3.0))), 1.0);
            s.store_offset_mul_ad(267, s.ad_value(281), A::offset(A::mul(s.ad_value(281), A::offset(A::mul(s.ad_value(281), A::scale_offset(s.ad_value(281), 0.148148111111111, 0.0402052934513951)), (1.0 / 3.0))), 1.0), 1.0);
        }
        ...
        if (!s.b[714]) {
            ...
            s.store_offset_ad(267, A::add_scaled_inputs(A::offset(s.ad_value(267), (-1.0)), 0.5, s.ad_value(639), 0.5), (1e-10 * 0.1));
        }
        ...
        if (!s.b[714]) {
            ...
            s.store_sub_from_scalar_ad(267, 1.0, A::add_scaled_inputs(s.ad_value(638), 0.5, s.ad_value(639), 0.5));
        }

        s.store_sub_ad_lhs(53, A::add_scaled_inputs3(s.ad_value(52), 1.0, s.ad_value(138), (-1.0), s.ad_value(80), 1.0), 267);

        s.copy_ad(76, 53);

        s.store_mul_ln_ad_rhs(298, 122, A::div(s.ad_value(471), s.ad_value(462)));

        s.store_ad_value(54, A::add_scaled_inputs3(s.ad_value(138), 1.0, s.ad_value(80), (-1.0), s.ad_value(267), 1.0));
        ...
        if s.b[718] {
            ...
            s.store_ad_value(280, A::add_scaled_product(A::sub(s.ad_value(122), s.ad_value(440)), 1.0, s.ad_value(278), A::add(s.ad_value(122), s.ad_value(440)), 1.0));
            s.store_scaled_square(281, 439, (s.v[295] * s.v[295]));
            s.store_ad_value(282, A::add_scaled_products(s.ad_value(280), s.ad_value(279), 2.0, s.ad_value(281), s.ad_value(120), (-1.0)));
            s.store_ad_value(283, A::add_scaled_inputs3(A::square(s.ad_value(280)), 1.0, A::mul3(s.ad_value(281), s.ad_value(120), s.ad_value(440)), 1.0, s.ad_value(281), 1.0));
        }

        if s.b[718] {
            s.store_ad_value(285, {
                if (((s.v[282] * s.v[282]) - (((4.0 * s.v[279]) * s.v[279]) * s.v[283])) >= 1e-50) {
                    A::sub(A::square(s.ad_value(282)), A::mul3_scaled_output(s.ad_value(279), s.ad_value(279), s.ad_value(283), 4.0))
                } else {
                    A::constant(1e-50)
                }
            });
        ...
        if (!s.b[718]) {
            ...
            s.store_ad_value(284, A::add_scaled_products(s.ad_value(283), s.ad_value(120), 1.0, s.ad_value(281), s.ad_value(282), (-2.0)));
        }

        if (!s.b[718]) {
            s.store_ad_value(285, {
                if (((s.v[284] * s.v[284]) - ((((4.0 * s.v[282]) * s.v[282]) * s.v[281]) * s.v[281])) >= 1e-50) {
                    A::add_scaled_product(A::square(s.ad_value(284)), 1.0, A::mul3_scaled_output(s.ad_value(282), s.ad_value(282), s.ad_value(281), 4.0), s.ad_value(281), (-1.0))
                } else {
                    A::constant(1e-50)
                }
            });
        ...
        s.store_ad_value(280, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(279)), 4.0, s.ad_value(278), 4.0), (-1.0), A::add_scaled_product(s.ad_value(279), 2.0, s.ad_value(278), s.ad_value(120), 1.0), A::add_scaled_product(s.ad_value(279), 2.0, s.ad_value(278), s.ad_value(120), 1.0), 1.0));
        ...
        s.store_ad_value(281, A::add_scaled_product(s.ad_value(279), 2.0, s.ad_value(278), s.ad_value(120), 1.0));

        s.store_scaled_sub(324, 281, 280, 0.5);

        s.store_div_ad(325, A::ln(A::div(A::div_scaled_product(s.ad_value(279), s.ad_value(279), 1.0, s.ad_value(278), 1.0), s.ad_value(143))), A::add(s.ad_value(120), A::div_from_scalar(2.0, s.ad_value(279))));
        ...
        if (!s.b[719]) {
            s.store_sqrt_square_add(639, 638, 639);
            s.store_offset_scaled_div(279, 638, 639, 0.5, 0.5);
            s.store_ad_value(331, A::add_scaled_inputs3(s.ad_value(325), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        }
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        while {
            ...
            if s.b[720] {
                ...
                s.store_mul_scaled_ad_rhs(282, 279, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(281), s.ad_value(280)), (-1.0)), 1.0, s.ad_value(143), A::offset(s.ad_value(278), (-1.0)), 1.0)));
                s.store_mul_ad(283, A::div(s.ad_value(438), s.ad_value(282)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(281)), 1.0, s.ad_value(143), s.ad_value(278), 1.0));
            }
            ...
            s.store_ad_value(284, A::add_scaled_inputs3(s.ad_value(296), -1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
            s.store_mul3_lhs(285, 285, 283, 286);
            s.store_ad_value(334, A::div_scaled_inputs(A::square(s.ad_value(284)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(471), 1.0));
            s.store_ad_value(335, A::div_scaled_product(s.ad_value(334), s.ad_value(285), 2.0, s.ad_value(284), 1.0));
            s.store_sub_ad_rhs(284, 331, A::div(A::add(A::add_scaled_inputs3(s.ad_value(282), 1.0 / (s.v[294]), s.ad_value(331), (-1.0), s.ad_value(440), -1.0), s.ad_value(334)), A::add(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), s.ad_value(335))));
        ...
        while {
            ...
            if ((!s.b[725]) && s.b[726]) {
                ...
                s.store_ad_value(280, A::add_scaled_inputs3(s.ad_value(296), ((-(0.5 * s.v[536])) * s.v[294]), s.ad_value(122), s.v[294], s.ad_value(440), s.v[294]));
                s.store_mul3_affine_lhs(285, 278, 270, 2.0, 0.0, 270);
                s.store_ad_value(282, A::add_scaled_product(A::add(A::offset(A::mul(s.ad_value(279), s.ad_value(270)), s.v[294]), A::mul3_scaled_output(s.ad_value(278), s.ad_value(270), s.ad_value(296), 2.0)), 1.0, s.ad_value(285), s.ad_value(55), 1.0));
                s.store_mul3_affine_lhs(286, 270, 278, ((2.0 * s.v[294]) * 2.0), 0.0, 270);
            }
            if ((!s.b[725]) && s.b[726]) {
                let assign7150_body6_ad_e5439: A = A::add_scaled_product(A::add_scaled_product(A::offset(A::mul3(A::add_scaled_product(A::square(s.ad_value(279)), 1.0, s.ad_value(278), s.ad_value(280), (-4.0)), s.ad_value(270), s.ad_value(270)), (s.v[294] * s.v[294])), 1.0, s.ad_value(270), A::add_scaled_product(s.ad_value(279), 1.0, s.ad_value(278), s.ad_value(296), 2.0), (2.0 * s.v[294])), 1.0, s.ad_value(286), s.ad_value(55), 1.0);
            ...
            if ((!s.b[725]) && s.b[726]) {
                ...
                s.store_scaled_div(370, 346, 347, -1.0);
            }
        ...
        if ((((!s.b[725]) && s.b[730]) && s.b[731]) && (!s.b[732])) {
            s.store_sqrt_square_add(639, 638, 639);
            s.store_offset_scaled_div(279, 638, 639, 0.5, 0.5);
            s.store_ad_value(307, A::add_scaled_inputs3(s.ad_value(325), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        }
        ...
        while {
            ...
            if (((!s.b[725]) && s.b[730]) && s.b[734]) {
                s.store_offset_ad(638, A::sub_scaled_inputs(s.ad_value(296), -1.0, s.ad_value(284), 1.0), (-1e-13));
            ...
            if (((!s.b[725]) && s.b[730]) && s.b[734]) {
                ...
                s.store_ad_value(284, A::add_scaled_inputs3(s.ad_value(296), -1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
                s.store_mul3_lhs(285, 285, 283, 286);
                s.store_ad_value(332, A::div_scaled_inputs(A::square(s.ad_value(284)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(471), 1.0));
                s.store_ad_value(333, A::div_scaled_product(s.ad_value(332), s.ad_value(285), 2.0, s.ad_value(284), 1.0));
                s.store_sub_ad_rhs(284, 307, A::div(A::add(A::add_scaled_inputs3(s.ad_value(282), 1.0 / (s.v[294]), s.ad_value(307), (-1.0), s.ad_value(440), -1.0), s.ad_value(332)), A::add(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), s.ad_value(333))));
            }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        while {
            ...
            if (((!s.b[725]) && s.b[730]) && (!s.b[734])) {
                let assign7580_body27_ad_e7124: A = A::div(A::add_scaled_inputs3(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(305), 1.0, s.ad_value(307), (-1.0), s.ad_value(282), 1.0 / (s.v[294])), 1.0, s.ad_value(282), (p.p227 * 9662367879.197212), s.ad_value(296), (0.5 * (p.p227 * 9662367879.197212))), 1.0, s.ad_value(440), (-1.0), s.ad_value(332), 1.0), A::add_scaled_inputs3(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), 1.0, s.ad_value(283), (p.p227 * 9662367879.197212), s.ad_value(333), 1.0));
        ...
        if (!s.b[725]) {
            s.store_offset_div_ad(290, A::scaled_offset(A::mul(s.ad_value(120), A::sub(s.ad_value(76), s.ad_value(50))), (-1.0), 4.0), A::mul(s.ad_value(145), s.ad_value(121)), 1.0);
        }
        ...
        if ((!s.b[725]) && s.b[743]) {
            s.store_mul_ad_rhs(282, 281, A::add_scaled_product(A::sub(s.ad_value(76), s.ad_value(440)), 1.0, A::add_scaled_inputs(s.ad_value(280), 1.0, s.ad_value(279), 0.5), s.ad_value(283), -1.0));
        }

        if ((!s.b[725]) && (!s.b[743])) {
            s.store_mul_ad_rhs(282, 281, A::add_scaled_product(A::sub(s.ad_value(76), s.ad_value(440)), 1.0, A::add_scaled_inputs(s.ad_value(280), 1.0, s.ad_value(279), 0.5), s.ad_value(296), -1.0));
        }
        ...
        if (((!s.b[725]) && s.b[744]) && s.b[745]) {
            ...
            s.store_ad_value(279, A::div_scaled_product(s.ad_value(645), s.ad_value(646), 0.15, A::offset(s.ad_value(220), 1e-50), 1.0));
        ...
        if (!s.b[725]) {
            s.store_ad_value(345, {
                if (s.v[321] > 0.0) {
                    A::sqrt(A::div_scaled_inputs(s.ad_value(321), ((2.0 * 1.034943e-10) / 1.6021918e-19), s.ad_value(471), 1.0))
                } else {
                    A::constant(0.0)
                }
            });
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        while {
            ...
            if ((!s.b[725]) && s.b[755]) {
                s.store_sub_ad_rhs(284, 307, A::div(A::add_scaled_inputs3(s.ad_value(282), 1.0 / (s.v[294]), s.ad_value(307), (-1.0), s.ad_value(440), -1.0), A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0))));
            }
        ...
        while {
            ...
            if ((!s.b[725]) && (!s.b[755])) {
                let assign8640_body12_ad_e8877: A = A::div(A::sub(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(56), 1.0, s.ad_value(307), (-1.0), s.ad_value(282), 1.0 / (s.v[294])), 1.0, s.ad_value(282), (p.p227 * 9662367879.197212), s.ad_value(296), (0.5 * (p.p227 * 9662367879.197212))), s.ad_value(440)), A::add_scaled_inputs(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), 1.0, s.ad_value(283), (p.p227 * 9662367879.197212)));
        ...
        while {
            ...
            if ((!s.b[725]) && (!s.b[755])) {
                let assign8730_body12_ad_e9220: A = A::div(A::sub(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(56), 1.0, s.ad_value(307), (-1.0), s.ad_value(282), 1.0 / (s.v[294])), 1.0, s.ad_value(282), (p.p227 * 9662367879.197212), s.ad_value(296), (0.5 * (p.p227 * 9662367879.197212))), s.ad_value(440)), A::add_scaled_inputs(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), 1.0, s.ad_value(283), (p.p227 * 9662367879.197212)));
        ...
        if ((!s.b[725]) && s.b[769]) {
            s.store_div_from_scalar_offset_input(646, 1.0, 646, 1e-50);
            s.store_scaled_mul(637, 638, 646, 0.15);
            s.store_ad_value(278, A::div_scaled_product(s.ad_value(645), s.ad_value(646), 0.15, A::offset(s.ad_value(220), 1e-50), 1.0));
        ...
        if s.b[775] {
            ...
            s.store_sub_ad_lhs(388, A::add_scaled_inputs3(s.ad_value(72), 1.0, s.ad_value(389), (-1.0), s.ad_value(80), 1.0), 267);
            ...
            s.store_div_ad_lhs(101, A::div_scaled_product(s.ad_value(127), s.ad_value(127), 1.0, s.ad_value(471), 1.0), 471);
            s.store_div_ad_lhs(102, A::div_scaled_product(s.ad_value(100), s.ad_value(100), 1.0, s.ad_value(270), 1.0), 270);
            s.store_scaled_mul(103, 102, 120, 0.5);
            s.store_scaled_mul(104, 103, 120, 2.0);
            s.store_sqrt_offset_ad(105, A::div(A::scaled_offset(A::mul(s.ad_value(120), s.ad_value(99)), (-1.0), 4.0), s.ad_value(104)), 1.0);
            s.store_ad_value(107, A::add_scaled_product(s.ad_value(99), 1.0, s.ad_value(103), A::sub_from_scalar(1.0, s.ad_value(105)), 1.0));
            ...
            s.store_ad_value(110, A::add_scaled_inputs3(s.ad_value(109), 1.0, s.ad_value(107), (-1.0), s.ad_value(32), -1.0));
            s.store_ad_value(111, A::add_scaled_inputs3(s.ad_value(109), 1.0, s.ad_value(110), (-0.5), A::sqrt(A::add_scaled_product(A::square(s.ad_value(110)), 1.0, s.ad_value(32), s.ad_value(109), 4.0)), (-0.5)));
        }
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if s.b[775] {
            ...
            s.store_ad_value(113, A::add_scaled_product(A::offset(A::mul(s.ad_value(120), s.ad_value(111)), (-1.0)), 1.0, s.ad_value(101), s.ad_value(112), 1.0));
        ...
        if (s.b[775] && s.b[776]) {
            ...
            s.store_scalar(279, 0.0);
            s.store_ad_value(116, A::div_scaled_product(A::mul3(s.ad_value(106), s.ad_value(158), s.ad_value(115)), s.ad_value(279), 1.0, A::sub(s.ad_value(123), s.ad_value(262)), 1.0));
            s.copy_ad(338, 116);
            s.copy_ad(339, 111);
            s.store_offset_div_ad(290, A::scaled_offset(A::mul(s.ad_value(120), s.ad_value(76)), (-1.0), 4.0), A::mul(s.ad_value(145), s.ad_value(121)), 1.0);
        }
        ...
        if (s.b[775] && s.b[776]) {
            ...
            s.store_sqrt_ad(285, A::add_scaled_inputs(A::square(s.ad_value(284)), 1.0, s.ad_value(283), (4.0 * 0.03)));
            s.store_ad_value(60, A::add_scaled_inputs3(s.ad_value(283), 1.0, s.ad_value(284), (-0.5), s.ad_value(285), (-0.5)));
        }
        ...
        if ((s.b[775] && s.b[776]) && (!s.b[799])) {
            ...
            s.store_ad_value(782, A::div_scaled_inputs(A::offset(A::add(A::add_scaled_inputs3(s.ad_value(70), p.p144, s.ad_value(82), 1.0, s.ad_value(266), 1.0), s.ad_value(137)), p.p143), -1.0, s.ad_value(796), 1.0));
            s.store_scalar(514, 0.0);
        }
        ...
        while {
            ...
            if ((s.b[775] && s.b[776]) && (!s.b[799])) {
                ...
                s.store_ad_value(786, A::add_scaled_inputs3(s.ad_value(53), 1.0, s.ad_value(73), 1.0, A::add_scaled_product(s.ad_value(339), 1.0, s.ad_value(392), s.ad_value(785), 1.0), -1.0));
            ...
            if ((s.b[775] && s.b[776]) && (!s.b[799])) {
                ...
                s.store_scaled_div(791, 789, 790, -1.0);
            }
        ...
        if ((s.b[775] && s.b[776]) && (!s.b[805])) {
            ...
            s.store_ad_value(283, A::add_scaled_inputs3(s.ad_value(279), 1.0, s.ad_value(122), (-1.0), s.ad_value(70), (-s.v[486])));
        ...
        if ((s.b[775] && s.b[776]) && (!s.b[805])) {
            ...
            s.store_ad_value(186, A::add_scaled_product(s.ad_value(279), s.v[491], A::div(s.ad_value(472), s.ad_value(285)), A::sub_from_scalar(1.0, A::sqrt(s.ad_value(284))), 1.0));
            s.store_ad_value(187, A::add_scaled_inputs3(s.ad_value(71), p.p123, s.ad_value(339), 1.0, s.ad_value(186), (-(s.v[487] * s.v[485]))));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        while {
            ...
            if s.b[810] {
                ...
                s.store_mul_sqrt_ad_rhs(312, 439, A::add_scaled_product(A::offset(A::add(s.ad_value(278), s.ad_value(297)), (-1.0)), 1.0, s.ad_value(143), A::offset(s.ad_value(280), (-1.0)), 1.0));
                s.store_ad_value(343, A::div_scaled_product(s.ad_value(438), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(278)), 1.0, s.ad_value(143), s.ad_value(280), 1.0), 1.0, s.ad_value(312), 1.0));
            }
            s.b[811] = (s.v[279] > (1e-8 / 10.0));
            s.v[811] = if s.b[811] { 1.0 } else { 0.0 };
            if ((!s.b[810]) && s.b[811]) {
                s.store_exp_mul(280, 120, 307);
                s.store_mul_scaled_ad_rhs(312, 439, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(278), s.ad_value(297)), (-1.0)), 1.0, s.ad_value(143), A::offset(A::sub(s.ad_value(280), s.ad_value(297)), (-1.0)), 1.0)));
                s.store_ad_value(343, A::div_scaled_product(s.ad_value(438), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(278)), 1.0, s.ad_value(143), A::offset(s.ad_value(280), (-1.0)), 1.0), 1.0, s.ad_value(312), 1.0));
            }
            if ((!s.b[810]) && (!s.b[811])) {
                s.store_scaled_mul(312, 439, 297, (-1.0 / (((2.0) as f64).sqrt())));
                s.store_scaled_mul(343, 439, 120, (-1.0 / (((2.0) as f64).sqrt())));
            }
            s.store_add_ad_lhs(306, A::add_scaled_inputs3(s.ad_value(307), 1.0, s.ad_value(312), (-1.0 / (s.v[294])), s.ad_value(50), 1.0), 298);
            ...
            if s.b[813] {
                ...
                s.store_ad_value(524, A::div_scaled_product3(s.ad_value(141), s.ad_value(120), A::sub_from_scalar(1.0, s.ad_value(284)), 1.0, s.ad_value(280), 2.0));
                s.store_neg(525, 524);
            ...
            if ((!s.b[813]) && s.b[814]) {
                ...
                s.store_ad_value(537, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(523), s.ad_value(524), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), A::offset(s.ad_value(278), (-1.0)), 1.0), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(538, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(523), s.ad_value(525), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), s.ad_value(297), (-1.0)), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(311, A::add_scaled_product(s.ad_value(523), (-1.0), s.ad_value(141), s.ad_value(282), -1.0));
                s.store_ad_value(526, A::add_scaled_product(s.ad_value(524), (-1.0), s.ad_value(141), s.ad_value(537), -1.0));
                s.store_ad_value(527, A::add_scaled_product(s.ad_value(525), (-1.0), s.ad_value(141), s.ad_value(538), -1.0));
            }
            if ((!s.b[813]) && (!s.b[814])) {
            ...
            if s.b[816] {
                ...
                s.store_ad_value(532, A::div_scaled_product3(s.ad_value(141), s.ad_value(120), A::sub_from_scalar(1.0, s.ad_value(284)), 1.0, s.ad_value(280), 2.0));
                s.store_neg(533, 532);
            ...
            if ((!s.b[816]) && s.b[817]) {
                ...
                s.store_ad_value(539, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(531), s.ad_value(532), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), A::offset(s.ad_value(278), (-1.0)), 1.0), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(538, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(531), s.ad_value(533), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), s.ad_value(297), (-1.0)), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(528, A::add_scaled_product(s.ad_value(531), (-1.0), s.ad_value(141), s.ad_value(282), -1.0));
                s.store_ad_value(529, A::add_scaled_product(s.ad_value(532), (-1.0), s.ad_value(141), s.ad_value(539), -1.0));
                s.store_ad_value(530, A::add_scaled_product(s.ad_value(533), (-1.0), s.ad_value(141), s.ad_value(538), -1.0));
            }
            if ((!s.b[816]) && (!s.b[817])) {
            ...
            if (!s.b[818]) {
                s.store_ad_value(346, A::add_scaled_inputs3(s.ad_value(305), 1.0, s.ad_value(76), (-1.0), A::div(A::add(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(312), 1.0, s.ad_value(311), 1.0, s.ad_value(523), 1.0), 1.0, s.ad_value(528), 1.0, s.ad_value(531), 1.0), s.ad_value(337)), s.ad_value(270)), -1.0));
                s.store_sub_from_scalar_ad(347, 1.0, A::div(A::add(s.ad_value(526), s.ad_value(524)), s.ad_value(270)));
                s.store_ad_value(348, A::div_scaled_inputs(A::add(A::add_scaled_inputs3(s.ad_value(527), 1.0, s.ad_value(525), 1.0, s.ad_value(530), 1.0), s.ad_value(533)), -1.0, s.ad_value(270), 1.0));
                s.store_ad_value(349, A::div_scaled_inputs(A::add_scaled_product(s.ad_value(343), 1.0, A::add(s.ad_value(529), s.ad_value(532)), s.ad_value(583), 1.0), -1.0, s.ad_value(270), 1.0));
            }
            ...
            if ((!s.b[818]) && s.b[819]) {
                ...
                s.store_ad_value(604, A::div_scaled_product(s.ad_value(296), s.ad_value(343), 1.0, s.ad_value(279), 1.0));
            }
            ...
            if (((!s.b[818]) && (!s.b[819])) && s.b[820]) {
                ...
                s.store_mul_ad_product_lhs(604, A::mul3(s.ad_value(601), A::sub(s.ad_value(312), s.ad_value(603)), A::sub(s.ad_value(312), s.ad_value(603))), A::add(A::sub_scaled_inputs(s.ad_value(312), 3.0, s.ad_value(602), 3.0), A::sub(s.ad_value(312), s.ad_value(603))), 343);
            }
            if (((!s.b[818]) && (!s.b[819])) && (!s.b[820])) {
                s.store_scalar(279, 0.0);
            ...
            if (!s.b[818]) {
                s.store_scaled_div(281, 316, 296, (-s.v[650]));
                ...
                s.store_scaled_div(281, 316, 296, (-s.v[651]));
                s.store_div_from_scalar_offset_ad(280, 1.0, A::exp_scaled_input(s.ad_value(281), -1.0), 1.0);
                s.store_mul_ad(278, A::square(s.ad_value(280)), A::exp_scaled_input(s.ad_value(281), -1.0));
                s.store_mul(280, 280, 600);
                ...
                s.store_ad_value(356, A::add_scaled_product(s.ad_value(605), 1.0 / (s.v[535]), s.ad_value(532), s.ad_value(583), 1.0 / (s.v[535])));
                s.store_add_ad(357, A::add_scaled_inputs3(A::mul3(s.ad_value(347), s.ad_value(352), s.ad_value(356)), 1.0, A::mul3(s.ad_value(347), s.ad_value(353), s.ad_value(355)), (-1.0), A::mul3(s.ad_value(348), s.ad_value(351), s.ad_value(356)), -1.0), A::mul3(s.ad_value(349), s.ad_value(351), s.ad_value(355)));
            }
            s.b[821] = (s.v[357] > 0.0);
            ...
            if (!s.b[818]) {
                s.store_ad_value(359, A::add_scaled_products(s.ad_value(352), s.ad_value(356), 1.0, s.ad_value(353), s.ad_value(355), (-1.0)));
                s.store_ad_value(360, A::add_scaled_products(s.ad_value(349), s.ad_value(355), 1.0, s.ad_value(348), s.ad_value(356), (-1.0)));
                s.store_ad_value(361, A::add_scaled_products(s.ad_value(348), s.ad_value(353), 1.0, s.ad_value(349), s.ad_value(352), (-1.0)));
                s.store_mul_neg_lhs(362, 351, 356);
                s.store_mul(363, 347, 356);
                s.store_ad_value(364, A::add_scaled_products(s.ad_value(349), s.ad_value(351), 1.0, s.ad_value(347), s.ad_value(353), (-1.0)));
                s.store_mul(365, 351, 355);
                s.store_mul_neg_lhs(366, 347, 355);
                s.store_ad_value(367, A::add_scaled_products(s.ad_value(347), s.ad_value(352), 1.0, s.ad_value(348), s.ad_value(351), (-1.0)));
                s.store_mul_scaled_ad_rhs(368, 358, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(359), s.ad_value(346), 1.0, s.ad_value(360), s.ad_value(350), 1.0), 1.0, s.ad_value(361), s.ad_value(354), 1.0));
                s.store_mul_scaled_ad_rhs(369, 358, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(362), s.ad_value(346), 1.0, s.ad_value(363), s.ad_value(350), 1.0), 1.0, s.ad_value(364), s.ad_value(354), 1.0));
                s.store_mul_scaled_ad_rhs(370, 358, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(365), s.ad_value(346), 1.0, s.ad_value(366), s.ad_value(350), 1.0), 1.0, s.ad_value(367), s.ad_value(354), 1.0));
                s.store_abs(279, 368);
            }
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        s.store_ad_value(288, A::add_scaled_product(s.ad_value(76), 1.0, s.ad_value(280), A::sub_from_scalar(1.0, s.ad_value(281)), 1.0));
        ...
        if ((!s.b[837]) && (!s.b[838])) {
            s.store_offset_ad(638, A::sub_scaled_inputs(s.ad_value(61), (1.0 + (0.3 * 0.5)), s.ad_value(51), 1.0), (-0.03));
        ...
        if ((!s.b[837]) && (!s.b[838])) {
            s.store_sqrt_square_add(639, 638, 639);
            s.store_offset_scaled_div(279, 638, 639, 0.5, 0.5);
            s.store_ad_value(60, A::add_scaled_inputs3(s.ad_value(61), (1.0 + (0.3 * 0.5)), s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        }
        ...
        if ((((!s.b[837]) && (!s.b[838])) && s.b[842]) && (!s.b[843])) {
            s.store_sqrt_square_add(639, 638, 639);
            s.store_offset_scaled_div(279, 638, 639, 0.5, 0.5);
            s.store_ad_value(310, A::add_scaled_inputs3(s.ad_value(325), 1.0, s.ad_value(638), (-0.5), s.ad_value(639), (-0.5)));
        }
        ...
        while {
            ...
            if ((((!s.b[837]) && (!s.b[838])) && s.b[845]) && s.b[846]) {
                ...
                s.store_mul_scaled_ad_rhs(282, 439, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(281), s.ad_value(280)), (-1.0)), 1.0, s.ad_value(143), A::offset(s.ad_value(278), (-1.0)), 1.0)));
                s.store_mul_ad(283, A::div(s.ad_value(438), s.ad_value(282)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(281)), 1.0, s.ad_value(143), s.ad_value(278), 1.0));
            }
            ...
            if (((!s.b[837]) && (!s.b[838])) && s.b[845]) {
                ...
                s.store_ad_value(332, A::div_scaled_inputs(A::square(s.ad_value(284)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(471), 1.0));
                s.store_ad_value(333, A::div_scaled_product(s.ad_value(332), s.ad_value(285), 2.0, s.ad_value(284), 1.0));
                s.store_sub_ad_rhs(284, 310, A::div(A::add(A::add_scaled_inputs3(s.ad_value(282), 1.0 / (s.v[294]), s.ad_value(310), (-1.0), s.ad_value(440), -1.0), s.ad_value(332)), A::add(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), s.ad_value(333))));
            }
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        while {
            ...
            if (((!s.b[837]) && (!s.b[838])) && (!s.b[845])) {
                let assign11490_body27_ad_e14835: A = A::div(A::add_scaled_inputs3(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(308), 1.0, s.ad_value(310), (-1.0), s.ad_value(282), 1.0 / (s.v[294])), 1.0, s.ad_value(282), s.v[536], s.ad_value(296), (0.5 * s.v[536])), 1.0, s.ad_value(440), (-1.0), s.ad_value(332), 1.0), A::add_scaled_inputs3(A::scale_offset(s.ad_value(283), 1.0 / (s.v[294]), (-1.0)), 1.0, s.ad_value(283), s.v[536], s.ad_value(333), 1.0));
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        while {
            ...
            if s.b[855] {
                ...
                s.store_mul_sqrt_ad_rhs(314, 439, A::add_scaled_product(A::offset(A::add(s.ad_value(278), s.ad_value(297)), (-1.0)), 1.0, s.ad_value(143), A::offset(s.ad_value(280), (-1.0)), 1.0));
                s.store_ad_value(344, A::div_scaled_product(s.ad_value(438), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(278)), 1.0, s.ad_value(143), s.ad_value(280), 1.0), 1.0, s.ad_value(314), 1.0));
            }
            s.b[856] = (s.v[279] > (1e-8 / 10.0));
            s.v[856] = if s.b[856] { 1.0 } else { 0.0 };
            if ((!s.b[855]) && s.b[856]) {
                s.store_exp_mul(280, 120, 310);
                s.store_mul_scaled_ad_rhs(314, 439, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(278), s.ad_value(297)), (-1.0)), 1.0, s.ad_value(143), A::offset(A::sub(s.ad_value(280), s.ad_value(297)), (-1.0)), 1.0)));
                s.store_ad_value(344, A::div_scaled_product(s.ad_value(438), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(278)), 1.0, s.ad_value(143), A::offset(s.ad_value(280), (-1.0)), 1.0), 1.0, s.ad_value(314), 1.0));
            }
            if ((!s.b[855]) && (!s.b[856])) {
                s.store_scaled_mul(314, 439, 297, (-1.0 / (((2.0) as f64).sqrt())));
                s.store_scaled_mul(344, 439, 120, (-1.0 / (((2.0) as f64).sqrt())));
            }
            s.store_add_ad_lhs(309, A::add_scaled_inputs3(s.ad_value(310), 1.0, s.ad_value(314), (-1.0 / (s.v[294])), s.ad_value(50), 1.0), 298);
            ...
            if s.b[858] {
                ...
                s.store_ad_value(577, A::div_scaled_product3(s.ad_value(141), s.ad_value(120), A::sub_from_scalar(1.0, s.ad_value(284)), 1.0, s.ad_value(280), 2.0));
                s.store_neg(578, 577);
            ...
            if ((!s.b[858]) && s.b[859]) {
                ...
                s.store_ad_value(537, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(576), s.ad_value(577), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), A::offset(s.ad_value(278), (-1.0)), 1.0), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(538, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(576), s.ad_value(578), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), s.ad_value(297), (-1.0)), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(313, A::add_scaled_product(s.ad_value(576), (-1.0), s.ad_value(141), s.ad_value(282), -1.0));
                s.store_ad_value(579, A::add_scaled_product(s.ad_value(577), (-1.0), s.ad_value(141), s.ad_value(537), -1.0));
                s.store_ad_value(580, A::add_scaled_product(s.ad_value(578), (-1.0), s.ad_value(141), s.ad_value(538), -1.0));
            }
            if ((!s.b[858]) && (!s.b[859])) {
            ...
            if s.b[861] {
                ...
                s.store_ad_value(586, A::div_scaled_product3(s.ad_value(141), s.ad_value(120), A::sub_from_scalar(1.0, s.ad_value(284)), 1.0, s.ad_value(280), 2.0));
                s.store_neg(587, 586);
            ...
            if ((!s.b[861]) && s.b[862]) {
                ...
                s.store_ad_value(539, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(585), s.ad_value(586), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), A::offset(s.ad_value(278), (-1.0)), 1.0), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(538, A::div_scaled_inputs(A::add_scaled_product(A::div_scaled_product(s.ad_value(585), s.ad_value(587), 2.0, A::square(s.ad_value(141)), 1.0), 1.0, A::mul3_scaled_output(s.ad_value(120), s.ad_value(142), s.ad_value(281), 2.0), s.ad_value(297), (-1.0)), 1.0, s.ad_value(282), 2.0));
                s.store_ad_value(588, A::add_scaled_product(s.ad_value(585), (-1.0), s.ad_value(141), s.ad_value(282), -1.0));
                s.store_ad_value(589, A::add_scaled_product(s.ad_value(586), (-1.0), s.ad_value(141), s.ad_value(539), -1.0));
                s.store_ad_value(590, A::add_scaled_product(s.ad_value(587), (-1.0), s.ad_value(141), s.ad_value(538), -1.0));
            }
            if ((!s.b[861]) && (!s.b[862])) {
            ...
            if (!s.b[863]) {
                s.store_ad_value(346, A::add_scaled_inputs3(s.ad_value(308), 1.0, s.ad_value(76), (-1.0), A::div(A::add(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(314), 1.0, s.ad_value(313), 1.0, s.ad_value(576), 1.0), 1.0, s.ad_value(588), 1.0, s.ad_value(585), 1.0), s.ad_value(337)), s.ad_value(270)), -1.0));
                s.store_sub_from_scalar_ad(347, 1.0, A::div(A::add(s.ad_value(579), s.ad_value(577)), s.ad_value(270)));
                s.store_ad_value(348, A::div_scaled_inputs(A::add(A::add_scaled_inputs3(s.ad_value(580), 1.0, s.ad_value(578), 1.0, s.ad_value(590), 1.0), s.ad_value(587)), -1.0, s.ad_value(270), 1.0));
                s.store_ad_value(349, A::div_scaled_inputs(A::add_scaled_product(s.ad_value(344), 1.0, A::add(s.ad_value(589), s.ad_value(586)), s.ad_value(582), 1.0), -1.0, s.ad_value(270), 1.0));
            }
            ...
            if ((!s.b[863]) && s.b[864]) {
                ...
                s.store_ad_value(604, A::div_scaled_product(s.ad_value(296), s.ad_value(344), 1.0, s.ad_value(279), 1.0));
            }
            ...
            if (((!s.b[863]) && (!s.b[864])) && s.b[865]) {
                ...
                s.store_mul_ad_product_lhs(604, A::mul3(s.ad_value(601), A::sub(s.ad_value(314), s.ad_value(603)), A::sub(s.ad_value(314), s.ad_value(603))), A::add(A::sub_scaled_inputs(s.ad_value(314), 3.0, s.ad_value(602), 3.0), A::sub(s.ad_value(314), s.ad_value(603))), 344);
            }
            if (((!s.b[863]) && (!s.b[864])) && (!s.b[865])) {
                s.store_scalar(279, 0.0);
                s.store_scalar(604, 0.0);
            ...
            if (!s.b[863]) {
                ...
                s.store_ad_value(356, A::add_scaled_product(s.ad_value(605), 1.0 / (s.v[535]), s.ad_value(586), s.ad_value(582), 1.0 / (s.v[535])));
                s.store_add_ad(357, A::add_scaled_inputs3(A::mul3(s.ad_value(347), s.ad_value(352), s.ad_value(356)), 1.0, A::mul3(s.ad_value(347), s.ad_value(353), s.ad_value(355)), (-1.0), A::mul3(s.ad_value(348), s.ad_value(351), s.ad_value(356)), -1.0), A::mul3(s.ad_value(349), s.ad_value(351), s.ad_value(355)));
            }
            s.b[866] = (s.v[357] > 0.0);
        ...
        s.store_ad_value(153, A::add_scaled_inputs3(s.ad_value(313), 1.0, s.ad_value(311), (-1.0), A::mul3_scaled_output(s.ad_value(120), A::add(s.ad_value(313), s.ad_value(311)), A::sub(s.ad_value(318), s.ad_value(317)), 0.5), -1.0));

        s.store_ad_value(154, A::add_scaled_inputs3(s.ad_value(588), 1.0, s.ad_value(528), (-1.0), A::mul3_scaled_output(s.ad_value(120), A::add(s.ad_value(588), s.ad_value(528)), A::sub(s.ad_value(323), s.ad_value(322)), 0.5), -1.0));
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        if (s.b[883] && (!s.b[884])) {
            ...
            s.store_ad_value(260, A::add_scaled_inputs3(s.ad_value(51), p.p176, s.ad_value(56), p.p176, s.ad_value(57), (1.0 - p.p176)));
        }
        ...
        if (s.b[883] && (!s.b[884])) {
            ...
            s.store_div_ad_lhs(387, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(283), 2.0, A::mul3_scaled_output(s.ad_value(288), s.ad_value(284), s.ad_value(282), 2.0), 1.0), 1.0, s.ad_value(279), s.ad_value(282), 1.0), 123);
            s.store_mul(285, 387, 282);
            s.store_ad_value(387, A::add_scaled_product(s.ad_value(279), 4.0, s.ad_value(288), s.ad_value(284), (2.0 * 4.0)));
        ...
        if (p.p32 != 0.0) {
            ...
            s.store_ad_value(163, A::add_scaled_inputs3(s.ad_value(596), (3.9 * 1.0 / ((11.7 * s.v[507]))), s.ad_value(597), ((-1.0) * (3.9 * 1.0 / ((11.7 * s.v[507])))), s.ad_value(440), (-(3.9 * 1.0 / ((11.7 * s.v[507]))))));
        ...
        if (p.p32 == 0.0) {
            ...
            s.store_ad_value(288, A::add_scaled_product(s.ad_value(503), 1.0, s.ad_value(498), s.ad_value(500), (-1.0)));
        ...
        s.store_ad_value(189, A::div_scaled_inputs(s.ad_value(122), s.v[466], A::sub(s.ad_value(123), s.ad_value(262)), 1.0));
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if s.b[902] {
            ...
            s.store_ad_value(282, A::add_scaled_product(A::scale_offset(s.ad_value(71), p.p241, 1.0), 1.0, s.ad_value(71), A::add_scaled_inputs3(s.ad_value(56), 1.0, s.ad_value(284), 1.0, s.ad_value(70), -1.0), s.v[476]));
        ...
        if s.b[906] {
            s.store_mul_ad_affine_product_rhs(287, 270, s.ad_value(120), A::powf(s.ad_value(280), p.p240), s.v[475], 0.0);
            s.store_ad_value(282, A::add_scaled_product(A::scale_offset(s.ad_value(71), p.p241, 1.0), 1.0, s.ad_value(71), A::add_scaled_inputs3(s.ad_value(322), 1.0, s.ad_value(284), 1.0, s.ad_value(70), -1.0), s.v[476]));
            s.store_mul(287, 287, 282);
        }
        ...
        if (s.b[908] && s.b[909]) {
            s.store_ad_value(638, A::add_scaled_inputs3(s.ad_value(174), 1.0, s.ad_value(173), (-1.0), s.ad_value(173), 0.05));
            s.store_square(642, 638);
        ...
        if (s.b[908] && s.b[909]) {
            ...
            s.store_ad_value(278, A::div_scaled_product3(s.ad_value(173), s.ad_value(645), s.ad_value(646), 0.05, A::offset(s.ad_value(220), 1e-50), 1.0));
            s.store_ad_value(174, A::add_scaled_inputs3(s.ad_value(173), 1.0, s.ad_value(173), (-0.05), s.ad_value(637), 1.0));
        }
        ...
        if s.b[915] {
            ...
            s.store_mul_ad_lhs(283, A::mul3_scaled_output(A::sub_from_scalar(p.p55, s.ad_value(130)), s.ad_value(279), s.ad_value(280), 2.0), 282);
            s.store_mul(81, 283, 135);
            s.store_scalar(282, p.p158);
            s.store_scalar(284, p.p159);
            s.store_ad_value(279, A::add_scaled_product(s.ad_value(282), 1.0, s.ad_value(284), s.ad_value(71), 1.0));
            s.store_mul(98, 81, 279);
            s.store_sub_from_scalar_ad(279, p.p160, A::scale(s.ad_value(51), p.p161));
            s.store_add_ad_lhs(99, A::add_scaled_inputs3(s.ad_value(72), 1.0, s.ad_value(138), (-1.0), s.ad_value(279), 1.0), 98);
            s.store_mul3_lhs(102, 119, 271, 271);
            s.store_scaled_mul(103, 102, 120, 0.5);
            s.store_scaled_mul(104, 103, 120, 2.0);
            s.store_scale(387, 120, 0.25);
            s.store_offset_sub_ad(288, A::offset(A::add(A::add_scaled_product(s.ad_value(122), 1.0, s.ad_value(102), s.ad_value(387), (-1.0)), s.ad_value(138)), (-p.p160)), s.ad_value(98), 1e-50);
            s.store_offset_sub(279, 72, 288, (-0.005));
        }
        ...
        if s.b[915] {
            s.store_sqrt_ad(280, A::add_scaled_product(A::square(s.ad_value(279)), 1.0, s.ad_value(278), s.ad_value(288), (4.0 * 0.005)));
            s.store_ad_value(281, A::add_scaled_inputs3(A::offset(A::sub(A::add_scaled_inputs3(s.ad_value(288), 1.0, s.ad_value(279), 0.5, s.ad_value(280), 0.5), s.ad_value(138)), p.p160), 1.0, s.ad_value(98), 1.0, s.ad_value(70), -1.0));
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        if s.b[915] {
            ...
            s.store_ad_value(111, A::add_scaled_inputs3(s.ad_value(109), 1.0, s.ad_value(110), (-0.5), s.ad_value(278), (-0.5)));
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if s.b[933] {
            ...
            s.store_ad_value(279, A::div_scaled_product(s.ad_value(120), s.ad_value(188), 1.0, s.ad_value(64), 1.0));
            s.store_ad_value(280, A::div_scaled_product(s.ad_value(120), s.ad_value(188), 1.0, s.ad_value(69), 1.0));
        ...
        if ((!s.b[956]) && s.b[957]) {
            ...
            s.store_sub_scaled_ad_lhs(938, A::add_scaled_inputs3(s.ad_value(72), 1.0, s.ad_value(138), (-p.p256), A::div(A::add_scaled_inputs3(s.ad_value(50), (-p.p258), s.ad_value(80), p.p206, s.ad_value(267), (-p.p206)), s.ad_value(951)), 1.0), 948, p.p205);
        ...
        if (((!s.b[956]) && s.b[957]) && (!s.b[960])) {
            ...
            s.store_powf_ad(943, A::div(A::add_scaled_inputs(s.ad_value(954), 1.0, s.ad_value(950), 1e-12), s.ad_value(955)), p.p257);
        ...
        if ((!s.b[956]) && (!s.b[964])) {
            s.store_ad_value(638, A::add_scaled_inputs3(s.ad_value(252), -1.0, s.ad_value(253), 1.0, s.ad_value(938), -1.0));
        ...
        if (!s.b[968]) {
            s.store_sub_ad(279, A::sub(A::scaled_offset(s.ad_value(51), p.p199, p.p198), s.ad_value(52)), A::add_scaled_inputs(s.ad_value(82), p.p200, s.ad_value(266), p.p200));
