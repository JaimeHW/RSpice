...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        let assign6110_ad_e6272: A = A::add_scaled_inputs_product(A::add_scaled_product(A::add_scaled_products(s.ad_value(159), A::sub(s.ad_value(252), s.ad_value(130)), 1.0, s.ad_value(118), A::sub(s.ad_value(130), s.ad_value(250)), 1.0), 1.0, s.ad_value(212), s.ad_value(130), (-1.0)), 1.0, A::div_scaled_product(s.ad_value(265), s.ad_value(265), 1.0, s.ad_value(28), 1.0), 1.0, A::square(s.ad_value(268)), s.ad_value(111), 1.0);
        let assign6110_ad_e6310: A = A::add_scaled_product(A::add_scaled_inputs_product(A::add_scaled_product(A::add_scaled_product(assign6110_ad_e6272, 1.0, A::square(s.ad_value(257)), s.ad_value(112), 1.0), 1.0, A::square(s.ad_value(258)), s.ad_value(113), 1.0), 1.0, A::div_scaled_product(s.ad_value(266), s.ad_value(266), 1.0, s.ad_value(30), 1.0), 1.0, s.ad_value(191), s.ad_value(254), 1.0), 1.0, A::add(A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(161), 1.0, s.ad_value(163), 1.0, s.ad_value(252), s.v[344]), 1.0, s.ad_value(57), (-1.0), s.ad_value(359), 1.0), s.ad_value(358)), s.ad_value(252), 1.0);
