...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (((s.b[2312] && s.b[2321]) && (!s.b[2325])) && (!s.b[2326])) {
            s.store_scaled_softlimit_poly_offset_lhs_ad_rhs(2055, 2054, (-230.25850929940458), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0)), 0.5, 1.0, 1.0, 1e100);
        }
    ...
    pub(super) fn stamp_transient_block_39(
        ...
        if ((((s.b[2665] && (!s.b[2666])) && (!s.b[2690])) && (!s.b[2694])) && s.b[2695]) {
            s.store_div_from_scalar_offset_product(2652, 1.0, 2646, 2651, 1.0);
        }
