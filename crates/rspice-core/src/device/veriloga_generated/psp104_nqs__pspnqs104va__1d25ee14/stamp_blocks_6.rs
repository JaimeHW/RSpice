...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_37(
        ...
        if s.b[3067] {
            ...
            s.store_add_scaled_inputs3(852, s.ad_value(851), -1.0, s.ad_value(850), (-1.0), s.ad_value(853), -1.0);
        }
        ...
        if s.b[3277] {
            s.store_div_scaled_inputs(2028, s.ad_value(1883), 4.0, s.ad_value(724), 1.0);
