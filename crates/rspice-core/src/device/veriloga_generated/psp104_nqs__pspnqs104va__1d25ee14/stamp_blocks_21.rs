...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_81(
        ...
        s.store_scaled_voltage(1969, ctx, nodes, Some(12), None, s.v[3]);s.store_scaled_voltage(1970, ctx, nodes, Some(13), None, s.v[3]);s.store_scaled_voltage(1971, ctx, nodes, Some(14), None, s.v[3]);s.store_scaled_voltage(1972, ctx, nodes, Some(15), None, s.v[3]);s.store_scaled_voltage(1973, ctx, nodes, Some(16), None, s.v[3]);s.store_scaled_voltage(1974, ctx, nodes, Some(17), None, s.v[3]);s.store_scaled_voltage(1975, ctx, nodes, Some(18), None, s.v[3]);s.store_scaled_voltage(1976, ctx, nodes, Some(19), None, s.v[3]);s.store_scaled_voltage(1977, ctx, nodes, Some(20), None, s.v[3]);s.store_scalar(1995, 0.0);s.b[2921] = (s.v[1] != 0.0);s.store_scalar(2921, if s.b[2921] { 1.0 } else { 0.0 });
        ...
        if ((((s.b[2921] && (!s.b[2922])) && (!s.b[2923])) && (!s.b[2924])) && s.b[2925]) {s.store_add_scaled_inputs_mixed_ai(1992, A::add(A::sub_scaled_inputs(A::add_scaled_inputs4(s.ad_value(1978), (-181.0), s.ad_value(1969), (-84.0), s.ad_value(1972), 24.0, s.ad_value(1973), (-6.0)), 1.0, s.ad_value(1971), 90.0), s.ad_value(1979)), 0.015384615384615385, 1970, (336.0 * 0.015384615384615385));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_82(
        s: &mut ReactiveScratch,
    ) {
        if ((((s.b[2921] && (!s.b[2922])) && (!s.b[2923])) && (!s.b[2924])) && s.b[2925]) {s.store_add_scaled_inputs_mixed_ai(1993, A::sub_scaled_inputs(A::add_scaled_inputs(A::add_scaled_inputs4(s.ad_value(1972), 432.0, s.ad_value(1973), (-108.0), s.ad_value(1971), (-1620.0), s.ad_value(1979), 18.0), 1.0, s.ad_value(1978), 3762.0), 1.0, s.ad_value(1969), 8532.0), 0.015384615384615385, 1970, (6048.0 * 0.015384615384615385));}
