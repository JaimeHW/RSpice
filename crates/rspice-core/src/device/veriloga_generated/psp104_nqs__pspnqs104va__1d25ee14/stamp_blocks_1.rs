...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if s.b[2288] {
            ...
            s.store_div_scaled_product_denominator_ad(2195, 2194, 2027, 1.0, A::add(A::sqrt(A::sub(s.ad_value(2029), s.ad_value(2027))), A::sqrt(A::add(s.ad_value(2029), s.ad_value(2027)))), 1.0);
