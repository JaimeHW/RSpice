...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1414])) {
            s.store_mul_ad_lhs(1191, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(1190), 0.29214664, A::square(s.ad_value(1190)), s.v[373]), 1.0, A::square(s.ad_value(1190)), s.ad_value(1190), s.v[374]), 1207);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1414])) && (!s.b[1418])) && s.b[1419]) {
            s.store_exp(1207, 1227);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1414])) && (!s.b[1418])) && (!s.b[1419])) {
            s.store_div_from_scalar_offset_ad(1207, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), s.ad_value(1227)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), s.ad_value(1227)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), s.ad_value(1227)), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1414])) {
            s.store_scaled_div(1230, 1229, 1225, (s.v[435] * (1.772453850905516 * 0.5)));
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && s.b[1420]) {
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) && s.b[1421]) {
            s.store_sqrt_scaled_ad(1207, A::sub_from_scalar(p.p828, s.ad_value(1205)), s.v[429]);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) {
            s.store_ad_value(1232, A::div_scaled_inputs(A::sub_from_scalar(p.p828, s.ad_value(1205)), (s.v[426] * s.v[411]), s.ad_value(1207), 1.0));
        }

        s.b[1422] = (((((-s.v[441]) / s.v[1232])) as f64).abs() < 230.25850929940458);
        s.v[1422] = if s.b[1422] { 1.0 } else { 0.0 };

        if ((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) && s.b[1422]) {
            s.store_exp_ad(1207, A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0));
        }

        s.b[1423] = (((-s.v[441]) / s.v[1232]) < 0.0);
        s.v[1423] = if s.b[1423] { 1.0 } else { 0.0 };

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) && (!s.b[1422])) && s.b[1423]) {
            let assign23570_ad_e26189: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign23570_ad_e26189, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) && (!s.b[1422])) && (!s.b[1423])) {
            let assign23580_ad_e26239: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_scale_ad(1207, assign23580_ad_e26239, 1e100);
        }

        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1420])) {
            s.store_mul_scaled_ad_lhs(1231, A::mul3(s.ad_value(488), s.ad_value(1232), s.ad_value(1232)), 1207, p.p851);
        }

        s.b[1424] = (p.p860 > 1000.0);
        s.v[1424] = if s.b[1424] { 1.0 } else { 0.0 };

        if (((s.b[1171] && s.b[1188]) && (!s.b[1410])) && s.b[1424]) {
            s.store_scalar(1233, 1.0);
        }

        s.b[1425] = (s.v[1206] > ((-s.v[444]) * p.p860));
        s.v[1425] = if s.b[1425] { 1.0 } else { 0.0 };

        s.b[1426] = (p.p863 == 4.0);
        s.v[1426] = if s.b[1426] { 1.0 } else { 0.0 };

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1424])) && s.b[1425]) && s.b[1426]) {
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1410])) && (!s.b[1424])) && s.b[1425]) {
        ...
        if ((s.b[1171] && s.b[1188]) && (!s.b[1410])) {
            s.store_mul_scale_ad_lhs(1234, A::add(A::add_scaled_inputs3(s.ad_value(1208), 1.0, s.ad_value(1209), 1.0, s.ad_value(1216), 1.0), s.ad_value(1231)), p.p29, 1233);
        }

        s.b[1427] = (s.v[647] == 0.0);
        ...
        s.b[1428] = ((p.p841 == 0.0) && (p.p846 == 0.0));
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1428])) {
            ...
            s.store_mul_scaled_ad_lhs(1215, A::offset(s.ad_value(1201), (-1.0)), 1214, s.v[385]);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1431])) {
            s.store_scaled_div(1217, 1214, 1210, (s.v[409] * s.v[439]));
            s.store_div_from_scalar(1218, (0.666666666666667 * s.v[436]), 1217);
            s.store_square(1219, 1218);
            s.store_sqrt_ad(1220, A::div_scaled_product(s.ad_value(1219), s.ad_value(1219), 1.0, A::offset(A::square(s.ad_value(1219)), 1.0), 1.0));
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1431])) {
            s.store_ad_value(1224, A::div_scaled_product(s.ad_value(1213), s.ad_value(1223), 1.0, A::add(s.ad_value(1213), s.ad_value(1223)), 1.0));
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(s.ad_value(1220), (-s.v[436]), s.ad_value(1218), s.ad_value(1221), s.v[436]), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1431])) && (!s.b[1434])) {
            s.store_div_from_scalar_offset_ad(1207, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), A::sub(s.ad_value(1227), s.ad_value(1189))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::sub(s.ad_value(1227), s.ad_value(1189))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::sub(s.ad_value(1227), s.ad_value(1189))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1431])) {
            s.store_scaled_div(1230, 1229, 1225, (s.v[436] * (1.772453850905516 * 0.5)));
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1437])) && s.b[1438]) {
            s.store_sqrt_scaled_ad(1207, A::sub_from_scalar(p.p829, s.ad_value(1205)), s.v[430]);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1437])) {
            s.store_ad_value(1232, A::div_scaled_inputs(A::sub_from_scalar(p.p829, s.ad_value(1205)), (s.v[427] * s.v[412]), s.ad_value(1207), 1.0));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1437])) && (!s.b[1439])) && s.b[1440]) {
            let assign24270_ad_e27332: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign24270_ad_e27332, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1427])) && (!s.b[1437])) && (!s.b[1439])) && (!s.b[1440])) {
            let assign24280_ad_e27382: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if ((s.b[1171] && s.b[1188]) && (!s.b[1427])) {
            s.store_mul_scale_ad_lhs(1235, A::add(A::add_scaled_inputs3(s.ad_value(1208), 1.0, s.ad_value(1209), 1.0, s.ad_value(1216), 1.0), s.ad_value(1231)), p.p29, 1233);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1445])) {
            ...
            s.store_mul_scaled_ad_lhs(1215, A::offset(s.ad_value(1201), (-1.0)), 1214, s.v[386]);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1448])) {
            s.store_scaled_div(1217, 1214, 1210, (s.v[410] * s.v[440]));
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1448])) {
            ...
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(s.ad_value(1220), (-s.v[437]), s.ad_value(1218), s.ad_value(1221), s.v[437]), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
            s.store_mul_offset_lhs(1228, 1226, (-1.0), 1225);
            s.store_square(1189, 1228);
        }
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1448])) {
            s.store_scaled_div(1230, 1229, 1225, (s.v[437] * (1.772453850905516 * 0.5)));
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1454])) && s.b[1455]) {
            s.store_sqrt_scaled_ad(1207, A::sub_from_scalar(p.p830, s.ad_value(1205)), s.v[431]);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1454])) {
            s.store_ad_value(1232, A::div_scaled_inputs(A::sub_from_scalar(p.p830, s.ad_value(1205)), (s.v[428] * s.v[413]), s.ad_value(1207), 1.0));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1454])) && (!s.b[1456])) && s.b[1457]) {
            let assign24970_ad_e28475: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign24970_ad_e28475, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1444])) && (!s.b[1454])) && (!s.b[1456])) && (!s.b[1457])) {
            let assign24980_ad_e28525: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if ((s.b[1171] && s.b[1188]) && (!s.b[1444])) {
            s.store_mul_scale_ad_lhs(1236, A::add(A::add_scaled_inputs3(s.ad_value(1208), 1.0, s.ad_value(1209), 1.0, s.ad_value(1216), 1.0), s.ad_value(1231)), p.p29, 1233);
        }

        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(478, A::add_scaled_product(A::add_scaled_products(s.ad_value(646), s.ad_value(1234), 1.0, s.ad_value(647), s.ad_value(1235), 1.0), 1.0, s.ad_value(648), s.ad_value(1236), 1.0));
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1461]) && s.b[1462]) && (!s.b[1463])) && s.b[1464]) {
            let assign25240_ad_e28897: A = A::div_from_scalar(1e-100, A::offset(A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(489), (s.v[371] * (-0.5)))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(489), (s.v[371] * (-0.5)))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(489), (s.v[371] * (-0.5)))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0));
            s.store_ad_value(1200, assign25240_ad_e28897);
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1461]) && s.b[1462]) && (!s.b[1463])) && (!s.b[1464])) {
            s.store_scaled_offset_ad(1200, A::mul(A::scale_offset(s.ad_value(489), (s.v[371] * (-0.5)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(489), (s.v[371] * (-0.5)), (-230.25850929940458)), A::scale_offset(s.ad_value(489), (((s.v[371] * (-0.5))) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && s.b[1461]) && s.b[1465]) {
            s.store_scaled_ln_ad(1202, A::add(A::offset(s.ad_value(1200), 2.0), A::sqrt(A::mul(A::offset(s.ad_value(1200), 1.0), A::offset(s.ad_value(1200), 3.0)))), (s.v[370] * 2.0));
        }

        if (((s.b[1171] && s.b[1188]) && s.b[1461]) && (!s.b[1465])) {
            s.store_sub_ad_lhs(1202, A::scale(A::ln(A::add(A::scale_offset(s.ad_value(1201), 2.0, 1.0), A::sqrt(A::mul(A::offset(s.ad_value(1201), 1.0), A::scale_offset(s.ad_value(1201), 3.0, 1.0))))), (s.v[370] * 2.0)), 489);
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1461]) {
            s.store_sub(1203, 656, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(489), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(489), s.ad_value(1203)), A::sub(s.ad_value(489), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(489), 0.5, s.ad_value(659), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(489), s.ad_value(659)), A::sub(s.ad_value(489), s.ad_value(659))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
            s.store_scaled_sub_ad_rhs(1206, 489, A::sqrt(A::offset(A::mul(s.ad_value(489), s.ad_value(489)), ((4.0 * 1e-6) * 1e-6))), 0.5);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1466])) && (!s.b[1467])) {
            ...
            s.store_mul_scaled_ad_lhs(1215, A::offset(s.ad_value(1201), (-1.0)), 1214, s.v[384]);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1466])) && (!s.b[1470])) {
            s.store_scaled_div(1217, 1214, 1210, (s.v[408] * s.v[438]));
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1466])) && (!s.b[1470])) {
            ...
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(s.ad_value(1220), (-s.v[435]), s.ad_value(1218), s.ad_value(1221), s.v[435]), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
            s.store_mul_offset_lhs(1228, 1226, (-1.0), 1225);
            s.store_square(1189, 1228);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1466])) && (!s.b[1476])) && (!s.b[1478])) && s.b[1479]) {
            let assign25970_ad_e30119: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign25970_ad_e30119, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1466])) && (!s.b[1476])) && (!s.b[1478])) && (!s.b[1479])) {
            let assign25980_ad_e30169: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(441), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1483])) && (!s.b[1493])) && (!s.b[1495])) && s.b[1496]) {
            let assign26670_ad_e31262: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign26670_ad_e31262, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1483])) && (!s.b[1493])) && (!s.b[1495])) && (!s.b[1496])) {
            let assign26680_ad_e31312: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(442), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1500])) && (!s.b[1510])) && (!s.b[1512])) && s.b[1513]) {
            let assign27370_ad_e32405: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign27370_ad_e32405, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1500])) && (!s.b[1510])) && (!s.b[1512])) && (!s.b[1513])) {
            let assign27380_ad_e32455: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(443), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(479, A::add_scaled_product(A::add_scaled_products(s.ad_value(646), s.ad_value(1234), 1.0, s.ad_value(647), s.ad_value(1235), 1.0), 1.0, s.ad_value(648), s.ad_value(1236), 1.0));
            s.store_ad_value(667, A::add_scaled_inputs3(s.ad_value(646), s.v[387], s.ad_value(647), s.v[388], s.ad_value(648), s.v[389]));
        }
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(483, A::add_scaled_product(s.ad_value(478), 1.0, s.ad_value(667), A::offset(A::exp_scaled_input(s.ad_value(488), (s.v[371] * s.v[668])), (-1.0)), (-1.0)));
            s.store_ad_value(484, A::add_scaled_product(s.ad_value(479), 1.0, s.ad_value(667), A::offset(A::exp_scaled_input(s.ad_value(489), (s.v[371] * s.v[668])), (-1.0)), (-1.0)));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && s.b[1517]) && s.b[1518]) && s.b[1519]) {
            ...
            s.store_ad_value(670, A::div_scaled_inputs(A::ln(s.ad_value(490)), s.v[370], A::sub(s.ad_value(488), s.ad_value(489)), 1.0));
            s.store_div_ad_rhs(669, 483, A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(488), s.v[371], s.ad_value(670))), (-1.0)));
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1517]) {
            s.store_ad_value(480, A::add_scaled_product(A::add_scaled_product(s.ad_value(475), 1.0, s.ad_value(667), A::offset(A::exp_scaled_input(s.ad_value(485), (s.v[371] * s.v[668])), (-1.0)), (-1.0)), 1.0, s.ad_value(669), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(485), s.v[371], s.ad_value(670))), (-1.0)), (-1.0)));
            s.store_ad_value(481, A::add_scaled_product(A::add_scaled_product(s.ad_value(476), 1.0, s.ad_value(667), A::offset(A::exp_scaled_input(s.ad_value(486), (s.v[371] * s.v[668])), (-1.0)), (-1.0)), 1.0, s.ad_value(669), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(486), s.v[371], s.ad_value(670))), (-1.0)), (-1.0)));
            s.store_ad_value(482, A::add_scaled_product(A::add_scaled_product(s.ad_value(477), 1.0, s.ad_value(667), A::offset(A::exp_scaled_input(s.ad_value(487), (s.v[371] * s.v[668])), (-1.0)), (-1.0)), 1.0, s.ad_value(669), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(487), s.v[371], s.ad_value(670))), (-1.0)), (-1.0)));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && s.b[1517]) && s.b[1520]) && s.b[1521]) {
            ...
            s.store_ad_value(491, A::div_scaled_inputs(A::ln(s.ad_value(490)), (-s.v[370]), A::sub(s.ad_value(485), s.ad_value(486)), 1.0));
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1517]) && s.b[1520]) && s.b[1521]) && s.b[1522]) {
            ...
            s.store_mul_ad_rhs(671, 482, A::add_scaled_inputs(A::div_from_scalar(1.0, s.ad_value(487)), 1.0, s.ad_value(672), (0.5 * s.v[371])));
            s.store_ad_value(672, A::div_scaled_product(s.ad_value(482), s.ad_value(672), ((-0.5) * s.v[371]), s.ad_value(487), 1.0));
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1517]) && s.b[1520]) && s.b[1521]) && (!s.b[1522])) {
            s.store_scalar(666, 0.0);
            s.store_ad_value(671, A::div_scaled_inputs(s.ad_value(482), -1.0, A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(487), (-s.v[371]), s.ad_value(672))), (-1.0)), 1.0));
        }

        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(501, A::add_scaled_inputs3(s.ad_value(646), (s.v[414] * p.p929), s.ad_value(647), (s.v[415] * p.p929), s.ad_value(648), (s.v[416] * p.p929)));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1527]) && s.b[1528]) && (!s.b[1529])) && s.b[1530]) {
            let assign28170_ad_e33570: A = A::div_from_scalar(1e-100, A::offset(A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(485), (s.v[371] * (-0.5)))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(485), (s.v[371] * (-0.5)))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(485), (s.v[371] * (-0.5)))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0));
            s.store_ad_value(1200, assign28170_ad_e33570);
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1527]) && s.b[1528]) && (!s.b[1529])) && (!s.b[1530])) {
            s.store_scaled_offset_ad(1200, A::mul(A::scale_offset(s.ad_value(485), (s.v[371] * (-0.5)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(485), (s.v[371] * (-0.5)), (-230.25850929940458)), A::scale_offset(s.ad_value(485), (((s.v[371] * (-0.5))) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && s.b[1527]) && (!s.b[1531])) {
            s.store_sub_ad_lhs(1202, A::scale(A::ln(A::add(A::scale_offset(s.ad_value(1201), 2.0, 1.0), A::sqrt(A::mul(A::offset(s.ad_value(1201), 1.0), A::scale_offset(s.ad_value(1201), 3.0, 1.0))))), (s.v[370] * 2.0)), 485);
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1527]) {
            s.store_sub(1203, 683, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(485), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(485), s.ad_value(1203)), A::sub(s.ad_value(485), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(485), 0.5, s.ad_value(686), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(485), s.ad_value(686)), A::sub(s.ad_value(485), s.ad_value(686))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1533])) && (!s.b[1534])) {
            s.store_mul_ad(1212, A::add(A::div_scaled_product(A::square(s.ad_value(1211)), A::ln(s.ad_value(1211)), 1.0, A::sub_from_scalar(1.0, s.ad_value(1211)), 1.0), s.ad_value(1211)), A::sub_from_scalar(1.0, A::scale(s.ad_value(511), 2.0)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1536])) {
            s.store_mul_ad_rhs(1217, 605, A::div_scaled_product(s.ad_value(1214), s.ad_value(575), 1.0, s.ad_value(1210), 1.0));
            s.store_scaled_div(1218, 602, 1217, 0.666666666666667);
            s.store_square(1219, 1218);
            s.store_sqrt_ad(1220, A::div_scaled_product(s.ad_value(1219), s.ad_value(1219), 1.0, A::offset(A::square(s.ad_value(1219)), 1.0), 1.0));
            s.store_sqrt(1221, 1220);
            s.store_mul(1222, 1220, 1221);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1536])) {
            ...
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(A::mul3(s.ad_value(602), s.ad_value(1218), s.ad_value(1221)), 1.0, s.ad_value(602), s.ad_value(1220), (-1.0)), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
            s.store_mul_offset_lhs(1228, 1226, (-1.0), 1225);
            s.store_square(1189, 1228);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1536])) {
            s.store_ad_value(1230, A::div_scaled_product(s.ad_value(602), s.ad_value(1229), (1.772453850905516 * 0.5), s.ad_value(1225), 1.0));
            s.store_mul_ad_rhs(1216, 525, A::mul3(s.ad_value(1215), s.ad_value(1230), s.ad_value(1224)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1542])) {
            s.store_mul_ad_rhs(1232, 578, A::div_scaled_product(A::sub(s.ad_value(508), s.ad_value(1205)), s.ad_value(593), 1.0, s.ad_value(1207), 1.0));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1542])) && s.b[1544]) {
            s.store_exp_ad(1207, A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1542])) && (!s.b[1544])) && s.b[1545]) {
            let assign28900_ad_e34792: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign28900_ad_e34792, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1542])) && (!s.b[1544])) && (!s.b[1545])) {
            let assign28910_ad_e34842: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1532])) && (!s.b[1546])) && (!s.b[1547])) {
            s.store_ad_value(1233, A::add_scaled_product(s.ad_value(611), 1.0, A::add_scaled_inputs(s.ad_value(1206), 1.0, s.ad_value(540), s.v[444]), s.ad_value(617), 1.0));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1550])) && (!s.b[1551])) {
            s.store_mul_ad(1212, A::add(A::div_scaled_product(A::square(s.ad_value(1211)), A::ln(s.ad_value(1211)), 1.0, A::sub_from_scalar(1.0, s.ad_value(1211)), 1.0), s.ad_value(1211)), A::sub_from_scalar(1.0, A::scale(s.ad_value(512), 2.0)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1553])) {
            s.store_mul_ad_rhs(1217, 606, A::div_scaled_product(s.ad_value(1214), s.ad_value(576), 1.0, s.ad_value(1210), 1.0));
            s.store_scaled_div(1218, 603, 1217, 0.666666666666667);
            s.store_square(1219, 1218);
            s.store_sqrt_ad(1220, A::div_scaled_product(s.ad_value(1219), s.ad_value(1219), 1.0, A::offset(A::square(s.ad_value(1219)), 1.0), 1.0));
            s.store_sqrt(1221, 1220);
            s.store_mul(1222, 1220, 1221);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1553])) {
            ...
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(A::mul3(s.ad_value(603), s.ad_value(1218), s.ad_value(1221)), 1.0, s.ad_value(603), s.ad_value(1220), (-1.0)), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
            s.store_mul_offset_lhs(1228, 1226, (-1.0), 1225);
            s.store_square(1189, 1228);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1553])) {
            s.store_ad_value(1230, A::div_scaled_product(s.ad_value(603), s.ad_value(1229), (1.772453850905516 * 0.5), s.ad_value(1225), 1.0));
            s.store_mul_ad_rhs(1216, 526, A::mul3(s.ad_value(1215), s.ad_value(1230), s.ad_value(1224)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1559])) {
            s.store_mul_ad_rhs(1232, 579, A::div_scaled_product(A::sub(s.ad_value(509), s.ad_value(1205)), s.ad_value(594), 1.0, s.ad_value(1207), 1.0));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1559])) && s.b[1561]) {
            s.store_exp_ad(1207, A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1559])) && (!s.b[1561])) && s.b[1562]) {
            let assign29600_ad_e35935: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign29600_ad_e35935, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1559])) && (!s.b[1561])) && (!s.b[1562])) {
            let assign29610_ad_e35985: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1549])) && (!s.b[1563])) && (!s.b[1564])) {
            s.store_ad_value(1233, A::add_scaled_product(s.ad_value(612), 1.0, A::add_scaled_inputs(s.ad_value(1206), 1.0, s.ad_value(541), s.v[444]), s.ad_value(618), 1.0));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1567])) && (!s.b[1568])) {
            s.store_mul_ad(1212, A::add(A::div_scaled_product(A::square(s.ad_value(1211)), A::ln(s.ad_value(1211)), 1.0, A::sub_from_scalar(1.0, s.ad_value(1211)), 1.0), s.ad_value(1211)), A::sub_from_scalar(1.0, A::scale(s.ad_value(513), 2.0)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1570])) {
            s.store_mul_ad_rhs(1217, 607, A::div_scaled_product(s.ad_value(1214), s.ad_value(577), 1.0, s.ad_value(1210), 1.0));
            s.store_scaled_div(1218, 604, 1217, 0.666666666666667);
            s.store_square(1219, 1218);
            s.store_sqrt_ad(1220, A::div_scaled_product(s.ad_value(1219), s.ad_value(1219), 1.0, A::offset(A::square(s.ad_value(1219)), 1.0), 1.0));
            s.store_sqrt(1221, 1220);
            s.store_mul(1222, 1220, 1221);
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1570])) {
            ...
            s.store_sqrt_scaled_ad(1225, A::div(s.ad_value(1217), s.ad_value(1221)), 0.375);
            s.store_ad_value(1226, A::add_scaled_product(s.ad_value(1220), (-1.0), s.ad_value(1218), s.ad_value(1221), 2.0));
            s.store_ad_value(1227, A::add_scaled_product(A::add_scaled_product(A::mul3(s.ad_value(604), s.ad_value(1218), s.ad_value(1221)), 1.0, s.ad_value(604), s.ad_value(1220), (-1.0)), 1.0, s.ad_value(1217), s.ad_value(1222), 0.5));
            s.store_mul_offset_lhs(1228, 1226, (-1.0), 1225);
            s.store_square(1189, 1228);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1570])) {
            s.store_ad_value(1230, A::div_scaled_product(s.ad_value(604), s.ad_value(1229), (1.772453850905516 * 0.5), s.ad_value(1225), 1.0));
            s.store_mul_ad_rhs(1216, 527, A::mul3(s.ad_value(1215), s.ad_value(1230), s.ad_value(1224)));
        }
        ...
        if (((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1576])) {
            s.store_mul_ad_rhs(1232, 580, A::div_scaled_product(A::sub(s.ad_value(510), s.ad_value(1205)), s.ad_value(595), 1.0, s.ad_value(1207), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1576])) && s.b[1578]) {
            s.store_exp_ad(1207, A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1576])) && (!s.b[1578])) && s.b[1579]) {
            let assign30300_ad_e37078: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign30300_ad_e37078, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1576])) && (!s.b[1578])) && (!s.b[1579])) {
            let assign30310_ad_e37128: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if ((((s.b[1171] && s.b[1188]) && (!s.b[1566])) && (!s.b[1580])) && (!s.b[1581])) {
            s.store_ad_value(1233, A::add_scaled_product(s.ad_value(613), 1.0, A::add_scaled_inputs(s.ad_value(1206), 1.0, s.ad_value(542), s.v[444]), s.ad_value(619), 1.0));
        }
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(475, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(1234), 1.0, s.ad_value(674), s.ad_value(1235), 1.0), 1.0, s.ad_value(675), s.ad_value(1236), 1.0));
            s.store_scalar(1205, 0.0);
            s.store_scalar(1202, 0.0);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1583]) && s.b[1584]) && (!s.b[1585])) && s.b[1586]) {
            let assign30570_ad_e37500: A = A::div_from_scalar(1e-100, A::offset(A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(486), (s.v[371] * (-0.5)))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(486), (s.v[371] * (-0.5)))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(486), (s.v[371] * (-0.5)))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0));
            s.store_ad_value(1200, assign30570_ad_e37500);
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1583]) && s.b[1584]) && (!s.b[1585])) && (!s.b[1586])) {
            s.store_scaled_offset_ad(1200, A::mul(A::scale_offset(s.ad_value(486), (s.v[371] * (-0.5)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(486), (s.v[371] * (-0.5)), (-230.25850929940458)), A::scale_offset(s.ad_value(486), (((s.v[371] * (-0.5))) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && s.b[1583]) && (!s.b[1587])) {
            s.store_sub_ad_lhs(1202, A::scale(A::ln(A::add(A::scale_offset(s.ad_value(1201), 2.0, 1.0), A::sqrt(A::mul(A::offset(s.ad_value(1201), 1.0), A::scale_offset(s.ad_value(1201), 3.0, 1.0))))), (s.v[370] * 2.0)), 486);
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1583]) {
            s.store_sub(1203, 683, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(486), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(486), s.ad_value(1203)), A::sub(s.ad_value(486), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(486), 0.5, s.ad_value(686), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(486), s.ad_value(686)), A::sub(s.ad_value(486), s.ad_value(686))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1588])) && (!s.b[1598])) && (!s.b[1600])) && s.b[1601]) {
            let assign31300_ad_e38722: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign31300_ad_e38722, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1588])) && (!s.b[1598])) && (!s.b[1600])) && (!s.b[1601])) {
            let assign31310_ad_e38772: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_22(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1605])) && (!s.b[1615])) && (!s.b[1617])) && s.b[1618]) {
            let assign32000_ad_e39865: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign32000_ad_e39865, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1605])) && (!s.b[1615])) && (!s.b[1617])) && (!s.b[1618])) {
            let assign32010_ad_e39915: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1622])) && (!s.b[1632])) && (!s.b[1634])) && s.b[1635]) {
            let assign32700_ad_e41008: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign32700_ad_e41008, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1622])) && (!s.b[1632])) && (!s.b[1634])) && (!s.b[1635])) {
            let assign32710_ad_e41058: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(476, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(1234), 1.0, s.ad_value(674), s.ad_value(1235), 1.0), 1.0, s.ad_value(675), s.ad_value(1236), 1.0));
            s.store_scalar(1205, 0.0);
            s.store_scalar(1202, 0.0);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1639]) && s.b[1640]) && (!s.b[1641])) && s.b[1642]) {
            let assign32970_ad_e41430: A = A::div_from_scalar(1e-100, A::offset(A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(487), (s.v[371] * (-0.5)))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(487), (s.v[371] * (-0.5)))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(487), (s.v[371] * (-0.5)))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0));
            s.store_ad_value(1200, assign32970_ad_e41430);
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1639]) && s.b[1640]) && (!s.b[1641])) && (!s.b[1642])) {
            s.store_scaled_offset_ad(1200, A::mul(A::scale_offset(s.ad_value(487), (s.v[371] * (-0.5)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(487), (s.v[371] * (-0.5)), (-230.25850929940458)), A::scale_offset(s.ad_value(487), (((s.v[371] * (-0.5))) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && s.b[1639]) && (!s.b[1643])) {
            s.store_sub_ad_lhs(1202, A::scale(A::ln(A::add(A::scale_offset(s.ad_value(1201), 2.0, 1.0), A::sqrt(A::mul(A::offset(s.ad_value(1201), 1.0), A::scale_offset(s.ad_value(1201), 3.0, 1.0))))), (s.v[370] * 2.0)), 487);
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1639]) {
            s.store_sub(1203, 683, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(487), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(487), s.ad_value(1203)), A::sub(s.ad_value(487), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(487), 0.5, s.ad_value(686), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(487), s.ad_value(686)), A::sub(s.ad_value(487), s.ad_value(686))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
        }
    ...
    pub(super) fn stamp_transient_block_23(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1644])) && (!s.b[1654])) && (!s.b[1656])) && s.b[1657]) {
            let assign33700_ad_e42652: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign33700_ad_e42652, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1644])) && (!s.b[1654])) && (!s.b[1656])) && (!s.b[1657])) {
            let assign33710_ad_e42702: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1661])) && (!s.b[1671])) && (!s.b[1673])) && s.b[1674]) {
            let assign34400_ad_e43795: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign34400_ad_e43795, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1661])) && (!s.b[1671])) && (!s.b[1673])) && (!s.b[1674])) {
            let assign34410_ad_e43845: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1678])) && (!s.b[1688])) && (!s.b[1690])) && s.b[1691]) {
            let assign35100_ad_e44938: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign35100_ad_e44938, 1.0);
        }
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(477, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(1234), 1.0, s.ad_value(674), s.ad_value(1235), 1.0), 1.0, s.ad_value(675), s.ad_value(1236), 1.0));
            s.store_scalar(1205, 0.0);
            s.store_scalar(1202, 0.0);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1695]) && s.b[1696]) && (!s.b[1697])) && s.b[1698]) {
            let assign35370_ad_e45360: A = A::div_from_scalar(1e-100, A::offset(A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(488), (s.v[371] * (-0.5)))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(488), (s.v[371] * (-0.5)))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(488), (s.v[371] * (-0.5)))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0));
            s.store_ad_value(1200, assign35370_ad_e45360);
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1695]) && s.b[1696]) && (!s.b[1697])) && (!s.b[1698])) {
            s.store_scaled_offset_ad(1200, A::mul(A::scale_offset(s.ad_value(488), (s.v[371] * (-0.5)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(488), (s.v[371] * (-0.5)), (-230.25850929940458)), A::scale_offset(s.ad_value(488), (((s.v[371] * (-0.5))) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[1171] && s.b[1188]) && s.b[1695]) && (!s.b[1699])) {
            s.store_sub_ad_lhs(1202, A::scale(A::ln(A::add(A::scale_offset(s.ad_value(1201), 2.0, 1.0), A::sqrt(A::mul(A::offset(s.ad_value(1201), 1.0), A::scale_offset(s.ad_value(1201), 3.0, 1.0))))), (s.v[370] * 2.0)), 488);
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1695]) {
            s.store_sub(1203, 683, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(488), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(488), s.ad_value(1203)), A::sub(s.ad_value(488), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(488), 0.5, s.ad_value(686), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(488), s.ad_value(686)), A::sub(s.ad_value(488), s.ad_value(686))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
    ...
    pub(super) fn stamp_transient_block_25(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1700])) && (!s.b[1710])) && (!s.b[1712])) && s.b[1713]) {
            let assign36100_ad_e46582: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign36100_ad_e46582, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1700])) && (!s.b[1710])) && (!s.b[1712])) && (!s.b[1713])) {
            let assign36110_ad_e46632: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1717])) && (!s.b[1727])) && (!s.b[1729])) && s.b[1730]) {
            let assign36800_ad_e47725: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign36800_ad_e47725, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1717])) && (!s.b[1727])) && (!s.b[1729])) && (!s.b[1730])) {
            let assign36810_ad_e47775: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_26(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1734])) && (!s.b[1744])) && (!s.b[1746])) && s.b[1747]) {
            let assign37500_ad_e48868: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign37500_ad_e48868, 1.0);
        }
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(478, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(1234), 1.0, s.ad_value(674), s.ad_value(1235), 1.0), 1.0, s.ad_value(675), s.ad_value(1236), 1.0));
            s.store_scalar(1205, 0.0);
            s.store_scalar(1202, 0.0);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1751]) && s.b[1752]) && (!s.b[1753])) && s.b[1754]) {
            ...
            s.store_ad_value(1200, assign37770_ad_e49290);
        }
        ...
        if ((s.b[1171] && s.b[1188]) && s.b[1751]) {
            s.store_sub(1203, 683, 1202);
            s.store_ad_value(1204, A::add_scaled_inputs3(s.ad_value(489), 0.5, s.ad_value(1203), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(489), s.ad_value(1203)), A::sub(s.ad_value(489), s.ad_value(1203))), ((4.0 * s.v[370]) * s.v[370]))), (-0.5)));
            s.store_ad_value(1205, A::add_scaled_inputs3(s.ad_value(489), 0.5, s.ad_value(686), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(489), s.ad_value(686)), A::sub(s.ad_value(489), s.ad_value(686))), ((4.0 * s.v[368]) * s.v[368]))), (-0.5)));
            s.store_scaled_sub_ad_rhs(1206, 489, A::sqrt(A::offset(A::mul(s.ad_value(489), s.ad_value(489)), ((4.0 * 1e-6) * 1e-6))), 0.5);
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1756])) && (!s.b[1766])) && (!s.b[1768])) && s.b[1769]) {
            let assign38500_ad_e50512: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign38500_ad_e50512, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1756])) && (!s.b[1766])) && (!s.b[1768])) && (!s.b[1769])) {
            let assign38510_ad_e50562: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(608), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_27(
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1773])) && (!s.b[1783])) && (!s.b[1785])) && s.b[1786]) {
            let assign39200_ad_e51655: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign39200_ad_e51655, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1773])) && (!s.b[1783])) && (!s.b[1785])) && (!s.b[1786])) {
            let assign39210_ad_e51705: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(609), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1171] && s.b[1188]) && (!s.b[1790])) && (!s.b[1800])) && (!s.b[1802])) && s.b[1803]) {
            let assign39900_ad_e52798: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1207, 1e-100, assign39900_ad_e52798, 1.0);
        }

        if (((((s.b[1171] && s.b[1188]) && (!s.b[1790])) && (!s.b[1800])) && (!s.b[1802])) && (!s.b[1803])) {
            let assign39910_ad_e52848: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(610), -1.0, s.ad_value(1232), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_28(
        ...
        if (s.b[1171] && s.b[1188]) {
            s.store_ad_value(479, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(1234), 1.0, s.ad_value(674), s.ad_value(1235), 1.0), 1.0, s.ad_value(675), s.ad_value(1236), 1.0));
            s.store_ad_value(694, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(563), 1.0, s.ad_value(674), s.ad_value(564), 1.0), 1.0, s.ad_value(675), s.ad_value(565), 1.0));
            s.store_ad_value(483, A::add_scaled_product(s.ad_value(478), 1.0, s.ad_value(694), A::offset(A::exp_scaled_input(s.ad_value(488), (s.v[371] * s.v[695])), (-1.0)), (-1.0)));
            s.store_ad_value(484, A::add_scaled_product(s.ad_value(479), 1.0, s.ad_value(694), A::offset(A::exp_scaled_input(s.ad_value(489), (s.v[371] * s.v[695])), (-1.0)), (-1.0)));
        }
        ...
        if ((((s.b[1171] && s.b[1188]) && s.b[1807]) && s.b[1808]) && s.b[1809]) {
            s.store_div(490, 483, 484);
            s.store_ad_value(697, A::div_scaled_inputs(A::ln(s.ad_value(490)), s.v[370], A::sub(s.ad_value(488), s.ad_value(489)), 1.0));
            s.store_div_ad_rhs(696, 483, A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(488), s.v[371], s.ad_value(697))), (-1.0)));
        }

        if ((s.b[1171] && s.b[1188]) && s.b[1807]) {
            s.store_ad_value(480, A::add_scaled_product(A::add_scaled_product(s.ad_value(475), 1.0, s.ad_value(694), A::offset(A::exp_scaled_input(s.ad_value(485), (s.v[371] * s.v[695])), (-1.0)), (-1.0)), 1.0, s.ad_value(696), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(485), s.v[371], s.ad_value(697))), (-1.0)), (-1.0)));
            s.store_ad_value(481, A::add_scaled_product(A::add_scaled_product(s.ad_value(476), 1.0, s.ad_value(694), A::offset(A::exp_scaled_input(s.ad_value(486), (s.v[371] * s.v[695])), (-1.0)), (-1.0)), 1.0, s.ad_value(696), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(486), s.v[371], s.ad_value(697))), (-1.0)), (-1.0)));
            s.store_ad_value(482, A::add_scaled_product(A::add_scaled_product(s.ad_value(477), 1.0, s.ad_value(694), A::offset(A::exp_scaled_input(s.ad_value(487), (s.v[371] * s.v[695])), (-1.0)), (-1.0)), 1.0, s.ad_value(696), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(487), s.v[371], s.ad_value(697))), (-1.0)), (-1.0)));
        }
        ...
        if (((((s.b[1171] && s.b[1188]) && s.b[1807]) && s.b[1810]) && s.b[1811]) && s.b[1812]) {
            ...
            s.store_mul_ad_rhs(698, 482, A::add_scaled_inputs(A::div_from_scalar(1.0, s.ad_value(487)), 1.0, s.ad_value(699), (0.5 * s.v[371])));
            s.store_ad_value(699, A::div_scaled_product(s.ad_value(482), s.ad_value(699), ((-0.5) * s.v[371]), s.ad_value(487), 1.0));
        }

        if (((((s.b[1171] && s.b[1188]) && s.b[1807]) && s.b[1810]) && s.b[1811]) && (!s.b[1812])) {
            s.store_scalar(693, 0.0);
            s.store_ad_value(698, A::div_scaled_inputs(s.ad_value(482), -1.0, A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(487), (-s.v[371]), s.ad_value(699))), (-1.0)), 1.0));
        }

        if (s.b[1171] && s.b[1188]) {
            s.store_mul_ad_rhs(501, 553, A::add_scaled_product(A::add_scaled_products(s.ad_value(673), s.ad_value(581), 1.0, s.ad_value(674), s.ad_value(582), 1.0), 1.0, s.ad_value(675), s.ad_value(583), 1.0));
        }
        ...
        s.store_ad_value(830, A::div_scaled_product(s.ad_value(826), s.ad_value(826), 1.0, A::offset(A::sqrt(A::offset(A::square(s.ad_value(826)), 0.01)), 0.1), 1.0));

        s.store_add_ad_lhs(2107, A::add_scaled_inputs3(s.ad_value(828), 0.5, s.ad_value(827), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(739), 1.0, A::sub(s.ad_value(828), s.ad_value(827)), A::sub(s.ad_value(828), s.ad_value(827)), 1.0)), (-0.5)), 737);

        s.copy_ad(1820, 2107);

        s.store_add_ad_lhs(2030, A::add_scaled_inputs3(s.ad_value(827), 1.0, s.ad_value(2107), (-0.5), A::sqrt(A::add_scaled_product(s.ad_value(738), 1.0, s.ad_value(2107), s.ad_value(2107), 1.0)), (-(-0.5))), 741);
        ...
        if s.b[2263] {
            s.store_ad_value(2032, A::add_scaled_inputs3(s.ad_value(2030), 1.0, s.ad_value(826), 0.5, s.ad_value(830), (-0.5)));
            s.store_sub_ad_lhs(2033, A::sqrt(A::add(s.ad_value(2032), s.ad_value(728))), 736);
            s.store_offset_div_ad(2027, A::sub_scaled_inputs(s.ad_value(2033), 2.0, s.ad_value(743), 2.0), s.ad_value(744), (-1.0));
            s.store_sub_ad_rhs(2034, 2033, A::mul3_scaled_output(A::sub_from_scalar(1.0, s.ad_value(184)), s.ad_value(744), A::add(s.ad_value(2027), A::sqrt(A::offset(A::square(s.ad_value(2027)), 0.4804530139182))), 0.25));
            s.store_ad_value(2035, A::add_scaled_product(A::square(s.ad_value(2034)), 1.0, s.ad_value(736), s.ad_value(2034), 2.0));
            s.store_ad_value(2030, A::add_scaled_inputs3(s.ad_value(2035), 1.0, s.ad_value(826), (-0.5), s.ad_value(830), (-(-0.5))));
        ...
        s.store_ad_value(2111, A::add_scaled_inputs3(s.ad_value(829), 1.0, s.ad_value(2112), (-1.0), s.ad_value(700), -1.0));

        s.store_ad_value(2113, A::add_scaled_inputs3(s.ad_value(2108), 1.0, s.ad_value(826), 0.5, s.ad_value(830), (-0.5)));
        ...
        if s.b[2264] {
            ...
            s.store_offset_ad(2028, A::div_scaled_inputs(s.ad_value(2106), 0.5, A::sqrt(s.ad_value(2116)), 1.0), 1.0);
            s.store_ad_value(2029, A::add_scaled_product(s.ad_value(2116), 1.0, s.ad_value(2106), A::sqrt(s.ad_value(2116)), 1.0));
            s.store_ad_value(2119, A::add_scaled_product(A::add_scaled_inputs(A::div(A::sub(s.ad_value(2118), s.ad_value(2029)), s.ad_value(2028)), 1.0, s.ad_value(2116), 0.5), 1.0, A::offset(s.ad_value(191), 1.0), s.ad_value(2117), (-1.0)));
            s.store_offset_scaled(2120, 2116, 0.5, 2.0);
            s.store_add(2121, 2116, 2117);
            s.store_ad_value(2028, A::sub_scaled_inputs(A::add_scaled_product(A::sub(s.ad_value(2118), s.ad_value(2121)), 1.0, s.ad_value(2106), A::sqrt(s.ad_value(2121)), (-1.0)), 1.0, A::ln(A::add(A::div(s.ad_value(2116), s.ad_value(2106)), A::sqrt(s.ad_value(2116)))), 2.0));
            s.store_add_scaled_inputs(2122, 2028, 2.0, 2120, 1.0);
            s.store_ad_value(2028, A::add_scaled_inputs3(s.ad_value(2119), 0.5, s.ad_value(2122), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2119), s.ad_value(2122)), A::sub(s.ad_value(2119), s.ad_value(2122))), 20.0)), 0.5));
            s.store_ad_value(2029, A::add_scaled_inputs3(s.ad_value(2118), 2.0, s.ad_value(2117), (-2.0), s.ad_value(2120), -1.0));
            s.store_ad_value(2123, A::add_scaled_inputs3(s.ad_value(2028), 0.5, s.ad_value(2029), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2028), s.ad_value(2029)), A::sub(s.ad_value(2028), s.ad_value(2029))), 20.0)), (-0.5)));
            s.store_ad_value(2028, A::add_scaled_inputs3(s.ad_value(2123), 0.5, s.ad_value(2120), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2123), s.ad_value(2120)), A::sub(s.ad_value(2123), s.ad_value(2120))), 5.0)), (-0.5)));
            s.store_ad_value(2124, A::add_scaled_inputs3(s.ad_value(2028), 0.5, s.ad_value(2120), ((-1.0) * 0.5), A::sqrt(A::offset(A::mul(A::sub_scaled_inputs(s.ad_value(2028), 1.0, s.ad_value(2120), -1.0), A::sub_scaled_inputs(s.ad_value(2028), 1.0, s.ad_value(2120), -1.0)), 20.0)), 0.5));
        ...
        if (s.b[2264] && (!s.b[2265])) {
            s.store_div_from_scalar_offset_ad(2125, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), s.ad_value(2029)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), s.ad_value(2029)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), s.ad_value(2029)), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }
        ...
        s.store_ad_value(2134, A::div_scaled_inputs(s.ad_value(830), 2.0, A::offset(A::sqrt(A::offset(A::mul(s.ad_value(197), s.ad_value(830)), 1.0)), 1.0), 1.0));
        ...
        if (s.b[2266] && s.b[2267]) {
            s.store_offset_mul_ad(2140, s.ad_value(2114), A::sub_from_scalar(1.0, A::mul_scaled_lhs(s.ad_value(2139), 0.5, A::sub_from_scalar(1.0, A::scale(s.ad_value(2139), 0.3125)))), 1.0);
        }
        ...
        if ((s.b[2266] && (!s.b[2267])) && (!s.b[2268])) {
            s.store_div_from_scalar_offset_ad(2154, 1e-200, A::mul(A::offset(s.ad_value(2139), (-460.51701859880916)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2139), (-460.51701859880916)), A::scale_offset(s.ad_value(2139), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if (s.b[2266] && (!s.b[2267])) {
            s.store_offset_ad(2140, A::div_scaled_product3(s.ad_value(2027), s.ad_value(2114), A::sub_from_scalar(1.0, A::mul(s.ad_value(2154), A::sub_from_scalar(1.0, s.ad_value(2139)))), 1.0, A::sqrt(A::mul(s.ad_value(2139), A::sub_from_scalar(1.0, s.ad_value(2154)))), 2.0), 1.0);
        }

        if (!s.b[2266]) {
            s.store_offset_ad(2140, A::div_scaled_inputs(s.ad_value(2114), 0.5, A::sqrt(s.ad_value(2139)), 1.0), 1.0);
        }

        s.store_ad_value(2141, A::add_scaled_product(A::add_scaled_product(s.ad_value(2139), 1.0, s.ad_value(2114), A::sqrt(s.ad_value(2139)), 1.0), 1.0, s.ad_value(2140), A::ln(A::offset(s.ad_value(2140), (-1.0))), (-1.0)));
        ...
        if s.b[2269] {
            ...
            s.store_scaled_add_ad_rhs(2027, 2143, A::sqrt(A::offset(A::square(s.ad_value(2143)), 10.0)), 0.5);
        }
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if s.b[2269] {
            ...
            s.store_scaled_add_ad_rhs(2145, 2144, A::sqrt(A::offset(A::square(s.ad_value(2144)), 2.0)), 0.5);
        }
        ...
        if (s.b[2269] && (!s.b[2270])) {
            s.store_scaled_offset_ad(2027, A::mul(A::offset(A::sub(s.ad_value(2142), s.ad_value(2145)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::sub(s.ad_value(2142), s.ad_value(2145)), (-230.25850929940458)), A::scale_offset(A::sub(s.ad_value(2142), s.ad_value(2145)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (s.b[2269] && s.b[2271]) {
            s.store_mul_offset_ad_rhs(2147, 2140, A::sub(s.ad_value(2145), A::div(A::offset(A::sqrt(A::offset(A::mul(s.ad_value(2146), s.ad_value(2027)), 1.0)), (-1.0)), s.ad_value(2146))), 1.0);
        }
        ...
        if s.b[2269] {
            s.store_scaled_add_ad(2027, A::offset(A::sub(s.ad_value(2133), s.ad_value(2147)), 2.0), A::sqrt(A::offset(A::mul(A::offset(A::sub(s.ad_value(2133), s.ad_value(2147)), (-2.0)), A::offset(A::sub(s.ad_value(2133), s.ad_value(2147)), (-2.0))), 1.0)), 0.5);
            ...
            s.store_ad_value(2139, A::add_scaled_product(s.ad_value(2138), 1.0, s.ad_value(2149), s.ad_value(2137), (-1.0)));
        }
        ...
        if s.b[2273] {
            ...
            s.store_mul_ad_product_rhs(2153, 2133, s.ad_value(2152), A::offset(A::mul(A::mul3(s.ad_value(2133), A::sub_from_scalar(1.0, s.ad_value(2154)), s.ad_value(2114)), s.ad_value(2239)), 1.0));
        }
        ...
        if ((!s.b[2273]) && s.b[2274]) {
            ...
            s.store_scaled_sub_ad(2243, A::offset(s.ad_value(2242), 10.0), A::sqrt(A::offset(A::mul(A::offset(s.ad_value(2242), (-6.0)), A::offset(s.ad_value(2242), (-6.0))), 64.0)), 0.5);
            s.store_sub(2238, 2241, 2243);
            s.store_ad_value(2244, A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::offset(s.ad_value(2243), 1.0), 1.0));
            ...
            s.store_ad_value(823, A::add_scaled_product(A::square(s.ad_value(824)), 1.0, s.ad_value(2246), A::sub_scaled_inputs(A::square(s.ad_value(2245)), 0.5, s.ad_value(2244), 1.0), 1.0));
        ...
        if (((!s.b[2273]) && s.b[2274]) && (!s.b[2275])) {
            s.store_scaled_offset_ad(2248, A::mul(A::offset(s.ad_value(2247), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2247), (-230.25850929940458)), A::scale_offset(s.ad_value(2247), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if ((!s.b[2273]) && s.b[2274]) {
            ...
            s.store_ad_value(2253, A::add_scaled_product(s.ad_value(2238), 2.0, s.ad_value(2115), A::add_scaled_product(A::sub(A::offset(s.ad_value(2248), (-1.0)), s.ad_value(2239)), 1.0, s.ad_value(2154), A::sub_from_scalar(1.0, s.ad_value(2251)), 1.0), 1.0));
            s.store_ad_value(2254, A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::add_scaled_product(A::add(A::offset(A::sub(s.ad_value(2248), s.ad_value(2247)), (-1.0)), s.ad_value(2239)), 1.0, s.ad_value(2154), A::sub(A::offset(s.ad_value(2247), (-1.0)), s.ad_value(2250)), 1.0), (-1.0)));
            s.store_sub_from_scalar_ad(2238, 2.0, A::mul(s.ad_value(2115), A::add_scaled_product(A::add(s.ad_value(2248), s.ad_value(2239)), 1.0, s.ad_value(2154), s.ad_value(2252), (-1.0))));
            s.store_ad_value(2238, A::add_scaled_product(A::square(s.ad_value(2253)), 1.0, s.ad_value(2254), s.ad_value(2238), (-2.0)));
            s.store_ad_value(2153, A::sub_scaled_inputs(s.ad_value(2247), -1.0, A::div(s.ad_value(2254), A::add(s.ad_value(2253), A::sqrt(s.ad_value(2238)))), 2.0));
        }
        ...
        if (((!s.b[2273]) && (!s.b[2274])) && (!s.b[2276])) {
            s.store_div_from_scalar_offset_ad(2238, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), A::neg(s.ad_value(2257))), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::neg(s.ad_value(2257))), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::neg(s.ad_value(2257))), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }

        if ((!s.b[2273]) && (!s.b[2274])) {
            s.store_sub_from_scalar(2258, 1.0, 2238);
            s.store_ad_value(2259, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(2133), 1.0, s.ad_value(2115), 0.5), 1.0, s.ad_value(2114), A::sqrt(A::add_scaled_inputs3(s.ad_value(2133), 1.0, s.ad_value(2115), 0.25, s.ad_value(2258), -1.0)), (-1.0)));
            s.store_offset(2260, 2139, 3.0);
            s.store_ad_value(2243, A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(2259), 0.5, s.ad_value(2260), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2259), s.ad_value(2260)), A::sub(s.ad_value(2259), s.ad_value(2260))), 5.0)), (-0.5)), 1.0, s.ad_value(2260), (-0.5), A::sqrt(A::offset(A::square(s.ad_value(2260)), 5.0)), (-(-0.5))));
        ...
        if ((!s.b[2273]) && (!s.b[2274])) {
            let assign42250_ad_e55460: A = {
                if (1e-40 > ((s.v[2238] * s.v[2238]) - (s.v[2115] * (((s.v[2239] + s.v[2243]) - 1.0) - (s.v[2154] * ((s.v[2243] + 1.0) + s.v[2250])))))) {
                    ...
                    A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::add_scaled_product(A::offset(A::add(s.ad_value(2239), s.ad_value(2243)), (-1.0)), 1.0, s.ad_value(2154), A::add(A::offset(s.ad_value(2243), 1.0), s.ad_value(2250)), (-1.0)), (-1.0))
                }
            };
            s.store_ad_value(2244, assign42250_ad_e55460);
        }
        ...
        if ((!s.b[2273]) && (!s.b[2274])) {
            ...
            s.store_ad_value(2245, A::add_scaled_product(s.ad_value(2238), 2.0, s.ad_value(2115), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(2239)), 1.0, s.ad_value(2154), A::offset(s.ad_value(2251), 1.0), (-1.0)), 1.0));
            s.store_ad_value(2246, A::add_scaled_inputs3(s.ad_value(2139), 1.0, s.ad_value(2243), (-1.0), A::ln(A::div(s.ad_value(2244), s.ad_value(2115))), 1.0));
            s.store_add(824, 2244, 2245);
            s.store_ad_value(823, A::add_scaled_product(A::square(s.ad_value(824)), 1.0, s.ad_value(2246), A::add_scaled_product(A::square(s.ad_value(2245)), 0.5, s.ad_value(2244), s.ad_value(2261), (-1.0)), 1.0));
            s.store_add_ad_rhs(2262, 2243, A::div_scaled_product3(s.ad_value(2244), s.ad_value(824), s.ad_value(2246), 1.0, A::add(s.ad_value(823), A::mul3(A::mul3(A::div(s.ad_value(824), s.ad_value(823)), s.ad_value(2246), s.ad_value(2246)), s.ad_value(2245), A::add_scaled_product(A::square(s.ad_value(2245)), 0.3333333333333333, s.ad_value(2244), s.ad_value(2261), (-1.0)))), 1.0));
        }
        ...
        if ((((!s.b[2273]) && (!s.b[2274])) && (!s.b[2277])) && (!s.b[2278])) {
            s.store_div_from_scalar_offset_ad(2248, 1e-100, A::mul(A::offset(A::sub(s.ad_value(2139), s.ad_value(2262)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::sub(s.ad_value(2139), s.ad_value(2262)), (-230.25850929940458)), A::scale_offset(A::sub(s.ad_value(2139), s.ad_value(2262)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2249, 1e-100, A::mul(A::offset(s.ad_value(2262), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2262), (-230.25850929940458)), A::scale_offset(s.ad_value(2262), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if ((!s.b[2273]) && (!s.b[2274])) {
            ...
            s.store_ad_value(2253, A::add_scaled_product(s.ad_value(2238), 2.0, s.ad_value(2115), A::add_scaled_product(A::add(A::sub_from_scalar(1.0, s.ad_value(2249)), s.ad_value(2248)), 1.0, s.ad_value(2154), A::offset(s.ad_value(2251), 1.0), (-1.0)), 1.0));
            s.store_ad_value(2254, A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::add_scaled_product(A::add(A::offset(A::add(s.ad_value(2249), s.ad_value(2262)), (-1.0)), s.ad_value(2248)), 1.0, s.ad_value(2154), A::add(A::offset(s.ad_value(2262), 1.0), s.ad_value(2250)), (-1.0)), (-1.0)));
            s.store_sub_from_scalar_ad(2238, 2.0, A::mul(s.ad_value(2115), A::add_scaled_product(A::add(s.ad_value(2249), s.ad_value(2248)), 1.0, s.ad_value(2154), s.ad_value(2252), (-1.0))));
            s.store_ad_value(2238, A::add_scaled_product(A::square(s.ad_value(2253)), 1.0, s.ad_value(2254), s.ad_value(2238), (-2.0)));
            s.store_ad_value(2153, A::add_scaled_inputs(s.ad_value(2262), 1.0, A::div(s.ad_value(2254), A::add(s.ad_value(2253), A::sqrt(s.ad_value(2238)))), 2.0));
        }
        ...
        if ((s.b[2279] && (!s.b[2280])) && (!s.b[2281])) {
            s.store_div_from_scalar_offset_ad(2158, 1e-100, A::mul(A::offset(A::sub(s.ad_value(2139), s.ad_value(2153)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::sub(s.ad_value(2139), s.ad_value(2153)), (-230.25850929940458)), A::scale_offset(A::sub(s.ad_value(2139), s.ad_value(2153)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2159, 1e-100, A::mul(A::offset(s.ad_value(2153), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2153), (-230.25850929940458)), A::scale_offset(s.ad_value(2153), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }

        if s.b[2279] {
            s.store_ad_value(2160, A::add_scaled_product(s.ad_value(2158), 1.0, s.ad_value(2154), A::add(A::offset(s.ad_value(2153), 1.0), s.ad_value(2155)), (-1.0)));
        }
        ...
        if (s.b[2279] && s.b[2282]) {
            s.store_scaled_mul_ad(2161, A::square(s.ad_value(2153)), A::sub_from_scalar(1.0, A::mul_scaled_output(s.ad_value(2153), A::sub_from_scalar(1.0, A::scale(s.ad_value(2153), 0.25)), 0.3333333333333333)), 0.5);
            s.store_ad_value(2160, A::mul3_scaled_output(A::mul3(s.ad_value(2154), s.ad_value(2153), s.ad_value(2153)), s.ad_value(2153), A::scale_offset(s.ad_value(2153), 1.75, 1.0), 0.16666666666666666));
            s.store_sqrt_sub_from_scalar_ad(2027, 1.0, A::mul_scaled_output(s.ad_value(2153), A::sub_from_scalar(1.0, A::scale(s.ad_value(2153), 0.25)), 0.3333333333333333));
            s.store_scaled_mul(2162, 2153, 2027, 0.7071067811865475);
            s.store_offset_ad(2163, A::div_scaled_product(s.ad_value(2114), A::add_scaled_inputs(A::sub_from_scalar(1.0, A::scale(s.ad_value(2153), 0.5)), 1.0, A::square(s.ad_value(2153)), 0.16666666666666666), 0.7071067811865475, s.ad_value(2027), 1.0), 1.0);
        }

        if (s.b[2279] && (!s.b[2282])) {
            s.store_add_ad_lhs(2161, A::offset(s.ad_value(2153), (-1.0)), 2159);
            s.store_sqrt(2162, 2161);
            s.store_offset_ad(2163, A::div_scaled_product(s.ad_value(2114), A::sub_from_scalar(1.0, s.ad_value(2159)), 0.5, s.ad_value(2162), 1.0), 1.0);
        }

        if s.b[2279] {
            s.store_div_ad(2164, A::offset(A::mul_scaled_lhs(s.ad_value(708), 0.2, s.ad_value(2113)), 1.0), A::offset(A::mul(s.ad_value(708), s.ad_value(2113)), 1.0));
        }
        ...
        if (s.b[2279] && s.b[2283]) {
            ...
            s.store_ad_value(2166, A::div_scaled_product3(s.ad_value(2115), s.ad_value(2160), s.ad_value(2129), 1.0, A::add_scaled_product(s.ad_value(2165), 1.0, s.ad_value(2114), s.ad_value(2162), 1.0), 1.0));
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if (s.b[2279] && s.b[2283]) {
            ...
            s.store_ad_value(2172, A::add_scaled_product(A::pow(A::mul(s.ad_value(2171), s.ad_value(704)), s.ad_value(705)), 1.0, s.ad_value(706), A::exp(A::mul_scaled_lhs(s.ad_value(707), 0.5, s.ad_value(2028))), 1.0));
        ...
        if (s.b[2288] && s.b[2289]) {
            ...
            s.store_div_ad_lhs(2027, A::div_scaled_product(s.ad_value(2115), s.ad_value(2158), 1.0, s.ad_value(2179), 1.0), 2179);
        }
        ...
        if ((s.b[2288] && s.b[2289]) && s.b[2292]) {
            ...
            s.store_ad_value(2027, A::add_scaled_product(s.ad_value(2166), 1.0, s.ad_value(2163), s.ad_value(2181), (-1.0)));
            s.store_scaled_add_ad_rhs(2182, 2027, A::sqrt(A::offset(A::square(s.ad_value(2027)), 1e-12)), 0.5);
            s.store_ad_value(2183, A::add_scaled_product(A::add_scaled_product(s.ad_value(2166), (-1.0), s.ad_value(2129), s.ad_value(2165), 1.0), 1.0, A::offset(s.ad_value(2163), (-1.0)), s.ad_value(2181), 1.0));
            s.store_offset_ad(2184, A::div_scaled_product(s.ad_value(2115), s.ad_value(2129), 0.5, s.ad_value(2183), 1.0), 1.0);
            s.store_ad_value(2027, A::add_scaled_product(s.ad_value(2183), 1.0, s.ad_value(775), s.ad_value(2182), 1.0));
            s.store_pow_ad(2185, A::mul3(s.ad_value(774), s.ad_value(2027), s.ad_value(704)), s.ad_value(705));
            s.store_mul_ad_lhs(2028, A::div_scaled_product(s.ad_value(705), A::offset(A::mul(s.ad_value(2184), A::sub_from_scalar(1.0, s.ad_value(775))), (-1.0)), 1.0, s.ad_value(2027), 1.0), 2185);
            s.store_div(2027, 2182, 2183);
            s.store_mul_pow_ad_rhs(2186, 706, A::offset(s.ad_value(2027), 1.0), A::neg(s.ad_value(707)));
            s.store_mul_ad_lhs(2029, A::div_scaled_product(s.ad_value(707), A::add(A::offset(s.ad_value(2184), (-1.0)), A::div_from_scalar(1.0, A::offset(s.ad_value(2027), 1.0))), 1.0, s.ad_value(2183), 1.0), 2186);
            s.store_mul_ad_lhs(2187, A::mul3(s.ad_value(757), s.ad_value(2168), s.ad_value(2169)), 2182);
            s.store_offset_div_ad(2027, A::add_scaled_product(s.ad_value(2028), 1.0, A::mul3(s.ad_value(757), s.ad_value(2168), s.ad_value(2169)), s.ad_value(2184), (-1.0)), s.ad_value(2029), 1.0);
        }
        ...
        if ((s.b[2288] && s.b[2289]) && s.b[2292]) {
            s.store_ad_value(2188, A::div_scaled_product3(s.ad_value(2181), s.ad_value(2029), s.ad_value(2028), -1.0, A::add_scaled_inputs3(A::offset(s.ad_value(2185), 1.0), 1.0, s.ad_value(2186), 1.0, s.ad_value(2187), 1.0), 1.0));
            s.store_mul_offset_ad_rhs(2189, 2180, A::div(s.ad_value(2188), A::offset(A::sqrt(A::offset(A::square(s.ad_value(2188)), 1.0)), 1.0)), 1.0);
        }
        ...
        if (s.b[2288] && s.b[2289]) {
            ...
            s.store_mul_ad_product_rhs(2192, 2189, s.ad_value(2191), A::offset(A::div_scaled_product(s.ad_value(2027), A::sub_from_scalar(1.0, A::mul(s.ad_value(2027), s.ad_value(2191))), 0.86, A::offset(A::mul3_scaled_output(s.ad_value(2027), s.ad_value(2027), s.ad_value(2191), 4.0), 1.0), 1.0), 1.0));
            s.store_scale(2193, 2192, 0.99);
            s.store_ad_value(2027, A::div_scaled_product3(s.ad_value(2193), A::sub_scaled_inputs(s.ad_value(2193), 1.0, s.ad_value(2179), 2.0), s.ad_value(2131), 1.0, s.ad_value(2160), 1.0));
        }
        ...
        if s.b[2288] {
            ...
            s.store_ad_value(2028, A::div_scaled_product(A::sqrt(s.ad_value(2027)), s.ad_value(826), 1.0, s.ad_value(2194), 1.0));
            s.store_add_ad_lhs(2029, A::square(s.ad_value(2028)), 2027);
            s.store_scale(2027, 2028, 2.0);
            s.store_ad_value(2195, A::div_scaled_product(s.ad_value(2194), s.ad_value(2027), 1.0, A::add(A::sqrt(A::sub(s.ad_value(2029), s.ad_value(2027))), A::sqrt(A::add(s.ad_value(2029), s.ad_value(2027)))), 1.0));
        ...
        if (s.b[2288] && (!s.b[2295])) {
            s.store_div_from_scalar_offset_ad(2198, 1e-200, A::mul(A::offset(s.ad_value(2196), (-460.51701859880916)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2196), (-460.51701859880916)), A::scale_offset(s.ad_value(2196), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if (s.b[2288] && s.b[2296]) {
            s.store_scaled_square(2239, 2152, (0.16666666666666666 * 0.7071067811865475));
            s.store_mul_ad_product_rhs(2200, 2133, s.ad_value(2152), A::offset(A::mul(A::mul3(s.ad_value(2133), A::sub_from_scalar(1.0, s.ad_value(2199)), s.ad_value(2114)), s.ad_value(2239)), 1.0));
        }
        ...
        if (s.b[2288] && (!s.b[2296])) {
            let assign44430_ad_e57404: A = {
                if (1e-40 > ((s.v[2238] * s.v[2238]) - (s.v[2115] * (((s.v[2239] + s.v[2243]) - 1.0) - (s.v[2199] * ((s.v[2243] + 1.0) + s.v[2250])))))) {
                    ...
                    A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::add_scaled_product(A::offset(A::add(s.ad_value(2239), s.ad_value(2243)), (-1.0)), 1.0, s.ad_value(2199), A::add(A::offset(s.ad_value(2243), 1.0), s.ad_value(2250)), (-1.0)), (-1.0))
                }
            };
            s.store_ad_value(2244, assign44430_ad_e57404);
        }
        ...
        if (s.b[2288] && (!s.b[2296])) {
            ...
            s.store_ad_value(2245, A::add_scaled_product(s.ad_value(2238), 2.0, s.ad_value(2115), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(2239)), 1.0, s.ad_value(2199), A::offset(s.ad_value(2251), 1.0), (-1.0)), 1.0));
            s.store_ad_value(2246, A::add_scaled_inputs3(s.ad_value(2197), 1.0, s.ad_value(2243), (-1.0), A::ln(A::div(s.ad_value(2244), s.ad_value(2115))), 1.0));
            s.store_add(824, 2244, 2245);
            s.store_ad_value(823, A::add_scaled_product(A::square(s.ad_value(824)), 1.0, s.ad_value(2246), A::add_scaled_product(A::square(s.ad_value(2245)), 0.5, s.ad_value(2244), s.ad_value(2261), (-1.0)), 1.0));
            s.store_add_ad_rhs(2262, 2243, A::div_scaled_product3(s.ad_value(2244), s.ad_value(824), s.ad_value(2246), 1.0, A::add(s.ad_value(823), A::mul3(A::mul3(A::div(s.ad_value(824), s.ad_value(823)), s.ad_value(2246), s.ad_value(2246)), s.ad_value(2245), A::add_scaled_product(A::square(s.ad_value(2245)), 0.3333333333333333, s.ad_value(2244), s.ad_value(2261), (-1.0)))), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if (((s.b[2288] && (!s.b[2296])) && (!s.b[2297])) && (!s.b[2298])) {
            s.store_div_from_scalar_offset_ad(2248, 1e-100, A::mul(A::offset(A::sub(s.ad_value(2197), s.ad_value(2262)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::sub(s.ad_value(2197), s.ad_value(2262)), (-230.25850929940458)), A::scale_offset(A::sub(s.ad_value(2197), s.ad_value(2262)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2249, 1e-100, A::mul(A::offset(s.ad_value(2262), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2262), (-230.25850929940458)), A::scale_offset(s.ad_value(2262), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if (s.b[2288] && (!s.b[2296])) {
            ...
            s.store_mul_ad_product_lhs(2252, A::sub_scaled_inputs(s.ad_value(2238), 8.0, s.ad_value(2250), 12.0), s.ad_value(2238), 2238);
            s.store_sub(2238, 2133, 2262);
            s.store_ad_value(2253, A::add_scaled_product(s.ad_value(2238), 2.0, s.ad_value(2115), A::add_scaled_product(A::add(A::sub_from_scalar(1.0, s.ad_value(2249)), s.ad_value(2248)), 1.0, s.ad_value(2199), A::offset(s.ad_value(2251), 1.0), (-1.0)), 1.0));
            s.store_ad_value(2254, A::add_scaled_product(A::square(s.ad_value(2238)), 1.0, s.ad_value(2115), A::add_scaled_product(A::add(A::offset(A::add(s.ad_value(2249), s.ad_value(2262)), (-1.0)), s.ad_value(2248)), 1.0, s.ad_value(2199), A::add(A::offset(s.ad_value(2262), 1.0), s.ad_value(2250)), (-1.0)), (-1.0)));
            s.store_sub_from_scalar_ad(2238, 2.0, A::mul(s.ad_value(2115), A::add_scaled_product(A::add(s.ad_value(2249), s.ad_value(2248)), 1.0, s.ad_value(2199), s.ad_value(2252), (-1.0))));
            s.store_ad_value(2238, A::add_scaled_product(A::square(s.ad_value(2253)), 1.0, s.ad_value(2254), s.ad_value(2238), (-2.0)));
            s.store_ad_value(2200, A::add_scaled_inputs(s.ad_value(2262), 1.0, A::div(s.ad_value(2254), A::add(s.ad_value(2253), A::sqrt(s.ad_value(2238)))), 2.0));
        }
        ...
        if (s.b[2288] && s.b[2299]) {
            s.store_ad_value(2202, A::add_scaled_product(A::sub_scaled_inputs(s.ad_value(2133), 2.0, s.ad_value(2153), 2.0), 1.0, s.ad_value(2115), A::add_scaled_product(A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(2159)), 1.0, s.ad_value(2158), s.ad_value(2198), 1.0), 1.0, s.ad_value(2199), A::offset(s.ad_value(2156), 1.0), (-1.0)), 1.0));
            s.store_mul_ad_product_lhs(2203, s.ad_value(2115), A::sub_from_scalar(1.0, s.ad_value(2198)), 2160);
            s.store_sub_from_scalar_ad(2027, 2.0, A::mul(s.ad_value(2115), A::add_scaled_product(A::add_scaled_product(s.ad_value(2159), 1.0, s.ad_value(2158), s.ad_value(2198), 1.0), 1.0, s.ad_value(2199), s.ad_value(2157), (-1.0))));
            s.store_ad_value(2027, A::add_scaled_product(A::square(s.ad_value(2202)), 1.0, s.ad_value(2027), s.ad_value(2203), (-2.0)));
        ...
        if s.b[2288] {
            ...
            s.store_ad_value(2205, A::div_scaled_product(s.ad_value(2200), s.ad_value(2200), 1.0, A::offset(A::square(s.ad_value(2200)), 2.0), 1.0));
        }
        ...
        if ((s.b[2288] && s.b[2300]) && s.b[2301]) {
            s.store_scaled_mul_ad(2207, A::square(s.ad_value(2200)), A::sub_from_scalar(1.0, A::mul_scaled_output(s.ad_value(2200), A::sub_from_scalar(1.0, A::scale(s.ad_value(2200), 0.25)), 0.3333333333333333)), 0.5);
            s.store_sqrt_sub_from_scalar_ad(2027, 1.0, A::mul_scaled_output(s.ad_value(2200), A::sub_from_scalar(1.0, A::scale(s.ad_value(2200), 0.25)), 0.3333333333333333));
            s.store_scaled_mul(2208, 2200, 2027, 0.7071067811865475);
            s.store_ad_value(2209, A::mul3(A::mul3_scaled_output(s.ad_value(2199), s.ad_value(2200), s.ad_value(2200), 0.16666666666666666), s.ad_value(2200), A::scale_offset(s.ad_value(2200), 1.75, 1.0)));
        }

        if ((s.b[2288] && s.b[2300]) && (!s.b[2301])) {
            s.store_add_ad_lhs(2207, A::offset(s.ad_value(2200), (-1.0)), 2206);
            s.store_sqrt(2208, 2207);
            s.store_mul_sub_ad_rhs(2209, 2199, A::offset(A::sub(A::div_from_scalar(1.0, s.ad_value(2206)), s.ad_value(2200)), (-1.0)), s.ad_value(2205));
        }
        ...
        if ((s.b[2288] && (!s.b[2300])) && s.b[2302]) {
            ...
            s.store_ad_value(2209, A::add_scaled_product(s.ad_value(2027), 1.0, s.ad_value(2199), A::add(A::offset(s.ad_value(2200), 1.0), s.ad_value(2205)), (-1.0)));
        }

        if ((s.b[2288] && (!s.b[2300])) && (!s.b[2302])) {
            s.store_div_from_scalar_offset_ad(2206, 1e-100, A::mul(A::offset(s.ad_value(2200), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(s.ad_value(2200), (-230.25850929940458)), A::scale_offset(s.ad_value(2200), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2027, 1e-100, A::mul(A::offset(A::sub(s.ad_value(2197), s.ad_value(2200)), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::sub(s.ad_value(2197), s.ad_value(2200)), (-230.25850929940458)), A::scale_offset(A::sub(s.ad_value(2197), s.ad_value(2200)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_ad_value(2209, A::add_scaled_product(s.ad_value(2027), 1.0, s.ad_value(2199), A::add(A::offset(s.ad_value(2200), 1.0), s.ad_value(2205)), (-1.0)));
        }
        ...
        if s.b[2288] {
            ...
            s.store_ad_value(2214, A::add_scaled_product(s.ad_value(2213), 1.0, A::square(s.ad_value(2201)), A::sub_scaled_inputs(s.ad_value(2212), 1.0, s.ad_value(2131), 2.0), 0.125));
        }
        ...
        if (s.b[2288] && s.b[2304]) {
            s.store_scaled_mul_ad(2215, A::square(s.ad_value(2211)), A::sub_from_scalar(1.0, A::mul_scaled_output(s.ad_value(2211), A::sub_from_scalar(1.0, A::scale(s.ad_value(2211), 0.25)), 0.3333333333333333)), 0.5);
        ...
        if (s.b[2288] && s.b[2304]) {
            s.store_sqrt_sub_from_scalar_ad(2027, 1.0, A::mul_scaled_output(s.ad_value(2211), A::sub_from_scalar(1.0, A::scale(s.ad_value(2211), 0.25)), 0.3333333333333333));
        ...
        if ((s.b[2288] && (!s.b[2304])) && s.b[2306]) {
            s.store_ad_value(2220, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(2212)), 1.0, s.ad_value(2216), s.ad_value(2131), 2.0));
            s.store_div_from_scalar_sqrt_ad(2217, 1.0, A::offset(A::mul(s.ad_value(730), s.ad_value(2216)), 1.0));
            s.store_div_ad_rhs(2027, 2217, A::offset(s.ad_value(2217), 1.0));
            s.store_mul_ad_rhs(2221, 730, A::mul3(A::square(s.ad_value(2027)), s.ad_value(2115), s.ad_value(2214)));
            s.store_ad_value(2222, A::add_scaled_product(A::sub_scaled_inputs(s.ad_value(2216), 2.0, s.ad_value(2221), 2.0), 1.0, s.ad_value(2115), A::add(A::sub_from_scalar(1.0, s.ad_value(2212)), s.ad_value(2214)), 1.0));
            s.store_mul_ad_rhs(2223, 2221, A::sub_scaled_inputs(s.ad_value(2221), 1.0, s.ad_value(2216), 2.0));
            s.store_sub_from_scalar_ad(2224, 1.0, A::mul_scaled_output(s.ad_value(2115), A::add(s.ad_value(2212), s.ad_value(2214)), 0.5));
            s.store_ad_value(2225, A::div_scaled_product(s.ad_value(2223), s.ad_value(2222), 1.0, A::add_scaled_product(A::square(s.ad_value(2222)), 1.0, s.ad_value(2224), s.ad_value(2223), (-1.0)), 1.0));
            ...
            s.store_ad_value(2201, A::div_scaled_product3(s.ad_value(2201), s.ad_value(2226), A::add(s.ad_value(2220), s.ad_value(2213)), 1.0, A::add_scaled_product(s.ad_value(2227), 1.0, s.ad_value(2226), s.ad_value(2213), 1.0), 1.0));
            s.store_mul(2204, 2201, 2129);
        }

        if (s.b[2288] && (!s.b[2304])) {
            s.store_sqrt(2218, 2215);
            s.store_add_ad_rhs(2219, 2217, A::div_scaled_product(s.ad_value(2114), A::sub_from_scalar(1.0, s.ad_value(2212)), 0.5, s.ad_value(2218), 1.0));
        }

        if s.b[2288] {
            s.store_mul_ad_rhs(2228, 2129, A::div_scaled_product(s.ad_value(2115), s.ad_value(2214), 1.0, A::add_scaled_product(s.ad_value(2216), 1.0, s.ad_value(2114), s.ad_value(2218), 1.0), 1.0));
            s.store_ad_value(2229, A::add_scaled_product(s.ad_value(2228), 1.0, s.ad_value(2129), s.ad_value(2219), 1.0));
        ...
        if s.b[2288] {
            s.store_mul_ad_lhs(2170, A::mul3(s.ad_value(757), s.ad_value(2168), s.ad_value(2169)), 2228);
            s.store_ad_value(2231, A::add_scaled_product(s.ad_value(2230), 1.0, s.ad_value(775), s.ad_value(2228), 1.0));
            s.store_ad_value(2232, A::add_scaled_product(s.ad_value(2230), 1.0, s.ad_value(776), s.ad_value(2228), 1.0));
            s.store_mul(2233, 774, 2231);
            s.store_ln_ad(2028, A::div(s.ad_value(2215), A::offset(A::add(s.ad_value(2215), s.ad_value(2214)), 1e-14)));
            s.store_ad_value(2172, A::add_scaled_product(A::pow(A::mul(s.ad_value(2233), s.ad_value(704)), s.ad_value(705)), 1.0, s.ad_value(706), A::exp(A::mul_scaled_lhs(s.ad_value(707), 0.5, s.ad_value(2028))), 1.0));
        ...
        if s.b[2309] {
            ...
            s.store_ad_value(2027, A::div_scaled_product(s.ad_value(1824), s.ad_value(1864), 1.0, s.ad_value(1866), 1.0));
            s.store_ad_value(2036, A::add_scaled_product(A::mul3(A::mul3(s.ad_value(227), s.ad_value(1867), s.ad_value(2027)), s.ad_value(2027), s.ad_value(2037)), 1.0, A::div_scaled_product(A::add(s.ad_value(225), A::div(s.ad_value(226), s.ad_value(1866))), s.ad_value(1865), 1.0, s.ad_value(1866), 1.0), s.ad_value(1871), 1.0));
        ...
        if s.b[2309] {
            s.store_mul_scaled_ad_rhs(2039, 1874, 0.5, A::offset(A::sqrt(A::scale_offset(s.ad_value(2038), 2.0, 1.0)), 1.0));
            ...
            s.store_ad_value(1877, A::div_scaled_product(s.ad_value(2027), s.ad_value(1866), 1.0, s.ad_value(2040), 1.0));
            s.store_mul_ad_lhs(838, A::mul3(s.ad_value(716), s.ad_value(1866), s.ad_value(1860)), 1876);
        }
