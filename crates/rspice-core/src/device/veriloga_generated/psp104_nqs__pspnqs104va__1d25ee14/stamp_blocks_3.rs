...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_59(
        ...
        if s.b[3277] {
            ...
            s.store_mul_ad_product_lhs(3258, A::mul(A::neg(s.ad_value(2028)), s.ad_value(3255)), s.ad_value(1884), 1881);
        ...
        if s.b[3277] {
            ...
            s.store_mul_ad_product_lhs(3266, A::scale(s.ad_value(717), s.v[715]), A::add(s.ad_value(1882), s.ad_value(3255)), 1876);
