...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_208(
        ...
        s.store_scalar(3252, 0.0);s.store_scalar(3247, 0.0);s.store_scalar(859, 1e-40);s.store_scalar(861, 0.0);s.store_scalar(863, 0.0);s.store_mul(860, 1904, 1895);s.store_scalar(862, 0.0);s.store_scalar(3254, 0.0);s.b[3268] = ((s.v[1829] > 0.0) && (s.v[716] > 0.0));s.store_scalar(3268, if s.b[3268] { 1.0 } else { 0.0 });s.b[3270] = (p.p32 > 0.0);s.store_scalar(3270, if s.b[3270] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_209(
        ...
        s.b[3273] = ((((p.p50 == 1.0) && (s.v[719] > 0.0)) && (p.p32 > 0.0)) && (p.p33 > 0.0));s.store_scalar(3273, if s.b[3273] { 1.0 } else { 0.0 });
        ...
        s.b[3277] = (((p.p46 != 0.0) && (s.v[287] > 0.0)) && (s.v[1880] > 0.0));s.store_scalar(3277, if s.b[3277] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_0(
        ...
        s.b[992] = (p.p51 < 1.5);s.store_scalar(992, if s.b[992] { 1.0 } else { 0.0 });
        if ((!s.b[991]) && s.b[992]) {s.store_scalar(1, 1.0);}
        s.b[993] = (p.p51 < 2.5);s.store_scalar(993, if s.b[993] { 1.0 } else { 0.0 });
        if (((!s.b[991]) && (!s.b[992])) && s.b[993]) {s.store_scalar(1, 2.0);}
        s.b[994] = (p.p51 < 4.0);s.store_scalar(994, if s.b[994] { 1.0 } else { 0.0 });
        if ((((!s.b[991]) && (!s.b[992])) && (!s.b[993])) && s.b[994]) {s.store_scalar(1, 3.0);}
        s.b[995] = (p.p51 < 7.0);s.store_scalar(995, if s.b[995] { 1.0 } else { 0.0 });
        ...
        s.store_scalar(3, 10.0);s.store_scalar(4, (1.0 / s.v[3]));s.store_scalar(350, (273.15 + p.p38));s.store_scalar(474, 0.0);s.b[996] = (p.p927 > 0.5);s.store_scalar(996, if s.b[996] { 1.0 } else { 0.0 });
        if s.b[996] {s.store_scalar(474, 1.0);}
        if (!s.b[996]) {s.store_scalar(474, 0.0);}
        s.store_scalar(364, (273.15 + p.p823));s.store_scalar(367, (1.3806505e-23 / 1.6021918e-19));s.store_scalar(368, (s.v[367] * s.v[364]));s.store_scalar(369, (1.0 / s.v[368]));s.store_scalar(375, ((-((0.000702 * s.v[364]) * s.v[364])) / (1108.0 + s.v[364])));s.store_scalar(378, (p.p834 + s.v[375]));s.store_scalar(379, (p.p835 + s.v[375]));s.store_scalar(380, (p.p836 + s.v[375]));s.store_scalar(408, (1.0 - p.p831));s.store_scalar(409, (1.0 - p.p832));s.store_scalar(410, (1.0 - p.p833));s.store_scalar(411, (1.0 / s.v[408]));s.store_scalar(412, (1.0 / s.v[409]));s.store_scalar(413, (1.0 / s.v[410]));s.store_scalar(423, (s.v[767] / p.p825));s.store_scalar(424, ((p.p843 * s.v[767]) / p.p826));s.store_scalar(425, ((p.p844 * s.v[767]) / p.p827));s.store_scalar(426, (1.0 / s.v[423]));s.store_scalar(427, (1.0 / s.v[424]));s.store_scalar(428, (1.0 / s.v[425]));s.store_scalar(429, (1.0 / p.p828));s.store_scalar(430, (1.0 / p.p829));s.store_scalar(431, (1.0 / p.p830));s.store_scalar(444, (1.0 - (1.0 / p.p824)));s.store_scalar(448, (1.0 / p.p860));s.store_scalar(449, (1.0 / p.p861));s.store_scalar(450, (1.0 / p.p862));s.b[997] = ((((p.p866 != 1.0) || (p.p867 != 1.0)) || (p.p868 != 1.0)) || (p.p869 != 1.0));s.store_scalar(997, if s.b[997] { 1.0 } else { 0.0 });
        ...
        if s.b[999] {s.store_scalar(505, p.p825);s.store_scalar(506, p.p826);s.store_scalar(507, p.p827);s.store_scalar(508, p.p828);s.store_scalar(509, p.p829);s.store_scalar(510, p.p830);s.store_scalar(511, p.p831);s.store_scalar(512, p.p832);s.store_scalar(513, p.p833);s.store_scalar(514, p.p834);s.store_scalar(515, p.p835);s.store_scalar(516, p.p836);s.store_scalar(517, p.p837);s.store_scalar(518, p.p838);s.store_scalar(519, p.p839);s.store_scalar(522, p.p840);s.store_scalar(523, p.p841);s.store_scalar(524, p.p842);s.store_scalar(520, p.p843);s.store_scalar(521, p.p844);s.store_scalar(525, p.p845);s.store_scalar(526, p.p846);s.store_scalar(527, p.p847);s.store_scalar(528, p.p848);s.store_scalar(529, p.p849);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_1(
        ...
        if s.b[999] {s.store_scalar(530, p.p850);s.store_scalar(531, p.p851);s.store_scalar(532, p.p852);s.store_scalar(533, p.p853);s.store_scalar(534, p.p854);s.store_scalar(535, p.p855);s.store_scalar(536, p.p856);s.store_scalar(537, p.p857);s.store_scalar(538, p.p858);s.store_scalar(539, p.p859);s.store_scalar(540, p.p860);s.store_scalar(541, p.p861);s.store_scalar(542, p.p862);s.store_scalar(543, p.p863);s.store_scalar(544, p.p864);s.store_scalar(545, p.p865);s.store_scalar(553, p.p929);s.store_scalar(636, p.p872);s.store_scalar(637, p.p873);s.store_scalar(638, p.p874);s.store_scalar(639, p.p875);s.store_scalar(546, p.p866);s.store_scalar(547, p.p867);s.store_scalar(548, p.p868);s.store_scalar(549, p.p869);s.store_scalar(550, p.p870);s.store_scalar(551, p.p871);}
        if (!s.b[999]) {s.store_scalar(505, p.p876);s.store_scalar(506, p.p877);s.store_scalar(507, p.p878);s.store_scalar(508, p.p879);s.store_scalar(509, p.p880);s.store_scalar(510, p.p881);s.store_scalar(511, p.p882);s.store_scalar(512, p.p883);s.store_scalar(513, p.p884);s.store_scalar(514, p.p885);s.store_scalar(515, p.p886);s.store_scalar(516, p.p887);s.store_scalar(517, p.p888);s.store_scalar(518, p.p889);s.store_scalar(519, p.p890);s.store_scalar(522, p.p891);s.store_scalar(523, p.p892);s.store_scalar(524, p.p893);s.store_scalar(520, p.p894);s.store_scalar(521, p.p895);s.store_scalar(525, p.p896);s.store_scalar(526, p.p897);s.store_scalar(527, p.p898);s.store_scalar(528, p.p899);s.store_scalar(529, p.p900);s.store_scalar(530, p.p901);s.store_scalar(531, p.p902);s.store_scalar(532, p.p903);s.store_scalar(533, p.p904);s.store_scalar(534, p.p905);s.store_scalar(535, p.p906);s.store_scalar(536, p.p907);s.store_scalar(537, p.p908);s.store_scalar(538, p.p909);s.store_scalar(539, p.p910);s.store_scalar(540, p.p911);s.store_scalar(541, p.p912);s.store_scalar(542, p.p913);s.store_scalar(543, p.p914);s.store_scalar(544, p.p915);s.store_scalar(545, p.p916);s.store_scalar(553, p.p931);s.store_scalar(636, p.p923);s.store_scalar(637, p.p924);s.store_scalar(638, p.p925);s.store_scalar(639, p.p926);s.store_scalar(546, p.p917);s.store_scalar(547, p.p918);s.store_scalar(548, p.p919);s.store_scalar(549, p.p920);s.store_scalar(550, p.p921);s.store_scalar(551, p.p922);}
    ...
    pub(super) fn stamp_reactive_block_6(
        ...
        s.store_scalar(127, p.p140);s.store_scalar(128, p.p141);s.store_scalar(129, p.p142);s.store_scalar(130, p.p143);s.store_scalar(131, p.p144);s.store_scalar(132, p.p145);s.store_scalar(133, p.p146);s.store_scalar(134, p.p147);s.store_scalar(135, p.p148);s.store_scalar(136, p.p149);s.store_scalar(137, p.p150);s.store_scalar(138, p.p151);s.store_scalar(139, p.p152);s.store_scalar(140, p.p153);s.store_scalar(141, p.p154);s.store_scalar(142, p.p155);s.store_scalar(143, p.p156);s.store_scalar(149, p.p162);s.store_scalar(150, p.p163);s.store_scalar(151, p.p164);s.store_scalar(152, p.p165);s.store_scalar(153, p.p166);s.store_scalar(154, p.p167);s.store_scalar(155, p.p168);s.store_scalar(156, p.p169);s.store_scalar(157, p.p170);s.store_scalar(158, p.p171);s.store_scalar(159, p.p172);s.store_scalar(160, p.p174);s.store_scalar(161, p.p173);s.store_scalar(176, p.p187);s.b[1030] = (p.p39 > 0.0);s.store_scalar(1030, if s.b[1030] { 1.0 } else { 0.0 });
