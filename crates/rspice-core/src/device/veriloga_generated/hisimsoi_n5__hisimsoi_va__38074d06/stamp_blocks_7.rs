...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        let mut t1a: usize = 0;
        while {
            let t19: f64 = if ((s.b[735] && (!s.b[927])) && (s.v[168] <= s.v[58])) { 1.0 } else { 0.0 };
            t19 != 0.0
        } {
            t1a += 1;
            ...
            let mut t16: usize = 0;
            while {
                let t15: f64 = if (((s.b[735] && (!s.b[927])) && (!s.b[1013])) && (s.v[44] >= 60.0)) { 1.0 } else { 0.0 };
                t15 != 0.0
            } {
                t16 += 1;
            ...
            let mut t18: usize = 0;
            while {
                let t17: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1016]) && s.b[1017]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t17 != 0.0
            } {
                t18 += 1;
            ...
            let mut t14: usize = 0;
            while {
                let t13: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1022]) && s.b[1023]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t13 != 0.0
            } {
                t14 += 1;
    ...
    pub(super) fn stamp_reactive_block_30(
        ...
        let mut t1c: usize = 0;
        while {
            let t1b: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1040]) && s.b[1041]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1b != 0.0
        } {
            t1c += 1;
    ...
    pub(super) fn stamp_reactive_block_31(
        ...
        let mut t1e: usize = 0;
        while {
            let t1d: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1047]) && s.b[1048]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1d != 0.0
        } {
            t1e += 1;
        ...
        let mut t20: usize = 0;
        while {
            let t1f: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1f != 0.0
        } {
            t20 += 1;
