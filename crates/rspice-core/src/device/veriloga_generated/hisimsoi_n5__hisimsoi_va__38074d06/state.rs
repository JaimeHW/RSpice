...
pub struct Instance {
    ...
    pub(crate) scratch: Option<Box<GenericScratch<1852, 19, 19>>>,
    pub(crate) reactive_scratch: Option<Box<GenericReactiveScratch<1852, 19, 19>>>,
}
...
impl Instance {
    ...
    fn recompute_instance_static(&mut self) {
        ...
        self.scalar_v47 = v47;
        let v49: f64 = (if v4 { 0.0 } else { 0.0 });
        self.scalar_v49 = v49;
        let v50: f64 = p.p25;
        self.scalar_v50 = v50;
