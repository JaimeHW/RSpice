...
impl Instance {
    ...
    if (((((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) && (!s.b[1055])) && s.b[1056]) {
        ...
        s.store_scalar(55, t0);s.b[1057] = (2.0 == 4.0);s.store_scalar(1057, if s.b[1057] { 1.0 } else { 0.0 });
        let (t1,) = {
    if ((((((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) && (!s.b[1055])) && (!s.b[1056])) && s.b[1057]) {
        ...
        s.store_scalar(55, t1);s.b[1058] = (2.0 == 8.0);s.store_scalar(1058, if s.b[1058] { 1.0 } else { 0.0 });
        let (t2,) = {
    ...
    if (((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) {
        ...
        s.store_scalar(54, t3);let mut t7: usize = 0;
        while {
            let t6: f64 = if ((((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;assert!(t7 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) {s.store_sqrt(53, 53);}
            let (t5,) = {
    if (((s.b[735] && (!s.b[927])) && s.b[1053]) && s.b[1054]) {
        let t4: f64 = (s.v[54] + 1.0);
        (t4,)
    } else {
        (s.v[54],)
    }
};
            s.store_scalar(54, t5);
        }
        ...
        s.b[1065] = (s.v[416] < p[237]);s.store_scalar(1065, if s.b[1065] { 1.0 } else { 0.0 });
        let (t8,) = {
    if ((!s.b[735]) && s.b[1065]) {
        (1.0,)
    } else {
    ...
    if ((!s.b[735]) && (!s.b[1065])) {
        ...
        s.store_scalar(339, t9);
        let (td,) = {
    if (!s.b[735]) {
        let ta: f64 = (s.v[123] - s.v[185]);let tb: f64 = (ta + s.v[320]);let tc: f64 = (tb + s.v[515]);
        (tc,)
    } else {
        (s.v[160],)
    }
};
        s.store_scalar(160, td);s.b[1066] = (s.v[158] < s.v[160]);s.store_scalar(1066, if s.b[1066] { 1.0 } else { 0.0 });
        let (tf,) = {
    if ((!s.b[735]) && s.b[1066]) {
        let te: f64 = (-1.0);
        (te,)
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        s.b[1072] = ((p[25] == 1.0) && (p[26] == 2.0));s.store_scalar(1072, if s.b[1072] { 1.0 } else { 0.0 });
        ...
        if (!s.b[735]) {s.store_exp_mul(486, 225, 515);s.store_mul(487, 379, 486);}
        let (t10,) = {
    if (!s.b[735]) {
        (0.0,)
    } else {
        ...
        s.store_scalar(430, t10);
        if (!s.b[735]) {s.copy_ad(349, 161);s.store_scale(419, 229, ((p[237] * (p[237] * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_34(
        ...
        let mut t18: usize = 0;
        while {
            let t16: f64 = (s.v[57] + 1.0);let t17: f64 = if ((!s.b[735]) && (s.v[167] <= t16)) { 1.0 } else { 0.0 };
            t17 != 0.0
        } {
    ...
    if ((!s.b[735]) && s.b[1077]) {
        ...
        (s.v[338],)
            ...
            s.store_scalar(338, t12);s.b[1078] = (s.v[338] == (-1.0));s.store_scalar(1078, if s.b[1078] { 1.0 } else { 0.0 });
            if ((!s.b[735]) && s.b[1078]) {s.store_scalar(401, 0.0);}
            if ((!s.b[735]) && (!s.b[1078])) {s.store_mul(401, 444, 242);}
            s.b[1079] = (s.v[401] < (p[237] * 1.01));s.store_scalar(1079, if s.b[1079] { 1.0 } else { 0.0 });
            let (t13,) = {
    if ((!s.b[735]) && s.b[1079]) {
        (1.0,)
    } else {
    ...
    if ((!s.b[735]) && s.b[1086]) {
        ...
        s.store_scalar(145, t1b);
        if ((!s.b[735]) && s.b[1086]) {s.copy_ad(352, 349);s.copy_ad(162, 161);s.copy_ad(314, 162);}
        let (t1c,) = {
    if ((!s.b[735]) && s.b[1086]) {
        (1.0,)
    } else {
        ...
        s.store_scalar(612, t1c);s.b[1087] = (s.v[612] == 0.0);s.store_scalar(1087, if s.b[1087] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[735]) && s.b[1087]) && s.b[1095]) {s.store_sub(44, 332, 1091);s.store_square(49, 44);s.store_square(50, 332);s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);}
        let (t1d,) = {
    ...
    if (((!s.b[735]) && s.b[1087]) && s.b[1095]) {
        ...
        if (((!s.b[735]) && s.b[1087]) && s.b[1095]) {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if (((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) && s.b[1097]) {
        ...
        s.store_scalar(55, t1f);s.b[1098] = (4.0 == 2.0);s.store_scalar(1098, if s.b[1098] { 1.0 } else { 0.0 });
        let (t20,) = {
    if ((((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) && (!s.b[1097])) && s.b[1098]) {
        ...
        s.store_scalar(55, t20);s.b[1099] = (4.0 == 4.0);s.store_scalar(1099, if s.b[1099] { 1.0 } else { 0.0 });
        let (t21,) = {
    if (((((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) && (!s.b[1097])) && (!s.b[1098])) && s.b[1099]) {
        ...
        s.store_scalar(55, t21);s.b[1100] = (4.0 == 8.0);s.store_scalar(1100, if s.b[1100] { 1.0 } else { 0.0 });
        let (t22,) = {
    ...
    if ((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) {
        ...
        while {
            let t26: f64 = if (((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
            t27 += 1;assert!(t27 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) {s.store_sqrt(53, 53);}
            let (t25,) = {
    if ((((!s.b[735]) && s.b[1087]) && s.b[1095]) && s.b[1096]) {
        ...
        if (((!s.b[735]) && s.b[1087]) && s.b[1102]) {s.store_scalar(164, 0.0);s.copy_ad(162, 161);}
        let (t28,) = {
    if (((!s.b[735]) && s.b[1087]) && s.b[1102]) {
        ...
        s.store_scalar(430, t28);s.b[1103] = (s.v[144] >= 1.0);s.store_scalar(1103, if s.b[1103] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[735]) && s.b[1087]) && (!s.b[1102])) {s.copy_ad(164, 165);s.store_add(162, 161, 164);}
        let (t29,) = {
    if (((!s.b[735]) && s.b[1087]) && (!s.b[1102])) {
        (0.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        let mut t2d: usize = 0;
        while {
            let t2b: f64 = (s.v[58] + 1.0);let t2c: f64 = if (((!s.b[735]) && s.b[1087]) && (s.v[168] <= t2b)) { 1.0 } else { 0.0 };
            t2c != 0.0
        } {
    ...
    if ((!s.b[735]) && s.b[1087]) {
        ...
        if ((!s.b[735]) && s.b[1087]) {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if ((((!s.b[735]) && s.b[1087]) && s.b[1121]) && s.b[1122]) {
        ...
        s.store_scalar(55, t30);s.b[1123] = (4.0 == 2.0);s.store_scalar(1123, if s.b[1123] { 1.0 } else { 0.0 });
        let (t31,) = {
    if (((((!s.b[735]) && s.b[1087]) && s.b[1121]) && (!s.b[1122])) && s.b[1123]) {
        ...
        s.store_scalar(55, t31);s.b[1124] = (4.0 == 4.0);s.store_scalar(1124, if s.b[1124] { 1.0 } else { 0.0 });
        let (t32,) = {
    if ((((((!s.b[735]) && s.b[1087]) && s.b[1121]) && (!s.b[1122])) && (!s.b[1123])) && s.b[1124]) {
        ...
        s.store_scalar(55, t32);s.b[1125] = (4.0 == 8.0);s.store_scalar(1125, if s.b[1125] { 1.0 } else { 0.0 });
        let (t33,) = {
    ...
    if (((!s.b[735]) && s.b[1087]) && s.b[1121]) {
        ...
        s.store_scalar(54, t34);let mut t38: usize = 0;
        while {
            let t37: f64 = if ((((!s.b[735]) && s.b[1087]) && s.b[1121]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t37 != 0.0
        } {
            t38 += 1;assert!(t38 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((!s.b[735]) && s.b[1087]) && s.b[1121]) {s.store_sqrt(53, 53);}
            let (t36,) = {
    if (((!s.b[735]) && s.b[1087]) && s.b[1121]) {
    ...
    pub(super) fn stamp_transient_block_40(
        ...
        s.b[1134] = (s.v[145] == 0.0);s.store_scalar(1134, if s.b[1134] { 1.0 } else { 0.0 });s.b[1150] = ((p[190] < (10.0 * 2.220446049250313e-16)) && (p[191] < (10.0 * 2.220446049250313e-16)));s.store_scalar(1150, if s.b[1150] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1131] && s.b[1134]) && (!s.b[1150])) {s.store_scalar(1149, (if (p[43] == 1.0) { p[237] } else { s.v[402] }));}
        if ((s.b[1131] && s.b[1134]) && (!s.b[1150])) {s.store_primal_div_from_scalar(1135, 1.0, 1149);s.store_mul(1136, 244, 1135);s.store_scale(1137, 1136, p[191]);s.store_add_scaled_product_indices(1140, 1137, 1.0, 80, 229, 1.0);s.store_div_from_scalar(1136, 1.0, 1140);s.store_scale(1139, 1136, 1.034943e-10);s.store_scalar(1136, (1.0 - p[189]));s.store_add_scaled_inputs_product_indices(314, 157, p[189], 161, p[189], 1136, 162, 1.0);}
        ...
        s.b[1156] = (p[43] == 0.0);s.store_scalar(1156, if s.b[1156] { 1.0 } else { 0.0 });
        ...
        if s.b[1131] {s.store_scaled_sub(1157, 157, 164, 0.5);s.store_scale(44, 1157, (2.0 * 1.0 / (p[227])));s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(177, p[227], 45);}
        ...
        if s.b[1131] {s.store_add(176, 161, 177);s.store_scalar(1168, (1.034943e-10 / 100.0));s.store_scale(1169, 437, 0.0001);s.store_scale(1170, 436, 0.0001);s.store_div_from_scalar(1159, p[92], 1168);s.store_primal_div_from_scalar(1160, p[93], 1168);s.store_scalar(1161, p[94]);s.store_offset_mul_ad(1162, A::sub(s.ad_value(162), s.ad_value(161)), s.ad_value(1161), 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_41(
        ...
        if s.b[1131] {s.store_add_scaled_products_indices(1163, 1159, 1169, 1.0, 1160, 1170, 1.0);s.store_div(1164, 1163, 1162);s.copy_ad(248, 1164);s.store_sqrt_square_offset(44, 248, ((4.0 * 3000.0) * 3000.0));s.store_offset_add_scaled_inputs_indices(1161, 248, 0.5, 44, 0.5, (1e-10 * 3000.0));}
        s.b[1171] = (s.v[1161] < 0.0);s.store_scalar(1171, if s.b[1171] { 1.0 } else { 0.0 });
        if (s.b[1131] && s.b[1171]) {s.store_scalar(1161, 0.0);}
        if s.b[1131] {s.store_powf(1163, 1161, (p[97] - 1.0));s.store_mul(1165, 1163, 1161);s.store_powf(1166, 1161, (s.v[111] - 1.0));s.store_mul(1167, 1166, 1161);s.store_scale(249, 1170, 6.241449993689894e18);s.store_add_scaled_inputs_mixed_ai(1159, A::add_scaled_product(A::div_from_scalar(1.0, A::scale_offset(s.ad_value(249), (p[96] * 1e-11), p[95])), 1.0, s.ad_value(543), s.ad_value(1165), 1.0), 1.0, 1167, 1.0 / (p[106]));s.store_div_from_scalar(251, 1.0, 1159);s.store_scale(251, 251, 0.0001);s.store_mul3_lhs(1172, 225, 244, 441);s.store_sqrt_square_offset(44, 1172, ((4.0 * 1e-50) * 1e-50));s.store_offset_add_scaled_inputs_indices(1172, 1172, 0.5, 44, 0.5, (1e-10 * 1e-50));}
        ...
        if ((s.b[1131] && (!s.b[1181])) && (!s.b[1182])) {s.store_powf(1176, 1173, (p[113] - 1.0));}
        ...
        if ((s.b[1131] && (!s.b[1183])) && (!s.b[1184])) {s.store_powf(1179, 1177, (((-1.0) / p[113]) - 1.0));s.store_mul(1178, 1177, 1179);}
        ...
        s.b[1194] = ((p[281] > 0.0) && (p[244] != 0.0));s.store_scalar(1194, if s.b[1194] { 1.0 } else { 0.0 });
        ...
        if (s.b[1131] && s.b[1194]) {s.store_scale(1186, 225, s.v[116]);s.store_mul(1187, 323, 1186);s.store_powf(1186, 1193, p[245]);s.store_mul(1188, 1187, 1186);s.store_offset_scaled(1189, 173, p[246], 1.0);s.store_scalar(1186, s.v[117]);}
        s.b[1196] = ((s.v[56] < 3.0) || (p[43] == 1.0));s.store_scalar(1196, if s.b[1196] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (s.b[1131] && s.b[1208]) {s.store_sqrt_offset_input(213, 1199, 1e-50);s.store_add_mul_sub_from_scalar_rhs_indices(215, 207, 211, 1.0, 213);s.store_div_from_scalar_add_ad(327, 1.0, s.ad_value(225), A::div_scalar_offset_denominator(2.0, s.ad_value(207), 1e-50, 1.0));s.store_mul_ln_mixed_ia(216, 327, A::mul(A::div_scalar_by_product(1.0, s.ad_value(209), s.ad_value(210), 1.0), A::square(s.ad_value(207))));s.store_div_scaled_value_offset_denominator(1202, s.ad_value(216), 1.0, s.ad_value(207), 1e-50, 1.0);s.store_offset_sub(217, 216, 215, (-0.002));s.store_sqrt_add_scaled_square_input(327, 217, 1.0, 216, (4.0 * 0.002));s.store_add_scaled_inputs3_indices(218, 216, 1.0, 217, (-0.5), 327, (-0.5));s.store_div_from_scalar(1199, 1.0, 327);s.store_mul_exp_mixed_ia(327, 209, A::mul(s.ad_value(225), s.ad_value(218)));s.store_add_offset_lhs_mixed_ai(1200, A::mul(s.ad_value(225), A::sub(s.ad_value(218), s.ad_value(514))), (-1.0), 327);s.store_sqrt_square_offset(44, 1200, ((4.0 * 0.01) * 0.01));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_43(
        ...
        if (s.b[1131] && s.b[1208]) {s.store_offset_add_scaled_inputs_indices(1199, 1200, 0.5, 44, 0.5, (1e-10 * 0.01));}
    ...
    if (((s.b[1131] && s.b[1208]) && s.b[1213]) && s.b[1214]) {
        ...
        s.store_scalar(55, t3b);s.b[1215] = (4.0 == 2.0);s.store_scalar(1215, if s.b[1215] { 1.0 } else { 0.0 });
        let (t3c,) = {
    if ((((s.b[1131] && s.b[1208]) && s.b[1213]) && (!s.b[1214])) && s.b[1215]) {
        ...
        s.store_scalar(55, t3c);s.b[1216] = (4.0 == 4.0);s.store_scalar(1216, if s.b[1216] { 1.0 } else { 0.0 });
        let (t3d,) = {
    if (((((s.b[1131] && s.b[1208]) && s.b[1213]) && (!s.b[1214])) && (!s.b[1215])) && s.b[1216]) {
        ...
        s.store_scalar(55, t3d);s.b[1217] = (4.0 == 8.0);s.store_scalar(1217, if s.b[1217] { 1.0 } else { 0.0 });
        let (t3e,) = {
    ...
    if ((s.b[1131] && s.b[1208]) && s.b[1213]) {
        ...
        s.store_scalar(54, t3f);let mut t43: usize = 0;
        while {
            let t42: f64 = if (((s.b[1131] && s.b[1208]) && s.b[1213]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t42 != 0.0
        } {
            ...
            let (t41,) = {
    if ((s.b[1131] && s.b[1208]) && s.b[1213]) {
        let t40: f64 = (s.v[54] + 1.0);
        (t40,)
    } else {
        (s.v[54],)
    }
};
            s.store_scalar(54, t41);
        }
    ...
    if ((s.b[1131] && s.b[1218]) && (!s.b[1221])) {
        ...
        s.store_scalar(146, t45);s.copy_ad(202, 199);s.store_scalar(204, 0.0);s.b[1222] = ((p[281] > 0.0) && (p[285] > 0.0));s.store_scalar(1222, if s.b[1222] { 1.0 } else { 0.0 });
        ...
        let (t47,) = {
    if s.b[1222] {
        let t46: f64 = (s.v[182] + p[286]);
        (t46,)
    } else {
        (s.v[1235],)
    }
};
        s.store_scalar(1235, t47);
    ...
    if (s.b[1222] && s.b[1251]) {
        ...
        s.store_scalar(144, t49);s.b[1252] = ((s.v[144] == 0.0) || (1.0 != 0.0));s.store_scalar(1252, if s.b[1252] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        if ((s.b[1222] && s.b[1252]) && s.b[1253]) {s.store_add_scaled_inputs_mixed_ai(336, A::sub_from_scalar(3.0, A::div_scaled_inputs(s.ad_value(329), 1.259921049894873, s.ad_value(332), 3.0)), 1.0, 332, (1.0 / (3.0 * 1.259921049894873)));s.store_add_scaled_product_indices(376, 1249, 1.0, 336, 227, 1.0);s.copy_ad(378, 376);}
    ...
    if (((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) && s.b[1261]) {
        ...
        s.store_scalar(55, t4c);s.b[1262] = (2.0 == 2.0);s.store_scalar(1262, if s.b[1262] { 1.0 } else { 0.0 });
        let (t4d,) = {
    if ((((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) && (!s.b[1261])) && s.b[1262]) {
        ...
        s.store_scalar(55, t4d);s.b[1263] = (2.0 == 4.0);s.store_scalar(1263, if s.b[1263] { 1.0 } else { 0.0 });
        let (t4e,) = {
    if (((((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) && (!s.b[1261])) && (!s.b[1262])) && s.b[1263]) {
        ...
        s.store_scalar(55, t4e);s.b[1264] = (2.0 == 8.0);s.store_scalar(1264, if s.b[1264] { 1.0 } else { 0.0 });
        let (t4f,) = {
    ...
    if ((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) {
        ...
        s.store_scalar(54, t50);let mut t54: usize = 0;
        while {
            let t53: f64 = if (((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t53 != 0.0
        } {
            t54 += 1;assert!(t54 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) {s.store_sqrt(53, 53);}
            let (t52,) = {
    if ((((((s.b[1222] && s.b[1252]) && s.b[1256]) && (!s.b[1257])) && s.b[1258]) && s.b[1259]) && s.b[1260]) {
        let t51: f64 = (s.v[54] + 1.0);
        (t51,)
    } else {
        (s.v[54],)
    }
};
            s.store_scalar(54, t52);
        }
        ...
        if (s.b[1222] && (0.0 != 0.0)) {s.store_offset_scaled(44, 166, (1.0 + 0.3), (((-p[287])) + ((-0.03))));s.store_scale(45, 166, ((1.0 + 0.3) * (4.0 * 0.03)));}
        if (s.b[1222] && (0.0 != 0.0)) {
            if (s.v[45] > 0.0) {
            } else {
                s.store_neg(45, 45);
    ...
    if (s.b[1222] && s.b[1268]) {
        let t55: f64 = (s.v[123] - s.v[185]);let t56: f64 = (t55 + s.v[320]);let t57: f64 = (t56 + s.v[1269]);let t58: f64 = (t57 + p[286]);
        (t58,)
    } else {
        (s.v[160],)
    }
};
        s.store_scalar(160, t59);s.b[1271] = (s.v[158] < s.v[160]);s.store_scalar(1271, if s.b[1271] { 1.0 } else { 0.0 });
        let (t5b,) = {
