...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_80(
        ...
        let mut t6: usize = 0;
        while {
            let t3: f64 = (2.0 * 20.0);let t4: f64 = (t3 + 1.0);let t5: f64 = if ((((((p[24] != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) && (s.v[167] <= t4)) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
            t6 += 1;
            ...
            let (t2,) = {
    if (((((((p[24] != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) && (!s.b[1638])) && s.b[1640]) {
        (1.0,)
    } else {
        (s.v[1544],)
    }
};
            s.store_scalar(1544, t2);
    ...
    pub(super) fn stamp_transient_block_81(
        ...
        if (((((p[24] != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) {s.store_mul(458, 1554, 1603);s.store_div_from_scalar_add_ad(1522, 1.0, s.ad_value(1595), s.ad_value(1603));s.store_mul3_lhs(460, 1554, 1591, 1522);s.store_add(459, 458, 460);}
    ...
    pub(super) fn stamp_transient_block_82(
        ...
        if s.b[1654] {s.store_scaled_mul(1678, 285, 1672, p[237]);s.store_scaled_mul(1680, 285, 1673, p[237]);s.store_scale(1656, 429, 1.0 / (s.v[81]));s.store_square(1655, 1656);s.store_offset(1657, 1677, 1e-50);s.store_offset(1658, 1678, 1e-50);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1675, p[174], 225, A::ln_offset_div_scaled_inputs(s.ad_value(1655), p[177], s.ad_value(1657), 1.0, 1.0));s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1676, p[174], 225, A::ln_offset_div_scaled_inputs(s.ad_value(1655), p[177], s.ad_value(1658), 1.0, 1.0));s.store_scale(1674, 227, p[174]);}
    ...
    pub(super) fn stamp_transient_block_84(
        ...
        s.b[1707] = (s.v[1670] < 0.0);s.store_scalar(1707, if s.b[1707] { 1.0 } else { 0.0 });s.b[1708] = (s.v[1664] > 0.0);s.store_scalar(1708, if s.b[1708] { 1.0 } else { 0.0 });
        ...
        s.b[1719] = (s.v[145] == 0.0);s.store_scalar(1719, if s.b[1719] { 1.0 } else { 0.0 });
        if ((s.v[85] != 0.0) && s.b[1719]) {s.store_scalar(1714, p[233]);s.store_scalar(1715, p[234]);s.copy_ad(1716, 441);s.store_mul_product3_indices(1717, 1716, 1714, 1715, 1716, 1.0);s.store_offset_add_ad(1718, A::mul3(s.ad_value(250), s.ad_value(192), s.ad_value(1714)), A::mul3(s.ad_value(1715), s.ad_value(1716), s.ad_value(1716)), 1e-50);s.store_div(289, 1717, 1718);}
        if ((s.v[85] != 0.0) && (!s.b[1719])) {s.store_scalar(289, (p[233] + 1e-50));}
        if (s.v[85] != 0.0) {s.store_scalar(1717, p[235]);s.store_mul(290, 1717, 323);}
    ...
    pub(super) fn stamp_transient_block_85(
        ...
        if s.b[1749] {s.store_sqrt(298, 296);s.store_add(1738, 192, 298);s.store_square(1739, 294);s.store_square(1740, 296);s.store_scaled_mul(1741, 294, 296, 42.0);s.store_add_scaled_inputs3_indices(1741, 1741, 1.0, 1739, 4.0, 1740, 4.0);s.store_add_product3_rhs_mixed_iia(1741, 1741, 298, 192, A::add(s.ad_value(294), s.ad_value(296)), 20.0);s.store_square(1742, 1738);s.store_square(1734, 1742);s.store_div_scaled_value_by_product_indices(299, 1741, 1.0, 1734, 1738, 1.0);s.store_mul_ad_product_lhs_mixed_ai(300, A::div(s.ad_value(107), s.ad_value(441)), 250, 323);s.store_mul(1744, 300, 192);s.store_div(1745, 292, 1744);s.store_add_mixed_ai(1743, A::add_scaled_product(s.ad_value(294), 1.0, s.ad_value(192), s.ad_value(298), 4.0), 296);s.store_div_scaled_product_by_product_mixed_iiia(301, 297, 1743, 3.872983346207417, 1738, A::sqrt(A::mul(A::mul3(s.ad_value(1745), s.ad_value(1738), s.ad_value(192)), s.ad_value(1741))), 6.0);}
    ...
    pub(super) fn stamp_transient_block_86(
        ...
        if ((s.v[85] != 0.0) && s.b[1751]) {s.store_scalar(25, 0.0);s.copy_ad(556, 438);s.store_scale(588, 196, s.v[451]);s.store_scale(587, 197, s.v[451]);}
        if ((s.v[85] != 0.0) && (!s.b[1751])) {s.store_scalar(554, 0.0);s.store_scale(588, 392, s.v[451]);s.store_scaled_add(576, 198, 477, s.v[451]);s.store_add_scaled_inputs3_indices(577, 197, s.v[451], 198, ((-1.0) * s.v[451]), 476, s.v[451]);}
        ...
        if ((s.v[85] == 0.0) && (!s.b[1752])) {s.store_add_scaled_inputs4_indices(23, 392, (-s.v[451]), 197, ((-1.0) * s.v[451]), 476, (-s.v[451]), 477, (-s.v[451]));s.store_scaled_add(24, 198, 477, s.v[451]);s.store_add_scaled_inputs3_indices(25, 197, s.v[451], 198, ((-1.0) * s.v[451]), 476, s.v[451]);}
        ...
        s.store_scale(15, 308, (-s.v[451]));s.b[1765] = (s.v[613] == 1.0);s.store_scalar(1765, if s.b[1765] { 1.0 } else { 0.0 });
        if s.b[1765] {s.store_add_scaled_product_indices(13, 307, ((-1.0) * s.v[451]), 310, 309, s.v[451]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_87(
        ...
        if (!s.b[1765]) {s.store_scaled_sub_mixed_ai(13, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(310), s.ad_value(309)), 306, s.v[451]);}
        s.b[1766] = (s.v[613] == 1.0);s.store_scalar(1766, if s.b[1766] { 1.0 } else { 0.0 });
        if s.b[1766] {s.store_scaled_sub_mixed_ai(14, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(310), s.ad_value(309)), 306, s.v[451]);}
        if (!s.b[1766]) {s.store_add_scaled_product_indices(14, 307, ((-1.0) * s.v[451]), 310, 309, s.v[451]);}
        if (s.v[613] == 1.0) {
    ...
    if s.b[1773] {
        ...
        s.store_scalar(1767, t12);
        if s.b[1773] {s.store_scale(1768, 555, 1.0 / (s.v[451]));s.store_div_scaled_product3_indices(1769, 227, 1768, 1768, (0.1185185185185185 * 1.6021918e-19), 300, 1.0);}
        ...
        if (s.b[1773] && s.b[1774]) {s.store_div(1770, 251, 250);s.store_div_scaled_inputs2_mixed_aii(1771, A::div(s.ad_value(251), s.ad_value(293)), 1.0, 1770, (-1.0), 157, 1.0);s.store_add_mixed_ia(1772, 1770, A::div_scaled_product(s.ad_value(1771), A::add(A::add_scaled_product(s.ad_value(294), 1.0, s.ad_value(192), s.ad_value(298), 1.0), s.ad_value(296)), 0.6666666666666667, A::add(s.ad_value(192), s.ad_value(298)), 1.0));}
        if (s.b[1773] && (!s.b[1774])) {s.store_div(1772, 251, 293);}
        if s.b[1773] {s.store_mul3_affine_lhs(558, 1769, 299, s.v[451], 0.0, 1772);s.copy_ad(559, 301);}
        if s.b[1773] {
        ...
        if (!s.b[1773]) {s.store_scalar(558, 0.0);s.store_scalar(559, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_88(
        ...
        s.store_scalar(4, 0.0);s.store_scalar(5, 0.0);s.b[1775] = (p[259] == 1.0);s.store_scalar(1775, if s.b[1775] { 1.0 } else { 0.0 });
        let (t13,) = {
    if s.b[1775] {
        (1.0,)
    } else {
        ...
        s.store_scalar(3, t13);s.b[1795] = (s.v[3] == 1.0);s.store_scalar(1795, if s.b[1795] { 1.0 } else { 0.0 });
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1786, (p[264] / 1e-6));s.store_scalar(1779, p[266]);s.store_scalar(1780, p[268]);s.store_scalar(1781, p[273]);}
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1782, (if (p[263] > 0.0) { (p[263] * p[255]) } else { 0.0 }));}
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1785, p[258]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_89(
        ...
        if (s.b[1775] && s.b[1795]) {s.store_scaled_voltage(1783, ctx, nodes, Some(7), Some(2), p[50]);}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1786, (p[59] / 1e-6));s.store_scalar(1779, p[265]);s.store_scalar(1780, p[267]);s.store_scalar(1781, p[272]);}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1782, (if (p[263] > 0.0) { (p[263] * p[256]) } else { 0.0 }));}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1785, p[257]);s.store_scaled_voltage(1783, ctx, nodes, Some(0), Some(6), p[50]);}
        if s.b[1775] {s.store_scalar(1792, ((((p[271] * p[271]) + (p[56] * p[56]))) as f64).sqrt());s.store_primal_scale(1794, 105, p[9]);s.store_primal_scale(1779, 1779, 0.0001);s.store_primal_scale(1780, 1780, 0.01);s.store_scale(1784, 429, 1.0 / (s.v[81]));s.store_powf(328, 1784, p[269]);s.store_div(1787, 1779, 328);s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1784), 0.4, 1.8), 1.0, s.ad_value(1784), s.ad_value(1784), 0.1), A::scale_offset(s.ad_value(1784), (-p[270]), p[270]));s.store_div(1788, 1780, 327);s.store_add_mixed_ia(1781, 1781, A::scaled_offset(s.ad_value(429), (-s.v[81]), p[274]));s.store_scalar(1776, (1.0 + (p[279] / ((s.v[100]) as f64).powf(p[280]))));s.store_scalar(1778, (1.0 + (p[277] / ((s.v[100]) as f64).powf(p[278]))));s.store_scalar(1777, (1.0 + (p[275] / ((s.v[109]) as f64).powf(p[276]))));s.store_mul(1787, 1787, 1776);s.store_offset_product3(1788, s.ad_value(1788), s.ad_value(1777), s.ad_value(1778), 1.0, 1e-50);s.store_div(1789, 1783, 1785);s.store_mul(1790, 1787, 1789);}
    ...
    if s.b[1803] {
        ...
        s.store_scalar(3, t14);s.b[1823] = (s.v[3] == 1.0);s.store_scalar(1823, if s.b[1823] { 1.0 } else { 0.0 });
        if (s.b[1803] && s.b[1823]) {s.store_scalar(1814, (p[264] / 1e-6));s.store_scalar(1807, p[266]);s.store_scalar(1808, p[268]);s.store_scalar(1809, p[273]);}
        if (s.b[1803] && s.b[1823]) {s.store_scalar(1810, (if (p[263] > 0.0) { (p[263] * p[255]) } else { 0.0 }));}
        if (s.b[1803] && s.b[1823]) {s.store_scalar(1813, p[258]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_91(
        ...
        if (s.b[1803] && (!s.b[1823])) {s.store_scalar(1814, (p[59] / 1e-6));s.store_scalar(1807, p[265]);s.store_scalar(1808, p[267]);s.store_scalar(1809, p[272]);}
        if (s.b[1803] && (!s.b[1823])) {s.store_scalar(1810, (if (p[263] > 0.0) { (p[263] * p[256]) } else { 0.0 }));}
        if (s.b[1803] && (!s.b[1823])) {s.store_scalar(1813, p[257]);s.store_scaled_voltage(1811, ctx, nodes, Some(0), Some(6), p[50]);}
        if s.b[1803] {s.store_scalar(1820, ((((p[271] * p[271]) + (p[56] * p[56]))) as f64).sqrt());s.store_primal_scale(1822, 105, p[9]);s.store_primal_scale(1807, 1807, 0.0001);s.store_primal_scale(1808, 1808, 0.01);s.store_scale(1812, 429, 1.0 / (s.v[81]));s.store_powf(328, 1812, p[269]);s.store_div(1815, 1807, 328);s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1812), 0.4, 1.8), 1.0, s.ad_value(1812), s.ad_value(1812), 0.1), A::scale_offset(s.ad_value(1812), (-p[270]), p[270]));s.store_div(1816, 1808, 327);s.store_add_mixed_ia(1809, 1809, A::scaled_offset(s.ad_value(429), (-s.v[81]), p[274]));s.store_scalar(1804, (1.0 + (p[279] / ((s.v[100]) as f64).powf(p[280]))));s.store_scalar(1806, (1.0 + (p[277] / ((s.v[100]) as f64).powf(p[278]))));s.store_scalar(1805, (1.0 + (p[275] / ((s.v[109]) as f64).powf(p[276]))));s.store_mul(1815, 1815, 1804);s.store_offset_product3(1816, s.ad_value(1816), s.ad_value(1805), s.ad_value(1806), 1.0, 1e-50);s.store_div(1817, 1811, 1813);s.store_mul(1818, 1815, 1817);}
        ...
        s.b[1831] = (p[43] == 1.0);s.store_scalar(1831, if s.b[1831] { 1.0 } else { 0.0 });s.b[1832] = (s.v[289] < (1e-15 / 0.0001));s.store_scalar(1832, if s.b[1832] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_92(
        ...
        if ((!s.b[1831]) && (s.v[85] == 0.0)) {s.store_scalar(574, 0.0);s.store_scalar(575, 0.0);s.store_scalar(583, 0.0);s.store_scalar(584, 0.0);s.store_scalar(585, 0.0);s.store_scalar(586, 0.0);s.store_scalar(581, 0.0);}
        ...
        s.copy_ad(307, 13);s.copy_ad(306, 14);s.copy_ad(308, 15);s.copy_ad(311, 11);s.copy_ad(312, 12);s.b[1837] = (p[43] == 1.0);s.store_scalar(1837, if s.b[1837] { 1.0 } else { 0.0 });
        ...
        s.store_scale(610, 429, (4.0 * 1.3806226e-23));s.b[1846] = (p[27] == 1.0);s.store_scalar(1846, if s.b[1846] { 1.0 } else { 0.0 });s.copy_ad(438, 439);s.store_mul(615, 610, 598);s.copy_ad(614, 559);
        ...
        s.b[1847] = (p[27] == 1.0);s.store_scalar(1847, if s.b[1847] { 1.0 } else { 0.0 });s.b[1848] = ((p[38] > 0.0) && (p[242] > 0.0));s.store_scalar(1848, if s.b[1848] { 1.0 } else { 0.0 });
        if s.b[1848] {s.copy_ad(595, 578);}
        s.b[1849] = (p[43] == 1.0);s.store_scalar(1849, if s.b[1849] { 1.0 } else { 0.0 });s.b[1850] = ((p[37] != 0.0) || ((p[25] == 1.0) && (p[26] == 2.0)));s.store_scalar(1850, if s.b[1850] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_93(
        ...
        s.b[1851] = (p[43] == 0.0);s.store_scalar(1851, if s.b[1851] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
