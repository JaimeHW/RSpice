...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if s.b[1222] {
            ...
            s.store_div_scaled_product_denominator_ad(1223, 1224, 1224, (-0.25), A::add(s.ad_value(157), s.ad_value(1224)), 1.0);
            s.copy_ad(1249, 1223);
            s.copy_ad(1250, 1235);
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1222] && s.b[1268]) {
            s.copy_ad(378, 1232);
            s.copy_ad(1269, 1223);
            s.store_offset_add_scaled_inputs3_offset(160, s.ad_value(185), (-1.0), s.ad_value(320), 1.0, s.ad_value(1269), 1.0, s.v[123], p.p286);
        }
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if (s.b[1727] && s.b[1728]) {
            ...
            s.store_add_scaled_product_mixed_aai(1723, assign33540_ad_e48672, 1.0, A::mul3(A::mul3(s.ad_value(1724), s.ad_value(252), s.ad_value(250)), s.ad_value(1724), s.ad_value(252)), 250, 1.0);
        }
