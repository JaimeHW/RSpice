...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_64(
        ...
        if (((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) {s.store_offset_scaled(1547, 1528, -1.0, (-1e-12));s.store_scale(1555, 1554, s.v[1533]);s.store_square(1556, 1555);s.store_sub_from_scalar(1557, s.v[82], 1553);s.store_div_from_scalar(1521, s.v[69], 230);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1558, 2.0, 225, A::ln(s.ad_value(1521)));}
        let (t1,) = {
    if (((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) {
        ...
        s.store_scalar(1559, t1);s.b[1608] = (s.v[1557] < s.v[1559]);s.store_scalar(1608, if s.b[1608] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_66(
        ...
        if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1608])) && s.b[1615]) {s.store_exp_ad(1588, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1547), -1.0));s.store_scale(1521, 230, 1.0 / (s.v[69]));s.store_square(1582, 1521);s.store_mul(1597, 1582, 1588);}
        let (t2,) = {
    if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1608])) && s.b[1615]) {
        ...
        if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1608])) && s.b[1615]) {s.store_scalar(1591, 0.0);s.store_scalar(1595, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    ...
    if (((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) {
        ...
        s.store_scalar(1559, t9);s.b[1628] = (s.v[1557] < s.v[1559]);s.store_scalar(1628, if s.b[1628] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_69(
        ...
        if ((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && s.b[1628]) {s.store_sub_from_scalar_scaled_mul_mixed_ia(1563, (7.0 * 1.414213562373095), 1531, A::offset(s.ad_value(1530), (-2.0)), 9.0);s.store_square(1564, 1563);}
    ...
    pub(super) fn stamp_transient_block_71(
        ...
        if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) {s.store_exp_ad(1588, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1547), -1.0));s.store_scale(1521, 230, 1.0 / (s.v[69]));s.store_square(1582, 1521);s.store_mul(1597, 1582, 1588);}
        let (ta,) = {
    if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) {
        ...
        s.store_scalar(1544, ta);
        if (((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) {s.store_scalar(1591, 0.0);s.store_scalar(1595, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_72(
        ...
        let mut tf: usize = 0;
        while {
            let tc: f64 = (2.0 * 20.0);let td: f64 = (tc + 1.0);let te: f64 = if ((((((p.p24 != 0.0) && s.b[1604]) && (!s.b[1605])) && (!s.b[1628])) && s.b[1635]) && (s.v[167] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if ((s.v[85] != 0.0) && s.b[1719]) {s.store_scalar(1714, p.p233);s.store_scalar(1715, p.p234);s.copy_ad(1716, 441);s.store_mul_product3_indices(1717, 1716, 1714, 1715, 1716, 1.0);s.store_offset_add_ad(1718, A::mul3(s.ad_value(250), s.ad_value(192), s.ad_value(1714)), A::mul3(s.ad_value(1715), s.ad_value(1716), s.ad_value(1716)), 1e-50);s.store_div(289, 1717, 1718);}
        if ((s.v[85] != 0.0) && (!s.b[1719])) {s.store_scalar(289, (p.p233 + 1e-50));}
        if (s.v[85] != 0.0) {s.store_scalar(1717, p.p235);s.store_mul(290, 1717, 323);}
    ...
    if s.b[1773] {
        ...
        s.store_scalar(4, 0.0);s.store_scalar(5, 0.0);s.b[1775] = (p.p259 == 1.0);s.store_scalar(1775, if s.b[1775] { 1.0 } else { 0.0 });
        let (t1c,) = {
    if s.b[1775] {
        (1.0,)
    } else {
        ...
        s.store_scalar(3, t1c);s.b[1795] = (s.v[3] == 1.0);s.store_scalar(1795, if s.b[1795] { 1.0 } else { 0.0 });
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1786, (p.p264 / 1e-6));s.store_scalar(1779, p.p266);s.store_scalar(1780, p.p268);s.store_scalar(1781, p.p273);}
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1782, (if (p.p263 > 0.0) { (p.p263 * p.p255) } else { 0.0 }));}
        if (s.b[1775] && s.b[1795]) {s.store_scalar(1785, p.p258);s.store_scaled_voltage(1783, ctx, nodes, Some(7), Some(2), p.p50);}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1786, (p.p59 / 1e-6));s.store_scalar(1779, p.p265);s.store_scalar(1780, p.p267);s.store_scalar(1781, p.p272);}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1782, (if (p.p263 > 0.0) { (p.p263 * p.p256) } else { 0.0 }));}
        if (s.b[1775] && (!s.b[1795])) {s.store_scalar(1785, p.p257);s.store_scaled_voltage(1783, ctx, nodes, Some(0), Some(6), p.p50);}
        if s.b[1775] {s.store_scalar(1792, ((((p.p271 * p.p271) + (p.p56 * p.p56))) as f64).sqrt());s.store_primal_scale(1794, 105, p.p9);s.store_primal_scale(1779, 1779, 0.0001);s.store_primal_scale(1780, 1780, 0.01);s.store_scale(1784, 429, 1.0 / (s.v[81]));s.store_powf(328, 1784, p.p269);s.store_div(1787, 1779, 328);}
    }
}
