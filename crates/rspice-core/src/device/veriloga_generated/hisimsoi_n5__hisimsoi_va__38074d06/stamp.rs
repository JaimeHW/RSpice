...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        let v66: f64 = nv14;
        let v69: f64 = (v5 * v48);
        let v70: f64 = (if self.scalar_v59 { v69 } else { v1 });
        let v72: f64 = (v19 * v48);
        let v73: f64 = (if self.scalar_v71 { v72 } else { v1 });
        let v78: f64 = nv9;
        let v79: f64 = (v78 - v36);
        let v80: f64 = (self.scalar_v34 * v79);
        let v81: f64 = (if self.scalar_v77 { v80 } else { v1 });
        let v82: f64 = nv8;
        let v83: f64 = (v82 - v36);
        let v84: f64 = (self.scalar_v25 * v83);
        let v85: f64 = (if self.scalar_v77 { v84 } else { v1 });
        let v89: f64 = (v5 * v38);
        let v90: f64 = (if self.scalar_v37 { v89 } else { v1 });
        let v91: f64 = (v5 * v39);
        let v92: f64 = (if self.scalar_v37 { v91 } else { v1 });
        let v95: f64 = (v5 * v55);
        let v96: f64 = (if self.scalar_v94 { v95 } else { v1 });
        let v102: f64 = (if self.scalar_v101 { v95 } else { v1 });
        let v106: f64 = (v5 * v43);
        let v107: f64 = (if self.scalar_v42 { v106 } else { v1 });
        let v108: f64 = (v5 * v44);
        let v109: f64 = (if self.scalar_v42 { v108 } else { v1 });
        let v110: f64 = (if self.scalar_v42 { v91 } else { v1 });
        ...
        Self::stamp_transient_block_1(s, p, param_given, var_dw, var_dwbt, var_lgate, var_mks_cth0, var_mks_rth0, var_subversion, var_wgate, &mut var_cth, &mut var_dwcv, &mut var_grg, &mut var_grg_cnst, &mut var_guard10, &mut var_guard21, &mut var_guard22, &mut var_mfactor, &mut var_rth, &mut var_weff, &mut var_weff_cv, &mut var_weff_nf, &mut var_weffcv_nf);
