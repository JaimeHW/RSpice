...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if (!s.b[636]) {
            ...
            s.store_scaled_div_ad_rhs(134, 329, A::offset(s.ad_value(329), p.p130), (p.p127 * (1.0 + (p.p128 / ((s.v[100]) as f64).powf(p.p129)))));
            s.store_scalar(130, (p.p124 * (1.0 + (p.p125 / ((s.v[100]) as f64).powf(p.p126)))));
        ...
        while {
            ...
            if s.b[639] {
                s.store_ad_value(328, A::add_scaled_inputs3(s.ad_value(328), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(562), (p.p12 + s.v[96]), (p.p10 + (0.5 * s.v[96])))), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(562), (p.p12 + s.v[96]), (p.p11 + (0.5 * s.v[96])))), 1.0));
        ...
        if s.b[640] {
            ...
            s.store_ad_value(538, A::div_scaled_product(s.ad_value(112), A::offset(A::mul(s.ad_value(328), s.ad_value(329)), 1.0), 1.0, A::offset(A::mul(s.ad_value(328), s.ad_value(330)), 1.0), 1.0));
        }
        ...
        if s.b[641] {
            ...
            s.store_ad_value(544, A::div_scaled_product(s.ad_value(544), A::offset(A::mul(s.ad_value(328), s.ad_value(329)), 1.0), 1.0, A::offset(A::mul(s.ad_value(328), s.ad_value(330)), 1.0), 1.0));
        }
        ...
        if (!s.b[642]) {
            s.store_ad_value(536, A::add_scaled_inputs3(s.ad_value(538), 1.0, s.ad_value(538), ((p.p72 - s.v[99]) * 1.0 / (p.p72)), s.ad_value(544), (-((p.p72 - s.v[99]) * 1.0 / (p.p72)))));
        }
        ...
        if s.b[643] {
            s.store_sub_ad_lhs(593, A::add_scaled_inputs3(s.ad_value(538), 2.0, s.ad_value(538), (-(s.v[99] * 1.0 / (p.p72))), s.ad_value(544), (-(-(s.v[99] * 1.0 / (p.p72))))), 544);
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        s.store_ad_value(253, A::div_scaled_inputs(s.ad_value(550), s.v[73], A::sub_scaled_inputs(A::add_scaled_product(A::scale_offset(s.ad_value(328), 0.4, 1.8), 1.0, s.ad_value(328), s.ad_value(328), 0.1), 1.0, A::sub_from_scalar(1.0, s.ad_value(328)), s.v[60]), 1.0));
        ...
        s.store_sqrt_scaled_ad(444, A::div(A::div_from_scalar(1.034943e-10, s.ad_value(229)), s.ad_value(225)), 2.0);
        ...
        if s.b[674] {
            ...
            s.store_ad_value(335, A::div_scaled_product3(s.ad_value(330), s.ad_value(52), s.ad_value(53), 1.0, s.ad_value(48), 1.0));
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_offset_scaled_add(331, 685, 44, 0.5, (1e-10 * 0.001));
        ...
        s.store_ad_value(193, A::add_scaled_product(s.ad_value(684), 1.0, s.ad_value(683), A::sub_from_scalar(1.0, s.ad_value(686)), 1.0));
        ...
        s.store_div_from_scalar_add_ad(686, 1.0, A::add_scaled_inputs3(A::offset(s.ad_value(44), 1.0), 1.0, s.ad_value(45), 1.0, s.ad_value(46), 1.0), s.ad_value(47));

        s.store_mul_ad_affine_product_lhs(327, A::add_scaled_inputs3(A::scale_offset(s.ad_value(44), 2.0, 1.0), 1.0, s.ad_value(45), 3.0, s.ad_value(46), 4.0), s.ad_value(686), -1.0, 0.0, 686);
        ...
        s.store_sqrt_ad(688, A::mul_scaled_lhs(s.ad_value(229), (2.0 * 1.034943e-10), s.ad_value(232)));
        ...
        if (!s.b[695]) {
            s.store_offset_ad(692, A::add_scaled_inputs3(s.ad_value(158), 1.0, s.ad_value(513), (-1.0), s.ad_value(325), -1.0), p.p205);
            s.store_sqrt_square_offset(44, 692, ((4.0 * 0.0001) * 0.0001));
            s.store_offset_scaled_add(688, 692, 44, 0.5, (1e-10 * 0.0001));
        }
        ...
        if (!s.b[695]) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(688, A::add_scaled_inputs3(A::div_from_scalar(1.0, s.ad_value(690)), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        ...
        if s.b[698] {
            ...
            s.store_ad_value(440, A::add_scaled_inputs3(s.ad_value(229), (((-p.p237) * p.p237) * 1.0 / ((2.0 * 1.034943e-10))), s.ad_value(231), 1.0, s.ad_value(227), -1.0));
        ...
        if s.b[698] {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(435, A::add_scaled_inputs3(s.ad_value(440), 1.0, s.ad_value(44), 0.5, s.ad_value(45), 0.5));
        }
        ...
        if (s.b[698] && s.b[699]) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(435, A::add_scaled_inputs3(s.ad_value(232), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }
        ...
        s.store_offset_ad(701, A::sub_scaled_inputs(s.ad_value(233), s.v[702], s.ad_value(435), 1.0), (-0.001));

        s.store_sqrt_ad(703, A::add_scaled_inputs(A::square(s.ad_value(701)), 1.0, s.ad_value(233), ((4.0 * s.v[702]) * 0.001)));

        s.store_ad_value(704, A::add_scaled_inputs3(s.ad_value(233), s.v[702], s.ad_value(701), (-0.5), s.ad_value(703), (-0.5)));
        ...
        if s.b[712] {
            s.store_ad_value(183, A::add_scaled_product(A::offset(s.ad_value(236), s.v[123]), 1.0, s.ad_value(707), s.ad_value(324), 1.0));
            ...
            s.store_ad_value(708, A::add_scaled_product(s.ad_value(707), 1.0, s.ad_value(710), s.ad_value(173), 1.0));
        ...
        if s.b[723] {
            s.store_add_scaled_ad_lhs(720, A::offset(A::add(s.ad_value(237), s.ad_value(231)), (-(2.0 * p.p88))), 173, p.p87);
        ...
        s.store_offset_add_ad(185, A::add_scaled_inputs3(s.ad_value(187), 1.0, s.ad_value(319), 1.0, s.ad_value(189), 1.0), s.ad_value(188), s.v[125]);
        ...
        if (((!s.b[731]) && (!s.b[732])) && s.b[733]) {
            s.store_offset_mul_ad(320, s.ad_value(729), A::offset(A::mul(s.ad_value(729), A::scale_offset(s.ad_value(729), (1.0 / 27.0), (1.0 / 3.0))), 1.0), 1.0);
        }

        if (((!s.b[731]) && (!s.b[732])) && (!s.b[733])) {
            s.store_offset_mul_ad(320, s.ad_value(729), A::offset(A::mul(s.ad_value(729), A::offset(A::mul(s.ad_value(729), A::scale_offset(s.ad_value(729), 0.148148111111111, 0.0402052934513951)), (1.0 / 3.0))), 1.0), 1.0);
        }

        if (!s.b[731]) {
            s.store_sqrt_offset_ad(44, A::mul(A::offset(s.ad_value(320), (-1.0)), A::offset(s.ad_value(320), (-1.0))), ((4.0 * 0.1) * 0.1));
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        s.store_ad_value(159, A::add_scaled_inputs3(A::offset(s.ad_value(158), (-s.v[123])), 1.0, s.ad_value(185), 1.0, s.ad_value(320), -1.0));
        ...
        if s.b[735] {
            ...
            s.store_neg(744, 475);
            s.store_ad_value(745, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(744)), 4.0, s.ad_value(743), 4.0), (-1.0), A::add_scaled_product(s.ad_value(744), 2.0, s.ad_value(743), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(744), 2.0, s.ad_value(743), s.ad_value(225), 1.0), 1.0));
        }

        if s.b[735] {
            s.store_ad_value(745, {
        ...
        if s.b[735] {
            ...
            s.store_ad_value(746, A::add_scaled_product(s.ad_value(744), 2.0, s.ad_value(743), s.ad_value(225), 1.0));
            s.store_scaled_sub(747, 746, 745, 0.5);
            s.store_div_ad(748, A::ln(A::div(A::div_scaled_product(s.ad_value(744), s.ad_value(744), 1.0, s.ad_value(743), 1.0), s.ad_value(239))), A::add(s.ad_value(225), A::div_from_scalar(2.0, s.ad_value(744))));
        }
        ...
        if (s.b[735] && (!s.b[749])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(387, A::add_scaled_inputs3(s.ad_value(748), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }
        ...
        while {
            ...
            if (s.b[735] && s.b[758]) {
                ...
                s.store_mul_scaled_ad_rhs(754, 750, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(752), s.ad_value(751)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(753), (-1.0)), 1.0)));
                s.store_mul_ad(755, A::div_from_scalar(s.v[122], s.ad_value(754)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(752)), 1.0, s.ad_value(239), s.ad_value(753), 1.0));
            }
            ...
            if ((s.b[735] && (!s.b[758])) && (!s.b[759])) {
                ...
                s.store_neg_ad(755, A::sqrt_scaled_input(s.ad_value(225), s.v[122]));
            }
            if s.b[735] {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(754)), 1.0, s.ad_value(741), s.ad_value(741), 4.0));
                s.store_offset_scaled_div(757, 754, 45, 0.5, 0.5);
                s.store_ad_value(756, A::add_scaled_inputs3(s.ad_value(754), 0.5, s.ad_value(45), 0.5, s.ad_value(741), 1e-10));
            }
            s.b[760] = (s.v[756] < 0.0);
            ...
            if s.b[735] {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(756), (-1.0), s.ad_value(742), -1.0));
            ...
            if s.b[735] {
                ...
                s.store_ad_value(756, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(757, 757, 755, 335);
                s.store_ad_value(390, A::div_scaled_inputs(A::square(s.ad_value(756)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_ad_value(391, A::div_scaled_product(s.ad_value(390), s.ad_value(757), 2.0, s.ad_value(756), 1.0));
                s.store_sub_ad_rhs(756, 387, A::div(A::add(A::add_scaled_inputs3(s.ad_value(754), 1.0 / (s.v[93]), s.ad_value(387), (-1.0), s.ad_value(475), -1.0), s.ad_value(390)), A::add(A::scale_offset(s.ad_value(755), 1.0 / (s.v[93]), (-1.0)), s.ad_value(391))));
            }
        ...
        if s.b[735] {
            s.copy_ad(330, 770);
            s.store_ad_value(179, A::add_scaled_inputs3(A::offset(A::add(s.ad_value(158), s.ad_value(330)), (-s.v[123])), 1.0, s.ad_value(185), 1.0, s.ad_value(320), -1.0));
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (s.b[735] && s.b[778]) {
            s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(405), 1.0, s.ad_value(403), (-1.0), s.ad_value(738), 1.0));
            s.store_square(49, 44);
        ...
        if (s.b[735] && s.b[778]) {
            ...
            s.store_ad_value(405, A::add_scaled_inputs3(s.ad_value(403), 1.0, s.ad_value(738), (-1.0), s.ad_value(43), 1.0));
        }
        ...
        if s.b[735] {
            ...
            s.store_ad_value(384, A::add_scaled_product(s.ad_value(227), 1.0, s.ad_value(341), s.ad_value(738), ((-0.5) * 9662367879.197212)));
            s.store_ad_value(385, A::add_scaled_product(s.ad_value(384), 1.0, s.ad_value(386), s.ad_value(738), (-9662367879.197212)));
        }
        ...
        if (s.b[735] && (!s.b[784])) {
            s.store_offset_div_ad(336, A::scaled_offset(A::mul(s.ad_value(225), s.ad_value(178)), (-1.0), 4.0), A::mul(s.ad_value(241), s.ad_value(226)), 1.0);
        }
        ...
        if ((s.b[735] && (!s.b[784])) && s.b[785]) {
            ...
            s.store_ad_value(376, A::add_scaled_product(s.ad_value(156), 1.0, s.ad_value(336), s.ad_value(227), 1.0));
            s.copy_ad(378, 376);
        }
        ...
        if (((s.b[735] && (!s.b[784])) && (!s.b[785])) && s.b[786]) {
            ...
            s.store_mul_ad_rhs(331, 330, A::add_scaled_product(A::sub(s.ad_value(178), s.ad_value(475)), 1.0, A::add_scaled_inputs(s.ad_value(329), 1.0, s.ad_value(328), 0.5), s.ad_value(369), -1.0));
        ...
        if (s.b[735] && (!s.b[784])) {
            s.store_ad_value(401, {
                if (s.v[378] > 0.0) {
                    A::sqrt(A::div_scaled_inputs(s.ad_value(378), ((2.0 * 1.034943e-10) / 1.6021918e-19), s.ad_value(544), 1.0))
                } else {
                    A::constant(0.0)
                }
            });
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if ((s.b[735] && (!s.b[784])) && s.b[796]) {
            ...
            s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(332), 1.0, s.ad_value(331), (-1.0), s.ad_value(332), (-0.001)));
        ...
        if ((s.b[735] && (!s.b[784])) && s.b[796]) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(331, A::add_scaled_inputs3(s.ad_value(332), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
            s.store_mul3_lhs(330, 329, 331, 226);
            s.store_ad_value(351, A::div_scaled_product(s.ad_value(328), A::sub_from_scalar(1.0, A::sqrt(s.ad_value(330))), 1.0, A::sub_from_scalar(1.0, s.ad_value(330)), 1.0));
        }

        if ((s.b[735] && (!s.b[784])) && (!s.b[796])) {
            s.store_scaled_square(327, 474, (s.v[95] * s.v[95]));
            s.store_neg_ad(328, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(349)), 1.0, s.ad_value(341), s.ad_value(738), (-(1.0 / (2.0) * 9662367879.197212))));
            s.store_ad_value(329, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(328)), 4.0, s.ad_value(327), 4.0), (-1.0), A::add_scaled_product(s.ad_value(328), 2.0, s.ad_value(327), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(328), 2.0, s.ad_value(327), s.ad_value(225), 1.0), 1.0));
        }

        if ((s.b[735] && (!s.b[784])) && (!s.b[796])) {
            s.store_ad_value(329, {
        ...
        if ((s.b[735] && (!s.b[784])) && (!s.b[796])) {
            ...
            s.store_ad_value(330, A::add_scaled_product(s.ad_value(328), 2.0, s.ad_value(327), s.ad_value(225), 1.0));
            s.store_scaled_sub(380, 330, 329, 0.5);
            s.store_div_ad(381, A::ln(A::div(A::div_scaled_product(s.ad_value(328), s.ad_value(328), 1.0, s.ad_value(327), 1.0), s.ad_value(239))), A::add(s.ad_value(225), A::div_from_scalar(2.0, s.ad_value(328))));
        }
        ...
        if (((s.b[735] && (!s.b[784])) && (!s.b[796])) && (!s.b[797])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(351, A::add_scaled_inputs3(s.ad_value(381), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }
        ...
        while {
            ...
            if ((s.b[735] && (!s.b[784])) && s.b[798]) {
                ...
                s.store_mul_scaled_ad_rhs(331, 328, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(330), s.ad_value(329)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(327), (-1.0)), 1.0)));
                s.store_mul_ad(332, A::div_from_scalar(s.v[122], s.ad_value(331)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(330)), 1.0, s.ad_value(239), s.ad_value(327), 1.0));
            }
            ...
            if (s.b[735] && (!s.b[784])) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(331)), 1.0, s.ad_value(741), s.ad_value(741), 4.0));
                s.store_offset_scaled_div(334, 331, 45, 0.5, 0.5);
                s.store_ad_value(333, A::add_scaled_inputs3(s.ad_value(331), 0.5, s.ad_value(45), 0.5, s.ad_value(741), 1e-10));
            }
            s.b[800] = (s.v[333] < 0.0);
            ...
            if (s.b[735] && (!s.b[784])) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(333), (-1.0), s.ad_value(742), -1.0));
                s.store_scaled_mul(45, 341, 742, (-4.0));
            }
            if (s.b[735] && (!s.b[784])) {
                s.store_ad_value(45, {
            ...
            if (s.b[735] && (!s.b[784])) {
                s.store_sqrt_square_add(45, 44, 45);
                s.store_offset_scaled_div(335, 44, 45, 0.5, 0.5);
                s.store_ad_value(333, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(334, 334, 332, 335);
                s.store_ad_value(388, A::div_scaled_inputs(A::square(s.ad_value(333)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_ad_value(389, A::div_scaled_product(s.ad_value(388), s.ad_value(334), 2.0, s.ad_value(333), 1.0));
            }
            if (s.b[735] && (!s.b[784])) {
                let assign9510_body27_ad_e8369: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(349), 1.0, s.ad_value(351), (-1.0), s.ad_value(331), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(331), 1.0, s.ad_value(341), 0.5), s.ad_value(738), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(332), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(332), s.ad_value(738), 9662367879.197212), s.ad_value(389)));
        ...
        if (s.b[735] && (!s.b[784])) {
            ...
            s.store_ad_value(350, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(737), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
        ...
        if (s.b[735] && s.b[802]) {
            ...
            s.store_sub_ad_lhs(445, A::add_scaled_inputs3(s.ad_value(174), 1.0, s.ad_value(446), (-1.0), s.ad_value(185), 1.0), 320);
            ...
            s.store_div_ad_lhs(209, A::div_scaled_product(s.ad_value(230), s.ad_value(230), 1.0, s.ad_value(544), 1.0), 544);
            s.store_div_ad_lhs(210, A::div_scaled_product(s.ad_value(208), s.ad_value(208), 1.0, s.ad_value(323), 1.0), 323);
            s.store_scaled_mul(211, 210, 225, 0.5);
            s.store_scaled_mul(212, 211, 225, 2.0);
            s.store_sqrt_offset_ad(213, A::div(A::scaled_offset(A::mul(s.ad_value(225), s.ad_value(207)), (-1.0), 4.0), s.ad_value(212)), 1.0);
            ...
            s.store_ad_value(217, A::add_scaled_inputs3(s.ad_value(216), 1.0, s.ad_value(215), (-1.0), s.ad_value(143), -1.0));
            s.store_ad_value(218, A::add_scaled_inputs3(s.ad_value(216), 1.0, s.ad_value(217), (-0.5), A::sqrt(A::add_scaled_product(A::square(s.ad_value(217)), 1.0, s.ad_value(143), s.ad_value(216), 4.0)), (-0.5)));
            s.store_exp_mul(224, 225, 218);
            s.store_ad_value(219, A::add_scaled_product(A::offset(A::mul(s.ad_value(225), s.ad_value(218)), (-1.0)), 1.0, s.ad_value(209), s.ad_value(224), 1.0));
        ...
        if ((s.b[735] && s.b[802]) && s.b[803]) {
            ...
            s.store_scaled_div(214, 105, 225, 2.0);
        ...
        if ((s.b[735] && s.b[802]) && s.b[803]) {
            ...
            s.store_ad_value(165, A::add_scaled_inputs3(s.ad_value(332), 1.0, s.ad_value(333), (-0.5), s.ad_value(334), (-0.5)));
        }
        ...
        if (((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[827])) {
            ...
            s.store_ad_value(809, A::div_scaled_inputs(A::offset(A::add(A::add_scaled_inputs3(s.ad_value(514), p.p145, s.ad_value(187), 1.0, s.ad_value(319), 1.0), s.ad_value(237)), p.p144), -1.0, s.ad_value(824), 1.0));
            s.store_scalar(562, 0.0);
        }
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        while {
            ...
            if (((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[827])) {
                ...
                s.store_ad_value(813, A::add_scaled_inputs3(s.ad_value(159), 1.0, s.ad_value(175), 1.0, A::add_scaled_product(s.ad_value(395), 1.0, s.ad_value(449), s.ad_value(812), 1.0), -1.0));
                ...
                s.store_offset_scaled_add(814, 814, 44, 0.5, (1e-10 * 0.001));
            }
            s.b[828] = (s.v[814] < 0.0);
            ...
            if (((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[827])) {
                s.store_scaled_sub_from_scalar_ad(816, 1.0, A::mul(A::sqrt(s.ad_value(814)), s.ad_value(814)), p.p143);
                s.store_scaled_div(818, 816, 817, -1.0);
            }
        ...
        if ((((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[845])) && s.b[846]) {
            ...
            s.store_ad_value(837, A::add_scaled_product(A::sub(s.ad_value(833), s.ad_value(227)), 1.0, s.ad_value(130), s.ad_value(514), (-1.0)));
            s.store_offset_mul(839, 836, 837, 1.0);
            s.store_sqrt_square_offset(44, 839, ((4.0 * 0.001) * 0.001));
            s.store_offset_scaled_add(838, 839, 44, 0.5, (1e-10 * 0.001));
        }
        ...
        if ((((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[845])) && s.b[846]) {
            ...
            s.store_ad_value(843, A::add_scaled_products(s.ad_value(833), s.ad_value(137), 1.0, s.ad_value(835), A::sub_from_scalar(1.0, s.ad_value(838)), 1.0));
            s.store_ad_value(844, A::add_scaled_inputs3(s.ad_value(173), p.p122, s.ad_value(395), 1.0, A::mul3(s.ad_value(131), s.ad_value(129), s.ad_value(843)), -1.0));
            s.store_sqrt_square_offset(44, 844, ((4.0 * 0.01) * 0.01));
            s.store_offset_scaled_add(844, 844, 44, 0.5, (1e-10 * 0.01));
        }
        ...
        if ((((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[845])) && (!s.b[846])) {
            s.store_ad_value(843, A::add_scaled_product(s.ad_value(833), 1.0, s.ad_value(835), A::sub_from_scalar(1.0, s.ad_value(838)), 1.0));
            s.store_div_from_scalar_offset_input(834, s.v[100], 131, s.v[100]);
            s.store_ad_value(844, A::add_scaled_product(A::scale_offset(s.ad_value(173), p.p122, s.v[176]), 1.0, s.ad_value(834), s.ad_value(843), (-1.0)));
            s.store_sqrt_square_offset(44, 844, ((4.0 * 0.001) * 0.001));
            s.store_offset_scaled_add(844, 844, 44, 0.5, (1e-10 * 0.001));
        }
        ...
        if (((s.b[735] && s.b[802]) && s.b[803]) && (!s.b[845])) {
            ...
            s.store_exp_ad(834, A::div_scaled_inputs(s.ad_value(133), -1.0, s.ad_value(844), 1.0));
            s.store_mul_ad_lhs(263, A::mul3(s.ad_value(132), s.ad_value(844), s.ad_value(394)), 834);
        }
        ...
        if (((s.b[735] && s.b[802]) && s.b[803]) && s.b[863]) {
            ...
            s.store_sqrt_ad(860, A::mul_scaled_lhs(s.ad_value(544), ((2.0 * 1.034943e-10) * 1.6021918e-19), s.ad_value(227)));
            s.store_sqrt_mul_ad(861, s.ad_value(225), A::sub(s.ad_value(395), s.ad_value(859)));
            s.store_sqrt_mul(862, 225, 395);
            s.store_mul_scaled_ad_rhs(393, 860, -1.0, A::sub(s.ad_value(861), s.ad_value(862)));
        }
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        while {
            ...
            if (s.b[735] && s.b[899]) {
                ...
                s.store_ad_value(871, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(357), 1.0));
            }
            s.b[900] = (s.v[865] > 1e-9);
            s.v[900] = if s.b[900] { 1.0 } else { 0.0 };
            if ((s.b[735] && (!s.b[899])) && s.b[900]) {
                s.store_exp(866, 864);
                s.store_mul_scaled_ad_rhs(357, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(864)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(866), s.ad_value(864)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(871, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(866), 1.0), s.v[122]), 357);
            }
            if ((s.b[735] && (!s.b[899])) && (!s.b[900])) {
            ...
            if s.b[735] {
                ...
                s.store_ad_value(898, A::div_scaled_product3(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(869), 1.0), 2.0, s.ad_value(868), 2.0));
                s.store_ad_value(355, A::add_scaled_product(s.ad_value(361), (-1.0), s.ad_value(238), s.ad_value(868), -1.0));
            ...
            if (s.b[735] && s.b[902]) {
                ...
                s.store_div_ad_lhs(364, A::div_scaled_product3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), 1.0, s.ad_value(866), 2.0), 740);
                s.store_neg(365, 364);
            }
            ...
            if (s.b[735] && s.b[904]) {
                ...
                s.store_ad_value(327, A::div_scaled_product3(s.ad_value(406), s.ad_value(52), s.ad_value(53), -1.0, s.ad_value(48), 1.0));
                s.store_ad_value(363, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(897), 1.0));
            }
            if (s.b[735] && s.b[904]) {
            }
            if (s.b[735] && (!s.b[904])) {
            ...
            if (s.b[735] && s.b[910]) {
                s.store_sub_ad_lhs(44, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(361)), 1.0, A::sub(s.ad_value(341), s.ad_value(361)), -1.0), 363);
                s.store_square(49, 44);
            ...
            if (s.b[735] && s.b[910]) {
                ...
                s.store_ad_value(327, A::div_scaled_product3(A::sub(s.ad_value(341), s.ad_value(361)), s.ad_value(52), s.ad_value(53), -1.0, s.ad_value(48), 1.0));
                s.store_sub_ad_lhs(363, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(361)), 1.0, A::sub(s.ad_value(341), s.ad_value(361)), -1.0), 897);
            }
            if (s.b[735] && s.b[910]) {
            }
            if (s.b[735] && (!s.b[910])) {
            ...
            if (s.b[735] && (!s.b[916])) {
                s.store_ad_value(875, A::add_scaled_product(A::sub(s.ad_value(349), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(357), 1.0, s.ad_value(361), 1.0, s.ad_value(355), 1.0), 1.0, s.ad_value(363), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(865, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(737), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
                s.store_mul(867, 737, 871);
                s.store_sub(879, 350, 865);
                s.store_scalar(880, (-1.0));
                s.store_scalar(881, 1.0);
                s.store_neg(882, 867);
                s.store_ad_value(883, A::add_scaled_inputs3(s.ad_value(351), 1.0, s.ad_value(350), (-1.0), s.ad_value(357), (-s.v[94])));
                s.store_scalar(884, (-1.0));
                s.store_sub_from_scalar_ad(885, 1.0, A::scale(s.ad_value(871), s.v[94]));
                s.store_add_ad(886, A::add_scaled_inputs3(A::mul3(s.ad_value(876), s.ad_value(881), s.ad_value(885)), 1.0, A::mul3(s.ad_value(876), s.ad_value(882), s.ad_value(884)), (-1.0), A::mul3(s.ad_value(877), s.ad_value(880), s.ad_value(885)), -1.0), A::mul3(s.ad_value(878), s.ad_value(880), s.ad_value(884)));
                s.store_div_from_scalar_offset_input(887, 1.0, 886, 1e-50);
                s.store_ad_value(888, A::add_scaled_products(s.ad_value(881), s.ad_value(885), 1.0, s.ad_value(882), s.ad_value(884), (-1.0)));
                s.store_ad_value(889, A::add_scaled_products(s.ad_value(878), s.ad_value(884), 1.0, s.ad_value(877), s.ad_value(885), (-1.0)));
                s.store_ad_value(890, A::add_scaled_products(s.ad_value(877), s.ad_value(882), 1.0, s.ad_value(878), s.ad_value(881), (-1.0)));
                s.store_mul_neg_lhs(891, 880, 885);
                s.store_mul(892, 876, 885);
                s.store_ad_value(893, A::add_scaled_products(s.ad_value(878), s.ad_value(880), 1.0, s.ad_value(876), s.ad_value(882), (-1.0)));
                s.store_mul(894, 880, 884);
                s.store_mul_neg_lhs(895, 876, 884);
                s.store_ad_value(896, A::add_scaled_products(s.ad_value(876), s.ad_value(881), 1.0, s.ad_value(877), s.ad_value(880), (-1.0)));
                s.store_mul_scaled_ad_rhs(872, 887, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(888), s.ad_value(875), 1.0, s.ad_value(889), s.ad_value(879), 1.0), 1.0, s.ad_value(890), s.ad_value(883), 1.0));
                s.store_mul_scaled_ad_rhs(873, 887, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(891), s.ad_value(875), 1.0, s.ad_value(892), s.ad_value(879), 1.0), 1.0, s.ad_value(893), s.ad_value(883), 1.0));
                s.store_mul_scaled_ad_rhs(874, 887, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(894), s.ad_value(875), 1.0, s.ad_value(895), s.ad_value(879), 1.0), 1.0, s.ad_value(896), s.ad_value(883), 1.0));
                s.store_abs(865, 872);
            }
            ...
            if ((s.b[735] && (!s.b[916])) && s.b[923]) {
                s.store_mul_div_ad_rhs(872, 872, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(865));
                s.store_mul_div_ad_rhs(873, 873, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(865));
                s.store_mul_div_ad_rhs(874, 874, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(865));
            }
            if (s.b[735] && (!s.b[916])) {
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[735] && (!s.b[927])) {
            ...
            s.store_ad_value(934, A::add_scaled_product(s.ad_value(159), 1.0, s.ad_value(929), A::sub_from_scalar(1.0, s.ad_value(930)), 1.0));
            s.store_sqrt_square_offset(44, 934, ((4.0 * 0.01) * 0.01));
            s.store_offset_scaled_add(934, 934, 44, 0.5, (1e-10 * 0.01));
        }
        ...
        if (s.b[735] && (!s.b[927])) {
            ...
            s.store_pow_ad(929, s.ad_value(928), A::offset(s.ad_value(138), (-1.0)));
        ...
        if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[952]) {
            s.store_neg(947, 475);
            s.store_ad_value(948, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(947)), 4.0, s.ad_value(946), 4.0), (-1.0), A::add_scaled_product(s.ad_value(947), 2.0, s.ad_value(946), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(947), 2.0, s.ad_value(946), s.ad_value(225), 1.0), 1.0));
        }

        if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[952]) {
            s.store_ad_value(948, {
        ...
        if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[952]) {
            ...
            s.store_ad_value(949, A::add_scaled_product(s.ad_value(947), 2.0, s.ad_value(946), s.ad_value(225), 1.0));
            s.store_scaled_sub(950, 949, 948, 0.5);
            s.store_div_ad(951, A::ln(A::div(A::div_scaled_product(s.ad_value(947), s.ad_value(947), 1.0, s.ad_value(946), 1.0), s.ad_value(239))), A::add(s.ad_value(225), A::div_from_scalar(2.0, s.ad_value(947))));
        }
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if (((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[952]) && (!s.b[953])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(354, A::add_scaled_inputs3(s.ad_value(951), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }

        if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && (!s.b[952])) {
            s.store_neg_ad(947, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(352)), 1.0, s.ad_value(341), s.ad_value(738), (-(1.0 / (2.0) * 9662367879.197212))));
            s.store_ad_value(948, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(947)), 4.0, s.ad_value(946), 4.0), (-1.0), A::add_scaled_product(s.ad_value(947), 2.0, s.ad_value(946), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(947), 2.0, s.ad_value(946), s.ad_value(225), 1.0), 1.0));
        }
        ...
        if (((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) {
            s.store_scaled_div(955, 352, 544, ((2.0 * 1.034943e-10) / 1.6021918e-19));
        }
        ...
        while {
            ...
            if (((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) && s.b[965]) {
                ...
                s.store_mul_scaled_ad_rhs(959, 956, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(958), s.ad_value(957)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(955), (-1.0)), 1.0)));
                s.store_mul_ad(960, A::div_from_scalar(s.v[122], s.ad_value(959)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(958)), 1.0, s.ad_value(239), s.ad_value(955), 1.0));
            }
            ...
            if ((((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) && (!s.b[965])) && (!s.b[966])) {
                ...
                s.store_neg_ad(960, A::sqrt_scaled_input(s.ad_value(225), s.v[122]));
            }
            if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(959)), 1.0, s.ad_value(741), s.ad_value(741), 4.0));
                s.store_offset_scaled_div(962, 959, 45, 0.5, 0.5);
                s.store_ad_value(961, A::add_scaled_inputs3(s.ad_value(959), 0.5, s.ad_value(45), 0.5, s.ad_value(741), 1e-10));
            }
            s.b[967] = (s.v[961] < 0.0);
            ...
            if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(961), (-1.0), s.ad_value(742), -1.0));
                s.store_scaled_mul(45, 341, 742, (-4.0));
            }
            if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) {
                s.store_ad_value(45, {
            ...
            if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && s.b[964]) {
                s.store_sqrt_square_add(45, 44, 45);
                s.store_offset_scaled_div(335, 44, 45, 0.5, 0.5);
                s.store_ad_value(961, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(962, 962, 960, 335);
                s.store_ad_value(388, A::div_scaled_inputs(A::square(s.ad_value(961)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_ad_value(389, A::div_scaled_product(s.ad_value(388), s.ad_value(962), 2.0, s.ad_value(961), 1.0));
                s.store_sub_ad_rhs(961, 354, A::div(A::add(A::add_scaled_inputs3(s.ad_value(959), 1.0 / (s.v[93]), s.ad_value(354), (-1.0), s.ad_value(475), -1.0), s.ad_value(388)), A::add(A::scale_offset(s.ad_value(960), 1.0 / (s.v[93]), (-1.0)), s.ad_value(389))));
            }
        ...
        while {
            ...
            if ((((s.b[735] && (!s.b[927])) && (!s.b[942])) && (!s.b[943])) && (!s.b[964])) {
                let assign12750_body27_ad_e16116: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(352), 1.0, s.ad_value(354), (-1.0), s.ad_value(959), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(959), 1.0, s.ad_value(341), 0.5), s.ad_value(738), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(960), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(960), s.ad_value(738), 9662367879.197212), s.ad_value(389)));
        ...
        if ((s.b[735] && (!s.b[927])) && s.b[1010]) {
            s.store_ad_value(353, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(737), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        while {
            ...
            if ((s.b[735] && (!s.b[927])) && s.b[1011]) {
                ...
                s.store_ad_value(981, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(360), 1.0));
            }
            s.b[1012] = (s.v[975] > 1e-9);
            s.v[1012] = if s.b[1012] { 1.0 } else { 0.0 };
            if (((s.b[735] && (!s.b[927])) && (!s.b[1011])) && s.b[1012]) {
                s.store_exp(976, 974);
                s.store_mul_scaled_ad_rhs(360, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(974)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(976), s.ad_value(974)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(981, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(976), 1.0), s.v[122]), 360);
            }
            if (((s.b[735] && (!s.b[927])) && (!s.b[1011])) && (!s.b[1012])) {
            ...
            if (s.b[735] && (!s.b[927])) {
                ...
                s.store_ad_value(1008, A::div_scaled_product3(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(979), 1.0), 2.0, s.ad_value(978), 2.0));
                s.store_ad_value(358, A::add_scaled_product(s.ad_value(362), (-1.0), s.ad_value(238), s.ad_value(978), -1.0));
            ...
            if ((s.b[735] && (!s.b[927])) && s.b[1014]) {
                ...
                s.store_div_ad_lhs(367, A::div_scaled_product3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), 1.0, s.ad_value(976), 2.0), 740);
                s.store_neg(368, 367);
            }
            ...
            if ((s.b[735] && (!s.b[927])) && s.b[1016]) {
                ...
                s.store_ad_value(327, A::div_scaled_product3(s.ad_value(406), s.ad_value(52), s.ad_value(53), -1.0, s.ad_value(48), 1.0));
                s.store_ad_value(366, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(1007), 1.0));
            }
            if ((s.b[735] && (!s.b[927])) && s.b[1016]) {
            }
            if ((s.b[735] && (!s.b[927])) && (!s.b[1016])) {
            ...
            if ((s.b[735] && (!s.b[927])) && s.b[1022]) {
                s.store_sub_ad_lhs(44, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(362)), 1.0, A::sub(s.ad_value(341), s.ad_value(362)), -1.0), 366);
                s.store_square(49, 44);
            ...
            if ((s.b[735] && (!s.b[927])) && s.b[1022]) {
                ...
                s.store_ad_value(327, A::div_scaled_product3(A::sub(s.ad_value(341), s.ad_value(362)), s.ad_value(52), s.ad_value(53), -1.0, s.ad_value(48), 1.0));
                s.store_sub_ad_lhs(366, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(362)), 1.0, A::sub(s.ad_value(341), s.ad_value(362)), -1.0), 1007);
            }
            if ((s.b[735] && (!s.b[927])) && s.b[1022]) {
            }
            if ((s.b[735] && (!s.b[927])) && (!s.b[1022])) {
            ...
            if ((s.b[735] && (!s.b[927])) && (!s.b[1028])) {
                s.store_ad_value(985, A::add_scaled_product(A::sub(s.ad_value(352), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(360), 1.0, s.ad_value(362), 1.0, s.ad_value(358), 1.0), 1.0, s.ad_value(366), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(975, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(737), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(360), 1.0), 1.0));
                s.store_mul(977, 737, 981);
                s.store_sub(989, 353, 975);
                s.store_scalar(990, (-1.0));
                s.store_scalar(991, 1.0);
                s.store_neg(992, 977);
                s.store_ad_value(993, A::add_scaled_inputs3(s.ad_value(354), 1.0, s.ad_value(353), (-1.0), s.ad_value(360), (-s.v[94])));
                s.store_scalar(994, (-1.0));
                s.store_sub_from_scalar_ad(995, 1.0, A::scale(s.ad_value(981), s.v[94]));
                s.store_add_ad(996, A::add_scaled_inputs3(A::mul3(s.ad_value(986), s.ad_value(991), s.ad_value(995)), 1.0, A::mul3(s.ad_value(986), s.ad_value(992), s.ad_value(994)), (-1.0), A::mul3(s.ad_value(987), s.ad_value(990), s.ad_value(995)), -1.0), A::mul3(s.ad_value(988), s.ad_value(990), s.ad_value(994)));
                s.store_div_from_scalar_offset_input(997, 1.0, 996, 1e-50);
                s.store_ad_value(998, A::add_scaled_products(s.ad_value(991), s.ad_value(995), 1.0, s.ad_value(992), s.ad_value(994), (-1.0)));
                s.store_ad_value(999, A::add_scaled_products(s.ad_value(988), s.ad_value(994), 1.0, s.ad_value(987), s.ad_value(995), (-1.0)));
                s.store_ad_value(1000, A::add_scaled_products(s.ad_value(987), s.ad_value(992), 1.0, s.ad_value(988), s.ad_value(991), (-1.0)));
                s.store_mul_neg_lhs(1001, 990, 995);
                s.store_mul(1002, 986, 995);
                s.store_ad_value(1003, A::add_scaled_products(s.ad_value(988), s.ad_value(990), 1.0, s.ad_value(986), s.ad_value(992), (-1.0)));
                s.store_mul(1004, 990, 994);
                s.store_mul_neg_lhs(1005, 986, 994);
                s.store_ad_value(1006, A::add_scaled_products(s.ad_value(986), s.ad_value(991), 1.0, s.ad_value(987), s.ad_value(990), (-1.0)));
                s.store_mul_scaled_ad_rhs(982, 997, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(998), s.ad_value(985), 1.0, s.ad_value(999), s.ad_value(989), 1.0), 1.0, s.ad_value(1000), s.ad_value(993), 1.0));
                s.store_mul_scaled_ad_rhs(983, 997, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1001), s.ad_value(985), 1.0, s.ad_value(1002), s.ad_value(989), 1.0), 1.0, s.ad_value(1003), s.ad_value(993), 1.0));
                s.store_mul_scaled_ad_rhs(984, 997, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1004), s.ad_value(985), 1.0, s.ad_value(1005), s.ad_value(989), 1.0), 1.0, s.ad_value(1006), s.ad_value(993), 1.0));
                s.store_abs(975, 982);
            }
            ...
            if (((s.b[735] && (!s.b[927])) && (!s.b[1028])) && s.b[1035]) {
                s.store_mul_div_ad_rhs(982, 982, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(975));
                s.store_mul_div_ad_rhs(983, 983, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(975));
                s.store_mul_div_ad_rhs(984, 984, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(975));
            }
            if ((s.b[735] && (!s.b[927])) && (!s.b[1028])) {
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        if (s.b[735] && (!s.b[927])) {
            ...
            s.store_ad_value(246, A::add_scaled_inputs3(s.ad_value(358), 1.0, s.ad_value(355), (-1.0), A::mul3_scaled_output(s.ad_value(225), A::add(s.ad_value(358), s.ad_value(355)), A::sub(s.ad_value(375), s.ad_value(374)), 0.5), -1.0));
        }
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if (!s.b[735]) {
            s.store_ad_value(160, A::add_scaled_inputs3(A::sub_from_scalar(s.v[123], s.ad_value(185)), 1.0, s.ad_value(320), 1.0, s.ad_value(515), 1.0));
        }
        ...
        if ((!s.b[735]) && s.b[1066]) {
            ...
            s.store_ad_value(313, A::add_scaled_product(s.ad_value(515), 1.0, s.ad_value(181), s.ad_value(227), 1.0));
        ...
        if (((!s.b[735]) && (!s.b[1066])) && (!s.b[1068])) {
            s.store_offset_div_ad(336, A::scaled_offset(A::mul(s.ad_value(225), A::sub(s.ad_value(159), s.ad_value(515))), (-1.0), 4.0), A::mul(s.ad_value(241), s.ad_value(226)), 1.0);
        }
        ...
        if ((((!s.b[735]) && (!s.b[1066])) && (!s.b[1068])) && s.b[1069]) {
            ...
            s.store_powf_ad(332, A::add(s.ad_value(330), A::sqrt(A::add(A::mul3_scaled_output(s.ad_value(329), s.ad_value(329), s.ad_value(329), 4.0), s.ad_value(331)))), 0.3333333333333333);
            s.store_add_scaled_ad_lhs(336, A::sub_from_scalar(3.0, A::div_scaled_inputs(s.ad_value(329), 1.259921049894873, s.ad_value(332), 3.0)), 332, (1.0 / (3.0 * 1.259921049894873)));
            s.store_ad_value(376, A::add_scaled_product(s.ad_value(515), 1.0, s.ad_value(336), s.ad_value(227), 1.0));
            s.copy_ad(378, 376);
        }
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        while {
            ...
            if ((((!s.b[735]) && (!s.b[1080])) && (!s.b[1081])) && (!s.b[1082])) {
                ...
                s.store_mul_ad_rhs(488, 379, A::add_scaled_product(s.ad_value(485), 1.0, s.ad_value(486), A::offset(s.ad_value(181), 1.0), (-1.0)));
            ...
            if (!s.b[735]) {
                s.store_ad_value(492, A::add_scaled_product(A::add_scaled_product(A::sub(s.ad_value(349), s.ad_value(159)), 1.0, s.ad_value(240), s.ad_value(490), 1.0), 1.0, s.ad_value(324), s.ad_value(393), (-1.0)));
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if ((!s.b[735]) && s.b[1087]) {
            s.store_ad_value(1094, A::add_scaled_product(s.ad_value(159), 1.0, s.ad_value(1089), A::sub_from_scalar(1.0, s.ad_value(1090)), 1.0));
            s.store_sqrt_square_offset(44, 1094, ((4.0 * 0.01) * 0.01));
            s.store_offset_scaled_add(1094, 1094, 44, 0.5, (1e-10 * 0.01));
        }
        ...
        while {
            ...
            if ((((!s.b[735]) && s.b[1087]) && (!s.b[1112])) && (!s.b[1113])) {
                ...
                s.store_exp(502, 501);
                s.store_mul_ad_rhs(497, 379, A::add_scaled_product(s.ad_value(502), 1.0, s.ad_value(484), A::offset(s.ad_value(181), 1.0), (-1.0)));
            ...
            if ((!s.b[735]) && s.b[1087]) {
                s.store_ad_value(503, A::add_scaled_product(A::add_scaled_product(A::sub(s.ad_value(352), s.ad_value(159)), 1.0, s.ad_value(240), s.ad_value(499), 1.0), 1.0, s.ad_value(324), s.ad_value(393), (-1.0)));
            ...
            if (((!s.b[735]) && s.b[1087]) && (!s.b[1114])) {
                s.store_scaled_div(495, 503, 504, -1.0);
            }
            if (((!s.b[735]) && s.b[1087]) && (!s.b[1114])) {
                s.store_scaled_offset_ad(496, {
        ...
        if ((!s.b[735]) && s.b[1087]) {
            ...
            s.store_sub_ad(328, A::add(s.ad_value(159), s.ad_value(227)), A::add_scaled_inputs(s.ad_value(161), (2.0 * 0.5), s.ad_value(164), 0.5));
            s.store_sub(329, 509, 510);
            s.store_mul(330, 225, 323);
            s.store_mul(331, 225, 238);
            s.store_ad_value(511, A::add_scaled_products(s.ad_value(330), s.ad_value(328), 1.0, s.ad_value(331), s.ad_value(329), 1.0));
        ...
        if (((!s.b[735]) && s.b[1087]) && s.b[1117]) {
            s.store_ad_value(246, A::add_scaled_inputs3(A::mul3(s.ad_value(425), s.ad_value(225), s.ad_value(164)), 1.0, s.ad_value(427), (-1.0), A::div_scaled_product(A::square(s.ad_value(426)), s.ad_value(426), 0.16666666666666666, s.ad_value(428), 1.0), -1.0));
        }
        ...
        if ((((!s.b[735]) && s.b[1087]) && s.b[1119]) && s.b[1120]) {
            let assign16600_ad_e24175: A = A::mul(A::mul3(A::add_scaled_product(A::sub_scaled_inputs(s.ad_value(425), 1.0, s.ad_value(424), 2.0), 1.0, A::div(s.ad_value(323), s.ad_value(225)), A::add(A::sub_from_scalar(1.0, A::div_scaled_product(s.ad_value(424), s.ad_value(424), 2.0, s.ad_value(428), 1.0)), A::div_scaled_product(s.ad_value(426), s.ad_value(426), 0.1, s.ad_value(428), 1.0)), 1.0), s.ad_value(426), s.ad_value(426)), s.ad_value(426));
            s.store_ad_value(437, A::add_scaled_product(A::div(assign16600_ad_e24175, s.ad_value(428)), 0.16666666666666666, s.ad_value(424), A::sub(A::mul3(s.ad_value(425), s.ad_value(225), s.ad_value(164)), s.ad_value(427)), 1.0));
        }
