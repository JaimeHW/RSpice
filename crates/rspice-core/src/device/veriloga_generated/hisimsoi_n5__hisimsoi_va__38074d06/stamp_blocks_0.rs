...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.b[627] = (p[43] == 0.0);s.store_scalar(627, if s.b[627] { 1.0 } else { 0.0 });s.store_scalar(246, 0.0);s.store_scalar(300, 1e-12);s.store_scalar(25, 0.0);s.store_scalar(146, 0.0);s.store_scalar(612, 0.0);s.store_scalar(556, 0.0);s.store_scalar(145, 0.0);s.store_scalar(338, 0.0);s.store_scalar(162, 0.0);s.store_scalar(163, 0.0);s.store_scalar(164, 0.0);s.store_scalar(165, 0.0);s.store_scalar(176, 1.0);s.store_scalar(190, 0.0);s.store_scalar(192, 0.0);s.store_scalar(196, 0.0);s.store_scalar(197, 0.0);s.store_scalar(198, 0.0);s.store_scalar(199, 0.0);s.store_scalar(242, 0.0);s.store_scalar(244, 0.0);s.store_scalar(250, 0.0);s.store_scalar(251, 0.0);s.store_scalar(252, 0.0);s.store_scalar(263, 0.0);s.store_scalar(264, 1.0);s.store_scalar(265, 0.0);s.store_scalar(267, 0.0);s.store_scalar(268, 0.0);s.store_scalar(272, 0.0);s.store_scalar(454, 0.0);s.store_scalar(455, 0.0);s.store_scalar(456, 0.0);s.store_scalar(457, 0.0);s.store_scalar(282, 0.0);s.store_scalar(281, 0.0);s.store_scalar(284, 0.0);s.store_scalar(283, 0.0);s.store_scalar(478, 0.0);s.store_scalar(479, 0.0);s.store_scalar(402, p[237]);s.store_scalar(463, 0.0);s.store_scalar(464, 0.0);s.store_scalar(466, 0.0);s.store_scalar(465, 0.0);s.store_scalar(467, 0.0);s.store_scalar(468, 0.0);s.store_scalar(470, 0.0);s.store_scalar(469, 0.0);s.store_scalar(522, 0.0);s.store_scalar(523, 0.0);s.store_scalar(471, 0.0);s.store_scalar(473, 0.0);s.store_scalar(289, 0.0);s.store_scalar(290, 0.0);s.store_scalar(293, 0.0);s.store_scalar(294, 0.0);s.store_scalar(296, 0.0);s.store_scalar(297, 0.0);s.store_scalar(298, 0.0);s.store_scalar(299, 0.0);s.store_scalar(301, 0.0);s.store_scalar(314, 0.0);s.store_scalar(315, 0.0);s.store_scalar(316, 0.0);s.store_scalar(339, 0.0);s.store_scalar(346, 0.0);s.store_scalar(347, 0.0);s.store_scalar(348, 0.0);s.store_scalar(349, 0.0);s.store_scalar(350, 0.0);s.store_scalar(351, 0.0);s.store_scalar(352, 0.0);s.store_scalar(353, 0.0);s.store_scalar(354, 0.0);s.store_scalar(370, 0.0);s.store_scalar(355, 0.0);s.store_scalar(363, 0.0);s.store_scalar(366, 0.0);s.store_scalar(356, 0.0);s.store_scalar(357, 0.0);s.store_scalar(358, 0.0);s.store_scalar(359, 0.0);s.store_scalar(360, 0.0);s.store_scalar(383, 0.0);s.store_scalar(386, 0.0);s.store_scalar(574, 0.0);s.store_scalar(575, 0.0);s.store_scalar(582, 0.0);s.store_scalar(580, 0.0);s.store_scalar(584, 0.0);s.store_scalar(585, 0.0);s.store_scalar(390, 0.0);s.store_scalar(392, 0.0);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_scalar(393, 0.0);s.store_scalar(401, 0.0);s.store_scalar(376, 0.0);s.store_scalar(436, 0.0);s.store_scalar(437, 0.0);s.store_scalar(438, 0.5);s.store_scalar(439, 0.5);s.store_scalar(447, 0.0);s.store_scalar(476, 0.0);s.store_scalar(477, 0.0);s.store_scalar(592, 0.0);s.store_scalar(576, 0.0);s.store_scalar(577, 0.0);s.store_scalar(587, 0.0);s.store_scalar(588, 0.0);s.store_scalar(488, 0.0);s.store_scalar(490, 0.0);s.store_scalar(497, 0.0);s.store_scalar(499, 0.0);let t0: f64 = (p[51] * 10.0);let t1: f64 = (t0 % 10.0);s.store_scalar(56, t1);s.store_scalar(57, 200.0);s.store_scalar(58, 200.0);s.store_scalar(86, 0.0);s.store_scalar(475, 0.0);s.store_scalar(378, 0.0);s.store_scalar(369, 0.0);s.store_scalar(203, 0.0);s.store_scalar(161, 0.0);s.store_scalar(515, 0.0);s.store_scalar(73, (p[52] * 0.01));s.store_scalar(59, (p[73] / 1e-6));s.store_scalar(60, (p[104] * 0.01));s.store_scalar(61, (p[201] / 1e-6));s.store_scalar(65, (p[240] / 1e-6));s.store_scalar(66, (p[241] / 1e-6));s.store_scalar(67, (p[242] * 0.01));s.store_scalar(68, (p[243] / 0.01));s.store_scalar(69, (p[59] / 1e-6));s.store_scalar(70, (p[284] / 1e-6));s.store_scalar(71, (p[148] / 1e-6));s.store_scalar(72, (p[198] / 0.0001));s.store_scalar(74, (p[70] * 0.01));s.store_scalar(75, (if (p[83] == 0.0) { 0.0 } else { p[84] }));s.store_scalar(76, (if (p[83] == 0.0) { 0.0 } else { p[85] }));s.store_scalar(77, (if (p[80] == 0.0) { 0.0 } else { p[81] }));s.store_scalar(78, (if (p[83] == 0.0) { 0.0 } else { p[82] }));s.store_scalar(79, (p[250] * 1000000.0));s.store_scalar(81, (p[232] + 273.15));s.store_scalar(82, p[58]);s.store_scalar(83, (p[15] * 100.0));s.store_scalar(84, p[46]);s.store_scalar(85, p[34]);s.store_scalar(80, (if param_given[190] { p[190] } else { (5000000000.0 / (p[237] * p[240])) }));s.b[628] = ((s.v[80] < (2.0 + 0.1)) && (0.1 >= 0.0));s.store_scalar(628, if s.b[628] { 1.0 } else { 0.0 });
    ...
    if (s.b[628] && s.b[629]) {
        ...
        s.store_scalar(139, (p[50] * p[253]));s.b[564] = param_given[168];s.store_scalar(564, if s.b[564] { 1.0 } else { 0.0 });s.b[565] = param_given[169];s.store_scalar(565, if s.b[565] { 1.0 } else { 0.0 });s.b[566] = param_given[170];s.store_scalar(566, if s.b[566] { 1.0 } else { 0.0 });s.b[525] = param_given[294];s.store_scalar(525, if s.b[525] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_3(
        ...
        s.b[524] = param_given[293];s.store_scalar(524, if s.b[524] { 1.0 } else { 0.0 });s.b[529] = param_given[13];s.store_scalar(529, if s.b[529] { 1.0 } else { 0.0 });s.b[530] = param_given[14];s.store_scalar(530, if s.b[530] { 1.0 } else { 0.0 });s.b[527] = param_given[23];s.store_scalar(527, if s.b[527] { 1.0 } else { 0.0 });s.b[526] = param_given[22];s.store_scalar(526, if s.b[526] { 1.0 } else { 0.0 });s.b[539] = param_given[16];s.store_scalar(539, if s.b[539] { 1.0 } else { 0.0 });s.b[540] = (p[17] != 0.0);s.store_scalar(540, if s.b[540] { 1.0 } else { 0.0 });s.store_scalar(451, 1.0);s.store_scalar(142, 0.0);s.store_scalar(518, p[13]);s.store_scalar(519, p[14]);s.store_scalar(520, (p[16] + 273.15));s.store_primal_div_from_scalar_scaled_input(541, s.v[67], 107, s.v[451]);s.store_primal_scale(542, 108, (s.v[451] * s.v[68]));s.b[639] = (((p[10] > 0.0) && (p[11] > 0.0)) && ((p[9] == 1.0) || ((p[9] > 1.0) && (p[12] > 0.0))));s.store_scalar(639, if s.b[639] { 1.0 } else { 0.0 });
        if s.b[639] {s.store_scalar(328, 0.0);s.store_scalar(562, 0.0);}
        let mut te: usize = 0;
        while {
            let td: f64 = if (s.b[639] && (s.v[562] < p[9])) { 1.0 } else { 0.0 };
            td != 0.0
        } {
            te += 1;
        ...
        s.store_scaled_ln_scaled_input(232, 536, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));s.store_scaled_ln_scaled_input(236, 544, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_4(
        ...
        let nv10 = ctx.node_voltage(nodes[10]);s.store_sqrt_div_from_scalar_ad(549, ((2.0 * 1.034943e-10) / 1.6021918e-19), s.ad_value(536));s.store_scalar(328, ((1.0 + (p[194] / ((s.v[100]) as f64).powf(p[195]))) * (1.0 + (p[196] / ((s.v[110]) as f64).powf(p[197])))));s.store_scalar(44, ((((s.v[328] * s.v[328]) + ((4.0 * 0.001) * 0.001))) as f64).sqrt());s.store_scalar(550, ((0.5 * (s.v[328] + s.v[44])) + (1e-10 * 0.001)));s.b[644] = (s.v[550] < 0.0);s.store_scalar(644, if s.b[644] { 1.0 } else { 0.0 });
        if s.b[644] {s.store_scalar(550, 0.0);}
        s.b[645] = (p[35] == 1.0);s.store_scalar(645, if s.b[645] { 1.0 } else { 0.0 });s.b[646] = (s.v[128] > 0.001);s.store_scalar(646, if s.b[646] { 1.0 } else { 0.0 });
        ...
        if s.b[647] {s.store_offset_scaled(327, 107, p[289], p[288]);s.store_scale(2, 327, 1.0 / (s.v[451]));}
        ...
        s.store_scalar(552, 0.0);s.store_scalar(553, 0.0);s.b[649] = (p[262] == 1.0);s.store_scalar(649, if s.b[649] { 1.0 } else { 0.0 });s.b[650] = (p[290] < 0.0001);s.store_scalar(650, if s.b[650] { 1.0 } else { 0.0 });
        if (s.b[649] && s.b[650]) {s.store_scalar(552, (s.v[451] * 10000.0));}
        if (s.b[649] && (!s.b[650])) {s.store_scalar(552, (s.v[451] * (1e-6 + (1.0 / p[290]))));}
        s.b[651] = (p[291] < 0.0001);s.store_scalar(651, if s.b[651] { 1.0 } else { 0.0 });
        if (s.b[649] && s.b[651]) {s.store_scalar(553, (s.v[451] * 10000.0));}
        if (s.b[649] && (!s.b[651])) {s.store_scalar(553, (s.v[451] * (1e-6 + (1.0 / p[291]))));}
        ...
        if (s.b[652] && (p[24] == 0.0)) {s.store_scalar(534, 0.0);s.store_scalar(532, 0.0);s.store_scalar(533, 0.0);s.store_scalar(531, 0.0);}
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        let ctx_temp = ctx.temperature();s.b[658] = (s.v[571] >= 0.0);s.store_scalar(658, if s.b[658] { 1.0 } else { 0.0 });
        let (tf,) = {
    if s.b[658] {
        (1.0,)
    } else {
        ...
        if s.b[658] {s.store_scalar(461, 1.0);s.store_scalar(462, 0.0);s.copy_ad(157, 571);s.copy_ad(158, 572);s.copy_ad(156, 570);}
        let (t11,) = {
    if (!s.b[658]) {
        let t10: f64 = (-1.0);
        (t10,)
        ...
        s.store_square(379, 328);s.store_sqrt_scaled_input_ad(444, A::div_scalar_by_product(1.034943e-10, s.ad_value(229), s.ad_value(225), 1.0), 2.0);s.store_div_from_scalar(547, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_6(
        ...
        let t12: f64 = (2.0 * 1.034943e-10);let t13: f64 = (t12 / 1.6021918e-19);let t14: f64 = (t13 * s.v[231]);let t15: f64 = (t14 / s.v[544]);let t16: f64 = (t15).sqrt();s.store_scalar(416, t16);s.b[672] = (p[43] == 1.0);s.store_scalar(672, if s.b[672] { 1.0 } else { 0.0 });
    ...
    if (s.b[674] && s.b[675]) {
        ...
        s.copy_ad(157, 152);s.copy_ad(158, 153);s.copy_ad(156, 154);s.store_scalar(144, 0.0);s.store_scalar(619, 0.0);s.store_scalar(620, 0.0);s.store_scalar(621, 0.0);s.store_scalar(622, 0.0);s.store_scalar(623, 0.0);s.store_scalar(624, 0.0);s.store_scalar(425, 0.0);s.store_scalar(426, 0.0);s.store_scalar(427, 0.0);s.store_scalar(428, 0.0);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_scalar(167, 0.0);s.store_scalar(168, 0.0);s.store_scaled_mul(680, 155, 157, 0.5);s.store_scale(44, 680, (2.0 * 1.0 / (p[226])));s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p[226], 45);s.b[681] = (s.v[175] < 5e-12);s.store_scalar(681, if s.b[681] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[695]) && s.b[697]) {
        ...
        s.store_add_mixed_ai(318, A::add_scaled_product(A::offset(s.ad_value(232), s.v[123]), 1.0, s.ad_value(245), s.ad_value(324), 1.0), 433);s.copy_ad(233, 232);s.store_scalar(702, 0.95);s.store_offset_sub_scaled_inputs_indices(701, 233, s.v[702], 435, 1.0, (-0.001));s.store_sqrt_add_scaled_square_input(703, 701, 1.0, 233, ((4.0 * s.v[702]) * 0.001));s.store_add_scaled_inputs3_indices(704, 233, s.v[702], 701, (-0.5), 703, (-0.5));s.store_sub(234, 233, 704);s.store_sqrt(235, 234);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_9(
        ...
        s.b[712] = (p[72] != 0.0);s.store_scalar(712, if s.b[712] { 1.0 } else { 0.0 });
    ...
    if (!s.b[730]) {
        ...
        if (!s.b[731]) {s.store_mul(320, 320, 728);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_10(
        ...
        if (!s.b[731]) {s.store_offset_sub_from_scalar_ad(44, 1.0, s.ad_value(320), (-0.05));s.store_scalar(45, (4.0 * 0.05));}
        if (!s.b[731]) {
            if (s.v[45] > 0.0) {
            } else {
                s.store_neg(45, 45);
    ...
    if ((s.b[735] && s.b[778]) && s.b[779]) {
        ...
        while {
            ...
            t49 += 1;
            if t49 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t49, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
