...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.store_scalar(518, p[13]);s.store_scalar(519, p[14]);s.store_scalar(520, (p[16] + 273.15));s.store_primal_div_from_scalar_scaled_input(541, s.v[67], 107, s.v[451]);s.store_primal_scale(542, 108, (s.v[451] * s.v[68]));s.b[639] = (((p[10] > 0.0) && (p[11] > 0.0)) && ((p[9] == 1.0) || ((p[9] > 1.0) && (p[12] > 0.0))));s.store_scalar(639, if s.b[639] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_scaled_ln_scaled_input(232, 536, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));s.store_scaled_ln_scaled_input(236, 544, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));s.store_sqrt_div_from_scalar_ad(549, ((2.0 * 1.034943e-10) / 1.6021918e-19), s.ad_value(536));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_scalar(328, ((1.0 + (p[194] / ((s.v[100]) as f64).powf(p[195]))) * (1.0 + (p[196] / ((s.v[110]) as f64).powf(p[197])))));s.store_scalar(44, ((((s.v[328] * s.v[328]) + ((4.0 * 0.001) * 0.001))) as f64).sqrt());s.store_scalar(550, ((0.5 * (s.v[328] + s.v[44])) + (1e-10 * 0.001)));s.b[644] = (s.v[550] < 0.0);s.store_scalar(644, if s.b[644] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        let ctx_temp = ctx.temperature();let nv10 = ctx.node_voltage(nodes[10]);s.store_scaled_voltage(571, ctx, nodes, Some(6), Some(7), p[50]);s.store_scaled_voltage(572, ctx, nodes, Some(11), Some(7), p[50]);s.store_scaled_voltage(570, ctx, nodes, Some(12), Some(7), p[50]);s.b[657] = (p[43] == 1.0);s.store_scalar(657, if s.b[657] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        s.store_square(379, 328);s.store_sqrt_scaled_input_ad(444, A::div_scalar_by_product(1.034943e-10, s.ad_value(229), s.ad_value(225), 1.0), 2.0);s.store_div_from_scalar(547, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544);let t12: f64 = (2.0 * 1.034943e-10);let t13: f64 = (t12 / 1.6021918e-19);let t14: f64 = (t13 * s.v[231]);let t15: f64 = (t14 / s.v[544]);let t16: f64 = (t15).sqrt();s.store_scalar(416, t16);s.b[672] = (p[43] == 1.0);s.store_scalar(672, if s.b[672] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        s.copy_ad(157, 152);s.copy_ad(158, 153);s.copy_ad(156, 154);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        s: &mut Scratch,
    ) {
        s.store_scalar(144, 0.0);s.store_scalar(619, 0.0);s.store_scalar(620, 0.0);s.store_scalar(621, 0.0);s.store_scalar(622, 0.0);s.store_scalar(623, 0.0);s.store_scalar(624, 0.0);s.store_scalar(425, 0.0);s.store_scalar(426, 0.0);s.store_scalar(427, 0.0);s.store_scalar(428, 0.0);s.store_scalar(167, 0.0);s.store_scalar(168, 0.0);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_13(
        ...
        s.store_scaled_mul(680, 155, 157, 0.5);s.store_scale(44, 680, (2.0 * 1.0 / (p[226])));s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p[226], 45);s.b[681] = (s.v[175] < 5e-12);s.store_scalar(681, if s.b[681] { 1.0 } else { 0.0 });
