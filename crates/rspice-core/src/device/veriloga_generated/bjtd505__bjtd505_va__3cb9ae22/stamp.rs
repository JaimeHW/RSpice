...
struct CommonStampValues {
    ...
    FA: f64, L4: f64, Mj: f64, Mm: f64, Mp: f64, Ms: f64,
    Mw: f64, MA: f64, MI: f64, MO: f64, MX: f64, MZ: f64,
    ...
    ano: f64, anp: f64, anq: f64, anr: f64, aRL: f64, aRM: f64,
    aRN: f64, aRO: f64, aRP: f64, aRQ: f64, aRV: f64, aRW: f64,
    aS9: f64, aSa: f64, aSb: f64, aSc: f64, aSd: f64, aSe: f64,
    aSr: f64, aSs: f64, aSt: f64, aSu: f64, aSv: f64, aSw: f64,
    aSB: f64, aSC: f64, aSH: f64, aSI: f64, aTr: f64, aTs: f64,
    aTt: f64, aTu: f64, aTv: f64, aTw: f64, aTx: f64, aTy: f64,
    aU4: f64, aU5: f64, aU6: f64, aU7: f64, aUk: f64, aUl: f64,
    aUm: f64, aUn: f64, aUo: f64, aUp: f64, aUq: f64,
}
...
impl Instance {
    ...
    fn eval_common_stamp_values<const REACTIVE: bool>(&mut self, ctx: &GeneratedEvalContext<'_>) -> CommonStampValues {
        ...
        CommonStampValues {
            ...
            FA, L4, Mj, Mm, Mp, Ms, Mw, MA,
            MI, MO, MX, MZ, ND, NE, NF, NG,
            ...
            ano, anp, anq, anr, aRL, aRM, aRN, aRO,
            aRP, aRQ, aRV, aRW, aS9, aSa, aSb, aSc,
            aSd, aSe, aSr, aSs, aSt, aSu, aSv, aSw,
            aSB, aSC, aSH, aSI, aTr, aTs, aTt, aTu,
            aTv, aTw, aTx, aTy, aU4, aU5, aU6, aU7,
            aUk, aUl, aUm, aUn, aUo, aUp, aUq,
        }
    }
    ...
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        stamper.stamp_current_sparse_local::<9, 0>(
            ...
            multiplicity * (MI),
            [0, 1, 3, 4, 5, 6, 7, 8, 9],
            [aTr, aTs, aTt, aTr, aTu, aTv, aTw, aTx, aTy],
            [],
            [],
            multiplicity,
        );
