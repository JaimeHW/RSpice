...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if ((((s.b[521] && (!s.b[522])) && s.b[526]) && s.b[527]) && s.b[530]) {
            ...
            s.store_mul_ad(196, A::mul3(A::div(s.ad_value(0), s.ad_value(98)), s.ad_value(191), s.ad_value(195)), A::sub(A::exp_div_scaled_inputs(s.ad_value(98), -1.0, s.ad_value(191), 1.0), A::exp(A::mul_offset_rhs(A::div_scaled_inputs(s.ad_value(98), -1.0, s.ad_value(191), 1.0), A::div(s.ad_value(187), s.ad_value(195)), 1.0))));
        }

        if ((((s.b[521] && (!s.b[522])) && s.b[526]) && s.b[527]) && (!s.b[530])) {
            s.store_mul_ad_product_rhs(196, 0, s.ad_value(187), A::exp_div_scaled_inputs(s.ad_value(98), -1.0, s.ad_value(191), 1.0));
        }
