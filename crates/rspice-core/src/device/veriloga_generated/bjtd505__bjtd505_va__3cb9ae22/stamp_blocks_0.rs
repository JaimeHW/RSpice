...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_sub_ad_lhs(235, A::add_scaled_inputs3(s.ad_value(234), 1.0, s.ad_value(231), 1.0, s.ad_value(236), -1.0), 238);

        s.store_sub_ad_lhs(242, A::add_scaled_inputs3(s.ad_value(240), 1.0, s.ad_value(244), (-1.0), s.ad_value(235), 1.0), 237);
        ...
        s.store_ad_value(106, A::div_scaled_inputs(s.ad_value(253), 2.0, A::offset(s.ad_value(105), 1.0), 1.0));
        ...
        s.store_ad_value(107, A::add_scaled_inputs3(s.ad_value(104), s.v[6], s.ad_value(105), ((-1.0) * s.v[6]), A::ln(A::div(A::offset(s.ad_value(104), 1.0), A::offset(s.ad_value(105), 1.0))), (-s.v[6])));
        ...
        if s.b[476] {
            s.store_ad_value(109, A::add_scaled_inputs3(s.ad_value(16), 1.0, A::ln(A::scale_offset(s.ad_value(108), (0.5 * (s.v[31] * s.v[8])), 1.0)), (2.0 * s.v[6]), s.ad_value(277), -1.0));
        ...
        if (s.b[476] && s.b[478]) {
            s.store_ad_value(110, A::div_scaled_inputs(s.ad_value(261), 0.5, A::sub(A::sqrt(A::add(s.ad_value(262), s.ad_value(261))), s.ad_value(109)), 1.0));
        }
        ...
        if s.b[476] {
            s.store_ad_value(111, A::div_scaled_product(s.ad_value(110), A::offset(s.ad_value(110), (p.p61 * p.p60)), 1.0, A::scaled_offset(s.ad_value(110), (p.p61 * s.v[31]), p.p60), 1.0));
        ...
        if s.b[476] {
            ...
            s.store_div_ad(114, A::offset(A::sqrt(A::offset(A::mul3_scaled_output(s.ad_value(112), s.ad_value(113), A::offset(s.ad_value(113), 1.0), 4.0), 1.0)), 1.0), A::mul_scaled_lhs(s.ad_value(112), 2.0, A::offset(s.ad_value(113), 1.0)));
            s.store_div_ad(115, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(114)), 1.0, s.ad_value(106), s.ad_value(114), 1.0), A::offset(A::mul(s.ad_value(106), s.ad_value(114)), 1.0));
            s.store_scaled_mul(117, 108, 115, ((0.5 * s.v[31]) * s.v[8]));
            s.store_ad_value(266, A::add_scaled_product(s.ad_value(117), 2.0, s.ad_value(106), A::offset(A::add(s.ad_value(106), s.ad_value(117)), 1.0), 1.0));
        ...
        if s.b[476] {
            s.store_ad_value(127, A::div_scaled_inputs(s.ad_value(108), p.p61, A::offset(s.ad_value(108), p.p61), 1.0));
            s.store_div_from_scalar_offset_input(199, p.p61, 108, p.p61);
        }

        if (!s.b[476]) {
            s.store_scalar(111, 0.0);
            s.store_ad_value(119, A::div_scaled_inputs(s.ad_value(251), 2.0, A::offset(s.ad_value(104), 1.0), 1.0));
            s.copy_ad(121, 245);
        }
        ...
        if s.b[484] {
            s.store_ad_value(130, A::add_scaled_product(s.ad_value(232), 1.0, s.ad_value(273), A::ln_one_plus_exp(s.ad_value(259)), (-1.0)));
        }

        if (!s.b[484]) {
            s.store_ad_value(130, A::add_scaled_product(s.ad_value(129), 1.0, s.ad_value(273), A::ln_one_plus_exp(A::neg(s.ad_value(259))), (-1.0)));
        }

        s.store_powf_ad(59, A::sub_from_scalar(1.0, A::mul(s.ad_value(130), s.ad_value(65))), (1.0 - p.p66));

        s.store_ad_value(131, A::add_scaled_product(A::sub_scaled_inputs(s.ad_value(232), 3.0, s.ad_value(130), 3.0), 1.0, s.ad_value(14), A::sub_from_scalar(1.0, s.ad_value(59)), 1.0 / ((1.0 - p.p66))));
        ...
        if s.b[487] {
            s.store_ad_value(135, A::add_scaled_product(s.ad_value(132), 1.0, s.ad_value(126), A::ln_one_plus_exp(s.ad_value(259)), (-1.0)));
        }

        if (!s.b[487]) {
            s.store_ad_value(135, A::add_scaled_product(s.ad_value(134), 1.0, s.ad_value(126), A::ln_one_plus_exp(A::neg(s.ad_value(259))), (-1.0)));
        }

        s.store_powf(136, 199, p.p75);

        s.store_ad_value(137, A::add_scaled_product(A::mul3(s.ad_value(136), s.ad_value(133), A::sub(s.ad_value(132), s.ad_value(135))), 1.0, s.ad_value(17), A::sub_from_scalar(1.0, A::mul(s.ad_value(136), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(135), s.ad_value(17))), (1.0 - p.p71)))), 1.0 / ((1.0 - p.p71))));

        s.store_ad_value(138, A::add_scaled_products(A::sub_from_scalar(1.0, s.ad_value(25)), s.ad_value(137), 1.0, s.ad_value(25), s.ad_value(230), 1.0));
        ...
        if (!s.b[488]) {
            ...
            s.store_scaled_div(270, 138, 40, (-(s.v[99] * s.v[8])));
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[494] {
            let assign3700_ad_e3474: A = A::add(A::add_scaled_product(A::scaled_offset(s.ad_value(276), (-1.0), s.v[42]), 1.0, A::div_scaled_product(s.ad_value(53), A::offset(s.ad_value(276), (-1.0)), 2.0, A::offset(A::sqrt(A::scale_offset(s.ad_value(278), 4.0, 1.0)), 1.0), 1.0), A::offset(A::div(s.ad_value(138), s.ad_value(40)), 1.0), 1.0), A::div_scaled_product3(s.ad_value(54), A::offset(s.ad_value(121), (-1.0)), s.ad_value(279), 1.0, A::offset(s.ad_value(279), 1.0), 1.0));
        ...
        if ((!s.b[494]) && (!s.b[497])) {
            s.store_ad_value(151, A::add_scaled_product(A::scaled_offset(s.ad_value(276), (-1.0), (1.0 - p.p92)), s.v[42], A::offset(A::add(s.ad_value(276), s.ad_value(121)), (-2.0)), A::offset(A::div(s.ad_value(138), s.ad_value(40)), 1.0), (p.p92 * s.v[42])));
        }
        ...
        if s.b[499] {
            s.store_add_ad(152, A::scaled_offset(s.ad_value(276), (-1.0), s.v[44]), A::div_scaled_product(s.ad_value(45), A::offset(s.ad_value(276), (-1.0)), 2.0, A::offset(A::sqrt(A::scale_offset(s.ad_value(278), 4.0, 1.0)), 1.0), 1.0));
        }
        ...
        if s.b[505] {
            ...
            s.store_scaled_mul_ad(60, A::powf(A::sqrt(A::offset(A::square(s.ad_value(255)), 1e-30)), ((-2.0) - p.p66)), A::sub_scaled_inputs(A::sub_from_scalar((1.0 - (p.p66 * p.p66)), A::scale(s.ad_value(255), (3.0 * (p.p66 - 1.0)))), p.p66, A::mul3_scaled_output(s.ad_value(255), s.ad_value(255), A::offset(s.ad_value(255), (p.p66 - 1.0)), 6.0), 1.0), 0.16666666666666666);
            s.store_ad_value(255, A::div_scaled_product(s.ad_value(232), s.ad_value(61), s.v[62], A::mul(s.ad_value(70), s.ad_value(60)), 1.0));
        }
        ...
        if s.b[509] {
            let assign4300_ad_e4164: A = A::mul_scaled_output(A::powf(A::sqrt(A::offset(A::square(s.ad_value(257)), 1e-30)), ((-2.0) - s.v[76])), A::sub_scaled_inputs(A::sub_from_scalar((1.0 - (s.v[76] * s.v[76])), A::scale(s.ad_value(257), (3.0 * (s.v[76] - 1.0)))), s.v[76], A::mul3_scaled_output(s.ad_value(257), s.ad_value(257), A::offset(s.ad_value(257), (s.v[76] - 1.0)), 6.0), 1.0), 0.16666666666666666);
            s.store_ad_value(80, assign4300_ad_e4164);
        }

        if s.b[509] {
            s.store_ad_value(257, A::div_scaled_product(s.ad_value(230), s.ad_value(83), s.v[79], A::mul(s.ad_value(85), s.ad_value(80)), 1.0));
        }
        ...
        s.store_div_ad(157, A::scaled_offset(s.ad_value(248), (-1.0), (2.0 * s.v[43])), A::offset(A::sqrt(A::scale_offset(s.ad_value(248), ((4.0 * s.v[43]) / s.v[37]), 1.0)), 1.0));
        ...
        if s.b[513] {
            ...
            s.store_div_ad(164, A::scaled_offset(s.ad_value(249), (-1.0), ((p.p32 * 2.0) * s.v[43])), A::offset(A::sqrt(A::scale_offset(s.ad_value(249), ((4.0 * s.v[43]) / s.v[37]), 1.0)), 1.0));
        ...
        if ((s.b[513] && s.b[514]) && s.b[515]) {
            s.store_ad_value(167, A::div_scaled_inputs(s.ad_value(261), 0.5, A::sub(A::sqrt(A::add(s.ad_value(262), s.ad_value(261))), s.ad_value(264)), 1.0));
        }
        ...
        if (s.b[513] && s.b[514]) {
            s.store_div_ad_rhs(168, 167, A::add(A::add_scaled_inputs3(s.ad_value(271), 1.0, s.ad_value(164), s.v[32], s.ad_value(165), s.v[32]), s.ad_value(167)));
        }
        ...
        if (s.b[516] && s.b[517]) {
            s.store_ad_value(323, A::div_scaled_inputs(s.ad_value(261), 0.5, A::sub_scaled_inputs(A::sqrt(A::add(s.ad_value(262), s.ad_value(261))), 1.0, s.ad_value(322), (-1.0)), 1.0));
        }
        ...
        if (s.b[516] && (!s.b[518])) {
            s.store_ad_value(320, A::add_scaled_product(s.ad_value(324), 1.0, A::sub(s.ad_value(323), s.ad_value(319)), s.ad_value(321), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_div_ad_lhs(177, A::add(A::scaled_offset(s.ad_value(247), (-1.0), (2.0 * s.v[6])), s.ad_value(234)), 175);
        ...
        if (((s.b[521] && (!s.b[522])) && s.b[526]) && s.b[527]) {
            s.store_ad_value(188, A::div_scaled_product(s.ad_value(186), s.ad_value(187), 1.0, A::sqrt(A::add(A::square(s.ad_value(186)), A::square(s.ad_value(187)))), 1.0));
        ...
        if ((((s.b[521] && (!s.b[522])) && s.b[526]) && s.b[527]) && (!s.b[529])) {
            ...
            s.store_ad_value(260, A::add_scaled_product(A::mul3_scaled_output(s.ad_value(189), s.ad_value(189), s.ad_value(127), (0.1 * 1.0 / (p.p61))), 1.0, A::sub(s.ad_value(194), s.ad_value(190)), A::sub(s.ad_value(194), s.ad_value(190)), 1.0));
            s.store_ad_value(191, A::add_scaled_inputs3(s.ad_value(194), 0.5, s.ad_value(190), 0.5, A::sqrt(s.ad_value(260)), 0.5));
        }
        ...
        if ((((s.b[521] && (!s.b[522])) && s.b[526]) && s.b[527]) && s.b[530]) {
            ...
            s.store_mul_ad(196, A::mul3(A::div(s.ad_value(0), s.ad_value(98)), s.ad_value(191), s.ad_value(195)), A::sub(A::exp(A::div_scaled_inputs(s.ad_value(98), -1.0, s.ad_value(191), 1.0)), A::exp(A::mul(A::div_scaled_inputs(s.ad_value(98), -1.0, s.ad_value(191), 1.0), A::offset(A::div(s.ad_value(187), s.ad_value(195)), 1.0)))));
        }
        ...
        if ((s.b[521] && s.b[536]) && s.b[537]) {
            s.store_ad_value(197, A::add_scaled_inputs3(A::div_from_scalar(s.v[6], A::mul(s.ad_value(149), A::add(s.ad_value(30), s.ad_value(175)))), 1.0, A::div(s.ad_value(146), s.ad_value(35)), s.v[42], A::div(s.ad_value(28), A::add(s.ad_value(30), s.ad_value(175))), 1.0));
        }
        ...
        if (((s.b[521] && s.b[536]) && s.b[537]) && (!s.b[538])) {
            s.store_ad_value(198, A::div_scaled_product3(s.ad_value(149), s.ad_value(196), s.ad_value(197), 1.0, A::add(s.ad_value(196), s.ad_value(197)), 1.0));
        }
        ...
        if s.b[541] {
            s.store_ad_value(205, A::add_scaled_product(s.ad_value(233), 1.0, s.ad_value(273), A::ln_one_plus_exp(s.ad_value(259)), (-1.0)));
        }

        if (!s.b[541]) {
            s.store_ad_value(205, A::add_scaled_product(s.ad_value(129), 1.0, s.ad_value(273), A::ln_one_plus_exp(A::neg(s.ad_value(259))), (-1.0)));
        }

        s.store_mul_scaled_ad_rhs(206, 23, p.p67, A::add_scaled_product(A::sub_scaled_inputs(s.ad_value(233), 3.0, s.ad_value(205), 3.0), 1.0, s.ad_value(14), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::mul(s.ad_value(205), s.ad_value(65))), (1.0 - p.p66))), 1.0 / ((1.0 - p.p66))));
        ...
        if s.b[542] {
            s.store_ad_value(214, A::add_scaled_product(s.ad_value(235), 1.0, s.ad_value(274), A::ln_one_plus_exp(s.ad_value(259)), (-1.0)));
        }

        if (!s.b[542]) {
            s.store_ad_value(214, A::add_scaled_product(s.ad_value(134), 1.0, s.ad_value(274), A::ln_one_plus_exp(A::neg(s.ad_value(259))), (-1.0)));
        }

        s.store_ad_value(215, A::add_scaled_products(s.ad_value(17), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(214), s.ad_value(17))), (1.0 - p.p71))), 1.0 / ((1.0 - p.p71)), s.ad_value(133), A::sub(s.ad_value(235), s.ad_value(214)), 1.0));

        s.store_mul_scaled_ad_rhs(216, 24, ((1.0 - p.p76) * (1.0 - p.p32)), A::add_scaled_products(A::sub_from_scalar(1.0, s.ad_value(25)), s.ad_value(215), 1.0, s.ad_value(25), s.ad_value(235), 1.0));
        ...
        if s.b[543] {
            s.store_ad_value(217, A::add_scaled_product(s.ad_value(241), 1.0, s.ad_value(274), A::ln_one_plus_exp(s.ad_value(259)), (-1.0)));
        }

        if (!s.b[543]) {
            s.store_ad_value(217, A::add_scaled_product(s.ad_value(134), 1.0, s.ad_value(274), A::ln_one_plus_exp(A::neg(s.ad_value(259))), (-1.0)));
        }

        s.store_ad_value(218, A::add_scaled_products(s.ad_value(17), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(217), s.ad_value(17))), (1.0 - p.p71))), 1.0 / ((1.0 - p.p71)), s.ad_value(133), A::sub(s.ad_value(241), s.ad_value(217)), 1.0));

        s.store_mul_scaled_ad_rhs(219, 24, ((1.0 - p.p76) * p.p32), A::add_scaled_products(A::sub_from_scalar(1.0, s.ad_value(25)), s.ad_value(218), 1.0, s.ad_value(25), s.ad_value(241), 1.0));
        ...
        if (!s.b[545]) {
            s.store_ad_value(229, A::div_scaled_inputs(s.ad_value(248), ((2.0 * s.v[43]) * s.v[97]), A::offset(A::sqrt(A::scale_offset(s.ad_value(170), 4.0, 1.0)), 1.0), 1.0));
        }
        ...
        if (s.b[547] && (!s.b[548])) {
            s.store_ad_value(227, A::div_scaled_inputs(s.ad_value(249), (((2.0 * p.p32) * s.v[43]) * s.v[97]), A::offset(A::sqrt(A::scale_offset(s.ad_value(171), 4.0, 1.0)), 1.0), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        s.store_scaled_abs_ad(289, A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(151), 1.0, s.ad_value(153), 1.0, s.ad_value(57), -1.0), 1.0, s.ad_value(327), 1.0, s.ad_value(326), 1.0), (2.0 * 1.6021918e-19));
        ...
        s.store_ad_value(302, A::add_scaled_inputs3(s.ad_value(153), 1.0, s.ad_value(155), 1.0, s.ad_value(156), 1.0));
