...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_83(
        ...
        let tf9: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f263 = tf9;
    ...
    pub(super) fn stamp_transient_block_87(
        ...
        let t1f7: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f28d = t1f7;
    ...
    pub(super) fn stamp_transient_block_88(
        ...
        let t262: f64 = if l.f5e5 < p[85] { 1.0 } else { 0.0 };l.f29d = t262;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29d != 0.0)) {let t263: f64 = (l.f73d - l.f793);let t264: f64 = (p[86] * t263);let t265: f64 = (t264 + l.f5e5);(l.f601, l.f602, l.f603, ) = (t265, 0.0, 0.0, );let t266: f64 = (p[86] * l.f793);let t267: f64 = (l.f5e5 - t266);(l.f5ed, l.f5ee, l.f5ef, ) = (t267, 0.0, 0.0, );let t268: f64 = (p[85] - l.f601);let t269: f64 = (t268 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t269, (-l.f602), (-l.f603), );let t26a: f64 = (4.0 * p[85]);let t26b: f64 = (t26a * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t26b, 0.0, 0.0, );}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29d != 0.0)) {let t270: f64 = (l.f6f3 * l.f6f3);let t271: f64 = (t270 + l.f6f7);let t272: f64 = (t271).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t272, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t272)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t272)), );let t273: f64 = (l.f6f3 + l.f6f7);let t274: f64 = (0.5 * t273);let t275: f64 = (p[85] - t274);(l.f605, l.f606, l.f607, ) = (t275, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t276: f64 = (l.f605 - l.f5e5);let t277: f64 = (t276 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t277, l.f606, l.f607, );let t278: f64 = (4.0 * l.f5e5);let t279: f64 = (t278 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t279, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29d != 0.0)) {
            let (t27b, t27c, t27d,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
    ...
    if (l.f6f7 > 0.0) {
        ...
        let t2a0: f64 = (l.f73d / l.f5f1);let t2a1: f64 = (l.f5f1 - l.f5ed);let t2a2: f64 = (l.f793 * t2a1);let t2a3: f64 = (l.f5ed * p[85]);let t2a4: f64 = (t2a2 / t2a3);let t2a5: f64 = (t2a0 + t2a4);let t2a6: f64 = (l.f645 * t2a5);let t2a7: f64 = (t2a6).abs();let t2a8: f64 = if t2a7 < 230.25850929940458 { 1.0 } else { 0.0 };l.f29f = t2a8;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29f != 0.0)) {let t2a9: f64 = (l.f73d / l.f5f1);let t2aa: f64 = (l.f5f1 - l.f5ed);let t2ab: f64 = (l.f793 * t2aa);let t2ac: f64 = (l.f5ed * p[85]);let t2ad: f64 = (t2ab / t2ac);let t2ae: f64 = (t2a9 + t2ad);let t2af: f64 = (l.f645 * t2ae);let t2b0: f64 = (t2af).exp();(l.f536, l.f537, l.f538, ) = (t2b0, (t2b0 * (l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2ac) - (t2ab * (l.f5ee * p[85]))) / (t2ac * t2ac))))), (t2b0 * (l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2ac) - (t2ab * (l.f5ef * p[85]))) / (t2ac * t2ac))))), );}
        let t2b1: f64 = (l.f73d / l.f5f1);let t2b2: f64 = (l.f5f1 - l.f5ed);let t2b3: f64 = (l.f793 * t2b2);let t2b4: f64 = (l.f5ed * p[85]);let t2b5: f64 = (t2b3 / t2b4);let t2b6: f64 = (t2b1 + t2b5);let t2b7: f64 = (l.f645 * t2b6);let t2b8: f64 = (-230.25850929940458);let t2b9: f64 = if t2b7 < t2b8 { 1.0 } else { 0.0 };l.f2a1 = t2b9;
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_90(
        ...
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29f == 0.0)) && (l.f2a1 != 0.0)) {let t2ba: f64 = (-230.25850929940458);let t2bb: f64 = (l.f73d / l.f5f1);let t2bc: f64 = (l.f5f1 - l.f5ed);let t2bd: f64 = (l.f793 * t2bc);let t2be: f64 = (l.f5ed * p[85]);let t2bf: f64 = (t2bd / t2be);let t2c0: f64 = (t2bb + t2bf);let t2c1: f64 = (l.f645 * t2c0);let t2c2: f64 = (t2ba - t2c1);let t2c3: f64 = (-230.25850929940458);let t2c4: f64 = (l.f73d / l.f5f1);let t2c5: f64 = (l.f5f1 - l.f5ed);let t2c6: f64 = (l.f793 * t2c5);let t2c7: f64 = (l.f5ed * p[85]);let t2c8: f64 = (t2c6 / t2c7);let t2c9: f64 = (t2c4 + t2c8);let t2ca: f64 = (l.f645 * t2c9);let t2cb: f64 = (t2c3 - t2ca);let t2cc: f64 = (-230.25850929940458);let t2cd: f64 = (l.f73d / l.f5f1);let t2ce: f64 = (l.f5f1 - l.f5ed);let t2cf: f64 = (l.f793 * t2ce);let t2d0: f64 = (l.f5ed * p[85]);let t2d1: f64 = (t2cf / t2d0);let t2d2: f64 = (t2cd + t2d1);let t2d3: f64 = (l.f645 * t2d2);let t2d4: f64 = (t2cc - t2d3);let t2d5: f64 = (t2d4 * 0.3333333333333333);let t2d6: f64 = (1.0 + t2d5);let t2d7: f64 = (t2cb * t2d6);let t2d8: f64 = (0.5 * t2d7);let t2d9: f64 = (1.0 + t2d8);let t2da: f64 = (t2c2 * t2d9);let t2db: f64 = (1.0 + t2da);let t2dc: f64 = (1e-100 / t2db);(l.f536, l.f537, l.f538, ) = (t2dc, (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2be) - (t2bd * (l.f5ee * p[85]))) / (t2be * t2be))))) * t2d9) + (t2c2 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2c7) - (t2c6 * (l.f5ee * p[85]))) / (t2c7 * t2c7))))) * t2d6) + (t2cb * ((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2d0) - (t2cf * (l.f5ee * p[85]))) / (t2d0 * t2d0))))) * 0.3333333333333333))))))) / (t2db * t2db))), (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2be) - (t2bd * (l.f5ef * p[85]))) / (t2be * t2be))))) * t2d9) + (t2c2 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2c7) - (t2c6 * (l.f5ef * p[85]))) / (t2c7 * t2c7))))) * t2d6) + (t2cb * ((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2d0) - (t2cf * (l.f5ef * p[85]))) / (t2d0 * t2d0))))) * 0.3333333333333333))))))) / (t2db * t2db))), );}
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f29f == 0.0)) && (l.f2a1 == 0.0)) {let t2dd: f64 = (l.f73d / l.f5f1);let t2de: f64 = (l.f5f1 - l.f5ed);let t2df: f64 = (l.f793 * t2de);let t2e0: f64 = (l.f5ed * p[85]);let t2e1: f64 = (t2df / t2e0);let t2e2: f64 = (t2dd + t2e1);let t2e3: f64 = (l.f645 * t2e2);let t2e4: f64 = (t2e3 - 230.25850929940458);let t2e5: f64 = (l.f73d / l.f5f1);let t2e6: f64 = (l.f5f1 - l.f5ed);let t2e7: f64 = (l.f793 * t2e6);let t2e8: f64 = (l.f5ed * p[85]);let t2e9: f64 = (t2e7 / t2e8);let t2ea: f64 = (t2e5 + t2e9);let t2eb: f64 = (l.f645 * t2ea);let t2ec: f64 = (t2eb - 230.25850929940458);let t2ed: f64 = (l.f73d / l.f5f1);let t2ee: f64 = (l.f5f1 - l.f5ed);let t2ef: f64 = (l.f793 * t2ee);let t2f0: f64 = (l.f5ed * p[85]);let t2f1: f64 = (t2ef / t2f0);let t2f2: f64 = (t2ed + t2f1);let t2f3: f64 = (l.f645 * t2f2);let t2f4: f64 = (t2f3 - 230.25850929940458);let t2f5: f64 = (t2f4 * 0.3333333333333333);let t2f6: f64 = (1.0 + t2f5);let t2f7: f64 = (t2ec * t2f6);let t2f8: f64 = (0.5 * t2f7);let t2f9: f64 = (1.0 + t2f8);let t2fa: f64 = (t2e4 * t2f9);let t2fb: f64 = (1.0 + t2fa);let t2fc: f64 = (1e100 * t2fb);(l.f536, l.f537, l.f538, ) = (t2fc, (1e100 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2e0) - (t2df * (l.f5ee * p[85]))) / (t2e0 * t2e0)))) * t2f9) + (t2e4 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2e8) - (t2e7 * (l.f5ee * p[85]))) / (t2e8 * t2e8)))) * t2f6) + (t2ec * ((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t2f0) - (t2ef * (l.f5ee * p[85]))) / (t2f0 * t2f0)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2e0) - (t2df * (l.f5ef * p[85]))) / (t2e0 * t2e0)))) * t2f9) + (t2e4 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2e8) - (t2e7 * (l.f5ef * p[85]))) / (t2e8 * t2e8)))) * t2f6) + (t2ec * ((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t2f0) - (t2ef * (l.f5ef * p[85]))) / (t2f0 * t2f0)))) * 0.3333333333333333))))))), );}
        ...
        let t303: f64 = if l.f5e9 < p[85] { 1.0 } else { 0.0 };l.f2a3 = t303;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a3 != 0.0)) {let t304: f64 = (l.f73d - l.f793);let t305: f64 = (p[86] * t304);let t306: f64 = (t305 + l.f5e9);(l.f601, l.f602, l.f603, ) = (t306, 0.0, 0.0, );let t307: f64 = (p[86] * l.f793);let t308: f64 = (l.f5e9 - t307);(l.f5ed, l.f5ee, l.f5ef, ) = (t308, 0.0, 0.0, );let t309: f64 = (p[85] - l.f601);let t30a: f64 = (t309 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t30a, (-l.f602), (-l.f603), );let t30b: f64 = (4.0 * p[85]);let t30c: f64 = (t30b * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t30c, 0.0, 0.0, );}
    ...
    pub(super) fn stamp_transient_block_91(
        ...
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a3 != 0.0)) {let t311: f64 = (l.f6f3 * l.f6f3);let t312: f64 = (t311 + l.f6f7);let t313: f64 = (t312).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t313, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t313)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t313)), );let t314: f64 = (l.f6f3 + l.f6f7);let t315: f64 = (0.5 * t314);let t316: f64 = (p[85] - t315);(l.f605, l.f606, l.f607, ) = (t316, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t317: f64 = (l.f605 - l.f5e9);let t318: f64 = (t317 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t318, l.f606, l.f607, );let t319: f64 = (4.0 * l.f5e9);let t31a: f64 = (t319 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t31a, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a3 != 0.0)) {
            let (t31c, t31d, t31e,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
    ...
    if (l.f6f7 > 0.0) {
        ...
        let t341: f64 = (l.f73d / l.f5f1);let t342: f64 = (l.f5f1 - l.f5ed);let t343: f64 = (l.f793 * t342);let t344: f64 = (l.f5ed * p[85]);let t345: f64 = (t343 / t344);let t346: f64 = (t341 + t345);let t347: f64 = (l.f645 * t346);let t348: f64 = (t347).abs();let t349: f64 = if t348 < 230.25850929940458 { 1.0 } else { 0.0 };l.f2a5 = t349;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a5 != 0.0)) {let t34a: f64 = (l.f73d / l.f5f1);let t34b: f64 = (l.f5f1 - l.f5ed);let t34c: f64 = (l.f793 * t34b);let t34d: f64 = (l.f5ed * p[85]);let t34e: f64 = (t34c / t34d);let t34f: f64 = (t34a + t34e);let t350: f64 = (l.f645 * t34f);let t351: f64 = (t350).exp();(l.f53e, l.f53f, l.f540, ) = (t351, (t351 * (l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t34d) - (t34c * (l.f5ee * p[85]))) / (t34d * t34d))))), (t351 * (l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t34d) - (t34c * (l.f5ef * p[85]))) / (t34d * t34d))))), );}
        let t352: f64 = (l.f73d / l.f5f1);let t353: f64 = (l.f5f1 - l.f5ed);let t354: f64 = (l.f793 * t353);let t355: f64 = (l.f5ed * p[85]);let t356: f64 = (t354 / t355);let t357: f64 = (t352 + t356);let t358: f64 = (l.f645 * t357);let t359: f64 = (-230.25850929940458);let t35a: f64 = if t358 < t359 { 1.0 } else { 0.0 };l.f2a7 = t35a;
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_92(
        ...
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a5 == 0.0)) && (l.f2a7 != 0.0)) {let t35b: f64 = (-230.25850929940458);let t35c: f64 = (l.f73d / l.f5f1);let t35d: f64 = (l.f5f1 - l.f5ed);let t35e: f64 = (l.f793 * t35d);let t35f: f64 = (l.f5ed * p[85]);let t360: f64 = (t35e / t35f);let t361: f64 = (t35c + t360);let t362: f64 = (l.f645 * t361);let t363: f64 = (t35b - t362);let t364: f64 = (-230.25850929940458);let t365: f64 = (l.f73d / l.f5f1);let t366: f64 = (l.f5f1 - l.f5ed);let t367: f64 = (l.f793 * t366);let t368: f64 = (l.f5ed * p[85]);let t369: f64 = (t367 / t368);let t36a: f64 = (t365 + t369);let t36b: f64 = (l.f645 * t36a);let t36c: f64 = (t364 - t36b);let t36d: f64 = (-230.25850929940458);let t36e: f64 = (l.f73d / l.f5f1);let t36f: f64 = (l.f5f1 - l.f5ed);let t370: f64 = (l.f793 * t36f);let t371: f64 = (l.f5ed * p[85]);let t372: f64 = (t370 / t371);let t373: f64 = (t36e + t372);let t374: f64 = (l.f645 * t373);let t375: f64 = (t36d - t374);let t376: f64 = (t375 * 0.3333333333333333);let t377: f64 = (1.0 + t376);let t378: f64 = (t36c * t377);let t379: f64 = (0.5 * t378);let t37a: f64 = (1.0 + t379);let t37b: f64 = (t363 * t37a);let t37c: f64 = (1.0 + t37b);let t37d: f64 = (1e-100 / t37c);(l.f53e, l.f53f, l.f540, ) = (t37d, (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t35f) - (t35e * (l.f5ee * p[85]))) / (t35f * t35f))))) * t37a) + (t363 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t368) - (t367 * (l.f5ee * p[85]))) / (t368 * t368))))) * t377) + (t36c * ((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t371) - (t370 * (l.f5ee * p[85]))) / (t371 * t371))))) * 0.3333333333333333))))))) / (t37c * t37c))), (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t35f) - (t35e * (l.f5ef * p[85]))) / (t35f * t35f))))) * t37a) + (t363 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t368) - (t367 * (l.f5ef * p[85]))) / (t368 * t368))))) * t377) + (t36c * ((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t371) - (t370 * (l.f5ef * p[85]))) / (t371 * t371))))) * 0.3333333333333333))))))) / (t37c * t37c))), );}
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a5 == 0.0)) && (l.f2a7 == 0.0)) {let t37e: f64 = (l.f73d / l.f5f1);let t37f: f64 = (l.f5f1 - l.f5ed);let t380: f64 = (l.f793 * t37f);let t381: f64 = (l.f5ed * p[85]);let t382: f64 = (t380 / t381);let t383: f64 = (t37e + t382);let t384: f64 = (l.f645 * t383);let t385: f64 = (t384 - 230.25850929940458);let t386: f64 = (l.f73d / l.f5f1);let t387: f64 = (l.f5f1 - l.f5ed);let t388: f64 = (l.f793 * t387);let t389: f64 = (l.f5ed * p[85]);let t38a: f64 = (t388 / t389);let t38b: f64 = (t386 + t38a);let t38c: f64 = (l.f645 * t38b);let t38d: f64 = (t38c - 230.25850929940458);let t38e: f64 = (l.f73d / l.f5f1);let t38f: f64 = (l.f5f1 - l.f5ed);let t390: f64 = (l.f793 * t38f);let t391: f64 = (l.f5ed * p[85]);let t392: f64 = (t390 / t391);let t393: f64 = (t38e + t392);let t394: f64 = (l.f645 * t393);let t395: f64 = (t394 - 230.25850929940458);let t396: f64 = (t395 * 0.3333333333333333);let t397: f64 = (1.0 + t396);let t398: f64 = (t38d * t397);let t399: f64 = (0.5 * t398);let t39a: f64 = (1.0 + t399);let t39b: f64 = (t385 * t39a);let t39c: f64 = (1.0 + t39b);let t39d: f64 = (1e100 * t39c);(l.f53e, l.f53f, l.f540, ) = (t39d, (1e100 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t381) - (t380 * (l.f5ee * p[85]))) / (t381 * t381)))) * t39a) + (t385 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t389) - (t388 * (l.f5ee * p[85]))) / (t389 * t389)))) * t397) + (t38d * ((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t391) - (t390 * (l.f5ee * p[85]))) / (t391 * t391)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t381) - (t380 * (l.f5ef * p[85]))) / (t381 * t381)))) * t39a) + (t385 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t389) - (t388 * (l.f5ef * p[85]))) / (t389 * t389)))) * t397) + (t38d * ((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t391) - (t390 * (l.f5ef * p[85]))) / (t391 * t391)))) * 0.3333333333333333))))))), );}
        ...
        let t3a4: f64 = if l.f5e7 < p[85] { 1.0 } else { 0.0 };l.f2a9 = t3a4;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a9 != 0.0)) {let t3a5: f64 = (l.f73d - l.f793);let t3a6: f64 = (p[86] * t3a5);let t3a7: f64 = (t3a6 + l.f5e7);(l.f601, l.f602, l.f603, ) = (t3a7, 0.0, 0.0, );let t3a8: f64 = (p[86] * l.f793);let t3a9: f64 = (l.f5e7 - t3a8);(l.f5ed, l.f5ee, l.f5ef, ) = (t3a9, 0.0, 0.0, );let t3aa: f64 = (p[85] - l.f601);let t3ab: f64 = (t3aa - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t3ab, (-l.f602), (-l.f603), );let t3ac: f64 = (4.0 * p[85]);let t3ad: f64 = (t3ac * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t3ad, 0.0, 0.0, );}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a9 != 0.0)) {let t3ce: f64 = (l.f6f3 * l.f6f3);let t3cf: f64 = (t3ce + l.f6f7);let t3d0: f64 = (t3cf).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t3d0, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t3d0)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t3d0)), );let t3d1: f64 = (l.f6f3 + l.f6f7);let t3d2: f64 = (0.5 * t3d1);let t3d3: f64 = (p[85] - t3d2);(l.f5ed, l.f5ee, l.f5ef, ) = (t3d3, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t3d4: f64 = (l.f5ed - l.f5e7);let t3d5: f64 = (t3d4 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t3d5, l.f5ee, l.f5ef, );let t3d6: f64 = (4.0 * l.f5e7);let t3d7: f64 = (t3d6 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t3d7, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2a9 != 0.0)) {
            let (t3d9, t3da, t3db,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        let t3e2: f64 = (l.f73d / l.f5f1);let t3e3: f64 = (l.f5f1 - l.f5ed);let t3e4: f64 = (l.f793 * t3e3);let t3e5: f64 = (l.f5ed * p[85]);let t3e6: f64 = (t3e4 / t3e5);let t3e7: f64 = (t3e2 + t3e6);let t3e8: f64 = (l.f645 * t3e7);let t3e9: f64 = (t3e8).abs();let t3ea: f64 = if t3e9 < 230.25850929940458 { 1.0 } else { 0.0 };l.f2ab = t3ea;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2ab != 0.0)) {let t3eb: f64 = (l.f73d / l.f5f1);let t3ec: f64 = (l.f5f1 - l.f5ed);let t3ed: f64 = (l.f793 * t3ec);let t3ee: f64 = (l.f5ed * p[85]);let t3ef: f64 = (t3ed / t3ee);let t3f0: f64 = (t3eb + t3ef);let t3f1: f64 = (l.f645 * t3f0);let t3f2: f64 = (t3f1).exp();(l.f53a, l.f53b, l.f53c, ) = (t3f2, (t3f2 * (l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t3ee) - (t3ed * (l.f5ee * p[85]))) / (t3ee * t3ee))))), (t3f2 * (l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t3ee) - (t3ed * (l.f5ef * p[85]))) / (t3ee * t3ee))))), );}
        let t3f3: f64 = (l.f73d / l.f5f1);let t3f4: f64 = (l.f5f1 - l.f5ed);let t3f5: f64 = (l.f793 * t3f4);let t3f6: f64 = (l.f5ed * p[85]);let t3f7: f64 = (t3f5 / t3f6);let t3f8: f64 = (t3f3 + t3f7);let t3f9: f64 = (l.f645 * t3f8);let t3fa: f64 = (-230.25850929940458);let t3fb: f64 = if t3f9 < t3fa { 1.0 } else { 0.0 };l.f2ad = t3fb;
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_94(
        ...
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2ab == 0.0)) && (l.f2ad != 0.0)) {let t3fc: f64 = (-230.25850929940458);let t3fd: f64 = (l.f73d / l.f5f1);let t3fe: f64 = (l.f5f1 - l.f5ed);let t3ff: f64 = (l.f793 * t3fe);let t400: f64 = (l.f5ed * p[85]);let t401: f64 = (t3ff / t400);let t402: f64 = (t3fd + t401);let t403: f64 = (l.f645 * t402);let t404: f64 = (t3fc - t403);let t405: f64 = (-230.25850929940458);let t406: f64 = (l.f73d / l.f5f1);let t407: f64 = (l.f5f1 - l.f5ed);let t408: f64 = (l.f793 * t407);let t409: f64 = (l.f5ed * p[85]);let t40a: f64 = (t408 / t409);let t40b: f64 = (t406 + t40a);let t40c: f64 = (l.f645 * t40b);let t40d: f64 = (t405 - t40c);let t40e: f64 = (-230.25850929940458);let t40f: f64 = (l.f73d / l.f5f1);let t410: f64 = (l.f5f1 - l.f5ed);let t411: f64 = (l.f793 * t410);let t412: f64 = (l.f5ed * p[85]);let t413: f64 = (t411 / t412);let t414: f64 = (t40f + t413);let t415: f64 = (l.f645 * t414);let t416: f64 = (t40e - t415);let t417: f64 = (t416 * 0.3333333333333333);let t418: f64 = (1.0 + t417);let t419: f64 = (t40d * t418);let t41a: f64 = (0.5 * t419);let t41b: f64 = (1.0 + t41a);let t41c: f64 = (t404 * t41b);let t41d: f64 = (1.0 + t41c);let t41e: f64 = (1e-100 / t41d);(l.f53a, l.f53b, l.f53c, ) = (t41e, (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t400) - (t3ff * (l.f5ee * p[85]))) / (t400 * t400))))) * t41b) + (t404 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t409) - (t408 * (l.f5ee * p[85]))) / (t409 * t409))))) * t418) + (t40d * ((-(l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t412) - (t411 * (l.f5ee * p[85]))) / (t412 * t412))))) * 0.3333333333333333))))))) / (t41d * t41d))), (-((1e-100 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t400) - (t3ff * (l.f5ef * p[85]))) / (t400 * t400))))) * t41b) + (t404 * (0.5 * (((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t409) - (t408 * (l.f5ef * p[85]))) / (t409 * t409))))) * t418) + (t40d * ((-(l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t412) - (t411 * (l.f5ef * p[85]))) / (t412 * t412))))) * 0.3333333333333333))))))) / (t41d * t41d))), );}
        if (((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 != 0.0)) && (l.f2ab == 0.0)) && (l.f2ad == 0.0)) {let t41f: f64 = (l.f73d / l.f5f1);let t420: f64 = (l.f5f1 - l.f5ed);let t421: f64 = (l.f793 * t420);let t422: f64 = (l.f5ed * p[85]);let t423: f64 = (t421 / t422);let t424: f64 = (t41f + t423);let t425: f64 = (l.f645 * t424);let t426: f64 = (t425 - 230.25850929940458);let t427: f64 = (l.f73d / l.f5f1);let t428: f64 = (l.f5f1 - l.f5ed);let t429: f64 = (l.f793 * t428);let t42a: f64 = (l.f5ed * p[85]);let t42b: f64 = (t429 / t42a);let t42c: f64 = (t427 + t42b);let t42d: f64 = (l.f645 * t42c);let t42e: f64 = (t42d - 230.25850929940458);let t42f: f64 = (l.f73d / l.f5f1);let t430: f64 = (l.f5f1 - l.f5ed);let t431: f64 = (l.f793 * t430);let t432: f64 = (l.f5ed * p[85]);let t433: f64 = (t431 / t432);let t434: f64 = (t42f + t433);let t435: f64 = (l.f645 * t434);let t436: f64 = (t435 - 230.25850929940458);let t437: f64 = (t436 * 0.3333333333333333);let t438: f64 = (1.0 + t437);let t439: f64 = (t42e * t438);let t43a: f64 = (0.5 * t439);let t43b: f64 = (1.0 + t43a);let t43c: f64 = (t426 * t43b);let t43d: f64 = (1.0 + t43c);let t43e: f64 = (1e100 * t43d);(l.f53a, l.f53b, l.f53c, ) = (t43e, (1e100 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t422) - (t421 * (l.f5ee * p[85]))) / (t422 * t422)))) * t43b) + (t426 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t42a) - (t429 * (l.f5ee * p[85]))) / (t42a * t42a)))) * t438) + (t42e * ((l.f645 * ((-((l.f73d * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t432) - (t431 * (l.f5ee * p[85]))) / (t432 * t432)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t422) - (t421 * (l.f5ef * p[85]))) / (t422 * t422)))) * t43b) + (t426 * (0.5 * (((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t42a) - (t429 * (l.f5ef * p[85]))) / (t42a * t42a)))) * t438) + (t42e * ((l.f645 * ((-((l.f73d * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t432) - (t431 * (l.f5ef * p[85]))) / (t432 * t432)))) * 0.3333333333333333))))))), );}
        ...
        let t44a: f64 = if l.f5e5 < p[85] { 1.0 } else { 0.0 };l.f2b0 = t44a;
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 == 0.0)) && (l.f2b0 != 0.0)) {let t44b: f64 = (l.f7b1 - l.f793);let t44c: f64 = (p[86] * t44b);let t44d: f64 = (t44c + l.f5e5);(l.f601, l.f602, l.f603, ) = (t44d, 0.0, 0.0, );let t44e: f64 = (p[86] * l.f793);let t44f: f64 = (l.f5e5 - t44e);(l.f5ed, l.f5ee, l.f5ef, ) = (t44f, 0.0, 0.0, );let t450: f64 = (p[85] - l.f601);let t451: f64 = (t450 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t451, (-l.f602), (-l.f603), );}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_95(
        ...
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 == 0.0)) && (l.f2b0 != 0.0)) {let t452: f64 = (4.0 * p[85]);let t453: f64 = (t452 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t453, 0.0, 0.0, );}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 == 0.0)) && (l.f2b0 != 0.0)) {let t47a: f64 = (l.f6f3 * l.f6f3);let t47b: f64 = (t47a + l.f6f7);let t47c: f64 = (t47b).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t47c, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t47c)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t47c)), );let t47d: f64 = (l.f6f3 + l.f6f7);let t47e: f64 = (0.5 * t47d);let t47f: f64 = (p[85] - t47e);(l.f5ed, l.f5ee, l.f5ef, ) = (t47f, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t480: f64 = (l.f5ed - l.f5e5);let t481: f64 = (t480 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t481, l.f5ee, l.f5ef, );let t482: f64 = (4.0 * l.f5e5);let t483: f64 = (t482 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t483, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f293 != 0.0)) && (l.f295 == 0.0)) && (l.f2b0 != 0.0)) {
            let (t485, t486, t487,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        let t490: f64 = (l.f7b1 / l.f5f1);let t491: f64 = (l.f5f1 - l.f5ed);let t492: f64 = (l.f793 * t491);let t493: f64 = (l.f5ed * p[85]);let t494: f64 = (t492 / t493);let t495: f64 = (t490 + t494);let t496: f64 = (l.f645 * t495);let t497: f64 = (t496).abs();let t498: f64 = if t497 < 230.25850929940458 { 1.0 } else { 0.0 };l.f2b2 = t498;
    }
}
