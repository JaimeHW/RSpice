...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_162(
        ...
        let t64: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f37e = t64;l.f37f = 0.0;
    ...
    pub(super) fn stamp_reactive_block_166(
        ...
        let t162: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f3a2 = t162;l.f3a3 = 0.0;
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_171(
        ...
        let t260: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f3c6 = t260;l.f3c7 = 0.0;
