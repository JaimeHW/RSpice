...
impl Instance {
    ...
    if s.b[958] {
        ...
        let eq7_e141_d_n0: f64 = (s.dn[338][0] + (s.dn[336][0] * ddt_scale));
        let eq7_e141_d_n1: f64 = (s.dn[338][1] + (s.dn[336][1] * ddt_scale));
        let eq7_e141_d_n2: f64 = (s.dn[338][2] + (s.dn[336][2] * ddt_scale));
        let eq7_e141_d_n3: f64 = (s.dn[338][3] + (s.dn[336][3] * ddt_scale));
        let eq7_e141_d_n4: f64 = (s.dn[338][4] + (s.dn[336][4] * ddt_scale));
        let eq7_e141_d_n5: f64 = (s.dn[338][5] + (s.dn[336][5] * ddt_scale));
        let eq7_e141_d_b0: f64 = (s.db[338][0] + (s.db[336][0] * ddt_scale));
        let eq7_e141_d_b1: f64 = (s.db[338][1] + (s.db[336][1] * ddt_scale));
        let eq7_e141_d_b2: f64 = (s.db[338][2] + (s.db[336][2] * ddt_scale));
        let eq7_e141_d_b3: f64 = (s.db[338][3] + (s.db[336][3] * ddt_scale));
    ...
    if s.b[958] {
        ...
        let eq8_e150_d_n0: f64 = (s.dn[339][0] + (s.dn[337][0] * ddt_scale));
        let eq8_e150_d_n1: f64 = (s.dn[339][1] + (s.dn[337][1] * ddt_scale));
        let eq8_e150_d_n2: f64 = (s.dn[339][2] + (s.dn[337][2] * ddt_scale));
        let eq8_e150_d_n3: f64 = (s.dn[339][3] + (s.dn[337][3] * ddt_scale));
        let eq8_e150_d_n4: f64 = (s.dn[339][4] + (s.dn[337][4] * ddt_scale));
        let eq8_e150_d_n5: f64 = (s.dn[339][5] + (s.dn[337][5] * ddt_scale));
        let eq8_e150_d_b0: f64 = (s.db[339][0] + (s.db[337][0] * ddt_scale));
        let eq8_e150_d_b1: f64 = (s.db[339][1] + (s.db[337][1] * ddt_scale));
        let eq8_e150_d_b2: f64 = (s.db[339][2] + (s.db[337][2] * ddt_scale));
        let eq8_e150_d_b3: f64 = (s.db[339][3] + (s.db[337][3] * ddt_scale));
    ...
    if s.b[959] {
        ...
        let eq11_e169_d_n0: f64 = (s.dn[345][0] + (s.dn[344][0] * ddt_scale));
        let eq11_e169_d_n1: f64 = (s.dn[345][1] + (s.dn[344][1] * ddt_scale));
        let eq11_e169_d_n2: f64 = (s.dn[345][2] + (s.dn[344][2] * ddt_scale));
        let eq11_e169_d_n3: f64 = (s.dn[345][3] + (s.dn[344][3] * ddt_scale));
        let eq11_e169_d_n4: f64 = (s.dn[345][4] + (s.dn[344][4] * ddt_scale));
        let eq11_e169_d_n5: f64 = (s.dn[345][5] + (s.dn[344][5] * ddt_scale));
        let eq11_e169_d_b0: f64 = (s.db[345][0] + (s.db[344][0] * ddt_scale));
        let eq11_e169_d_b1: f64 = (s.db[345][1] + (s.db[344][1] * ddt_scale));
        let eq11_e169_d_b2: f64 = (s.db[345][2] + (s.db[344][2] * ddt_scale));
        let eq11_e169_d_b3: f64 = (s.db[345][3] + (s.db[344][3] * ddt_scale));
