...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if ((s.b[418] && (!s.b[717])) && (!s.b[722])) {
            ...
            s.store_sub_ad_lhs(455, A::mul_scaled_output(s.ad_value(447), s.ad_value(450), 2.0), 449);
            s.store_add_ad(456, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(447), s.v[149], s.ad_value(450)), 1.0, s.ad_value(449), s.v[149]), A::mul_scaled_output(s.ad_value(446), s.ad_value(451), 0.5));
        ...
        if ((s.b[418] && (!s.b[717])) && (!s.b[722])) {
            s.store_mul_add_ad_lhs(421, A::add_scaled_inputs(s.ad_value(420), 0.29214664, A::square(s.ad_value(420)), s.v[87]), A::mul_scaled_output(A::square(s.ad_value(420)), s.ad_value(420), s.v[88]), 436);
        }
        ...
        if ((s.b[418] && (!s.b[717])) && (!s.b[728])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(193), s.ad_value(461)), s.ad_value(461)), 436, s.v[29]);
        }
        ...
        if ((s.b[418] && (!s.b[735])) && (!s.b[740])) {
            ...
            s.store_sqrt_scaled_ad(454, A::div(s.ad_value(446), s.ad_value(450)), 0.375);
            s.store_sub_ad_lhs(455, A::mul_scaled_output(s.ad_value(447), s.ad_value(450), 2.0), 449);
            s.store_add_ad(456, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(447), s.v[150], s.ad_value(450)), 1.0, s.ad_value(449), s.v[150]), A::mul_scaled_output(s.ad_value(446), s.ad_value(451), 0.5));
            s.store_mul_offset_lhs(457, 455, (-1.0), 454);
            s.store_square(419, 457);
        }
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if ((s.b[418] && (!s.b[735])) && (!s.b[746])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(193), s.ad_value(461)), s.ad_value(461)), 436, s.v[30]);
        }
        ...
        if ((s.b[418] && (!s.b[753])) && (!s.b[758])) {
            ...
            s.store_sqrt_scaled_ad(454, A::div(s.ad_value(446), s.ad_value(450)), 0.375);
            s.store_sub_ad_lhs(455, A::mul_scaled_output(s.ad_value(447), s.ad_value(450), 2.0), 449);
            s.store_add_ad(456, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(447), s.v[151], s.ad_value(450)), 1.0, s.ad_value(449), s.v[151]), A::mul_scaled_output(s.ad_value(446), s.ad_value(451), 0.5));
            s.store_mul_offset_lhs(457, 455, (-1.0), 454);
            s.store_square(419, 457);
        }
        ...
        if ((s.b[418] && (!s.b[753])) && (!s.b[764])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(193), s.ad_value(461)), s.ad_value(461)), 436, s.v[31]);
        }
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[418] && s.b[771]) {
            ...
            s.store_scaled_sub_ad(434, A::add(s.ad_value(194), s.ad_value(267)), A::sqrt(A::add(A::mul(A::sub(s.ad_value(194), s.ad_value(267)), A::sub(s.ad_value(194), s.ad_value(267))), A::mul_scaled_lhs(s.ad_value(82), 4.0, s.ad_value(82)))), 0.5);
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        if ((s.b[418] && (!s.b[794])) && (!s.b[805])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(194), s.ad_value(461)), s.ad_value(461)), 436, s.v[29]);
        }
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if ((s.b[418] && (!s.b[812])) && (!s.b[823])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(194), s.ad_value(461)), s.ad_value(461)), 436, s.v[30]);
        }
        ...
        if ((s.b[418] && (!s.b[830])) && (!s.b[841])) {
            s.store_mul_scaled_ad_lhs(460, A::mul(A::mul(s.ad_value(194), s.ad_value(461)), s.ad_value(461)), 436, s.v[31]);
        }
        ...
        if s.b[418] {
            ...
            s.copy_ad(300, 289);
            s.store_sub_ad_rhs(188, 183, A::mul(s.ad_value(300), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(193), s.v[85], s.ad_value(301))), (-1.0))));
            s.store_sub_ad_rhs(189, 184, A::mul(s.ad_value(300), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(194), s.v[85], s.ad_value(301))), (-1.0))));
        }
        ...
        if (s.b[418] && s.b[848]) {
            s.store_sub_ad(185, A::sub(s.ad_value(180), A::mul(s.ad_value(300), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(190), s.v[85], s.ad_value(301))), (-1.0)))), A::mul(s.ad_value(302), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(190), s.v[85], s.ad_value(303))), (-1.0))));
            s.store_sub_ad(186, A::sub(s.ad_value(181), A::mul(s.ad_value(300), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(191), s.v[85], s.ad_value(301))), (-1.0)))), A::mul(s.ad_value(302), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(191), s.v[85], s.ad_value(303))), (-1.0))));
            s.store_sub_ad(187, A::sub(s.ad_value(182), A::mul(s.ad_value(300), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(192), s.v[85], s.ad_value(301))), (-1.0)))), A::mul(s.ad_value(302), A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(192), s.v[85], s.ad_value(303))), (-1.0))));
        }
    ...
    pub(super) fn stamp_transient_block_22(
        ...
        if (s.b[858] && s.b[859]) {
            s.store_mul_add_ad_rhs(211, 277, s.ad_value(304), A::mul(s.ad_value(277), s.ad_value(305)));
        }
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if ((!s.b[858]) && s.b[866]) {
            ...
            s.store_scaled_sub_ad(227, A::add(s.ad_value(277), s.ad_value(267)), A::sqrt(A::add(A::mul(A::sub(s.ad_value(277), s.ad_value(267)), A::sub(s.ad_value(277), s.ad_value(267))), A::mul_scaled_lhs(s.ad_value(82), 4.0, s.ad_value(82)))), 0.5);
        ...
        if (((!s.b[858]) && (!s.b[889])) && (!s.b[891])) {
            ...
            s.store_mul_ad_product_rhs(237, 98, A::offset(s.ad_value(223), (-1.0)), s.ad_value(236));
    ...
    pub(super) fn stamp_transient_block_25(
        ...
        if (((!s.b[858]) && (!s.b[889])) && (!s.b[894])) {
            ...
            s.store_sub_ad_lhs(248, A::mul_scaled_output(s.ad_value(240), s.ad_value(243), 2.0), 242);
            s.store_add_ad(249, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(240), s.v[149], s.ad_value(243)), 1.0, s.ad_value(242), s.v[149]), A::mul_scaled_output(s.ad_value(239), s.ad_value(244), 0.5));
        ...
        if (((!s.b[858]) && (!s.b[889])) && (!s.b[894])) {
            s.store_mul_add_ad_lhs(214, A::add_scaled_inputs(s.ad_value(213), 0.29214664, A::square(s.ad_value(213)), s.v[87]), A::mul_scaled_output(A::square(s.ad_value(213)), s.ad_value(213), s.v[88]), 229);
        }
        ...
        if (((!s.b[858]) && (!s.b[889])) && (!s.b[894])) {
            ...
            s.store_mul_scaled_ad_lhs(238, A::mul(s.ad_value(237), s.ad_value(252)), 246, s.v[23]);
        }
        ...
        if (((!s.b[858]) && (!s.b[889])) && (!s.b[900])) {
            s.store_mul_scaled_ad_lhs(253, A::mul(A::mul(s.ad_value(277), s.ad_value(254)), s.ad_value(254)), 229, s.v[29]);
        }
        ...
        if (((!s.b[858]) && (!s.b[907])) && (!s.b[909])) {
            ...
            s.store_mul_ad_product_rhs(237, 99, A::offset(s.ad_value(223), (-1.0)), s.ad_value(236));
        ...
        if (((!s.b[858]) && (!s.b[907])) && (!s.b[912])) {
            ...
            s.store_sqrt_scaled_ad(247, A::div(s.ad_value(239), s.ad_value(243)), 0.375);
            s.store_sub_ad_lhs(248, A::mul_scaled_output(s.ad_value(240), s.ad_value(243), 2.0), 242);
            s.store_add_ad(249, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(240), s.v[150], s.ad_value(243)), 1.0, s.ad_value(242), s.v[150]), A::mul_scaled_output(s.ad_value(239), s.ad_value(244), 0.5));
            s.store_mul_offset_lhs(250, 248, (-1.0), 247);
            s.store_square(212, 250);
        }
        ...
        if (((!s.b[858]) && (!s.b[907])) && (!s.b[912])) {
            ...
            s.store_mul_scaled_ad_lhs(238, A::mul(s.ad_value(237), s.ad_value(252)), 246, s.v[24]);
        }
        ...
        if (((!s.b[858]) && (!s.b[907])) && (!s.b[918])) {
            s.store_mul_scaled_ad_lhs(253, A::mul(A::mul(s.ad_value(277), s.ad_value(254)), s.ad_value(254)), 229, s.v[30]);
        }
    ...
    pub(super) fn stamp_transient_block_26(
        ...
        if (((!s.b[858]) && (!s.b[925])) && (!s.b[927])) {
            ...
            s.store_mul_ad_product_rhs(237, 100, A::offset(s.ad_value(223), (-1.0)), s.ad_value(236));
        ...
        if (((!s.b[858]) && (!s.b[925])) && (!s.b[930])) {
            ...
            s.store_sqrt_scaled_ad(247, A::div(s.ad_value(239), s.ad_value(243)), 0.375);
            s.store_sub_ad_lhs(248, A::mul_scaled_output(s.ad_value(240), s.ad_value(243), 2.0), 242);
            s.store_add_ad(249, A::sub_scaled_inputs(A::mul_scaled_lhs(s.ad_value(240), s.v[151], s.ad_value(243)), 1.0, s.ad_value(242), s.v[151]), A::mul_scaled_output(s.ad_value(239), s.ad_value(244), 0.5));
            s.store_mul_offset_lhs(250, 248, (-1.0), 247);
            s.store_square(212, 250);
        }
        ...
        if (((!s.b[858]) && (!s.b[925])) && (!s.b[930])) {
            ...
            s.store_mul_scaled_ad_lhs(238, A::mul(s.ad_value(237), s.ad_value(252)), 246, s.v[25]);
        }
        ...
        if (((!s.b[858]) && (!s.b[925])) && (!s.b[936])) {
            s.store_mul_scaled_ad_lhs(253, A::mul(A::mul(s.ad_value(277), s.ad_value(254)), s.ad_value(254)), 229, s.v[31]);
        }
        ...
        if (s.b[945] && (!s.b[950])) {
            s.store_mul_scaled_ad_rhs(357, 353, p.p90, A::exp(A::mul(A::mul_scaled_lhs(A::sub(s.ad_value(277), s.ad_value(347)), (-p.p91), A::sub(s.ad_value(277), s.ad_value(347))), A::exp_scaled_input(A::ln_scaled_input(s.ad_value(78), 1.0 / (s.v[79])), p.p98))));
        }
    ...
    pub(super) fn stamp_transient_block_27(
        ...
        if (s.b[945] && (!s.b[952])) {
            s.store_mul_scaled_ad_rhs(358, 354, p.p90, A::exp(A::mul(A::mul_scaled_lhs(A::sub(s.ad_value(277), s.ad_value(348)), (-p.p91), A::sub(s.ad_value(277), s.ad_value(348))), A::exp_scaled_input(A::ln_scaled_input(s.ad_value(78), 1.0 / (s.v[79])), p.p98))));
        }
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        if (s.b[418] && s.b[463]) {
            ...
            s.store_scaled_sub_ad(434, A::add(s.ad_value(190), s.ad_value(267)), A::sqrt(A::add(A::mul(A::sub(s.ad_value(190), s.ad_value(267)), A::sub(s.ad_value(190), s.ad_value(267))), A::mul_scaled_lhs(s.ad_value(82), 4.0, s.ad_value(82)))), 0.5);
