...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_66(
        ...
        if ((s.b[418] && (!s.b[830])) && (!s.b[835])) {s.store_primal_div_scaled_product_add_scaled_denominator_indices(453, 442, 452, 1.0, 442, 1.0, 452, 1.0, 1.0);s.store_primal_sqrt_scaled_input_ad(454, A::div(s.ad_value(446), s.ad_value(450)), 0.375);s.store_primal_add_scaled_product_indices(455, 449, (-1.0), 447, 450, 2.0);s.store_primal_add_scaled_value_products_indices(456, 449, (-s.v[151]), 447, 450, s.v[151], 446, 451, 0.5);s.store_primal_mul_scale_offset_indices(457, 454, 455, 1.0, (-1.0));s.store_primal_square(419, 457);}
    ...
    pub(super) fn stamp_transient_block_67(
        ...
        if s.b[418] {s.store_add_scaled_inputs3_indices(184, 268, s.v[256], 270, s.v[257], 272, s.v[258]);s.copy_ad(300, 289);s.store_add_scaled_offset_product_rhs_mixed_iia(188, 183, 1.0, 300, A::exp(A::mul_scaled_lhs(s.ad_value(193), s.v[85], s.ad_value(301))), (-1.0), (-1.0));s.store_add_scaled_offset_product_rhs_mixed_iia(189, 184, 1.0, 300, A::exp(A::mul_scaled_lhs(s.ad_value(194), s.v[85], s.ad_value(301))), (-1.0), (-1.0));}
        ...
        if (s.b[418] && s.b[848]) {s.store_add_scaled_offset_product_rhs_mixed_aia(185, A::add_scaled_offset_product_rhs(s.ad_value(180), 1.0, s.ad_value(300), A::exp(A::mul_scaled_lhs(s.ad_value(190), s.v[85], s.ad_value(301))), (-1.0), (-1.0)), 1.0, 302, A::exp(A::mul_scaled_lhs(s.ad_value(190), s.v[85], s.ad_value(303))), (-1.0), (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_68(
        ...
        if (((s.b[418] && s.b[848]) && s.b[851]) && s.b[852]) {s.store_div(195, 185, 186);s.store_div_scaled_inputs(196, A::ln(s.ad_value(195)), (-s.v[84]), A::sub(s.ad_value(190), s.ad_value(191)), 1.0);s.store_primal_div_add_scaled_inputs_rhs_indices(198, 191, 191, 1.0, 190, -1.0);s.store_scaled_mul_ad(199, A::offset(s.ad_value(195), (-1.0)), A::offset(A::pow(s.ad_value(195), s.ad_value(198)), (-1.0)), s.v[84]);s.store_primal_div_add_scaled_inputs_rhs_indices(198, 190, 190, 1.0, 191, -1.0);s.store_sub_mixed_ai(200, A::add_scaled_products(A::pow(s.ad_value(195), s.ad_value(198)), A::sub(s.ad_value(191), s.ad_value(190)), 1.0, s.ad_value(195), s.ad_value(190), 1.0), 191);s.store_div(197, 199, 200);s.store_add(305, 196, 197);}
    ...
    if ((((s.b[418] && s.b[848]) && s.b[851]) && s.b[852]) && s.b[853]) {
        ...
        s.store_scalar(306, t0);
        if ((((s.b[418] && s.b[848]) && s.b[851]) && s.b[852]) && s.b[853]) {s.store_mul_add_scaled_inputs_rhs_mixed_ai(304, 187, A::div_from_scalar(1.0, s.ad_value(192)), 1.0, 305, (0.5 * s.v[85]));s.store_div_scaled_product_indices(305, 187, 305, ((-0.5) * s.v[85]), 192, 1.0);}
        let (t1,) = {
    if ((((s.b[418] && s.b[848]) && s.b[851]) && s.b[852]) && (!s.b[853])) {
        (0.0,)
    } else {
        ...
        s.store_scalar(306, t1);
        if ((((s.b[418] && s.b[848]) && s.b[851]) && s.b[852]) && (!s.b[853])) {s.store_div_scaled_value_offset_denominator(304, s.ad_value(187), -1.0, A::exp(A::mul_scaled_lhs(s.ad_value(192), (-s.v[85]), s.ad_value(305))), (-1.0), 1.0);}
        let (t8,) = {
    if s.b[418] {
        let t2: f64 = (s.v[256] * s.v[128]);let t3: f64 = (s.v[257] * s.v[129]);let t4: f64 = (t2 + t3);let t5: f64 = (s.v[258] * s.v[130]);let t6: f64 = (t4 + t5);let t7: f64 = (s.v[47] * t6);
        (t7,)
    } else {
        (s.v[208],)
    }
};
        s.store_scalar(208, t8);s.b[854] = ((s.v[256] * s.v[128]) <= s.v[208]);s.store_scalar(854, if s.b[854] { 1.0 } else { 0.0 });
        let (t9,) = {
    if (s.b[418] && s.b[854]) {
        (0.0,)
    } else {
        ...
        s.store_scalar(259, t9);s.b[855] = ((s.v[257] * s.v[129]) <= s.v[208]);s.store_scalar(855, if s.b[855] { 1.0 } else { 0.0 });
        let (ta,) = {
    if (s.b[418] && s.b[855]) {
        (0.0,)
    } else {
        ...
        s.store_scalar(260, ta);s.b[856] = ((s.v[258] * s.v[130]) <= s.v[208]);s.store_scalar(856, if s.b[856] { 1.0 } else { 0.0 });
        let (tb,) = {
    if (s.b[418] && s.b[856]) {
        (0.0,)
    } else {
        ...
        s.store_scalar(261, tb);s.b[857] = (!(((s.v[256] == 0.0) && (s.v[257] == 0.0)) && (s.v[258] == 0.0)));s.store_scalar(857, if s.b[857] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_69(
        ...
        if s.b[858] {s.store_add_scaled_inputs3_indices(274, 209, 1.0, 210, 1.0, 211, 1.0);s.store_add(290, 210, 211);s.store_scalar(268, 0.0);s.store_scalar(270, 0.0);s.store_scalar(272, 0.0);s.store_scalar(291, 0.0);s.store_scalar(292, 0.0);s.store_scalar(293, 0.0);s.store_primal_scaled_mul(215, 265, 265, 4.0);s.store_primal_div(216, 265, 266);s.store_add_scaled_product_indices(217, 277, 1.0, 265, 216, 1.0);s.store_add(218, 266, 217);s.store_sub(219, 266, 217);s.store_sqrt_square_add(220, 219, 215);s.store_div_scaled_product_add_scaled_denominator_indices(204, 277, 266, 2.0, 218, 1.0, 220, 1.0, 1.0);}
    ...
    pub(super) fn stamp_transient_block_70(
        ...
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[870]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_add_scaled_inputs_indices(361, 314, (-0.5), 315, (-0.5), p.p85);s.store_offset(314, 361, (((-s.v[62])) + ((-0.01))));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_71(
        ...
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[870]) {s.store_scalar(315, ((4.0 * s.v[62]) * 0.01));}
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[870]) {
            if (s.v[315] > 0.0) {
            } else {
                s.store_neg(315, 315);
        ...
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[873]) {s.store_sqrt_square_add(315, 314, 315);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_72(
        ...
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[873]) {s.store_offset_add_scaled_inputs_indices(350, 314, (-0.5), 315, (-0.5), p.p85);s.store_offset(314, 350, (((-s.v[64])) + ((-0.01))));s.store_scalar(315, ((4.0 * s.v[64]) * 0.01));}
        if ((((!s.b[858]) && s.b[866]) && s.b[867]) && s.b[873]) {
            if (s.v[315] > 0.0) {
            } else {
                s.store_neg(315, 315);
    ...
    pub(super) fn stamp_transient_block_73(
        ...
        if ((((!s.b[858]) && s.b[866]) && (!s.b[867])) && s.b[879]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_scaled_div(365, 314, 315, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(359, 314, 0.5, 315, 0.5, s.v[62]);s.store_offset_sub_from_scalar_ad(314, p.p85, s.ad_value(350), (-0.01));s.store_scalar(315, ((4.0 * p.p85) * 0.01));}
        if ((((!s.b[858]) && s.b[866]) && (!s.b[867])) && s.b[879]) {
            if (s.v[315] > 0.0) {
            } else {
                s.store_neg(315, 315);
    ...
    pub(super) fn stamp_transient_block_74(
        ...
        if ((((!s.b[858]) && s.b[866]) && (!s.b[867])) && s.b[882]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_add_scaled_inputs_indices(350, 314, 0.5, 315, 0.5, s.v[64]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_75(
        ...
        if ((((!s.b[858]) && s.b[866]) && (!s.b[867])) && s.b[882]) {s.store_scaled_mul(366, 364, 365, p.p86);}
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if ((!s.b[858]) && s.b[866]) {s.store_sub(225, 264, 224);s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(226, 277, 0.5, 225, 0.5, 277, 225, ((4.0 * s.v[84]) * s.v[84]), (-0.5));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_77(
        s: &mut Scratch,
    ) {
        if ((!s.b[858]) && s.b[866]) {s.store_add_scaled_inputs3_sqrt_third_mixed_iia(227, 277, 0.5, 267, 0.5, A::add_scaled_square_product(A::sub(s.ad_value(277), s.ad_value(267)), 1.0, s.ad_value(82), s.ad_value(82), 4.0), (-0.5));s.store_scaled_sub_mixed_ia(228, 277, A::sqrt_square_offset(s.ad_value(277), ((4.0 * 1e-6) * 1e-6)), 0.5);}
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        if (((!s.b[858]) && (!s.b[907])) && (!s.b[912])) {s.store_div_scaled_inputs_indices(239, 236, (s.v[123] * s.v[153]), 232, 1.0);s.store_div_from_scalar(240, (0.666666666666667 * s.v[150]), 239);s.store_square(241, 240);s.store_sqrt_div_scaled_square_offset_denominator(242, 241, 1.0, 1.0, 1.0);s.store_sqrt_abs_ad(243, s.ad_value(242));s.store_mul(244, 242, 243);}
