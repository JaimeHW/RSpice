...
impl Instance {
    ...
    if (locals.var_guard571 != 0.0) {
        let eq7_e140: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 0, locals.var_q_nqs_a);
        let eq7_e141: f64 = (locals.var_inqs0_a + eq7_e140);
        let eq7_e141_d_n3: f64 = (locals.var_inqs0_a_dn3 + (locals.var_q_nqs_a_dn3 * ddt_scale));
        let eq7_e142: f64 = (1e-12 * eq7_e141);
        let eq7_e142_d_n0: f64 = (1e-12 * locals.var_inqs0_a_dn0);
        let eq7_e142_d_n2: f64 = (1e-12 * locals.var_inqs0_a_dn2);
    ...
    if (locals.var_guard571 != 0.0) {
        let eq8_e149: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 1, locals.var_q_nqs_k);
        let eq8_e150: f64 = (locals.var_inqs0_k + eq8_e149);
        let eq8_e150_d_n4: f64 = (locals.var_inqs0_k_dn4 + (locals.var_q_nqs_k_dn4 * ddt_scale));
        let eq8_e151: f64 = (1e-12 * eq8_e150);
        let eq8_e151_d_n0: f64 = (1e-12 * locals.var_inqs0_k_dn0);
        let eq8_e151_d_n2: f64 = (1e-12 * locals.var_inqs0_k_dn2);
    ...
    if (locals.var_guard572 != 0.0) {
        let eq11_e168: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 2, locals.var_w_nqs_a);
        let eq11_e169: f64 = (locals.var_iwnqs0_a + eq11_e168);
        let eq11_e169_d_n5: f64 = (locals.var_iwnqs0_a_dn5 + (locals.var_w_nqs_a_dn5 * ddt_scale));
        let eq11_e170: f64 = (1e-13 * eq11_e169);
        let eq11_e170_d_n0: f64 = (1e-13 * locals.var_iwnqs0_a_dn0);
        let eq11_e170_d_n2: f64 = (1e-13 * locals.var_iwnqs0_a_dn2);
    ...
    if (locals.var_guard571 != 0.0) {
        let eq7_e140_q: f64 = locals.var_q_nqs_a;
        let eq7_e141: f64 = (locals.var_inqs0_a + locals.var_q_nqs_a);
        let eq7_e141_d_n3: f64 = (locals.var_inqs0_a_dn3 + locals.var_q_nqs_a_dn3);
        ...
        let eq7_e142_q_d_n3: f64 = (1e-12 * locals.var_q_nqs_a_dn3);
    ...
    if (locals.var_guard571 != 0.0) {
        let eq8_e149_q: f64 = locals.var_q_nqs_k;
        let eq8_e150: f64 = (locals.var_inqs0_k + locals.var_q_nqs_k);
        let eq8_e150_d_n4: f64 = (locals.var_inqs0_k_dn4 + locals.var_q_nqs_k_dn4);
        ...
        let eq8_e151_q_d_n4: f64 = (1e-12 * locals.var_q_nqs_k_dn4);
    ...
    if (locals.var_guard572 != 0.0) {
        let eq11_e168_q: f64 = locals.var_w_nqs_a;
        let eq11_e169: f64 = (locals.var_iwnqs0_a + locals.var_w_nqs_a);
        let eq11_e169_d_n5: f64 = (locals.var_iwnqs0_a_dn5 + locals.var_w_nqs_a_dn5);
        ...
        let eq11_e170_q_d_n5: f64 = (1e-13 * locals.var_w_nqs_a_dn5);
