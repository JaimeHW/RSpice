...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_34(
        ...
        let t7b: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.ffb = t7b;l.ffc = 0.0;
    ...
    pub(super) fn stamp_reactive_block_39(
        ...
        let t179: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f123 = t179;l.f124 = 0.0;
    ...
    pub(super) fn stamp_reactive_block_43(
        ...
        let t277: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f148 = t277;l.f149 = 0.0;
    ...
    pub(super) fn stamp_reactive_block_45(
        ...
        let t2e2: f64 = if l.f5e5 < p[85] { 1.0 } else { 0.0 };l.f156 = t2e2;l.f157 = 0.0;
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f156 != 0.0)) {let t2e3: f64 = (l.f739 - l.f793);let t2e4: f64 = (p[86] * t2e3);let t2e5: f64 = (t2e4 + l.f5e5);(l.f601, l.f602, l.f603, ) = (t2e5, 0.0, 0.0, );l.f604 = 0.0;let t2e6: f64 = (p[86] * l.f793);let t2e7: f64 = (l.f5e5 - t2e6);(l.f5ed, l.f5ee, l.f5ef, ) = (t2e7, 0.0, 0.0, );l.f5f0 = 0.0;let t2e8: f64 = (p[85] - l.f601);let t2e9: f64 = (t2e8 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2e9, (-l.f602), (-l.f603), );l.f6f6 = 0.0;let t2ea: f64 = (4.0 * p[85]);let t2eb: f64 = (t2ea * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2eb, 0.0, 0.0, );l.f6fa = 0.0;}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f156 != 0.0)) {let t2f0: f64 = (l.f6f3 * l.f6f3);let t2f1: f64 = (t2f0 + l.f6f7);let t2f2: f64 = (t2f1).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t2f2, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t2f2)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t2f2)), );l.f6fa = 0.0;let t2f3: f64 = (l.f6f3 + l.f6f7);let t2f4: f64 = (0.5 * t2f3);let t2f5: f64 = (p[85] - t2f4);(l.f605, l.f606, l.f607, ) = (t2f5, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );l.f608 = 0.0;let t2f6: f64 = (l.f605 - l.f5e5);let t2f7: f64 = (t2f6 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2f7, l.f606, l.f607, );l.f6f6 = 0.0;let t2f8: f64 = (4.0 * l.f5e5);let t2f9: f64 = (t2f8 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2f9, 0.0, 0.0, );l.f6fa = 0.0;}
    }
    #[inline(never)]
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f156 != 0.0)) {let t30c: f64 = (l.f6f3 * l.f6f3);let t30d: f64 = (t30c + l.f6f7);let t30e: f64 = (t30d).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t30e, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t30e)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t30e)), );l.f6fa = 0.0;let t30f: f64 = (l.f6f3 + l.f6f7);let t310: f64 = (0.5 * t30f);let t311: f64 = (p[85] - t310);(l.f5ed, l.f5ee, l.f5ef, ) = (t311, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );l.f5f0 = 0.0;let t312: f64 = (l.f5ed - l.f5e5);let t313: f64 = (t312 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t313, l.f5ee, l.f5ef, );l.f6f6 = 0.0;let t314: f64 = (4.0 * l.f5e5);let t315: f64 = (t314 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t315, 0.0, 0.0, );l.f6fa = 0.0;}
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f156 != 0.0)) {
            let (t317, t318, t319,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        let t320: f64 = (l.f739 / l.f5f1);let t321: f64 = (l.f5f1 - l.f5ed);let t322: f64 = (l.f793 * t321);let t323: f64 = (l.f5ed * p[85]);let t324: f64 = (t322 / t323);let t325: f64 = (t320 + t324);let t326: f64 = (l.f645 * t325);let t327: f64 = (t326).abs();let t328: f64 = if t327 < 230.25850929940458 { 1.0 } else { 0.0 };l.f158 = t328;l.f159 = 0.0;
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f158 != 0.0)) {let t329: f64 = (l.f739 / l.f5f1);let t32a: f64 = (l.f5f1 - l.f5ed);let t32b: f64 = (l.f793 * t32a);let t32c: f64 = (l.f5ed * p[85]);let t32d: f64 = (t32b / t32c);let t32e: f64 = (t329 + t32d);let t32f: f64 = (l.f645 * t32e);let t330: f64 = (t32f).exp();(l.f536, l.f537, l.f538, ) = (t330, (t330 * (l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t32c) - (t32b * (l.f5ee * p[85]))) / (t32c * t32c))))), (t330 * (l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t32c) - (t32b * (l.f5ef * p[85]))) / (t32c * t32c))))), );l.f539 = 0.0;}
        let t331: f64 = (l.f739 / l.f5f1);let t332: f64 = (l.f5f1 - l.f5ed);let t333: f64 = (l.f793 * t332);let t334: f64 = (l.f5ed * p[85]);let t335: f64 = (t333 / t334);let t336: f64 = (t331 + t335);let t337: f64 = (l.f645 * t336);let t338: f64 = (-230.25850929940458);let t339: f64 = if t337 < t338 { 1.0 } else { 0.0 };l.f15a = t339;l.f15b = 0.0;
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_47(
        ...
        if (((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f158 == 0.0)) && (l.f15a != 0.0)) {let t33a: f64 = (-230.25850929940458);let t33b: f64 = (l.f739 / l.f5f1);let t33c: f64 = (l.f5f1 - l.f5ed);let t33d: f64 = (l.f793 * t33c);let t33e: f64 = (l.f5ed * p[85]);let t33f: f64 = (t33d / t33e);let t340: f64 = (t33b + t33f);let t341: f64 = (l.f645 * t340);let t342: f64 = (t33a - t341);let t343: f64 = (-230.25850929940458);let t344: f64 = (l.f739 / l.f5f1);let t345: f64 = (l.f5f1 - l.f5ed);let t346: f64 = (l.f793 * t345);let t347: f64 = (l.f5ed * p[85]);let t348: f64 = (t346 / t347);let t349: f64 = (t344 + t348);let t34a: f64 = (l.f645 * t349);let t34b: f64 = (t343 - t34a);let t34c: f64 = (-230.25850929940458);let t34d: f64 = (l.f739 / l.f5f1);let t34e: f64 = (l.f5f1 - l.f5ed);let t34f: f64 = (l.f793 * t34e);let t350: f64 = (l.f5ed * p[85]);let t351: f64 = (t34f / t350);let t352: f64 = (t34d + t351);let t353: f64 = (l.f645 * t352);let t354: f64 = (t34c - t353);let t355: f64 = (t354 * 0.3333333333333333);let t356: f64 = (1.0 + t355);let t357: f64 = (t34b * t356);let t358: f64 = (0.5 * t357);let t359: f64 = (1.0 + t358);let t35a: f64 = (t342 * t359);let t35b: f64 = (1.0 + t35a);let t35c: f64 = (1e-100 / t35b);(l.f536, l.f537, l.f538, ) = (t35c, (-((1e-100 * (((-(l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t33e) - (t33d * (l.f5ee * p[85]))) / (t33e * t33e))))) * t359) + (t342 * (0.5 * (((-(l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t347) - (t346 * (l.f5ee * p[85]))) / (t347 * t347))))) * t356) + (t34b * ((-(l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t350) - (t34f * (l.f5ee * p[85]))) / (t350 * t350))))) * 0.3333333333333333))))))) / (t35b * t35b))), (-((1e-100 * (((-(l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t33e) - (t33d * (l.f5ef * p[85]))) / (t33e * t33e))))) * t359) + (t342 * (0.5 * (((-(l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t347) - (t346 * (l.f5ef * p[85]))) / (t347 * t347))))) * t356) + (t34b * ((-(l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t350) - (t34f * (l.f5ef * p[85]))) / (t350 * t350))))) * 0.3333333333333333))))))) / (t35b * t35b))), );l.f539 = 0.0;}
        if (((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f158 == 0.0)) && (l.f15a == 0.0)) {let t35d: f64 = (l.f739 / l.f5f1);let t35e: f64 = (l.f5f1 - l.f5ed);let t35f: f64 = (l.f793 * t35e);let t360: f64 = (l.f5ed * p[85]);let t361: f64 = (t35f / t360);let t362: f64 = (t35d + t361);let t363: f64 = (l.f645 * t362);let t364: f64 = (t363 - 230.25850929940458);let t365: f64 = (l.f739 / l.f5f1);let t366: f64 = (l.f5f1 - l.f5ed);let t367: f64 = (l.f793 * t366);let t368: f64 = (l.f5ed * p[85]);let t369: f64 = (t367 / t368);let t36a: f64 = (t365 + t369);let t36b: f64 = (l.f645 * t36a);let t36c: f64 = (t36b - 230.25850929940458);let t36d: f64 = (l.f739 / l.f5f1);let t36e: f64 = (l.f5f1 - l.f5ed);let t36f: f64 = (l.f793 * t36e);let t370: f64 = (l.f5ed * p[85]);let t371: f64 = (t36f / t370);let t372: f64 = (t36d + t371);let t373: f64 = (l.f645 * t372);let t374: f64 = (t373 - 230.25850929940458);let t375: f64 = (t374 * 0.3333333333333333);let t376: f64 = (1.0 + t375);let t377: f64 = (t36c * t376);let t378: f64 = (0.5 * t377);let t379: f64 = (1.0 + t378);let t37a: f64 = (t364 * t379);let t37b: f64 = (1.0 + t37a);let t37c: f64 = (1e100 * t37b);(l.f536, l.f537, l.f538, ) = (t37c, (1e100 * (((l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t360) - (t35f * (l.f5ee * p[85]))) / (t360 * t360)))) * t379) + (t364 * (0.5 * (((l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t368) - (t367 * (l.f5ee * p[85]))) / (t368 * t368)))) * t376) + (t36c * ((l.f645 * ((-((l.f739 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t370) - (t36f * (l.f5ee * p[85]))) / (t370 * t370)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t360) - (t35f * (l.f5ef * p[85]))) / (t360 * t360)))) * t379) + (t364 * (0.5 * (((l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t368) - (t367 * (l.f5ef * p[85]))) / (t368 * t368)))) * t376) + (t36c * ((l.f645 * ((-((l.f739 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t370) - (t36f * (l.f5ef * p[85]))) / (t370 * t370)))) * 0.3333333333333333))))))), );l.f539 = 0.0;}
        ...
        let t383: f64 = if l.f5e9 < p[85] { 1.0 } else { 0.0 };l.f15c = t383;l.f15d = 0.0;
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f15c != 0.0)) {let t384: f64 = (l.f739 - l.f793);let t385: f64 = (p[86] * t384);let t386: f64 = (t385 + l.f5e9);(l.f601, l.f602, l.f603, ) = (t386, 0.0, 0.0, );l.f604 = 0.0;let t387: f64 = (p[86] * l.f793);let t388: f64 = (l.f5e9 - t387);(l.f5ed, l.f5ee, l.f5ef, ) = (t388, 0.0, 0.0, );l.f5f0 = 0.0;}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_48(
        ...
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 != 0.0)) && (l.f15c != 0.0)) {let t389: f64 = (p[85] - l.f601);let t38a: f64 = (t389 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t38a, (-l.f602), (-l.f603), );l.f6f6 = 0.0;let t38b: f64 = (4.0 * p[85]);let t38c: f64 = (t38b * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t38c, 0.0, 0.0, );l.f6fa = 0.0;}
