...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_161(
        ...
        let tac: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f43e = tac;
    ...
    pub(super) fn stamp_transient_block_165(
        ...
        let t1aa: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f462 = t1aa;
    ...
    pub(super) fn stamp_transient_block_169(
        ...
        let t2a8: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f486 = t2a8;
        ...
        let t2d2: f64 = (l.f0 * l.f68c);let t2d3: f64 = (l.f5b1 * l.f694);let t2d4: f64 = (t2d2 + t2d3);let t2d5: f64 = (l.f5af * l.f690);let t2d6: f64 = (t2d4 + t2d5);(l.f685, l.f686, l.f687, l.f688, l.f689, l.f68a, ) = (t2d6, (((l.f0 * l.f68d) + (l.f5b1 * l.f695)) + (l.f5af * l.f691)), (((l.f0 * l.f68e) + (l.f5b1 * l.f696)) + (l.f5af * l.f692)), 0.0, 0.0, 0.0, );(l.f7b9, l.f7ba, l.f7bb, ) = ((nv2 - nv1), -1.0, 1.0, );let t2d7: f64 = if p[84] > 0.0 { 1.0 } else { 0.0 };l.f48c = t2d7;let t2d8: f64 = if l.f609 < p[85] { 1.0 } else { 0.0 };l.f48e = t2d8;
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {let t2d9: f64 = (l.f745 - l.f743);let t2da: f64 = (p[86] * t2d9);let t2db: f64 = (t2da + l.f609);(l.f5f6, l.f5f7, l.f5f8, ) = (t2db, (p[86] * l.f746), (p[86] * l.f747), );let t2dc: f64 = (p[86] * l.f743);let t2dd: f64 = (l.f609 - t2dc);(l.f5ed, l.f5ee, l.f5ef, ) = (t2dd, 0.0, 0.0, );}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_170(
        ...
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {let t2de: f64 = (p[85] - l.f5f6);let t2df: f64 = (t2de - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2df, (-l.f5f7), (-l.f5f8), );let t2e0: f64 = (4.0 * p[85]);let t2e1: f64 = (t2e0 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2e1, 0.0, 0.0, );}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {let t2e6: f64 = (l.f6f3 * l.f6f3);let t2e7: f64 = (t2e6 + l.f6f7);let t2e8: f64 = (t2e7).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t2e8, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t2e8)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t2e8)), );let t2e9: f64 = (l.f6f3 + l.f6f7);let t2ea: f64 = (0.5 * t2e9);let t2eb: f64 = (p[85] - t2ea);(l.f5fa, l.f5fb, l.f5fc, ) = (t2eb, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t2ec: f64 = (l.f5fa - l.f609);let t2ed: f64 = (t2ec - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2ed, l.f5fb, l.f5fc, );let t2ee: f64 = (4.0 * l.f609);let t2ef: f64 = (t2ee * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2ef, 0.0, 0.0, );}
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {
            let (t2f1, t2f2, t2f3,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {let t2f4: f64 = (l.f6f3 * l.f6f3);let t2f5: f64 = (t2f4 + l.f6f7);let t2f6: f64 = (t2f5).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t2f6, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t2f6)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t2f6)), );let t2f7: f64 = (l.f6f3 + l.f6f7);let t2f8: f64 = (0.5 * t2f7);let t2f9: f64 = (l.f609 + t2f8);(l.f5f5, l.f5fe, l.f5ff, ) = (t2f9, (0.5 * (l.f6f4 + l.f6f8)), (0.5 * (l.f6f5 + l.f6f9)), );let t2fa: f64 = (p[85] - l.f5ed);let t2fb: f64 = (t2fa - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2fb, (-l.f5ee), (-l.f5ef), );let t2fc: f64 = (4.0 * p[85]);let t2fd: f64 = (t2fc * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2fd, 0.0, 0.0, );}
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {
            let (t2ff, t300, t301,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {let t302: f64 = (l.f6f3 * l.f6f3);let t303: f64 = (t302 + l.f6f7);let t304: f64 = (t303).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t304, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t304)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t304)), );let t305: f64 = (l.f6f3 + l.f6f7);let t306: f64 = (0.5 * t305);let t307: f64 = (p[85] - t306);(l.f5ed, l.f5ee, l.f5ef, ) = (t307, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t308: f64 = (l.f5ed - l.f609);let t309: f64 = (t308 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t309, l.f5ee, l.f5ef, );let t30a: f64 = (4.0 * l.f609);let t30b: f64 = (t30a * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t30b, 0.0, 0.0, );}
        if ((l.f48c != 0.0) && (l.f48e != 0.0)) {
            let (t30d, t30e, t30f,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        let t316: f64 = (l.f743 - l.f741);let t317: f64 = (l.f745 - t316);let t318: f64 = if t317 > 0.0 { 1.0 } else { 0.0 };l.f490 = t318;let t319: f64 = (l.f745 / l.f5f5);let t31a: f64 = (l.f743 - l.f741);let t31b: f64 = (t31a / l.f5f5);let t31c: f64 = (t319 - t31b);let t31d: f64 = (l.f5f5 - l.f5ed);let t31e: f64 = (l.f743 * t31d);let t31f: f64 = (l.f5ed * p[85]);let t320: f64 = (t31e / t31f);let t321: f64 = (t31c + t320);let t322: f64 = (l.f645 * t321);let t323: f64 = (t322).abs();let t324: f64 = if t323 < 230.25850929940458 { 1.0 } else { 0.0 };l.f492 = t324;
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_171(
        ...
        if (((l.f48c != 0.0) && (l.f490 != 0.0)) && (l.f492 != 0.0)) {let t325: f64 = (l.f745 / l.f5f5);let t326: f64 = (l.f743 - l.f741);let t327: f64 = (t326 / l.f5f5);let t328: f64 = (t325 - t327);let t329: f64 = (l.f5f5 - l.f5ed);let t32a: f64 = (l.f743 * t329);let t32b: f64 = (l.f5ed * p[85]);let t32c: f64 = (t32a / t32b);let t32d: f64 = (t328 + t32c);let t32e: f64 = (l.f645 * t32d);let t32f: f64 = (t32e).exp();(l.f81, l.f86, l.f87, ) = (t32f, (t32f * (l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t326 * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t32b) - (t32a * (l.f5ee * p[85]))) / (t32b * t32b))))), (t32f * (l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t326 * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t32b) - (t32a * (l.f5ef * p[85]))) / (t32b * t32b))))), );}
        let t330: f64 = (l.f745 / l.f5f5);let t331: f64 = (l.f743 - l.f741);let t332: f64 = (t331 / l.f5f5);let t333: f64 = (t330 - t332);let t334: f64 = (l.f5f5 - l.f5ed);let t335: f64 = (l.f743 * t334);let t336: f64 = (l.f5ed * p[85]);let t337: f64 = (t335 / t336);let t338: f64 = (t333 + t337);let t339: f64 = (l.f645 * t338);let t33a: f64 = (-230.25850929940458);let t33b: f64 = if t339 < t33a { 1.0 } else { 0.0 };l.f494 = t33b;
        if ((((l.f48c != 0.0) && (l.f490 != 0.0)) && (l.f492 == 0.0)) && (l.f494 != 0.0)) {
            let t33c: f64 = (-230.25850929940458);let t33d: f64 = (l.f745 / l.f5f5);let t33e: f64 = (l.f743 - l.f741);let t33f: f64 = (t33e / l.f5f5);let t340: f64 = (t33d - t33f);let t341: f64 = (l.f5f5 - l.f5ed);let t342: f64 = (l.f743 * t341);let t343: f64 = (l.f5ed * p[85]);let t344: f64 = (t342 / t343);let t345: f64 = (t340 + t344);let t346: f64 = (l.f645 * t345);let t347: f64 = (t33c - t346);let t348: f64 = (-230.25850929940458);let t349: f64 = (l.f745 / l.f5f5);let t34a: f64 = (l.f743 - l.f741);let t34b: f64 = (t34a / l.f5f5);let t34c: f64 = (t349 - t34b);let t34d: f64 = (l.f5f5 - l.f5ed);let t34e: f64 = (l.f743 * t34d);let t34f: f64 = (l.f5ed * p[85]);let t350: f64 = (t34e / t34f);let t351: f64 = (t34c + t350);let t352: f64 = (l.f645 * t351);let t353: f64 = (t348 - t352);let t354: f64 = (-230.25850929940458);let t355: f64 = (l.f745 / l.f5f5);let t356: f64 = (l.f743 - l.f741);let t357: f64 = (t356 / l.f5f5);let t358: f64 = (t355 - t357);let t359: f64 = (l.f5f5 - l.f5ed);let t35a: f64 = (l.f743 * t359);let t35b: f64 = (l.f5ed * p[85]);let t35c: f64 = (t35a / t35b);let t35d: f64 = (t358 + t35c);let t35e: f64 = (l.f645 * t35d);let t35f: f64 = (t354 - t35e);let t360: f64 = (t35f * 0.3333333333333333);let t361: f64 = (1.0 + t360);let t362: f64 = (t353 * t361);let t363: f64 = (0.5 * t362);let t364: f64 = (1.0 + t363);let t365: f64 = (t347 * t364);let t366: f64 = (1.0 + t365);let t367: f64 = (1e-100 / t366);
            (l.f81, l.f86, l.f87, ) = (t367, (-((1e-100 * (((-(l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t33e * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t343) - (t342 * (l.f5ee * p[85]))) / (t343 * t343))))) * t364) + (t347 * (0.5 * (((-(l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t34a * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t34f) - (t34e * (l.f5ee * p[85]))) / (t34f * t34f))))) * t361) + (t353 * ((-(l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t356 * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t35b) - (t35a * (l.f5ee * p[85]))) / (t35b * t35b))))) * 0.3333333333333333))))))) / (t366 * t366))), (-((1e-100 * (((-(l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t33e * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t343) - (t342 * (l.f5ef * p[85]))) / (t343 * t343))))) * t364) + (t347 * (0.5 * (((-(l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t34a * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t34f) - (t34e * (l.f5ef * p[85]))) / (t34f * t34f))))) * t361) + (t353 * ((-(l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t356 * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t35b) - (t35a * (l.f5ef * p[85]))) / (t35b * t35b))))) * 0.3333333333333333))))))) / (t366 * t366))), );
        }
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_172(
        ...
        if ((((l.f48c != 0.0) && (l.f490 != 0.0)) && (l.f492 == 0.0)) && (l.f494 == 0.0)) {
            let t368: f64 = (l.f745 / l.f5f5);let t369: f64 = (l.f743 - l.f741);let t36a: f64 = (t369 / l.f5f5);let t36b: f64 = (t368 - t36a);let t36c: f64 = (l.f5f5 - l.f5ed);let t36d: f64 = (l.f743 * t36c);let t36e: f64 = (l.f5ed * p[85]);let t36f: f64 = (t36d / t36e);let t370: f64 = (t36b + t36f);let t371: f64 = (l.f645 * t370);let t372: f64 = (t371 - 230.25850929940458);let t373: f64 = (l.f745 / l.f5f5);let t374: f64 = (l.f743 - l.f741);let t375: f64 = (t374 / l.f5f5);let t376: f64 = (t373 - t375);let t377: f64 = (l.f5f5 - l.f5ed);let t378: f64 = (l.f743 * t377);let t379: f64 = (l.f5ed * p[85]);let t37a: f64 = (t378 / t379);let t37b: f64 = (t376 + t37a);let t37c: f64 = (l.f645 * t37b);let t37d: f64 = (t37c - 230.25850929940458);let t37e: f64 = (l.f745 / l.f5f5);let t37f: f64 = (l.f743 - l.f741);let t380: f64 = (t37f / l.f5f5);let t381: f64 = (t37e - t380);let t382: f64 = (l.f5f5 - l.f5ed);let t383: f64 = (l.f743 * t382);let t384: f64 = (l.f5ed * p[85]);let t385: f64 = (t383 / t384);let t386: f64 = (t381 + t385);let t387: f64 = (l.f645 * t386);let t388: f64 = (t387 - 230.25850929940458);let t389: f64 = (t388 * 0.3333333333333333);let t38a: f64 = (1.0 + t389);let t38b: f64 = (t37d * t38a);let t38c: f64 = (0.5 * t38b);let t38d: f64 = (1.0 + t38c);let t38e: f64 = (t372 * t38d);let t38f: f64 = (1.0 + t38e);let t390: f64 = (1e100 * t38f);
            (l.f81, l.f86, l.f87, ) = (t390, (1e100 * (((l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t369 * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t36e) - (t36d * (l.f5ee * p[85]))) / (t36e * t36e)))) * t38d) + (t372 * (0.5 * (((l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t374 * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t379) - (t378 * (l.f5ee * p[85]))) / (t379 * t379)))) * t38a) + (t37d * ((l.f645 * (((((l.f746 * l.f5f5) - (l.f745 * l.f5fe)) / (l.f5f5 * l.f5f5)) - (-((t37f * l.f5fe) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5fe - l.f5ee)) * t384) - (t383 * (l.f5ee * p[85]))) / (t384 * t384)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t369 * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t36e) - (t36d * (l.f5ef * p[85]))) / (t36e * t36e)))) * t38d) + (t372 * (0.5 * (((l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t374 * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t379) - (t378 * (l.f5ef * p[85]))) / (t379 * t379)))) * t38a) + (t37d * ((l.f645 * (((((l.f747 * l.f5f5) - (l.f745 * l.f5ff)) / (l.f5f5 * l.f5f5)) - (-((t37f * l.f5ff) / (l.f5f5 * l.f5f5)))) + ((((l.f743 * (l.f5ff - l.f5ef)) * t384) - (t383 * (l.f5ef * p[85]))) / (t384 * t384)))) * 0.3333333333333333))))))), );
        }
        if ((l.f48c != 0.0) && (l.f490 == 0.0)) {(l.f81, l.f86, l.f87, ) = (1.0, 0.0, 0.0, );}
        let t391: f64 = if ((p[91] == 0.0) || (l.f745 < l.f741)) { 1.0 } else { 0.0 };l.f496 = t391;
        if ((l.f48c != 0.0) && (l.f496 != 0.0)) {let t392: f64 = (l.f79 * p[90]);(l.f7a, l.f7b, l.f7c, ) = (t392, (l.f7e * p[90]), (l.f7f * p[90]), );}
        if ((l.f48c != 0.0) && (l.f496 == 0.0)) {let t393: f64 = (l.f79 * p[90]);let t394: f64 = (-p[91]);let t395: f64 = (l.f745 - l.f741);let t396: f64 = (t394 * t395);let t397: f64 = (l.f745 - l.f741);let t398: f64 = (t396 * t397);let t399: f64 = (l.f6e9 / l.f6e7);let t39a: f64 = (t399).ln();let t39b: f64 = (p[98] * t39a);let t39c: f64 = (t39b).exp();let t39d: f64 = (t398 * t39c);let t39e: f64 = (t39d).exp();let t39f: f64 = (t393 * t39e);(l.f7a, l.f7b, l.f7c, ) = (t39f, (((l.f7e * p[90]) * t39e) + (t393 * (t39e * ((((t394 * l.f746) * t397) + (t396 * l.f746)) * t39c)))), (((l.f7f * p[90]) * t39e) + (t393 * (t39e * ((((t394 * l.f747) * t397) + (t396 * l.f747)) * t39c)))), );}
        if (l.f48c != 0.0) {
            let (t3a0, t3a1, t3a2,) = {
    if (l.f7a > p[79]) {
        (p[79], 0.0, 0.0,)
        ...
        let t3a7: f64 = if p[92] > 0.0 { 1.0 } else { 0.0 };l.f498 = t3a7;
        if ((l.f48c != 0.0) && (l.f498 != 0.0)) {let t3a8: f64 = (1e-23 / l.f669);let t3a9: f64 = (l.f66b * t3a8);(l.f67d, l.f67e, l.f67f, ) = (t3a9, (l.f66c * t3a8), (l.f66d * t3a8), );let t3aa: f64 = (nv3 - 0.0);(l.f663, l.f664, ) = (t3aa, 1.0, );let t3ab: f64 = (l.f663 - l.f67d);let t3ac: f64 = (t3ab / p[92]);(l.f57c, l.f57d, l.f57e, l.f57f, ) = (t3ac, ((-l.f67e) / p[92]), ((-l.f67f) / p[92]), (l.f664 / p[92]), );let t3ad: f64 = (1e-23 / l.f669);let t3ae: f64 = (l.f663 / t3ad);(l.f66e, l.f66f, l.f670, l.f671, ) = (t3ae, 0.0, 0.0, (l.f664 / t3ad), );}
        if ((l.f48c != 0.0) && (l.f498 == 0.0)) {(l.f67d, l.f67e, l.f67f, ) = (l.f66b, l.f66c, l.f66d, );(l.f66e, l.f66f, l.f670, l.f671, ) = (l.f67d, l.f67e, l.f67f, 0.0, );}
        let t3af: f64 = if ((p[91] == 0.0) || (l.f745 < l.f743)) { 1.0 } else { 0.0 };l.f49a = t3af;
        if ((l.f48c != 0.0) && (l.f49a != 0.0)) {let t3b0: f64 = (l.f81 * p[90]);(l.f82, l.f83, l.f84, ) = (t3b0, (l.f86 * p[90]), (l.f87 * p[90]), );}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_173(
        ...
        if ((l.f48c != 0.0) && (l.f49a == 0.0)) {let t3b1: f64 = (l.f81 * p[90]);let t3b2: f64 = (-p[91]);let t3b3: f64 = (l.f745 - l.f743);let t3b4: f64 = (t3b2 * t3b3);let t3b5: f64 = (l.f745 - l.f743);let t3b6: f64 = (t3b4 * t3b5);let t3b7: f64 = (l.f6e9 / l.f6e7);let t3b8: f64 = (t3b7).ln();let t3b9: f64 = (p[98] * t3b8);let t3ba: f64 = (t3b9).exp();let t3bb: f64 = (t3b6 * t3ba);let t3bc: f64 = (t3bb).exp();let t3bd: f64 = (t3b1 * t3bc);(l.f82, l.f83, l.f84, ) = (t3bd, (((l.f86 * p[90]) * t3bc) + (t3b1 * (t3bc * ((((t3b2 * l.f746) * t3b5) + (t3b4 * l.f746)) * t3ba)))), (((l.f87 * p[90]) * t3bc) + (t3b1 * (t3bc * ((((t3b2 * l.f747) * t3b5) + (t3b4 * l.f747)) * t3ba)))), );}
        if (l.f48c != 0.0) {
            let (t3be, t3bf, t3c0,) = {
    if (l.f82 > p[79]) {
        (p[79], 0.0, 0.0,)
        ...
        let t3c5: f64 = if p[92] > 0.0 { 1.0 } else { 0.0 };l.f49c = t3c5;
        if ((l.f48c != 0.0) && (l.f49c != 0.0)) {let t3c6: f64 = (1e-23 / l.f669);let t3c7: f64 = (l.f674 * t3c6);(l.f681, l.f682, l.f683, ) = (t3c7, (l.f675 * t3c6), (l.f676 * t3c6), );let t3c8: f64 = (nv4 - 0.0);(l.f666, l.f667, ) = (t3c8, 1.0, );let t3c9: f64 = (l.f666 - l.f681);let t3ca: f64 = (t3c9 / p[92]);(l.f581, l.f582, l.f583, l.f584, ) = (t3ca, ((-l.f682) / p[92]), ((-l.f683) / p[92]), (l.f667 / p[92]), );let t3cb: f64 = (1e-23 / l.f669);let t3cc: f64 = (l.f666 / t3cb);(l.f677, l.f678, l.f679, l.f67a, ) = (t3cc, 0.0, 0.0, (l.f667 / t3cb), );}
        ...
        if (l.f48c != 0.0) {let t3d6: f64 = (2.0 * l.f6b);let t3d7: f64 = (t3d6 * l.f7a7);let t3d8: f64 = (1.6021918e-19 * l.f5dd);let t3d9: f64 = (t3d7 / t3d8);let t3da: f64 = (t3d9).sqrt();(l.f7bc, l.f7c1, l.f7c2, ) = (t3da, (((t3d6 * l.f7a8) / t3d8) / (2.0 * t3da)), (((t3d6 * l.f7a9) / t3d8) / (2.0 * t3da)), );let t3db: f64 = (p[94] - l.f7bc);let t3dc: f64 = (t3db - 1e-7);(l.f6f3, l.f6f4, l.f6f5, ) = (t3dc, (-l.f7c1), (-l.f7c2), );let t3dd: f64 = (4.0 * p[94]);let t3de: f64 = (t3dd * 1e-7);(l.f6f7, l.f6f8, l.f6f9, ) = (t3de, 0.0, 0.0, );}
        if (l.f48c != 0.0) {
            let (t3e0, t3e1, t3e2,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        if (l.f48c != 0.0) {let t3e3: f64 = (l.f6f3 * l.f6f3);let t3e4: f64 = (t3e3 + l.f6f7);let t3e5: f64 = (t3e4).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t3e5, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t3e5)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t3e5)), );let t3e6: f64 = (l.f6f3 + l.f6f7);let t3e7: f64 = (0.5 * t3e6);let t3e8: f64 = (p[94] - t3e7);(l.f7bc, l.f7c1, l.f7c2, ) = (t3e8, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );}
        let t3e9: f64 = if p[95] > 0.0 { 1.0 } else { 0.0 };l.f4a0 = t3e9;
        if ((l.f48c != 0.0) && (l.f4a0 != 0.0)) {let t3ea: f64 = (1.0 / l.f7bd);let t3eb: f64 = (l.f7bc * t3ea);(l.f7cc, l.f7cd, l.f7ce, ) = (t3eb, ((l.f7c1 * t3ea) + (l.f7bc * (-(l.f7be / (l.f7bd * l.f7bd))))), ((l.f7c2 * t3ea) + (l.f7bc * (-(l.f7bf / (l.f7bd * l.f7bd))))), );let t3ec: f64 = (nv5 - 0.0);(l.f7c9, l.f7ca, ) = (t3ec, 1.0, );let t3ed: f64 = (l.f7c9 - l.f7cc);let t3ee: f64 = (t3ed / p[95]);(l.f59e, l.f59f, l.f5a0, l.f5a1, ) = (t3ee, ((-l.f7cd) / p[95]), ((-l.f7ce) / p[95]), (l.f7ca / p[95]), );let t3ef: f64 = (1.0 / l.f7bd);let t3f0: f64 = (l.f7c9 / t3ef);(l.f7c3, l.f7c4, l.f7c5, l.f7c6, ) = (t3f0, (-((l.f7c9 * (-(l.f7be / (l.f7bd * l.f7bd)))) / (t3ef * t3ef))), (-((l.f7c9 * (-(l.f7bf / (l.f7bd * l.f7bd)))) / (t3ef * t3ef))), (l.f7ca / t3ef), );}
        if ((l.f48c != 0.0) && (l.f4a0 == 0.0)) {(l.f7cc, l.f7cd, l.f7ce, ) = (l.f7bc, l.f7c1, l.f7c2, );(l.f7c3, l.f7c4, l.f7c5, l.f7c6, ) = (l.f7cc, l.f7cd, l.f7ce, 0.0, );}
        if (l.f48c != 0.0) {let t3f1: f64 = (l.f5dd * l.f0);let t3f2: f64 = (t3f1 * 1.6021918e-19);let t3f3: f64 = (-t3f2);let t3f4: f64 = (t3f3 * p[94]);l.f655 = t3f4;}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_174(
        ...
        let t40b: f64 = if ((l.f6af > 0.0) && (l.f6af >= p[4])) { 1.0 } else { 0.0 };l.f4a2 = t40b;let t40c: f64 = if ((p[84] > 0.0) && (p[92] > 0.0)) { 1.0 } else { 0.0 };l.f4a3 = t40c;let t40d: f64 = if ((p[84] > 0.0) && (p[95] > 0.0)) { 1.0 } else { 0.0 };l.f4a5 = t40d;
    }
    #[inline(never)]
    ...
    if (p[16] > 0.05) {
        ...
        l.f62f = ta;l.f630 = 0.0;l.f631 = p[17];l.f632 = 0.0;l.f641 = p[18];l.f642 = 0.0;l.f639 = p[19];l.f63a = 0.0;
        let (tb,) = {
    if (p[20] > 0.0) {
        (p[20],)
    } else {
