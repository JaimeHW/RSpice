...
impl Instance {
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f174 != 0.0)) {let t11: f64 = (l.f6f3 * l.f6f3);let t12: f64 = (t11 + l.f6f7);let t13: f64 = (t12).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t13, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t13)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t13)), );let t14: f64 = (l.f6f3 + l.f6f7);let t15: f64 = (0.5 * t14);let t16: f64 = (p[85] - t15);(l.f5ed, l.f5ee, l.f5ef, ) = (t16, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t17: f64 = (l.f5ed - l.f5e7);let t18: f64 = (t17 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t18, l.f5ee, l.f5ef, );let t19: f64 = (4.0 * l.f5e7);let t1a: f64 = (t19 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t1a, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f174 != 0.0)) {
            let (t1c, t1d, t1e,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f174 != 0.0)) {let t1f: f64 = (l.f6f3 * l.f6f3);let t20: f64 = (t1f + l.f6f7);let t21: f64 = (t20).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t21, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t21)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t21)), );let t22: f64 = (l.f6f3 + l.f6f7);let t23: f64 = (0.5 * t22);let t24: f64 = (l.f5e7 + t23);(l.f5ed, l.f5ee, l.f5ef, ) = (t24, (0.5 * (l.f6f4 + l.f6f8)), (0.5 * (l.f6f5 + l.f6f9)), );let t25: f64 = (p[86] * l.f55);let t26: f64 = (t25 * l.f51);(l.f5b, l.f5c, l.f5d, ) = (t26, (((p[86] * l.f56) * l.f51) + (t25 * l.f52)), (((p[86] * l.f57) * l.f51) + (t25 * l.f53)), );}
        ...
        let t27: f64 = (l.f7b1 / l.f5f1);let t28: f64 = (l.f5f1 - l.f5ed);let t29: f64 = (l.f793 * t28);let t2a: f64 = (l.f5ed * p[85]);let t2b: f64 = (t29 / t2a);let t2c: f64 = (t27 + t2b);let t2d: f64 = (l.f645 * t2c);let t2e: f64 = (t2d).abs();let t2f: f64 = if t2e < 230.25850929940458 { 1.0 } else { 0.0 };l.f176 = t2f;
        if ((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f176 != 0.0)) {let t30: f64 = (l.f7b1 / l.f5f1);let t31: f64 = (l.f5f1 - l.f5ed);let t32: f64 = (l.f793 * t31);let t33: f64 = (l.f5ed * p[85]);let t34: f64 = (t32 / t33);let t35: f64 = (t30 + t34);let t36: f64 = (l.f645 * t35);let t37: f64 = (t36).exp();(l.f8e, l.f8f, l.f90, ) = (t37, (t37 * (l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t33) - (t32 * (l.f5ee * p[85]))) / (t33 * t33))))), (t37 * (l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t33) - (t32 * (l.f5ef * p[85]))) / (t33 * t33))))), );}
        let t38: f64 = (l.f7b1 / l.f5f1);let t39: f64 = (l.f5f1 - l.f5ed);let t3a: f64 = (l.f793 * t39);let t3b: f64 = (l.f5ed * p[85]);let t3c: f64 = (t3a / t3b);let t3d: f64 = (t38 + t3c);let t3e: f64 = (l.f645 * t3d);let t3f: f64 = (-230.25850929940458);let t40: f64 = if t3e < t3f { 1.0 } else { 0.0 };l.f178 = t40;
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_49(
        ...
        if (((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f176 == 0.0)) && (l.f178 != 0.0)) {let t41: f64 = (-230.25850929940458);let t42: f64 = (l.f7b1 / l.f5f1);let t43: f64 = (l.f5f1 - l.f5ed);let t44: f64 = (l.f793 * t43);let t45: f64 = (l.f5ed * p[85]);let t46: f64 = (t44 / t45);let t47: f64 = (t42 + t46);let t48: f64 = (l.f645 * t47);let t49: f64 = (t41 - t48);let t4a: f64 = (-230.25850929940458);let t4b: f64 = (l.f7b1 / l.f5f1);let t4c: f64 = (l.f5f1 - l.f5ed);let t4d: f64 = (l.f793 * t4c);let t4e: f64 = (l.f5ed * p[85]);let t4f: f64 = (t4d / t4e);let t50: f64 = (t4b + t4f);let t51: f64 = (l.f645 * t50);let t52: f64 = (t4a - t51);let t53: f64 = (-230.25850929940458);let t54: f64 = (l.f7b1 / l.f5f1);let t55: f64 = (l.f5f1 - l.f5ed);let t56: f64 = (l.f793 * t55);let t57: f64 = (l.f5ed * p[85]);let t58: f64 = (t56 / t57);let t59: f64 = (t54 + t58);let t5a: f64 = (l.f645 * t59);let t5b: f64 = (t53 - t5a);let t5c: f64 = (t5b * 0.3333333333333333);let t5d: f64 = (1.0 + t5c);let t5e: f64 = (t52 * t5d);let t5f: f64 = (0.5 * t5e);let t60: f64 = (1.0 + t5f);let t61: f64 = (t49 * t60);let t62: f64 = (1.0 + t61);let t63: f64 = (1e-100 / t62);(l.f8e, l.f8f, l.f90, ) = (t63, (-((1e-100 * (((-(l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t45) - (t44 * (l.f5ee * p[85]))) / (t45 * t45))))) * t60) + (t49 * (0.5 * (((-(l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t4e) - (t4d * (l.f5ee * p[85]))) / (t4e * t4e))))) * t5d) + (t52 * ((-(l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t57) - (t56 * (l.f5ee * p[85]))) / (t57 * t57))))) * 0.3333333333333333))))))) / (t62 * t62))), (-((1e-100 * (((-(l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t45) - (t44 * (l.f5ef * p[85]))) / (t45 * t45))))) * t60) + (t49 * (0.5 * (((-(l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t4e) - (t4d * (l.f5ef * p[85]))) / (t4e * t4e))))) * t5d) + (t52 * ((-(l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t57) - (t56 * (l.f5ef * p[85]))) / (t57 * t57))))) * 0.3333333333333333))))))) / (t62 * t62))), );}
        if (((((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) && (l.f176 == 0.0)) && (l.f178 == 0.0)) {let t64: f64 = (l.f7b1 / l.f5f1);let t65: f64 = (l.f5f1 - l.f5ed);let t66: f64 = (l.f793 * t65);let t67: f64 = (l.f5ed * p[85]);let t68: f64 = (t66 / t67);let t69: f64 = (t64 + t68);let t6a: f64 = (l.f645 * t69);let t6b: f64 = (t6a - 230.25850929940458);let t6c: f64 = (l.f7b1 / l.f5f1);let t6d: f64 = (l.f5f1 - l.f5ed);let t6e: f64 = (l.f793 * t6d);let t6f: f64 = (l.f5ed * p[85]);let t70: f64 = (t6e / t6f);let t71: f64 = (t6c + t70);let t72: f64 = (l.f645 * t71);let t73: f64 = (t72 - 230.25850929940458);let t74: f64 = (l.f7b1 / l.f5f1);let t75: f64 = (l.f5f1 - l.f5ed);let t76: f64 = (l.f793 * t75);let t77: f64 = (l.f5ed * p[85]);let t78: f64 = (t76 / t77);let t79: f64 = (t74 + t78);let t7a: f64 = (l.f645 * t79);let t7b: f64 = (t7a - 230.25850929940458);let t7c: f64 = (t7b * 0.3333333333333333);let t7d: f64 = (1.0 + t7c);let t7e: f64 = (t73 * t7d);let t7f: f64 = (0.5 * t7e);let t80: f64 = (1.0 + t7f);let t81: f64 = (t6b * t80);let t82: f64 = (1.0 + t81);let t83: f64 = (1e100 * t82);(l.f8e, l.f8f, l.f90, ) = (t83, (1e100 * (((l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t67) - (t66 * (l.f5ee * p[85]))) / (t67 * t67)))) * t80) + (t6b * (0.5 * (((l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t6f) - (t6e * (l.f5ee * p[85]))) / (t6f * t6f)))) * t7d) + (t73 * ((l.f645 * ((-((l.f7b1 * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t77) - (t76 * (l.f5ee * p[85]))) / (t77 * t77)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t67) - (t66 * (l.f5ef * p[85]))) / (t67 * t67)))) * t80) + (t6b * (0.5 * (((l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t6f) - (t6e * (l.f5ef * p[85]))) / (t6f * t6f)))) * t7d) + (t73 * ((l.f645 * ((-((l.f7b1 * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t77) - (t76 * (l.f5ef * p[85]))) / (t77 * t77)))) * 0.3333333333333333))))))), );}
        if (((l.f29a != 0.0) && (l.f14e != 0.0)) && (l.f150 == 0.0)) {let t84: f64 = (l.f7b1 * l.f5b);let t85: f64 = (l.f5f1 - t84);let t86: f64 = (l.f5f1 * l.f5f1);let t87: f64 = (t85 / t86);let t88: f64 = (l.f793 * l.f5b);let t89: f64 = (l.f5ed * p[85]);let t8a: f64 = (t88 / t89);let t8b: f64 = (t87 + t8a);let t8c: f64 = (l.f645 * t8b);(l.f61, l.f62, l.f63, ) = (t8c, (l.f645 * (((((l.f5f2 - (l.f7b1 * l.f5c)) * t86) - (t85 * ((l.f5f2 * l.f5f1) + (l.f5f1 * l.f5f2)))) / (t86 * t86)) + ((((l.f793 * l.f5c) * t89) - (t88 * (l.f5ee * p[85]))) / (t89 * t89)))), (l.f645 * (((((l.f5f3 - (l.f7b1 * l.f5d)) * t86) - (t85 * ((l.f5f3 * l.f5f1) + (l.f5f1 * l.f5f3)))) / (t86 * t86)) + ((((l.f793 * l.f5d) * t89) - (t88 * (l.f5ef * p[85]))) / (t89 * t89)))), );let t8d: f64 = (l.f739 - l.f7b1);let t8e: f64 = (t8d * l.f61);let t8f: f64 = (1.0 + t8e);let t90: f64 = (t8f * l.f8e);(l.f53a, l.f53b, l.f53c, ) = (t90, (((t8d * l.f62) * l.f8e) + (t8f * l.f8f)), (((t8d * l.f63) * l.f8e) + (t8f * l.f90)), );}
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        let t1a9: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f19a = t1a9;
    ...
    pub(super) fn stamp_transient_block_57(
        ...
        let t2a7: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f1c0 = t2a7;
    ...
    pub(super) fn stamp_transient_block_61(
        ...
        let t3a5: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f1e5 = t3a5;
    ...
    pub(super) fn stamp_transient_block_62(
        ...
        let t410: f64 = if l.f5e5 < p[85] { 1.0 } else { 0.0 };l.f1f4 = t410;
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {let t411: f64 = (l.f73b - l.f793);let t412: f64 = (p[86] * t411);let t413: f64 = (t412 + l.f5e5);(l.f601, l.f602, l.f603, ) = (t413, 0.0, 0.0, );let t414: f64 = (p[86] * l.f793);let t415: f64 = (l.f5e5 - t414);(l.f5ed, l.f5ee, l.f5ef, ) = (t415, 0.0, 0.0, );let t416: f64 = (p[85] - l.f601);let t417: f64 = (t416 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t417, (-l.f602), (-l.f603), );let t418: f64 = (4.0 * p[85]);let t419: f64 = (t418 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t419, 0.0, 0.0, );}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {let t41e: f64 = (l.f6f3 * l.f6f3);let t41f: f64 = (t41e + l.f6f7);let t420: f64 = (t41f).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t420, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t420)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t420)), );let t421: f64 = (l.f6f3 + l.f6f7);let t422: f64 = (0.5 * t421);let t423: f64 = (p[85] - t422);(l.f605, l.f606, l.f607, ) = (t423, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t424: f64 = (l.f605 - l.f5e5);let t425: f64 = (t424 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t425, l.f606, l.f607, );let t426: f64 = (4.0 * l.f5e5);let t427: f64 = (t426 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t427, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {
            let (t429, t42a, t42b,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {let t43a: f64 = (l.f6f3 * l.f6f3);let t43b: f64 = (t43a + l.f6f7);let t43c: f64 = (t43b).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t43c, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t43c)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t43c)), );let t43d: f64 = (l.f6f3 + l.f6f7);let t43e: f64 = (0.5 * t43d);let t43f: f64 = (p[85] - t43e);(l.f5ed, l.f5ee, l.f5ef, ) = (t43f, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );let t440: f64 = (l.f5ed - l.f5e5);let t441: f64 = (t440 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t441, l.f5ee, l.f5ef, );let t442: f64 = (4.0 * l.f5e5);let t443: f64 = (t442 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t443, 0.0, 0.0, );}
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {
            let (t445, t446, t447,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
        ...
        let t44e: f64 = (l.f73b / l.f5f1);let t44f: f64 = (l.f5f1 - l.f5ed);let t450: f64 = (l.f793 * t44f);let t451: f64 = (l.f5ed * p[85]);let t452: f64 = (t450 / t451);let t453: f64 = (t44e + t452);let t454: f64 = (l.f645 * t453);let t455: f64 = (t454).abs();let t456: f64 = if t455 < 230.25850929940458 { 1.0 } else { 0.0 };l.f1f6 = t456;
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f6 != 0.0)) {let t457: f64 = (l.f73b / l.f5f1);let t458: f64 = (l.f5f1 - l.f5ed);let t459: f64 = (l.f793 * t458);let t45a: f64 = (l.f5ed * p[85]);let t45b: f64 = (t459 / t45a);let t45c: f64 = (t457 + t45b);let t45d: f64 = (l.f645 * t45c);let t45e: f64 = (t45d).exp();(l.f536, l.f537, l.f538, ) = (t45e, (t45e * (l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t45a) - (t459 * (l.f5ee * p[85]))) / (t45a * t45a))))), (t45e * (l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t45a) - (t459 * (l.f5ef * p[85]))) / (t45a * t45a))))), );}
        let t45f: f64 = (l.f73b / l.f5f1);let t460: f64 = (l.f5f1 - l.f5ed);let t461: f64 = (l.f793 * t460);let t462: f64 = (l.f5ed * p[85]);let t463: f64 = (t461 / t462);let t464: f64 = (t45f + t463);let t465: f64 = (l.f645 * t464);let t466: f64 = (-230.25850929940458);let t467: f64 = if t465 < t466 { 1.0 } else { 0.0 };l.f1f8 = t467;
    }
}
