...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_32(
        ...
        if (((s.b[418] && s.b[617]) && (!s.b[618])) && s.b[630]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_scaled_div(365, 314, 315, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(359, 314, 0.5, 315, 0.5, s.v[62]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_33(
        ...
        if (((s.b[418] && s.b[617]) && (!s.b[618])) && s.b[630]) {s.store_offset_sub_from_scalar_ad(314, p.p85, s.ad_value(350), (-0.01));s.store_scalar(315, ((4.0 * p.p85) * 0.01));}
        if (((s.b[418] && s.b[617]) && (!s.b[618])) && s.b[630]) {
            if (s.v[315] > 0.0) {
            } else {
                s.store_neg(315, 315);
    ...
    pub(super) fn stamp_reactive_block_36(
        ...
        if (s.b[418] && (!s.b[617])) {s.store_scalar(370, 0.0);s.store_scalar(371, 0.0);s.store_scalar(372, 0.0);s.store_scalar(431, 0.0);s.store_scalar(428, 0.0);s.store_scalar(430, 0.0);s.store_scalar(433, 0.0);s.store_scalar(434, 0.0);s.store_scalar(435, 0.0);}
    ...
    pub(super) fn stamp_reactive_block_38(
        ...
        if ((s.b[418] && (!s.b[658])) && (!s.b[663])) {s.store_primal_div_scaled_inputs_indices(446, 443, (s.v[123] * s.v[153]), 439, 1.0);s.store_primal_div_from_scalar(447, (0.666666666666667 * s.v[150]), 446);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_39(
        ...
        if ((s.b[418] && (!s.b[658])) && (!s.b[663])) {s.store_primal_square(448, 447);s.store_primal_sqrt_div_scaled_square_offset_denominator(449, 448, 1.0, 1.0, 1.0);s.store_primal_sqrt_abs_ad(450, s.ad_value(449));s.store_primal_mul(451, 449, 450);}
    ...
    pub(super) fn stamp_reactive_block_41(
        ...
        if ((s.b[418] && (!s.b[676])) && (!s.b[681])) {s.store_primal_mul(451, 449, 450);}
    ...
    pub(super) fn stamp_reactive_block_42(
        ...
        if ((s.b[418] && s.b[694]) && s.b[695]) {s.store_primal_scaled_square(363, 318, 1.0 / (s.v[308]));s.store_primal_scaled_ln_ad(362, A::div_from_scalar(s.v[308], s.ad_value(363)), (s.v[62] / s.v[85]));}
