...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_11(
        ...
        if (s.b[418] && s.b[463]) {s.store_primal_sub(432, 264, 431);s.store_primal_add_scaled_inputs3_sqrt_third_sub_square_offset(433, 190, 0.5, 432, 0.5, 190, 432, ((4.0 * s.v[84]) * s.v[84]), (-0.5));s.store_primal_add_scaled_inputs3_sqrt_third_mixed_iia(434, 190, 0.5, 267, 0.5, A::add_scaled_square_product(A::sub(s.ad_value(190), s.ad_value(267)), 1.0, s.ad_value(82), s.ad_value(82), 4.0), (-0.5));s.store_primal_scaled_sub_mixed_ia(435, 190, A::sqrt_square_offset(s.ad_value(190), ((4.0 * 1e-6) * 1e-6)), 0.5);}
        ...
        if ((s.b[418] && (!s.b[486])) && s.b[488]) {s.store_scalar(439, 0.0);s.store_scalar(442, 0.0);s.store_scalar(443, 0.0);s.store_scalar(444, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_12(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[418] && (!s.b[486])) && s.b[488]) {s.store_scalar(438, 0.0);}
        ...
        if ((s.b[418] && (!s.b[486])) && (!s.b[491])) {s.store_primal_div_scaled_product_add_scaled_denominator_indices(453, 442, 452, 1.0, 442, 1.0, 452, 1.0, 1.0);s.store_primal_sqrt_scaled_input_ad(454, A::div(s.ad_value(446), s.ad_value(450)), 0.375);s.store_primal_add_scaled_product_indices(455, 449, (-1.0), 447, 450, 2.0);s.store_primal_add_scaled_value_products_indices(456, 449, (-s.v[149]), 447, 450, s.v[149], 446, 451, 0.5);s.store_primal_mul_scale_offset_indices(457, 454, 455, 1.0, (-1.0));s.store_primal_square(419, 457);}
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if ((s.b[418] && (!s.b[522])) && (!s.b[524])) {s.store_primal_scale(443, 436, s.v[139]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_16(
        ...
        if ((s.b[418] && (!s.b[522])) && (!s.b[524])) {s.store_primal_mul_ad_product_lhs_mixed_ia(444, 100, A::offset(s.ad_value(430), (-1.0)), 443);s.store_primal_scaled_mul(438, 444, 442, s.v[22]);}
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        if (((s.b[418] && s.b[540]) && (!s.b[541])) && s.b[553]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_scaled_div(365, 314, 315, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(359, 314, 0.5, 315, 0.5, s.v[62]);s.store_offset_sub_from_scalar_ad(314, p.p85, s.ad_value(350), (-0.01));s.store_scalar(315, ((4.0 * p.p85) * 0.01));}
        if (((s.b[418] && s.b[540]) && (!s.b[541])) && s.b[553]) {
            if (s.v[315] > 0.0) {
            } else {
                s.store_neg(315, 315);
    ...
    pub(super) fn stamp_reactive_block_22(
        ...
        if (((s.b[418] && s.b[540]) && (!s.b[541])) && s.b[559]) {s.store_sqrt_square_add(315, 314, 315);s.store_offset_add_scaled_inputs_indices(350, 314, 0.5, 315, 0.5, s.v[63]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_23(
        ...
        if (((s.b[418] && s.b[540]) && (!s.b[541])) && s.b[559]) {s.store_scaled_mul(366, 364, 365, p.p86);}
        ...
        if (s.b[418] && s.b[540]) {s.store_primal_sub(432, 264, 431);s.store_primal_add_scaled_inputs3_sqrt_third_sub_square_offset(433, 191, 0.5, 432, 0.5, 191, 432, ((4.0 * s.v[84]) * s.v[84]), (-0.5));s.store_primal_add_scaled_inputs3_sqrt_third_mixed_iia(434, 191, 0.5, 267, 0.5, A::add_scaled_square_product(A::sub(s.ad_value(191), s.ad_value(267)), 1.0, s.ad_value(82), s.ad_value(82), 4.0), (-0.5));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_24(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[418] && s.b[540]) {s.store_primal_scaled_sub_mixed_ia(435, 191, A::sqrt_square_offset(s.ad_value(191), ((4.0 * 1e-6) * 1e-6)), 0.5);}
        ...
        if ((s.b[418] && (!s.b[563])) && (!s.b[568])) {s.store_primal_div_scaled_product_add_scaled_denominator_indices(453, 442, 452, 1.0, 442, 1.0, 452, 1.0, 1.0);s.store_primal_sqrt_scaled_input_ad(454, A::div(s.ad_value(446), s.ad_value(450)), 0.375);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_25(
        ...
        if ((s.b[418] && (!s.b[563])) && (!s.b[568])) {s.store_primal_add_scaled_product_indices(455, 449, (-1.0), 447, 450, 2.0);s.store_primal_add_scaled_value_products_indices(456, 449, (-s.v[149]), 447, 450, s.v[149], 446, 451, 0.5);s.store_primal_mul_scale_offset_indices(457, 454, 455, 1.0, (-1.0));s.store_primal_square(419, 457);}
    ...
    pub(super) fn stamp_reactive_block_26(
        ...
        if ((s.b[418] && (!s.b[581])) && (!s.b[586])) {s.store_primal_div_scaled_inputs_indices(446, 443, (s.v[123] * s.v[153]), 439, 1.0);s.store_primal_div_from_scalar(447, (0.666666666666667 * s.v[150]), 446);s.store_primal_square(448, 447);s.store_primal_sqrt_div_scaled_square_offset_denominator(449, 448, 1.0, 1.0, 1.0);s.store_primal_sqrt_abs_ad(450, s.ad_value(449));s.store_primal_mul(451, 449, 450);}
