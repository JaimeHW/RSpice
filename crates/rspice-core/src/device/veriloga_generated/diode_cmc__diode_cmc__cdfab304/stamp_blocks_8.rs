...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_131(
        ...
        let t113: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f37e = t113;
    ...
    pub(super) fn stamp_transient_block_135(
        ...
        let t211: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f3a2 = t211;
    ...
    pub(super) fn stamp_transient_block_139(
        ...
        let t30f: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f3c6 = t30f;
