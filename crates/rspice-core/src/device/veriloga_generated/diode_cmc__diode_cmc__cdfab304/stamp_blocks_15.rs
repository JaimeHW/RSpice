...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_66(
        ...
        let t64: f64 = if ((l.f783 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f19a = t64;l.f19b = 0.0;
    ...
    pub(super) fn stamp_reactive_block_70(
        ...
        let t162: f64 = if ((l.f78d > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f1c0 = t162;l.f1c1 = 0.0;
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_75(
        ...
        let t260: f64 = if ((l.f785 > 1000000.0) || (p[80] == 0.0)) { 1.0 } else { 0.0 };l.f1e5 = t260;l.f1e6 = 0.0;
    ...
    pub(super) fn stamp_reactive_block_77(
        ...
        let t2cb: f64 = if l.f5e5 < p[85] { 1.0 } else { 0.0 };l.f1f4 = t2cb;l.f1f5 = 0.0;
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f4 != 0.0)) {let t2cc: f64 = (l.f73b - l.f793);let t2cd: f64 = (p[86] * t2cc);let t2ce: f64 = (t2cd + l.f5e5);(l.f601, l.f602, l.f603, ) = (t2ce, 0.0, 0.0, );l.f604 = 0.0;let t2cf: f64 = (p[86] * l.f793);let t2d0: f64 = (l.f5e5 - t2cf);(l.f5ed, l.f5ee, l.f5ef, ) = (t2d0, 0.0, 0.0, );l.f5f0 = 0.0;let t2d1: f64 = (p[85] - l.f601);let t2d2: f64 = (t2d1 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t2d2, (-l.f602), (-l.f603), );l.f6f6 = 0.0;let t2d3: f64 = (4.0 * p[85]);let t2d4: f64 = (t2d3 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t2d4, 0.0, 0.0, );l.f6fa = 0.0;}
    ...
    if (l.f6f7 > 0.0) {
        ...
        let t309: f64 = (l.f73b / l.f5f1);let t30a: f64 = (l.f5f1 - l.f5ed);let t30b: f64 = (l.f793 * t30a);let t30c: f64 = (l.f5ed * p[85]);let t30d: f64 = (t30b / t30c);let t30e: f64 = (t309 + t30d);let t30f: f64 = (l.f645 * t30e);let t310: f64 = (t30f).abs();let t311: f64 = if t310 < 230.25850929940458 { 1.0 } else { 0.0 };l.f1f6 = t311;l.f1f7 = 0.0;
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f6 != 0.0)) {let t312: f64 = (l.f73b / l.f5f1);let t313: f64 = (l.f5f1 - l.f5ed);let t314: f64 = (l.f793 * t313);let t315: f64 = (l.f5ed * p[85]);let t316: f64 = (t314 / t315);let t317: f64 = (t312 + t316);let t318: f64 = (l.f645 * t317);let t319: f64 = (t318).exp();(l.f536, l.f537, l.f538, ) = (t319, (t319 * (l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t315) - (t314 * (l.f5ee * p[85]))) / (t315 * t315))))), (t319 * (l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t315) - (t314 * (l.f5ef * p[85]))) / (t315 * t315))))), );l.f539 = 0.0;}
        let t31a: f64 = (l.f73b / l.f5f1);let t31b: f64 = (l.f5f1 - l.f5ed);let t31c: f64 = (l.f793 * t31b);let t31d: f64 = (l.f5ed * p[85]);let t31e: f64 = (t31c / t31d);let t31f: f64 = (t31a + t31e);let t320: f64 = (l.f645 * t31f);let t321: f64 = (-230.25850929940458);let t322: f64 = if t320 < t321 { 1.0 } else { 0.0 };l.f1f8 = t322;l.f1f9 = 0.0;
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_79(
        ...
        if (((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f6 == 0.0)) && (l.f1f8 != 0.0)) {let t323: f64 = (-230.25850929940458);let t324: f64 = (l.f73b / l.f5f1);let t325: f64 = (l.f5f1 - l.f5ed);let t326: f64 = (l.f793 * t325);let t327: f64 = (l.f5ed * p[85]);let t328: f64 = (t326 / t327);let t329: f64 = (t324 + t328);let t32a: f64 = (l.f645 * t329);let t32b: f64 = (t323 - t32a);let t32c: f64 = (-230.25850929940458);let t32d: f64 = (l.f73b / l.f5f1);let t32e: f64 = (l.f5f1 - l.f5ed);let t32f: f64 = (l.f793 * t32e);let t330: f64 = (l.f5ed * p[85]);let t331: f64 = (t32f / t330);let t332: f64 = (t32d + t331);let t333: f64 = (l.f645 * t332);let t334: f64 = (t32c - t333);let t335: f64 = (-230.25850929940458);let t336: f64 = (l.f73b / l.f5f1);let t337: f64 = (l.f5f1 - l.f5ed);let t338: f64 = (l.f793 * t337);let t339: f64 = (l.f5ed * p[85]);let t33a: f64 = (t338 / t339);let t33b: f64 = (t336 + t33a);let t33c: f64 = (l.f645 * t33b);let t33d: f64 = (t335 - t33c);let t33e: f64 = (t33d * 0.3333333333333333);let t33f: f64 = (1.0 + t33e);let t340: f64 = (t334 * t33f);let t341: f64 = (0.5 * t340);let t342: f64 = (1.0 + t341);let t343: f64 = (t32b * t342);let t344: f64 = (1.0 + t343);let t345: f64 = (1e-100 / t344);(l.f536, l.f537, l.f538, ) = (t345, (-((1e-100 * (((-(l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t327) - (t326 * (l.f5ee * p[85]))) / (t327 * t327))))) * t342) + (t32b * (0.5 * (((-(l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t330) - (t32f * (l.f5ee * p[85]))) / (t330 * t330))))) * t33f) + (t334 * ((-(l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t339) - (t338 * (l.f5ee * p[85]))) / (t339 * t339))))) * 0.3333333333333333))))))) / (t344 * t344))), (-((1e-100 * (((-(l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t327) - (t326 * (l.f5ef * p[85]))) / (t327 * t327))))) * t342) + (t32b * (0.5 * (((-(l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t330) - (t32f * (l.f5ef * p[85]))) / (t330 * t330))))) * t33f) + (t334 * ((-(l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t339) - (t338 * (l.f5ef * p[85]))) / (t339 * t339))))) * 0.3333333333333333))))))) / (t344 * t344))), );l.f539 = 0.0;}
        if (((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1f6 == 0.0)) && (l.f1f8 == 0.0)) {let t346: f64 = (l.f73b / l.f5f1);let t347: f64 = (l.f5f1 - l.f5ed);let t348: f64 = (l.f793 * t347);let t349: f64 = (l.f5ed * p[85]);let t34a: f64 = (t348 / t349);let t34b: f64 = (t346 + t34a);let t34c: f64 = (l.f645 * t34b);let t34d: f64 = (t34c - 230.25850929940458);let t34e: f64 = (l.f73b / l.f5f1);let t34f: f64 = (l.f5f1 - l.f5ed);let t350: f64 = (l.f793 * t34f);let t351: f64 = (l.f5ed * p[85]);let t352: f64 = (t350 / t351);let t353: f64 = (t34e + t352);let t354: f64 = (l.f645 * t353);let t355: f64 = (t354 - 230.25850929940458);let t356: f64 = (l.f73b / l.f5f1);let t357: f64 = (l.f5f1 - l.f5ed);let t358: f64 = (l.f793 * t357);let t359: f64 = (l.f5ed * p[85]);let t35a: f64 = (t358 / t359);let t35b: f64 = (t356 + t35a);let t35c: f64 = (l.f645 * t35b);let t35d: f64 = (t35c - 230.25850929940458);let t35e: f64 = (t35d * 0.3333333333333333);let t35f: f64 = (1.0 + t35e);let t360: f64 = (t355 * t35f);let t361: f64 = (0.5 * t360);let t362: f64 = (1.0 + t361);let t363: f64 = (t34d * t362);let t364: f64 = (1.0 + t363);let t365: f64 = (1e100 * t364);(l.f536, l.f537, l.f538, ) = (t365, (1e100 * (((l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t349) - (t348 * (l.f5ee * p[85]))) / (t349 * t349)))) * t362) + (t34d * (0.5 * (((l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t351) - (t350 * (l.f5ee * p[85]))) / (t351 * t351)))) * t35f) + (t355 * ((l.f645 * ((-((l.f73b * l.f5f2) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f2 - l.f5ee)) * t359) - (t358 * (l.f5ee * p[85]))) / (t359 * t359)))) * 0.3333333333333333))))))), (1e100 * (((l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t349) - (t348 * (l.f5ef * p[85]))) / (t349 * t349)))) * t362) + (t34d * (0.5 * (((l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t351) - (t350 * (l.f5ef * p[85]))) / (t351 * t351)))) * t35f) + (t355 * ((l.f645 * ((-((l.f73b * l.f5f3) / (l.f5f1 * l.f5f1))) + ((((l.f793 * (l.f5f3 - l.f5ef)) * t359) - (t358 * (l.f5ef * p[85]))) / (t359 * t359)))) * 0.3333333333333333))))))), );l.f539 = 0.0;}
        ...
        let t36c: f64 = if l.f5e9 < p[85] { 1.0 } else { 0.0 };l.f1fa = t36c;l.f1fb = 0.0;
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1fa != 0.0)) {let t36d: f64 = (l.f73b - l.f793);let t36e: f64 = (p[86] * t36d);let t36f: f64 = (t36e + l.f5e9);(l.f601, l.f602, l.f603, ) = (t36f, 0.0, 0.0, );l.f604 = 0.0;let t370: f64 = (p[86] * l.f793);let t371: f64 = (l.f5e9 - t370);(l.f5ed, l.f5ee, l.f5ef, ) = (t371, 0.0, 0.0, );l.f5f0 = 0.0;}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_80(
        ...
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1fa != 0.0)) {let t372: f64 = (p[85] - l.f601);let t373: f64 = (t372 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t373, (-l.f602), (-l.f603), );l.f6f6 = 0.0;let t374: f64 = (4.0 * p[85]);let t375: f64 = (t374 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t375, 0.0, 0.0, );l.f6fa = 0.0;}
    ...
    if (l.f6f7 > 0.0) {
        ...
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1fa != 0.0)) {let t37a: f64 = (l.f6f3 * l.f6f3);let t37b: f64 = (t37a + l.f6f7);let t37c: f64 = (t37b).sqrt();(l.f6f7, l.f6f8, l.f6f9, ) = (t37c, ((((l.f6f4 * l.f6f3) + (l.f6f3 * l.f6f4)) + l.f6f8) / (2.0 * t37c)), ((((l.f6f5 * l.f6f3) + (l.f6f3 * l.f6f5)) + l.f6f9) / (2.0 * t37c)), );l.f6fa = 0.0;let t37d: f64 = (l.f6f3 + l.f6f7);let t37e: f64 = (0.5 * t37d);let t37f: f64 = (p[85] - t37e);(l.f605, l.f606, l.f607, ) = (t37f, (-(0.5 * (l.f6f4 + l.f6f8))), (-(0.5 * (l.f6f5 + l.f6f9))), );l.f608 = 0.0;let t380: f64 = (l.f605 - l.f5e9);let t381: f64 = (t380 - 0.01);(l.f6f3, l.f6f4, l.f6f5, ) = (t381, l.f606, l.f607, );l.f6f6 = 0.0;let t382: f64 = (4.0 * l.f5e9);let t383: f64 = (t382 * 0.01);(l.f6f7, l.f6f8, l.f6f9, ) = (t383, 0.0, 0.0, );l.f6fa = 0.0;}
        if ((((l.f29a != 0.0) && (l.f1ec != 0.0)) && (l.f1ee != 0.0)) && (l.f1fa != 0.0)) {
            let (t385, t386, t387,) = {
    if (l.f6f7 > 0.0) {
        (l.f6f7, l.f6f8, l.f6f9,)
