...
impl Instance {
    ...
    pub(super) fn stamp_transient_equations_block_9(
        ...
        stamper.stamp_current_dense_local(
            ...
            multiplicity,
        );let eq35_e710: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 14, s.v[374]);let eq35_e711: f64 = (p[14] * eq35_e710);let eq35_e711_d_n0: f64 = (p[14] * (s.dn[374][0] * ddt_scale));let eq35_e711_d_n1: f64 = (p[14] * (s.dn[374][1] * ddt_scale));let eq35_e711_d_n2: f64 = (p[14] * (s.dn[374][2] * ddt_scale));let eq35_e711_d_n3: f64 = (p[14] * (s.dn[374][3] * ddt_scale));let eq35_e711_d_n4: f64 = (p[14] * (s.dn[374][4] * ddt_scale));let eq35_e711_d_n5: f64 = (p[14] * (s.dn[374][5] * ddt_scale));let eq35_e711_d_n6: f64 = (p[14] * (s.dn[374][6] * ddt_scale));let eq35_e711_d_n7: f64 = (p[14] * (s.dn[374][7] * ddt_scale));let eq35_e711_d_n8: f64 = (p[14] * (s.dn[374][8] * ddt_scale));let eq35_e711_d_n9: f64 = (p[14] * (s.dn[374][9] * ddt_scale));let eq35_e711_d_n10: f64 = (p[14] * (s.dn[374][10] * ddt_scale));let eq35_e711_d_n11: f64 = (p[14] * (s.dn[374][11] * ddt_scale));let eq35_e711_d_n12: f64 = (p[14] * (s.dn[374][12] * ddt_scale));let eq35_e711_d_n13: f64 = (p[14] * (s.dn[374][13] * ddt_scale));let eq35_e711_d_b0: f64 = (p[14] * (s.db[374][0] * ddt_scale));let eq35_e711_d_b1: f64 = (p[14] * (s.db[374][1] * ddt_scale));let eq35_e711_d_b2: f64 = (p[14] * (s.db[374][2] * ddt_scale));let eq35_e711_d_b3: f64 = (p[14] * (s.db[374][3] * ddt_scale));let eq35_value: f64 = eq35_e711;let eq35_node_derivatives: [f64; 14] = [eq35_e711_d_n0, eq35_e711_d_n1, eq35_e711_d_n2, eq35_e711_d_n3, eq35_e711_d_n4, eq35_e711_d_n5, eq35_e711_d_n6, eq35_e711_d_n7, eq35_e711_d_n8, eq35_e711_d_n9, eq35_e711_d_n10, eq35_e711_d_n11, eq35_e711_d_n12, eq35_e711_d_n13];let eq35_branch_derivatives: [f64; 4] = [eq35_e711_d_b0, eq35_e711_d_b1, eq35_e711_d_b2, eq35_e711_d_b3];
        stamper.stamp_current_dense_local(
            Some(9),
            Some(8),
