...
impl Instance {
    pub(super) fn stamp_transient_block_0(
        ...
        let assign100_e921: f64 = 0.0;
        locals.var_gmin = assign100_e921;
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if (locals.var_guard83 != 0.0) {
            ...
            locals.var_rg_i = p.p187;
            locals.var_rse_i = p.p188;
            locals.var_rde_i = p.p189;
            locals.var_rwell_i = p.p190;
        }
        if (locals.var_guard83 == 0.0) {
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if (locals.var_guard83 == 0.0) {
            let assign2320_e2026: f64 = (p.p20 + locals.var_dellps);
            let assign2320_e2028: f64 = (assign2320_e2026).max(1e-9);
            locals.var_l_f = assign2320_e2028;
        }
        if (locals.var_guard83 == 0.0) {
            let assign2330_e2035: f64 = (locals.var_l_f + p.p499);
            let assign2330_e2037: f64 = (assign2330_e2035).max(1e-9);
            locals.var_l_slif = assign2330_e2037;
        }
        if (locals.var_guard83 == 0.0) {
            let assign2340_e2044: f64 = (locals.var_w_i + locals.var_delwod);
            let assign2340_e2046: f64 = (assign2340_e2044).max(1e-9);
            locals.var_w_f = assign2340_e2046;
        }
        if (locals.var_guard83 == 0.0) {
            let assign2350_e2054: f64 = (0.5 * locals.var_delwod);
            let assign2350_e2055: f64 = (p.p38 - assign2350_e2054);
            let assign2350_e2057: f64 = (assign2350_e2055).max(1e-9);
            locals.var_xgwe = assign2350_e2057;
        }
        if (locals.var_guard83 == 0.0) {
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (locals.var_guard83 == 0.0) {
            ...
            (locals.var_cth_p, locals.var_cth_p_dn4, locals.var_cth_p_dn6, locals.var_cth_p_dn7, locals.var_cth_p_dn8, locals.var_cth_p_dn9, ) = (assign5410_e4728, (p.p448 * locals.var_temp_dn4), (p.p448 * locals.var_temp_dn6), (p.p448 * locals.var_temp_dn7), (p.p448 * locals.var_temp_dn8), (p.p448 * locals.var_temp_dn9), );
        }
        if (locals.var_guard83 == 0.0) {
            let assign5420_e4735: f64 = (locals.var_cth_p).max(0.0);
            (locals.var_cth_i, locals.var_cth_i_dn4, locals.var_cth_i_dn6, locals.var_cth_i_dn7, locals.var_cth_i_dn8, locals.var_cth_i_dn9, ) = (assign5420_e4735, if locals.var_cth_p >= 0.0 { locals.var_cth_p_dn4 } else { 0.0 }, if locals.var_cth_p >= 0.0 { locals.var_cth_p_dn6 } else { 0.0 }, if locals.var_cth_p >= 0.0 { locals.var_cth_p_dn7 } else { 0.0 }, if locals.var_cth_p >= 0.0 { locals.var_cth_p_dn8 } else { 0.0 }, if locals.var_cth_p >= 0.0 { locals.var_cth_p_dn9 } else { 0.0 }, );
        }
        if (locals.var_guard83 == 0.0) {
        ...
        if (locals.var_guard83 == 0.0) {
            let assign5580_e4856: f64 = (0.3333333333333 * locals.var_w_f);
            let assign5580_e4858: f64 = (assign5580_e4856 / p.p37);
            let assign5580_e4860: f64 = (assign5580_e4858 + locals.var_xgwe);
            let assign5580_e4861: f64 = (p.p498 * assign5580_e4860);
            let assign5580_e4864: f64 = (p.p37 * locals.var_l_slif);
            let assign5580_e4865: f64 = (assign5580_e4861 / assign5580_e4864);
            let assign5580_e4868: f64 = (p.p496 + p.p497);
            let assign5580_e4871: f64 = (locals.var_w_f * locals.var_l_f);
            let assign5580_e4872: f64 = (assign5580_e4868 / assign5580_e4871);
            let assign5580_e4873: f64 = (assign5580_e4865 + assign5580_e4872);
            let assign5580_e4876: f64 = (p.p29 * p.p495);
            let assign5580_e4877: f64 = (assign5580_e4873 + assign5580_e4876);
            locals.var_rg_p = assign5580_e4877;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5590_e4884: f64 = (locals.var_rg_p).max(0.0);
            locals.var_rg_i = assign5590_e4884;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5600_e4891: f64 = (p.p500).max(0.0);
            locals.var_rsh_i = assign5600_e4891;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5610_e4898: f64 = (p.p501).max(0.0);
            locals.var_rshd_i = assign5610_e4898;
        }
        let assign5620_e4903: f64 = if p.p7 == 0.0 { 1.0 } else { 0.0 };
        locals.var_guard132 = assign5620_e4903;
        if ((locals.var_guard83 == 0.0) && (locals.var_guard132 != 0.0)) {
            locals.var_rshd_i = locals.var_rsh_i;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5640_e4915: f64 = (p.p29 * p.p39);
            let assign5640_e4917: f64 = (assign5640_e4915 * locals.var_rsh_i);
            locals.var_rse_i = assign5640_e4917;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5650_e4924: f64 = (p.p29 * p.p40);
            let assign5650_e4926: f64 = (assign5650_e4924 * locals.var_rshd_i);
            locals.var_rde_i = assign5650_e4926;
        }
        if (locals.var_guard83 == 0.0) {
            let assign5660_e4933: f64 = (p.p29 * p.p502);
            locals.var_rwell_i = assign5660_e4933;
        }
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        let assign8260_e7537: f64 = if locals.var_rg_i > 0.0 { 1.0 } else { 0.0 };
        locals.var_guard151 = assign8260_e7537;
        if (locals.var_guard151 != 0.0) {
            let assign8270_e7541: f64 = (1.0 / locals.var_rg_i);
            locals.var_ggate = assign8270_e7541;
        }
        if (locals.var_guard151 == 0.0) {
            locals.var_ggate = 0.0;
        }
        let assign8290_e7551: f64 = if locals.var_rse_i > 0.0 { 1.0 } else { 0.0 };
        locals.var_guard152 = assign8290_e7551;
        if (locals.var_guard152 != 0.0) {
            let assign8300_e7555: f64 = (1.0 / locals.var_rse_i);
            locals.var_gsource = assign8300_e7555;
        }
        if (locals.var_guard152 == 0.0) {
            locals.var_gsource = 0.0;
        }
        let assign8320_e7565: f64 = if locals.var_rde_i > 0.0 { 1.0 } else { 0.0 };
        locals.var_guard153 = assign8320_e7565;
        if (locals.var_guard153 != 0.0) {
            let assign8330_e7569: f64 = (1.0 / locals.var_rde_i);
            locals.var_gdrain = assign8330_e7569;
        }
        if (locals.var_guard153 == 0.0) {
            locals.var_gdrain = 0.0;
        }
        let assign8350_e7579: f64 = if locals.var_rwell_i > 0.0 { 1.0 } else { 0.0 };
        locals.var_guard154 = assign8350_e7579;
        if (locals.var_guard154 != 0.0) {
            let assign8360_e7583: f64 = (1.0 / locals.var_rwell_i);
            locals.var_gwell = assign8360_e7583;
        }
        if (locals.var_guard154 == 0.0) {
