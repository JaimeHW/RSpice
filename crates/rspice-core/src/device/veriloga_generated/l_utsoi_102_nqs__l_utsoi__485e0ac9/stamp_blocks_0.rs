...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if (!s.b[611]) {s.store_primal_max_with_scalar_ad(314, A::add(s.ad_value(532), s.ad_value(574)), 1e-9);s.store_primal_max_with_scalar_ad(315, A::sub_from_scalar(p[38], A::scale(s.ad_value(574), 0.5)), 1e-9);s.store_scalar(533, p[201]);s.store_scalar(14, p[202]);s.store_scalar(15, p[203]);s.store_scalar(534, p[204]);}
        let (t2,) = {
    if (!s.b[611]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if ((!s.b[611]) && s.b[626]) {s.store_add_scaled_product_mixed_iai(186, 128, 1.0, A::div_scaled_product(s.ad_value(129), s.ad_value(534), 1.0, s.ad_value(533), 1.0), 0, 1.0);s.store_scalar(132, p[228]);}
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if ((!s.b[611]) && s.b[626]) {s.store_mul_scale_offset(0, A::pow(s.ad_value(584), s.ad_value(138)), A::mul(s.ad_value(139), s.ad_value(580)), 1.0, 1.0);s.store_mul(547, 137, 0);s.store_max_with_scalar(189, 547, 0.0);s.store_div_scaled_product_indices(190, 189, 534, p[238], 533, 1.0);s.store_scalar(142, p[293]);}
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if ((!s.b[611]) && s.b[657]) {s.store_div_scaled_product_mixed_iaa(2, 4, A::sub(s.ad_value(5), A::scale_offset(A::powi(s.ad_value(4), (p[29] as i32)), (-1.0 / (p[29])), 1.0 / (p[29]))), (2.0 * p[450]), A::square(s.ad_value(5)), 1.0);}
    ...
    if (!s.b[611]) {
        ...
        let (t10,) = {
    if (!s.b[611]) {
        let t9: f64 = (p[452] * s.v[548]);let ta: f64 = (t9 * s.v[548]);let tb: f64 = (ta * s.v[580]);let tc: f64 = (tb * s.v[580]);let td: f64 = (p[453] - 2.0);let te: f64 = (s.v[579]).powf(td);let tf: f64 = (tc * te);
        (tf,)
    } else {
        (s.v[172],)
    }
        ...
        if (!s.b[611]) {s.store_primal_add_scaled_inputs(568, 581, p[454], 580, p[455]);s.store_primal_max_with_scalar(173, 568, 0.0);s.store_primal_scale(174, 581, p[456]);s.store_primal_scale(175, 581, p[457]);s.store_scalar(176, p[458]);s.store_scalar(177, p[459]);s.store_offset_scaled(0, 579, p[490], p[489]);s.store_max_with_scalar(179, 0, 0.0);s.store_offset_scaled(0, 579, p[492], p[491]);s.store_max_with_scalar(180, 0, 0.0);s.store_scalar(181, p[493]);s.store_scalar(182, p[494]);s.store_primal_offset_add_ad(310, A::div_scaled_inputs2(s.ad_value(314), ((0.3333333333333 * 1.0 / (p[37])) * p[498]), s.ad_value(315), p[498], s.ad_value(313), p[37]), A::div_from_scalar((p[496] + p[497]), A::mul(s.ad_value(314), s.ad_value(312))), (p[29] * p[495]));s.store_primal_max_with_scalar(311, 310, 0.0);s.store_scalar(319, (p[500]).max(0.0));s.store_scalar(323, (p[501]).max(0.0));}
        ...
        let mut t13: usize = 0;
        while {
            let t11: f64 = (p[29] - 0.5);let t12: f64 = if ((((!s.b[611]) && s.b[661]) && s.b[662]) && (s.v[594] < t11)) { 1.0 } else { 0.0 };
            t12 != 0.0
        } {
            t13 += 1;
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        let mut t16: usize = 0;
        while {
            let t14: f64 = (p[29] - 0.5);let t15: f64 = if ((((!s.b[611]) && s.b[661]) && (!s.b[662])) && (s.v[594] < t14)) { 1.0 } else { 0.0 };
            t15 != 0.0
        } {
            t16 += 1;
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        s.copy_ad(235, 234);s.store_primal_div_from_scalar_offset_ad(238, 1.0, A::sqrt_scaled_input(s.ad_value(15), 10.0), 1.0);s.store_sub_scaled_inputs(237, 15, 0.05, 232, 0.5);s.store_scaled_mul(0, 536, 14, ((1.602176565e-19 * 0.5) * 28959234086.17689));s.b[668] = (s.v[535] > 0.0);s.store_scalar(668, if s.b[668] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        s.b[786] = (p[10] == 1.0);s.store_scalar(786, if s.b[786] { 1.0 } else { 0.0 });
