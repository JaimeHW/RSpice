...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if (!s.b[611]) {
            s.store_max_with_scalar_ad(585, A::add(A::offset(A::div_scaled_product_offset_rhs(A::scale_offset(s.ad_value(580), p.p246, 1.0), s.ad_value(3), (-1.0), p.p245, s.ad_value(2), 1.0), 1.0), A::div(A::scaled_offset(s.ad_value(5), (-1.0), p.p249), s.ad_value(4))), 1e-6);
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if ((!s.b[611]) && s.b[626]) {
            s.store_ad_value(0, A::div_scaled_product_offset_denominator(s.ad_value(122), A::pow(s.ad_value(579), s.ad_value(123)), 1.0, A::mul(s.ad_value(126), A::pow(s.ad_value(579), s.ad_value(127))), 1.0, 1.0));
        ...
        if ((!s.b[611]) && s.b[626]) {
            s.store_ad_value(0, A::mul_offset_rhs(A::pow(s.ad_value(584), s.ad_value(138)), A::mul(s.ad_value(139), s.ad_value(580)), 1.0));
        ...
        if ((!s.b[611]) && s.b[626]) {
            s.store_ad_value(553, A::mul_offset_rhs(A::mul3(s.ad_value(587), A::add_scaled_product(s.ad_value(142), 1.0, s.ad_value(143), A::pow(s.ad_value(579), s.ad_value(144)), 1.0), A::offset(A::mul(s.ad_value(145), s.ad_value(580)), 1.0)), A::mul(s.ad_value(146), s.ad_value(581)), 1.0));
        ...
        if ((!s.b[611]) && s.b[626]) {
            s.store_div_ad_rhs(555, 148, A::offset(A::div_scaled_product_offset_denominator(s.ad_value(149), A::pow(s.ad_value(579), s.ad_value(150)), 1.0, A::mul(s.ad_value(151), A::pow(s.ad_value(579), s.ad_value(152))), 1.0, 1.0), 1.0));
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if (((!s.b[611]) && s.b[661]) && s.b[662]) {
            ...
            s.store_ad_value(548, A::div_scaled_product_offset_denominator(s.ad_value(548), A::offset(s.ad_value(604), 1.0), 1.0, s.ad_value(605), 1.0, 1.0));
            s.store_max_with_scalar(191, 548, 1e-10);
            s.store_scale(192, 191, p.p254);
            s.store_ad_value(0, A::div_scaled_product_by_product(A::offset(s.ad_value(604), 1.0), A::scale_offset(s.ad_value(605), p.p466, 1.0), 1.0, A::offset(s.ad_value(605), 1.0), A::scale_offset(s.ad_value(604), p.p466, 1.0), 1.0));
        ...
        while {
            ...
            if ((((!s.b[611]) && s.b[661]) && (!s.b[662])) && (!s.b[664])) {
                ...
                s.store_div_from_scalar_offset_ad(3, 1.80485e-35, A::mul_offset_lhs(A::neg(A::scale(A::scale_offset(A::sub_from_scalar((p.p29 - 1.0), s.ad_value(594)), (p.p28 + p.p20), (p.p27 + (0.5 * p.p20))), (-1.0 / (p.p481)))), (-80.0), A::offset(assign6120_body5_ad_e5851, 1.0)), 1.0);
            }
            if (((!s.b[611]) && s.b[661]) && (!s.b[662])) {
        ...
        if (((!s.b[611]) && s.b[661]) && (!s.b[662])) {
            ...
            s.store_max_with_scalar(191, 548, 1e-10);
            s.store_scale(192, 191, p.p254);
            s.store_ad_value(0, A::div_scaled_product_by_product(A::offset(s.ad_value(604), 1.0), A::scale_offset(s.ad_value(605), p.p488, 1.0), 1.0, A::offset(s.ad_value(605), 1.0), A::scale_offset(s.ad_value(604), p.p488, 1.0), 1.0));
            s.store_mul(552, 552, 0);
            s.store_max_with_scalar(199, 552, 0.0);
            s.store_mul(553, 553, 0);
            s.store_max_with_scalar(200, 553, 0.0);
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if (s.b[1059] && s.b[1060]) {
            s.store_ad_value(883, A::div_scaled_product_offset_denominator(s.ad_value(882), A::offset(s.ad_value(881), 1.0), 2.0, s.ad_value(881), (-1.0), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if ((s.b[1059] && (!s.b[1063])) && s.b[1064]) {
            s.store_div_from_scalar_offset_ad(846, 1.80485e-35, A::mul_offset_lhs(A::neg(A::neg(s.ad_value(266))), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(A::neg(s.ad_value(266))), (-80.0)), 0.5, A::scale_offset(A::neg(A::neg(s.ad_value(266))), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }

        if ((s.b[1059] && (!s.b[1063])) && (!s.b[1064])) {
            s.store_scaled_offset_ad(846, A::mul_offset_lhs(A::neg(s.ad_value(266)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(266)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(266)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1059] && (!s.b[1065])) && s.b[1066]) && (!s.b[1067])) {
            s.store_scaled_offset_ad(855, A::mul_offset_lhs(s.ad_value(854), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(854), (-80.0)), 0.5, A::scale_offset(s.ad_value(854), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1059] && (!s.b[1065])) && (!s.b[1066])) && (!s.b[1068])) {
            s.store_div_from_scalar_offset_ad(842, 1.80485e-35, A::mul_offset_lhs(A::neg(A::neg(s.ad_value(864))), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(A::neg(s.ad_value(864))), (-80.0)), 0.5, A::scale_offset(A::neg(A::neg(s.ad_value(864))), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
        ...
        if ((((s.b[1059] && (!s.b[1065])) && (!s.b[1066])) && (!s.b[1069])) && (!s.b[1070])) {
            s.store_div_from_scalar_offset_ad(855, 1.80485e-35, A::mul_offset_lhs(A::sub(s.ad_value(266), s.ad_value(868)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::sub(s.ad_value(266), s.ad_value(868)), (-80.0)), 0.5, A::scale_offset(A::sub(s.ad_value(266), s.ad_value(868)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(856, 1.80485e-35, A::mul_offset_lhs(s.ad_value(868), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(868), (-80.0)), 0.5, A::scale_offset(s.ad_value(868), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
        ...
        s.store_ad_value(0, A::mul_offset_rhs(A::mul3_scaled_output(s.ad_value(329), A::offset(A::sqrt(A::offset(A::div(s.ad_value(340), s.ad_value(329)), 1.0)), (-1.0)), A::offset(A::mul(s.ad_value(36), s.ad_value(901)), 1.0), 2.0), A::mul(s.ad_value(37), s.ad_value(879)), 1.0));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if (!s.b[1080]) {
            s.store_scaled_offset_ad(793, A::mul_offset_lhs(A::sub(s.ad_value(909), s.ad_value(916)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::sub(s.ad_value(909), s.ad_value(916)), (-80.0)), 0.5, A::scale_offset(A::sub(s.ad_value(909), s.ad_value(916)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }
        ...
        if s.b[1081] {
            ...
            s.store_ad_value(811, A::add_scaled_product(A::div_scaled_product(s.ad_value(809), s.ad_value(806), 1.0, s.ad_value(805), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(805), 1.0, s.ad_value(809), s.ad_value(808), 1.0, (-2.0)), s.ad_value(793), 1.0));
        ...
        if ((!s.b[1081]) && s.b[1082]) {
            ...
            s.store_ad_value(808, A::div_scaled_product_offset_rhs(s.ad_value(807), s.ad_value(810), 1.0, 1.0, A::sub_from_scalar(1.0, s.ad_value(810)), 1.0));
            s.store_scaled_div(793, 805, 804, 0.25);
            s.store_mul_add_ad_lhs(809, s.ad_value(804), A::mul_sub_from_scalar_rhs(s.ad_value(808), 2.0, s.ad_value(808)), 793);
            s.store_ad_value(811, A::add_scaled_product(A::div_scaled_product(s.ad_value(809), s.ad_value(806), 1.0, s.ad_value(805), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(805), 1.0, s.ad_value(809), s.ad_value(808), 1.0, (-2.0)), s.ad_value(793), 1.0));
            s.store_sub_from_scalar_ad(794, 1.0, A::scale(s.ad_value(808), 0.5));
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if (!s.b[1127]) {
            s.store_scaled_offset_ad(793, A::mul_offset_lhs(A::sub(s.ad_value(910), s.ad_value(920)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::sub(s.ad_value(910), s.ad_value(920)), (-80.0)), 0.5, A::scale_offset(A::sub(s.ad_value(910), s.ad_value(920)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if (s.b[1128] && s.b[1129]) {
            s.store_ad_value(2, A::add_scaled_offset_product_lhs(A::add_scaled_products(s.ad_value(926), s.ad_value(927), 1.0, A::offset(s.ad_value(916), 2.0), s.ad_value(927), 2.0), 1.0, s.ad_value(920), 2.0, s.ad_value(926), 2.0));
            s.store_ad_value(929, A::div_scaled_product_by_product(s.ad_value(921), s.ad_value(928), (-4.0), s.ad_value(917), s.ad_value(2), 1.0));
        }
        ...
        if (s.b[1128] && (!s.b[1129])) {
            ...
            s.store_ad_value(3, A::add_scaled_offset_product_rhs(A::add_scaled_products(s.ad_value(926), s.ad_value(922), 1.0, s.ad_value(927), s.ad_value(923), 1.0), 1.0, A::mul3(s.ad_value(926), s.ad_value(927), s.ad_value(917)), A::mul(s.ad_value(917), s.ad_value(2)), 1.0, 1.0));
            s.store_ad_value(929, A::div_scaled_product3_by_product(s.ad_value(922), s.ad_value(923), s.ad_value(928), 1.0, s.ad_value(917), s.ad_value(3), 1.0));
        }
        ...
        if s.b[1136] {
            s.store_sub_ad(959, A::div_scaled_product_by_product(s.ad_value(929), s.ad_value(928), 1.0, s.ad_value(926), s.ad_value(927), 1.0), A::div(A::add(A::div(s.ad_value(922), s.ad_value(926)), A::div(s.ad_value(923), s.ad_value(927))), s.ad_value(917)));
            s.store_ad_value(960, A::div_scaled_product_offset_denominator(s.ad_value(959), s.ad_value(917), 1.0, s.ad_value(959), 1.0, 1.0));
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        if ((((!s.b[1184]) && (!s.b[1187])) && s.b[1191]) && (!s.b[1192])) {
            let assign20980_ad_e21303: A = A::mul_offset_lhs(A::sub(A::add_scaled_inputs3(s.ad_value(980), 1.0, s.ad_value(979), 1.0, s.ad_value(909), -1.0), s.ad_value(807)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::sub(A::add_scaled_inputs3(s.ad_value(980), 1.0, s.ad_value(979), 1.0, s.ad_value(909), -1.0), s.ad_value(807)), (-80.0)), 0.5, A::scale_offset(A::sub(A::add_scaled_inputs3(s.ad_value(980), 1.0, s.ad_value(979), 1.0, s.ad_value(909), -1.0), s.ad_value(807)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0));
        ...
        if (s.b[1195] && s.b[1196]) {
            s.store_ad_value(2, A::add_scaled_offset_product_lhs(A::add_scaled_products(s.ad_value(990), s.ad_value(991), 1.0, A::offset(s.ad_value(980), 2.0), s.ad_value(991), 2.0), 1.0, s.ad_value(981), 2.0, s.ad_value(990), 2.0));
            s.store_ad_value(993, A::div_scaled_product_by_product(s.ad_value(985), s.ad_value(992), (-4.0), s.ad_value(982), s.ad_value(2), 1.0));
        }
        ...
        if (s.b[1195] && (!s.b[1196])) {
            ...
            s.store_ad_value(3, A::add_scaled_offset_product_rhs(A::add_scaled_products(s.ad_value(990), s.ad_value(986), 1.0, s.ad_value(991), s.ad_value(987), 1.0), 1.0, A::mul3(s.ad_value(990), s.ad_value(991), s.ad_value(982)), A::mul(s.ad_value(982), s.ad_value(2)), 1.0, 1.0));
            s.store_ad_value(993, A::div_scaled_product3_by_product(s.ad_value(986), s.ad_value(987), s.ad_value(992), 1.0, s.ad_value(982), s.ad_value(3), 1.0));
        }
        ...
        if s.b[1197] {
            ...
            s.store_scaled_add_ad(997, A::offset(s.ad_value(997), 1e-5), A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(997), (-1e-5), A::offset(s.ad_value(997), (-1e-5))), 1.0)), 0.5);
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if ((s.b[1206] && s.b[1207]) && s.b[1208]) {
            s.store_div_ad(0, A::add_scaled_inputs(A::offset(s.ad_value(980), 2.0), 1.0, s.ad_value(990), 0.5), A::mul_offset_lhs(s.ad_value(981), 2.0, s.ad_value(990)));
            s.store_mul(2, 0, 991);
            s.store_square(3, 2);
            ...
            s.store_ad_value(1036, A::div_scaled_product_offset_denominator(s.ad_value(1035), s.ad_value(982), 1.0, s.ad_value(1035), 1.0, 1.0));
        }

        if ((s.b[1206] && s.b[1207]) && (!s.b[1208])) {
            s.store_sub_ad(1035, A::div_scaled_product_by_product(s.ad_value(993), s.ad_value(992), 1.0, s.ad_value(990), s.ad_value(991), 1.0), A::div(A::add(A::div(s.ad_value(986), s.ad_value(990)), A::div(s.ad_value(987), s.ad_value(991))), s.ad_value(982)));
            s.store_ad_value(1036, A::div_scaled_product_offset_denominator(s.ad_value(1035), s.ad_value(982), 1.0, s.ad_value(1035), 1.0, 1.0));
        }
