...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if (!s.b[611]) {
            ...
            s.store_offset_add_ad(310, A::div(A::add_scaled_inputs(s.ad_value(314), ((0.3333333333333 * 1.0 / (p.p37)) * p.p498), s.ad_value(315), p.p498), A::scale(s.ad_value(313), p.p37)), A::div_from_scalar((p.p496 + p.p497), A::mul(s.ad_value(314), s.ad_value(312))), (p.p29 * p.p495));
