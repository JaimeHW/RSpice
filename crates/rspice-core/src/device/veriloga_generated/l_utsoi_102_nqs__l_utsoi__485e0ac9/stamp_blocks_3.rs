...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_16(
        ...
        if ((s.b[1222] && (!s.b[1223])) && (!s.b[1224])) {
            ...
            s.store_add_scaled_inputs_product(700, s.ad_value(706), 1.0, s.ad_value(709), 0.5, s.ad_value(708), A::sqrt(A::add_scaled_inputs3(s.ad_value(706), 1.0, s.ad_value(709), 0.25, s.ad_value(697), -1.0)), (-1.0));
        }
        ...
        if ((s.b[1222] && (!s.b[1223])) && (!s.b[1224])) {
            ...
            s.store_add_scaled_products(695, A::sub(s.ad_value(706), s.ad_value(700)), A::sub(s.ad_value(706), s.ad_value(700)), 1.0, s.ad_value(709), A::add(A::offset(s.ad_value(700), (-1.0)), s.ad_value(693)), (-1.0));
            s.store_sub_from_scalar_ad(696, 1.0, A::mul_scaled_lhs(s.ad_value(709), 0.5, s.ad_value(693)));
            s.store_add_scaled_square_product(691, s.ad_value(694), 1.0, s.ad_value(696), s.ad_value(695), (-4.0));
        ...
        if ((s.b[1231] && (!s.b[1232])) && (!s.b[1233])) {
            s.store_sub_from_scalar(697, 1.0, 691);
            s.store_add_scaled_inputs_product(700, s.ad_value(705), 1.0, s.ad_value(709), 0.5, s.ad_value(708), A::sqrt(A::add_scaled_inputs3(s.ad_value(705), 1.0, s.ad_value(709), 0.25, s.ad_value(697), -1.0)), (-1.0));
        }
        ...
        if ((s.b[1231] && (!s.b[1232])) && (!s.b[1233])) {
            ...
            s.store_add_scaled_products(695, A::sub(s.ad_value(705), s.ad_value(700)), A::sub(s.ad_value(705), s.ad_value(700)), 1.0, s.ad_value(709), A::add(A::offset(s.ad_value(700), (-1.0)), s.ad_value(693)), (-1.0));
            s.store_sub_from_scalar_ad(696, 1.0, A::mul_scaled_lhs(s.ad_value(709), 0.5, s.ad_value(693)));
            s.store_add_scaled_square_product(691, s.ad_value(694), 1.0, s.ad_value(696), s.ad_value(695), (-4.0));
            s.store_div_scaled_inputs(701, s.ad_value(695), 2.0, A::add(s.ad_value(694), A::sqrt(s.ad_value(691))), 1.0);
        ...
        if ((s.b[1240] && (!s.b[1241])) && (!s.b[1242])) {
            s.store_sub_from_scalar(697, 1.0, 691);
            s.store_add_scaled_inputs_product(700, s.ad_value(707), 1.0, s.ad_value(709), 0.5, s.ad_value(708), A::sqrt(A::add_scaled_inputs3(s.ad_value(707), 1.0, s.ad_value(709), 0.25, s.ad_value(697), -1.0)), (-1.0));
        }
        ...
        if ((s.b[1240] && (!s.b[1241])) && (!s.b[1242])) {
            ...
            s.store_add_scaled_products(695, A::sub(s.ad_value(707), s.ad_value(700)), A::sub(s.ad_value(707), s.ad_value(700)), 1.0, s.ad_value(709), A::add(A::offset(s.ad_value(700), (-1.0)), s.ad_value(693)), (-1.0));
            s.store_sub_from_scalar_ad(696, 1.0, A::mul_scaled_lhs(s.ad_value(709), 0.5, s.ad_value(693)));
            s.store_add_scaled_square_product(691, s.ad_value(694), 1.0, s.ad_value(696), s.ad_value(695), (-4.0));
            s.store_div_scaled_inputs(701, s.ad_value(695), 2.0, A::add(s.ad_value(694), A::sqrt(s.ad_value(691))), 1.0);
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        if (s.b[1249] && s.b[1250]) {
            ...
            s.store_add_scaled_products(723, s.ad_value(83), s.ad_value(2), 1.0, s.ad_value(80), s.ad_value(3), 1.0);
            s.store_add_scaled_products(724, s.ad_value(84), s.ad_value(2), 1.0, s.ad_value(82), s.ad_value(3), 1.0);
            s.store_add_scaled_products(725, s.ad_value(282), s.ad_value(2), 1.0, s.ad_value(281), s.ad_value(3), 1.0);
        ...
        if (s.b[1249] && s.b[1250]) {
            s.store_add_scaled_product(728, A::offset(s.ad_value(714), 3.0), 1.0, s.ad_value(721), s.ad_value(224), 1.0);
        }
        ...
        if (s.b[1249] && s.b[1250]) {
            ...
            s.store_ad_value(0, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, 1.0, A::offset(s.ad_value(730), 1.0), 1.0));
        }
        ...
        if (s.b[1249] && s.b[1250]) {
            s.store_add_scaled_product(4, s.ad_value(2), 1.0, s.ad_value(85), s.ad_value(703), 1.0);
        }
        ...
        if (s.b[1249] && s.b[1267]) {
            s.store_add_scaled_product(728, A::offset(s.ad_value(715), 3.0), 1.0, s.ad_value(721), s.ad_value(224), 1.0);
        }
        ...
        if (s.b[1249] && s.b[1267]) {
            s.store_add_scaled_product(4, s.ad_value(2), 1.0, s.ad_value(85), s.ad_value(702), 1.0);
        }
        ...
        if (((s.b[1249] && s.b[1284]) && (!s.b[1285])) && s.b[1286]) {
            let assign26710_ad_e28192: A = A::div_scalar_offset_denominator(1.80485e-35, A::mul_offset_lhs(A::neg(A::sub_scaled_inputs(s.ad_value(735), 2.0, s.ad_value(411), 1.0)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(A::sub_scaled_inputs(s.ad_value(735), 2.0, s.ad_value(411), 1.0)), (-80.0)), 0.5, A::scale_offset(A::neg(A::sub_scaled_inputs(s.ad_value(735), 2.0, s.ad_value(411), 1.0)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 1.0);
        ...
        if ((s.b[1249] && s.b[1284]) && (!s.b[1295])) {
            s.store_add_scaled_product(0, s.ad_value(78), 1.0, s.ad_value(79), s.ad_value(722), 2.0);
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1310] {
            ...
            s.store_add_scaled_product(768, s.ad_value(760), 1.0, A::add(s.ad_value(761), s.ad_value(766)), s.ad_value(763), 1.0);
            s.store_add_scaled_product(769, s.ad_value(760), 1.0, A::add(s.ad_value(762), s.ad_value(767)), s.ad_value(764), 1.0);
        }
        ...
        if (s.b[1310] && s.b[1311]) {
            ...
            s.store_div_scaled_product(4, A::sub(s.ad_value(2), s.ad_value(3)), s.ad_value(777), 0.5, s.ad_value(776), 1.0);
        }
        ...
        if (s.b[1310] && (!s.b[1311])) {
            ...
            s.store_div_scaled_product(4, s.ad_value(777), A::sub(s.ad_value(2), s.ad_value(3)), 1.0, s.ad_value(778), 2.0);
        }
        ...
        if s.b[1318] {
            s.store_ad_value(757, A::div_scaled_add_product(s.ad_value(339), 1.0, s.ad_value(115), s.ad_value(411), (-1.0), s.ad_value(227), 1.0));
        }
        ...
        if (s.b[1318] && s.b[1319]) {
            s.store_ad_value(3, A::div_scaled_value_offset_denominator(s.ad_value(113), (-1.0), s.ad_value(757), 1e-30, 1.0));
        }
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_product(1428, s.ad_value(341), (-1.0), A::sub_scaled_inputs(s.ad_value(337), -1.0, s.ad_value(1419), 1.0), s.ad_value(227), 1.0);
        ...
        if (s.b[1608] && s.b[1609]) {
            ...
            s.store_ad_value(1430, A::div_scaled_offset_numerator(s.ad_value(246), 1.0, 1.0, A::offset(s.ad_value(247), 1.0), 1.0));
        ...
        if (s.b[1608] && s.b[1609]) {
            ...
            s.store_add_scaled_product(1436, s.ad_value(1427), 1.0, s.ad_value(1463), s.ad_value(1434), (-1.0));
            s.store_add_scaled_product(1437, s.ad_value(1429), 1.0, s.ad_value(1463), s.ad_value(1435), 1.0);
    ...
    pub(super) fn stamp_reactive_block_19(
        ...
        if (((s.b[1608] && s.b[1609]) && (!s.b[1615])) && s.b[1616]) {
            ...
            s.store_add_scaled_square_product(1399, s.ad_value(1391), 1.0, s.ad_value(261), A::offset(s.ad_value(1398), 1.0), 1.0);
            ...
            s.store_add_scaled_square_product(1390, s.ad_value(1389), 1.0, s.ad_value(1402), A::add_scaled_product(s.ad_value(1399), (-1.0), s.ad_value(1401), s.ad_value(1401), 0.5), 1.0);
        ...
        if (((s.b[1608] && s.b[1609]) && (!s.b[1615])) && s.b[1616]) {
            ...
            s.store_add_scaled_product(1409, s.ad_value(1391), 2.0, s.ad_value(261), A::add_scaled_inputs3_offset(s.ad_value(1404), 1.0, s.ad_value(1392), (-1.0), A::mul_sub_from_scalar_rhs(s.ad_value(1395), 1.0, s.ad_value(1407)), 1.0, (-1.0)), 1.0);
            s.store_add_scaled_square_product(1410, s.ad_value(1391), 1.0, s.ad_value(261), A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(1404), 1.0, s.ad_value(1403), (-1.0), s.ad_value(1392), 1.0, (-1.0)), 1.0, s.ad_value(1395), A::sub(A::offset(s.ad_value(1403), (-1.0)), s.ad_value(1406)), 1.0), (-1.0));
            ...
            s.store_add_scaled_square_product(1391, s.ad_value(1409), 1.0, s.ad_value(1410), s.ad_value(1391), (-2.0));
        ...
        if (((s.b[1608] && s.b[1609]) && (!s.b[1615])) && (!s.b[1616])) {
            ...
            s.store_add_scaled_inputs_product(1415, s.ad_value(1394), 1.0, s.ad_value(261), 0.5, s.ad_value(260), A::sqrt(A::add_scaled_inputs3(s.ad_value(1394), 1.0, s.ad_value(261), 0.25, s.ad_value(1414), -1.0)), (-1.0));
            ...
            s.store_add_scaled_product(1401, s.ad_value(1391), 2.0, s.ad_value(261), A::add_scaled_sub_value_product(1.0, s.ad_value(1392), 1.0, s.ad_value(1395), A::offset(s.ad_value(1407), 1.0), (-1.0)), 1.0);
            s.store_add_scaled_inputs3(1402, s.ad_value(266), 1.0, s.ad_value(1398), (-1.0), A::ln(A::div(s.ad_value(1399), s.ad_value(261))), 1.0);
            s.store_add(1389, 1399, 1401);
            s.store_add_scaled_square_product(1390, s.ad_value(1389), 1.0, s.ad_value(1402), A::add_scaled_products(s.ad_value(1401), s.ad_value(1401), 0.5, s.ad_value(1399), s.ad_value(1400), (-1.0)), 1.0);
        ...
        if (((s.b[1608] && s.b[1609]) && (!s.b[1615])) && (!s.b[1616])) {
            ...
            s.store_add_scaled_product(1409, s.ad_value(1391), 2.0, s.ad_value(261), A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(1405)), 1.0, s.ad_value(1404), 1.0, s.ad_value(1395), A::offset(s.ad_value(1407), 1.0), (-1.0)), 1.0);
            s.store_add_scaled_square_product(1410, s.ad_value(1391), 1.0, s.ad_value(261), A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(1405), 1.0, s.ad_value(1417), 1.0, s.ad_value(1404), 1.0, (-1.0)), 1.0, s.ad_value(1395), A::add(A::offset(s.ad_value(1417), 1.0), s.ad_value(1406)), (-1.0)), (-1.0));
        ...
        if (s.b[1608] && s.b[1621]) {
            ...
            s.store_div_scaled_product(1443, s.ad_value(246), s.ad_value(4), 1.0, s.ad_value(1441), 1.0);
            s.store_div_scaled_product(1444, s.ad_value(247), s.ad_value(4), 1.0, s.ad_value(1442), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_product(1451, s.ad_value(1449), 1.0, s.ad_value(255), s.ad_value(1450), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_ad_value(1430, A::div_scaled_offset_numerator(s.ad_value(1460), 1.0, 1.0, A::offset(s.ad_value(1461), 1.0), 1.0));
            s.store_ln(1431, 1430);
        }
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        if s.b[1608] {
            s.store_add_scaled_product(1436, s.ad_value(1458), 1.0, s.ad_value(1463), s.ad_value(1434), (-1.0));
            s.store_add_scaled_product(1437, s.ad_value(1459), 1.0, s.ad_value(1463), s.ad_value(1435), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_product(1354, s.ad_value(1352), 1.0, s.ad_value(1460), s.ad_value(1351), 2.0);
            s.store_add_scaled_product(1355, s.ad_value(1352), (-1.0), s.ad_value(1460), s.ad_value(1460), 2.0);
        }
        ...
        if (s.b[1608] && s.b[1631]) {
            ...
            s.store_add_scaled_product(1360, A::div_scaled_product(s.ad_value(1358), s.ad_value(1355), 1.0, s.ad_value(1354), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(1354), 1.0, s.ad_value(1358), s.ad_value(1357), 1.0, (-2.0)), s.ad_value(1342), 1.0);
        ...
        if ((s.b[1608] && (!s.b[1631])) && (!s.b[1632])) {
            ...
            s.store_add_scaled_products(1360, s.ad_value(1355), s.ad_value(1342), 1.0, A::square(s.ad_value(1354)), s.ad_value(1343), (-1.0));
            s.store_scaled_mul(1363, 1354, 1344, (-0.5));
            s.store_add_scaled_product(1364, A::mul3_scaled_output(s.ad_value(1354), s.ad_value(1354), A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1353), 2.0, A::scale(s.ad_value(1353), 0.075), 0.0238095238095)), (0.25 * 0.0055555555556)), 1.0, s.ad_value(1355), s.ad_value(1344), (-0.5));
        }
        ...
        if (s.b[1608] && s.b[1636]) {
            ...
            s.store_add_scaled_square_product(1370, s.ad_value(1369), (-1.0), s.ad_value(1367), s.ad_value(1342), 1.0);
        }
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_product(1374, s.ad_value(1351), 1.0, s.ad_value(1461), s.ad_value(1371), 1.0);
            s.store_add_scaled_product(1375, s.ad_value(1460), 1.0, s.ad_value(1461), s.ad_value(1372), 1.0);
            s.store_mul(1376, 1461, 1373);
            s.store_add_scaled_product(1377, s.ad_value(1352), (-1.0), s.ad_value(1374), s.ad_value(1365), 1.0);
            ...
            s.store_add_scaled_square_product(1388, s.ad_value(1378), 1.0, s.ad_value(1377), s.ad_value(1379), (-0.5));
            ...
            s.store_add_scaled_product(1383, A::scale_offset(s.ad_value(1374), 8.5797362674, 39.478417604), 1.0, s.ad_value(1351), s.ad_value(1381), 1.0);
            s.store_add_scaled_product(1384, s.ad_value(1374), (2.0 * 39.478417604), s.ad_value(1351), s.ad_value(1381), 39.478417604);
        ...
        if (s.b[1608] && s.b[1637]) {
            ...
            s.store_add_scaled_product(1378, s.ad_value(1386), 1.0, s.ad_value(1460), s.ad_value(1351), 2.0);
    ...
    pub(super) fn stamp_reactive_block_23(
        ...
        if (((s.b[1608] && (!s.b[1667])) && (!s.b[1670])) && s.b[1674]) {
            ...
            s.store_div_scaled_product(1342, s.ad_value(1470), s.ad_value(1343), 4.0, A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs(s.ad_value(1359), 2.0, s.ad_value(1359))), 1.0);
        }
        ...
        if ((((s.b[1608] && (!s.b[1667])) && (!s.b[1670])) && (!s.b[1674])) && s.b[1676]) {
            s.store_sin_scaled_input(1343, 1356, 0.5);
            s.store_ad_value(1342, A::div_scaled_value_by_product(s.ad_value(1470), -1.0, A::square(s.ad_value(1343)), s.ad_value(1471), 1.0));
        }
        ...
        if ((s.b[1608] && s.b[1678]) && s.b[1679]) {
            ...
            s.store_ad_value(1478, A::div_scaled_product_by_product(s.ad_value(1470), s.ad_value(1477), (-4.0), s.ad_value(1466), s.ad_value(2), 1.0));
        }
        ...
        if ((s.b[1608] && s.b[1678]) && (!s.b[1679])) {
            ...
            s.store_ad_value(1478, A::div_scaled_product3_by_product(s.ad_value(1471), s.ad_value(1472), s.ad_value(1477), 1.0, s.ad_value(1466), s.ad_value(3), 1.0));
        }
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_products(1484, s.ad_value(270), s.ad_value(1480), 1.0, s.ad_value(271), s.ad_value(1482), 1.0);
            s.store_add_scaled_products(1485, s.ad_value(270), s.ad_value(1481), 1.0, s.ad_value(271), s.ad_value(1483), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_inputs_product(1494, A::offset(A::exp(A::mul(s.ad_value(47), A::ln(A::offset(A::mul(s.ad_value(267), s.ad_value(1484)), 1e-6)))), 1.0), 1.0, s.ad_value(1491), 1.0, s.ad_value(38), s.ad_value(1493), 1.0);
            s.store_add_scaled_inputs_product(1495, A::offset(A::exp(A::mul(s.ad_value(47), A::ln(A::offset(A::mul(s.ad_value(267), s.ad_value(1485)), 1e-6)))), 1.0), 1.0, s.ad_value(1491), 1.0, s.ad_value(39), s.ad_value(1493), 1.0);
            s.store_div_scaled_product(1496, s.ad_value(1490), A::add(s.ad_value(1488), s.ad_value(1489)), 1.0, A::add(A::div(s.ad_value(1488), s.ad_value(1494)), A::div(s.ad_value(1489), s.ad_value(1495))), 1.0);
        }
        ...
        if ((s.b[1608] && s.b[1684]) && (!s.b[1685])) {
            s.store_exp(0, 1463);
            s.store_ad_value(1498, A::div_scaled_value_offset_denominator(s.ad_value(1463), 1.0, s.ad_value(0), (-1.0), 1.0));
        ...
        if (s.b[1608] && (!s.b[1684])) {
            let assign35250_ad_e39593: A = A::div_from_scalar((-12.0), A::add_scaled_inputs4_offset(s.ad_value(1462), ((-1.0) * 3.0), A::div_scaled_inputs(s.ad_value(1462), 12.0, A::mul(s.ad_value(1460), s.ad_value(1461)), 1.0), 1.0, A::mul3(s.ad_value(1462), A::sub(s.ad_value(1434), s.ad_value(1435)), s.ad_value(1463)), 1.0, A::mul_sub_from_scalar_lhs_scaled_output(0.2, A::scale(s.ad_value(1462), 0.25), s.ad_value(1464), 0.3333333333333), 1.0, 4.0));
        ...
        if (s.b[1608] && s.b[1686]) {
            s.store_ad_value(1504, A::div_scaled_value_offset_denominator(s.ad_value(1480), 100.0, s.ad_value(1480), 100.0, 1.0));
        }
        ...
        if (s.b[1608] && s.b[1686]) {
            s.store_ad_value(1506, A::div_scaled_value_offset_denominator(s.ad_value(1481), 100.0, s.ad_value(1481), 100.0, 1.0));
        }
        ...
        if (s.b[1608] && s.b[1686]) {
            ...
            s.store_ad_value(1510, A::div_scaled_add_product(s.ad_value(1466), 1.0, s.ad_value(1502), s.ad_value(1499), 1.0, s.ad_value(2), 1.0));
    ...
    pub(super) fn stamp_reactive_block_24(
        ...
        if (s.b[1608] && s.b[1686]) {
            ...
            s.store_add_scaled_product(1524, s.ad_value(1466), 1.0, s.ad_value(1509), s.ad_value(1523), 1.0);
        ...
        if (s.b[1608] && (!s.b[1686])) {
            ...
            s.store_add_scaled_product(1526, s.ad_value(1466), 0.5, s.ad_value(1502), A::sub_scaled_inputs(s.ad_value(1523), 1.0, s.ad_value(1499), 0.5), 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_27(
        ...
        if (((s.b[1608] && (!s.b[1734])) && (!s.b[1737])) && s.b[1741]) {
            s.store_div(1343, 1344, 1433);
            s.store_div_scaled_product(1342, s.ad_value(1534), s.ad_value(1343), 4.0, A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs(s.ad_value(1359), 2.0, s.ad_value(1359))), 1.0);
        }
        ...
        if ((((s.b[1608] && (!s.b[1734])) && (!s.b[1737])) && (!s.b[1741])) && s.b[1743]) {
            s.store_sin_scaled_input(1343, 1356, 0.5);
            s.store_ad_value(1342, A::div_scaled_value_by_product(s.ad_value(1534), -1.0, A::square(s.ad_value(1343)), s.ad_value(1535), 1.0));
        }
        ...
        if ((s.b[1608] && s.b[1745]) && s.b[1746]) {
            ...
            s.store_ad_value(1542, A::div_scaled_product_by_product(s.ad_value(1534), s.ad_value(1541), (-4.0), s.ad_value(1531), s.ad_value(2), 1.0));
        }
        ...
        if ((s.b[1608] && s.b[1745]) && (!s.b[1746])) {
            ...
            s.store_ad_value(1542, A::div_scaled_product3_by_product(s.ad_value(1535), s.ad_value(1536), s.ad_value(1541), 1.0, s.ad_value(1531), s.ad_value(3), 1.0));
        }
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_products(1553, s.ad_value(270), s.ad_value(1549), 1.0, s.ad_value(271), s.ad_value(1551), 1.0);
            s.store_add_scaled_products(1554, s.ad_value(270), s.ad_value(1550), 1.0, s.ad_value(271), s.ad_value(1552), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_add_scaled_inputs_product(1569, A::offset(A::exp(A::mul(s.ad_value(47), A::ln(A::offset(A::mul(s.ad_value(267), s.ad_value(1561)), 1e-6)))), 1.0), 1.0, s.ad_value(1567), 1.0, s.ad_value(38), s.ad_value(1568), 1.0);
            s.store_add_scaled_inputs_product(1570, A::offset(A::exp(A::mul(s.ad_value(47), A::ln(A::offset(A::mul(s.ad_value(267), s.ad_value(1562)), 1e-6)))), 1.0), 1.0, s.ad_value(1567), 1.0, s.ad_value(39), s.ad_value(1568), 1.0);
            s.store_div_scaled_product(1571, s.ad_value(1566), s.ad_value(1565), 1.0, A::add(A::div(s.ad_value(1563), s.ad_value(1569)), A::div(s.ad_value(1564), s.ad_value(1570))), 1.0);
        ...
        if s.b[1608] {
            ...
            s.store_ad_value(1504, A::div_scaled_value_offset_denominator(s.ad_value(1555), 100.0, s.ad_value(1555), 100.0, 1.0));
        }
    ...
    pub(super) fn stamp_reactive_block_28(
        ...
        if s.b[1608] {
            s.store_ad_value(1506, A::div_scaled_value_offset_denominator(s.ad_value(1556), 100.0, s.ad_value(1556), 100.0, 1.0));
        }
        ...
        if s.b[1608] {
            ...
            s.store_ad_value(1581, A::div_scaled_offset_numerator(s.ad_value(1579), 1.5, 1.0, s.ad_value(1580), 1.0));
        }
        ...
        if (s.b[1608] && s.b[1755]) {
            ...
            s.store_ad_value(1582, A::div_scaled_offset_numerator(A::mul(s.ad_value(1460), s.ad_value(2)), 1.0, 1.0, s.ad_value(1441), 1.0));
            s.store_ad_value(1583, A::div_scaled_offset_numerator(A::mul(s.ad_value(1461), s.ad_value(3)), 1.0, 1.0, s.ad_value(1442), 1.0));
        }
        ...
        if ((s.b[1608] && s.b[1756]) && s.b[1759]) {
            ...
            s.store_add_scaled_product(1586, s.ad_value(4), 1.0, s.ad_value(1585), s.ad_value(1545), (-1.0));
            s.store_add_scaled_product(1587, s.ad_value(4), 1.0, s.ad_value(1509), s.ad_value(1545), (-1.0));
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        s.store_div_scaled_product(0, s.ad_value(120), A::sub(s.ad_value(448), s.ad_value(446)), 1.0, A::scale_offset(s.ad_value(464), 0.25, 1.0), 1.0);
        ...
        s.store_add_scaled_product(1328, s.ad_value(3), 1.0, s.ad_value(1326), s.ad_value(465), 0.5);

        s.store_add_scaled_product(1326, s.ad_value(2), 1.0, s.ad_value(1326), s.ad_value(465), 1.0);
        ...
        s.store_add_scaled_product(3, s.ad_value(2), 1.0, A::add_scaled_product(s.ad_value(174), 1.0, s.ad_value(175), A::sub_scaled_inputs(s.ad_value(1784), 1.0, s.ad_value(1783), 2.0), 1.0), s.ad_value(1785), 1.0);
        ...
        s.store_ad_value(1831, A::div_scaled_value_offset_denominator(s.ad_value(1823), 1.0, A::div_scaled_inputs(s.ad_value(17), s.v[7], s.ad_value(8), 1.0), 1.0, 1.0));
        ...
        s.store_ad_value(1815, A::div_scaled_value_by_product(s.ad_value(402), 1.0, s.ad_value(401), A::offset(s.ad_value(402), 1.0), 1.0));

        s.store_ad_value(1816, A::div_scaled_value_by_product(s.ad_value(401), 1.0, s.ad_value(402), A::offset(s.ad_value(401), 1.0), 1.0));
        ...
        s.store_add_scaled_products(1819, A::offset(s.ad_value(1815), 1.0), s.ad_value(1817), 1.0, s.ad_value(399), s.ad_value(1815), (-1.0));
        ...
        s.store_add_scaled_product(1822, s.ad_value(21), 1.0, s.ad_value(226), A::add_scaled_inputs3(A::div_scaled_inputs2(s.ad_value(1821), 1.0, s.ad_value(394), (-1.0), s.ad_value(395), 1.0), 1.0, s.ad_value(397), (-1.0), s.ad_value(394), 1.0), 1.0);
    ...
    pub(super) fn stamp_reactive_block_30(
        ...
        s.store_add_scaled_product(1845, s.ad_value(1844), (-1.0), A::sub(s.ad_value(1822), s.ad_value(1840)), s.ad_value(1831), 1.0);

        s.store_add_scaled_product(1846, s.ad_value(1844), (-1.0), A::sub_scaled_inputs(s.ad_value(337), -1.0, s.ad_value(1841), 1.0), s.ad_value(1831), 1.0);

        s.b[1887] = (p.p2 > 0.0);
        s.v[1887] = if s.b[1887] { 1.0 } else { 0.0 };

        if s.b[1887] {
            s.store_div_scaled_product(0, s.ad_value(16), A::sub(s.ad_value(1845), s.ad_value(1846)), p.p14, s.ad_value(260), 1.0);
        }
        ...
        if s.b[1887] {
            s.store_add_scaled_product(1847, s.ad_value(1846), 1.0, s.ad_value(16), s.ad_value(2), p.p14);
        }
        ...
        if s.b[1894] {
            s.store_ad_value(1815, A::div_scaled_value_by_product(s.ad_value(457), 1.0, s.ad_value(456), A::offset(s.ad_value(457), 1.0), 1.0));
            s.store_ad_value(1816, A::div_scaled_value_by_product(s.ad_value(456), 1.0, s.ad_value(457), A::offset(s.ad_value(456), 1.0), 1.0));
            ...
            s.store_add_scaled_products(1819, A::offset(s.ad_value(1815), 1.0), s.ad_value(1817), 1.0, s.ad_value(455), s.ad_value(1815), (-1.0));
            ...
            s.store_add_scaled_product(1822, s.ad_value(130), 1.0, s.ad_value(226), A::add_scaled_inputs3(A::div_scaled_inputs2(s.ad_value(1821), 1.0, s.ad_value(450), (-1.0), s.ad_value(451), 1.0), 1.0, s.ad_value(453), (-1.0), s.ad_value(450), 1.0), 1.0);
            s.store_mul_offset_rhs(0, 34, 8, (-s.v[7]));
            s.store_ad_value(0, A::add_scaled_offset_product_rhs(s.ad_value(256), 1.0, s.ad_value(23), s.ad_value(8), (-s.v[7]), p.p14));
