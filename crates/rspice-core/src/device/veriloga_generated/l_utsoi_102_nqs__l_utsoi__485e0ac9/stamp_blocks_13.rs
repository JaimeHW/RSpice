...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_85(
        ...
        if (((s.b[1608] && s.b[1657]) && s.b[1658]) && s.b[1662]) {s.store_sub_ln_lhs(1362, 1343, 1356);}
    ...
    pub(super) fn stamp_reactive_block_87(
        ...
        if s.b[1608] {s.store_mul(1472, 1433, 1342);s.store_scalar(1475, 0.0);s.store_scalar(1476, 0.0);s.store_scalar(1473, 0.0);s.store_scalar(1474, 0.0);s.store_scalar(1477, 0.0);s.store_scalar(1478, 0.0);}
        ...
        if s.b[1608] {s.store_scale(1481, 3, 2.0);s.store_sub(1482, 1481, 1468);s.store_sub(1483, 1480, 1467);s.store_add_scaled_products_indices(1484, 270, 1480, 1.0, 271, 1482, 1.0);s.store_add_scaled_products_indices(1485, 270, 1481, 1.0, 271, 1483, 1.0);s.store_div_add_scaled_inputs_rhs_indices(0, 1466, 1480, 1.0, 1481, 1.0);s.store_mul(1486, 1480, 0);s.store_mul(1487, 1481, 0);s.store_mul_ad_product_rhs_mixed_ia(1488, 1480, 191, A::exp(A::mul(s.ad_value(40), s.ad_value(295))));s.store_mul_ad_product_rhs_mixed_ia(1489, 1481, 192, A::exp(A::mul(s.ad_value(40), s.ad_value(295))));s.store_mul_add_scaled_product_rhs_indices(2, 50, 1482, 1.0, 51, 1483, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_88(
        s: &mut ReactiveScratch,
    ) {
        if s.b[1608] {s.store_scaled_add_sqrt_square_offset_ad(3, A::offset(s.ad_value(2), 1.0), 0.01, 0.5);s.store_scaled_add_sqrt_square_offset_ad(4, A::scale_offset(s.ad_value(2), 0.2, 1.0), 0.01, 0.5);s.store_div(1490, 3, 4);s.store_mul_ad_product_rhs(1491, 33, A::add_scaled_product(A::offset(A::mul(s.ad_value(41), s.ad_value(1482)), 1.0), 1.0, s.ad_value(42), s.ad_value(1483), 1.0), A::exp(A::mul_scaled_lhs(s.ad_value(44), -1.0, A::ln(A::add_scaled_product(A::offset(A::mul(s.ad_value(1486), s.ad_value(268)), 1.0), 1.0, s.ad_value(1487), s.ad_value(269), 1.0)))));}
    ...
    pub(super) fn stamp_reactive_block_89(
        ...
        if ((s.b[1608] && s.b[1684]) && s.b[1685]) {s.store_exp_neg_input(0, 1463);s.store_div_mixed_ia(1497, 1463, A::sub_from_scalar(1.0, s.ad_value(0)));s.store_mul(1498, 0, 1497);s.store_add_offset_lhs_mixed_ai(1499, A::ln(A::div(s.ad_value(1433), A::mul(s.ad_value(1466), s.ad_value(1497)))), (-0.6931471805599), 1436);}
        ...
        if (s.b[1608] && (!s.b[1684])) {s.store_scale(0, 1464, (0.5 * 0.1666666666667));s.store_scale(2, 1463, 0.5);s.store_add_offset_lhs(1497, 2, 1.0, 0);s.store_add_mixed_ai(1498, A::sub_from_scalar(1.0, s.ad_value(2)), 0);s.store_scale(3, 2, 0.1666666666667);s.store_div_scalar_by_product_mixed_ia(1500, 1.0, 1462, A::add(A::offset(s.ad_value(1435), 0.5), s.ad_value(3)), 1.0);s.store_div_scalar_by_product_mixed_ia(1501, 1.0, 1462, A::sub(A::offset(s.ad_value(1434), 0.5), s.ad_value(3)), 1.0);s.store_add_scaled_inputs3_offset_mixed_aii(1499, A::ln(A::div(s.ad_value(1433), A::mul_sub_from_scalar_rhs(s.ad_value(1466), 1.0, A::scale(s.ad_value(0), 0.5)))), 1.0, 1436, 0.5, 1437, 0.5, (-0.6931471805599));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_90(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[1608] && (!s.b[1684])) {s.store_div_from_scalar_ad(1502, (-12.0), A::add_scaled_inputs4_offset(s.ad_value(1462), ((-1.0) * 3.0), A::div_scaled_inputs(s.ad_value(1462), 12.0, A::mul(s.ad_value(1460), s.ad_value(1461)), 1.0), 1.0, A::mul3(s.ad_value(1462), A::sub(s.ad_value(1434), s.ad_value(1435)), s.ad_value(1463)), 1.0, A::mul_sub_from_scalar_lhs_scaled_output(0.2, A::scale(s.ad_value(1462), 0.25), s.ad_value(1464), 0.3333333333333), 1.0, 4.0));}
    ...
    pub(super) fn stamp_reactive_block_91(
        ...
        if ((s.b[1608] && s.b[1686]) && s.b[1689]) {s.store_sqrt_offset_ad(1520, A::add(A::square(s.ad_value(1518)), A::mul3_scaled_output(s.ad_value(1517), s.ad_value(1517), s.ad_value(1517), 0.148148148148)), 1e-20);s.store_sub_ad(1521, A::exp_scaled_input(A::ln_scaled_input(A::add(s.ad_value(1519), s.ad_value(1516)), 0.5), 0.3333333333333), A::exp_scaled_input(A::ln_scaled_input(A::sub(s.ad_value(1519), s.ad_value(1516)), 0.5), 0.3333333333333));s.store_sub_ad(1522, A::exp_scaled_input(A::ln_scaled_input(A::add(s.ad_value(1520), s.ad_value(1518)), 0.5), 0.3333333333333), A::exp_scaled_input(A::ln_scaled_input(A::sub(s.ad_value(1520), s.ad_value(1518)), 0.5), 0.3333333333333));}
        ...
        if s.b[1608] {s.store_sub(1527, 225, 2);s.store_div(2, 339, 1527);s.store_square(3, 2);s.store_square(4, 3);s.store_square(5, 4);s.store_exp_scaled_input_ad(0, A::ln(A::offset(A::mul(s.ad_value(1425), s.ad_value(4)), 1.0)), 2.666666666667);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_92(
        s: &mut ReactiveScratch,
    ) {
        if s.b[1608] {s.store_mul_mixed_ia(1528, 339, A::exp_scaled_input(A::ln(A::add(s.ad_value(0), A::square(s.ad_value(5)))), (-0.0625)));s.store_div_from_scalar_offset_input(1342, 1.0, 1460, 1.0);s.store_div_from_scalar_offset_input(1343, 1.0, 1461, 1.0);s.store_offset_add_ad(1345, A::ln(A::div_scaled_product(A::add_scaled_product(s.ad_value(1460), 1.0, s.ad_value(1461), s.ad_value(1343), 1.0), s.ad_value(1432), 1.0, s.ad_value(1433), 1.0)), s.ad_value(1528), 3.0);s.store_offset_add_ad(1346, A::ln(A::div_scaled_product(A::add_scaled_product(s.ad_value(1461), 1.0, s.ad_value(1460), s.ad_value(1342), 1.0), s.ad_value(1432), 1.0, s.ad_value(1433), 1.0)), s.ad_value(1528), 3.0);}
    ...
    pub(super) fn stamp_reactive_block_96(
        ...
        if (s.b[1608] && s.b[1708]) {s.store_mul_add_scaled_inputs4_rhs_mixed_aiii(1377, 1386, A::ln(A::div(s.ad_value(1386), s.ad_value(1433))), 1.0, 1528, 1.0, 1458, -1.0, 1529, 1.0);s.store_add_scaled_product_indices(1378, 1386, 1.0, 1460, 1351, 2.0);s.store_add_scaled_inputs3_indices(1387, 1458, 1.0, 1529, (-1.0), 1345, -1.0);}
        s.b[1709] = ((((s.v[1377] < 0.0) && (s.v[1378] > 0.0)) && (((s.v[1387] + 2.3025850929941) + ((s.v[1460]) as f64).ln()) > 0.0)) || (s.v[1387] > 1.0));s.store_scalar(1709, if s.b[1709] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_97(
        ...
        if ((s.b[1608] && (!s.b[1711])) && (!s.b[1712])) {s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1344, 1353, 1.0, 1353, 1.0, 1353, 0.025, 0.0238095238095, ((0.0166666666667) * ((-0.1666666666667))), 0.1666666666667);s.store_offset_mul(1357, 1353, 1344, 2.0);s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1342, 1353, 1.0, 1353, 1.0, 1353, 0.0333333333333, 0.0357142857143, ((0.0333333333333) * ((-0.1666666666667))), 0.1666666666667);s.store_mul(1358, 1354, 1342);s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1343, 1353, 1.0, 1353, 1.0, 1353, 0.0420875420875421, 0.05, ((0.0714285714286) * ((-0.0055555555556))), 0.0055555555556);s.store_add_scaled_products_mixed_iiai(1360, 1355, 1342, 1.0, A::square(s.ad_value(1354)), 1343, (-1.0));s.store_scaled_mul(1363, 1354, 1344, (-0.5));s.store_add_scaled_product_mixed_aii(1364, A::mul3_scaled_output(s.ad_value(1354), s.ad_value(1354), A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1353), 2.0, A::scale(s.ad_value(1353), 0.075), 0.0238095238095)), (0.25 * 0.0055555555556)), 1.0, 1355, 1344, (-0.5));}
    ...
    pub(super) fn stamp_reactive_block_98(
        ...
        if ((s.b[1608] && (!s.b[1718])) && s.b[1719]) {s.store_sqrt_abs_ad(1356, s.ad_value(1353));s.store_exp_neg_input(1359, 1356);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_99(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[1608] && (!s.b[1718])) && s.b[1719]) {s.store_div_scaled_product_offset_rhs_mixed_iia(1357, 1356, 1359, 1.0, 1.0, A::sub_from_scalar(1.0, s.ad_value(1359)), 1.0);s.store_div_scaled_inputs_indices(1342, 1354, 0.25, 1353, 1.0);s.store_mul_add_mixed_iia(1358, 1342, 1353, A::mul_sub_from_scalar_rhs(s.ad_value(1357), 2.0, s.ad_value(1357)));s.store_add_scaled_product_mixed_aai(1360, A::div_scaled_product(s.ad_value(1358), s.ad_value(1355), 1.0, s.ad_value(1354), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(1354), 1.0, s.ad_value(1358), s.ad_value(1357), 1.0, (-2.0)), 1342, 1.0);s.store_sub_from_scalar_scaled_input(1343, 1.0, 1357, 0.5);s.store_mul_div_lhs(1363, 1354, 1353, 1343);s.store_div_mixed_ai(1364, A::add_scaled_products(s.ad_value(1355), s.ad_value(1343), 1.0, s.ad_value(1354), A::add_scaled_inputs(s.ad_value(1363), 1.0, s.ad_value(1358), 0.5), (-1.0)), 1353);}
        ...
        if (s.b[1608] && (!s.b[1722])) {s.store_div_from_scalar_sub_ad(1343, 1.0, s.ad_value(1351), s.ad_value(1357));s.store_sub(1344, 1358, 1460);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_100(
        ...
        if (s.b[1608] && (!s.b[1722])) {s.store_mul_sub_lhs(1365, 1352, 1361, 1343);s.store_mul_mixed_ai(1366, A::add_scaled_value_products(s.ad_value(1352), (-1.0), s.ad_value(1344), s.ad_value(1365), 1.0, s.ad_value(1363), s.ad_value(1361), (-1.0)), 1343);s.store_mul_mixed_ai(1367, A::add_scaled_inputs_product(A::add_scaled_products(s.ad_value(1360), s.ad_value(1365), 1.0, s.ad_value(1344), s.ad_value(1366), 2.0), 1.0, s.ad_value(1352), 1.0, A::add(s.ad_value(1364), A::square(s.ad_value(1363))), s.ad_value(1361), (-1.0)), 1343);}
        ...
        s.b[1724] = (p[10] == 1.0);s.store_scalar(1724, if s.b[1724] { 1.0 } else { 0.0 });s.b[1725] = (((s.v[1380]) as f64).abs() > 0.01);s.store_scalar(1725, if s.b[1725] { 1.0 } else { 0.0 });
