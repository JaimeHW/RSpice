...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_78(
        ...
        if (s.b[1608] && s.b[1637]) {s.store_mul_add_scaled_inputs3_offset_rhs_mixed_aii(1377, 1386, A::ln(A::div(s.ad_value(1386), s.ad_value(1433))), 1.0, 1458, (-1.0), 1465, 1.0, 0.0);s.store_add_scaled_product_indices(1378, 1386, 1.0, 1460, 1351, 2.0);s.store_add_scaled_inputs3_indices(1387, 1458, 1.0, 1465, (-1.0), 1345, -1.0);}
        s.b[1638] = ((((s.v[1377] < 0.0) && (s.v[1378] > 0.0)) && (((s.v[1387] + 2.3025850929941) + ((s.v[1460]) as f64).ln()) > 0.0)) || (s.v[1387] > 1.0));s.store_scalar(1638, if s.b[1638] { 1.0 } else { 0.0 });
        ...
        if (s.b[1608] && s.b[1641]) {s.store_mul_add_scaled_inputs3_offset_rhs_mixed_aii(1377, 1386, A::ln(A::div(s.ad_value(1386), s.ad_value(1433))), 1.0, 1458, (-1.0), 1465, 1.0, 0.0);s.store_add_scaled_product_indices(1378, 1386, 1.0, 1460, 1351, 2.0);s.store_add_scaled_inputs3_indices(1387, 1458, 1.0, 1465, (-1.0), 1345, -1.0);}
        s.b[1642] = ((((s.v[1377] < 0.0) && (s.v[1378] > 0.0)) && (((s.v[1387] + 2.3025850929941) + ((s.v[1460]) as f64).ln()) > 0.0)) || (s.v[1387] > 1.0));s.store_scalar(1642, if s.b[1642] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_80(
        ...
        if ((s.b[1608] && (!s.b[1644])) && (!s.b[1645])) {s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1343, 1353, 1.0, 1353, 1.0, 1353, 0.0420875420875421, 0.05, ((0.0714285714286) * ((-0.0055555555556))), 0.0055555555556);s.store_add_scaled_products_mixed_iiai(1360, 1355, 1342, 1.0, A::square(s.ad_value(1354)), 1343, (-1.0));s.store_scaled_mul(1363, 1354, 1344, (-0.5));s.store_add_scaled_product_mixed_aii(1364, A::mul3_scaled_output(s.ad_value(1354), s.ad_value(1354), A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1353), 2.0, A::scale(s.ad_value(1353), 0.075), 0.0238095238095)), (0.25 * 0.0055555555556)), 1.0, 1355, 1344, (-0.5));}
    ...
    pub(super) fn stamp_reactive_block_82(
        ...
        if ((s.b[1608] && (!s.b[1651])) && s.b[1652]) {s.store_div_mixed_ai(1364, A::add_scaled_products(s.ad_value(1355), s.ad_value(1343), 1.0, s.ad_value(1354), A::add_scaled_inputs(s.ad_value(1363), 1.0, s.ad_value(1358), 0.5), (-1.0)), 1353);}
    ...
    pub(super) fn stamp_reactive_block_83(
        ...
        if (s.b[1608] && (!s.b[1655])) {s.store_mul_mixed_ai(1367, A::add_scaled_inputs_product(A::add_scaled_products(s.ad_value(1360), s.ad_value(1365), 1.0, s.ad_value(1344), s.ad_value(1366), 2.0), 1.0, s.ad_value(1352), 1.0, A::add(s.ad_value(1364), A::square(s.ad_value(1363))), s.ad_value(1361), (-1.0)), 1343);}
    ...
    pub(super) fn stamp_reactive_block_84(
        ...
        if (((s.b[1608] && s.b[1657]) && s.b[1658]) && s.b[1660]) {s.store_add_scaled_product_mixed_aai(1360, A::div_scaled_product(s.ad_value(1358), s.ad_value(1355), 1.0, s.ad_value(1354), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(1354), 1.0, s.ad_value(1358), s.ad_value(1357), 1.0, (-2.0)), 1342, 1.0);s.store_sub_from_scalar_scaled_input(1343, 1.0, 1357, 0.5);s.store_mul_div_lhs(1363, 1354, 1353, 1343);s.store_div_mixed_ai(1364, A::add_scaled_products(s.ad_value(1355), s.ad_value(1343), 1.0, s.ad_value(1354), A::add_scaled_inputs(s.ad_value(1363), 1.0, s.ad_value(1358), 0.5), (-1.0)), 1353);}
        ...
        if (((s.b[1608] && s.b[1657]) && s.b[1658]) && s.b[1662]) {s.store_div_scaled_inputs_mixed_ia(1343, 1353, 4.0, A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs(s.ad_value(1359), 2.0, s.ad_value(1359))), 1.0);s.store_mul(1361, 1343, 1359);}
    }
    #[inline(never)]
