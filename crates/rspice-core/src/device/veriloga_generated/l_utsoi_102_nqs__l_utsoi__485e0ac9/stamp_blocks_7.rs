...
impl Instance {
    ...
    if s.b[1812] {
        ...
        s.store_scalar(1795, tf);s.store_div_scaled_product3_indices(1799, 456, 447, 116, 1.0, 469, 1.0);s.store_mul_scale_offset_indices(1800, 1799, 468, 1.0, 1.0);s.store_mul_scale_offset_mixed_ia(1802, 1800, A::mul_scaled_lhs(s.ad_value(334), 0.25, s.ad_value(1788)), -1.0, 0.5);s.store_sub(1801, 1800, 1802);s.store_scalar(1805, 0.0);s.b[1813] = (p[6] > 0.0);s.store_scalar(1813, if s.b[1813] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_120(
        ...
        s.store_mul_scale_offset(0, A::mul3_scaled_output(s.ad_value(1838), A::offset(A::sqrt(A::offset(A::div(s.ad_value(1843), s.ad_value(1838)), 1.0)), (-1.0)), A::offset(A::mul(s.ad_value(36), s.ad_value(1857)), 1.0), 2.0), A::mul(s.ad_value(37), s.ad_value(1846)), 1.0, 1.0);s.b[1894] = (p[11] > 0.0);s.store_scalar(1894, if s.b[1894] { 1.0 } else { 0.0 });
