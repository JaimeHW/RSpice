...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if (((s.b[1249] && s.b[1250]) && (!s.b[1258])) && (!s.b[1259])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(731, 1.80485e-35, A::neg(s.ad_value(0)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(0)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(0)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0), 1.0);
        }
        ...
        if (((s.b[1249] && s.b[1250]) && (!s.b[1260])) && (!s.b[1261])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(732, 1.80485e-35, A::neg(s.ad_value(2)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(2)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(2)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if ((((s.b[1249] && s.b[1284]) && (!s.b[1292])) && (!s.b[1293])) && (!s.b[1294])) {
            s.store_scaled_offset_mul_offset_lhs_ad_rhs(731, 0, (-80.0), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(0), (-80.0)), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0), 1.0, 5.54062e34);
        }

        if (s.b[1249] && s.b[1284]) {
            s.store_mul_ad_product_rhs(741, 68, s.ad_value(731), A::ln(A::div_scaled_offset_numerator(s.ad_value(729), 1.0, 1.0, A::offset(s.ad_value(730), 1.0), 1.0)));
        }
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1322] && (!s.b[1323])) {
            s.store_div_scaled_inputs(359, A::offset(A::sub_scaled_inputs(A::offset(s.ad_value(0), p.p16), 0.5, A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(0), (-p.p16), A::offset(s.ad_value(0), (-p.p16))), 1.0)), 0.5), (0.25 / p.p16)), -1.0, s.ad_value(168), 1.0);
        }
