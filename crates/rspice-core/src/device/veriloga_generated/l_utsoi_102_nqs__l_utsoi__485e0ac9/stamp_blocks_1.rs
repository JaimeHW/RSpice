...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        let assign24410_e24665: f64 = (1e-5 * s.v[710]);
        s.store_scalar(711, assign24410_e24665);
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if (s.b[1249] && s.b[1250]) {
            ...
            s.store_add_scaled_products_indices(726, 71, 2, 1.0, 69, 3, 1.0);
        ...
        if ((s.b[1249] && s.b[1250]) && s.b[1258]) {
            s.store_offset_mul_offset_rhs_ad_rhs(731, 0, A::mul_scaled_lhs(s.ad_value(0), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, 1.0)), 1.0, 1.0);
        }
        ...
        if (((s.b[1249] && s.b[1250]) && (!s.b[1258])) && (!s.b[1259])) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(731, 1.80485e-35, A::neg(s.ad_value(0)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if ((s.b[1249] && s.b[1250]) && s.b[1260]) {
            s.store_offset_mul_offset_rhs_ad_rhs(732, 2, A::mul_scaled_lhs(s.ad_value(2), 0.5, A::scale_offset(s.ad_value(2), 0.3333333333333, 1.0)), 1.0, 1.0);
        }
        ...
        if (((s.b[1249] && s.b[1250]) && (!s.b[1260])) && (!s.b[1261])) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(732, 1.80485e-35, A::neg(s.ad_value(2)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if (s.b[1249] && s.b[1267]) {
            ...
            s.store_add_scaled_products_indices(724, 84, 2, 1.0, 82, 3, 1.0);
            s.store_add_scaled_products_indices(725, 282, 2, 1.0, 281, 3, 1.0);
            s.store_add_scaled_products_indices(726, 72, 2, 1.0, 70, 3, 1.0);
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if ((((s.b[1249] && s.b[1284]) && (!s.b[1292])) && (!s.b[1293])) && (!s.b[1294])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(731, 0, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }

        if (s.b[1249] && s.b[1284]) {
            s.store_mul_ad_product_rhs_mixed_ia(741, 68, 731, A::ln(A::div_scaled_offset_numerator(s.ad_value(729), 1.0, 1.0, A::offset(s.ad_value(730), 1.0), 1.0)));
        }
        ...
        if ((s.b[1249] && s.b[1284]) && (!s.b[1295])) {
            ...
            s.store_mul_sub_from_scalar_scaled_rhs_scaled_output(748, 746, 1.0, 746, 1.0, 0.5);
            s.store_sub_from_scalar_scaled_input(747, 0.5, 748, 3.0);
        }
        ...
        if (((s.b[1249] && s.b[1284]) && (!s.b[1295])) && s.b[1296]) {
            ...
            s.store_add_scaled_offset_product_rhs_mixed_iia(743, 742, 0.5, 745, A::mul(s.ad_value(749), A::add_scaled_offset_product_rhs(A::scaled_offset(s.ad_value(748), 0.25, 0.4), 1.0, s.ad_value(749), s.ad_value(748), 0.125, 0.0285714285714)), 1.0, (-0.1666666666667));
        }
        ...
        if (((s.b[1249] && s.b[1284]) && (!s.b[1295])) && (!s.b[1296])) {
            ...
            s.store_add_scaled_products_left_left_ad(742, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(746), s.ad_value(0)), 750, 0.5, 746, 3, 0.5);
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1322] && (!s.b[1323])) {
            s.store_div_scaled_inputs_mixed_ai(359, A::offset(A::sub_scaled_inputs(A::offset(s.ad_value(0), p.p16), 0.5, A::sqrt_square_offset(A::offset(s.ad_value(0), (-p.p16)), 1.0), 0.5), (0.25 / p.p16)), -1.0, 168, 1.0);
        }
    ...
    if (s.b[1608] && s.b[1637]) {
        let assign31440_e34429: f64 = (s.v[1458] - s.v[1465]);
        let assign31440_e34431: f64 = (assign31440_e34429 - s.v[1345]);
        (assign31440_e34431,)
    } else {
        (s.v[1387],)
    }
};
        s.store_scalar(1387, assign31440_e34433);
    ...
    if (s.b[1608] && s.b[1641]) {
        let assign31710_e34758: f64 = (s.v[1458] - s.v[1465]);
        let assign31710_e34760: f64 = (assign31710_e34758 - s.v[1345]);
        (assign31710_e34760,)
    } else {
        (s.v[1387],)
    }
};
        s.store_scalar(1387, assign31710_e34762);
    ...
    if (s.b[1608] && s.b[1704]) {
        let assign36960_e41549: f64 = (s.v[1458] - s.v[1529]);
        let assign36960_e41551: f64 = (assign36960_e41549 - s.v[1345]);
        (assign36960_e41551,)
    } else {
        (s.v[1387],)
    }
};
        s.store_scalar(1387, assign36960_e41553);
    ...
    if (s.b[1608] && s.b[1708]) {
        let assign37230_e41878: f64 = (s.v[1458] - s.v[1529]);
        let assign37230_e41880: f64 = (assign37230_e41878 - s.v[1345]);
        (assign37230_e41880,)
    } else {
        (s.v[1387],)
    }
};
        s.store_scalar(1387, assign37230_e41882);
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        s.store_mul_add_scaled_inputs3_offset_rhs(365, 13, s.ad_value(348), p.p31, s.ad_value(356), p.p31, s.ad_value(358), p.p31, 0.0);
        ...
        s.store_div_scaled_product3_by_product(1793, A::mul3(s.ad_value(342), s.ad_value(390), s.ad_value(226)), s.ad_value(1782), s.ad_value(344), 1.0, s.ad_value(345), s.ad_value(346), 1.0);
        ...
        let assign43520_e48716: f64 = (s.v[1793] * s.v[1792]);
        let assign43520_e48718: f64 = (assign43520_e48716 * s.v[3]);
        s.store_scalar(1795, assign43520_e48718);
    ...
    if s.b[1812] {
        let assign43540_e48725: f64 = (s.v[427] / s.v[422]);
        (assign43540_e48725,)
    } else {
        (s.v[1796],)
    }
};
        s.store_scalar(1796, assign43540_e48727);

        let (assign43550_e48747,) = {
    if s.b[1812] {
        let assign43550_e48731: f64 = (s.v[309] * s.v[348]);
        let assign43550_e48733: f64 = (assign43550_e48731 * s.v[411]);
        let assign43550_e48735: f64 = (assign43550_e48733 * s.v[223]);
        let assign43550_e48739: f64 = (s.v[1796] * s.v[1796]);
        let assign43550_e48740: f64 = (1.0 + assign43550_e48739);
        let assign43550_e48742: f64 = (assign43550_e48740 * s.v[1791]);
        let assign43550_e48744: f64 = (assign43550_e48742 * s.v[1791]);
        ...
        s.store_scalar(1797, assign43550_e48747);

        let (assign43560_e48755,) = {
    if s.b[1812] {
        let assign43560_e48752: f64 = (s.v[1797] / s.v[308]);
        let assign43560_e48753: f64 = (s.v[1795] + assign43560_e48752);
        (assign43560_e48753,)
    } else {
        (s.v[1795],)
    }
};
        s.store_scalar(1795, assign43560_e48755);
        ...
        if s.b[1813] {
            ...
            s.store_max_with_scalar(3, 2, 1e-40);
            s.store_div_scaled_product3_indices(1803, 1793, 1791, 1791, 1.0, 3, 1.0);
        }
        ...
        if (s.b[1813] && s.b[1814]) {
            s.store_mul_ad_product_rhs_mixed_ia(1805, 1792, 1788, A::add_scaled_sub_value_product(1.0, s.ad_value(1794), 1.0, A::add_scaled_inputs_product(s.ad_value(1787), 1.0, s.ad_value(1789), 19.2, s.ad_value(1787), s.ad_value(1794), (-1.0)), s.ad_value(1790), (-1.0)));
        }
