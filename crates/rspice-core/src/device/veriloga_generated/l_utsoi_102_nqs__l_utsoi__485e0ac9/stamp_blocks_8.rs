...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_10(
        ...
        while {
            ...
            t5 += 1;assert!(t5 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");s.b[663] = (((-((p[26] + (0.5 * p[20])) + (s.v[594] * (p[28] + p[20])))) / p[481]) > (-80.0));s.store_scalar(663, if s.b[663] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_11(
        ...
        if (((!s.b[611]) && s.b[661]) && (!s.b[662])) {s.store_mul_ad_affine_product_rhs(0, 607, A::powf(s.ad_value(584), p[236]), A::scale_offset(s.ad_value(580), p[237], 1.0), p[485], 0.0);s.store_add(546, 546, 0);s.store_max_with_scalar(187, 546, 0.0);s.store_add(547, 547, 0);s.store_max_with_scalar(189, 547, 0.0);s.store_div_scaled_inputs_indices(0, 534, p[238], 533, 1.0);s.store_mul(188, 187, 0);s.store_mul(190, 189, 0);}
    ...
    pub(super) fn stamp_reactive_block_16(
        ...
        s.b[791] = (p[14] == 1.0);s.store_scalar(791, if s.b[791] { 1.0 } else { 0.0 });
