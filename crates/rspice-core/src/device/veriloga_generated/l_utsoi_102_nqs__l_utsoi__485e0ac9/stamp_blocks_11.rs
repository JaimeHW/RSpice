...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_54(
        ...
        s.b[1205] = (p[13] > 0.0);s.store_scalar(1205, if s.b[1205] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_56(
        ...
        s.copy_ad(417, 1006);s.copy_ad(418, 1007);s.copy_ad(419, 1008);s.copy_ad(420, 1009);s.copy_ad(421, 1016);s.copy_ad(422, 1022);s.copy_ad(423, 1023);s.copy_ad(424, 1025);s.copy_ad(425, 1027);s.copy_ad(426, 1031);s.copy_ad(428, 1030);s.copy_ad(429, 1032);s.copy_ad(430, 1033);s.copy_ad(431, 1034);s.copy_ad(432, 1036);s.copy_ad(433, 1042);s.copy_ad(435, 1045);s.copy_ad(436, 1055);s.copy_ad(437, 1056);s.copy_ad(438, 1057);s.copy_ad(439, 1058);s.store_div_scaled_inputs_mixed_ia(342, 421, p[35], A::add(s.ad_value(417), s.ad_value(418)), 1.0);s.store_mul_add_scaled_product_rhs_indices(343, 424, 63, 1.0, 275, 423, 1.0);s.store_mul_scale_offset_mixed_ia(344, 425, A::mul_offset_rhs(s.ad_value(343), s.ad_value(343), 1.0), 1.0, 1.0);s.store_mul3_lhs(345, 422, 425, 426);s.b[1212] = (p[13] > 0.0);s.store_scalar(1212, if s.b[1212] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_59(
        ...
        s.store_div_mixed_ai(708, A::sqrt(A::mul3_scaled_output(s.ad_value(20), s.ad_value(229), s.ad_value(224), (2.0 * 1.602176565e-19))), 241);s.store_square(709, 708);s.store_offset_scaled(710, 708, 0.707106781186545, 1.0);s.store_scale(711, 710, 1e-5);s.store_div_from_scalar(712, 1.0, 710);s.store_div_from_scalar_offset_scaled_input(713, 1.0, 708, 0.7324648775608221, 1.25);s.b[1231] = (((p[3] > 0.0) && ((s.v[70] > 0.0) || (s.v[72] > 0.0))) || ((p[4] > 0.0) && (s.v[90] > 0.0)));s.store_scalar(1231, if s.b[1231] { 1.0 } else { 0.0 });s.b[1232] = (((s.v[705]) as f64).abs() <= s.v[711]);s.store_scalar(1232, if s.b[1232] { 1.0 } else { 0.0 });
