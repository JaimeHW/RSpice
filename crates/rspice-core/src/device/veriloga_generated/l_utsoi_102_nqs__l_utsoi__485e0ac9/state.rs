...
pub struct Instance {
    ...
    pub(crate) scalar_v782: bool,
    pub(crate) scalar_v789: f64,
    pub(crate) scalar_v790: f64,
    pub(crate) scalar_v791: bool,
    ...
    pub(crate) scalar_v2743: f64,
    pub(crate) scalar_v2745: f64,
    pub(crate) scalar_v2758: f64,
    pub(crate) scalar_v2776: f64,
    pub(crate) scalar_v2777: f64,
    pub(crate) scalar_v2778: f64,
    pub(crate) scalar_v2779: f64,
    pub(crate) scalar_v2780: f64,
    pub(crate) scalar_v2781: f64,
    ...
    pub(crate) scalar_v5886: f64,
    pub(crate) scalar_v5992: f64,
    pub(crate) scalar_v7014: f64,
    pub(crate) scalar_v7348: f64,
    pub(crate) scalar_v7349: f64,
    pub(crate) scalar_v7510: f64,
    pub(crate) scalar_v7511: f64,
    pub(crate) scalar_v7617: f64,
    pub(crate) scalar_v7618: f64,
    pub(crate) scalar_v7674: f64,
    pub(crate) scalar_v7675: f64,
    pub(crate) scalar_v7676: f64,
    pub(crate) scalar_v7848: f64,
    pub(crate) scalar_v7849: f64,
    pub(crate) scalar_v7955: f64,
    pub(crate) scalar_v7956: f64,
    ...
    pub(crate) scalar_v8078: f64,
    pub(crate) scalar_v8079: f64,
    pub(crate) scalar_v8080: f64,
    pub(crate) scalar_v8081: f64,
    ...
    pub(crate) scalar_v8027: f64,
    pub(crate) scalar_v8028: f64,
    pub(crate) scalar_v8029: f64,
    pub(crate) scalar_v8053: f64,
...
impl Clone for Instance {
    ...
    fn clone(&self) -> Self {
        Self {
            ...
            scalar_v2776: self.scalar_v2776,
            scalar_v2777: self.scalar_v2777,
            scalar_v2778: self.scalar_v2778,
            scalar_v2779: self.scalar_v2779,
            scalar_v2780: self.scalar_v2780,
            scalar_v2781: self.scalar_v2781,
            ...
            scalar_v5992: self.scalar_v5992,
            scalar_v7014: self.scalar_v7014,
            scalar_v7348: self.scalar_v7348,
            scalar_v7349: self.scalar_v7349,
            scalar_v7510: self.scalar_v7510,
            scalar_v7511: self.scalar_v7511,
            scalar_v7617: self.scalar_v7617,
            scalar_v7618: self.scalar_v7618,
            scalar_v7674: self.scalar_v7674,
            scalar_v7675: self.scalar_v7675,
            scalar_v7676: self.scalar_v7676,
            scalar_v7848: self.scalar_v7848,
            scalar_v7849: self.scalar_v7849,
            scalar_v7955: self.scalar_v7955,
            ...
            scalar_v8078: self.scalar_v8078,
            scalar_v8079: self.scalar_v8079,
            scalar_v8080: self.scalar_v8080,
            scalar_v8081: self.scalar_v8081,
            ...
            scalar_v8027: self.scalar_v8027,
            scalar_v8028: self.scalar_v8028,
            scalar_v8029: self.scalar_v8029,
            scalar_v8053: self.scalar_v8053,
...
impl Instance {
    ...
    fn recompute_instance_static(&mut self) {
        ...
        let v333: f64 = (if v332 { v331 } else { 1.0 });
        self.scalar_v333 = v333;
        let v334: f64 = (if v167 { v333 } else { v85 });
        self.scalar_v334 = v334;
        let v335: f64 = p.p236;
        self.scalar_v335 = v335;
        let v336: f64 = f64::powf(v326, p.p236);
        self.scalar_v336 = v336;
        let v337: f64 = p.p237;
        self.scalar_v337 = v337;
        let v338: f64 = (v229 * p.p237);
        ...
        let v503: f64 = (p.p381 * p.p382);
        self.scalar_v503 = v503;
        let v504: f64 = (v503 / v213);
        self.scalar_v504 = v504;
        let v505: f64 = (v345 / p.p382);
        self.scalar_v505 = v505;
        let v506: f64 = ((v505) as f64).exp();
        self.scalar_v506 = v506;
        let v507: f64 = (1.0 - v506);
        self.scalar_v507 = v507;
        let v508: f64 = (v504 * v507);
        self.scalar_v508 = v508;
        let v509: f64 = (1.0 + v508);
        self.scalar_v509 = v509;
        let v515: f64 = p.p384;
        self.scalar_v515 = v515;
        let v516: f64 = p.p385;
        self.scalar_v516 = v516;
        let v517: f64 = (v227 * p.p385);
        self.scalar_v517 = v517;
        let v518: f64 = (p.p384 + v517);
        self.scalar_v518 = v518;
        let v519: f64 = p.p386;
        self.scalar_v519 = v519;
        let v520: f64 = (v229 * p.p386);
        self.scalar_v520 = v520;
        let v521: f64 = (v518 + v520);
        self.scalar_v521 = v521;
        let v522: f64 = p.p387;
        self.scalar_v522 = v522;
        let v523: f64 = (v227 * p.p387);
        self.scalar_v523 = v523;
        let v524: f64 = (v229 * v523);
        self.scalar_v524 = v524;
        let v525: f64 = (v521 + v524);
        self.scalar_v525 = v525;
        let v526: f64 = (if v167 { v525 } else { v143 });
        self.scalar_v526 = v526;
        let v535: bool = (v147 && v167);
        self.scalar_v535 = v535;
        let v536: f64 = (if v535 { p.p212 } else { 0.0 });
        self.scalar_v536 = v536;
        let v537: f64 = if param_given[402] { 1.0 } else { 0.0 };
        self.scalar_v537 = v537;
        let v538: bool = (1.0 == if param_given[402] { 1.0 } else { 0.0 });
        self.scalar_v538 = v538;
        let v539: bool = (v535 && v538);
        self.scalar_v539 = v539;
        let v540: f64 = p.p402;
        self.scalar_v540 = v540;
        let v541: f64 = (if v539 { p.p402 } else { v536 });
        self.scalar_v541 = v541;
        let v542: f64 = (if v535 { p.p213 } else { 0.0 });
        self.scalar_v542 = v542;
        let v543: f64 = if param_given[403] { 1.0 } else { 0.0 };
        self.scalar_v543 = v543;
        let v544: bool = (1.0 == if param_given[403] { 1.0 } else { 0.0 });
        self.scalar_v544 = v544;
        let v545: bool = (v535 && v544);
        self.scalar_v545 = v545;
        let v546: f64 = p.p403;
        self.scalar_v546 = v546;
        let v547: f64 = (if v545 { p.p403 } else { v542 });
        self.scalar_v547 = v547;
        let v548: f64 = (if v535 { p.p214 } else { 0.0 });
        self.scalar_v548 = v548;
        let v549: f64 = if param_given[404] { 1.0 } else { 0.0 };
        self.scalar_v549 = v549;
        let v550: bool = (1.0 == if param_given[404] { 1.0 } else { 0.0 });
        self.scalar_v550 = v550;
        let v551: bool = (v535 && v550);
        self.scalar_v551 = v551;
        let v552: f64 = p.p404;
        self.scalar_v552 = v552;
        let v553: f64 = (if v551 { p.p404 } else { v548 });
        self.scalar_v553 = v553;
        let v554: f64 = (if v535 { p.p215 } else { 0.0 });
        self.scalar_v554 = v554;
        let v555: f64 = if param_given[405] { 1.0 } else { 0.0 };
        self.scalar_v555 = v555;
        let v556: bool = (1.0 == if param_given[405] { 1.0 } else { 0.0 });
        self.scalar_v556 = v556;
        let v557: bool = (v535 && v556);
        self.scalar_v557 = v557;
        let v558: f64 = p.p405;
        self.scalar_v558 = v558;
        let v559: f64 = (if v557 { p.p405 } else { v554 });
        self.scalar_v559 = v559;
        let v560: f64 = f64::powf(v227, v547);
        self.scalar_v560 = v560;
        let v561: f64 = (v541 * v560);
        self.scalar_v561 = v561;
        let v562: f64 = f64::powf(v227, v559);
        self.scalar_v562 = v562;
        let v563: f64 = (v553 * v562);
        self.scalar_v563 = v563;
        let v564: f64 = (1.0 + v563);
        self.scalar_v564 = v564;
        let v565: f64 = (v561 / v564);
        self.scalar_v565 = v565;
        let v567: f64 = (if v535 { p.p236 } else { 0.0 });
        self.scalar_v567 = v567;
        let v568: f64 = if param_given[414] { 1.0 } else { 0.0 };
        self.scalar_v568 = v568;
        let v569: bool = (1.0 == if param_given[414] { 1.0 } else { 0.0 });
        self.scalar_v569 = v569;
        let v570: bool = (v535 && v569);
        self.scalar_v570 = v570;
        let v571: f64 = p.p414;
        self.scalar_v571 = v571;
        let v572: f64 = (if v570 { p.p414 } else { v567 });
        self.scalar_v572 = v572;
        let v573: f64 = (if v535 { p.p237 } else { 0.0 });
        self.scalar_v573 = v573;
        let v574: f64 = if param_given[415] { 1.0 } else { 0.0 };
        self.scalar_v574 = v574;
        let v575: bool = (1.0 == if param_given[415] { 1.0 } else { 0.0 });
        self.scalar_v575 = v575;
        let v576: bool = (v535 && v575);
        self.scalar_v576 = v576;
        let v577: f64 = p.p415;
        self.scalar_v577 = v577;
        let v578: f64 = (if v576 { p.p415 } else { v573 });
        self.scalar_v578 = v578;
        let v579: f64 = f64::powf(v326, v572);
        self.scalar_v579 = v579;
        let v580: f64 = (v229 * v578);
        self.scalar_v580 = v580;
        let v581: f64 = (1.0 + v580);
        self.scalar_v581 = v581;
        let v582: f64 = (v579 * v581);
        self.scalar_v582 = v582;
        let v584: f64 = (3.45313e-11 / v256);
        self.scalar_v584 = v584;
        let v585: f64 = (v225 * v584);
        self.scalar_v585 = v585;
        let v587: f64 = p.p431;
        self.scalar_v587 = v587;
        let v590: f64 = p.p436;
        self.scalar_v590 = v590;
        let v591: f64 = (if v167 { p.p436 } else { v151 });
        ...
        let v605: f64 = (if v167 { 0.0 } else { v354 });
        self.scalar_v605 = v605;
        let v606: bool = (p.p29 > 1.0);
        self.scalar_v606 = v606;
        let v607: f64 = p.p28;
        self.scalar_v607 = v607;
        let v608: bool = (p.p28 > 0.0);
        self.scalar_v608 = v608;
        let v609: bool = (v606 && v608);
        self.scalar_v609 = v609;
        let v610: bool = (v167 && v609);
        self.scalar_v610 = v610;
        let v611: f64 = (p.p20 + p.p28);
        self.scalar_v611 = v611;
        let v612: f64 = (-v611);
        self.scalar_v612 = v612;
        let v613: f64 = p.p449;
        self.scalar_v613 = v613;
        let v614: f64 = (v612 / p.p449);
        self.scalar_v614 = v614;
        let v615: f64 = (if v610 { v614 } else { v375 });
        self.scalar_v615 = v615;
        let v616: f64 = ((v615) as f64).abs();
        self.scalar_v616 = v616;
        let v617: bool = (v616 < 80.0);
        self.scalar_v617 = v617;
        let v618: bool = (v610 && v617);
        self.scalar_v618 = v618;
        let v619: f64 = ((v615) as f64).exp();
        self.scalar_v619 = v619;
        let v620: f64 = (if v618 { v619 } else { v378 });
        self.scalar_v620 = v620;
        let v621: bool = (v615 < -80.0);
        self.scalar_v621 = v621;
        let v622: bool = (!v617);
        self.scalar_v622 = v622;
        let v623: bool = (v610 && v622);
        self.scalar_v623 = v623;
        let v624: bool = (v621 && v623);
        self.scalar_v624 = v624;
        let v625: f64 = (-v615);
        self.scalar_v625 = v625;
        let v626: f64 = (v625 - 80.0);
        self.scalar_v626 = v626;
        let v627: f64 = (0.5 * v626);
        self.scalar_v627 = v627;
        let v628: f64 = (0.3333333333333 * v626);
        ...
        let v690: f64 = (p.p496 + p.p497);
        self.scalar_v690 = v690;
        let v691: f64 = (v242 * v248);
        self.scalar_v691 = v691;
        let v692: f64 = (v690 / v691);
        self.scalar_v692 = v692;
        let v693: f64 = (v687 + v692);
        self.scalar_v693 = v693;
        let v694: f64 = p.p495;
        self.scalar_v694 = v694;
        let v695: f64 = (p.p29 * p.p495);
        self.scalar_v695 = v695;
        let v696: f64 = (v693 + v695);
        self.scalar_v696 = v696;
        let v697: f64 = (if v167 { v696 } else { 0.0 });
        self.scalar_v697 = v697;
        let v698: bool = (v697 > 0.0);
        self.scalar_v698 = v698;
        let v699: f64 = (if v698 { v697 } else { 0.0 });
        self.scalar_v699 = v699;
        let v700: f64 = (if v167 { v699 } else { v160 });
        self.scalar_v700 = v700;
        let v701: f64 = p.p500;
        self.scalar_v701 = v701;
        let v702: bool = (p.p500 > 0.0);
        self.scalar_v702 = v702;
        let v703: f64 = (if v702 { p.p500 } else { 0.0 });
        self.scalar_v703 = v703;
        let v704: f64 = (if v167 { v703 } else { 0.0 });
        self.scalar_v704 = v704;
        let v705: f64 = p.p501;
        self.scalar_v705 = v705;
        let v706: bool = (p.p501 > 0.0);
        self.scalar_v706 = v706;
        let v707: f64 = (if v706 { p.p501 } else { 0.0 });
        self.scalar_v707 = v707;
        let v708: f64 = (if v167 { v707 } else { 0.0 });
        self.scalar_v708 = v708;
        let v709: f64 = p.p7;
        self.scalar_v709 = v709;
        let v710: bool = (0.0 == p.p7);
        self.scalar_v710 = v710;
        let v711: bool = (v167 && v710);
        self.scalar_v711 = v711;
        let v712: f64 = (if v711 { v704 } else { v708 });
        self.scalar_v712 = v712;
        let v713: f64 = p.p39;
        self.scalar_v713 = v713;
        let v714: f64 = (p.p29 * p.p39);
        self.scalar_v714 = v714;
        let v715: f64 = (v704 * v714);
        self.scalar_v715 = v715;
        let v716: f64 = (if v167 { v715 } else { v162 });
        self.scalar_v716 = v716;
        let v717: f64 = p.p40;
        self.scalar_v717 = v717;
        let v718: f64 = (p.p29 * p.p40);
        self.scalar_v718 = v718;
        let v719: f64 = (v712 * v718);
        self.scalar_v719 = v719;
        let v720: f64 = (if v167 { v719 } else { v164 });
        self.scalar_v720 = v720;
        let v721: f64 = p.p502;
        self.scalar_v721 = v721;
        let v722: f64 = (p.p29 * p.p502);
        self.scalar_v722 = v722;
        let v723: f64 = (if v167 { v722 } else { v166 });
        self.scalar_v723 = v723;
        let v724: f64 = (if v710 { v267 } else { v270 });
        self.scalar_v724 = v724;
        let v725: f64 = (if v710 { v401 } else { v404 });
        self.scalar_v725 = v725;
        let v726: f64 = (if v710 { v407 } else { v410 });
        self.scalar_v726 = v726;
        let v727: f64 = (if v710 { v413 } else { v416 });
        self.scalar_v727 = v727;
        let v728: f64 = (if v710 { v445 } else { v453 });
        self.scalar_v728 = v728;
        let v729: f64 = (if v710 { v455 } else { v457 });
        self.scalar_v729 = v729;
        let v730: f64 = (if v710 { v459 } else { v461 });
        self.scalar_v730 = v730;
        let v731: f64 = (if v710 { v463 } else { v465 });
        self.scalar_v731 = v731;
        let v732: f64 = (if v710 { v470 } else { v475 });
        self.scalar_v732 = v732;
        let v733: f64 = (v310 * 1.04479e-10);
        self.scalar_v733 = v733;
        let v734: f64 = (v315 + v733);
        self.scalar_v734 = v734;
        let v751: f64 = (v310 * -0.4);
        self.scalar_v751 = v751;
        let v758: f64 = p.p13;
        self.scalar_v758 = v758;
        let v769: bool = (v334 > 0.0);
        self.scalar_v769 = v769;
        let v770: f64 = (1.0 + v334);
        self.scalar_v770 = v770;
        let v771: f64 = (v584 * v770);
        self.scalar_v771 = v771;
        let v772: f64 = (if v769 { v771 } else { 0.0 });
        self.scalar_v772 = v772;
        let v773: bool = (!v769);
        self.scalar_v773 = v773;
        let v774: f64 = (if v773 { v584 } else { v772 });
        self.scalar_v774 = v774;
        let v781: f64 = p.p9;
        self.scalar_v781 = v781;
        let v782: bool = (p.p9 > 0.0);
        self.scalar_v782 = v782;
        let v789: f64 = (v258 * 1e18);
        self.scalar_v789 = v789;
        let v790: f64 = (v258 * v789);
        self.scalar_v790 = v790;
        let v791: bool = (p.p13 > 0.0);
        self.scalar_v791 = v791;
        let v792: f64 = p.p14;
        self.scalar_v792 = v792;
        let v793: bool = (1.0 == p.p14);
        self.scalar_v793 = v793;
        let v794: bool = (v791 && v793);
        self.scalar_v794 = v794;
        let v796: f64 = (0.409618895 / v790);
        self.scalar_v796 = v796;
        let v797: f64 = (if v794 { v796 } else { 0.0 });
        self.scalar_v797 = v797;
        let v798: bool = (!v793);
        self.scalar_v798 = v798;
        let v799: bool = (v791 && v798);
        self.scalar_v799 = v799;
        let v801: f64 = (0.723134895 / v790);
        self.scalar_v801 = v801;
        let v802: f64 = (if v799 { v801 } else { v797 });
        self.scalar_v802 = v802;
        let v803: f64 = (v295 * p.p14);
        ...
        let v820: f64 = (1.0 / v437);
        self.scalar_v820 = v820;
        let v824: f64 = (v437 * 2.9189679640027008e-49);
        self.scalar_v824 = v824;
        let v825: f64 = ((v824) as f64).sqrt();
        self.scalar_v825 = v825;
        let v826: f64 = (1.3333333333332 * v825);
        self.scalar_v826 = v826;
        let v828: f64 = (v826 / 1.054571726e-34);
        self.scalar_v828 = v828;
        let v829: f64 = (v264 * v828);
        self.scalar_v829 = v829;
        let v831: bool = (v426 < 0.0);
        self.scalar_v831 = v831;
        let v832: f64 = (v422 * -0.495);
        self.scalar_v832 = v832;
        let v833: f64 = (v832 / v426);
        self.scalar_v833 = v833;
        let v834: f64 = (if v831 { v833 } else { 0.0 });
        self.scalar_v834 = v834;
        let v835: bool = (v430 < 0.0);
        self.scalar_v835 = v835;
        let v836: f64 = (v428 * -0.495);
        self.scalar_v836 = v836;
        let v837: f64 = (v836 / v430);
        self.scalar_v837 = v837;
        let v838: f64 = (if v835 { v837 } else { 0.0 });
        self.scalar_v838 = v838;
        let v841: f64 = (v264 * v264);
        self.scalar_v841 = v841;
        let v842: f64 = (4e-18 / v841);
        self.scalar_v842 = v842;
        let v843: f64 = (v445 * v842);
        self.scalar_v843 = v843;
        let v844: f64 = (v728 * v842);
        self.scalar_v844 = v844;
        let v846: f64 = (v264 * 500000000.0);
        self.scalar_v846 = v846;
        let v872: bool = (v700 > 0.0);
        self.scalar_v872 = v872;
        let v873: f64 = (1.0 / v700);
        self.scalar_v873 = v873;
        let v874: f64 = (if v872 { v873 } else { 0.0 });
        self.scalar_v874 = v874;
        let v875: bool = (!v872);
        self.scalar_v875 = v875;
        let v876: f64 = (if v875 { 0.0 } else { v874 });
        self.scalar_v876 = v876;
        let v877: bool = (v716 > 0.0);
        self.scalar_v877 = v877;
        let v878: f64 = (1.0 / v716);
        self.scalar_v878 = v878;
        let v879: f64 = (if v877 { v878 } else { 0.0 });
        self.scalar_v879 = v879;
        let v880: bool = (!v877);
        self.scalar_v880 = v880;
        let v881: f64 = (if v880 { 0.0 } else { v879 });
        self.scalar_v881 = v881;
        let v882: bool = (v720 > 0.0);
        self.scalar_v882 = v882;
        let v883: f64 = (1.0 / v720);
        self.scalar_v883 = v883;
        let v884: f64 = (if v882 { v883 } else { 0.0 });
        self.scalar_v884 = v884;
        let v885: bool = (!v882);
        self.scalar_v885 = v885;
        let v886: f64 = (if v885 { 0.0 } else { v884 });
        self.scalar_v886 = v886;
        let v887: bool = (v723 > 0.0);
        self.scalar_v887 = v887;
        let v888: f64 = (1.0 / v723);
        self.scalar_v888 = v888;
        let v889: f64 = (if v887 { v888 } else { 0.0 });
        self.scalar_v889 = v889;
        let v890: bool = (!v887);
        self.scalar_v890 = v890;
        let v891: f64 = (if v890 { 0.0 } else { v889 });
        self.scalar_v891 = v891;
        let v892: bool = (v53 > 0.0);
        self.scalar_v892 = v892;
        let v935: bool = (v782 && v892);
        self.scalar_v935 = v935;
        let v1031: f64 = (v591 * p.p14);
        self.scalar_v1031 = v1031;
        let v1035: f64 = (v267 * 3.20435313e-19);
        self.scalar_v1035 = v1035;
        let v1036: f64 = (v734 * v1035);
        self.scalar_v1036 = v1036;
        let v1049: f64 = p.p3;
        self.scalar_v1049 = v1049;
        let v1050: bool = (p.p3 > 0.0);
        self.scalar_v1050 = v1050;
        let v1055: f64 = p.p4;
        self.scalar_v1055 = v1055;
        let v1056: bool = (p.p4 > 0.0);
        self.scalar_v1056 = v1056;
        let v1057: bool = (v843 > 0.0);
        self.scalar_v1057 = v1057;
        let v1058: bool = (v1056 && v1057);
        self.scalar_v1058 = v1058;
        let v1518: f64 = (v724 * 3.20435313e-19);
        self.scalar_v1518 = v1518;
        let v1519: f64 = (v734 * v1518);
        self.scalar_v1519 = v1519;
        let v1535: bool = (v844 > 0.0);
        self.scalar_v1535 = v1535;
        let v1536: bool = (v1056 && v1535);
        self.scalar_v1536 = v1536;
        let v1860: f64 = (-v424);
        self.scalar_v1860 = v1860;
        let v2424: f64 = (v463 * v463);
        self.scalar_v2424 = v2424;
        let v2506: f64 = (-v843);
        self.scalar_v2506 = v2506;
        let v2517: f64 = (v731 * v731);
        ...
        let v2611: f64 = p.p31;
        self.scalar_v2611 = v2611;
        let v2612: f64 = (v178 * p.p31);
        self.scalar_v2612 = v2612;
        let v2626: f64 = (0.0 * p.p31);
        self.scalar_v2626 = v2626;
        let v2628: f64 = (v876 * v2612);
        self.scalar_v2628 = v2628;
        let v2633: f64 = (v881 * v2612);
        self.scalar_v2633 = v2633;
        let v2638: f64 = (v886 * v2612);
        self.scalar_v2638 = v2638;
        let v2643: f64 = (v891 * v2612);
        self.scalar_v2643 = v2643;
        let v2662: f64 = (if v892 { 1.0 } else { 0.0 });
        self.scalar_v2662 = v2662;
        let v2663: f64 = (if v892 { v2662 } else { 0.0 });
        self.scalar_v2663 = v2663;
        let v2667: f64 = (if v892 { v2663 } else { 0.0 });
        self.scalar_v2667 = v2667;
        let v2668: f64 = (v2 * v2663);
        self.scalar_v2668 = v2668;
        let v2669: f64 = (-v2668);
        self.scalar_v2669 = v2669;
        let v2672: f64 = (8.617332384961e-5 * v2663);
        self.scalar_v2672 = v2672;
        let v2673: f64 = (if v892 { v2672 } else { 0.0 });
        self.scalar_v2673 = v2673;
        let v2674: f64 = (-v2673);
        self.scalar_v2674 = v2674;
        let v2704: f64 = (0.0033333333333 * v2663);
        self.scalar_v2704 = v2704;
        let v2717: f64 = (v803 * v2667);
        self.scalar_v2717 = v2717;
        let v2742: f64 = (v398 * v2673);
        self.scalar_v2742 = v2742;
        let v2743: f64 = (if v892 { v2742 } else { 0.0 });
        self.scalar_v2743 = v2743;
        let v2745: f64 = (v459 * v2667);
        self.scalar_v2745 = v2745;
        let v2758: f64 = (v730 * v2667);
        self.scalar_v2758 = v2758;
        let v2776: f64 = (if v793 { -1.0 } else { 0.0 });
        self.scalar_v2776 = v2776;
        let v2777: f64 = (if v793 { 1.0 } else { 0.0 });
        self.scalar_v2777 = v2777;
        let v2778: f64 = (if v798 { 1.0 } else { v2776 });
        self.scalar_v2778 = v2778;
        let v2779: f64 = (if v798 { -1.0 } else { v2777 });
        self.scalar_v2779 = v2779;
        let v2780: f64 = (-v2778);
        self.scalar_v2780 = v2780;
        let v2781: f64 = (-v2779);
        self.scalar_v2781 = v2781;
        let v2782: f64 = (v2778 + v2780);
        self.scalar_v2782 = v2782;
        let v2783: f64 = (v2778 + v2779);
        self.scalar_v2783 = v2783;
        let v2800: f64 = (-v2782);
        self.scalar_v2800 = v2800;
        let v5884: f64 = (v433 * v2782);
        self.scalar_v5884 = v5884;
        let v5885: f64 = (v433 * v2781);
        self.scalar_v5885 = v5885;
        let v5886: f64 = (v433 * v2779);
        self.scalar_v5886 = v5886;
        let v5992: f64 = (v433 * v2780);
        self.scalar_v5992 = v5992;
        let v7014: f64 = (v433 * v2778);
        self.scalar_v7014 = v7014;
        let v7348: f64 = (v2424 * v2779);
        self.scalar_v7348 = v7348;
        let v7349: f64 = (v2424 * v2778);
        self.scalar_v7349 = v7349;
        let v7510: f64 = (v470 * v2780);
        self.scalar_v7510 = v7510;
        let v7511: f64 = (v470 * v2781);
        self.scalar_v7511 = v7511;
        let v7617: f64 = (v2506 * v2780);
        self.scalar_v7617 = v7617;
        let v7618: f64 = (v2506 * v2781);
        self.scalar_v7618 = v7618;
        let v7674: f64 = (v2517 * v2783);
        self.scalar_v7674 = v7674;
        let v7675: f64 = (v2517 * v2779);
        self.scalar_v7675 = v7675;
        let v7676: f64 = (v2517 * v2778);
        self.scalar_v7676 = v7676;
        let v7848: f64 = (v732 * v2778);
        self.scalar_v7848 = v7848;
        let v7849: f64 = (v732 * v2779);
        self.scalar_v7849 = v7849;
        let v7955: f64 = (v2593 * v2778);
        self.scalar_v7955 = v7955;
        let v7956: f64 = (v2593 * v2779);
        self.scalar_v7956 = v7956;
        let v8072: f64 = (-v2626);
        self.scalar_v8072 = v8072;
        let v8073: f64 = (-v2628);
        self.scalar_v8073 = v8073;
        let v8074: f64 = (if v872 { v2628 } else { 0.0 });
        self.scalar_v8074 = v8074;
        let v8075: f64 = (if v872 { v8073 } else { 0.0 });
        self.scalar_v8075 = v8075;
        let v8076: f64 = (-v2633);
        self.scalar_v8076 = v8076;
        let v8077: f64 = (if v877 { v2633 } else { 0.0 });
        self.scalar_v8077 = v8077;
        let v8078: f64 = (if v877 { v8076 } else { 0.0 });
        self.scalar_v8078 = v8078;
        let v8079: f64 = (-v2638);
        self.scalar_v8079 = v8079;
        let v8080: f64 = (if v882 { v2638 } else { 0.0 });
        self.scalar_v8080 = v8080;
        let v8081: f64 = (if v882 { v8079 } else { 0.0 });
        self.scalar_v8081 = v8081;
        let v8082: f64 = (-v2643);
        self.scalar_v8082 = v8082;
        let v8083: f64 = (if v887 { v2643 } else { 0.0 });
        self.scalar_v8083 = v8083;
        let v8084: f64 = (if v887 { v8082 } else { 0.0 });
    ...
    fn recompute_temperature_static(&mut self, temperature: f64, thermal_voltage: f64) {
        ...
        self.scalar_v58 = v58;
        let v234: f64 = (if self.scalar_v167 { self.scalar_v233 } else { self.scalar_v8 });
        self.scalar_v234 = v234;
        let v235: f64 = (self.scalar_v234 / self.scalar_v180);
        self.scalar_v235 = v235;
        let v236: f64 = (if self.scalar_v167 { self.scalar_v235 } else { 0.0 });
        self.scalar_v236 = v236;
        let v239: f64 = (if self.scalar_v167 { self.scalar_v238 } else { self.scalar_v234 });
        self.scalar_v239 = v239;
        let v240: f64 = (self.scalar_v239 / self.scalar_v180);
        self.scalar_v240 = v240;
        let v241: f64 = (if self.scalar_v167 { self.scalar_v240 } else { 0.0 });
        self.scalar_v241 = v241;
        let v281: f64 = (if self.scalar_v167 { self.scalar_v280 } else { self.scalar_v239 });
        self.scalar_v281 = v281;
        let v341: f64 = (if self.scalar_v167 { self.scalar_v340 } else { self.scalar_v281 });
        self.scalar_v341 = v341;
        let v343: f64 = (self.scalar_v341 * self.scalar_v342);
        self.scalar_v343 = v343;
        let v344: f64 = (if self.scalar_v167 { self.scalar_v343 } else { self.scalar_v87 });
        self.scalar_v344 = v344;
        let v480: f64 = (if self.scalar_v167 { self.scalar_v479 } else { self.scalar_v341 });
        self.scalar_v480 = v480;
        let v490: f64 = (if self.scalar_v167 { self.scalar_v489 } else { self.scalar_v480 });
        self.scalar_v490 = v490;
        let v497: f64 = (if self.scalar_v167 { self.scalar_v496 } else { self.scalar_v490 });
        self.scalar_v497 = v497;
        let v499: f64 = (self.scalar_v497 * self.scalar_v498);
        self.scalar_v499 = v499;
        let v500: f64 = (if self.scalar_v167 { self.scalar_v499 } else { self.scalar_v497 });
        self.scalar_v500 = v500;
        let v510: f64 = (if self.scalar_v167 { self.scalar_v509 } else { self.scalar_v500 });
        self.scalar_v510 = v510;
        let v512: bool = (self.scalar_v510 > 1e-15);
        self.scalar_v512 = v512;
        let v513: f64 = (if self.scalar_v512 { self.scalar_v510 } else { 1e-15 });
        self.scalar_v513 = v513;
        let v514: f64 = (if self.scalar_v167 { self.scalar_v513 } else { self.scalar_v510 });
        self.scalar_v514 = v514;
        let v566: f64 = (if self.scalar_v535 { self.scalar_v565 } else { self.scalar_v514 });
        self.scalar_v566 = v566;
        let v583: f64 = (if self.scalar_v535 { self.scalar_v582 } else { self.scalar_v566 });
        self.scalar_v583 = v583;
        let v586: f64 = (if self.scalar_v167 { self.scalar_v585 } else { self.scalar_v583 });
        self.scalar_v586 = v586;
        let v588: f64 = (self.scalar_v586 * self.scalar_v587);
        self.scalar_v588 = v588;
        let v589: f64 = (if self.scalar_v167 { self.scalar_v588 } else { self.scalar_v149 });
        self.scalar_v589 = v589;
        let v593: f64 = (self.scalar_v236 * self.scalar_v592);
        self.scalar_v593 = v593;
        let v594: f64 = (1.0 + self.scalar_v593);
        self.scalar_v594 = v594;
        let v596: f64 = (self.scalar_v241 * self.scalar_v595);
        self.scalar_v596 = v596;
        let v597: f64 = (self.scalar_v594 + self.scalar_v596);
        self.scalar_v597 = v597;
        let v599: f64 = (self.scalar_v236 * self.scalar_v598);
        self.scalar_v599 = v599;
        let v600: f64 = (self.scalar_v241 * self.scalar_v599);
        self.scalar_v600 = v600;
        let v601: f64 = (self.scalar_v597 + self.scalar_v600);
        self.scalar_v601 = v601;
        let v602: bool = (self.scalar_v601 > 1e-10);
        self.scalar_v602 = v602;
        let v603: f64 = (if self.scalar_v602 { self.scalar_v601 } else { 1e-10 });
        self.scalar_v603 = v603;
        let v604: f64 = (if self.scalar_v167 { self.scalar_v603 } else { self.scalar_v586 });
        self.scalar_v604 = v604;
        let v663: f64 = (self.scalar_v604 / self.scalar_v662);
        self.scalar_v663 = v663;
        let v664: f64 = (if self.scalar_v167 { self.scalar_v663 } else { self.scalar_v604 });
        self.scalar_v664 = v664;
        let v665: f64 = (self.scalar_v46 / self.scalar_v664);
        self.scalar_v665 = v665;
        let v666: f64 = (if self.scalar_v167 { self.scalar_v665 } else { 0.0 });
        self.scalar_v666 = v666;
        let v667: bool = (self.scalar_v666 > 1e-6);
        self.scalar_v667 = v667;
        let v668: f64 = (if self.scalar_v667 { self.scalar_v666 } else { 1e-6 });
        self.scalar_v668 = v668;
        let v669: f64 = (if self.scalar_v167 { self.scalar_v668 } else { self.scalar_v152 });
        self.scalar_v669 = v669;
        let v673: f64 = (self.scalar_v664 * self.scalar_v672);
        self.scalar_v673 = v673;
        let v674: f64 = (if self.scalar_v167 { self.scalar_v673 } else { 0.0 });
        self.scalar_v674 = v674;
        let v675: bool = (self.scalar_v674 > 0.0);
        self.scalar_v675 = v675;
        let v676: f64 = (if self.scalar_v675 { self.scalar_v674 } else { 0.0 });
        self.scalar_v676 = v676;
        let v677: f64 = (if self.scalar_v167 { self.scalar_v676 } else { self.scalar_v156 });
        self.scalar_v677 = v677;
        let v737: f64 = (self.scalar_v54 * 0.000473);
        self.scalar_v737 = v737;
        let v739: f64 = (self.scalar_v39 + 636.0);
        self.scalar_v739 = v739;
        let v740: f64 = (self.scalar_v737 / self.scalar_v739);
        self.scalar_v740 = v740;
        let v741: f64 = (1.17 - self.scalar_v740);
        self.scalar_v741 = v741;
        let v744: f64 = (self.scalar_v54 * 0.0004774);
        self.scalar_v744 = v744;
        let v746: f64 = (self.scalar_v39 + 235.0);
        self.scalar_v746 = v746;
        let v747: f64 = (self.scalar_v744 / self.scalar_v746);
        self.scalar_v747 = v747;
        let v748: f64 = (0.744 - self.scalar_v747);
        self.scalar_v748 = v748;
        let v749: f64 = (self.scalar_v748 - self.scalar_v741);
        self.scalar_v749 = v749;
        let v752: f64 = (self.scalar_v749 + self.scalar_v751);
        self.scalar_v752 = v752;
        let v753: f64 = (self.scalar_v260 * self.scalar_v752);
        self.scalar_v753 = v753;
        let v754: f64 = (self.scalar_v741 + self.scalar_v753);
        self.scalar_v754 = v754;
        let v755: f64 = (0.5 * self.scalar_v754);
        self.scalar_v755 = v755;
        let v756: f64 = (self.scalar_v58 * self.scalar_v755);
        self.scalar_v756 = v756;
        let v757: f64 = (0.5 * self.scalar_v753);
        self.scalar_v757 = v757;
        let v760: f64 = (self.scalar_v39 * 0.0033333333333);
        self.scalar_v760 = v760;
        let v761: f64 = ((self.scalar_v760) as f64).sqrt();
        self.scalar_v761 = v761;
        let v763: f64 = (self.scalar_v761 * 4.05e25);
        self.scalar_v763 = v763;
        let v764: f64 = (self.scalar_v761 * self.scalar_v763);
        self.scalar_v764 = v764;
        let v765: f64 = (self.scalar_v761 * self.scalar_v764);
        self.scalar_v765 = v765;
        let v766: f64 = (self.scalar_v58 * self.scalar_v757);
        self.scalar_v766 = v766;
        let v767: f64 = ((self.scalar_v766) as f64).exp();
        self.scalar_v767 = v767;
        let v768: f64 = (self.scalar_v765 * self.scalar_v767);
        self.scalar_v768 = v768;
        let v775: f64 = (self.scalar_v56 * self.scalar_v262);
        self.scalar_v775 = v775;
        let v776: f64 = (1.0 + self.scalar_v775);
        self.scalar_v776 = v776;
        let v777: f64 = (self.scalar_v57 * self.scalar_v776);
        self.scalar_v777 = v777;
        let v783: f64 = (self.scalar_v309 / self.scalar_v768);
        self.scalar_v783 = v783;
        let v784: f64 = ((self.scalar_v783) as f64).ln();
        self.scalar_v784 = v784;
        let v785: f64 = (self.scalar_v756 + self.scalar_v784);
        self.scalar_v785 = v785;
        let v786: f64 = (self.scalar_v57 * self.scalar_v785);
        self.scalar_v786 = v786;
        let v787: f64 = (if self.scalar_v782 { self.scalar_v786 } else { 0.0 });
        self.scalar_v787 = v787;
        let v805: f64 = ((self.scalar_v56) as f64).ln();
        self.scalar_v805 = v805;
        let v809: f64 = (self.scalar_v805 * self.scalar_v808);
        self.scalar_v809 = v809;
        let v810: f64 = ((self.scalar_v809) as f64).exp();
        self.scalar_v810 = v810;
        let v811: f64 = (self.scalar_v401 * self.scalar_v810);
        self.scalar_v811 = v811;
        let v812: f64 = (self.scalar_v725 * self.scalar_v810);
        self.scalar_v812 = v812;
        let v813: f64 = (self.scalar_v413 * self.scalar_v810);
        self.scalar_v813 = v813;
        let v814: f64 = (self.scalar_v727 * self.scalar_v810);
        self.scalar_v814 = v814;
        let v816: f64 = (self.scalar_v805 * self.scalar_v815);
        self.scalar_v816 = v816;
        let v817: f64 = ((self.scalar_v816) as f64).exp();
        self.scalar_v817 = v817;
        let v818: f64 = (self.scalar_v407 * self.scalar_v817);
        self.scalar_v818 = v818;
        let v819: f64 = (self.scalar_v726 * self.scalar_v817);
        self.scalar_v819 = v819;
        let v839: f64 = (self.scalar_v57 * self.scalar_v398);
        self.scalar_v839 = v839;
        let v847: f64 = (self.scalar_v55 * self.scalar_v459);
        self.scalar_v847 = v847;
        let v848: f64 = (1.0 + self.scalar_v847);
        self.scalar_v848 = v848;
        let v849: f64 = (self.scalar_v848 * self.scalar_v848);
        self.scalar_v849 = v849;
        let v850: f64 = (0.01 + self.scalar_v849);
        self.scalar_v850 = v850;
        let v851: f64 = ((self.scalar_v850) as f64).sqrt();
        self.scalar_v851 = v851;
        let v852: f64 = (self.scalar_v848 + self.scalar_v851);
        self.scalar_v852 = v852;
        let v853: f64 = (0.5 * self.scalar_v852);
        self.scalar_v853 = v853;
        let v854: f64 = (self.scalar_v455 * self.scalar_v853);
        self.scalar_v854 = v854;
        let v855: f64 = (self.scalar_v846 * self.scalar_v854);
        self.scalar_v855 = v855;
        let v856: f64 = (self.scalar_v55 * self.scalar_v730);
        self.scalar_v856 = v856;
        let v857: f64 = (1.0 + self.scalar_v856);
        self.scalar_v857 = v857;
        let v858: f64 = (self.scalar_v857 * self.scalar_v857);
        self.scalar_v858 = v858;
        let v859: f64 = (0.01 + self.scalar_v858);
        self.scalar_v859 = v859;
        let v860: f64 = ((self.scalar_v859) as f64).sqrt();
        self.scalar_v860 = v860;
        let v861: f64 = (self.scalar_v857 + self.scalar_v860);
        self.scalar_v861 = v861;
        let v862: f64 = (0.5 * self.scalar_v861);
        self.scalar_v862 = v862;
        let v863: f64 = (self.scalar_v729 * self.scalar_v862);
        self.scalar_v863 = v863;
        let v864: f64 = (self.scalar_v846 * self.scalar_v863);
        self.scalar_v864 = v864;
        let v865: f64 = (self.scalar_v526 * self.scalar_v805);
        self.scalar_v865 = v865;
        let v866: f64 = ((self.scalar_v865) as f64).exp();
        self.scalar_v866 = v866;
        let v867: f64 = (self.scalar_v806 * self.scalar_v866);
        self.scalar_v867 = v867;
        let v869: f64 = (self.scalar_v671 * self.scalar_v805);
        self.scalar_v869 = v869;
        let v870: f64 = ((self.scalar_v869) as f64).exp();
        self.scalar_v870 = v870;
        let v871: f64 = (self.scalar_v669 * self.scalar_v870);
        self.scalar_v871 = v871;
        let v1297: bool = (self.scalar_v589 > 0.0);
        self.scalar_v1297 = v1297;
        let v2713: f64 = (self.scalar_v344 * self.scalar_v2667);
        self.scalar_v2713 = v2713;
        let v2715: f64 = (self.scalar_v785 * self.scalar_v2673);
        self.scalar_v2715 = v2715;
        let v2716: f64 = (if self.scalar_v935 { self.scalar_v2715 } else { 0.0 });
        self.scalar_v2716 = v2716;
        let v8027: f64 = (self.scalar_v677 * self.scalar_v2662);
        self.scalar_v8027 = v8027;
        let v8028: f64 = (if self.scalar_v892 { self.scalar_v8027 } else { 0.0 });
        self.scalar_v8028 = v8028;
        let v8029: f64 = (if self.scalar_v2604 { 0.0 } else { self.scalar_v8028 });
        self.scalar_v8029 = v8029;
        let v8053: f64 = (self.scalar_v178 * self.scalar_v8029);
        self.scalar_v8053 = v8053;
