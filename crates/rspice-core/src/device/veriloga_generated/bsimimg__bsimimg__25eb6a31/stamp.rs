...
pub(crate) struct StampLocals {
    ...
    pub(crate) f984: f64, pub(crate) f985: f64,
}
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        let p = Box::as_ref(&self.params);let nodes = &(*self).nodes;let branches = &(*self).branches;let param_given = self.param_given.as_ref();let multiplicity = (*self).multiplicity;let timestep = (*self).timestep;let ddt_state_current = self.ddt_state_current.as_mut();let ddt_state_previous = self.ddt_state_previous.as_mut();let ddt_state_older = self.ddt_state_older.as_mut();let ddt_state_initialized = self.ddt_state_initialized.as_mut();let ddt_derivative_current = self.ddt_derivative_current.as_mut();let ddt_derivative_previous = self.ddt_derivative_previous.as_mut();let ddt_active = self.ddt_coefficients.active;let ddt_scale = self.ddt_coefficients.derivative_scale;let ddt_previous_value_scale = self.ddt_coefficients.previous_value_scale;let ddt_older_value_scale = self.ddt_coefficients.older_value_scale;let ddt_previous_derivative_scale = self.ddt_coefficients.previous_derivative_scale;let mut l = StampLocals::default();Self::stamp_transient_block_0(p, &mut l);Self::stamp_transient_block_1(p, &mut l);Self::stamp_transient_block_2(p, &mut l);Self::stamp_transient_block_3(p, &mut l);Self::stamp_transient_block_4(p, &mut l);Self::stamp_transient_block_5(p, &mut l);Self::stamp_transient_block_6(p, &mut l);Self::stamp_transient_block_7(p, &mut l);Self::stamp_transient_block_8(p, &mut l);Self::stamp_transient_block_9(p, &mut l);Self::stamp_transient_block_10(p, &mut l);Self::stamp_transient_block_11(p, &mut l);Self::stamp_transient_block_12(p, param_given, &mut l);Self::stamp_transient_block_13(p, &mut l);Self::stamp_transient_block_14(p, &mut l);Self::stamp_transient_block_15(p, &mut l);Self::stamp_transient_block_16(p, &mut l);Self::stamp_transient_block_17(ctx, p, nodes, &mut l);Self::stamp_transient_block_18(p, param_given, &mut l);Self::stamp_transient_block_19(p, &mut l);Self::stamp_transient_block_20(p, &mut l);Self::stamp_transient_block_21(p, &mut l);Self::stamp_transient_block_22(ctx, p, nodes, &mut l);Self::stamp_transient_block_23(p, &mut l);Self::stamp_transient_block_24(p, &mut l);Self::stamp_transient_block_25(&mut l);Self::stamp_transient_block_26(p, &mut l);Self::stamp_transient_block_27(p, &mut l);Self::stamp_transient_block_28(&mut l);Self::stamp_transient_block_29(&mut l);Self::stamp_transient_block_30(&mut l);Self::stamp_transient_block_31(&mut l);Self::stamp_transient_block_32(&mut l);Self::stamp_transient_block_33(&mut l);Self::stamp_transient_block_34(&mut l);Self::stamp_transient_block_35(&mut l);Self::stamp_transient_block_36(&mut l);Self::stamp_transient_block_37(p, &mut l);Self::stamp_transient_block_38(p, &mut l);Self::stamp_transient_block_39(p, &mut l);Self::stamp_transient_block_40(&mut l);Self::stamp_transient_block_41(&mut l);Self::stamp_transient_block_42(&mut l);Self::stamp_transient_block_43(&mut l);Self::stamp_transient_block_44(&mut l);Self::stamp_transient_block_45(&mut l);Self::stamp_transient_block_46(&mut l);Self::stamp_transient_block_47(&mut l);Self::stamp_transient_block_48(&mut l);Self::stamp_transient_block_49(p, &mut l);Self::stamp_transient_block_50(p, &mut l);Self::stamp_transient_block_51(p, &mut l);Self::stamp_transient_block_52(p, &mut l);Self::stamp_transient_block_53(p, &mut l);Self::stamp_transient_block_54(p, &mut l);Self::stamp_transient_block_55(ctx, p, nodes, &mut l);Self::stamp_transient_block_56(ctx, p, nodes, &mut l);Self::stamp_transient_block_57(p, &mut l);Self::stamp_transient_block_58(p, &mut l);Self::stamp_transient_block_59(p, &mut l);Self::stamp_transient_block_60(p, &mut l);Self::stamp_transient_block_61(p, &mut l);Self::stamp_transient_block_62(p, &mut l);Self::stamp_transient_block_63(p, &mut l);
        ...
        stamper.stamp_potential_branch_local(
            ...
            4,
            multiplicity,
        );Self::stamp_transient_equations_block_0(ctx, stamper, nodes, multiplicity, &mut l);Self::stamp_transient_equations_block_1(stamper, multiplicity, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, &mut l);Self::stamp_transient_equations_block_2(ctx, stamper, nodes, multiplicity, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, &mut l);Self::stamp_transient_equations_block_3(ctx, stamper, nodes, multiplicity, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, &mut l);
    }
    pub fn stamp_reactive(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedReactiveStamper<'_>) {
        let p = Box::as_ref(&self.params);let nodes = &(*self).nodes;let branches = &(*self).branches;let param_given = self.param_given.as_ref();let multiplicity = (*self).multiplicity;let mut l = StampLocals::default();Self::stamp_reactive_block_0(p, &mut l);Self::stamp_reactive_block_1(p, &mut l);Self::stamp_reactive_block_2(p, &mut l);Self::stamp_reactive_block_3(p, &mut l);Self::stamp_reactive_block_4(p, &mut l);Self::stamp_reactive_block_5(p, &mut l);Self::stamp_reactive_block_6(p, &mut l);Self::stamp_reactive_block_7(p, &mut l);Self::stamp_reactive_block_8(p, &mut l);Self::stamp_reactive_block_9(p, &mut l);Self::stamp_reactive_block_10(p, &mut l);Self::stamp_reactive_block_11(p, &mut l);Self::stamp_reactive_block_12(p, &mut l);Self::stamp_reactive_block_13(p, param_given, &mut l);Self::stamp_reactive_block_14(p, &mut l);Self::stamp_reactive_block_15(p, &mut l);Self::stamp_reactive_block_16(p, &mut l);Self::stamp_reactive_block_17(p, &mut l);Self::stamp_reactive_block_18(ctx, p, nodes, &mut l);Self::stamp_reactive_block_19(p, param_given, &mut l);Self::stamp_reactive_block_20(p, &mut l);Self::stamp_reactive_block_21(&mut l);Self::stamp_reactive_block_22(p, &mut l);Self::stamp_reactive_block_23(p, &mut l);Self::stamp_reactive_block_24(ctx, p, nodes, &mut l);Self::stamp_reactive_block_25(p, &mut l);Self::stamp_reactive_block_26(p, &mut l);Self::stamp_reactive_block_27(p, &mut l);Self::stamp_reactive_block_28(p, &mut l);Self::stamp_reactive_block_29(p, &mut l);Self::stamp_reactive_block_30(p, &mut l);Self::stamp_reactive_block_31(&mut l);Self::stamp_reactive_block_32(&mut l);Self::stamp_reactive_block_33(&mut l);Self::stamp_reactive_block_34(&mut l);Self::stamp_reactive_block_35(&mut l);Self::stamp_reactive_block_36(&mut l);Self::stamp_reactive_block_37(&mut l);Self::stamp_reactive_block_38(&mut l);Self::stamp_reactive_block_39(&mut l);Self::stamp_reactive_block_40(&mut l);Self::stamp_reactive_block_41(&mut l);Self::stamp_reactive_block_42(p, &mut l);Self::stamp_reactive_block_43(p, &mut l);Self::stamp_reactive_block_44(p, &mut l);Self::stamp_reactive_block_45(p, &mut l);Self::stamp_reactive_block_46(&mut l);Self::stamp_reactive_block_47(&mut l);Self::stamp_reactive_block_48(&mut l);Self::stamp_reactive_block_49(&mut l);Self::stamp_reactive_block_50(&mut l);Self::stamp_reactive_block_51(&mut l);Self::stamp_reactive_block_52(&mut l);Self::stamp_reactive_block_53(&mut l);Self::stamp_reactive_block_54(&mut l);Self::stamp_reactive_block_55(&mut l);Self::stamp_reactive_block_56(&mut l);Self::stamp_reactive_block_57(p, &mut l);Self::stamp_reactive_block_58(p, &mut l);Self::stamp_reactive_block_59(p, &mut l);Self::stamp_reactive_block_60(p, &mut l);Self::stamp_reactive_block_61(p, &mut l);Self::stamp_reactive_block_62(p, &mut l);Self::stamp_reactive_block_63(p, &mut l);Self::stamp_reactive_block_64(ctx, p, nodes, &mut l);Self::stamp_reactive_block_65(ctx, p, nodes, &mut l);Self::stamp_reactive_block_66(p, &mut l);Self::stamp_reactive_block_67(p, &mut l);Self::stamp_reactive_block_68(p, &mut l);Self::stamp_reactive_block_69(p, &mut l);Self::stamp_reactive_block_70(p, &mut l);Self::stamp_reactive_block_71(p, &mut l);Self::stamp_reactive_block_72(p, &mut l);Self::stamp_reactive_equations_block_0(ctx, stamper, nodes, multiplicity, &mut l);
    }
}
