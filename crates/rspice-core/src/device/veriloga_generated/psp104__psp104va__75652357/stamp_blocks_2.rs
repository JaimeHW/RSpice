...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (((s.b[2204] && s.b[2213]) && (!s.b[2217])) && (!s.b[2218])) {
            s.store_scaled_softlimit_poly_offset_lhs_ad_rhs(1947, 1946, (-230.25850929940458), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0)), 0.5, 1.0, 1.0, 1e100);
        }
