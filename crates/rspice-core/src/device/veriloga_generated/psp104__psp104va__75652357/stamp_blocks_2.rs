...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (((s.b[2204] && s.b[2213]) && (!s.b[2217])) && s.b[2218]) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(1947, 1e-100, (-230.25850929940458), 1946, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1946), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (((s.b[2204] && s.b[2213]) && (!s.b[2219])) && s.b[2220]) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(1919, 1e-100, (-230.25850929940458), 1946, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1946), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (s.b[2204] && s.b[2213]) {
            s.store_mul_ad_product_rhs(1949, 231, s.ad_value(1937), A::ln(A::div_scaled_offset_numerator(s.ad_value(1947), 1.0, 1.0, A::offset(s.ad_value(1948), 1.0), 1.0)));
        }
        ...
        if ((s.b[2204] && s.b[2213]) && (!s.b[2223])) {
            ...
            s.store_mul_sub_from_scalar_scaled_rhs_scaled_output(1953, 1952, 1.0, 1952, 1.0, 0.5);
            s.store_sub_from_scalar_scaled_input(1954, 0.5, 1953, 3.0);
        }
        ...
        if (((s.b[2204] && s.b[2213]) && (!s.b[2223])) && s.b[2224]) {
            ...
            s.store_add_scaled_offset_product_rhs_mixed_iia(1957, 1956, 0.5, 1951, A::mul(s.ad_value(1955), A::add_scaled_offset_product_rhs(A::scaled_offset(s.ad_value(1953), 0.25, 0.4), 1.0, s.ad_value(1955), s.ad_value(1953), 0.125, 0.0285714285714)), 1.0, (-0.16666666666666666));
        }
        ...
        if (((((s.b[2204] && s.b[2213]) && (!s.b[2223])) && (!s.b[2224])) && (!s.b[2225])) && s.b[2226]) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(1959, 1e-100, (-230.25850929940458), 1951, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1951), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }

        if (((((s.b[2204] && s.b[2213]) && (!s.b[2223])) && (!s.b[2224])) && (!s.b[2225])) && (!s.b[2226])) {
            s.store_scaled_offset_mul_offset_lhs_ad_rhs(1959, 1951, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(1951), (-230.25850929940458), A::scale_offset(s.ad_value(1951), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0, 1e100);
        }
        ...
        if (((s.b[2204] && s.b[2213]) && (!s.b[2223])) && (!s.b[2224])) {
            ...
            s.store_add_scaled_products_left_left_ad(1956, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(1952), s.ad_value(1919)), 1958, 0.5, 1952, 1921, 0.5);
        ...
        if ((s.b[2227] && s.b[2228]) && (!s.b[2229])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(1921, 1e-100, (-230.25850929940458), 1919, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1919), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if s.b[2232] {
            ...
            s.store_offset_div_scaled_inputs(1982, s.ad_value(755), 1.0, A::sqrt(s.ad_value(1979)), 2.0, 1.0);
        ...
        if ((s.b[2232] && s.b[2233]) && (!s.b[2234])) {
            s.store_scaled_offset_mul_offset_lhs_ad(1989, A::sub(s.ad_value(1984), s.ad_value(1988)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(1984), s.ad_value(1988)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(1984), s.ad_value(1988)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0, 1e100);
        }
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        if ((s.b[2232] && (!s.b[2233])) && (!s.b[2235])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad(1975, 1e-100, (-230.25850929940458), A::mul(s.ad_value(1983), A::add(s.ad_value(1984), s.ad_value(719))), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::mul(s.ad_value(1983), A::add(s.ad_value(1984), s.ad_value(719))), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if ((s.b[2232] && s.b[2236]) && (!s.b[2237])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad(1919, 1e-100, (-230.25850929940458), A::sub(s.ad_value(1974), s.ad_value(1976)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::sub(s.ad_value(1974), s.ad_value(1976)), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (((s.b[2232] && (!s.b[2236])) && (!s.b[2238])) && (!s.b[2240])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad(1977, 1e-100, (-230.25850929940458), A::mul(s.ad_value(1983), A::add(s.ad_value(1984), s.ad_value(719))), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::mul(s.ad_value(1983), A::add(s.ad_value(1984), s.ad_value(719))), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (((s.b[2241] && s.b[2242]) && (!s.b[2243])) && s.b[2244]) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad(1919, 1e-100, (-230.25850929940458), A::neg(s.ad_value(1921)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::neg(s.ad_value(1921)), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }

        if (((s.b[2241] && s.b[2242]) && (!s.b[2243])) && (!s.b[2244])) {
            s.store_scaled_offset_mul_offset_lhs_ad(1919, A::neg(s.ad_value(1921)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::neg(s.ad_value(1921)), (-230.25850929940458), A::scale_offset(A::neg(s.ad_value(1921)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0, 1e100);
        }
        ...
        if ((s.b[2241] && s.b[2242]) && s.b[2245]) {
            s.store_offset_div_scaled_inputs(1919, s.ad_value(841), 2.0, s.ad_value(229), 1.0, (-1.0));
        ...
        if ((s.b[2439] && s.b[2440]) && s.b[2442]) {
            ...
            s.store_offset_div_scaled_inputs(1920, s.ad_value(2282), 0.5, A::sqrt(s.ad_value(2292)), 1.0, 1.0);
            ...
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(1920, 2295, 0.5, 2298, 0.5, A::offset(A::mul(A::sub(s.ad_value(2295), s.ad_value(2298)), A::sub(s.ad_value(2295), s.ad_value(2298))), 20.0), 0.5);
            s.store_add_scaled_inputs3(1921, s.ad_value(2294), 2.0, s.ad_value(2293), (-2.0), s.ad_value(2296), -1.0);
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(2299, 1920, 0.5, 1921, 0.5, A::offset(A::mul(A::sub(s.ad_value(1920), s.ad_value(1921)), A::sub(s.ad_value(1920), s.ad_value(1921))), 20.0), (-0.5));
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(1920, 2299, 0.5, 2296, 0.5, A::offset(A::mul(A::sub(s.ad_value(2299), s.ad_value(2296)), A::sub(s.ad_value(2299), s.ad_value(2296))), 5.0), (-0.5));
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(2300, 1920, 0.5, 2296, ((-1.0) * 0.5), A::offset(A::mul(A::sub_scaled_inputs(s.ad_value(1920), 1.0, s.ad_value(2296), -1.0), A::sub_scaled_inputs(s.ad_value(1920), 1.0, s.ad_value(2296), -1.0)), 20.0), 0.5);
        ...
        if (((s.b[2439] && s.b[2440]) && s.b[2442]) && (!s.b[2443])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(2301, 1e-100, (-230.25850929940458), 1921, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1921), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if ((((s.b[2439] && s.b[2440]) && s.b[2444]) && (!s.b[2445])) && (!s.b[2446])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2330, 1e-200, 2315, (-460.51701859880916), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2315), (-460.51701859880916), A::scale_offset(s.ad_value(2315), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
        ...
        if ((s.b[2439] && s.b[2440]) && (!s.b[2444])) {
            s.store_offset_div_scaled_inputs(2316, s.ad_value(2290), 0.5, A::sqrt(s.ad_value(2315)), 1.0, 1.0);
        }
        ...
        if (((s.b[2439] && s.b[2440]) && s.b[2447]) && (!s.b[2448])) {
            s.store_scaled_offset_mul_offset_lhs_ad(1919, A::sub(s.ad_value(2318), s.ad_value(2321)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2318), s.ad_value(2321)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2318), s.ad_value(2321)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0, 1e100);
        }
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        if ((((s.b[2439] && s.b[2440]) && (!s.b[2451])) && s.b[2452]) && (!s.b[2453])) {
            s.store_scaled_offset_mul_offset_lhs_ad_rhs(2424, 2423, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2423), (-230.25850929940458), A::scale_offset(s.ad_value(2423), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0, 1e100);
        }
        ...
        if ((((s.b[2439] && s.b[2440]) && (!s.b[2451])) && (!s.b[2452])) && (!s.b[2454])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad(2414, 1e-100, (-230.25850929940458), A::neg(s.ad_value(2433)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::neg(s.ad_value(2433)), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (((((s.b[2439] && s.b[2440]) && (!s.b[2451])) && (!s.b[2452])) && (!s.b[2455])) && (!s.b[2456])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(2424, 1e-100, A::sub(s.ad_value(2315), s.ad_value(2438)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2315), s.ad_value(2438)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2315), s.ad_value(2438)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2425, 1e-100, 2438, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2438), (-230.25850929940458), A::scale_offset(s.ad_value(2438), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
        ...
        if ((((s.b[2439] && s.b[2440]) && s.b[2457]) && (!s.b[2458])) && (!s.b[2459])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(2334, 1e-100, A::sub(s.ad_value(2315), s.ad_value(2329)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2315), s.ad_value(2329)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2315), s.ad_value(2329)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2335, 1e-100, 2329, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2329), (-230.25850929940458), A::scale_offset(s.ad_value(2329), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        if (((s.b[2439] && s.b[2440]) && s.b[2457]) && s.b[2461]) {
            s.store_mul_product3_rhs(2346, 2342, s.ad_value(751), s.ad_value(2344), s.ad_value(2345), 1.0);
        ...
        if (((s.b[2439] && s.b[2467]) && s.b[2468]) && s.b[2471]) {
            ...
            s.store_mul_div_scaled_product_rhs(1921, 2362, s.ad_value(701), A::add(A::offset(s.ad_value(2360), (-1.0)), A::div_scalar_offset_denominator(1.0, s.ad_value(1919), 1.0, 1.0)), 1.0, s.ad_value(2359), 1.0);
            s.store_mul_product3_rhs(2363, 2358, s.ad_value(751), s.ad_value(2344), s.ad_value(2345), 1.0);
    ...
    pub(super) fn stamp_transient_block_36(
        ...
        if ((s.b[2439] && s.b[2467]) && (!s.b[2474])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2374, 1e-200, 2372, (-460.51701859880916), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2372), (-460.51701859880916), A::scale_offset(s.ad_value(2372), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
        ...
        if ((((s.b[2439] && s.b[2467]) && (!s.b[2475])) && (!s.b[2476])) && (!s.b[2477])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(2424, 1e-100, A::sub(s.ad_value(2373), s.ad_value(2438)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2373), s.ad_value(2438)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2373), s.ad_value(2438)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2425, 1e-100, 2438, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2438), (-230.25850929940458), A::scale_offset(s.ad_value(2438), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
        ...
        if (((s.b[2439] && s.b[2467]) && (!s.b[2479])) && (!s.b[2481])) {
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2382, 1e-100, 2376, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2376), (-230.25850929940458), A::scale_offset(s.ad_value(2376), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
            s.store_div_from_scalar_offset_mul_offset_lhs_ad(1919, 1e-100, A::sub(s.ad_value(2373), s.ad_value(2376)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2373), s.ad_value(2376)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2373), s.ad_value(2376)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
            s.store_add_scaled_product_right_ad(2385, 1919, 1.0, 2375, A::add(A::offset(s.ad_value(2376), 1.0), s.ad_value(2381)), (-1.0));
        }
        ...
        if (((s.b[2439] && s.b[2467]) && (!s.b[2483])) && s.b[2485]) {
            ...
            s.store_mul_product3_rhs(2397, 724, A::square(s.ad_value(1919)), s.ad_value(2291), s.ad_value(2390), 1.0);
        ...
        if (s.b[2439] && s.b[2467]) {
            s.store_mul_div_scaled_product_rhs(2404, 2305, s.ad_value(2291), s.ad_value(2390), 1.0, A::add_scaled_product(s.ad_value(2392), 1.0, s.ad_value(2290), s.ad_value(2394), 1.0), 1.0);
        ...
        if (s.b[2439] && s.b[2467]) {
            s.store_mul_product3_rhs(2346, 2404, s.ad_value(751), s.ad_value(2344), s.ad_value(2345), 1.0);
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        if s.b[2489] {
            s.store_mul_div_scaled_product_rhs(2246, 1889, A::add(s.ad_value(255), A::div(s.ad_value(256), s.ad_value(1886))), s.ad_value(1885), 1.0, s.ad_value(1886), 1.0);
        }
        ...
        if (s.b[2493] && s.b[2494]) {
            ...
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(1919, 2256, 0.5, 802, 0.5, A::add_scaled_product(s.ad_value(803), 1.0, A::sub(s.ad_value(2256), s.ad_value(802)), A::sub(s.ad_value(2256), s.ad_value(802)), 1.0), 0.5);
        ...
        if (((s.b[2493] && s.b[2495]) && (!s.b[2496])) && s.b[2497]) {
            s.store_div_from_scalar_offset_mul_offset_lhs_mixed_ia(2262, 1e-100, 2261, (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2261), (-230.25850929940458), A::scale_offset(s.ad_value(2261), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0), 1.0);
        }
        ...
        if ((s.b[2500] && s.b[2501]) && (!s.b[2502])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(2273, 1e-100, (-230.25850929940458), 1919, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1919), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        if ((s.b[2504] && s.b[2505]) && (!s.b[2506])) {
            s.store_div_from_scalar_offset_mul_sub_from_scalar_lhs_ad_rhs(2276, 1e-100, (-230.25850929940458), 1919, A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1919), 0.3333333333333333, 1.0, 0.5), 1.0), 1.0);
        }
        ...
        if (s.b[2555] && s.b[2556]) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[654]) {
                    s.store_mul_offset_ad_rhs(491, 655, A::sub(s.ad_value(490), s.ad_value(654)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if (s.b[2555] && s.b[2556]) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[656]) {
                    s.store_mul_offset_ad_rhs(491, 657, A::sub(s.ad_value(490), s.ad_value(656)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if ((s.b[2555] && s.b[2556]) && s.b[2557]) {
            s.store_mul_add_scaled_product_rhs(498, 826, s.ad_value(665), 1.0, s.ad_value(826), s.ad_value(666), 1.0);
        }
        ...
        if ((s.b[2555] && s.b[2556]) && (!s.b[2557])) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[658]) {
                    s.store_mul_offset_ad_rhs(491, 659, A::sub(s.ad_value(490), s.ad_value(658)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if (s.b[2555] && s.b[2556]) {
            s.store_add_scaled_inputs3(842, s.ad_value(496), 1.0, s.ad_value(497), 1.0, s.ad_value(498), 1.0);
        ...
        if (s.b[2555] && s.b[2556]) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[681]) {
                    s.store_mul_offset_ad_rhs(491, 682, A::sub(s.ad_value(490), s.ad_value(681)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if (s.b[2555] && s.b[2556]) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[683]) {
                    s.store_mul_offset_ad_rhs(491, 684, A::sub(s.ad_value(490), s.ad_value(683)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if ((s.b[2555] && s.b[2556]) && s.b[2558]) {
            s.store_mul_add_scaled_product_rhs(498, 827, s.ad_value(692), 1.0, s.ad_value(827), s.ad_value(693), 1.0);
        }
        ...
        if ((s.b[2555] && s.b[2556]) && (!s.b[2558])) {
            if (s.v[490] < (-230.25850929940458)) {
                ...
                if (s.v[490] > s.v[685]) {
                    s.store_mul_offset_ad_rhs(491, 686, A::sub(s.ad_value(490), s.ad_value(685)), 1.0);
                } else {
                    s.store_exp(491, 490);
                }
            }
        ...
        if (s.b[2555] && s.b[2556]) {
            s.store_add_scaled_inputs3(843, s.ad_value(496), 1.0, s.ad_value(497), 1.0, s.ad_value(498), 1.0);
    ...
    pub(super) fn stamp_transient_block_39(
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2580])) && (!s.b[2581])) {
            ...
            s.store_mul_offset_lhs_scaled_output(2534, 2520, (-1.0), 2533, s.v[378]);
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2580])) && (!s.b[2584])) {
            s.store_div_scaled_product_denominator_ad(2543, 2532, 2542, 1.0, A::add(s.ad_value(2532), s.ad_value(2542)), 1.0);
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2580])) && (!s.b[2584])) {
            s.store_div_scaled_inputs(2549, s.ad_value(2548), (s.v[429] * (1.772453850905516 * 0.5)), s.ad_value(2544), 1.0);
        ...
        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2580])) {
            s.store_mul_scale_ad_lhs(1900, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
    ...
    pub(super) fn stamp_transient_block_40(
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2598])) && (!s.b[2599])) {
            ...
            s.store_mul_offset_lhs_scaled_output(2534, 2520, (-1.0), 2533, s.v[379]);
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2598])) && (!s.b[2602])) {
            s.store_div_scaled_inputs(2549, s.ad_value(2548), (s.v[430] * (1.772453850905516 * 0.5)), s.ad_value(2544), 1.0);
        ...
        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2598])) {
            s.store_mul_scale_ad_lhs(1901, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2616])) && (!s.b[2617])) {
            ...
            s.store_mul_offset_lhs_scaled_output(2534, 2520, (-1.0), 2533, s.v[380]);
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2616])) && (!s.b[2620])) {
            s.store_div_scaled_inputs(2549, s.ad_value(2548), (s.v[431] * (1.772453850905516 * 0.5)), s.ad_value(2544), 1.0);
    ...
    pub(super) fn stamp_transient_block_41(
        ...
        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2616])) {
            s.store_mul_scale_ad_lhs(1902, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
        ...
        if (s.b[2555] && (!s.b[2556])) {
            s.store_add_scaled_products3(842, s.ad_value(640), s.ad_value(1900), 1.0, s.ad_value(641), s.ad_value(1901), 1.0, s.ad_value(642), s.ad_value(1902), 1.0);
        }
        ...
        if ((s.b[2555] && (!s.b[2556])) && s.b[2637]) {
            ...
            s.store_div_scaled_value_offset_denominator(613, s.ad_value(613), 1.0, A::div(s.ad_value(637), s.ad_value(536)), 1.0, 1.0);
        }
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2644])) && (!s.b[2645])) && (!s.b[2646])) {
            s.store_mul_sub_from_scalar_rhs_ad(2531, A::add(A::div_scaled_product(A::square(s.ad_value(2530)), A::ln(s.ad_value(2530)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2530)), 1.0), s.ad_value(2530)), 1.0, A::scale(s.ad_value(505), 2.0));
        }
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2644])) && (!s.b[2648])) {
            s.store_div_scaled_product_indices(2549, 596, 2548, (1.772453850905516 * 0.5), 2544, 1.0);
            s.store_mul_product3_rhs(2535, 519, s.ad_value(2534), s.ad_value(2549), s.ad_value(2543), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2644])) && (!s.b[2658])) && (!s.b[2659])) {
            s.store_add_scaled_product_left_ad(2552, 605, 1.0, A::add_scaled_inputs(s.ad_value(2525), 1.0, s.ad_value(534), s.v[438]), 611, 1.0);
        }

        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2644])) {
            s.store_mul_scale_ad_lhs(1903, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2662])) && (!s.b[2663])) && (!s.b[2664])) {
            s.store_mul_sub_from_scalar_rhs_ad(2531, A::add(A::div_scaled_product(A::square(s.ad_value(2530)), A::ln(s.ad_value(2530)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2530)), 1.0), s.ad_value(2530)), 1.0, A::scale(s.ad_value(506), 2.0));
        }
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2662])) && (!s.b[2666])) {
            s.store_div_scaled_product_indices(2549, 597, 2548, (1.772453850905516 * 0.5), 2544, 1.0);
            s.store_mul_product3_rhs(2535, 520, s.ad_value(2534), s.ad_value(2549), s.ad_value(2543), 1.0);
        }
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2662])) && (!s.b[2676])) && (!s.b[2677])) {
            s.store_add_scaled_product_left_ad(2552, 606, 1.0, A::add_scaled_inputs(s.ad_value(2525), 1.0, s.ad_value(535), s.v[438]), 612, 1.0);
        }

        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2662])) {
            s.store_mul_scale_ad_lhs(1904, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2680])) && (!s.b[2681])) && (!s.b[2682])) {
            s.store_mul_sub_from_scalar_rhs_ad(2531, A::add(A::div_scaled_product(A::square(s.ad_value(2530)), A::ln(s.ad_value(2530)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2530)), 1.0), s.ad_value(2530)), 1.0, A::scale(s.ad_value(507), 2.0));
        }
    ...
    pub(super) fn stamp_transient_block_43(
        ...
        if (((s.b[2555] && (!s.b[2556])) && (!s.b[2680])) && (!s.b[2684])) {
            s.store_div_scaled_product_indices(2549, 598, 2548, (1.772453850905516 * 0.5), 2544, 1.0);
            s.store_mul_product3_rhs(2535, 521, s.ad_value(2534), s.ad_value(2549), s.ad_value(2543), 1.0);
        }
        ...
        if ((((s.b[2555] && (!s.b[2556])) && (!s.b[2680])) && (!s.b[2694])) && (!s.b[2695])) {
            s.store_add_scaled_product_left_ad(2552, 607, 1.0, A::add_scaled_inputs(s.ad_value(2525), 1.0, s.ad_value(635), s.v[438]), 613, 1.0);
        }

        if ((s.b[2555] && (!s.b[2556])) && (!s.b[2680])) {
            s.store_mul_scale_ad_lhs(1905, A::add_scaled_inputs4(s.ad_value(2527), 1.0, s.ad_value(2528), 1.0, s.ad_value(2535), 1.0, s.ad_value(2550), 1.0), p.p29, 2552);
        }
        ...
        if (s.b[2555] && (!s.b[2556])) {
            s.store_add_scaled_products3(843, s.ad_value(667), s.ad_value(1903), 1.0, s.ad_value(668), s.ad_value(1904), 1.0, s.ad_value(669), s.ad_value(1905), 1.0);
        }
        ...
        if (s.b[2743] && s.b[2744]) {
            ...
            s.store_mul_ad(858, A::add_scaled_value_products(s.ad_value(273), 1.0, s.ad_value(274), s.ad_value(2711), (-1.0), s.ad_value(275), A::square(s.ad_value(2711)), 1.0), A::ln(A::div_scaled_inputs2(s.ad_value(2712), 1.0, s.ad_value(2713), 0.5, A::sub_scaled_inputs(s.ad_value(2712), 1.0, s.ad_value(2713), 0.5), 1.0)));
            s.store_add_scaled_product_left_ad(858, 858, 1.0, A::add_scaled_product(s.ad_value(274), 1.0, s.ad_value(275), A::sub_scaled_inputs(s.ad_value(2712), 1.0, s.ad_value(2711), 2.0), 1.0), 2713, 1.0);
            s.store_div_scaled_product_left_ad(858, A::mul3(s.ad_value(716), s.ad_value(832), s.ad_value(1864)), 858, 1.0, 2711, 1.0);
        }
        ...
        if (s.b[2743] && s.b[2745]) {
            if ((1.0 - (12.0 * (s.v[2718] * s.v[2717]))) > 1e-20) {
                s.store_sub_from_scalar_ad(2719, 1.0, A::mul_scaled_output(s.ad_value(2718), s.ad_value(2717), 12.0));
            } else {
        ...
        if (s.b[2743] && s.b[2745]) {
            ...
            s.store_add_scaled_inputs3(2722, s.ad_value(2715), 1.0, s.ad_value(2717), 12.0, A::mul3_scaled_output(A::offset(s.ad_value(2715), 1.0), s.ad_value(2717), s.ad_value(2718), 24.0), -1.0);
        }
        ...
        if (((s.b[2743] && s.b[2745]) && s.b[2746]) && s.b[2747]) {
            s.store_div_scaled_value_offset_denominator(2724, s.ad_value(2724), 1.0, A::mul(s.ad_value(2723), s.ad_value(1848)), 1.0, 1.0);
        }

        if ((s.b[2743] && s.b[2745]) && s.b[2746]) {
            s.store_mul_offset_rhs_scaled_ad_rhs(2725, 1857, A::sqrt(A::scale_offset(s.ad_value(2724), 2.0, 1.0)), 1.0, 0.5);
    ...
    pub(super) fn stamp_transient_block_44(
        ...
        if ((s.b[2743] && s.b[2748]) && (!s.b[2750])) {
            s.store_div_scaled_product_indices(857, 2728, 2729, 1.0, 856, 1.0);
        }
        ...
        if (s.b[2743] && s.b[2748]) {
            s.store_div_scaled_product_indices(855, 857, 856, 1.0, 2729, 1.0);
        }
        ...
        s.store_mul_offset_lhs_scaled_ad_rhs(1916, 1873, 1.0, A::abs(s.ad_value(841)), (2.0 * 1.6021918e-19));
        ...
        if s.b[2752] {
            ...
            s.store_mul_product3_rhs(2733, 1869, s.ad_value(1920), s.ad_value(2730), s.ad_value(1872), -1.0);
            s.store_mul_ad(863, A::add_scaled_product(s.ad_value(291), 1.0, A::add_scaled_product(s.ad_value(292), 1.0, s.ad_value(293), s.ad_value(2731), (-1.0)), s.ad_value(2731), (-1.0)), A::ln(A::div_scaled_inputs2(s.ad_value(2732), 1.0, s.ad_value(2733), 0.5, A::sub_scaled_inputs(s.ad_value(2732), 1.0, s.ad_value(2733), 0.5), 1.0)));
            s.store_add_scaled_product_left_ad(863, 863, 1.0, A::add_scaled_product(s.ad_value(292), 1.0, s.ad_value(293), A::sub_scaled_inputs(s.ad_value(2732), 1.0, s.ad_value(2731), 2.0), 1.0), 2733, 1.0);
            s.store_div_scaled_product_left_ad(863, A::mul3(s.ad_value(720), s.ad_value(840), s.ad_value(1864)), 863, 1.0, 2731, 1.0);
        }
        ...
        if s.b[2752] {
            s.store_div_scaled_inputs2(2734, s.ad_value(1870), s.v[709], s.ad_value(2730), s.v[709], s.ad_value(2730), 1.0);
            s.store_div_scaled_product_denominator_ad(2735, 1812, 1870, 1.0 / (s.v[709]), A::add(s.ad_value(1870), s.ad_value(2730)), 1.0);
            s.store_div_scaled_product_indices(2736, 1872, 1869, (((-0.5) * 0.16666666666666666) * s.v[709]), 2734, 1.0);
        ...
        if (s.b[2752] && s.b[2753]) {
            s.store_offset_div_scaled_product(2738, s.ad_value(2730), s.ad_value(2734), 1.0, s.ad_value(1920), 1.0, (-1.0));
        }

        if s.b[2752] {
            if ((1.0 - (12.0 * (s.v[2738] * s.v[2737]))) > 1e-20) {
                s.store_sub_from_scalar_ad(2739, 1.0, A::mul_scaled_output(s.ad_value(2738), s.ad_value(2737), 12.0));
            } else {
                s.store_scalar(2739, 1e-20);
            }
        }
        ...
        if s.b[2752] {
            ...
            s.store_add_scaled_inputs3(2742, s.ad_value(2735), 1.0, s.ad_value(2737), 12.0, A::mul3_scaled_output(A::offset(s.ad_value(2735), 1.0), s.ad_value(2737), s.ad_value(2738), 24.0), -1.0);
        }

        if s.b[2752] {
            if (s.v[2742] > 1e-40) {
            } else {
                s.store_scalar(2742, 1e-40);
            }
        }
