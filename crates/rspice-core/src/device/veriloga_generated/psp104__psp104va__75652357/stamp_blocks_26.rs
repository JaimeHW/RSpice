...
impl Instance {
    ...
    if (l.f8ae != 0.0) {
        let eq24_e1154: f64 = (l.febf * p[32]);let eq24_e1156: f64 = (eq24_e1154 * l.f506);let eq24_e1158: f64 = (eq24_e1156 * (nv8 - nv9));
    ...
    if (l.f8af != 0.0) {
        let eq27_e1179: f64 = (l.febf * p[32]);let eq27_e1181: f64 = (eq27_e1179 * l.f56f);let eq27_e1183: f64 = (eq27_e1181 * (nv10 - nv9));
    ...
    if (l.f8b0 != 0.0) {
        let eq30_e1204: f64 = (l.febf * p[32]);let eq30_e1206: f64 = (eq30_e1204 * l.f56e);let eq30_e1208: f64 = (eq30_e1206 * (nv11 - nv9));
    ...
    if (l.f8b1 != 0.0) {
        let eq33_e1229: f64 = (l.febf * p[32]);let eq33_e1231: f64 = (eq33_e1229 * l.fbeb);let eq33_e1233: f64 = (eq33_e1231 * (nv3 - nv9));
    ...
    if (l.f8b1 == 0.0) {
        ...
        stamper.stamp_potential_const_local(
            6,
            eq35_value,
        );let eq36_e1253: f64 = (p[32] * l.f570);let eq36_e1255: f64 = (eq36_e1253 * (nv7 - nv8));let eq36_value: f64 = eq36_e1255;
        stamper.stamp_current_node2_local(
            Some(7),
            Some(8),
            ...
            8,
            multiplicity * ((-eq36_e1253)),
        );let eq37_e1258: f64 = (p[32] * l.f570);let eq37_e1260: f64 = (eq37_e1258 * (nv6 - nv8));let eq37_value: f64 = eq37_e1260;
        stamper.stamp_current_node2_local(
            Some(6),
            Some(8),
            ...
            8,
            multiplicity * ((-eq37_e1258)),
        );let eq38_e1263: f64 = (l.f193 * l.febf);let eq38_e1265: f64 = (eq38_e1263 * p[33]);let eq38_e1267: f64 = (eq38_e1265 * l.f115e);let eq38_e1267_d_n5: f64 = (eq38_e1265 * l.f1165);let eq38_e1267_d_n6: f64 = (eq38_e1265 * l.f1166);let eq38_e1267_d_n7: f64 = (eq38_e1265 * l.f1167);let eq38_e1267_d_n8: f64 = (eq38_e1265 * l.f1168);let eq38_e1268: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 0, eq38_e1267);let eq38_value: f64 = eq38_e1268;
        stamper.stamp_current_sparse_local::<4, 0>(
            ...
            [],
            1.0,
        );let eq39_e1271: f64 = (l.f193 * l.febf);let eq39_e1273: f64 = (eq39_e1271 * p[33]);let eq39_e1275: f64 = (eq39_e1273 * l.f1098);let eq39_e1275_d_n5: f64 = (eq39_e1273 * l.f10a1);let eq39_e1275_d_n6: f64 = (eq39_e1273 * l.f10a2);let eq39_e1275_d_n7: f64 = (eq39_e1273 * l.f10a3);let eq39_e1275_d_n8: f64 = (eq39_e1273 * l.f10a4);let eq39_e1276: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 1, eq39_e1275);let eq39_value: f64 = eq39_e1276;
        stamper.stamp_current_sparse_local::<4, 0>(
            Some(8),
            Some(6),
            ...
            [],
            1.0,
        );let eq40_e1279: f64 = (l.f193 * l.febf);let eq40_e1281: f64 = (eq40_e1279 * p[33]);let eq40_e1283: f64 = (eq40_e1281 * l.f1112);let eq40_e1283_d_n5: f64 = (eq40_e1281 * l.f1119);let eq40_e1283_d_n6: f64 = (eq40_e1281 * l.f111a);let eq40_e1283_d_n7: f64 = (eq40_e1281 * l.f111b);let eq40_e1283_d_n8: f64 = (eq40_e1281 * l.f111c);let eq40_e1284: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 2, eq40_e1283);let eq40_value: f64 = eq40_e1284;
        stamper.stamp_current_sparse_local::<4, 0>(
            Some(7),
            Some(6),
            ...
            [],
            1.0,
        );let eq41_e1287: f64 = (l.f193 * l.febf);let eq41_e1289: f64 = (eq41_e1287 * p[33]);let eq41_e1291: f64 = (eq41_e1289 * l.f1159);let eq41_e1291_d_n5: f64 = (eq41_e1289 * l.f115a);let eq41_e1291_d_n6: f64 = (eq41_e1289 * l.f115b);let eq41_e1291_d_n7: f64 = (eq41_e1289 * l.f115c);let eq41_e1292: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 3, eq41_e1291);let eq41_value: f64 = eq41_e1292;
        ...
        );let eq42_e1295: f64 = (l.f193 * l.febf);let eq42_e1297: f64 = (eq42_e1295 * p[33]);let eq42_e1299: f64 = (eq42_e1297 * l.f1154);let eq42_e1299_d_n5: f64 = (eq42_e1297 * l.f1155);let eq42_e1299_d_n6: f64 = (eq42_e1297 * l.f1156);let eq42_e1299_d_n7: f64 = (eq42_e1297 * l.f1157);let eq42_e1300: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 4, eq42_e1299);let eq42_value: f64 = eq42_e1300;
        stamper.stamp_current_node3_local(
            Some(5),
            Some(7),
    ...
    pub(super) fn stamp_transient_equations_block_3(
        ...
        stamper.stamp_current_sparse_local::<6, 0>(
            ...
            [],
            1.0,
        );let eq45_e1319: f64 = (l.f193 * l.febf);let eq45_e1321: f64 = (eq45_e1319 * p[33]);let eq45_e1323: f64 = (eq45_e1321 * l.f120a);let eq45_e1323_d_n5: f64 = (eq45_e1321 * l.f120d);let eq45_e1323_d_n6: f64 = (eq45_e1321 * l.f120e);let eq45_e1323_d_n7: f64 = (eq45_e1321 * l.f120f);let eq45_e1323_d_n8: f64 = (eq45_e1321 * l.f1210);let eq45_e1323_d_n10: f64 = (eq45_e1321 * l.f120b);let eq45_e1323_d_n11: f64 = (eq45_e1321 * l.f120c);let eq45_e1324: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 7, eq45_e1323);let eq45_value: f64 = eq45_e1324;
        stamper.stamp_current_sparse_local::<6, 0>(
            Some(11),
            Some(7),
    ...
    pub(super) fn stamp_reactive_equations_block_0(
        ...
        let nv4 = ctx.node_voltage(nodes[4]);let eq38_e1263: f64 = (l.f193 * l.febf);let eq38_e1265: f64 = (eq38_e1263 * p[33]);let eq38_e1267: f64 = (eq38_e1265 * l.f115e);let eq38_e1267_d_n5: f64 = (eq38_e1265 * l.f1165);let eq38_e1267_d_n6: f64 = (eq38_e1265 * l.f1166);let eq38_e1267_d_n7: f64 = (eq38_e1265 * l.f1167);let eq38_e1267_d_n8: f64 = (eq38_e1265 * l.f1168);let eq38_e1268_q: f64 = eq38_e1267;
        ...
        );let eq39_e1271: f64 = (l.f193 * l.febf);let eq39_e1273: f64 = (eq39_e1271 * p[33]);let eq39_e1275: f64 = (eq39_e1273 * l.f1098);let eq39_e1275_d_n5: f64 = (eq39_e1273 * l.f10a1);let eq39_e1275_d_n6: f64 = (eq39_e1273 * l.f10a2);let eq39_e1275_d_n7: f64 = (eq39_e1273 * l.f10a3);let eq39_e1275_d_n8: f64 = (eq39_e1273 * l.f10a4);let eq39_e1276_q: f64 = eq39_e1275;
        stamper.stamp_current_reactive_local(
            Some(8),
            Some(6),
            &[
        ...
        );let eq41_e1287: f64 = (l.f193 * l.febf);let eq41_e1289: f64 = (eq41_e1287 * p[33]);let eq41_e1291: f64 = (eq41_e1289 * l.f1159);let eq41_e1291_d_n5: f64 = (eq41_e1289 * l.f115a);let eq41_e1291_d_n6: f64 = (eq41_e1289 * l.f115b);let eq41_e1291_d_n7: f64 = (eq41_e1289 * l.f115c);let eq41_e1292_q: f64 = eq41_e1291;
        ...
        );let eq42_e1295: f64 = (l.f193 * l.febf);let eq42_e1297: f64 = (eq42_e1295 * p[33]);let eq42_e1299: f64 = (eq42_e1297 * l.f1154);let eq42_e1299_d_n5: f64 = (eq42_e1297 * l.f1155);let eq42_e1299_d_n6: f64 = (eq42_e1297 * l.f1156);let eq42_e1299_d_n7: f64 = (eq42_e1297 * l.f1157);let eq42_e1300_q: f64 = eq42_e1299;
        stamper.stamp_current_reactive_node3_local(
            Some(5),
            Some(7),
            5,
