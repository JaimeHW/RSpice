...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_mul_ad_lhs(611, A::mul3_scaled_output(A::square(s.ad_value(605)), A::pow_from_scalar(s.v[438], A::offset(s.ad_value(537), (-1.0))), s.ad_value(537), -1.0), 608);

        s.store_mul_ad_lhs(612, A::mul3_scaled_output(A::square(s.ad_value(606)), A::pow_from_scalar(s.v[438], A::offset(s.ad_value(538), (-1.0))), s.ad_value(538), -1.0), 609);

        s.store_mul_ad_lhs(613, A::mul3_scaled_output(A::square(s.ad_value(607)), A::pow_from_scalar(s.v[438], A::offset(s.ad_value(539), (-1.0))), s.ad_value(539), -1.0), 610);
        ...
        if s.b[1010] {
            ...
            s.store_ad_value(459, A::add_scaled_inputs(s.ad_value(458), 1.0, A::ln_one_plus_exp(A::scale(A::sub_from_scalar(0.05, s.ad_value(458)), s.v[365])), s.v[364]));
        ...
        s.store_ad_value(563, A::add_scaled_inputs(s.ad_value(560), 1.0, A::ln_one_plus_exp(A::scale(A::sub_from_scalar(0.05, s.ad_value(560)), s.v[365])), s.v[364]));

        s.store_ad_value(564, A::add_scaled_inputs(s.ad_value(561), 1.0, A::ln_one_plus_exp(A::scale(A::sub_from_scalar(0.05, s.ad_value(561)), s.v[365])), s.v[364]));

        s.store_ad_value(565, A::add_scaled_inputs(s.ad_value(562), 1.0, A::ln_one_plus_exp(A::scale(A::sub_from_scalar(0.05, s.ad_value(562)), s.v[365])), s.v[364]));
        ...
        if s.b[1011] {
            ...
            s.store_ad_value(622, A::add_scaled_inputs(s.ad_value(621), 1.0, A::ln_one_plus_exp(A::scale(A::sub_from_scalar(0.05, s.ad_value(621)), s.v[365])), s.v[364]));
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[1019] {
            s.store_ad_value(40, A::add_scaled_inputs3(A::scale_offset(A::powf(s.ad_value(308), p.p198), p.p197, p.p196), 1.0, s.ad_value(310), p.p199, s.ad_value(312), p.p200));
            s.store_ad_value(41, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p202, p.p201), 1.0, s.ad_value(310), p.p203, s.ad_value(312), p.p204));
        ...
        if (s.b[1019] && s.b[1020]) {
            ...
            s.store_ad_value(330, A::add_scaled_product(A::sqrt(s.ad_value(325)), 1.0, s.ad_value(328), A::ln(A::offset(A::mul(A::div_scaled_inputs(s.ad_value(327), 2.0, s.ad_value(306), 1.0), A::offset(A::exp(A::div(s.ad_value(329), s.ad_value(328))), (-1.0))), 1.0)), 1.0));
        ...
        if ((s.b[1019] && (!s.b[1020])) && (!s.b[1021])) {
            s.store_ad_value(330, A::add_scaled_product(s.ad_value(325), 1.0, s.ad_value(326), A::sub_from_scalar(2.0, A::div(s.ad_value(306), s.ad_value(327))), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if s.b[1019] {
            s.store_ad_value(46, A::add_scaled_inputs3(A::scale_offset(A::powf(s.ad_value(308), p.p220), p.p219, p.p218), 1.0, s.ad_value(310), p.p221, s.ad_value(312), p.p222));
            s.store_scalar(47, p.p223);
            s.store_scalar(48, p.p224);
            s.store_ad_value(49, A::add_scaled_inputs3(A::scale_offset(A::powf(s.ad_value(308), p.p227), p.p226, p.p225), 1.0, s.ad_value(310), p.p228, s.ad_value(312), p.p229));
        }
        ...
        if s.b[1019] {
            s.store_ad_value(333, A::add_scaled_product(A::offset(A::mul(A::div(A::mul(s.ad_value(331), s.ad_value(332)), s.ad_value(306)), A::sub_from_scalar(1.0, A::exp(A::div_scaled_inputs(s.ad_value(306), -1.0, s.ad_value(332), 1.0)))), 1.0), 1.0, A::div_from_scalar((p.p261 * p.p262), s.ad_value(306)), A::sub_from_scalar(1.0, A::exp_scaled_input(s.ad_value(306), (-1.0 / (p.p262)))), 1.0));
        }
        ...
        if s.b[1019] {
            s.store_ad_value(334, A::add_scaled_product(A::scale_offset(s.ad_value(310), p.p263, 1.0), 1.0, s.ad_value(310), A::ln(A::scale_offset(s.ad_value(307), 1.0 / (p.p265), 1.0)), p.p264));
            s.store_mul_ad_lhs(65, A::div_scaled_inputs(s.ad_value(307), p.p256, A::mul(s.ad_value(333), s.ad_value(306)), 1.0), 334);
            s.store_ad_value(66, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p267, p.p266), 1.0, s.ad_value(310), p.p268, s.ad_value(312), p.p269));
            ...
            s.store_ad_value(83, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p300, p.p299), 1.0, s.ad_value(310), p.p301, s.ad_value(312), p.p302));
            ...
            s.store_div_ad(89, A::mul_scaled_lhs(s.ad_value(335), p.p311, A::scale_offset(s.ad_value(310), p.p314, 1.0)), A::offset(A::mul_scaled_lhs(s.ad_value(308), p.p313, s.ad_value(335)), 1.0));
            s.store_powf(335, 308, p.p316);
            s.store_div_ad(90, A::mul_scaled_lhs(s.ad_value(335), p.p315, A::scale_offset(s.ad_value(310), p.p318, 1.0)), A::offset(A::mul_scaled_lhs(s.ad_value(308), p.p317, s.ad_value(335)), 1.0));
        ...
        if s.b[1019] {
            ...
            s.store_ad_value(119, A::add_scaled_inputs3(A::scale_offset(A::powf(s.ad_value(308), p.p354), p.p353, p.p352), 1.0, s.ad_value(310), p.p355, s.ad_value(312), p.p356));
            s.store_ad_value(120, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p358, p.p357), 1.0, s.ad_value(310), p.p359, s.ad_value(312), p.p360));
        ...
        if s.b[1019] {
            s.store_ad_value(121, A::mul3(A::add_scaled_product(s.ad_value(32), 1.0, A::div(A::mul(s.ad_value(33), s.ad_value(334)), s.ad_value(333)), A::pow(s.ad_value(308), s.ad_value(34)), 1.0), A::offset(A::mul(s.ad_value(35), s.ad_value(310)), 1.0), A::offset(A::mul(s.ad_value(36), s.ad_value(312)), 1.0)));
        ...
        if s.b[1019] {
            ...
            s.store_div_ad(124, A::mul_scaled_lhs(s.ad_value(335), p.p371, A::scale_offset(s.ad_value(310), p.p374, 1.0)), A::offset(A::mul_scaled_lhs(s.ad_value(308), p.p373, s.ad_value(335)), 1.0));
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if s.b[1019] {
            ...
            s.store_mul_ad_lhs(140, A::mul3_scaled_output(s.ad_value(65), s.ad_value(65), s.ad_value(310), p.p388), 310);
            ...
            s.store_ad_value(146, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p399, p.p398), 1.0, s.ad_value(310), p.p400, s.ad_value(312), p.p401));
            s.store_ad_value(147, A::add_scaled_inputs3(A::scale_offset(A::powf(s.ad_value(308), p.p404), p.p403, p.p402), 1.0, s.ad_value(310), p.p405, s.ad_value(312), p.p406));
        ...
        if s.b[1019] {
            ...
            s.store_ad_value(151, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p419, p.p418), 1.0, s.ad_value(310), p.p420, s.ad_value(312), p.p421));
            ...
            s.store_ad_value(342, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p808, p.p807), 1.0, s.ad_value(310), p.p809, s.ad_value(312), p.p810));
            s.store_ad_value(343, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p812, p.p811), 1.0, s.ad_value(310), p.p813, s.ad_value(312), p.p814));
            s.store_ad_value(163, A::add_scaled_inputs3(A::div_scaled_inputs(A::add_scaled_inputs(s.ad_value(323), ((0.3333333333333333 * 1.0 / (s.v[14])) * p.p440), s.ad_value(324), p.p440), 1.0, s.ad_value(322), s.v[14]), 1.0, A::div_from_scalar((p.p438 + p.p439), A::mul(s.ad_value(323), s.ad_value(321))), 1.0, s.ad_value(1), p.p437));
        }
        ...
        if (s.b[1019] && s.b[1034]) {
            s.store_ad_value(40, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p449, p.p448), 1.0, s.ad_value(310), p.p450, s.ad_value(312), p.p451));
        }
        ...
        if (s.b[1019] && s.b[1035]) {
            s.store_ad_value(41, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p453, p.p452), 1.0, s.ad_value(310), p.p454, s.ad_value(312), p.p455));
        }
        ...
        if (s.b[1019] && s.b[1036]) {
            s.store_ad_value(45, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p457, p.p456), 1.0, s.ad_value(310), p.p458, s.ad_value(312), p.p459));
        }
        ...
        if (s.b[1019] && s.b[1037]) {
            s.store_ad_value(46, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p461, p.p460), 1.0, s.ad_value(310), p.p462, s.ad_value(312), p.p463));
        }
        ...
        if (s.b[1019] && s.b[1038]) {
            s.store_ad_value(47, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p465, p.p464), 1.0, s.ad_value(310), p.p466, s.ad_value(312), p.p467));
        }
        ...
        if (s.b[1019] && s.b[1039]) {
            s.store_ad_value(49, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p469, p.p468), 1.0, s.ad_value(310), p.p470, s.ad_value(312), p.p471));
        }
        ...
        if (s.b[1019] && s.b[1040]) {
            s.store_ad_value(50, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p473, p.p472), 1.0, s.ad_value(310), p.p474, s.ad_value(312), p.p475));
        }
        ...
        if (s.b[1019] && s.b[1041]) {
            s.store_ad_value(57, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p477, p.p476), 1.0, s.ad_value(310), p.p478, s.ad_value(312), p.p479));
        }
        ...
        if (s.b[1019] && s.b[1042]) {
            s.store_ad_value(58, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p481, p.p480), 1.0, s.ad_value(310), p.p482, s.ad_value(312), p.p483));
        }
        ...
        if (s.b[1019] && s.b[1043]) {
            s.store_ad_value(51, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p485, p.p484), 1.0, s.ad_value(310), p.p486, s.ad_value(312), p.p487));
        }
        ...
        if (s.b[1019] && s.b[1044]) {
            s.store_ad_value(52, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p493, p.p492), 1.0, s.ad_value(310), p.p494, s.ad_value(312), p.p495));
        }
        ...
        if (s.b[1019] && s.b[1045]) {
            s.store_ad_value(53, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p489, p.p488), 1.0, s.ad_value(310), p.p490, s.ad_value(312), p.p491));
        }
        ...
        if (s.b[1019] && s.b[1046]) {
            s.store_ad_value(54, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p497, p.p496), 1.0, s.ad_value(310), p.p498, s.ad_value(312), p.p499));
        }
        ...
        if (s.b[1019] && s.b[1047]) {
            s.store_mul_ad_rhs(62, 309, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p501, p.p500), 1.0, s.ad_value(310), p.p502, s.ad_value(312), p.p503));
        }
        ...
        if (s.b[1019] && s.b[1048]) {
            s.store_ad_value(63, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p509, p.p508), 1.0, s.ad_value(310), p.p510, s.ad_value(312), p.p511));
        }
        ...
        if (s.b[1019] && s.b[1049]) {
            s.store_ad_value(64, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p505, p.p504), 1.0, s.ad_value(310), p.p506, s.ad_value(312), p.p507));
        }
        ...
        if (s.b[1019] && s.b[1050]) {
            s.store_mul_ad_rhs(59, 309, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p513, p.p512), 1.0, s.ad_value(310), p.p514, s.ad_value(312), p.p515));
        }
        ...
        if (s.b[1019] && s.b[1051]) {
            s.store_ad_value(60, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p521, p.p520), 1.0, s.ad_value(310), p.p522, s.ad_value(312), p.p523));
        }
        ...
        if (s.b[1019] && s.b[1052]) {
            s.store_ad_value(61, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p517, p.p516), 1.0, s.ad_value(310), p.p518, s.ad_value(312), p.p519));
        }
        ...
        if (s.b[1019] && s.b[1053]) {
            s.store_mul_ad(65, A::div(s.ad_value(307), s.ad_value(306)), A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p525, p.p524), 1.0, s.ad_value(310), p.p526, s.ad_value(312), p.p527));
        }
        ...
        if (s.b[1019] && s.b[1054]) {
            s.store_ad_value(66, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p529, p.p528), 1.0, s.ad_value(310), p.p530, s.ad_value(312), p.p531));
        }
        ...
        if (s.b[1019] && s.b[1055]) {
            s.store_ad_value(67, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p533, p.p532), 1.0, s.ad_value(310), p.p534, s.ad_value(312), p.p535));
        }
        ...
        if (s.b[1019] && s.b[1056]) {
            s.store_ad_value(69, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p537, p.p536), 1.0, s.ad_value(310), p.p538, s.ad_value(312), p.p539));
        }
        ...
        if (s.b[1019] && s.b[1057]) {
            s.store_ad_value(71, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p541, p.p540), 1.0, s.ad_value(310), p.p542, s.ad_value(312), p.p543));
        }
        ...
        if (s.b[1019] && s.b[1058]) {
            s.store_ad_value(73, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p545, p.p544), 1.0, s.ad_value(310), p.p546, s.ad_value(312), p.p547));
        }
        ...
        if (s.b[1019] && s.b[1059]) {
            s.store_ad_value(75, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p549, p.p548), 1.0, s.ad_value(310), p.p550, s.ad_value(312), p.p551));
        }
        ...
        if (s.b[1019] && s.b[1060]) {
            s.store_mul_ad_rhs(78, 310, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p553, p.p552), 1.0, s.ad_value(310), p.p554, s.ad_value(312), p.p555));
        }
        ...
        if (s.b[1019] && s.b[1061]) {
            s.store_ad_value(79, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p557, p.p556), 1.0, s.ad_value(310), p.p558, s.ad_value(312), p.p559));
        }
        ...
        if (s.b[1019] && s.b[1062]) {
            s.store_ad_value(80, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p561, p.p560), 1.0, s.ad_value(310), p.p562, s.ad_value(312), p.p563));
        }
        ...
        if (s.b[1019] && s.b[1063]) {
            s.store_ad_value(81, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p565, p.p564), 1.0, s.ad_value(310), p.p566, s.ad_value(312), p.p567));
        }
        ...
        if (s.b[1019] && s.b[1064]) {
            s.store_mul_ad_rhs(82, 308, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p569, p.p568), 1.0, s.ad_value(310), p.p570, s.ad_value(312), p.p571));
        }
        ...
        if (s.b[1019] && s.b[1065]) {
            s.store_ad_value(83, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p573, p.p572), 1.0, s.ad_value(310), p.p574, s.ad_value(312), p.p575));
        }
        ...
        if (s.b[1019] && s.b[1066]) {
            s.store_ad_value(84, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p577, p.p576), 1.0, s.ad_value(310), p.p578, s.ad_value(312), p.p579));
        }
        ...
        if (s.b[1019] && s.b[1067]) {
            s.store_ad_value(85, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p581, p.p580), 1.0, s.ad_value(310), p.p582, s.ad_value(312), p.p583));
        }
        ...
        if (s.b[1019] && s.b[1068]) {
            s.store_ad_value(87, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p585, p.p584), 1.0, s.ad_value(310), p.p586, s.ad_value(312), p.p587));
        }
        ...
        if (s.b[1019] && s.b[1069]) {
            s.store_mul_ad_rhs(88, 308, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p589, p.p588), 1.0, s.ad_value(310), p.p590, s.ad_value(312), p.p591));
        }
        ...
        if (s.b[1019] && s.b[1070]) {
            s.store_ad_value(89, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p593, p.p592), 1.0, s.ad_value(310), p.p594, s.ad_value(312), p.p595));
        }
        ...
        if (s.b[1019] && s.b[1071]) {
            s.store_ad_value(90, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p597, p.p596), 1.0, s.ad_value(310), p.p598, s.ad_value(312), p.p599));
        }
        ...
        if (s.b[1019] && s.b[1072]) {
            s.store_ad_value(92, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p601, p.p600), 1.0, s.ad_value(310), p.p602, s.ad_value(312), p.p603));
        }
        ...
        if (s.b[1019] && s.b[1073]) {
            s.store_ad_value(94, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p605, p.p604), 1.0, s.ad_value(310), p.p606, s.ad_value(312), p.p607));
        }
        ...
        if (s.b[1019] && s.b[1074]) {
            s.store_ad_value(95, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p609, p.p608), 1.0, s.ad_value(310), p.p610, s.ad_value(312), p.p611));
        }
        ...
        if (s.b[1019] && s.b[1075]) {
            s.store_ad_value(96, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p613, p.p612), 1.0, s.ad_value(310), p.p614, s.ad_value(312), p.p615));
        }
        ...
        if (s.b[1019] && s.b[1076]) {
            s.store_mul_ad_rhs(99, 313, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p617, p.p616), 1.0, s.ad_value(310), p.p618, s.ad_value(312), p.p619));
        }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (s.b[1019] && s.b[1077]) {
            s.store_mul_ad_rhs(100, 311, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p621, p.p620), 1.0, s.ad_value(310), p.p622, s.ad_value(312), p.p623));
        }
        ...
        if (s.b[1019] && s.b[1078]) {
            s.store_mul_ad_rhs(101, 311, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p625, p.p624), 1.0, s.ad_value(310), p.p626, s.ad_value(312), p.p627));
        }
        ...
        if (s.b[1019] && s.b[1079]) {
            s.store_ad_value(102, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p629, p.p628), 1.0, s.ad_value(310), p.p630, s.ad_value(312), p.p631));
        }
        ...
        if (s.b[1019] && s.b[1080]) {
            s.store_mul_ad_rhs(110, 311, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p633, p.p632), 1.0, s.ad_value(310), p.p634, s.ad_value(312), p.p635));
        }
        ...
        if (s.b[1019] && s.b[1081]) {
            s.store_mul_ad_rhs(111, 311, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p637, p.p636), 1.0, s.ad_value(310), p.p638, s.ad_value(312), p.p639));
        }
        ...
        if (s.b[1019] && s.b[1082]) {
            s.store_ad_value(114, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p641, p.p640), 1.0, s.ad_value(310), p.p642, s.ad_value(312), p.p643));
        }
        ...
        if (s.b[1019] && s.b[1083]) {
            s.store_ad_value(115, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p645, p.p644), 1.0, s.ad_value(310), p.p646, s.ad_value(312), p.p647));
        }
        ...
        if (s.b[1019] && s.b[1084]) {
            s.store_mul_ad_affine_product_rhs(118, 316, s.ad_value(314), A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p649, p.p648), 1.0, s.ad_value(310), p.p650, s.ad_value(312), p.p651), 1.0 / (1e-6), 0.0);
        }
        ...
        if (s.b[1019] && s.b[1085]) {
            s.store_ad_value(119, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p653, p.p652), 1.0, s.ad_value(310), p.p654, s.ad_value(312), p.p655));
        }
        ...
        if (s.b[1019] && s.b[1086]) {
            s.store_ad_value(120, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p657, p.p656), 1.0, s.ad_value(310), p.p658, s.ad_value(312), p.p659));
        }
        ...
        if (s.b[1019] && s.b[1087]) {
            s.store_mul_ad_rhs(121, 308, A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(s.ad_value(28), 1.0, s.ad_value(29), s.ad_value(308), 1.0), 1.0, s.ad_value(30), s.ad_value(310), 1.0), 1.0, s.ad_value(31), s.ad_value(312), 1.0));
        }
        ...
        if (s.b[1019] && s.b[1092]) {
            s.store_ad_value(122, A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(s.ad_value(28), 1.0, s.ad_value(29), s.ad_value(308), 1.0), 1.0, s.ad_value(30), s.ad_value(310), 1.0), 1.0, s.ad_value(31), s.ad_value(312), 1.0));
        }
        ...
        if (s.b[1019] && s.b[1097]) {
            s.store_mul_ad_rhs(123, 308, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p669, p.p668), 1.0, s.ad_value(310), p.p670, s.ad_value(312), p.p671));
        }
        ...
        if (s.b[1019] && s.b[1098]) {
            s.store_mul_ad_rhs(124, 308, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p673, p.p672), 1.0, s.ad_value(310), p.p674, s.ad_value(312), p.p675));
        }
        ...
        if (s.b[1019] && s.b[1099]) {
            s.store_mul_ad_rhs(125, 316, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p677, p.p676), 1.0, s.ad_value(310), p.p678, s.ad_value(312), p.p679));
        }
        ...
        if (s.b[1019] && s.b[1100]) {
            s.store_mul_ad_rhs(126, 316, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p681, p.p680), 1.0, s.ad_value(310), p.p682, s.ad_value(312), p.p683));
        }
        ...
        if (s.b[1019] && s.b[1101]) {
            s.store_mul_ad_rhs(130, 319, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p685, p.p684), 1.0, s.ad_value(310), p.p686, s.ad_value(312), p.p687));
        }
        ...
        if (s.b[1019] && s.b[1102]) {
            s.store_mul_ad_rhs(131, 316, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p689, p.p688), 1.0, s.ad_value(310), p.p690, s.ad_value(312), p.p691));
        }
        ...
        if (s.b[1019] && s.b[1103]) {
            s.store_mul_ad_rhs(132, 316, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p693, p.p692), 1.0, s.ad_value(310), p.p694, s.ad_value(312), p.p695));
        }
        ...
        if (s.b[1019] && s.b[1104]) {
            s.store_mul_ad_rhs(137, 320, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p697, p.p696), 1.0, s.ad_value(310), p.p698, s.ad_value(312), p.p699));
        }
        ...
        if (s.b[1019] && s.b[1105]) {
            s.store_mul_ad_rhs(138, 320, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p701, p.p700), 1.0, s.ad_value(310), p.p702, s.ad_value(312), p.p703));
        }
        ...
        if (s.b[1019] && s.b[1106]) {
            s.store_mul_ad_rhs(140, 309, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p705, p.p704), 1.0, s.ad_value(310), p.p706, s.ad_value(312), p.p707));
        }
        ...
        if (s.b[1019] && s.b[1107]) {
            s.store_mul_ad_rhs(141, 312, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p709, p.p708), 1.0, s.ad_value(310), p.p710, s.ad_value(312), p.p711));
        }
        ...
        if (s.b[1019] && s.b[1108]) {
            s.store_mul_ad_rhs(142, 312, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p713, p.p712), 1.0, s.ad_value(310), p.p714, s.ad_value(312), p.p715));
        }
        ...
        if (s.b[1019] && s.b[1109]) {
            s.store_mul_ad_rhs(143, 312, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p717, p.p716), 1.0, s.ad_value(310), p.p718, s.ad_value(312), p.p719));
        }
        ...
        if (s.b[1019] && s.b[1110]) {
            s.store_ad_value(145, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p721, p.p720), 1.0, s.ad_value(310), p.p722, s.ad_value(312), p.p723));
        }
        ...
        if (s.b[1019] && s.b[1111]) {
            s.store_ad_value(146, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p725, p.p724), 1.0, s.ad_value(310), p.p726, s.ad_value(312), p.p727));
        }
        ...
        if (s.b[1019] && s.b[1112]) {
            s.store_ad_value(147, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p729, p.p728), 1.0, s.ad_value(310), p.p730, s.ad_value(312), p.p731));
        }
        ...
        if (s.b[1019] && s.b[1113]) {
            s.store_ad_value(148, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p733, p.p732), 1.0, s.ad_value(310), p.p734, s.ad_value(312), p.p735));
        }
        ...
        if (s.b[1019] && s.b[1114]) {
            s.store_ad_value(149, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p737, p.p736), 1.0, s.ad_value(310), p.p738, s.ad_value(312), p.p739));
        }
        ...
        if (s.b[1019] && s.b[1115]) {
            s.store_mul_ad(150, A::div(s.ad_value(338), s.ad_value(306)), A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p741, p.p740), 1.0, s.ad_value(310), p.p742, s.ad_value(312), p.p743));
        }
        ...
        if (s.b[1019] && s.b[1116]) {
            s.store_ad_value(151, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p745, p.p744), 1.0, s.ad_value(310), p.p746, s.ad_value(312), p.p747));
        }
        ...
        if (s.b[1019] && s.b[1117]) {
            s.store_mul_ad_rhs(152, 309, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p749, p.p748), 1.0, s.ad_value(310), p.p750, s.ad_value(312), p.p751));
        }
        ...
        if (s.b[1019] && s.b[1118]) {
            s.store_ad_value(153, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p753, p.p752), 1.0, s.ad_value(310), p.p754, s.ad_value(312), p.p755));
        }
        ...
        if (s.b[1019] && s.b[1119]) {
            s.store_ad_value(154, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p757, p.p756), 1.0, s.ad_value(310), p.p758, s.ad_value(312), p.p759));
        }
        ...
        if (s.b[1019] && s.b[1120]) {
            s.store_mul_ad_rhs(155, 309, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p761, p.p760), 1.0, s.ad_value(310), p.p762, s.ad_value(312), p.p763));
        }
        ...
        if (s.b[1019] && s.b[1121]) {
            s.store_ad_value(156, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p769, p.p768), 1.0, s.ad_value(310), p.p770, s.ad_value(312), p.p771));
        }
        ...
        if (s.b[1019] && s.b[1122]) {
            s.store_ad_value(157, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p765, p.p764), 1.0, s.ad_value(310), p.p766, s.ad_value(312), p.p767));
        }
        ...
        if (s.b[1019] && s.b[1123]) {
            s.store_mul_ad_rhs(159, 340, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p773, p.p772), 1.0, s.ad_value(310), p.p774, s.ad_value(312), p.p775));
        }
        ...
        if (s.b[1019] && s.b[1124]) {
            s.store_mul_ad_rhs(160, 340, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p777, p.p776), 1.0, s.ad_value(310), p.p778, s.ad_value(312), p.p779));
        }
        ...
        if (s.b[1019] && s.b[1125]) {
            s.store_mul_ad_rhs(161, 340, A::add_scaled_inputs3(A::scale_offset(s.ad_value(308), p.p781, p.p780), 1.0, s.ad_value(310), p.p782, s.ad_value(312), p.p783));
        }
        ...
        if (s.b[1019] && s.b[1127]) {
            ...
            s.store_ad_value(996, A::add_scaled_product(A::add_scaled_inputs(A::scale_offset(s.ad_value(1003), p.p791, 1.0), 1.0, s.ad_value(1004), p.p792), (1.0 + (p.p790 * (s.v[346] - 1.0))), s.ad_value(1003), s.ad_value(1004), (p.p793 * (1.0 + (p.p790 * (s.v[346] - 1.0))))));
            s.store_div_ad_lhs(997, A::add_scaled_inputs(s.ad_value(992), p.p787, s.ad_value(993), p.p787), 996);
            s.store_div_ad_lhs(998, A::add_scaled_inputs(s.ad_value(994), p.p787, s.ad_value(995), p.p787), 996);
            ...
            s.store_ad_value(999, A::add_scaled_product(A::add_scaled_inputs(A::scale_offset(s.ad_value(1003), p.p797, 1.0), 1.0, s.ad_value(1004), p.p798), 1.0, s.ad_value(1003), s.ad_value(1004), p.p799));
            s.store_sub_ad_lhs(1001, A::add_scaled_inputs3(s.ad_value(992), 1.0, s.ad_value(993), 1.0, s.ad_value(994), -1.0), 995);
            s.store_div_ad(1002, A::offset(s.ad_value(997), 1.0), A::offset(s.ad_value(998), 1.0));
            s.store_mul(65, 65, 1002);
            s.store_div_ad(82, A::mul3(s.ad_value(82), s.ad_value(1002), A::scale_offset(s.ad_value(998), p.p788, 1.0)), A::scale_offset(s.ad_value(997), p.p788, 1.0));
            s.store_div_ad(121, A::mul3(s.ad_value(121), s.ad_value(1002), A::offset(A::mul(s.ad_value(39), s.ad_value(998)), 1.0)), A::offset(A::mul(s.ad_value(39), s.ad_value(997)), 1.0));
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if (s.b[1019] && s.b[1127]) {
            ...
            s.store_ad_value(1002, A::div_scaled_inputs(s.ad_value(1001), p.p802, A::powf(s.ad_value(999), p.p803), 1.0));
        ...
        if ((s.b[1019] && s.b[1128]) && s.b[1129]) {
            ...
            s.store_div_ad_lhs(12, A::add_scaled_product(A::exp_scaled_input(s.ad_value(1002), ((-10.0) * s.v[8])), ((0.1 * s.v[8]) + (0.01 * p.p804)), A::scale_offset(s.ad_value(1001), 0.1, (0.01 * p.p804)), A::exp(A::mul_scaled_lhs(s.ad_value(1001), (-10.0), s.ad_value(1002))), (-1.0)), 4);
            s.store_div_ad_lhs(13, A::add_scaled_product(A::exp_scaled_input(s.ad_value(1002), ((-20.0) * s.v[8])), ((0.05 * s.v[8]) + (0.0025 * p.p804)), A::scale_offset(s.ad_value(1001), 0.05, (0.0025 * p.p804)), A::exp(A::mul_scaled_lhs(s.ad_value(1001), (-20.0), s.ad_value(1002))), (-1.0)), 4);
        }

        if (s.b[1019] && s.b[1128]) {
            s.store_ad_value(1001, A::add_scaled_inputs3(s.ad_value(11), 1.0, s.ad_value(12), p.p805, s.ad_value(13), p.p806));
            s.store_ad_value(40, A::add_scaled_product(s.ad_value(40), 1.0, s.ad_value(342), s.ad_value(1001), 1.0));
            s.store_mul3_affine_rhs(65, 65, 343, 1001, 1.0, 1.0);
            s.store_ad_value(145, A::add_scaled_product(s.ad_value(145), 1.0, s.ad_value(342), s.ad_value(1001), 1.0));
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_ad_value(785, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(816), 1.0, s.ad_value(778), 0.5), 1.0, s.ad_value(776), A::sqrt(A::add_scaled_inputs3(s.ad_value(816), 1.0, s.ad_value(778), 0.25, s.ad_value(784), 1.0)), (-1.0)));
        ...
        s.store_ad_value(788, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(816), 1.0, s.ad_value(779), 0.5), 1.0, s.ad_value(777), A::sqrt(A::add_scaled_inputs3(s.ad_value(816), 1.0, s.ad_value(779), 0.25, s.ad_value(787), 1.0)), (-1.0)));

        s.store_ad_value(722, A::add_scaled_inputs(A::offset(s.ad_value(182), s.v[356]), 1.0, A::ln_scaled_input(A::mul(s.ad_value(178), A::powf(s.ad_value(357), (-0.75))), 4e-26), (2.0 * s.v[709])));
        ...
        if s.b[1140] {
            s.store_ad_value(724, A::div_scaled_inputs(A::mul_scaled_output(s.ad_value(763), s.ad_value(763), (2.0 * s.v[709])), 1.0, s.ad_value(725), (1.6021918e-19 * s.v[761])));
        }
        ...
        s.store_ad_value(735, A::add_scaled_inputs3(s.ad_value(731), 0.5, s.ad_value(734), ((-1.0) * 0.5), A::sqrt(A::add_scaled_product(s.ad_value(732), 1.0, A::sub(s.ad_value(731), s.ad_value(734)), A::sub(s.ad_value(731), s.ad_value(734)), 1.0)), (-0.5)));

        s.store_scaled_offset(736, 722, s.v[356], 0.5);

        s.store_sub_ad_lhs(737, A::sqrt(A::add(s.ad_value(180), s.ad_value(722))), 730);

        s.store_ad_value(738, A::add_scaled_inputs3(A::sqrt(A::add_scaled_inputs3(s.ad_value(180), 1.0, s.ad_value(181), 1.0, s.ad_value(722), 1.0)), 1.0, s.ad_value(730), (-1.0), s.ad_value(737), -1.0));

        s.store_ad_value(739, A::add_scaled_inputs3(A::offset(s.ad_value(182), s.v[356]), 1.0, s.ad_value(251), 1.0, A::ln_scaled_input(A::mul(s.ad_value(766), A::powf(s.ad_value(357), (-0.75))), 4e-26), (2.0 * s.v[709])));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_ad_value(744, A::add_scaled_inputs3(s.ad_value(741), 0.5, s.ad_value(734), ((-1.0) * 0.5), A::sqrt(A::add_scaled_product(s.ad_value(742), 1.0, A::sub(s.ad_value(741), s.ad_value(734)), A::sub(s.ad_value(741), s.ad_value(734)), 1.0)), (-0.5)));
        ...
        if s.b[1143] {
            ...
            s.store_ad_value(754, A::add_scaled_product(A::offset(s.ad_value(279), s.v[356]), 1.0, s.ad_value(717), A::ln_scaled_input(A::mul(s.ad_value(280), A::powf(s.ad_value(357), (-0.75))), 4e-26), 2.0));
        }
        ...
        if s.b[1143] {
            ...
            s.store_ad_value(760, A::add_scaled_inputs3(s.ad_value(756), 0.5, s.ad_value(759), ((-1.0) * 0.5), A::sqrt(A::add_scaled_product(s.ad_value(757), 1.0, A::sub(s.ad_value(756), s.ad_value(759)), A::sub(s.ad_value(756), s.ad_value(759)), 1.0)), (-0.5)));
        ...
        s.store_ad_value(798, A::div_scaled_inputs(s.ad_value(242), 4e-18, A::square(s.ad_value(187)), 1.0));

        s.store_ad_value(799, A::div_scaled_inputs(s.ad_value(243), 4e-18, A::square(s.ad_value(188)), 1.0));
        ...
        if s.b[1157] {
            ...
            s.store_ad_value(21, A::add_scaled_product(s.ad_value(2), s.v[644], s.ad_value(26), s.ad_value(27), (-1.0)));
            s.copy_ad(22, 27);
            s.store_scale(23, 2, s.v[670]);
            s.store_ad_value(24, A::add_scaled_product(s.ad_value(2), s.v[671], s.ad_value(26), s.ad_value(27), (-1.0)));
            s.copy_ad(25, 27);
        }
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if ((s.b[1159] && (!s.b[1163])) && s.b[1164]) {
            s.store_div_from_scalar_offset_ad(649, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(648), s.v[365])), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(648), s.v[365])), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(648), s.v[365])), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }

        if ((s.b[1159] && (!s.b[1163])) && (!s.b[1164])) {
            s.store_scaled_offset_ad(649, A::mul(A::scale_offset(s.ad_value(648), s.v[365], (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(648), s.v[365], (-230.25850929940458)), A::scale_offset(s.ad_value(648), ((s.v[365]) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if ((s.b[1159] && (!s.b[1171])) && s.b[1172]) {
            s.store_div_from_scalar_offset_ad(676, 1e-100, A::mul(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(675), s.v[365])), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(675), s.v[365])), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::scale(s.ad_value(675), s.v[365])), 0.3333333333333333, 1.0), 0.5), 1.0)), 1.0);
        }

        if ((s.b[1159] && (!s.b[1171])) && (!s.b[1172])) {
            s.store_scaled_offset_ad(676, A::mul(A::scale_offset(s.ad_value(675), s.v[365], (-230.25850929940458)), A::offset(A::mul_scaled_output(A::scale_offset(s.ad_value(675), s.v[365], (-230.25850929940458)), A::scale_offset(s.ad_value(675), ((s.v[365]) * (0.3333333333333333)), (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if ((s.b[1159] && s.b[1176]) && s.b[1225]) {
            ...
            s.store_ad_value(1193, A::add_scaled_inputs3(s.ad_value(479), 0.5, s.ad_value(653), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(479), s.ad_value(653)), A::sub(s.ad_value(479), s.ad_value(653))), ((4.0 * s.v[362]) * s.v[362]))), (-0.5)));
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1230])) && (!s.b[1240])) && (!s.b[1242])) && s.b[1243]) {
            let assign16180_ad_e14140: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign16180_ad_e14140, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1230])) && (!s.b[1240])) && (!s.b[1242])) && (!s.b[1243])) {
            let assign16190_ad_e14190: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1247])) && (!s.b[1257])) && (!s.b[1259])) && s.b[1260]) {
            let assign16880_ad_e15283: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign16880_ad_e15283, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1247])) && (!s.b[1257])) && (!s.b[1259])) && (!s.b[1260])) {
            let assign16890_ad_e15333: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1264])) && (!s.b[1274])) && (!s.b[1276])) && s.b[1277]) {
            let assign17580_ad_e16426: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign17580_ad_e16426, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1264])) && (!s.b[1274])) && (!s.b[1276])) && (!s.b[1277])) {
            let assign17590_ad_e16476: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (s.b[1159] && s.b[1176]) {
            s.store_ad_value(469, A::add_scaled_product(A::add_scaled_products(s.ad_value(640), s.ad_value(1222), 1.0, s.ad_value(641), s.ad_value(1223), 1.0), 1.0, s.ad_value(642), s.ad_value(1224), 1.0));
            s.store_scalar(1193, 0.0);
            s.store_scalar(1190, 0.0);
        }
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        if ((s.b[1159] && s.b[1176]) && s.b[1281]) {
            ...
            s.store_ad_value(1193, A::add_scaled_inputs3(s.ad_value(480), 0.5, s.ad_value(653), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(480), s.ad_value(653)), A::sub(s.ad_value(480), s.ad_value(653))), ((4.0 * s.v[362]) * s.v[362]))), (-0.5)));
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1286])) && (!s.b[1296])) && (!s.b[1298])) && s.b[1299]) {
            let assign18580_ad_e18070: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign18580_ad_e18070, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1286])) && (!s.b[1296])) && (!s.b[1298])) && (!s.b[1299])) {
            let assign18590_ad_e18120: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1303])) && (!s.b[1313])) && (!s.b[1315])) && s.b[1316]) {
            let assign19280_ad_e19213: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign19280_ad_e19213, 1.0);
        }
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1320])) && (!s.b[1330])) && (!s.b[1332])) && s.b[1333]) {
            let assign19980_ad_e20356: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign19980_ad_e20356, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1320])) && (!s.b[1330])) && (!s.b[1332])) && (!s.b[1333])) {
            let assign19990_ad_e20406: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (s.b[1159] && s.b[1176]) {
            s.store_ad_value(470, A::add_scaled_product(A::add_scaled_products(s.ad_value(640), s.ad_value(1222), 1.0, s.ad_value(641), s.ad_value(1223), 1.0), 1.0, s.ad_value(642), s.ad_value(1224), 1.0));
            s.store_scalar(1193, 0.0);
            s.store_scalar(1190, 0.0);
        }
        ...
        if ((s.b[1159] && s.b[1176]) && s.b[1337]) {
            ...
            s.store_ad_value(1193, A::add_scaled_inputs3(s.ad_value(481), 0.5, s.ad_value(653), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(481), s.ad_value(653)), A::sub(s.ad_value(481), s.ad_value(653))), ((4.0 * s.v[362]) * s.v[362]))), (-0.5)));
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1342])) && (!s.b[1352])) && (!s.b[1354])) && s.b[1355]) {
            let assign20980_ad_e22000: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign20980_ad_e22000, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1342])) && (!s.b[1352])) && (!s.b[1354])) && (!s.b[1355])) {
            let assign20990_ad_e22050: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1359])) && (!s.b[1369])) && (!s.b[1371])) && s.b[1372]) {
            let assign21680_ad_e23143: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign21680_ad_e23143, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1359])) && (!s.b[1369])) && (!s.b[1371])) && (!s.b[1372])) {
            let assign21690_ad_e23193: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(436), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1376])) && (!s.b[1386])) && (!s.b[1388])) && s.b[1389]) {
            let assign22380_ad_e24286: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign22380_ad_e24286, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1376])) && (!s.b[1386])) && (!s.b[1388])) && (!s.b[1389])) {
            let assign22390_ad_e24336: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(437), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        ...
        if (s.b[1159] && s.b[1176]) {
            s.store_ad_value(471, A::add_scaled_product(A::add_scaled_products(s.ad_value(640), s.ad_value(1222), 1.0, s.ad_value(641), s.ad_value(1223), 1.0), 1.0, s.ad_value(642), s.ad_value(1224), 1.0));
            s.store_scalar(1193, 0.0);
            s.store_scalar(1190, 0.0);
        }
        ...
        if ((s.b[1159] && s.b[1176]) && s.b[1393]) {
            ...
            s.store_ad_value(1193, A::add_scaled_inputs3(s.ad_value(482), 0.5, s.ad_value(653), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(482), s.ad_value(653)), A::sub(s.ad_value(482), s.ad_value(653))), ((4.0 * s.v[362]) * s.v[362]))), (-0.5)));
        ...
        if (((((s.b[1159] && s.b[1176]) && (!s.b[1398])) && (!s.b[1408])) && (!s.b[1410])) && s.b[1411]) {
            let assign23380_ad_e25930: A = A::mul(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::offset(A::mul_scaled_output(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), A::scale_offset(A::sub_from_scalar((-230.25850929940458), A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0)), 0.3333333333333333, 1.0), 0.5), 1.0));
            s.store_div_from_scalar_offset_ad(1195, 1e-100, assign23380_ad_e25930, 1.0);
        }

        if (((((s.b[1159] && s.b[1176]) && (!s.b[1398])) && (!s.b[1408])) && (!s.b[1410])) && (!s.b[1411])) {
            let assign23390_ad_e25980: A = A::offset(A::mul(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::offset(A::mul_scaled_output(A::offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), (-230.25850929940458)), A::scale_offset(A::div_scaled_inputs(s.ad_value(435), -1.0, s.ad_value(1220), 1.0), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
