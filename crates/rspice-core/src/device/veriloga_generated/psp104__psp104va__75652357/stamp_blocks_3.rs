...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_23(
        ...
        if ((locals.var_guard1456 != 0.0) && (locals.var_guard1457 != 0.0)) {
            ...
            (locals.var_margin__blk1344, locals.var_margin__blk1344_dn5, locals.var_margin__blk1344_dn6, locals.var_margin__blk1344_dn7, locals.var_margin__blk1344_dn8, ) = (assign49060_e62987, (1e-5 * locals.var_xi__blk1343_dn5), (1e-5 * locals.var_xi__blk1343_dn6), (1e-5 * locals.var_xi__blk1343_dn7), (1e-5 * locals.var_xi__blk1343_dn8), );
    ...
    pub(super) fn stamp_reactive_block_25(
        ...
        if ((locals.var_guard1456 != 0.0) && (locals.var_guard1457 == 0.0)) {
            ...
            locals.var_xi__blk1343_rv = 0.0;
            (locals.var_margin__blk1344, locals.var_margin__blk1344_dn5, locals.var_margin__blk1344_dn6, locals.var_margin__blk1344_dn7, locals.var_margin__blk1344_dn8, ) = (locals.var_margin_dc, locals.var_margin_dc_dn5, locals.var_margin_dc_dn6, locals.var_margin_dc_dn7, locals.var_margin_dc_dn8, );
            locals.var_margin__blk1344_rv = 0.0;
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        if (locals.var_guard1456 != 0.0) {
            (locals.var_xg_ac, locals.var_xg_ac_dn5, locals.var_xg_ac_dn6, locals.var_xg_ac_dn7, locals.var_xg_ac_dn8, ) = (locals.var_xg__blk1326, locals.var_xg__blk1326_dn5, locals.var_xg__blk1326_dn6, locals.var_xg__blk1326_dn7, locals.var_xg__blk1326_dn8, );
        ...
        if (locals.var_guard1456 == 0.0) {
            ...
            locals.var_gf_ac_rv = 0.0;
            (locals.var_xg_ac, locals.var_xg_ac_dn5, locals.var_xg_ac_dn6, locals.var_xg_ac_dn7, locals.var_xg_ac_dn8, ) = (locals.var_xg_dc, locals.var_xg_dc_dn5, locals.var_xg_dc_dn6, locals.var_xg_dc_dn7, locals.var_xg_dc_dn8, );
            locals.var_xg_ac_rv = 0.0;
