...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        if ((p.p16 == 0.0) && s.b[120]) {
            ...
            s.store_add_scaled_inputs_ad_rhs(4, 4, 1.0, A::sqrt(A::offset(A::square(s.ad_value(39)), (p.p122 * p.p122))), p.p119);
        }
        ...
        if ((p.p16 == 0.0) && s.b[121]) {
            ...
            s.store_add_scaled_inputs_ad_rhs(3, 3, 1.0, A::sqrt(A::offset(A::square(s.ad_value(39)), (p.p123 * p.p123))), p.p120);
        }
        ...
        if ((p.p16 == 0.0) && s.b[122]) {
            ...
            s.store_exp_scaled_input_ad(40, A::sqrt(A::offset(A::square(s.ad_value(39)), (p.p121 * p.p121))), (0.01 * p.p118));
        }
    ...
    if ((!s.b[127]) && (!s.b[128])) {
        ...
        if s.b[129] {
            if (p.p63 > 2.0) {
                s.store_mul_scaled_offset_ad_rhs(107, 71, 0.55, A::exp(A::div_scaled_inputs(s.ad_value(106), -1.0, s.ad_value(71), 1.0)), 1.0);
            } else {
        ...
        if s.b[140] {
            ...
            s.store_add_scaled_product_right_ad(76, 142, 1.0, 70, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::div_scaled_inputs(s.ad_value(142), -1.0, s.ad_value(70), 1.0)), 4.0, 1.0)), 1.0), 0.5), 2.0);
        ...
        if s.b[143] {
            ...
            s.store_add_scaled_product_right_ad(78, 145, 1.0, 70, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::div_scaled_inputs(s.ad_value(145), -1.0, s.ad_value(70), 1.0)), 4.0, 1.0)), 1.0), 0.5), 2.0);
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[147] {
            ...
            s.store_div_scaled_inputs(20, s.ad_value(19), p.p65, s.ad_value(73), 1.0);
        ...
        if s.b[203] {
            ...
            s.store_div_scaled_inputs(158, s.ad_value(46), 1.5, s.ad_value(51), 1.0);
        ...
        if (s.b[203] && s.b[204]) {
            ...
            s.store_div_scaled_inputs(174, s.ad_value(170), -1.0, s.ad_value(173), 1.0);
        }

        if (s.b[203] && (!s.b[204])) {
            s.store_sub_scaled_inputs(174, 169, (-0.5), 172, 1.0);
            s.store_div_scaled_inputs(173, s.ad_value(170), -1.0, s.ad_value(174), 1.0);
        }
        ...
        if ((!s.b[203]) && (!s.b[210])) {
            ...
            s.store_div_scaled_inputs2(183, A::sub_from_scalar(1.0, s.ad_value(198)), 1.0, A::sqrt(A::offset(s.ad_value(198), 1.0)), 1.0, s.ad_value(46), 4.5);
        }
        ...
        if s.b[211] {
            ...
            s.store_div_scaled_product_add_scaled_denominator(184, 151, 193, 2.0, A::sqrt(A::add_scaled_product(s.ad_value(192), 1.0, A::sub(s.ad_value(151), s.ad_value(193)), A::sub(s.ad_value(151), s.ad_value(193)), 1.0)), 1.0, A::sqrt(A::add_scaled_product(s.ad_value(192), 1.0, A::add(s.ad_value(151), s.ad_value(193)), A::add(s.ad_value(151), s.ad_value(193)), 1.0)), 1.0, 1.0);
        }
        ...
        if (!s.b[211]) {
            s.store_div_scaled_product_add_scaled_denominator(184, 151, 183, 2.0, A::sqrt(A::add_scaled_product(s.ad_value(107), 1.0, A::sub(s.ad_value(151), s.ad_value(183)), A::sub(s.ad_value(151), s.ad_value(183)), 1.0)), 1.0, A::sqrt(A::add_scaled_product(s.ad_value(107), 1.0, A::add(s.ad_value(151), s.ad_value(183)), A::add(s.ad_value(151), s.ad_value(183)), 1.0)), 1.0, 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if (s.b[259] && (p.p63 != 0.0)) {
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(67, 65, 0.5, 48, ((-1.0) * 0.5), A::offset(A::mul(A::add(s.ad_value(65), s.ad_value(48)), A::add(s.ad_value(65), s.ad_value(48))), 0.04), 0.5);
        }
        ...
        if (s.b[290] && (p.p63 != 0.0)) {
            s.store_add_scaled_inputs3_sqrt_third_mixed_iia(67, 66, 0.5, 48, ((-1.0) * 0.5), A::offset(A::mul(A::add(s.ad_value(66), s.ad_value(48)), A::add(s.ad_value(66), s.ad_value(48))), 0.04), 0.5);
        }
