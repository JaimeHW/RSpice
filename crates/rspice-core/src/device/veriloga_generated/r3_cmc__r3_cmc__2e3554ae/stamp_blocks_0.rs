...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[146] {
            ...
            s.store_mul_ad_product_rhs(62, 104, s.ad_value(70), A::ln(A::offset(A::exp_div_scaled_inputs(s.ad_value(103), -1.0, A::mul(s.ad_value(104), s.ad_value(70)), 1.0), (p.p27 / p.p84))));
        }
