...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        s.store_sub_from_scalar(347, p[13], 345);s.store_sub_from_scalar(348, p[17], 346);s.store_mul_powf_mixed_ia(97, 347, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20]);s.store_mul_powf_mixed_ia(89, 348, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19]);s.store_scaled_abs_ad(136, A::sub(s.ad_value(37), s.ad_value(129)), (s.v[80] / p[9]));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(129)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 37, 37, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[3], 136, p[3], 90, 1.0, 1.0);
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if s.b[396] {s.store_sub_ad(113, A::sub_from_scalar(((-1.0) * s.v[99]), A::div(s.ad_value(109), s.ad_value(110))), A::div(s.ad_value(111), s.ad_value(112)));s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 130, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[28], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[29], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if s.b[396] {
            s.store_add_scaled_value_products_mixed_iiaia(120, 115, s.v[99], 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
