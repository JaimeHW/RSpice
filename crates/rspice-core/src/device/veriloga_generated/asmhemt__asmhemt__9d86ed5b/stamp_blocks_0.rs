...
impl Instance {
    ...
    if (s.b[384] && s.b[385]) {
        ...
        s.store_scalar(361, t0);s.store_scalar(35, (p[0] + 273.15));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_2(
        ...
        s.store_offset_sqrt_ad(140, A::offset(A::square(s.ad_value(38)), 0.01), (-0.1));s.store_offset_sqrt_ad(141, A::offset(A::square(A::voltage(ctx, nodes, Some(0), Some(2))), 0.01), (-0.1));s.store_offset_voltage(82, ctx, nodes, Some(4), None, ((ctx_temp) + (p[274])));s.store_scale(36, 82, 8.617087e-5);s.b[387] = (p[81] == 0.0);s.store_scalar(387, if s.b[387] { 1.0 } else { 0.0 });s.b[388] = (p[81] == 1.0);s.store_scalar(388, if s.b[388] { 1.0 } else { 0.0 });s.b[389] = (p[81] == 2.0);s.store_scalar(389, if s.b[389] { 1.0 } else { 0.0 });s.b[390] = (p[81] == 3.0);s.store_scalar(390, if s.b[390] { 1.0 } else { 0.0 });s.b[391] = (p[81] == 4.0);s.store_scalar(391, if s.b[391] { 1.0 } else { 0.0 });s.b[392] = (p[81] == 5.0);s.store_scalar(392, if s.b[392] { 1.0 } else { 0.0 });
        if (s.b[388] && (!s.b[387])) {s.store_voltage(186, ctx, nodes, Some(5), None);s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(186, 186, 0.5, 36, 0.5, 186, 36, ((0.25 * p[128]) * p[128]), 0.5);s.store_offset_scaled_ad(213, A::limited_exp(A::div_from_scalar((-1.0), s.ad_value(186))), p[101], p[100]);s.store_offset_scaled_ad(214, A::limited_exp(A::div_from_scalar((-1.0), s.ad_value(186))), p[105], p[104]);s.store_offset_scaled_ad(215, A::limited_exp(A::div_from_scalar((-1.0), s.ad_value(186))), p[107], p[106]);s.store_offset_scaled_ad(216, A::limited_exp(A::div_from_scalar((-1.0), s.ad_value(186))), p[103], p[102]);}
        if (s.b[389] && (!(s.b[387] || s.b[388]))) {s.store_limited_exp_scaled_voltage(208, ctx, nodes, Some(1), Some(2), (-p[112]));s.store_scaled_voltage(209, ctx, nodes, Some(6), None, p[113]);s.store_offset_add_scaled_inputs(210, A::voltage(ctx, nodes, Some(5), None), (-p[116]), A::voltage(ctx, nodes, Some(6), None), p[117], p[118]);s.store_scaled_voltage(211, ctx, nodes, Some(6), None, p[114]);s.store_scaled_voltage(212, ctx, nodes, Some(6), None, p[115]);}
        if (s.b[390] && (!((s.b[387] || s.b[388]) || s.b[389]))) {s.store_voltage(147, ctx, nodes, Some(0), Some(1));s.store_mul_div_from_scalar_lhs_ad_mixed_ai(90, p[124], A::scale_offset(s.ad_value(147), p[123], 1.0), 147);s.store_scaled_offset(91, 147, (-p[127]), p[125]);s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(148, 90, 0.5, 91, 0.5, 90, 91, ((0.25 * p[128]) * p[128]), 0.5);s.store_exp_scaled_input_ad(136, A::offset(A::voltage(ctx, nodes, Some(1), Some(2)), (-p[10])), ((-2.0) * 1.0 / (p[122])));s.store_offset_scaled_ad(149, A::div(A::sub_from_scalar(1.0, s.ad_value(136)), A::offset(s.ad_value(136), 1.0)), ((p[120] - 1e-9) * 0.5), ((((p[120] - 1e-9) * 0.5)) + (1e-9)));s.store_scaled_voltage(184, ctx, nodes, Some(5), None, 1.0 / (p[121]));s.store_mul_powf_mixed_ia(185, 184, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[126]);}
        if (s.b[391] && (!(((s.b[387] || s.b[388]) || s.b[389]) || s.b[390]))) {s.store_abs_voltage(136, ctx, nodes, Some(0), Some(2));s.store_div_from_scalar_ad(338, p[82], A::scale_offset(A::exp_scaled_input(A::voltage(ctx, nodes, Some(11), Some(12)), 1.0 / (p[86])), p[85], 1.0));s.store_abs_voltage(90, ctx, nodes, Some(1), Some(2));s.store_div_from_scalar_ad(343, p[84], A::scale_offset(A::exp_scaled_input(A::voltage(ctx, nodes, Some(13), Some(14)), 1.0 / (p[88])), p[87], 1.0));s.store_sub_voltage_abs_voltage(337, ctx, nodes, Some(12), None, Some(0), Some(2));}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        s.store_sub_from_scalar_ad(379, p[266], A::scaled_offset(s.ad_value(334), (-1.0), p[267]));s.store_add_scaled_inputs_mixed_ai(88, A::add_scaled_inputs4_offset(s.ad_value(87), 1.0, s.ad_value(334), ((-1.0) * p[24]), s.ad_value(209), 1.0, s.ad_value(213), 1.0, ((-1.0) * ((-1.0) * p[24]))), 1.0, 45, ((s.v[81] / (s.v[81] + s.v[80])) * p[11]));s.store_div_scalar_by_product_indices(136, p[3], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[30]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 40, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(40), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(37, 160, 88);s.store_div_from_scalar_scaled_input(84, s.v[80], 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_scalar(99, (s.v[80] / 1.602176634e-19));s.store_scaled_add_mixed_ia(154, 37, A::sqrt_square_offset(s.ad_value(37), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t1: A = A::powf(A::scale(s.ad_value(154), s.v[99]), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t1, (-(p[28] / 3.0)), A::add_scaled_offset_product_rhs(t1, ((2.0 * p[28]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 37, 1.0, 83, 2.0);s.b[393] = (s.v[136] < 200.0);s.store_scalar(393, if s.b[393] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        s.store_sub_from_scalar(347, p[13], 345);s.store_sub_from_scalar(348, p[17], 346);s.store_mul_powf_mixed_ia(97, 347, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20]);s.store_mul_powf_mixed_ia(89, 348, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19]);s.store_scaled_abs_ad(136, A::sub(s.ad_value(37), s.ad_value(129)), (s.v[80] / p[9]));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(129)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_mixed_ia(90, 37, A::sqrt_square_offset(s.ad_value(37), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[3], 136, p[3], 90, 1.0, 1.0);
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if s.b[396] {s.store_sub_ad(113, A::sub_from_scalar(((-1.0) * s.v[99]), A::div(s.ad_value(109), s.ad_value(110))), A::div(s.ad_value(111), s.ad_value(112)));s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 130, 114);s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[28], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[29], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if s.b[396] {
            s.store_add_scaled_value_products_mixed_iiaia(120, 115, s.v[99], 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if (s.b[403] && (!s.b[402])) {s.store_div_scaled_inputs_mixed_ai(136, A::voltage(ctx, nodes, Some(9), Some(8)), 1.0, 82, (p[57] * 8.617087e-5));s.store_offset_scaled(137, 82, ((1.0 / (s.v[35])) * (p[71])), (((((-1.0)) * (p[71]))) + (p[63])));s.store_scaled_mul_ad(206, A::abs(s.ad_value(137)), A::offset(A::limited_exp(s.ad_value(136)), (-1.0)), ((p[4] * p[3]) * p[5]));s.store_div_scaled_inputs_mixed_ai(136, A::voltage(ctx, nodes, Some(9), Some(7)), 1.0, 82, (p[60] * 8.617087e-5));s.store_offset_scaled(137, 82, ((1.0 / (s.v[35])) * (p[72])), (((((-1.0)) * (p[72]))) + (p[64])));s.store_scaled_mul_ad(207, A::abs(s.ad_value(137)), A::offset(A::limited_exp(s.ad_value(136)), (-1.0)), ((p[4] * p[3]) * p[5]));}
        if (s.b[404] && (!(s.b[402] || s.b[403]))) {s.store_offset_scaled(326, 82, ((1.0 / (s.v[35])) * (p[75])), (((((-1.0)) * (p[75]))) + (p[67])));s.store_offset_scaled(328, 82, ((1.0 / (s.v[35])) * (p[77])), (((((-1.0)) * (p[77]))) + (p[57])));s.store_offset_scaled(330, 82, ((1.0 / (s.v[35])) * (p[79])), (((((-1.0)) * (p[79]))) + (p[61])));s.store_div_scaled_inputs2_mixed_aii(136, A::voltage(ctx, nodes, Some(9), Some(8)), 1.0, 326, (-1.0), 328, (8.617087e-5 * s.v[35]));s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[71]), p[63]);s.store_scaled_mul_ad(206, A::abs(s.ad_value(137)), A::offset(A::limited_exp(s.ad_value(136)), (-1.0)), ((p[4] * p[3]) * p[5]));s.store_add_scaled_inputs3_sqrt_third_ad(321, A::voltage(ctx, nodes, Some(9), Some(8)), -1.0, A::voltage(ctx, nodes, Some(9), Some(8)), (-(-0.5)), A::offset(A::square(A::neg(A::voltage(ctx, nodes, Some(9), Some(8)))), 0.001), (-(-0.5)));s.store_scale(322, 321, 1.0 / (p[1]));s.store_offset_sqrt(136, 321, p[69]);s.store_div_scaled_inputs_indices(90, 136, 1.0, 330, (8.617087e-5 * s.v[35]));s.store_scale_ad(324, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[73]), p[65]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[404] && (!(s.b[402] || s.b[403]))) {s.store_mul_scale_offset_mixed_ia(206, 206, A::mul3(s.ad_value(322), s.ad_value(324), A::limited_exp(s.ad_value(90))), 1.0, 1.0);s.store_offset_scaled(327, 82, ((1.0 / (s.v[35])) * (p[76])), (((((-1.0)) * (p[76]))) + (p[68])));s.store_offset_scaled(329, 82, ((1.0 / (s.v[35])) * (p[78])), (((((-1.0)) * (p[78]))) + (p[60])));s.store_offset_scaled(331, 82, ((1.0 / (s.v[35])) * (p[80])), (((((-1.0)) * (p[80]))) + (p[62])));s.store_div_scaled_inputs2_mixed_aii(136, A::voltage(ctx, nodes, Some(9), Some(7)), 1.0, 327, (-1.0), 329, (8.617087e-5 * s.v[35]));s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[72]), p[64]);s.store_scaled_mul_ad(207, A::abs(s.ad_value(137)), A::offset(A::limited_exp(s.ad_value(136)), (-1.0)), ((p[4] * p[3]) * p[5]));s.store_add_scaled_inputs3_sqrt_third_ad(323, A::voltage(ctx, nodes, Some(9), Some(7)), -1.0, A::voltage(ctx, nodes, Some(9), Some(7)), (-(-0.5)), A::offset(A::square(A::neg(A::voltage(ctx, nodes, Some(9), Some(7)))), 0.001), (-(-0.5)));s.store_scale(322, 323, 1.0 / (p[1]));s.store_offset_sqrt(136, 323, p[70]);s.store_div_scaled_inputs_indices(136, 136, 1.0, 331, (8.617087e-5 * s.v[35]));s.store_scale_ad(325, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[74]), p[66]);s.store_mul_scale_offset_mixed_ia(207, 207, A::mul3(s.ad_value(322), s.ad_value(325), A::limited_exp(s.ad_value(136))), 1.0, 1.0);}
        if (s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) {s.store_offset_scaled(326, 82, ((1.0 / (s.v[35])) * (p[75])), (((((-1.0)) * (p[75]))) + (p[67])));s.store_offset_scaled(328, 82, ((1.0 / (s.v[35])) * (p[77])), (((((-1.0)) * (p[77]))) + (p[57])));s.store_offset_scaled(330, 82, ((1.0 / (s.v[35])) * (p[79])), (((((-1.0)) * (p[79]))) + (p[61])));s.store_scale_ad(324, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[73]), p[65]);s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[71]), (((p[4] * p[3]) * p[5]) * p[63]));}
        ...
        if (((s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) && s.b[407]) && s.b[408]) {s.store_div_scaled_value_by_product_mixed_aii(354, A::powf(A::voltage(ctx, nodes, Some(9), Some(8)), p[58]), 1.0, 328, 36, 1.0);}
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if (s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) {s.store_offset_scaled(327, 82, ((1.0 / (s.v[35])) * (p[76])), (((((-1.0)) * (p[76]))) + (p[68])));s.store_offset_scaled(329, 82, ((1.0 / (s.v[35])) * (p[78])), (((((-1.0)) * (p[78]))) + (p[60])));s.store_offset_scaled(331, 82, ((1.0 / (s.v[35])) * (p[80])), (((((-1.0)) * (p[80]))) + (p[62])));s.store_scale_ad(325, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[74]), p[66]);s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[72]), (((p[4] * p[3]) * p[5]) * p[64]));}
        ...
        if (((s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) && s.b[411]) && s.b[412]) {s.store_div_scaled_value_by_product_mixed_aii(354, A::powf(A::voltage(ctx, nodes, Some(9), Some(7)), p[59]), 1.0, 329, 36, 1.0);}
        ...
        if ((s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) && s.b[411]) {s.store_mul_exp_rhs(355, 355, 354);s.store_mul_ad_product_rhs(207, 137, A::offset(s.ad_value(355), (-1.0)), A::exp_div_scaled_inputs(s.ad_value(327), -1.0, A::mul(s.ad_value(329), s.ad_value(36)), 1.0));s.store_add_scaled_inputs3_sqrt_third_ad(356, A::voltage(ctx, nodes, Some(9), Some(7)), -1.0, A::voltage(ctx, nodes, Some(9), Some(7)), (-(-0.5)), A::offset(A::square(A::neg(A::voltage(ctx, nodes, Some(9), Some(7)))), 0.001), (-(-0.5)));s.store_div_scaled_offset_numerator(357, A::sqrt(s.ad_value(356)), 1.0, p[70], A::mul(s.ad_value(331), s.ad_value(36)), 1.0);}
        ...
        if (s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) {s.store_offset_scaled(326, 82, ((1.0 / (s.v[35])) * (p[75])), (((((-1.0)) * (p[75]))) + (p[67])));s.store_offset_scaled(328, 82, ((1.0 / (s.v[35])) * (p[77])), (((((-1.0)) * (p[77]))) + (p[57])));s.store_offset_scaled(330, 82, ((1.0 / (s.v[35])) * (p[79])), (((((-1.0)) * (p[79]))) + (p[61])));s.store_scale_ad(324, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[73]), (((p[4] * p[3]) * p[5]) * p[65]));s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[71]), (((p[4] * p[3]) * p[5]) * p[63]));}
        ...
        if (((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[415]) && s.b[416]) {s.store_div_scaled_value_by_product_mixed_aii(354, A::powf(A::voltage(ctx, nodes, Some(9), Some(8)), p[58]), 1.0, 328, 36, 1.0);}
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[415]) {s.store_mul_exp_rhs(355, 355, 354);s.store_mul_ad_product_rhs(380, 137, A::offset(s.ad_value(355), (-1.0)), A::exp_div_scaled_inputs(s.ad_value(326), -1.0, A::mul(s.ad_value(328), s.ad_value(36)), 1.0));s.store_add_scaled_inputs3_sqrt_third_ad(356, A::voltage(ctx, nodes, Some(9), Some(8)), -1.0, A::voltage(ctx, nodes, Some(9), Some(8)), (-(-0.5)), A::square(A::neg(A::voltage(ctx, nodes, Some(9), Some(8)))), (-(-0.5)));s.store_div_scaled_offset_numerator(357, A::sqrt(s.ad_value(356)), 1.0, p[69], A::mul(s.ad_value(330), s.ad_value(36)), 1.0);}
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[415]) {s.store_mul_exp_rhs(358, 358, 357);s.store_mul_sub_mixed_iia(381, 324, 358, A::exp(A::div_from_scalar(p[69], A::mul(s.ad_value(330), s.ad_value(36)))));s.store_sub(206, 380, 381);}
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && (!s.b[415])) {s.store_scalar(206, 0.0);}
        if (s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) {s.store_offset_scaled(327, 82, ((1.0 / (s.v[35])) * (p[76])), (((((-1.0)) * (p[76]))) + (p[68])));s.store_offset_scaled(329, 82, ((1.0 / (s.v[35])) * (p[78])), (((((-1.0)) * (p[78]))) + (p[60])));s.store_offset_scaled(331, 82, ((1.0 / (s.v[35])) * (p[80])), (((((-1.0)) * (p[80]))) + (p[62])));s.store_scale_ad(325, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[74]), (((p[4] * p[3]) * p[5]) * p[66]));s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[72]), (((p[4] * p[3]) * p[5]) * p[64]));}
        ...
        if (((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[419]) && s.b[420]) {s.store_div_scaled_value_by_product_mixed_aii(354, A::powf(A::voltage(ctx, nodes, Some(9), Some(7)), p[59]), 1.0, 329, 36, 1.0);}
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[419]) {s.store_mul_exp_rhs(355, 355, 354);s.store_mul_ad_product_rhs(380, 137, A::offset(s.ad_value(355), (-1.0)), A::exp_div_scaled_inputs(s.ad_value(327), -1.0, A::mul(s.ad_value(329), s.ad_value(36)), 1.0));s.store_add_scaled_inputs3_sqrt_third_ad(356, A::voltage(ctx, nodes, Some(9), Some(7)), -1.0, A::voltage(ctx, nodes, Some(9), Some(7)), (-(-0.5)), A::square(A::neg(A::voltage(ctx, nodes, Some(9), Some(7)))), (-(-0.5)));s.store_div_scaled_offset_numerator(357, A::sqrt(s.ad_value(356)), 1.0, p[70], A::mul(s.ad_value(331), s.ad_value(36)), 1.0);}
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[419]) {s.store_mul_exp_rhs(358, 358, 357);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[419]) {s.store_mul_sub_mixed_iia(381, 325, 358, A::exp(A::div_from_scalar(p[70], A::mul(s.ad_value(331), s.ad_value(36)))));s.store_sub(207, 380, 381);}
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && (!s.b[419])) {s.store_scalar(207, 0.0);}
        s.b[423] = (p[56] == 0.0);s.store_scalar(423, if s.b[423] { 1.0 } else { 0.0 });s.b[359] = param_given[45];s.store_scalar(359, if s.b[359] { 1.0 } else { 0.0 });s.b[360] = param_given[44];s.store_scalar(360, if s.b[360] { 1.0 } else { 0.0 });s.copy_ad(187, 154);s.b[424] = (s.v[361] == 1.0);s.store_scalar(424, if s.b[424] { 1.0 } else { 0.0 });
        if s.b[424] {s.store_add_scaled_inputs4_offset_indices(177, 82, ((-p[36]) * ((1.0 / (s.v[35])) * (p[50]))), 340, (-1.0), 365, -1.0, 45, ((p[12] / 1.602176634e-19) * s.v[81]), (p[36] + ((-p[36]) * (((-1.0)) * (p[50])))));s.store_add_scaled_inputs3_offset_mixed_iia(177, 177, 1.0, 177, (-0.5), A::sqrt_square_offset(A::offset(s.ad_value(177), (-1.0)), 0.001), (-(-0.5)), (1.0 + (-0.5)));s.store_mul_scale_offset_rhs(172, 177, 187, ((p[38]) * (1.602176634e-19)), 1.602176634e-19);s.store_scaled_powf_ad(176, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[51], p[35]);s.store_scaled_mul(173, 172, 176, (p[4] * p[5]));s.store_scaled_powf_ad(180, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[52], p[40]);s.store_div_scalar_by_product_indices(175, p[46], 172, 180, (p[4] * p[5]));}
        ...
        if s.b[424] {s.store_div(170, 175, 91);s.store_offset_scaled(178, 82, ((((1.0 / (s.v[35])) * (p[54]))) * (p[48])), (((((((-1.0)) * (p[54]))) + (1.0))) * (p[48])));s.store_add_scaled_inputs3_indices(145, 178, 1.0 / ((p[4] * p[5])), 170, 1.0, 214, 1.0);s.store_add_scaled_inputs4_offset_indices(177, 82, ((-p[37]) * ((1.0 / (s.v[35])) * (p[50]))), 341, (-1.0), 366, -1.0, 45, ((p[12] / 1.602176634e-19) * s.v[81]), (p[37] + ((-p[37]) * (((-1.0)) * (p[50])))));s.store_add_scaled_inputs3_offset_mixed_iia(177, 177, 1.0, 177, (-0.5), A::sqrt_square_offset(A::offset(s.ad_value(177), (-1.0)), 0.001), (-(-0.5)), (1.0 + (-0.5)));s.store_mul_scale_offset_rhs(172, 177, 187, ((p[39]) * (1.602176634e-19)), 1.602176634e-19);s.store_scaled_mul(173, 172, 176, (p[4] * p[5]));s.store_scaled_powf_ad(181, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[53], p[41]);s.store_div_scalar_by_product_indices(174, p[47], 172, 181, (p[4] * p[5]));}
        s.b[426] = s.b[360];s.store_scalar(426, if s.b[426] { 1.0 } else { 0.0 });
        if (s.b[424] && s.b[426]) {s.store_scalar(350, (1.0 + p[44]));s.store_mul_sqrt_lhs(351, 350, 94);s.store_div(352, 351, 173);s.store_scale(353, 352, 2.0);s.store_add_mixed_ia(350, 350, A::square(s.ad_value(352)));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_13(
        ...
        if (s.b[424] && s.b[426]) {s.store_add_ad(350, A::sqrt(A::sub(s.ad_value(350), s.ad_value(353))), A::sqrt(A::add(s.ad_value(350), s.ad_value(353))));s.store_div_scaled_inputs_indices(349, 351, 2.0, 350, 1.0);s.store_sub_from_scalar_div_indices(91, 1.0, 349, 173);}
        ...
        if s.b[424] {s.store_div(171, 174, 91);s.store_offset_scaled(179, 82, ((((1.0 / (s.v[35])) * (p[55]))) * (p[49])), (((((((-1.0)) * (p[55]))) + (1.0))) * (p[49])));s.store_add_mixed_ai(144, A::add_scaled_inputs4(s.ad_value(179), 1.0 / ((p[4] * p[5])), s.ad_value(171), 1.0, s.ad_value(185), 1.0, s.ad_value(210), 1.0), 215);s.store_div_from_scalar(142, 1.0, 144);s.store_div_from_scalar(143, 1.0, 145);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_14(
        ...
        s.b[427] = (p[149] == 0.0);s.store_scalar(427, if s.b[427] { 1.0 } else { 0.0 });s.b[428] = (p[149] == 0.0);s.store_scalar(428, if s.b[428] { 1.0 } else { 0.0 });s.b[429] = (p[260] == 1.0);s.store_scalar(429, if s.b[429] { 1.0 } else { 0.0 });s.b[430] = (s.v[361] == 1.0);s.store_scalar(430, if s.b[430] { 1.0 } else { 0.0 });s.b[431] = (p[149] == 0.0);s.store_scalar(431, if s.b[431] { 1.0 } else { 0.0 });s.b[432] = (p[56] != 0.0);s.store_scalar(432, if s.b[432] { 1.0 } else { 0.0 });s.b[433] = (p[149] == 0.0);s.store_scalar(433, if s.b[433] { 1.0 } else { 0.0 });s.b[434] = (p[150] != 0.0);s.store_scalar(434, if s.b[434] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_15(
        ...
        if (s.b[433] && s.b[434]) {s.store_offset_sqrt_ad(232, A::offset(A::square(s.ad_value(231)), 0.01), (-0.1));s.store_offset_scaled(146, 232, p[166], (1.0 + p[165]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_sub_ad(88, A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[162])), (((((-1.0)) * (p[162]))) + (p[159]))), A::div_scaled_inputs(s.ad_value(232), (p[168] * p[167]), A::sqrt_square_offset(s.ad_value(232), (p[168] * p[168])), 1.0));s.store_scalar(223, (p[9] / p[160]));s.store_div_scalar_by_product_indices(136, p[161], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[158]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 230, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(230), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(222, 160, 88);s.store_div_scaled_inputs_indices(84, 223, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 223, 6.241509074460763e18);s.store_scaled_add_mixed_ia(154, 222, A::sqrt_square_offset(s.ad_value(222), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t3: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t3, (-(p[169] / 3.0)), A::add_scaled_offset_product_rhs(t3, ((2.0 * p[169]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 222, 1.0, 83, 2.0);}
