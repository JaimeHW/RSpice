...
impl Instance {
    ...
    if (s.b[384] && s.b[385]) {
        ...
        if (s.b[388] && (!s.b[387])) {s.store_voltage(186, ctx, nodes, Some(5), None);s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(186, 186, 0.5, 36, 0.5, 186, 36, ((0.25 * p[128]) * p[128]), 0.5);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.b[402] = (p[56] == 0.0);s.store_scalar(402, if s.b[402] { 1.0 } else { 0.0 });s.b[403] = (p[56] == 1.0);s.store_scalar(403, if s.b[403] { 1.0 } else { 0.0 });s.b[404] = (p[56] == 2.0);s.store_scalar(404, if s.b[404] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_8(
        ...
        s.b[405] = (p[56] == 3.0);s.store_scalar(405, if s.b[405] { 1.0 } else { 0.0 });s.b[406] = (p[56] == 4.0);s.store_scalar(406, if s.b[406] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[405] && (!((s.b[402] || s.b[403]) || s.b[404]))) {s.store_offset_scaled(330, 82, ((1.0 / (s.v[35])) * (p[79])), (((((-1.0)) * (p[79]))) + (p[61])));s.store_scale_ad(324, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[73]), p[65]);s.store_scale_ad(137, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[71]), (((p[4] * p[3]) * p[5]) * p[63]));}
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if ((s.b[406] && (!(((s.b[402] || s.b[403]) || s.b[404]) || s.b[405]))) && s.b[419]) {s.store_mul_exp_rhs(358, 358, 357);s.store_mul_sub_mixed_iia(381, 325, 358, A::exp(A::div_from_scalar(p[70], A::mul(s.ad_value(331), s.ad_value(36)))));s.store_sub(207, 380, 381);}
        ...
        if (s.b[424] && s.b[425]) {s.store_scalar(350, (1.0 + p[45]));s.store_mul_sqrt_lhs(351, 350, 94);s.store_div(352, 351, 173);s.store_scale(353, 352, 2.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        ...
        s.b[427] = (p[149] == 0.0);s.store_scalar(427, if s.b[427] { 1.0 } else { 0.0 });s.b[428] = (p[149] == 0.0);s.store_scalar(428, if s.b[428] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
