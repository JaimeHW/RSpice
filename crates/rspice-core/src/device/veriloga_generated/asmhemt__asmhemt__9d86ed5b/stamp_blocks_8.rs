...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_45(
        ...
        if ((!s.b[493]) && s.b[502]) {s.copy_ad(278, 66);s.store_scalar(146, (1.0 + p[191]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_sub_from_scalar_ad(88, p[185], A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[188])), (((-1.0)) * (p[188]))));s.store_scalar(271, (p[9] / p[186]));s.store_div_scalar_by_product_indices(136, p[187], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[184]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 278, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(278), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(270, 160, 88);s.store_div_scaled_inputs_indices(84, 271, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 271, 6.241509074460763e18);s.store_scaled_add_mixed_ia(154, 270, A::sqrt_square_offset(s.ad_value(270), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t0: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t0, (-(p[195] / 3.0)), A::add_scaled_offset_product_rhs(t0, ((2.0 * p[195]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 270, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_reactive_block_46(
        ...
        if ((!s.b[493]) && s.b[502]) {s.store_scalar(279, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[189]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[190]);s.store_mul_scaled_abs_ad_rhs(136, 271, 1.0 / (p[9]), A::sub(s.ad_value(270), s.ad_value(272)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(272)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_mixed_ia(90, 270, A::sqrt_square_offset(s.ad_value(270), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[187], 136, p[187], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(279), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));}
    }
    #[inline(never)]
