...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_62(
        ...
        if ((!s.b[523]) && s.b[532]) {s.store_scalar(303, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 295, 1.0 / (p[9]), A::sub(s.ad_value(294), s.ad_value(296)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(296)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 294, 294, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(303), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_64(
        ...
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {s.store_sub(115, 130, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
