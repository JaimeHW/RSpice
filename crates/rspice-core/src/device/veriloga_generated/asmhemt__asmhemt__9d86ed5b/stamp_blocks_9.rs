...
impl Instance {
    ...
    if (s.b[388] && (!s.b[387])) {
        let eq9_e352: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 0, (nv5 - 0.0));let eq9_e353: f64 = (p[97] * eq9_e352);
        (eq9_e353, (p[97] * ddt_scale),)
    } else {
        (0.0, 0.0,)
    }
};
    ...
    if (s.b[388] && (!s.b[387])) {
        let __rspice_inv_cse_1: f64 = 1.0 / p[98];let eq10_e362: f64 = ((nv5 - 0.0) * __rspice_inv_cse_1);let eq10_e362_d_n5: f64 = (1.0 * __rspice_inv_cse_1);
    ...
    if (s.b[389] && (!(s.b[387] || s.b[388]))) {
        let __rspice_inv_cse_2: f64 = 1.0 / p[108];let eq15_e401: f64 = ((nv5 - 0.0) * __rspice_inv_cse_2);let eq15_e401_d_n5: f64 = (1.0 * __rspice_inv_cse_2);
    ...
    if (s.b[389] && (!(s.b[387] || s.b[388]))) {
        let eq17_e424: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 1, (nv5 - 0.0));let eq17_e425: f64 = (p[110] * eq17_e424);
        (eq17_e425, (p[110] * ddt_scale),)
    } else {
        (0.0, 0.0,)
    }
};
    ...
    if (s.b[389] && (!(s.b[387] || s.b[388]))) {
        let __rspice_inv_cse_3: f64 = 1.0 / p[109];let eq18_e436: f64 = ((nv6 - 0.0) * __rspice_inv_cse_3);let eq18_e436_d_n6: f64 = (1.0 * __rspice_inv_cse_3);
    ...
    if (s.b[389] && (!(s.b[387] || s.b[388]))) {
        let eq20_e459: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 2, (nv6 - 0.0));let eq20_e460: f64 = (p[111] * eq20_e459);
        (eq20_e460, (p[111] * ddt_scale),)
    } else {
        (0.0, 0.0,)
    }
};
    ...
    if (s.b[390] && (!((s.b[387] || s.b[388]) || s.b[389]))) {
        let __rspice_inv_cse_4: f64 = 1.0 / p[119];let eq25_e509: f64 = ((nv5 - 0.0) * __rspice_inv_cse_4);let eq25_e509_d_n5: f64 = (1.0 * __rspice_inv_cse_4);
