...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_65(
        ...
        if ((s.b[523] && s.b[524]) && s.b[530]) {s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[523] && s.b[524]) && s.b[530]) {
    ...
    pub(super) fn stamp_transient_block_67(
        ...
        if ((!s.b[523]) && s.b[532]) {s.store_scalar(303, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 295, 1.0 / (p[9]), A::sub(s.ad_value(294), s.ad_value(296)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(296)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_mixed_ia(90, 294, A::sqrt_square_offset(s.ad_value(294), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(303), s.ad_value(85)), p[18]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_68(
        ...
        if ((!s.b[523]) && s.b[532]) {s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));s.store_mul(86, 303, 90);s.store_sub(39, 294, 86);s.copy_ad(130, 39);s.store_scaled_add_mixed_ia(131, 130, A::sqrt_square_offset(s.ad_value(130), ((4.0 * 0.3) * 0.3)), 0.5);s.copy_ad(154, 131);s.store_div_scaled_product_sqrt_square_sum_denominator(157, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(158, 154, 151, 1.0, 154, 151, 1.0);let t2: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(157)))), 1.0, t2, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t2, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(158)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 130, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_69(
        ...
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 130, 114);s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
    ...
    pub(super) fn stamp_transient_block_72(
        ...
        if (s.b[538] && s.b[539]) {s.store_sub(39, 306, 86);s.copy_ad(130, 39);s.store_scaled_add_mixed_ia(131, 130, A::sqrt_square_offset(s.ad_value(130), ((4.0 * 0.3) * 0.3)), 0.5);s.copy_ad(154, 131);s.store_div_scaled_product_sqrt_square_sum_denominator(157, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(158, 154, 151, 1.0, 154, 151, 1.0);let t4: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(157)))), 1.0, t4, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t4, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(158)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 130, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if ((!s.b[538]) && s.b[547]) {s.store_mul(86, 315, 90);s.store_sub(39, 306, 86);s.copy_ad(130, 39);s.store_scaled_add_mixed_ia(131, 130, A::sqrt_square_offset(s.ad_value(130), ((4.0 * 0.3) * 0.3)), 0.5);s.copy_ad(154, 131);s.store_div_scaled_product_sqrt_square_sum_denominator(157, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(158, 154, 151, 1.0, 154, 151, 1.0);let t6: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(157)))), 1.0, t6, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t6, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(158)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 130, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_78(
        ...
        if s.b[558] {s.store_div_scaled_inputs(168, A::voltage(ctx, nodes, Some(0), Some(2)), p[214], A::sqrt(A::offset(A::square(A::voltage(ctx, nodes, Some(0), Some(2))), (p[214] * p[214]))), 1.0);s.store_scalar(169, (p[213]).min((p[211] / (2.0 * p[214]))));s.store_sub_from_scalar_scaled_mul(167, ((p[4] * p[5]) * p[211]), 169, 168, (p[4] * p[5]));s.store_mul_voltage_ad(163, A::max_with_scalar(s.ad_value(167), 0.0), ctx, nodes, Some(10), Some(0));}
        ...
        s.store_scaled_voltage(164, ctx, nodes, Some(0), Some(2), ((p[4] * p[5]) * p[212]));s.store_scaled_voltage(219, ctx, nodes, Some(3), Some(0), ((p[4] * p[5]) * p[215]));s.store_scaled_voltage(220, ctx, nodes, Some(3), Some(2), ((p[4] * p[5]) * p[216]));s.store_scaled_voltage(221, ctx, nodes, Some(3), Some(1), ((p[4] * p[5]) * p[217]));s.store_offset_scaled(375, 82, ((1.0 / (s.v[35])) * (p[285])), (((((-1.0)) * (p[285]))) + (p[279])));s.store_offset_scaled(373, 82, ((1.0 / (s.v[35])) * (p[283])), (((((-1.0)) * (p[283]))) + (p[275])));s.store_scale_ad(377, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[281]), p[277]);s.store_offset_scaled(376, 82, ((1.0 / (s.v[35])) * (p[286])), (((((-1.0)) * (p[286]))) + (p[280])));s.store_offset_scaled(374, 82, ((1.0 / (s.v[35])) * (p[284])), (((((-1.0)) * (p[284]))) + (p[276])));s.store_scale_ad(378, A::exp_scaled_input(A::scale_offset(s.ad_value(82), 1.0 / (s.v[35]), (-1.0)), p[282]), p[278]);s.store_scale(137, 378, (p[4] * p[5]));s.store_max_with_scalar_ad(371, A::sub(A::voltage(ctx, nodes, Some(0), Some(3)), s.ad_value(376)), 0.0);s.b[559] = (s.v[137] > 0.0);s.store_scalar(559, if s.b[559] { 1.0 } else { 0.0 });s.b[560] = (s.v[371] > 0.0);s.store_scalar(560, if s.b[560] { 1.0 } else { 0.0 });
        ...
        s.store_max_with_scalar_ad(372, A::sub(A::voltage(ctx, nodes, Some(2), Some(3)), s.ad_value(375)), 0.0);s.store_scale(137, 377, (p[4] * p[5]));s.b[563] = (s.v[137] > 0.0);s.store_scalar(563, if s.b[563] { 1.0 } else { 0.0 });s.b[564] = (s.v[372] > 0.0);s.store_scalar(564, if s.b[564] { 1.0 } else { 0.0 });
        ...
        s.b[567] = (p[259] == 1.0);s.store_scalar(567, if s.b[567] { 1.0 } else { 0.0 });s.b[569] = (p[255] == 2.0);s.store_scalar(569, if s.b[569] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
