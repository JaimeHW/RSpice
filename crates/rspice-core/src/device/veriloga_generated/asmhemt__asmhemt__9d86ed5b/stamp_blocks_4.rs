...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_64(
        ...
        if (s.b[523] && s.b[524]) {s.store_sub_ad(88, A::sub_from_scalar(p[198], A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[201])), (((-1.0)) * (p[201])))), A::div_scaled_inputs(s.ad_value(304), (p[207] * p[206]), A::sqrt_square_offset(s.ad_value(304), (p[207] * p[207])), 1.0));s.store_scalar(295, (p[9] / p[199]));s.store_div_scalar_by_product_indices(136, p[200], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[197]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 302, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(302), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(294, 160, 88);s.store_div_scaled_inputs_indices(84, 295, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 295, 6.241509074460763e18);s.store_scaled_add_sqrt_square_offset_rhs(154, 294, 294, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t0: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t0, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t0, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 294, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_65(
        ...
        if ((s.b[523] && s.b[524]) && s.b[528]) {s.store_scaled_mul(107, 136, 91, p[208]);s.store_scaled_mul(108, 136, 91, p[209]);s.store_scaled_mul_limited_exp_scale_offset_rhs(109, 104, 107, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(110, 104, 1.0);s.store_scaled_mul_limited_exp_scale_offset_rhs(111, 105, 108, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(112, 105, 1.0);s.store_add_scaled_inputs3_mixed_iaa(113, 99, (-1.0), A::div(s.ad_value(109), s.ad_value(110)), (-1.0), A::div(s.ad_value(111), s.ad_value(112)), -1.0);s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 294, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(137, 115, (-0.3333333333333333));s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[523] && s.b[524]) && s.b[528]) {
        ...
        if ((s.b[523] && s.b[524]) && s.b[528]) {s.store_scaled_mul(121, 136, 137, p[208]);s.store_scaled_mul(122, 136, 137, p[209]);s.store_scaled_mul_limited_exp_scale_offset_rhs(123, 118, 121, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(124, 118, 1.0);s.store_scaled_mul_limited_exp_scale_offset_rhs(125, 119, 122, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(126, 119, 1.0);s.store_add_scaled_inputs3_mixed_iaa(127, 99, (-1.0), A::div(s.ad_value(123), s.ad_value(124)), (-1.0), A::div(s.ad_value(125), s.ad_value(126)), -1.0);s.store_sub_div_rhs_indices(128, 114, 120, 127);s.copy_ad(296, 128);}
        if ((s.b[523] && s.b[524]) && (!s.b[528])) {s.copy_ad(296, 100);}
        if (s.b[523] && s.b[524]) {s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 295, 1.0 / (p[9]), A::sub(s.ad_value(294), s.ad_value(296)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(296)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 294, 294, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(303), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));s.store_mul(86, 303, 90);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_66(
        ...
        if ((s.b[523] && s.b[524]) && s.b[530]) {s.store_sub(101, 130, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
    ...
    pub(super) fn stamp_transient_block_67(
        ...
        if ((s.b[523] && s.b[524]) && s.b[530]) {s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[523] && s.b[524]) && s.b[530]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
        ...
        if ((s.b[523] && s.b[524]) && s.b[530]) {s.store_mul_scaled_powf_rhs(121, 136, p[208], 115, (-0.3333333333333333));s.store_mul_scaled_powf_rhs(122, 136, p[209], 115, (-0.3333333333333333));s.store_scaled_mul_limited_exp_scale_offset_rhs(123, 118, 121, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(124, 118, 1.0);s.store_scaled_mul_limited_exp_scale_offset_rhs(125, 119, 122, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(126, 119, 1.0);s.store_add_scaled_inputs3_mixed_iaa(127, 99, (-1.0), A::div(s.ad_value(123), s.ad_value(124)), (-1.0), A::div(s.ad_value(125), s.ad_value(126)), -1.0);s.store_sub_div_rhs_indices(128, 114, 120, 127);s.store_add(297, 128, 86);}
        if ((s.b[523] && s.b[524]) && (!s.b[530])) {s.store_add(297, 100, 86);}
        if (s.b[523] && s.b[524]) {s.store_scaled_add(298, 296, 297, 0.5);s.store_sub(299, 297, 296);s.store_mul_add_scaled_inputs3_offset_rhs_indices(135, 299, 294, 1.0, 298, (-1.0), 83, 1.0, 0.0);s.store_mul_scaled_abs_ad_rhs(136, 295, 1.0 / (p[9]), A::sub(s.ad_value(294), s.ad_value(298)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(129)), (s.v[81] / p[9]));s.store_div_add_scaled_inputs_rhs_mixed_ai(95, 97, A::add_scaled_product(A::scale_offset(s.ad_value(136), p[14], 1.0), 1.0, s.ad_value(136), s.ad_value(136), p[15]), 1.0, 90, p[16]);s.store_scaled_mul(96, 95, 295, (p[4] * (p[5] * 1.0 / (p[200]))));s.store_mul_scale_offset_mixed_ia(98, 96, A::sub_scaled_inputs(s.ad_value(304), p[21], s.ad_value(86), p[21]), 1.0, 1.0);s.store_sqrt_offset_ad(92, A::mul_scaled_lhs(s.ad_value(299), (p[25] * p[25]), s.ad_value(299)), 1.0);s.store_div(93, 98, 92);s.store_mul(305, 93, 135);s.store_sub(90, 297, 296);s.store_add_scaled_inputs3_indices(91, 294, 1.0, 83, 1.0, 298, -1.0);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(137, 295, 294, ((p[4] * p[5]) * p[200]), 298, (((-1.0)) * (((p[4] * p[5]) * p[200]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[200]), 0.0);s.store_scale(188, 137, (1.0 / (p[245]) * 1e26));s.store_offset_powf_ad(189, s.ad_value(188), p[244], 1.0);s.store_div_from_scalar(190, p[243], 189);s.store_div_from_scalar_offset_input(191, p[9], 190, p[199]);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(300, 191, 294, ((p[4] * p[5]) * p[200]), 298, (((-1.0)) * (((p[4] * p[5]) * p[200]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[200]), 0.0);s.store_add_scaled_inputs3_indices(136, 294, 1.0, 83, 1.0, 298, -1.0);s.store_add_scaled_inputs(90, 296, 0.3333333333333333, 297, (2.0 * 0.3333333333333333));s.store_div_scaled_inputs_mixed_ai(91, A::square(s.ad_value(299)), (1.0 / 12.0), 136, 1.0);s.store_div_scaled_product_mixed_aia(137, A::square(s.ad_value(299)), 299, (1.0 / 120.0), A::square(s.ad_value(136)), 1.0);s.store_mul_add_scaled_inputs4_indices_rhs(301, 191, 294, (-(((p[4] * p[200]) * p[5]) * 0.5)), 90, (((-1.0)) * ((-(((p[4] * p[200]) * p[5]) * 0.5)))), 91, (-(((p[4] * p[200]) * p[5]) * 0.5)), 137, (-(((p[4] * p[200]) * p[5]) * 0.5)));}
    ...
    pub(super) fn stamp_transient_block_68(
        ...
        if ((!s.b[523]) && s.b[532]) {s.copy_ad(302, 74);s.store_scalar(146, (1.0 + p[204]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_sub_from_scalar_ad(88, p[198], A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[201])), (((-1.0)) * (p[201]))));s.store_scalar(295, (p[9] / p[199]));s.store_div_scalar_by_product_indices(136, p[200], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[197]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 302, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(302), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(294, 160, 88);s.store_div_scaled_inputs_indices(84, 295, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 295, 6.241509074460763e18);s.store_scaled_add_sqrt_square_offset_rhs(154, 294, 294, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t2: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t2, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t2, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 294, 1.0, 83, 2.0);}
        ...
        if (((!s.b[523]) && s.b[532]) && s.b[535]) {s.store_sub(101, 294, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_69(
        ...
        if ((!s.b[523]) && s.b[532]) {s.store_scalar(303, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 295, 1.0 / (p[9]), A::sub(s.ad_value(294), s.ad_value(296)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(296)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 294, 294, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(303), s.ad_value(85)), p[18]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_70(
        ...
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {s.store_sub(101, 130, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {
            s.store_add_scaled_products3_mixed_iiiaia(106, 99, 101, 1.0, 83, {
                if ((!(s.v[104] >= 37.0)) && (!(s.v[104] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(104))
    ...
    pub(super) fn stamp_transient_block_71(
        ...
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 130, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[523]) && s.b[532]) && s.b[537]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
    ...
    pub(super) fn stamp_transient_block_72(
        ...
        if (s.b[538] && s.b[539]) {s.store_sub_ad(88, A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[201])), (((((-1.0)) * (p[201]))) + (p[198]))), A::div_scaled_inputs(s.ad_value(316), (p[207] * p[206]), A::sqrt_square_offset(s.ad_value(316), (p[207] * p[207])), 1.0));s.store_scalar(307, (p[9] / p[199]));s.store_div_scalar_by_product_indices(136, p[200], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[197]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 314, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(314), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(306, 160, 88);s.store_div_scaled_inputs_indices(84, 307, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 307, 6.241509074460763e18);s.store_scaled_add_sqrt_square_offset_rhs(154, 306, 306, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t4: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t4, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t4, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 306, 1.0, 83, 2.0);}
        ...
        if ((s.b[538] && s.b[539]) && s.b[543]) {s.store_sub(101, 306, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_73(
        ...
        if ((s.b[538] && s.b[539]) && s.b[543]) {s.store_scaled_mul(107, 136, 91, p[208]);s.store_scaled_mul(108, 136, 91, p[209]);s.store_scaled_mul_limited_exp_scale_offset_rhs(109, 104, 107, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(110, 104, 1.0);s.store_scaled_mul_limited_exp_scale_offset_rhs(111, 105, 108, 0.6666666666666666, 1.0, 3.24e17);s.store_offset_limited_exp(112, 105, 1.0);s.store_add_scaled_inputs3_mixed_iaa(113, 99, (-1.0), A::div(s.ad_value(109), s.ad_value(110)), (-1.0), A::div(s.ad_value(111), s.ad_value(112)), -1.0);s.store_sub_div_rhs_indices(114, 100, 106, 113);s.store_sub(115, 306, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(137, 115, (-0.3333333333333333));s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[538] && s.b[539]) && s.b[543]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
        ...
        if (s.b[538] && s.b[539]) {s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 307, 1.0 / (p[9]), A::sub(s.ad_value(306), s.ad_value(308)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(308)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 306, 306, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(315), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));s.store_mul(86, 315, 90);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_74(
        ...
        if ((s.b[538] && s.b[539]) && s.b[545]) {s.store_sub(101, 130, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
    ...
    pub(super) fn stamp_transient_block_75(
        ...
        if ((s.b[538] && s.b[539]) && s.b[545]) {s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[538] && s.b[539]) && s.b[545]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if ((!s.b[538]) && s.b[547]) {s.copy_ad(314, 78);s.store_scalar(146, (1.0 + p[204]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_offset_scaled(88, 82, ((1.0 / (s.v[35])) * (p[201])), (((((-1.0)) * (p[201]))) + (p[198])));s.store_scalar(307, (p[9] / p[199]));s.store_div_scalar_by_product_indices(136, p[200], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[197]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 314, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(314), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(306, 160, 88);s.store_div_scaled_inputs_indices(84, 307, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 307, 6.241509074460763e18);s.store_scaled_add_sqrt_square_offset_rhs(154, 306, 306, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);let t6: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t6, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t6, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 306, 1.0, 83, 2.0);}
        ...
        if (((!s.b[538]) && s.b[547]) && s.b[550]) {s.store_sub(101, 306, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_77(
        ...
        if ((!s.b[538]) && s.b[547]) {s.store_scalar(315, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[202]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[203]);s.store_mul_scaled_abs_ad_rhs(136, 307, 1.0 / (p[9]), A::sub(s.ad_value(306), s.ad_value(308)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(308)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(90, 306, 306, ((4.0 * 0.3) * 0.3), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[200], 136, p[200], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(315), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_78(
        ...
        if ((!s.b[538]) && s.b[547]) {s.store_mul(86, 315, 90);s.store_sub(39, 306, 86);s.copy_ad(130, 39);s.store_scaled_add_sqrt_square_offset_rhs(131, 130, 130, ((4.0 * 0.3) * 0.3), 0.5);s.copy_ad(154, 131);s.store_div_scaled_product_sqrt_square_sum_denominator(157, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(158, 154, 151, 1.0, 154, 151, 1.0);let t7: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(157)))), 1.0, t7, (-(p[208] / 3.0)), A::add_scaled_offset_product_rhs(t7, ((2.0 * p[208]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(158)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 130, 1.0, 83, 2.0);}
        ...
        if (((!s.b[538]) && s.b[547]) && s.b[552]) {s.store_sub(101, 130, 100);s.store_scaled_add_sqrt_square_offset_rhs(101, 101, 101, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_powf(136, 99, 0.6666666666666666);s.store_powf(90, 101, 0.6666666666666666);s.store_powf(91, 101, (-0.3333333333333333));s.store_scaled_mul(102, 136, 90, p[208]);s.store_scaled_mul(103, 136, 90, p[209]);s.store_sub_div_same_denominator(104, 100, 102, 83);s.store_sub_div_same_denominator(105, 100, 103, 83);}
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        if (((!s.b[538]) && s.b[547]) && s.b[552]) {s.store_sub(115, 130, 114);s.store_scaled_add_sqrt_square_offset_rhs(115, 115, 115, ((4.0 * 1e-9) * 1e-9), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[208], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[209], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[538]) && s.b[547]) && s.b[552]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
        ...
        s.b[553] = (p[255] == 1.0);s.store_scalar(553, if s.b[553] { 1.0 } else { 0.0 });
        if s.b[553] {s.store_scalar(318, ((p[258] * (p[256] + ((p[4] / 3.0) / p[257]))) / ((p[257] * p[5]) * p[3])));}
        ...
        s.b[555] = (p[255] == 2.0);s.store_scalar(555, if s.b[555] { 1.0 } else { 0.0 });
        if ((!s.b[553]) && s.b[555]) {s.store_scalar(319, ((p[258] * (p[256] + ((p[4] / 3.0) / p[257]))) / ((p[257] * p[5]) * p[3])));s.store_scalar(320, ((p[258] * (((2.0 * p[4]) / 3.0) / p[257])) / ((p[257] * p[5]) * p[3])));}
        ...
        if s.b[558] {s.store_scaled_voltage(162, ctx, nodes, Some(10), Some(2), ((p[4] * p[5]) * p[210]));}
    }
}
