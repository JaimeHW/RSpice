...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if (s.b[433] && s.b[434]) {s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[163]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[164]);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if ((s.b[433] && s.b[434]) && s.b[440]) {s.store_sub_div_same_denominator(105, 100, 103, 83);}
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        if (((!s.b[433]) && s.b[442]) && s.b[444]) {s.store_div_scaled_product3_mixed_iiaa(153, 83, 99, A::add_scaled_inputs(s.ad_value(136), (3.0 * 0.25), A::ln(A::add(s.ad_value(90), s.ad_value(91))), 1.0), 2.0, A::add_scaled_product(A::div_from_scalar(1.0, s.ad_value(152)), 1.0, s.ad_value(99), A::limited_exp_div_scaled_inputs(s.ad_value(222), (-1.0), s.ad_value(83), 2.0), 1.0 / (3.24e17)), 1.0);}
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if (((!s.b[433]) && s.b[442]) && s.b[445]) {s.store_add_scaled_inputs3_mixed_iaa(127, 99, (-1.0), A::div(s.ad_value(123), s.ad_value(124)), (-1.0), A::div(s.ad_value(125), s.ad_value(126)), -1.0);s.store_sub_div_rhs_indices(128, 114, 120, 127);s.copy_ad(224, 128);}
        if (((!s.b[433]) && s.b[442]) && (!s.b[445])) {s.copy_ad(224, 100);}
        if ((!s.b[433]) && s.b[442]) {s.store_scalar(231, 0.0);s.store_scaled_powf_ad(97, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[20], p[163]);s.store_scaled_powf_ad(89, A::scale(s.ad_value(82), 1.0 / (s.v[35])), p[19], p[164]);s.store_mul_scaled_abs_ad_rhs(136, 223, 1.0 / (p[9]), A::sub(s.ad_value(222), s.ad_value(224)));s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(224)), (s.v[81] / p[9]));s.store_div_mixed_ia(95, 97, A::add_scaled_inputs3_offset(s.ad_value(136), p[14], A::square(s.ad_value(136)), p[15], s.ad_value(90), p[16], 1.0));s.store_div_scaled_inputs_indices(136, 89, 2.0, 95, 1.0);s.store_scaled_add_mixed_ia(90, 222, A::sqrt_square_offset(s.ad_value(222), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(85, 136, 90, p[161], 136, p[161], 90, 1.0, 1.0);s.store_powf_ad(136, A::div(s.ad_value(231), s.ad_value(85)), p[18]);s.store_powf_offset_input(90, 136, 1.0, ((-1.0) / p[18]));s.store_mul(86, 231, 90);s.store_sub(39, 222, 86);s.copy_ad(130, 39);s.store_scaled_add_mixed_ia(131, 130, A::sqrt_square_offset(s.ad_value(130), ((4.0 * 0.3) * 0.3)), 0.5);s.copy_ad(154, 131);s.store_div_scaled_product_sqrt_square_sum_denominator(157, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(158, 154, 151, 1.0, 154, 151, 1.0);let t5: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(157)))), 1.0, t5, (-(p[169] / 3.0)), A::add_scaled_offset_product_rhs(t5, ((2.0 * p[169]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(158)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 130, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_22(
        ...
        if ((!s.b[433]) && s.b[442]) {s.store_scaled_add(226, 224, 225, 0.5);s.store_sub(227, 225, 224);s.store_sub(90, 225, 224);s.store_add_scaled_inputs3_indices(91, 222, 1.0, 83, 1.0, 226, -1.0);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(137, 223, 222, ((p[4] * p[5]) * p[161]), 226, (((-1.0)) * (((p[4] * p[5]) * p[161]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[161]), 0.0);s.store_scale(188, 137, (1.0 / (p[236]) * 1e26));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_23(
        ...
        if ((!s.b[433]) && s.b[442]) {s.store_offset_powf_ad(189, s.ad_value(188), p[235], 1.0);s.store_div_from_scalar(190, p[234], 189);s.store_div_from_scalar_offset_input(191, p[9], 190, p[160]);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(228, 191, 222, ((p[4] * p[5]) * p[161]), 226, (((-1.0)) * (((p[4] * p[5]) * p[161]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[161]), 0.0);s.store_add_scaled_inputs3_indices(136, 222, 1.0, 83, 1.0, 226, -1.0);s.store_add_scaled_inputs(90, 224, 0.3333333333333333, 225, (2.0 * 0.3333333333333333));s.store_div_scaled_inputs_mixed_ai(91, A::square(s.ad_value(227)), (1.0 / 12.0), 136, 1.0);s.store_div_scaled_product_mixed_aia(137, A::square(s.ad_value(227)), 227, (1.0 / 120.0), A::square(s.ad_value(136)), 1.0);s.store_mul_add_scaled_inputs4_indices_rhs(229, 191, 222, (-(((p[4] * p[161]) * p[5]) * 0.5)), 90, (((-1.0)) * ((-(((p[4] * p[161]) * p[5]) * 0.5)))), 91, (-(((p[4] * p[161]) * p[5]) * 0.5)), 137, (-(((p[4] * p[161]) * p[5]) * 0.5)));}
        ...
        if (s.b[448] && s.b[449]) {s.store_offset_sqrt_ad(244, A::offset(A::square(s.ad_value(243)), 0.01), (-0.1));s.store_offset_scaled(146, 244, p[166], (1.0 + p[165]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_sub_ad(88, A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[162])), (((((-1.0)) * (p[162]))) + (p[159]))), A::div_scaled_inputs(s.ad_value(244), (p[168] * p[167]), A::sqrt_square_offset(s.ad_value(244), (p[168] * p[168])), 1.0));s.store_scalar(235, (p[9] / p[160]));s.store_div_scalar_by_product_indices(136, p[161], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[158]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 242, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(242), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(234, 160, 88);s.store_div_scaled_inputs_indices(84, 235, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 235, 6.241509074460763e18);s.store_scaled_add_mixed_ia(154, 234, A::sqrt_square_offset(s.ad_value(234), ((4.0 * 0.3) * 0.3)), 0.5);s.store_div_scaled_product_sqrt_square_sum_denominator(155, 154, 150, 1.0, 154, 150, 1.0);s.store_div_scaled_product_sqrt_square_sum_denominator(130, 154, 151, 1.0, 154, 151, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_24(
        ...
        if (s.b[448] && s.b[449]) {let t6: A = A::powf(A::mul(s.ad_value(99), s.ad_value(154)), 0.6666666666666666);s.store_div_scaled_inputs3_mixed_iaaa(152, 154, 1.0, A::mul_sub_from_scalar_rhs(s.ad_value(83), 1.0, A::ln(A::mul(s.ad_value(84), s.ad_value(155)))), 1.0, t6, (-(p[169] / 3.0)), A::add_scaled_offset_product_rhs(t6, ((2.0 * p[169]) / 3.0), s.ad_value(154), A::div(s.ad_value(83), s.ad_value(130)), 1.0, 1.0), 1.0);s.store_div_scaled_inputs_indices(136, 234, 1.0, 83, 2.0);}
    ...
    pub(super) fn stamp_transient_block_25(
        ...
        if ((s.b[448] && s.b[449]) && s.b[454]) {s.store_limited_exp_scaled_input(90, 136, 1.0 / (4.0));s.store_limited_exp_scaled_input(91, 136, ((-3.0) * 1.0 / (4.0)));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_26(
        ...
        if ((s.b[448] && s.b[449]) && s.b[454]) {s.store_div_scaled_product3_mixed_iiaa(156, 83, 99, A::add_scaled_inputs(s.ad_value(136), (3.0 * 0.25), A::ln(A::add(s.ad_value(90), s.ad_value(91))), 1.0), 2.0, A::add_scaled_product(A::div_from_scalar(1.0, s.ad_value(152)), 1.0, s.ad_value(99), A::limited_exp_div_scaled_inputs(s.ad_value(130), (-1.0), s.ad_value(83), 2.0), 1.0 / (3.24e17)), 1.0);}
    ...
    pub(super) fn stamp_transient_block_27(
        ...
        if ((!s.b[448]) && s.b[457]) {s.copy_ad(234, 54);s.store_scalar(146, (1.0 + p[165]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_offset_scaled(88, 82, ((1.0 / (s.v[35])) * (p[162])), (((((-1.0)) * (p[162]))) + (p[159])));s.store_scalar(235, (p[9] / p[160]));s.store_div_scalar_by_product_indices(136, p[161], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[158]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 242, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(242), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(234, 160, 88);s.store_div_scaled_inputs_indices(84, 235, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if (((!s.b[448]) && s.b[457]) && s.b[460]) {s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_powf(137, 115, (-0.3333333333333333));s.store_mul_scaled_powf_rhs(116, 136, p[169], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[170], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[448]) && s.b[457]) && s.b[460]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
