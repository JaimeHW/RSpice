...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if (s.b[433] && s.b[434]) {s.store_scaled_add(226, 224, 225, 0.5);s.store_sub(227, 225, 224);s.store_mul_add_scaled_inputs3_offset_rhs_indices(135, 227, 222, 1.0, 226, (-1.0), 83, 1.0, 0.0);s.store_mul_scaled_abs_ad_rhs(136, 223, 1.0 / (p[9]), A::sub(s.ad_value(222), s.ad_value(226)));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_17(
        ...
        if (s.b[433] && s.b[434]) {s.store_scaled_abs_ad(90, A::sub(s.ad_value(45), s.ad_value(129)), (s.v[81] / p[9]));s.store_div_add_scaled_inputs_rhs_mixed_ai(95, 97, A::add_scaled_product(A::scale_offset(s.ad_value(136), p[14], 1.0), 1.0, s.ad_value(136), s.ad_value(136), p[15]), 1.0, 90, p[16]);s.store_scaled_mul(96, 95, 223, (p[4] * (p[5] * 1.0 / (p[161]))));s.store_mul_scale_offset_mixed_ia(98, 96, A::sub_scaled_inputs(s.ad_value(232), p[21], s.ad_value(86), p[21]), 1.0, 1.0);s.store_sqrt_offset_ad(92, A::mul_scaled_lhs(s.ad_value(227), (p[25] * p[25]), s.ad_value(227)), 1.0);s.store_div(93, 98, 92);s.store_mul(233, 93, 135);s.store_sub(90, 225, 224);s.store_add_scaled_inputs3_indices(91, 222, 1.0, 83, 1.0, 226, -1.0);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(137, 223, 222, ((p[4] * p[5]) * p[161]), 226, (((-1.0)) * (((p[4] * p[5]) * p[161]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[161]), 0.0);s.store_scale(188, 137, (1.0 / (p[236]) * 1e26));s.store_offset_powf_ad(189, s.ad_value(188), p[235], 1.0);s.store_div_from_scalar(190, p[234], 189);s.store_div_from_scalar_offset_input(191, p[9], 190, p[160]);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_iia(228, 191, 222, ((p[4] * p[5]) * p[161]), 226, (((-1.0)) * (((p[4] * p[5]) * p[161]))), A::div_scaled_product(s.ad_value(90), s.ad_value(90), 0.5, s.ad_value(91), 6.0), ((p[4] * p[5]) * p[161]), 0.0);s.store_add_scaled_inputs3_indices(136, 222, 1.0, 83, 1.0, 226, -1.0);s.store_add_scaled_inputs(90, 224, 0.3333333333333333, 225, (2.0 * 0.3333333333333333));s.store_div_scaled_inputs_mixed_ai(91, A::square(s.ad_value(227)), (1.0 / 12.0), 136, 1.0);s.store_div_scaled_product_mixed_aia(137, A::square(s.ad_value(227)), 227, (1.0 / 120.0), A::square(s.ad_value(136)), 1.0);s.store_mul_add_scaled_inputs4_indices_rhs(229, 191, 222, (-(((p[4] * p[161]) * p[5]) * 0.5)), 90, (((-1.0)) * ((-(((p[4] * p[161]) * p[5]) * 0.5)))), 91, (-(((p[4] * p[161]) * p[5]) * 0.5)), 137, (-(((p[4] * p[161]) * p[5]) * 0.5)));}
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if (s.b[448] && s.b[449]) {s.store_offset_sqrt_ad(244, A::offset(A::square(s.ad_value(243)), 0.01), (-0.1));s.store_offset_scaled(146, 244, p[166], (1.0 + p[165]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);s.store_sub_ad(88, A::scale_offset(s.ad_value(82), ((1.0 / (s.v[35])) * (p[162])), (((((-1.0)) * (p[162]))) + (p[159]))), A::div_scaled_inputs(s.ad_value(244), (p[168] * p[167]), A::sqrt_square_offset(s.ad_value(244), (p[168] * p[168])), 1.0));s.store_scalar(235, (p[9] / p[160]));s.store_div_scalar_by_product_indices(136, p[161], 83, 83, (((2.0 * p[4]) * 1.602176634e-19) * 3.24e17));s.store_add_scaled_product_mixed_iia(159, 88, 1.0, 83, A::ln_scaled_input(s.ad_value(136), p[158]), 1.0);s.store_add_scaled_inputs4_mixed_iiai(160, 242, 0.5, 159, ((-1.0) * 0.5), A::sqrt_square_offset(A::sub(s.ad_value(242), s.ad_value(159)), 0.0001), 0.5, 159, 1.0);s.store_sub(234, 160, 88);s.store_div_scaled_inputs_indices(84, 235, 1.0, 83, (1.602176634e-19 * 3.24e17));s.store_div_from_scalar(150, 2.718281828459045, 84);s.store_div_from_scalar(151, 1.0, 84);s.store_primal_scale(99, 235, 6.241509074460763e18);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_23(
        ...
        if ((s.b[448] && s.b[449]) && s.b[453]) {s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_powf(137, 115, (-0.3333333333333333));s.store_mul_scaled_powf_rhs(116, 136, p[169], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[170], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if ((s.b[448] && s.b[449]) && s.b[453]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if (((!s.b[448]) && s.b[457]) && s.b[462]) {s.store_sub(115, 130, 114);s.store_scaled_add_mixed_ia(115, 115, A::sqrt_square_offset(s.ad_value(115), ((4.0 * 1e-9) * 1e-9)), 0.5);s.store_mul_scaled_powf_rhs(116, 136, p[169], 115, 0.6666666666666666);s.store_mul_scaled_powf_rhs(117, 136, p[170], 115, 0.6666666666666666);s.store_sub_div_same_denominator(118, 114, 116, 83);s.store_sub_div_same_denominator(119, 114, 117, 83);}
        if (((!s.b[448]) && s.b[457]) && s.b[462]) {
            s.store_add_scaled_products3_mixed_iiiaia(120, 99, 115, 1.0, 83, {
                if ((!(s.v[118] >= 37.0)) && (!(s.v[118] <= (-37.0)))) {
                    A::ln_one_plus_exp(s.ad_value(118))
        ...
        if (s.b[463] && s.b[464]) {s.store_offset_sqrt_ad(256, A::offset(A::square(s.ad_value(255)), 0.01), (-0.1));s.store_offset_scaled(146, 256, p[179], (1.0 + p[178]));s.store_scaled_mul(83, 82, 146, 8.617087e-5);}
    }
    #[inline(never)]
