...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_13(
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_scaled_add(938, 934, 937, p.p3);s.store_primal_div(930, 928, 447);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(447), (2.0 * p.p90), (p.p90 * p.p90)), 1.0, A::square(s.ad_value(447)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, s.ad_value(447), s.ad_value(930), 1.0), 447);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if (s.b[1259] && (!s.b[1260])) {
    ...
    pub(super) fn stamp_reactive_block_14(
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_add_scaled_inputs3_sqrt_third_mixed_iia(947, 946, p.p3, 933, ((-0.5) * p.p3), A::add_scaled_square_product(s.ad_value(933), 1.0, s.ad_value(627), s.ad_value(946), 4.0), ((-0.5) * p.p3));s.store_add(451, 938, 947);}
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if (s.b[1259] && (!s.b[1262])) {s.store_scaled_add(938, 934, 937, p.p92);s.store_primal_div(930, 928, 448);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_16(
        ...
        if (s.b[1259] && (!s.b[1262])) {s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(448), (2.0 * p.p90), (p.p90 * p.p90)), 1.0, A::square(s.ad_value(448)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, s.ad_value(448), s.ad_value(930), 1.0), 448);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if (s.b[1259] && (!s.b[1262])) {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1267] {s.store_scaled_add(938, 934, 937, p.p43);s.store_primal_scale(930, 928, 1.0 / (p.p1089));s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);s.store_primal_offset_add_scaled_inputs_mixed_ai(940, A::offset(A::mul(A::sqrt(A::scale_offset(s.ad_value(930), (p.p1089 * p.p1089), (((p.p1089 * p.p1089)) + (((p.p90 * p.p90) + ((2.0 * p.p1089) * p.p90)))))), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, 930, p.p1089, p.p1089);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_19(
        ...
        if s.b[1267] {s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if s.b[1267] {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
        ...
        if (s.b[1267] && s.b[1271]) {s.store_primal_scale_ad(935, A::min(A::div_scaled_value_offset_denominator(s.ad_value(449), 1.0, s.ad_value(448), p.p90, 1.0), A::div_scaled_offset_numerator(s.ad_value(448), 1.0, p.p90, s.ad_value(449), 1.0)), 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_20(
        ...
        if (s.b[1267] && (!s.b[1271])) {s.store_primal_offset_div_scaled_offset_numerator_indices(925, 448, 0.2, (p.p90 * 0.2), 449, 1.0, 2.3);s.store_scalar(926, 1.05);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_21(
        ...
        if (s.b[1267] && (!s.b[1271])) {s.store_primal_abs_ad(927, A::sub(A::offset(s.ad_value(448), p.p90), s.ad_value(449)));s.store_primal_scale(928, 926, p.p1087);s.store_primal_min_offset_rhs(929, 449, 448, p.p90);s.store_primal_div_from_scalar_offset_input(930, p.p1087, 925, 1.0);s.store_scalar(931, 1700000000000.0);s.store_primal_scaled_sub(932, 929, 930, (s.v[144] * 1.0 / (p.p1087)));s.store_mul(933, 931, 932);}
    ...
    pub(super) fn stamp_reactive_block_22(
        ...
        if s.b[1267] {s.store_scaled_add(938, 934, 937, p.p40);s.store_primal_div(930, 928, 448);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_23(
        ...
        if s.b[1267] {s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(448), (2.0 * p.p90), (p.p90 * p.p90)), 1.0, A::square(s.ad_value(448)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, s.ad_value(448), s.ad_value(930), 1.0), 448);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if s.b[1267] {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
    ...
    pub(super) fn stamp_reactive_block_24(
        ...
        if s.b[1267] {s.store_scaled_add(938, 934, 937, p.p42);s.store_primal_div(930, 928, 448);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(448), (2.0 * p.p90), (p.p90 * p.p90)), 1.0, A::square(s.ad_value(448)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, s.ad_value(448), s.ad_value(930), 1.0), 448);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if s.b[1267] {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
    ...
    pub(super) fn stamp_reactive_block_26(
        ...
        s.store_scalar(168, (p.p1109 * p.p1109));s.store_scale(169, 742, p.p1109);s.store_square(170, 169);s.b[1287] = (p.p1717 < (-273.15));s.store_scalar(1287, if s.b[1287] { 1.0 } else { 0.0 });
