...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_113(
        ...
        if (((s.b[1523] && s.b[1524]) && (!s.b[1525])) && s.b[1526]) {s.store_div(168, 521, 539);s.store_div_scaled_offset_numerator_indices(169, 521, 1.0, p.p1626, 539, 1.0);s.store_limited_exp_neg_input(170, 169);s.store_mul_add_scaled_inputs3_offset_rhs_limited_exp_first(519, 537, 168, 1.0, 547, 1.0, 170, (-p.p1628), (-1.0));}
    ...
    pub(super) fn stamp_transient_block_114(
        ...
        if ((s.b[1523] && s.b[1527]) && s.b[1528]) {s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 281, 169, (-p.p11));}
        if ((s.b[1523] && s.b[1527]) && (!s.b[1528])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 287, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1643, A::sub_from_scalar(p.p1643, s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 281, 169, (-p.p11));}
        ...
        if ((s.b[1523] && s.b[1529]) && s.b[1530]) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 289, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 283, 169, (-p.p13));}
        if ((s.b[1523] && s.b[1529]) && (!s.b[1530])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 289, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1645, A::sub_from_scalar(p.p1645, s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 283, 169, (-p.p13));}
        ...
        if ((s.b[1523] && s.b[1531]) && s.b[1532]) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 291, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 285, 169, (-(p.p3 * s.v[115])));}
        if ((s.b[1523] && s.b[1531]) && (!s.b[1532])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 291, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1647, A::sub_from_scalar(p.p1647, s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 285, 169, (-(p.p3 * s.v[115])));}
        ...
        if (((s.b[1523] && s.b[1533]) && (!s.b[1534])) && s.b[1535]) {s.store_div(168, 522, 540);s.store_div_scaled_offset_numerator_indices(169, 522, 1.0, p.p1627, 540, 1.0);s.store_limited_exp_neg_input(170, 169);s.store_mul_add_scaled_inputs3_offset_rhs_limited_exp_first(520, 538, 168, 1.0, 554, 1.0, 170, (-p.p1629), (-1.0));}
        ...
        if ((s.b[1523] && s.b[1536]) && s.b[1537]) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 288, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 282, 169, (-p.p12));}
        if ((s.b[1523] && s.b[1536]) && (!s.b[1537])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 288, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1644, A::sub_from_scalar(p.p1644, s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 282, 169, (-p.p12));}
        ...
        if ((s.b[1523] && s.b[1538]) && s.b[1539]) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 290, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 284, 169, (-p.p14));}
        if ((s.b[1523] && s.b[1538]) && (!s.b[1539])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 290, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1646, A::sub_from_scalar(p.p1646, s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 284, 169, (-p.p14));}
    ...
    pub(super) fn stamp_transient_block_115(
        ...
        if ((s.b[1523] && s.b[1540]) && s.b[1541]) {s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 286, 169, (-(p.p3 * s.v[115])));}
        if ((s.b[1523] && s.b[1540]) && (!s.b[1541])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 292, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p.p1648, A::sub_from_scalar(p.p1648, s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 286, 169, (-(p.p3 * s.v[115])));}
    ...
    pub(super) fn stamp_transient_block_116(
        ...
        s.b[1580] = (p.p1610 != 1.0);s.store_scalar(1580, if s.b[1580] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_117(
        ...
        s.b[1581] = (p.p1610 == 0.5);s.store_scalar(1581, if s.b[1581] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_123(
        ...
        s.store_mul_add_mixed_iia(169, 126, 865, A::mul3(s.ad_value(866), s.ad_value(126), s.ad_value(126)));s.store_mul_ad_affine_product_lhs(556, A::sub_scaled_inputs(s.ad_value(153), 1.0, s.ad_value(875), 2.0), s.ad_value(555), (p.p92 * p.p3), 0.0, 169);s.store_div_scaled_product3_indices(168, 415, 372, 158, 1.0, 153, 1.0);s.b[1675] = ((p.p73 != 0.0) && (s.v[873] != 0.0));s.store_scalar(1675, if s.b[1675] { 1.0 } else { 0.0 });
        ...
        s.b[1676] = (p.p73 == 2.0);s.store_scalar(1676, if s.b[1676] { 1.0 } else { 0.0 });
        if s.b[1676] {s.store_div_scaled_inputs_mixed_ia(570, 569, 1e-9, A::mul3(s.ad_value(163), s.ad_value(158), s.ad_value(153)), 1.0);}
        s.store_scale(476, 476, s.v[115]);s.store_scale(475, 475, s.v[115]);s.store_scale(478, 478, s.v[115]);s.store_scale(477, 477, s.v[115]);s.store_scale(471, 471, s.v[115]);s.store_scale(470, 470, s.v[115]);s.store_scale(480, 480, s.v[115]);s.store_scale(481, 481, s.v[115]);s.store_scale(461, 461, s.v[115]);s.store_scale(469, 469, s.v[115]);s.store_scale(556, 556, s.v[115]);s.b[1677] = (p.p61 == 0.0);s.store_scalar(1677, if s.b[1677] { 1.0 } else { 0.0 });
        if s.b[1677] {s.store_mul_add_lhs(464, 461, 469, 186);s.store_mul_add_lhs(465, 461, 469, 187);}
        s.store_div_scaled_inputs_indices(579, 428, 2.0, 415, 1.0);s.b[1678] = (((p.p1682 > 0.0) || (p.p1683 > 0.0)) || (p.p1684 > 0.0));s.store_scalar(1678, if s.b[1678] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1678] && s.b[1680]) && s.b[1682]) {s.store_div(169, 400, 576);s.store_offset_pow_ad(170, s.ad_value(169), s.ad_value(575), 1.0);s.store_div(171, 574, 170);s.store_scale(172, 171, 1.0 / (p.p1682));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_124(
        ...
        if ((s.b[1678] && s.b[1680]) && s.b[1682]) {s.store_scaled_add_offset_sqrt_square_offset(174, 172, 1.0, (-1.0), ((0.25 * p.p1688) * p.p1688), 0.5);s.store_scale(573, 174, p.p1682);}
        ...
        if ((s.b[1678] && (!s.b[1680])) && s.b[1684]) {s.store_div(169, 400, 576);s.store_offset_pow_ad(170, s.ad_value(169), s.ad_value(575), 1.0);s.store_div(171, 574, 170);s.store_scale(172, 171, 1.0 / (p.p1682));s.store_scaled_add_offset_sqrt_square_offset(174, 172, 1.0, (-1.0), ((0.25 * p.p1688) * p.p1688), 0.5);s.store_scale(573, 174, p.p1682);s.store_div_scaled_inputs_indices(589, 179, 2.0, 217, 1.0);s.store_offset_mul(169, 589, 402, 1.0);s.store_offset_scaled(170, 402, p.p1685, 1.0);}
    ...
    pub(super) fn stamp_transient_block_127(
        ...
        s.b[1695] = (s.v[128] > 0.0);s.store_scalar(1695, if s.b[1695] { 1.0 } else { 0.0 });s.b[1696] = (p.p73 == 2.0);s.store_scalar(1696, if s.b[1696] { 1.0 } else { 0.0 });s.b[1697] = (p.p65 == 1.0);s.store_scalar(1697, if s.b[1697] { 1.0 } else { 0.0 });s.b[1698] = (s.v[128] > 0.0);s.store_scalar(1698, if s.b[1698] { 1.0 } else { 0.0 });s.b[1699] = (p.p61 != 0.0);s.store_scalar(1699, if s.b[1699] { 1.0 } else { 0.0 });s.b[1700] = ((p.p70 == 2.0) && (((p.p62 == 2.0) || (p.p62 == 3.0)) || (p.p62 == 5.0)));s.store_scalar(1700, if s.b[1700] { 1.0 } else { 0.0 });s.b[1701] = (p.p61 != 0.0);s.store_scalar(1701, if s.b[1701] { 1.0 } else { 0.0 });s.b[1702] = ((p.p70 == 2.0) && (((p.p62 == 2.0) || (p.p62 == 3.0)) || (p.p62 == 5.0)));s.store_scalar(1702, if s.b[1702] { 1.0 } else { 0.0 });s.b[1703] = (p.p61 == 0.0);s.store_scalar(1703, if s.b[1703] { 1.0 } else { 0.0 });s.b[1704] = (p.p61 != 0.0);s.store_scalar(1704, if s.b[1704] { 1.0 } else { 0.0 });
    }
}
