...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_112(
        ...
        if ((s.b[1508] && s.b[1518]) && s.b[1519]) {s.store_div_scaled_inputs3_mixed_aiii(169, A::add_scaled_product(A::mul3(s.ad_value(767), s.ad_value(134), s.ad_value(134)), 1.0, s.ad_value(253), s.ad_value(134), (-1.0)), 1.0, 769, (-1.0), 479, 1.0, 179, 1.0);s.store_mul_product3_mixed_aiii(170, A::limited_exp(s.ad_value(169)), 766, 158, 141, 1.0);s.store_mul3_affine_lhs(172, 521, 521, -1.0, 0.0, 521);s.store_offset_add_ad(173, s.ad_value(763), A::abs(s.ad_value(172)), 1e-5);}
        if ((s.b[1508] && s.b[1518]) && s.b[1519]) {
    ...
    pub(super) fn stamp_transient_block_113(
        ...
        s.b[1522] = (s.v[128] > 0.0);s.store_scalar(1522, if s.b[1522] { 1.0 } else { 0.0 });
        if (s.b[1508] && s.b[1522]) {s.copy_ad(475, 175);s.copy_ad(477, 176);}
        if (s.b[1508] && (!s.b[1522])) {s.copy_ad(476, 175);s.copy_ad(478, 176);}
        ...
        if ((s.b[1523] && s.b[1524]) && s.b[1525]) {s.store_div(168, 521, 539);s.store_offset_limited_exp(169, 168, (-1.0));s.store_add_scaled_product_right_sub(170, 542, 1.0, 541, 521, 543, 1.0);s.store_mul(519, 169, 170);}
        s.b[1526] = (s.v[521] <= s.v[546]);s.store_scalar(1526, if s.b[1526] { 1.0 } else { 0.0 });
        if (((s.b[1523] && s.b[1524]) && (!s.b[1525])) && s.b[1526]) {s.store_div(168, 521, 539);s.store_div_scaled_offset_numerator_indices(169, 521, 1.0, p[1626], 539, 1.0);s.store_limited_exp_neg_input(170, 169);s.store_mul_add_scaled_inputs3_offset_rhs_limited_exp_first(519, 537, 168, 1.0, 547, 1.0, 170, (-p[1628]), (-1.0));}
        if (((s.b[1523] && s.b[1524]) && (!s.b[1525])) && (!s.b[1526])) {s.store_add_scaled_product_right_sub(519, 545, 1.0, 544, 521, 546, 1.0);}
        if (s.b[1523] && (!s.b[1524])) {s.store_scalar(519, 0.0);}
        ...
        if ((s.b[1523] && s.b[1527]) && s.b[1528]) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 287, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_114(
        ...
        if ((s.b[1523] && s.b[1527]) && s.b[1528]) {s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 281, 169, (-p[11]));}
        if ((s.b[1523] && s.b[1527]) && (!s.b[1528])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 287, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1643], A::sub_from_scalar(p[1643], s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 281, 169, (-p[11]));}
        ...
        if ((s.b[1523] && s.b[1529]) && s.b[1530]) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 289, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 283, 169, (-p[13]));}
        if ((s.b[1523] && s.b[1529]) && (!s.b[1530])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 289, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1645], A::sub_from_scalar(p[1645], s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 283, 169, (-p[13]));}
        ...
        if ((s.b[1523] && s.b[1531]) && s.b[1532]) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 291, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 285, 169, (-(p[3] * s.v[115])));}
        if ((s.b[1523] && s.b[1531]) && (!s.b[1532])) {s.store_div_scaled_value_by_product_indices(168, 521, -1.0, 180, 291, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1647], A::sub_from_scalar(p[1647], s.ad_value(521)), 1.0), (-1.0));s.store_add_scaled_product_indices(519, 519, 1.0, 285, 169, (-(p[3] * s.v[115])));}
        ...
        if ((s.b[1523] && s.b[1533]) && s.b[1534]) {s.store_div(168, 522, 540);s.store_offset_limited_exp(169, 168, (-1.0));s.store_add_scaled_product_right_sub(170, 549, 1.0, 548, 522, 550, 1.0);s.store_mul(520, 169, 170);}
        s.b[1535] = (s.v[522] <= s.v[553]);s.store_scalar(1535, if s.b[1535] { 1.0 } else { 0.0 });
        if (((s.b[1523] && s.b[1533]) && (!s.b[1534])) && s.b[1535]) {s.store_div(168, 522, 540);s.store_div_scaled_offset_numerator_indices(169, 522, 1.0, p[1627], 540, 1.0);s.store_limited_exp_neg_input(170, 169);s.store_mul_add_scaled_inputs3_offset_rhs_limited_exp_first(520, 538, 168, 1.0, 554, 1.0, 170, (-p[1629]), (-1.0));}
        if (((s.b[1523] && s.b[1533]) && (!s.b[1534])) && (!s.b[1535])) {s.store_add_scaled_product_right_sub(520, 552, 1.0, 551, 522, 553, 1.0);}
        if (s.b[1523] && (!s.b[1533])) {s.store_scalar(520, 0.0);}
        ...
        if ((s.b[1523] && s.b[1536]) && s.b[1537]) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 288, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 282, 169, (-p[12]));}
        if ((s.b[1523] && s.b[1536]) && (!s.b[1537])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 288, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1644], A::sub_from_scalar(p[1644], s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 282, 169, (-p[12]));}
        ...
        if ((s.b[1523] && s.b[1538]) && s.b[1539]) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 290, 1.0);s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 284, 169, (-p[14]));}
        if ((s.b[1523] && s.b[1538]) && (!s.b[1539])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 290, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1646], A::sub_from_scalar(p[1646], s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 284, 169, (-p[14]));}
        ...
        if ((s.b[1523] && s.b[1540]) && s.b[1541]) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 292, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_115(
        ...
        if ((s.b[1523] && s.b[1540]) && s.b[1541]) {s.store_offset_ad(169, A::limited_exp_scaled_input(s.ad_value(168), 1000.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 286, 169, (-(p[3] * s.v[115])));}
        if ((s.b[1523] && s.b[1540]) && (!s.b[1541])) {s.store_div_scaled_value_by_product_indices(168, 522, -1.0, 180, 292, 1.0);s.store_offset_ad(169, A::limited_exp_div_scaled_inputs(s.ad_value(168), p[1648], A::sub_from_scalar(p[1648], s.ad_value(522)), 1.0), (-1.0));s.store_add_scaled_product_indices(520, 520, 1.0, 286, 169, (-(p[3] * s.v[115])));}
    ...
    pub(super) fn stamp_transient_block_116(
        ...
        s.b[1580] = (p[1610] != 1.0);s.store_scalar(1580, if s.b[1580] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_117(
        ...
        s.b[1581] = (p[1610] == 0.5);s.store_scalar(1581, if s.b[1581] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_123(
        ...
        s.store_mul_add_mixed_iia(169, 126, 865, A::mul3(s.ad_value(866), s.ad_value(126), s.ad_value(126)));s.store_mul_ad_affine_product_lhs(556, A::sub_scaled_inputs(s.ad_value(153), 1.0, s.ad_value(875), 2.0), s.ad_value(555), (p[92] * p[3]), 0.0, 169);s.store_div_scaled_product3_indices(168, 415, 372, 158, 1.0, 153, 1.0);s.b[1675] = ((p[73] != 0.0) && (s.v[873] != 0.0));s.store_scalar(1675, if s.b[1675] { 1.0 } else { 0.0 });
        if s.b[1675] {s.store_div_scaled_product3_mixed_iiia(572, 183, 123, 205, 1.0, A::mul3(s.ad_value(411), s.ad_value(209), s.ad_value(188)), 1.0);s.store_mul_add_scaled_inputs_rhs_mixed_ia(569, 873, 572, s.v[115], A::mul3(s.ad_value(874), s.ad_value(179), s.ad_value(168)), s.v[115]);}
        s.b[1676] = (p[73] == 2.0);s.store_scalar(1676, if s.b[1676] { 1.0 } else { 0.0 });
        if s.b[1676] {s.store_div_scaled_inputs_mixed_ia(570, 569, 1e-9, A::mul3(s.ad_value(163), s.ad_value(158), s.ad_value(153)), 1.0);}
        s.store_scale(476, 476, s.v[115]);s.store_scale(475, 475, s.v[115]);s.store_scale(478, 478, s.v[115]);s.store_scale(477, 477, s.v[115]);s.store_scale(471, 471, s.v[115]);s.store_scale(470, 470, s.v[115]);s.store_scale(480, 480, s.v[115]);s.store_scale(481, 481, s.v[115]);s.store_scale(461, 461, s.v[115]);s.store_scale(469, 469, s.v[115]);s.store_scale(556, 556, s.v[115]);s.b[1677] = (p[61] == 0.0);s.store_scalar(1677, if s.b[1677] { 1.0 } else { 0.0 });
        if s.b[1677] {s.store_mul_add_lhs(464, 461, 469, 186);s.store_mul_add_lhs(465, 461, 469, 187);}
        s.store_div_scaled_inputs_indices(579, 428, 2.0, 415, 1.0);s.b[1678] = (((p[1682] > 0.0) || (p[1683] > 0.0)) || (p[1684] > 0.0));s.store_scalar(1678, if s.b[1678] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1678] && s.b[1680]) && s.b[1682]) {s.store_div(169, 400, 576);s.store_offset_pow_ad(170, s.ad_value(169), s.ad_value(575), 1.0);s.store_div(171, 574, 170);s.store_scale(172, 171, 1.0 / (p[1682]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_124(
        ...
        if ((s.b[1678] && s.b[1680]) && s.b[1682]) {s.store_scaled_add_offset_sqrt_square_offset(174, 172, 1.0, (-1.0), ((0.25 * p[1688]) * p[1688]), 0.5);s.store_scale(573, 174, p[1682]);}
        ...
        if ((s.b[1678] && (!s.b[1680])) && s.b[1684]) {s.store_div(169, 400, 576);s.store_offset_pow_ad(170, s.ad_value(169), s.ad_value(575), 1.0);s.store_div(171, 574, 170);s.store_scale(172, 171, 1.0 / (p[1682]));s.store_scaled_add_offset_sqrt_square_offset(174, 172, 1.0, (-1.0), ((0.25 * p[1688]) * p[1688]), 0.5);s.store_scale(573, 174, p[1682]);s.store_div_scaled_inputs_indices(589, 179, 2.0, 217, 1.0);s.store_offset_mul(169, 589, 402, 1.0);s.store_offset_scaled(170, 402, p[1685], 1.0);}
    ...
    pub(super) fn stamp_transient_block_125(
        ...
        s.b[1686] = (p[72] == 0.0);s.store_scalar(1686, if s.b[1686] { 1.0 } else { 0.0 });s.b[1687] = (p[72] == 1.0);s.store_scalar(1687, if s.b[1687] { 1.0 } else { 0.0 });
        if s.b[1686] {s.store_mul(168, 415, 592);s.store_add_scaled_square_product_indices(169, 153, 1.0, 168, 197, 1.0);}
        if (s.b[1687] && (!s.b[1686])) {s.store_div(168, 399, 217);s.store_square(168, 168);s.store_scaled_offset_ad(597, A::mul_scaled_lhs(s.ad_value(168), p[1709], s.ad_value(153)), 1.0, p[1708]);s.store_scaled_offset_ad(598, A::mul_scaled_lhs(s.ad_value(168), p[1711], s.ad_value(153)), 1.0, p[1710]);s.store_scaled_offset_ad(599, A::mul_scaled_lhs(s.ad_value(168), p[1713], s.ad_value(153)), 1.0, p[1712]);s.store_scaled_offset_ad(600, A::mul_scaled_lhs(s.ad_value(168), p[1715], s.ad_value(153)), 1.0, p[1714]);s.store_scaled_mul(169, 597, 597, 3.0);s.store_scaled_mul(170, 598, 598, 7.5);s.store_scale(171, 599, 2.5298);s.store_mul_scale_offset(601, A::div(s.ad_value(393), s.ad_value(392)), A::div(s.ad_value(390), s.ad_value(210)), -1.0, 1.0);s.store_mul_square_lhs(604, 209, 209);s.store_div_add_scaled_inputs_rhs_indices(602, 339, 339, 1.0, 399, 1.0);s.store_div_mixed_ia(172, 236, A::add_scaled_product(s.ad_value(181), 2.0, A::max_from_scalar(0.0, s.ad_value(237)), s.ad_value(392), 1.0));s.store_limited_exp_neg_input(616, 172);}
        s.b[1688] = (p[61] == 2.0);s.store_scalar(1688, if s.b[1688] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1687] && (!s.b[1686])) && s.b[1688]) {s.store_div_mixed_ia(174, 172, A::add_scaled_product(s.ad_value(181), 2.0, A::max_from_scalar(0.0, s.ad_value(238)), s.ad_value(392), 1.0));s.store_sub_ad(175, A::sqrt(A::sub(s.ad_value(689), s.ad_value(370))), A::sqrt(s.ad_value(689)));s.store_limited_exp_ad(617, A::mul_scaled_lhs(s.ad_value(174), -1.0, s.ad_value(175)));}
        ...
        s.b[1689] = (p[61] != 0.0);s.store_scalar(1689, if s.b[1689] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_126(
        ...
        if (s.b[1687] && (!s.b[1686])) {s.store_offset(618, 174, 1.0);s.store_scaled_add_offset_sqrt_square_offset(618, 618, 1.0, (-1.0), ((0.25 * p[604]) * p[604]), 0.5);s.store_scale(618, 618, 1.0 / (p[24]));s.store_scalar(619, (1.0 + (0.25 * p[453])));s.store_div_add_scaled_inputs_rhs_indices(612, 339, 339, 1.0, 392, 1.0);s.store_mul_scale_offset_indices(172, 181, 612, -1.0, 2.0);s.store_add(613, 392, 172);}
        s.b[1690] = (p[64] == 0.0);s.store_scalar(1690, if s.b[1690] { 1.0 } else { 0.0 });s.b[1691] = (p[64] == 1.0);s.store_scalar(1691, if s.b[1691] { 1.0 } else { 0.0 });s.b[1692] = (p[64] == 2.0);s.store_scalar(1692, if s.b[1692] { 1.0 } else { 0.0 });
        if ((s.b[1687] && (!s.b[1686])) && s.b[1690]) {s.store_offset_mul(172, 711, 392, 1.0);s.store_div_from_scalar(174, 1.0, 172);s.store_scaled_add_mixed_ia(175, 174, A::sqrt_square_offset(s.ad_value(174), 0.01), 0.5);s.store_mul_ad_product_lhs_mixed_ia(614, 194, A::offset(A::mul(s.ad_value(709), s.ad_value(175)), p[908]), 189);s.store_offset_mul_ad(620, A::div_scaled_product_by_product(s.ad_value(183), s.ad_value(613), s.v[115], s.ad_value(618), s.ad_value(619), 1.0), s.ad_value(614), 1.0);}
        if ((s.b[1687] && (!s.b[1686])) && (s.b[1691] && (!s.b[1690]))) {s.store_scalar(620, 1.0);}
        if ((s.b[1687] && (!s.b[1686])) && (s.b[1692] && (!(s.b[1690] || s.b[1691])))) {s.store_offset_mul(172, 711, 392, 1.0);s.store_div_from_scalar(174, 1.0, 172);s.store_scaled_add_mixed_ia(175, 174, A::sqrt_square_offset(s.ad_value(174), 0.01), 0.5);s.store_mul_scale_offset_mixed_ia(614, 189, A::mul(s.ad_value(709), s.ad_value(175)), 1.0, p[908]);s.store_mul_add_scaled_inputs3_offset_rhs_indices(614, 194, 190, 1.0, 191, 1.0, 614, 1.0, 0.0);s.store_offset_mul_ad(620, A::div_scaled_product_by_product(s.ad_value(183), s.ad_value(613), s.v[115], s.ad_value(618), s.ad_value(619), 1.0), s.ad_value(614), 1.0);}
        if (s.b[1687] && (!s.b[1686])) {s.store_div_scaled_product_mixed_aia(603, A::mul3_scaled_output(s.ad_value(183), s.ad_value(392), s.ad_value(616), s.v[115]), 617, 1.0, A::mul3(s.ad_value(618), s.ad_value(619), s.ad_value(620)), 1.0);s.store_offset(172, 601, 1.0);s.store_sub_from_scalar(174, 1.0, 601);s.store_mul_div_scaled_inputs_indices(175, 181, 602, 2.0, 392, 1.0);s.store_add(176, 172, 175);s.store_square(605, 174);s.store_mul(606, 605, 174);s.store_mul(607, 606, 174);s.store_square(608, 176);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_127(
        ...
        if (s.b[1687] && (!s.b[1686])) {s.store_mul(609, 608, 176);s.store_mul(610, 609, 176);s.store_mul(611, 610, 176);s.store_scale(621, 172, 0.5);s.store_div_scaled_inputs_indices(622, 605, 1.0, 176, 6.0);s.store_mul_div_scaled_inputs_mixed_aii(623, A::add(s.ad_value(621), s.ad_value(622)), 205, 1.0, 209, 1.0);s.store_div(624, 172, 608);s.store_div_scaled_product_mixed_aii(625, A::add_scaled_inputs(s.ad_value(172), 6.0, s.ad_value(175), 1.0), 605, 1.0, 610, 15.0);s.store_div_scaled_inputs_indices(626, 607, 1.0, 611, 9.0);s.store_mul_ad_affine_product_rhs(627, 205, s.ad_value(604), A::add_scaled_inputs3(s.ad_value(624), 1.0, s.ad_value(625), (-1.0), s.ad_value(626), 1.0), 1.0 / (6.0), 0.0);s.store_div(628, 174, 176);s.store_div_scaled_inputs_indices(629, 606, 1.0, 609, 3.0);s.store_mul_ad_affine_product_rhs(630, 205, s.ad_value(209), A::sub(s.ad_value(628), s.ad_value(629)), 1.0 / (6.0), 0.0);s.store_div_scaled_product_mixed_iia(631, 171, 630, 1.0, A::sqrt(A::mul(s.ad_value(623), s.ad_value(627))), 1.0);}
        s.b[1693] = (s.v[631] > 1.0);s.store_scalar(1693, if s.b[1693] { 1.0 } else { 0.0 });
        if ((s.b[1687] && (!s.b[1686])) && s.b[1693]) {s.store_scalar(631, 1.0);}
        s.b[1694] = (s.v[631] < 0.0);s.store_scalar(1694, if s.b[1694] { 1.0 } else { 0.0 });
        if (((s.b[1687] && (!s.b[1686])) && (!s.b[1693])) && s.b[1694]) {s.store_scalar(631, 0.0);}
        if (s.b[1687] && (!s.b[1686])) {s.store_offset_mul_ad(177, A::div_scaled_product_offset_denominator(s.ad_value(600), s.ad_value(600), 1.0, s.ad_value(399), p[1716], 1.0), A::div(s.ad_value(390), s.ad_value(210)), 1.0);s.store_mul_div_scaled_inputs_mixed_aii(623, A::add_scaled_products(s.ad_value(177), s.ad_value(621), 1.0, s.ad_value(169), s.ad_value(622), 1.0), 205, 1.0, 209, 1.0);s.store_mul_product3_mixed_aiii(627, A::add_scaled_inputs3(s.ad_value(624), 1.0, s.ad_value(625), (-1.0), s.ad_value(626), 1.0), 205, 604, 170, 1.0 / (6.0));s.store_div_scaled_product_mixed_aii(632, A::mul3_scaled_output(A::sqrt(A::div(s.ad_value(627), s.ad_value(623))), s.ad_value(372), s.ad_value(159), s.v[115]), 156, 1.0, 603, 1.0);}
        s.b[1695] = (s.v[128] > 0.0);s.store_scalar(1695, if s.b[1695] { 1.0 } else { 0.0 });s.b[1696] = (p[73] == 2.0);s.store_scalar(1696, if s.b[1696] { 1.0 } else { 0.0 });s.b[1697] = (p[65] == 1.0);s.store_scalar(1697, if s.b[1697] { 1.0 } else { 0.0 });s.b[1698] = (s.v[128] > 0.0);s.store_scalar(1698, if s.b[1698] { 1.0 } else { 0.0 });s.b[1699] = (p[61] != 0.0);s.store_scalar(1699, if s.b[1699] { 1.0 } else { 0.0 });s.b[1700] = ((p[70] == 2.0) && (((p[62] == 2.0) || (p[62] == 3.0)) || (p[62] == 5.0)));s.store_scalar(1700, if s.b[1700] { 1.0 } else { 0.0 });s.b[1701] = (p[61] != 0.0);s.store_scalar(1701, if s.b[1701] { 1.0 } else { 0.0 });s.b[1702] = ((p[70] == 2.0) && (((p[62] == 2.0) || (p[62] == 3.0)) || (p[62] == 5.0)));s.store_scalar(1702, if s.b[1702] { 1.0 } else { 0.0 });s.b[1703] = (p[61] == 0.0);s.store_scalar(1703, if s.b[1703] { 1.0 } else { 0.0 });s.b[1704] = (p[61] != 0.0);s.store_scalar(1704, if s.b[1704] { 1.0 } else { 0.0 });
    }
}
