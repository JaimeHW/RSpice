...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_92(
        ...
        if ((s.b[1431] && (!s.b[1437])) && s.b[1438]) {s.store_offset_mul(172, 711, 394, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_mixed_ia(168, 169, A::sqrt_square_offset(s.ad_value(169), 0.01), 0.5);s.store_mul_ad_affine_product_lhs(199, A::offset(A::mul(s.ad_value(709), s.ad_value(168)), p[908]), s.ad_value(189), s.v[115], 0.0, 194);}
