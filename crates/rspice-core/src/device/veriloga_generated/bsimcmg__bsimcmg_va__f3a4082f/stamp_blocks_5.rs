...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_84(
        ...
        if s.b[1429] {s.store_ln_offset_input(176, 901, 1.0);s.store_offset_scaled_ad(901, A::sqrt_square_offset(s.ad_value(176), 1.0), (-2.0), 2.0);s.store_mul_add_scaled_inputs_rhs_indices(177, 898, 901, p.p1805, 897, 1.0);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_90(
        ...
        if ((s.b[1431] && (!s.b[1437])) && s.b[1438]) {s.store_offset_mul(172, 711, 394, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_mixed_ia(168, 169, A::sqrt_square_offset(s.ad_value(169), 0.01), 0.5);s.store_mul_ad_affine_product_lhs(199, A::offset(A::mul(s.ad_value(709), s.ad_value(168)), p.p908), s.ad_value(189), s.v[115], 0.0, 194);}
    ...
    pub(super) fn stamp_transient_block_95(
        ...
        s.b[1450] = (p.p603 != 0.0);s.store_scalar(1450, if s.b[1450] { 1.0 } else { 0.0 });
