...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_71(
        ...
        if s.b[1390] {s.store_scaled_limited_exp_ad(281, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1729, s.ad_value(179), 1.0), p.p1630);s.store_scaled_limited_exp_ad(282, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1730, s.ad_value(179), 1.0), p.p1631);s.store_scaled_limited_exp_ad(283, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1731, s.ad_value(179), 1.0), p.p1632);s.store_scaled_limited_exp_ad(284, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1732, s.ad_value(179), 1.0), p.p1633);s.store_scaled_mul_ad(285, A::offset(A::sqrt(A::div_from_scalar(p.p1636, s.ad_value(158))), 1.0), A::limited_exp(A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1733, s.ad_value(179), 1.0)), p.p1634);s.store_scaled_mul_ad(286, A::offset(A::sqrt(A::div_from_scalar(p.p1636, s.ad_value(158))), 1.0), A::limited_exp(A::div_scaled_product(s.ad_value(147), s.ad_value(230), p.p1734, s.ad_value(179), 1.0)), p.p1635);}
        if s.b[1390] {
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if (s.b[1404] && s.b[1405]) {s.store_limited_exp_div(168, 546, 539);s.store_mul_scale_offset_mixed_ia(545, 537, A::add_scaled_inputs3(s.ad_value(168), 1.0, A::div(s.ad_value(547), s.ad_value(168)), (-1.0), s.ad_value(547), 1.0), 1.0, (-1.0));s.store_div_scaled_product_mixed_iai(544, 537, A::add(s.ad_value(168), A::div(s.ad_value(547), s.ad_value(168))), 1.0, 539, 1.0);}
        if (s.b[1404] && s.b[1405]) {
        ...
        if (s.b[1404] && s.b[1406]) {s.store_limited_exp_div(168, 553, 540);s.store_mul_scale_offset_mixed_ia(552, 538, A::add_scaled_inputs3(s.ad_value(168), 1.0, A::div(s.ad_value(554), s.ad_value(168)), (-1.0), s.ad_value(554), 1.0), 1.0, (-1.0));s.store_div_scaled_product_mixed_iai(551, 538, A::add(s.ad_value(168), A::div(s.ad_value(554), s.ad_value(168))), 1.0, 540, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_77(
        ...
        if s.b[1404] {s.store_scale(523, 263, p.p11);s.store_scale(524, 264, p.p13);s.store_scaled_mul(525, 268, 158, s.v[115]);s.store_scale(526, 266, p.p12);s.store_scale(527, 267, p.p14);s.store_scaled_mul(528, 265, 158, s.v[115]);}
    ...
    pub(super) fn stamp_transient_block_78(
        ...
        s.store_sub(347, 125, 167);s.store_offset_sqrt_ad(127, A::offset(A::square(s.ad_value(126)), 0.01), (-0.1));s.b[1415] = (p.p61 != 0.0);s.store_scalar(1415, if s.b[1415] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        s.store_div_scaled_value_by_product_mixed_iia(169, 893, 2.0, 895, A::offset(s.ad_value(898), 2.0), 1.0);s.store_mul_add_scaled_product_rhs_indices(164, 362, 662, 1.0, 664, 127, 1.0);s.b[1417] = (p.p175 == 0.0);s.store_scalar(1417, if s.b[1417] { 1.0 } else { 0.0 });s.b[1418] = (p.p80 == 0.0);s.store_scalar(1418, if s.b[1418] { 1.0 } else { 0.0 });
