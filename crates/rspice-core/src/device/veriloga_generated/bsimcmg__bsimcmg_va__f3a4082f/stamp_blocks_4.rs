...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_71(
        ...
        if s.b[1390] {s.store_scaled_limited_exp_ad(281, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1729], s.ad_value(179), 1.0), p[1630]);s.store_scaled_limited_exp_ad(282, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1730], s.ad_value(179), 1.0), p[1631]);s.store_scaled_limited_exp_ad(283, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1731], s.ad_value(179), 1.0), p[1632]);s.store_scaled_limited_exp_ad(284, A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1732], s.ad_value(179), 1.0), p[1633]);s.store_scaled_mul_ad(285, A::offset(A::sqrt(A::div_from_scalar(p[1636], s.ad_value(158))), 1.0), A::limited_exp(A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1733], s.ad_value(179), 1.0)), p[1634]);s.store_scaled_mul_ad(286, A::offset(A::sqrt(A::div_from_scalar(p[1636], s.ad_value(158))), 1.0), A::limited_exp(A::div_scaled_product(s.ad_value(147), s.ad_value(230), p[1734], s.ad_value(179), 1.0)), p[1635]);}
        if s.b[1390] {
    ...
    pub(super) fn stamp_transient_block_77(
        ...
        if s.b[1404] {s.store_scale(523, 263, p[11]);s.store_scale(524, 264, p[13]);s.store_scaled_mul(525, 268, 158, s.v[115]);s.store_scale(526, 266, p[12]);s.store_scale(527, 267, p[14]);s.store_scaled_mul(528, 265, 158, s.v[115]);}
