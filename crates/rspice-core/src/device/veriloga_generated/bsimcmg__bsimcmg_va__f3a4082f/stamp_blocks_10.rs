...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        if s.b[1288] {s.store_primal_div_mixed_ia(988, 972, A::pow_from_scalar((p.p1852 * 1000000000.0), A::scale(s.ad_value(973), p.p1868)));let t0: A = A::pow_from_scalar((p.p43 * 1000000000.0), A::scale(s.ad_value(975), p.p1867));s.store_add_scaled_inputs4_mixed_iaia(985, 888, 0.5, A::div(s.ad_value(974), t0), (p.p1865 * 0.5), 987, ((-p.p1865) * 0.5), A::sqrt_square_offset(A::add_scaled_inputs3(s.ad_value(888), 1.0, A::div(s.ad_value(974), t0), p.p1865, s.ad_value(987), (-p.p1865)), ((0.25 * 0.01) * 0.01)), 0.5);let t1: A = A::pow_from_scalar((p.p43 * 1000000000.0), A::scale(s.ad_value(973), p.p1868));s.store_primal_add_scaled_inputs4_mixed_iaia(986, 889, 0.5, A::div(s.ad_value(972), t1), (p.p1866 * 0.5), 988, ((-p.p1866) * 0.5), A::sqrt_square_offset(A::add_scaled_inputs3(s.ad_value(889), 1.0, A::div(s.ad_value(972), t1), p.p1866, s.ad_value(988), (-p.p1866)), ((0.25 * 0.01) * 0.01)), 0.5);let t2: A = A::pow_from_scalar((p.p43 * 1000000000.0), A::scale(s.ad_value(990), p.p1890));let t3: A = A::powf(A::scale_offset(t2, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(995, A::div(s.ad_value(989), t3), ((0.25 * 0.1) * 0.1), 0.5);let t4: A = A::pow_from_scalar((p.p1852 * 1000000000.0), A::scale(s.ad_value(990), p.p1890));let t5: A = A::powf(A::scale_offset(t4, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(996, A::div(s.ad_value(989), t5), ((0.25 * 0.1) * 0.1), 0.5);s.store_primal_add_scaled_inputs3_indices(997, 890, 1.0, 995, p.p1887, 996, (-p.p1887));let t6: A = A::pow_from_scalar((p.p43 * 1000000000.0), A::scale(s.ad_value(992), p.p1891));let t7: A = A::powf(A::scale_offset(t6, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(998, A::div(s.ad_value(991), t7), ((0.25 * 0.1) * 0.1), 0.5);let t8: A = A::pow_from_scalar((p.p1852 * 1000000000.0), A::scale(s.ad_value(992), p.p1891));let t9: A = A::powf(A::scale_offset(t8, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(999, A::div(s.ad_value(991), t9), ((0.25 * 0.1) * 0.1), 0.5);s.store_primal_add_scaled_inputs3_indices(1000, 891, 1.0, 998, p.p1888, 999, (-p.p1888));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_30(
        ...
        if s.b[1288] {let ta: A = A::pow_from_scalar((p.p43 * 1000000000.0), A::scale(s.ad_value(994), p.p1892));let tb: A = A::powf(A::scale_offset(ta, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(1001, A::div(s.ad_value(993), tb), ((0.25 * 0.1) * 0.1), 0.5);let tc: A = A::pow_from_scalar((p.p1852 * 1000000000.0), A::scale(s.ad_value(994), p.p1892));let td: A = A::powf(A::scale_offset(tc, 5.0, 1.0), 0.5);s.store_primal_scaled_add_sqrt_square_offset_ad(1002, A::div(s.ad_value(993), td), ((0.25 * 0.1) * 0.1), 0.5);s.store_primal_add_scaled_inputs3_indices(1003, 892, 1.0, 1001, p.p1889, 1002, (-p.p1889));let te: A = A::scale_offset(s.ad_value(960), ((0.5) * (2.0)), ((((1.0) + ((-1.0)))) * (2.0)));s.store_primal_mul_product3_mixed_iiaa(1010, 979, 960, A::div(A::pow_from_scalar(3.14, A::scale(s.ad_value(960), 0.5)), A::offset(A::sub(A::add_scaled_inputs(A::sub_scaled_inputs(A::add_scaled_inputs(A::add_scaled_inputs4(A::exp_scaled_input(A::scale_offset(s.ad_value(960), 0.5, ((1.0) + ((-1.0)))), (-4.6)), 0.0385, A::powi(A::scale_offset(s.ad_value(960), ((0.5) * (2.0)), ((2.0) + ((-3.0)))), 8), 7.5893e-7, A::powi(te, 6), 6.9583e-5, A::powi(te, 5), (-0.0006583)), 1.0, A::pow4(te), 0.0065), 1.0, A::cube(te), 0.026), 1.0, A::square(te), 0.1371), A::scale_offset(s.ad_value(960), ((0.5) * ((0.194 * 2.0))), ((((1.0) + ((-1.0)))) * ((0.194 * 2.0))))), 0.959)), A::pow(A::scale(s.ad_value(997), 1000000.0), s.ad_value(960)), (1.0 / (2.0) * 1.60219e-19));let tf: A = A::scale_offset(s.ad_value(961), ((0.5) * (2.0)), ((((1.0) + ((-1.0)))) * (2.0)));s.store_primal_mul_product3_mixed_iiaa(1011, 980, 961, A::div(A::pow_from_scalar(3.14, A::scale(s.ad_value(961), 0.5)), A::offset(A::sub(A::add_scaled_inputs(A::sub_scaled_inputs(A::add_scaled_inputs(A::add_scaled_inputs4(A::exp_scaled_input(A::scale_offset(s.ad_value(961), 0.5, ((1.0) + ((-1.0)))), (-4.6)), 0.0385, A::powi(A::scale_offset(s.ad_value(961), ((0.5) * (2.0)), ((2.0) + ((-3.0)))), 8), 7.5893e-7, A::powi(tf, 6), 6.9583e-5, A::powi(tf, 5), (-0.0006583)), 1.0, A::pow4(tf), 0.0065), 1.0, A::cube(tf), 0.026), 1.0, A::square(tf), 0.1371), A::scale_offset(s.ad_value(961), ((0.5) * ((0.194 * 2.0))), ((((1.0) + ((-1.0)))) * ((0.194 * 2.0))))), 0.959)), A::pow(A::scale(s.ad_value(1000), 1000000.0), s.ad_value(961)), (1.0 / (2.0) * 1.60219e-19));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_31(
        ...
        if s.b[1288] {let t10: A = A::scale_offset(s.ad_value(962), ((0.5) * (2.0)), ((((1.0) + ((-1.0)))) * (2.0)));s.store_primal_mul_product3_mixed_iiaa(1012, 981, 962, A::div(A::pow_from_scalar(3.14, A::scale(s.ad_value(962), 0.5)), A::offset(A::sub(A::add_scaled_inputs(A::sub_scaled_inputs(A::add_scaled_inputs(A::add_scaled_inputs4(A::exp_scaled_input(A::scale_offset(s.ad_value(962), 0.5, ((1.0) + ((-1.0)))), (-4.6)), 0.0385, A::powi(A::scale_offset(s.ad_value(962), ((0.5) * (2.0)), ((2.0) + ((-3.0)))), 8), 7.5893e-7, A::powi(t10, 6), 6.9583e-5, A::powi(t10, 5), (-0.0006583)), 1.0, A::pow4(t10), 0.0065), 1.0, A::cube(t10), 0.026), 1.0, A::square(t10), 0.1371), A::scale_offset(s.ad_value(962), ((0.5) * ((0.194 * 2.0))), ((((1.0) + ((-1.0)))) * ((0.194 * 2.0))))), 0.959)), A::pow(A::scale(s.ad_value(1003), 1000000.0), s.ad_value(962)), (1.0 / (2.0) * 1.60219e-19));}
