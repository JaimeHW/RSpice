...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_primal_add_scaled_inputs4_offset_indices(640, 635, p.p134, 637, p.p136, 638, 0.0, 639, 0.0, ((p.p133) + ((s.v[636] * p.p135))));s.b[1073] = (p.p95 != 0.0);s.store_scalar(1073, if s.b[1073] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1081] && (!((((s.b[1076] || s.b[1077]) || s.b[1078]) || s.b[1079]) || s.b[1080]))) && s.b[1085]) {s.store_primal_offset_scaled(955, 161, 2.0, ((((p.p40) * (2.0))) + (p.p46)));s.store_primal_offset_scaled(949, 161, p.p40, p.p47);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_4(
        ...
        if ((s.b[1081] && (!((((s.b[1076] || s.b[1077]) || s.b[1078]) || s.b[1079]) || s.b[1080]))) && s.b[1089]) {s.store_primal_offset_scaled(959, 161, 2.0, ((((p.p40) * (2.0))) + (p.p54)));s.store_primal_offset_scaled(953, 161, p.p40, p.p55);s.store_primal_add_mixed_ai(895, A::add(A::add_scaled_inputs4(s.ad_value(954), 1.0, s.ad_value(955), 1.0, s.ad_value(956), 1.0, s.ad_value(957), 1.0), s.ad_value(958)), 959);s.store_primal_add_mixed_ai(894, A::add(A::add_scaled_inputs4(s.ad_value(948), 1.0, s.ad_value(949), 1.0, s.ad_value(950), 1.0, s.ad_value(951), 1.0), s.ad_value(952)), 953);}
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.b[1106] = ((p.p73 != 0.0) && (p.p1668 != 0.0));s.store_scalar(1106, if s.b[1106] { 1.0 } else { 0.0 });
        if s.b[1106] {s.store_primal_add_scaled_inputs4_offset_indices(873, 635, p.p1669, 637, p.p1671, 638, p.p1672, 639, p.p1673, ((p.p1668) + ((s.v[636] * p.p1670))));s.store_primal_add_scaled_inputs4_offset_indices(874, 635, p.p1675, 637, p.p1677, 638, p.p1678, 639, p.p1679, ((p.p1674) + ((s.v[636] * p.p1676))));}
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        s.b[1198] = (p.p1649 >= (s.v[153] / 2.0));s.store_scalar(1198, if s.b[1198] { 1.0 } else { 0.0 });
        if s.b[1198] {s.store_scalar(875, 0.0);}
        if (!s.b[1198]) {s.store_scalar(875, p.p1649);}
        s.b[1199] = (s.v[864] <= 0.0);s.store_scalar(1199, if s.b[1199] { 1.0 } else { 0.0 });
        if s.b[1199] {s.store_scalar(864, 1.0);}
        s.b[1200] = ((p.p73 == 1.0) && (s.v[873] != 0.0));s.store_scalar(1200, if s.b[1200] { 1.0 } else { 0.0 });s.b[1201] = (s.v[873] < 0.001);s.store_scalar(1201, if s.b[1201] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if s.b[1234] {s.store_add_scaled_inputs3_indices(633, 169, 1.0 / (p.p1791), 170, 1.0 / (p.p1791), 171, 1.0 / (p.p1791));s.store_add_scaled_inputs3_indices(634, 169, p.p1792, 170, p.p1792, 171, p.p1792);}
        s.b[1239] = (p.p76 != 0.0);s.store_scalar(1239, if s.b[1239] { 1.0 } else { 0.0 });
        if s.b[1239] {s.store_scalar(457, (((p.p1074 / p.p6) + ((p.p1075 * p.p5) / (if (p.p6 == 2.0) { 12.0 } else { 3.0 }))) / p.p59));}
        if s.b[1239] {s.store_primal_div_from_scalar_ad(456, 1.0, A::max_from_scalar(0.001, s.ad_value(457)));}
        s.b[1240] = (p.p76 == 2.0);s.store_scalar(1240, if s.b[1240] { 1.0 } else { 0.0 });
        if (s.b[1239] && s.b[1240]) {s.store_scalar(458, (1.0 / (0.001_f64).max(p.p1076)));s.store_scalar(459, (1.0 / (0.001_f64).max(p.p1077)));}
        ...
        if (((!s.b[1241]) && (!s.b[1243])) && s.b[1244]) {s.store_scalar(168, (((p.p97 / 9.68e22)) as f64).powf(0.68));s.store_scalar(169, (3.43e26 / p.p97));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        ...
        if ((!s.b[1241]) && s.b[1246]) {s.store_scalar(441, (p.p1082 / (((-p.p1080) * p.p3) * p.p5)));s.store_div_scaled_product_mixed_aia(442, A::add(s.ad_value(440), s.ad_value(434)), 441, 1.0, A::add_scaled_inputs3(s.ad_value(440), 1.0, s.ad_value(434), 1.0, s.ad_value(441), 1.0), 1.0);}
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_primal_scale_ad(935, A::min(A::div_scaled_value_offset_denominator(s.ad_value(450), 1.0, s.ad_value(447), p.p90, 1.0), A::div_scaled_offset_numerator(s.ad_value(447), 1.0, p.p90, s.ad_value(450), 1.0)), 0.5);s.store_primal_mul(936, 927, 935);}
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_scaled_add(938, 934, 937, p.p3);s.store_primal_div(930, 928, 447);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_14(
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(447), (2.0 * p.p90), (p.p90 * p.p90)), 1.0, A::square(s.ad_value(447)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p.p90), 1.0, s.ad_value(447), s.ad_value(930), 1.0), 447);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p.p90, A::scaled_offset(s.ad_value(930), 2.0, p.p90), 1.0);}
        if (s.b[1259] && (!s.b[1260])) {
        ...
        if (s.b[1259] && (!s.b[1260])) {s.store_scalar(627, 1.2e-12);s.store_add_scaled_inputs3_indices(933, 946, 1.0, 942, (-1.0), 627, -1.0);s.store_add_scaled_inputs3_sqrt_third_mixed_iia(947, 946, p.p3, 933, ((-0.5) * p.p3), A::add_scaled_square_product(s.ad_value(933), 1.0, s.ad_value(627), s.ad_value(946), 4.0), ((-0.5) * p.p3));s.store_add(451, 938, 947);}
        s.b[1262] = (p.p1090 > 0.0);s.store_scalar(1262, if s.b[1262] { 1.0 } else { 0.0 });
