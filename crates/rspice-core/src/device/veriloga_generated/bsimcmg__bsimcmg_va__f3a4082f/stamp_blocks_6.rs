...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_98(
        ...
        s.store_div_mixed_ia(169, 236, A::add_scaled_product(s.ad_value(181), 2.0, A::max_from_scalar(0.0, A::add(s.ad_value(237), A::mul3(s.ad_value(294), s.ad_value(402), s.ad_value(402)))), s.ad_value(399), 1.0));s.store_limited_exp_neg_input(366, 169);s.b[1463] = (p.p61 == 2.0);s.store_scalar(1463, if s.b[1463] { 1.0 } else { 0.0 });
        if s.b[1463] {
    ...
    pub(super) fn stamp_transient_block_100(
        ...
        if (s.b[1468] && (!s.b[1467])) {s.store_mul_mixed_ia(192, 194, A::add_scaled_offset_product_lhs(s.ad_value(191), 1.0, A::mul(s.ad_value(174), s.ad_value(168)), p.p914, s.ad_value(189), 1.0));}
        ...
        s.store_div_from_scalar(208, 1.0, 207);s.store_add_scaled_products_mixed_iiai(138, 208, 138, 1.0, A::offset(s.ad_value(207), (-1.0)), 393, 1.0);s.store_add_scaled_products_mixed_aiai(137, A::square(s.ad_value(208)), 137, 1.0, A::sub(s.ad_value(207), s.ad_value(208)), 393, 0.5);s.b[1471] = (p.p73 == 2.0);s.store_scalar(1471, if s.b[1471] { 1.0 } else { 0.0 });
        if s.b[1471] {s.store_div_scaled_inputs_indices(571, 137, -1.0, 138, 1.0);}
        if (!s.b[1471]) {s.store_scalar(571, 0.0);}
        s.store_sub_scaled_inputs(139, 138, -1.0, 137, 1.0);s.store_mul3_affine_lhs(175, 159, 156, s.v[115], 0.0, 372);s.store_mul(138, 175, 138);s.store_mul(137, 175, 137);s.store_mul(139, 175, 139);s.copy_ad(592, 138);s.b[1472] = (p.p61 != 0.0);s.store_scalar(1472, if s.b[1472] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_101(
        ...
        s.b[1473] = (p.p62 == 5.0);s.store_scalar(1473, if s.b[1473] { 1.0 } else { 0.0 });
        ...
        s.b[1475] = (p.p78 != 1.0);s.store_scalar(1475, if s.b[1475] { 1.0 } else { 0.0 });s.b[1476] = (p.p76 != 2.0);s.store_scalar(1476, if s.b[1476] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_103(
        ...
        if s.b[1484] {s.store_scalar(239, 1e-6);s.store_mul_div_scaled_inputs_mixed_aii(178, A::sqrt(s.ad_value(179)), 239, 1.0, 181, 2.0);s.store_scale(168, 178, 0.5);s.store_div_scaled_inputs_mixed_ai(170, A::offset(s.ad_value(132), (-p.p144)), -1.0, 179, 1.0);}
    ...
    pub(super) fn stamp_transient_block_106(
        ...
        if (((!s.b[1494]) && s.b[1496]) && (!s.b[1497])) {s.store_div_from_scalar_offset_product(171, 1.0, 788, 126, 1.0);s.store_mul3_lhs(491, 169, 170, 171);s.store_mul_scale_offset_mixed_ia(490, 491, A::div(s.ad_value(784), s.ad_value(153)), -1.0, 1.0);s.store_sub(489, 126, 490);s.store_add_ad(168, A::add_scaled_product(s.ad_value(782), 1.0, s.ad_value(781), s.ad_value(489), 1.0), A::mul3(s.ad_value(780), s.ad_value(489), s.ad_value(489)));s.store_sqrt_square_offset(169, 168, 1e-10);let t0: A = A::limited_exp(A::div(s.ad_value(489), s.ad_value(169)));s.store_neg_ad(492, A::offset(A::add_scaled_inputs(A::offset(A::mul_scaled_lhs(s.ad_value(493), -1.0, t0), (((-(-10.0))) + ((-p.p1443)))), 0.5, A::sqrt_square_offset(A::offset(A::mul_scaled_lhs(s.ad_value(493), -1.0, t0), (((-(-10.0))) + ((-p.p1443)))), (-((4.0 * (-10.0)) * p.p1443))), 0.5), (-10.0)));s.store_mul(488, 492, 124);}
    ...
    pub(super) fn stamp_transient_block_107(
        ...
        if s.b[1498] {s.store_mul_ad_product_lhs_mixed_ai(461, A::mul3(A::mul3(s.ad_value(158), s.ad_value(153), s.ad_value(175)), s.ad_value(486), s.ad_value(497)), 460, 174);s.store_scaled_mul(461, 461, 256, p.p27);s.store_add_scaled_inputs3_indices(468, 167, 1.0, 146, (-0.5), 166, -1.0);s.store_sub(168, 468, 497);s.store_div_scaled_value_by_product_indices(169, 168, 1.0, 731, 179, 1.0);}
        if s.b[1498] {
    ...
    pub(super) fn stamp_transient_block_108(
        ...
        if s.b[1501] {s.store_offset_mul(170, 740, 482, 1.0);s.store_mul_product3_indices(171, 170, 485, 742, 169, (-p.p1109));s.store_limited_exp(172, 171);}
        s.b[1504] = (s.v[128] > 0.0);s.store_scalar(1504, if s.b[1504] { 1.0 } else { 0.0 });
        if (s.b[1501] && s.b[1504]) {s.store_mul_product3_indices(480, 172, 462, 134, 482, p.p1104);}
        if (s.b[1501] && (!s.b[1504])) {s.store_mul_product3_indices(481, 172, 462, 134, 482, p.p1104);}
        ...
        if (s.b[1501] && s.b[1507]) {s.store_mul_product3_indices(481, 172, 462, 136, 483, p.p1105);}
        if (s.b[1501] && (!s.b[1507])) {s.store_mul_product3_indices(480, 172, 462, 136, 483, p.p1105);}
