...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_96(
        ...
        if ((s.b[1445] && (!s.b[1446])) && (!s.b[1447])) {s.store_limited_exp_neg_input(341, 340);s.store_sub_mixed_ai(172, A::sqrt(A::add_scaled_inputs3_offset(s.ad_value(170), 1.0, s.ad_value(341), 1.0, A::square(s.ad_value(168)), 1.0, (-1.0))), 168);s.store_add_ad(340, A::sub_from_scalar(1.0, s.ad_value(341)), A::square(s.ad_value(172)));}
        if ((s.b[1445] && (!s.b[1446])) && (!s.b[1447])) {
        ...
        s.store_scaled_add(399, 392, 393, 0.5);s.store_sub(402, 392, 393);s.store_scaled_square(168, 390, 1600.0);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_97(
        ...
        s.b[1450] = (p[603] != 0.0);s.store_scalar(1450, if s.b[1450] { 1.0 } else { 0.0 });
        if s.b[1450] {s.store_add_scaled_inputs3_mixed_iia(400, 392, 0.5, 393, 0.5, A::mul_sub_from_scalar_lhs_scaled_output(1.0, A::limited_exp_scaled_input(s.ad_value(168), -1.0), s.ad_value(402), (p[603] * 0.5)), 1.0);}
        if (!s.b[1450]) {s.store_scaled_add(400, 392, 393, 0.5);}
        s.b[1451] = (s.v[655] > 0.0);s.store_scalar(1451, if s.b[1451] { 1.0 } else { 0.0 });
        if s.b[1451] {s.store_scale(172, 399, 1.0 / (p[400]));s.store_offset_pow_ad(174, s.ad_value(172), s.ad_value(661), 1.0);s.store_div(374, 373, 174);s.store_div_from_scalar_ad(372, 1.0, A::add_scaled_product(A::div_from_scalar(1.0, A::scale(s.ad_value(163), (p[89] * 1.0 / (p[90])))), 1.0, s.ad_value(374), s.ad_value(655), 1.0 / (s.v[143])));}
        if (!s.b[1451]) {s.copy_ad(372, 163);}
        s.b[1452] = ((p[61] != 0.0) && (s.v[656] != 0.0));s.store_scalar(1452, if s.b[1452] { 1.0 } else { 0.0 });
        if s.b[1452] {s.store_offset_powf_ad(175, A::scale(s.ad_value(904), 1.0 / (p[401])), p[402], 1.0);s.store_div(374, 373, 175);s.store_div_from_scalar_ad(494, 1.0, A::add_scaled_product(A::div_from_scalar(1.0, s.ad_value(494)), 1.0, s.ad_value(374), s.ad_value(656), 1.0 / (s.v[143])));}
        s.store_div_scaled_product3_indices(183, 416, 163, 158, 1.0, 153, 1.0);s.store_add_scaled_product_indices(409, 396, s.v[420], 407, 400, s.v[420]);s.b[1453] = (p[80] == 0.0);s.store_scalar(1453, if s.b[1453] { 1.0 } else { 0.0 });
        ...
        s.store_pow_indices(168, 409, 822);s.b[1454] = (p[61] != 0.0);s.store_scalar(1454, if s.b[1454] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_98(
        ...
        s.store_scaled_add_offset_sqrt_square_offset(411, 411, 1.0, (-1.0), ((0.25 * p[604]) * p[604]), 0.5);s.store_offset_scaled_ad(215, A::scale(A::limited_exp_scaled_input(s.ad_value(390), (-p[888])), p[887]), (-p[24]), p[24]);s.store_div(411, 411, 215);s.store_div(415, 416, 411);s.b[1455] = (p[67] == 1.0);s.store_scalar(1455, if s.b[1455] { 1.0 } else { 0.0 });s.b[1456] = (p[80] == 0.0);s.store_scalar(1456, if s.b[1456] { 1.0 } else { 0.0 });
        ...
        s.store_offset(412, 171, 1.0);s.store_scaled_add_offset_sqrt_square_offset(412, 412, 1.0, (-1.0), ((0.25 * p[604]) * p[604]), 0.5);s.store_div(412, 412, 215);s.store_offset_div_scaled_product_indices(360, 719, 153, 1.0, 351, 1.0, 1e-6);s.b[1457] = (s.v[360] < 40.0);s.store_scalar(1457, if s.b[1457] { 1.0 } else { 0.0 });
        ...
        s.store_sub(202, 126, 390);s.b[1459] = (p[80] == 0.0);s.store_scalar(1459, if s.b[1459] { 1.0 } else { 0.0 });
        ...
        if s.b[1460] {s.copy_ad(169, 204);s.store_div_add_scaled_inputs_rhs_indices(171, 169, 210, 1.0, 169, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_99(
        ...
        if s.b[1460] {s.store_mul_ad_product_lhs_mixed_ai(203, A::div(s.ad_value(169), s.ad_value(200)), 171, 201);s.store_offset_div(205, 202, 203, 1.0);}
    ...
    pub(super) fn stamp_transient_block_100(
        ...
        s.store_div_mixed_ia(169, 236, A::add_scaled_product(s.ad_value(181), 2.0, A::max_from_scalar(0.0, A::add(s.ad_value(237), A::mul3(s.ad_value(294), s.ad_value(402), s.ad_value(402)))), s.ad_value(399), 1.0));s.store_limited_exp_neg_input(366, 169);s.b[1463] = (p[61] == 2.0);s.store_scalar(1463, if s.b[1463] { 1.0 } else { 0.0 });
        if s.b[1463] {
        ...
        s.b[1464] = (p[67] == 1.0);s.store_scalar(1464, if s.b[1464] { 1.0 } else { 0.0 });
        ...
        s.store_mul(221, 220, 156);s.b[1465] = (p[67] == 1.0);s.store_scalar(1465, if s.b[1465] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_101(
        ...
        s.store_mul3_affine_lhs(140, 640, 894, (-1.60219e-19), 0.0, 156);s.store_div_add_scaled_inputs_rhs_indices(131, 339, 339, 1.0, 399, 1.0);s.store_add_mixed_ia(123, 399, A::mul_sub_from_scalar_lhs(2.0, s.ad_value(131), s.ad_value(181)));s.store_mul(122, 123, 402);s.b[1467] = (p[64] == 0.0);s.store_scalar(1467, if s.b[1467] { 1.0 } else { 0.0 });s.b[1468] = (p[64] == 1.0);s.store_scalar(1468, if s.b[1468] { 1.0 } else { 0.0 });s.b[1469] = (p[64] == 2.0);s.store_scalar(1469, if s.b[1469] { 1.0 } else { 0.0 });
        if s.b[1467] {s.copy_ad(193, 190);s.copy_ad(192, 191);s.store_offset_mul(172, 711, 399, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_sqrt_square_offset_rhs(168, 169, 169, 0.01, 0.5);s.store_mul_ad_product_lhs_mixed_ia(197, 194, A::offset(A::mul(s.ad_value(709), s.ad_value(168)), p[908]), 189);s.store_offset_mul_ad(188, A::div_scaled_product_by_product(s.ad_value(183), s.ad_value(123), s.v[115], s.ad_value(411), s.ad_value(209), 1.0), s.ad_value(197), 1.0);}
        if (s.b[1468] && (!s.b[1467])) {s.store_scalar(197, 0.0);s.store_scalar(188, 1.0);s.store_add_scaled_product_mixed_iia(170, 479, (-1.0), 114, A::voltage(ctx, nodes, Some(11), Some(8)), 1.0);s.store_sqrt_square_offset(171, 170, 0.1);s.store_scaled_add(482, 170, 171, 0.5);s.store_offset_mul(172, 711, 482, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_sqrt_square_offset_rhs(168, 169, 169, 0.01, 0.5);s.store_mul_scale_offset_mixed_ia(174, 853, A::mul(s.ad_value(425), A::powf(A::offset(A::square(A::voltage(ctx, nodes, Some(2), Some(8))), 1e-6), (0.5 * p[921]))), 1.0, 1.0);s.store_mul_mixed_ia(193, 194, A::add_scaled_offset_product_lhs(s.ad_value(190), 1.0, A::mul(s.ad_value(174), s.ad_value(168)), p[911], s.ad_value(189), 1.0));s.store_add_scaled_product_mixed_iia(170, 479, (-1.0), 114, A::voltage(ctx, nodes, Some(11), Some(9)), 1.0);s.store_sqrt_square_offset(171, 170, 0.1);s.store_scaled_add(483, 170, 171, 0.5);s.store_offset_mul(172, 712, 483, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_sqrt_square_offset_rhs(168, 169, 169, 0.01, 0.5);s.store_mul_scale_offset_mixed_ia(174, 852, A::mul(s.ad_value(426), A::powf(A::offset(A::square(A::voltage(ctx, nodes, Some(0), Some(9))), 1e-6), (0.5 * p[922]))), 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_102(
        ...
        if (s.b[1468] && (!s.b[1467])) {s.store_mul_mixed_ia(192, 194, A::add_scaled_offset_product_lhs(s.ad_value(191), 1.0, A::mul(s.ad_value(174), s.ad_value(168)), p[914], s.ad_value(189), 1.0));}
        if (s.b[1469] && (!(s.b[1467] || s.b[1468]))) {s.store_offset_mul(172, 711, 399, 1.0);s.store_div_from_scalar(169, 1.0, 172);s.store_scaled_add_sqrt_square_offset_rhs(168, 169, 169, 0.01, 0.5);s.store_mul_add_mixed_iai(197, 194, A::add_scaled_offset_product_lhs(s.ad_value(190), 1.0, A::mul(s.ad_value(709), s.ad_value(168)), p[908], s.ad_value(189), 1.0), 191);s.store_offset_mul_ad(188, A::div_scaled_product_by_product(s.ad_value(183), s.ad_value(123), s.v[115], s.ad_value(411), s.ad_value(209), 1.0), s.ad_value(197), 1.0);s.store_scalar(193, 0.0);s.store_scalar(192, 0.0);}
        s.store_div_scaled_product3_mixed_aiia(124, A::mul3_scaled_output(s.ad_value(183), s.ad_value(122), s.ad_value(205), s.v[115]), 366, 371, 1.0, A::mul3(s.ad_value(411), s.ad_value(209), s.ad_value(188)), 1.0);s.store_scale(124, 124, p[25]);s.b[1470] = (p[67] == 1.0);s.store_scalar(1470, if s.b[1470] { 1.0 } else { 0.0 });
        ...
        s.store_div_from_scalar(208, 1.0, 207);s.store_add_scaled_products_mixed_iiai(138, 208, 138, 1.0, A::offset(s.ad_value(207), (-1.0)), 393, 1.0);s.store_add_scaled_products_mixed_aiai(137, A::square(s.ad_value(208)), 137, 1.0, A::sub(s.ad_value(207), s.ad_value(208)), 393, 0.5);s.b[1471] = (p[73] == 2.0);s.store_scalar(1471, if s.b[1471] { 1.0 } else { 0.0 });
        if s.b[1471] {s.store_div_scaled_inputs_indices(571, 137, -1.0, 138, 1.0);}
        if (!s.b[1471]) {s.store_scalar(571, 0.0);}
        s.store_sub_scaled_inputs(139, 138, -1.0, 137, 1.0);s.store_mul3_affine_lhs(175, 159, 156, s.v[115], 0.0, 372);s.store_mul(138, 175, 138);s.store_mul(137, 175, 137);s.store_mul(139, 175, 139);s.copy_ad(592, 138);s.b[1472] = (p[61] != 0.0);s.store_scalar(1472, if s.b[1472] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_103(
        ...
        s.b[1473] = (p[62] == 5.0);s.store_scalar(1473, if s.b[1473] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_104(
        ...
        s.b[1479] = (p[78] == 1.0);s.store_scalar(1479, if s.b[1479] { 1.0 } else { 0.0 });s.b[1480] = (p[76] != 2.0);s.store_scalar(1480, if s.b[1480] { 1.0 } else { 0.0 });s.b[1481] = (p[63] == 1.0);s.store_scalar(1481, if s.b[1481] { 1.0 } else { 0.0 });
        if ((((!s.b[1477]) && s.b[1479]) && s.b[1480]) && s.b[1481]) {s.store_scale(168, 159, s.v[115]);s.store_mul(644, 168, 644);s.store_mul(645, 168, 645);s.store_scale(513, 168, p[15]);s.store_scale(514, 168, p[16]);}
        if ((((!s.b[1477]) && s.b[1479]) && s.b[1480]) && (!s.b[1481])) {s.store_scalar(513, p[15]);s.store_scalar(514, p[16]);}
        ...
        s.b[1482] = (p[63] == 1.0);s.store_scalar(1482, if s.b[1482] { 1.0 } else { 0.0 });
        if ((((!s.b[1477]) && s.b[1479]) && (!s.b[1480])) && s.b[1482]) {s.store_scale(168, 159, s.v[115]);s.store_mul(644, 168, 644);s.store_mul(645, 168, 645);s.store_scale(513, 168, p[15]);s.store_scale(514, 168, p[16]);}
        if ((((!s.b[1477]) && s.b[1479]) && (!s.b[1480])) && (!s.b[1482])) {s.store_scalar(513, p[15]);s.store_scalar(514, p[16]);}
        if (((!s.b[1477]) && s.b[1479]) && (!s.b[1480])) {s.store_mul_voltage_ad(498, s.ad_value(644), ctx, nodes, Some(13), Some(6));s.store_mul_voltage_ad(499, s.ad_value(645), ctx, nodes, Some(14), Some(5));s.copy_ad(505, 498);s.copy_ad(506, 499);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_105(
        ...
        if (((!s.b[1477]) && s.b[1479]) && (!s.b[1480])) {s.store_mul_voltage_ad(500, s.ad_value(513), ctx, nodes, Some(13), Some(2));s.store_mul_voltage_ad(501, s.ad_value(514), ctx, nodes, Some(14), Some(0));}
        s.b[1483] = (p[76] != 2.0);s.store_scalar(1483, if s.b[1483] { 1.0 } else { 0.0 });
        ...
        s.b[1484] = (p[65] == 1.0);s.store_scalar(1484, if s.b[1484] { 1.0 } else { 0.0 });
        if s.b[1484] {s.store_scalar(239, 1e-6);s.store_mul_div_scaled_inputs_mixed_aii(178, A::sqrt(s.ad_value(179)), 239, 1.0, 181, 2.0);s.store_scale(168, 178, 0.5);s.store_div_scaled_inputs_mixed_ai(170, A::offset(s.ad_value(132), (-p[144])), -1.0, 179, 1.0);}
        ...
        if ((s.b[1484] && (!s.b[1487])) && s.b[1488]) {s.store_add_scaled_inputs_product_indices(344, 170, -1.0, 340, 1.0, 178, 176, (-1.0));s.store_offset_div_scaled_product_indices(345, 178, 175, 0.5, 176, 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_106(
        ...
        if ((s.b[1484] && (!s.b[1487])) && s.b[1488]) {s.store_sub_div_rhs_indices(177, 340, 344, 345);}
        if ((s.b[1484] && (!s.b[1487])) && (!s.b[1488])) {s.store_scalar(177, 0.0);}
        if s.b[1484] {s.store_mul_ad_product_lhs_mixed_ia(906, 178, A::limited_exp_scaled_input(s.ad_value(177), (-1.0 / (2.0))), 179);s.store_abs_voltage(915, ctx, nodes, Some(7), Some(6));s.store_mul_div_from_scalar_lhs_ad_indices(916, (2.0 * p[454]), 416, 397);s.store_scale(917, 916, p[1]);s.store_scalar(920, (1.0 / p[530]));s.store_add_scaled_inputs(175, 906, p[491], 182, (2.0 * p[491]));s.store_div_scaled_product_add_scaled_denominator_indices(918, 917, 175, 1.0, 917, 1.0, 175, 1.0, 1.0);}
        if s.b[1484] {
        ...
        if ((s.b[1484] && (!s.b[1489])) && (!s.b[1490])) {s.store_limited_exp_scaled_input(341, 340, (-1.2));s.store_sub_mixed_ai(172, A::sqrt(A::add_scaled_inputs3_offset(s.ad_value(170), 1.0, s.ad_value(341), 1.0, A::square(s.ad_value(168)), 1.0, (-1.0))), 168);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_107(
        ...
        if ((s.b[1484] && (!s.b[1489])) && (!s.b[1490])) {s.store_add_ad(340, A::sub_from_scalar(1.0, s.ad_value(341)), A::square(s.ad_value(172)));s.store_offset_ad(175, A::limited_exp_scaled_input(s.ad_value(340), -1.0), (-1.0));}
        if s.b[1484] {s.store_sqrt_add(176, 175, 340);}
        ...
        s.b[1493] = (p[62] == 5.0);s.store_scalar(1493, if s.b[1493] { 1.0 } else { 0.0 });
        if (s.b[1484] && s.b[1493]) {s.store_scaled_mul(169, 160, 494, (s.v[115] * p[1]));}
        if (s.b[1484] && (!s.b[1493])) {s.store_scaled_mul(169, 159, 494, (s.v[115] * p[1]));}
        ...
        s.store_scaled_voltage(502, ctx, nodes, Some(0), Some(2), p[17]);s.b[1494] = (p[71] == 1.0);s.store_scalar(1494, if s.b[1494] { 1.0 } else { 0.0 });
        ...
        if (s.b[1494] && s.b[1495]) {s.store_scalar(488, 0.0);}
        if (s.b[1494] && (!s.b[1495])) {s.store_div_scaled_value_offset_denominator(169, s.ad_value(248), -1.0, s.ad_value(202), 1e-30, 1.0);s.store_mul_product3_mixed_aiii(488, A::limited_exp(s.ad_value(169)), 168, 202, 124, 1.0);}
        s.b[1496] = (p[71] == 2.0);s.store_scalar(1496, if s.b[1496] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[1494]) && s.b[1496]) && s.b[1497]) {s.store_scalar(488, 0.0);}
    ...
    pub(super) fn stamp_transient_block_108(
        ...
        if (((!s.b[1494]) && s.b[1496]) && (!s.b[1497])) {
            s.store_div_from_scalar_offset_ad(168, 1.0, {
                if (!((s.v[786] * s.v[348]) < ((-10000.0) * p[1441]))) {
                    A::add_scaled_product(A::sqrt_square_offset(A::mul(s.ad_value(786), s.ad_value(348)), ((4.0 * p[1441]) * p[1441])), 0.5, s.ad_value(786), s.ad_value(348), 0.5)
                } else {
                    {
                        if ((s.v[786] * s.v[348]) < ((-10000.0) * p[1441])) {
                            A::div_from_scalar(((-p[1441]) * p[1441]), A::mul(s.ad_value(786), s.ad_value(348)))
                        } else {
                            A::constant(0.0)
                        }
                    }
        ...
        if (((!s.b[1494]) && s.b[1496]) && (!s.b[1497])) {
            if (!((s.v[348] * s.v[171]) < ((-10000.0) * p[1442]))) {
                s.store_add_scaled_product_mixed_aii(170, A::sqrt_square_offset(A::mul(s.ad_value(348), s.ad_value(171)), ((4.0 * p[1442]) * p[1442])), 0.5, 348, 171, 0.5);
            } else {
                if ((s.v[348] * s.v[171]) < ((-10000.0) * p[1442])) {
                    s.store_div_scalar_by_product_indices(170, ((-p[1442]) * p[1442]), 348, 171, 1.0);
                } else {
                    s.store_scalar(170, 0.0);
                }
            }
        }
        if (((!s.b[1494]) && s.b[1496]) && (!s.b[1497])) {s.store_div_from_scalar_offset_product(171, 1.0, 788, 126, 1.0);s.store_mul3_lhs(491, 169, 170, 171);s.store_mul_scale_offset_mixed_ia(490, 491, A::div(s.ad_value(784), s.ad_value(153)), -1.0, 1.0);s.store_sub(489, 126, 490);s.store_add_ad(168, A::add_scaled_product(s.ad_value(782), 1.0, s.ad_value(781), s.ad_value(489), 1.0), A::mul3(s.ad_value(780), s.ad_value(489), s.ad_value(489)));s.store_sqrt_square_offset(169, 168, 1e-10);let t0: A = A::limited_exp(A::div(s.ad_value(489), s.ad_value(169)));s.store_neg_ad(492, A::offset(A::add_scaled_inputs(A::offset(A::mul_scaled_lhs(s.ad_value(493), -1.0, t0), (((-(-10.0))) + ((-p[1443])))), 0.5, A::sqrt_square_offset(A::offset(A::mul_scaled_lhs(s.ad_value(493), -1.0, t0), (((-(-10.0))) + ((-p[1443])))), (-((4.0 * (-10.0)) * p[1443]))), 0.5), (-10.0)));s.store_mul(488, 492, 124);}
        s.b[1498] = (p[69] != 0.0);s.store_scalar(1498, if s.b[1498] { 1.0 } else { 0.0 });
        if s.b[1498] {s.store_div_scaled_inputs2_by_product_indices(169, 399, 1.0, 725, (-1.0), 726, 179, 1.0);}
        if s.b[1498] {
        ...
        if s.b[1498] {s.store_offset_add_scaled_inputs(170, A::offset(A::add_scaled_product(s.ad_value(243), 1.0, s.ad_value(723), s.ad_value(399), (-1.0)), (((-(-p[1110]))) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::add_scaled_product(s.ad_value(243), 1.0, s.ad_value(723), s.ad_value(399), (-1.0)), (((-(-p[1110]))) + ((-1e-6)))), (-((4.0 * (-p[1110])) * 1e-6))), 0.5, (-p[1110]));s.store_offset_mul(171, 724, 399, 1.0);s.store_scaled_mul(172, 170, 171, ((-982222000000.0) * p[1109]));s.store_limited_exp(174, 172);s.store_scalar(175, 3.75956e-7);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_109(
        ...
        if s.b[1498] {s.store_mul_ad_product_lhs_mixed_ai(461, A::mul3(A::mul3(s.ad_value(158), s.ad_value(153), s.ad_value(175)), s.ad_value(486), s.ad_value(497)), 460, 174);s.store_scaled_mul(461, 461, 256, p[27]);s.store_add_scaled_inputs3_indices(468, 167, 1.0, 146, (-0.5), 166, -1.0);s.store_sub(168, 468, 497);s.store_div_scaled_value_by_product_indices(169, 168, 1.0, 731, 179, 1.0);}
        if s.b[1498] {
        ...
        s.b[1499] = (p[61] != 0.0);s.store_scalar(1499, if s.b[1499] { 1.0 } else { 0.0 });
        ...
        if s.b[1498] {s.store_offset_add_scaled_inputs(170, A::offset(A::add_scaled_product(s.ad_value(244), 1.0, s.ad_value(729), s.ad_value(466), (-1.0)), (((-(-p[1111]))) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::add_scaled_product(s.ad_value(244), 1.0, s.ad_value(729), s.ad_value(466), (-1.0)), (((-(-p[1111]))) + ((-1e-6)))), (-((4.0 * (-p[1111])) * 1e-6))), 0.5, (-p[1111]));s.store_offset_mul(171, 730, 466, 1.0);s.store_scaled_mul(172, 170, 171, ((-745669000000.0) * p[1109]));s.store_limited_exp(174, 172);s.store_scalar(175, 4.97232e-7);s.store_mul_ad_product_lhs_mixed_ai(469, A::mul3(A::mul3(s.ad_value(158), s.ad_value(153), s.ad_value(175)), s.ad_value(486), s.ad_value(497)), 467, 174);s.store_scaled_mul(469, 469, 256, p[27]);}
        s.b[1501] = (p[68] != 0.0);s.store_scalar(1501, if s.b[1501] { 1.0 } else { 0.0 });
        if s.b[1501] {s.store_offset_add_scaled_inputs(169, A::offset(A::add_scaled_product(s.ad_value(245), 1.0, s.ad_value(734), s.ad_value(399), (-1.0)), (((-(-p[1112]))) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::add_scaled_product(s.ad_value(245), 1.0, s.ad_value(734), s.ad_value(399), (-1.0)), (((-(-p[1112]))) + ((-1e-6)))), (-((4.0 * (-p[1112])) * 1e-6))), 0.5, (-p[1112]));s.store_offset_mul(170, 735, 399, 1.0);s.store_mul3_affine_lhs(171, 485, 169, (-p[1109]), 0.0, 170);s.store_mul_limited_exp_rhs(172, 399, 171);s.store_add_scaled_inputs4_indices(174, 497, 1.0, 127, 0.5, 521, 0.5, 522, 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_110(
        ...
        if s.b[1501] {s.store_mul_ad_product_lhs_mixed_ai(472, A::mul3(A::mul3_scaled_output(s.ad_value(158), s.ad_value(153), s.ad_value(484), p[26]), s.ad_value(486), s.ad_value(172)), 174, 256);s.store_offset_sqrt_ad(473, A::offset(A::square(s.ad_value(390)), 0.01), (-0.1));s.store_mul(169, 736, 473);s.store_limited_exp_neg_input(474, 169);s.store_offset_add(171, 169, 474, (((-1.0)) + (0.0001)));s.store_offset_sub_from_scalar_ad(172, 1.0, A::mul_offset_lhs(s.ad_value(169), 1.0, s.ad_value(474)), 0.0001);s.store_offset_square(174, 169, 0.0002);s.store_div_scaled_product_indices(471, 472, 172, 1.0, 174, 1.0);s.store_div_scaled_product_indices(470, 472, 171, 1.0, 174, 1.0);s.store_sub(168, 134, 479);s.store_sqrt_square_offset(482, 168, 0.0001);}
        ...
        if s.b[1501] {s.store_offset_mul(170, 740, 482, 1.0);s.store_mul_product3_indices(171, 170, 485, 742, 169, (-p[1109]));s.store_limited_exp(172, 171);}
        s.b[1504] = (s.v[128] > 0.0);s.store_scalar(1504, if s.b[1504] { 1.0 } else { 0.0 });
        if (s.b[1501] && s.b[1504]) {s.store_mul_product3_indices(480, 172, 462, 134, 482, p[1104]);}
        if (s.b[1501] && (!s.b[1504])) {s.store_mul_product3_indices(481, 172, 462, 134, 482, p[1104]);}
        if s.b[1501] {s.store_sub(168, 136, 479);s.store_sqrt_square_offset(483, 168, 0.0001);}
        ...
        s.b[1507] = (s.v[128] > 0.0);s.store_scalar(1507, if s.b[1507] { 1.0 } else { 0.0 });
        if (s.b[1501] && s.b[1507]) {s.store_mul_product3_indices(481, 172, 462, 136, 483, p[1105]);}
        if (s.b[1501] && (!s.b[1507])) {s.store_mul_product3_indices(480, 172, 462, 136, 483, p[1105]);}
