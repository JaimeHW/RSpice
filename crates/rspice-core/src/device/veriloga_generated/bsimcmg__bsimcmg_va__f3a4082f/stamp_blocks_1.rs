...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if s.b[1267] {s.store_scaled_add(938, 934, 937, p[43]);s.store_primal_scale(930, 928, 1.0 / (p[1089]));s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);s.store_primal_offset_add_scaled_inputs_mixed_ai(940, A::offset(A::mul(A::sqrt(A::scale_offset(s.ad_value(930), (p[1089] * p[1089]), (((p[1089] * p[1089])) + (((p[90] * p[90]) + ((2.0 * p[1089]) * p[90])))))), A::sqrt(A::offset(s.ad_value(930), 1.0))), p[90]), 1.0, 930, p[1089], p[1089]);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p[90], A::scaled_offset(s.ad_value(930), 2.0, p[90]), 1.0);}
        if s.b[1267] {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        if (s.b[1267] && s.b[1271]) {s.store_scaled_add(938, 934, 937, p[40]);s.store_primal_div(930, 928, 448);s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_21(
        ...
        if (s.b[1267] && s.b[1271]) {s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(448), (2.0 * p[90]), (p[90] * p[90])), 1.0, A::square(s.ad_value(448)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p[90]), 1.0, s.ad_value(448), s.ad_value(930), 1.0), 448);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p[90], A::scaled_offset(s.ad_value(930), 2.0, p[90]), 1.0);}
        if (s.b[1267] && s.b[1271]) {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if s.b[1267] {s.store_scaled_add(938, 934, 937, p[42]);s.store_primal_div(930, 928, 448);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_25(
        ...
        if s.b[1267] {s.store_primal_div_from_scalar_scaled_ad(939, 4.0, A::sqrt_scaled_input(A::offset(s.ad_value(930), 1.0), 2.0), 3.141592653589793);s.store_primal_add_mixed_ai(940, A::add_scaled_product(A::offset(A::mul(A::sqrt(A::add_scaled_offset_product_rhs(A::scale_offset(s.ad_value(448), (2.0 * p[90]), (p[90] * p[90])), 1.0, A::square(s.ad_value(448)), s.ad_value(930), 1.0, 1.0)), A::sqrt(A::offset(s.ad_value(930), 1.0))), p[90]), 1.0, s.ad_value(448), s.ad_value(930), 1.0), 448);s.store_primal_add_scaled_inputs_ad(941, A::sqrt(A::mul_offset_lhs(s.ad_value(930), 1.0, A::offset(s.ad_value(930), 4.0))), p[90], A::scaled_offset(s.ad_value(930), 2.0, p[90]), 1.0);}
        if s.b[1267] {
            s.store_primal_scaled_offset_ad(942, A::mul(s.ad_value(939), {
                if (!((s.v[940] / s.v[941]) > 1e-38)) {
                    A::neg(A::constant(87.498233534))
        ...
        if s.b[1267] {s.store_primal_scale(1033, 1031, (p[4] - p[43]));s.store_primal_scaled_offset_ad(455, A::add_scaled_inputs(s.ad_value(1032), p[5], s.ad_value(1033), ((2.0 * p[56]) * p[5])), ((p[1092]) + (p[1091])), (s.v[144] * 1.0 / (p[1087])));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_26(
        ...
        s.store_scalar(168, (p[1109] * p[1109]));s.store_scale(169, 742, p[1109]);s.store_square(170, 169);s.store_scale_ad(486, A::pow_from_scalar((p[1108] / p[1109]), s.ad_value(741)), 1.0 / (s.v[168]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_27(
        ...
        s.store_div_mixed_ai(487, A::pow(A::div_from_scalar(p[1108], s.ad_value(169)), s.ad_value(741)), 170);s.store_mul3_lhs(463, 158, 484, 487);s.b[1287] = (p[1717] < (-273.15));s.store_scalar(1287, if s.b[1287] { 1.0 } else { 0.0 });
