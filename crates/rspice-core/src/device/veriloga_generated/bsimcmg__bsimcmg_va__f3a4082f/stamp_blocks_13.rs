...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_88(
        ...
        if ((s.b[1431] && (!s.b[1437])) && s.b[1438]) {s.store_scaled_add_sqrt_square_offset_rhs(168, 169, 169, 0.01, 0.5);s.store_mul_ad_affine_product_lhs(199, A::offset(A::mul(s.ad_value(709), s.ad_value(168)), p[908]), s.ad_value(189), s.v[115], 0.0, 194);}
