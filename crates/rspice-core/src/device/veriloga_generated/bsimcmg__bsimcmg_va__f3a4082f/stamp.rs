...
impl Instance {
    ...
    pub fn stamp_reactive(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedReactiveStamper<'_>) {
        ...
        self.stamp_reactive_equation_54_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_55_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_56_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_69_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_71_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_96_block_0(ctx, stamper, &mut s);
        self.stamp_reactive_equation_97_block_0(ctx, stamper, &mut s);
