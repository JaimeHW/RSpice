...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_127(
        ...
        let ta0: f64 = if p[37] == 3.0 { 1.0 } else { 0.0 };l.fb7d = ta0;l.fb7e = 0.0;let ta1: f64 = if ((p[33] == 1.0) && (p[16] != 0.0)) { 1.0 } else { 0.0 };l.fb83 = ta1;l.fb84 = 0.0;
    }
    #[inline(never)]
