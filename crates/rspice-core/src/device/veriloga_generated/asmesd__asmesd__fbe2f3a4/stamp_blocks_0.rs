...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_div_ad_lhs(20, A::scale(A::exp_scaled_input(s.ad_value(68), 1.0 / (p.p59)), p.p58), 18);

        s.store_div_ad_lhs(21, A::scale(A::exp_scaled_input(s.ad_value(68), 1.0 / (p.p65)), p.p64), 18);
        ...
        s.store_sub_from_scalar_ad(83, 1.16, A::div(A::mul_scaled_lhs(s.ad_value(10), 0.000702, s.ad_value(10)), A::offset(s.ad_value(10), 1108.0)));

        s.store_offset_div_ad(84, A::neg(s.ad_value(83)), A::scale(s.ad_value(10), (2.0 * 1.3806226e-23)), (1.1150877 / (1.3806226e-23 * (300.15 + 300.15))));
        ...
        s.store_div_from_scalar_ad(89, s.v[32], A::scale_offset(A::sub_from_scalar((0.0004 * (s.v[11] - 300.15)), s.ad_value(87)), p.p18, 1.0));

        s.store_ad_value(25, A::add_scaled_product(s.ad_value(85), 1.0, s.ad_value(82), s.ad_value(86), 1.0));
        ...
        s.store_div_from_scalar_ad(89, s.v[33], A::scale_offset(A::sub_from_scalar((0.0004 * (s.v[11] - 300.15)), s.ad_value(87)), p.p71, 1.0));

        s.store_ad_value(26, A::add_scaled_product(s.ad_value(85), 1.0, s.ad_value(82), s.ad_value(86), 1.0));
        ...
        s.store_div_from_scalar_ad(89, s.v[34], A::scale_offset(A::sub_from_scalar((0.0004 * (s.v[11] - 300.15)), s.ad_value(87)), p.p76, 1.0));

        s.store_ad_value(27, A::add_scaled_product(s.ad_value(85), 1.0, s.ad_value(82), s.ad_value(86), 1.0));
        ...
        if s.b[105] {
            s.store_scaled_div(0, 76, 15, (1.0 / (p.p1)));
            s.store_div_ad(90, A::sub_scaled_inputs(s.ad_value(76), -1.0, s.ad_value(30), 1.0), A::scale(s.ad_value(15), p.p11));
        ...
        if s.b[105] {
            s.store_ad_value(35, A::add_scaled_product(A::div(A::mul(s.ad_value(28), s.ad_value(2)), A::scale_offset(A::pow(A::abs(s.ad_value(76)), s.ad_value(31)), p.p8, 1.0)), (-1.0), s.ad_value(19), A::offset(s.ad_value(1), (-1.0)), 1.0));
        }
        ...
        if s.b[107] {
            ...
            s.store_div_ad(0, A::scale(s.ad_value(76), ((-1.0) * p.p4)), A::mul_scaled_lhs(s.ad_value(15), p.p3, s.ad_value(101)));
        }
        ...
        if s.b[109] {
            s.store_scaled_div(0, 76, 15, (1.0 / (p.p59)));
            s.store_div_ad(90, A::sub_scaled_inputs(s.ad_value(76), -1.0, s.ad_value(30), 1.0), A::scale(s.ad_value(15), p.p57));
        ...
        if s.b[109] {
            s.store_ad_value(36, A::add_scaled_product(A::div(A::scale(s.ad_value(2), 0.0), A::scale_offset(A::pow(A::abs(s.ad_value(76)), s.ad_value(31)), p.p8, 1.0)), (-1.0), s.ad_value(20), A::offset(s.ad_value(1), (-1.0)), 1.0));
        }
        ...
        if s.b[111] {
            s.store_scaled_div(0, 77, 15, (1.0 / (p.p61)));
            s.store_div_ad(90, A::sub_scaled_inputs(s.ad_value(77), -1.0, s.ad_value(30), 1.0), A::scale(s.ad_value(15), p.p57));
            s.store_div_ad(91, A::neg(s.ad_value(30)), A::scale(s.ad_value(15), p.p57));
        }
        ...
        if s.b[111] {
            s.store_ad_value(38, A::add_scaled_product(A::div(A::mul(s.ad_value(29), s.ad_value(2)), A::scale_offset(A::pow(A::abs(s.ad_value(77)), s.ad_value(31)), p.p8, 1.0)), (-1.0), s.ad_value(19), A::offset(s.ad_value(1), (-1.0)), 1.0));
        }
        ...
        if s.b[113] {
            s.store_scaled_div(0, 77, 15, (1.0 / (p.p65)));
            s.store_div_ad(90, A::sub_scaled_inputs(s.ad_value(77), -1.0, s.ad_value(30), 1.0), A::scale(s.ad_value(15), p.p57));
            s.store_div_ad(91, A::neg(s.ad_value(30)), A::scale(s.ad_value(15), p.p57));
        }
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[113] {
            s.store_ad_value(39, A::add_scaled_product(A::div(A::scale(s.ad_value(2), 0.0), A::scale_offset(A::powf(A::abs(s.ad_value(77)), p.p9), p.p8, 1.0)), (-1.0), s.ad_value(21), A::offset(s.ad_value(1), (-1.0)), 1.0));
        }
        ...
        s.store_ad_value(42, A::add_scaled_product(s.ad_value(38), s.v[67], s.ad_value(35), s.ad_value(66), 1.0));
        ...
        s.store_scaled_div(43, 41, 96, 2.0);

        s.store_mul(45, 38, 43);

        s.store_mul(44, 35, 43);

        s.store_ad_value(46, A::add_scaled_product(A::mul3_scaled_output(s.ad_value(35), s.ad_value(43), s.ad_value(102), p.p84), 1.0, s.ad_value(35), s.ad_value(43), (1.0 - p.p84)));
        ...
        if (!s.b[117]) {
            s.store_mul_ad_product_rhs(57, 24, s.ad_value(75), A::offset(A::div(A::scale(s.ad_value(75), (0.5 * p.p76)), s.ad_value(27)), 1.0));
        }
        ...
        if s.b[118] {
            ...
            s.store_mul_scaled_ad_rhs(7, 25, 1.0 / ((1.0 - p.p18)), A::sub_from_scalar(1.0, A::scale(s.ad_value(6), ((1.0 - p.p24) * (1.0 - p.p24)))));
            s.store_mul_ad_product_lhs(8, s.ad_value(5), A::offset(A::div(A::scale(s.ad_value(5), (0.5 * p.p18)), s.ad_value(25)), (1.0 - p.p24)), 6);
        }

        if (!s.b[118]) {
            s.store_mul_scaled_ad_rhs(7, 25, 1.0 / ((1.0 - p.p18)), A::sub_from_scalar(1.0, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(76), s.ad_value(25)))), (1.0 - p.p18))));
        ...
        if s.b[119] {
            ...
            s.store_mul_scaled_ad_rhs(7, 26, 1.0 / ((1.0 - p.p71)), A::sub_from_scalar(1.0, A::scale(s.ad_value(6), ((1.0 - p.p24) * (1.0 - p.p24)))));
            s.store_mul_ad_product_lhs(8, s.ad_value(5), A::offset(A::div(A::scale(s.ad_value(5), (0.5 * p.p71)), s.ad_value(26)), (1.0 - p.p24)), 6);
        }

        if (!s.b[119]) {
            s.store_mul_scaled_ad_rhs(7, 26, 1.0 / ((1.0 - p.p71)), A::sub_from_scalar(1.0, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(78), s.ad_value(26)))), (1.0 - p.p71))));
            s.store_scalar(8, 0.0);
        }
        ...
        if (!s.b[120]) {
            s.store_mul_scaled_ad_rhs(7, 26, 1.0 / ((1.0 - p.p71)), A::sub_from_scalar(1.0, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(77), s.ad_value(26)))), (1.0 - p.p71))));
            s.store_scalar(8, 0.0);
        }
