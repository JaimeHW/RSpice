...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        if s.b[109] {
            s.store_add_scaled_offset_product_rhs_mixed_aii(36, A::div_scaled_inputs(s.ad_value(2), 0.0, A::scale_offset(A::pow(A::abs(s.ad_value(76)), s.ad_value(31)), p.p8, 1.0), 1.0), (-1.0), 20, 1, (-1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_equations_block_0(
        ...
        let __rspice_deriv_cse_0: f64 = (s.dn[37][0] * (nv1 - nv2));
        let __rspice_deriv_cse_1: f64 = ((s.dn[37][1] * (nv1 - nv2)) + s.v[37]);
        let __rspice_deriv_cse_2: f64 = ((s.dn[37][2] * (nv1 - nv2)) + (-s.v[37]));
        let __rspice_deriv_cse_3: f64 = (s.dn[37][3] * (nv1 - nv2));
        let __rspice_deriv_cse_4: f64 = (s.dn[37][4] * (nv1 - nv2));
        let __rspice_deriv_cse_5: f64 = (s.dn[37][5] * (nv1 - nv2));
        let __rspice_deriv_cse_6: f64 = (s.dn[37][6] * (nv1 - nv2));
        let __rspice_deriv_cse_7: f64 = (s.dn[37][7] * (nv1 - nv2));
        let __rspice_deriv_cse_8: f64 = (s.dn[37][8] * (nv1 - nv2));
        let __rspice_deriv_cse_9: f64 = (s.dn[37][9] * (nv1 - nv2));
        let __rspice_deriv_cse_10: f64 = (s.db[37][0] * (nv1 - nv2));
        let __rspice_deriv_cse_11: f64 = (s.db[37][1] * (nv1 - nv2));
        let __rspice_deriv_cse_12: f64 = (s.db[37][2] * (nv1 - nv2));
        let __rspice_deriv_cse_13: f64 = (s.db[37][3] * (nv1 - nv2));
        let __rspice_deriv_cse_14: f64 = (s.db[37][4] * (nv1 - nv2));
        let __rspice_deriv_cse_15: f64 = (s.db[37][5] * (nv1 - nv2));
        let __rspice_deriv_cse_16: f64 = (s.db[37][6] * (nv1 - nv2));
        let __rspice_deriv_cse_17: f64 = (s.db[37][7] * (nv1 - nv2));
        let __rspice_deriv_cse_18: f64 = ((s.dn[40][0] * (nv1 - nv0)) + (-s.v[40]));
        let __rspice_deriv_cse_19: f64 = ((s.dn[40][1] * (nv1 - nv0)) + s.v[40]);
        let __rspice_deriv_cse_20: f64 = (s.dn[40][2] * (nv1 - nv0));
        let __rspice_deriv_cse_21: f64 = (s.dn[40][3] * (nv1 - nv0));
        let __rspice_deriv_cse_22: f64 = (s.dn[40][4] * (nv1 - nv0));
        let __rspice_deriv_cse_23: f64 = (s.dn[40][5] * (nv1 - nv0));
        let __rspice_deriv_cse_24: f64 = (s.dn[40][6] * (nv1 - nv0));
        let __rspice_deriv_cse_25: f64 = (s.dn[40][7] * (nv1 - nv0));
        let __rspice_deriv_cse_26: f64 = (s.dn[40][8] * (nv1 - nv0));
        let __rspice_deriv_cse_27: f64 = (s.dn[40][9] * (nv1 - nv0));
        let __rspice_deriv_cse_28: f64 = (s.db[40][0] * (nv1 - nv0));
        let __rspice_deriv_cse_29: f64 = (s.db[40][1] * (nv1 - nv0));
        let __rspice_deriv_cse_30: f64 = (s.db[40][2] * (nv1 - nv0));
        let __rspice_deriv_cse_31: f64 = (s.db[40][3] * (nv1 - nv0));
        let __rspice_deriv_cse_32: f64 = (s.db[40][4] * (nv1 - nv0));
        let __rspice_deriv_cse_33: f64 = (s.db[40][5] * (nv1 - nv0));
        let __rspice_deriv_cse_34: f64 = (s.db[40][6] * (nv1 - nv0));
        let __rspice_deriv_cse_35: f64 = (s.db[40][7] * (nv1 - nv0));
    ...
    if s.b[115] {
        ...
        let __rspice_inv_cse_0: f64 = 1.0 / (s.v[16] * s.v[16]);
        let eq3_e103_d_n0: f64 = (((s.dn[35][0] * s.v[16]) - (s.v[35] * s.dn[16][0])) * __rspice_inv_cse_0);
        let eq3_e103_d_n1: f64 = (((s.dn[35][1] * s.v[16]) - (s.v[35] * s.dn[16][1])) * __rspice_inv_cse_0);
        let eq3_e103_d_n2: f64 = (((s.dn[35][2] * s.v[16]) - (s.v[35] * s.dn[16][2])) * __rspice_inv_cse_0);
        let eq3_e103_d_n3: f64 = (((s.dn[35][3] * s.v[16]) - (s.v[35] * s.dn[16][3])) * __rspice_inv_cse_0);
        let eq3_e103_d_n4: f64 = (((s.dn[35][4] * s.v[16]) - (s.v[35] * s.dn[16][4])) * __rspice_inv_cse_0);
        let eq3_e103_d_n5: f64 = (((s.dn[35][5] * s.v[16]) - (s.v[35] * s.dn[16][5])) * __rspice_inv_cse_0);
        let eq3_e103_d_n6: f64 = (((s.dn[35][6] * s.v[16]) - (s.v[35] * s.dn[16][6])) * __rspice_inv_cse_0);
        let eq3_e103_d_n7: f64 = (((s.dn[35][7] * s.v[16]) - (s.v[35] * s.dn[16][7])) * __rspice_inv_cse_0);
        let eq3_e103_d_n8: f64 = (((s.dn[35][8] * s.v[16]) - (s.v[35] * s.dn[16][8])) * __rspice_inv_cse_0);
        let eq3_e103_d_n9: f64 = (((s.dn[35][9] * s.v[16]) - (s.v[35] * s.dn[16][9])) * __rspice_inv_cse_0);
        let eq3_e103_d_b0: f64 = (((s.db[35][0] * s.v[16]) - (s.v[35] * s.db[16][0])) * __rspice_inv_cse_0);
        let eq3_e103_d_b1: f64 = (((s.db[35][1] * s.v[16]) - (s.v[35] * s.db[16][1])) * __rspice_inv_cse_0);
        let eq3_e103_d_b2: f64 = (((s.db[35][2] * s.v[16]) - (s.v[35] * s.db[16][2])) * __rspice_inv_cse_0);
        let eq3_e103_d_b3: f64 = (((s.db[35][3] * s.v[16]) - (s.v[35] * s.db[16][3])) * __rspice_inv_cse_0);
        let eq3_e103_d_b4: f64 = (((s.db[35][4] * s.v[16]) - (s.v[35] * s.db[16][4])) * __rspice_inv_cse_0);
        let eq3_e103_d_b5: f64 = (((s.db[35][5] * s.v[16]) - (s.v[35] * s.db[16][5])) * __rspice_inv_cse_0);
        let eq3_e103_d_b6: f64 = (((s.db[35][6] * s.v[16]) - (s.v[35] * s.db[16][6])) * __rspice_inv_cse_0);
        let eq3_e103_d_b7: f64 = (((s.db[35][7] * s.v[16]) - (s.v[35] * s.db[16][7])) * __rspice_inv_cse_0);
        let eq3_e104: f64 = (-eq3_e103);
        let eq3_e106: f64 = (eq3_e104 * s.v[54]);
        let eq3_e106_d_n0: f64 = (((-eq3_e103_d_n0) * s.v[54]) + (eq3_e104 * s.dn[54][0]));
        let eq3_e106_d_n1: f64 = (((-eq3_e103_d_n1) * s.v[54]) + (eq3_e104 * s.dn[54][1]));
        let eq3_e106_d_n2: f64 = (((-eq3_e103_d_n2) * s.v[54]) + (eq3_e104 * s.dn[54][2]));
        let eq3_e106_d_n3: f64 = (((-eq3_e103_d_n3) * s.v[54]) + (eq3_e104 * s.dn[54][3]));
        let eq3_e106_d_n4: f64 = (((-eq3_e103_d_n4) * s.v[54]) + (eq3_e104 * s.dn[54][4]));
        let eq3_e106_d_n5: f64 = (((-eq3_e103_d_n5) * s.v[54]) + (eq3_e104 * s.dn[54][5]));
        let eq3_e106_d_n6: f64 = (((-eq3_e103_d_n6) * s.v[54]) + (eq3_e104 * s.dn[54][6]));
        let eq3_e106_d_n7: f64 = (((-eq3_e103_d_n7) * s.v[54]) + (eq3_e104 * s.dn[54][7]));
        let eq3_e106_d_n8: f64 = (((-eq3_e103_d_n8) * s.v[54]) + (eq3_e104 * s.dn[54][8]));
        let eq3_e106_d_n9: f64 = (((-eq3_e103_d_n9) * s.v[54]) + (eq3_e104 * s.dn[54][9]));
        let eq3_e106_d_b0: f64 = (((-eq3_e103_d_b0) * s.v[54]) + (eq3_e104 * s.db[54][0]));
        let eq3_e106_d_b1: f64 = (((-eq3_e103_d_b1) * s.v[54]) + (eq3_e104 * s.db[54][1]));
        let eq3_e106_d_b2: f64 = (((-eq3_e103_d_b2) * s.v[54]) + (eq3_e104 * s.db[54][2]));
        let eq3_e106_d_b3: f64 = (((-eq3_e103_d_b3) * s.v[54]) + (eq3_e104 * s.db[54][3]));
        let eq3_e106_d_b4: f64 = (((-eq3_e103_d_b4) * s.v[54]) + (eq3_e104 * s.db[54][4]));
        let eq3_e106_d_b5: f64 = (((-eq3_e103_d_b5) * s.v[54]) + (eq3_e104 * s.db[54][5]));
        let eq3_e106_d_b6: f64 = (((-eq3_e103_d_b6) * s.v[54]) + (eq3_e104 * s.db[54][6]));
        let eq3_e106_d_b7: f64 = (((-eq3_e103_d_b7) * s.v[54]) + (eq3_e104 * s.db[54][7]));
    ...
    if s.b[122] {
        ...
        let eq7_e133_d_n0: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_0 } else { (-__rspice_deriv_cse_0) };
        let eq7_e133_d_n1: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_1 } else { (-__rspice_deriv_cse_1) };
        let eq7_e133_d_n2: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_2 } else { (-__rspice_deriv_cse_2) };
        let eq7_e133_d_n3: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_3 } else { (-__rspice_deriv_cse_3) };
        let eq7_e133_d_n4: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_4 } else { (-__rspice_deriv_cse_4) };
        let eq7_e133_d_n5: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_5 } else { (-__rspice_deriv_cse_5) };
        let eq7_e133_d_n6: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_6 } else { (-__rspice_deriv_cse_6) };
        let eq7_e133_d_n7: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_7 } else { (-__rspice_deriv_cse_7) };
        let eq7_e133_d_n8: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_8 } else { (-__rspice_deriv_cse_8) };
        let eq7_e133_d_n9: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_9 } else { (-__rspice_deriv_cse_9) };
        let eq7_e133_d_b0: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_10 } else { (-__rspice_deriv_cse_10) };
        let eq7_e133_d_b1: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_11 } else { (-__rspice_deriv_cse_11) };
        let eq7_e133_d_b2: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_12 } else { (-__rspice_deriv_cse_12) };
        let eq7_e133_d_b3: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_13 } else { (-__rspice_deriv_cse_13) };
        let eq7_e133_d_b4: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_14 } else { (-__rspice_deriv_cse_14) };
        let eq7_e133_d_b5: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_15 } else { (-__rspice_deriv_cse_15) };
        let eq7_e133_d_b6: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_16 } else { (-__rspice_deriv_cse_16) };
        let eq7_e133_d_b7: f64 = if eq7_e132 >= 0.0 { __rspice_deriv_cse_17 } else { (-__rspice_deriv_cse_17) };
        ...
        let eq7_e138_d_n0: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_18 } else { (-__rspice_deriv_cse_18) };
        let eq7_e138_d_n1: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_19 } else { (-__rspice_deriv_cse_19) };
        let eq7_e138_d_n2: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_20 } else { (-__rspice_deriv_cse_20) };
        let eq7_e138_d_n3: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_21 } else { (-__rspice_deriv_cse_21) };
        let eq7_e138_d_n4: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_22 } else { (-__rspice_deriv_cse_22) };
        let eq7_e138_d_n5: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_23 } else { (-__rspice_deriv_cse_23) };
        let eq7_e138_d_n6: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_24 } else { (-__rspice_deriv_cse_24) };
        let eq7_e138_d_n7: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_25 } else { (-__rspice_deriv_cse_25) };
        let eq7_e138_d_n8: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_26 } else { (-__rspice_deriv_cse_26) };
        let eq7_e138_d_n9: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_27 } else { (-__rspice_deriv_cse_27) };
        let eq7_e138_d_b0: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_28 } else { (-__rspice_deriv_cse_28) };
        let eq7_e138_d_b1: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_29 } else { (-__rspice_deriv_cse_29) };
        let eq7_e138_d_b2: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_30 } else { (-__rspice_deriv_cse_30) };
        let eq7_e138_d_b3: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_31 } else { (-__rspice_deriv_cse_31) };
        let eq7_e138_d_b4: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_32 } else { (-__rspice_deriv_cse_32) };
        let eq7_e138_d_b5: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_33 } else { (-__rspice_deriv_cse_33) };
        let eq7_e138_d_b6: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_34 } else { (-__rspice_deriv_cse_34) };
        let eq7_e138_d_b7: f64 = if eq7_e137 >= 0.0 { __rspice_deriv_cse_35 } else { (-__rspice_deriv_cse_35) };
    ...
    if ((!s.b[122]) && s.b[123]) {
        ...
        let eq11_e168_d_n0: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_0 } else { (-__rspice_deriv_cse_0) };
        let eq11_e168_d_n1: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_1 } else { (-__rspice_deriv_cse_1) };
        let eq11_e168_d_n2: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_2 } else { (-__rspice_deriv_cse_2) };
        let eq11_e168_d_n3: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_3 } else { (-__rspice_deriv_cse_3) };
        let eq11_e168_d_n4: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_4 } else { (-__rspice_deriv_cse_4) };
        let eq11_e168_d_n5: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_5 } else { (-__rspice_deriv_cse_5) };
        let eq11_e168_d_n6: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_6 } else { (-__rspice_deriv_cse_6) };
        let eq11_e168_d_n7: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_7 } else { (-__rspice_deriv_cse_7) };
        let eq11_e168_d_n8: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_8 } else { (-__rspice_deriv_cse_8) };
        let eq11_e168_d_n9: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_9 } else { (-__rspice_deriv_cse_9) };
        let eq11_e168_d_b0: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_10 } else { (-__rspice_deriv_cse_10) };
        let eq11_e168_d_b1: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_11 } else { (-__rspice_deriv_cse_11) };
        let eq11_e168_d_b2: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_12 } else { (-__rspice_deriv_cse_12) };
        let eq11_e168_d_b3: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_13 } else { (-__rspice_deriv_cse_13) };
        let eq11_e168_d_b4: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_14 } else { (-__rspice_deriv_cse_14) };
        let eq11_e168_d_b5: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_15 } else { (-__rspice_deriv_cse_15) };
        let eq11_e168_d_b6: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_16 } else { (-__rspice_deriv_cse_16) };
        let eq11_e168_d_b7: f64 = if eq11_e167 >= 0.0 { __rspice_deriv_cse_17 } else { (-__rspice_deriv_cse_17) };
        ...
        let eq11_e173_d_n0: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_18 } else { (-__rspice_deriv_cse_18) };
        let eq11_e173_d_n1: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_19 } else { (-__rspice_deriv_cse_19) };
        let eq11_e173_d_n2: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_20 } else { (-__rspice_deriv_cse_20) };
        let eq11_e173_d_n3: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_21 } else { (-__rspice_deriv_cse_21) };
        let eq11_e173_d_n4: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_22 } else { (-__rspice_deriv_cse_22) };
        let eq11_e173_d_n5: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_23 } else { (-__rspice_deriv_cse_23) };
        let eq11_e173_d_n6: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_24 } else { (-__rspice_deriv_cse_24) };
        let eq11_e173_d_n7: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_25 } else { (-__rspice_deriv_cse_25) };
        let eq11_e173_d_n8: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_26 } else { (-__rspice_deriv_cse_26) };
        let eq11_e173_d_n9: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_27 } else { (-__rspice_deriv_cse_27) };
        let eq11_e173_d_b0: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_28 } else { (-__rspice_deriv_cse_28) };
        let eq11_e173_d_b1: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_29 } else { (-__rspice_deriv_cse_29) };
        let eq11_e173_d_b2: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_30 } else { (-__rspice_deriv_cse_30) };
        let eq11_e173_d_b3: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_31 } else { (-__rspice_deriv_cse_31) };
        let eq11_e173_d_b4: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_32 } else { (-__rspice_deriv_cse_32) };
        let eq11_e173_d_b5: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_33 } else { (-__rspice_deriv_cse_33) };
        let eq11_e173_d_b6: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_34 } else { (-__rspice_deriv_cse_34) };
        let eq11_e173_d_b7: f64 = if eq11_e172 >= 0.0 { __rspice_deriv_cse_35 } else { (-__rspice_deriv_cse_35) };
    ...
    if s.b[125] {
        let __rspice_inv_cse_0: f64 = 1.0 / s.v[3];
        let eq23_e287: f64 = (s.v[51] * __rspice_inv_cse_0);
        let eq23_e287_d_n0: f64 = (s.dn[51][0] * __rspice_inv_cse_0);
        let eq23_e287_d_n1: f64 = (s.dn[51][1] * __rspice_inv_cse_0);
        let eq23_e287_d_n2: f64 = (s.dn[51][2] * __rspice_inv_cse_0);
        let eq23_e287_d_n3: f64 = (s.dn[51][3] * __rspice_inv_cse_0);
        let eq23_e287_d_n4: f64 = (s.dn[51][4] * __rspice_inv_cse_0);
        let eq23_e287_d_n5: f64 = (s.dn[51][5] * __rspice_inv_cse_0);
        let eq23_e287_d_n6: f64 = (s.dn[51][6] * __rspice_inv_cse_0);
        let eq23_e287_d_n7: f64 = (s.dn[51][7] * __rspice_inv_cse_0);
        let eq23_e287_d_n8: f64 = (s.dn[51][8] * __rspice_inv_cse_0);
        let eq23_e287_d_n9: f64 = (s.dn[51][9] * __rspice_inv_cse_0);
        let eq23_e287_d_b0: f64 = (s.db[51][0] * __rspice_inv_cse_0);
        let eq23_e287_d_b1: f64 = (s.db[51][1] * __rspice_inv_cse_0);
        let eq23_e287_d_b2: f64 = (s.db[51][2] * __rspice_inv_cse_0);
        let eq23_e287_d_b3: f64 = (s.db[51][3] * __rspice_inv_cse_0);
        let eq23_e287_d_b4: f64 = (s.db[51][4] * __rspice_inv_cse_0);
        let eq23_e287_d_b5: f64 = (s.db[51][5] * __rspice_inv_cse_0);
        let eq23_e287_d_b6: f64 = (s.db[51][6] * __rspice_inv_cse_0);
        let eq23_e287_d_b7: f64 = (s.db[51][7] * __rspice_inv_cse_0);
        let (eq23_e294, eq23_e294_d_n0, eq23_e294_d_n1, eq23_e294_d_n2, eq23_e294_d_n3, eq23_e294_d_n4, eq23_e294_d_n5, eq23_e294_d_n6, eq23_e294_d_n7, eq23_e294_d_n8, eq23_e294_d_n9, eq23_e294_d_b0, eq23_e294_d_b1, eq23_e294_d_b2, eq23_e294_d_b3, eq23_e294_d_b4, eq23_e294_d_b5, eq23_e294_d_b6, eq23_e294_d_b7,) = {
            if (eq23_e287 > p.p46) {
                let __rspice_inv_cse_1: f64 = 1.0 / s.v[3];
                let eq23_e292: f64 = (s.v[51] * __rspice_inv_cse_1);
                let eq23_e292_d_n0: f64 = (s.dn[51][0] * __rspice_inv_cse_1);
                let eq23_e292_d_n1: f64 = (s.dn[51][1] * __rspice_inv_cse_1);
                let eq23_e292_d_n2: f64 = (s.dn[51][2] * __rspice_inv_cse_1);
                let eq23_e292_d_n3: f64 = (s.dn[51][3] * __rspice_inv_cse_1);
                let eq23_e292_d_n4: f64 = (s.dn[51][4] * __rspice_inv_cse_1);
                let eq23_e292_d_n5: f64 = (s.dn[51][5] * __rspice_inv_cse_1);
                let eq23_e292_d_n6: f64 = (s.dn[51][6] * __rspice_inv_cse_1);
                let eq23_e292_d_n7: f64 = (s.dn[51][7] * __rspice_inv_cse_1);
                let eq23_e292_d_n8: f64 = (s.dn[51][8] * __rspice_inv_cse_1);
                let eq23_e292_d_n9: f64 = (s.dn[51][9] * __rspice_inv_cse_1);
                let eq23_e292_d_b0: f64 = (s.db[51][0] * __rspice_inv_cse_1);
                let eq23_e292_d_b1: f64 = (s.db[51][1] * __rspice_inv_cse_1);
                let eq23_e292_d_b2: f64 = (s.db[51][2] * __rspice_inv_cse_1);
                let eq23_e292_d_b3: f64 = (s.db[51][3] * __rspice_inv_cse_1);
                let eq23_e292_d_b4: f64 = (s.db[51][4] * __rspice_inv_cse_1);
                let eq23_e292_d_b5: f64 = (s.db[51][5] * __rspice_inv_cse_1);
                let eq23_e292_d_b6: f64 = (s.db[51][6] * __rspice_inv_cse_1);
                let eq23_e292_d_b7: f64 = (s.db[51][7] * __rspice_inv_cse_1);
    ...
    if s.b[126] {
        let __rspice_inv_cse_2: f64 = 1.0 / s.v[3];
        let eq26_e313: f64 = (s.v[53] * __rspice_inv_cse_2);
        let eq26_e313_d_n0: f64 = (s.dn[53][0] * __rspice_inv_cse_2);
        let eq26_e313_d_n1: f64 = (s.dn[53][1] * __rspice_inv_cse_2);
        let eq26_e313_d_n2: f64 = (s.dn[53][2] * __rspice_inv_cse_2);
        let eq26_e313_d_n3: f64 = (s.dn[53][3] * __rspice_inv_cse_2);
        let eq26_e313_d_n4: f64 = (s.dn[53][4] * __rspice_inv_cse_2);
        let eq26_e313_d_n5: f64 = (s.dn[53][5] * __rspice_inv_cse_2);
        let eq26_e313_d_n6: f64 = (s.dn[53][6] * __rspice_inv_cse_2);
        let eq26_e313_d_n7: f64 = (s.dn[53][7] * __rspice_inv_cse_2);
        let eq26_e313_d_n8: f64 = (s.dn[53][8] * __rspice_inv_cse_2);
        let eq26_e313_d_n9: f64 = (s.dn[53][9] * __rspice_inv_cse_2);
        let eq26_e313_d_b0: f64 = (s.db[53][0] * __rspice_inv_cse_2);
        let eq26_e313_d_b1: f64 = (s.db[53][1] * __rspice_inv_cse_2);
        let eq26_e313_d_b2: f64 = (s.db[53][2] * __rspice_inv_cse_2);
        let eq26_e313_d_b3: f64 = (s.db[53][3] * __rspice_inv_cse_2);
        let eq26_e313_d_b4: f64 = (s.db[53][4] * __rspice_inv_cse_2);
        let eq26_e313_d_b5: f64 = (s.db[53][5] * __rspice_inv_cse_2);
        let eq26_e313_d_b6: f64 = (s.db[53][6] * __rspice_inv_cse_2);
        let eq26_e313_d_b7: f64 = (s.db[53][7] * __rspice_inv_cse_2);
        let (eq26_e320, eq26_e320_d_n0, eq26_e320_d_n1, eq26_e320_d_n2, eq26_e320_d_n3, eq26_e320_d_n4, eq26_e320_d_n5, eq26_e320_d_n6, eq26_e320_d_n7, eq26_e320_d_n8, eq26_e320_d_n9, eq26_e320_d_b0, eq26_e320_d_b1, eq26_e320_d_b2, eq26_e320_d_b3, eq26_e320_d_b4, eq26_e320_d_b5, eq26_e320_d_b6, eq26_e320_d_b7,) = {
            if (eq26_e313 > p.p46) {
                ...
                let eq26_e318: f64 = (s.v[53] * __rspice_inv_cse_3);
                let eq26_e318_d_n0: f64 = (s.dn[53][0] * __rspice_inv_cse_3);
                let eq26_e318_d_n1: f64 = (s.dn[53][1] * __rspice_inv_cse_3);
                let eq26_e318_d_n2: f64 = (s.dn[53][2] * __rspice_inv_cse_3);
                let eq26_e318_d_n3: f64 = (s.dn[53][3] * __rspice_inv_cse_3);
                let eq26_e318_d_n4: f64 = (s.dn[53][4] * __rspice_inv_cse_3);
                let eq26_e318_d_n5: f64 = (s.dn[53][5] * __rspice_inv_cse_3);
                let eq26_e318_d_n6: f64 = (s.dn[53][6] * __rspice_inv_cse_3);
                let eq26_e318_d_n7: f64 = (s.dn[53][7] * __rspice_inv_cse_3);
                let eq26_e318_d_n8: f64 = (s.dn[53][8] * __rspice_inv_cse_3);
                let eq26_e318_d_n9: f64 = (s.dn[53][9] * __rspice_inv_cse_3);
                let eq26_e318_d_b0: f64 = (s.db[53][0] * __rspice_inv_cse_3);
                let eq26_e318_d_b1: f64 = (s.db[53][1] * __rspice_inv_cse_3);
                let eq26_e318_d_b2: f64 = (s.db[53][2] * __rspice_inv_cse_3);
                let eq26_e318_d_b3: f64 = (s.db[53][3] * __rspice_inv_cse_3);
                let eq26_e318_d_b4: f64 = (s.db[53][4] * __rspice_inv_cse_3);
                let eq26_e318_d_b5: f64 = (s.db[53][5] * __rspice_inv_cse_3);
                let eq26_e318_d_b6: f64 = (s.db[53][6] * __rspice_inv_cse_3);
                let eq26_e318_d_b7: f64 = (s.db[53][7] * __rspice_inv_cse_3);
    ...
    if s.b[127] {
        ...
        let eq29_e339: f64 = (s.v[52] * __rspice_inv_cse_4);
        let eq29_e339_d_n0: f64 = (s.dn[52][0] * __rspice_inv_cse_4);
        let eq29_e339_d_n1: f64 = (s.dn[52][1] * __rspice_inv_cse_4);
        let eq29_e339_d_n2: f64 = (s.dn[52][2] * __rspice_inv_cse_4);
        let eq29_e339_d_n3: f64 = (s.dn[52][3] * __rspice_inv_cse_4);
        let eq29_e339_d_n4: f64 = (s.dn[52][4] * __rspice_inv_cse_4);
        let eq29_e339_d_n5: f64 = (s.dn[52][5] * __rspice_inv_cse_4);
        let eq29_e339_d_n6: f64 = (s.dn[52][6] * __rspice_inv_cse_4);
        let eq29_e339_d_n7: f64 = (s.dn[52][7] * __rspice_inv_cse_4);
        let eq29_e339_d_n8: f64 = (s.dn[52][8] * __rspice_inv_cse_4);
        let eq29_e339_d_n9: f64 = (s.dn[52][9] * __rspice_inv_cse_4);
        let eq29_e339_d_b0: f64 = (s.db[52][0] * __rspice_inv_cse_4);
        let eq29_e339_d_b1: f64 = (s.db[52][1] * __rspice_inv_cse_4);
        let eq29_e339_d_b2: f64 = (s.db[52][2] * __rspice_inv_cse_4);
        let eq29_e339_d_b3: f64 = (s.db[52][3] * __rspice_inv_cse_4);
        let eq29_e339_d_b4: f64 = (s.db[52][4] * __rspice_inv_cse_4);
        let eq29_e339_d_b5: f64 = (s.db[52][5] * __rspice_inv_cse_4);
        let eq29_e339_d_b6: f64 = (s.db[52][6] * __rspice_inv_cse_4);
        let eq29_e339_d_b7: f64 = (s.db[52][7] * __rspice_inv_cse_4);
        let (eq29_e346, eq29_e346_d_n0, eq29_e346_d_n1, eq29_e346_d_n2, eq29_e346_d_n3, eq29_e346_d_n4, eq29_e346_d_n5, eq29_e346_d_n6, eq29_e346_d_n7, eq29_e346_d_n8, eq29_e346_d_n9, eq29_e346_d_b0, eq29_e346_d_b1, eq29_e346_d_b2, eq29_e346_d_b3, eq29_e346_d_b4, eq29_e346_d_b5, eq29_e346_d_b6, eq29_e346_d_b7,) = {
            if (eq29_e339 > p.p46) {
                ...
                let eq29_e344: f64 = (s.v[52] * __rspice_inv_cse_5);
                let eq29_e344_d_n0: f64 = (s.dn[52][0] * __rspice_inv_cse_5);
                let eq29_e344_d_n1: f64 = (s.dn[52][1] * __rspice_inv_cse_5);
                let eq29_e344_d_n2: f64 = (s.dn[52][2] * __rspice_inv_cse_5);
                let eq29_e344_d_n3: f64 = (s.dn[52][3] * __rspice_inv_cse_5);
                let eq29_e344_d_n4: f64 = (s.dn[52][4] * __rspice_inv_cse_5);
                let eq29_e344_d_n5: f64 = (s.dn[52][5] * __rspice_inv_cse_5);
                let eq29_e344_d_n6: f64 = (s.dn[52][6] * __rspice_inv_cse_5);
                let eq29_e344_d_n7: f64 = (s.dn[52][7] * __rspice_inv_cse_5);
                let eq29_e344_d_n8: f64 = (s.dn[52][8] * __rspice_inv_cse_5);
                let eq29_e344_d_n9: f64 = (s.dn[52][9] * __rspice_inv_cse_5);
                let eq29_e344_d_b0: f64 = (s.db[52][0] * __rspice_inv_cse_5);
                let eq29_e344_d_b1: f64 = (s.db[52][1] * __rspice_inv_cse_5);
                let eq29_e344_d_b2: f64 = (s.db[52][2] * __rspice_inv_cse_5);
                let eq29_e344_d_b3: f64 = (s.db[52][3] * __rspice_inv_cse_5);
                let eq29_e344_d_b4: f64 = (s.db[52][4] * __rspice_inv_cse_5);
                let eq29_e344_d_b5: f64 = (s.db[52][5] * __rspice_inv_cse_5);
                let eq29_e344_d_b6: f64 = (s.db[52][6] * __rspice_inv_cse_5);
                let eq29_e344_d_b7: f64 = (s.db[52][7] * __rspice_inv_cse_5);
    ...
    pub(super) fn stamp_transient_equations_block_2(
        ...
        let eq34_e375_d_n0: f64 = ((-s.dn[45][0]) * s.v[3]);
        let eq34_e375_d_n1: f64 = ((-s.dn[45][1]) * s.v[3]);
        let eq34_e375_d_n2: f64 = ((-s.dn[45][2]) * s.v[3]);
        let eq34_e375_d_n3: f64 = ((-s.dn[45][3]) * s.v[3]);
        let eq34_e375_d_n4: f64 = ((-s.dn[45][4]) * s.v[3]);
        let eq34_e375_d_n5: f64 = ((-s.dn[45][5]) * s.v[3]);
        let eq34_e375_d_n6: f64 = ((-s.dn[45][6]) * s.v[3]);
        let eq34_e375_d_n7: f64 = ((-s.dn[45][7]) * s.v[3]);
        let eq34_e375_d_n8: f64 = ((-s.dn[45][8]) * s.v[3]);
        let eq34_e375_d_n9: f64 = ((-s.dn[45][9]) * s.v[3]);
        let eq34_e375_d_b0: f64 = ((-s.db[45][0]) * s.v[3]);
        let eq34_e375_d_b1: f64 = ((-s.db[45][1]) * s.v[3]);
        let eq34_e375_d_b2: f64 = ((-s.db[45][2]) * s.v[3]);
        let eq34_e375_d_b3: f64 = ((-s.db[45][3]) * s.v[3]);
        let eq34_e375_d_b4: f64 = ((-s.db[45][4]) * s.v[3]);
        let eq34_e375_d_b5: f64 = ((-s.db[45][5]) * s.v[3]);
        let eq34_e375_d_b6: f64 = ((-s.db[45][6]) * s.v[3]);
        let eq34_e375_d_b7: f64 = ((-s.db[45][7]) * s.v[3]);
