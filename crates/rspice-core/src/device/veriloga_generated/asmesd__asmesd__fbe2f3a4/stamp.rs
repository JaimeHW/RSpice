...
struct CommonStampValues {
    ...
    n6: f64, n8: f64, na: f64, nc: f64, ne: f64, ng: f64,
    ni: f64, nj: f64, ny: f64, nA: f64, nP: f64, rm: f64,
    rq: f64, rA: f64, rB: f64, rC: f64, sn: f64, so: f64,
    sp: f64, sR: f64, sS: f64, sY: f64, tl: f64, tm: f64,
    tn: f64, tJ: f64, tK: f64, tL: f64, um: f64, un: f64,
    uo: f64, up: f64, uq: f64, ur: f64, uw: f64, ux: f64,
    uy: f64, uz: f64, uU: f64, uV: f64, uW: f64, uX: f64,
    vo: f64, vp: f64, vq: f64, vr: f64, vY: f64, vZ: f64,
    w0: f64, w1: f64, yo: f64, yp: f64, yq: f64, yr: f64,
    yu: f64, yx: f64, yA: f64, yB: f64, yC: f64, yF: f64,
    yI: f64, Es: f64, ET: f64, EX: f64, F1: f64, F5: f64,
    Ge: f64, Gf: f64, Gg: f64, Gk: f64, Gl: f64, Gm: f64,
    Gs: f64, Gt: f64, Gu: f64, Gv: f64, Gw: f64, GC: f64,
    GD: f64, GE: f64, GF: f64, GG: f64, GL: f64, GM: f64,
    GN: f64, GO: f64, GS: f64, GT: f64, GU: f64, GZ: f64,
    H0: f64, H1: f64, H2: f64, H3: f64, H4: f64, H5: f64,
    H6: f64,
}
...
impl Instance {
    ...
    fn eval_common_stamp_values<const REACTIVE: bool>(&mut self, ctx: &GeneratedEvalContext<'_>) -> CommonStampValues {
        ...
        CommonStampValues {
            ...
            lY, m6, ml, mp, mu, mA, n6, n8,
            na, nc, ne, ng, ni, nj, ny, nA,
            nP, rm, rq, rA, rB, rC, sn, so,
            sp, sR, sS, sY, tl, tm, tn, tJ,
            tK, tL, um, un, uo, up, uq, ur,
            uw, ux, uy, uz, uU, uV, uW, uX,
            vo, vp, vq, vr, vY, vZ, w0, w1,
            yo, yp, yq, yr, yu, yx, yA, yB,
            yC, yF, yI, Es, ET, EX, F1, F5,
