...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_mul_scaled_exp_scaled_input_rhs(205, 204, p.p13, 10, s.v[176]);
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[310] {
            s.store_sub_from_scalar_scaled_mul_ad_lhs(150, 1.0, A::div(A::div_scaled_value_offset_denominator(s.ad_value(142), 1.0, s.ad_value(206), 1.0, 1.0), s.ad_value(120)), 128, 1.0);
        ...
        if (((!s.b[311]) && (!s.b[314])) && (!s.b[315])) {
            s.store_mul_scaled_sqrt_ad_rhs(87, 89, (-0.5), A::div_from_scalar((-27.0), A::mul(A::square(s.ad_value(88)), s.ad_value(88))));
