...
impl Instance {
    ...
    pub(super) fn stamp_reactive_equations_block_0(
        ...
        let eq14_e257_d_n0: f64 = ((p.p3 * s.dn[212][0]) * p.p1);
        let eq14_e257_d_n1: f64 = ((p.p3 * s.dn[212][1]) * p.p1);
        let eq14_e257_d_n2: f64 = ((p.p3 * s.dn[212][2]) * p.p1);
        let eq14_e257_d_n3: f64 = ((p.p3 * s.dn[212][3]) * p.p1);
        let eq14_e257_d_n4: f64 = ((p.p3 * s.dn[212][4]) * p.p1);
        let eq14_e257_d_n5: f64 = ((p.p3 * s.dn[212][5]) * p.p1);
        let eq14_e257_d_n6: f64 = ((p.p3 * s.dn[212][6]) * p.p1);
        let eq14_e257_d_n7: f64 = ((p.p3 * s.dn[212][7]) * p.p1);
        let eq14_e257_d_n8: f64 = ((p.p3 * s.dn[212][8]) * p.p1);
        let eq14_e257_d_n9: f64 = ((p.p3 * s.dn[212][9]) * p.p1);
        let eq14_e257_d_n10: f64 = ((p.p3 * s.dn[212][10]) * p.p1);
        let eq14_e257_d_n11: f64 = ((p.p3 * s.dn[212][11]) * p.p1);
        let eq14_e257_d_b0: f64 = ((p.p3 * s.db[212][0]) * p.p1);
        let eq14_e257_d_b1: f64 = ((p.p3 * s.db[212][1]) * p.p1);
        ...
        let eq16_e273_d_n0: f64 = ((p.p3 * s.dn[217][0]) * p.p1);
        let eq16_e273_d_n1: f64 = ((p.p3 * s.dn[217][1]) * p.p1);
        let eq16_e273_d_n2: f64 = ((p.p3 * s.dn[217][2]) * p.p1);
        let eq16_e273_d_n3: f64 = ((p.p3 * s.dn[217][3]) * p.p1);
        let eq16_e273_d_n4: f64 = ((p.p3 * s.dn[217][4]) * p.p1);
        let eq16_e273_d_n5: f64 = ((p.p3 * s.dn[217][5]) * p.p1);
        let eq16_e273_d_n6: f64 = ((p.p3 * s.dn[217][6]) * p.p1);
        let eq16_e273_d_n7: f64 = ((p.p3 * s.dn[217][7]) * p.p1);
        let eq16_e273_d_n8: f64 = ((p.p3 * s.dn[217][8]) * p.p1);
        let eq16_e273_d_n9: f64 = ((p.p3 * s.dn[217][9]) * p.p1);
        let eq16_e273_d_n10: f64 = ((p.p3 * s.dn[217][10]) * p.p1);
        let eq16_e273_d_n11: f64 = ((p.p3 * s.dn[217][11]) * p.p1);
        let eq16_e273_d_b0: f64 = ((p.p3 * s.db[217][0]) * p.p1);
        let eq16_e273_d_b1: f64 = ((p.p3 * s.db[217][1]) * p.p1);
        ...
        let eq17_e281_d_n0: f64 = ((eq17_e276 * s.dn[249][0]) * p.p1);
        let eq17_e281_d_n1: f64 = ((eq17_e276 * s.dn[249][1]) * p.p1);
        let eq17_e281_d_n2: f64 = ((eq17_e276 * s.dn[249][2]) * p.p1);
        let eq17_e281_d_n3: f64 = ((eq17_e276 * s.dn[249][3]) * p.p1);
        let eq17_e281_d_n4: f64 = ((eq17_e276 * s.dn[249][4]) * p.p1);
        let eq17_e281_d_n5: f64 = ((eq17_e276 * s.dn[249][5]) * p.p1);
        let eq17_e281_d_n6: f64 = ((eq17_e276 * s.dn[249][6]) * p.p1);
        let eq17_e281_d_n7: f64 = ((eq17_e276 * s.dn[249][7]) * p.p1);
        let eq17_e281_d_n8: f64 = ((eq17_e276 * s.dn[249][8]) * p.p1);
        let eq17_e281_d_n9: f64 = ((eq17_e276 * s.dn[249][9]) * p.p1);
        let eq17_e281_d_n10: f64 = ((eq17_e276 * s.dn[249][10]) * p.p1);
        let eq17_e281_d_n11: f64 = ((eq17_e276 * s.dn[249][11]) * p.p1);
        let eq17_e281_d_b0: f64 = ((eq17_e276 * s.db[249][0]) * p.p1);
        let eq17_e281_d_b1: f64 = ((eq17_e276 * s.db[249][1]) * p.p1);
        ...
        let eq18_e289_d_n0: f64 = ((eq18_e284 * s.dn[250][0]) * p.p1);
        let eq18_e289_d_n1: f64 = ((eq18_e284 * s.dn[250][1]) * p.p1);
        let eq18_e289_d_n2: f64 = ((eq18_e284 * s.dn[250][2]) * p.p1);
        let eq18_e289_d_n3: f64 = ((eq18_e284 * s.dn[250][3]) * p.p1);
        let eq18_e289_d_n4: f64 = ((eq18_e284 * s.dn[250][4]) * p.p1);
        let eq18_e289_d_n5: f64 = ((eq18_e284 * s.dn[250][5]) * p.p1);
        let eq18_e289_d_n6: f64 = ((eq18_e284 * s.dn[250][6]) * p.p1);
        let eq18_e289_d_n7: f64 = ((eq18_e284 * s.dn[250][7]) * p.p1);
        let eq18_e289_d_n8: f64 = ((eq18_e284 * s.dn[250][8]) * p.p1);
        let eq18_e289_d_n9: f64 = ((eq18_e284 * s.dn[250][9]) * p.p1);
        let eq18_e289_d_n10: f64 = ((eq18_e284 * s.dn[250][10]) * p.p1);
        let eq18_e289_d_n11: f64 = ((eq18_e284 * s.dn[250][11]) * p.p1);
        let eq18_e289_d_b0: f64 = ((eq18_e284 * s.db[250][0]) * p.p1);
        let eq18_e289_d_b1: f64 = ((eq18_e284 * s.db[250][1]) * p.p1);
        ...
        let eq30_reactive_node_derivatives: [f64; 12] = [(s.dn[312][0] * eq30_e367_q), (s.dn[312][1] * eq30_e367_q), (s.dn[312][2] * eq30_e367_q), (s.dn[312][3] * eq30_e367_q), (s.dn[312][4] * eq30_e367_q), (s.dn[312][5] * eq30_e367_q), (s.dn[312][6] * eq30_e367_q), (s.dn[312][7] * eq30_e367_q), (s.dn[312][8] * eq30_e367_q), (s.dn[312][9] * eq30_e367_q), (s.dn[312][10] * eq30_e367_q), eq30_e368_q_d_n11];
        let eq30_reactive_branch_derivatives: [f64; 2] = [(s.db[312][0] * eq30_e367_q), (s.db[312][1] * eq30_e367_q)];
        stamper.stamp_current_reactive_dense(
            Some(nodes[6]),
            Some(nodes[4]),
            nodes,
