...
impl Default for Parameters {
    fn default() -> Self {
        ...
        params.rth = 0.0;
        validate_parameter_rth(params.rth).expect("generated Verilog-A parameter default must satisfy declared range");
        params.cth = 0.0;
        validate_parameter_cth(params.cth).expect("generated Verilog-A parameter default must satisfy declared range");
        params.strth = 0.0;
        validate_parameter_strth(params.strth).expect("generated Verilog-A parameter default must satisfy declared range");
        params.povfb = -1.0;
        ...
        params.rtho = 0.0;
        validate_parameter_rtho(params.rtho).expect("generated Verilog-A parameter default must satisfy declared range");
        params.rthw1 = 0.0;
        validate_parameter_rthw1(params.rthw1).expect("generated Verilog-A parameter default must satisfy declared range");
        params.rthw2 = 0.0;
        validate_parameter_rthw2(params.rthw2).expect("generated Verilog-A parameter default must satisfy declared range");
        params.rthlw = 0.0;
        validate_parameter_rthlw(params.rthlw).expect("generated Verilog-A parameter default must satisfy declared range");
        params.ctho = 0.0;
        validate_parameter_ctho(params.ctho).expect("generated Verilog-A parameter default must satisfy declared range");
        params.cthw1 = 0.0;
        validate_parameter_cthw1(params.cthw1).expect("generated Verilog-A parameter default must satisfy declared range");
        params.cthw2 = 0.0;
        validate_parameter_cthw2(params.cthw2).expect("generated Verilog-A parameter default must satisfy declared range");
        params.cthlw = 0.0;
        validate_parameter_cthlw(params.cthlw).expect("generated Verilog-A parameter default must satisfy declared range");
        params.strtho = 0.0;
        validate_parameter_strtho(params.strtho).expect("generated Verilog-A parameter default must satisfy declared range");
        params.saref = 1e-6;
...
fn validate_parameter_rth(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'RTH' must be finite, got {}", value));
    }
    if value < 0.0 {
        return Err(format!("parameter 'RTH' must be >= 0.0, got {}", value));
    }
    Ok(())
}

fn validate_parameter_cth(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'CTH' must be finite, got {}", value));
    }
    if value < 0.0 {
        return Err(format!("parameter 'CTH' must be >= 0.0, got {}", value));
    }
    Ok(())
}

fn validate_parameter_strth(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'STRTH' must be finite, got {}", value));
    }
    Ok(())
}
...
fn validate_parameter_rtho(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'RTHO' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_rthw1(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'RTHW1' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_rthw2(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'RTHW2' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_rthlw(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'RTHLW' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_ctho(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'CTHO' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_cthw1(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'CTHW1' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_cthw2(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'CTHW2' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_cthlw(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'CTHLW' must be finite, got {}", value));
    }
    Ok(())
}

fn validate_parameter_strtho(value: f64) -> Result<(), String> {
    if !value.is_finite() {
        return Err(format!("parameter 'STRTHO' must be finite, got {}", value));
    }
    Ok(())
}
...
pub struct Instance {
    ...
    pub(crate) param_given: [bool; 820],
...
impl Instance {
    ...
    pub const PARAMETER_COUNT: usize = 820;
    pub const VARIABLE_COUNT: usize = 2628;
    ...
    pub fn set_parameter(&mut self, name: &str, value: f64) -> Result<(), String> {
        match name.to_ascii_lowercase().as_str() {
            ...
            "rth" => { validate_parameter_rth(value)?; self.params.rth = value; self.mark_param_given(158); Ok(()) }
            "cth" => { validate_parameter_cth(value)?; self.params.cth = value; self.mark_param_given(159); Ok(()) }
            "strth" => { validate_parameter_strth(value)?; self.params.strth = value; self.mark_param_given(160); Ok(()) }
            "povfb" => { validate_parameter_povfb(value)?; self.params.povfb = value; self.mark_param_given(161); Ok(()) }
            "plvfb" => { validate_parameter_plvfb(value)?; self.params.plvfb = value; self.mark_param_given(162); Ok(()) }
            "pwvfb" => { validate_parameter_pwvfb(value)?; self.params.pwvfb = value; self.mark_param_given(163); Ok(()) }
            "plwvfb" => { validate_parameter_plwvfb(value)?; self.params.plwvfb = value; self.mark_param_given(164); Ok(()) }
            "postvfb" => { validate_parameter_postvfb(value)?; self.params.postvfb = value; self.mark_param_given(165); Ok(()) }
            "plstvfb" => { validate_parameter_plstvfb(value)?; self.params.plstvfb = value; self.mark_param_given(166); Ok(()) }
            "pwstvfb" => { validate_parameter_pwstvfb(value)?; self.params.pwstvfb = value; self.mark_param_given(167); Ok(()) }
            "plwstvfb" => { validate_parameter_plwstvfb(value)?; self.params.plwstvfb = value; self.mark_param_given(168); Ok(()) }
            "post2vfb" => { validate_parameter_post2vfb(value)?; self.params.post2vfb = value; self.mark_param_given(169); Ok(()) }
            "potox" => { validate_parameter_potox(value)?; self.params.potox = value; self.mark_param_given(170); Ok(()) }
            "poepsrox" => { validate_parameter_poepsrox(value)?; self.params.poepsrox = value; self.mark_param_given(171); Ok(()) }
            "poneff" => { validate_parameter_poneff(value)?; self.params.poneff = value; self.mark_param_given(172); Ok(()) }
            "plneff" => { validate_parameter_plneff(value)?; self.params.plneff = value; self.mark_param_given(173); Ok(()) }
            "pwneff" => { validate_parameter_pwneff(value)?; self.params.pwneff = value; self.mark_param_given(174); Ok(()) }
            "plwneff" => { validate_parameter_plwneff(value)?; self.params.plwneff = value; self.mark_param_given(175); Ok(()) }
            "pofacneffac" => { validate_parameter_pofacneffac(value)?; self.params.pofacneffac = value; self.mark_param_given(176); Ok(()) }
            "plfacneffac" => { validate_parameter_plfacneffac(value)?; self.params.plfacneffac = value; self.mark_param_given(177); Ok(()) }
            "pwfacneffac" => { validate_parameter_pwfacneffac(value)?; self.params.pwfacneffac = value; self.mark_param_given(178); Ok(()) }
            "plwfacneffac" => { validate_parameter_plwfacneffac(value)?; self.params.plwfacneffac = value; self.mark_param_given(179); Ok(()) }
            "pogfacnud" => { validate_parameter_pogfacnud(value)?; self.params.pogfacnud = value; self.mark_param_given(180); Ok(()) }
            "plgfacnud" => { validate_parameter_plgfacnud(value)?; self.params.plgfacnud = value; self.mark_param_given(181); Ok(()) }
            "pwgfacnud" => { validate_parameter_pwgfacnud(value)?; self.params.pwgfacnud = value; self.mark_param_given(182); Ok(()) }
            "plwgfacnud" => { validate_parameter_plwgfacnud(value)?; self.params.plwgfacnud = value; self.mark_param_given(183); Ok(()) }
            "povsbnud" => { validate_parameter_povsbnud(value)?; self.params.povsbnud = value; self.mark_param_given(184); Ok(()) }
            "podvsbnud" => { validate_parameter_podvsbnud(value)?; self.params.podvsbnud = value; self.mark_param_given(185); Ok(()) }
            "povnsub" => { validate_parameter_povnsub(value)?; self.params.povnsub = value; self.mark_param_given(186); Ok(()) }
            "ponslp" => { validate_parameter_ponslp(value)?; self.params.ponslp = value; self.mark_param_given(187); Ok(()) }
            "podnsub" => { validate_parameter_podnsub(value)?; self.params.podnsub = value; self.mark_param_given(188); Ok(()) }
            "podphib" => { validate_parameter_podphib(value)?; self.params.podphib = value; self.mark_param_given(189); Ok(()) }
            "pldphib" => { validate_parameter_pldphib(value)?; self.params.pldphib = value; self.mark_param_given(190); Ok(()) }
            "pwdphib" => { validate_parameter_pwdphib(value)?; self.params.pwdphib = value; self.mark_param_given(191); Ok(()) }
            "plwdphib" => { validate_parameter_plwdphib(value)?; self.params.plwdphib = value; self.mark_param_given(192); Ok(()) }
            "podelvtac" => { validate_parameter_podelvtac(value)?; self.params.podelvtac = value; self.mark_param_given(193); Ok(()) }
            "pldelvtac" => { validate_parameter_pldelvtac(value)?; self.params.pldelvtac = value; self.mark_param_given(194); Ok(()) }
            "pwdelvtac" => { validate_parameter_pwdelvtac(value)?; self.params.pwdelvtac = value; self.mark_param_given(195); Ok(()) }
            "plwdelvtac" => { validate_parameter_plwdelvtac(value)?; self.params.plwdelvtac = value; self.mark_param_given(196); Ok(()) }
            "ponp" => { validate_parameter_ponp(value)?; self.params.ponp = value; self.mark_param_given(197); Ok(()) }
            "plnp" => { validate_parameter_plnp(value)?; self.params.plnp = value; self.mark_param_given(198); Ok(()) }
            "pwnp" => { validate_parameter_pwnp(value)?; self.params.pwnp = value; self.mark_param_given(199); Ok(()) }
            "plwnp" => { validate_parameter_plwnp(value)?; self.params.plwnp = value; self.mark_param_given(200); Ok(()) }
            "potoxov" => { validate_parameter_potoxov(value)?; self.params.potoxov = value; self.mark_param_given(201); Ok(()) }
            "potoxovd" => { validate_parameter_potoxovd(value)?; self.params.potoxovd = value; self.mark_param_given(202); Ok(()) }
            "ponov" => { validate_parameter_ponov(value)?; self.params.ponov = value; self.mark_param_given(203); Ok(()) }
            "plnov" => { validate_parameter_plnov(value)?; self.params.plnov = value; self.mark_param_given(204); Ok(()) }
            "pwnov" => { validate_parameter_pwnov(value)?; self.params.pwnov = value; self.mark_param_given(205); Ok(()) }
            "plwnov" => { validate_parameter_plwnov(value)?; self.params.plwnov = value; self.mark_param_given(206); Ok(()) }
            "ponovd" => { validate_parameter_ponovd(value)?; self.params.ponovd = value; self.mark_param_given(207); Ok(()) }
            "plnovd" => { validate_parameter_plnovd(value)?; self.params.plnovd = value; self.mark_param_given(208); Ok(()) }
            "pwnovd" => { validate_parameter_pwnovd(value)?; self.params.pwnovd = value; self.mark_param_given(209); Ok(()) }
            "plwnovd" => { validate_parameter_plwnovd(value)?; self.params.plwnovd = value; self.mark_param_given(210); Ok(()) }
            "poct" => { validate_parameter_poct(value)?; self.params.poct = value; self.mark_param_given(211); Ok(()) }
            "plct" => { validate_parameter_plct(value)?; self.params.plct = value; self.mark_param_given(212); Ok(()) }
            "pwct" => { validate_parameter_pwct(value)?; self.params.pwct = value; self.mark_param_given(213); Ok(()) }
            "plwct" => { validate_parameter_plwct(value)?; self.params.plwct = value; self.mark_param_given(214); Ok(()) }
            "poctg" => { validate_parameter_poctg(value)?; self.params.poctg = value; self.mark_param_given(215); Ok(()) }
            "poctb" => { validate_parameter_poctb(value)?; self.params.poctb = value; self.mark_param_given(216); Ok(()) }
            "postct" => { validate_parameter_postct(value)?; self.params.postct = value; self.mark_param_given(217); Ok(()) }
            "pocf" => { validate_parameter_pocf(value)?; self.params.pocf = value; self.mark_param_given(218); Ok(()) }
            "plcf" => { validate_parameter_plcf(value)?; self.params.plcf = value; self.mark_param_given(219); Ok(()) }
            "pwcf" => { validate_parameter_pwcf(value)?; self.params.pwcf = value; self.mark_param_given(220); Ok(()) }
            "plwcf" => { validate_parameter_plwcf(value)?; self.params.plwcf = value; self.mark_param_given(221); Ok(()) }
            "pocfd" => { validate_parameter_pocfd(value)?; self.params.pocfd = value; self.mark_param_given(222); Ok(()) }
            "pocfb" => { validate_parameter_pocfb(value)?; self.params.pocfb = value; self.mark_param_given(223); Ok(()) }
            "popsce" => { validate_parameter_popsce(value)?; self.params.popsce = value; self.mark_param_given(224); Ok(()) }
            "plpsce" => { validate_parameter_plpsce(value)?; self.params.plpsce = value; self.mark_param_given(225); Ok(()) }
            "pwpsce" => { validate_parameter_pwpsce(value)?; self.params.pwpsce = value; self.mark_param_given(226); Ok(()) }
            "plwpsce" => { validate_parameter_plwpsce(value)?; self.params.plwpsce = value; self.mark_param_given(227); Ok(()) }
            "popsceb" => { validate_parameter_popsceb(value)?; self.params.popsceb = value; self.mark_param_given(228); Ok(()) }
            "popsced" => { validate_parameter_popsced(value)?; self.params.popsced = value; self.mark_param_given(229); Ok(()) }
            "pobetn" => { validate_parameter_pobetn(value)?; self.params.pobetn = value; self.mark_param_given(230); Ok(()) }
            "plbetn" => { validate_parameter_plbetn(value)?; self.params.plbetn = value; self.mark_param_given(231); Ok(()) }
            "pwbetn" => { validate_parameter_pwbetn(value)?; self.params.pwbetn = value; self.mark_param_given(232); Ok(()) }
            "plwbetn" => { validate_parameter_plwbetn(value)?; self.params.plwbetn = value; self.mark_param_given(233); Ok(()) }
            "postbet" => { validate_parameter_postbet(value)?; self.params.postbet = value; self.mark_param_given(234); Ok(()) }
            "plstbet" => { validate_parameter_plstbet(value)?; self.params.plstbet = value; self.mark_param_given(235); Ok(()) }
            "pwstbet" => { validate_parameter_pwstbet(value)?; self.params.pwstbet = value; self.mark_param_given(236); Ok(()) }
            "plwstbet" => { validate_parameter_plwstbet(value)?; self.params.plwstbet = value; self.mark_param_given(237); Ok(()) }
            "pomue" => { validate_parameter_pomue(value)?; self.params.pomue = value; self.mark_param_given(238); Ok(()) }
            "plmue" => { validate_parameter_plmue(value)?; self.params.plmue = value; self.mark_param_given(239); Ok(()) }
            "pwmue" => { validate_parameter_pwmue(value)?; self.params.pwmue = value; self.mark_param_given(240); Ok(()) }
            "plwmue" => { validate_parameter_plwmue(value)?; self.params.plwmue = value; self.mark_param_given(241); Ok(()) }
            "postmue" => { validate_parameter_postmue(value)?; self.params.postmue = value; self.mark_param_given(242); Ok(()) }
            "pothemu" => { validate_parameter_pothemu(value)?; self.params.pothemu = value; self.mark_param_given(243); Ok(()) }
            "postthemu" => { validate_parameter_postthemu(value)?; self.params.postthemu = value; self.mark_param_given(244); Ok(()) }
            "pocs" => { validate_parameter_pocs(value)?; self.params.pocs = value; self.mark_param_given(245); Ok(()) }
            "plcs" => { validate_parameter_plcs(value)?; self.params.plcs = value; self.mark_param_given(246); Ok(()) }
            "pwcs" => { validate_parameter_pwcs(value)?; self.params.pwcs = value; self.mark_param_given(247); Ok(()) }
            "plwcs" => { validate_parameter_plwcs(value)?; self.params.plwcs = value; self.mark_param_given(248); Ok(()) }
            "postcs" => { validate_parameter_postcs(value)?; self.params.postcs = value; self.mark_param_given(249); Ok(()) }
            "pothecs" => { validate_parameter_pothecs(value)?; self.params.pothecs = value; self.mark_param_given(250); Ok(()) }
            "postthecs" => { validate_parameter_postthecs(value)?; self.params.postthecs = value; self.mark_param_given(251); Ok(()) }
            "poxcor" => { validate_parameter_poxcor(value)?; self.params.poxcor = value; self.mark_param_given(252); Ok(()) }
            "plxcor" => { validate_parameter_plxcor(value)?; self.params.plxcor = value; self.mark_param_given(253); Ok(()) }
            "pwxcor" => { validate_parameter_pwxcor(value)?; self.params.pwxcor = value; self.mark_param_given(254); Ok(()) }
            "plwxcor" => { validate_parameter_plwxcor(value)?; self.params.plwxcor = value; self.mark_param_given(255); Ok(()) }
            "postxcor" => { validate_parameter_postxcor(value)?; self.params.postxcor = value; self.mark_param_given(256); Ok(()) }
            "pofeta" => { validate_parameter_pofeta(value)?; self.params.pofeta = value; self.mark_param_given(257); Ok(()) }
            "pors" => { validate_parameter_pors(value)?; self.params.pors = value; self.mark_param_given(258); Ok(()) }
            "plrs" => { validate_parameter_plrs(value)?; self.params.plrs = value; self.mark_param_given(259); Ok(()) }
            "pwrs" => { validate_parameter_pwrs(value)?; self.params.pwrs = value; self.mark_param_given(260); Ok(()) }
            "plwrs" => { validate_parameter_plwrs(value)?; self.params.plwrs = value; self.mark_param_given(261); Ok(()) }
            "postrs" => { validate_parameter_postrs(value)?; self.params.postrs = value; self.mark_param_given(262); Ok(()) }
            "porsb" => { validate_parameter_porsb(value)?; self.params.porsb = value; self.mark_param_given(263); Ok(()) }
            "porsg" => { validate_parameter_porsg(value)?; self.params.porsg = value; self.mark_param_given(264); Ok(()) }
            "pothesat" => { validate_parameter_pothesat(value)?; self.params.pothesat = value; self.mark_param_given(265); Ok(()) }
            "plthesat" => { validate_parameter_plthesat(value)?; self.params.plthesat = value; self.mark_param_given(266); Ok(()) }
            "pwthesat" => { validate_parameter_pwthesat(value)?; self.params.pwthesat = value; self.mark_param_given(267); Ok(()) }
            "plwthesat" => { validate_parameter_plwthesat(value)?; self.params.plwthesat = value; self.mark_param_given(268); Ok(()) }
            "postthesat" => { validate_parameter_postthesat(value)?; self.params.postthesat = value; self.mark_param_given(269); Ok(()) }
            "plstthesat" => { validate_parameter_plstthesat(value)?; self.params.plstthesat = value; self.mark_param_given(270); Ok(()) }
            "pwstthesat" => { validate_parameter_pwstthesat(value)?; self.params.pwstthesat = value; self.mark_param_given(271); Ok(()) }
            "plwstthesat" => { validate_parameter_plwstthesat(value)?; self.params.plwstthesat = value; self.mark_param_given(272); Ok(()) }
            "pothesatb" => { validate_parameter_pothesatb(value)?; self.params.pothesatb = value; self.mark_param_given(273); Ok(()) }
            "plthesatb" => { validate_parameter_plthesatb(value)?; self.params.plthesatb = value; self.mark_param_given(274); Ok(()) }
            "pwthesatb" => { validate_parameter_pwthesatb(value)?; self.params.pwthesatb = value; self.mark_param_given(275); Ok(()) }
            "plwthesatb" => { validate_parameter_plwthesatb(value)?; self.params.plwthesatb = value; self.mark_param_given(276); Ok(()) }
            "pothesatg" => { validate_parameter_pothesatg(value)?; self.params.pothesatg = value; self.mark_param_given(277); Ok(()) }
            "plthesatg" => { validate_parameter_plthesatg(value)?; self.params.plthesatg = value; self.mark_param_given(278); Ok(()) }
            "pwthesatg" => { validate_parameter_pwthesatg(value)?; self.params.pwthesatg = value; self.mark_param_given(279); Ok(()) }
            "plwthesatg" => { validate_parameter_plwthesatg(value)?; self.params.plwthesatg = value; self.mark_param_given(280); Ok(()) }
            "poax" => { validate_parameter_poax(value)?; self.params.poax = value; self.mark_param_given(281); Ok(()) }
            "plax" => { validate_parameter_plax(value)?; self.params.plax = value; self.mark_param_given(282); Ok(()) }
            "pwax" => { validate_parameter_pwax(value)?; self.params.pwax = value; self.mark_param_given(283); Ok(()) }
            "plwax" => { validate_parameter_plwax(value)?; self.params.plwax = value; self.mark_param_given(284); Ok(()) }
            "poalp" => { validate_parameter_poalp(value)?; self.params.poalp = value; self.mark_param_given(285); Ok(()) }
            "plalp" => { validate_parameter_plalp(value)?; self.params.plalp = value; self.mark_param_given(286); Ok(()) }
            "pwalp" => { validate_parameter_pwalp(value)?; self.params.pwalp = value; self.mark_param_given(287); Ok(()) }
            "plwalp" => { validate_parameter_plwalp(value)?; self.params.plwalp = value; self.mark_param_given(288); Ok(()) }
            "poalp1" => { validate_parameter_poalp1(value)?; self.params.poalp1 = value; self.mark_param_given(289); Ok(()) }
            "plalp1" => { validate_parameter_plalp1(value)?; self.params.plalp1 = value; self.mark_param_given(290); Ok(()) }
            "pwalp1" => { validate_parameter_pwalp1(value)?; self.params.pwalp1 = value; self.mark_param_given(291); Ok(()) }
            "plwalp1" => { validate_parameter_plwalp1(value)?; self.params.plwalp1 = value; self.mark_param_given(292); Ok(()) }
            "poalp2" => { validate_parameter_poalp2(value)?; self.params.poalp2 = value; self.mark_param_given(293); Ok(()) }
            "plalp2" => { validate_parameter_plalp2(value)?; self.params.plalp2 = value; self.mark_param_given(294); Ok(()) }
            "pwalp2" => { validate_parameter_pwalp2(value)?; self.params.pwalp2 = value; self.mark_param_given(295); Ok(()) }
            "plwalp2" => { validate_parameter_plwalp2(value)?; self.params.plwalp2 = value; self.mark_param_given(296); Ok(()) }
            "povp" => { validate_parameter_povp(value)?; self.params.povp = value; self.mark_param_given(297); Ok(()) }
            "poa1" => { validate_parameter_poa1(value)?; self.params.poa1 = value; self.mark_param_given(298); Ok(()) }
            "pla1" => { validate_parameter_pla1(value)?; self.params.pla1 = value; self.mark_param_given(299); Ok(()) }
            "pwa1" => { validate_parameter_pwa1(value)?; self.params.pwa1 = value; self.mark_param_given(300); Ok(()) }
            "plwa1" => { validate_parameter_plwa1(value)?; self.params.plwa1 = value; self.mark_param_given(301); Ok(()) }
            "poa2" => { validate_parameter_poa2(value)?; self.params.poa2 = value; self.mark_param_given(302); Ok(()) }
            "posta2" => { validate_parameter_posta2(value)?; self.params.posta2 = value; self.mark_param_given(303); Ok(()) }
            "poa3" => { validate_parameter_poa3(value)?; self.params.poa3 = value; self.mark_param_given(304); Ok(()) }
            "pla3" => { validate_parameter_pla3(value)?; self.params.pla3 = value; self.mark_param_given(305); Ok(()) }
            "pwa3" => { validate_parameter_pwa3(value)?; self.params.pwa3 = value; self.mark_param_given(306); Ok(()) }
            "plwa3" => { validate_parameter_plwa3(value)?; self.params.plwa3 = value; self.mark_param_given(307); Ok(()) }
            "poa4" => { validate_parameter_poa4(value)?; self.params.poa4 = value; self.mark_param_given(308); Ok(()) }
            "pla4" => { validate_parameter_pla4(value)?; self.params.pla4 = value; self.mark_param_given(309); Ok(()) }
            "pwa4" => { validate_parameter_pwa4(value)?; self.params.pwa4 = value; self.mark_param_given(310); Ok(()) }
            "plwa4" => { validate_parameter_plwa4(value)?; self.params.plwa4 = value; self.mark_param_given(311); Ok(()) }
            "pogco" => { validate_parameter_pogco(value)?; self.params.pogco = value; self.mark_param_given(312); Ok(()) }
            "poiginv" => { validate_parameter_poiginv(value)?; self.params.poiginv = value; self.mark_param_given(313); Ok(()) }
            "pliginv" => { validate_parameter_pliginv(value)?; self.params.pliginv = value; self.mark_param_given(314); Ok(()) }
            "pwiginv" => { validate_parameter_pwiginv(value)?; self.params.pwiginv = value; self.mark_param_given(315); Ok(()) }
            "plwiginv" => { validate_parameter_plwiginv(value)?; self.params.plwiginv = value; self.mark_param_given(316); Ok(()) }
            "poigov" => { validate_parameter_poigov(value)?; self.params.poigov = value; self.mark_param_given(317); Ok(()) }
            "pligov" => { validate_parameter_pligov(value)?; self.params.pligov = value; self.mark_param_given(318); Ok(()) }
            "pwigov" => { validate_parameter_pwigov(value)?; self.params.pwigov = value; self.mark_param_given(319); Ok(()) }
            "plwigov" => { validate_parameter_plwigov(value)?; self.params.plwigov = value; self.mark_param_given(320); Ok(()) }
            "poigovd" => { validate_parameter_poigovd(value)?; self.params.poigovd = value; self.mark_param_given(321); Ok(()) }
            "pligovd" => { validate_parameter_pligovd(value)?; self.params.pligovd = value; self.mark_param_given(322); Ok(()) }
            "pwigovd" => { validate_parameter_pwigovd(value)?; self.params.pwigovd = value; self.mark_param_given(323); Ok(()) }
            "plwigovd" => { validate_parameter_plwigovd(value)?; self.params.plwigovd = value; self.mark_param_given(324); Ok(()) }
            "postig" => { validate_parameter_postig(value)?; self.params.postig = value; self.mark_param_given(325); Ok(()) }
            "pogc2" => { validate_parameter_pogc2(value)?; self.params.pogc2 = value; self.mark_param_given(326); Ok(()) }
            "pogc3" => { validate_parameter_pogc3(value)?; self.params.pogc3 = value; self.mark_param_given(327); Ok(()) }
            "pochib" => { validate_parameter_pochib(value)?; self.params.pochib = value; self.mark_param_given(328); Ok(()) }
            "poagidl" => { validate_parameter_poagidl(value)?; self.params.poagidl = value; self.mark_param_given(329); Ok(()) }
            "plagidl" => { validate_parameter_plagidl(value)?; self.params.plagidl = value; self.mark_param_given(330); Ok(()) }
            "pwagidl" => { validate_parameter_pwagidl(value)?; self.params.pwagidl = value; self.mark_param_given(331); Ok(()) }
            "plwagidl" => { validate_parameter_plwagidl(value)?; self.params.plwagidl = value; self.mark_param_given(332); Ok(()) }
            "poagidld" => { validate_parameter_poagidld(value)?; self.params.poagidld = value; self.mark_param_given(333); Ok(()) }
            "plagidld" => { validate_parameter_plagidld(value)?; self.params.plagidld = value; self.mark_param_given(334); Ok(()) }
            "pwagidld" => { validate_parameter_pwagidld(value)?; self.params.pwagidld = value; self.mark_param_given(335); Ok(()) }
            "plwagidld" => { validate_parameter_plwagidld(value)?; self.params.plwagidld = value; self.mark_param_given(336); Ok(()) }
            "pobgidl" => { validate_parameter_pobgidl(value)?; self.params.pobgidl = value; self.mark_param_given(337); Ok(()) }
            "pobgidld" => { validate_parameter_pobgidld(value)?; self.params.pobgidld = value; self.mark_param_given(338); Ok(()) }
            "postbgidl" => { validate_parameter_postbgidl(value)?; self.params.postbgidl = value; self.mark_param_given(339); Ok(()) }
            "postbgidld" => { validate_parameter_postbgidld(value)?; self.params.postbgidld = value; self.mark_param_given(340); Ok(()) }
            "pocgidl" => { validate_parameter_pocgidl(value)?; self.params.pocgidl = value; self.mark_param_given(341); Ok(()) }
            "pocgidld" => { validate_parameter_pocgidld(value)?; self.params.pocgidld = value; self.mark_param_given(342); Ok(()) }
            "pocox" => { validate_parameter_pocox(value)?; self.params.pocox = value; self.mark_param_given(343); Ok(()) }
            "plcox" => { validate_parameter_plcox(value)?; self.params.plcox = value; self.mark_param_given(344); Ok(()) }
            "pwcox" => { validate_parameter_pwcox(value)?; self.params.pwcox = value; self.mark_param_given(345); Ok(()) }
            "plwcox" => { validate_parameter_plwcox(value)?; self.params.plwcox = value; self.mark_param_given(346); Ok(()) }
            "pocgov" => { validate_parameter_pocgov(value)?; self.params.pocgov = value; self.mark_param_given(347); Ok(()) }
            "plcgov" => { validate_parameter_plcgov(value)?; self.params.plcgov = value; self.mark_param_given(348); Ok(()) }
            "pwcgov" => { validate_parameter_pwcgov(value)?; self.params.pwcgov = value; self.mark_param_given(349); Ok(()) }
            "plwcgov" => { validate_parameter_plwcgov(value)?; self.params.plwcgov = value; self.mark_param_given(350); Ok(()) }
            "pocgovd" => { validate_parameter_pocgovd(value)?; self.params.pocgovd = value; self.mark_param_given(351); Ok(()) }
            "plcgovd" => { validate_parameter_plcgovd(value)?; self.params.plcgovd = value; self.mark_param_given(352); Ok(()) }
            "pwcgovd" => { validate_parameter_pwcgovd(value)?; self.params.pwcgovd = value; self.mark_param_given(353); Ok(()) }
            "plwcgovd" => { validate_parameter_plwcgovd(value)?; self.params.plwcgovd = value; self.mark_param_given(354); Ok(()) }
            "pocgbov" => { validate_parameter_pocgbov(value)?; self.params.pocgbov = value; self.mark_param_given(355); Ok(()) }
            "plcgbov" => { validate_parameter_plcgbov(value)?; self.params.plcgbov = value; self.mark_param_given(356); Ok(()) }
            "pwcgbov" => { validate_parameter_pwcgbov(value)?; self.params.pwcgbov = value; self.mark_param_given(357); Ok(()) }
            "plwcgbov" => { validate_parameter_plwcgbov(value)?; self.params.plwcgbov = value; self.mark_param_given(358); Ok(()) }
            "pocfr" => { validate_parameter_pocfr(value)?; self.params.pocfr = value; self.mark_param_given(359); Ok(()) }
            "plcfr" => { validate_parameter_plcfr(value)?; self.params.plcfr = value; self.mark_param_given(360); Ok(()) }
            "pwcfr" => { validate_parameter_pwcfr(value)?; self.params.pwcfr = value; self.mark_param_given(361); Ok(()) }
            "plwcfr" => { validate_parameter_plwcfr(value)?; self.params.plwcfr = value; self.mark_param_given(362); Ok(()) }
            "pocfrd" => { validate_parameter_pocfrd(value)?; self.params.pocfrd = value; self.mark_param_given(363); Ok(()) }
            "plcfrd" => { validate_parameter_plcfrd(value)?; self.params.plcfrd = value; self.mark_param_given(364); Ok(()) }
            "pwcfrd" => { validate_parameter_pwcfrd(value)?; self.params.pwcfrd = value; self.mark_param_given(365); Ok(()) }
            "plwcfrd" => { validate_parameter_plwcfrd(value)?; self.params.plwcfrd = value; self.mark_param_given(366); Ok(()) }
            "pofnt" => { validate_parameter_pofnt(value)?; self.params.pofnt = value; self.mark_param_given(367); Ok(()) }
            "pofntexc" => { validate_parameter_pofntexc(value)?; self.params.pofntexc = value; self.mark_param_given(368); Ok(()) }
            "plfntexc" => { validate_parameter_plfntexc(value)?; self.params.plfntexc = value; self.mark_param_given(369); Ok(()) }
            "pwfntexc" => { validate_parameter_pwfntexc(value)?; self.params.pwfntexc = value; self.mark_param_given(370); Ok(()) }
            "plwfntexc" => { validate_parameter_plwfntexc(value)?; self.params.plwfntexc = value; self.mark_param_given(371); Ok(()) }
            "ponfa" => { validate_parameter_ponfa(value)?; self.params.ponfa = value; self.mark_param_given(372); Ok(()) }
            "plnfa" => { validate_parameter_plnfa(value)?; self.params.plnfa = value; self.mark_param_given(373); Ok(()) }
            "pwnfa" => { validate_parameter_pwnfa(value)?; self.params.pwnfa = value; self.mark_param_given(374); Ok(()) }
            "plwnfa" => { validate_parameter_plwnfa(value)?; self.params.plwnfa = value; self.mark_param_given(375); Ok(()) }
            "ponfb" => { validate_parameter_ponfb(value)?; self.params.ponfb = value; self.mark_param_given(376); Ok(()) }
            "plnfb" => { validate_parameter_plnfb(value)?; self.params.plnfb = value; self.mark_param_given(377); Ok(()) }
            "pwnfb" => { validate_parameter_pwnfb(value)?; self.params.pwnfb = value; self.mark_param_given(378); Ok(()) }
            "plwnfb" => { validate_parameter_plwnfb(value)?; self.params.plwnfb = value; self.mark_param_given(379); Ok(()) }
            "ponfc" => { validate_parameter_ponfc(value)?; self.params.ponfc = value; self.mark_param_given(380); Ok(()) }
            "plnfc" => { validate_parameter_plnfc(value)?; self.params.plnfc = value; self.mark_param_given(381); Ok(()) }
            "pwnfc" => { validate_parameter_pwnfc(value)?; self.params.pwnfc = value; self.mark_param_given(382); Ok(()) }
            "plwnfc" => { validate_parameter_plwnfc(value)?; self.params.plwnfc = value; self.mark_param_given(383); Ok(()) }
            "poef" => { validate_parameter_poef(value)?; self.params.poef = value; self.mark_param_given(384); Ok(()) }
            "povfbedge" => { validate_parameter_povfbedge(value)?; self.params.povfbedge = value; self.mark_param_given(385); Ok(()) }
            "postvfbedge" => { validate_parameter_postvfbedge(value)?; self.params.postvfbedge = value; self.mark_param_given(386); Ok(()) }
            "plstvfbedge" => { validate_parameter_plstvfbedge(value)?; self.params.plstvfbedge = value; self.mark_param_given(387); Ok(()) }
            "pwstvfbedge" => { validate_parameter_pwstvfbedge(value)?; self.params.pwstvfbedge = value; self.mark_param_given(388); Ok(()) }
            "plwstvfbedge" => { validate_parameter_plwstvfbedge(value)?; self.params.plwstvfbedge = value; self.mark_param_given(389); Ok(()) }
            "podphibedge" => { validate_parameter_podphibedge(value)?; self.params.podphibedge = value; self.mark_param_given(390); Ok(()) }
            "pldphibedge" => { validate_parameter_pldphibedge(value)?; self.params.pldphibedge = value; self.mark_param_given(391); Ok(()) }
            "pwdphibedge" => { validate_parameter_pwdphibedge(value)?; self.params.pwdphibedge = value; self.mark_param_given(392); Ok(()) }
            "plwdphibedge" => { validate_parameter_plwdphibedge(value)?; self.params.plwdphibedge = value; self.mark_param_given(393); Ok(()) }
            "poneffedge" => { validate_parameter_poneffedge(value)?; self.params.poneffedge = value; self.mark_param_given(394); Ok(()) }
            "plneffedge" => { validate_parameter_plneffedge(value)?; self.params.plneffedge = value; self.mark_param_given(395); Ok(()) }
            "pwneffedge" => { validate_parameter_pwneffedge(value)?; self.params.pwneffedge = value; self.mark_param_given(396); Ok(()) }
            "plwneffedge" => { validate_parameter_plwneffedge(value)?; self.params.plwneffedge = value; self.mark_param_given(397); Ok(()) }
            "poctedge" => { validate_parameter_poctedge(value)?; self.params.poctedge = value; self.mark_param_given(398); Ok(()) }
            "plctedge" => { validate_parameter_plctedge(value)?; self.params.plctedge = value; self.mark_param_given(399); Ok(()) }
            "pwctedge" => { validate_parameter_pwctedge(value)?; self.params.pwctedge = value; self.mark_param_given(400); Ok(()) }
            "plwctedge" => { validate_parameter_plwctedge(value)?; self.params.plwctedge = value; self.mark_param_given(401); Ok(()) }
            "pobetnedge" => { validate_parameter_pobetnedge(value)?; self.params.pobetnedge = value; self.mark_param_given(402); Ok(()) }
            "plbetnedge" => { validate_parameter_plbetnedge(value)?; self.params.plbetnedge = value; self.mark_param_given(403); Ok(()) }
            "pwbetnedge" => { validate_parameter_pwbetnedge(value)?; self.params.pwbetnedge = value; self.mark_param_given(404); Ok(()) }
            "plwbetnedge" => { validate_parameter_plwbetnedge(value)?; self.params.plwbetnedge = value; self.mark_param_given(405); Ok(()) }
            "postbetedge" => { validate_parameter_postbetedge(value)?; self.params.postbetedge = value; self.mark_param_given(406); Ok(()) }
            "plstbetedge" => { validate_parameter_plstbetedge(value)?; self.params.plstbetedge = value; self.mark_param_given(407); Ok(()) }
            "pwstbetedge" => { validate_parameter_pwstbetedge(value)?; self.params.pwstbetedge = value; self.mark_param_given(408); Ok(()) }
            "plwstbetedge" => { validate_parameter_plwstbetedge(value)?; self.params.plwstbetedge = value; self.mark_param_given(409); Ok(()) }
            "popsceedge" => { validate_parameter_popsceedge(value)?; self.params.popsceedge = value; self.mark_param_given(410); Ok(()) }
            "plpsceedge" => { validate_parameter_plpsceedge(value)?; self.params.plpsceedge = value; self.mark_param_given(411); Ok(()) }
            "pwpsceedge" => { validate_parameter_pwpsceedge(value)?; self.params.pwpsceedge = value; self.mark_param_given(412); Ok(()) }
            "plwpsceedge" => { validate_parameter_plwpsceedge(value)?; self.params.plwpsceedge = value; self.mark_param_given(413); Ok(()) }
            "popscebedge" => { validate_parameter_popscebedge(value)?; self.params.popscebedge = value; self.mark_param_given(414); Ok(()) }
            "popscededge" => { validate_parameter_popscededge(value)?; self.params.popscededge = value; self.mark_param_given(415); Ok(()) }
            "pocfedge" => { validate_parameter_pocfedge(value)?; self.params.pocfedge = value; self.mark_param_given(416); Ok(()) }
            "plcfedge" => { validate_parameter_plcfedge(value)?; self.params.plcfedge = value; self.mark_param_given(417); Ok(()) }
            "pwcfedge" => { validate_parameter_pwcfedge(value)?; self.params.pwcfedge = value; self.mark_param_given(418); Ok(()) }
            "plwcfedge" => { validate_parameter_plwcfedge(value)?; self.params.plwcfedge = value; self.mark_param_given(419); Ok(()) }
            "pocfdedge" => { validate_parameter_pocfdedge(value)?; self.params.pocfdedge = value; self.mark_param_given(420); Ok(()) }
            "pocfbedge" => { validate_parameter_pocfbedge(value)?; self.params.pocfbedge = value; self.mark_param_given(421); Ok(()) }
            "pofntedge" => { validate_parameter_pofntedge(value)?; self.params.pofntedge = value; self.mark_param_given(422); Ok(()) }
            "ponfaedge" => { validate_parameter_ponfaedge(value)?; self.params.ponfaedge = value; self.mark_param_given(423); Ok(()) }
            "plnfaedge" => { validate_parameter_plnfaedge(value)?; self.params.plnfaedge = value; self.mark_param_given(424); Ok(()) }
            "pwnfaedge" => { validate_parameter_pwnfaedge(value)?; self.params.pwnfaedge = value; self.mark_param_given(425); Ok(()) }
            "plwnfaedge" => { validate_parameter_plwnfaedge(value)?; self.params.plwnfaedge = value; self.mark_param_given(426); Ok(()) }
            "ponfbedge" => { validate_parameter_ponfbedge(value)?; self.params.ponfbedge = value; self.mark_param_given(427); Ok(()) }
            "plnfbedge" => { validate_parameter_plnfbedge(value)?; self.params.plnfbedge = value; self.mark_param_given(428); Ok(()) }
            "pwnfbedge" => { validate_parameter_pwnfbedge(value)?; self.params.pwnfbedge = value; self.mark_param_given(429); Ok(()) }
            "plwnfbedge" => { validate_parameter_plwnfbedge(value)?; self.params.plwnfbedge = value; self.mark_param_given(430); Ok(()) }
            "ponfcedge" => { validate_parameter_ponfcedge(value)?; self.params.ponfcedge = value; self.mark_param_given(431); Ok(()) }
            "plnfcedge" => { validate_parameter_plnfcedge(value)?; self.params.plnfcedge = value; self.mark_param_given(432); Ok(()) }
            "pwnfcedge" => { validate_parameter_pwnfcedge(value)?; self.params.pwnfcedge = value; self.mark_param_given(433); Ok(()) }
            "plwnfcedge" => { validate_parameter_plwnfcedge(value)?; self.params.plwnfcedge = value; self.mark_param_given(434); Ok(()) }
            "poefedge" => { validate_parameter_poefedge(value)?; self.params.poefedge = value; self.mark_param_given(435); Ok(()) }
            "pokvthowe" => { validate_parameter_pokvthowe(value)?; self.params.pokvthowe = value; self.mark_param_given(436); Ok(()) }
            "plkvthowe" => { validate_parameter_plkvthowe(value)?; self.params.plkvthowe = value; self.mark_param_given(437); Ok(()) }
            "pwkvthowe" => { validate_parameter_pwkvthowe(value)?; self.params.pwkvthowe = value; self.mark_param_given(438); Ok(()) }
            "plwkvthowe" => { validate_parameter_plwkvthowe(value)?; self.params.plwkvthowe = value; self.mark_param_given(439); Ok(()) }
            "pokuowe" => { validate_parameter_pokuowe(value)?; self.params.pokuowe = value; self.mark_param_given(440); Ok(()) }
            "plkuowe" => { validate_parameter_plkuowe(value)?; self.params.plkuowe = value; self.mark_param_given(441); Ok(()) }
            "pwkuowe" => { validate_parameter_pwkuowe(value)?; self.params.pwkuowe = value; self.mark_param_given(442); Ok(()) }
            "plwkuowe" => { validate_parameter_plwkuowe(value)?; self.params.plwkuowe = value; self.mark_param_given(443); Ok(()) }
            "lmin" => { validate_parameter_lmin(value)?; self.params.lmin = value; self.mark_param_given(444); Ok(()) }
            "lmax" => { validate_parameter_lmax(value)?; self.params.lmax = value; self.mark_param_given(445); Ok(()) }
            "wmin" => { validate_parameter_wmin(value)?; self.params.wmin = value; self.mark_param_given(446); Ok(()) }
            "wmax" => { validate_parameter_wmax(value)?; self.params.wmax = value; self.mark_param_given(447); Ok(()) }
            "lvaro" => { validate_parameter_lvaro(value)?; self.params.lvaro = value; self.mark_param_given(448); Ok(()) }
            "lvarl" => { validate_parameter_lvarl(value)?; self.params.lvarl = value; self.mark_param_given(449); Ok(()) }
            "lvarw" => { validate_parameter_lvarw(value)?; self.params.lvarw = value; self.mark_param_given(450); Ok(()) }
            "lap" => { validate_parameter_lap(value)?; self.params.lap = value; self.mark_param_given(451); Ok(()) }
            "wvaro" => { validate_parameter_wvaro(value)?; self.params.wvaro = value; self.mark_param_given(452); Ok(()) }
            "wvarl" => { validate_parameter_wvarl(value)?; self.params.wvarl = value; self.mark_param_given(453); Ok(()) }
            "wvarw" => { validate_parameter_wvarw(value)?; self.params.wvarw = value; self.mark_param_given(454); Ok(()) }
            "wot" => { validate_parameter_wot(value)?; self.params.wot = value; self.mark_param_given(455); Ok(()) }
            "dlq" => { validate_parameter_dlq(value)?; self.params.dlq = value; self.mark_param_given(456); Ok(()) }
            "dwq" => { validate_parameter_dwq(value)?; self.params.dwq = value; self.mark_param_given(457); Ok(()) }
            "vfbo" => { validate_parameter_vfbo(value)?; self.params.vfbo = value; self.mark_param_given(458); Ok(()) }
            "vfbl" => { validate_parameter_vfbl(value)?; self.params.vfbl = value; self.mark_param_given(459); Ok(()) }
            "vfbw" => { validate_parameter_vfbw(value)?; self.params.vfbw = value; self.mark_param_given(460); Ok(()) }
            "vfblw" => { validate_parameter_vfblw(value)?; self.params.vfblw = value; self.mark_param_given(461); Ok(()) }
            "stvfbo" => { validate_parameter_stvfbo(value)?; self.params.stvfbo = value; self.mark_param_given(462); Ok(()) }
            "stvfbl" => { validate_parameter_stvfbl(value)?; self.params.stvfbl = value; self.mark_param_given(463); Ok(()) }
            "stvfbw" => { validate_parameter_stvfbw(value)?; self.params.stvfbw = value; self.mark_param_given(464); Ok(()) }
            "stvfblw" => { validate_parameter_stvfblw(value)?; self.params.stvfblw = value; self.mark_param_given(465); Ok(()) }
            "st2vfbo" => { validate_parameter_st2vfbo(value)?; self.params.st2vfbo = value; self.mark_param_given(466); Ok(()) }
            "toxo" => { validate_parameter_toxo(value)?; self.params.toxo = value; self.mark_param_given(467); Ok(()) }
            "epsroxo" => { validate_parameter_epsroxo(value)?; self.params.epsroxo = value; self.mark_param_given(468); Ok(()) }
            "nsubo" => { validate_parameter_nsubo(value)?; self.params.nsubo = value; self.mark_param_given(469); Ok(()) }
            "nsubw" => { validate_parameter_nsubw(value)?; self.params.nsubw = value; self.mark_param_given(470); Ok(()) }
            "wseg" => { validate_parameter_wseg(value)?; self.params.wseg = value; self.mark_param_given(471); Ok(()) }
            "npck" => { validate_parameter_npck(value)?; self.params.npck = value; self.mark_param_given(472); Ok(()) }
            "npckw" => { validate_parameter_npckw(value)?; self.params.npckw = value; self.mark_param_given(473); Ok(()) }
            "wsegp" => { validate_parameter_wsegp(value)?; self.params.wsegp = value; self.mark_param_given(474); Ok(()) }
            "lpck" => { validate_parameter_lpck(value)?; self.params.lpck = value; self.mark_param_given(475); Ok(()) }
            "lpckw" => { validate_parameter_lpckw(value)?; self.params.lpckw = value; self.mark_param_given(476); Ok(()) }
            "fol1" => { validate_parameter_fol1(value)?; self.params.fol1 = value; self.mark_param_given(477); Ok(()) }
            "fol2" => { validate_parameter_fol2(value)?; self.params.fol2 = value; self.mark_param_given(478); Ok(()) }
            "facneffaco" => { validate_parameter_facneffaco(value)?; self.params.facneffaco = value; self.mark_param_given(479); Ok(()) }
            "facneffacl" => { validate_parameter_facneffacl(value)?; self.params.facneffacl = value; self.mark_param_given(480); Ok(()) }
            "facneffacw" => { validate_parameter_facneffacw(value)?; self.params.facneffacw = value; self.mark_param_given(481); Ok(()) }
            "facneffaclw" => { validate_parameter_facneffaclw(value)?; self.params.facneffaclw = value; self.mark_param_given(482); Ok(()) }
            "gfacnudo" => { validate_parameter_gfacnudo(value)?; self.params.gfacnudo = value; self.mark_param_given(483); Ok(()) }
            "gfacnudl" => { validate_parameter_gfacnudl(value)?; self.params.gfacnudl = value; self.mark_param_given(484); Ok(()) }
            "gfacnudlexp" => { validate_parameter_gfacnudlexp(value)?; self.params.gfacnudlexp = value; self.mark_param_given(485); Ok(()) }
            "gfacnudw" => { validate_parameter_gfacnudw(value)?; self.params.gfacnudw = value; self.mark_param_given(486); Ok(()) }
            "gfacnudlw" => { validate_parameter_gfacnudlw(value)?; self.params.gfacnudlw = value; self.mark_param_given(487); Ok(()) }
            "vsbnudo" => { validate_parameter_vsbnudo(value)?; self.params.vsbnudo = value; self.mark_param_given(488); Ok(()) }
            "dvsbnudo" => { validate_parameter_dvsbnudo(value)?; self.params.dvsbnudo = value; self.mark_param_given(489); Ok(()) }
            "vnsubo" => { validate_parameter_vnsubo(value)?; self.params.vnsubo = value; self.mark_param_given(490); Ok(()) }
            "nslpo" => { validate_parameter_nslpo(value)?; self.params.nslpo = value; self.mark_param_given(491); Ok(()) }
            "dnsubo" => { validate_parameter_dnsubo(value)?; self.params.dnsubo = value; self.mark_param_given(492); Ok(()) }
            "dphibo" => { validate_parameter_dphibo(value)?; self.params.dphibo = value; self.mark_param_given(493); Ok(()) }
            "dphibl" => { validate_parameter_dphibl(value)?; self.params.dphibl = value; self.mark_param_given(494); Ok(()) }
            "dphiblexp" => { validate_parameter_dphiblexp(value)?; self.params.dphiblexp = value; self.mark_param_given(495); Ok(()) }
            "dphibw" => { validate_parameter_dphibw(value)?; self.params.dphibw = value; self.mark_param_given(496); Ok(()) }
            "dphiblw" => { validate_parameter_dphiblw(value)?; self.params.dphiblw = value; self.mark_param_given(497); Ok(()) }
            "delvtaco" => { validate_parameter_delvtaco(value)?; self.params.delvtaco = value; self.mark_param_given(498); Ok(()) }
            "delvtacl" => { validate_parameter_delvtacl(value)?; self.params.delvtacl = value; self.mark_param_given(499); Ok(()) }
            "delvtaclexp" => { validate_parameter_delvtaclexp(value)?; self.params.delvtaclexp = value; self.mark_param_given(500); Ok(()) }
            "delvtacw" => { validate_parameter_delvtacw(value)?; self.params.delvtacw = value; self.mark_param_given(501); Ok(()) }
            "delvtaclw" => { validate_parameter_delvtaclw(value)?; self.params.delvtaclw = value; self.mark_param_given(502); Ok(()) }
            "npo" => { validate_parameter_npo(value)?; self.params.npo = value; self.mark_param_given(503); Ok(()) }
            "npl" => { validate_parameter_npl(value)?; self.params.npl = value; self.mark_param_given(504); Ok(()) }
            "toxovo" => { validate_parameter_toxovo(value)?; self.params.toxovo = value; self.mark_param_given(505); Ok(()) }
            "toxovdo" => { validate_parameter_toxovdo(value)?; self.params.toxovdo = value; self.mark_param_given(506); Ok(()) }
            "lov" => { validate_parameter_lov(value)?; self.params.lov = value; self.mark_param_given(507); Ok(()) }
            "lovd" => { validate_parameter_lovd(value)?; self.params.lovd = value; self.mark_param_given(508); Ok(()) }
            "novo" => { validate_parameter_novo(value)?; self.params.novo = value; self.mark_param_given(509); Ok(()) }
            "novdo" => { validate_parameter_novdo(value)?; self.params.novdo = value; self.mark_param_given(510); Ok(()) }
            "cto" => { validate_parameter_cto(value)?; self.params.cto = value; self.mark_param_given(511); Ok(()) }
            "ctl" => { validate_parameter_ctl(value)?; self.params.ctl = value; self.mark_param_given(512); Ok(()) }
            "ctlexp" => { validate_parameter_ctlexp(value)?; self.params.ctlexp = value; self.mark_param_given(513); Ok(()) }
            "ctw" => { validate_parameter_ctw(value)?; self.params.ctw = value; self.mark_param_given(514); Ok(()) }
            "ctlw" => { validate_parameter_ctlw(value)?; self.params.ctlw = value; self.mark_param_given(515); Ok(()) }
            "ctgo" => { validate_parameter_ctgo(value)?; self.params.ctgo = value; self.mark_param_given(516); Ok(()) }
            "ctbo" => { validate_parameter_ctbo(value)?; self.params.ctbo = value; self.mark_param_given(517); Ok(()) }
            "stcto" => { validate_parameter_stcto(value)?; self.params.stcto = value; self.mark_param_given(518); Ok(()) }
            "cfl" => { validate_parameter_cfl(value)?; self.params.cfl = value; self.mark_param_given(519); Ok(()) }
            "cflexp" => { validate_parameter_cflexp(value)?; self.params.cflexp = value; self.mark_param_given(520); Ok(()) }
            "cfw" => { validate_parameter_cfw(value)?; self.params.cfw = value; self.mark_param_given(521); Ok(()) }
            "cfdo" => { validate_parameter_cfdo(value)?; self.params.cfdo = value; self.mark_param_given(522); Ok(()) }
            "cfbo" => { validate_parameter_cfbo(value)?; self.params.cfbo = value; self.mark_param_given(523); Ok(()) }
            "pscel" => { validate_parameter_pscel(value)?; self.params.pscel = value; self.mark_param_given(524); Ok(()) }
            "pscelexp" => { validate_parameter_pscelexp(value)?; self.params.pscelexp = value; self.mark_param_given(525); Ok(()) }
            "pscew" => { validate_parameter_pscew(value)?; self.params.pscew = value; self.mark_param_given(526); Ok(()) }
            "pscebo" => { validate_parameter_pscebo(value)?; self.params.pscebo = value; self.mark_param_given(527); Ok(()) }
            "pscedo" => { validate_parameter_pscedo(value)?; self.params.pscedo = value; self.mark_param_given(528); Ok(()) }
            "uo" => { validate_parameter_uo(value)?; self.params.uo = value; self.mark_param_given(529); Ok(()) }
            "fbet1" => { validate_parameter_fbet1(value)?; self.params.fbet1 = value; self.mark_param_given(530); Ok(()) }
            "fbet1w" => { validate_parameter_fbet1w(value)?; self.params.fbet1w = value; self.mark_param_given(531); Ok(()) }
            "lp1" => { validate_parameter_lp1(value)?; self.params.lp1 = value; self.mark_param_given(532); Ok(()) }
            "lp1w" => { validate_parameter_lp1w(value)?; self.params.lp1w = value; self.mark_param_given(533); Ok(()) }
            "fbet2" => { validate_parameter_fbet2(value)?; self.params.fbet2 = value; self.mark_param_given(534); Ok(()) }
            "lp2" => { validate_parameter_lp2(value)?; self.params.lp2 = value; self.mark_param_given(535); Ok(()) }
            "betw1" => { validate_parameter_betw1(value)?; self.params.betw1 = value; self.mark_param_given(536); Ok(()) }
            "betw2" => { validate_parameter_betw2(value)?; self.params.betw2 = value; self.mark_param_given(537); Ok(()) }
            "wbet" => { validate_parameter_wbet(value)?; self.params.wbet = value; self.mark_param_given(538); Ok(()) }
            "stbeto" => { validate_parameter_stbeto(value)?; self.params.stbeto = value; self.mark_param_given(539); Ok(()) }
            "stbetl" => { validate_parameter_stbetl(value)?; self.params.stbetl = value; self.mark_param_given(540); Ok(()) }
            "stbetw" => { validate_parameter_stbetw(value)?; self.params.stbetw = value; self.mark_param_given(541); Ok(()) }
            "stbetlw" => { validate_parameter_stbetlw(value)?; self.params.stbetlw = value; self.mark_param_given(542); Ok(()) }
            "mueo" => { validate_parameter_mueo(value)?; self.params.mueo = value; self.mark_param_given(543); Ok(()) }
            "muew" => { validate_parameter_muew(value)?; self.params.muew = value; self.mark_param_given(544); Ok(()) }
            "stmueo" => { validate_parameter_stmueo(value)?; self.params.stmueo = value; self.mark_param_given(545); Ok(()) }
            "themuo" => { validate_parameter_themuo(value)?; self.params.themuo = value; self.mark_param_given(546); Ok(()) }
            "stthemuo" => { validate_parameter_stthemuo(value)?; self.params.stthemuo = value; self.mark_param_given(547); Ok(()) }
            "cso" => { validate_parameter_cso(value)?; self.params.cso = value; self.mark_param_given(548); Ok(()) }
            "csl" => { validate_parameter_csl(value)?; self.params.csl = value; self.mark_param_given(549); Ok(()) }
            "cslexp" => { validate_parameter_cslexp(value)?; self.params.cslexp = value; self.mark_param_given(550); Ok(()) }
            "csw" => { validate_parameter_csw(value)?; self.params.csw = value; self.mark_param_given(551); Ok(()) }
            "cslw" => { validate_parameter_cslw(value)?; self.params.cslw = value; self.mark_param_given(552); Ok(()) }
            "stcso" => { validate_parameter_stcso(value)?; self.params.stcso = value; self.mark_param_given(553); Ok(()) }
            "thecso" => { validate_parameter_thecso(value)?; self.params.thecso = value; self.mark_param_given(554); Ok(()) }
            "stthecso" => { validate_parameter_stthecso(value)?; self.params.stthecso = value; self.mark_param_given(555); Ok(()) }
            "xcoro" => { validate_parameter_xcoro(value)?; self.params.xcoro = value; self.mark_param_given(556); Ok(()) }
            "xcorl" => { validate_parameter_xcorl(value)?; self.params.xcorl = value; self.mark_param_given(557); Ok(()) }
            "xcorw" => { validate_parameter_xcorw(value)?; self.params.xcorw = value; self.mark_param_given(558); Ok(()) }
            "xcorlw" => { validate_parameter_xcorlw(value)?; self.params.xcorlw = value; self.mark_param_given(559); Ok(()) }
            "stxcoro" => { validate_parameter_stxcoro(value)?; self.params.stxcoro = value; self.mark_param_given(560); Ok(()) }
            "fetao" => { validate_parameter_fetao(value)?; self.params.fetao = value; self.mark_param_given(561); Ok(()) }
            "rsw1" => { validate_parameter_rsw1(value)?; self.params.rsw1 = value; self.mark_param_given(562); Ok(()) }
            "rsw2" => { validate_parameter_rsw2(value)?; self.params.rsw2 = value; self.mark_param_given(563); Ok(()) }
            "strso" => { validate_parameter_strso(value)?; self.params.strso = value; self.mark_param_given(564); Ok(()) }
            "rsbo" => { validate_parameter_rsbo(value)?; self.params.rsbo = value; self.mark_param_given(565); Ok(()) }
            "rsgo" => { validate_parameter_rsgo(value)?; self.params.rsgo = value; self.mark_param_given(566); Ok(()) }
            "thesato" => { validate_parameter_thesato(value)?; self.params.thesato = value; self.mark_param_given(567); Ok(()) }
            "thesatl" => { validate_parameter_thesatl(value)?; self.params.thesatl = value; self.mark_param_given(568); Ok(()) }
            "thesatlexp" => { validate_parameter_thesatlexp(value)?; self.params.thesatlexp = value; self.mark_param_given(569); Ok(()) }
            "thesatw" => { validate_parameter_thesatw(value)?; self.params.thesatw = value; self.mark_param_given(570); Ok(()) }
            "thesatlw" => { validate_parameter_thesatlw(value)?; self.params.thesatlw = value; self.mark_param_given(571); Ok(()) }
            "stthesato" => { validate_parameter_stthesato(value)?; self.params.stthesato = value; self.mark_param_given(572); Ok(()) }
            "stthesatl" => { validate_parameter_stthesatl(value)?; self.params.stthesatl = value; self.mark_param_given(573); Ok(()) }
            "stthesatw" => { validate_parameter_stthesatw(value)?; self.params.stthesatw = value; self.mark_param_given(574); Ok(()) }
            "stthesatlw" => { validate_parameter_stthesatlw(value)?; self.params.stthesatlw = value; self.mark_param_given(575); Ok(()) }
            "thesatbo" => { validate_parameter_thesatbo(value)?; self.params.thesatbo = value; self.mark_param_given(576); Ok(()) }
            "thesatgo" => { validate_parameter_thesatgo(value)?; self.params.thesatgo = value; self.mark_param_given(577); Ok(()) }
            "axo" => { validate_parameter_axo(value)?; self.params.axo = value; self.mark_param_given(578); Ok(()) }
            "axl" => { validate_parameter_axl(value)?; self.params.axl = value; self.mark_param_given(579); Ok(()) }
            "alpl" => { validate_parameter_alpl(value)?; self.params.alpl = value; self.mark_param_given(580); Ok(()) }
            "alplexp" => { validate_parameter_alplexp(value)?; self.params.alplexp = value; self.mark_param_given(581); Ok(()) }
            "alpw" => { validate_parameter_alpw(value)?; self.params.alpw = value; self.mark_param_given(582); Ok(()) }
            "alp1l1" => { validate_parameter_alp1l1(value)?; self.params.alp1l1 = value; self.mark_param_given(583); Ok(()) }
            "alp1lexp" => { validate_parameter_alp1lexp(value)?; self.params.alp1lexp = value; self.mark_param_given(584); Ok(()) }
            "alp1l2" => { validate_parameter_alp1l2(value)?; self.params.alp1l2 = value; self.mark_param_given(585); Ok(()) }
            "alp1w" => { validate_parameter_alp1w(value)?; self.params.alp1w = value; self.mark_param_given(586); Ok(()) }
            "alp2l1" => { validate_parameter_alp2l1(value)?; self.params.alp2l1 = value; self.mark_param_given(587); Ok(()) }
            "alp2lexp" => { validate_parameter_alp2lexp(value)?; self.params.alp2lexp = value; self.mark_param_given(588); Ok(()) }
            "alp2l2" => { validate_parameter_alp2l2(value)?; self.params.alp2l2 = value; self.mark_param_given(589); Ok(()) }
            "alp2w" => { validate_parameter_alp2w(value)?; self.params.alp2w = value; self.mark_param_given(590); Ok(()) }
            "vpo" => { validate_parameter_vpo(value)?; self.params.vpo = value; self.mark_param_given(591); Ok(()) }
            "a1o" => { validate_parameter_a1o(value)?; self.params.a1o = value; self.mark_param_given(592); Ok(()) }
            "a1l" => { validate_parameter_a1l(value)?; self.params.a1l = value; self.mark_param_given(593); Ok(()) }
            "a1w" => { validate_parameter_a1w(value)?; self.params.a1w = value; self.mark_param_given(594); Ok(()) }
            "a2o" => { validate_parameter_a2o(value)?; self.params.a2o = value; self.mark_param_given(595); Ok(()) }
            "sta2o" => { validate_parameter_sta2o(value)?; self.params.sta2o = value; self.mark_param_given(596); Ok(()) }
            "a3o" => { validate_parameter_a3o(value)?; self.params.a3o = value; self.mark_param_given(597); Ok(()) }
            "a3l" => { validate_parameter_a3l(value)?; self.params.a3l = value; self.mark_param_given(598); Ok(()) }
            "a3w" => { validate_parameter_a3w(value)?; self.params.a3w = value; self.mark_param_given(599); Ok(()) }
            "a4o" => { validate_parameter_a4o(value)?; self.params.a4o = value; self.mark_param_given(600); Ok(()) }
            "a4l" => { validate_parameter_a4l(value)?; self.params.a4l = value; self.mark_param_given(601); Ok(()) }
            "a4w" => { validate_parameter_a4w(value)?; self.params.a4w = value; self.mark_param_given(602); Ok(()) }
            "gcoo" => { validate_parameter_gcoo(value)?; self.params.gcoo = value; self.mark_param_given(603); Ok(()) }
            "iginvlw" => { validate_parameter_iginvlw(value)?; self.params.iginvlw = value; self.mark_param_given(604); Ok(()) }
            "igovw" => { validate_parameter_igovw(value)?; self.params.igovw = value; self.mark_param_given(605); Ok(()) }
            "igovdw" => { validate_parameter_igovdw(value)?; self.params.igovdw = value; self.mark_param_given(606); Ok(()) }
            "stigo" => { validate_parameter_stigo(value)?; self.params.stigo = value; self.mark_param_given(607); Ok(()) }
            "gc2o" => { validate_parameter_gc2o(value)?; self.params.gc2o = value; self.mark_param_given(608); Ok(()) }
            "gc3o" => { validate_parameter_gc3o(value)?; self.params.gc3o = value; self.mark_param_given(609); Ok(()) }
            "chibo" => { validate_parameter_chibo(value)?; self.params.chibo = value; self.mark_param_given(610); Ok(()) }
            "agidlw" => { validate_parameter_agidlw(value)?; self.params.agidlw = value; self.mark_param_given(611); Ok(()) }
            "agidldw" => { validate_parameter_agidldw(value)?; self.params.agidldw = value; self.mark_param_given(612); Ok(()) }
            "bgidlo" => { validate_parameter_bgidlo(value)?; self.params.bgidlo = value; self.mark_param_given(613); Ok(()) }
            "bgidldo" => { validate_parameter_bgidldo(value)?; self.params.bgidldo = value; self.mark_param_given(614); Ok(()) }
            "stbgidlo" => { validate_parameter_stbgidlo(value)?; self.params.stbgidlo = value; self.mark_param_given(615); Ok(()) }
            "stbgidldo" => { validate_parameter_stbgidldo(value)?; self.params.stbgidldo = value; self.mark_param_given(616); Ok(()) }
            "cgidlo" => { validate_parameter_cgidlo(value)?; self.params.cgidlo = value; self.mark_param_given(617); Ok(()) }
            "cgidldo" => { validate_parameter_cgidldo(value)?; self.params.cgidldo = value; self.mark_param_given(618); Ok(()) }
            "cgbovl" => { validate_parameter_cgbovl(value)?; self.params.cgbovl = value; self.mark_param_given(619); Ok(()) }
            "cfrw" => { validate_parameter_cfrw(value)?; self.params.cfrw = value; self.mark_param_given(620); Ok(()) }
            "cfrdw" => { validate_parameter_cfrdw(value)?; self.params.cfrdw = value; self.mark_param_given(621); Ok(()) }
            "fnto" => { validate_parameter_fnto(value)?; self.params.fnto = value; self.mark_param_given(622); Ok(()) }
            "fntexcl" => { validate_parameter_fntexcl(value)?; self.params.fntexcl = value; self.mark_param_given(623); Ok(()) }
            "nfalw" => { validate_parameter_nfalw(value)?; self.params.nfalw = value; self.mark_param_given(624); Ok(()) }
            "nfblw" => { validate_parameter_nfblw(value)?; self.params.nfblw = value; self.mark_param_given(625); Ok(()) }
            "nfclw" => { validate_parameter_nfclw(value)?; self.params.nfclw = value; self.mark_param_given(626); Ok(()) }
            "efo" => { validate_parameter_efo(value)?; self.params.efo = value; self.mark_param_given(627); Ok(()) }
            "lintnoi" => { validate_parameter_lintnoi(value)?; self.params.lintnoi = value; self.mark_param_given(628); Ok(()) }
            "alpnoi" => { validate_parameter_alpnoi(value)?; self.params.alpnoi = value; self.mark_param_given(629); Ok(()) }
            "wedge" => { validate_parameter_wedge(value)?; self.params.wedge = value; self.mark_param_given(630); Ok(()) }
            "wedgew" => { validate_parameter_wedgew(value)?; self.params.wedgew = value; self.mark_param_given(631); Ok(()) }
            "vfbedgeo" => { validate_parameter_vfbedgeo(value)?; self.params.vfbedgeo = value; self.mark_param_given(632); Ok(()) }
            "stvfbedgeo" => { validate_parameter_stvfbedgeo(value)?; self.params.stvfbedgeo = value; self.mark_param_given(633); Ok(()) }
            "stvfbedgel" => { validate_parameter_stvfbedgel(value)?; self.params.stvfbedgel = value; self.mark_param_given(634); Ok(()) }
            "stvfbedgew" => { validate_parameter_stvfbedgew(value)?; self.params.stvfbedgew = value; self.mark_param_given(635); Ok(()) }
            "stvfbedgelw" => { validate_parameter_stvfbedgelw(value)?; self.params.stvfbedgelw = value; self.mark_param_given(636); Ok(()) }
            "dphibedgeo" => { validate_parameter_dphibedgeo(value)?; self.params.dphibedgeo = value; self.mark_param_given(637); Ok(()) }
            "dphibedgel" => { validate_parameter_dphibedgel(value)?; self.params.dphibedgel = value; self.mark_param_given(638); Ok(()) }
            "dphibedgelexp" => { validate_parameter_dphibedgelexp(value)?; self.params.dphibedgelexp = value; self.mark_param_given(639); Ok(()) }
            "dphibedgew" => { validate_parameter_dphibedgew(value)?; self.params.dphibedgew = value; self.mark_param_given(640); Ok(()) }
            "dphibedgelw" => { validate_parameter_dphibedgelw(value)?; self.params.dphibedgelw = value; self.mark_param_given(641); Ok(()) }
            "nsubedgeo" => { validate_parameter_nsubedgeo(value)?; self.params.nsubedgeo = value; self.mark_param_given(642); Ok(()) }
            "nsubedgel" => { validate_parameter_nsubedgel(value)?; self.params.nsubedgel = value; self.mark_param_given(643); Ok(()) }
            "nsubedgelexp" => { validate_parameter_nsubedgelexp(value)?; self.params.nsubedgelexp = value; self.mark_param_given(644); Ok(()) }
            "nsubedgew" => { validate_parameter_nsubedgew(value)?; self.params.nsubedgew = value; self.mark_param_given(645); Ok(()) }
            "nsubedgelw" => { validate_parameter_nsubedgelw(value)?; self.params.nsubedgelw = value; self.mark_param_given(646); Ok(()) }
            "ctedgeo" => { validate_parameter_ctedgeo(value)?; self.params.ctedgeo = value; self.mark_param_given(647); Ok(()) }
            "ctedgel" => { validate_parameter_ctedgel(value)?; self.params.ctedgel = value; self.mark_param_given(648); Ok(()) }
            "ctedgelexp" => { validate_parameter_ctedgelexp(value)?; self.params.ctedgelexp = value; self.mark_param_given(649); Ok(()) }
            "fbetedge" => { validate_parameter_fbetedge(value)?; self.params.fbetedge = value; self.mark_param_given(650); Ok(()) }
            "lpedge" => { validate_parameter_lpedge(value)?; self.params.lpedge = value; self.mark_param_given(651); Ok(()) }
            "betedgew" => { validate_parameter_betedgew(value)?; self.params.betedgew = value; self.mark_param_given(652); Ok(()) }
            "stbetedgeo" => { validate_parameter_stbetedgeo(value)?; self.params.stbetedgeo = value; self.mark_param_given(653); Ok(()) }
            "stbetedgel" => { validate_parameter_stbetedgel(value)?; self.params.stbetedgel = value; self.mark_param_given(654); Ok(()) }
            "stbetedgew" => { validate_parameter_stbetedgew(value)?; self.params.stbetedgew = value; self.mark_param_given(655); Ok(()) }
            "stbetedgelw" => { validate_parameter_stbetedgelw(value)?; self.params.stbetedgelw = value; self.mark_param_given(656); Ok(()) }
            "psceedgel" => { validate_parameter_psceedgel(value)?; self.params.psceedgel = value; self.mark_param_given(657); Ok(()) }
            "psceedgelexp" => { validate_parameter_psceedgelexp(value)?; self.params.psceedgelexp = value; self.mark_param_given(658); Ok(()) }
            "psceedgew" => { validate_parameter_psceedgew(value)?; self.params.psceedgew = value; self.mark_param_given(659); Ok(()) }
            "pscebedgeo" => { validate_parameter_pscebedgeo(value)?; self.params.pscebedgeo = value; self.mark_param_given(660); Ok(()) }
            "pscededgeo" => { validate_parameter_pscededgeo(value)?; self.params.pscededgeo = value; self.mark_param_given(661); Ok(()) }
            "cfedgel" => { validate_parameter_cfedgel(value)?; self.params.cfedgel = value; self.mark_param_given(662); Ok(()) }
            "cfedgelexp" => { validate_parameter_cfedgelexp(value)?; self.params.cfedgelexp = value; self.mark_param_given(663); Ok(()) }
            "cfedgew" => { validate_parameter_cfedgew(value)?; self.params.cfedgew = value; self.mark_param_given(664); Ok(()) }
            "cfdedgeo" => { validate_parameter_cfdedgeo(value)?; self.params.cfdedgeo = value; self.mark_param_given(665); Ok(()) }
            "cfbedgeo" => { validate_parameter_cfbedgeo(value)?; self.params.cfbedgeo = value; self.mark_param_given(666); Ok(()) }
            "fntedgeo" => { validate_parameter_fntedgeo(value)?; self.params.fntedgeo = value; self.mark_param_given(667); Ok(()) }
            "nfaedgelw" => { validate_parameter_nfaedgelw(value)?; self.params.nfaedgelw = value; self.mark_param_given(668); Ok(()) }
            "nfbedgelw" => { validate_parameter_nfbedgelw(value)?; self.params.nfbedgelw = value; self.mark_param_given(669); Ok(()) }
            "nfcedgelw" => { validate_parameter_nfcedgelw(value)?; self.params.nfcedgelw = value; self.mark_param_given(670); Ok(()) }
            "efedgeo" => { validate_parameter_efedgeo(value)?; self.params.efedgeo = value; self.mark_param_given(671); Ok(()) }
            "kvthoweo" => { validate_parameter_kvthoweo(value)?; self.params.kvthoweo = value; self.mark_param_given(672); Ok(()) }
            "kvthowel" => { validate_parameter_kvthowel(value)?; self.params.kvthowel = value; self.mark_param_given(673); Ok(()) }
            "kvthowew" => { validate_parameter_kvthowew(value)?; self.params.kvthowew = value; self.mark_param_given(674); Ok(()) }
            "kvthowelw" => { validate_parameter_kvthowelw(value)?; self.params.kvthowelw = value; self.mark_param_given(675); Ok(()) }
            "kuoweo" => { validate_parameter_kuoweo(value)?; self.params.kuoweo = value; self.mark_param_given(676); Ok(()) }
            "kuowel" => { validate_parameter_kuowel(value)?; self.params.kuowel = value; self.mark_param_given(677); Ok(()) }
            "kuowew" => { validate_parameter_kuowew(value)?; self.params.kuowew = value; self.mark_param_given(678); Ok(()) }
            "kuowelw" => { validate_parameter_kuowelw(value)?; self.params.kuowelw = value; self.mark_param_given(679); Ok(()) }
            "rgo" => { validate_parameter_rgo(value)?; self.params.rgo = value; self.mark_param_given(680); Ok(()) }
            "rint" => { validate_parameter_rint(value)?; self.params.rint = value; self.mark_param_given(681); Ok(()) }
            "rvpoly" => { validate_parameter_rvpoly(value)?; self.params.rvpoly = value; self.mark_param_given(682); Ok(()) }
            "rshg" => { validate_parameter_rshg(value)?; self.params.rshg = value; self.mark_param_given(683); Ok(()) }
            "dlsil" => { validate_parameter_dlsil(value)?; self.params.dlsil = value; self.mark_param_given(684); Ok(()) }
            "rsh" => { validate_parameter_rsh(value)?; self.params.rsh = value; self.mark_param_given(685); Ok(()) }
            "rshd" => { validate_parameter_rshd(value)?; self.params.rshd = value; self.mark_param_given(686); Ok(()) }
            "rbulko" => { validate_parameter_rbulko(value)?; self.params.rbulko = value; self.mark_param_given(687); Ok(()) }
            "rwello" => { validate_parameter_rwello(value)?; self.params.rwello = value; self.mark_param_given(688); Ok(()) }
            "rjunso" => { validate_parameter_rjunso(value)?; self.params.rjunso = value; self.mark_param_given(689); Ok(()) }
            "rjundo" => { validate_parameter_rjundo(value)?; self.params.rjundo = value; self.mark_param_given(690); Ok(()) }
            "rtho" => { validate_parameter_rtho(value)?; self.params.rtho = value; self.mark_param_given(691); Ok(()) }
            "rthw1" => { validate_parameter_rthw1(value)?; self.params.rthw1 = value; self.mark_param_given(692); Ok(()) }
            "rthw2" => { validate_parameter_rthw2(value)?; self.params.rthw2 = value; self.mark_param_given(693); Ok(()) }
            "rthlw" => { validate_parameter_rthlw(value)?; self.params.rthlw = value; self.mark_param_given(694); Ok(()) }
            "ctho" => { validate_parameter_ctho(value)?; self.params.ctho = value; self.mark_param_given(695); Ok(()) }
            "cthw1" => { validate_parameter_cthw1(value)?; self.params.cthw1 = value; self.mark_param_given(696); Ok(()) }
            "cthw2" => { validate_parameter_cthw2(value)?; self.params.cthw2 = value; self.mark_param_given(697); Ok(()) }
            "cthlw" => { validate_parameter_cthlw(value)?; self.params.cthlw = value; self.mark_param_given(698); Ok(()) }
            "strtho" => { validate_parameter_strtho(value)?; self.params.strtho = value; self.mark_param_given(699); Ok(()) }
            "saref" => { validate_parameter_saref(value)?; self.params.saref = value; self.mark_param_given(700); Ok(()) }
            "sbref" => { validate_parameter_sbref(value)?; self.params.sbref = value; self.mark_param_given(701); Ok(()) }
            "wlod" => { validate_parameter_wlod(value)?; self.params.wlod = value; self.mark_param_given(702); Ok(()) }
            "kuo" => { validate_parameter_kuo(value)?; self.params.kuo = value; self.mark_param_given(703); Ok(()) }
            "kvsat" => { validate_parameter_kvsat(value)?; self.params.kvsat = value; self.mark_param_given(704); Ok(()) }
            "tkuo" => { validate_parameter_tkuo(value)?; self.params.tkuo = value; self.mark_param_given(705); Ok(()) }
            "lkuo" => { validate_parameter_lkuo(value)?; self.params.lkuo = value; self.mark_param_given(706); Ok(()) }
            "wkuo" => { validate_parameter_wkuo(value)?; self.params.wkuo = value; self.mark_param_given(707); Ok(()) }
            "pkuo" => { validate_parameter_pkuo(value)?; self.params.pkuo = value; self.mark_param_given(708); Ok(()) }
            "llodkuo" => { validate_parameter_llodkuo(value)?; self.params.llodkuo = value; self.mark_param_given(709); Ok(()) }
            "wlodkuo" => { validate_parameter_wlodkuo(value)?; self.params.wlodkuo = value; self.mark_param_given(710); Ok(()) }
            "kvtho" => { validate_parameter_kvtho(value)?; self.params.kvtho = value; self.mark_param_given(711); Ok(()) }
            "lkvtho" => { validate_parameter_lkvtho(value)?; self.params.lkvtho = value; self.mark_param_given(712); Ok(()) }
            "wkvtho" => { validate_parameter_wkvtho(value)?; self.params.wkvtho = value; self.mark_param_given(713); Ok(()) }
            "pkvtho" => { validate_parameter_pkvtho(value)?; self.params.pkvtho = value; self.mark_param_given(714); Ok(()) }
            "llodvth" => { validate_parameter_llodvth(value)?; self.params.llodvth = value; self.mark_param_given(715); Ok(()) }
            "wlodvth" => { validate_parameter_wlodvth(value)?; self.params.wlodvth = value; self.mark_param_given(716); Ok(()) }
            "stetao" => { validate_parameter_stetao(value)?; self.params.stetao = value; self.mark_param_given(717); Ok(()) }
            "lodetao" => { validate_parameter_lodetao(value)?; self.params.lodetao = value; self.mark_param_given(718); Ok(()) }
            "scref" => { validate_parameter_scref(value)?; self.params.scref = value; self.mark_param_given(719); Ok(()) }
            "web" => { validate_parameter_web(value)?; self.params.web = value; self.mark_param_given(720); Ok(()) }
            "wec" => { validate_parameter_wec(value)?; self.params.wec = value; self.mark_param_given(721); Ok(()) }
            "swsoa" => { validate_parameter_swsoa(value)?; self.params.swsoa = value; self.mark_param_given(722); Ok(()) }
            "vgs_max" => { validate_parameter_vgs_max(value)?; self.params.vgs_max = value; self.mark_param_given(723); Ok(()) }
            "vgd_max" => { validate_parameter_vgd_max(value)?; self.params.vgd_max = value; self.mark_param_given(724); Ok(()) }
            "vgb_max" => { validate_parameter_vgb_max(value)?; self.params.vgb_max = value; self.mark_param_given(725); Ok(()) }
            "vds_max" => { validate_parameter_vds_max(value)?; self.params.vds_max = value; self.mark_param_given(726); Ok(()) }
            "vdb_max" => { validate_parameter_vdb_max(value)?; self.params.vdb_max = value; self.mark_param_given(727); Ok(()) }
            "vsb_max" => { validate_parameter_vsb_max(value)?; self.params.vsb_max = value; self.mark_param_given(728); Ok(()) }
            "imax" => { validate_parameter_imax(value)?; self.params.imax = value; self.mark_param_given(729); Ok(()) }
            "trj" => { validate_parameter_trj(value)?; self.params.trj = value; self.mark_param_given(730); Ok(()) }
            "frev" => { validate_parameter_frev(value)?; self.params.frev = value; self.mark_param_given(731); Ok(()) }
            "cjorbot" => { validate_parameter_cjorbot(value)?; self.params.cjorbot = value; self.mark_param_given(732); Ok(()) }
            "cjorsti" => { validate_parameter_cjorsti(value)?; self.params.cjorsti = value; self.mark_param_given(733); Ok(()) }
            "cjorgat" => { validate_parameter_cjorgat(value)?; self.params.cjorgat = value; self.mark_param_given(734); Ok(()) }
            "vbirbot" => { validate_parameter_vbirbot(value)?; self.params.vbirbot = value; self.mark_param_given(735); Ok(()) }
            "vbirsti" => { validate_parameter_vbirsti(value)?; self.params.vbirsti = value; self.mark_param_given(736); Ok(()) }
            "vbirgat" => { validate_parameter_vbirgat(value)?; self.params.vbirgat = value; self.mark_param_given(737); Ok(()) }
            "pbot" => { validate_parameter_pbot(value)?; self.params.pbot = value; self.mark_param_given(738); Ok(()) }
            "psti" => { validate_parameter_psti(value)?; self.params.psti = value; self.mark_param_given(739); Ok(()) }
            "pgat" => { validate_parameter_pgat(value)?; self.params.pgat = value; self.mark_param_given(740); Ok(()) }
            "phigbot" => { validate_parameter_phigbot(value)?; self.params.phigbot = value; self.mark_param_given(741); Ok(()) }
            "phigsti" => { validate_parameter_phigsti(value)?; self.params.phigsti = value; self.mark_param_given(742); Ok(()) }
            "phiggat" => { validate_parameter_phiggat(value)?; self.params.phiggat = value; self.mark_param_given(743); Ok(()) }
            "idsatrbot" => { validate_parameter_idsatrbot(value)?; self.params.idsatrbot = value; self.mark_param_given(744); Ok(()) }
            "idsatrsti" => { validate_parameter_idsatrsti(value)?; self.params.idsatrsti = value; self.mark_param_given(745); Ok(()) }
            "idsatrgat" => { validate_parameter_idsatrgat(value)?; self.params.idsatrgat = value; self.mark_param_given(746); Ok(()) }
            "csrhbot" => { validate_parameter_csrhbot(value)?; self.params.csrhbot = value; self.mark_param_given(747); Ok(()) }
            "csrhsti" => { validate_parameter_csrhsti(value)?; self.params.csrhsti = value; self.mark_param_given(748); Ok(()) }
            "csrhgat" => { validate_parameter_csrhgat(value)?; self.params.csrhgat = value; self.mark_param_given(749); Ok(()) }
            "xjunsti" => { validate_parameter_xjunsti(value)?; self.params.xjunsti = value; self.mark_param_given(750); Ok(()) }
            "xjungat" => { validate_parameter_xjungat(value)?; self.params.xjungat = value; self.mark_param_given(751); Ok(()) }
            "ctatbot" => { validate_parameter_ctatbot(value)?; self.params.ctatbot = value; self.mark_param_given(752); Ok(()) }
            "ctatsti" => { validate_parameter_ctatsti(value)?; self.params.ctatsti = value; self.mark_param_given(753); Ok(()) }
            "ctatgat" => { validate_parameter_ctatgat(value)?; self.params.ctatgat = value; self.mark_param_given(754); Ok(()) }
            "mefftatbot" => { validate_parameter_mefftatbot(value)?; self.params.mefftatbot = value; self.mark_param_given(755); Ok(()) }
            "mefftatsti" => { validate_parameter_mefftatsti(value)?; self.params.mefftatsti = value; self.mark_param_given(756); Ok(()) }
            "mefftatgat" => { validate_parameter_mefftatgat(value)?; self.params.mefftatgat = value; self.mark_param_given(757); Ok(()) }
            "cbbtbot" => { validate_parameter_cbbtbot(value)?; self.params.cbbtbot = value; self.mark_param_given(758); Ok(()) }
            "cbbtsti" => { validate_parameter_cbbtsti(value)?; self.params.cbbtsti = value; self.mark_param_given(759); Ok(()) }
            "cbbtgat" => { validate_parameter_cbbtgat(value)?; self.params.cbbtgat = value; self.mark_param_given(760); Ok(()) }
            "fbbtrbot" => { validate_parameter_fbbtrbot(value)?; self.params.fbbtrbot = value; self.mark_param_given(761); Ok(()) }
            "fbbtrsti" => { validate_parameter_fbbtrsti(value)?; self.params.fbbtrsti = value; self.mark_param_given(762); Ok(()) }
            "fbbtrgat" => { validate_parameter_fbbtrgat(value)?; self.params.fbbtrgat = value; self.mark_param_given(763); Ok(()) }
            "stfbbtbot" => { validate_parameter_stfbbtbot(value)?; self.params.stfbbtbot = value; self.mark_param_given(764); Ok(()) }
            "stfbbtsti" => { validate_parameter_stfbbtsti(value)?; self.params.stfbbtsti = value; self.mark_param_given(765); Ok(()) }
            "stfbbtgat" => { validate_parameter_stfbbtgat(value)?; self.params.stfbbtgat = value; self.mark_param_given(766); Ok(()) }
            "vbrbot" => { validate_parameter_vbrbot(value)?; self.params.vbrbot = value; self.mark_param_given(767); Ok(()) }
            "vbrsti" => { validate_parameter_vbrsti(value)?; self.params.vbrsti = value; self.mark_param_given(768); Ok(()) }
            "vbrgat" => { validate_parameter_vbrgat(value)?; self.params.vbrgat = value; self.mark_param_given(769); Ok(()) }
            "pbrbot" => { validate_parameter_pbrbot(value)?; self.params.pbrbot = value; self.mark_param_given(770); Ok(()) }
            "pbrsti" => { validate_parameter_pbrsti(value)?; self.params.pbrsti = value; self.mark_param_given(771); Ok(()) }
            "pbrgat" => { validate_parameter_pbrgat(value)?; self.params.pbrgat = value; self.mark_param_given(772); Ok(()) }
            "cjorbotd" => { validate_parameter_cjorbotd(value)?; self.params.cjorbotd = value; self.mark_param_given(773); Ok(()) }
            "cjorstid" => { validate_parameter_cjorstid(value)?; self.params.cjorstid = value; self.mark_param_given(774); Ok(()) }
            "cjorgatd" => { validate_parameter_cjorgatd(value)?; self.params.cjorgatd = value; self.mark_param_given(775); Ok(()) }
            "vbirbotd" => { validate_parameter_vbirbotd(value)?; self.params.vbirbotd = value; self.mark_param_given(776); Ok(()) }
            "vbirstid" => { validate_parameter_vbirstid(value)?; self.params.vbirstid = value; self.mark_param_given(777); Ok(()) }
            "vbirgatd" => { validate_parameter_vbirgatd(value)?; self.params.vbirgatd = value; self.mark_param_given(778); Ok(()) }
            "pbotd" => { validate_parameter_pbotd(value)?; self.params.pbotd = value; self.mark_param_given(779); Ok(()) }
            "pstid" => { validate_parameter_pstid(value)?; self.params.pstid = value; self.mark_param_given(780); Ok(()) }
            "pgatd" => { validate_parameter_pgatd(value)?; self.params.pgatd = value; self.mark_param_given(781); Ok(()) }
            "phigbotd" => { validate_parameter_phigbotd(value)?; self.params.phigbotd = value; self.mark_param_given(782); Ok(()) }
            "phigstid" => { validate_parameter_phigstid(value)?; self.params.phigstid = value; self.mark_param_given(783); Ok(()) }
            "phiggatd" => { validate_parameter_phiggatd(value)?; self.params.phiggatd = value; self.mark_param_given(784); Ok(()) }
            "idsatrbotd" => { validate_parameter_idsatrbotd(value)?; self.params.idsatrbotd = value; self.mark_param_given(785); Ok(()) }
            "idsatrstid" => { validate_parameter_idsatrstid(value)?; self.params.idsatrstid = value; self.mark_param_given(786); Ok(()) }
            "idsatrgatd" => { validate_parameter_idsatrgatd(value)?; self.params.idsatrgatd = value; self.mark_param_given(787); Ok(()) }
            "csrhbotd" => { validate_parameter_csrhbotd(value)?; self.params.csrhbotd = value; self.mark_param_given(788); Ok(()) }
            "csrhstid" => { validate_parameter_csrhstid(value)?; self.params.csrhstid = value; self.mark_param_given(789); Ok(()) }
            "csrhgatd" => { validate_parameter_csrhgatd(value)?; self.params.csrhgatd = value; self.mark_param_given(790); Ok(()) }
            "xjunstid" => { validate_parameter_xjunstid(value)?; self.params.xjunstid = value; self.mark_param_given(791); Ok(()) }
            "xjungatd" => { validate_parameter_xjungatd(value)?; self.params.xjungatd = value; self.mark_param_given(792); Ok(()) }
            "ctatbotd" => { validate_parameter_ctatbotd(value)?; self.params.ctatbotd = value; self.mark_param_given(793); Ok(()) }
            "ctatstid" => { validate_parameter_ctatstid(value)?; self.params.ctatstid = value; self.mark_param_given(794); Ok(()) }
            "ctatgatd" => { validate_parameter_ctatgatd(value)?; self.params.ctatgatd = value; self.mark_param_given(795); Ok(()) }
            "mefftatbotd" => { validate_parameter_mefftatbotd(value)?; self.params.mefftatbotd = value; self.mark_param_given(796); Ok(()) }
            "mefftatstid" => { validate_parameter_mefftatstid(value)?; self.params.mefftatstid = value; self.mark_param_given(797); Ok(()) }
            "mefftatgatd" => { validate_parameter_mefftatgatd(value)?; self.params.mefftatgatd = value; self.mark_param_given(798); Ok(()) }
            "cbbtbotd" => { validate_parameter_cbbtbotd(value)?; self.params.cbbtbotd = value; self.mark_param_given(799); Ok(()) }
            "cbbtstid" => { validate_parameter_cbbtstid(value)?; self.params.cbbtstid = value; self.mark_param_given(800); Ok(()) }
            "cbbtgatd" => { validate_parameter_cbbtgatd(value)?; self.params.cbbtgatd = value; self.mark_param_given(801); Ok(()) }
            "fbbtrbotd" => { validate_parameter_fbbtrbotd(value)?; self.params.fbbtrbotd = value; self.mark_param_given(802); Ok(()) }
            "fbbtrstid" => { validate_parameter_fbbtrstid(value)?; self.params.fbbtrstid = value; self.mark_param_given(803); Ok(()) }
            "fbbtrgatd" => { validate_parameter_fbbtrgatd(value)?; self.params.fbbtrgatd = value; self.mark_param_given(804); Ok(()) }
            "stfbbtbotd" => { validate_parameter_stfbbtbotd(value)?; self.params.stfbbtbotd = value; self.mark_param_given(805); Ok(()) }
            "stfbbtstid" => { validate_parameter_stfbbtstid(value)?; self.params.stfbbtstid = value; self.mark_param_given(806); Ok(()) }
            "stfbbtgatd" => { validate_parameter_stfbbtgatd(value)?; self.params.stfbbtgatd = value; self.mark_param_given(807); Ok(()) }
            "vbrbotd" => { validate_parameter_vbrbotd(value)?; self.params.vbrbotd = value; self.mark_param_given(808); Ok(()) }
            "vbrstid" => { validate_parameter_vbrstid(value)?; self.params.vbrstid = value; self.mark_param_given(809); Ok(()) }
            "vbrgatd" => { validate_parameter_vbrgatd(value)?; self.params.vbrgatd = value; self.mark_param_given(810); Ok(()) }
            "pbrbotd" => { validate_parameter_pbrbotd(value)?; self.params.pbrbotd = value; self.mark_param_given(811); Ok(()) }
            "pbrstid" => { validate_parameter_pbrstid(value)?; self.params.pbrstid = value; self.mark_param_given(812); Ok(()) }
            "pbrgatd" => { validate_parameter_pbrgatd(value)?; self.params.pbrgatd = value; self.mark_param_given(813); Ok(()) }
            "swjunexp" => { validate_parameter_swjunexp(value)?; self.params.swjunexp = value; self.mark_param_given(814); Ok(()) }
            "vjunref" => { validate_parameter_vjunref(value)?; self.params.vjunref = value; self.mark_param_given(815); Ok(()) }
            "fjunq" => { validate_parameter_fjunq(value)?; self.params.fjunq = value; self.mark_param_given(816); Ok(()) }
            "vjunrefd" => { validate_parameter_vjunrefd(value)?; self.params.vjunrefd = value; self.mark_param_given(817); Ok(()) }
            "fjunqd" => { validate_parameter_fjunqd(value)?; self.params.fjunqd = value; self.mark_param_given(818); Ok(()) }
            "dta" => { validate_parameter_dta(value)?; self.params.dta = value; self.mark_param_given(819); Ok(()) }
            "trise" => { validate_parameter_dta(value)?; self.params.dta = value; self.mark_param_given(819); Ok(()) }
            _ => Err(format!("unknown parameter '{}' for generated Verilog-A model 'PSP103TVA'", name)),
        }
    }
