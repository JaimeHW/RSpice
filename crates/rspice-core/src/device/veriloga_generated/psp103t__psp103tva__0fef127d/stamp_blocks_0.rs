...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        scratch.values[418] = (if (self.params.vjunref > 0.5) { self.params.vjunref } else { 0.5 });
        ...
        if (scratch.values[1265] != 0.0) {
            scratch.values[584] = scratch.values[418];
            scratch.node_derivatives[584] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[584] = [0.0; Instance::BRANCH_COUNT];
        }
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if (!(scratch.values[1265] != 0.0)) {
            scratch.values[584] = (if (self.params.vjunrefd > 0.5) { self.params.vjunrefd } else { 0.5 });
            scratch.node_derivatives[584] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[584] = [0.0; Instance::BRANCH_COUNT];
        }
        ...
        scratch.values[428] = (1.772453850905516 * 0.29214664);

        scratch.values[429] = (((((-5.0) * 0.29214664) + 6.0) - ((scratch.values[428]) as f64).powf((-2.0))) / 3.0);

        scratch.values[430] = ((1.0 - 0.29214664) - scratch.values[429]);
        ...
        scratch.values[501] = (1.0 / (1.0 - ((scratch.values[500]) as f64).powf(scratch.values[414])));

        scratch.values[502] = (1.0 / (1.0 - ((scratch.values[500]) as f64).powf(scratch.values[415])));

        scratch.values[503] = (1.0 / (1.0 - ((scratch.values[500]) as f64).powf(scratch.values[416])));
        ...
        scratch.values[507] = (((-((scratch.values[501] * scratch.values[501]) * ((scratch.values[500]) as f64).powf((scratch.values[414] - 1.0)))) * scratch.values[414]) * scratch.values[504]);

        scratch.values[508] = (((-((scratch.values[502] * scratch.values[502]) * ((scratch.values[500]) as f64).powf((scratch.values[415] - 1.0)))) * scratch.values[415]) * scratch.values[505]);

        scratch.values[509] = (((-((scratch.values[503] * scratch.values[503]) * ((scratch.values[500]) as f64).powf((scratch.values[416] - 1.0)))) * scratch.values[416]) * scratch.values[506]);
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        scratch.store_ad(643, &AdValue::div_from_scalar(1.0, AdValue::sub_from_scalar(1.0, AdValue::pow_from_scalar(scratch.values[500], scratch.ad_value(581)))));

        scratch.store_ad(644, &AdValue::div_from_scalar(1.0, AdValue::sub_from_scalar(1.0, AdValue::pow_from_scalar(scratch.values[500], scratch.ad_value(582)))));

        scratch.store_ad(645, &AdValue::div_from_scalar(1.0, AdValue::sub_from_scalar(1.0, AdValue::pow_from_scalar(scratch.values[500], scratch.ad_value(583)))));
        ...
        scratch.store_ad(649, &AdValue::mul(AdValue::mul(AdValue::neg(AdValue::mul(AdValue::square(scratch.ad_value(643)), AdValue::pow_from_scalar(scratch.values[500], AdValue::offset(scratch.ad_value(581), (-1.0))))), scratch.ad_value(581)), scratch.ad_value(646)));

        scratch.store_ad(650, &AdValue::mul(AdValue::mul(AdValue::neg(AdValue::mul(AdValue::square(scratch.ad_value(644)), AdValue::pow_from_scalar(scratch.values[500], AdValue::offset(scratch.ad_value(582), (-1.0))))), scratch.ad_value(582)), scratch.ad_value(647)));

        scratch.store_ad(651, &AdValue::mul(AdValue::mul(AdValue::neg(AdValue::mul(AdValue::square(scratch.ad_value(645)), AdValue::pow_from_scalar(scratch.values[500], AdValue::offset(scratch.ad_value(583), (-1.0))))), scratch.ad_value(583)), scratch.ad_value(648)));
        ...
        if ((scratch.values[13] + scratch.values[311]) > 1e-9) {
            scratch.store_ad(321, &AdValue::add(scratch.ad_value(13), scratch.ad_value(311)));
        } else {
            scratch.values[321] = 1e-9;
            scratch.node_derivatives[321] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[321] = [0.0; Instance::BRANCH_COUNT];
        }

        if ((scratch.values[321] + self.params.dlsil) > 1e-9) {
            scratch.store_ad(322, &AdValue::offset(scratch.ad_value(321), self.params.dlsil));
        } else {
            scratch.values[322] = 1e-9;
            scratch.node_derivatives[322] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[322] = [0.0; Instance::BRANCH_COUNT];
        }

        if ((scratch.values[14] + scratch.values[312]) > 1e-9) {
            scratch.store_ad(323, &AdValue::add(scratch.ad_value(14), scratch.ad_value(312)));
        } else {
            scratch.values[323] = 1e-9;
            scratch.node_derivatives[323] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[323] = [0.0; Instance::BRANCH_COUNT];
        }

        if ((scratch.values[19] - (0.5 * scratch.values[312])) > 1e-9) {
            scratch.store_ad(324, &AdValue::sub_from_scalar(scratch.values[19], AdValue::scale(scratch.ad_value(312), 0.5)));
        } else {
            scratch.values[324] = 1e-9;
            scratch.node_derivatives[324] = [0.0; Instance::NODE_COUNT];
            scratch.branch_derivatives[324] = [0.0; Instance::BRANCH_COUNT];
        }
        ...
        scratch.values[187] = self.params.rth;

        scratch.values[188] = self.params.cth;

        scratch.values[189] = self.params.strth;
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(335, &AdValue::powf(scratch.ad_value(319), self.params.alp1lexp));
        }

        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(126, &AdValue::div(AdValue::mul(AdValue::scale(scratch.ad_value(335), self.params.alp1l1), AdValue::offset(AdValue::scale(scratch.ad_value(320), self.params.alp1w), 1.0)), AdValue::offset(AdValue::mul(AdValue::scale(scratch.ad_value(319), scratch.values[53]), scratch.ad_value(335)), 1.0)));
        }

        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(335, &AdValue::powf(scratch.ad_value(319), self.params.alp2lexp));
        }

        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(127, &AdValue::div(AdValue::mul(AdValue::scale(scratch.ad_value(335), self.params.alp2l1), AdValue::offset(AdValue::scale(scratch.ad_value(320), self.params.alp2w), 1.0)), AdValue::offset(AdValue::mul(AdValue::scale(scratch.ad_value(319), scratch.values[54]), scratch.ad_value(335)), 1.0)));
        }
        ...
        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(129, &AdValue::mul(AdValue::scale(AdValue::offset(AdValue::scale(scratch.ad_value(319), self.params.a1l), 1.0), self.params.a1o), AdValue::offset(AdValue::scale(scratch.ad_value(320), self.params.a1w), 1.0)));
        }
        ...
        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(336, &{
                if (scratch.values[1274] > 0.001) {
                    scratch.ad_value(1274)
                } else {
                    AdValue::constant(0.001)
                }
            });
        ...
        if (scratch.values[1289] != 0.0) {
            scratch.store_ad(337, &AdValue::div_from_scalar(1.0, AdValue::powf(scratch.ad_value(336), self.params.alpnoi)));
        }
