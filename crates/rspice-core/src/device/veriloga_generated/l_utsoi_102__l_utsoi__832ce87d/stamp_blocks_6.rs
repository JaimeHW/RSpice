...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_96(
        ...
        if (((s.b[1604] && s.b[1605]) && (!s.b[1611])) && (!s.b[1612])) {s.store_div_from_scalar_offset_scaled_input(1407, 1.0, 256, 0.732464877560822, 1.25);s.store_mul_scale_offset_mixed_ia(1408, 1407, A::mul_scaled_lhs(s.ad_value(259), 1.25, s.ad_value(1407)), 1.0, (-1.0));s.store_mul_ad_product_rhs_mixed_ia(1409, 1390, 260, A::offset(A::mul(s.ad_value(1408), s.ad_value(1390)), 1.0));}
    ...
    pub(super) fn stamp_transient_block_97(
        ...
        if (((((s.b[1604] && s.b[1605]) && (!s.b[1611])) && (!s.b[1612])) && (!s.b[1615])) && s.b[1616]) {s.store_exp_sub(1400, 1413, 262);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_98(
        ...
        if (((((s.b[1604] && s.b[1605]) && (!s.b[1611])) && (!s.b[1612])) && (!s.b[1615])) && s.b[1616]) {s.store_div(1401, 1391, 1400);}
    ...
    pub(super) fn stamp_transient_block_99(
        ...
        if s.b[1604] {s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(1445, 1444, 0.5, 250, 0.5, 1444, 250, 4.0, (-0.5));s.store_offset_sqrt_ad(1446, A::offset(A::div_scaled_inputs2(s.ad_value(250), 2.0, s.ad_value(1445), (-2.0), s.ad_value(251), 1.0), 1.0), (-1.0));s.store_add_scaled_product_indices(1447, 1445, 1.0, 251, 1446, 1.0);s.store_scaled_add_offset_sqrt_square_offset_ad(0, A::mul(s.ad_value(30), s.ad_value(1424)), ((1.0) + (0.5)), ((1.0) + ((-0.5))), 0.01, 0.5);s.store_div_from_scalar_offset_product(1448, 1.0, 1416, 0, 1.0);s.store_div_from_scalar_offset_product(1449, 1.0, 1417, 0, 1.0);s.store_mul_scale_offset(0, A::mul3_scaled_output(s.ad_value(325), A::offset(A::sqrt(A::offset(A::div(s.ad_value(336), s.ad_value(325)), 1.0)), (-1.0)), A::offset(A::mul(s.ad_value(36), s.ad_value(1446)), 1.0), 2.0), A::mul(s.ad_value(37), s.ad_value(1424)), 1.0, 1.0);s.store_mul(1450, 1418, 0);s.store_mul(1451, 1419, 0);s.store_add_mixed_ai(1452, A::add_scaled_product(s.ad_value(1447), 1.0, A::add_scaled_inputs3(s.ad_value(1423), 1.0, s.ad_value(1447), (-1.0), s.ad_value(1450), 1.0), s.ad_value(1448), 1.0), 337);s.store_add_mixed_ai(1453, A::add_scaled_product(s.ad_value(1447), 1.0, A::add_scaled_inputs3(s.ad_value(1434), 1.0, s.ad_value(1447), (-1.0), s.ad_value(1451), 1.0), s.ad_value(1449), 1.0), 337);s.store_add_scaled_inputs3_sqrt_third_mixed_aia(1454, A::add_scaled_product(s.ad_value(1453), 1.0, s.ad_value(25), A::sub(s.ad_value(1452), s.ad_value(1453)), 1.0), 0.5, 221, 0.5, A::offset(A::square(A::sub(A::add_scaled_product(s.ad_value(1453), 1.0, s.ad_value(25), A::sub(s.ad_value(1452), s.ad_value(1453)), 1.0), s.ad_value(221))), 0.01), (-0.5));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_100(
        s: &mut Scratch,
    ) {
        if s.b[1604] {s.store_add_scaled_inputs3_sqrt_third_mixed_aia(1455, A::add_scaled_product(s.ad_value(1452), 1.0, s.ad_value(26), A::sub(s.ad_value(1453), s.ad_value(1452)), 1.0), 0.5, 221, 0.5, A::offset(A::square(A::sub(A::add_scaled_product(s.ad_value(1452), 1.0, s.ad_value(26), A::sub(s.ad_value(1453), s.ad_value(1452)), 1.0), s.ad_value(221))), 0.01), (-0.5));s.store_div(1456, 1439, 1448);s.store_div(1457, 1440, 1449);s.store_div_from_scalar(1430, 1.0, 1456);s.store_div_from_scalar(1431, 1.0, 1457);s.store_div_from_scalar_add_ad(1458, 1.0, A::offset(s.ad_value(1430), 1.0), s.ad_value(1431));s.store_div_square_rhs(1429, 249, 1443);s.store_div_scaled_offset_numerator_mixed_ia(1426, 1456, 1.0, 1.0, A::offset(s.ad_value(1457), 1.0), 1.0);s.store_ln(1427, 1426);}
        ...
        if s.b[1604] {s.store_sub_scaled_inputs(1346, 1342, 1.0, 1340, 3.0);s.store_sub(1461, 1454, 1345);s.store_sub(1465, 1455, 1346);s.store_scalar(1352, 0.0);s.store_scalar(1355, 0.0);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_102(
        ...
        if ((s.b[1604] && (!s.b[1627])) && (!s.b[1628])) {s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1339, 1349, 1.0, 1349, 1.0, 1349, 0.0420875420875421, 0.05, ((0.0714285714286) * ((-0.0055555555556))), 0.0055555555556);s.store_add_scaled_products_mixed_iiai(1356, 1351, 1338, 1.0, A::square(s.ad_value(1350)), 1339, (-1.0));s.store_scaled_mul(1359, 1350, 1340, (-0.5));s.store_add_scaled_product_mixed_aii(1360, A::mul3_scaled_output(s.ad_value(1350), s.ad_value(1350), A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1349), 2.0, A::scale(s.ad_value(1349), 0.075), 0.0238095238095)), (0.25 * 0.0055555555556)), 1.0, 1351, 1340, (-0.5));}
    ...
    if (s.b[1604] && s.b[1633]) {
        ...
        if ((s.b[1604] && (!s.b[1635])) && (!s.b[1636])) {s.store_offset_ad(1353, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1349), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1349), 1.0, A::scale(s.ad_value(1349), 0.0238095238095), 0.0166666666667), 0.1666666666667), 2.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_104(
        s: &mut Scratch,
    ) {
        if ((s.b[1604] && (!s.b[1635])) && (!s.b[1636])) {s.store_offset_scaled_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(1354, 1349, 1.0, 1349, 1.0, 1349, 0.0333333333333, 0.0357142857143, ((0.0333333333333) * ((-0.1666666666667))), 0.1666666666667);}
    ...
    if (s.b[1604] && s.b[1637]) {
        ...
        if (s.b[1604] && s.b[1640]) {s.store_sqrt_abs_ad(1352, s.ad_value(1349));s.store_div_mixed_ia(1353, 1352, A::tan(A::scale(s.ad_value(1352), 0.5)));s.store_div_scaled_inputs_indices(1338, 1350, 0.25, 1349, 1.0);s.store_mul_add_mixed_iia(1354, 1338, 1349, A::mul_sub_from_scalar_rhs(s.ad_value(1353), 2.0, s.ad_value(1353)));s.store_add_scaled_product_mixed_aai(1356, A::div_scaled_product(s.ad_value(1354), s.ad_value(1351), 1.0, s.ad_value(1350), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(1350), 1.0, s.ad_value(1354), s.ad_value(1353), 1.0, (-2.0)), 1338, 1.0);s.store_sub_from_scalar_scaled_input(1339, 1.0, 1353, 0.5);s.store_mul_div_lhs(1359, 1350, 1349, 1339);s.store_div_mixed_ai(1360, A::add_scaled_products(s.ad_value(1351), s.ad_value(1339), 1.0, s.ad_value(1350), A::add_scaled_inputs(s.ad_value(1359), 1.0, s.ad_value(1354), 0.5), (-1.0)), 1349);}
    ...
    pub(super) fn stamp_transient_block_105(
        ...
        if ((s.b[1604] && (!s.b[1640])) && s.b[1641]) {s.store_add_scaled_product_mixed_aai(1356, A::div_scaled_product(s.ad_value(1354), s.ad_value(1351), 1.0, s.ad_value(1350), 1.0), 1.0, A::add_scaled_offset_product_rhs(s.ad_value(1350), 1.0, s.ad_value(1354), s.ad_value(1353), 1.0, (-2.0)), 1338, 1.0);s.store_sub_from_scalar_scaled_input(1339, 1.0, 1353, 0.5);s.store_mul_div_lhs(1359, 1350, 1349, 1339);s.store_div_mixed_ai(1360, A::add_scaled_products(s.ad_value(1351), s.ad_value(1339), 1.0, s.ad_value(1350), A::add_scaled_inputs(s.ad_value(1359), 1.0, s.ad_value(1354), 0.5), (-1.0)), 1349);}
        ...
        if (s.b[1604] && s.b[1642]) {s.store_div_scaled_inputs_mixed_ia(1339, 1349, 4.0, A::sub_from_scalar(1.0, A::mul_sub_from_scalar_rhs(s.ad_value(1355), 2.0, s.ad_value(1355))), 1.0);s.store_mul(1357, 1339, 1355);s.store_sub_ln_lhs(1358, 1339, 1352);}
    ...
    pub(super) fn stamp_transient_block_106(
        ...
        if (s.b[1604] && (!s.b[1644])) {s.store_mul_mixed_ai(1363, A::add_scaled_inputs_product(A::add_scaled_products(s.ad_value(1356), s.ad_value(1361), 1.0, s.ad_value(1340), s.ad_value(1362), 2.0), 1.0, s.ad_value(1348), 1.0, A::add(s.ad_value(1360), A::square(s.ad_value(1359))), s.ad_value(1357), (-1.0)), 1339);}
    ...
    pub(super) fn stamp_transient_block_107(
        ...
        if (s.b[1604] && s.b[1647]) {s.store_mul_div_lhs(1359, 1350, 1349, 1339);s.store_div_mixed_ai(1360, A::add_scaled_products(s.ad_value(1351), s.ad_value(1339), 1.0, s.ad_value(1350), A::add_scaled_inputs(s.ad_value(1359), 1.0, s.ad_value(1354), 0.5), (-1.0)), 1349);}
    ...
    pub(super) fn stamp_transient_block_108(
        ...
        s.b[1653] = (p[10] == 1.0);s.store_scalar(1653, if s.b[1653] { 1.0 } else { 0.0 });s.b[1654] = (((s.v[1376]) as f64).abs() > 0.01);s.store_scalar(1654, if s.b[1654] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_110(
        ...
        if ((s.b[1604] && s.b[1653]) && s.b[1654]) {s.store_sub_add_scaled_inputs4_lhs_indices(1367, 1455, 1.0, 1454, (-1.0), 1461, 1.0, 1364, 2.0, 1358);s.store_sub_mixed_ai(1368, A::scale_offset(s.ad_value(1365), 2.0, 1.0), 1359);s.store_sub_scaled_inputs(1369, 1366, 2.0, 1360, 1.0);s.store_add_scaled_product_indices(1370, 1347, 1.0, 1457, 1367, 1.0);s.store_add_scaled_product_indices(1371, 1456, 1.0, 1457, 1368, 1.0);s.store_mul(1372, 1457, 1369);s.store_add_scaled_product_indices(1373, 1348, (-1.0), 1370, 1361, 1.0);s.store_add_mixed_ai(1374, A::add_scaled_products(s.ad_value(1371), s.ad_value(1361), 1.0, s.ad_value(1370), s.ad_value(1362), 1.0), 1348);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_111(
        s: &mut Scratch,
    ) {
        if ((s.b[1604] && s.b[1653]) && s.b[1654]) {s.store_sub_mixed_ai(1375, A::add_scaled_products3(s.ad_value(1372), s.ad_value(1361), 1.0, s.ad_value(1371), s.ad_value(1362), 2.0, s.ad_value(1370), s.ad_value(1363), 1.0), 1348);s.store_add_scaled_square_product_indices(1384, 1374, 1.0, 1373, 1375, (-0.5));s.store_div_scaled_product3_mixed_iiia(1376, 1373, 1374, 1384, -1.0, A::offset(A::square(s.ad_value(1384)), 1e-200), 1.0);s.store_add(1461, 1461, 1376);}
        ...
        s.b[1670] = (s.v[1466] > 0.005);s.store_scalar(1670, if s.b[1670] { 1.0 } else { 0.0 });
    }
}
