...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_16(
        ...
        if ((((s.b[1218] && (!s.b[1219])) && (!s.b[1220])) && (!s.b[1225])) && s.b[1226]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(689, 1.80485e-35, A::neg(A::neg(s.ad_value(696))), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if ((((s.b[1218] && (!s.b[1219])) && (!s.b[1220])) && (!s.b[1225])) && (!s.b[1226])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad(689, A::neg(s.ad_value(696)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }

        if ((s.b[1218] && (!s.b[1219])) && (!s.b[1220])) {
            s.store_add_scaled_inputs3_mixed_iia(690, 702, 2.0, 696, (-2.0), A::mul_sub_from_scalar_rhs(s.ad_value(705), 1.0, s.ad_value(689)), 1.0);
            s.store_add_scaled_square_product_mixed_aia(691, A::sub(s.ad_value(702), s.ad_value(696)), 1.0, 705, A::add(A::offset(s.ad_value(696), (-1.0)), s.ad_value(689)), (-1.0));
        ...
        if ((s.b[1227] && (!s.b[1228])) && s.b[1229]) {
            ...
            s.store_add_scaled_square_product_mixed_aia(682, A::sub(s.ad_value(679), s.ad_value(681)), 1.0, 705, A::offset(s.ad_value(681), 1.0), 1.0);
        ...
        if ((((s.b[1227] && (!s.b[1228])) && s.b[1229]) && (!s.b[1230])) && s.b[1231]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(689, 1.80485e-35, A::neg(s.ad_value(688)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if ((((s.b[1227] && (!s.b[1228])) && s.b[1229]) && (!s.b[1230])) && (!s.b[1231])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(689, 688, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if ((s.b[1227] && (!s.b[1228])) && s.b[1229]) {
            ...
            s.store_neg_add(711, 688, 693);
        }

        if ((s.b[1227] && (!s.b[1228])) && (!s.b[1229])) {
            s.store_mul_offset_ad_lhs(694, A::mul_scaled_lhs(s.ad_value(706), 1.25, s.ad_value(709)), (-1.0), 709);
            s.store_mul_ad_product_rhs_mixed_ia(695, 701, 708, A::offset(A::mul(s.ad_value(694), s.ad_value(701)), 1.0));
        }
        ...
        if ((((s.b[1227] && (!s.b[1228])) && (!s.b[1229])) && (!s.b[1232])) && s.b[1233]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(687, 1.80485e-35, A::neg(A::neg(s.ad_value(695))), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if ((((s.b[1227] && (!s.b[1228])) && (!s.b[1229])) && (!s.b[1232])) && (!s.b[1233])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad(687, A::neg(s.ad_value(695)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if ((s.b[1227] && (!s.b[1228])) && (!s.b[1229])) {
            ...
            s.store_add_scaled_square_product_mixed_aia(691, A::sub(s.ad_value(701), s.ad_value(696)), 1.0, 705, A::add(A::offset(s.ad_value(696), (-1.0)), s.ad_value(689)), (-1.0));
            s.store_sub_from_scalar_scaled_mul(692, 1.0, 705, 689, 0.5);
            s.store_add_scaled_square_product_indices(687, 690, 1.0, 692, 691, (-4.0));
            s.store_div_scaled_inputs_mixed_ia(697, 691, 2.0, A::add(s.ad_value(690), A::sqrt(s.ad_value(687))), 1.0);
        ...
        if ((s.b[1236] && (!s.b[1237])) && s.b[1238]) {
            ...
            s.store_add_scaled_square_product_indices(687, 690, 1.0, 692, 691, (-4.0));
            s.store_div_scaled_inputs_mixed_ia(693, 691, 2.0, A::add(s.ad_value(690), A::sqrt(s.ad_value(687))), 1.0);
            s.store_neg_add(713, 688, 693);
        }

        if ((s.b[1236] && (!s.b[1237])) && (!s.b[1238])) {
            s.store_mul_offset_ad_lhs(694, A::mul_scaled_lhs(s.ad_value(706), 1.25, s.ad_value(709)), (-1.0), 709);
            s.store_mul_ad_product_rhs_mixed_ia(695, 703, 708, A::offset(A::mul(s.ad_value(694), s.ad_value(703)), 1.0));
        }
        ...
        if ((s.b[1236] && (!s.b[1237])) && (!s.b[1238])) {
            ...
            s.store_add_scaled_square_product_mixed_aia(691, A::sub(s.ad_value(703), s.ad_value(696)), 1.0, 705, A::add(A::offset(s.ad_value(696), (-1.0)), s.ad_value(689)), (-1.0));
            s.store_sub_from_scalar_scaled_mul(692, 1.0, 705, 689, 0.5);
            s.store_add_scaled_square_product_indices(687, 690, 1.0, 692, 691, (-4.0));
            s.store_div_scaled_inputs_mixed_ia(697, 691, 2.0, A::add(s.ad_value(690), A::sqrt(s.ad_value(687))), 1.0);
        ...
        if (s.b[1245] && s.b[1246]) {
            ...
            s.store_scaled_sub_ad_rhs(717, 716, A::sqrt_square_offset(A::neg(s.ad_value(716)), 0.01), 0.5);
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1247])) && s.b[1248]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(0, 1.80485e-35, A::neg(A::scale(s.ad_value(700), 0.5)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if (s.b[1245] && s.b[1246]) {
            ...
            s.store_mul_div_scaled_inputs_indices(2, 275, 81, (-1.0), 718, 1.0);
        }
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1249]) {
            s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(718, 718, 0.5, 721, 0.5, 718, 721, 1e-6, (-0.5));
        }
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1250])) && s.b[1251]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(725, 1.80485e-35, A::neg(s.ad_value(724)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((s.b[1245] && s.b[1246]) && (!s.b[1250])) && (!s.b[1251])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(725, 724, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1252])) && s.b[1253]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(726, 1.80485e-35, A::neg(s.ad_value(724)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((s.b[1245] && s.b[1246]) && (!s.b[1252])) && (!s.b[1253])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(726, 724, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1245] && s.b[1263]) && (!s.b[1264])) && s.b[1265]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(0, 1.80485e-35, A::neg(A::scale(s.ad_value(701), 0.5)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1281])) && s.b[1282]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(0, 1.80485e-35, A::neg(A::sub_scaled_inputs(s.ad_value(731), 2.0, s.ad_value(407), 1.0)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((s.b[1245] && s.b[1280]) && (!s.b[1281])) && (!s.b[1282])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad(0, A::sub_scaled_inputs(s.ad_value(731), 2.0, s.ad_value(407), 1.0), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if ((s.b[1245] && s.b[1280]) && s.b[1283]) {
            s.store_add_scaled_inputs3_sqrt_third_sub_square_offset(718, 718, 0.5, 276, 0.5, 718, 276, 1e-6, (-0.5));
        }
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1286])) && s.b[1287]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(0, 1.80485e-35, A::neg(s.ad_value(724)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((s.b[1245] && s.b[1280]) && (!s.b[1286])) && (!s.b[1287])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(0, 724, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if (((((s.b[1245] && s.b[1280]) && (!s.b[1291])) && (!s.b[1292])) && (!s.b[1293])) && s.b[1294]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(747, 1.80485e-35, A::neg(s.ad_value(741)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((((s.b[1245] && s.b[1280]) && (!s.b[1291])) && (!s.b[1292])) && (!s.b[1293])) && (!s.b[1294])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad_rhs(747, 741, (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1306] {
            ...
            s.store_mul_offset_ad_lhs(755, A::sqrt_square_offset(s.ad_value(332), 0.01), (-0.1), 285);
            ...
            s.store_div_square_rhs(773, 286, 386);
        ...
        if (((s.b[1306] && (!s.b[1308])) && s.b[1309]) && (!s.b[1310])) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(780, 1.80485e-35, A::neg(s.ad_value(766)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if ((s.b[1306] && (!s.b[1308])) && (!s.b[1309])) {
            s.store_add_ln_lhs(780, 775, 766);
            s.store_mul_sub_from_scalar_ad_rhs(0, 780, 1.0, A::div(A::ln(A::offset(s.ad_value(780), 1.0)), A::offset(s.ad_value(780), 2.0)));
        }
        ...
        if (((s.b[1306] && (!s.b[1311])) && s.b[1312]) && (!s.b[1313])) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(780, 1.80485e-35, A::neg(A::sub(s.ad_value(766), s.ad_value(407))), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }
        ...
        if (s.b[1604] && s.b[1605]) {
            s.store_div_square_rhs(1429, 249, 241);
        ...
        if (((s.b[1604] && s.b[1605]) && (!s.b[1609])) && s.b[1610]) {
            s.store_div_from_scalar_softlimit_poly_offset_lhs_mul_scaled_ad(1391, 1.80485e-35, A::neg(A::neg(s.ad_value(262))), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0);
        }

        if (((s.b[1604] && s.b[1605]) && (!s.b[1609])) && (!s.b[1610])) {
            s.store_scaled_softlimit_poly_offset_lhs_mul_scaled_ad(1391, A::neg(s.ad_value(262)), (-80.0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)), 0.5, 1.0, 1.0, 5.54062e34);
        }
        ...
        if ((s.b[1604] && s.b[1605]) && s.b[1611]) {
            ...
            s.store_mul_ad_product_rhs_mixed_ia(4, 1390, 260, A::offset(A::mul3(A::mul_sub_from_scalar_rhs(s.ad_value(1390), 1.0, s.ad_value(1391)), s.ad_value(256), s.ad_value(1388)), 1.0));
        }
        ...
        if (((s.b[1604] && s.b[1605]) && (!s.b[1611])) && s.b[1612]) {
            ...
            s.store_scaled_sub_offset_sqrt_square_offset(1394, 1393, 10.0, (-6.0), 64.0, 0.5);
            ...
            s.store_sub_ln_mul_lhs(1398, 1395, 258, 1394);
    ...
    if (!s.b[1763]) {
        ...
        let eq23_e631: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 0, s.v[358]);
        let eq23_e633: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 1, s.v[373]);
        let eq23_e634: f64 = (eq23_e631 + eq23_e633);
        let eq23_e634_d_n0: f64 = ((s.dn[358][0] * ddt_scale) + (s.dn[373][0] * ddt_scale));
        let eq23_e634_d_n1: f64 = ((s.dn[358][1] * ddt_scale) + (s.dn[373][1] * ddt_scale));
        let eq23_e634_d_n2: f64 = ((s.dn[358][2] * ddt_scale) + (s.dn[373][2] * ddt_scale));
        let eq23_e634_d_n3: f64 = ((s.dn[358][3] * ddt_scale) + (s.dn[373][3] * ddt_scale));
        let eq23_e634_d_n4: f64 = ((s.dn[358][4] * ddt_scale) + (s.dn[373][4] * ddt_scale));
        let eq23_e634_d_n5: f64 = ((s.dn[358][5] * ddt_scale) + (s.dn[373][5] * ddt_scale));
        let eq23_e634_d_n6: f64 = ((s.dn[358][6] * ddt_scale) + (s.dn[373][6] * ddt_scale));
        let eq23_e634_d_n7: f64 = ((s.dn[358][7] * ddt_scale) + (s.dn[373][7] * ddt_scale));
        let eq23_e634_d_n8: f64 = ((s.dn[358][8] * ddt_scale) + (s.dn[373][8] * ddt_scale));
        let eq23_e634_d_n9: f64 = ((s.dn[358][9] * ddt_scale) + (s.dn[373][9] * ddt_scale));
        let eq23_e634_d_b0: f64 = ((s.db[358][0] * ddt_scale) + (s.db[373][0] * ddt_scale));
        let eq23_e634_d_b1: f64 = ((s.db[358][1] * ddt_scale) + (s.db[373][1] * ddt_scale));
        let eq23_e634_d_b2: f64 = ((s.db[358][2] * ddt_scale) + (s.db[373][2] * ddt_scale));
        let eq23_e634_d_b3: f64 = ((s.db[358][3] * ddt_scale) + (s.db[373][3] * ddt_scale));
        let eq23_e636: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 2, s.v[377]);
        let eq23_e637: f64 = (eq23_e634 + eq23_e636);
        let eq23_e637_d_n0: f64 = (eq23_e634_d_n0 + (s.dn[377][0] * ddt_scale));
        let eq23_e637_d_n1: f64 = (eq23_e634_d_n1 + (s.dn[377][1] * ddt_scale));
        let eq23_e637_d_n2: f64 = (eq23_e634_d_n2 + (s.dn[377][2] * ddt_scale));
        let eq23_e637_d_n3: f64 = (eq23_e634_d_n3 + (s.dn[377][3] * ddt_scale));
        let eq23_e637_d_n4: f64 = (eq23_e634_d_n4 + (s.dn[377][4] * ddt_scale));
        let eq23_e637_d_n5: f64 = (eq23_e634_d_n5 + (s.dn[377][5] * ddt_scale));
        let eq23_e637_d_n6: f64 = (eq23_e634_d_n6 + (s.dn[377][6] * ddt_scale));
        let eq23_e637_d_n7: f64 = (eq23_e634_d_n7 + (s.dn[377][7] * ddt_scale));
        let eq23_e637_d_n8: f64 = (eq23_e634_d_n8 + (s.dn[377][8] * ddt_scale));
        let eq23_e637_d_n9: f64 = (eq23_e634_d_n9 + (s.dn[377][9] * ddt_scale));
        let eq23_e637_d_b0: f64 = (eq23_e634_d_b0 + (s.db[377][0] * ddt_scale));
        let eq23_e637_d_b1: f64 = (eq23_e634_d_b1 + (s.db[377][1] * ddt_scale));
        let eq23_e637_d_b2: f64 = (eq23_e634_d_b2 + (s.db[377][2] * ddt_scale));
        let eq23_e637_d_b3: f64 = (eq23_e634_d_b3 + (s.db[377][3] * ddt_scale));
        ...
        let eq24_e641: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 3, s.v[367]);
        let eq24_e643: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 4, s.v[369]);
        let eq24_e644: f64 = (eq24_e641 + eq24_e643);
        let eq24_e644_d_n0: f64 = ((s.dn[367][0] * ddt_scale) + (s.dn[369][0] * ddt_scale));
        let eq24_e644_d_n1: f64 = ((s.dn[367][1] * ddt_scale) + (s.dn[369][1] * ddt_scale));
        let eq24_e644_d_n2: f64 = ((s.dn[367][2] * ddt_scale) + (s.dn[369][2] * ddt_scale));
        let eq24_e644_d_n3: f64 = ((s.dn[367][3] * ddt_scale) + (s.dn[369][3] * ddt_scale));
        let eq24_e644_d_n4: f64 = ((s.dn[367][4] * ddt_scale) + (s.dn[369][4] * ddt_scale));
        let eq24_e644_d_n5: f64 = ((s.dn[367][5] * ddt_scale) + (s.dn[369][5] * ddt_scale));
        let eq24_e644_d_n6: f64 = ((s.dn[367][6] * ddt_scale) + (s.dn[369][6] * ddt_scale));
        let eq24_e644_d_n7: f64 = ((s.dn[367][7] * ddt_scale) + (s.dn[369][7] * ddt_scale));
        let eq24_e644_d_n8: f64 = ((s.dn[367][8] * ddt_scale) + (s.dn[369][8] * ddt_scale));
        let eq24_e644_d_n9: f64 = ((s.dn[367][9] * ddt_scale) + (s.dn[369][9] * ddt_scale));
        let eq24_e644_d_b0: f64 = ((s.db[367][0] * ddt_scale) + (s.db[369][0] * ddt_scale));
        let eq24_e644_d_b1: f64 = ((s.db[367][1] * ddt_scale) + (s.db[369][1] * ddt_scale));
        let eq24_e644_d_b2: f64 = ((s.db[367][2] * ddt_scale) + (s.db[369][2] * ddt_scale));
        let eq24_e644_d_b3: f64 = ((s.db[367][3] * ddt_scale) + (s.db[369][3] * ddt_scale));
        let eq24_e646: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 5, s.v[376]);
        let eq24_e647: f64 = (eq24_e644 + eq24_e646);
        let eq24_e647_d_n0: f64 = (eq24_e644_d_n0 + (s.dn[376][0] * ddt_scale));
        let eq24_e647_d_n1: f64 = (eq24_e644_d_n1 + (s.dn[376][1] * ddt_scale));
        let eq24_e647_d_n2: f64 = (eq24_e644_d_n2 + (s.dn[376][2] * ddt_scale));
        let eq24_e647_d_n3: f64 = (eq24_e644_d_n3 + (s.dn[376][3] * ddt_scale));
        let eq24_e647_d_n4: f64 = (eq24_e644_d_n4 + (s.dn[376][4] * ddt_scale));
        let eq24_e647_d_n5: f64 = (eq24_e644_d_n5 + (s.dn[376][5] * ddt_scale));
        let eq24_e647_d_n6: f64 = (eq24_e644_d_n6 + (s.dn[376][6] * ddt_scale));
        let eq24_e647_d_n7: f64 = (eq24_e644_d_n7 + (s.dn[376][7] * ddt_scale));
        let eq24_e647_d_n8: f64 = (eq24_e644_d_n8 + (s.dn[376][8] * ddt_scale));
        let eq24_e647_d_n9: f64 = (eq24_e644_d_n9 + (s.dn[376][9] * ddt_scale));
        let eq24_e647_d_b0: f64 = (eq24_e644_d_b0 + (s.db[376][0] * ddt_scale));
        let eq24_e647_d_b1: f64 = (eq24_e644_d_b1 + (s.db[376][1] * ddt_scale));
        let eq24_e647_d_b2: f64 = (eq24_e644_d_b2 + (s.db[376][2] * ddt_scale));
        let eq24_e647_d_b3: f64 = (eq24_e644_d_b3 + (s.db[376][3] * ddt_scale));
        ...
        let eq25_e651: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 6, s.v[372]);
        let eq25_e653: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 7, s.v[378]);
        let eq25_e654: f64 = (eq25_e651 + eq25_e653);
        let eq25_e654_d_n0: f64 = ((s.dn[372][0] * ddt_scale) + (s.dn[378][0] * ddt_scale));
        let eq25_e654_d_n1: f64 = ((s.dn[372][1] * ddt_scale) + (s.dn[378][1] * ddt_scale));
        let eq25_e654_d_n2: f64 = ((s.dn[372][2] * ddt_scale) + (s.dn[378][2] * ddt_scale));
        let eq25_e654_d_n3: f64 = ((s.dn[372][3] * ddt_scale) + (s.dn[378][3] * ddt_scale));
        let eq25_e654_d_n4: f64 = ((s.dn[372][4] * ddt_scale) + (s.dn[378][4] * ddt_scale));
        let eq25_e654_d_n5: f64 = ((s.dn[372][5] * ddt_scale) + (s.dn[378][5] * ddt_scale));
        let eq25_e654_d_n6: f64 = ((s.dn[372][6] * ddt_scale) + (s.dn[378][6] * ddt_scale));
        let eq25_e654_d_n7: f64 = ((s.dn[372][7] * ddt_scale) + (s.dn[378][7] * ddt_scale));
        let eq25_e654_d_n8: f64 = ((s.dn[372][8] * ddt_scale) + (s.dn[378][8] * ddt_scale));
        let eq25_e654_d_n9: f64 = ((s.dn[372][9] * ddt_scale) + (s.dn[378][9] * ddt_scale));
        let eq25_e654_d_b0: f64 = ((s.db[372][0] * ddt_scale) + (s.db[378][0] * ddt_scale));
        let eq25_e654_d_b1: f64 = ((s.db[372][1] * ddt_scale) + (s.db[378][1] * ddt_scale));
        let eq25_e654_d_b2: f64 = ((s.db[372][2] * ddt_scale) + (s.db[378][2] * ddt_scale));
        let eq25_e654_d_b3: f64 = ((s.db[372][3] * ddt_scale) + (s.db[378][3] * ddt_scale));
        ...
        let eq26_e658: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 8, s.v[370]);
        let eq26_e659: f64 = (p.p14 * eq26_e658);
        let eq26_e659_d_n0: f64 = (p.p14 * (s.dn[370][0] * ddt_scale));
        let eq26_e659_d_n1: f64 = (p.p14 * (s.dn[370][1] * ddt_scale));
        let eq26_e659_d_n2: f64 = (p.p14 * (s.dn[370][2] * ddt_scale));
        let eq26_e659_d_n3: f64 = (p.p14 * (s.dn[370][3] * ddt_scale));
        let eq26_e659_d_n4: f64 = (p.p14 * (s.dn[370][4] * ddt_scale));
        let eq26_e659_d_n5: f64 = (p.p14 * (s.dn[370][5] * ddt_scale));
        let eq26_e659_d_n6: f64 = (p.p14 * (s.dn[370][6] * ddt_scale));
        let eq26_e659_d_n7: f64 = (p.p14 * (s.dn[370][7] * ddt_scale));
        let eq26_e659_d_n8: f64 = (p.p14 * (s.dn[370][8] * ddt_scale));
        let eq26_e659_d_n9: f64 = (p.p14 * (s.dn[370][9] * ddt_scale));
        let eq26_e659_d_b0: f64 = (p.p14 * (s.db[370][0] * ddt_scale));
        let eq26_e659_d_b1: f64 = (p.p14 * (s.db[370][1] * ddt_scale));
        let eq26_e659_d_b2: f64 = (p.p14 * (s.db[370][2] * ddt_scale));
        let eq26_e659_d_b3: f64 = (p.p14 * (s.db[370][3] * ddt_scale));
        ...
        let eq27_e662: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 9, s.v[357]);
        let eq27_e664: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 10, s.v[366]);
        let eq27_e665: f64 = (eq27_e662 + eq27_e664);
        let eq27_e665_d_n0: f64 = ((s.dn[357][0] * ddt_scale) + (s.dn[366][0] * ddt_scale));
        let eq27_e665_d_n1: f64 = ((s.dn[357][1] * ddt_scale) + (s.dn[366][1] * ddt_scale));
        let eq27_e665_d_n2: f64 = ((s.dn[357][2] * ddt_scale) + (s.dn[366][2] * ddt_scale));
        let eq27_e665_d_n3: f64 = ((s.dn[357][3] * ddt_scale) + (s.dn[366][3] * ddt_scale));
        let eq27_e665_d_n4: f64 = ((s.dn[357][4] * ddt_scale) + (s.dn[366][4] * ddt_scale));
        let eq27_e665_d_n5: f64 = ((s.dn[357][5] * ddt_scale) + (s.dn[366][5] * ddt_scale));
        let eq27_e665_d_n6: f64 = ((s.dn[357][6] * ddt_scale) + (s.dn[366][6] * ddt_scale));
        let eq27_e665_d_n7: f64 = ((s.dn[357][7] * ddt_scale) + (s.dn[366][7] * ddt_scale));
        let eq27_e665_d_n8: f64 = ((s.dn[357][8] * ddt_scale) + (s.dn[366][8] * ddt_scale));
        let eq27_e665_d_n9: f64 = ((s.dn[357][9] * ddt_scale) + (s.dn[366][9] * ddt_scale));
        let eq27_e665_d_b0: f64 = ((s.db[357][0] * ddt_scale) + (s.db[366][0] * ddt_scale));
        let eq27_e665_d_b1: f64 = ((s.db[357][1] * ddt_scale) + (s.db[366][1] * ddt_scale));
        let eq27_e665_d_b2: f64 = ((s.db[357][2] * ddt_scale) + (s.db[366][2] * ddt_scale));
        let eq27_e665_d_b3: f64 = ((s.db[357][3] * ddt_scale) + (s.db[366][3] * ddt_scale));
        let eq27_e667: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 11, s.v[368]);
        let eq27_e668: f64 = (eq27_e665 + eq27_e667);
        let eq27_e668_d_n0: f64 = (eq27_e665_d_n0 + (s.dn[368][0] * ddt_scale));
        let eq27_e668_d_n1: f64 = (eq27_e665_d_n1 + (s.dn[368][1] * ddt_scale));
        let eq27_e668_d_n2: f64 = (eq27_e665_d_n2 + (s.dn[368][2] * ddt_scale));
        let eq27_e668_d_n3: f64 = (eq27_e665_d_n3 + (s.dn[368][3] * ddt_scale));
        let eq27_e668_d_n4: f64 = (eq27_e665_d_n4 + (s.dn[368][4] * ddt_scale));
        let eq27_e668_d_n5: f64 = (eq27_e665_d_n5 + (s.dn[368][5] * ddt_scale));
        let eq27_e668_d_n6: f64 = (eq27_e665_d_n6 + (s.dn[368][6] * ddt_scale));
        let eq27_e668_d_n7: f64 = (eq27_e665_d_n7 + (s.dn[368][7] * ddt_scale));
        let eq27_e668_d_n8: f64 = (eq27_e665_d_n8 + (s.dn[368][8] * ddt_scale));
        let eq27_e668_d_n9: f64 = (eq27_e665_d_n9 + (s.dn[368][9] * ddt_scale));
        let eq27_e668_d_b0: f64 = (eq27_e665_d_b0 + (s.db[368][0] * ddt_scale));
        let eq27_e668_d_b1: f64 = (eq27_e665_d_b1 + (s.db[368][1] * ddt_scale));
        let eq27_e668_d_b2: f64 = (eq27_e665_d_b2 + (s.db[368][2] * ddt_scale));
        let eq27_e668_d_b3: f64 = (eq27_e665_d_b3 + (s.db[368][3] * ddt_scale));
        let eq27_e670: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 12, s.v[375]);
        let eq27_e671: f64 = (eq27_e668 + eq27_e670);
        let eq27_e671_d_n0: f64 = (eq27_e668_d_n0 + (s.dn[375][0] * ddt_scale));
        let eq27_e671_d_n1: f64 = (eq27_e668_d_n1 + (s.dn[375][1] * ddt_scale));
        let eq27_e671_d_n2: f64 = (eq27_e668_d_n2 + (s.dn[375][2] * ddt_scale));
        let eq27_e671_d_n3: f64 = (eq27_e668_d_n3 + (s.dn[375][3] * ddt_scale));
        let eq27_e671_d_n4: f64 = (eq27_e668_d_n4 + (s.dn[375][4] * ddt_scale));
        let eq27_e671_d_n5: f64 = (eq27_e668_d_n5 + (s.dn[375][5] * ddt_scale));
        let eq27_e671_d_n6: f64 = (eq27_e668_d_n6 + (s.dn[375][6] * ddt_scale));
        let eq27_e671_d_n7: f64 = (eq27_e668_d_n7 + (s.dn[375][7] * ddt_scale));
        let eq27_e671_d_n8: f64 = (eq27_e668_d_n8 + (s.dn[375][8] * ddt_scale));
        let eq27_e671_d_n9: f64 = (eq27_e668_d_n9 + (s.dn[375][9] * ddt_scale));
        let eq27_e671_d_b0: f64 = (eq27_e668_d_b0 + (s.db[375][0] * ddt_scale));
        let eq27_e671_d_b1: f64 = (eq27_e668_d_b1 + (s.db[375][1] * ddt_scale));
        let eq27_e671_d_b2: f64 = (eq27_e668_d_b2 + (s.db[375][2] * ddt_scale));
        let eq27_e671_d_b3: f64 = (eq27_e668_d_b3 + (s.db[375][3] * ddt_scale));
        ...
        let eq28_e675: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 13, s.v[359]);
        let eq28_e677: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 14, s.v[371]);
        let eq28_e678: f64 = (eq28_e675 + eq28_e677);
        let eq28_e678_d_n0: f64 = ((s.dn[359][0] * ddt_scale) + (s.dn[371][0] * ddt_scale));
        let eq28_e678_d_n1: f64 = ((s.dn[359][1] * ddt_scale) + (s.dn[371][1] * ddt_scale));
        let eq28_e678_d_n2: f64 = ((s.dn[359][2] * ddt_scale) + (s.dn[371][2] * ddt_scale));
        let eq28_e678_d_n3: f64 = ((s.dn[359][3] * ddt_scale) + (s.dn[371][3] * ddt_scale));
        let eq28_e678_d_n4: f64 = ((s.dn[359][4] * ddt_scale) + (s.dn[371][4] * ddt_scale));
        let eq28_e678_d_n5: f64 = ((s.dn[359][5] * ddt_scale) + (s.dn[371][5] * ddt_scale));
        let eq28_e678_d_n6: f64 = ((s.dn[359][6] * ddt_scale) + (s.dn[371][6] * ddt_scale));
        let eq28_e678_d_n7: f64 = ((s.dn[359][7] * ddt_scale) + (s.dn[371][7] * ddt_scale));
        let eq28_e678_d_n8: f64 = ((s.dn[359][8] * ddt_scale) + (s.dn[371][8] * ddt_scale));
        let eq28_e678_d_n9: f64 = ((s.dn[359][9] * ddt_scale) + (s.dn[371][9] * ddt_scale));
        let eq28_e678_d_b0: f64 = ((s.db[359][0] * ddt_scale) + (s.db[371][0] * ddt_scale));
        let eq28_e678_d_b1: f64 = ((s.db[359][1] * ddt_scale) + (s.db[371][1] * ddt_scale));
        let eq28_e678_d_b2: f64 = ((s.db[359][2] * ddt_scale) + (s.db[371][2] * ddt_scale));
        let eq28_e678_d_b3: f64 = ((s.db[359][3] * ddt_scale) + (s.db[371][3] * ddt_scale));
        ...
        let eq29_e681: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 15, s.v[374]);
