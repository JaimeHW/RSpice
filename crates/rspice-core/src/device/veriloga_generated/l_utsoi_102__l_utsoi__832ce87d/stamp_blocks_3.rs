...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        (locals.var_idse, locals.var_idse_dn4, locals.var_idse_dn6, locals.var_idse_dn7, locals.var_idse_dn8, locals.var_idse_dn9, ) = (assign42790_e48275, (assign42790_e48269 * ((locals.var_ids_dn4 + locals.var_ids_edge_dn4) + locals.var_iimpact_dn4)), (assign42790_e48269 * ((locals.var_ids_dn6 + locals.var_ids_edge_dn6) + locals.var_iimpact_dn6)), (assign42790_e48269 * ((locals.var_ids_dn7 + locals.var_ids_edge_dn7) + locals.var_iimpact_dn7)), (assign42790_e48269 * ((locals.var_ids_dn8 + locals.var_ids_edge_dn8) + locals.var_iimpact_dn8)), (assign42790_e48269 * ((locals.var_ids_dn9 + locals.var_ids_edge_dn9) + locals.var_iimpact_dn9)), );

        let assign42820_e48288: f64 = (p.p31 * locals.var_mult_i_int);
        let assign42820_e48290: f64 = (assign42820_e48288 * locals.var_igidl);
        (locals.var_igidle, locals.var_igidle_dn4, locals.var_igidle_dn6, locals.var_igidle_dn7, locals.var_igidle_dn8, locals.var_igidle_dn9, ) = (assign42820_e48290, (assign42820_e48288 * locals.var_igidl_dn4), (assign42820_e48288 * locals.var_igidl_dn6), (assign42820_e48288 * locals.var_igidl_dn7), (assign42820_e48288 * locals.var_igidl_dn8), (assign42820_e48288 * locals.var_igidl_dn9), );

        let assign42830_e48293: f64 = (p.p31 * locals.var_mult_i_int);
        let assign42830_e48295: f64 = (assign42830_e48293 * locals.var_igisl);
        (locals.var_igisle, locals.var_igisle_dn4, locals.var_igisle_dn6, locals.var_igisle_dn7, locals.var_igisle_dn8, locals.var_igisle_dn9, ) = (assign42830_e48295, (assign42830_e48293 * locals.var_igisl_dn4), (assign42830_e48293 * locals.var_igisl_dn6), (assign42830_e48293 * locals.var_igisl_dn7), (assign42830_e48293 * locals.var_igisl_dn8), (assign42830_e48293 * locals.var_igisl_dn9), );

        let assign42840_e48298: f64 = (locals.var_mult_i_int * locals.var_ithpwr);
        (locals.var_ithpwre, locals.var_ithpwre_dn4, locals.var_ithpwre_dn6, locals.var_ithpwre_dn7, locals.var_ithpwre_dn8, locals.var_ithpwre_dn9, ) = (assign42840_e48298, (locals.var_mult_i_int * locals.var_ithpwr_dn4), (locals.var_mult_i_int * locals.var_ithpwr_dn6), (locals.var_mult_i_int * locals.var_ithpwr_dn7), (locals.var_mult_i_int * locals.var_ithpwr_dn8), (locals.var_mult_i_int * locals.var_ithpwr_dn9), );
        ...
        (locals.var_lc, locals.var_lc_dn4, locals.var_lc_dn6, locals.var_lc_dn7, locals.var_lc_dn8, locals.var_lc_dn9, ) = (assign43270_e48498, if assign43270_e48496 >= 1e-20 { (-(((12.0 * locals.var_r_dn4) * locals.var_t2) + (assign43270_e48493 * locals.var_t2_dn4))) } else { 0.0 }, if assign43270_e48496 >= 1e-20 { (-(((12.0 * locals.var_r_dn6) * locals.var_t2) + (assign43270_e48493 * locals.var_t2_dn6))) } else { 0.0 }, if assign43270_e48496 >= 1e-20 { (-(((12.0 * locals.var_r_dn7) * locals.var_t2) + (assign43270_e48493 * locals.var_t2_dn7))) } else { 0.0 }, if assign43270_e48496 >= 1e-20 { (-(((12.0 * locals.var_r_dn8) * locals.var_t2) + (assign43270_e48493 * locals.var_t2_dn8))) } else { 0.0 }, if assign43270_e48496 >= 1e-20 { (-(((12.0 * locals.var_r_dn9) * locals.var_t2) + (assign43270_e48493 * locals.var_t2_dn9))) } else { 0.0 }, );

        let assign43280_e48502: f64 = (locals.var_lc * locals.var_lc);
        let assign43280_e48503: f64 = (1.0 / assign43280_e48502);
        (locals.var_lcinv2, locals.var_lcinv2_dn4, locals.var_lcinv2_dn6, locals.var_lcinv2_dn7, locals.var_lcinv2_dn8, locals.var_lcinv2_dn9, ) = (assign43280_e48503, (-(((locals.var_lc_dn4 * locals.var_lc) + (locals.var_lc * locals.var_lc_dn4)) / (assign43280_e48502 * assign43280_e48502))), (-(((locals.var_lc_dn6 * locals.var_lc) + (locals.var_lc * locals.var_lc_dn6)) / (assign43280_e48502 * assign43280_e48502))), (-(((locals.var_lc_dn7 * locals.var_lc) + (locals.var_lc * locals.var_lc_dn7)) / (assign43280_e48502 * assign43280_e48502))), (-(((locals.var_lc_dn8 * locals.var_lc) + (locals.var_lc * locals.var_lc_dn8)) / (assign43280_e48502 * assign43280_e48502))), (-(((locals.var_lc_dn9 * locals.var_lc) + (locals.var_lc * locals.var_lc_dn9)) / (assign43280_e48502 * assign43280_e48502))), );
    ...
    pub(super) fn stamp_transient_block_54(
        ...
        if (locals.var_guard1278 != 0.0) {
            ...
            locals.var_sqrt_zsatexc = assign43350_e48547;
        }
