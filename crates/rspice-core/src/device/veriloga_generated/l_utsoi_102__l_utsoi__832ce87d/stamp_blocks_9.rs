...
impl Instance {
    ...
    if (locals.var_guard559 != 0.0) {
        ...
        let (assign12430_e11690, assign12430_e11690_d_n4, assign12430_e11690_d_n6, assign12430_e11690_d_n7, assign12430_e11690_d_n8, assign12430_e11690_d_n9,) = {
    if (locals.var_guard559 != 0.0) {
        ...
        locals.var_q_dx1_dn4 = assign12430_e11690_d_n4;
        locals.var_q_dx1_dn6 = assign12430_e11690_d_n6;
        locals.var_q_dx1_dn7 = assign12430_e11690_d_n7;
        locals.var_q_dx1_dn8 = assign12430_e11690_d_n8;
        locals.var_q_dx1_dn9 = assign12430_e11690_d_n9;
    ...
    if (locals.var_guard563 != 0.0) {
        ...
        let (assign12700_e11963, assign12700_e11963_d_n4, assign12700_e11963_d_n6, assign12700_e11963_d_n7, assign12700_e11963_d_n8, assign12700_e11963_d_n9,) = {
    if (locals.var_guard563 != 0.0) {
        ...
        (assign12700_e11961, ((locals.var_xg1x_dn4 - locals.var_q1s_dn4) - locals.var_q_x1sat_dn4), ((locals.var_xg1x_dn6 - locals.var_q1s_dn6) - locals.var_q_x1sat_dn6), ((locals.var_xg1x_dn7 - locals.var_q1s_dn7) - locals.var_q_x1sat_dn7), ((locals.var_xg1x_dn8 - locals.var_q1s_dn8) - locals.var_q_x1sat_dn8), ((locals.var_xg1x_dn9 - locals.var_q1s_dn9) - locals.var_q_x1sat_dn9),)
    } else {
        (locals.var_q_dx1, locals.var_q_dx1_dn4, locals.var_q_dx1_dn6, locals.var_q_dx1_dn7, locals.var_q_dx1_dn8, locals.var_q_dx1_dn9,)
    }
};
        locals.var_q_dx1 = assign12700_e11963;
        locals.var_q_dx1_dn4 = assign12700_e11963_d_n4;
        locals.var_q_dx1_dn6 = assign12700_e11963_d_n6;
        locals.var_q_dx1_dn7 = assign12700_e11963_d_n7;
        locals.var_q_dx1_dn8 = assign12700_e11963_d_n8;
        locals.var_q_dx1_dn9 = assign12700_e11963_d_n9;
        locals.var_q_dx1_rv = 0.0;
