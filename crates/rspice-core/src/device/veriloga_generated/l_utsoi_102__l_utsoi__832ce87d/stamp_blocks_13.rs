...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_66(
        ...
        s.b[1296] = (((p[4] > 0.0) && (s.v[89] > 0.0)) && (s.v[714] < 0.0));s.store_scalar(1296, if s.b[1296] { 1.0 } else { 0.0 });
        ...
        s.b[1301] = (((p[4] > 0.0) && (s.v[90] > 0.0)) && (s.v[715] < 0.0));s.store_scalar(1301, if s.b[1301] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_68(
        ...
        s.b[1314] = (p[8] != 0.0);s.store_scalar(1314, if s.b[1314] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_74(
        ...
        if s.b[1604] {s.store_mul_scale_offset(0, A::mul3_scaled_output(s.ad_value(325), A::offset(A::sqrt(A::offset(A::div(s.ad_value(336), s.ad_value(325)), 1.0)), (-1.0)), A::offset(A::mul(s.ad_value(36), s.ad_value(1446)), 1.0), 2.0), A::mul(s.ad_value(37), s.ad_value(1424)), 1.0, 1.0);s.store_mul(1450, 1418, 0);s.store_mul(1451, 1419, 0);s.store_add_mixed_ai(1452, A::add_scaled_product(s.ad_value(1447), 1.0, A::add_scaled_inputs3(s.ad_value(1423), 1.0, s.ad_value(1447), (-1.0), s.ad_value(1450), 1.0), s.ad_value(1448), 1.0), 337);s.store_add_mixed_ai(1453, A::add_scaled_product(s.ad_value(1447), 1.0, A::add_scaled_inputs3(s.ad_value(1434), 1.0, s.ad_value(1447), (-1.0), s.ad_value(1451), 1.0), s.ad_value(1449), 1.0), 337);s.store_add_scaled_inputs3_sqrt_third_mixed_aia(1454, A::add_scaled_product(s.ad_value(1453), 1.0, s.ad_value(25), A::sub(s.ad_value(1452), s.ad_value(1453)), 1.0), 0.5, 221, 0.5, A::offset(A::square(A::sub(A::add_scaled_product(s.ad_value(1453), 1.0, s.ad_value(25), A::sub(s.ad_value(1452), s.ad_value(1453)), 1.0), s.ad_value(221))), 0.01), (-0.5));s.store_add_scaled_inputs3_sqrt_third_mixed_aia(1455, A::add_scaled_product(s.ad_value(1452), 1.0, s.ad_value(26), A::sub(s.ad_value(1453), s.ad_value(1452)), 1.0), 0.5, 221, 0.5, A::offset(A::square(A::sub(A::add_scaled_product(s.ad_value(1452), 1.0, s.ad_value(26), A::sub(s.ad_value(1453), s.ad_value(1452)), 1.0), s.ad_value(221))), 0.01), (-0.5));s.store_div(1456, 1439, 1448);s.store_div(1457, 1440, 1449);s.store_div_from_scalar(1430, 1.0, 1456);s.store_div_from_scalar(1431, 1.0, 1457);s.store_div_from_scalar_add_ad(1458, 1.0, A::offset(s.ad_value(1430), 1.0), s.ad_value(1431));s.store_div_square_rhs(1429, 249, 1443);s.store_div_scaled_offset_numerator_mixed_ia(1426, 1456, 1.0, 1.0, A::offset(s.ad_value(1457), 1.0), 1.0);s.store_ln(1427, 1426);}
    ...
    pub(super) fn stamp_reactive_block_75(
        ...
        if s.b[1604] {s.store_offset_ln_ad(1341, A::div_scaled_product(A::add_scaled_product(s.ad_value(1456), 1.0, s.ad_value(1457), s.ad_value(1339), 1.0), s.ad_value(1428), 1.0, s.ad_value(1429), 1.0), 3.0);s.store_offset_ln_ad(1342, A::div_scaled_product(A::add_scaled_product(s.ad_value(1457), 1.0, s.ad_value(1456), s.ad_value(1338), 1.0), s.ad_value(1428), 1.0, s.ad_value(1429), 1.0), 3.0);}
    ...
    pub(super) fn stamp_reactive_block_76(
        ...
        if (s.b[1604] && s.b[1627]) {s.store_div_mixed_ai(1360, A::add_scaled_products(s.ad_value(1351), s.ad_value(1339), 1.0, s.ad_value(1350), A::add_scaled_inputs(s.ad_value(1359), 1.0, s.ad_value(1354), 0.5), (-1.0)), 1349);}
    ...
    pub(super) fn stamp_reactive_block_78(
        ...
        if (s.b[1604] && s.b[1633]) {s.store_mul_add_scaled_inputs3_offset_rhs_mixed_aii(1373, 1382, A::ln(A::div(s.ad_value(1382), s.ad_value(1429))), 1.0, 1454, (-1.0), 1461, 1.0, 0.0);s.store_add_scaled_product_indices(1374, 1382, 1.0, 1456, 1347, 2.0);s.store_add_scaled_inputs3_indices(1383, 1454, 1.0, 1461, (-1.0), 1341, -1.0);}
        s.b[1634] = ((((s.v[1373] < 0.0) && (s.v[1374] > 0.0)) && (((s.v[1383] + 2.3025850929941) + ((s.v[1456]) as f64).ln()) > 0.0)) || (s.v[1383] > 1.0));s.store_scalar(1634, if s.b[1634] { 1.0 } else { 0.0 });
        ...
        if (s.b[1604] && s.b[1637]) {s.store_mul_add_scaled_inputs3_offset_rhs_mixed_aii(1373, 1382, A::ln(A::div(s.ad_value(1382), s.ad_value(1429))), 1.0, 1454, (-1.0), 1461, 1.0, 0.0);s.store_add_scaled_product_indices(1374, 1382, 1.0, 1456, 1347, 2.0);s.store_add_scaled_inputs3_indices(1383, 1454, 1.0, 1461, (-1.0), 1341, -1.0);}
        s.b[1638] = ((((s.v[1373] < 0.0) && (s.v[1374] > 0.0)) && (((s.v[1383] + 2.3025850929941) + ((s.v[1456]) as f64).ln()) > 0.0)) || (s.v[1383] > 1.0));s.store_scalar(1638, if s.b[1638] { 1.0 } else { 0.0 });
