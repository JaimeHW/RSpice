...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1254]) {
            s.store_offset_ad(727, A::mul_offset_rhs(s.ad_value(0), A::mul_scaled_lhs(s.ad_value(0), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1254])) && (!s.b[1255])) {
            s.store_div_from_scalar_offset_ad(727, 1.80485e-35, A::mul_offset_lhs(A::neg(s.ad_value(0)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(0)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(0)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1256]) {
            s.store_offset_ad(728, A::mul_offset_rhs(s.ad_value(2), A::mul_scaled_lhs(s.ad_value(2), 0.5, A::scale_offset(s.ad_value(2), 0.3333333333333, 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1256])) && (!s.b[1257])) {
            s.store_div_from_scalar_offset_ad(728, 1.80485e-35, A::mul_offset_lhs(A::neg(s.ad_value(2)), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(2)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(2)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if ((((s.b[1245] && s.b[1280]) && (!s.b[1288])) && (!s.b[1289])) && (!s.b[1290])) {
            s.store_scaled_offset_ad(727, A::mul_offset_lhs(s.ad_value(0), (-80.0), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(0), (-80.0)), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1291])) && s.b[1292]) {
            ...
            s.store_ad_value(739, A::add_scaled_offset_product_rhs(s.ad_value(738), 0.5, s.ad_value(741), A::mul(s.ad_value(745), A::add_scaled_offset_product_rhs(A::scaled_offset(s.ad_value(744), 0.25, 0.4), 1.0, s.ad_value(745), s.ad_value(744), 0.125, 0.0285714285714)), 1.0, (-0.1666666666667)));
        }
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1318] && (!s.b[1319])) {
            s.store_ad_value(355, A::div_scaled_inputs(A::offset(A::sub_scaled_inputs(A::offset(s.ad_value(0), p.p16), 0.5, A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(0), (-p.p16), A::offset(s.ad_value(0), (-p.p16))), 1.0)), 0.5), (0.25 / p.p16)), -1.0, s.ad_value(168), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if (s.b[1803] && s.b[1804]) {
            let assign43530_ad_e48767: A = A::add_scaled_inputs3_offset(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5, A::sqrt(A::offset(A::mul_offset_lhs(A::add_scaled_inputs(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5), (-1.0), A::offset(A::add_scaled_inputs(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5), (-1.0))), 1e-40)), -1.0, 1.0);
        ...
        s.store_ad_value(1801, A::mul_offset_lhs_scaled_output(s.ad_value(353), 1.0, A::abs(s.ad_value(354)), (2.0 * 1.602176565e-19)));
