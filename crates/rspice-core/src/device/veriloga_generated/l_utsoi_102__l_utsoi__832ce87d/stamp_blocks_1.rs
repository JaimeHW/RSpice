...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if (s.b[1245] && s.b[1246]) {
            ...
            s.store_ad_value(722, A::add_scaled_products(s.ad_value(71), s.ad_value(2), 1.0, s.ad_value(69), s.ad_value(3), 1.0));
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1254]) {
            s.store_offset_mul_ad(727, s.ad_value(0), A::offset(A::mul_scaled_lhs(s.ad_value(0), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1254])) && (!s.b[1255])) {
            s.store_div_from_scalar_offset_ad(727, 1.80485e-35, A::mul(A::offset(A::neg(s.ad_value(0)), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(0)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(0)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1256]) {
            s.store_offset_mul_ad(728, s.ad_value(2), A::offset(A::mul_scaled_lhs(s.ad_value(2), 0.5, A::scale_offset(s.ad_value(2), 0.3333333333333, 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1256])) && (!s.b[1257])) {
            s.store_div_from_scalar_offset_ad(728, 1.80485e-35, A::mul(A::offset(A::neg(s.ad_value(2)), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(2)), (-80.0)), 0.5, A::scale_offset(A::neg(s.ad_value(2)), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0);
        }
        ...
        if (s.b[1245] && s.b[1246]) {
            s.store_sub_ad(729, A::div_scaled_product(A::mul3(s.ad_value(722), s.ad_value(727), A::ln(s.ad_value(0))), A::offset(s.ad_value(3), 1.0), 1.0, A::offset(s.ad_value(5), 1.0), 1.0), A::div_scaled_product3(s.ad_value(723), s.ad_value(728), A::offset(s.ad_value(3), 1.0), 1.0, A::offset(s.ad_value(5), 1.0), 1.0));
        }
        ...
        if (s.b[1245] && s.b[1263]) {
            ...
            s.store_ad_value(720, A::add_scaled_products(s.ad_value(84), s.ad_value(2), 1.0, s.ad_value(82), s.ad_value(3), 1.0));
            s.store_ad_value(721, A::add_scaled_products(s.ad_value(278), s.ad_value(2), 1.0, s.ad_value(277), s.ad_value(3), 1.0));
            s.store_ad_value(722, A::add_scaled_products(s.ad_value(72), s.ad_value(2), 1.0, s.ad_value(70), s.ad_value(3), 1.0));
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if (s.b[1245] && s.b[1263]) {
            s.store_sub_ad(730, A::div_scaled_product(A::mul3(s.ad_value(722), s.ad_value(727), A::ln(s.ad_value(0))), A::offset(s.ad_value(3), 1.0), 1.0, A::offset(s.ad_value(5), 1.0), 1.0), A::div_scaled_product3(s.ad_value(723), s.ad_value(728), A::offset(s.ad_value(3), 1.0), 1.0, A::offset(s.ad_value(5), 1.0), 1.0));
        }
        ...
        if ((((s.b[1245] && s.b[1280]) && (!s.b[1288])) && (!s.b[1289])) && (!s.b[1290])) {
            s.store_scaled_offset_ad(727, A::mul(A::offset(s.ad_value(0), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(0), (-80.0)), 0.5, A::scale_offset(s.ad_value(0), 0.3333333333333, (((((-80.0)) * (0.3333333333333))) + (1.0)))), 1.0)), 1.0, 5.54062e34);
        }

        if (s.b[1245] && s.b[1280]) {
            s.store_mul_ad_product_rhs(737, 68, s.ad_value(727), A::ln(A::div(A::offset(s.ad_value(725), 1.0), A::offset(s.ad_value(726), 1.0))));
        }
        ...
        if ((s.b[1245] && s.b[1280]) && (!s.b[1291])) {
            ...
            s.store_ad_value(744, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(742), 1.0, s.ad_value(742), 0.5));
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1291])) && s.b[1292]) {
            ...
            s.store_ad_value(739, A::add_scaled_product(s.ad_value(738), 0.5, s.ad_value(741), A::offset(A::mul(s.ad_value(745), A::add_scaled_product(A::scaled_offset(s.ad_value(744), 0.25, 0.4), 1.0, s.ad_value(745), A::offset(s.ad_value(744), 0.125), 0.0285714285714)), 1.0), (-0.1666666666667)));
        }
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1291])) && (!s.b[1292])) {
            ...
            s.store_ad_value(738, A::add_scaled_products(A::mul_sub_from_scalar_lhs(1.0, s.ad_value(742), s.ad_value(0)), s.ad_value(746), 0.5, s.ad_value(742), s.ad_value(3), 0.5));
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1318] && (!s.b[1319])) {
            s.store_ad_value(355, A::div_scaled_inputs(A::offset(A::sub_scaled_inputs(A::offset(s.ad_value(0), p.p16), 0.5, A::sqrt(A::offset(A::mul(A::offset(s.ad_value(0), (-p.p16)), A::offset(s.ad_value(0), (-p.p16))), 1.0)), 0.5), (0.25 / p.p16)), -1.0, s.ad_value(168), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        s.store_mul_scaled_ad_rhs(361, 13, p.p31, A::add_scaled_inputs3(s.ad_value(344), 1.0, s.ad_value(352), 1.0, s.ad_value(354), 1.0));
        ...
        s.store_div_ad_lhs(1783, A::div_scaled_product3(A::mul3(s.ad_value(338), s.ad_value(386), s.ad_value(222)), s.ad_value(1772), s.ad_value(340), 1.0, s.ad_value(341), 1.0), 342);
        ...
        s.store_mul3_lhs(1785, 1783, 1782, 3);
        ...
        if s.b[1802] {
            ...
            s.store_ad_value(1787, A::div_scaled_product(A::mul3(s.ad_value(305), s.ad_value(344), s.ad_value(407)), s.ad_value(219), 1.0, A::mul3(A::offset(A::square(s.ad_value(1786)), 1.0), s.ad_value(1781), s.ad_value(1781)), 1.0));
            s.store_add_ad_rhs(1785, 1785, A::div(s.ad_value(1787), s.ad_value(304)));
        }

        s.store_mul3_affine_lhs(1788, 13, 303, p.p31, 0.0, 1785);
        ...
        if s.b[1803] {
            ...
            s.store_max_with_scalar(3, 2, 1e-40);
            s.store_ad_value(1793, A::div_scaled_product3(s.ad_value(1783), s.ad_value(1781), s.ad_value(1781), 1.0, s.ad_value(3), 1.0));
            s.store_mul3_affine_lhs(1794, 13, 303, p.p31, 0.0, 1793);
        }
        ...
        if (s.b[1803] && s.b[1804]) {
            s.store_mul_ad_product_rhs(1795, 1782, s.ad_value(1778), A::add_scaled_sub_value_product(1.0, s.ad_value(1784), 1.0, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(1777), 1.0, s.ad_value(1779), 19.2), 1.0, s.ad_value(1777), s.ad_value(1784), (-1.0)), s.ad_value(1780), (-1.0)));
            s.store_ad_value(1796, A::div_scaled_product(A::square(s.ad_value(1795)), s.ad_value(1793), 1.0, s.ad_value(1785), 1.0));
        }

        if (s.b[1803] && s.b[1804]) {
            let assign43530_ad_e48767: A = A::add_scaled_inputs3_offset(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5, A::sqrt(A::offset(A::mul(A::offset(A::add_scaled_inputs(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5), (-1.0)), A::offset(A::add_scaled_inputs(s.ad_value(1796), 0.5, A::sqrt(A::offset(A::mul(s.ad_value(1796), s.ad_value(1796)), 1e-40)), 0.5), (-1.0))), 1e-40)), -1.0, 1.0);
        ...
        s.store_mul_sub_from_scalar_rhs(1797, 1788, 1.0, 1796);
        ...
        s.store_mul_scaled_ad_rhs(1776, 13, p.p33, A::max_with_scalar(s.ad_value(0), 0.0));

        s.store_mul_scaled_ad_rhs(1798, 13, ((2.0 * 1.602176565e-19) * p.p31), A::abs(s.ad_value(348)));

        s.store_mul_scaled_ad_rhs(1799, 13, ((2.0 * 1.602176565e-19) * p.p31), A::abs(s.ad_value(349)));

        s.store_scaled_mul_ad(1801, A::offset(s.ad_value(353), 1.0), A::abs(s.ad_value(354)), (2.0 * 1.602176565e-19));

        s.store_ad_value(1800, A::add_scaled_products(s.ad_value(13), A::abs(A::sub(s.ad_value(350), s.ad_value(351))), ((2.0 * 1.602176565e-19) * p.p31), s.ad_value(13), s.ad_value(1801), p.p31));
