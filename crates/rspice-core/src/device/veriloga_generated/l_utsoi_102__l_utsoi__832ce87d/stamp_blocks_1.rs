...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1254]) {
            s.store_offset_mul_ad(727, s.ad_value(0), A::offset(A::mul_scaled_lhs(s.ad_value(0), 0.5, A::offset(A::scale(s.ad_value(0), 0.3333333333333), 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1254])) && (!s.b[1255])) {
            s.store_div_from_scalar_offset_ad(727, 1.80485e-35, A::mul(A::offset(A::neg(s.ad_value(0)), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(0)), (-80.0)), 0.5, A::offset(A::scale(A::offset(A::neg(s.ad_value(0)), (-80.0)), 0.3333333333333), 1.0)), 1.0)), 1.0);
        }
        ...
        if ((s.b[1245] && s.b[1246]) && s.b[1256]) {
            s.store_offset_mul_ad(728, s.ad_value(2), A::offset(A::mul_scaled_lhs(s.ad_value(2), 0.5, A::offset(A::scale(s.ad_value(2), 0.3333333333333), 1.0)), 1.0), 1.0);
        }
        ...
        if (((s.b[1245] && s.b[1246]) && (!s.b[1256])) && (!s.b[1257])) {
            s.store_div_from_scalar_offset_ad(728, 1.80485e-35, A::mul(A::offset(A::neg(s.ad_value(2)), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(A::neg(s.ad_value(2)), (-80.0)), 0.5, A::offset(A::scale(A::offset(A::neg(s.ad_value(2)), (-80.0)), 0.3333333333333), 1.0)), 1.0)), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        if ((((s.b[1245] && s.b[1280]) && (!s.b[1288])) && (!s.b[1289])) && (!s.b[1290])) {
            s.store_scaled_offset_ad(727, A::mul(A::offset(s.ad_value(0), (-80.0)), A::offset(A::mul_scaled_lhs(A::offset(s.ad_value(0), (-80.0)), 0.5, A::offset(A::scale(A::offset(s.ad_value(0), (-80.0)), 0.3333333333333), 1.0)), 1.0)), 1.0, 5.54062e34);
        }
        ...
        if (((s.b[1245] && s.b[1280]) && (!s.b[1291])) && s.b[1292]) {
            ...
            s.store_offset_mul_ad(738, s.ad_value(745), A::add(A::offset(A::scale(s.ad_value(742), 0.3333333333333), 0.1666666666667), A::mul_scaled_lhs(s.ad_value(745), 0.1666666666667, A::offset(A::scale(s.ad_value(742), 0.2), 0.05))), 1.0);
            s.store_sub_scaled_ad_rhs(739, 738, 0.5, A::mul_scaled_lhs(s.ad_value(741), 0.1666666666667, A::offset(A::mul(s.ad_value(745), A::add(A::scale(A::offset(s.ad_value(744), 0.25), 0.4), A::mul_scaled_lhs(s.ad_value(745), 0.0285714285714, A::offset(s.ad_value(744), 0.125)))), 1.0)));
        }
