...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_add_scaled_product_value_ad(114, A::mul_sub_from_scalar_lhs(1.0, A::div_scaled_inputs(s.ad_value(4), 1.0, s.ad_value(66), 2.0), s.ad_value(1)), 1.0, 2, 162, -1.0);
