...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_53(
        ...
        if (s.b[1439] && (s.b[1442] && (!(s.b[1440] || s.b[1441])))) {
            s.copy_ad(134, 135);
            s.store_ad_value(131, A::add_scaled_inputs4(s.ad_value(2094), (-0.5), s.ad_value(2118), ((-1.0) * (-0.5)), s.ad_value(2095), (-0.5), s.ad_value(2119), (-(-0.5))));
    ...
    pub(super) fn stamp_reactive_block_60(
        ...
        while {
            ...
            if (((((((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) && s.b[2540]) && (!s.b[2550])) && (!s.b[2557])) && (!s.b[2558])) {
                ...
                s.store_sqrt_square_add(216, 223, 214);
                s.store_ad_value(217, A::div_scaled_add_product(s.ad_value(215), 0.5, s.ad_value(2549), s.ad_value(223), (2.0 * 0.5), s.ad_value(216), 1.0));
            }
            if (((((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) && s.b[2540]) && (!s.b[2550])) {
