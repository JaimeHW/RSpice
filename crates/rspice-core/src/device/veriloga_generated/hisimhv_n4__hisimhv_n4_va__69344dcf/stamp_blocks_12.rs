...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_192(
        ...
        let mut t12: usize = 0;
        while {
            let t10: f64 = (s.v[421] + 1.0);let t11: f64 = if ((((s.b[3107] && s.b[3108]) && (!s.b[3135])) && s.b[3174]) && (s.v[97] <= t10)) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_193(
        ...
        if ((s.b[3107] && s.b[3108]) && s.b[3192]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 3118);}
        let (t13,) = {
    if ((s.b[3107] && s.b[3108]) && s.b[3192]) {
        ...
        if ((s.b[3107] && s.b[3108]) && s.b[3192]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3111)), s.ad_value(155)), 2.0);}
        ...
        if ((s.b[3107] && s.b[3108]) && s.b[3192]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3111, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t14,) = {
    if ((s.b[3107] && s.b[3108]) && s.b[3192]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_194(
        ...
        let mut t1d: usize = 0;
        while {
            let t1b: f64 = (s.v[421] + 1.0);let t1c: f64 = if (((s.b[3107] && s.b[3108]) && s.b[3192]) && (s.v[97] <= t1b)) { 1.0 } else { 0.0 };
            t1c != 0.0
        } {
    ...
    if s.b[3211] {
        ...
        s.store_scalar(2619, t1e);
        if s.b[3211] {s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scalar(335, (s.v[188] * s.v[635]));}
    ...
    if s.b[3213] {
        ...
        s.store_scalar(2622, t1f);
        if s.b[3213] {s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scale(335, 412, s.v[635]);}
    ...
    pub(super) fn stamp_transient_block_196(
        ...
        if (s.b[3218] && s.b[3219]) {s.store_offset_add_scaled_inputs3_offset_indices(781, 168, 1.0, 87, -1.0, 790, -1.0, (-(-(10.0 * 2.220446049250313e-16))), (10.0 * 2.220446049250313e-16));s.store_square(722, 781);s.store_scalar(723, ((10.0 * 2.220446049250313e-16) * (10.0 * 2.220446049250313e-16)));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t20,) = {
    ...
    if (s.b[3218] && s.b[3219]) {
        ...
        if (s.b[3218] && s.b[3219]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((s.b[3218] && s.b[3219]) && s.b[3220]) && s.b[3221]) {
        ...
        s.store_scalar(720, t22);s.b[3222] = (2.0 == 2.0);s.store_scalar(3222, if s.b[3222] { 1.0 } else { 0.0 });
        let (t23,) = {
    if ((((s.b[3218] && s.b[3219]) && s.b[3220]) && (!s.b[3221])) && s.b[3222]) {
        ...
        s.store_scalar(720, t23);s.b[3223] = (2.0 == 4.0);s.store_scalar(3223, if s.b[3223] { 1.0 } else { 0.0 });
        let (t24,) = {
    if (((((s.b[3218] && s.b[3219]) && s.b[3220]) && (!s.b[3221])) && (!s.b[3222])) && s.b[3223]) {
        ...
        s.store_scalar(720, t24);s.b[3224] = (2.0 == 8.0);s.store_scalar(3224, if s.b[3224] { 1.0 } else { 0.0 });
        let (t25,) = {
    ...
    if ((s.b[3218] && s.b[3219]) && s.b[3220]) {
        ...
        while {
            let t29: f64 = if (((s.b[3218] && s.b[3219]) && s.b[3220]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t29 != 0.0
        } {
            t2a += 1;assert!(t2a <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((s.b[3218] && s.b[3219]) && s.b[3220]) {s.store_sqrt(726, 726);}
            let (t28,) = {
    if ((s.b[3218] && s.b[3219]) && s.b[3220]) {
    ...
    pub(super) fn stamp_transient_block_197(
        ...
        if (s.b[3229] && s.b[3232]) {s.store_offset(336, 847, 1e-25);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_198(
        ...
        if (s.b[3229] && s.b[3235]) {s.store_offset(337, 852, 1e-25);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(853, s.v[825], 154, A::ln_offset_div_scaled_inputs(s.ad_value(334), s.v[827], s.ad_value(337), 1.0, 1.0));s.store_exp_scaled_input_ad(854, A::offset(s.ad_value(676), (-1.0)), p.p535);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_199(
        ...
        if (s.b[3229] && s.b[3235]) {s.store_div_from_scalar_div_from_scalar_ad(855, 1.0, s.v[825], s.ad_value(154));s.store_exp_mul(856, 853, 855);}
        ...
        if (s.b[3250] && s.b[3251]) {s.store_add_ad(885, A::add_scaled_products(s.ad_value(873), A::offset(s.ad_value(335), (-1.0)), 1.0, s.ad_value(334), A::offset(s.ad_value(336), (-1.0)), 1.0), A::scaled_offset(s.ad_value(337), (-1.0), s.v[821]));}
    ...
    pub(super) fn stamp_transient_block_200(
        ...
        if (s.b[3250] && (!s.b[3251])) {s.store_add_ad(885, A::add_scaled_products3(s.ad_value(873), A::offset(s.ad_value(335), (-1.0)), 1.0, s.ad_value(338), A::sub(s.ad_value(860), s.ad_value(848)), 1.0, s.ad_value(334), A::offset(s.ad_value(336), (-1.0)), 1.0), A::scaled_offset(s.ad_value(337), (-1.0), s.v[821]));}
        if (!s.b[3250]) {s.store_scalar(885, 0.0);}
        s.store_scale(346, 874, p.p514);s.store_add_scaled_product_indices(885, 885, 1.0, 346, 860, 1.0);s.b[3253] = (s.v[875] > 0.0);s.store_scalar(3253, if s.b[3253] { 1.0 } else { 0.0 });
        ...
        if (s.b[3253] && s.b[3254]) {s.store_add_ad(887, A::add_scaled_products(s.ad_value(875), A::offset(s.ad_value(335), (-1.0)), 1.0, s.ad_value(334), A::offset(s.ad_value(336), (-1.0)), 1.0), A::scaled_offset(s.ad_value(337), (-1.0), s.v[821]));}
        if (s.b[3253] && (!s.b[3254])) {s.copy_ad(335, 851);s.store_mul3_lhs(338, 875, 850, 335);s.store_add_ad(887, A::add_scaled_products3(s.ad_value(875), A::offset(s.ad_value(335), (-1.0)), 1.0, s.ad_value(338), A::sub(s.ad_value(860), s.ad_value(848)), 1.0, s.ad_value(334), A::offset(s.ad_value(336), (-1.0)), 1.0), A::scaled_offset(s.ad_value(337), (-1.0), s.v[821]));}
        if (!s.b[3253]) {s.store_scalar(887, 0.0);}
        s.store_scale(346, 876, p.p514);s.store_add_scaled_product_indices(887, 887, 1.0, 346, 860, 1.0);s.b[3256] = (p.p48 > 0.0);s.store_scalar(3256, if s.b[3256] { 1.0 } else { 0.0 });s.b[3257] = (s.v[877] > 0.0);s.store_scalar(3257, if s.b[3257] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3256] && s.b[3257]) && s.b[3258]) {s.store_add_ad(889, A::add_scaled_products(s.ad_value(877), A::offset(s.ad_value(335), (-1.0)), 1.0, s.ad_value(334), A::offset(s.ad_value(336), (-1.0)), 1.0), A::scaled_offset(s.ad_value(337), (-1.0), s.v[821]));}
    ...
    pub(super) fn stamp_transient_block_201(
        ...
        if s.b[3256] {s.store_scale(346, 878, p.p514);s.store_add_scaled_product_indices(889, 889, 1.0, 346, 868, 1.0);}
        ...
        s.store_scale(346, 880, p.p537);s.store_add_scaled_product_indices(886, 886, 1.0, 346, 859, 1.0);s.b[3263] = (s.v[881] > 0.0);s.store_scalar(3263, if s.b[3263] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_202(
        ...
        s.store_scale(346, 882, p.p537);s.store_add_scaled_product_indices(888, 888, 1.0, 346, 859, 1.0);s.b[3266] = (p.p48 > 0.0);s.store_scalar(3266, if s.b[3266] { 1.0 } else { 0.0 });s.b[3267] = (s.v[883] > 0.0);s.store_scalar(3267, if s.b[3267] { 1.0 } else { 0.0 });
        ...
        if s.b[3266] {s.store_scale(346, 884, p.p537);s.store_add_scaled_product_indices(890, 890, 1.0, 346, 867, 1.0);}
    ...
    pub(super) fn stamp_transient_block_204(
        ...
        s.store_scaled_add(862, 886, 888, s.v[365]);s.store_scaled_add(861, 885, 887, s.v[365]);s.b[3296] = (p.p48 > 0.0);s.store_scalar(3296, if s.b[3296] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_206(
        ...
        if s.b[3297] {s.store_offset_sub_from_scalar_ad(781, p.p545, s.ad_value(915), (-1e-7));s.store_scalar(782, ((4.0 * p.p545) * 1e-7));}
        if s.b[3297] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (((s.b[3307] && s.b[3308]) && s.b[3309]) && s.b[3310]) {
        ...
        s.b[3316] = (p.p48 > 0.0);s.store_scalar(3316, if s.b[3316] { 1.0 } else { 0.0 });
        ...
        if ((s.v[81] != 0.0) && s.b[3317]) {s.store_scalar(346, p.p270);s.store_scalar(344, p.p271);s.copy_ad(337, 170);s.store_mul_product3_indices(335, 337, 346, 344, 337, 1.0);s.store_offset_add_ad(336, A::mul3(s.ad_value(253), s.ad_value(127), s.ad_value(346)), A::mul3(s.ad_value(344), s.ad_value(337), s.ad_value(337)), 1e-25);s.store_div(306, 335, 336);}
        if ((s.v[81] != 0.0) && (!s.b[3317])) {s.store_scalar(306, p.p270);}
