...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_192(
        ...
        if ((s.v[2621] != 0.0) && s.b[2960]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 2886);}
        let (t0,) = {
    if ((s.v[2621] != 0.0) && s.b[2960]) {
        ...
        if ((s.v[2621] != 0.0) && s.b[2960]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2879)), s.ad_value(155)), 2.0);}
        ...
        if (((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2961])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
        ...
        if ((s.v[2621] != 0.0) && s.b[2960]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 2879, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t1,) = {
    if ((s.v[2621] != 0.0) && s.b[2960]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_193(
        ...
        let mut ta: usize = 0;
        while {
            let t8: f64 = (s.v[421] + 1.0);let t9: f64 = if (((s.v[2621] != 0.0) && s.b[2960]) && (s.v[97] <= t8)) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    pub(super) fn stamp_transient_block_194(
        ...
        if (((s.v[2621] != 0.0) && s.b[2975]) && s.b[2976]) {s.store_sqrt_offset_square_offset(782, 2880, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(2880), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 2880, p[137], 782, 0.5);}
    ...
    if (s.b[2986] && s.b[2990]) {
        ...
        s.store_scalar(2619, tc);
        if (s.b[2986] && s.b[2990]) {s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_195(
        ...
        if (s.b[2986] && s.b[2990]) {s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
    ...
    if ((s.b[2987] && (!s.b[2986])) && s.b[2991]) {
        ...
        s.store_scalar(2621, td);
        if ((s.b[2987] && (!s.b[2986])) && s.b[2991]) {s.store_sub(395, 734, 735);s.store_neg(396, 735);}
    ...
    if ((s.b[2988] && (!(s.b[2986] || s.b[2987]))) && s.b[2992]) {
        ...
        s.store_scalar(2622, tf);
        if ((s.b[2988] && (!(s.b[2986] || s.b[2987]))) && s.b[2992]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        ...
        if ((((s.b[2988] && (!(s.b[2986] || s.b[2987]))) && s.b[2992]) && s.b[2993]) && s.b[2994]) {s.store_sqrt_offset_square_offset(782, 396, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 396, p[137], 782, 0.5);}
    ...
    if ((s.b[2989] && (!((s.b[2986] || s.b[2987]) || s.b[2988]))) && s.b[2997]) {
        ...
        s.store_scalar(2621, t10);
        if ((s.b[2989] && (!((s.b[2986] || s.b[2987]) || s.b[2988]))) && s.b[2997]) {s.store_sub(395, 734, 735);s.store_sub(396, 733, 735);}
        if (s.v[2621] != 0.0) {s.store_scalar(3005, 0.4);}
        let (t11,) = {
    if (s.v[2621] != 0.0) {
        (0.0,)
    } else {
    ...
    if (s.v[2621] != 0.0) {
        ...
        if (s.v[2621] != 0.0) {s.store_scalar(3007, 0.0);s.store_scalar(3008, 0.0);s.store_mul_scaled_ln_ad_rhs(3003, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(3003), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2621] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (s.v[2621] != 0.0) {
        ...
        if (s.v[2621] != 0.0) {s.store_scalar(2999, 0.0);s.store_primal_scale(3000, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
        ...
        let mut t19: usize = 0;
        while {
            let t18: f64 = if (((s.v[2621] != 0.0) && (!s.b[3017])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t18 != 0.0
        } {
            t19 += 1;
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t1a,) = {
    ...
    if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {s.store_scalar(770, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_197(
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && s.b[3020]) {
        ...
        s.store_scalar(720, t1c);s.b[3021] = (1.0 == 2.0);s.store_scalar(3021, if s.b[3021] { 1.0 } else { 0.0 });
        let (t1d,) = {
    if ((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (!s.b[3020])) && s.b[3021]) {
        ...
        s.store_scalar(720, t1d);s.b[3022] = (1.0 == 4.0);s.store_scalar(3022, if s.b[3022] { 1.0 } else { 0.0 });
        let (t1e,) = {
    if (((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (!s.b[3020])) && (!s.b[3021])) && s.b[3022]) {
        ...
        s.store_scalar(720, t1e);s.b[3023] = (1.0 == 8.0);s.store_scalar(3023, if s.b[3023] { 1.0 } else { 0.0 });
        let (t1f,) = {
    ...
    if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) {
        ...
        while {
            let t23: f64 = if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t23 != 0.0
        } {
            t24 += 1;
            ...
            if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) {s.store_sqrt(726, 726);}
            let (t22,) = {
    if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) {
    ...
    if ((s.v[2621] != 0.0) && (s.v[406] != 0.0)) {
        ...
        s.store_scalar(403, t28);s.b[3024] = (s.v[402] < s.v[403]);s.store_scalar(3024, if s.b[3024] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && (!s.b[3026])) {s.store_offset_div_scaled_offset_numerator(332, A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_198(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && (!s.b[3026])) {s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3027]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) {s.store_offset_add(442, 402, 397, 0.1);s.store_mul(222, 405, 229);s.store_mul(443, 405, 229);s.store_mul(334, 156, 213);s.store_mul(444, 154, 442);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_199(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) {s.store_add_scaled_inputs_product_mixed_aaii(447, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), 1.0, A::ln(A::mul(s.ad_value(405), s.ad_value(334))), (-1.0), 154, 397, 1.0);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) {s.store_sub(444, 444, 447);s.store_add_scaled_inputs(444, 444, 1.0, 154, 0.1);s.store_sub_ad(335, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), A::ln(A::mul(s.ad_value(405), s.ad_value(334))));s.store_add_scaled_product_indices(446, 335, 1.0, 154, 397, 1.0);}
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) {
            if (s.v[446] >= 0.0) {
            } else {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) {s.store_add_scaled_inputs3_indices(781, 445, 1.0, 446, (-1.0), 446, 0.2);s.store_square(722, 781);s.store_scaled_mul(723, 446, 446, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t29,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) && s.b[3033]) {
        ...
        s.store_scalar(720, t2b);s.b[3034] = (2.0 == 2.0);s.store_scalar(3034, if s.b[3034] { 1.0 } else { 0.0 });
        let (t2c,) = {
    if ((((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) && (!s.b[3033])) && s.b[3034]) {
        ...
        s.store_scalar(720, t2c);s.b[3035] = (2.0 == 4.0);s.store_scalar(3035, if s.b[3035] { 1.0 } else { 0.0 });
        let (t2d,) = {
    if (((((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) && (!s.b[3033])) && (!s.b[3034])) && s.b[3035]) {
        ...
        s.store_scalar(720, t2d);s.b[3036] = (2.0 == 8.0);s.store_scalar(3036, if s.b[3036] { 1.0 } else { 0.0 });
        let (t2e,) = {
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) {
        ...
        while {
            let t32: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t32 != 0.0
        } {
            t33 += 1;
            ...
            if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) {s.store_sqrt(726, 726);}
            let (t31,) = {
    if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3028]) && s.b[3030]) && s.b[3031]) && s.b[3032]) {
    ...
    pub(super) fn stamp_transient_block_200(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3037]) && (!s.b[3038])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3037]) && s.b[3042]) {
        let t34: f64 = (s.v[3006] + 1.0);
        (t34,)
    } else {
        (s.v[3006],)
    }
};
        s.store_scalar(3006, t35);
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3037]) && s.b[3042]) {s.copy_ad(116, 447);}
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) {s.store_add_scaled_inputs3_indices(781, 3044, 1.0, 386, (-1.0), 386, 0.1);s.store_square(722, 781);s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t36,) = {
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) {
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) && s.b[3049]) {
        ...
        s.store_scalar(720, t38);s.b[3050] = (2.0 == 2.0);s.store_scalar(3050, if s.b[3050] { 1.0 } else { 0.0 });
        let (t39,) = {
    if (((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) && (!s.b[3049])) && s.b[3050]) {
        ...
        s.store_scalar(720, t39);s.b[3051] = (2.0 == 4.0);s.store_scalar(3051, if s.b[3051] { 1.0 } else { 0.0 });
        let (t3a,) = {
    if ((((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) && (!s.b[3049])) && (!s.b[3050])) && s.b[3051]) {
        ...
        s.store_scalar(720, t3a);s.b[3052] = (2.0 == 8.0);s.store_scalar(3052, if s.b[3052] { 1.0 } else { 0.0 });
        let (t3b,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) {
        ...
        while {
            let t3f: f64 = if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t3f != 0.0
        } {
            t40 += 1;
            ...
            if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) {s.store_sqrt(726, 726);}
            let (t3e,) = {
    if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) && s.b[3048]) {
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3053]) {
        let t41: f64 = (s.v[3006] + 2.0);
        (t41,)
    } else {
        (s.v[3006],)
    }
};
        s.store_scalar(3006, t42);
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[3024])) && (!s.b[3046])) && s.b[3054]) {
        let t43: f64 = (s.v[3006] + 2.0);
        (t43,)
    } else {
        (s.v[3006],)
    }
};
        s.store_scalar(3006, t44);s.b[3055] = (s.v[3006] >= 2.0);s.store_scalar(3055, if s.b[3055] { 1.0 } else { 0.0 });
        ...
        s.b[3056] = (p[33] == 2.0);s.store_scalar(3056, if s.b[3056] { 1.0 } else { 0.0 });s.b[3057] = ((s.v[404] > (s.v[3045] - 0.1)) && (0.1 >= 0.0));s.store_scalar(3057, if s.b[3057] { 1.0 } else { 0.0 });
        if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) {s.store_offset_sub(781, 404, 3045, 0.1);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t45,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) && s.b[3059]) {
        ...
        s.store_scalar(720, t47);s.b[3060] = (2.0 == 2.0);s.store_scalar(3060, if s.b[3060] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if ((((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) && (!s.b[3059])) && s.b[3060]) {
        ...
        s.store_scalar(720, t48);s.b[3061] = (2.0 == 4.0);s.store_scalar(3061, if s.b[3061] { 1.0 } else { 0.0 });
        let (t49,) = {
    if (((((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) && (!s.b[3059])) && (!s.b[3060])) && s.b[3061]) {
        ...
        s.store_scalar(720, t49);s.b[3062] = (2.0 == 8.0);s.store_scalar(3062, if s.b[3062] { 1.0 } else { 0.0 });
        let (t4a,) = {
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) {
        ...
        while {
            let t4e: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4e != 0.0
        } {
            t4f += 1;
            ...
            if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) {s.store_sqrt(726, 726);}
            let (t4d,) = {
    if ((((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3055]) && s.b[3056]) && s.b[3057]) && s.b[3058]) {
        ...
        s.b[3063] = (p[33] == 1.0);s.store_scalar(3063, if s.b[3063] { 1.0 } else { 0.0 });
        let (t50,) = {
    if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3000)), s.ad_value(155)), 2.0);}
        s.b[3064] = (s.v[411] > 0.0);s.store_scalar(3064, if s.b[3064] { 1.0 } else { 0.0 });
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) && s.b[3064]) {s.store_sub_from_scalar(336, p[334], 411);}
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) && (!s.b[3064])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) && (!s.b[3064])) {s.store_scaled_sqrt_mul(600, 651, 336, p[432]);s.store_sub_from_scalar(336, p[334], 600);}
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p[334] * 0.01)) * (p[334] * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3000, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t51,) = {
    if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_203(
        ...
        let mut t59: usize = 0;
        while {
            let t57: f64 = (s.v[421] + 1.0);let t58: f64 = if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) && (s.v[97] <= t57)) { 1.0 } else { 0.0 };
            t58 != 0.0
        } {
            t59 += 1;
    ...
    pub(super) fn stamp_transient_block_204(
        ...
        s.b[3081] = (p[33] == 4.0);s.store_scalar(3081, if s.b[3081] { 1.0 } else { 0.0 });
        if ((s.v[2621] != 0.0) && s.b[3081]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 3007);}
        let (t5a,) = {
    if ((s.v[2621] != 0.0) && s.b[3081]) {
        ...
        if ((s.v[2621] != 0.0) && s.b[3081]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3000)), s.ad_value(155)), 2.0);}
        s.b[3082] = (s.v[411] > 0.0);s.store_scalar(3082, if s.b[3082] { 1.0 } else { 0.0 });
        if (((s.v[2621] != 0.0) && s.b[3081]) && s.b[3082]) {s.store_sub_from_scalar(336, p[334], 411);}
        if (((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3082])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
        ...
        if (((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3082])) {s.store_scaled_sqrt_mul(600, 651, 336, p[432]);s.store_sub_from_scalar(336, p[334], 600);}
        if ((s.v[2621] != 0.0) && s.b[3081]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p[334] * 0.01)) * (p[334] * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        ...
        if ((s.v[2621] != 0.0) && s.b[3081]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3000, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t5b,) = {
    if ((s.v[2621] != 0.0) && s.b[3081]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_205(
        ...
        let mut t64: usize = 0;
        while {
            let t62: f64 = (s.v[421] + 1.0);let t63: f64 = if (((s.v[2621] != 0.0) && s.b[3081]) && (s.v[97] <= t62)) { 1.0 } else { 0.0 };
            t63 != 0.0
        } {
            t64 += 1;
    ...
    pub(super) fn stamp_transient_block_206(
        ...
        s.b[3097] = (p[55] == 0.0);s.store_scalar(3097, if s.b[3097] { 1.0 } else { 0.0 });s.b[3098] = (p[50] == 0.0);s.store_scalar(3098, if s.b[3098] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2621] != 0.0) && s.b[3096]) && s.b[3097]) {s.store_sqrt_offset_square_offset(782, 3001, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(3001), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 3001, p[137], 782, 0.5);}
        ...
        if (((s.v[2621] != 0.0) && s.b[3096]) && s.b[3097]) {s.store_scaled_sqrt_mul(600, 651, 336, p[432]);s.store_add_scaled_inputs3_indices(781, 407, 1.0, 600, (-1.0), 407, (-0.1));s.store_scaled_mul(782, 407, 407, (4.0 * 0.1));}
        ...
        s.b[3100] = (4.0 == 1.0);s.store_scalar(3100, if s.b[3100] { 1.0 } else { 0.0 });s.b[3101] = (4.0 == 2.0);s.store_scalar(3101, if s.b[3101] { 1.0 } else { 0.0 });s.b[3102] = (4.0 == 3.0);s.store_scalar(3102, if s.b[3102] { 1.0 } else { 0.0 });s.b[3103] = (4.0 == 4.0);s.store_scalar(3103, if s.b[3103] { 1.0 } else { 0.0 });s.b[3104] = (p[55] == 1.0);s.store_scalar(3104, if s.b[3104] { 1.0 } else { 0.0 });
        ...
        s.b[3105] = (p[55] == 1.0);s.store_scalar(3105, if s.b[3105] { 1.0 } else { 0.0 });
        ...
        s.b[3106] = (p[430] == 0.0);s.store_scalar(3106, if s.b[3106] { 1.0 } else { 0.0 });
        ...
        s.b[3107] = (p[430] > 0.0);s.store_scalar(3107, if s.b[3107] { 1.0 } else { 0.0 });
        let (t65,) = {
    if s.b[3107] {
        (1.0,)
    } else {
        ...
        s.store_scalar(406, t65);s.b[3108] = (((p[35] == 1.0) && (p[63] > 0.0)) && (s.v[459] > 0.0));s.store_scalar(3108, if s.b[3108] { 1.0 } else { 0.0 });
        if (s.b[3107] && s.b[3108]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, 0.0);s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_scalar(3116, 0.4);}
        let (t66,) = {
    if (s.b[3107] && s.b[3108]) {
        ...
        s.store_scalar(3117, t66);
        if (s.b[3107] && s.b[3108]) {s.store_scalar(223, 0.0);s.store_scalar(214, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_207(
        ...
        if (s.b[3107] && s.b[3108]) {s.store_scalar(216, 0.0);s.store_scalar(232, 0.0);s.store_scalar(236, 0.0);s.store_scalar(233, 0.0);s.store_scalar(217, 0.0);s.store_scalar(420, 0.0);s.store_scalar(215, 0.0);s.store_scalar(447, 0.0);s.store_scalar(445, 0.0);s.store_scalar(446, 0.0);}
        let (t68,) = {
    if (s.b[3107] && s.b[3108]) {
        let t67: f64 = (-1.0);
        (t67,)
        ...
        if (s.b[3107] && s.b[3108]) {s.store_scalar(3118, 0.0);s.store_scalar(3119, 0.0);s.store_mul_scaled_ln_ad_rhs(3114, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(3114), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.b[3107] && s.b[3108]) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if (s.b[3107] && s.b[3108]) {s.store_div(212, 410, 413);s.store_square(213, 212);s.store_sub_from_scalar(402, s.v[458], 395);}
        let (t6c,) = {
    if (s.b[3107] && s.b[3108]) {
        ...
        if (s.b[3107] && s.b[3108]) {s.store_scalar(3110, 0.0);s.store_primal_scale(3111, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
