...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_31(
        ...
        if s.b[1427] {s.store_sqrt_offset_square_offset(782, 182, (-1.0), ((4.0 * 0.05) * 0.05));s.store_scaled_offset_ad(340, A::div_scaled_offset_numerator(s.ad_value(182), 1.0, (-1.0), s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(182, 182, (-1.0), 782, 0.5);}
