...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        s.store_scaled_mul(335, 1432, 790, 0.5);s.store_scale(781, 335, (2.0 * 1.0 / (p[262])));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(1433, p[262], 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);s.b[1438] = (s.v[1433] < 1e-12);s.store_scalar(1438, if s.b[1438] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        s.b[1440] = (p[42] == 1.0);s.store_scalar(1440, if s.b[1440] { 1.0 } else { 0.0 });s.b[1441] = (p[42] == 2.0);s.store_scalar(1441, if s.b[1441] { 1.0 } else { 0.0 });s.b[1442] = (p[42] == 3.0);s.store_scalar(1442, if s.b[1442] { 1.0 } else { 0.0 });
