...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        s.store_scaled_mul(335, 1432, 790, 0.5);s.store_scale(781, 335, (2.0 * 1.0 / (p.p262)));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(1433, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);s.b[1438] = (s.v[1433] < 1e-12);s.store_scalar(1438, if s.b[1438] { 1.0 } else { 0.0 });
        if s.b[1438] {s.store_scalar(1433, 1e-12);}
        s.store_add(1434, 1431, 1433);s.store_add_scaled_inputs(1435, 790, 1.0, 1433, 2.0);s.store_add(1436, 791, 1433);s.store_add_scaled_inputs3_offset_indices(85, 791, 1.0, 120, 1.0, 182, -1.0, (-s.v[160]));let t0: f64 = (s.v[160] - s.v[120]);let t1: f64 = (t0 + s.v[182]);let t2: f64 = (t1 + s.v[1431]);s.store_scalar(86, t2);s.b[1439] = (s.v[963] != 0.0);s.store_scalar(1439, if s.b[1439] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_33(
        ...
        s.b[1440] = (p.p42 == 1.0);s.store_scalar(1440, if s.b[1440] { 1.0 } else { 0.0 });s.b[1441] = (p.p42 == 2.0);s.store_scalar(1441, if s.b[1441] { 1.0 } else { 0.0 });s.b[1442] = (p.p42 == 3.0);s.store_scalar(1442, if s.b[1442] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        let mut t24: usize = 0;
        while {
            let t22: f64 = (150.0 + 1.0);let t23: f64 = if (((s.b[1439] && s.b[1440]) && s.b[1555]) && (s.v[97] <= t22)) { 1.0 } else { 0.0 };
            t23 != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1556]) && s.b[1557]) && s.b[1558]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6);s.b[1559] = (2.0 == 2.0);s.store_scalar(1559, if s.b[1559] { 1.0 } else { 0.0 });
            let (t7,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1556]) && s.b[1557]) && (!s.b[1558])) && s.b[1559]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t7);s.b[1560] = (2.0 == 4.0);s.store_scalar(1560, if s.b[1560] { 1.0 } else { 0.0 });
            let (t8,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1556]) && s.b[1557]) && (!s.b[1558])) && (!s.b[1559])) && s.b[1560]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t8);s.b[1561] = (2.0 == 8.0);s.store_scalar(1561, if s.b[1561] { 1.0 } else { 0.0 });
            let (t9,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1556]) && s.b[1557]) {
        ...
        (s.v[719],)
            ...
            while {
                let td: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1556]) && s.b[1557]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                td != 0.0
            } {
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1562]) && s.b[1563]) && s.b[1564]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t11);s.b[1565] = (2.0 == 2.0);s.store_scalar(1565, if s.b[1565] { 1.0 } else { 0.0 });
            let (t12,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1562]) && s.b[1563]) && (!s.b[1564])) && s.b[1565]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t12);s.b[1566] = (2.0 == 4.0);s.store_scalar(1566, if s.b[1566] { 1.0 } else { 0.0 });
            let (t13,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1562]) && s.b[1563]) && (!s.b[1564])) && (!s.b[1565])) && s.b[1566]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t13);s.b[1567] = (2.0 == 8.0);s.store_scalar(1567, if s.b[1567] { 1.0 } else { 0.0 });
            let (t14,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1562]) && s.b[1563]) {
        ...
        (s.v[719],)
            ...
            while {
                let t18: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1562]) && s.b[1563]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t18 != 0.0
            } {
    ...
    if ((s.b[1439] && s.b[1440]) && s.b[1555]) {
        ...
        s.store_scalar(1505, t25);s.b[1570] = (s.v[85] > s.v[1462]);s.store_scalar(1570, if s.b[1570] { 1.0 } else { 0.0 });
        let (t26,) = {
    if (((s.b[1439] && s.b[1440]) && s.b[1555]) && s.b[1570]) {
        ...
        s.store_scalar(1475, t26);s.b[1571] = (s.v[85] > s.v[1505]);s.store_scalar(1571, if s.b[1571] { 1.0 } else { 0.0 });
        let (t27,) = {
    ...
    if ((s.b[1439] && s.b[1440]) && s.b[1573]) {
        let t2c: f64 = (-s.v[961]);let t2d: f64 = (t2c + s.v[1431]);let t2e: f64 = (s.v[335]).sqrt();let t2f: f64 = (t2e / s.v[185]);let t30: f64 = (t2d - t2f);
        (t30,)
    } else {
        (s.v[1451],)
    }
};
        s.store_scalar(1451, t31);
        let (t34,) = {
    if ((s.b[1439] && s.b[1440]) && (!s.b[1573])) {
        let t32: f64 = (-s.v[961]);let t33: f64 = (t32 + s.v[1431]);
        (t33,)
    } else {
        (s.v[1451],)
    }
};
        s.store_scalar(1451, t34);s.b[1574] = (s.v[85] > s.v[1462]);s.store_scalar(1574, if s.b[1574] { 1.0 } else { 0.0 });
    ...
    if (((((s.b[1439] && s.b[1440]) && (!s.b[1574])) && (!s.b[1576])) && s.b[1577]) && s.b[1579]) {
        ...
        while {
            let t3e: f64 = (150.0 + 1.0);let t3f: f64 = if ((((((s.b[1439] && s.b[1440]) && (!s.b[1574])) && (!s.b[1576])) && s.b[1577]) && s.b[1579]) && (s.v[97] <= t3e)) { 1.0 } else { 0.0 };
            t3f != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && (!s.b[1574])) && (!s.b[1576])) && (!s.b[1577])) && s.b[1586]) {
        ...
        while {
            let t48: f64 = (s.v[421] + 1.0);let t49: f64 = if ((((((s.b[1439] && s.b[1440]) && (!s.b[1574])) && (!s.b[1576])) && (!s.b[1577])) && s.b[1586]) && (s.v[97] <= t48)) { 1.0 } else { 0.0 };
            t49 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        let mut t79: usize = 0;
        while {
            let t77: f64 = (150.0 + 1.0);let t78: f64 = if ((s.b[1439] && s.b[1440]) && (s.v[97] <= t77)) { 1.0 } else { 0.0 };
            t78 != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1590]) && s.b[1591]) && s.b[1592]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t62);s.b[1593] = (2.0 == 2.0);s.store_scalar(1593, if s.b[1593] { 1.0 } else { 0.0 });
            let (t63,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1590]) && s.b[1591]) && (!s.b[1592])) && s.b[1593]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t63);s.b[1594] = (2.0 == 4.0);s.store_scalar(1594, if s.b[1594] { 1.0 } else { 0.0 });
            let (t64,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1590]) && s.b[1591]) && (!s.b[1592])) && (!s.b[1593])) && s.b[1594]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t64);s.b[1595] = (2.0 == 8.0);s.store_scalar(1595, if s.b[1595] { 1.0 } else { 0.0 });
            let (t65,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1590]) && s.b[1591]) {
        ...
        (s.v[719],)
            ...
            while {
                let t69: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1590]) && s.b[1591]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t69 != 0.0
            } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1596]) && s.b[1597]) && s.b[1598]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6d);s.b[1599] = (2.0 == 2.0);s.store_scalar(1599, if s.b[1599] { 1.0 } else { 0.0 });
            let (t6e,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1596]) && s.b[1597]) && (!s.b[1598])) && s.b[1599]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6e);s.b[1600] = (2.0 == 4.0);s.store_scalar(1600, if s.b[1600] { 1.0 } else { 0.0 });
            let (t6f,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1596]) && s.b[1597]) && (!s.b[1598])) && (!s.b[1599])) && s.b[1600]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6f);s.b[1601] = (2.0 == 8.0);s.store_scalar(1601, if s.b[1601] { 1.0 } else { 0.0 });
            let (t70,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1596]) && s.b[1597]) {
        ...
        (s.v[719],)
            ...
            while {
                let t74: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1596]) && s.b[1597]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t74 != 0.0
            } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1603]) && s.b[1604]) && s.b[1605]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t52);s.b[1606] = (4.0 == 2.0);s.store_scalar(1606, if s.b[1606] { 1.0 } else { 0.0 });
            let (t53,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1603]) && s.b[1604]) && (!s.b[1605])) && s.b[1606]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t53);s.b[1607] = (4.0 == 4.0);s.store_scalar(1607, if s.b[1607] { 1.0 } else { 0.0 });
            let (t54,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1603]) && s.b[1604]) && (!s.b[1605])) && (!s.b[1606])) && s.b[1607]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t54);s.b[1608] = (4.0 == 8.0);s.store_scalar(1608, if s.b[1608] { 1.0 } else { 0.0 });
            let (t55,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1603]) && s.b[1604]) {
        ...
        (s.v[719],)
            ...
            while {
                let t59: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1603]) && s.b[1604]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t59 != 0.0
            } {
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1612]) && s.b[1613]) && s.b[1614]) && s.b[1615]) {
        ...
        s.store_scalar(720, t7c);s.b[1616] = (2.0 == 2.0);s.store_scalar(1616, if s.b[1616] { 1.0 } else { 0.0 });
        let (t7d,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1612]) && s.b[1613]) && s.b[1614]) && (!s.b[1615])) && s.b[1616]) {
        ...
        s.store_scalar(720, t7d);s.b[1617] = (2.0 == 4.0);s.store_scalar(1617, if s.b[1617] { 1.0 } else { 0.0 });
        let (t7e,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1612]) && s.b[1613]) && s.b[1614]) && (!s.b[1615])) && (!s.b[1616])) && s.b[1617]) {
        ...
        s.store_scalar(720, t7e);s.b[1618] = (2.0 == 8.0);s.store_scalar(1618, if s.b[1618] { 1.0 } else { 0.0 });
        let (t7f,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1612]) && s.b[1613]) && s.b[1614]) {
        ...
        while {
            let t83: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1612]) && s.b[1613]) && s.b[1614]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t83 != 0.0
        } {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) {
        ...
        if (((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_40(
        s: &mut Scratch,
    ) {
        if (((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) {s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) && s.b[1621]) && s.b[1622]) {
        ...
        s.store_scalar(720, t87);s.b[1623] = (2.0 == 2.0);s.store_scalar(1623, if s.b[1623] { 1.0 } else { 0.0 });
        let (t88,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) && s.b[1621]) && (!s.b[1622])) && s.b[1623]) {
        ...
        s.store_scalar(720, t88);s.b[1624] = (2.0 == 4.0);s.store_scalar(1624, if s.b[1624] { 1.0 } else { 0.0 });
        let (t89,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) && s.b[1621]) && (!s.b[1622])) && (!s.b[1623])) && s.b[1624]) {
        ...
        s.store_scalar(720, t89);s.b[1625] = (2.0 == 8.0);s.store_scalar(1625, if s.b[1625] { 1.0 } else { 0.0 });
        let (t8a,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) && s.b[1621]) {
        ...
        while {
            let t8e: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1619]) && s.b[1620]) && s.b[1621]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8e != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1627]) && s.b[1628]) && s.b[1629]) {
        ...
        s.store_scalar(720, t92);s.b[1630] = (2.0 == 2.0);s.store_scalar(1630, if s.b[1630] { 1.0 } else { 0.0 });
        let (t93,) = {
    if ((((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1627]) && s.b[1628]) && (!s.b[1629])) && s.b[1630]) {
        ...
        s.store_scalar(720, t93);s.b[1631] = (2.0 == 4.0);s.store_scalar(1631, if s.b[1631] { 1.0 } else { 0.0 });
        let (t94,) = {
    if (((((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1627]) && s.b[1628]) && (!s.b[1629])) && (!s.b[1630])) && s.b[1631]) {
        ...
        s.store_scalar(720, t94);s.b[1632] = (2.0 == 8.0);s.store_scalar(1632, if s.b[1632] { 1.0 } else { 0.0 });
        let (t95,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1627]) && s.b[1628]) {
        ...
        while {
            let t99: f64 = if (((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1627]) && s.b[1628]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t99 != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1633]) && s.b[1634]) && s.b[1635]) {
        ...
        s.store_scalar(720, t9d);s.b[1636] = (2.0 == 2.0);s.store_scalar(1636, if s.b[1636] { 1.0 } else { 0.0 });
        let (t9e,) = {
    ...
    if (((((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1633]) && s.b[1634]) && (!s.b[1635])) && (!s.b[1636])) && s.b[1637]) {
        ...
        s.store_scalar(720, t9f);s.b[1638] = (2.0 == 8.0);s.store_scalar(1638, if s.b[1638] { 1.0 } else { 0.0 });
        let (ta0,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1633]) && s.b[1634]) {
        ...
        while {
            let ta4: f64 = if (((((s.b[1439] && s.b[1440]) && (!s.b[1619])) && s.b[1633]) && s.b[1634]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta4 != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1639]) && s.b[1640]) && s.b[1641]) {
        ...
        s.store_scalar(720, ta8);s.b[1642] = (2.0 == 2.0);s.store_scalar(1642, if s.b[1642] { 1.0 } else { 0.0 });
        let (ta9,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1639]) && s.b[1640]) && (!s.b[1641])) && s.b[1642]) {
        ...
        s.store_scalar(720, ta9);s.b[1643] = (2.0 == 4.0);s.store_scalar(1643, if s.b[1643] { 1.0 } else { 0.0 });
        let (taa,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1639]) && s.b[1640]) && (!s.b[1641])) && (!s.b[1642])) && s.b[1643]) {
        ...
        s.store_scalar(720, taa);s.b[1644] = (2.0 == 8.0);s.store_scalar(1644, if s.b[1644] { 1.0 } else { 0.0 });
        let (tab,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1639]) && s.b[1640]) {
        ...
        while {
            let taf: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1639]) && s.b[1640]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            taf != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1645]) && s.b[1646]) && s.b[1647]) {
        ...
        s.store_scalar(720, tb3);s.b[1648] = (2.0 == 2.0);s.store_scalar(1648, if s.b[1648] { 1.0 } else { 0.0 });
        let (tb4,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1645]) && s.b[1646]) && (!s.b[1647])) && s.b[1648]) {
        ...
        s.store_scalar(720, tb4);s.b[1649] = (2.0 == 4.0);s.store_scalar(1649, if s.b[1649] { 1.0 } else { 0.0 });
        let (tb5,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1645]) && s.b[1646]) && (!s.b[1647])) && (!s.b[1648])) && s.b[1649]) {
        ...
        s.store_scalar(720, tb5);s.b[1650] = (2.0 == 8.0);s.store_scalar(1650, if s.b[1650] { 1.0 } else { 0.0 });
        let (tb6,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1645]) && s.b[1646]) {
        ...
        while {
            let tba: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1645]) && s.b[1646]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tba != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1651]) && s.b[1652]) && s.b[1653]) {
        ...
        s.store_scalar(720, tbe);s.b[1654] = (2.0 == 2.0);s.store_scalar(1654, if s.b[1654] { 1.0 } else { 0.0 });
        let (tbf,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1651]) && s.b[1652]) && (!s.b[1653])) && s.b[1654]) {
        ...
        s.store_scalar(720, tbf);s.b[1655] = (2.0 == 4.0);s.store_scalar(1655, if s.b[1655] { 1.0 } else { 0.0 });
        let (tc0,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1651]) && s.b[1652]) && (!s.b[1653])) && (!s.b[1654])) && s.b[1655]) {
        ...
        s.store_scalar(720, tc0);s.b[1656] = (2.0 == 8.0);s.store_scalar(1656, if s.b[1656] { 1.0 } else { 0.0 });
        let (tc1,) = {
    ...
    pub(super) fn stamp_transient_block_44(
        ...
        let mut tc6: usize = 0;
        while {
            let tc5: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1651]) && s.b[1652]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc5 != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1657]) && s.b[1658]) && s.b[1659]) {
        ...
        s.store_scalar(720, tc9);s.b[1660] = (2.0 == 2.0);s.store_scalar(1660, if s.b[1660] { 1.0 } else { 0.0 });
        let (tca,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1657]) && s.b[1658]) && (!s.b[1659])) && s.b[1660]) {
        ...
        s.store_scalar(720, tca);s.b[1661] = (2.0 == 4.0);s.store_scalar(1661, if s.b[1661] { 1.0 } else { 0.0 });
        let (tcb,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1657]) && s.b[1658]) && (!s.b[1659])) && (!s.b[1660])) && s.b[1661]) {
        ...
        s.store_scalar(720, tcb);s.b[1662] = (2.0 == 8.0);s.store_scalar(1662, if s.b[1662] { 1.0 } else { 0.0 });
        let (tcc,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1657]) && s.b[1658]) {
        ...
        while {
            let td0: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1657]) && s.b[1658]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            td0 != 0.0
        } {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) {
        ...
        if (((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_45(
        s: &mut Scratch,
    ) {
        if (((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) {s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) && s.b[1665]) && s.b[1666]) {
        ...
        s.store_scalar(720, td4);s.b[1667] = (2.0 == 2.0);s.store_scalar(1667, if s.b[1667] { 1.0 } else { 0.0 });
        let (td5,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) && s.b[1665]) && (!s.b[1666])) && s.b[1667]) {
        ...
        s.store_scalar(720, td5);s.b[1668] = (2.0 == 4.0);s.store_scalar(1668, if s.b[1668] { 1.0 } else { 0.0 });
        let (td6,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) && s.b[1665]) && (!s.b[1666])) && (!s.b[1667])) && s.b[1668]) {
        ...
        s.store_scalar(720, td6);s.b[1669] = (2.0 == 8.0);s.store_scalar(1669, if s.b[1669] { 1.0 } else { 0.0 });
        let (td7,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) && s.b[1665]) {
        ...
        while {
            let tdb: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1663]) && s.b[1664]) && s.b[1665]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tdb != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && (!s.b[1663])) && s.b[1670]) && s.b[1671]) && s.b[1672]) {
        ...
        s.store_scalar(720, tdf);s.b[1673] = (2.0 == 2.0);s.store_scalar(1673, if s.b[1673] { 1.0 } else { 0.0 });
        let (te0,) = {
    if ((((((s.b[1439] && s.b[1440]) && (!s.b[1663])) && s.b[1670]) && s.b[1671]) && (!s.b[1672])) && s.b[1673]) {
        ...
        s.store_scalar(720, te0);s.b[1674] = (2.0 == 4.0);s.store_scalar(1674, if s.b[1674] { 1.0 } else { 0.0 });
        let (te1,) = {
    if (((((((s.b[1439] && s.b[1440]) && (!s.b[1663])) && s.b[1670]) && s.b[1671]) && (!s.b[1672])) && (!s.b[1673])) && s.b[1674]) {
        ...
        s.store_scalar(720, te1);s.b[1675] = (2.0 == 8.0);s.store_scalar(1675, if s.b[1675] { 1.0 } else { 0.0 });
        let (te2,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && (!s.b[1663])) && s.b[1670]) && s.b[1671]) {
        ...
        while {
            let te6: f64 = if (((((s.b[1439] && s.b[1440]) && (!s.b[1663])) && s.b[1670]) && s.b[1671]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te6 != 0.0
        } {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) && s.b[1678]) {
        ...
        s.store_scalar(720, tea);s.b[1679] = (2.0 == 2.0);s.store_scalar(1679, if s.b[1679] { 1.0 } else { 0.0 });
        let (teb,) = {
    if (((((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) && (!s.b[1678])) && s.b[1679]) {
        ...
        s.store_scalar(720, teb);s.b[1680] = (2.0 == 4.0);s.store_scalar(1680, if s.b[1680] { 1.0 } else { 0.0 });
        let (tec,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) && (!s.b[1678])) && (!s.b[1679])) && s.b[1680]) {
        ...
        s.store_scalar(720, tec);s.b[1681] = (2.0 == 8.0);s.store_scalar(1681, if s.b[1681] { 1.0 } else { 0.0 });
        let (ted,) = {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) {
        ...
        while {
            let tf1: f64 = if ((((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tf1 != 0.0
        } {
    ...
    if (((s.b[1439] && s.b[1440]) && s.b[1676]) && s.b[1677]) {
        ...
        if (((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) {s.store_sub_from_scalar(781, 2.0, 338);s.store_square(722, 781);s.store_scalar(723, (2.0 * 2.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_47(
        s: &mut Scratch,
    ) {
        if (((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) {s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (tf3,) = {
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) && s.b[1684]) && s.b[1685]) {
        ...
        s.store_scalar(720, tf5);s.b[1686] = (2.0 == 2.0);s.store_scalar(1686, if s.b[1686] { 1.0 } else { 0.0 });
        let (tf6,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) && s.b[1684]) && (!s.b[1685])) && s.b[1686]) {
        ...
        s.store_scalar(720, tf6);s.b[1687] = (2.0 == 4.0);s.store_scalar(1687, if s.b[1687] { 1.0 } else { 0.0 });
        let (tf7,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) && s.b[1684]) && (!s.b[1685])) && (!s.b[1686])) && s.b[1687]) {
        ...
        s.store_scalar(720, tf7);s.b[1688] = (2.0 == 8.0);s.store_scalar(1688, if s.b[1688] { 1.0 } else { 0.0 });
        let (tf8,) = {
    ...
    if ((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) && s.b[1684]) {
        ...
        while {
            let tfc: f64 = if (((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1683]) && s.b[1684]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tfc != 0.0
        } {
    ...
    if (((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1689]) && s.b[1690]) && s.b[1691]) {
        ...
        s.store_scalar(720, t100);s.b[1692] = (4.0 == 2.0);s.store_scalar(1692, if s.b[1692] { 1.0 } else { 0.0 });
        let (t101,) = {
    if ((((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1689]) && s.b[1690]) && (!s.b[1691])) && s.b[1692]) {
        ...
        s.store_scalar(720, t101);s.b[1693] = (4.0 == 4.0);s.store_scalar(1693, if s.b[1693] { 1.0 } else { 0.0 });
        let (t102,) = {
    if (((((((s.b[1439] && s.b[1440]) && s.b[1682]) && s.b[1689]) && s.b[1690]) && (!s.b[1691])) && (!s.b[1692])) && s.b[1693]) {
        ...
        s.store_scalar(720, t102);s.b[1694] = (4.0 == 8.0);s.store_scalar(1694, if s.b[1694] { 1.0 } else { 0.0 });
    }
}
