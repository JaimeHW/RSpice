...
impl Instance {
    ...
    if (((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) {
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3359]) {s.store_scale(781, 799, ((-0.5) * (2.0 * 1.0 / (p[262]))));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_213(
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3359]) {s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p[262], 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) {
        ...
        while {
            let t10: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && (s.v[719] < p[442])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    if (((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && s.b[3370]) {
        ...
        s.store_scalar(720, t12);s.b[3371] = (p[442] == 2.0);s.store_scalar(3371, if s.b[3371] { 1.0 } else { 0.0 });
        let (t13,) = {
    if ((((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && (!s.b[3370])) && s.b[3371]) {
        ...
        s.store_scalar(720, t13);s.b[3372] = (p[442] == 4.0);s.store_scalar(3372, if s.b[3372] { 1.0 } else { 0.0 });
        let (t14,) = {
    if (((((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && (!s.b[3370])) && (!s.b[3371])) && s.b[3372]) {
        ...
        s.store_scalar(720, t14);s.b[3373] = (p[442] == 8.0);s.store_scalar(3373, if s.b[3373] { 1.0 } else { 0.0 });
        let (t15,) = {
    ...
    pub(super) fn stamp_transient_block_215(
        ...
        if (s.b[3332] && (!s.b[3352])) {s.store_offset_sub(336, 3348, 3349, p[137]);s.store_sqrt_square_offset(782, 336, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_transient_block_218(
        ...
        s.b[3405] = (p[48] > 0.0);s.store_scalar(3405, if s.b[3405] { 1.0 } else { 0.0 });s.b[3406] = (p[24] == 1.0);s.store_scalar(3406, if s.b[3406] { 1.0 } else { 0.0 });s.b[3408] = ((p[51] == 1.0) && (p[132] > 0.0));s.store_scalar(3408, if s.b[3408] { 1.0 } else { 0.0 });s.b[3409] = (p[53] > 0.0);s.store_scalar(3409, if s.b[3409] { 1.0 } else { 0.0 });
