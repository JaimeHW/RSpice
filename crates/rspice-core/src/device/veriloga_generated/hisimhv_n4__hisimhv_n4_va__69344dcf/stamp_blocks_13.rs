...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_209(
        ...
        if s.b[3325] {s.store_scalar(700, 0.0);s.store_scalar(701, 0.0);s.store_scalar(702, 0.0);s.copy_ad(708, 247);s.store_scale(754, 20, s.v[365]);s.store_scale(132, 132, s.v[365]);}
    ...
    pub(super) fn stamp_transient_block_210(
        ...
        if (p.p29 != 0.0) {s.store_scale(308, 572, s.v[188]);s.store_voltage(817, ctx, nodes, Some(13), None);s.store_div_scaled_inputs2_indices(815, 817, 1.0, 816, (-1.0), 308, 1.0);s.store_add_scaled_inputs3_indices(352, 352, 1.0, 816, -1.0, 817, 1.0);s.copy_ad(355, 817);}
        ...
        if s.b[3328] {s.store_sub_scaled_inputs(9, 199, (p.p252 * s.v[365]), 201, s.v[365]);}
        if (!s.b[3328]) {s.store_sub_scaled_inputs(9, 199, ((1.0 - p.p252) * s.v[365]), 200, s.v[365]);}
        s.b[3329] = (s.v[949] == 1.0);s.store_scalar(3329, if s.b[3329] { 1.0 } else { 0.0 });
        if s.b[3329] {s.store_sub_scaled_inputs(10, 199, ((1.0 - p.p252) * s.v[365]), 200, s.v[365]);}
        if (!s.b[3329]) {s.store_sub_scaled_inputs(10, 199, (p.p252 * s.v[365]), 201, s.v[365]);}
        ...
        s.store_scalar(713, 0.0);s.store_scalar(714, 0.0);s.b[3330] = (((((p.p31 != 0.0) && (p.p30 != 0.0)) && (s.v[321] == 1.0)) && (s.v[78] == 0.0)) && (s.v[963] == 0.0));s.store_scalar(3330, if s.b[3330] { 1.0 } else { 0.0 });
    ...
    if ((s.b[3332] && (!s.b[3333])) && s.b[3340]) {
        ...
        if ((s.b[3332] && (!s.b[3333])) && s.b[3340]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if ((((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) && s.b[3342]) {
        ...
        s.store_scalar(720, t2);s.b[3343] = (2.0 == 2.0);s.store_scalar(3343, if s.b[3343] { 1.0 } else { 0.0 });
        let (t3,) = {
    if (((((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) && (!s.b[3342])) && s.b[3343]) {
        ...
        s.store_scalar(720, t3);s.b[3344] = (2.0 == 4.0);s.store_scalar(3344, if s.b[3344] { 1.0 } else { 0.0 });
        let (t4,) = {
    if ((((((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) && (!s.b[3342])) && (!s.b[3343])) && s.b[3344]) {
        ...
        s.store_scalar(720, t4);s.b[3345] = (2.0 == 8.0);s.store_scalar(3345, if s.b[3345] { 1.0 } else { 0.0 });
        let (t5,) = {
    ...
    if (((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) {
        ...
        while {
            let t9: f64 = if ((((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
    ...
    if (((s.b[3332] && (!s.b[3333])) && s.b[3340]) && s.b[3341]) {
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3359]) {s.store_scale(781, 799, ((-0.5) * (2.0 * 1.0 / (p.p262))));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_213(
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3359]) {s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
    ...
    pub(super) fn stamp_transient_block_214(
        ...
        if (((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) {s.store_add_scaled_inputs3_indices(781, 597, 1.0, 408, (-p.p440), 408, p.p441);s.store_square(722, 781);s.store_scaled_mul(723, 408, 408, (p.p441 * p.p441));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (tb,) = {
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) {
        ...
        while {
            let t10: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && (s.v[719] < p.p442)) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    if (((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && s.b[3370]) {
        ...
        s.store_scalar(720, t12);s.b[3371] = (p.p442 == 2.0);s.store_scalar(3371, if s.b[3371] { 1.0 } else { 0.0 });
        let (t13,) = {
    if ((((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && (!s.b[3370])) && s.b[3371]) {
        ...
        s.store_scalar(720, t13);s.b[3372] = (p.p442 == 4.0);s.store_scalar(3372, if s.b[3372] { 1.0 } else { 0.0 });
        let (t14,) = {
    if (((((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && (!s.b[3370])) && (!s.b[3371])) && s.b[3372]) {
        ...
        s.store_scalar(720, t14);s.b[3373] = (p.p442 == 8.0);s.store_scalar(3373, if s.b[3373] { 1.0 } else { 0.0 });
        let (t15,) = {
    ...
    if ((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) {
        ...
        while {
            let t19: f64 = if (((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t19 != 0.0
        } {
    ...
    if ((((s.b[3332] && (!s.b[3352])) && s.b[3367]) && s.b[3368]) && s.b[3369]) {
        ...
        if (s.b[3332] && (!s.b[3352])) {s.store_offset(334, 334, (10.0 * 2.220446049250313e-16));s.store_sqrt_mul(599, 650, 334);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_215(
        ...
        if (s.b[3332] && (!s.b[3352])) {s.store_offset_sub(336, 3348, 3349, p.p137);s.store_sqrt_square_offset(782, 336, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    if ((((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) && s.b[3379]) {
        ...
        s.store_scalar(720, t1d);s.b[3380] = (2.0 == 2.0);s.store_scalar(3380, if s.b[3380] { 1.0 } else { 0.0 });
        let (t1e,) = {
    if (((((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) && (!s.b[3379])) && s.b[3380]) {
        ...
        s.store_scalar(720, t1e);s.b[3381] = (2.0 == 4.0);s.store_scalar(3381, if s.b[3381] { 1.0 } else { 0.0 });
        let (t1f,) = {
    if ((((((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) && (!s.b[3379])) && (!s.b[3380])) && s.b[3381]) {
        ...
        s.store_scalar(720, t1f);s.b[3382] = (2.0 == 8.0);s.store_scalar(3382, if s.b[3382] { 1.0 } else { 0.0 });
        let (t20,) = {
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) {
        ...
        while {
            let t24: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t24 != 0.0
        } {
            t25 += 1;assert!(t25 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) {s.store_sqrt(726, 726);}
            let (t23,) = {
    if (((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) {
    ...
    pub(super) fn stamp_transient_block_216(
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3383]) {s.store_offset(781, 4, (((-1000000.0)) + (1000.0)));s.store_square(722, 781);s.store_scalar(723, (1000.0 * 1000.0));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t26,) = {
    ...
    if ((s.b[3332] && (!s.b[3352])) && s.b[3383]) {
        ...
        if ((s.b[3332] && (!s.b[3352])) && s.b[3383]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if ((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && s.b[3385]) {
        ...
        s.store_scalar(720, t28);s.b[3386] = (2.0 == 2.0);s.store_scalar(3386, if s.b[3386] { 1.0 } else { 0.0 });
        let (t29,) = {
    if (((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (!s.b[3385])) && s.b[3386]) {
        ...
        s.store_scalar(720, t29);s.b[3387] = (2.0 == 4.0);s.store_scalar(3387, if s.b[3387] { 1.0 } else { 0.0 });
        let (t2a,) = {
    if ((((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (!s.b[3385])) && (!s.b[3386])) && s.b[3387]) {
        ...
        s.store_scalar(720, t2a);s.b[3388] = (2.0 == 8.0);s.store_scalar(3388, if s.b[3388] { 1.0 } else { 0.0 });
        let (t2b,) = {
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) {
        ...
        while {
            let t2f: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2f != 0.0
        } {
            t30 += 1;assert!(t30 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) {s.store_sqrt(726, 726);}
            let (t2e,) = {
    if (((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) {
        ...
        s.copy_ad(4, 715);s.copy_ad(5, 716);s.copy_ad(201, 9);s.copy_ad(200, 10);s.copy_ad(202, 11);s.b[3395] = (s.v[949] > 0.0);s.store_scalar(3395, if s.b[3395] { 1.0 } else { 0.0 });
        if s.b[3395] {s.copy_ad(134, 0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_217(
        ...
        if s.b[3395] {s.copy_ad(19, 701);s.copy_ad(18, 700);s.copy_ad(741, 702);s.store_add_scaled_inputs3_indices(20, 700, (-1.0), 701, (-1.0), 702, (-1.0));s.copy_ad(280, 709);s.store_scalar(736, 0.0);s.copy_ad(281, 710);s.store_scalar(737, 0.0);s.copy_ad(400, 699);s.store_scalar(738, 0.0);s.copy_ad(431, 430);s.store_scalar(432, 0.0);s.copy_ad(424, 422);s.store_scalar(425, 0.0);s.copy_ad(203, 7);s.copy_ad(204, 8);}
        if (s.b[3395] && (s.v[81] != 0.0)) {s.copy_ad(247, 708);}
        if (!s.b[3395]) {s.store_neg(134, 0);s.copy_ad(19, 702);s.copy_ad(18, 700);s.copy_ad(741, 701);s.store_add_scaled_inputs3_indices(20, 700, (-1.0), 701, (-1.0), 702, (-1.0));s.store_scalar(280, 0.0);s.copy_ad(736, 709);s.store_scalar(281, 0.0);s.copy_ad(737, 710);s.store_scalar(400, 0.0);s.copy_ad(738, 699);s.store_scalar(431, 0.0);s.copy_ad(432, 430);s.store_scalar(424, 0.0);s.copy_ad(425, 422);s.copy_ad(203, 8);s.copy_ad(204, 7);}
        ...
        s.b[3401] = (s.v[306] < 1e-15);s.store_scalar(3401, if s.b[3401] { 1.0 } else { 0.0 });
        if ((s.v[81] != 0.0) && s.b[3401]) {s.store_scalar(306, 1e-15);}
        s.b[3402] = (s.v[307] < 1e-15);s.store_scalar(3402, if s.b[3402] { 1.0 } else { 0.0 });
        if ((s.v[81] != 0.0) && s.b[3402]) {s.store_scalar(307, 1e-15);}
    ...
    pub(super) fn stamp_transient_block_218(
        ...
        s.b[3405] = (p.p48 > 0.0);s.store_scalar(3405, if s.b[3405] { 1.0 } else { 0.0 });s.b[3406] = (p.p24 == 1.0);s.store_scalar(3406, if s.b[3406] { 1.0 } else { 0.0 });s.b[3408] = ((p.p51 == 1.0) && (p.p132 > 0.0));s.store_scalar(3408, if s.b[3408] { 1.0 } else { 0.0 });s.b[3409] = (p.p53 > 0.0);s.store_scalar(3409, if s.b[3409] { 1.0 } else { 0.0 });
        if s.b[3409] {s.copy_ad(802, 746);}
