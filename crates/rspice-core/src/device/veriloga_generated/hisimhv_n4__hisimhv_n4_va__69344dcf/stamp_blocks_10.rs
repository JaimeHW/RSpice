...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_59(
        ...
        if ((!s.b[1439]) && s.b[2515]) {
            ...
            s.store_sqrt_offset_ad(781, A::square(A::sub(s.ad_value(960), s.ad_value(1431))), ((4.0 * 0.01) * 0.01));
        ...
        s.b[2534] = (p.p457 > 0.0);
        s.store_scalar(2534, if s.b[2534] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) {
            s.store_add_product3_rhs_mixed_iia(89, 2521, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 0.5);
        ...
        if (((((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) && (!s.b[2537])) && (!s.b[2538])) {
            ...
            s.store_add_div_from_scalar_rhs(337, 154, 2.0, 2521);
    ...
    pub(super) fn stamp_reactive_block_60(
        ...
        if ((((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) && s.b[2540]) {
            s.copy_ad(88, 2519);
            s.copy_ad(2541, 993);
            s.store_offset_add_scaled_inputs3_offset_indices(86, 120, (-1.0), 182, 1.0, 2541, 1.0, s.v[160], p.p455);
        }
        ...
        while {
            ...
            if ((((((!s.b[1439]) && s.b[2515]) && (!s.b[2534])) && s.b[2540]) && (!s.b[2550])) && s.b[2552]) {
                ...
                s.store_div_ln_offset_lhs(2547, 336, 1.0, 2544);
        ...
        if ((!s.b[1439]) && s.b[2515]) {
            ...
            s.store_div_scaled_inputs_indices(2529, 2528, 1.0, 586, 1.6021918e-19);
            s.store_offset(335, 2529, (-p.p452));
            s.store_scale(2530, 2529, 0.01);
            s.store_sqrt_add_scaled_square_product(781, 335, 1.0, 2530, 2530, 4.0);
    ...
    pub(super) fn stamp_reactive_block_68(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2718]) && s.b[2727]) {
                ...
                s.store_div_scaled_inputs2_indices(217, 2646, 0.5, 215, 0.5, 216, 1.0);
            }
            ...
            if ((((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2727])) && s.b[2728]) {
                ...
                s.store_div_scaled_inputs_indices(217, 2646, 0.5, 216, 1.0);
            }
            if ((((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2727])) && (!s.b[2728])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
        ...
        if (((s.v[2621] != 0.0) && s.b[2733]) && s.b[2734]) {
            s.store_sqrt_offset_square_offset(782, 2638, p.p137, ((4.0 * 0.1) * 0.1));
