...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_62(
        ...
        if (s.b[2599] && s.b[2600]) {
            ...
            s.store_sub_scaled_ad_lhs(335, A::add(A::offset(s.ad_value(1436), (-s.v[160])), A::mul(A::scale(A::sub(s.ad_value(120), s.ad_value(182)), s.v[560]), s.ad_value(162))), 191, s.v[515]);
    ...
    pub(super) fn stamp_reactive_block_64(
        ...
        if (s.v[2621] != 0.0) {
            ...
            s.store_mul_scaled_ad_rhs(2640, 155, 2.0, A::ln(A::div(s.ad_value(409), s.ad_value(394))));
    ...
    pub(super) fn stamp_reactive_block_66(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2683]) && s.b[2684]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(2681), s.ad_value(386)), 386, 0.1);
            s.store_square(722, 781);
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2700]) {
            ...
            s.store_sqrt_scaled_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2637)), s.ad_value(155)), 2.0);
        }
    ...
    pub(super) fn stamp_reactive_block_68(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2718]) && s.b[2724]) {
                ...
                s.store_mul_sub_ad_rhs(2646, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2724])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(2645, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(2646, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
            ...
            if ((((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2727])) && s.b[2728]) {
                ...
                s.store_scaled_div(217, 2646, 216, 0.5);
            }
            if ((((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2727])) && (!s.b[2728])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
        ...
        if (((s.v[2621] != 0.0) && s.b[2733]) && s.b[2734]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(2638), p.p137), A::offset(s.ad_value(2638), p.p137)), ((4.0 * 0.1) * 0.1));
            s.store_scaled_offset_ad(343, A::div(A::offset(s.ad_value(2638), p.p137), s.ad_value(782)), 1.0, 0.5);
    ...
    pub(super) fn stamp_reactive_block_69(
        ...
        if (s.v[2621] != 0.0) {
            ...
            s.store_mul_scaled_ad_rhs(2761, 155, 2.0, A::ln(A::div(s.ad_value(409), s.ad_value(394))));
    ...
    pub(super) fn stamp_reactive_block_71(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2804]) && s.b[2805]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(2802), s.ad_value(386)), 386, 0.1);
            s.store_square(722, 781);
            s.store_scaled_square(723, 386, ((0.1) * (0.1)));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
    ...
    pub(super) fn stamp_reactive_block_72(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2821]) {
            s.store_scalar(79, 0.0);
            s.store_sqrt_scaled_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2758)), s.ad_value(155)), 2.0);
        }
    ...
    pub(super) fn stamp_reactive_block_73(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2839]) && s.b[2845]) {
                ...
                s.store_mul_sub_ad_rhs(2767, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.v[2621] != 0.0) && s.b[2839]) && (!s.b[2845])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(2766, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(2767, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
            ...
            if ((((s.v[2621] != 0.0) && s.b[2839]) && (!s.b[2848])) && s.b[2849]) {
                ...
                s.store_scaled_div(217, 2767, 216, 0.5);
            }
            if ((((s.v[2621] != 0.0) && s.b[2839]) && (!s.b[2848])) && (!s.b[2849])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
        ...
        if (((s.v[2621] != 0.0) && s.b[2854]) && s.b[2855]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(2759), p.p137), A::offset(s.ad_value(2759), p.p137)), ((4.0 * 0.1) * 0.1));
            s.store_scaled_offset_ad(343, A::div(A::offset(s.ad_value(2759), p.p137), s.ad_value(782)), 1.0, 0.5);
    ...
    pub(super) fn stamp_reactive_block_74(
        ...
        if (s.v[2621] != 0.0) {
            ...
            s.store_mul_scaled_ad_rhs(2882, 155, 2.0, A::ln(A::div(s.ad_value(409), s.ad_value(394))));
    ...
    pub(super) fn stamp_reactive_block_76(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(2923), s.ad_value(386)), 386, 0.1);
            s.store_square(722, 781);
            s.store_scaled_square(723, 386, ((0.1) * (0.1)));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
    ...
    pub(super) fn stamp_reactive_block_77(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) {
            s.store_scalar(79, 0.0);
            s.store_sqrt_scaled_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2879)), s.ad_value(155)), 2.0);
        }
