...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_63(
        ...
        if s.b[2599] {
            ...
            s.store_scaled_offset_ad(336, A::add(A::add_scaled_inputs3(s.ad_value(1434), s.v[493], s.ad_value(1436), (-1.0), s.ad_value(122), 1.0), s.ad_value(174)), (-s.v[492]), (-1.0 / (s.v[187])));
    ...
    pub(super) fn stamp_reactive_block_66(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2683]) && s.b[2684]) {
            s.store_ad_value(781, A::add_scaled_inputs3(s.ad_value(2681), 1.0, s.ad_value(386), (-1.0), s.ad_value(386), 0.1));
            s.store_square(722, 781);
    ...
    pub(super) fn stamp_reactive_block_68(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2718]) && s.b[2724]) {
                ...
                s.store_mul_ad_rhs(2646, 154, A::add_scaled_product(s.ad_value(335), 1.0, s.ad_value(417), s.ad_value(337), (-1.0)));
            }
            if (((s.v[2621] != 0.0) && s.b[2718]) && (!s.b[2724])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(2645, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_ad_rhs(2646, 154, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(334)), 1.0, s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335)), (-1.0)));
            }
    ...
    pub(super) fn stamp_reactive_block_71(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2804]) && s.b[2805]) {
            s.store_ad_value(781, A::add_scaled_inputs3(s.ad_value(2802), 1.0, s.ad_value(386), (-1.0), s.ad_value(386), 0.1));
            s.store_square(722, 781);
            s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
    ...
    pub(super) fn stamp_reactive_block_73(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2839]) && s.b[2845]) {
                ...
                s.store_mul_ad_rhs(2767, 154, A::add_scaled_product(s.ad_value(335), 1.0, s.ad_value(417), s.ad_value(337), (-1.0)));
            }
            if (((s.v[2621] != 0.0) && s.b[2839]) && (!s.b[2845])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(2766, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_ad_rhs(2767, 154, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(334)), 1.0, s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335)), (-1.0)));
            }
    ...
    pub(super) fn stamp_reactive_block_76(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) {
            s.store_ad_value(781, A::add_scaled_inputs3(s.ad_value(2923), 1.0, s.ad_value(386), (-1.0), s.ad_value(386), 0.1));
            s.store_square(722, 781);
            s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
