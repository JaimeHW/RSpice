...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_160(
        ...
        if (s.b[2865] && s.b[2869]) {s.store_scalar(407, p.p66);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
    ...
    if ((s.b[2866] && (!s.b[2865])) && s.b[2870]) {
        ...
        s.store_scalar(2621, t0);
        if ((s.b[2866] && (!s.b[2865])) && s.b[2870]) {s.store_sub(395, 734, 735);s.store_neg(396, 735);}
    ...
    if ((s.b[2867] && (!(s.b[2865] || s.b[2866]))) && s.b[2871]) {
        ...
        s.store_scalar(2622, t2);
        if ((s.b[2867] && (!(s.b[2865] || s.b[2866]))) && s.b[2871]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p.p63 + (p.p64 * p.p55)));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
    ...
    if ((s.b[2868] && (!((s.b[2865] || s.b[2866]) || s.b[2867]))) && s.b[2876]) {
        ...
        s.store_scalar(2621, t3);
        if ((s.b[2868] && (!((s.b[2865] || s.b[2866]) || s.b[2867]))) && s.b[2876]) {s.store_sub(395, 734, 735);s.store_sub(396, 733, 735);}
        if (s.v[2621] != 0.0) {s.store_scalar(2884, 0.4);}
        let (t4,) = {
    if (s.v[2621] != 0.0) {
        (0.0,)
    } else {
    ...
    if (s.v[2621] != 0.0) {
        ...
        if (s.v[2621] != 0.0) {s.store_scalar(2886, 0.0);s.store_scalar(2887, 0.0);s.store_mul_scaled_ln_ad_rhs(2882, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(2882), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2621] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (s.v[2621] != 0.0) {
        ...
        if (s.v[2621] != 0.0) {s.store_scalar(2878, 0.0);s.store_primal_scale(2879, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((s.v[2621] != 0.0) && (!s.b[2896])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (td,) = {
    ...
    if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) {
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_162(
        s: &mut Scratch,
    ) {
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) {s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) && s.b[2899]) {
        ...
        s.store_scalar(720, tf);s.b[2900] = (1.0 == 2.0);s.store_scalar(2900, if s.b[2900] { 1.0 } else { 0.0 });
        let (t10,) = {
    if ((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) && (!s.b[2899])) && s.b[2900]) {
        ...
        s.store_scalar(720, t10);s.b[2901] = (1.0 == 4.0);s.store_scalar(2901, if s.b[2901] { 1.0 } else { 0.0 });
        let (t11,) = {
    if (((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) && (!s.b[2899])) && (!s.b[2900])) && s.b[2901]) {
        ...
        s.store_scalar(720, t11);s.b[2902] = (1.0 == 8.0);s.store_scalar(2902, if s.b[2902] { 1.0 } else { 0.0 });
        let (t12,) = {
    ...
    if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) {
        ...
        while {
            let t16: f64 = if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t16 != 0.0
        } {
            t17 += 1;assert!(t17 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) {s.store_sqrt(726, 726);}
            let (t15,) = {
    if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2897]) && s.b[2898]) {
    ...
    if ((s.v[2621] != 0.0) && (s.v[406] != 0.0)) {
        ...
        s.store_scalar(403, t1b);s.b[2903] = (s.v[402] < s.v[403]);s.store_scalar(2903, if s.b[2903] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && (!s.b[2905])) {s.store_offset_div_scaled_offset_numerator(332, A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_163(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && (!s.b[2905])) {s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2906]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) {s.store_offset_add(442, 402, 397, 0.1);s.store_mul(222, 405, 229);s.store_mul(443, 405, 229);s.store_mul(334, 156, 213);s.store_mul(444, 154, 442);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_164(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) {s.store_add_scaled_inputs_product_mixed_aaii(447, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), 1.0, A::ln(A::mul(s.ad_value(405), s.ad_value(334))), (-1.0), 154, 397, 1.0);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) {s.store_sub(444, 444, 447);s.store_add_scaled_inputs(444, 444, 1.0, 154, 0.1);s.store_sub_ad(335, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), A::ln(A::mul(s.ad_value(405), s.ad_value(334))));s.store_add_scaled_product_indices(446, 335, 1.0, 154, 397, 1.0);}
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) {
            if (s.v[446] >= 0.0) {
            } else {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) {s.store_add_scaled_inputs3_indices(781, 445, 1.0, 446, (-1.0), 446, 0.2);s.store_square(722, 781);s.store_scaled_mul(723, 446, 446, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t1c,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) && s.b[2912]) {
        ...
        s.store_scalar(720, t1e);s.b[2913] = (2.0 == 2.0);s.store_scalar(2913, if s.b[2913] { 1.0 } else { 0.0 });
        let (t1f,) = {
    if ((((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) && (!s.b[2912])) && s.b[2913]) {
        ...
        s.store_scalar(720, t1f);s.b[2914] = (2.0 == 4.0);s.store_scalar(2914, if s.b[2914] { 1.0 } else { 0.0 });
        let (t20,) = {
    if (((((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) && (!s.b[2912])) && (!s.b[2913])) && s.b[2914]) {
        ...
        s.store_scalar(720, t20);s.b[2915] = (2.0 == 8.0);s.store_scalar(2915, if s.b[2915] { 1.0 } else { 0.0 });
        let (t21,) = {
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) {
        ...
        while {
            let t25: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t25 != 0.0
        } {
            t26 += 1;assert!(t26 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) {s.store_sqrt(726, 726);}
            let (t24,) = {
    if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2907]) && s.b[2909]) && s.b[2910]) && s.b[2911]) {
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2916]) && s.b[2921]) {
        let t27: f64 = (s.v[2885] + 1.0);
        (t27,)
    } else {
        (s.v[2885],)
    }
};
        s.store_scalar(2885, t28);
        if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2916]) && s.b[2921]) {s.copy_ad(116, 447);}
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) {s.store_add_scaled_inputs3_indices(781, 2923, 1.0, 386, (-1.0), 386, 0.1);s.store_square(722, 781);s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t29,) = {
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) {
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) && s.b[2928]) {
        ...
        s.store_scalar(720, t2b);s.b[2929] = (2.0 == 2.0);s.store_scalar(2929, if s.b[2929] { 1.0 } else { 0.0 });
        let (t2c,) = {
    if (((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) && (!s.b[2928])) && s.b[2929]) {
        ...
        s.store_scalar(720, t2c);s.b[2930] = (2.0 == 4.0);s.store_scalar(2930, if s.b[2930] { 1.0 } else { 0.0 });
        let (t2d,) = {
    if ((((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) && (!s.b[2928])) && (!s.b[2929])) && s.b[2930]) {
        ...
        s.store_scalar(720, t2d);s.b[2931] = (2.0 == 8.0);s.store_scalar(2931, if s.b[2931] { 1.0 } else { 0.0 });
        let (t2e,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) {
        ...
        while {
            let t32: f64 = if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t32 != 0.0
        } {
            t33 += 1;assert!(t33 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) {s.store_sqrt(726, 726);}
            let (t31,) = {
    if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2926]) && s.b[2927]) {
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2925]) && s.b[2932]) {
        let t34: f64 = (s.v[2885] + 2.0);
        (t34,)
    } else {
        (s.v[2885],)
    }
};
        s.store_scalar(2885, t35);
    ...
    if ((((s.v[2621] != 0.0) && (!s.b[2903])) && (!s.b[2925])) && s.b[2933]) {
        let t36: f64 = (s.v[2885] + 2.0);
        (t36,)
    } else {
        (s.v[2885],)
    }
};
        s.store_scalar(2885, t37);s.b[2934] = (s.v[2885] >= 2.0);s.store_scalar(2934, if s.b[2934] { 1.0 } else { 0.0 });
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) {s.store_offset_sub(781, 404, 2924, 0.1);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t38,) = {
    ...
    if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) {
        ...
        if (((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) && s.b[2938]) {
        ...
        s.store_scalar(720, t3a);s.b[2939] = (2.0 == 2.0);s.store_scalar(2939, if s.b[2939] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if ((((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) && (!s.b[2938])) && s.b[2939]) {
        ...
        s.store_scalar(720, t3b);s.b[2940] = (2.0 == 4.0);s.store_scalar(2940, if s.b[2940] { 1.0 } else { 0.0 });
        let (t3c,) = {
    if (((((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) && (!s.b[2938])) && (!s.b[2939])) && s.b[2940]) {
        ...
        s.store_scalar(720, t3c);s.b[2941] = (2.0 == 8.0);s.store_scalar(2941, if s.b[2941] { 1.0 } else { 0.0 });
        let (t3d,) = {
    ...
    if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) {
        ...
        while {
            let t41: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t41 != 0.0
        } {
            t42 += 1;assert!(t42 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) {s.store_sqrt(726, 726);}
            let (t40,) = {
    if ((((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2934]) && s.b[2935]) && s.b[2936]) && s.b[2937]) {
    ...
    if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) {
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2879)), s.ad_value(155)), 2.0);}
        ...
        if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 2879, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t44,) = {
    if (((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_168(
        ...
        let mut t4c: usize = 0;
        while {
            let t4a: f64 = (s.v[421] + 1.0);let t4b: f64 = if ((((s.v[2621] != 0.0) && (!s.b[2903])) && s.b[2942]) && (s.v[97] <= t4a)) { 1.0 } else { 0.0 };
            t4b != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_170(
        ...
        let mut t57: usize = 0;
        while {
            let t55: f64 = (s.v[421] + 1.0);let t56: f64 = if (((s.v[2621] != 0.0) && s.b[2960]) && (s.v[97] <= t55)) { 1.0 } else { 0.0 };
            t56 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_172(
        ...
        if (s.b[2986] && s.b[2990]) {s.store_scalar(407, p.p66);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
    ...
    if ((s.b[2988] && (!(s.b[2986] || s.b[2987]))) && s.b[2992]) {
        ...
        s.store_scalar(2622, t5c);
        if ((s.b[2988] && (!(s.b[2986] || s.b[2987]))) && s.b[2992]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p.p63 + (p.p64 * p.p55)));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
    ...
    if (s.v[2621] != 0.0) {
        ...
        let mut t66: usize = 0;
        while {
            let t65: f64 = if (((s.v[2621] != 0.0) && (!s.b[3017])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t65 != 0.0
        } {
    ...
    if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {
        ...
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_174(
        s: &mut Scratch,
    ) {
        if (((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) {s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && s.b[3020]) {
        ...
        s.store_scalar(720, t69);s.b[3021] = (1.0 == 2.0);s.store_scalar(3021, if s.b[3021] { 1.0 } else { 0.0 });
        let (t6a,) = {
    if ((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (!s.b[3020])) && s.b[3021]) {
        ...
        s.store_scalar(720, t6a);s.b[3022] = (1.0 == 4.0);s.store_scalar(3022, if s.b[3022] { 1.0 } else { 0.0 });
        let (t6b,) = {
    if (((((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (!s.b[3020])) && (!s.b[3021])) && s.b[3022]) {
        ...
        s.store_scalar(720, t6b);s.b[3023] = (1.0 == 8.0);s.store_scalar(3023, if s.b[3023] { 1.0 } else { 0.0 });
        let (t6c,) = {
    ...
    if ((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) {
        ...
        while {
            let t70: f64 = if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[3018]) && s.b[3019]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t70 != 0.0
        } {
    ...
    if ((s.v[2621] != 0.0) && (s.v[406] != 0.0)) {
        ...
        s.store_scalar(403, t75);s.b[3024] = (s.v[402] < s.v[403]);s.store_scalar(3024, if s.b[3024] { 1.0 } else { 0.0 });
