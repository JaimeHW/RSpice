...
impl Instance {
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) {
        ...
        while {
            let t3: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3377]) && s.b[3378]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
            t4 += 1;
    ...
    if ((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && s.b[3385]) {
        ...
        s.store_scalar(720, t7);s.b[3386] = (2.0 == 2.0);s.store_scalar(3386, if s.b[3386] { 1.0 } else { 0.0 });
        let (t8,) = {
    if (((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (!s.b[3385])) && s.b[3386]) {
        ...
        s.store_scalar(720, t8);s.b[3387] = (2.0 == 4.0);s.store_scalar(3387, if s.b[3387] { 1.0 } else { 0.0 });
        let (t9,) = {
    if ((((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (!s.b[3385])) && (!s.b[3386])) && s.b[3387]) {
        ...
        s.store_scalar(720, t9);s.b[3388] = (2.0 == 8.0);s.store_scalar(3388, if s.b[3388] { 1.0 } else { 0.0 });
        let (ta,) = {
    ...
    if (((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) {
        ...
        while {
            let te: f64 = if ((((s.b[3332] && (!s.b[3352])) && s.b[3383]) && s.b[3384]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
    ...
    pub(super) fn stamp_reactive_block_10(
        ...
        if (s.b[1269] && s.b[1273]) {s.store_exp(335, 335);s.store_scaled_mul(337, 336, 335, s.v[532]);s.store_scaled_add_sqrt_square_offset_rhs(647, 337, 337, ((((4.0 * 1e-6) / 100.0) * 1e-6) / 100.0), 0.5);}
