...
impl Instance {
    ...
    if ((((s.b[1439] && (s.b[1442] && (!(s.b[1440] || s.b[1441])))) && s.b[2187]) && s.b[2188]) && s.b[2189]) {
        ...
        s.store_scalar(720, t3a);s.b[2190] = (1.0 == 2.0);s.store_scalar(2190, if s.b[2190] { 1.0 } else { 0.0 });
        let (t3b,) = {
    ...
    if ((((((s.b[1439] && (s.b[1442] && (!(s.b[1440] || s.b[1441])))) && (!s.b[2230])) && s.b[2236]) && s.b[2237]) && (!s.b[2238])) && s.b[2239]) {
        ...
        s.store_scalar(720, t92);s.b[2240] = (2.0 == 4.0);s.store_scalar(2240, if s.b[2240] { 1.0 } else { 0.0 });
        let (t93,) = {
