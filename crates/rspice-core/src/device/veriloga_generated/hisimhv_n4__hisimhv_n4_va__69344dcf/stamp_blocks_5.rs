...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_80(
        ...
        if (((s.b[1439] && s.b[1440]) && s.b[1821]) && s.b[1822]) {s.copy_ad(338, 647);s.store_scaled_offset(335, 796, (-p[300]), s.v[533]);s.store_offset_sub(781, 335, 338, (-(0.01 * 0.01)));s.store_scale(782, 338, (4.0 * (0.01 * 0.01)));}
    ...
    if ((s.b[1439] && s.b[1440]) && s.b[1825]) {
        ...
        if (s.b[1439] && (s.b[1441] && (!s.b[1440]))) {s.copy_ad(1851, 960);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_82(
        s: &mut Scratch,
    ) {
        if (s.b[1439] && (s.b[1441] && (!s.b[1440]))) {s.store_scale(1901, 964, 1.6021918e-19);s.store_scale(1880, 964, (1.6021918e-19 * 1.034943e-10));s.store_scale(1900, 622, 1.6021918e-19);s.store_square(1899, 965);s.store_div_from_scalar(1904, (2.0 * 1.034943e-10), 1901);s.store_div_from_scalar(1905, (2.0 * 1.034943e-10), 1900);s.store_div(1898, 964, 622);s.store_div_from_scalar_offset_input(1897, 1.0, 1898, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_83(
        ...
        if (s.b[1439] && (s.b[1441] && (!s.b[1440]))) {s.store_div_square_rhs(1902, 1880, 185);s.store_div_from_scalar(1903, 2.0, 1902);s.store_scalar(1906, 4.0);s.store_scalar(1907, 0.1);s.store_scalar(1908, 0.1);s.store_offset(1909, 961, p[407]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_84(
        s: &mut Scratch,
    ) {
        if (s.b[1439] && (s.b[1441] && (!s.b[1440]))) {s.store_scalar(1910, 3.0);s.store_scalar(1849, 0.0);s.store_scalar(1850, 0.0);s.store_scalar(1858, 0.0);s.store_scalar(1859, 0.0);s.store_scalar(1891, 0.0);s.store_scalar(1892, 0.0);s.store_scalar(1862, 0.0);s.store_scalar(1864, 0.0);s.store_scalar(1863, 0.0);s.store_scalar(1865, 0.0);s.store_scalar(1835, 0.0);s.store_scalar(1830, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_85(
        ...
        if (s.b[1439] && (s.b[1441] && (!s.b[1440]))) {s.copy_ad(1883, 1431);s.store_offset(85, 85, ((10.0 * 2.220446049250313e-16) * 100000000.0));s.store_div_scaled_product_add_scaled_denominator_indices(962, 1904, 622, 1.0, 964, 1.0, 622, 1.0, 1.0);s.store_sub(335, 1851, 1434);}
    ...
    if ((((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1913]) && s.b[1914]) && s.b[1915]) {
        ...
        s.store_scalar(720, t3);s.b[1916] = (4.0 == 2.0);s.store_scalar(1916, if s.b[1916] { 1.0 } else { 0.0 });
        let (t4,) = {
    ...
    if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1952]) && s.b[1953]) {
        ...
        if ((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1952]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_lhs(780, 781, 1907, 726);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_89(
        ...
        if ((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1952]) {s.store_div_scaled_product3_indices(334, 1907, 725, 726, 1.0, 770, 1.0);s.store_sub(336, 1907, 780);}
        if ((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1952]) {
        }
    ...
    if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1958]) && s.b[1965]) {
        ...
        if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1958]) && s.b[1965]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_90(
        ...
        if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && s.b[1958]) && s.b[1965]) {s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if ((((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && (!s.b[1971])) && s.b[2003]) && s.b[2004]) {
        ...
        if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && (!s.b[1971])) && s.b[2003]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_lhs(780, 781, 1907, 726);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_94(
        ...
        if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && (!s.b[1971])) && s.b[2003]) {s.store_div_scaled_product3_indices(334, 1907, 725, 726, 1.0, 770, 1.0);s.store_sub(336, 1907, 780);}
        if (((s.b[1439] && (s.b[1441] && (!s.b[1440]))) && (!s.b[1971])) && s.b[2003]) {
        }
