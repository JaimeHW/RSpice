...
impl Instance {
    ...
    if ((s.b[2591] && s.b[2592]) && s.b[2593]) {
        ...
        if (s.b[2599] && s.b[2600]) {s.store_offset(337, 337, (-p[262]));s.store_scale(332, 337, 10.0);s.store_offset_square(336, 332, 1.0);s.store_sub_from_scalar_ad(335, 1.0, A::div_from_scalar(1.0, s.ad_value(336)));}
    }
    #[inline(never)]
