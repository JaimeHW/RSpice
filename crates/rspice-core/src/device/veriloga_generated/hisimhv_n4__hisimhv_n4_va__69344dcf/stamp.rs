...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        Self::stamp_transient_block_11(s, p, param_given, var_uc_nover);
        ...
        Self::stamp_transient_block_70(s, p, var_cox0, var_coxb0, var_lgate, var_tox0, var_uc_nover, var_uc_novers, &mut var_flg_coovlp, &mut var_flg_coovlps, &mut var_guard1627, &mut var_guard1628, &mut var_guard1629, &mut var_guard1631, &mut var_guard1633);
        Self::stamp_transient_block_71(s, p, param_given, var_guard1627, var_guard1628, var_guard1629);
        ...
        Self::stamp_transient_block_76(s, p, param_given, var_cox0, var_coxb0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlp, &mut var_flg_coovlps, &mut var_guard1748, &mut var_guard1749, &mut var_guard1750, &mut var_guard1752, &mut var_guard1754);
        ...
        Self::stamp_transient_block_81(s, p, var_cox0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlps, &mut var_guard1869, &mut var_guard1870, &mut var_guard1871, &mut var_guard1873, &mut var_guard1875);
        Self::stamp_transient_block_82(s, p, param_given, var_coxb0, var_guard1869, var_guard1870, var_guard1871, var_guard1875, var_uc_nover, &mut var_flg_coovlp);
        ...
        Self::stamp_transient_block_87(s, p, var_cox0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlps, &mut var_guard1990, &mut var_guard1991, &mut var_guard1992, &mut var_guard1994, &mut var_guard1996);
        Self::stamp_transient_block_88(s, p, param_given, var_coxb0, var_guard1990, var_guard1991, var_guard1992, var_guard1996, var_uc_nover, &mut var_flg_coovlp);
