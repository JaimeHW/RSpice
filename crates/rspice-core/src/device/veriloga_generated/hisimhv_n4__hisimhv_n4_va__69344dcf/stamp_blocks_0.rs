...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        s.b[1262] = (s.v[588] > 0.0);s.store_scalar(1262, if s.b[1262] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        s.store_scaled_ln_scaled_input(159, 622, 1.0 / (1.04e16), (2.0 / 38.68283));s.b[1265] = (p[51] == 1.0);s.store_scalar(1265, if s.b[1265] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        if s.b[1285] {s.store_scalar(686, 0.0);s.store_scalar(687, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_15(
        ...
        if s.b[1285] {s.store_scalar(387, (ctx_temp + p[11]));s.copy_ad(388, 387);s.store_offset(387, 387, s.v[732]);s.store_offset(389, 388, (-s.v[764]));s.store_offset_square(390, 388, (-(s.v[764] * s.v[764])));s.store_offset(391, 387, (-s.v[764]));s.store_offset_square(392, 387, (-(s.v[764] * s.v[764])));s.store_scale(676, 387, 1.0 / (s.v[764]));s.store_ln(590, 676);s.store_sub_scaled_inputs_mixed_ai(393, A::sub_from_scalar(s.v[616], A::scale(s.ad_value(391), s.v[455])), 1.0, 392, s.v[456]);s.store_sqrt(677, 393);s.store_div_from_scalar(335, 1.0, 387);}
    }
}
