...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_78(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2960]) && s.b[2966]) {
                ...
                s.store_mul_sub_ad_rhs(2888, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2966])) {
                ...
                s.store_mul_sub_ad_rhs(2888, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
    ...
    pub(super) fn stamp_reactive_block_81(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3037]) {
            s.copy_ad(386, 336);
            s.store_mul_scaled_ad_lhs(418, A::mul(s.ad_value(3000), s.ad_value(386)), 386, (0.5 * 9662367879.197212));
    ...
    pub(super) fn stamp_reactive_block_83(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[3081]) && s.b[3087]) {
                ...
                s.store_mul_sub_ad_rhs(3009, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3087])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3008, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(3009, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
    ...
    pub(super) fn stamp_reactive_block_85(
        ...
        if (((s.b[3107] && s.b[3108]) && (!s.b[3135])) && s.b[3148]) {
            s.copy_ad(386, 336);
            s.store_mul_scaled_ad_lhs(418, A::mul(s.ad_value(3111), s.ad_value(386)), 386, (0.5 * 9662367879.197212));
            s.store_sqrt_ad(334, A::mul_scaled_lhs(s.ad_value(154), 2.0, s.ad_value(418)));
            s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);
            s.store_div_ad_lhs(419, A::ln(s.ad_value(335)), 418);
            s.store_add(414, 404, 397);
    ...
    pub(super) fn stamp_reactive_block_88(
        ...
        while {
            ...
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && s.b[3198]) {
                ...
                s.store_mul_sub_ad_rhs(3120, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && (!s.b[3198])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3119, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(3120, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_sub_ad(283, A::add_scaled_inputs(s.ad_value(1435), s.v[488], s.ad_value(109), 1.0), A::mul(s.ad_value(336), s.ad_value(282)));
        ...
        if s.b[3321] {
            let assign101490_ad_e153678: A = A::add(A::add(A::mul(A::mul(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 3.0, 1.0), 1.0, s.ad_value(334), 6.0), s.ad_value(316)), s.ad_value(316)), A::mul(A::mul(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 4.0, 3.0), 1.0, s.ad_value(334), 3.0), s.ad_value(316)), s.ad_value(253))), A::mul(A::mul(A::add(A::scale_offset(s.ad_value(125), 3.0, 6.0), s.ad_value(334)), s.ad_value(253)), s.ad_value(253)));
            s.store_div_ad(315, A::mul(A::mul(A::mul_scaled_lhs(s.ad_value(185), s.v[632], s.ad_value(127)), s.ad_value(253)), assign101490_ad_e153678), A::mul(A::mul(A::mul_scaled_lhs(s.ad_value(170), 15.0, A::offset(s.ad_value(125), 1.0)), s.ad_value(314)), s.ad_value(314)));
        }
