...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_81(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) {
            s.store_ad_value(781, A::add_scaled_inputs3(s.ad_value(3044), 1.0, s.ad_value(386), (-1.0), s.ad_value(386), 0.1));
            s.store_square(722, 781);
    ...
    pub(super) fn stamp_reactive_block_85(
        ...
        if ((((s.b[3107] && s.b[3108]) && (!s.b[3135])) && s.b[3157]) && s.b[3158]) {
            s.store_ad_value(781, A::add_scaled_inputs3(s.ad_value(3155), 1.0, s.ad_value(386), (-1.0), s.ad_value(386), 0.1));
        }
    ...
    pub(super) fn stamp_reactive_block_89(
        ...
        if ((!s.b[3226]) && s.b[3227]) {
            ...
            s.store_ad_value(335, A::add_scaled_inputs3(s.ad_value(1435), s.v[172], s.ad_value(87), s.v[172], s.ad_value(304), (1.0 - s.v[172])));
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if s.b[3318] {
            ...
            s.store_ad_value(339, A::add_scaled_inputs3(s.ad_value(87), 0.5, s.ad_value(1431), ((-1.0) * 0.5), s.ad_value(782), 0.5));
        }
        ...
        if s.b[3321] {
            ...
            s.store_ad_value(315, A::div_scaled_product(A::mul3_scaled_output(s.ad_value(185), s.ad_value(127), s.ad_value(253), s.v[632]), assign101490_ad_e153678, 1.0, A::mul(A::mul3_scaled_output(s.ad_value(170), A::offset(s.ad_value(125), 1.0), s.ad_value(314), 15.0), s.ad_value(314)), 1.0));
        }
