...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_add_scaled_inputs_product(339, s.ad_value(335), 1.0, s.ad_value(155), (-1.0), s.ad_value(666), s.ad_value(1434), (-1.0));
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_add_scaled_inputs_product(283, s.ad_value(1435), s.v[488], s.ad_value(109), 1.0, s.ad_value(336), s.ad_value(282), (-1.0));
