...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_78(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2966])) {
                ...
                s.store_ad_value(2887, A::add_scaled_inputs4(s.ad_value(116), 1.0, s.ad_value(415), (-1.0), s.ad_value(334), 1.0, s.ad_value(335), (-1.0)));
    ...
    pub(super) fn stamp_reactive_block_83(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3087])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_ad_value(3008, A::add_scaled_inputs4(s.ad_value(116), 1.0, s.ad_value(415), (-1.0), s.ad_value(334), 1.0, s.ad_value(335), (-1.0)));
    ...
    pub(super) fn stamp_reactive_block_88(
        ...
        while {
            ...
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && (!s.b[3198])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_ad_value(3119, A::add_scaled_inputs4(s.ad_value(116), 1.0, s.ad_value(415), (-1.0), s.ad_value(334), 1.0, s.ad_value(335), (-1.0)));
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_ad_value(339, A::add_scaled_inputs_product(s.ad_value(335), 1.0, s.ad_value(155), (-1.0), s.ad_value(666), s.ad_value(1434), (-1.0)));
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_ad_value(283, A::add_scaled_inputs_product(s.ad_value(1435), s.v[488], s.ad_value(109), 1.0, s.ad_value(336), s.ad_value(282), (-1.0)));
        ...
        if s.b[3321] {
            ...
            s.store_ad_value(315, A::div_scaled_product_by_product(A::mul3_scaled_output(s.ad_value(185), s.ad_value(127), s.ad_value(253), s.v[632]), assign101490_ad_e153678, 1.0, A::mul3_scaled_output(s.ad_value(170), A::offset(s.ad_value(125), 1.0), s.ad_value(314), 15.0), s.ad_value(314), 1.0));
        }
