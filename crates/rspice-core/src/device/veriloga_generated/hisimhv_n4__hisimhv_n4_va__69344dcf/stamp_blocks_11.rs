...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_78(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[2960]) && s.b[2966]) {
                ...
                s.store_mul_ad_rhs(2888, 154, A::add_scaled_product(s.ad_value(335), 1.0, s.ad_value(417), s.ad_value(337), (-1.0)));
            }
            if (((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2966])) {
                ...
                s.store_mul_ad_rhs(2888, 154, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(334)), 1.0, s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335)), (-1.0)));
            }
            ...
            if (((s.v[2621] != 0.0) && s.b[2960]) && s.b[2969]) {
                ...
                s.store_div_ad_lhs(217, A::add_scaled_inputs(s.ad_value(2888), 0.5, s.ad_value(215), 0.5), 216);
            }
            s.b[2970] = (s.v[2887] > 0.0);
            s.v[2970] = if s.b[2970] { 1.0 } else { 0.0 };
            if ((((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2969])) && s.b[2970]) {
                s.store_sqrt(216, 2887);
                s.store_scaled_div(217, 2888, 216, 0.5);
            }
            if ((((s.v[2621] != 0.0) && s.b[2960]) && (!s.b[2969])) && (!s.b[2970])) {
        ...
        if (((s.v[2621] != 0.0) && s.b[2975]) && s.b[2976]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(2880), p.p137), A::offset(s.ad_value(2880), p.p137)), ((4.0 * 0.1) * 0.1));
            s.store_scaled_offset_ad(343, A::div(A::offset(s.ad_value(2880), p.p137), s.ad_value(782)), 1.0, 0.5);
    ...
    pub(super) fn stamp_reactive_block_79(
        ...
        if (s.v[2621] != 0.0) {
            ...
            s.store_mul_scaled_ad_rhs(3003, 155, 2.0, A::ln(A::div(s.ad_value(409), s.ad_value(394))));
        ...
        if (s.v[2621] != 0.0) {
            s.store_sqrt_square_add(782, 781, 782);
            s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);
            s.store_sub_from_scalar_ad(3004, 0.8, A::add_scaled_inputs(s.ad_value(781), 0.5, s.ad_value(782), 0.5));
        }
    ...
    pub(super) fn stamp_reactive_block_81(
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3046]) && s.b[3047]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(3044), s.ad_value(386)), 386, 0.1);
            s.store_square(722, 781);
    ...
    pub(super) fn stamp_reactive_block_82(
        ...
        if (((s.v[2621] != 0.0) && (!s.b[3024])) && s.b[3063]) {
            ...
            s.store_sqrt_scaled_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3000)), s.ad_value(155)), 2.0);
        }
    ...
    pub(super) fn stamp_reactive_block_83(
        ...
        while {
            ...
            if (((s.v[2621] != 0.0) && s.b[3081]) && s.b[3087]) {
                ...
                s.store_mul_ad_rhs(3009, 154, A::add_scaled_product(s.ad_value(335), 1.0, s.ad_value(417), s.ad_value(337), (-1.0)));
            }
            if (((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3087])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3008, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_ad_rhs(3009, 154, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(334)), 1.0, s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335)), (-1.0)));
            }
            ...
            if (((s.v[2621] != 0.0) && s.b[3081]) && s.b[3090]) {
                ...
                s.store_div_ad_lhs(217, A::add_scaled_inputs(s.ad_value(3009), 0.5, s.ad_value(215), 0.5), 216);
            }
            s.b[3091] = (s.v[3008] > 0.0);
            s.v[3091] = if s.b[3091] { 1.0 } else { 0.0 };
            if ((((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3090])) && s.b[3091]) {
                s.store_sqrt(216, 3008);
                s.store_scaled_div(217, 3009, 216, 0.5);
            }
            if ((((s.v[2621] != 0.0) && s.b[3081]) && (!s.b[3090])) && (!s.b[3091])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
        ...
        if (((s.v[2621] != 0.0) && s.b[3096]) && s.b[3097]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(3001), p.p137), A::offset(s.ad_value(3001), p.p137)), ((4.0 * 0.1) * 0.1));
            s.store_scaled_offset_ad(343, A::div(A::offset(s.ad_value(3001), p.p137), s.ad_value(782)), 1.0, 0.5);
    ...
    pub(super) fn stamp_reactive_block_85(
        ...
        if ((((s.b[3107] && s.b[3108]) && (!s.b[3135])) && s.b[3157]) && s.b[3158]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(3155), s.ad_value(386)), 386, 0.1);
        }
    ...
    pub(super) fn stamp_reactive_block_86(
        ...
        if (((s.b[3107] && s.b[3108]) && (!s.b[3135])) && s.b[3174]) {
            s.store_scalar(79, 0.0);
            s.store_sqrt_scaled_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3111)), s.ad_value(155)), 2.0);
        }
    ...
    pub(super) fn stamp_reactive_block_88(
        ...
        while {
            ...
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && s.b[3198]) {
                ...
                s.store_mul_ad_rhs(3120, 154, A::add_scaled_product(s.ad_value(335), 1.0, s.ad_value(417), s.ad_value(337), (-1.0)));
            }
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && (!s.b[3198])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3119, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_ad_rhs(3120, 154, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(334)), 1.0, s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335)), (-1.0)));
            }
            ...
            if (((s.b[3107] && s.b[3108]) && s.b[3192]) && s.b[3201]) {
                ...
                s.store_div_ad_lhs(217, A::add_scaled_inputs(s.ad_value(3120), 0.5, s.ad_value(215), 0.5), 216);
            }
            ...
            if ((((s.b[3107] && s.b[3108]) && s.b[3192]) && (!s.b[3201])) && s.b[3202]) {
                ...
                s.store_scaled_div(217, 3120, 216, 0.5);
            }
            if ((((s.b[3107] && s.b[3108]) && s.b[3192]) && (!s.b[3201])) && (!s.b[3202])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
        ...
        if (((s.b[3107] && s.b[3108]) && s.b[3207]) && s.b[3208]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(3112), p.p137), A::offset(s.ad_value(3112), p.p137)), ((4.0 * 0.1) * 0.1));
            s.store_scaled_offset_ad(343, A::div(A::offset(s.ad_value(3112), p.p137), s.ad_value(782)), 1.0, 0.5);
    ...
    pub(super) fn stamp_reactive_block_89(
        ...
        if ((!s.b[3226]) && s.b[3227]) {
            ...
            s.store_add_scaled_ad_lhs(335, A::add_scaled_inputs(s.ad_value(1435), s.v[172], s.ad_value(87), s.v[172]), 304, (1.0 - s.v[172]));
            s.store_mul_scale_ad_lhs(305, A::sub(A::add(s.ad_value(87), s.ad_value(1435)), s.ad_value(335)), (-1.0 / (p.p133)), 336);
        }
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_ad_value(339, A::add_scaled_product(A::sub(s.ad_value(335), s.ad_value(155)), 1.0, s.ad_value(666), s.ad_value(1434), (-1.0)));
        ...
        if (s.b[3307] && s.b[3308]) {
            ...
            s.store_ad_value(283, A::add_scaled_product(A::add_scaled_inputs(s.ad_value(1435), s.v[488], s.ad_value(109), 1.0), 1.0, s.ad_value(336), s.ad_value(282), (-1.0)));
        ...
        if s.b[3318] {
            ...
            s.store_scaled_offset_ad(334, A::div(A::sub(s.ad_value(87), s.ad_value(1431)), s.ad_value(782)), 1.0, 0.5);
            s.store_scaled_add_ad_lhs(339, A::sub(s.ad_value(87), s.ad_value(1431)), 782, 0.5);
        }
        ...
        if s.b[3321] {
            let assign101490_ad_e153678: A = A::add(A::add(A::mul3(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 3.0, 1.0), 1.0, s.ad_value(334), 6.0), s.ad_value(316), s.ad_value(316)), A::mul3(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 4.0, 3.0), 1.0, s.ad_value(334), 3.0), s.ad_value(316), s.ad_value(253))), A::mul3(A::add(A::scale_offset(s.ad_value(125), 3.0, 6.0), s.ad_value(334)), s.ad_value(253), s.ad_value(253)));
            s.store_div_ad(315, A::mul(A::mul3_scaled_output(s.ad_value(185), s.ad_value(127), s.ad_value(253), s.v[632]), assign101490_ad_e153678), A::mul(A::mul3_scaled_output(s.ad_value(170), A::offset(s.ad_value(125), 1.0), s.ad_value(314), 15.0), s.ad_value(314)));
        }
