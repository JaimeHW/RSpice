...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_125(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((!s.b[1439]) && s.b[2515]) && s.b[2564]) && s.b[2565]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_reactive_block_126(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((s.b[2570] && s.b[2571]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_reactive_block_127(
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((!s.b[2576]) && s.b[2577]) && s.b[2578]) && s.b[2579]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_128(
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((s.b[2591] && s.b[2592]) && s.b[2593]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_131(
        ...
        if ((((s.b[2625] && (!(s.b[2623] || s.b[2624]))) && s.b[2629]) && s.b[2630]) && s.b[2631]) {s.store_sqrt_offset_square_offset(782, 396, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 396, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_133(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((s.v[2621] != 0.0) && (!s.b[2654])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2655]) && s.b[2656]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
    ...
    pub(super) fn stamp_reactive_block_135(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2665]) && s.b[2667]) && s.b[2668]) && s.b[2669]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
    ...
    pub(super) fn stamp_reactive_block_137(
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if ((((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2683]) && s.b[2684]) && s.b[2685]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2692]) && s.b[2693]) && s.b[2694]) && s.b[2695]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
            t11 += 1;
    ...
    pub(super) fn stamp_reactive_block_139(
        ...
        let mut t14: usize = 0;
        while {
            let t12: f64 = (s.v[421] + 1.0);let t13: f64 = if ((((s.v[2621] != 0.0) && (!s.b[2661])) && s.b[2700]) && (s.v[97] <= t12)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
            t14 += 1;
