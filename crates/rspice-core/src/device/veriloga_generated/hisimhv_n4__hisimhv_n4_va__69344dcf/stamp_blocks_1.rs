...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        s.b[1317] = ((p.p39 == 0.0) || (p.p39 == 1.0));s.store_scalar(1317, if s.b[1317] { 1.0 } else { 0.0 });
        ...
        if s.b[1285] {s.store_scaled_sqrt(139, 155, s.v[639]);s.store_square(694, 139);s.store_scaled_square(140, 394, s.v[640]);s.store_offset_scaled(427, 391, p.p448, p.p447);s.store_scalar(957, p.p193);}
        ...
        if (s.b[1285] && s.b[1322]) {s.store_div_from_scalar(794, s.v[569], 335);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_17(
        ...
        if (s.b[1285] && s.b[1322]) {s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p.p418), p.p418));s.store_div_from_scalar(795, s.v[570], 334);s.store_offset_scaled(959, 387, p.p439, (((((-s.v[764])) * (p.p439))) + (s.v[959])));}
        if (s.b[1285] && s.b[1322]) {
            if (s.v[676] == 0.0) {
                s.store_scalar(335, 0.0);
            } else {
        ...
        if (s.b[1285] && s.b[1322]) {s.store_div_from_scalar(787, s.v[567], 335);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p.p417), p.p417));s.store_div_from_scalar(788, s.v[568], 334);s.store_offset_scaled(956, 387, p.p438, (((((-s.v[764])) * (p.p438))) + (s.v[956])));}
        ...
        s.b[1325] = (p.p48 > 0.0);s.store_scalar(1325, if s.b[1325] { 1.0 } else { 0.0 });s.b[1326] = (p.p15 > s.v[632]);s.store_scalar(1326, if s.b[1326] { 1.0 } else { 0.0 });
        if ((s.b[1285] && s.b[1325]) && s.b[1326]) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scale(875, 829, (p.p15 - s.v[632]));s.store_scale(876, 831, (p.p15 - s.v[632]));s.store_scale(877, 836, s.v[632]);s.store_scale(878, 837, s.v[632]);}
        if ((s.b[1285] && s.b[1325]) && (!s.b[1326])) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scalar(875, 0.0);s.store_scalar(876, 0.0);s.store_scale(877, 836, p.p15);s.store_scale(878, 837, p.p15);}
        if (s.b[1285] && (!s.b[1325])) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scale(875, 829, p.p15);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_18(
        ...
        if (s.b[1285] && (!s.b[1325])) {s.store_scale(876, 831, p.p15);s.store_scalar(877, 0.0);s.store_scalar(878, 0.0);}
        ...
        s.b[1328] = (p.p48 > 0.0);s.store_scalar(1328, if s.b[1328] { 1.0 } else { 0.0 });s.b[1329] = (p.p16 > s.v[632]);s.store_scalar(1329, if s.b[1329] { 1.0 } else { 0.0 });
        if ((s.b[1285] && s.b[1328]) && s.b[1329]) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scale(881, 829, (p.p16 - s.v[632]));s.store_scale(882, 831, (p.p16 - s.v[632]));s.store_scale(883, 836, s.v[632]);s.store_scale(884, 837, s.v[632]);}
        if ((s.b[1285] && s.b[1328]) && (!s.b[1329])) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scalar(881, 0.0);s.store_scalar(882, 0.0);s.store_scale(883, 836, p.p16);s.store_scale(884, 837, p.p16);}
        if (s.b[1285] && (!s.b[1328])) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scale(881, 829, p.p16);s.store_scale(882, 831, p.p16);s.store_scalar(883, 0.0);s.store_scalar(884, 0.0);}
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if s.b[1285] {s.store_offset_scaled(832, 391, ((p.p481) * ((p.p500 * p.p13))), (p.p500 * p.p13));}
        s.b[1331] = (p.p15 > s.v[632]);s.store_scalar(1331, if s.b[1331] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1331]) {s.store_offset_scaled(833, 391, ((p.p483) * ((p.p501 * (p.p15 - s.v[632])))), (p.p501 * (p.p15 - s.v[632])));s.store_offset_scaled(834, 391, ((p.p485) * ((p.p502 * s.v[632]))), (p.p502 * s.v[632]));}
        if (s.b[1285] && (!s.b[1331])) {s.store_scalar(833, 0.0);s.store_offset_scaled(834, 391, ((p.p485) * ((p.p502 * p.p15))), (p.p502 * p.p15));}
        ...
        if s.b[1285] {s.store_sub_from_scalar_scaled_input(841, p.p506, 391, p.p487);s.store_sub_from_scalar_scaled_input(842, p.p507, 391, p.p489);s.store_sub_from_scalar_scaled_input(843, p.p508, 391, p.p491);}
        s.b[1335] = ((s.v[841] < 0.01) && (p.p13 > 0.0));s.store_scalar(1335, if s.b[1335] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1335]) {s.store_scalar(841, 0.01);}
        s.b[1336] = ((s.v[842] < 0.01) && (p.p15 > s.v[632]));s.store_scalar(1336, if s.b[1336] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1336]) {s.store_scalar(842, 0.01);}
        s.b[1337] = ((s.v[843] < 0.01) && (p.p15 > 0.0));s.store_scalar(1337, if s.b[1337] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1337]) {s.store_scalar(843, 0.01);}
        if s.b[1285] {s.store_offset_scaled(835, 391, ((p.p482) * ((p.p523 * p.p14))), (p.p523 * p.p14));}
        s.b[1338] = (p.p16 > s.v[632]);s.store_scalar(1338, if s.b[1338] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1338]) {s.store_offset_scaled(838, 391, ((p.p484) * ((p.p524 * (p.p16 - s.v[632])))), (p.p524 * (p.p16 - s.v[632])));s.store_offset_scaled(839, 391, ((p.p486) * ((p.p525 * s.v[632]))), (p.p525 * s.v[632]));}
        if (s.b[1285] && (!s.b[1338])) {s.store_scalar(838, 0.0);s.store_offset_scaled(839, 391, ((p.p486) * ((p.p525 * p.p16))), (p.p525 * p.p16));}
        ...
        if s.b[1285] {s.store_sub_from_scalar_scaled_input(844, p.p529, 391, p.p488);s.store_sub_from_scalar_scaled_input(845, p.p530, 391, p.p490);s.store_sub_from_scalar_scaled_input(846, p.p531, 391, p.p492);}
        s.b[1342] = ((s.v[844] < 0.01) && (p.p14 > 0.0));s.store_scalar(1342, if s.b[1342] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1342]) {s.store_scalar(844, 0.01);}
        s.b[1343] = ((s.v[845] < 0.01) && (p.p16 > s.v[632]));s.store_scalar(1343, if s.b[1343] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1343]) {s.store_scalar(845, 0.01);}
        s.b[1344] = ((s.v[846] < 0.01) && (p.p16 > 0.0));s.store_scalar(1344, if s.b[1344] { 1.0 } else { 0.0 });
        if (s.b[1285] && s.b[1344]) {s.store_scalar(846, 0.01);}
        s.store_scaled_voltage(729, ctx, nodes, Some(5), Some(7), p.p87);s.store_scaled_voltage(731, ctx, nodes, Some(6), Some(7), p.p87);s.store_scaled_voltage(728, ctx, nodes, Some(8), Some(7), p.p87);s.store_scaled_voltage(733, ctx, nodes, Some(0), Some(2), p.p87);s.store_scaled_voltage(734, ctx, nodes, Some(6), Some(2), p.p87);s.store_scaled_voltage(735, ctx, nodes, Some(8), Some(2), p.p87);s.store_scaled_voltage(799, ctx, nodes, Some(0), Some(5), p.p87);s.store_scaled_voltage(804, ctx, nodes, Some(7), Some(2), p.p87);s.store_scaled_voltage(857, ctx, nodes, Some(10), Some(2), p.p87);s.store_scaled_voltage(858, ctx, nodes, Some(9), Some(0), p.p87);s.store_scaled_voltage(865, ctx, nodes, Some(8), Some(7), p.p87);s.store_scaled_voltage(866, ctx, nodes, Some(8), Some(5), p.p87);s.copy_ad(859, 857);s.copy_ad(860, 858);s.copy_ad(867, 865);s.copy_ad(868, 866);s.store_scalar(798, 0.0);
        ...
        if s.b[1345] {s.store_scalar(949, 1.0);s.copy_ad(790, 729);s.copy_ad(791, 731);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_20(
        ...
        if s.b[1345] {s.copy_ad(792, 728);s.copy_ad(793, 733);s.copy_ad(796, 734);s.copy_ad(797, 735);}
        ...
        s.b[1348] = ((p.p53 > 0.0) && (s.v[541] != 0.0));s.store_scalar(1348, if s.b[1348] { 1.0 } else { 0.0 });
        if s.b[1348] {s.store_voltage(732, ctx, nodes, Some(4), None);}
        s.b[1349] = (p.p53 == 2.0);s.store_scalar(1349, if s.b[1349] { 1.0 } else { 0.0 });
        if (s.b[1348] && s.b[1349]) {s.store_offset_sub_from_scalar_ad(781, p.p433, s.ad_value(732), (-(p.p337 * 10.0)));s.store_scalar(782, ((4.0 * p.p433) * (p.p337 * 10.0)));}
        ...
        if (s.b[1348] && s.b[1349]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(732, 781, (-0.5), 782, (-0.5), p.p433);}
        if s.b[1348] {s.store_scalar(387, (ctx_temp + p.p11));s.copy_ad(388, 387);s.store_add(387, 387, 732);s.store_offset(389, 388, (-s.v[764]));s.store_offset_square(390, 388, (-(s.v[764] * s.v[764])));s.store_offset(391, 387, (-s.v[764]));s.store_offset_square(392, 387, (-(s.v[764] * s.v[764])));s.store_scale(676, 387, 1.0 / (s.v[764]));s.store_ln(590, 676);s.store_sub_scaled_inputs_mixed_ai(393, A::sub_from_scalar(s.v[616], A::scale(s.ad_value(391), s.v[455])), 1.0, 392, s.v[456]);s.store_sqrt(677, 393);s.store_div_from_scalar(335, 1.0, 387);s.store_scalar(336, (1.0 / s.v[764]));s.store_add_scaled_inputs4_offset_mixed_iiaa(337, 335, p.p260, 336, (-p.p260), A::square(s.ad_value(335)), p.p261, A::square(s.ad_value(336)), (-p.p261), (s.v[616] + p.p259));s.store_sqrt(192, 337);s.store_mul(193, 337, 192);s.store_div_from_scalar_scaled_input(154, 1.6021918e-19, 387, 1.3806226e-23);s.store_div_from_scalar(155, 1.0, 154);s.store_square(156, 154);s.store_scalar(678, (1.6021918e-19 / (1.3806226e-23 * s.v[764])));s.store_scaled_mul_ad(394, A::exp_scaled_input(s.ad_value(590), 1.5), A::exp(A::add_scaled_product(s.ad_value(678), (s.v[616] / 2.0), s.ad_value(393), s.ad_value(154), (-1.0 / (2.0)))), 1.04e16);s.store_exp_scaled_input(335, 590, s.v[480]);s.store_div(679, 335, 573);}
        ...
        if (s.b[1348] && s.b[1351]) {s.store_div_mixed_ia(966, 966, A::powf(s.ad_value(676), p.p381));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_21(
        ...
        if (s.b[1348] && s.b[1351]) {s.store_div_mixed_ia(970, 970, A::powf(s.ad_value(676), p.p382));}
        ...
        if ((s.b[1348] && (!s.b[1351])) && s.b[1354]) {s.store_div_mixed_ia(966, 966, A::powf(s.ad_value(676), p.p381));s.store_offset_scaled(976, 676, p.p365, (((((-1.0)) * (p.p365))) + (p.p364)));}
        ...
        s.b[1357] = (p.p39 != 2.0);s.store_scalar(1357, if s.b[1357] { 1.0 } else { 0.0 });
        if (s.b[1348] && s.b[1357]) {s.store_mul_div_from_scalar_lhs_ad_mixed_ia(681, (s.v[641] * s.v[454]), 334, A::add_scaled_inputs(A::scale_offset(s.ad_value(389), p.p90, 1.0), 1.0, s.ad_value(390), p.p91));}
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if s.b[1348] {s.store_scaled_sqrt(139, 155, s.v[639]);s.store_square(694, 139);s.store_scaled_square(140, 394, s.v[640]);s.store_offset_scaled(427, 391, p.p448, p.p447);s.store_scalar(957, p.p193);}
    ...
    if (s.b[1397] && s.b[1398]) {
        ...
        s.store_scalar(74, t0);s.b[1399] = (s.v[448] == 2.0);s.store_scalar(1399, if s.b[1399] { 1.0 } else { 0.0 });
        let (t1,) = {
    if (s.b[1397] && s.b[1399]) {
        ...
        s.store_scalar(74, t1);s.b[1400] = (s.v[448] == 3.0);s.store_scalar(1400, if s.b[1400] { 1.0 } else { 0.0 });
        let (t2,) = {
    if (s.b[1397] && s.b[1400]) {
        ...
        s.store_scalar(74, t2);s.store_scalar(77, 0.0);s.b[1401] = (((s.v[449] == 1.0) && (p.p54 == 1.0)) && ((s.v[459] * (s.v[544] + s.v[459])) > 0.0));s.store_scalar(1401, if s.b[1401] { 1.0 } else { 0.0 });
        ...
        if s.b[1401] {s.store_scale(781, 376, (0.5 * (2.0 * 1.0 / (p.p262))));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
    ...
    pub(super) fn stamp_transient_block_26(
        ...
        if s.b[1401] {s.store_scalar(782, ((4.0 * p.p334) * (0.1 * p.p334)));}
        if s.b[1401] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (!s.b[1421]) {
        ...
        s.store_scalar(80, t4);s.copy_ad(335, 637);s.store_sqrt_mul(336, 335, 158);s.store_add_scaled_inputs_mixed_ai(190, A::offset(s.ad_value(158), s.v[160]), 1.0, 336, s.v[189]);s.b[1422] = (s.v[80] == 0.0);s.store_scalar(1422, if s.b[1422] { 1.0 } else { 0.0 });
        ...
        if (!s.b[1422]) {s.store_sqrt_square_add(782, 781, 782);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_30(
        ...
        if (!s.b[1422]) {s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_mixed_aii(336, A::div_from_scalar(1.0, s.ad_value(338)), 1.0, 781, (-0.5), 782, (-0.5));s.store_offset_scaled(184, 336, p.p235, p.p237);s.store_scalar(341, p.p235);}
        s.b[1425] = ((s.v[184] * 1000000000000.0) < s.v[187]);s.store_scalar(1425, if s.b[1425] { 1.0 } else { 0.0 });
        if ((!s.b[1422]) && s.b[1425]) {s.store_scalar(184, 0.0);}
        let (t5,) = {
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if s.b[1426] {s.store_offset_scaled(336, 180, (s.v[467] * 1.0 / (p.p140)), s.v[465]);s.store_add_scaled_inputs(337, 336, 1.0, 106, s.v[466]);s.store_offset(178, 106, p.p221);s.store_square(179, 178);s.store_add_scaled_inputs3_mixed_aia(174, A::mul3(s.ad_value(335), s.ad_value(121), s.ad_value(337)), 1.0, 177, 1.0, A::div(s.ad_value(618), s.ad_value(179)), -1.0);}
