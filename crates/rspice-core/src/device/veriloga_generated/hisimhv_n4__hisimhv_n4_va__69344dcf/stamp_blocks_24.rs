...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_141(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[421] + 1.0);let t1: f64 = if (((s.v[2621] != 0.0) && s.b[2718]) && (s.v[97] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
            t2 += 1;
    ...
    pub(super) fn stamp_reactive_block_144(
        ...
        let mut t4: usize = 0;
        while {
            let t3: f64 = if (((s.v[2621] != 0.0) && (!s.b[2775])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
            t4 += 1;
    ...
    pub(super) fn stamp_reactive_block_145(
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if (((((s.v[2621] != 0.0) && (s.v[406] != 0.0)) && s.b[2776]) && s.b[2777]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
            t6 += 1;
    ...
    pub(super) fn stamp_reactive_block_147(
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2786]) && s.b[2788]) && s.b[2789]) && s.b[2790]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
            t8 += 1;
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2795]) && (!s.b[2796])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_148(
        ...
        let mut ta: usize = 0;
        while {
            let t9: f64 = if ((((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2804]) && s.b[2805]) && s.b[2806]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    pub(super) fn stamp_reactive_block_149(
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2813]) && s.b[2814]) && s.b[2815]) && s.b[2816]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
            tc += 1;
        ...
        if ((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2821]) && (!s.b[2822])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_151(
        ...
        let mut tf: usize = 0;
        while {
            let td: f64 = (s.v[421] + 1.0);let te: f64 = if ((((s.v[2621] != 0.0) && (!s.b[2782])) && s.b[2821]) && (s.v[97] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
    ...
    pub(super) fn stamp_reactive_block_152(
        ...
        if (((s.v[2621] != 0.0) && s.b[2839]) && (!s.b[2840])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_153(
        ...
        let mut t12: usize = 0;
        while {
            let t10: f64 = (s.v[421] + 1.0);let t11: f64 = if (((s.v[2621] != 0.0) && s.b[2839]) && (s.v[97] <= t10)) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
            t12 += 1;
    ...
    pub(super) fn stamp_reactive_block_154(
        ...
        if (((s.v[2621] != 0.0) && s.b[2854]) && s.b[2855]) {s.store_sqrt_offset_square_offset(782, 2759, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(2759), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 2759, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_155(
        ...
        if ((((s.b[2867] && (!(s.b[2865] || s.b[2866]))) && s.b[2871]) && s.b[2872]) && s.b[2873]) {s.store_sqrt_offset_square_offset(782, 396, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 396, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_156(
        ...
        let mut t14: usize = 0;
        while {
            let t13: f64 = if (((s.v[2621] != 0.0) && (!s.b[2896])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
            t14 += 1;
