...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_80(
        ...
        if (s.b[1439] && (s.b[1442] && (!(s.b[1440] || s.b[1441])))) {s.store_offset_scaled_div(2148, 2144, 2145, (p[394] - p[395]), p[395]);s.store_scalar(79, 0.0);s.store_mul(2136, 2125, 2126);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
