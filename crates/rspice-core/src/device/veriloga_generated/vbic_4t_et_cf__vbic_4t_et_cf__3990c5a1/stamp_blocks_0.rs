...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_scaled_powf_ad(0, A::mul(A::powf(s.ad_value(36), p.p78), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p71)), s.ad_value(48)))), (1.0 / p.p12), p.p11);

        s.store_scaled_powf_ad(1, A::mul(A::powf(s.ad_value(36), p.p95), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p96)), s.ad_value(48)))), (1.0 / p.p13), p.p94);

        s.store_scaled_powf_ad(5, A::mul(A::powf(s.ad_value(36), p.p78), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p97)), s.ad_value(48)))), (1.0 / p.p44), p.p42);

        s.store_scaled_powf_ad(3, A::mul(A::powf(s.ad_value(36), p.p79), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p72)), s.ad_value(48)))), (1.0 / p.p33), p.p31);

        s.store_scaled_powf_ad(6, A::mul(A::powf(s.ad_value(36), p.p80), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p75)), s.ad_value(48)))), (1.0 / p.p35), p.p34);

        s.store_scaled_powf_ad(4, A::mul(A::powf(s.ad_value(36), p.p79), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p73)), s.ad_value(48)))), (1.0 / p.p37), p.p36);

        s.store_scaled_powf_ad(7, A::mul(A::powf(s.ad_value(36), p.p80), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p76)), s.ad_value(48)))), (1.0 / p.p39), p.p38);

        s.store_scaled_powf_ad(8, A::mul(A::powf(s.ad_value(36), p.p79), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p73)), s.ad_value(48)))), (1.0 / p.p37), p.p45);

        s.store_scaled_powf_ad(9, A::mul(A::powf(s.ad_value(36), p.p80), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p76)), s.ad_value(48)))), (1.0 / p.p39), p.p46);

        s.store_scaled_powf_ad(10, A::mul(A::powf(s.ad_value(36), p.p79), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p74)), s.ad_value(48)))), (1.0 / p.p48), p.p47);

        s.store_scaled_powf_ad(11, A::mul(A::powf(s.ad_value(36), p.p80), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p77)), s.ad_value(48)))), (1.0 / p.p50), p.p49);
        ...
        s.store_scaled_offset_ad(29, A::mul(s.ad_value(37), A::offset(A::scale(s.ad_value(37), p.p102), p.p101)), 1.0, p.p98);

        s.store_offset_scaled(30, 37, ((p.p103) * (p.p99)), p.p99);

        s.store_mul_ad(108, A::scale(A::div(s.ad_value(48), s.ad_value(36)), 2.0), A::ln(A::sub(A::exp(A::div(A::scale(s.ad_value(36), (0.5 * p.p17)), s.ad_value(48))), A::exp(A::div(A::scale(s.ad_value(36), ((-0.5) * p.p17)), s.ad_value(48))))));

        s.store_sub_ad(109, A::sub(A::mul(s.ad_value(108), s.ad_value(36)), A::mul(A::scale(s.ad_value(48), 3.0), A::ln(s.ad_value(36)))), A::scale(A::offset(s.ad_value(36), (-1.0)), p.p72));

        s.store_add_ad_rhs(19, 109, A::mul(A::scale(s.ad_value(48), 2.0), A::ln_scaled_input(A::offset(A::sqrt(A::offset(A::scale(A::exp(A::div(A::neg(s.ad_value(109)), s.ad_value(48))), 4.0), 1.0)), 1.0), 0.5)));

        s.store_mul_ad(108, A::scale(A::div(s.ad_value(48), s.ad_value(36)), 2.0), A::ln(A::sub(A::exp(A::div(A::scale(s.ad_value(36), (0.5 * p.p24)), s.ad_value(48))), A::exp(A::div(A::scale(s.ad_value(36), ((-0.5) * p.p24)), s.ad_value(48))))));

        s.store_sub_ad(109, A::sub(A::mul(s.ad_value(108), s.ad_value(36)), A::mul(A::scale(s.ad_value(48), 3.0), A::ln(s.ad_value(36)))), A::scale(A::offset(s.ad_value(36), (-1.0)), p.p73));

        s.store_add_ad_rhs(20, 109, A::mul(A::scale(s.ad_value(48), 2.0), A::ln_scaled_input(A::offset(A::sqrt(A::offset(A::scale(A::exp(A::div(A::neg(s.ad_value(109)), s.ad_value(48))), 4.0), 1.0)), 1.0), 0.5)));

        s.store_mul_ad(108, A::scale(A::div(s.ad_value(48), s.ad_value(36)), 2.0), A::ln(A::sub(A::exp(A::div(A::scale(s.ad_value(36), (0.5 * p.p28)), s.ad_value(48))), A::exp(A::div(A::scale(s.ad_value(36), ((-0.5) * p.p28)), s.ad_value(48))))));

        s.store_sub_ad(109, A::sub(A::mul(s.ad_value(108), s.ad_value(36)), A::mul(A::scale(s.ad_value(48), 3.0), A::ln(s.ad_value(36)))), A::scale(A::offset(s.ad_value(36), (-1.0)), p.p74));

        s.store_add_ad_rhs(21, 109, A::mul(A::scale(s.ad_value(48), 2.0), A::ln_scaled_input(A::offset(A::sqrt(A::offset(A::scale(A::exp(A::div(A::neg(s.ad_value(109)), s.ad_value(48))), 4.0), 1.0)), 1.0), 0.5)));
        ...
        s.store_mul_ad(31, A::scale(A::powf(s.ad_value(36), p.p78), p.p4), A::exp(A::div(A::scale(A::sub_from_scalar(1.0, s.ad_value(36)), (-p.p71)), s.ad_value(48))));

        s.store_scale_ad(32, A::powf(s.ad_value(36), p.p70), p.p3);

        s.store_exp_ad(33, A::div(A::neg(s.ad_value(29)), A::mul(s.ad_value(30), s.ad_value(48))));
        ...
        if (s.b[137] && s.b[138]) {
            ...
            s.store_mul_scaled_ad_rhs(113, 19, 1.0 / ((1.0 - p.p18)), A::sub_from_scalar(1.0, A::scale(s.ad_value(112), ((1.0 - p.p14) * (1.0 - p.p14)))));
            s.store_mul_ad_product_lhs(114, s.ad_value(111), A::offset(A::div(A::scale(s.ad_value(111), (0.5 * p.p18)), s.ad_value(19)), (1.0 - p.p14)), 112);
        }

        if (s.b[137] && (!s.b[138])) {
            s.store_mul_scaled_ad_rhs(113, 19, 1.0 / ((1.0 - p.p18)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(132), s.ad_value(19))), (1.0 - p.p18))));
        ...
        if (!s.b[137]) {
            ...
            s.store_scaled_mul_ad(117, A::neg(s.ad_value(19)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(19))), (1.0 - p.p18)), 1.0 / ((1.0 - p.p18)));
            s.store_add(118, 132, 110);
            s.store_sqrt_square_offset(119, 118, ((4.0 * p.p19) * p.p19));
            s.store_sub_ad_lhs(120, A::scale(A::sub(s.ad_value(118), s.ad_value(119)), 0.5), 110);
            s.store_scaled_mul_ad(113, A::neg(s.ad_value(19)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(19))), (1.0 - p.p18)), 1.0 / ((1.0 - p.p18)));
            s.store_sub_ad_lhs(88, A::add(s.ad_value(113), A::scale(A::add(A::sub(s.ad_value(132), s.ad_value(120)), s.ad_value(116)), (((1.0 - p.p14)) as f64).powf((-p.p18)))), 117);
        }
        ...
        if (s.b[139] && (!s.b[140])) {
            s.store_mul_scaled_ad_rhs(113, 19, 1.0 / ((1.0 - p.p18)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(133), s.ad_value(19))), (1.0 - p.p18))));
            s.store_scalar(114, 0.0);
        }
        ...
        if (!s.b[139]) {
            ...
            s.store_sub_ad_lhs(120, A::scale(A::sub(s.ad_value(118), s.ad_value(119)), 0.5), 110);
            s.store_scaled_mul_ad(113, A::neg(s.ad_value(19)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(19))), (1.0 - p.p18)), 1.0 / ((1.0 - p.p18)));
            s.store_sub_ad_lhs(89, A::add(s.ad_value(113), A::scale(A::add(A::sub(s.ad_value(133), s.ad_value(120)), s.ad_value(116)), (((1.0 - p.p14)) as f64).powf((-p.p18)))), 117);
        }
        ...
        if (s.b[141] && s.b[142]) {
            ...
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::scale(s.ad_value(112), ((1.0 - p.p14) * (1.0 - p.p14)))));
            s.store_mul_ad_product_lhs(114, s.ad_value(111), A::offset(A::div(A::scale(s.ad_value(111), (0.5 * p.p25)), s.ad_value(20)), (1.0 - p.p14)), 112);
        }
        ...
        if ((s.b[141] && (!s.b[142])) && s.b[143]) {
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::mul(A::powf(A::offset(A::div_from_scalar(p.p85, s.ad_value(20)), 1.0), (1.0 - p.p25)), A::sub_from_scalar(1.0, A::div(A::scale(A::offset(s.ad_value(134), p.p85), (1.0 - p.p25)), A::offset(s.ad_value(20), p.p85))))));
        }

        if ((s.b[141] && (!s.b[142])) && (!s.b[143])) {
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(134), s.ad_value(20))), (1.0 - p.p25))));
        }
        ...
        if ((!s.b[141]) && s.b[144]) {
            s.store_div_ad(121, A::offset(s.ad_value(110), p.p85), A::sub_from_scalar(p.p85, s.ad_value(110)));
            s.store_div_ad(122, A::scale(s.ad_value(121), 2.0), A::add(A::sqrt(A::offset(A::mul(A::offset(s.ad_value(121), (-1.0)), A::offset(s.ad_value(121), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul(A::offset(s.ad_value(121), 1.0), A::offset(s.ad_value(121), 1.0)), ((4.0 * p.p86) * p.p86)))));
            s.store_scaled_sub_ad_lhs(116, A::offset(A::mul(s.ad_value(122), A::sub_from_scalar(p.p85, s.ad_value(110))), (-p.p85)), 110, 0.5);
            s.store_mul_scaled_ad_rhs(123, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(20))), (1.0 - p.p25))));
            s.store_div_ad(124, A::add(A::offset(A::scale(s.ad_value(134), 2.0), p.p85), s.ad_value(110)), A::sub_from_scalar(p.p85, s.ad_value(110)));
            s.store_div_ad(125, A::scale(s.ad_value(124), 2.0), A::add(A::sqrt(A::offset(A::mul(A::offset(s.ad_value(124), (-1.0)), A::offset(s.ad_value(124), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul(A::offset(s.ad_value(124), 1.0), A::offset(s.ad_value(124), 1.0)), ((4.0 * p.p86) * p.p86)))));
            s.store_scaled_sub_ad_lhs(120, A::offset(A::mul(s.ad_value(125), A::sub_from_scalar(p.p85, s.ad_value(110))), (-p.p85)), 110, 0.5);
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25))));
            ...
            s.store_add_ad(129, A::mul(A::sub_from_scalar(1.0, s.ad_value(126)), s.ad_value(127)), A::mul(s.ad_value(126), s.ad_value(128)));
            s.store_mul_add_ad_lhs(130, A::sub(s.ad_value(134), s.ad_value(120)), s.ad_value(116), 129);
            s.store_sub_ad_lhs(90, A::add(s.ad_value(130), s.ad_value(113)), 123);
        }

        if ((!s.b[141]) && (!s.b[144])) {
            s.store_sqrt_square_offset(115, 110, ((4.0 * p.p26) * p.p26));
            s.store_scaled_add(116, 110, 115, (-0.5));
            s.store_scaled_mul_ad(117, A::neg(s.ad_value(20)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_add(118, 134, 110);
            s.store_sqrt_square_offset(119, 118, ((4.0 * p.p26) * p.p26));
            s.store_sub_ad_lhs(120, A::scale(A::sub(s.ad_value(118), s.ad_value(119)), 0.5), 110);
            s.store_scaled_mul_ad(113, A::neg(s.ad_value(20)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_sub_ad_lhs(90, A::add(s.ad_value(113), A::scale(A::add(A::sub(s.ad_value(134), s.ad_value(120)), s.ad_value(116)), (((1.0 - p.p14)) as f64).powf((-p.p25)))), 117);
        }
        ...
        if ((s.b[145] && (!s.b[146])) && s.b[147]) {
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::mul(A::powf(A::offset(A::div_from_scalar(p.p85, s.ad_value(20)), 1.0), (1.0 - p.p25)), A::sub_from_scalar(1.0, A::div(A::scale(A::offset(s.ad_value(136), p.p85), (1.0 - p.p25)), A::offset(s.ad_value(20), p.p85))))));
        }

        if ((s.b[145] && (!s.b[146])) && (!s.b[147])) {
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(136), s.ad_value(20))), (1.0 - p.p25))));
        }
        ...
        if ((!s.b[145]) && s.b[148]) {
            ...
            s.store_scaled_sub_ad_lhs(116, A::offset(A::mul(s.ad_value(122), A::sub_from_scalar(p.p85, s.ad_value(110))), (-p.p85)), 110, 0.5);
            s.store_mul_scaled_ad_rhs(123, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(20))), (1.0 - p.p25))));
            s.store_div_ad(124, A::add(A::offset(A::scale(s.ad_value(136), 2.0), p.p85), s.ad_value(110)), A::sub_from_scalar(p.p85, s.ad_value(110)));
            s.store_div_ad(125, A::scale(s.ad_value(124), 2.0), A::add(A::sqrt(A::offset(A::mul(A::offset(s.ad_value(124), (-1.0)), A::offset(s.ad_value(124), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul(A::offset(s.ad_value(124), 1.0), A::offset(s.ad_value(124), 1.0)), ((4.0 * p.p86) * p.p86)))));
            s.store_scaled_sub_ad_lhs(120, A::offset(A::mul(s.ad_value(125), A::sub_from_scalar(p.p85, s.ad_value(110))), (-p.p85)), 110, 0.5);
            s.store_mul_scaled_ad_rhs(113, 20, 1.0 / ((1.0 - p.p25)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25))));
            s.store_scaled_offset(126, 125, 1.0, 0.5);
            ...
            s.store_powf_ad(128, A::offset(A::div(s.ad_value(110), s.ad_value(20)), 1.0), (-p.p25));
            s.store_add_ad(129, A::mul(A::sub_from_scalar(1.0, s.ad_value(126)), s.ad_value(127)), A::mul(s.ad_value(126), s.ad_value(128)));
            s.store_mul_add_ad_lhs(130, A::sub(s.ad_value(136), s.ad_value(120)), s.ad_value(116), 129);
            s.store_sub_ad_lhs(91, A::add(s.ad_value(130), s.ad_value(113)), 123);
        }
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if ((!s.b[145]) && (!s.b[148])) {
            ...
            s.store_sub_ad_lhs(120, A::scale(A::sub(s.ad_value(118), s.ad_value(119)), 0.5), 110);
            s.store_scaled_mul_ad(113, A::neg(s.ad_value(20)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_sub_ad_lhs(91, A::add(s.ad_value(113), A::scale(A::add(A::sub(s.ad_value(136), s.ad_value(120)), s.ad_value(116)), (((1.0 - p.p14)) as f64).powf((-p.p25)))), 117);
        }
        ...
        if ((s.b[149] && s.b[150]) && s.b[151]) {
            ...
            s.store_mul_scaled_ad_rhs(113, 21, 1.0 / ((1.0 - p.p29)), A::sub_from_scalar(1.0, A::scale(s.ad_value(112), ((1.0 - p.p14) * (1.0 - p.p14)))));
            s.store_mul_ad_product_lhs(114, s.ad_value(111), A::offset(A::div(A::scale(s.ad_value(111), (0.5 * p.p29)), s.ad_value(21)), (1.0 - p.p14)), 112);
        }

        if ((s.b[149] && s.b[150]) && (!s.b[151])) {
            s.store_mul_scaled_ad_rhs(113, 21, 1.0 / ((1.0 - p.p29)), A::sub_from_scalar(1.0, A::powf(A::sub_from_scalar(1.0, A::div(A::voltage(ctx, nodes, Some(11), Some(10)), s.ad_value(21))), (1.0 - p.p29))));
            s.store_scalar(114, 0.0);
        }
        ...
        if (s.b[149] && (!s.b[150])) {
            ...
            s.store_scaled_add(116, 110, 115, (-0.5));
            s.store_scaled_mul_ad(117, A::neg(s.ad_value(21)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(21))), (1.0 - p.p29)), 1.0 / ((1.0 - p.p29)));
            s.store_add_ad_lhs(118, A::voltage(ctx, nodes, Some(11), Some(10)), 110);
            s.store_sqrt_square_offset(119, 118, ((4.0 * p.p30) * p.p30));
            s.store_sub_ad_lhs(120, A::scale(A::sub(s.ad_value(118), s.ad_value(119)), 0.5), 110);
            s.store_scaled_mul_ad(113, A::neg(s.ad_value(21)), A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(21))), (1.0 - p.p29)), 1.0 / ((1.0 - p.p29)));
            s.store_sub_ad_lhs(92, A::add(s.ad_value(113), A::scale(A::add(A::sub(A::voltage(ctx, nodes, Some(11), Some(10)), s.ad_value(120)), s.ad_value(116)), (((1.0 - p.p14)) as f64).powf((-p.p29)))), 117);
        }
        ...
        s.store_add_scaled_ad_lhs(53, A::offset(A::scale(s.ad_value(88), s.v[39]), 1.0), 90, s.v[38]);

        s.store_offset_scaled_ad(54, A::offset(A::add(A::sqrt(A::offset(A::mul(A::offset(s.ad_value(53), (-0.0001)), A::offset(s.ad_value(53), (-0.0001))), 1e-8)), s.ad_value(53)), (-0.0001)), 0.5, 0.0001);

        s.store_add_scaled_ad_lhs(55, A::mul(s.ad_value(49), s.ad_value(40)), 50, s.v[41]);

        s.b[152] = (p.p88 < 0.5);
        s.v[152] = if s.b[152] { 1.0 } else { 0.0 };

        if s.b[152] {
            s.store_scaled_add_ad_rhs(56, 54, A::powf(A::add(A::powf(s.ad_value(54), (1.0 / p.p89)), A::scale(s.ad_value(55), 4.0)), p.p89), 0.5);
        }

        if (!s.b[152]) {
            s.store_mul_scaled_ad_rhs(56, 54, 0.5, A::offset(A::powf(A::offset(A::scale(s.ad_value(55), 4.0), 1.0), p.p89), 1.0));
        }
        ...
        if s.b[153] {
            ...
            s.store_mul_offset_ad_rhs(57, 5, A::add(A::scale(s.ad_value(83), p.p43), A::scale(s.ad_value(87), (1.0 - p.p43))), (-1.0));
            s.store_scale(60, 57, s.v[42]);
            s.store_scaled_offset_ad(61, A::sqrt(A::offset(A::scale(s.ad_value(60), 4.0), 1.0)), 1.0, 0.5);
            s.store_div_voltage_by_ad(82, ctx, nodes, Some(11), Some(10), A::scale(s.ad_value(48), p.p44));
            s.store_limexp(83, 82);
            s.store_mul_offset_rhs(58, 5, 83, (-1.0));
            s.store_div_ad_lhs(59, A::sub(s.ad_value(57), s.ad_value(58)), 61);
        }
        ...
        if (s.b[154] && s.b[155]) {
            s.store_div_ad(86, A::sub(A::neg(s.ad_value(29)), s.ad_value(132)), A::mul(s.ad_value(30), s.ad_value(48)));
            s.store_limexp(87, 86);
            s.store_sub_ad(62, A::add(A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0)))), A::scale(A::sub(s.ad_value(87), s.ad_value(33)), p.p100));
        }

        if (s.b[154] && (!s.b[155])) {
            s.store_add_ad(62, A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0))));
        }
        ...
        if (((!s.b[154]) && s.b[156]) && s.b[157]) {
            s.store_div_ad(86, A::sub(A::neg(s.ad_value(29)), s.ad_value(133)), A::mul(s.ad_value(30), s.ad_value(48)));
            s.store_limexp(87, 86);
            s.store_sub_ad(63, A::add(A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0)))), A::scale(A::sub(s.ad_value(87), s.ad_value(33)), p.p100));
        }

        if (((!s.b[154]) && s.b[156]) && (!s.b[157])) {
            s.store_add_ad(63, A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0))));
        }
        ...
        if (((!s.b[154]) && (!s.b[156])) && s.b[158]) {
            s.store_div_ad(86, A::sub(A::neg(s.ad_value(29)), s.ad_value(132)), A::mul(s.ad_value(30), s.ad_value(48)));
            s.store_limexp(87, 86);
            s.store_scaled_sub_ad(62, A::add(A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0)))), A::scale(A::sub(s.ad_value(87), s.ad_value(33)), p.p100), p.p32);
        }

        if (((!s.b[154]) && (!s.b[156])) && (!s.b[158])) {
            s.store_scaled_add_ad(62, A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0))), p.p32);
        }
        ...
        if (((!s.b[154]) && (!s.b[156])) && s.b[159]) {
            s.store_div_ad(86, A::sub(A::neg(s.ad_value(29)), s.ad_value(133)), A::mul(s.ad_value(30), s.ad_value(48)));
            s.store_limexp(87, 86);
            s.store_scaled_sub_ad(63, A::add(A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0)))), A::scale(A::sub(s.ad_value(87), s.ad_value(33)), p.p100), (1.0 - p.p32));
        }

        if (((!s.b[154]) && (!s.b[156])) && (!s.b[159])) {
            s.store_scaled_add_ad(63, A::mul(s.ad_value(3), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(6), A::offset(s.ad_value(85), (-1.0))), (1.0 - p.p32));
        }
        ...
        s.store_add_ad(64, A::mul(s.ad_value(4), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(7), A::offset(s.ad_value(85), (-1.0))));
        ...
        if s.b[160] {
            ...
            s.store_limexp(85, 84);
            s.store_add_ad(66, A::mul(s.ad_value(8), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(9), A::offset(s.ad_value(85), (-1.0))));
        }
        ...
        if s.b[161] {
            s.store_scaled_add_ad(120, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(20), s.ad_value(134)), A::sub(s.ad_value(20), s.ad_value(134))), 0.01)), A::sub(s.ad_value(20), s.ad_value(134)), 0.5);
            s.store_mul_scaled_ad_rhs(69, 120, p.p40, A::limexp(A::mul(A::neg(s.ad_value(28)), A::powf(s.ad_value(120), (p.p25 - 1.0)))));
            s.store_mul_sub_ad_lhs(68, A::sub(s.ad_value(51), s.ad_value(52)), s.ad_value(64), 69);
        }
        ...
        if s.b[163] {
            ...
            s.store_div_ad(81, A::mul(A::mul(s.ad_value(43), s.ad_value(13)), s.ad_value(80)), A::offset(A::mul(A::scale(s.ad_value(43), (0.5 * s.v[44])), A::sqrt(A::offset(A::square(A::voltage(ctx, nodes, Some(5), Some(6))), 0.01))), 1.0));
        ...
        if s.b[165] {
            s.store_div_ad_lhs(73, A::mul(A::voltage(ctx, nodes, Some(7), Some(8)), s.ad_value(56)), 15);
        }
        ...
        if s.b[167] {
            s.store_div_ad_lhs(75, A::mul(A::voltage(ctx, nodes, Some(10), Some(5)), s.ad_value(61)), 18);
        }
        ...
        if s.b[168] {
            s.store_div_voltage_by_ad(82, ctx, nodes, Some(11), Some(10), A::scale(s.ad_value(48), p.p48));
            s.store_limexp(83, 82);
            s.store_div_voltage_by_ad(84, ctx, nodes, Some(11), Some(10), A::scale(s.ad_value(48), p.p50));
        }
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[168] {
            s.store_limexp(85, 84);
            s.store_add_ad(67, A::mul(s.ad_value(10), A::offset(s.ad_value(83), (-1.0))), A::mul(s.ad_value(11), A::offset(s.ad_value(85), (-1.0))));
        }
        ...
        s.store_div_ad_rhs(95, 94, A::offset(s.ad_value(94), 1.0));

        s.store_mul_ad(96, A::scale(A::offset(A::scale(s.ad_value(54), p.p57), 1.0), p.p56), A::offset(A::scale(A::mul(A::scale(A::limexp_scaled_input(s.ad_value(134), (s.v[45] * 1.0 / (1.44))), p.p58), A::offset(A::square(s.ad_value(95)), s.v[47])), s.v[93]), 1.0));

        s.store_add_ad(97, A::scale(A::mul(s.ad_value(22), s.ad_value(88)), p.p32), A::div(A::mul(s.ad_value(96), s.ad_value(49)), s.ad_value(56)));

        s.store_scaled_mul(98, 22, 89, (1.0 - p.p32));

        s.store_add_scaled_ad_lhs(99, A::add(A::mul(s.ad_value(23), s.ad_value(90)), A::scale(s.ad_value(50), p.p61)), 77, p.p22);

        s.store_scale(100, 78, p.p22);

        s.store_add_scaled_ad_lhs(101, A::mul(s.ad_value(24), s.ad_value(91)), 57, p.p61);

        s.store_add_ad(102, A::mul(s.ad_value(25), s.ad_value(92)), A::scale(A::voltage(ctx, nodes, Some(11), Some(10)), p.p87));

        s.store_scaled_voltage(103, ctx, nodes, Some(1), Some(2), p.p15);

        s.store_scaled_voltage(104, ctx, nodes, Some(1), Some(0), p.p20);

        let assign3230_ad_e3798: A = A::add(A::add(A::add(A::add(A::add(A::mul(s.ad_value(62), s.ad_value(132)), A::mul(s.ad_value(65), s.ad_value(134))), A::mul(A::sub(s.ad_value(51), s.ad_value(52)), A::voltage(ctx, nodes, Some(6), Some(9)))), A::mul(s.ad_value(63), s.ad_value(133))), A::mul(s.ad_value(66), s.ad_value(136))), A::mul(s.ad_value(76), A::voltage(ctx, nodes, Some(3), Some(11))));
        let assign3230_ad_e3818: A = A::add(A::add(A::add(A::add(A::add(assign3230_ad_e3798, A::mul(s.ad_value(67), A::voltage(ctx, nodes, Some(11), Some(10)))), A::mul(s.ad_value(59), A::voltage(ctx, nodes, Some(7), Some(11)))), A::mul(s.ad_value(70), A::voltage(ctx, nodes, Some(0), Some(5)))), A::mul(s.ad_value(71), A::voltage(ctx, nodes, Some(5), Some(6)))), A::mul(s.ad_value(72), A::voltage(ctx, nodes, Some(1), Some(7))));
        s.store_neg_ad(105, A::add(A::add(A::add(assign3230_ad_e3818, A::mul(s.ad_value(73), A::voltage(ctx, nodes, Some(7), Some(8)))), A::mul(s.ad_value(74), A::voltage(ctx, nodes, Some(2), Some(9)))), A::mul(s.ad_value(75), A::voltage(ctx, nodes, Some(10), Some(5)))));
