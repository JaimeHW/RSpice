...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_add_scaled_product_right_ad(19, 109, 1.0, 48, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::div_scaled_inputs(s.ad_value(109), -1.0, s.ad_value(48), 1.0)), 4.0, 1.0)), 1.0), 0.5), 2.0);
        ...
        s.store_add_scaled_product_right_ad(20, 109, 1.0, 48, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::div_scaled_inputs(s.ad_value(109), -1.0, s.ad_value(48), 1.0)), 4.0, 1.0)), 1.0), 0.5), 2.0);
        ...
        s.store_add_scaled_product_right_ad(21, 109, 1.0, 48, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::div_scaled_inputs(s.ad_value(109), -1.0, s.ad_value(48), 1.0)), 4.0, 1.0)), 1.0), 0.5), 2.0);
        ...
        if (s.b[137] && s.b[138]) {
            ...
            s.store_mul_sub_from_scalar_scaled_rhs_scaled_output(113, 19, 1.0, 112, ((1.0 - p.p14) * (1.0 - p.p14)), 1.0 / ((1.0 - p.p18)));
        ...
        if (s.b[137] && (!s.b[138])) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 19, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(132), s.ad_value(19))), (1.0 - p.p18)), 1.0 / ((1.0 - p.p18)));
        ...
        if (s.b[139] && (!s.b[140])) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 19, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(133), s.ad_value(19))), (1.0 - p.p18)), 1.0 / ((1.0 - p.p18)));
            s.store_scalar(114, 0.0);
        }
        ...
        if (s.b[141] && s.b[142]) {
            ...
            s.store_mul_sub_from_scalar_scaled_rhs_scaled_output(113, 20, 1.0, 112, ((1.0 - p.p14) * (1.0 - p.p14)), 1.0 / ((1.0 - p.p25)));
        ...
        if ((s.b[141] && (!s.b[142])) && s.b[143]) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::mul_sub_from_scalar_rhs(A::powf(A::offset(A::div_from_scalar(p.p85, s.ad_value(20)), 1.0), (1.0 - p.p25)), 1.0, A::div_scaled_offset_numerator(s.ad_value(134), (1.0 - p.p25), (p.p85 * (1.0 - p.p25)), A::offset(s.ad_value(20), p.p85), 1.0)), 1.0 / ((1.0 - p.p25)));
        }

        if ((s.b[141] && (!s.b[142])) && (!s.b[143])) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(134), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
        }
        ...
        if ((!s.b[141]) && s.b[144]) {
            s.store_div_scaled_offset_numerator(121, s.ad_value(110), 1.0, p.p85, A::sub_from_scalar(p.p85, s.ad_value(110)), 1.0);
            s.store_div_scaled_inputs(122, s.ad_value(121), 2.0, A::add(A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(121), (-1.0), A::offset(s.ad_value(121), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(121), 1.0, A::offset(s.ad_value(121), 1.0)), ((4.0 * p.p86) * p.p86)))), 1.0);
            s.store_scaled_sub_ad_lhs(116, A::offset(A::mul_sub_from_scalar_rhs(s.ad_value(122), p.p85, s.ad_value(110)), (-p.p85)), 110, 0.5);
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(123, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_div_scaled_inputs2(124, A::scale_offset(s.ad_value(134), 2.0, p.p85), 1.0, s.ad_value(110), 1.0, A::sub_from_scalar(p.p85, s.ad_value(110)), 1.0);
            s.store_div_scaled_inputs(125, s.ad_value(124), 2.0, A::add(A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(124), (-1.0), A::offset(s.ad_value(124), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(124), 1.0, A::offset(s.ad_value(124), 1.0)), ((4.0 * p.p86) * p.p86)))), 1.0);
            s.store_scaled_sub_ad_lhs(120, A::offset(A::mul_sub_from_scalar_rhs(s.ad_value(125), p.p85, s.ad_value(110)), (-p.p85)), 110, 0.5);
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            ...
            s.store_add_scaled_product_value_ad(129, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(126), s.ad_value(127)), 1.0, 126, 128, 1.0);
            s.store_mul_add_scaled_inputs3_offset_rhs(130, 129, s.ad_value(134), 1.0, s.ad_value(120), (-1.0), s.ad_value(116), 1.0, 0.0);
        ...
        if ((s.b[145] && (!s.b[146])) && s.b[147]) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::mul_sub_from_scalar_rhs(A::powf(A::offset(A::div_from_scalar(p.p85, s.ad_value(20)), 1.0), (1.0 - p.p25)), 1.0, A::div_scaled_offset_numerator(s.ad_value(136), (1.0 - p.p25), (p.p85 * (1.0 - p.p25)), A::offset(s.ad_value(20), p.p85), 1.0)), 1.0 / ((1.0 - p.p25)));
        }

        if ((s.b[145] && (!s.b[146])) && (!s.b[147])) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(136), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
        }
        ...
        if ((!s.b[145]) && s.b[148]) {
            ...
            s.store_scaled_sub_ad_lhs(116, A::offset(A::mul_sub_from_scalar_rhs(s.ad_value(122), p.p85, s.ad_value(110)), (-p.p85)), 110, 0.5);
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(123, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(116), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_div_scaled_inputs2(124, A::scale_offset(s.ad_value(136), 2.0, p.p85), 1.0, s.ad_value(110), 1.0, A::sub_from_scalar(p.p85, s.ad_value(110)), 1.0);
            s.store_div_scaled_inputs(125, s.ad_value(124), 2.0, A::add(A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(124), (-1.0), A::offset(s.ad_value(124), (-1.0))), ((4.0 * p.p26) * p.p26))), A::sqrt(A::offset(A::mul_offset_lhs(s.ad_value(124), 1.0, A::offset(s.ad_value(124), 1.0)), ((4.0 * p.p86) * p.p86)))), 1.0);
            s.store_scaled_sub_ad_lhs(120, A::offset(A::mul_sub_from_scalar_rhs(s.ad_value(125), p.p85, s.ad_value(110)), (-p.p85)), 110, 0.5);
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 20, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(s.ad_value(120), s.ad_value(20))), (1.0 - p.p25)), 1.0 / ((1.0 - p.p25)));
            s.store_scaled_offset(126, 125, 1.0, 0.5);
            ...
            s.store_powf_ad(128, A::offset(A::div(s.ad_value(110), s.ad_value(20)), 1.0), (-p.p25));
            s.store_add_scaled_product_value_ad(129, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(126), s.ad_value(127)), 1.0, 126, 128, 1.0);
            s.store_mul_add_scaled_inputs3_offset_rhs(130, 129, s.ad_value(136), 1.0, s.ad_value(120), (-1.0), s.ad_value(116), 1.0, 0.0);
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if ((s.b[149] && s.b[150]) && s.b[151]) {
            ...
            s.store_mul_sub_from_scalar_scaled_rhs_scaled_output(113, 21, 1.0, 112, ((1.0 - p.p14) * (1.0 - p.p14)), 1.0 / ((1.0 - p.p29)));
        ...
        if ((s.b[149] && s.b[150]) && (!s.b[151])) {
            s.store_mul_sub_from_scalar_ad_rhs_scaled_output(113, 21, 1.0, A::powf(A::sub_from_scalar(1.0, A::div(A::voltage(ctx, nodes, Some(11), Some(10)), s.ad_value(21))), (1.0 - p.p29)), 1.0 / ((1.0 - p.p29)));
            s.store_scalar(114, 0.0);
        }
        ...
        if s.b[153] {
            s.store_div_scaled_inputs(82, s.ad_value(136), 1.0, s.ad_value(48), p.p44);
            s.store_limexp(83, 82);
            s.store_div_scaled_inputs(86, s.ad_value(134), 1.0, s.ad_value(48), p.p44);
            ...
            s.store_div_scaled_inputs(82, A::voltage(ctx, nodes, Some(11), Some(10)), 1.0, s.ad_value(48), p.p44);
            s.store_limexp(83, 82);
            s.store_mul_offset_rhs(58, 5, 83, (-1.0));
            s.store_div_scaled_inputs2(59, s.ad_value(57), 1.0, s.ad_value(58), (-1.0), s.ad_value(61), 1.0);
        }
        ...
        if s.b[154] {
            s.store_div_scaled_inputs(82, s.ad_value(132), 1.0, s.ad_value(48), p.p33);
            s.store_limexp(83, 82);
            s.store_div_scaled_inputs(84, s.ad_value(132), 1.0, s.ad_value(48), p.p35);
        ...
        if (s.b[154] && s.b[155]) {
            s.store_div_scaled_inputs2(86, s.ad_value(29), -1.0, s.ad_value(132), (-1.0), A::mul(s.ad_value(30), s.ad_value(48)), 1.0);
            s.store_limexp(87, 86);
        ...
        if (s.b[154] && (!s.b[155])) {
            s.store_add_scaled_products_mixed_iaia(62, 3, A::offset(s.ad_value(83), (-1.0)), 1.0, 6, A::offset(s.ad_value(85), (-1.0)), 1.0);
        }
        ...
        if ((!s.b[154]) && s.b[156]) {
            ...
            s.store_div_scaled_inputs(82, s.ad_value(133), 1.0, s.ad_value(48), p.p33);
            s.store_limexp(83, 82);
            s.store_div_scaled_inputs(84, s.ad_value(133), 1.0, s.ad_value(48), p.p35);
            s.store_limexp(85, 84);
        }
        ...
        if (((!s.b[154]) && s.b[156]) && s.b[157]) {
            s.store_div_scaled_inputs2(86, s.ad_value(29), -1.0, s.ad_value(133), (-1.0), A::mul(s.ad_value(30), s.ad_value(48)), 1.0);
            s.store_limexp(87, 86);
        ...
        if (((!s.b[154]) && s.b[156]) && (!s.b[157])) {
            s.store_add_scaled_products_mixed_iaia(63, 3, A::offset(s.ad_value(83), (-1.0)), 1.0, 6, A::offset(s.ad_value(85), (-1.0)), 1.0);
        }
        ...
        if (((!s.b[154]) && (!s.b[156])) && (!s.b[158])) {
            s.store_add_scaled_products_mixed_iaia(62, 3, A::offset(s.ad_value(83), (-1.0)), p.p32, 6, A::offset(s.ad_value(85), (-1.0)), p.p32);
        }
        ...
        if (((!s.b[154]) && (!s.b[156])) && (!s.b[159])) {
            s.store_add_scaled_products_mixed_iaia(63, 3, A::offset(s.ad_value(83), (-1.0)), (1.0 - p.p32), 6, A::offset(s.ad_value(85), (-1.0)), (1.0 - p.p32));
        }

        s.store_div_scaled_inputs(82, s.ad_value(134), 1.0, s.ad_value(48), p.p37);

        s.store_limexp(83, 82);

        s.store_div_scaled_inputs(84, s.ad_value(134), 1.0, s.ad_value(48), p.p39);

        s.store_limexp(85, 84);

        s.store_add_scaled_products_mixed_iaia(64, 4, A::offset(s.ad_value(83), (-1.0)), 1.0, 7, A::offset(s.ad_value(85), (-1.0)), 1.0);

        s.b[160] = ((p.p45 > 0.0) || (p.p46 > 0.0));
        s.v[160] = if s.b[160] { 1.0 } else { 0.0 };

        if s.b[160] {
            s.store_div_scaled_inputs(82, s.ad_value(136), 1.0, s.ad_value(48), p.p37);
            s.store_limexp(83, 82);
            s.store_div_scaled_inputs(84, s.ad_value(136), 1.0, s.ad_value(48), p.p39);
            s.store_limexp(85, 84);
            s.store_add_scaled_products_mixed_iaia(66, 8, A::offset(s.ad_value(83), (-1.0)), 1.0, 9, A::offset(s.ad_value(85), (-1.0)), 1.0);
        }
        ...
        if s.b[161] {
            s.store_add_scaled_inputs3_sqrt_first_mixed_aii(120, A::offset(A::mul(A::sub(s.ad_value(20), s.ad_value(134)), A::sub(s.ad_value(20), s.ad_value(134))), 0.01), 0.5, 20, 0.5, 134, ((-1.0) * 0.5));
            s.store_mul_scaled_ad_rhs(69, 120, p.p40, A::limexp(A::mul_scaled_lhs(s.ad_value(28), -1.0, A::powf(s.ad_value(120), (p.p25 - 1.0)))));
            s.store_mul_add_scaled_inputs3_offset_rhs(68, 69, s.ad_value(51), 1.0, s.ad_value(52), (-1.0), s.ad_value(64), -1.0, 0.0);
        }
        ...
        if s.b[163] {
            s.store_div_scaled_offset_numerator(79, s.ad_value(77), 1.0, 1.0, A::offset(s.ad_value(78), 1.0), 1.0);
            s.store_div_scaled_add_product(80, A::voltage(ctx, nodes, Some(5), Some(6)), 1.0, s.ad_value(48), A::add_scaled_inputs3(s.ad_value(77), 1.0, s.ad_value(78), (-1.0), A::ln(s.ad_value(79)), -1.0), 1.0, s.ad_value(13), 1.0);
            s.store_div_scaled_product3_mixed_iiia(81, 43, 13, 80, 1.0, A::offset(A::mul_scaled_lhs(s.ad_value(43), (0.5 * s.v[44]), A::sqrt(A::offset(A::square(A::voltage(ctx, nodes, Some(5), Some(6))), 0.01))), 1.0), 1.0);
        ...
        if s.b[165] {
            s.store_div_scaled_product_left_ad(73, A::voltage(ctx, nodes, Some(7), Some(8)), 56, 1.0, 15, 1.0);
        }
        ...
        if s.b[167] {
            s.store_div_scaled_product_left_ad(75, A::voltage(ctx, nodes, Some(10), Some(5)), 61, 1.0, 18, 1.0);
        }
        ...
        if s.b[168] {
            s.store_div_scaled_inputs(82, A::voltage(ctx, nodes, Some(11), Some(10)), 1.0, s.ad_value(48), p.p48);
            s.store_limexp(83, 82);
            s.store_div_scaled_inputs(84, A::voltage(ctx, nodes, Some(11), Some(10)), 1.0, s.ad_value(48), p.p50);
        }
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if s.b[168] {
            s.store_limexp(85, 84);
            s.store_add_scaled_products_mixed_iaia(67, 10, A::offset(s.ad_value(83), (-1.0)), 1.0, 11, A::offset(s.ad_value(85), (-1.0)), 1.0);
        }
        ...
        s.store_div_scaled_value_offset_denominator(95, s.ad_value(94), 1.0, s.ad_value(94), 1.0, 1.0);

        s.store_scaled_mul_scale_offset_rhs_ad(96, A::offset(A::mul_offset_rhs_scaled_output(A::limexp_scaled_input(s.ad_value(134), (s.v[45] * 1.0 / (1.44))), A::square(s.ad_value(95)), s.v[47], (p.p58 * s.v[93])), 1.0), 54, p.p57, 1.0, p.p56);

        s.store_add_scaled_product_value_ad(97, A::div_scaled_product(s.ad_value(96), s.ad_value(49), 1.0, s.ad_value(56), 1.0), 1.0, 22, 88, p.p32);
        ...
        s.store_add_scaled_product_value_ad(102, A::voltage(ctx, nodes, Some(11), Some(10)), p.p87, 25, 92, 1.0);
