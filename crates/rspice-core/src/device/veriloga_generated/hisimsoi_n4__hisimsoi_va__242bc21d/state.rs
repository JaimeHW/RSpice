...
impl Instance {
    ...
    fn recompute_instance_static(&mut self) {
        ...
        let v404: bool = (v2 && (p.p262 != 0.0));
        self.scalar_v404 = v404;
        let v423: bool = (v2 && v380);
