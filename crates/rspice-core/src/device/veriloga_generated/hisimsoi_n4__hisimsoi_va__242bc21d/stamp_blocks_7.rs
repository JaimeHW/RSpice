...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_21(
        ...
        if ((((s.b[733] && s.b[800]) && s.b[801]) && s.b[861]) && (p[37] != 0.0)) {s.store_scaled_voltage(596, ctx, nodes, Some(17), None, (1e-9 / 0.0001));s.copy_ad(393, 596);}
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        let mut t1a: usize = 0;
        while {
            let t19: f64 = if ((s.b[733] && (!s.b[925])) && (s.v[168] <= s.v[58])) { 1.0 } else { 0.0 };
            t19 != 0.0
        } {
            t1a += 1;
            ...
            let mut t16: usize = 0;
            while {
                let t15: f64 = if (((s.b[733] && (!s.b[925])) && (!s.b[1011])) && (s.v[44] >= 60.0)) { 1.0 } else { 0.0 };
                t15 != 0.0
            } {
                t16 += 1;
            ...
            let mut t18: usize = 0;
            while {
                let t17: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1014]) && s.b[1015]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t17 != 0.0
            } {
                t18 += 1;
            ...
            let mut t14: usize = 0;
            while {
                let t13: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1020]) && s.b[1021]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t13 != 0.0
            } {
                t14 += 1;
    ...
    pub(super) fn stamp_reactive_block_30(
        ...
        let mut t1c: usize = 0;
        while {
            let t1b: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1038]) && s.b[1039]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1b != 0.0
        } {
            t1c += 1;
        ...
        if ((s.b[733] && (!s.b[925])) && s.b[1045]) {s.store_sub_scaled_inputs(44, 341, 1e-5, 414, 1.0);s.store_square(49, 44);s.store_scaled_mul(50, 341, 341, (1e-5 * 1e-5));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_31(
        ...
        if ((s.b[733] && (!s.b[925])) && s.b[1045]) {s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);s.store_scalar(54, 0.0);s.store_scalar(55, 0.0);s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
        ...
        let mut t1e: usize = 0;
        while {
            let t1d: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1045]) && s.b[1046]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1d != 0.0
        } {
            t1e += 1;
        ...
        let mut t20: usize = 0;
        while {
            let t1f: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1051]) && s.b[1052]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1f != 0.0
        } {
            t20 += 1;
    ...
    pub(super) fn stamp_reactive_block_33(
        ...
        if ((((!s.b[733]) && (!s.b[1064])) && (!s.b[1066])) && s.b[1067]) {s.store_add_scaled_inputs_mixed_ai(336, A::sub_from_scalar(3.0, A::div_scaled_inputs(s.ad_value(329), 1.259921049894873, s.ad_value(332), 3.0)), 1.0, 332, (1.0 / (3.0 * 1.259921049894873)));s.store_add_scaled_product_indices(376, 515, 1.0, 336, 227, 1.0);s.copy_ad(378, 376);}
        ...
        if (!s.b[733]) {s.store_exp_mul(486, 225, 515);s.store_mul(487, 379, 486);s.store_scalar(430, 0.0);s.copy_ad(349, 161);s.store_scale(419, 229, ((p[237] * (p[237] * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
}
