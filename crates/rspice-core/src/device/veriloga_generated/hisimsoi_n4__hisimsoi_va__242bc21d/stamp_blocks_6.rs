...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (s.b[637] && (s.v[562] < p[9])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_reactive_block_6(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((s.b[672] && s.b[673]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_reactive_block_11(
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (s.b[733] && (s.v[167] < s.v[57])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_12(
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((s.b[733] && s.b[770]) && s.b[771]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_13(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((s.b[733] && s.b[776]) && s.b[777]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if ((((((s.b[733] && (!s.b[782])) && (!s.b[786])) && s.b[787]) && s.b[788]) && s.b[789]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if ((s.b[733] && (!s.b[782])) && (s.v[167] < s.v[57])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
