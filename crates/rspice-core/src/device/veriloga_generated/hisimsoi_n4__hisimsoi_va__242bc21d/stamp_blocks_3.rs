...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_48(
        ...
        let mut t5: usize = 0;
        while {
            let t3: f64 = (s.v[57] + 1.0);let t4: f64 = if (((s.b[1220] && s.b[1266]) && (!s.b[1269])) && (s.v[167] <= t3)) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
    ...
    if (((s.b[1220] && s.b[1266]) && (!s.b[1269])) && s.b[1275]) {
        ...
        (s.v[338],)
            ...
            s.store_scalar(338, t1);s.b[1276] = (s.v[181] < 0.0);s.store_scalar(1276, if s.b[1276] { 1.0 } else { 0.0 });
    ...
    if (((s.b[1220] && s.b[1285]) && s.b[1286]) && s.b[1287]) {
        ...
        s.store_scalar(55, t8);s.b[1288] = (1.0 == 2.0);s.store_scalar(1288, if s.b[1288] { 1.0 } else { 0.0 });
        let (t9,) = {
    if ((((s.b[1220] && s.b[1285]) && s.b[1286]) && (!s.b[1287])) && s.b[1288]) {
        ...
        s.store_scalar(55, t9);s.b[1289] = (1.0 == 4.0);s.store_scalar(1289, if s.b[1289] { 1.0 } else { 0.0 });
        let (ta,) = {
    if (((((s.b[1220] && s.b[1285]) && s.b[1286]) && (!s.b[1287])) && (!s.b[1288])) && s.b[1289]) {
        ...
        s.store_scalar(55, ta);s.b[1290] = (1.0 == 8.0);s.store_scalar(1290, if s.b[1290] { 1.0 } else { 0.0 });
        let (tb,) = {
    ...
    pub(super) fn stamp_transient_block_50(
        ...
        let mut t10: usize = 0;
        while {
            let tf: f64 = if (((s.b[1220] && s.b[1285]) && s.b[1286]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            tf != 0.0
        } {
    ...
    if ((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) {
        ...
        if ((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    }
    #[inline(never)]
    ...
    if ((((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) && s.b[1311]) {
        ...
        s.store_scalar(55, t13);s.b[1312] = (4.0 == 2.0);s.store_scalar(1312, if s.b[1312] { 1.0 } else { 0.0 });
        let (t14,) = {
    if (((((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) && (!s.b[1311])) && s.b[1312]) {
        ...
        s.store_scalar(55, t14);s.b[1313] = (4.0 == 4.0);s.store_scalar(1313, if s.b[1313] { 1.0 } else { 0.0 });
        let (t15,) = {
    if ((((((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) && (!s.b[1311])) && (!s.b[1312])) && s.b[1313]) {
        ...
        s.store_scalar(55, t15);s.b[1314] = (4.0 == 8.0);s.store_scalar(1314, if s.b[1314] { 1.0 } else { 0.0 });
        let (t16,) = {
    ...
    if (((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) {
        ...
        while {
            let t1a: f64 = if ((((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1a != 0.0
        } {
    ...
    if (((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) {
        ...
        if s.b[1316] {s.store_sqrt_ad(1323, A::add_scaled_product(A::offset(A::exp(A::mul_scaled_lhs(s.ad_value(225), -1.0, s.ad_value(176))), (-1.0)), 1.0, s.ad_value(225), s.ad_value(176), 1.0));s.store_mul_sub_scaled_inputs_rhs_indices(1324, 1321, 1322, -1.0, 1323, -1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_52(
        ...
        if s.b[1316] {s.store_offset_sub_from_scalar_ad(44, p.p47, s.ad_value(1324), (-(p.p47 * 0.01)));s.store_scalar(45, ((4.0 * p.p47) * (p.p47 * 0.01)));}
        if s.b[1316] {
            if (s.v[45] > 0.0) {
            } else {
                s.store_neg(45, 45);
        ...
        if s.b[1316] {s.store_div_scaled_value_offset_denominator(398, s.ad_value(1317), 1.0, s.ad_value(263), p.p139, 1.0);s.store_mul(397, 398, 323);s.copy_ad(396, 393);s.store_scaled_voltage(596, ctx, nodes, Some(17), None, (1e-9 / 0.0001));s.copy_ad(393, 596);s.store_div_scaled_inputs2_indices(592, 596, 1.0, 396, (-1.0), 397, 1.0);}
        ...
        s.store_scalar(1355, (s.v[88] * 100.0));s.store_scale(1356, 323, 0.0001);s.store_scalar(1357, (s.v[97] * 100.0));s.store_primal_scale(1358, 107, 100.0);s.store_scale(1359, 252, 0.01);s.store_scale(1360, 436, 0.0001);s.store_scale(1361, 238, 0.0001);s.b[1362] = (p.p27 == 0.0);s.store_scalar(1362, if s.b[1362] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        if (!s.b[1362]) {s.store_offset_scaled(1343, 158, (-p.p221), p.p222);s.store_exp_scaled_input(1345, 1343, s.v[1355]);s.store_scale(1343, 158, (1.0 / (s.v[1355]) * 1.0 / (s.v[1355])));s.store_mul(1346, 158, 1343);s.store_scale(1347, 1358, (p.p220 / 1000000.0));s.store_mul3_lhs(306, 1347, 1345, 1346);}
        s.b[1367] = (s.v[158] >= 0.0);s.store_scalar(1367, if s.b[1367] { 1.0 } else { 0.0 });
        if ((!s.b[1362]) && s.b[1367]) {s.store_scale(306, 306, (-1.0));}
        if (!s.b[1362]) {s.store_sub(1344, 158, 157);s.store_offset_scaled(1343, 1344, (-p.p221), p.p222);s.store_exp_scaled_input(1345, 1343, s.v[1355]);s.store_scale(1343, 1344, (1.0 / (s.v[1355]) * 1.0 / (s.v[1355])));s.store_mul(1346, 1344, 1343);s.store_scale(1347, 1358, (p.p220 / 1000000.0));s.store_mul3_lhs(307, 1347, 1345, 1346);}
        s.b[1368] = (s.v[1344] >= 0.0);s.store_scalar(1368, if s.b[1368] { 1.0 } else { 0.0 });
        if ((!s.b[1362]) && s.b[1368]) {s.store_scale(307, 307, (-1.0));}
        if (!s.b[1362]) {s.store_offset_scaled_sub(1353, 513, 158, 1.0 / (s.v[1355]), ((((s.v[123]) + (p.p225))) * (1.0 / (s.v[1355]))));s.store_sqrt_square_offset(44, 1353, ((4.0 * 0.01) * 0.01));s.store_offset_add_scaled_inputs_indices(1353, 1353, 0.5, 44, 0.5, (1e-10 * 0.01));}
        ...
        if ((!s.b[1362]) && (!s.b[1370])) {s.store_exp(1345, 1344);s.store_scale(1346, 1358, (p.p223 * s.v[1357]));s.store_mul_product3_indices(308, 1345, 1346, 1353, 1353, 1.0);}
        ...
        if ((!s.b[1378]) && (!s.b[1380])) {s.store_exp(1371, 1375);s.store_mul_scale_offset_mixed_ia(1372, 107, A::div_from_scalar(p.p207, s.ad_value(302)), 1.6021918e-19, 0.0);s.store_mul_product3_indices(311, 1371, 1372, 304, 304, 1.0);}
        if (!s.b[1378]) {s.store_sub(1377, 157, 513);}
        s.b[1381] = (s.v[1377] > 0.0);s.store_scalar(1381, if s.b[1381] { 1.0 } else { 0.0 });
        if ((!s.b[1378]) && s.b[1381]) {s.store_square(1372, 1377);s.store_mul(331, 1372, 1377);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_54(
        ...
        if ((!s.b[1378]) && s.b[1381]) {s.store_offset(1375, 331, p.p212);s.store_div(1376, 331, 1375);s.store_mul(311, 311, 1376);}
        ...
        if ((!s.b[1389]) && (!s.b[1391])) {s.store_exp(1382, 1386);s.store_div_from_scalar(1385, 1.0, 302);s.store_scaled_mul(1383, 1385, 107, (p.p207 * 1.6021918e-19));s.store_mul_product3_indices(312, 1382, 1383, 305, 305, 1.0);}
        if (!s.b[1389]) {s.store_neg(1388, 513);}
        s.b[1392] = (s.v[1388] > 0.0);s.store_scalar(1392, if s.b[1392] { 1.0 } else { 0.0 });
        if ((!s.b[1389]) && s.b[1392]) {s.store_square(1383, 1388);s.store_mul(331, 1383, 1388);s.store_offset(1386, 331, p.p212);s.store_div(1387, 331, 1386);s.store_mul(312, 312, 1387);}
        ...
        if (s.b[1393] && (p.p24 != 0.0)) {s.copy_ad(521, 536);}
        let (t1c,) = {
    if (s.b[1393] && (p.p24 != 0.0)) {
        ...
        s.store_scalar(528, t1c);s.b[1473] = (1.0 == 1.0);s.store_scalar(1473, if s.b[1473] { 1.0 } else { 0.0 });s.b[1474] = (1.0 == 2.0);s.store_scalar(1474, if s.b[1474] { 1.0 } else { 0.0 });
        if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1473]) {s.store_primal_scale(522, 533, 0.5);s.store_scalar(523, p.p292);}
        let (t1d,) = {
    if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1473]) {
        ...
        if ((s.b[1393] && (p.p24 != 0.0)) && (s.b[1474] && (!s.b[1473]))) {s.store_primal_scale(522, 534, 0.5);s.store_scalar(523, p.p68);}
        let (t1e,) = {
    ...
    pub(super) fn stamp_transient_block_55(
        ...
        if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) {s.store_offset_ad(1414, A::add_scaled_products(s.ad_value(1407), s.ad_value(1421), 1.0, s.ad_value(1408), s.ad_value(1420), 1.0), (10.0 * 2.220446049250313e-16));s.store_neg(1394, 1414);}
        ...
        if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) {s.store_offset_scaled(1415, 1399, -1.0, (-1e-12));s.store_mul(1424, 1423, 1404);s.store_square(1425, 1424);s.store_sub(1426, 1422, 523);s.store_div(1394, 521, 230);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1427, 2.0, 225, A::ln(s.ad_value(1394)));}
        let (t21,) = {
    if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) {
        let t20: f64 = (-s.v[1415]);
        (t20,)
    } else {
        (s.v[1428],)
    }
};
        s.store_scalar(1428, t21);s.b[1477] = (s.v[1426] < s.v[1428]);s.store_scalar(1477, if s.b[1477] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_56(
        ...
        if (((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) {s.store_sqrt_square_add(45, 44, 45);s.store_offset_scaled_div(1395, 44, 45, 0.5, 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_57(
        ...
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) {s.store_exp_ad(1457, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1415), -1.0));s.store_div(1394, 230, 521);s.store_square(1451, 1394);s.store_mul(1466, 1451, 1457);}
        let (t22,) = {
    if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) {
        ...
        s.store_scalar(1411, t22);
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) {s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_58(
        ...
        let mut t27: usize = 0;
        while {
            let t24: f64 = (2.0 * 20.0);let t25: f64 = (t24 + 1.0);let t26: f64 = if (((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) && (s.v[167] <= t25)) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_59(
        ...
        let (t29,) = {
    if ((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) {
        let t28: f64 = (-s.v[1415]);
        (t28,)
    } else {
        (s.v[1428],)
    }
};
        s.store_scalar(1428, t29);s.b[1495] = (s.v[1426] < s.v[1428]);s.store_scalar(1495, if s.b[1495] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_60(
        ...
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && s.b[1495]) && (!s.b[1496])) {s.store_sqrt_add(1434, 1430, 1433);s.store_add_scaled_offset_product_rhs_mixed_aii(1435, A::offset(s.ad_value(1434), ((-7.0) * 1.414213562373095)), 1.0, 1402, 1401, (-2.0), 9.0);}
    ...
    pub(super) fn stamp_transient_block_61(
        ...
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1499]) {s.store_div_scaled_value_by_product_mixed_aii(1447, A::add_scaled_square_product(s.ad_value(1443), (-1.0), s.ad_value(1442), s.ad_value(1444), 3.0), 1.0, 1442, 1442, 9.0);s.store_sqrt_add_scaled_square_cube_product(1398, 1446, 1.0, 1447, 1.0);s.store_powf_ad(1448, A::sub(s.ad_value(1398), s.ad_value(1446)), 0.3333333333333333);s.store_neg_powf_add_input(1449, 1446, 1398, 0.3333333333333333);s.store_add_scaled_inputs3_div_scaled_third_indices(1401, 1448, 1.0, 1449, 1.0, 1443, 1.0, 1442, 3.0, -1.0);s.store_add_scaled_product_indices(1441, 1415, (-1.0), 1401, 227, 1.0);s.store_mul_add_rhs(1438, 225, 1441, 1415);}
        ...
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) {s.store_exp_ad(1457, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1415), -1.0));s.store_div(1394, 230, 521);s.store_square(1451, 1394);s.store_mul(1466, 1451, 1457);}
        let (t2a,) = {
    if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) {
        ...
        s.store_scalar(1411, t2a);
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) {s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_62(
        ...
        let mut t2f: usize = 0;
        while {
            let t2c: f64 = (2.0 * 20.0);let t2d: f64 = (t2c + 1.0);let t2e: f64 = if (((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) && (s.v[167] <= t2d)) { 1.0 } else { 0.0 };
            t2e != 0.0
        } {
