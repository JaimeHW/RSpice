...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if ((!s.b[733]) && s.b[1085]) {
            ...
            s.store_pow_offset_rhs(1087, 1086, 138, (-1.0));
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        if (s.b[1129] && s.b[1192]) {
            s.store_add_product3_rhs_indices(1187, 1187, 173, 1184, 1188, 1.0);
        ...
        if (s.b[1129] && s.b[1206]) {
            ...
            s.store_mul_ad_product_lhs_mixed_ai(1202, A::mul_sub_from_scalar_lhs_scaled_output(p.p69, s.ad_value(233), s.ad_value(324), (2.0 * 1.034943e-10)), 1199, 1201);
        ...
        if (s.b[1129] && s.b[1206]) {
            s.store_sqrt_add_scaled_square_product(1199, 1197, 1.0, 327, 1203, (4.0 * 0.005));
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1220] {
            s.store_add_product3_rhs_mixed_iia(376, 1232, 241, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(336))), 0.5);
        }
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        if s.b[1220] {
            ...
            s.store_sqrt_add_scaled_square_product(44, 328, 1.0, 1244, 1244, 4.0);
        ...
        if s.b[1220] {
            ...
            s.store_mul_div_scaled_inputs_indices(1236, 1240, 227, 2.0, 1227, 1.0);
            s.store_mul_product3_indices(204, 337, 1236, 1235, 107, 1.0);
        ...
        if (((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) {
            ...
            s.store_div_square_rhs(1294, 545, 323);
    ...
    pub(super) fn stamp_reactive_block_21(
        ...
        if ((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) {
            ...
            s.store_ad_value(1293, A::exp_div_scaled_inputs(s.ad_value(133), -1.0, s.ad_value(1303), 1.0));
            s.store_mul_product3_indices(263, 1293, 132, 1303, 199, 1.0);
        }
        ...
        if s.b[1316] {
            ...
            s.store_sqrt_mul_scaled_lhs(1321, 544, ((2.0 * 1.034943e-10) * 1.6021918e-19), 227);
        ...
        s.store_scalar(1355, (s.v[88] * 100.0));

        s.store_scale(1356, 323, 0.0001);

        s.store_scalar(1357, (s.v[97] * 100.0));
    ...
    pub(super) fn stamp_reactive_block_22(
        ...
        if (((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) {
            s.store_add_product3_rhs_mixed_iia(1441, 1426, 1425, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(1401))), 1.0 / (2.0));
    ...
    pub(super) fn stamp_reactive_block_23(
        ...
        if ((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1481]) {
            ...
            s.store_add_scaled_inputs3_div_scaled_third_mixed_aaii(1446, A::div_scaled_product(A::square(s.ad_value(1443)), s.ad_value(1443), 1.0, A::mul3_scaled_output(s.ad_value(1442), s.ad_value(1442), s.ad_value(1442), 27.0), 1.0), 1.0, A::div_scaled_product_by_product(s.ad_value(1443), s.ad_value(1444), 1.0, s.ad_value(1442), s.ad_value(1442), 6.0), (-1.0), 1445, 1.0, 1442, 2.0, 1.0);
            ...
            s.store_sqrt_add_scaled_square_cube_product(1398, 1446, 1.0, 1447, 1.0);
            s.store_powf_ad(1448, A::sub(s.ad_value(1398), s.ad_value(1446)), 0.3333333333333333);
            s.store_neg_powf_add_input(1449, 1446, 1398, 0.3333333333333333);
            s.store_add_scaled_inputs3_div_scaled_third_indices(1401, 1448, 1.0, 1449, 1.0, 1443, 1.0, 1442, 3.0, -1.0);
        ...
        while {
            ...
            if (((((s.b[1393] && (p.p24 != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) && s.b[1484]) {
                ...
                s.store_mul_product3_indices(1461, 1459, 1466, 225, 1458, 2.0);
    ...
    pub(super) fn stamp_reactive_block_25(
        ...
        s.store_scalar(1530, s.v[91]);

        s.store_scalar(1531, (1.0 / s.v[1530]));
        ...
        if (((p.p24 != 0.0) && s.b[1602]) && s.b[1603]) {
            s.store_mul_ad_product_rhs_mixed_ia(1523, 1533, 1520, A::add(s.ad_value(1534), s.ad_value(1535)));
            ...
            s.store_mul_ad_product_rhs_mixed_ia(1523, 1533, 1520, A::add_scaled_inputs3(s.ad_value(1534), 1.0, s.ad_value(1535), 1.0, s.ad_value(157), -1.0));
        ...
        if ((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) {
            s.store_add_product3_rhs_mixed_iia(1570, 1555, 1554, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(1528))), 1.0 / (2.0));
        ...
        if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1610]) {
            ...
            s.store_add_scaled_inputs3_div_scaled_third_mixed_aaii(1575, A::div_scaled_product(A::square(s.ad_value(1572)), s.ad_value(1572), 1.0, A::mul3_scaled_output(s.ad_value(1571), s.ad_value(1571), s.ad_value(1571), 27.0), 1.0), 1.0, A::div_scaled_product_by_product(s.ad_value(1572), s.ad_value(1573), 1.0, s.ad_value(1571), s.ad_value(1571), 6.0), (-1.0), 1574, 1.0, 1571, 2.0, 1.0);
            ...
            s.store_sqrt_add_scaled_square_cube_product(1524, 1575, 1.0, 1576, 1.0);
            s.store_powf_ad(1577, A::sub(s.ad_value(1524), s.ad_value(1575)), 0.3333333333333333);
            s.store_neg_powf_add_input(1578, 1575, 1524, 0.3333333333333333);
            s.store_add_scaled_inputs3_div_scaled_third_indices(1528, 1577, 1.0, 1578, 1.0, 1572, 1.0, 1571, 3.0, -1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_26(
        ...
        while {
            ...
            if ((((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) && s.b[1614]) {
                ...
                s.store_mul_product3_indices(1590, 1588, 1595, 225, 1587, 2.0);
