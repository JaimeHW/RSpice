...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_51(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((((((s.b[1291] && (!s.b[1304])) && (!s.b[1305])) && (!s.b[1306])) && s.b[1309]) && s.b[1310]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_reactive_block_57(
        ...
        let mut t5: usize = 0;
        while {
            let t2: f64 = (2.0 * 20.0);let t3: f64 = (t2 + 1.0);let t4: f64 = if (((((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) && (!s.b[1477])) && s.b[1483]) && (s.v[167] <= t3)) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_61(
        ...
        let mut t9: usize = 0;
        while {
            let t6: f64 = (2.0 * 20.0);let t7: f64 = (t6 + 1.0);let t8: f64 = if (((((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) && (s.v[167] <= t7)) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
            ...
            if ((((((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) && (!s.b[1504])) && s.b[1506]) {s.store_scalar(1411, 1.0);}
        ...
        if ((((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) {s.store_mul(458, 1423, 1472);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_62(
        ...
        if ((((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) && (!s.b[1495])) && s.b[1501]) {s.store_div_from_scalar_add_ad(1395, 1.0, s.ad_value(1464), s.ad_value(1472));s.store_mul3_lhs(460, 1423, 1460, 1395);s.store_add(459, 458, 460);}
        if ((s.b[1393] && (p[24] != 0.0)) && s.b[1475]) {s.store_sub(460, 459, 458);}
        ...
        if ((p[24] != 0.0) && s.b[1602]) {s.store_scalar(1533, p[171]);s.store_scalar(1534, p[172]);s.copy_ad(1535, 158);s.store_scalar(1532, p[188]);}
    ...
    pub(super) fn stamp_reactive_block_65(
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {s.store_exp_ad(1586, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1545), -1.0));s.store_scale(1519, 230, 1.0 / (s.v[69]));s.store_square(1580, 1519);s.store_mul(1595, 1580, 1586);s.store_scalar(1542, 0.0);s.store_scalar(1589, 0.0);s.store_scalar(1593, 0.0);s.store_scalar(167, 1.0);}
    }
}
