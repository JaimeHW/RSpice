...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_34(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[57] + 1.0);let t1: f64 = if ((!s.b[733]) && (s.v[167] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
            t2 += 1;
    ...
    pub(super) fn stamp_reactive_block_35(
        ...
        let mut t4: usize = 0;
        while {
            let t3: f64 = if (((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
            t4 += 1;
        ...
        if (((!s.b[733]) && s.b[1085]) && s.b[1093]) {s.store_div_from_scalar(53, 1.0, 53);s.store_mul3_lhs(43, 44, 332, 53);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_36(
        s: &mut ReactiveScratch,
    ) {
        if (((!s.b[733]) && s.b[1085]) && s.b[1093]) {s.store_sub(1089, 332, 43);}
    ...
    pub(super) fn stamp_reactive_block_37(
        ...
        let mut t7: usize = 0;
        while {
            let t5: f64 = (s.v[58] + 1.0);let t6: f64 = if (((!s.b[733]) && s.b[1085]) && (s.v[168] <= t5)) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_39(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if ((((!s.b[733]) && s.b[1085]) && s.b[1119]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
    ...
    pub(super) fn stamp_reactive_block_41(
        ...
        if (s.b[1129] && s.b[1195]) {s.store_scale(1183, 225, s.v[118]);s.store_mul(1191, 323, 1183);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_42(
        ...
        if (s.b[1129] && s.b[1195]) {s.store_mul(1190, 1191, 173);}
    ...
    pub(super) fn stamp_reactive_block_43(
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((s.b[1129] && s.b[1206]) && s.b[1211]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
        ...
        s.copy_ad(202, 199);s.store_scalar(204, 0.0);s.b[1220] = ((p[281] > 0.0) && (p[285] > 0.0));s.store_scalar(1220, if s.b[1220] { 1.0 } else { 0.0 });
        if s.b[1220] {s.store_scalar(1227, s.v[99]);s.store_scalar(1231, p[237]);s.store_offset_add_scaled_inputs3_offset_indices(1232, 158, 1.0, 185, 1.0, 320, -1.0, (-s.v[123]), (-p[286]));s.store_offset(1233, 182, p[286]);s.store_scalar(1235, p[285]);s.store_scalar(1234, p[283]);s.store_scalar(1225, s.v[70]);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_46(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
    ...
    pub(super) fn stamp_reactive_block_48(
        ...
        let mut t10: usize = 0;
        while {
            let te: f64 = (s.v[57] + 1.0);let tf: f64 = if (((s.b[1220] && s.b[1266]) && (!s.b[1269])) && (s.v[167] <= te)) { 1.0 } else { 0.0 };
            tf != 0.0
        } {
            t10 += 1;
    ...
    pub(super) fn stamp_reactive_block_49(
        ...
        let mut t12: usize = 0;
        while {
            let t11: f64 = if (((s.b[1220] && s.b[1285]) && s.b[1286]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
            t12 += 1;
