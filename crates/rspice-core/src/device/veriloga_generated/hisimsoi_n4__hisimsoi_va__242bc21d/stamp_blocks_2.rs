...
impl Instance {
    ...
    if (((((s.b[733] && (!s.b[925])) && s.b[1051]) && s.b[1052]) && (!s.b[1053])) && s.b[1054]) {
        ...
        s.store_scalar(55, t0);s.b[1055] = (2.0 == 4.0);s.store_scalar(1055, if s.b[1055] { 1.0 } else { 0.0 });
        let (t1,) = {
    if ((((((s.b[733] && (!s.b[925])) && s.b[1051]) && s.b[1052]) && (!s.b[1053])) && (!s.b[1054])) && s.b[1055]) {
        ...
        s.store_scalar(55, t1);s.b[1056] = (2.0 == 8.0);s.store_scalar(1056, if s.b[1056] { 1.0 } else { 0.0 });
        let (t2,) = {
    ...
    if (((s.b[733] && (!s.b[925])) && s.b[1051]) && s.b[1052]) {
        ...
        while {
            let t6: f64 = if ((((s.b[733] && (!s.b[925])) && s.b[1051]) && s.b[1052]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
    ...
    if (!s.b[733]) {
        ...
        s.store_scalar(160, td);s.b[1064] = (s.v[158] < s.v[160]);s.store_scalar(1064, if s.b[1064] { 1.0 } else { 0.0 });
        let (tf,) = {
    if ((!s.b[733]) && s.b[1064]) {
        let te: f64 = (-1.0);
        (te,)
    ...
    if (!s.b[733]) {
        ...
        if (!s.b[733]) {s.copy_ad(349, 161);s.store_scale(419, 229, ((p.p237 * (p.p237 * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_34(
        ...
        let mut t18: usize = 0;
        while {
            let t16: f64 = (s.v[57] + 1.0);let t17: f64 = if ((!s.b[733]) && (s.v[167] <= t16)) { 1.0 } else { 0.0 };
            t17 != 0.0
        } {
    ...
    if ((!s.b[733]) && s.b[1075]) {
        ...
        (s.v[338],)
            ...
            s.store_scalar(338, t12);s.b[1076] = (s.v[338] == (-1.0));s.store_scalar(1076, if s.b[1076] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[733]) && s.b[1084]) {
        ...
        s.store_scalar(612, t1c);s.b[1085] = (s.v[612] == 0.0);s.store_scalar(1085, if s.b[1085] { 1.0 } else { 0.0 });
    ...
    if (((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) && s.b[1095]) {
        ...
        s.store_scalar(55, t1f);s.b[1096] = (4.0 == 2.0);s.store_scalar(1096, if s.b[1096] { 1.0 } else { 0.0 });
        let (t20,) = {
    if ((((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) && (!s.b[1095])) && s.b[1096]) {
        ...
        s.store_scalar(55, t20);s.b[1097] = (4.0 == 4.0);s.store_scalar(1097, if s.b[1097] { 1.0 } else { 0.0 });
        let (t21,) = {
    if (((((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) && (!s.b[1095])) && (!s.b[1096])) && s.b[1097]) {
        ...
        s.store_scalar(55, t21);s.b[1098] = (4.0 == 8.0);s.store_scalar(1098, if s.b[1098] { 1.0 } else { 0.0 });
        let (t22,) = {
    ...
    if ((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) {
        ...
        while {
            let t26: f64 = if (((((!s.b[733]) && s.b[1085]) && s.b[1093]) && s.b[1094]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
    ...
    if (((!s.b[733]) && s.b[1085]) && s.b[1100]) {
        ...
        s.store_scalar(430, t28);s.b[1101] = (s.v[144] >= 1.0);s.store_scalar(1101, if s.b[1101] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        let mut t2d: usize = 0;
        while {
            let t2b: f64 = (s.v[58] + 1.0);let t2c: f64 = if (((!s.b[733]) && s.b[1085]) && (s.v[168] <= t2b)) { 1.0 } else { 0.0 };
            t2c != 0.0
        } {
    ...
    if ((((!s.b[733]) && s.b[1085]) && s.b[1119]) && s.b[1120]) {
        ...
        s.store_scalar(55, t30);s.b[1121] = (4.0 == 2.0);s.store_scalar(1121, if s.b[1121] { 1.0 } else { 0.0 });
        let (t31,) = {
    if (((((!s.b[733]) && s.b[1085]) && s.b[1119]) && (!s.b[1120])) && s.b[1121]) {
        ...
        s.store_scalar(55, t31);s.b[1122] = (4.0 == 4.0);s.store_scalar(1122, if s.b[1122] { 1.0 } else { 0.0 });
        let (t32,) = {
    if ((((((!s.b[733]) && s.b[1085]) && s.b[1119]) && (!s.b[1120])) && (!s.b[1121])) && s.b[1122]) {
        ...
        s.store_scalar(55, t32);s.b[1123] = (4.0 == 8.0);s.store_scalar(1123, if s.b[1123] { 1.0 } else { 0.0 });
        let (t33,) = {
    ...
    if (((!s.b[733]) && s.b[1085]) && s.b[1119]) {
        ...
        while {
            let t37: f64 = if ((((!s.b[733]) && s.b[1085]) && s.b[1119]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t37 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (s.b[1129] && s.b[1206]) {s.store_sqrt_offset_input(213, 1197, 1e-50);s.store_add_mul_sub_from_scalar_rhs_indices(215, 207, 211, 1.0, 213);s.store_div_from_scalar_add_ad(327, 1.0, s.ad_value(225), A::div_scalar_offset_denominator(2.0, s.ad_value(207), 1e-50, 1.0));s.store_mul_ln_mixed_ia(216, 327, A::mul(A::div_scalar_by_product(1.0, s.ad_value(209), s.ad_value(210), 1.0), A::square(s.ad_value(207))));s.store_div_scaled_value_offset_denominator(1200, s.ad_value(216), 1.0, s.ad_value(207), 1e-50, 1.0);s.store_offset_sub(217, 216, 215, (-0.002));s.store_sqrt_add_scaled_square_input(327, 217, 1.0, 216, (4.0 * 0.002));s.store_add_scaled_inputs3_indices(218, 216, 1.0, 217, (-0.5), 327, (-0.5));s.store_div_from_scalar(1197, 1.0, 327);s.store_mul_exp_mixed_ia(327, 209, A::mul(s.ad_value(225), s.ad_value(218)));s.store_add_offset_lhs_mixed_ai(1198, A::mul(s.ad_value(225), A::sub(s.ad_value(218), s.ad_value(514))), (-1.0), 327);s.store_sqrt_square_offset(44, 1198, ((4.0 * 0.01) * 0.01));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_43(
        ...
        if (s.b[1129] && s.b[1206]) {s.store_offset_add_scaled_inputs_indices(1197, 1198, 0.5, 44, 0.5, (1e-10 * 0.01));}
    ...
    if (((s.b[1129] && s.b[1206]) && s.b[1211]) && s.b[1212]) {
        ...
        s.store_scalar(55, t3b);s.b[1213] = (4.0 == 2.0);s.store_scalar(1213, if s.b[1213] { 1.0 } else { 0.0 });
        let (t3c,) = {
    if ((((s.b[1129] && s.b[1206]) && s.b[1211]) && (!s.b[1212])) && s.b[1213]) {
        ...
        s.store_scalar(55, t3c);s.b[1214] = (4.0 == 4.0);s.store_scalar(1214, if s.b[1214] { 1.0 } else { 0.0 });
        let (t3d,) = {
    if (((((s.b[1129] && s.b[1206]) && s.b[1211]) && (!s.b[1212])) && (!s.b[1213])) && s.b[1214]) {
        ...
        s.store_scalar(55, t3d);s.b[1215] = (4.0 == 8.0);s.store_scalar(1215, if s.b[1215] { 1.0 } else { 0.0 });
        let (t3e,) = {
    ...
    if ((s.b[1129] && s.b[1206]) && s.b[1211]) {
        ...
        while {
            let t42: f64 = if (((s.b[1129] && s.b[1206]) && s.b[1211]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t42 != 0.0
        } {
    ...
    if ((s.b[1129] && s.b[1216]) && (!s.b[1219])) {
        ...
        s.store_scalar(146, t45);s.copy_ad(202, 199);s.store_scalar(204, 0.0);s.b[1220] = ((p.p281 > 0.0) && (p.p285 > 0.0));s.store_scalar(1220, if s.b[1220] { 1.0 } else { 0.0 });
        if s.b[1220] {s.store_scalar(1227, s.v[99]);s.store_scalar(1231, p.p237);s.store_offset_add_scaled_inputs3_offset_indices(1232, 158, 1.0, 185, 1.0, 320, -1.0, (-s.v[123]), (-p.p286));}
        let (t47,) = {
    if s.b[1220] {
        ...
        s.store_scalar(1233, t47);
        if s.b[1220] {s.store_scalar(1235, p.p285);s.store_scalar(1234, p.p283);s.store_scalar(1225, s.v[70]);s.store_mul_ln_mixed_ia(1226, 227, A::div_scaled_product_by_product(s.ad_value(1225), s.ad_value(536), 1.0, s.ad_value(230), s.ad_value(230), 1.0));}
        if s.b[1220] {
            if (p.p43 == 1.0) {
                s.copy_ad(1223, 435);
            } else {
    ...
    if (s.b[1220] && s.b[1249]) {
        ...
        s.store_scalar(144, t49);s.b[1250] = ((s.v[144] == 0.0) || (1.0 != 0.0));s.store_scalar(1250, if s.b[1250] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        if ((s.b[1220] && s.b[1250]) && s.b[1251]) {s.store_add_scaled_inputs_mixed_ai(336, A::sub_from_scalar(3.0, A::div_scaled_inputs(s.ad_value(329), 1.259921049894873, s.ad_value(332), 3.0)), 1.0, 332, (1.0 / (3.0 * 1.259921049894873)));s.store_add_scaled_product_indices(376, 1247, 1.0, 336, 227, 1.0);s.copy_ad(378, 376);}
    ...
    if (((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) && s.b[1259]) {
        ...
        s.store_scalar(55, t4c);s.b[1260] = (2.0 == 2.0);s.store_scalar(1260, if s.b[1260] { 1.0 } else { 0.0 });
        let (t4d,) = {
    if ((((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) {
        ...
        s.store_scalar(55, t4d);s.b[1261] = (2.0 == 4.0);s.store_scalar(1261, if s.b[1261] { 1.0 } else { 0.0 });
        let (t4e,) = {
    if (((((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) && (!s.b[1259])) && (!s.b[1260])) && s.b[1261]) {
        ...
        s.store_scalar(55, t4e);s.b[1262] = (2.0 == 8.0);s.store_scalar(1262, if s.b[1262] { 1.0 } else { 0.0 });
        let (t4f,) = {
    ...
    if ((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) {
        ...
        while {
            let t53: f64 = if (((((((s.b[1220] && s.b[1250]) && s.b[1254]) && (!s.b[1255])) && s.b[1256]) && s.b[1257]) && s.b[1258]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t53 != 0.0
        } {
    ...
    if (s.b[1220] && s.b[1266]) {
        let t55: f64 = (s.v[123] - s.v[185]);let t56: f64 = (t55 + s.v[320]);let t57: f64 = (t56 + s.v[1267]);let t58: f64 = (t57 + p.p286);
        (t58,)
    } else {
        (s.v[160],)
    }
};
        s.store_scalar(160, t59);s.b[1269] = (s.v[158] < s.v[160]);s.store_scalar(1269, if s.b[1269] { 1.0 } else { 0.0 });
        let (t5b,) = {
    if ((s.b[1220] && s.b[1266]) && s.b[1269]) {
        ...
        if ((s.b[1220] && s.b[1266]) && (!s.b[1269])) {s.store_exp_ad(484, A::mul_offset_rhs(s.ad_value(225), s.ad_value(1267), (-p.p287)));}
        let (t5c,) = {
    if ((s.b[1220] && s.b[1266]) && (!s.b[1269])) {
        (0.0,)
    } else {
        ...
        if ((s.b[1220] && s.b[1266]) && (!s.b[1269])) {s.copy_ad(1268, 378);s.store_scale(419, 229, ((p.p237 * (p.p237 * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
}
