...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        Self::stamp_transient_block_1(s, p, param_given, var_dw, var_dwbt, var_lgate, var_mks_cth0, var_mks_rth0, var_subversion, var_wgate, &mut var_cth, &mut var_dwcv, &mut var_grg, &mut var_grg_cnst, &mut var_guard19, &mut var_guard20, &mut var_guard8, &mut var_mfactor, &mut var_rth, &mut var_weff, &mut var_weff_cv, &mut var_weff_nf, &mut var_weffcv_nf);
