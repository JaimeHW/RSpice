...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_ad_value(193, A::add_scaled_product(s.ad_value(682), 1.0, s.ad_value(681), A::sub_from_scalar(1.0, s.ad_value(684)), 1.0));
        ...
        s.store_div_from_scalar_add_ad(684, 1.0, A::add_scaled_inputs3(A::offset(s.ad_value(44), 1.0), 1.0, s.ad_value(45), 1.0, s.ad_value(46), 1.0), s.ad_value(47));

        s.store_mul_ad_affine_product_lhs(327, A::add_scaled_inputs3(A::scale_offset(s.ad_value(44), 2.0, 1.0), 1.0, s.ad_value(45), 3.0, s.ad_value(46), 4.0), s.ad_value(684), -1.0, 0.0, 684);
        ...
        if (!s.b[693]) {
            s.store_offset_ad(690, A::add_scaled_inputs3(s.ad_value(158), 1.0, s.ad_value(513), (-1.0), s.ad_value(325), -1.0), p.p205);
        ...
        if (!s.b[693]) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(686, A::add_scaled_inputs3(A::div_from_scalar(1.0, s.ad_value(688)), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        ...
        s.store_ad_value(702, A::add_scaled_inputs3(s.ad_value(233), s.v[700], s.ad_value(699), (-0.5), s.ad_value(701), (-0.5)));
        ...
        if s.b[710] {
            s.store_ad_value(183, A::add_scaled_product(A::offset(s.ad_value(236), s.v[123]), 1.0, s.ad_value(705), s.ad_value(324), 1.0));
            ...
            s.store_ad_value(706, A::add_scaled_product(s.ad_value(705), 1.0, s.ad_value(708), s.ad_value(173), 1.0));
        ...
        if (((!s.b[729]) && (!s.b[730])) && s.b[731]) {
            s.store_offset_mul_ad(320, s.ad_value(727), A::offset(A::mul(s.ad_value(727), A::scale_offset(s.ad_value(727), (1.0 / 27.0), (1.0 / 3.0))), 1.0), 1.0);
        }

        if (((!s.b[729]) && (!s.b[730])) && (!s.b[731])) {
            s.store_offset_mul_ad(320, s.ad_value(727), A::offset(A::mul(s.ad_value(727), A::offset(A::mul(s.ad_value(727), A::scale_offset(s.ad_value(727), 0.148148111111111, 0.0402052934513951)), (1.0 / 3.0))), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if s.b[733] {
            ...
            s.store_neg(742, 475);
            s.store_ad_value(743, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(742)), 4.0, s.ad_value(741), 4.0), (-1.0), A::add_scaled_product(s.ad_value(742), 2.0, s.ad_value(741), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(742), 2.0, s.ad_value(741), s.ad_value(225), 1.0), 1.0));
        }
        ...
        if s.b[733] {
            ...
            s.store_ad_value(744, A::add_scaled_product(s.ad_value(742), 2.0, s.ad_value(741), s.ad_value(225), 1.0));
        ...
        if (s.b[733] && (!s.b[747])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(387, A::add_scaled_inputs3(s.ad_value(746), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }
        ...
        while {
            ...
            if (s.b[733] && s.b[756]) {
                ...
                s.store_mul_scaled_ad_rhs(752, 748, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(750), s.ad_value(749)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(751), (-1.0)), 1.0)));
                s.store_mul_ad(753, A::div_from_scalar(s.v[122], s.ad_value(752)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(750)), 1.0, s.ad_value(239), s.ad_value(751), 1.0));
            }
            ...
            if s.b[733] {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(752)), 1.0, s.ad_value(739), s.ad_value(739), 4.0));
                s.store_offset_scaled_div(755, 752, 45, 0.5, 0.5);
                s.store_ad_value(754, A::add_scaled_inputs3(s.ad_value(752), 0.5, s.ad_value(45), 0.5, s.ad_value(739), 1e-10));
            }
            s.b[758] = (s.v[754] < 0.0);
            ...
            if s.b[733] {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(754), (-1.0), s.ad_value(740), -1.0));
            ...
            if s.b[733] {
                ...
                s.store_ad_value(754, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(755, 755, 753, 335);
                s.store_ad_value(390, A::div_scaled_inputs(A::square(s.ad_value(754)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_div_ad_lhs(391, A::mul_scaled_lhs(s.ad_value(390), 2.0, s.ad_value(755)), 754);
                s.store_sub_ad_rhs(754, 387, A::div(A::add(A::add_scaled_inputs3(s.ad_value(752), 1.0 / (s.v[93]), s.ad_value(387), (-1.0), s.ad_value(475), -1.0), s.ad_value(390)), A::add(A::scale_offset(s.ad_value(753), 1.0 / (s.v[93]), (-1.0)), s.ad_value(391))));
            }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (s.b[733] && s.b[776]) {
            s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(405), 1.0, s.ad_value(403), (-1.0), s.ad_value(736), 1.0));
            s.store_square(49, 44);
        ...
        if (s.b[733] && s.b[776]) {
            ...
            s.store_ad_value(405, A::add_scaled_inputs3(s.ad_value(403), 1.0, s.ad_value(736), (-1.0), s.ad_value(43), 1.0));
        }
        ...
        if s.b[733] {
            ...
            s.store_ad_value(384, A::add_scaled_product(s.ad_value(227), 1.0, s.ad_value(341), s.ad_value(736), ((-0.5) * 9662367879.197212)));
            s.store_ad_value(385, A::add_scaled_product(s.ad_value(384), 1.0, s.ad_value(386), s.ad_value(736), (-9662367879.197212)));
        }
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if ((s.b[733] && (!s.b[782])) && (!s.b[794])) {
            ...
            s.store_neg_ad(328, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(349)), 1.0, s.ad_value(341), s.ad_value(736), (-(1.0 / (2.0) * 9662367879.197212))));
        ...
        while {
            ...
            if (s.b[733] && (!s.b[782])) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(331)), 1.0, s.ad_value(739), s.ad_value(739), 4.0));
                s.store_offset_scaled_div(334, 331, 45, 0.5, 0.5);
                s.store_ad_value(333, A::add_scaled_inputs3(s.ad_value(331), 0.5, s.ad_value(45), 0.5, s.ad_value(739), 1e-10));
            }
            s.b[798] = (s.v[333] < 0.0);
            ...
            if (s.b[733] && (!s.b[782])) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(333), (-1.0), s.ad_value(740), -1.0));
                s.store_scaled_mul(45, 341, 740, (-4.0));
            }
            if (s.b[733] && (!s.b[782])) {
                s.store_ad_value(45, {
            ...
            if (s.b[733] && (!s.b[782])) {
                let assign9490_body27_ad_e8359: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(349), 1.0, s.ad_value(351), (-1.0), s.ad_value(331), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(331), 1.0, s.ad_value(341), 0.5), s.ad_value(736), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(332), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(332), s.ad_value(736), 9662367879.197212), s.ad_value(389)));
        ...
        if (s.b[733] && (!s.b[782])) {
            ...
            s.store_ad_value(350, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(735), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
        ...
        if (((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[825])) {
            ...
            s.store_ad_value(807, A::div_scaled_inputs(A::offset(A::add(A::add_scaled_inputs3(s.ad_value(514), p.p145, s.ad_value(187), 1.0, s.ad_value(319), 1.0), s.ad_value(237)), p.p144), -1.0, s.ad_value(822), 1.0));
            s.store_scalar(562, 0.0);
        }
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        while {
            ...
            if (((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[825])) {
                ...
                s.store_ad_value(811, A::add_scaled_inputs3(s.ad_value(159), 1.0, s.ad_value(175), 1.0, A::add_scaled_product(s.ad_value(395), 1.0, s.ad_value(449), s.ad_value(810), 1.0), -1.0));
            ...
            if (((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[825])) {
                ...
                s.store_scaled_div(816, 814, 815, -1.0);
            }
        ...
        if ((((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[843])) && s.b[844]) {
            ...
            s.store_ad_value(835, A::add_scaled_product(A::sub(s.ad_value(831), s.ad_value(227)), 1.0, s.ad_value(130), s.ad_value(514), (-1.0)));
        ...
        if ((((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[843])) && s.b[844]) {
            ...
            s.store_ad_value(841, A::add_scaled_products(s.ad_value(831), s.ad_value(137), 1.0, s.ad_value(833), A::sub_from_scalar(1.0, s.ad_value(836)), 1.0));
            s.store_ad_value(842, A::add_scaled_inputs3(s.ad_value(173), p.p122, s.ad_value(395), 1.0, A::mul3(s.ad_value(131), s.ad_value(129), s.ad_value(841)), -1.0));
        ...
        if ((((s.b[733] && s.b[800]) && s.b[801]) && (!s.b[843])) && (!s.b[844])) {
            s.store_ad_value(841, A::add_scaled_product(s.ad_value(831), 1.0, s.ad_value(833), A::sub_from_scalar(1.0, s.ad_value(836)), 1.0));
            s.store_div_from_scalar_offset_input(832, s.v[100], 131, s.v[100]);
            s.store_ad_value(842, A::add_scaled_product(A::scale_offset(s.ad_value(173), p.p122, s.v[176]), 1.0, s.ad_value(832), s.ad_value(841), (-1.0)));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        while {
            ...
            if (s.b[733] && s.b[897]) {
                ...
                s.store_ad_value(869, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(357), 1.0));
            }
            s.b[898] = (s.v[863] > 1e-9);
            s.v[898] = if s.b[898] { 1.0 } else { 0.0 };
            if ((s.b[733] && (!s.b[897])) && s.b[898]) {
                s.store_exp(864, 862);
                s.store_mul_scaled_ad_rhs(357, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(862)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(864), s.ad_value(862)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(869, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(864), 1.0), s.v[122]), 357);
            }
            if ((s.b[733] && (!s.b[897])) && (!s.b[898])) {
            ...
            if s.b[733] {
                ...
                s.store_sqrt_ad(866, A::add_scaled_product(A::div(A::square(s.ad_value(361)), A::square(s.ad_value(238))), 1.0, s.ad_value(379), A::add_scaled_inputs3(s.ad_value(867), 1.0, s.ad_value(862), 1.0, s.ad_value(865), -1.0), 2.0));
                s.store_ad_value(896, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(867), 1.0), 2.0), 1.0, s.ad_value(866), 2.0));
                s.store_ad_value(355, A::add_scaled_product(s.ad_value(361), (-1.0), s.ad_value(238), s.ad_value(866), -1.0));
            ...
            if (s.b[733] && s.b[900]) {
                ...
                s.store_div_ad_lhs(364, A::div_scaled_inputs(A::mul3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333))), 1.0, s.ad_value(864), 2.0), 738);
                s.store_neg(365, 364);
            }
            ...
            if ((s.b[733] && (!s.b[900])) && s.b[901]) {
                ...
                s.store_div_ad_lhs(364, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), -1.0), 1.0, s.ad_value(864), 2.0), 738);
                s.store_neg(365, 364);
            }
            if ((s.b[733] && (!s.b[900])) && (!s.b[901])) {
            ...
            if (s.b[733] && s.b[902]) {
                ...
                s.store_ad_value(363, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(895), 1.0));
            }
            if (s.b[733] && s.b[902]) {
            }
            if (s.b[733] && (!s.b[902])) {
            ...
            if (s.b[733] && s.b[908]) {
                ...
                s.store_sub_ad_lhs(363, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(361)), 1.0, A::sub(s.ad_value(341), s.ad_value(361)), -1.0), 895);
            }
            if (s.b[733] && s.b[908]) {
            }
            if (s.b[733] && (!s.b[908])) {
            ...
            if (s.b[733] && (!s.b[914])) {
                s.store_ad_value(873, A::add_scaled_product(A::sub(s.ad_value(349), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(357), 1.0, s.ad_value(361), 1.0, s.ad_value(355), 1.0), 1.0, s.ad_value(363), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(863, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(735), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
                s.store_mul(865, 735, 869);
                s.store_sub(877, 350, 863);
                s.store_scalar(878, (-1.0));
                s.store_scalar(879, 1.0);
                s.store_neg(880, 865);
                s.store_ad_value(881, A::add_scaled_inputs3(s.ad_value(351), 1.0, s.ad_value(350), (-1.0), s.ad_value(357), (-s.v[94])));
                s.store_scalar(882, (-1.0));
                s.store_sub_from_scalar_ad(883, 1.0, A::scale(s.ad_value(869), s.v[94]));
                s.store_add_ad(884, A::add_scaled_inputs3(A::mul3(s.ad_value(874), s.ad_value(879), s.ad_value(883)), 1.0, A::mul3(s.ad_value(874), s.ad_value(880), s.ad_value(882)), (-1.0), A::mul3(s.ad_value(875), s.ad_value(878), s.ad_value(883)), -1.0), A::mul3(s.ad_value(876), s.ad_value(878), s.ad_value(882)));
                s.store_div_from_scalar_offset_input(885, 1.0, 884, 1e-50);
                s.store_ad_value(886, A::add_scaled_products(s.ad_value(879), s.ad_value(883), 1.0, s.ad_value(880), s.ad_value(882), (-1.0)));
                s.store_ad_value(887, A::add_scaled_products(s.ad_value(876), s.ad_value(882), 1.0, s.ad_value(875), s.ad_value(883), (-1.0)));
                s.store_ad_value(888, A::add_scaled_products(s.ad_value(875), s.ad_value(880), 1.0, s.ad_value(876), s.ad_value(879), (-1.0)));
                s.store_mul_neg_lhs(889, 878, 883);
                s.store_mul(890, 874, 883);
                s.store_ad_value(891, A::add_scaled_products(s.ad_value(876), s.ad_value(878), 1.0, s.ad_value(874), s.ad_value(880), (-1.0)));
                s.store_mul(892, 878, 882);
                s.store_mul_neg_lhs(893, 874, 882);
                s.store_ad_value(894, A::add_scaled_products(s.ad_value(874), s.ad_value(879), 1.0, s.ad_value(875), s.ad_value(878), (-1.0)));
                s.store_mul_scaled_ad_rhs(870, 885, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(886), s.ad_value(873), 1.0, s.ad_value(887), s.ad_value(877), 1.0), 1.0, s.ad_value(888), s.ad_value(881), 1.0));
                s.store_mul_scaled_ad_rhs(871, 885, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(889), s.ad_value(873), 1.0, s.ad_value(890), s.ad_value(877), 1.0), 1.0, s.ad_value(891), s.ad_value(881), 1.0));
                s.store_mul_scaled_ad_rhs(872, 885, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(892), s.ad_value(873), 1.0, s.ad_value(893), s.ad_value(877), 1.0), 1.0, s.ad_value(894), s.ad_value(881), 1.0));
                s.store_abs(863, 870);
            }
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[733] && (!s.b[925])) {
            ...
            s.store_ad_value(932, A::add_scaled_product(s.ad_value(159), 1.0, s.ad_value(927), A::sub_from_scalar(1.0, s.ad_value(928)), 1.0));
        ...
        if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[950]) {
            s.store_neg(945, 475);
            s.store_ad_value(946, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(945)), 4.0, s.ad_value(944), 4.0), (-1.0), A::add_scaled_product(s.ad_value(945), 2.0, s.ad_value(944), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(945), 2.0, s.ad_value(944), s.ad_value(225), 1.0), 1.0));
        }
        ...
        if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[950]) {
            ...
            s.store_ad_value(947, A::add_scaled_product(s.ad_value(945), 2.0, s.ad_value(944), s.ad_value(225), 1.0));
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if (((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[950]) && (!s.b[951])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(354, A::add_scaled_inputs3(s.ad_value(949), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }

        if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && (!s.b[950])) {
            s.store_neg_ad(945, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(352)), 1.0, s.ad_value(341), s.ad_value(736), (-(1.0 / (2.0) * 9662367879.197212))));
            s.store_ad_value(946, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(945)), 4.0, s.ad_value(944), 4.0), (-1.0), A::add_scaled_product(s.ad_value(945), 2.0, s.ad_value(944), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(945), 2.0, s.ad_value(944), s.ad_value(225), 1.0), 1.0));
        }
        ...
        while {
            ...
            if (((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[962]) && s.b[963]) {
                ...
                s.store_mul_scaled_ad_rhs(957, 954, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(956), s.ad_value(955)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(953), (-1.0)), 1.0)));
                s.store_mul_ad(958, A::div_from_scalar(s.v[122], s.ad_value(957)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(956)), 1.0, s.ad_value(239), s.ad_value(953), 1.0));
            }
            ...
            if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[962]) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(957)), 1.0, s.ad_value(739), s.ad_value(739), 4.0));
                s.store_offset_scaled_div(960, 957, 45, 0.5, 0.5);
                s.store_ad_value(959, A::add_scaled_inputs3(s.ad_value(957), 0.5, s.ad_value(45), 0.5, s.ad_value(739), 1e-10));
            }
            s.b[965] = (s.v[959] < 0.0);
            ...
            if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[962]) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(959), (-1.0), s.ad_value(740), -1.0));
                s.store_scaled_mul(45, 341, 740, (-4.0));
            }
            if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[962]) {
                s.store_ad_value(45, {
            ...
            if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && s.b[962]) {
                s.store_sqrt_square_add(45, 44, 45);
                s.store_offset_scaled_div(335, 44, 45, 0.5, 0.5);
                s.store_ad_value(959, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(960, 960, 958, 335);
                s.store_ad_value(388, A::div_scaled_inputs(A::square(s.ad_value(959)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_div_ad_lhs(389, A::mul_scaled_lhs(s.ad_value(388), 2.0, s.ad_value(960)), 959);
                s.store_sub_ad_rhs(959, 354, A::div(A::add(A::add_scaled_inputs3(s.ad_value(957), 1.0 / (s.v[93]), s.ad_value(354), (-1.0), s.ad_value(475), -1.0), s.ad_value(388)), A::add(A::scale_offset(s.ad_value(958), 1.0 / (s.v[93]), (-1.0)), s.ad_value(389))));
            }
        ...
        while {
            ...
            if ((((s.b[733] && (!s.b[925])) && (!s.b[940])) && (!s.b[941])) && (!s.b[962])) {
                let assign12730_body27_ad_e16106: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(352), 1.0, s.ad_value(354), (-1.0), s.ad_value(957), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(957), 1.0, s.ad_value(341), 0.5), s.ad_value(736), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(958), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(958), s.ad_value(736), 9662367879.197212), s.ad_value(389)));
        ...
        if ((s.b[733] && (!s.b[925])) && s.b[1008]) {
            s.store_ad_value(353, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(735), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        while {
            ...
            if ((s.b[733] && (!s.b[925])) && s.b[1009]) {
                ...
                s.store_ad_value(979, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(360), 1.0));
            }
            s.b[1010] = (s.v[973] > 1e-9);
            s.v[1010] = if s.b[1010] { 1.0 } else { 0.0 };
            if (((s.b[733] && (!s.b[925])) && (!s.b[1009])) && s.b[1010]) {
                s.store_exp(974, 972);
                s.store_mul_scaled_ad_rhs(360, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(972)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(974), s.ad_value(972)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(979, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(974), 1.0), s.v[122]), 360);
            }
            if (((s.b[733] && (!s.b[925])) && (!s.b[1009])) && (!s.b[1010])) {
            ...
            if (s.b[733] && (!s.b[925])) {
                ...
                s.store_sqrt_ad(976, A::add_scaled_product(A::div(A::square(s.ad_value(362)), A::square(s.ad_value(238))), 1.0, s.ad_value(379), A::add_scaled_inputs3(s.ad_value(977), 1.0, s.ad_value(972), 1.0, s.ad_value(975), -1.0), 2.0));
                s.store_ad_value(1006, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(977), 1.0), 2.0), 1.0, s.ad_value(976), 2.0));
                s.store_ad_value(358, A::add_scaled_product(s.ad_value(362), (-1.0), s.ad_value(238), s.ad_value(976), -1.0));
            ...
            if ((s.b[733] && (!s.b[925])) && s.b[1012]) {
                ...
                s.store_div_ad_lhs(367, A::div_scaled_inputs(A::mul3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333))), 1.0, s.ad_value(974), 2.0), 738);
                s.store_neg(368, 367);
            }
            ...
            if (((s.b[733] && (!s.b[925])) && (!s.b[1012])) && s.b[1013]) {
                ...
                s.store_div_ad_lhs(367, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), -1.0), 1.0, s.ad_value(974), 2.0), 738);
                s.store_neg(368, 367);
            }
            if (((s.b[733] && (!s.b[925])) && (!s.b[1012])) && (!s.b[1013])) {
            ...
            if ((s.b[733] && (!s.b[925])) && s.b[1014]) {
                ...
                s.store_div_ad_lhs(327, A::mul3_scaled_output(s.ad_value(406), s.ad_value(52), s.ad_value(53), -1.0), 48);
                s.store_ad_value(366, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(1005), 1.0));
            }
            if ((s.b[733] && (!s.b[925])) && s.b[1014]) {
            }
            if ((s.b[733] && (!s.b[925])) && (!s.b[1014])) {
            ...
            if ((s.b[733] && (!s.b[925])) && s.b[1020]) {
                ...
                s.store_sub_ad_lhs(366, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(362)), 1.0, A::sub(s.ad_value(341), s.ad_value(362)), -1.0), 1005);
            }
            if ((s.b[733] && (!s.b[925])) && s.b[1020]) {
            }
            if ((s.b[733] && (!s.b[925])) && (!s.b[1020])) {
            ...
            if ((s.b[733] && (!s.b[925])) && (!s.b[1026])) {
                s.store_ad_value(983, A::add_scaled_product(A::sub(s.ad_value(352), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(360), 1.0, s.ad_value(362), 1.0, s.ad_value(358), 1.0), 1.0, s.ad_value(366), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(973, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(735), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(360), 1.0), 1.0));
                s.store_mul(975, 735, 979);
                s.store_sub(987, 353, 973);
                s.store_scalar(988, (-1.0));
                s.store_scalar(989, 1.0);
                s.store_neg(990, 975);
                s.store_ad_value(991, A::add_scaled_inputs3(s.ad_value(354), 1.0, s.ad_value(353), (-1.0), s.ad_value(360), (-s.v[94])));
                s.store_scalar(992, (-1.0));
                s.store_sub_from_scalar_ad(993, 1.0, A::scale(s.ad_value(979), s.v[94]));
                s.store_add_ad(994, A::add_scaled_inputs3(A::mul3(s.ad_value(984), s.ad_value(989), s.ad_value(993)), 1.0, A::mul3(s.ad_value(984), s.ad_value(990), s.ad_value(992)), (-1.0), A::mul3(s.ad_value(985), s.ad_value(988), s.ad_value(993)), -1.0), A::mul3(s.ad_value(986), s.ad_value(988), s.ad_value(992)));
                s.store_div_from_scalar_offset_input(995, 1.0, 994, 1e-50);
                s.store_ad_value(996, A::add_scaled_products(s.ad_value(989), s.ad_value(993), 1.0, s.ad_value(990), s.ad_value(992), (-1.0)));
                s.store_ad_value(997, A::add_scaled_products(s.ad_value(986), s.ad_value(992), 1.0, s.ad_value(985), s.ad_value(993), (-1.0)));
                s.store_ad_value(998, A::add_scaled_products(s.ad_value(985), s.ad_value(990), 1.0, s.ad_value(986), s.ad_value(989), (-1.0)));
                s.store_mul_neg_lhs(999, 988, 993);
                s.store_mul(1000, 984, 993);
                s.store_ad_value(1001, A::add_scaled_products(s.ad_value(986), s.ad_value(988), 1.0, s.ad_value(984), s.ad_value(990), (-1.0)));
                s.store_mul(1002, 988, 992);
                s.store_mul_neg_lhs(1003, 984, 992);
                s.store_ad_value(1004, A::add_scaled_products(s.ad_value(984), s.ad_value(989), 1.0, s.ad_value(985), s.ad_value(988), (-1.0)));
                s.store_mul_scaled_ad_rhs(980, 995, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(996), s.ad_value(983), 1.0, s.ad_value(997), s.ad_value(987), 1.0), 1.0, s.ad_value(998), s.ad_value(991), 1.0));
                s.store_mul_scaled_ad_rhs(981, 995, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(999), s.ad_value(983), 1.0, s.ad_value(1000), s.ad_value(987), 1.0), 1.0, s.ad_value(1001), s.ad_value(991), 1.0));
                s.store_mul_scaled_ad_rhs(982, 995, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1002), s.ad_value(983), 1.0, s.ad_value(1003), s.ad_value(987), 1.0), 1.0, s.ad_value(1004), s.ad_value(991), 1.0));
                s.store_abs(973, 980);
            }
