...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_64(
        ...
        if (((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) {s.store_offset_scaled(1545, 1526, -1.0, (-1e-12));s.store_scale(1553, 1552, s.v[1531]);s.store_square(1554, 1553);s.store_sub_from_scalar(1555, s.v[82], 1551);s.store_div_from_scalar(1519, s.v[69], 230);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1556, 2.0, 225, A::ln(s.ad_value(1519)));}
        let (t1,) = {
    ...
    pub(super) fn stamp_transient_block_66(
        ...
        if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {s.store_exp_ad(1586, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1545), -1.0));s.store_scale(1519, 230, 1.0 / (s.v[69]));s.store_square(1580, 1519);s.store_mul(1595, 1580, 1586);}
        let (t2,) = {
    if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {
        ...
        if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {s.store_scalar(1589, 0.0);s.store_scalar(1593, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_69(
        ...
        if ((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && s.b[1626]) {s.store_sub_from_scalar_scaled_mul_mixed_ia(1561, (7.0 * 1.414213562373095), 1529, A::offset(s.ad_value(1528), (-2.0)), 9.0);s.store_square(1562, 1561);}
    ...
    pub(super) fn stamp_transient_block_71(
        ...
        if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) {s.store_exp_ad(1586, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1545), -1.0));s.store_scale(1519, 230, 1.0 / (s.v[69]));s.store_square(1580, 1519);s.store_mul(1595, 1580, 1586);}
        let (ta,) = {
    if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) {
        ...
        if (((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) {s.store_scalar(1589, 0.0);s.store_scalar(1593, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_72(
        ...
        let mut tf: usize = 0;
        while {
            let tc: f64 = (2.0 * 20.0);let td: f64 = (tc + 1.0);let te: f64 = if ((((((p.p24 != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) && (s.v[167] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_76(
        ...
        if ((s.v[85] != 0.0) && s.b[1717]) {s.store_scalar(1712, p.p233);s.store_scalar(1713, p.p234);s.copy_ad(1714, 441);s.store_mul_product3_indices(1715, 1714, 1712, 1713, 1714, 1.0);s.store_offset_add_ad(1716, A::mul3(s.ad_value(250), s.ad_value(192), s.ad_value(1712)), A::mul3(s.ad_value(1713), s.ad_value(1714), s.ad_value(1714)), 1e-50);s.store_div(289, 1715, 1716);}
        if ((s.v[85] != 0.0) && (!s.b[1717])) {s.store_scalar(289, (p.p233 + 1e-50));}
        if (s.v[85] != 0.0) {s.store_scalar(1715, p.p235);s.store_mul(290, 1715, 323);}
    ...
    if s.b[1771] {
        ...
        s.store_scalar(4, 0.0);s.store_scalar(5, 0.0);s.b[1773] = (p.p259 == 1.0);s.store_scalar(1773, if s.b[1773] { 1.0 } else { 0.0 });
        let (t1c,) = {
    if s.b[1773] {
        (1.0,)
    } else {
        ...
        if (s.b[1773] && s.b[1793]) {s.store_scalar(1784, (p.p264 / 1e-6));s.store_scalar(1777, p.p266);s.store_scalar(1778, p.p268);s.store_scalar(1779, p.p273);}
        if (s.b[1773] && s.b[1793]) {s.store_scalar(1780, (if (p.p263 > 0.0) { (p.p263 * p.p255) } else { 0.0 }));}
        if (s.b[1773] && s.b[1793]) {s.store_scalar(1783, p.p258);s.store_scaled_voltage(1781, ctx, nodes, Some(7), Some(2), p.p50);}
        if (s.b[1773] && (!s.b[1793])) {s.store_scalar(1784, (p.p59 / 1e-6));s.store_scalar(1777, p.p265);s.store_scalar(1778, p.p267);s.store_scalar(1779, p.p272);}
        if (s.b[1773] && (!s.b[1793])) {s.store_scalar(1780, (if (p.p263 > 0.0) { (p.p263 * p.p256) } else { 0.0 }));}
        if (s.b[1773] && (!s.b[1793])) {s.store_scalar(1783, p.p257);s.store_scaled_voltage(1781, ctx, nodes, Some(0), Some(6), p.p50);}
        if s.b[1773] {s.store_scalar(1790, ((((p.p271 * p.p271) + (p.p56 * p.p56))) as f64).sqrt());s.store_primal_scale(1792, 105, p.p9);s.store_primal_scale(1777, 1777, 0.0001);s.store_primal_scale(1778, 1778, 0.01);s.store_scale(1782, 429, 1.0 / (s.v[81]));s.store_powf(328, 1782, p.p269);s.store_div(1785, 1777, 328);}
    }
}
