...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_64(
        ...
        if ((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && s.b[1604]) {s.store_offset_ad(1544, A::add_scaled_products(s.ad_value(1538), s.ad_value(1550), 1.0, s.ad_value(1539), s.ad_value(1549), 1.0), (10.0 * 2.220446049250313e-16));}
    ...
    if (((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) {
        ...
        s.store_scalar(1557, t1);s.b[1606] = (s.v[1555] < s.v[1557]);s.store_scalar(1606, if s.b[1606] { 1.0 } else { 0.0 });
        ...
        if ((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) {s.store_scalar(1567, 3.0);s.store_sub_div_lhs_indices(1570, 1567, 225, 1545);s.store_exp_neg_input(1529, 1567);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_65(
        ...
        if ((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) {s.store_offset_div_scaled_inputs2_mixed_aia(1528, A::offset(A::mul(s.ad_value(225), A::add(s.ad_value(1555), s.ad_value(1545))), (-1.0)), 4.0, 1529, 4.0, A::mul(s.ad_value(1554), s.ad_value(226)), 1.0, 1.0);}
    ...
    pub(super) fn stamp_transient_block_66(
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1611]) {s.store_add_scaled_inputs_product_mixed_aaii(1583, A::ln(A::add_scaled_square_product(s.ad_value(1582), 1.0, s.ad_value(1581), s.ad_value(1519), 1.0)), 1.0, A::ln(A::mul(s.ad_value(1580), s.ad_value(1519))), (-1.0), 225, 1545, 1.0);s.store_offset_sub(44, 1582, 1583, (-1.0));s.store_scale(45, 1582, 4.0);}
        ...
        if ((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) {s.store_sub_div_lhs_indices(1569, 1567, 225, 1545);s.store_add_offset_lhs_mixed_ia(1520, 1567, (-1.0), A::exp_scaled_input(s.ad_value(1567), -1.0));}
    ...
    pub(super) fn stamp_transient_block_67(
        ...
        let mut t7: usize = 0;
        while {
            let t4: f64 = (2.0 * 20.0);let t5: f64 = (t4 + 1.0);let t6: f64 = if ((((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) && (s.v[167] <= t5)) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
    ...
    if (((((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) && (!s.b[1616])) && s.b[1618]) {
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {s.store_mul(458, 1552, 1601);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_68(
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1606])) && s.b[1613]) {s.store_div_from_scalar_add_ad(1520, 1.0, s.ad_value(1593), s.ad_value(1601));s.store_mul3_lhs(460, 1552, 1589, 1520);s.store_add(459, 458, 460);}
    ...
    if (((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) {
        ...
        s.store_scalar(1557, t9);s.b[1626] = (s.v[1555] < s.v[1557]);s.store_scalar(1626, if s.b[1626] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_72(
        ...
        let mut tf: usize = 0;
        while {
            let tc: f64 = (2.0 * 20.0);let td: f64 = (tc + 1.0);let te: f64 = if ((((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) && (s.v[167] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
    ...
    if (((((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) && (!s.b[1636])) && s.b[1638]) {
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) {s.store_mul(458, 1552, 1601);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_73(
        ...
        if (((((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) && (!s.b[1626])) && s.b[1633]) {s.store_div_from_scalar_add_ad(1520, 1.0, s.ad_value(1593), s.ad_value(1601));s.store_mul3_lhs(460, 1552, 1589, 1520);s.store_add(459, 458, 460);}
        if (((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) {s.store_sub(460, 459, 458);}
        if (((p[24] != 0.0) && s.b[1602]) && (!s.b[1603])) {
            if (p[43] == 1.0) {
                s.store_mul(1523, 287, 1532);
    ...
    if s.b[1773] {
        ...
        s.store_scalar(3, t1c);s.b[1793] = (s.v[3] == 1.0);s.store_scalar(1793, if s.b[1793] { 1.0 } else { 0.0 });
        ...
        if (s.b[1773] && s.b[1793]) {s.store_scalar(1783, p[258]);s.store_scaled_voltage(1781, ctx, nodes, Some(7), Some(2), p[50]);}
        ...
        if s.b[1773] {s.store_scalar(1790, ((((p[271] * p[271]) + (p[56] * p[56]))) as f64).sqrt());s.store_primal_scale(1792, 105, p[9]);s.store_primal_scale(1777, 1777, 0.0001);s.store_primal_scale(1778, 1778, 0.01);s.store_scale(1782, 429, 1.0 / (s.v[81]));s.store_powf(328, 1782, p[269]);s.store_div(1785, 1777, 328);}
    }
}
