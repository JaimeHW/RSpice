...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (s.b[1220] && s.b[1266]) {
            s.copy_ad(378, 1230);
            s.copy_ad(1267, 1221);
            s.store_offset_add_scaled_inputs3_offset(160, s.ad_value(185), (-1.0), s.ad_value(320), 1.0, s.ad_value(1267), 1.0, s.v[123], p.p286);
        }
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if s.b[1725] {
            s.store_mul_div_scaled_product_rhs(291, 1721, A::square(s.ad_value(199)), s.ad_value(1723), 1.0, A::mul3(s.ad_value(441), s.ad_value(225), s.ad_value(107)), 1.0);
        }
