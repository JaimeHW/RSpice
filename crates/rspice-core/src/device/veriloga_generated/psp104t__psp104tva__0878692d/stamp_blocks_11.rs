...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_33(
        ...
        if (s.b[2194] && (!s.b[2202])) {s.store_offset(2166, 2103, 3.0);s.store_sub_ad(2149, A::add_scaled_inputs3(s.ad_value(2165), 0.5, s.ad_value(2166), 0.5, A::sqrt_square_offset(A::sub(s.ad_value(2165), s.ad_value(2166)), 5.0), (-0.5)), A::sub_scaled_inputs(s.ad_value(2166), 0.5, A::sqrt_square_offset(s.ad_value(2166), 5.0), 0.5));s.store_sub(2144, 2039, 2149);s.store_exp_neg_input(2145, 2149);s.store_div_from_scalar_offset_square(2146, 1.0, 2149, 2.0);s.store_mul_square_lhs(2156, 2149, 2146);s.store_mul3_affine_lhs(2157, 2149, 2146, 4.0, 0.0, 2146);s.store_mul_ad_product_lhs_mixed_ai(2158, A::sub_scaled_inputs(s.ad_value(2146), 8.0, s.ad_value(2156), 12.0), 2146, 2146);}
    ...
    pub(super) fn stamp_reactive_block_34(
        ...
        if ((s.b[2194] && s.b[2206]) && s.b[2207]) {s.store_square_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(2113, 2106, 1.0, 2106, 1.0, 2106, 0.25, 0.3333333333333333, 0.5);s.store_sqrt_sub_from_scalar_ad(1929, 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2106), 1.0, A::scale(s.ad_value(2106), 0.25), 0.3333333333333333));s.store_scaled_mul(2114, 2106, 1929, 0.7071067811865475);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_35(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[2194] && s.b[2206]) && s.b[2207]) {s.store_mul3_ad_middle(2115, A::mul3_scaled_output(s.ad_value(2105), s.ad_value(2106), s.ad_value(2106), 0.16666666666666666), 2106, A::scale_offset(s.ad_value(2106), 1.75, 1.0));}
        if ((s.b[2194] && s.b[2206]) && (!s.b[2207])) {s.store_add_offset_lhs(2113, 2106, (-1.0), 2112);s.store_sqrt(2114, 2113);s.store_mul_add_scaled_inputs3_offset_rhs_mixed_aii(2115, 2105, A::div_from_scalar(1.0, s.ad_value(2112)), 1.0, 2106, (-1.0), 2111, -1.0, (-1.0));}
    ...
    pub(super) fn stamp_reactive_block_38(
        ...
        if s.b[2217] {s.store_scaled_add_mixed_ia(1943, 1801, A::sqrt(A::add(A::square(s.ad_value(1801)), s.ad_value(778))), 0.5);s.store_add_mixed_ai(1944, A::add_scaled_inputs_product(s.ad_value(1943), -1.0, s.ad_value(773), (-0.5), s.ad_value(771), A::sqrt(A::add_scaled_inputs3(s.ad_value(1943), 1.0, s.ad_value(773), 0.25, s.ad_value(779), 1.0)), 1.0), 780);s.store_scaled_add_mixed_ia(1943, 1802, A::sqrt(A::add(A::square(s.ad_value(1802)), s.ad_value(781))), 0.5);s.store_add_mixed_ai(1945, A::add_scaled_inputs_product(s.ad_value(1943), -1.0, s.ad_value(774), (-0.5), s.ad_value(772), A::sqrt(A::add_scaled_inputs3(s.ad_value(1943), 1.0, s.ad_value(774), 0.25, s.ad_value(782), 1.0)), 1.0), 783);s.store_scaled_add(1862, 1801, 1944, (-s.v[355]));s.store_scaled_add(1863, 1802, 1945, (-s.v[355]));}
        s.b[2218] = (p.p40 != 0.0);s.store_scalar(2218, if s.b[2218] { 1.0 } else { 0.0 });s.b[2219] = (s.v[235] > 0.0);s.store_scalar(2219, if s.b[2219] { 1.0 } else { 0.0 });
        ...
        if (s.b[2218] && s.b[2219]) {s.store_mul_scale_offset_mixed_ia(1929, 787, A::mul(s.ad_value(1946), A::add_scaled_product(s.ad_value(240), 1.0, s.ad_value(241), s.ad_value(1946), 1.0)), 1.0, (-1.5));s.store_offset(1948, 1944, 3.0);s.store_primal_sub_from_scalar(1949, (-3.0), 233);s.store_scale(1950, 823, 30.0);s.store_scalar(807, (4.0 - 0.9));s.store_add(808, 1948, 1950);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1929, 2.0, 807, A::sub(s.ad_value(808), A::sqrt(A::sub(A::square(s.ad_value(808)), A::mul3(s.ad_value(807), s.ad_value(1948), s.ad_value(1950))))));s.store_scalar(807, (4.0 - 0.3));s.store_add(808, 1949, 1929);}
        ...
        if (s.b[2218] && s.b[2223]) {s.store_mul_scale_offset_mixed_ia(1929, 788, A::mul(s.ad_value(1946), A::add_scaled_product(s.ad_value(242), 1.0, s.ad_value(243), s.ad_value(1946), 1.0)), 1.0, (-1.5));s.store_offset(1948, 1945, 3.0);s.store_primal_sub_from_scalar(1949, (-3.0), 233);s.store_scale(1950, 826, 30.0);s.store_scalar(807, (4.0 - 0.9));s.store_add(808, 1948, 1950);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_39(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[2218] && s.b[2223]) {s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1929, 2.0, 807, A::sub(s.ad_value(808), A::sqrt(A::sub(A::square(s.ad_value(808)), A::mul3(s.ad_value(807), s.ad_value(1948), s.ad_value(1950))))));s.store_scalar(807, (4.0 - 0.3));s.store_add(808, 1949, 1929);}
        ...
        if (s.b[2218] && s.b[2227]) {s.store_add_scaled_product_mixed_iai(1956, 1846, 1.0, A::add_scaled_inputs3(s.ad_value(1955), 1.0, s.ad_value(731), (-1.0), s.ad_value(1952), -1.0), 1809, 1.0);s.store_mul_scale_offset_mixed_ia(1956, 1809, A::add_scaled_inputs3(s.ad_value(814), 1.0, s.ad_value(1932), 1.0, s.ad_value(1952), -1.0), -1.0, 0.0);}
        ...
        if (s.b[2218] && s.b[2227]) {s.store_mul_scale_offset_mixed_ia(1929, 786, A::mul(s.ad_value(1946), A::add_scaled_product(s.ad_value(238), 1.0, s.ad_value(239), s.ad_value(1946), 1.0)), 1.0, (-1.5));}
        s.b[2237] = ((s.v[1813] <= 0.0) || ((s.v[238] == 0.0) && (s.v[239] == 0.0)));s.store_scalar(2237, if s.b[2237] { 1.0 } else { 0.0 });
        if ((s.b[2218] && s.b[2227]) && (!s.b[2237])) {s.store_add_scaled_product_indices(1929, 238, 1.0, 239, 1946, 2.0);s.store_div_scaled_value_by_product_indices(1960, 244, 1.0, 1929, 786, 1.0);s.store_scaled_div(1961, 1844, 1960, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_40(
        ...
        if (((s.b[2218] && s.b[2227]) && (!s.b[2237])) && (!s.b[2238])) {s.store_div_from_scalar(1970, 1.0, 1969);s.store_sub(1929, 1969, 1970);s.store_add(1931, 1969, 1970);}
        s.b[2241] = (p.p42 != 0.0);s.store_scalar(2241, if s.b[2241] { 1.0 } else { 0.0 });s.b[2242] = ((s.v[246] > 0.0) && (s.v[1863] < 0.0));s.store_scalar(2242, if s.b[2242] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_41(
        ...
        if ((s.b[2246] && (!s.b[2250])) && s.b[2252]) {s.store_offset_add(1995, 1994, 1926, (-1.0));s.store_scaled_add_mixed_ia(1996, 1995, A::sqrt_square_offset(s.ad_value(1995), 10.0), 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_42(
        ...
        if ((s.b[2246] && (!s.b[2250])) && s.b[2252]) {s.store_add_mixed_ai(1997, A::add_scaled_product(s.ad_value(1994), 1.0, s.ad_value(1992), A::ln(s.ad_value(1996)), (-1.0)), 1926);s.store_scaled_add_mixed_ia(1998, 1997, A::sqrt_square_offset(s.ad_value(1997), 2.0), 0.5);}
    ...
    pub(super) fn stamp_reactive_block_43(
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2455]) {s.store_add_scaled_inputs4_mixed_iiai(2297, 817, 0.5, 816, 0.5, A::sqrt(A::add(A::square(A::sub(s.ad_value(817), s.ad_value(816))), s.ad_value(738))), (-0.5), 736, 1.0);s.store_add_scaled_inputs4_mixed_iiai(1870, 816, 1.0, 2297, (-0.5), A::sqrt(A::add(A::square(s.ad_value(2297)), s.ad_value(737))), (-(-0.5)), 739, 1.0);s.copy_ad(2298, 1870);s.copy_ad(2294, 734);s.copy_ad(2295, 737);s.copy_ad(2296, 735);}
    ...
    pub(super) fn stamp_reactive_block_44(
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2456]) {s.store_mul_scale_offset_mixed_ia(1931, 703, A::div(s.ad_value(2314), s.ad_value(2310)), 1.0, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_45(
        ...
        if (s.b[2453] && s.b[2454]) {s.store_offset_scaled(2340, 2304, 0.7071067811865475, 1.0);s.store_scale(2341, 2340, 1e-5);s.store_div_from_scalar(2342, 1.0, 2340);s.store_scalar(2449, 0.0);s.store_scalar(2343, 0.0);}
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && s.b[2466]) {s.store_neg(2431, 2323);s.store_scaled_mul(2432, 2431, 2342, 1.25);s.store_scaled_sub_offset_sqrt_square_offset(2433, 2432, 10.0, (-6.0), 64.0, 0.5);s.store_sub(2428, 2431, 2433);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_48(
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {s.store_div_from_scalar_offset_square(2428, 1.0, 2452, 2.0);s.store_mul_square_lhs(2440, 2452, 2428);s.store_mul3_affine_lhs(2441, 2452, 2428, 4.0, 0.0, 2428);s.store_mul_ad_product_lhs_mixed_ai(2442, A::sub_scaled_inputs(s.ad_value(2428), 8.0, s.ad_value(2440), 12.0), 2428, 2428);s.store_sub(2428, 2323, 2452);s.store_add_scaled_product_mixed_iia(2443, 2428, 2.0, 2305, A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(2439)), 1.0, s.ad_value(2438), 1.0, s.ad_value(2344), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0);s.store_add_scaled_square_product_mixed_iia(2444, 2428, 1.0, 2305, A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(2439), 1.0, s.ad_value(2452), 1.0, s.ad_value(2438), 1.0, (-1.0)), 1.0, s.ad_value(2344), A::add(A::offset(s.ad_value(2452), 1.0), s.ad_value(2440)), (-1.0)), (-1.0));s.store_sub_from_scalar_scaled_mul_mixed_ia(2428, 2.0, 2305, A::add_scaled_inputs_product(s.ad_value(2439), 1.0, s.ad_value(2438), 1.0, s.ad_value(2344), s.ad_value(2442), (-1.0)), 1.0);s.store_add_scaled_square_product_indices(2428, 2443, 1.0, 2444, 2428, (-2.0));s.store_add_scaled_inputs_mixed_ia(2343, 2452, 1.0, A::div(s.ad_value(2444), A::add(s.ad_value(2443), A::sqrt(s.ad_value(2428)))), 2.0);}
