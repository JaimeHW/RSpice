...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (((s.b[2218] && s.b[2219]) && (!s.b[2221])) && (!s.b[2222])) {
            s.store_div_from_scalar_offset_ad(1947, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1929), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1929), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if ((s.b[2218] && s.b[2223]) && s.b[2224]) {
            s.store_ad_value(1946, A::add_scaled_inputs3(s.ad_value(1946), 0.5, s.ad_value(791), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(1946), s.ad_value(791)), A::sub(s.ad_value(1946), s.ad_value(791))), 1e-6)), (-0.5)));
        }
        ...
        if ((s.b[2218] && s.b[2227]) && s.b[2228]) {
            ...
            s.store_div_scaled_product(1930, A::sqrt(s.ad_value(1929)), s.ad_value(815), 1.0, s.ad_value(1839), 1.0);
            s.store_add_ad_lhs(1931, A::square(s.ad_value(1930)), 1929);
            s.store_scale(1929, 1930, 2.0);
            s.store_ad_value(1842, A::div_scaled_product3(s.ad_value(1839), s.ad_value(1809), s.ad_value(1929), 1.0, A::add(A::sqrt(A::sub(s.ad_value(1931), s.ad_value(1929))), A::sqrt(A::add(s.ad_value(1931), s.ad_value(1929)))), 1.0));
        }
        ...
        if ((s.b[2218] && s.b[2227]) && (!s.b[2229])) {
            s.store_div_from_scalar_offset_ad(1929, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), A::sub(s.ad_value(1843), s.ad_value(1842)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::sub(s.ad_value(1843), s.ad_value(1842)), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (s.b[2218] && s.b[2227]) {
            s.store_add_scaled_product(1952, s.ad_value(1932), 1.0, s.ad_value(1808), A::sub_scaled_inputs(s.ad_value(1843), 0.5, A::ln_scaled_input(A::offset(s.ad_value(1929), 1.0), 0.5), 1.0), 1.0);
        ...
        if ((s.b[2218] && s.b[2227]) && s.b[2230]) {
            s.store_ad_value(1946, A::add_scaled_inputs3(s.ad_value(1946), 0.5, s.ad_value(789), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(1946), s.ad_value(789)), A::sub(s.ad_value(1946), s.ad_value(789))), 1e-6)), (-0.5)));
        }

        if (s.b[2218] && s.b[2227]) {
            s.store_add_scaled_product(1956, s.ad_value(1846), 1.0, A::add_scaled_inputs3(s.ad_value(1955), 1.0, s.ad_value(731), (-1.0), s.ad_value(1952), -1.0), s.ad_value(1809), 1.0);
        }
        ...
        if (((s.b[2218] && s.b[2227]) && (!s.b[2231])) && s.b[2232]) {
            s.store_div_from_scalar_offset_ad(1957, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1956), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1956), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (((s.b[2218] && s.b[2227]) && (!s.b[2231])) && (!s.b[2232])) {
            s.store_scaled_offset_ad(1957, A::mul_offset_lhs(s.ad_value(1956), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(1956), (-230.25850929940458), A::scale_offset(s.ad_value(1956), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[2218] && s.b[2227]) && (!s.b[2233])) && s.b[2234]) {
            s.store_div_from_scalar_offset_ad(1929, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1956), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1956), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (((s.b[2218] && s.b[2227]) && (!s.b[2233])) && (!s.b[2234])) {
            s.store_scaled_offset_ad(1929, A::mul_offset_lhs(s.ad_value(1956), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(1956), (-230.25850929940458), A::scale_offset(s.ad_value(1956), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if ((s.b[2218] && s.b[2227]) && (!s.b[2237])) {
            s.store_add_scaled_product(1929, s.ad_value(238), 1.0, s.ad_value(239), s.ad_value(1946), 2.0);
            ...
            s.store_ad_value(1963, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(1962), 1.0, s.ad_value(1962), 0.5));
        ...
        if (((((s.b[2218] && s.b[2227]) && (!s.b[2237])) && (!s.b[2238])) && (!s.b[2239])) && s.b[2240]) {
            s.store_div_from_scalar_offset_ad(1969, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1961), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1961), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (((((s.b[2218] && s.b[2227]) && (!s.b[2237])) && (!s.b[2238])) && (!s.b[2239])) && (!s.b[2240])) {
            s.store_scaled_offset_ad(1969, A::mul_offset_lhs(s.ad_value(1961), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(1961), (-230.25850929940458), A::scale_offset(s.ad_value(1961), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[2218] && s.b[2227]) && (!s.b[2237])) && (!s.b[2238])) {
            ...
            s.store_ad_value(1966, A::add_scaled_products(A::mul_sub_from_scalar_lhs(1.0, s.ad_value(1962), s.ad_value(1929)), s.ad_value(1968), 0.5, s.ad_value(1962), s.ad_value(1931), 0.5));
        ...
        if (s.b[2241] && s.b[2242]) {
            ...
            s.store_scaled_div(1929, 796, 1973, -1.0);
        }
        ...
        if ((s.b[2241] && s.b[2242]) && (!s.b[2243])) {
            s.store_div_from_scalar_offset_ad(1931, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1929), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1929), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if (s.b[2241] && s.b[2244]) {
            ...
            s.store_scaled_div(1929, 795, 1974, -1.0);
        }
        ...
        if s.b[2246] {
            s.store_ad_value(1929, A::add_scaled_inputs4(s.ad_value(817), 0.5, s.ad_value(816), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(753), 1.0, A::sub(s.ad_value(817), s.ad_value(816)), A::sub(s.ad_value(817), s.ad_value(816)), 1.0)), (-0.5), s.ad_value(751), 1.0));
            s.store_ad_value(1975, A::add_scaled_inputs4(s.ad_value(816), 1.0, s.ad_value(1929), (-0.5), A::sqrt(A::add_scaled_product(s.ad_value(752), 1.0, s.ad_value(1929), s.ad_value(1929), 1.0)), (-(-0.5)), s.ad_value(755), 1.0));
            s.store_ad_value(1976, A::add_scaled_inputs3(s.ad_value(1975), 1.0, s.ad_value(815), 0.5, s.ad_value(819), (-0.5)));
            ...
            s.store_ad_value(1980, A::div_scaled_value_offset_denominator(s.ad_value(819), 2.0, A::sqrt(A::offset(A::mul(s.ad_value(291), s.ad_value(819)), 1.0)), 1.0, 1.0));
            s.store_mul_ad_product_rhs(1981, 290, s.ad_value(1980), A::offset(A::mul(s.ad_value(292), s.ad_value(1976)), 1.0));
            s.store_mul_ad_rhs(1864, 1979, A::add_scaled_inputs3(s.ad_value(818), 1.0, s.ad_value(1981), 1.0, s.ad_value(714), -1.0));
            ...
            s.store_add_scaled_product(1990, s.ad_value(1989), 1.0, s.ad_value(750), A::sqrt(s.ad_value(1989)), 1.0);
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        if s.b[2246] {
            s.store_offset_ad(1992, A::div_scaled_inputs(s.ad_value(750), 1.0, A::sqrt(s.ad_value(1989)), 2.0), 1.0);
        ...
        if ((s.b[2246] && s.b[2247]) && (!s.b[2248])) {
            s.store_scaled_offset_ad(1999, A::mul_offset_lhs(A::sub(s.ad_value(1994), s.ad_value(1998)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(1994), s.ad_value(1998)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(1994), s.ad_value(1998)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }

        if (s.b[2246] && s.b[2247]) {
            s.store_mul(2000, 1925, 1999);
            s.store_pow_ad(2001, s.ad_value(2000), s.ad_value(1993));
            s.store_ad_value(2002, A::add_scaled_square_product(s.ad_value(1992), 1.0, A::add_scaled_inputs3(s.ad_value(1998), 2.0, s.ad_value(1992), 2.0, s.ad_value(2001), -1.0), s.ad_value(2001), 1.0));
        ...
        if ((s.b[2246] && s.b[2250]) && (!s.b[2251])) {
            s.store_div_from_scalar_offset_ad(1929, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), A::sub(s.ad_value(1984), s.ad_value(1986)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::sub(s.ad_value(1984), s.ad_value(1986)), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if (((s.b[2246] && (!s.b[2250])) && (!s.b[2252])) && (!s.b[2254])) {
            s.store_div_from_scalar_offset_ad(1987, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), A::mul(s.ad_value(1993), A::add(s.ad_value(1994), s.ad_value(1926))), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::mul(s.ad_value(1993), A::add(s.ad_value(1994), s.ad_value(1926))), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if s.b[2246] {
            ...
            s.store_ad_value(835, A::div_scaled_product3(A::mul3_scaled_output(s.ad_value(1918), s.ad_value(1978), s.ad_value(1978), -1.0), A::offset(A::mul(s.ad_value(1868), s.ad_value(1866)), 1.0), s.ad_value(1865), 1.0, s.ad_value(1853), 1.0));
        }
        ...
        if s.b[2255] {
            s.store_add_scaled_product(1988, s.ad_value(815), 1.0, s.ad_value(230), s.ad_value(1844), (-1.0));
        }
        ...
        if (((s.b[2255] && s.b[2256]) && (!s.b[2257])) && s.b[2258]) {
            s.store_div_from_scalar_offset_ad(1929, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), A::neg(s.ad_value(1931)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::neg(s.ad_value(1931)), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (((s.b[2255] && s.b[2256]) && (!s.b[2257])) && (!s.b[2258])) {
            s.store_scaled_offset_ad(1929, A::mul_offset_lhs(A::neg(s.ad_value(1931)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::neg(s.ad_value(1931)), (-230.25850929940458), A::scale_offset(A::neg(s.ad_value(1931)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if ((s.b[2255] && s.b[2256]) && s.b[2259]) {
            s.store_offset_ad(1929, A::div_scaled_inputs(s.ad_value(836), 2.0, s.ad_value(232), 1.0), (-1.0));
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2455]) {
            s.store_ad_value(2297, A::add_scaled_inputs4(s.ad_value(817), 0.5, s.ad_value(816), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(738), 1.0, A::sub(s.ad_value(817), s.ad_value(816)), A::sub(s.ad_value(817), s.ad_value(816)), 1.0)), (-0.5), s.ad_value(736), 1.0));
            s.store_ad_value(1870, A::add_scaled_inputs4(s.ad_value(816), 1.0, s.ad_value(2297), (-0.5), A::sqrt(A::add_scaled_product(s.ad_value(737), 1.0, s.ad_value(2297), s.ad_value(2297), 1.0)), (-(-0.5)), s.ad_value(739), 1.0));
            s.copy_ad(2298, 1870);
            s.copy_ad(2294, 734);
            s.copy_ad(2295, 737);
            s.copy_ad(2296, 735);
        ...
        if (s.b[2453] && s.b[2454]) {
            s.store_ad_value(2301, A::add_scaled_inputs3(s.ad_value(818), 1.0, s.ad_value(2302), (-1.0), s.ad_value(701), -1.0));
            s.store_ad_value(2303, A::add_scaled_inputs3(s.ad_value(2298), 1.0, s.ad_value(815), 0.5, s.ad_value(819), (-0.5)));
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2456]) {
            ...
            s.store_offset_ad(1930, A::div_scaled_inputs(s.ad_value(2296), 0.5, A::sqrt(s.ad_value(2306)), 1.0), 1.0);
            s.store_add_scaled_product(1931, s.ad_value(2306), 1.0, s.ad_value(2296), A::sqrt(s.ad_value(2306)), 1.0);
            s.store_ad_value(2309, A::add_scaled_inputs_product(A::div_scaled_inputs2(s.ad_value(2308), 1.0, s.ad_value(1931), (-1.0), s.ad_value(1930), 1.0), 1.0, s.ad_value(2306), 0.5, A::offset(s.ad_value(189), 1.0), s.ad_value(2307), (-1.0)));
            s.store_offset_scaled(2310, 2306, 0.5, 2.0);
            s.store_add(2311, 2306, 2307);
            s.store_ad_value(1930, A::sub_scaled_inputs(A::add_scaled_inputs_product(s.ad_value(2308), 1.0, s.ad_value(2311), (-1.0), s.ad_value(2296), A::sqrt(s.ad_value(2311)), (-1.0)), 1.0, A::ln(A::add(A::div(s.ad_value(2306), s.ad_value(2296)), A::sqrt(s.ad_value(2306)))), 2.0));
            s.store_add_scaled_inputs(2312, 1930, 2.0, 2310, 1.0);
            s.store_ad_value(1930, A::add_scaled_inputs3(s.ad_value(2309), 0.5, s.ad_value(2312), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2309), s.ad_value(2312)), A::sub(s.ad_value(2309), s.ad_value(2312))), 20.0)), 0.5));
            s.store_ad_value(1931, A::add_scaled_inputs3(s.ad_value(2308), 2.0, s.ad_value(2307), (-2.0), s.ad_value(2310), -1.0));
            s.store_ad_value(2313, A::add_scaled_inputs3(s.ad_value(1930), 0.5, s.ad_value(1931), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(1930), s.ad_value(1931)), A::sub(s.ad_value(1930), s.ad_value(1931))), 20.0)), (-0.5)));
            s.store_ad_value(1930, A::add_scaled_inputs3(s.ad_value(2313), 0.5, s.ad_value(2310), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2313), s.ad_value(2310)), A::sub(s.ad_value(2313), s.ad_value(2310))), 5.0)), (-0.5)));
            s.store_ad_value(2314, A::add_scaled_inputs3(s.ad_value(1930), 0.5, s.ad_value(2310), ((-1.0) * 0.5), A::sqrt(A::offset(A::mul(A::sub_scaled_inputs(s.ad_value(1930), 1.0, s.ad_value(2310), -1.0), A::sub_scaled_inputs(s.ad_value(1930), 1.0, s.ad_value(2310), -1.0)), 20.0)), 0.5));
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2456]) && (!s.b[2457])) {
            s.store_div_from_scalar_offset_ad(2315, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1931), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1931), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if (s.b[2453] && s.b[2454]) {
            ...
            s.store_ad_value(2324, A::div_scaled_value_offset_denominator(s.ad_value(819), 2.0, A::sqrt(A::offset(A::mul(s.ad_value(195), s.ad_value(819)), 1.0)), 1.0, 1.0));
        ...
        if ((((s.b[2453] && s.b[2454]) && s.b[2458]) && (!s.b[2459])) && (!s.b[2460])) {
            s.store_div_from_scalar_offset_ad(2344, 1e-200, A::mul_offset_lhs(s.ad_value(2329), (-460.51701859880916), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2329), (-460.51701859880916), A::scale_offset(s.ad_value(2329), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        if ((s.b[2453] && s.b[2454]) && (!s.b[2458])) {
            s.store_offset_ad(2330, A::div_scaled_inputs(s.ad_value(2304), 0.5, A::sqrt(s.ad_value(2329)), 1.0), 1.0);
        }

        if (s.b[2453] && s.b[2454]) {
            s.store_ad_value(2331, A::add_scaled_value_products(s.ad_value(2329), 1.0, s.ad_value(2304), A::sqrt(s.ad_value(2329)), 1.0, s.ad_value(2330), A::ln(A::offset(s.ad_value(2330), (-1.0))), (-1.0)));
            s.store_ad_value(2332, A::div_scaled_inputs2(s.ad_value(2323), 1.0, s.ad_value(2331), (-1.0), s.ad_value(2330), 1.0));
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2461]) && (!s.b[2462])) {
            s.store_scaled_offset_ad(1929, A::mul_offset_lhs(A::sub(s.ad_value(2332), s.ad_value(2335)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2332), s.ad_value(2335)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2332), s.ad_value(2335)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2461]) {
            s.store_ad_value(1929, A::add_scaled_inputs3_offset(s.ad_value(2323), 0.5, s.ad_value(2337), ((-1.0) * 0.5), A::sqrt(A::offset(A::mul_offset_lhs(A::sub(s.ad_value(2323), s.ad_value(2337)), (-2.0), A::offset(A::sub(s.ad_value(2323), s.ad_value(2337)), (-2.0))), 1.0)), 0.5, (2.0 * 0.5)));
            ...
            s.store_add_scaled_product(2329, s.ad_value(2328), 1.0, s.ad_value(2339), s.ad_value(2327), (-1.0));
        }
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && s.b[2466]) {
            ...
            s.store_ad_value(2434, A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::offset(s.ad_value(2433), 1.0), 1.0));
            ...
            s.store_ad_value(812, A::add_scaled_square_product(s.ad_value(813), 1.0, s.ad_value(2436), A::sub_scaled_inputs(A::square(s.ad_value(2435)), 0.5, s.ad_value(2434), 1.0), 1.0));
        ...
        if ((((s.b[2453] && s.b[2454]) && (!s.b[2465])) && s.b[2466]) && (!s.b[2467])) {
            s.store_scaled_offset_ad(2438, A::mul_offset_lhs(s.ad_value(2437), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2437), (-230.25850929940458), A::scale_offset(s.ad_value(2437), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0, 1e100);
        }
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && s.b[2466]) {
            ...
            s.store_add_scaled_product(2443, s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs3_offset(s.ad_value(2438), 1.0, s.ad_value(2429), (-1.0), A::mul_sub_from_scalar_rhs(s.ad_value(2344), 1.0, s.ad_value(2441)), 1.0, (-1.0)), 1.0);
            s.store_ad_value(2444, A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(2438), 1.0, s.ad_value(2437), (-1.0), s.ad_value(2429), 1.0, (-1.0)), 1.0, s.ad_value(2344), A::sub(A::offset(s.ad_value(2437), (-1.0)), s.ad_value(2440)), 1.0), (-1.0)));
            ...
            s.store_ad_value(2428, A::add_scaled_square_product(s.ad_value(2443), 1.0, s.ad_value(2444), s.ad_value(2428), (-2.0)));
        ...
        if ((((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) && (!s.b[2468])) {
            s.store_div_from_scalar_offset_ad(2428, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), A::neg(s.ad_value(2447)), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), A::neg(s.ad_value(2447)), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }

        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            s.store_sub_from_scalar(2448, 1.0, 2428);
            s.store_ad_value(2449, A::add_scaled_inputs_product(s.ad_value(2323), 1.0, s.ad_value(2305), 0.5, s.ad_value(2304), A::sqrt(A::add_scaled_inputs3(s.ad_value(2323), 1.0, s.ad_value(2305), 0.25, s.ad_value(2448), -1.0)), (-1.0)));
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            let assign49760_ad_e64162: A = {
                if (1e-40 > ((s.v[2428] * s.v[2428]) - (s.v[2305] * (((s.v[2429] + s.v[2433]) - 1.0) - (s.v[2344] * ((s.v[2433] + 1.0) + s.v[2440])))))) {
                    ...
                    A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::add_scaled_product(A::offset(A::add(s.ad_value(2429), s.ad_value(2433)), (-1.0)), 1.0, s.ad_value(2344), A::add(A::offset(s.ad_value(2433), 1.0), s.ad_value(2440)), (-1.0)), (-1.0))
                }
            };
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            ...
            s.store_add_scaled_product(2435, s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_sub_value_product(1.0, s.ad_value(2429), 1.0, s.ad_value(2344), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0);
            s.store_ad_value(2436, A::add_scaled_inputs3(s.ad_value(2329), 1.0, s.ad_value(2433), (-1.0), A::ln(A::div(s.ad_value(2434), s.ad_value(2305))), 1.0));
            s.store_add(813, 2434, 2435);
            s.store_ad_value(812, A::add_scaled_square_product(s.ad_value(813), 1.0, s.ad_value(2436), A::add_scaled_square_product(s.ad_value(2435), 0.5, s.ad_value(2434), s.ad_value(2451), (-1.0)), 1.0));
        ...
        if (((((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) && (!s.b[2469])) && (!s.b[2470])) {
            s.store_div_from_scalar_offset_ad(2438, 1e-100, A::mul_offset_lhs(A::sub(s.ad_value(2329), s.ad_value(2452)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2329), s.ad_value(2452)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2329), s.ad_value(2452)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2439, 1e-100, A::mul_offset_lhs(s.ad_value(2452), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2452), (-230.25850929940458), A::scale_offset(s.ad_value(2452), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            ...
            s.store_add_scaled_product(2443, s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(2439)), 1.0, s.ad_value(2438), 1.0, s.ad_value(2344), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0);
            s.store_ad_value(2444, A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(2439), 1.0, s.ad_value(2452), 1.0, s.ad_value(2438), 1.0, (-1.0)), 1.0, s.ad_value(2344), A::add(A::offset(s.ad_value(2452), 1.0), s.ad_value(2440)), (-1.0)), (-1.0)));
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        if ((((s.b[2453] && s.b[2454]) && s.b[2471]) && (!s.b[2472])) && (!s.b[2473])) {
            s.store_div_from_scalar_offset_ad(2348, 1e-100, A::mul_offset_lhs(A::sub(s.ad_value(2329), s.ad_value(2343)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2329), s.ad_value(2343)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2329), s.ad_value(2343)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2349, 1e-100, A::mul_offset_lhs(s.ad_value(2343), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2343), (-230.25850929940458), A::scale_offset(s.ad_value(2343), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }

        if ((s.b[2453] && s.b[2454]) && s.b[2471]) {
            s.store_add_scaled_product(2350, s.ad_value(2348), 1.0, s.ad_value(2344), A::add(A::offset(s.ad_value(2343), 1.0), s.ad_value(2345)), (-1.0));
        }
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2471]) && s.b[2474]) {
            s.store_ad_value(2351, A::mul_sub_from_scalar_rhs_scaled_output(A::square(s.ad_value(2343)), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2343), 1.0, A::scale(s.ad_value(2343), 0.25), 0.3333333333333333), 0.5));
            ...
            s.store_offset_ad(2353, A::div_scaled_product(s.ad_value(2304), A::add_scaled_inputs(A::sub_from_scalar(1.0, A::scale(s.ad_value(2343), 0.5)), 1.0, A::square(s.ad_value(2343)), 0.16666666666666666), 0.7071067811865475, s.ad_value(1929), 1.0), 1.0);
        }
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2471]) {
            s.store_ad_value(2354, A::div_scaled_offset_numerator(A::mul_scaled_lhs(s.ad_value(709), 0.2, s.ad_value(2303)), 1.0, 1.0, A::offset(A::mul(s.ad_value(709), s.ad_value(2303)), 1.0), 1.0));
        }
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2471]) && s.b[2475]) {
            ...
            s.store_ad_value(2356, A::div_scaled_product3(s.ad_value(2305), s.ad_value(2350), s.ad_value(2319), 1.0, A::add_scaled_product(s.ad_value(2355), 1.0, s.ad_value(2304), s.ad_value(2352), 1.0), 1.0));
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2471]) && s.b[2475]) {
            ...
            s.store_add_scaled_product(2362, A::pow(A::mul(s.ad_value(2361), s.ad_value(705)), s.ad_value(706)), 1.0, s.ad_value(707), A::exp(A::mul_scaled_lhs(s.ad_value(708), 0.5, s.ad_value(1930))), 1.0);
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2482]) && s.b[2485]) {
            ...
            s.store_add_scaled_product(1929, s.ad_value(2356), 1.0, s.ad_value(2353), s.ad_value(2371), (-1.0));
            s.store_scaled_add_ad_rhs(2372, 1929, A::sqrt(A::offset(A::square(s.ad_value(1929)), 1e-12)), 0.5);
            s.store_ad_value(2373, A::add_scaled_value_products(s.ad_value(2356), (-1.0), s.ad_value(2319), s.ad_value(2355), 1.0, A::offset(s.ad_value(2353), (-1.0)), s.ad_value(2371), 1.0));
            s.store_offset_ad(2374, A::div_scaled_product(s.ad_value(2305), s.ad_value(2319), 0.5, s.ad_value(2373), 1.0), 1.0);
            s.store_add_scaled_product(1929, s.ad_value(2373), 1.0, s.ad_value(764), s.ad_value(2372), 1.0);
            ...
            s.store_mul_ad_lhs(1931, A::div_scaled_product(s.ad_value(708), A::add(A::offset(s.ad_value(2374), (-1.0)), A::div_scalar_offset_denominator(1.0, s.ad_value(1929), 1.0, 1.0)), 1.0, s.ad_value(2373), 1.0), 2376);
        }
    ...
    pub(super) fn stamp_transient_block_36(
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2482]) && s.b[2485]) {
            s.store_ad_value(2378, A::div_scaled_product3(s.ad_value(2371), s.ad_value(1931), s.ad_value(1930), -1.0, A::add_scaled_inputs3_offset(s.ad_value(2375), 1.0, s.ad_value(2376), 1.0, s.ad_value(2377), 1.0, 1.0), 1.0));
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2482]) {
            ...
            s.store_ad_value(1929, A::div_scaled_product3(s.ad_value(2383), A::sub_scaled_inputs(s.ad_value(2383), 1.0, s.ad_value(2369), 2.0), s.ad_value(2321), 1.0, s.ad_value(2350), 1.0));
        }
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_div_scaled_product(1930, A::sqrt(s.ad_value(1929)), s.ad_value(815), 1.0, s.ad_value(2384), 1.0);
            s.store_add_ad_lhs(1931, A::square(s.ad_value(1930)), 1929);
            s.store_scale(1929, 1930, 2.0);
            s.store_div_scaled_product(2385, s.ad_value(2384), s.ad_value(1929), 1.0, A::add(A::sqrt(A::sub(s.ad_value(1931), s.ad_value(1929))), A::sqrt(A::add(s.ad_value(1931), s.ad_value(1929)))), 1.0);
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2488])) {
            s.store_div_from_scalar_offset_ad(2388, 1e-200, A::mul_offset_lhs(s.ad_value(2386), (-460.51701859880916), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2386), (-460.51701859880916), A::scale_offset(s.ad_value(2386), 0.3333333333333333, (((((-460.51701859880916)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2489])) {
            let assign52090_ad_e66961: A = {
                if (1e-40 > ((s.v[2428] * s.v[2428]) - (s.v[2305] * (((s.v[2429] + s.v[2433]) - 1.0) - (s.v[2389] * ((s.v[2433] + 1.0) + s.v[2440])))))) {
                    ...
                    A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::add_scaled_product(A::offset(A::add(s.ad_value(2429), s.ad_value(2433)), (-1.0)), 1.0, s.ad_value(2389), A::add(A::offset(s.ad_value(2433), 1.0), s.ad_value(2440)), (-1.0)), (-1.0))
                }
            };
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2489])) {
            ...
            s.store_add_scaled_product(2435, s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_sub_value_product(1.0, s.ad_value(2429), 1.0, s.ad_value(2389), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0);
            s.store_ad_value(2436, A::add_scaled_inputs3(s.ad_value(2387), 1.0, s.ad_value(2433), (-1.0), A::ln(A::div(s.ad_value(2434), s.ad_value(2305))), 1.0));
            s.store_add(813, 2434, 2435);
            s.store_ad_value(812, A::add_scaled_square_product(s.ad_value(813), 1.0, s.ad_value(2436), A::add_scaled_square_product(s.ad_value(2435), 0.5, s.ad_value(2434), s.ad_value(2451), (-1.0)), 1.0));
            s.store_add_ad_rhs(2452, 2433, A::div_scaled_product3(s.ad_value(2434), s.ad_value(813), s.ad_value(2436), 1.0, A::add(s.ad_value(812), A::mul3(A::mul3(A::div(s.ad_value(813), s.ad_value(812)), s.ad_value(2436), s.ad_value(2436)), s.ad_value(2435), A::add_scaled_square_product(s.ad_value(2435), 0.3333333333333333, s.ad_value(2434), s.ad_value(2451), (-1.0)))), 1.0));
        }
        ...
        if ((((s.b[2453] && s.b[2481]) && (!s.b[2489])) && (!s.b[2490])) && (!s.b[2491])) {
            s.store_div_from_scalar_offset_ad(2438, 1e-100, A::mul_offset_lhs(A::sub(s.ad_value(2387), s.ad_value(2452)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2387), s.ad_value(2452)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2387), s.ad_value(2452)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(2439, 1e-100, A::mul_offset_lhs(s.ad_value(2452), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2452), (-230.25850929940458), A::scale_offset(s.ad_value(2452), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2489])) {
            ...
            s.store_mul_ad_product_lhs(2442, A::sub_scaled_inputs(s.ad_value(2428), 8.0, s.ad_value(2440), 12.0), s.ad_value(2428), 2428);
            s.store_sub(2428, 2323, 2452);
            s.store_add_scaled_product(2443, s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(2439)), 1.0, s.ad_value(2438), 1.0, s.ad_value(2389), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0);
            s.store_ad_value(2444, A::add_scaled_square_product(s.ad_value(2428), 1.0, s.ad_value(2305), A::add_scaled_product(A::add_scaled_inputs3_offset(s.ad_value(2439), 1.0, s.ad_value(2452), 1.0, s.ad_value(2438), 1.0, (-1.0)), 1.0, s.ad_value(2389), A::add(A::offset(s.ad_value(2452), 1.0), s.ad_value(2440)), (-1.0)), (-1.0)));
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2492]) {
            s.store_ad_value(2392, A::add_scaled_inputs_product(s.ad_value(2323), 2.0, s.ad_value(2343), (-2.0), s.ad_value(2305), A::add_scaled_offset_product_rhs(A::add_scaled_sub_value_product(1.0, s.ad_value(2349), 1.0, s.ad_value(2348), s.ad_value(2388), 1.0), 1.0, s.ad_value(2389), s.ad_value(2346), 1.0, (-1.0)), 1.0));
            ...
            s.store_ad_value(1929, A::add_scaled_square_product(s.ad_value(2392), 1.0, s.ad_value(1929), s.ad_value(2393), (-2.0)));
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_ad_value(2395, A::div_scaled_product_offset_denominator(s.ad_value(2390), s.ad_value(2390), 1.0, A::square(s.ad_value(2390)), 2.0, 1.0));
        }
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2493]) && s.b[2494]) {
            s.store_ad_value(2397, A::mul_sub_from_scalar_rhs_scaled_output(A::square(s.ad_value(2390)), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2390), 1.0, A::scale(s.ad_value(2390), 0.25), 0.3333333333333333), 0.5));
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2493]) && (!s.b[2494])) {
            ...
            s.store_mul_ad_rhs(2399, 2389, A::add_scaled_inputs3_offset(A::div_from_scalar(1.0, s.ad_value(2396)), 1.0, s.ad_value(2390), (-1.0), s.ad_value(2395), -1.0, (-1.0)));
        }
        ...
        if (((s.b[2453] && s.b[2481]) && (!s.b[2493])) && s.b[2495]) {
            ...
            s.store_add_scaled_product(2399, s.ad_value(1929), 1.0, s.ad_value(2389), A::add(A::offset(s.ad_value(2390), 1.0), s.ad_value(2395)), (-1.0));
        }

        if (((s.b[2453] && s.b[2481]) && (!s.b[2493])) && (!s.b[2495])) {
            s.store_div_from_scalar_offset_ad(2396, 1e-100, A::mul_offset_lhs(s.ad_value(2390), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2390), (-230.25850929940458), A::scale_offset(s.ad_value(2390), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_div_from_scalar_offset_ad(1929, 1e-100, A::mul_offset_lhs(A::sub(s.ad_value(2387), s.ad_value(2390)), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(A::sub(s.ad_value(2387), s.ad_value(2390)), (-230.25850929940458), A::scale_offset(A::sub(s.ad_value(2387), s.ad_value(2390)), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
            s.store_add_scaled_product(2399, s.ad_value(1929), 1.0, s.ad_value(2389), A::add(A::offset(s.ad_value(2390), 1.0), s.ad_value(2395)), (-1.0));
        }
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_add_scaled_product(2404, s.ad_value(2403), 1.0, A::square(s.ad_value(2391)), A::sub_scaled_inputs(s.ad_value(2402), 1.0, s.ad_value(2321), 2.0), 0.125);
        }
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2497]) {
            s.store_ad_value(2405, A::mul_sub_from_scalar_rhs_scaled_output(A::square(s.ad_value(2401)), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2401), 1.0, A::scale(s.ad_value(2401), 0.25), 0.3333333333333333), 0.5));
        ...
        if (((s.b[2453] && s.b[2481]) && (!s.b[2497])) && s.b[2499]) {
            s.store_ad_value(2410, A::add_scaled_sub_value_product(1.0, s.ad_value(2402), 1.0, s.ad_value(2406), s.ad_value(2321), 2.0));
            s.store_div_from_scalar_sqrt_ad(2407, 1.0, A::offset(A::mul(s.ad_value(719), s.ad_value(2406)), 1.0));
            s.store_ad_value(1929, A::div_scaled_value_offset_denominator(s.ad_value(2407), 1.0, s.ad_value(2407), 1.0, 1.0));
            s.store_mul_ad_rhs(2411, 719, A::mul3(A::square(s.ad_value(1929)), s.ad_value(2305), s.ad_value(2404)));
            s.store_ad_value(2412, A::add_scaled_inputs_product(s.ad_value(2406), 2.0, s.ad_value(2411), (-2.0), s.ad_value(2305), A::add(A::sub_from_scalar(1.0, s.ad_value(2402)), s.ad_value(2404)), 1.0));
            ...
            s.store_div_scaled_product(2415, s.ad_value(2413), s.ad_value(2412), 1.0, A::add_scaled_square_product(s.ad_value(2412), 1.0, s.ad_value(2414), s.ad_value(2413), (-1.0)), 1.0);
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        if (((s.b[2453] && s.b[2481]) && (!s.b[2497])) && s.b[2499]) {
            ...
            s.store_ad_value(2391, A::div_scaled_product3(s.ad_value(2391), s.ad_value(2416), A::add(s.ad_value(2410), s.ad_value(2403)), 1.0, A::add_scaled_product(s.ad_value(2417), 1.0, s.ad_value(2416), s.ad_value(2403), 1.0), 1.0));
            s.store_mul(2394, 2391, 2319);
        }

        if ((s.b[2453] && s.b[2481]) && (!s.b[2497])) {
            s.store_sqrt(2408, 2405);
            s.store_ad_value(2409, A::add_scaled_inputs(s.ad_value(2407), 1.0, A::div(A::mul_sub_from_scalar_rhs(s.ad_value(2304), 1.0, s.ad_value(2402)), s.ad_value(2408)), 0.5));
        }

        if (s.b[2453] && s.b[2481]) {
            s.store_mul_ad_rhs(2418, 2319, A::div_scaled_product(s.ad_value(2305), s.ad_value(2404), 1.0, A::add_scaled_product(s.ad_value(2406), 1.0, s.ad_value(2304), s.ad_value(2408), 1.0), 1.0));
            s.store_add_scaled_product(2419, s.ad_value(2418), 1.0, s.ad_value(2319), s.ad_value(2409), 1.0);
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_add_scaled_product(2421, s.ad_value(2420), 1.0, s.ad_value(764), s.ad_value(2418), 1.0);
            s.store_add_scaled_product(2422, s.ad_value(2420), 1.0, s.ad_value(765), s.ad_value(2418), 1.0);
            ...
            s.store_add_scaled_product(2362, A::pow(A::mul(s.ad_value(2423), s.ad_value(705)), s.ad_value(706)), 1.0, s.ad_value(707), A::exp(A::mul_scaled_lhs(s.ad_value(708), 0.5, s.ad_value(1930))), 1.0);
        ...
        if s.b[2502] {
            s.store_ad_value(1888, A::div_scaled_value_offset_denominator(s.ad_value(253), 1.0, A::mul(s.ad_value(762), A::powf(A::add(A::square(s.ad_value(1883)), s.ad_value(722)), ((-1.0) * 0.16666666666666666))), 1.0, 1.0));
        }
        ...
        if s.b[2503] {
            s.store_mul_ad_lhs(2260, A::div_scaled_product(A::add(s.ad_value(258), A::div(s.ad_value(259), s.ad_value(1882))), s.ad_value(1881), 1.0, s.ad_value(1882), 1.0), 1885);
        }
        ...
        if (s.b[2503] && s.b[2505]) {
            s.store_ad_value(2261, A::div_scaled_value_offset_denominator(s.ad_value(2261), 1.0, A::mul(s.ad_value(1891), s.ad_value(1877)), 1.0, 1.0));
        }
        ...
        if s.b[2503] {
            ...
            s.store_div_scaled_product(1893, s.ad_value(1929), s.ad_value(1882), 1.0, s.ad_value(2262), 1.0);
        ...
        if s.b[2503] {
            s.store_add_scaled_product(2268, s.ad_value(2266), 1.0, s.ad_value(1889), A::add_scaled_product(s.ad_value(1881), 1.0, s.ad_value(1929), s.ad_value(2263), 1.0), 1.0);
        ...
        if (s.b[2507] && s.b[2508]) {
            s.store_ad_value(2270, A::add_scaled_inputs3(s.ad_value(1871), 1.0, s.ad_value(268), (-1.0), s.ad_value(797), 1.0));
            s.store_ad_value(1929, A::add_scaled_inputs3(s.ad_value(2270), 0.5, s.ad_value(797), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(798), 1.0, A::sub(s.ad_value(2270), s.ad_value(797)), A::sub(s.ad_value(2270), s.ad_value(797)), 1.0)), 0.5));
            s.store_mul_ad_rhs(1930, 1929, A::add_scaled_inputs3(s.ad_value(1929), 2.0, s.ad_value(797), (-1.0), s.ad_value(2270), -1.0));
            ...
            s.store_ad_value(2273, A::add_scaled_inputs3(A::div(A::sub_from_scalar(1.0, s.ad_value(2272)), s.ad_value(270)), 1.0, s.ad_value(2270), 1.0, s.ad_value(2271), -1.0));
        ...
        if (s.b[2507] && s.b[2509]) {
            s.store_add_scaled_product(1929, s.ad_value(734), 0.5, s.ad_value(1872), A::scale_offset(s.ad_value(1873), 0.7071067811865475, 1.0), 1.0);
        ...
        if (((s.b[2507] && s.b[2509]) && (!s.b[2510])) && s.b[2511]) {
            s.store_div_from_scalar_offset_ad(2276, 1e-100, A::mul_offset_lhs(s.ad_value(2275), (-230.25850929940458), A::offset(A::mul_offset_lhs_scaled_output(s.ad_value(2275), (-230.25850929940458), A::scale_offset(s.ad_value(2275), 0.3333333333333333, (((((-230.25850929940458)) * (0.3333333333333333))) + (1.0))), 0.5), 1.0)), 1.0);
        }
        ...
        if s.b[2507] {
            s.store_add_scaled_product(2278, s.ad_value(2274), 1.0, s.ad_value(269), A::sub(s.ad_value(2276), s.ad_value(2274)), 1.0);
            s.store_add_scaled_product(2279, s.ad_value(2273), 1.0, s.ad_value(269), A::sub(s.ad_value(2277), s.ad_value(2273)), 1.0);
            s.store_ad_value(2280, A::add_scaled_inputs3(A::add_scaled_product(s.ad_value(1871), 1.0, s.ad_value(1872), s.ad_value(1875), (-1.0)), 1.0, s.ad_value(1887), (-1.0), s.ad_value(1877), (-0.5)));
            s.store_ad_value(2281, A::add_scaled_inputs3(s.ad_value(1871), 1.0, s.ad_value(2280), (-1.0), s.ad_value(1876), -1.0));
            s.store_ad_value(2282, A::add_scaled_inputs3(s.ad_value(1877), 1.0, s.ad_value(2280), 1.0, s.ad_value(815), -1.0));
            s.store_ad_value(2283, A::add_scaled_inputs3(s.ad_value(1871), 1.0, s.ad_value(2282), (-1.0), s.ad_value(1878), -1.0));
        }
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        if s.b[2507] {
            ...
            s.store_ad_value(841, A::add_scaled_inputs4(s.ad_value(841), 1.0, s.ad_value(2284), (-1.0), s.ad_value(2286), -1.0, s.ad_value(2285), -1.0));
        }
        ...
        if ((s.b[2514] && s.b[2515]) && (!s.b[2516])) {
            s.store_div_from_scalar_offset_ad(2287, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1929), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1929), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if ((s.b[2514] && s.b[2515]) && (!s.b[2517])) {
            s.copy_ad(2288, 2287);
            s.store_ad_value(1930, A::div_scaled_value_offset_denominator(s.ad_value(2288), 2.0, s.ad_value(2288), 2.0, 1.0));
        }
        ...
        if ((s.b[2518] && s.b[2519]) && (!s.b[2520])) {
            s.store_div_from_scalar_offset_ad(2290, 1e-100, A::mul_sub_from_scalar_lhs((-230.25850929940458), s.ad_value(1929), A::offset(A::mul_sub_from_scalar_scaled_offset_self((-230.25850929940458), s.ad_value(1929), 0.3333333333333333, 1.0, 0.5), 1.0)), 1.0);
        }
        ...
        if ((s.b[2518] && s.b[2519]) && (!s.b[2521])) {
            s.copy_ad(2291, 2290);
            s.store_ad_value(1930, A::div_scaled_value_offset_denominator(s.ad_value(2291), 2.0, s.ad_value(2291), 2.0, 1.0));
        }
        ...
        s.store_add_scaled_product(845, s.ad_value(2293), 1.0, s.ad_value(265), s.ad_value(818), 1.0);
        ...
        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    A::div_scalar_offset_denominator(1e-100, A::sub_from_scalar((-230.25850929940458), s.ad_value(497)), 1.0, 1.0)
                } else {
                    {
                        if (s.v[497] > s.v[661]) {
                            A::mul_offset_rhs(s.ad_value(662), A::sub(s.ad_value(497), s.ad_value(661)), 1.0)
                        } else {
        ...
        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    ...
                    {
                        if (s.v[497] > s.v[663]) {
                            A::mul_offset_rhs(s.ad_value(664), A::sub(s.ad_value(497), s.ad_value(663)), 1.0)
                        } else {
                            A::exp(s.ad_value(497))
                        }
                    }
        ...
        if ((s.b[2569] && s.b[2570]) && s.b[2571]) {
            s.store_mul_ad_rhs(505, 821, A::add_scaled_product(s.ad_value(672), 1.0, s.ad_value(821), s.ad_value(673), 1.0));
        }
        ...
        if ((s.b[2569] && s.b[2570]) && (!s.b[2571])) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    ...
                    {
                        if (s.v[497] > s.v[665]) {
                            A::mul_offset_rhs(s.ad_value(666), A::sub(s.ad_value(497), s.ad_value(665)), 1.0)
                        } else {
                            A::exp(s.ad_value(497))
                        }
                    }
        ...
        if ((s.b[2569] && s.b[2570]) && (!s.b[2571])) {
            s.store_mul_scaled_ad_rhs(505, 672, -1.0, A::offset(s.ad_value(498), (-1.0)));
        }

        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(837, A::add_scaled_inputs3(s.ad_value(503), 1.0, s.ad_value(504), 1.0, s.ad_value(505), 1.0));
        ...
        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    ...
                    {
                        if (s.v[497] > s.v[688]) {
                            A::mul_offset_rhs(s.ad_value(689), A::sub(s.ad_value(497), s.ad_value(688)), 1.0)
                        } else {
                            A::exp(s.ad_value(497))
                        }
                    }
        ...
        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    ...
                    {
                        if (s.v[497] > s.v[690]) {
                            A::mul_offset_rhs(s.ad_value(691), A::sub(s.ad_value(497), s.ad_value(690)), 1.0)
                        } else {
                            A::exp(s.ad_value(497))
                        }
                    }
        ...
        if ((s.b[2569] && s.b[2570]) && s.b[2572]) {
            s.store_mul_ad_rhs(505, 822, A::add_scaled_product(s.ad_value(699), 1.0, s.ad_value(822), s.ad_value(700), 1.0));
        }
        ...
        if ((s.b[2569] && s.b[2570]) && (!s.b[2572])) {
            s.store_ad_value(498, {
                if (s.v[497] < (-230.25850929940458)) {
                    ...
                    {
                        if (s.v[497] > s.v[692]) {
                            A::mul_offset_rhs(s.ad_value(693), A::sub(s.ad_value(497), s.ad_value(692)), 1.0)
                        } else {
                            A::exp(s.ad_value(497))
                        }
                    }
        ...
        if ((s.b[2569] && s.b[2570]) && (!s.b[2572])) {
            s.store_mul_scaled_ad_rhs(505, 699, -1.0, A::offset(s.ad_value(498), (-1.0)));
        }

        if (s.b[2569] && s.b[2570]) {
            s.store_ad_value(838, A::add_scaled_inputs3(s.ad_value(503), 1.0, s.ad_value(504), 1.0, s.ad_value(505), 1.0));
            ...
            s.store_div_scaled_product(2574, s.ad_value(821), s.ad_value(659), 2.0, A::add(s.ad_value(2528), s.ad_value(2530)), 1.0);
        }
        ...
        if ((s.b[2569] && s.b[2570]) && s.b[2575]) {
            s.store_ad_value(1902, A::add_scaled_inputs3_offset(s.ad_value(2573), (-s.v[418]), s.ad_value(821), s.v[421], s.ad_value(2574), (-s.v[421]), s.v[418]));
        }
    ...
    pub(super) fn stamp_transient_block_39(
        ...
        if ((s.b[2569] && s.b[2570]) && s.b[2577]) {
            s.store_ad_value(1903, A::add_scaled_inputs3_offset(s.ad_value(2573), (-s.v[419]), s.ad_value(821), s.v[422], s.ad_value(2574), (-s.v[422]), s.v[419]));
        }
        ...
        if ((s.b[2569] && s.b[2570]) && s.b[2579]) {
            s.store_ad_value(1904, A::add_scaled_inputs3_offset(s.ad_value(2573), (-s.v[420]), s.ad_value(821), s.v[423], s.ad_value(2574), (-s.v[423]), s.v[420]));
        }
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2595])) {
            ...
            s.store_ad_value(2548, A::mul_offset_lhs_scaled_output(s.ad_value(2534), (-1.0), s.ad_value(2547), s.v[385]));
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2598])) {
            s.store_div_scaled_product(2557, s.ad_value(2546), s.ad_value(2556), 1.0, A::add(s.ad_value(2546), s.ad_value(2556)), 1.0);
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2598])) {
            s.store_scaled_div(2563, 2562, 2558, (s.v[436] * (1.772453850905516 * 0.5)));
    ...
    pub(super) fn stamp_transient_block_40(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2612])) && (!s.b[2613])) {
            ...
            s.store_ad_value(2548, A::mul_offset_lhs_scaled_output(s.ad_value(2534), (-1.0), s.ad_value(2547), s.v[386]));
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2612])) && (!s.b[2616])) {
            s.store_scaled_div(2563, 2562, 2558, (s.v[437] * (1.772453850905516 * 0.5)));
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2630])) && (!s.b[2631])) {
            ...
            s.store_ad_value(2548, A::mul_offset_lhs_scaled_output(s.ad_value(2534), (-1.0), s.ad_value(2547), s.v[387]));
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2630])) && (!s.b[2634])) {
            s.store_scaled_div(2563, 2562, 2558, (s.v[438] * (1.772453850905516 * 0.5)));
        }
    ...
    pub(super) fn stamp_transient_block_41(
        ...
        if (s.b[2569] && (!s.b[2570])) {
            s.store_ad_value(837, A::add_scaled_products3(s.ad_value(647), s.ad_value(1896), 1.0, s.ad_value(648), s.ad_value(1897), 1.0, s.ad_value(649), s.ad_value(1898), 1.0));
        }
        ...
        if ((s.b[2569] && (!s.b[2570])) && s.b[2651]) {
            ...
            s.store_ad_value(620, A::div_scaled_value_offset_denominator(s.ad_value(620), 1.0, A::div(s.ad_value(644), s.ad_value(543)), 1.0, 1.0));
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) && (!s.b[2659])) && (!s.b[2660])) {
            s.store_ad_value(2545, A::mul_sub_from_scalar_rhs(A::add(A::div_scaled_product(A::square(s.ad_value(2544)), A::ln(s.ad_value(2544)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2544)), 1.0), s.ad_value(2544)), 1.0, A::scale(s.ad_value(512), 2.0)));
        }
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) && (!s.b[2662])) {
            s.store_div_scaled_product(2563, s.ad_value(603), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0);
            s.store_mul_ad_rhs(2549, 526, A::mul3(s.ad_value(2548), s.ad_value(2563), s.ad_value(2557)));
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) && (!s.b[2672])) && (!s.b[2673])) {
            s.store_add_scaled_product(2566, s.ad_value(612), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(541), s.v[445]), s.ad_value(618), 1.0);
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) && (!s.b[2677])) && (!s.b[2678])) {
            s.store_ad_value(2545, A::mul_sub_from_scalar_rhs(A::add(A::div_scaled_product(A::square(s.ad_value(2544)), A::ln(s.ad_value(2544)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2544)), 1.0), s.ad_value(2544)), 1.0, A::scale(s.ad_value(513), 2.0)));
        }
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) && (!s.b[2680])) {
            s.store_div_scaled_product(2563, s.ad_value(604), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0);
            s.store_mul_ad_rhs(2549, 527, A::mul3(s.ad_value(2548), s.ad_value(2563), s.ad_value(2557)));
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) && (!s.b[2690])) && (!s.b[2691])) {
            s.store_add_scaled_product(2566, s.ad_value(613), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(542), s.v[445]), s.ad_value(619), 1.0);
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) && (!s.b[2695])) && (!s.b[2696])) {
            s.store_ad_value(2545, A::mul_sub_from_scalar_rhs(A::add(A::div_scaled_product(A::square(s.ad_value(2544)), A::ln(s.ad_value(2544)), 1.0, A::sub_from_scalar(1.0, s.ad_value(2544)), 1.0), s.ad_value(2544)), 1.0, A::scale(s.ad_value(514), 2.0)));
        }
    ...
    pub(super) fn stamp_transient_block_43(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) && (!s.b[2698])) {
            s.store_div_scaled_product(2563, s.ad_value(605), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0);
            s.store_mul_ad_rhs(2549, 528, A::mul3(s.ad_value(2548), s.ad_value(2563), s.ad_value(2557)));
        }
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) && (!s.b[2708])) && (!s.b[2709])) {
            s.store_add_scaled_product(2566, s.ad_value(614), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(642), s.v[445]), s.ad_value(620), 1.0);
        }
        ...
        if (s.b[2569] && (!s.b[2570])) {
            s.store_ad_value(838, A::add_scaled_products3(s.ad_value(674), s.ad_value(1899), 1.0, s.ad_value(675), s.ad_value(1900), 1.0, s.ad_value(676), s.ad_value(1901), 1.0));
        }
        ...
        if s.b[2727] {
            s.store_ad_value(1915, A::add_scaled_inputs3(A::add_scaled_products(A::add(s.ad_value(827), s.ad_value(835)), s.ad_value(815), 1.0, s.ad_value(836), A::add(s.ad_value(815), s.ad_value(816)), 1.0), 1.0, s.ad_value(2723), 1.0, s.ad_value(2724), 1.0));
        }
        ...
        if (s.b[2762] && s.b[2763]) {
            s.store_mul3_lhs(2730, 760, 1848, 1916);
            s.store_mul(2731, 760, 1850);
            s.store_mul3_lhs(2732, 760, 1848, 1844);
            s.store_mul_ad(853, A::add_scaled_value_products(s.ad_value(276), 1.0, s.ad_value(277), s.ad_value(2730), (-1.0), s.ad_value(278), A::square(s.ad_value(2730)), 1.0), A::ln(A::div_scaled_inputs2(s.ad_value(2731), 1.0, s.ad_value(2732), 0.5, A::sub_scaled_inputs(s.ad_value(2731), 1.0, s.ad_value(2732), 0.5), 1.0)));
            s.store_add_scaled_product(853, s.ad_value(853), 1.0, A::add_scaled_product(s.ad_value(277), 1.0, s.ad_value(278), A::sub_scaled_inputs(s.ad_value(2731), 1.0, s.ad_value(2730), 2.0), 1.0), s.ad_value(2732), 1.0);
            s.store_div_scaled_product(853, A::mul3(s.ad_value(1923), s.ad_value(827), s.ad_value(1860)), s.ad_value(853), 1.0, s.ad_value(2730), 1.0);
        }
        ...
        if (s.b[2762] && s.b[2764]) {
            s.store_ad_value(2738, {
                if ((1.0 - (12.0 * (s.v[2737] * s.v[2736]))) > 1e-20) {
                    A::sub_from_scalar(1.0, A::mul_scaled_output(s.ad_value(2737), s.ad_value(2736), 12.0))
                } else {
                    A::constant(1e-20)
                }
            });
    ...
    pub(super) fn stamp_transient_block_44(
        ...
        if (s.b[2762] && s.b[2764]) {
            s.store_ad_value(2741, A::add_scaled_inputs3(s.ad_value(2734), 1.0, s.ad_value(2736), 12.0, A::mul3_scaled_output(A::offset(s.ad_value(2734), 1.0), s.ad_value(2736), s.ad_value(2737), 24.0), -1.0));
        }

        if (s.b[2762] && s.b[2764]) {
            s.store_ad_value(2741, {
                if (s.v[2741] > 1e-40) {
                    s.ad_value(2741)
                } else {
                    A::constant(1e-40)
        ...
        if (((s.b[2762] && s.b[2764]) && s.b[2765]) && s.b[2766]) {
            s.store_ad_value(2743, A::div_scaled_value_offset_denominator(s.ad_value(2743), 1.0, A::mul(s.ad_value(2742), s.ad_value(1844)), 1.0, 1.0));
        }

        if ((s.b[2762] && s.b[2764]) && s.b[2765]) {
            s.store_ad_value(2744, A::mul_offset_rhs_scaled_output(s.ad_value(1853), A::sqrt(A::scale_offset(s.ad_value(2743), 2.0, 1.0)), 1.0, 0.5));
        ...
        if ((s.b[2762] && s.b[2767]) && (!s.b[2769])) {
            s.store_div_scaled_product(852, s.ad_value(2747), s.ad_value(2748), 1.0, s.ad_value(851), 1.0);
        }

        if (s.b[2762] && s.b[2767]) {
            s.store_ad_value(852, {
                if (s.v[852] > 0.0) {
                    {
                        if (s.v[852] < 1.0) {
                            s.ad_value(852)
        ...
        if (s.b[2762] && s.b[2767]) {
            s.store_div_scaled_product(850, s.ad_value(852), s.ad_value(851), 1.0, s.ad_value(2748), 1.0);
        }

        s.store_scaled_abs(1908, 830, (2.0 * 1.6021918e-19));

        s.store_scaled_abs(1909, 831, (2.0 * 1.6021918e-19));

        s.store_scaled_abs(1910, 828, (2.0 * 1.6021918e-19));

        s.store_scaled_abs(1911, 829, (2.0 * 1.6021918e-19));

        s.store_ad_value(1912, A::mul_offset_lhs_scaled_output(s.ad_value(1869), 1.0, A::abs(s.ad_value(836)), (2.0 * 1.6021918e-19)));

        s.store_scaled_abs(1913, 837, (2.0 * 1.6021918e-19));

        s.store_scaled_abs(1914, 838, (2.0 * 1.6021918e-19));

        s.b[2770] = (s.v[820] > 0.0);
        ...
        if s.b[2771] {
            ...
            s.store_mul_add_rhs(2751, 1930, 1866, 2749);
            s.store_mul_ad_lhs(2752, A::mul3_scaled_output(s.ad_value(1930), s.ad_value(2749), s.ad_value(1868), -1.0), 1865);
            s.store_mul_ad(858, A::add_scaled_product(s.ad_value(294), 1.0, A::add_scaled_product(s.ad_value(295), 1.0, s.ad_value(296), s.ad_value(2750), (-1.0)), s.ad_value(2750), (-1.0)), A::ln(A::div_scaled_inputs2(s.ad_value(2751), 1.0, s.ad_value(2752), 0.5, A::sub_scaled_inputs(s.ad_value(2751), 1.0, s.ad_value(2752), 0.5), 1.0)));
            s.store_add_scaled_product(858, s.ad_value(858), 1.0, A::add_scaled_product(s.ad_value(295), 1.0, s.ad_value(296), A::sub_scaled_inputs(s.ad_value(2751), 1.0, s.ad_value(2750), 2.0), 1.0), s.ad_value(2752), 1.0);
            s.store_div_scaled_product(858, A::mul3(s.ad_value(1927), s.ad_value(835), s.ad_value(1860)), s.ad_value(858), 1.0, s.ad_value(2750), 1.0);
        }
        ...
        if s.b[2771] {
            s.store_div_scaled_product(2753, s.ad_value(1916), A::add(s.ad_value(1866), s.ad_value(2749)), 1.0, s.ad_value(2749), 1.0);
        ...
        s.b[2772] = (s.v[1930] > 1e-10);
        s.v[2772] = if s.b[2772] { 1.0 } else { 0.0 };

        if (s.b[2771] && s.b[2772]) {
            s.store_offset_ad(2757, A::div_scaled_product(s.ad_value(2749), s.ad_value(2753), 1.0, s.ad_value(1930), 1.0), (-1.0));
        }

        if s.b[2771] {
            s.store_ad_value(2758, {
                if ((1.0 - (12.0 * (s.v[2757] * s.v[2756]))) > 1e-20) {
                    A::sub_from_scalar(1.0, A::mul_scaled_output(s.ad_value(2757), s.ad_value(2756), 12.0))
                } else {
                    A::constant(1e-20)
                }
            });
        ...
        if s.b[2771] {
            s.store_div_from_scalar_square_ad(2759, 1.0, s.ad_value(2758));
            s.store_mul_ad_lhs(2760, A::mul3(s.ad_value(1918), s.ad_value(1916), A::add(s.ad_value(1866), s.ad_value(2749))), 1860);
            s.store_ad_value(2761, A::add_scaled_inputs3(s.ad_value(2754), 1.0, s.ad_value(2756), 12.0, A::mul3_scaled_output(A::offset(s.ad_value(2754), 1.0), s.ad_value(2756), s.ad_value(2757), 24.0), -1.0));
        }

        if s.b[2771] {
            s.store_ad_value(2761, {
                if (s.v[2761] > 1e-40) {
                    s.ad_value(2761)
                } else {
                    A::constant(1e-40)
        ...
        if s.b[2771] {
            s.store_mul3_lhs(2761, 2760, 2759, 2761);
            s.store_sqrt_mul(859, 1928, 2761);
        }
