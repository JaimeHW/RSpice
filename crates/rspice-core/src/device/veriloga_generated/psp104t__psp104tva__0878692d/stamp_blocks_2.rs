...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if ((s.b[2218] && s.b[2227]) && s.b[2228]) {
            ...
            s.store_ad_value(1930, A::div_scaled_product(A::sqrt(s.ad_value(1929)), s.ad_value(815), 1.0, s.ad_value(1839), 1.0));
        ...
        if (s.b[2218] && s.b[2227]) {
            s.store_ad_value(1956, A::add_scaled_product(s.ad_value(1846), 1.0, A::add_scaled_inputs3(s.ad_value(1955), 1.0, s.ad_value(731), (-1.0), s.ad_value(1952), -1.0), s.ad_value(1809), 1.0));
        }
        ...
        if (s.b[2218] && s.b[2227]) {
            s.store_mul_ad_product_rhs(1959, 234, s.ad_value(1947), A::ln(A::div(A::offset(s.ad_value(1957), 1.0), A::offset(s.ad_value(1958), 1.0))));
        }
        ...
        if (((s.b[2218] && s.b[2227]) && (!s.b[2237])) && s.b[2238]) {
            ...
            s.store_ad_value(1967, A::add_scaled_product(s.ad_value(1966), 0.5, s.ad_value(1961), A::offset(A::mul(s.ad_value(1965), A::add_scaled_product(A::scaled_offset(s.ad_value(1963), 0.25, 0.4), 1.0, s.ad_value(1965), A::offset(s.ad_value(1963), 0.125), 0.0285714285714)), 1.0), (-0.16666666666666666)));
        }
        ...
        if s.b[2246] {
            s.store_add_ad_lhs(1929, A::add_scaled_inputs3(s.ad_value(817), 0.5, s.ad_value(816), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(753), 1.0, A::sub(s.ad_value(817), s.ad_value(816)), A::sub(s.ad_value(817), s.ad_value(816)), 1.0)), (-0.5)), 751);
            s.store_add_ad_lhs(1975, A::add_scaled_inputs3(s.ad_value(816), 1.0, s.ad_value(1929), (-0.5), A::sqrt(A::add_scaled_product(s.ad_value(752), 1.0, s.ad_value(1929), s.ad_value(1929), 1.0)), (-(-0.5))), 755);
            ...
            s.store_ad_value(1980, A::div_scaled_inputs(s.ad_value(819), 2.0, A::offset(A::sqrt(A::offset(A::mul(s.ad_value(291), s.ad_value(819)), 1.0)), 1.0), 1.0));
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2455]) {
            s.store_add_ad_lhs(2297, A::add_scaled_inputs3(s.ad_value(817), 0.5, s.ad_value(816), 0.5, A::sqrt(A::add_scaled_product(s.ad_value(738), 1.0, A::sub(s.ad_value(817), s.ad_value(816)), A::sub(s.ad_value(817), s.ad_value(816)), 1.0)), (-0.5)), 736);
            s.store_add_ad_lhs(1870, A::add_scaled_inputs3(s.ad_value(816), 1.0, s.ad_value(2297), (-0.5), A::sqrt(A::add_scaled_product(s.ad_value(737), 1.0, s.ad_value(2297), s.ad_value(2297), 1.0)), (-(-0.5))), 739);
            s.copy_ad(2298, 1870);
            s.copy_ad(2294, 734);
            s.copy_ad(2295, 737);
            s.copy_ad(2296, 735);
        ...
        if ((s.b[2453] && s.b[2454]) && s.b[2456]) {
            ...
            s.store_ad_value(2309, A::add_scaled_inputs_product(A::div(A::sub(s.ad_value(2308), s.ad_value(1931)), s.ad_value(1930)), 1.0, s.ad_value(2306), 0.5, A::offset(s.ad_value(189), 1.0), s.ad_value(2307), (-1.0)));
        ...
        if (s.b[2453] && s.b[2454]) {
            ...
            s.store_ad_value(2324, A::div_scaled_inputs(s.ad_value(819), 2.0, A::offset(A::sqrt(A::offset(A::mul(s.ad_value(195), s.ad_value(819)), 1.0)), 1.0), 1.0));
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && s.b[2466]) {
            ...
            s.store_ad_value(2443, A::add_scaled_product(s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs3_offset(s.ad_value(2438), 1.0, s.ad_value(2429), (-1.0), A::mul_sub_from_scalar_rhs(s.ad_value(2344), 1.0, s.ad_value(2441)), 1.0, (-1.0)), 1.0));
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            ...
            s.store_ad_value(2433, A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(2449), 0.5, s.ad_value(2450), 0.5, A::sqrt(A::offset(A::mul(A::sub(s.ad_value(2449), s.ad_value(2450)), A::sub(s.ad_value(2449), s.ad_value(2450))), 5.0)), (-0.5)), 1.0, s.ad_value(2450), (-0.5), A::sqrt(A::offset(A::square(s.ad_value(2450)), 5.0)), (-(-0.5))));
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            ...
            s.store_ad_value(2435, A::add_scaled_product(s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_sub_value_product(1.0, s.ad_value(2429), 1.0, s.ad_value(2344), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0));
        ...
        if (((s.b[2453] && s.b[2454]) && (!s.b[2465])) && (!s.b[2466])) {
            ...
            s.store_ad_value(2443, A::add_scaled_product(s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(2439)), 1.0, s.ad_value(2438), 1.0, s.ad_value(2344), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0));
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2482]) && s.b[2485]) {
            ...
            s.store_mul_ad_lhs(1930, A::div_scaled_product(s.ad_value(706), A::offset(A::mul_sub_from_scalar_rhs(s.ad_value(2374), 1.0, s.ad_value(764)), (-1.0)), 1.0, s.ad_value(1929), 1.0), 2375);
            s.store_div(1929, 2372, 2373);
            s.store_mul_pow_ad_rhs(2376, 707, A::offset(s.ad_value(1929), 1.0), A::neg(s.ad_value(708)));
            s.store_mul_ad_lhs(1931, A::div_scaled_product(s.ad_value(708), A::add(A::offset(s.ad_value(2374), (-1.0)), A::div_from_scalar(1.0, A::offset(s.ad_value(1929), 1.0))), 1.0, s.ad_value(2373), 1.0), 2376);
        }
    ...
    pub(super) fn stamp_transient_block_36(
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_ad_value(1930, A::div_scaled_product(A::sqrt(s.ad_value(1929)), s.ad_value(815), 1.0, s.ad_value(2384), 1.0));
            s.store_add_ad_lhs(1931, A::square(s.ad_value(1930)), 1929);
            s.store_scale(1929, 1930, 2.0);
            s.store_ad_value(2385, A::div_scaled_product(s.ad_value(2384), s.ad_value(1929), 1.0, A::add(A::sqrt(A::sub(s.ad_value(1931), s.ad_value(1929))), A::sqrt(A::add(s.ad_value(1931), s.ad_value(1929)))), 1.0));
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2489])) {
            ...
            s.store_ad_value(2435, A::add_scaled_product(s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_sub_value_product(1.0, s.ad_value(2429), 1.0, s.ad_value(2389), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0));
        ...
        if ((s.b[2453] && s.b[2481]) && (!s.b[2489])) {
            ...
            s.store_mul_ad_product_lhs(2442, A::sub_scaled_inputs(s.ad_value(2428), 8.0, s.ad_value(2440), 12.0), s.ad_value(2428), 2428);
            s.store_sub(2428, 2323, 2452);
            s.store_ad_value(2443, A::add_scaled_product(s.ad_value(2428), 2.0, s.ad_value(2305), A::add_scaled_inputs_product(A::sub_from_scalar(1.0, s.ad_value(2439)), 1.0, s.ad_value(2438), 1.0, s.ad_value(2389), A::offset(s.ad_value(2441), 1.0), (-1.0)), 1.0));
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2492]) {
            s.store_ad_value(2392, A::add_scaled_inputs_product(s.ad_value(2323), 2.0, s.ad_value(2343), (-2.0), s.ad_value(2305), A::add_scaled_product(A::add_scaled_sub_value_product(1.0, s.ad_value(2349), 1.0, s.ad_value(2348), s.ad_value(2388), 1.0), 1.0, s.ad_value(2389), A::offset(s.ad_value(2346), 1.0), (-1.0)), 1.0));
        ...
        if (s.b[2453] && s.b[2481]) {
            ...
            s.store_ad_value(2395, A::div_scaled_product(s.ad_value(2390), s.ad_value(2390), 1.0, A::offset(A::square(s.ad_value(2390)), 2.0), 1.0));
        }
        ...
        if (((s.b[2453] && s.b[2481]) && (!s.b[2497])) && s.b[2499]) {
            ...
            s.store_ad_value(2415, A::div_scaled_product(s.ad_value(2413), s.ad_value(2412), 1.0, A::add_scaled_square_product(s.ad_value(2412), 1.0, s.ad_value(2414), s.ad_value(2413), (-1.0)), 1.0));
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        if s.b[2503] {
            ...
            s.store_ad_value(1893, A::div_scaled_product(s.ad_value(1929), s.ad_value(1882), 1.0, s.ad_value(2262), 1.0));
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        if s.b[2507] {
            ...
            s.store_sub_ad_lhs(841, A::add_scaled_inputs3(s.ad_value(841), 1.0, s.ad_value(2284), (-1.0), s.ad_value(2286), -1.0), 2285);
        }
        ...
        if ((s.b[2514] && s.b[2515]) && (!s.b[2517])) {
            s.copy_ad(2288, 2287);
            s.store_ad_value(1930, A::div_scaled_inputs(s.ad_value(2288), 2.0, A::offset(s.ad_value(2288), 2.0), 1.0));
        }
        ...
        if ((s.b[2518] && s.b[2519]) && (!s.b[2521])) {
            s.copy_ad(2291, 2290);
            s.store_ad_value(1930, A::div_scaled_inputs(s.ad_value(2291), 2.0, A::offset(s.ad_value(2291), 2.0), 1.0));
        }
        ...
        if (s.b[2569] && s.b[2570]) {
            ...
            s.store_ad_value(2574, A::div_scaled_product(s.ad_value(821), s.ad_value(659), 2.0, A::add(s.ad_value(2528), s.ad_value(2530)), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_39(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2598])) {
            s.store_ad_value(2557, A::div_scaled_product(s.ad_value(2546), s.ad_value(2556), 1.0, A::add(s.ad_value(2546), s.ad_value(2556)), 1.0));
    ...
    pub(super) fn stamp_transient_block_40(
        ...
        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) {
            s.store_mul_scale_ad_lhs(1896, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
        ...
        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2612])) {
            s.store_mul_scale_ad_lhs(1897, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
    ...
    pub(super) fn stamp_transient_block_41(
        ...
        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2630])) {
            s.store_mul_scale_ad_lhs(1898, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
        ...
        if (s.b[2569] && (!s.b[2570])) {
            s.store_ad_value(837, A::add_scaled_product(A::add_scaled_products(s.ad_value(647), s.ad_value(1896), 1.0, s.ad_value(648), s.ad_value(1897), 1.0), 1.0, s.ad_value(649), s.ad_value(1898), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) && (!s.b[2662])) {
            s.store_ad_value(2563, A::div_scaled_product(s.ad_value(603), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0));
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) && (!s.b[2672])) && (!s.b[2673])) {
            s.store_ad_value(2566, A::add_scaled_product(s.ad_value(612), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(541), s.v[445]), s.ad_value(618), 1.0));
        }

        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2658])) {
            s.store_mul_scale_ad_lhs(1899, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) && (!s.b[2680])) {
            s.store_ad_value(2563, A::div_scaled_product(s.ad_value(604), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0));
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) && (!s.b[2690])) && (!s.b[2691])) {
            s.store_ad_value(2566, A::add_scaled_product(s.ad_value(613), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(542), s.v[445]), s.ad_value(619), 1.0));
        }

        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2676])) {
            s.store_mul_scale_ad_lhs(1900, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
    ...
    pub(super) fn stamp_transient_block_43(
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) && (!s.b[2698])) {
            s.store_ad_value(2563, A::div_scaled_product(s.ad_value(605), s.ad_value(2562), (1.772453850905516 * 0.5), s.ad_value(2558), 1.0));
        ...
        if ((((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) && (!s.b[2708])) && (!s.b[2709])) {
            s.store_ad_value(2566, A::add_scaled_product(s.ad_value(614), 1.0, A::add_scaled_inputs(s.ad_value(2539), 1.0, s.ad_value(642), s.v[445]), s.ad_value(620), 1.0));
        }

        if ((s.b[2569] && (!s.b[2570])) && (!s.b[2694])) {
            s.store_mul_scale_ad_lhs(1901, A::add(A::add_scaled_inputs3(s.ad_value(2541), 1.0, s.ad_value(2542), 1.0, s.ad_value(2549), 1.0), s.ad_value(2564)), p.p29, 2566);
        }
        ...
        if (s.b[2569] && (!s.b[2570])) {
            s.store_ad_value(838, A::add_scaled_product(A::add_scaled_products(s.ad_value(674), s.ad_value(1899), 1.0, s.ad_value(675), s.ad_value(1900), 1.0), 1.0, s.ad_value(676), s.ad_value(1901), 1.0));
        }
        ...
        if (s.b[2762] && s.b[2763]) {
            ...
            s.store_mul_ad(853, A::add_scaled_product(A::add_scaled_product(s.ad_value(276), 1.0, s.ad_value(277), s.ad_value(2730), (-1.0)), 1.0, s.ad_value(278), A::square(s.ad_value(2730)), 1.0), A::ln(A::div(A::add_scaled_inputs(s.ad_value(2731), 1.0, s.ad_value(2732), 0.5), A::sub_scaled_inputs(s.ad_value(2731), 1.0, s.ad_value(2732), 0.5))));
            s.store_ad_value(853, A::add_scaled_product(s.ad_value(853), 1.0, A::add_scaled_product(s.ad_value(277), 1.0, s.ad_value(278), A::sub_scaled_inputs(s.ad_value(2731), 1.0, s.ad_value(2730), 2.0), 1.0), s.ad_value(2732), 1.0));
            s.store_ad_value(853, A::div_scaled_product(A::mul3(s.ad_value(1923), s.ad_value(827), s.ad_value(1860)), s.ad_value(853), 1.0, s.ad_value(2730), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_44(
        ...
        if ((s.b[2762] && s.b[2767]) && s.b[2768]) {
            ...
            s.store_sub_ad_rhs(2747, 2747, A::div_scaled_product3(s.ad_value(2746), s.ad_value(2735), A::offset(s.ad_value(2737), 1.0), 1.0, A::mul(s.ad_value(2740), s.ad_value(1919)), 1.0));
        }
        ...
        if ((s.b[2762] && s.b[2767]) && (!s.b[2769])) {
            s.store_ad_value(852, A::div_scaled_product(s.ad_value(2747), s.ad_value(2748), 1.0, s.ad_value(851), 1.0));
        }
        ...
        if (s.b[2762] && s.b[2767]) {
            s.store_ad_value(850, A::div_scaled_product(s.ad_value(852), s.ad_value(851), 1.0, s.ad_value(2748), 1.0));
        }
        ...
        if s.b[2771] {
            ...
            s.store_mul_ad(858, A::add_scaled_product(s.ad_value(294), 1.0, A::add_scaled_product(s.ad_value(295), 1.0, s.ad_value(296), s.ad_value(2750), (-1.0)), s.ad_value(2750), (-1.0)), A::ln(A::div(A::add_scaled_inputs(s.ad_value(2751), 1.0, s.ad_value(2752), 0.5), A::sub_scaled_inputs(s.ad_value(2751), 1.0, s.ad_value(2752), 0.5))));
            s.store_ad_value(858, A::add_scaled_product(s.ad_value(858), 1.0, A::add_scaled_product(s.ad_value(295), 1.0, s.ad_value(296), A::sub_scaled_inputs(s.ad_value(2751), 1.0, s.ad_value(2750), 2.0), 1.0), s.ad_value(2752), 1.0));
            s.store_ad_value(858, A::div_scaled_product(A::mul3(s.ad_value(1927), s.ad_value(835), s.ad_value(1860)), s.ad_value(858), 1.0, s.ad_value(2750), 1.0));
        }
