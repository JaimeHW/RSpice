...
impl Instance {
    ...
    if (locals.var_xn_s > 0.0) {
        ...
        (locals.var_margin, locals.var_margin_dn4, locals.var_margin_dn6, locals.var_margin_dn7, locals.var_margin_dn8, locals.var_margin_dn9, ) = (assign41700_e54669, (1e-5 * locals.var_xi_dn4), (1e-5 * locals.var_xi_dn6), (1e-5 * locals.var_xi_dn7), (1e-5 * locals.var_xi_dn8), (1e-5 * locals.var_xi_dn9), );
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        (locals.var_margin_dc, locals.var_margin_dc_dn4, locals.var_margin_dc_dn6, locals.var_margin_dc_dn7, locals.var_margin_dc_dn8, locals.var_margin_dc_dn9, ) = (locals.var_margin, locals.var_margin_dn4, locals.var_margin_dn6, locals.var_margin_dn7, locals.var_margin_dn8, locals.var_margin_dn9, );
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if (locals.var_guard1237 != 0.0) {
            ...
            (locals.var_xd_ov, locals.var_xd_ov_dn6, locals.var_xd_ov_dn7, locals.var_xd_ov_dn8, ) = (assign46110_e59193, ((-locals.var_sp_ov_xg_dn6) + (locals.var_gov_d * (locals.var_sp_ov_xg_dn6 / (2.0 * assign46110_e59189)))), ((-locals.var_sp_ov_xg_dn7) + (locals.var_gov_d * (locals.var_sp_ov_xg_dn7 / (2.0 * assign46110_e59189)))), ((-locals.var_sp_ov_xg_dn8) + (locals.var_gov_d * (locals.var_sp_ov_xg_dn8 / (2.0 * assign46110_e59189)))), );
            locals.var_xd_ov_rv = 0.0;
        }
        ...
        if (locals.var_guard1237 != 0.0) {
            ...
            (locals.var_vovs, locals.var_vovs_dn6, locals.var_vovs_dn7, locals.var_vovs_dn8, ) = (assign46120_e59202, (assign46120_e59198 * (locals.var_xgs_ov_dn6 + locals.var_xs_ov_dn6)), (assign46120_e59198 * (locals.var_xgs_ov_dn7 + locals.var_xs_ov_dn7)), (assign46120_e59198 * (locals.var_xgs_ov_dn8 + locals.var_xs_ov_dn8)), );
            locals.var_vovs_rv = 0.0;
        }
        ...
        if (locals.var_guard1237 != 0.0) {
            ...
            (locals.var_vovd, locals.var_vovd_dn6, locals.var_vovd_dn7, locals.var_vovd_dn8, ) = (assign46130_e59211, (assign46130_e59207 * (locals.var_xgd_ov_dn6 + locals.var_xd_ov_dn6)), (assign46130_e59207 * (locals.var_xgd_ov_dn7 + locals.var_xd_ov_dn7)), (assign46130_e59207 * (locals.var_xgd_ov_dn8 + locals.var_xd_ov_dn8)), );
            locals.var_vovd_rv = 0.0;
        }
        ...
        if ((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) {
            ...
            (locals.var_zg, locals.var_zg_dn4, locals.var_zg_dn6, locals.var_zg_dn7, locals.var_zg_dn8, locals.var_zg_dn9, ) = (assign46220_e59236, 0.0, ((((locals.var_vovs_dn6 * locals.var_vovs) + (locals.var_vovs * locals.var_vovs_dn6)) / (2.0 * assign46220_e59234)) * locals.var_inv_chib), ((((locals.var_vovs_dn7 * locals.var_vovs) + (locals.var_vovs * locals.var_vovs_dn7)) / (2.0 * assign46220_e59234)) * locals.var_inv_chib), ((((locals.var_vovs_dn8 * locals.var_vovs) + (locals.var_vovs * locals.var_vovs_dn8)) / (2.0 * assign46220_e59234)) * locals.var_inv_chib), 0.0, );
        ...
        if (((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) && (locals.var_guard1240 != 0.0)) {
            ...
            (locals.var_zg, locals.var_zg_dn4, locals.var_zg_dn6, locals.var_zg_dn7, locals.var_zg_dn8, locals.var_zg_dn9, ) = (assign46240_e59262, (0.5 * (locals.var_zg_dn4 - (((locals.var_zg_dn4 * assign46240_e59256) + (assign46240_e59253 * locals.var_zg_dn4)) / (2.0 * assign46240_e59260)))), (0.5 * (locals.var_zg_dn6 - (((locals.var_zg_dn6 * assign46240_e59256) + (assign46240_e59253 * locals.var_zg_dn6)) / (2.0 * assign46240_e59260)))), (0.5 * (locals.var_zg_dn7 - (((locals.var_zg_dn7 * assign46240_e59256) + (assign46240_e59253 * locals.var_zg_dn7)) / (2.0 * assign46240_e59260)))), (0.5 * (locals.var_zg_dn8 - (((locals.var_zg_dn8 * assign46240_e59256) + (assign46240_e59253 * locals.var_zg_dn8)) / (2.0 * assign46240_e59260)))), (0.5 * (locals.var_zg_dn9 - (((locals.var_zg_dn9 * assign46240_e59256) + (assign46240_e59253 * locals.var_zg_dn9)) / (2.0 * assign46240_e59260)))), );
            locals.var_zg_rv = 0.0;
        }
        ...
        if ((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) {
            ...
            locals.var_fs2 = assign46320_e59374;
            locals.var_fs2_rv = 0.0;
        }

        if ((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) {
            let assign46330_e59382: f64 = (30.0 * locals.var_vgsprime);
            (locals.var_fs3, locals.var_fs3_dn6, locals.var_fs3_dn7, locals.var_fs3_dn8, ) = (assign46330_e59382, (30.0 * locals.var_vgsprime_dn6), (30.0 * locals.var_vgsprime_dn7), (30.0 * locals.var_vgsprime_dn8), );
            locals.var_fs3_rv = 0.0;
        }

        if ((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) {
            let assign46340_e59390: f64 = (4.0 - 0.9);
            locals.var_tme1 = assign46340_e59390;
            locals.var_tme1_rv = 0.0;
        }

        if ((locals.var_guard1238 != 0.0) && (locals.var_guard1239 != 0.0)) {
            let assign46350_e59398: f64 = (locals.var_fs1 + locals.var_fs3);
            (locals.var_tme2, locals.var_tme2_dn4, locals.var_tme2_dn6, locals.var_tme2_dn7, locals.var_tme2_dn8, locals.var_tme2_dn9, ) = (assign46350_e59398, 0.0, (locals.var_fs1_dn6 + locals.var_fs3_dn6), (locals.var_fs1_dn7 + locals.var_fs3_dn7), (locals.var_fs1_dn8 + locals.var_fs3_dn8), 0.0, );
