...
impl Instance {
    ...
    if s.b[982] {
        ...
        s.store_scalar(475, assign70_e1509);
    ...
    if (!s.b[982]) {
        ...
        s.store_scalar(475, assign80_e1514);
        ...
        s.store_scalar(373, (1.772453850905516 * 0.29214664));

        s.store_scalar(374, (((((-5.0) * 0.29214664) + 6.0) - ((s.v[373]) as f64).powf((-2.0))) / 3.0));

        s.store_scalar(375, ((1.0 - 0.29214664) - s.v[374]));

        s.store_scalar(445, (1.0 - (1.0 / p.p841)));

        s.store_scalar(446, (1.0 / (1.0 - ((s.v[445]) as f64).powf(p.p880))));

        s.store_scalar(447, (1.0 / (1.0 - ((s.v[445]) as f64).powf(p.p881))));

        s.store_scalar(448, (1.0 / (1.0 - ((s.v[445]) as f64).powf(p.p882))));
        ...
        s.store_scalar(452, (((-((s.v[446] * s.v[446]) * ((s.v[445]) as f64).powf((p.p880 - 1.0)))) * p.p880) * s.v[449]));

        s.store_scalar(453, (((-((s.v[447] * s.v[447]) * ((s.v[445]) as f64).powf((p.p881 - 1.0)))) * p.p881) * s.v[450]));

        s.store_scalar(454, (((-((s.v[448] * s.v[448]) * ((s.v[445]) as f64).powf((p.p882 - 1.0)))) * p.p882) * s.v[451]));
    ...
    if s.b[983] {
        ...
        s.store_scalar(474, assign460_e1711);
    ...
    if (!s.b[983]) {
        ...
        s.store_scalar(474, assign470_e1716);
    ...
    if (!s.b[985]) {
        ...
        s.store_mul_product3_mixed_iaai(618, 615, A::square(s.ad_value(612)), A::pow_from_scalar(s.v[445], A::offset(s.ad_value(544), (-1.0))), 544, -1.0);

        s.store_mul_product3_mixed_iaai(619, 616, A::square(s.ad_value(613)), A::pow_from_scalar(s.v[445], A::offset(s.ad_value(545), (-1.0))), 545, -1.0);

        s.store_mul_product3_mixed_iaai(620, 617, A::square(s.ad_value(614)), A::pow_from_scalar(s.v[445], A::offset(s.ad_value(546), (-1.0))), 546, -1.0);
    ...
    if s.b[986] {
        ...
        s.store_scalar(636, assign1910_e2425);
    ...
    if (!s.b[986]) {
        ...
        s.store_scalar(636, assign1920_e2430);
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        s.store_scalar(14, (if (p.p10 < 1.5) { 1.0 } else { 2.0 }));
        ...
        s.store_scalar(163, p.p179);

        s.store_scalar(166, p.p180);

        s.store_scalar(167, p.p181);

        s.store_scalar(168, p.p183);

        s.store_scalar(169, p.p182);

        s.store_scalar(170, p.p184);

        s.store_scalar(171, p.p185);

        s.store_scalar(172, p.p186);

        s.store_scalar(173, p.p187);

        s.store_scalar(174, p.p188);
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if s.b[1016] {
            ...
            s.store_mul_product3_indices(140, 316, 65, 65, 316, p.p391);
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_scalar(669, 1.0);

        s.store_scalar(696, 1.0);

        s.store_scalar(670, 0.0);

        s.store_scalar(697, 0.0);

        s.store_scalar(671, 1.0);

        s.store_scalar(698, 1.0);
        ...
        s.store_scalar(493, 0.0);

        s.store_scalar(481, 0.0);

        s.store_scalar(482, 0.0);
