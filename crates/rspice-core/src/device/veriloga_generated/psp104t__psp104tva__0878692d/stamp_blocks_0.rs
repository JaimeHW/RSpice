...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[1007] {
            ...
            s.store_ad_value(466, A::add_scaled_inputs(s.ad_value(465), 1.0, A::ln_one_plus_exp(A::scale_offset(s.ad_value(465), (-s.v[372]), ((0.05) * (s.v[372])))), s.v[371]));
        ...
        s.store_ad_value(570, A::add_scaled_inputs(s.ad_value(567), 1.0, A::ln_one_plus_exp(A::scale_offset(s.ad_value(567), (-s.v[372]), ((0.05) * (s.v[372])))), s.v[371]));

        s.store_ad_value(571, A::add_scaled_inputs(s.ad_value(568), 1.0, A::ln_one_plus_exp(A::scale_offset(s.ad_value(568), (-s.v[372]), ((0.05) * (s.v[372])))), s.v[371]));

        s.store_ad_value(572, A::add_scaled_inputs(s.ad_value(569), 1.0, A::ln_one_plus_exp(A::scale_offset(s.ad_value(569), (-s.v[372]), ((0.05) * (s.v[372])))), s.v[371]));
        ...
        if s.b[1008] {
            ...
            s.store_ad_value(629, A::add_scaled_inputs(s.ad_value(628), 1.0, A::ln_one_plus_exp(A::scale_offset(s.ad_value(628), (-s.v[372]), ((0.05) * (s.v[372])))), s.v[371]));
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if s.b[1016] {
            s.store_add_scaled_product(340, A::scale_offset(s.ad_value(316), p.p266, 1.0), 1.0, s.ad_value(316), A::ln(A::scale_offset(s.ad_value(313), 1.0 / (p.p268), 1.0)), p.p267);
            ...
            s.store_ad_value(89, A::div_scaled_product_offset_denominator(s.ad_value(341), A::scale_offset(s.ad_value(316), p.p317, 1.0), p.p314, A::mul_scaled_lhs(s.ad_value(314), p.p316, s.ad_value(341)), 1.0, 1.0));
            s.store_powf(341, 314, p.p319);
            s.store_ad_value(90, A::div_scaled_product_offset_denominator(s.ad_value(341), A::scale_offset(s.ad_value(316), p.p321, 1.0), p.p318, A::mul_scaled_lhs(s.ad_value(314), p.p320, s.ad_value(341)), 1.0, 1.0));
        ...
        if s.b[1016] {
            s.store_ad_value(122, A::div_scaled_value_offset_denominator(s.ad_value(37), 1.0, A::mul(s.ad_value(38), s.ad_value(314)), 1.0, 1.0));
            ...
            s.store_ad_value(124, A::div_scaled_product_offset_denominator(s.ad_value(341), A::scale_offset(s.ad_value(316), p.p377, 1.0), p.p374, A::mul_scaled_lhs(s.ad_value(314), p.p376, s.ad_value(341)), 1.0, 1.0));
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (s.b[1016] && s.b[1089]) {
            s.store_ad_value(122, A::add_scaled_value_products3(s.ad_value(28), 1.0, s.ad_value(29), s.ad_value(314), 1.0, s.ad_value(30), s.ad_value(316), 1.0, s.ad_value(31), s.ad_value(318), 1.0));
        }
        ...
        if (s.b[1016] && s.b[1127]) {
            ...
            s.store_add_scaled_inputs_product(993, A::scale_offset(s.ad_value(1000), p.p815, 1.0), (1.0 + (p.p814 * (s.v[353] - 1.0))), s.ad_value(1001), (p.p816 * (1.0 + (p.p814 * (s.v[353] - 1.0)))), s.ad_value(1000), s.ad_value(1001), (p.p817 * (1.0 + (p.p814 * (s.v[353] - 1.0)))));
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if (s.b[1016] && s.b[1127]) {
            s.store_add_scaled_inputs_product(996, A::scale_offset(s.ad_value(1000), p.p821, 1.0), 1.0, s.ad_value(1001), p.p822, s.ad_value(1000), s.ad_value(1001), p.p823);
            s.store_add_scaled_inputs4(998, s.ad_value(989), 1.0, s.ad_value(990), 1.0, s.ad_value(991), -1.0, s.ad_value(992), -1.0);
            s.store_ad_value(999, A::div_scaled_offset_numerator(s.ad_value(994), 1.0, 1.0, A::offset(s.ad_value(995), 1.0), 1.0));
        ...
        if ((s.b[1016] && s.b[1128]) && s.b[1129]) {
            ...
            s.store_ad_value(12, A::div_scaled_add_product(A::exp_scaled_input(s.ad_value(999), ((-10.0) * s.v[8])), ((0.1 * s.v[8]) + (0.01 * p.p828)), A::scale_offset(s.ad_value(998), 0.1, (0.01 * p.p828)), A::exp(A::mul_scaled_lhs(s.ad_value(998), (-10.0), s.ad_value(999))), (-1.0), s.ad_value(4), 1.0));
            s.store_ad_value(13, A::div_scaled_add_product(A::exp_scaled_input(s.ad_value(999), ((-20.0) * s.v[8])), ((0.05 * s.v[8]) + (0.0025 * p.p828)), A::scale_offset(s.ad_value(998), 0.05, (0.0025 * p.p828)), A::exp(A::mul_scaled_lhs(s.ad_value(998), (-20.0), s.ad_value(999))), (-1.0), s.ad_value(4), 1.0));
        }

        if (s.b[1016] && s.b[1128]) {
            s.store_add_scaled_inputs3(998, s.ad_value(11), 1.0, s.ad_value(12), p.p829, s.ad_value(13), p.p830);
            s.store_add_scaled_product(40, s.ad_value(40), 1.0, s.ad_value(348), s.ad_value(998), 1.0);
            s.store_mul_offset_ad_rhs(65, 65, A::mul(s.ad_value(349), s.ad_value(998)), 1.0);
            s.store_add_scaled_product(145, s.ad_value(145), 1.0, s.ad_value(348), s.ad_value(998), 1.0);
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_ad_value(766, A::div_scaled_product_offset_lhs(s.ad_value(997), (-1.0), A::offset(s.ad_value(997), (-1.0)), 1.0, {
        ...
        s.store_ad_value(767, A::div_scaled_product_offset_lhs(s.ad_value(997), (-1.0), A::offset(s.ad_value(997), (-1.0)), 1.0, {
            if ((4.0 * s.v[997]) > 0.0001) {
                A::scale(s.ad_value(997), 4.0)
            } else {
                A::constant(0.0001)
        ...
        s.store_add_scaled_inputs_product(780, s.ad_value(811), 1.0, s.ad_value(773), 0.5, s.ad_value(771), A::sqrt(A::add_scaled_inputs3(s.ad_value(811), 1.0, s.ad_value(773), 0.25, s.ad_value(779), 1.0)), (-1.0));
        ...
        s.store_add_scaled_inputs_product(783, s.ad_value(811), 1.0, s.ad_value(774), 0.5, s.ad_value(772), A::sqrt(A::add_scaled_inputs3(s.ad_value(811), 1.0, s.ad_value(774), 0.25, s.ad_value(782), 1.0)), (-1.0));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if s.b[1153] {
            ...
            s.store_add_scaled_product(21, s.ad_value(2), s.v[651], s.ad_value(26), s.ad_value(27), (-1.0));
            s.copy_ad(22, 27);
            s.store_scale(23, 2, s.v[677]);
            s.store_add_scaled_product(24, s.ad_value(2), s.v[678], s.ad_value(26), s.ad_value(27), (-1.0));
            s.copy_ad(25, 27);
        }
