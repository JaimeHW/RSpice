...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_49(
        ...
        if (((s.b[2453] && s.b[2454]) && s.b[2471]) && (!s.b[2474])) {s.store_add_offset_lhs(2351, 2343, (-1.0), 2349);s.store_sqrt(2352, 2351);s.store_offset_scaled_ad(2353, A::div(A::mul_sub_from_scalar_rhs(s.ad_value(2304), 1.0, s.ad_value(2349)), s.ad_value(2352)), 0.5, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_50(
        ...
        if (s.b[2453] && (!s.b[2454])) {s.copy_ad(2301, 1806);s.copy_ad(2303, 1807);s.copy_ad(2319, 1808);s.copy_ad(2320, 1809);s.copy_ad(2304, 1810);s.copy_ad(2305, 1811);s.copy_ad(2321, 1812);s.copy_ad(2323, 1813);s.copy_ad(2328, 1814);s.copy_ad(2329, 1815);s.copy_ad(2340, 1816);s.copy_ad(2341, 1817);s.copy_ad(2342, 1818);s.copy_ad(2449, 1819);s.copy_ad(2344, 1820);s.copy_ad(2343, 1821);s.copy_ad(2346, 1822);s.copy_ad(2347, 1823);s.copy_ad(2348, 1824);s.copy_ad(2349, 1825);s.copy_ad(2351, 1826);s.copy_ad(2350, 1827);s.copy_ad(2352, 1828);s.copy_ad(2353, 1829);s.copy_ad(2354, 1830);s.copy_ad(2355, 1831);s.copy_ad(2356, 1832);s.copy_ad(2357, 1833);s.copy_ad(2358, 1834);s.copy_ad(2359, 1835);s.copy_ad(2363, 1836);s.copy_ad(2364, 1837);s.copy_ad(2366, 1838);}
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2482]) && s.b[2485]) {s.store_scaled_mul(2371, 2319, 2370, 0.475);s.store_add_scaled_product_indices(1929, 2356, 1.0, 2353, 2371, (-1.0));s.store_scaled_add_mixed_ia(2372, 1929, A::sqrt_square_offset(s.ad_value(1929), 1e-12), 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_51(
        s: &mut ReactiveScratch,
    ) {
        if (((s.b[2453] && s.b[2481]) && s.b[2482]) && s.b[2485]) {s.store_add_scaled_value_products_mixed_iiiai(2373, 2356, (-1.0), 2319, 2355, 1.0, A::offset(s.ad_value(2353), (-1.0)), 2371, 1.0);s.store_offset_div_scaled_product_indices(2374, 2305, 2319, 0.5, 2373, 1.0, 1.0);s.store_add_scaled_product_indices(1929, 2373, 1.0, 764, 2372, 1.0);s.store_pow_ad(2375, A::mul3(s.ad_value(763), s.ad_value(1929), s.ad_value(705)), s.ad_value(706));s.store_mul_mixed_ai(1930, A::div_scaled_product_offset_rhs(s.ad_value(706), A::mul_sub_from_scalar_rhs(s.ad_value(2374), 1.0, s.ad_value(764)), (-1.0), 1.0, s.ad_value(1929), 1.0), 2375);s.store_div(1929, 2372, 2373);s.store_mul_pow_mixed_iaa(2376, 707, A::offset(s.ad_value(1929), 1.0), A::neg(s.ad_value(708)));s.store_mul_div_scaled_product_mixed_iiai(1931, 2376, 708, A::add(A::offset(s.ad_value(2374), (-1.0)), A::div_scalar_offset_denominator(1.0, s.ad_value(1929), 1.0, 1.0)), 1.0, 2373, 1.0);s.store_mul_product3_indices(2377, 2372, 746, 2358, 2359, 1.0);s.store_offset_ad(1929, A::div_scaled_add_product(s.ad_value(1930), 1.0, A::mul3(s.ad_value(746), s.ad_value(2358), s.ad_value(2359)), s.ad_value(2374), (-1.0), s.ad_value(1931), 1.0), 1.0);}
        ...
        if (s.b[2453] && s.b[2481]) {s.store_offset(1929, 2300, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_52(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[2453] && s.b[2481]) {s.store_div_scaled_product_mixed_aii(1930, A::sqrt(s.ad_value(1929)), 815, 1.0, 2384, 1.0);s.store_add_mixed_ai(1931, A::square(s.ad_value(1930)), 1929);s.store_scale(1929, 1930, 2.0);s.store_div_scaled_product_add_scaled_denominator(2385, 2384, 1929, 1.0, A::sqrt(A::sub(s.ad_value(1931), s.ad_value(1929))), 1.0, A::sqrt(A::add(s.ad_value(1931), s.ad_value(1929))), 1.0, 1.0);s.store_mul(2386, 2385, 2320);s.store_add(2387, 2329, 2386);}
    ...
    pub(super) fn stamp_reactive_block_53(
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2492]) {s.store_add_scaled_inputs_product_mixed_iiia(2392, 2323, 2.0, 2343, (-2.0), 2305, A::add_scaled_offset_product_rhs(A::add_scaled_sub_value_product(1.0, s.ad_value(2349), 1.0, s.ad_value(2348), s.ad_value(2388), 1.0), 1.0, s.ad_value(2389), s.ad_value(2346), 1.0, (-1.0)), 1.0);s.store_mul_mixed_ai(2393, A::mul_sub_from_scalar_rhs(s.ad_value(2305), 1.0, s.ad_value(2388)), 2350);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_54(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[2453] && s.b[2481]) && s.b[2492]) {s.store_sub_from_scalar_scaled_mul_mixed_ia(1929, 2.0, 2305, A::add_scaled_value_products(s.ad_value(2349), 1.0, s.ad_value(2348), s.ad_value(2388), 1.0, s.ad_value(2389), s.ad_value(2347), (-1.0)), 1.0);s.store_add_scaled_square_product_indices(1929, 2392, 1.0, 1929, 2393, (-2.0));s.store_scaled_div_mixed_ia(2391, 2393, A::add(s.ad_value(2392), A::sqrt(s.ad_value(1929))), 2.0);s.store_add(2390, 2343, 2391);}
        ...
        if (((s.b[2453] && s.b[2481]) && s.b[2493]) && s.b[2494]) {s.store_square_mul_sub_from_scalar_scaled_sub_rhs_scaled_output(2397, 2390, 1.0, 2390, 1.0, 2390, 0.25, 0.3333333333333333, 0.5);s.store_sqrt_sub_from_scalar_ad(1929, 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2390), 1.0, A::scale(s.ad_value(2390), 0.25), 0.3333333333333333));s.store_scaled_mul(2398, 2390, 1929, 0.7071067811865475);s.store_mul3_ad_middle(2399, A::mul3_scaled_output(s.ad_value(2389), s.ad_value(2390), s.ad_value(2390), 0.16666666666666666), 2390, A::scale_offset(s.ad_value(2390), 1.75, 1.0));}
        ...
        if ((s.b[2453] && s.b[2481]) && s.b[2497]) {s.store_sqrt_sub_from_scalar_ad(1929, 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2401), 1.0, A::scale(s.ad_value(2401), 0.25), 0.3333333333333333));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_55(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[2453] && s.b[2481]) && s.b[2497]) {s.store_scaled_mul(2408, 2401, 1929, 0.7071067811865475);s.store_add_mixed_ia(2409, 2407, A::div_scaled_product(s.ad_value(2304), A::add_scaled_inputs(A::sub_from_scalar(1.0, A::scale(s.ad_value(2401), 0.5)), 1.0, A::square(s.ad_value(2401)), 0.16666666666666666), 0.7071067811865475, s.ad_value(1929), 1.0));}
        ...
        if (s.b[2453] && s.b[2481]) {s.store_mul_product3_indices(2360, 2418, 746, 2358, 2359, 1.0);s.store_add_scaled_product_indices(2421, 2420, 1.0, 764, 2418, 1.0);s.store_add_scaled_product_indices(2422, 2420, 1.0, 765, 2418, 1.0);s.store_mul(2423, 763, 2421);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_56(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[2453] && s.b[2481]) {s.store_ln_ad(1930, A::div_scaled_value_offset_denominator(s.ad_value(2405), 1.0, A::add(s.ad_value(2405), s.ad_value(2404)), 1e-14, 1.0));s.store_add_scaled_product_mixed_aia(2362, A::pow(A::mul(s.ad_value(2423), s.ad_value(705)), s.ad_value(706)), 1.0, 707, A::exp(A::mul_scaled_lhs(s.ad_value(708), 0.5, s.ad_value(1930))), 1.0);s.store_mul_add_mixed_iai(2424, 2354, A::offset(s.ad_value(2362), 1.0), 2360);s.store_ln_ad(2425, A::div_scaled_offset_numerator(A::mul(A::sub(s.ad_value(815), s.ad_value(2394)), s.ad_value(768)), 1.0, 1.0, A::offset(A::mul(A::sub(s.ad_value(2385), s.ad_value(2394)), s.ad_value(768)), 1.0), 1.0));s.store_mul(1931, 2418, 2364);s.store_div_add_scaled_inputs_rhs_indices(2365, 1931, 221, 1.0, 1931, 1.0);}
        ...
        if s.b[2453] {s.copy_ad(1871, 2301);s.copy_ad(1872, 2319);s.copy_ad(1873, 2304);s.copy_ad(1874, 2323);s.copy_ad(1875, 2328);s.copy_ad(1876, 2357);s.copy_ad(1877, 2394);s.copy_ad(1878, 2400);s.copy_ad(1879, 2407);s.copy_ad(1880, 2409);s.copy_ad(1881, 2418);s.copy_ad(1882, 2419);s.copy_ad(1883, 2422);s.copy_ad(1884, 2424);s.copy_ad(1885, 2425);s.copy_ad(1886, 2427);s.copy_ad(1887, 2426);}
        if (!s.b[2453]) {s.copy_ad(734, 717);s.copy_ad(1871, 1806);s.copy_ad(1872, 1808);s.copy_ad(1873, 1810);s.copy_ad(1874, 1813);s.copy_ad(1875, 1814);s.copy_ad(1876, 1833);s.copy_ad(1877, 1844);s.copy_ad(1878, 1845);s.copy_ad(1879, 1847);s.copy_ad(1880, 1848);s.copy_ad(1881, 1849);s.copy_ad(1882, 1850);s.copy_ad(1883, 1852);s.copy_ad(1884, 1853);s.copy_ad(1885, 1855);s.copy_ad(1886, 1854);s.copy_ad(1887, 1856);}
        ...
        s.store_scalar(1889, 1.0);s.store_scalar(1890, 1.0);s.store_scalar(1891, 0.0);s.store_scalar(1892, 1.0);s.store_scalar(1893, 1.0);s.copy_ad(2265, 1887);
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_57(
        ...
        s.store_scalar(2268, 0.0);s.store_scalar(2267, 0.0);s.copy_ad(2269, 2265);s.b[2503] = (s.v[1874] > 0.0);s.store_scalar(2503, if s.b[2503] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_59(
        ...
        if ((s.b[2514] && s.b[2515]) && s.b[2517]) {s.store_ln_offset_input(2288, 2287, 1.0);s.store_mul_scale_offset_mixed_ia(1930, 2288, A::div(A::ln(A::offset(s.ad_value(2288), 1.0)), A::offset(s.ad_value(2288), 2.0)), -1.0, 1.0);}
        ...
        s.store_add(2293, 2289, 2292);s.store_add_scaled_product_indices(845, 2293, 1.0, 265, 818, 1.0);s.store_mul(843, 272, 823);s.store_mul(844, 273, 826);s.store_scalar(2522, 0.0);s.store_scalar(2525, 0.0);s.store_scalar(2526, 0.0);s.store_scalar(2527, 0.0);s.store_scalar(2528, 0.0);s.store_scalar(2529, 0.0);s.store_scalar(2530, 0.0);s.store_scalar(2531, 0.0);s.store_scalar(2532, 0.0);s.store_scalar(2533, 0.0);s.store_scalar(2534, 0.0);s.store_scalar(2535, 0.0);s.store_scalar(2536, 0.0);s.store_scalar(2537, 0.0);s.store_scalar(2538, 0.0);s.store_scalar(2539, 0.0);s.store_scalar(2540, 0.0);s.store_scalar(2543, 0.0);s.store_scalar(2547, 0.0);s.store_scalar(2550, 0.0);s.store_scalar(2551, 0.0);
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_60(
        ...
        s.store_scalar(2552, 0.0);s.store_scalar(2553, 0.0);s.store_scalar(2554, 0.0);s.store_scalar(2555, 0.0);s.store_scalar(2558, 0.0);s.store_scalar(2559, 0.0);s.store_scalar(2560, 0.0);s.store_scalar(2561, 0.0);s.store_scalar(2565, 0.0);s.store_scalar(2567, 0.0);s.store_scalar(2568, 0.0);s.store_scalar(846, 0.0);s.store_scalar(1902, 0.0);s.store_scalar(1903, 0.0);s.store_scalar(1904, 0.0);s.store_scalar(847, 0.0);s.store_scalar(1905, 0.0);s.store_scalar(1906, 0.0);s.store_scalar(1907, 0.0);s.b[2569] = (p.p43 > 0.0);s.store_scalar(2569, if s.b[2569] { 1.0 } else { 0.0 });s.b[2570] = (s.v[475] == 1.0);s.store_scalar(2570, if s.b[2570] { 1.0 } else { 0.0 });
        if (s.b[2569] && s.b[2570]) {s.store_scalar(2573, 0.0);s.store_scalar(2574, 0.0);s.store_primal_scaled_mul(2525, 658, 658, 4.0);s.store_primal_div(2526, 658, 659);s.store_add_scaled_product_indices(2527, 821, 1.0, 658, 2526, 1.0);s.store_add(2528, 659, 2527);s.store_sub(2529, 659, 2527);s.store_sqrt_square_add(2530, 2529, 2525);s.store_div_scaled_product_add_scaled_denominator_indices(2574, 821, 659, 2.0, 2528, 1.0, 2530, 1.0, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_61(
        ...
        if ((s.b[2569] && (!s.b[2570])) && s.b[2589]) {s.store_primal_scaled_mul(2525, 658, 658, 4.0);s.store_primal_div(2526, 658, 659);s.store_add_scaled_product_indices(2527, 821, 1.0, 658, 2526, 1.0);s.store_add(2528, 659, 2527);s.store_sub(2529, 659, 2527);s.store_sqrt_square_add(2530, 2529, 2525);s.store_div_scaled_product_add_scaled_denominator_indices(2532, 821, 659, 2.0, 2528, 1.0, 2530, 1.0, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_62(
        ...
        if ((s.b[2569] && (!s.b[2570])) && s.b[2594]) {s.store_scalar(1902, 0.0);}
        s.b[2595] = ((p.p857 == 0.0) && (p.p862 == 0.0));s.store_scalar(2595, if s.b[2595] { 1.0 } else { 0.0 });
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2595])) {s.store_sub_from_scalar(2543, s.v[394], 2537);}
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2594])) && (!s.b[2595])) {s.store_scale(2547, 2540, s.v[424]);}
        ...
        s.b[2602] = (s.v[2561] > 0.0);s.store_scalar(2602, if s.b[2602] { 1.0 } else { 0.0 });s.b[2603] = (s.v[2560] > (-230.25850929940458));s.store_scalar(2603, if s.b[2603] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_63(
        ...
        s.b[2608] = (p.p877 > 1000.0);s.store_scalar(2608, if s.b[2608] { 1.0 } else { 0.0 });s.b[2609] = (s.v[2539] > ((-s.v[445]) * p.p877));s.store_scalar(2609, if s.b[2609] { 1.0 } else { 0.0 });s.b[2610] = (p.p880 == 4.0);s.store_scalar(2610, if s.b[2610] { 1.0 } else { 0.0 });
        ...
        if ((s.b[2569] && (!s.b[2570])) && s.b[2612]) {s.store_scalar(1903, 0.0);}
        s.b[2613] = ((p.p858 == 0.0) && (p.p863 == 0.0));s.store_scalar(2613, if s.b[2613] { 1.0 } else { 0.0 });
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2612])) && (!s.b[2613])) {s.store_sub_from_scalar(2543, s.v[395], 2537);}
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2612])) && (!s.b[2613])) {s.store_scale(2547, 2540, s.v[425]);}
        ...
        s.b[2620] = (s.v[2561] > 0.0);s.store_scalar(2620, if s.b[2620] { 1.0 } else { 0.0 });s.b[2621] = (s.v[2560] > (-230.25850929940458));s.store_scalar(2621, if s.b[2621] { 1.0 } else { 0.0 });
        ...
        s.b[2622] = (p.p869 == 0.0);s.store_scalar(2622, if s.b[2622] { 1.0 } else { 0.0 });s.b[2623] = (p.p849 == 0.5);s.store_scalar(2623, if s.b[2623] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_64(
        ...
        s.b[2626] = (p.p878 > 1000.0);s.store_scalar(2626, if s.b[2626] { 1.0 } else { 0.0 });s.b[2627] = (s.v[2539] > ((-s.v[445]) * p.p878));s.store_scalar(2627, if s.b[2627] { 1.0 } else { 0.0 });s.b[2628] = (p.p881 == 4.0);s.store_scalar(2628, if s.b[2628] { 1.0 } else { 0.0 });
        ...
        if ((s.b[2569] && (!s.b[2570])) && s.b[2630]) {s.store_scalar(1904, 0.0);}
        s.b[2631] = ((p.p859 == 0.0) && (p.p864 == 0.0));s.store_scalar(2631, if s.b[2631] { 1.0 } else { 0.0 });
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2630])) && (!s.b[2631])) {s.store_sub_from_scalar(2543, s.v[396], 2537);}
        ...
        if (((s.b[2569] && (!s.b[2570])) && (!s.b[2630])) && (!s.b[2631])) {s.store_scale(2547, 2540, s.v[426]);}
        ...
        s.b[2638] = (s.v[2561] > 0.0);s.store_scalar(2638, if s.b[2638] { 1.0 } else { 0.0 });s.b[2639] = (s.v[2560] > (-230.25850929940458));s.store_scalar(2639, if s.b[2639] { 1.0 } else { 0.0 });
        ...
        s.b[2640] = (p.p870 == 0.0);s.store_scalar(2640, if s.b[2640] { 1.0 } else { 0.0 });s.b[2641] = (p.p850 == 0.5);s.store_scalar(2641, if s.b[2641] { 1.0 } else { 0.0 });
        ...
        s.b[2644] = (s.v[641] > 1000.0);s.store_scalar(2644, if s.b[2644] { 1.0 } else { 0.0 });s.b[2645] = (s.v[2539] > ((-s.v[445]) * s.v[641]));s.store_scalar(2645, if s.b[2645] { 1.0 } else { 0.0 });s.b[2646] = (p.p882 == 4.0);s.store_scalar(2646, if s.b[2646] { 1.0 } else { 0.0 });
    }
}
