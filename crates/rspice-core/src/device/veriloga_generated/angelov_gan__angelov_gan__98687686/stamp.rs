...
struct CommonStampValues {
    ...
    B4: f64, KC: f64, Ly: f64, NZ: f64, O0: f64, O1: f64, 
    O2: f64, OO: f64, OP: f64, OQ: f64, OR: f64, Pl: f64, 
    Pn: f64, Po: f64, Pw: f64, Py: f64, PA: f64, PK: f64, 
    PT: f64, PU: f64, PV: f64, PW: f64, PX: f64, Q3: f64, 
}
...
impl Instance {
    ...
    fn eval_common_stamp_values(&mut self, ctx: &GeneratedEvalContext<'_>) -> CommonStampValues {
        ...
        CommonStampValues {
            ...
            Ly, NZ, O0, O1, O2, OO, OP, OQ, 
            OR, Pl, Pn, Po, Pw, Py, PA, PK, 
            PT, PU, PV, PW, PX, Q3, 
        }
    }
    ...
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        stamper.stamp_current_sparse_local::<4, 0>(
            ...
            [5, 8, 10, 11],
            [(if (sf[120]!=0.0){(OO*P3)}else{n_}), (if (sf[120]!=0.0){(OP*P3)}else{n_}), (if (sf[120]!=0.0){(OQ*P3)}else{n_}), (if (sf[120]!=0.0){(OR*P3)}else{n_})],
            [],
            [],
            multiplicity,
        );
        stamper.stamp_current_sparse_local::<4, 0>(
            ...
            [5, 8, 10, 11],
            [(if (sf[120]!=0.0){(NZ*P3)}else{n_}), (if (sf[120]!=0.0){(O0*P3)}else{n_}), (if (sf[120]!=0.0){(O1*P3)}else{n_}), (if (sf[120]!=0.0){(O2*P3)}else{n_})],
            [],
            [],
            multiplicity,
        );
        stamper.stamp_current_node3_local(
            ...
            5,
            multiplicity * ((if sb[69]{(P3*((-l5)+Pl))}else{n_})),
            8,
            multiplicity * ((if sb[69]{(P3*Pn)}else{n_})),
            10,
            multiplicity * ((if sb[69]{(P3*(l5+Po))}else{n_})),
        );
        stamper.stamp_current_node3_local(
            Some(11),
            Some(8),
            ...
            5,
            multiplicity * ((if sb[69]{(P3*Pw)}else{n_})),
            8,
            multiplicity * ((if sb[69]{(P3*((-l3)+Py))}else{n_})),
            11,
            multiplicity * ((if sb[69]{(P3*(l3+PA))}else{n_})),
        );
        ...
        stamper.stamp_potential_sparse_local::<5, 1>(
            ...
            [PT, PU, PV, PW, PX],
            [1],
            [(if (sf[122]!=0.0){(gt+(sf[121]*P3))}else{n_})],
        );
        stamper.stamp_potential_branch_local(
            Some(4),
            Some(8),
        ...
        stamper.stamp_current_node2_local(
            ...
            8,
            multiplicity * ((if (sf[123]!=0.0){(P3*Q3)}else{n_})),
            12,
            multiplicity * ((if (sf[123]!=0.0){(bu*P3)}else{n_})),
        );
        stamper.stamp_potential_branch_local(
            Some(11),
            Some(8),
        ...
        stamper.stamp_current_node1_local(
            ...
            17,
            multiplicity * ((if sb[67]{(np*P3)}else{n_})),
        );
        stamper.stamp_current_const_local(
            Some(5),
            Some(8),
        ...
        stamper.stamp_current_node1_local(
            ...
            3,
            multiplicity * ((if (sf[143]!=0.0){(sf[152]*P3)}else{n_})),
        );
        stamper.stamp_current_node1_local(
            Some(3),
            None,
    ...
    pub fn stamp_reactive(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedReactiveStamper<'_>) {
        ...
        let jl=KC;let jn=Ly;let l2=O2;let l3=(if sb[49]{l2}else{(if sb[46]{k4}else{(if sb[43]{jl}else{it})})});let l4=OQ;let l5=(if sb[49]{l4}else{(if sb[46]{k9}else{(if sb[43]{jn}else{iz})})});let ma=0.0;let mc=0.0;let mg=0.0;let mj=0.0;let my=0.0;let mF=0.0;let nr=0.0;let nE=0.0;let P3=1.0;
