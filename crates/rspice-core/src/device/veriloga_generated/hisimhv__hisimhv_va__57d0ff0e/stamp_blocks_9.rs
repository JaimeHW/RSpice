...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_sqrt_offset_ad(782, A::mul(A::neg(A::add(s.ad_value(2119), s.ad_value(2118))), A::neg(A::add(s.ad_value(2119), s.ad_value(2118)))), ((4.0 * (1e-12 * 1e-6)) * (1e-12 * 1e-6)));
            s.store_scaled_offset_ad(335, A::div(A::neg(A::add(s.ad_value(2119), s.ad_value(2118))), s.ad_value(782)), 1.0, 0.5);
            s.store_scaled_add_ad_lhs(2121, A::neg(A::add(s.ad_value(2119), s.ad_value(2118))), 782, 0.5);
        }
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_mul_ad_affine_product_lhs(248, A::neg(s.ad_value(154)), s.ad_value(2121), 0.5, 0.0, 94);
        ...
        if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2297])) && s.b[2304]) {
            s.store_div_from_scalar(726, 1.0, 726);
            s.store_mul_ad_product_lhs(780, s.ad_value(781), A::sub_from_scalar(0.8, s.ad_value(2117)), 726);
