...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_scaled_offset_ad(335, A::div_scaled_inputs(A::add(s.ad_value(2119), s.ad_value(2118)), -1.0, s.ad_value(782), 1.0), 1.0, 0.5);
            s.store_ad_value(2121, A::add_scaled_inputs3(s.ad_value(2119), (-0.5), s.ad_value(2118), (-0.5), s.ad_value(782), 0.5));
        }
        ...
        if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2297])) && s.b[2304]) {
            ...
            s.store_ad_value(334, A::div_scaled_product3(A::sub_from_scalar(0.8, s.ad_value(2117)), s.ad_value(725), s.ad_value(726), 1.0, s.ad_value(770), 1.0));
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2297])) {
            ...
            s.store_ad_value(339, A::add_scaled_product(s.ad_value(336), 1.0, s.ad_value(508), s.ad_value(2133), 1.0));
