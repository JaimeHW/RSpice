...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        Self::stamp_transient_block_70(s, p, var_cox0, var_coxb0, var_lgate, var_tox0, var_uc_nover, var_uc_novers, &mut var_flg_coovlp, &mut var_flg_coovlps, &mut var_guard1631, &mut var_guard1632, &mut var_guard1633, &mut var_guard1635, &mut var_guard1637);
        Self::stamp_transient_block_71(s, p, param_given, var_guard1631, var_guard1632, var_guard1633);
        ...
        Self::stamp_transient_block_76(s, p, param_given, var_cox0, var_coxb0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlp, &mut var_flg_coovlps, &mut var_guard1752, &mut var_guard1753, &mut var_guard1754, &mut var_guard1756, &mut var_guard1758);
        ...
        Self::stamp_transient_block_81(s, p, var_cox0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlps, &mut var_guard1873, &mut var_guard1874, &mut var_guard1875, &mut var_guard1877, &mut var_guard1879);
        Self::stamp_transient_block_82(s, p, param_given, var_coxb0, var_guard1873, var_guard1874, var_guard1875, var_guard1879, var_uc_nover, &mut var_flg_coovlp);
        ...
        Self::stamp_transient_block_87(s, p, var_cox0, var_uc_nover, var_uc_novers, var_weffcv_nf, &mut var_flg_coovlps, &mut var_guard1994, &mut var_guard1995, &mut var_guard1996, &mut var_guard1998, &mut var_guard2000);
        Self::stamp_transient_block_88(s, p, param_given, var_coxb0, var_guard1994, var_guard1995, var_guard1996, var_guard2000, var_uc_nover, &mut var_flg_coovlp);
