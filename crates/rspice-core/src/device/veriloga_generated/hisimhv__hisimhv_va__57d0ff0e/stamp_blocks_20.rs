...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_101(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) && (s.v[97] <= 150.0)) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_affine_lhs(780, 781, 972, 0.5, 0.0, 726);s.store_div_scaled_product3_indices(334, 972, 725, 726, 0.5, 770, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_102(
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) {s.store_add_scaled_inputs3_indices(2166, 972, 1.0, 972, (-0.5), 780, 1.0);}
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {s.store_div(985, 254, 338);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_106(
        ...
        let mut t6: usize = 0;
        while {
            let t4: f64 = (s.v[421] + 1.0);let t5: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[97] <= t4)) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
        ...
        if (((!s.b[1443]) && s.b[2430]) && (!s.b[2442])) {s.store_scalar(347, 3.0);s.store_scalar(78, 0.0);s.store_offset(99, 116, (-1.0));s.store_sqrt(100, 99);s.store_mul(101, 99, 100);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_109(
        ...
        let mut t9: usize = 0;
        while {
            let t7: f64 = (40.0 + 1.0);let t8: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[98] <= t7)) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
        ...
        if ((!s.b[1443]) && s.b[2430]) {s.store_sub(94, 91, 87);s.copy_ad(790, 349);s.store_div(335, 154, 99);s.store_mul(258, 335, 94);s.store_offset(259, 258, 1.0);s.store_sqrt(260, 259);s.store_mul(261, 260, 259);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_110(
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_111(
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) {s.store_scalar(335, (1.0 - s.v[507]));s.store_add_scaled_inputs_product_indices(168, 790, s.v[507], 87, s.v[507], 335, 91, 1.0);}
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_112(
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if (((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_114(
        ...
        if ((!s.b[1443]) && s.b[2430]) {s.store_div_from_scalar(338, 1.0, 255);s.store_mul(256, 254, 255);s.store_div(335, 256, 257);}
    ...
    pub(super) fn stamp_reactive_block_115(
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2499]) && s.b[2502]) {s.store_scalar(378, (((((20.0 + 1.0)) as f64).powf((p.p297 - 1.0)) * ((20.0 + 1.0) - ((0.5 * p.p297) * 20.0))) * ((1e-12) as f64).powf(p.p297)));s.store_scalar(379, ((((0.5 * p.p297) * (((20.0 + 1.0)) as f64).powf((p.p297 - 1.0))) / 20.0) * ((1e-12) as f64).powf((p.p297 - 2.0))));s.store_add_product3_rhs_indices(335, 378, 379, 369, 369, 1.0);}
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2503]) {s.store_sqrt_add_scaled_square_product(336, 335, 1.0, 334, 344, (4.0 * 0.005));s.store_sub_mixed_ai(337, A::add_scaled_inputs4_offset(s.ad_value(344), 1.0, s.ad_value(335), 0.5, s.ad_value(336), 0.5, s.ad_value(137), 1.0, (((-s.v[160])) + (s.v[498]))), 1438);s.store_offset_mul(338, 154, 337, (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_116(
        s: &mut ReactiveScratch,
    ) {
        if (((!s.b[1443]) && s.b[2430]) && s.b[2503]) {s.store_div_from_scalar(339, 4.0, 143);s.store_offset_mul(335, 338, 339, 1.0);s.store_mul(340, 154, 339);s.store_mul(341, 338, 339);s.store_sqrt_square_offset(782, 335, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(336, 335, 782, 0.5, 0.5);s.store_scaled_add(335, 335, 782, 0.5);}
        ...
        s.b[2508] = ((((4.0 == 1.0) || (4.0 == 2.0)) || (4.0 == 4.0)) || (4.0 == 8.0));s.store_scalar(2508, if s.b[2508] { 1.0 } else { 0.0 });
    }
}
