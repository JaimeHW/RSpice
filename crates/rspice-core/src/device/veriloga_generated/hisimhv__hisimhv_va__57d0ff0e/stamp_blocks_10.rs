...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_160(
        ...
        let mut t8: usize = 0;
        while {
            let t6: f64 = (s.v[421] + 1.0);let t7: f64 = if (((s.v[2625] != 0.0) && s.b[2843]) && (s.v[97] <= t6)) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
            t8 += 1;
            if t8 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t8, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (s.b[2869] && s.b[2873]) {
        ...
        s.store_scalar(2623, ta);
        if (s.b[2869] && s.b[2873]) {s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_162(
        ...
        if (s.b[2869] && s.b[2873]) {s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
    ...
    if ((s.b[2871] && (!(s.b[2869] || s.b[2870]))) && s.b[2875]) {
        ...
        s.store_scalar(2626, td);
        if ((s.b[2871] && (!(s.b[2869] || s.b[2870]))) && s.b[2875]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
    ...
    pub(super) fn stamp_transient_block_163(
        ...
        let (t15,) = {
    if (s.v[2625] != 0.0) {
        let t12: f64 = (-s.v[397]);let t13: f64 = (10.0 * 2.220446049250313e-16);let t14: f64 = (t12 + t13);
        (t14,)
    } else {
        (s.v[403],)
    }
};
        s.store_scalar(403, t15);
        ...
        let mut t17: usize = 0;
        while {
            let t16: f64 = if (((s.v[2625] != 0.0) && (!s.b[2900])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t16 != 0.0
        } {
            t17 += 1;
    ...
    if (((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) {
        ...
        if (((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) {s.store_scalar(770, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_164(
        ...
        if (((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) {s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) && s.b[2903]) {
        ...
        s.store_scalar(720, t1a);s.b[2904] = (1.0 == 2.0);s.store_scalar(2904, if s.b[2904] { 1.0 } else { 0.0 });
        let (t1b,) = {
    if ((((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) && (!s.b[2903])) && s.b[2904]) {
        ...
        s.store_scalar(720, t1b);s.b[2905] = (1.0 == 4.0);s.store_scalar(2905, if s.b[2905] { 1.0 } else { 0.0 });
        let (t1c,) = {
    if (((((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) && (!s.b[2903])) && (!s.b[2904])) && s.b[2905]) {
        ...
        s.store_scalar(720, t1c);s.b[2906] = (1.0 == 8.0);s.store_scalar(2906, if s.b[2906] { 1.0 } else { 0.0 });
        let (t1d,) = {
    ...
    if ((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) {
        ...
        while {
            let t21: f64 = if (((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t21 != 0.0
        } {
            t22 += 1;
    ...
    if ((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2901]) && s.b[2902]) {
        ...
        let (t26,) = {
    if ((s.v[2625] != 0.0) && (s.v[406] != 0.0)) {
        let t23: f64 = (-s.v[397]);let t24: f64 = (10.0 * 2.220446049250313e-16);let t25: f64 = (t23 + t24);
        (t25,)
    } else {
        (s.v[403],)
    }
};
        s.store_scalar(403, t26);s.b[2907] = (s.v[402] < s.v[403]);s.store_scalar(2907, if s.b[2907] { 1.0 } else { 0.0 });
    ...
    if (((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2911]) && s.b[2913]) && s.b[2914]) && s.b[2915]) && s.b[2916]) {
        ...
        s.store_scalar(720, t29);s.b[2917] = (2.0 == 2.0);s.store_scalar(2917, if s.b[2917] { 1.0 } else { 0.0 });
        let (t2a,) = {
    if ((((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2911]) && s.b[2913]) && s.b[2914]) && s.b[2915]) && (!s.b[2916])) && s.b[2917]) {
        ...
        s.store_scalar(720, t2a);s.b[2918] = (2.0 == 4.0);s.store_scalar(2918, if s.b[2918] { 1.0 } else { 0.0 });
        let (t2b,) = {
    if (((((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2911]) && s.b[2913]) && s.b[2914]) && s.b[2915]) && (!s.b[2916])) && (!s.b[2917])) && s.b[2918]) {
        ...
        s.store_scalar(720, t2b);s.b[2919] = (2.0 == 8.0);s.store_scalar(2919, if s.b[2919] { 1.0 } else { 0.0 });
        let (t2c,) = {
    ...
    if ((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2911]) && s.b[2913]) && s.b[2914]) && s.b[2915]) {
        ...
        s.store_scalar(719, t2d);let mut t31: usize = 0;
        while {
            let t30: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2911]) && s.b[2913]) && s.b[2914]) && s.b[2915]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t30 != 0.0
        } {
            t31 += 1;
    ...
    if ((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2920]) && s.b[2925]) {
        let t32: f64 = (s.v[2889] + 1.0);
        (t32,)
    } else {
        (s.v[2889],)
    }
};
        s.store_scalar(2889, t33);
    ...
    if ((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2930]) && s.b[2931]) && s.b[2932]) {
        ...
        s.store_scalar(720, t36);s.b[2933] = (2.0 == 2.0);s.store_scalar(2933, if s.b[2933] { 1.0 } else { 0.0 });
        let (t37,) = {
    if (((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2930]) && s.b[2931]) && (!s.b[2932])) && s.b[2933]) {
        ...
        s.store_scalar(720, t37);s.b[2934] = (2.0 == 4.0);s.store_scalar(2934, if s.b[2934] { 1.0 } else { 0.0 });
        let (t38,) = {
    if ((((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2930]) && s.b[2931]) && (!s.b[2932])) && (!s.b[2933])) && s.b[2934]) {
        ...
        s.store_scalar(720, t38);s.b[2935] = (2.0 == 8.0);s.store_scalar(2935, if s.b[2935] { 1.0 } else { 0.0 });
        let (t39,) = {
    ...
    if (((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2930]) && s.b[2931]) {
        ...
        while {
            let t3d: f64 = if ((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2930]) && s.b[2931]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t3d != 0.0
        } {
            t3e += 1;
    ...
    if ((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2929]) && s.b[2936]) {
        let t3f: f64 = (s.v[2889] + 2.0);
        (t3f,)
    } else {
        (s.v[2889],)
    }
};
        s.store_scalar(2889, t40);
    ...
    if ((((s.v[2625] != 0.0) && (!s.b[2907])) && (!s.b[2929])) && s.b[2937]) {
        let t41: f64 = (s.v[2889] + 2.0);
        (t41,)
    } else {
        (s.v[2889],)
    }
};
        s.store_scalar(2889, t42);s.b[2938] = (s.v[2889] >= 2.0);s.store_scalar(2938, if s.b[2938] { 1.0 } else { 0.0 });
    ...
    if (((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2938]) && s.b[2939]) && s.b[2940]) && s.b[2941]) && s.b[2942]) {
        ...
        s.store_scalar(720, t45);s.b[2943] = (2.0 == 2.0);s.store_scalar(2943, if s.b[2943] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if ((((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2938]) && s.b[2939]) && s.b[2940]) && s.b[2941]) && (!s.b[2942])) && s.b[2943]) {
        ...
        s.store_scalar(720, t46);s.b[2944] = (2.0 == 4.0);s.store_scalar(2944, if s.b[2944] { 1.0 } else { 0.0 });
        let (t47,) = {
    if (((((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2938]) && s.b[2939]) && s.b[2940]) && s.b[2941]) && (!s.b[2942])) && (!s.b[2943])) && s.b[2944]) {
        ...
        s.store_scalar(720, t47);s.b[2945] = (2.0 == 8.0);s.store_scalar(2945, if s.b[2945] { 1.0 } else { 0.0 });
        let (t48,) = {
    ...
    if ((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2938]) && s.b[2939]) && s.b[2940]) && s.b[2941]) {
        ...
        while {
            let t4c: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2938]) && s.b[2939]) && s.b[2940]) && s.b[2941]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4c != 0.0
        } {
            t4d += 1;
    ...
    pub(super) fn stamp_transient_block_170(
        ...
        let mut t57: usize = 0;
        while {
            let t55: f64 = (s.v[421] + 1.0);let t56: f64 = if ((((s.v[2625] != 0.0) && (!s.b[2907])) && s.b[2946]) && (s.v[97] <= t55)) { 1.0 } else { 0.0 };
            t56 != 0.0
        } {
            t57 += 1;
    ...
    pub(super) fn stamp_transient_block_172(
        ...
        let mut t62: usize = 0;
        while {
            let t60: f64 = (s.v[421] + 1.0);let t61: f64 = if (((s.v[2625] != 0.0) && s.b[2964]) && (s.v[97] <= t60)) { 1.0 } else { 0.0 };
            t61 != 0.0
        } {
            t62 += 1;
            if t62 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t62, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    pub(super) fn stamp_transient_block_175(
        ...
        let (t6f,) = {
    if (s.v[2625] != 0.0) {
        let t6c: f64 = (-s.v[397]);let t6d: f64 = (10.0 * 2.220446049250313e-16);let t6e: f64 = (t6c + t6d);
        (t6e,)
    } else {
        (s.v[403],)
    }
};
        s.store_scalar(403, t6f);
        ...
        let mut t71: usize = 0;
        while {
            let t70: f64 = if (((s.v[2625] != 0.0) && (!s.b[3021])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t70 != 0.0
        } {
            t71 += 1;
            if t71 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t71, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
