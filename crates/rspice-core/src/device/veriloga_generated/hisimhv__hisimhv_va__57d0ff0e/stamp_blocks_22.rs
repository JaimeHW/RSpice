...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_110(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[421] + 1.0);let t1: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[97] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
            t2 += 1;
    ...
    pub(super) fn stamp_reactive_block_113(
        ...
        let mut t5: usize = 0;
        while {
            let t3: f64 = (40.0 + 1.0);let t4: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[98] <= t3)) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_114(
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_115(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
    ...
    pub(super) fn stamp_reactive_block_116(
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
    ...
    pub(super) fn stamp_reactive_block_117(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
    ...
    pub(super) fn stamp_reactive_block_121(
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if (((((!s.b[1443]) && s.b[2430]) && s.b[2503]) && s.b[2508]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
