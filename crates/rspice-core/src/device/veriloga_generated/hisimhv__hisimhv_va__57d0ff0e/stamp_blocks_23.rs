...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_125(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((!s.b[1443]) && s.b[2519]) && s.b[2568]) && s.b[2569]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_reactive_block_126(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((s.b[2574] && s.b[2575]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_reactive_block_127(
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((!s.b[2580]) && s.b[2581]) && s.b[2582]) && s.b[2583]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_128(
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((s.b[2595] && s.b[2596]) && s.b[2597]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_131(
        ...
        if ((!s.b[2619]) && s.b[2620]) {s.store_scalar(339, 0.0);}
        ...
        if ((!s.b[2619]) && (!s.b[2621])) {s.store_exp(335, 334);s.store_div_from_scalar(337, 1.0, 192);s.store_scale(336, 337, (s.v[511] * (1.6021918e-19 * s.v[632])));}
        if (!s.b[2619]) {s.store_neg(206, 792);}
        s.b[2622] = (s.v[206] > 0.0);s.store_scalar(2622, if s.b[2622] { 1.0 } else { 0.0 });
        if ((!s.b[2619]) && s.b[2622]) {s.store_square(336, 206);s.store_mul(338, 336, 206);s.store_offset(334, 338, 0.5);s.store_div(339, 338, 334);s.store_div_square_rhs_mixed_ai(341, A::add_scaled_products(s.ad_value(336), s.ad_value(334), 3.0, s.ad_value(338), s.ad_value(336), (-3.0)), 334);}
        s.store_scalar(2623, 0.0);s.store_scalar(2626, 0.0);s.store_scalar(2625, 0.0);s.store_scalar(406, 0.0);s.store_scalar(2625, 0.0);s.b[2627] = (1.0 == 1.0);s.store_scalar(2627, if s.b[2627] { 1.0 } else { 0.0 });s.b[2628] = (1.0 == 2.0);s.store_scalar(2628, if s.b[2628] { 1.0 } else { 0.0 });s.b[2629] = (1.0 == 3.0);s.store_scalar(2629, if s.b[2629] { 1.0 } else { 0.0 });s.b[2630] = (1.0 == 4.0);s.store_scalar(2630, if s.b[2630] { 1.0 } else { 0.0 });s.b[2631] = (((p[36] == 1.0) && (p[66] > 0.0)) && (s.v[460] > 0.0));s.store_scalar(2631, if s.b[2631] { 1.0 } else { 0.0 });
        if (s.b[2627] && s.b[2631]) {s.store_scalar(2625, 1.0);s.store_scalar(2623, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
        s.b[2632] = (((((p[36] == 1.0) && (p[66] > 0.0)) && (s.v[460] > 0.0)) && (s.v[526] != 0.0)) && (p[55] != 1.0));s.store_scalar(2632, if s.b[2632] { 1.0 } else { 0.0 });
        if ((s.b[2628] && (!s.b[2627])) && s.b[2632]) {s.store_scalar(2625, 1.0);s.store_sub(395, 734, 735);s.store_neg(396, 735);}
        s.b[2633] = (((p[35] == 1.0) && (p[63] > 0.0)) && (s.v[459] > 0.0));s.store_scalar(2633, if s.b[2633] { 1.0 } else { 0.0 });
        if ((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) {s.store_scalar(2625, 1.0);s.store_scalar(2626, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        s.b[2634] = (((s.v[407] < 0.0) && (p[432] > 0.0)) && (p[55] == 1.0));s.store_scalar(2634, if s.b[2634] { 1.0 } else { 0.0 });
        if (((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) && s.b[2634]) {s.store_neg(407, 407);s.store_scalar(335, p[63]);s.store_offset_div_scaled_product_indices(996, 335, 335, 1.0, 651, 1.0, (-p[137]));}
        s.b[2635] = (p[113] > 0.0);s.store_scalar(2635, if s.b[2635] { 1.0 } else { 0.0 });s.b[2636] = ((s.v[396] == 0.0) || (p[113] <= 0.0));s.store_scalar(2636, if s.b[2636] { 1.0 } else { 0.0 });
        ...
        if (((((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) && s.b[2634]) && s.b[2635]) && (!s.b[2636])) {s.store_mul(784, 783, 396);s.store_offset_powf_ad(781, A::div(s.ad_value(784), s.ad_value(996)), p[113], 1.0);s.store_powf(782, 781, (1.0 / p[113]));s.store_div_scaled_product_indices(396, 783, 784, 1.0, 782, 1.0);}
        if ((((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) && s.b[2634]) && s.b[2635]) {s.store_sqrt_offset_square_offset(782, 396, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(396), p[137]), 782, 0.5);}
        ...
        if ((((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) && s.b[2634]) && s.b[2635]) {s.store_scaled_sqrt_mul(600, 651, 336, p[432]);s.store_sub(407, 407, 600);}
        s.b[2638] = (((((p[35] == 1.0) && (p[63] > 0.0)) && (s.v[459] > 0.0)) && (s.v[526] != 0.0)) && (p[55] != 1.0));s.store_scalar(2638, if s.b[2638] { 1.0 } else { 0.0 });
        if ((s.b[2630] && (!((s.b[2627] || s.b[2628]) || s.b[2629]))) && s.b[2638]) {s.store_scalar(2625, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_132(
        ...
        if (s.v[2625] != 0.0) {s.store_scalar(2646, 0.4);s.store_scalar(2647, 0.0);s.store_scalar(223, 0.0);s.store_scalar(214, 0.0);s.store_scalar(216, 0.0);s.store_scalar(232, 0.0);s.store_scalar(236, 0.0);s.store_scalar(233, 0.0);s.store_scalar(217, 0.0);s.store_scalar(420, 0.0);s.store_scalar(215, 0.0);s.store_scalar(447, 0.0);s.store_scalar(445, 0.0);s.store_scalar(446, 0.0);s.store_scalar(79, (-1.0));s.store_scalar(2648, 0.0);s.store_scalar(2649, 0.0);s.store_mul_scaled_ln_ad_rhs(2644, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(2644), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2625] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if (s.v[2625] != 0.0) {s.store_div(212, 410, 413);s.store_square(213, 212);s.store_sub_from_scalar(402, s.v[458], 395);s.store_sub_from_scalar(403, (10.0 * 2.220446049250313e-16), 397);s.store_scalar(2640, 0.0);s.store_primal_scale(2641, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
    ...
    pub(super) fn stamp_reactive_block_133(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((s.v[2625] != 0.0) && (!s.b[2658])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
        ...
        if (((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) && s.b[2661]) {s.store_scalar(720, 1.0);}
        s.b[2662] = (1.0 == 2.0);s.store_scalar(2662, if s.b[2662] { 1.0 } else { 0.0 });
        if ((((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) && (!s.b[2661])) && s.b[2662]) {s.store_scalar(720, 2.0);}
        s.b[2663] = (1.0 == 4.0);s.store_scalar(2663, if s.b[2663] { 1.0 } else { 0.0 });
        if (((((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) && (!s.b[2661])) && (!s.b[2662])) && s.b[2663]) {s.store_scalar(720, 3.0);}
        s.b[2664] = (1.0 == 8.0);s.store_scalar(2664, if s.b[2664] { 1.0 } else { 0.0 });
        if ((((((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) && (!s.b[2661])) && (!s.b[2662])) && (!s.b[2663])) && s.b[2664]) {s.store_scalar(720, 4.0);}
        if ((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) {s.store_scalar(719, 0.0);}
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
            ...
            if ((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[2659]) && s.b[2660]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        s.b[2665] = (s.v[402] < s.v[403]);s.store_scalar(2665, if s.b[2665] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_135(
        ...
        if (((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) {s.store_add_scaled_inputs3_indices(781, 445, 1.0, 446, (-1.0), 446, 0.2);s.store_square(722, 781);s.store_scaled_mul(723, 446, 446, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && s.b[2674]) {s.store_scalar(720, 1.0);}
        s.b[2675] = (2.0 == 2.0);s.store_scalar(2675, if s.b[2675] { 1.0 } else { 0.0 });
        if ((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && (!s.b[2674])) && s.b[2675]) {s.store_scalar(720, 2.0);}
        s.b[2676] = (2.0 == 4.0);s.store_scalar(2676, if s.b[2676] { 1.0 } else { 0.0 });
        if (((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && (!s.b[2674])) && (!s.b[2675])) && s.b[2676]) {s.store_scalar(720, 3.0);}
        s.b[2677] = (2.0 == 8.0);s.store_scalar(2677, if s.b[2677] { 1.0 } else { 0.0 });
        if ((((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && (!s.b[2674])) && (!s.b[2675])) && (!s.b[2676])) && s.b[2677]) {s.store_scalar(720, 4.0);}
        if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) {s.store_scalar(719, 0.0);}
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
            ...
            if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_136(
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2678]) && s.b[2683]) {s.store_primal_offset(2647, 2647, 1.0);s.copy_ad(116, 447);}
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) {s.store_add_scaled_inputs3_indices(781, 2685, 1.0, 386, (-1.0), 386, 0.1);s.store_square(722, 781);s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_137(
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) {s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) && s.b[2690]) {s.store_scalar(720, 1.0);}
        s.b[2691] = (2.0 == 2.0);s.store_scalar(2691, if s.b[2691] { 1.0 } else { 0.0 });
        if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) && (!s.b[2690])) && s.b[2691]) {s.store_scalar(720, 2.0);}
        s.b[2692] = (2.0 == 4.0);s.store_scalar(2692, if s.b[2692] { 1.0 } else { 0.0 });
        if ((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) && (!s.b[2690])) && (!s.b[2691])) && s.b[2692]) {s.store_scalar(720, 3.0);}
        s.b[2693] = (2.0 == 8.0);s.store_scalar(2693, if s.b[2693] { 1.0 } else { 0.0 });
        if (((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) && (!s.b[2690])) && (!s.b[2691])) && (!s.b[2692])) && s.b[2693]) {s.store_scalar(720, 4.0);}
        if (((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) {s.store_scalar(719, 0.0);}
        let mut tf: usize = 0;
        while {
            let te: f64 = if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
            ...
            if (((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2688]) && s.b[2689]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2687]) && s.b[2694]) {s.store_primal_offset(2647, 2647, 2.0);}
        if (((s.v[2625] != 0.0) && (!s.b[2665])) && (!s.b[2687])) {
            if (s.v[2685] <= s.v[386]) {
                s.copy_ad(335, 2685);
            } else {
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[2665])) && (!s.b[2687])) && s.b[2695]) {s.store_primal_offset(2647, 2647, 2.0);}
        s.b[2696] = (s.v[2647] >= 2.0);s.store_scalar(2696, if s.b[2696] { 1.0 } else { 0.0 });
        ...
        if (((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) {s.store_offset_sub(781, 404, 2686, 0.1);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) && s.b[2700]) {s.store_scalar(720, 1.0);}
        s.b[2701] = (2.0 == 2.0);s.store_scalar(2701, if s.b[2701] { 1.0 } else { 0.0 });
        if ((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) && (!s.b[2700])) && s.b[2701]) {s.store_scalar(720, 2.0);}
        s.b[2702] = (2.0 == 4.0);s.store_scalar(2702, if s.b[2702] { 1.0 } else { 0.0 });
        if (((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) && (!s.b[2700])) && (!s.b[2701])) && s.b[2702]) {s.store_scalar(720, 3.0);}
        s.b[2703] = (2.0 == 8.0);s.store_scalar(2703, if s.b[2703] { 1.0 } else { 0.0 });
        if ((((((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) && (!s.b[2700])) && (!s.b[2701])) && (!s.b[2702])) && s.b[2703]) {s.store_scalar(720, 4.0);}
        if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) {s.store_scalar(719, 0.0);}
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
            t11 += 1;
            ...
            if ((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2696]) && s.b[2697]) && s.b[2698]) && s.b[2699]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
    ...
    pub(super) fn stamp_reactive_block_138(
        ...
        if (((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) {s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2641)), s.ad_value(155)), 2.0);}
        ...
        if (((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 2641, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_139(
        ...
        let mut t14: usize = 0;
        while {
            let t12: f64 = (s.v[421] + 1.0);let t13: f64 = if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) && (s.v[97] <= t12)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
            t14 += 1;
            if t14 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("reactive stamp", t14, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
            ...
            if ((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) && s.b[2718]) {s.store_scalar(97, (s.v[421] + 1.0));}
            ...
            if (((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) && (!s.b[2718])) && s.b[2720]) {s.store_scalar(79, 1.0);}
            if (((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2704]) {s.store_primal_offset(97, 97, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_140(
        ...
        if ((s.v[2625] != 0.0) && s.b[2722]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 2648);s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2641)), s.ad_value(155)), 2.0);}
        ...
        if ((s.v[2625] != 0.0) && s.b[2722]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 2641, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_scalar(97, 1.0);}
    }
}
