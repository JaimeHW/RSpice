...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_206(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && (s.v[719] < p[442])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_reactive_block_207(
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3381]) && s.b[3382]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3387]) && s.b[3388]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
