...
impl Instance {
    ...
    if (((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) {
        ...
        while {
            let t10: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && (s.v[719] < p[442])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    if (((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && s.b[3374]) {
        ...
        s.store_scalar(720, t12);s.b[3375] = (p[442] == 2.0);s.store_scalar(3375, if s.b[3375] { 1.0 } else { 0.0 });
        let (t13,) = {
    if ((((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (!s.b[3374])) && s.b[3375]) {
        ...
        s.store_scalar(720, t13);s.b[3376] = (p[442] == 4.0);s.store_scalar(3376, if s.b[3376] { 1.0 } else { 0.0 });
        let (t14,) = {
    if (((((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (!s.b[3374])) && (!s.b[3375])) && s.b[3376]) {
        ...
        s.store_scalar(720, t14);s.b[3377] = (p[442] == 8.0);s.store_scalar(3377, if s.b[3377] { 1.0 } else { 0.0 });
        let (t15,) = {
    ...
    pub(super) fn stamp_transient_block_215(
        ...
        if (s.b[3336] && (!s.b[3356])) {s.store_offset_sub(336, 3352, 3353, p[137]);s.store_sqrt_square_offset(782, 336, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_transient_block_217(
        ...
        s.store_scaled_mul(0, 949, 134, p[87]);s.store_scalar(22, A::ddx_projection(&s.ad_value(18), Some(6), None));s.store_scale(22, 22, p[87]);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_218(
        ...
        s.store_scalar(23, A::ddx_projection(&s.ad_value(18), Some(8), None));s.store_scale(23, 23, p[87]);s.b[3407] = (s.v[949] == 1.0);s.store_scalar(3407, if s.b[3407] { 1.0 } else { 0.0 });
