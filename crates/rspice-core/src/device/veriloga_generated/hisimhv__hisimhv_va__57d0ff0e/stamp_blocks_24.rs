...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_165(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((s.v[2625] != 0.0) && (s.v[406] != 0.0)) && s.b[3022]) && s.b[3023]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
        ...
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3031]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_166(
        ...
        s.b[3033] = (p.p33 == 2.0);s.store_scalar(3033, if s.b[3033] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3032]) {s.store_sub(444, 444, 447);s.store_add_scaled_inputs(444, 444, 1.0, 154, 0.1);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_167(
        ...
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3032]) {s.store_sub_ad(335, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), A::ln(A::mul(s.ad_value(405), s.ad_value(334))));s.store_add_scaled_product_indices(446, 335, 1.0, 154, 397, 1.0);}
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3032]) {
            if (s.v[446] >= 0.0) {
            } else {
        ...
        s.b[3034] = (p.p33 == 2.0);s.store_scalar(3034, if s.b[3034] { 1.0 } else { 0.0 });s.b[3035] = ((s.v[445] > (s.v[446] - (0.2 * s.v[446]))) && ((0.2 * s.v[446]) >= 0.0));s.store_scalar(3035, if s.b[3035] { 1.0 } else { 0.0 });
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3032]) && s.b[3034]) && s.b[3035]) && s.b[3036]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
        ...
        s.b[3041] = (p.p33 == 1.0);s.store_scalar(3041, if s.b[3041] { 1.0 } else { 0.0 });
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3041]) && s.b[3042]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3041]) && (!s.b[3042])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3041]) && (!s.b[3042])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3041]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        ...
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3041]) {s.copy_ad(386, 336);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_168(
        ...
        s.b[3050] = (p.p33 == 2.0);s.store_scalar(3050, if s.b[3050] { 1.0 } else { 0.0 });s.b[3051] = ((s.v[3048] > (s.v[386] - (s.v[386] * 0.1))) && ((s.v[386] * 0.1) >= 0.0));s.store_scalar(3051, if s.b[3051] { 1.0 } else { 0.0 });
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if ((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3050]) && s.b[3051]) && s.b[3052]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3050]) && s.b[3057]) {s.store_primal_offset(3010, 3010, 2.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_169(
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && (!s.b[3050])) && s.b[3058]) {s.store_primal_offset(3010, 3010, 2.0);}
        s.b[3059] = (s.v[3010] >= 2.0);s.store_scalar(3059, if s.b[3059] { 1.0 } else { 0.0 });
        ...
        s.b[3060] = (p.p33 == 2.0);s.store_scalar(3060, if s.b[3060] { 1.0 } else { 0.0 });s.b[3061] = ((s.v[404] > (s.v[3049] - 0.1)) && (0.1 >= 0.0));s.store_scalar(3061, if s.b[3061] { 1.0 } else { 0.0 });
        if (((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) {s.store_offset_sub(781, 404, 3049, 0.1);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) && s.b[3063]) {s.store_scalar(720, 1.0);}
        s.b[3064] = (2.0 == 2.0);s.store_scalar(3064, if s.b[3064] { 1.0 } else { 0.0 });
        if ((((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) && (!s.b[3063])) && s.b[3064]) {s.store_scalar(720, 2.0);}
        s.b[3065] = (2.0 == 4.0);s.store_scalar(3065, if s.b[3065] { 1.0 } else { 0.0 });
        if (((((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) && (!s.b[3063])) && (!s.b[3064])) && s.b[3065]) {s.store_scalar(720, 3.0);}
        s.b[3066] = (2.0 == 8.0);s.store_scalar(3066, if s.b[3066] { 1.0 } else { 0.0 });
        if ((((((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) && (!s.b[3063])) && (!s.b[3064])) && (!s.b[3065])) && s.b[3066]) {s.store_scalar(720, 4.0);}
        if ((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) {s.store_scalar(719, 0.0);}
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;assert!(t7 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3059]) && s.b[3060]) && s.b[3061]) && s.b[3062]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        s.b[3067] = (p.p33 == 1.0);s.store_scalar(3067, if s.b[3067] { 1.0 } else { 0.0 });
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) {s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3004)), s.ad_value(155)), 2.0);}
        s.b[3068] = (s.v[411] > 0.0);s.store_scalar(3068, if s.b[3068] { 1.0 } else { 0.0 });
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && s.b[3068]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && (!s.b[3068])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && (!s.b[3068])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_170(
        ...
        if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3004, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_171(
        ...
        let mut ta: usize = 0;
        while {
            let t8: f64 = (s.v[421] + 1.0);let t9: f64 = if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && (s.v[97] <= t8)) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ...
            if ((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && s.b[3081]) {s.store_scalar(97, (s.v[421] + 1.0));}
            ...
            if (((((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) && (!s.b[3081])) && s.b[3083]) {s.store_scalar(79, 1.0);}
            if (((s.v[2625] != 0.0) && (!s.b[3028])) && s.b[3067]) {s.store_primal_offset(97, 97, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_172(
        ...
        s.b[3085] = (p.p33 == 4.0);s.store_scalar(3085, if s.b[3085] { 1.0 } else { 0.0 });
        if ((s.v[2625] != 0.0) && s.b[3085]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 3011);s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3004)), s.ad_value(155)), 2.0);}
        s.b[3086] = (s.v[411] > 0.0);s.store_scalar(3086, if s.b[3086] { 1.0 } else { 0.0 });
        if (((s.v[2625] != 0.0) && s.b[3085]) && s.b[3086]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if (((s.v[2625] != 0.0) && s.b[3085]) && (!s.b[3086])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if (((s.v[2625] != 0.0) && s.b[3085]) && (!s.b[3086])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if ((s.v[2625] != 0.0) && s.b[3085]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        ...
        if ((s.v[2625] != 0.0) && s.b[3085]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3004, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_173(
        ...
        let mut td: usize = 0;
        while {
            let tb: f64 = (s.v[421] + 1.0);let tc: f64 = if (((s.v[2625] != 0.0) && s.b[3085]) && (s.v[97] <= tb)) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            ...
            if (((s.v[2625] != 0.0) && s.b[3085]) && s.b[3096]) {s.store_scalar(97, (s.v[421] + 1.0));}
            ...
            if ((((s.v[2625] != 0.0) && s.b[3085]) && (!s.b[3096])) && s.b[3098]) {s.store_primal_offset(79, 79, 2.0);}
            if ((s.v[2625] != 0.0) && s.b[3085]) {s.store_primal_offset(97, 97, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_174(
        ...
        s.b[3101] = (p.p55 == 0.0);s.store_scalar(3101, if s.b[3101] { 1.0 } else { 0.0 });s.b[3102] = (p.p50 == 0.0);s.store_scalar(3102, if s.b[3102] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2625] != 0.0) && s.b[3100]) && s.b[3101]) {s.store_sqrt_offset_square_offset(782, 3005, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(3005), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(3005), p.p137), 782, 0.5);}
        ...
        if (((s.v[2625] != 0.0) && s.b[3100]) && s.b[3101]) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_add_scaled_inputs3_indices(781, 407, 1.0, 600, (-1.0), 407, (-0.1));s.store_scaled_mul(782, 407, 407, (4.0 * 0.1));}
        ...
        s.b[3104] = (4.0 == 1.0);s.store_scalar(3104, if s.b[3104] { 1.0 } else { 0.0 });s.b[3105] = (4.0 == 2.0);s.store_scalar(3105, if s.b[3105] { 1.0 } else { 0.0 });s.b[3106] = (4.0 == 3.0);s.store_scalar(3106, if s.b[3106] { 1.0 } else { 0.0 });s.b[3107] = (4.0 == 4.0);s.store_scalar(3107, if s.b[3107] { 1.0 } else { 0.0 });s.b[3108] = (p.p55 == 1.0);s.store_scalar(3108, if s.b[3108] { 1.0 } else { 0.0 });
        ...
        s.b[3109] = (p.p55 == 1.0);s.store_scalar(3109, if s.b[3109] { 1.0 } else { 0.0 });
        ...
        s.b[3110] = (p.p430 == 0.0);s.store_scalar(3110, if s.b[3110] { 1.0 } else { 0.0 });
        ...
        s.b[3111] = (p.p430 > 0.0);s.store_scalar(3111, if s.b[3111] { 1.0 } else { 0.0 });
        if s.b[3111] {s.store_scalar(406, 1.0);}
        s.b[3112] = (((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] > 0.0));s.store_scalar(3112, if s.b[3112] { 1.0 } else { 0.0 });
        if (s.b[3111] && s.b[3112]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, 0.0);s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_scalar(3120, 0.4);s.store_scalar(3121, 0.0);s.store_scalar(223, 0.0);s.store_scalar(214, 0.0);s.store_scalar(216, 0.0);s.store_scalar(232, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_175(
        ...
        if ((s.b[3111] && s.b[3112]) && s.b[3126]) {s.store_scalar(3119, p.p338);}
        s.b[3127] = param_given[339];s.store_scalar(3127, if s.b[3127] { 1.0 } else { 0.0 });
        if ((s.b[3111] && s.b[3112]) && s.b[3127]) {s.store_scalar(3120, p.p339);}
        ...
        s.b[3130] = (p.p38 == 1.0);s.store_scalar(3130, if s.b[3130] { 1.0 } else { 0.0 });
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if (((s.b[3111] && s.b[3112]) && (!s.b[3132])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
        ...
        if ((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) {s.store_offset_scaled(781, 402, (-0.5), (((-0.5)) + ((-1.0))));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_176(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) {s.store_scalar(782, (4.0 * 0.5));}
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_177(
        ...
        s.b[3143] = (p.p33 > 0.0);s.store_scalar(3143, if s.b[3143] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_178(
        ...
        s.b[3144] = (p.p33 == 2.0);s.store_scalar(3144, if s.b[3144] { 1.0 } else { 0.0 });
        ...
        s.b[3145] = (p.p33 == 2.0);s.store_scalar(3145, if s.b[3145] { 1.0 } else { 0.0 });s.b[3146] = ((s.v[445] > (s.v[446] - (0.2 * s.v[446]))) && ((0.2 * s.v[446]) >= 0.0));s.store_scalar(3146, if s.b[3146] { 1.0 } else { 0.0 });
        ...
        let mut t13: usize = 0;
        while {
            let t12: f64 = if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t12 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_179(
        ...
        s.b[3152] = (p.p33 == 1.0);s.store_scalar(3152, if s.b[3152] { 1.0 } else { 0.0 });
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && s.b[3153]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3153])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3153])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        ...
        s.b[3161] = (p.p33 == 2.0);s.store_scalar(3161, if s.b[3161] { 1.0 } else { 0.0 });s.b[3162] = ((s.v[3159] > (s.v[386] - (s.v[386] * 0.1))) && ((s.v[386] * 0.1) >= 0.0));s.store_scalar(3162, if s.b[3162] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_180(
        ...
        let mut t15: usize = 0;
        while {
            let t14: f64 = if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t14 != 0.0
        } {
        ...
        s.b[3171] = (p.p33 == 2.0);s.store_scalar(3171, if s.b[3171] { 1.0 } else { 0.0 });s.b[3172] = ((s.v[404] > (s.v[3160] - 0.1)) && (0.1 >= 0.0));s.store_scalar(3172, if s.b[3172] { 1.0 } else { 0.0 });
        ...
        let mut t17: usize = 0;
        while {
            let t16: f64 = if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t16 != 0.0
        } {
        ...
        s.b[3178] = (p.p33 == 1.0);s.store_scalar(3178, if s.b[3178] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) {s.store_scalar(79, 0.0);}
    }
}
