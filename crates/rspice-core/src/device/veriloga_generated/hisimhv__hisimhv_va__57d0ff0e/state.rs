...
pub struct Instance {
    ...
    pub(crate) scalar_static_f64: Box<[f64; 189]>,
...
impl Instance {
    ...
    pub fn new(nodes: &[usize]) -> Self {
        ...
        let mut instance = Self {
            ...
            scalar_static_f64: boxed_zero_f64_array::<189>(),
    ...
    fn recompute_instance_static(&mut self) {
        ...
        self.scalar_static_f64[71]=(if self.scalar_static_bool[1]{1.0}else{0.0});
        self.scalar_static_f64[72]=p.p5;
        self.scalar_static_f64[73]=p.p4;
        self.scalar_static_f64[74]=(3.0*self.scalar_static_f64[73]);
        self.scalar_static_f64[75]=(self.scalar_static_f64[53]/self.scalar_static_f64[74]);
        self.scalar_static_f64[76]=(self.scalar_static_f64[72]+self.scalar_static_f64[75]);
        self.scalar_static_f64[77]=(if (self.scalar_static_f64[71]!=0.0){self.scalar_static_f64[76]}else{self.scalar_static_f64[68]});
        self.scalar_static_f64[78]=(if (self.scalar_static_f64[71]!=0.0){self.scalar_static_f64[28]}else{self.scalar_static_f64[69]});
        self.scalar_static_f64[79]=(self.scalar_static_f64[1]*self.scalar_static_f64[77]);
        self.scalar_static_f64[80]=(self.scalar_static_f64[73]*self.scalar_static_f64[78]);
        self.scalar_static_f64[81]=(self.scalar_static_f64[21]*self.scalar_static_f64[80]);
        self.scalar_static_f64[82]=(self.scalar_static_f64[79]/self.scalar_static_f64[81]);
        self.scalar_static_f64[83]=(if (self.scalar_static_f64[71]!=0.0){self.scalar_static_f64[82]}else{0.0});
        self.scalar_static_bool[2]=(self.scalar_static_f64[83]>0.001);
        self.scalar_static_f64[84]=(if self.scalar_static_bool[2]{1.0}else{0.0});
        self.scalar_static_bool[3]=((self.scalar_static_f64[71]!=0.0)&&(self.scalar_static_f64[84]!=0.0));
        self.scalar_static_f64[85]=(1.0/self.scalar_static_f64[83]);
        self.scalar_static_f64[86]=(if self.scalar_static_bool[3]{self.scalar_static_f64[85]}else{self.scalar_static_f64[83]});
        self.scalar_static_bool[4]=(!(self.scalar_static_f64[84]!=0.0));
        self.scalar_static_bool[5]=((self.scalar_static_f64[71]!=0.0)&&self.scalar_static_bool[4]);
        self.scalar_static_f64[87]=(if self.scalar_static_bool[5]{1000.0}else{self.scalar_static_f64[86]});
        self.scalar_static_bool[6]=(!(self.scalar_static_f64[71]!=0.0));
        self.scalar_static_f64[88]=p.p444;
        self.scalar_static_f64[89]=(1.0/self.scalar_static_f64[88]);
        self.scalar_static_f64[90]=(if self.scalar_static_bool[6]{self.scalar_static_f64[89]}else{self.scalar_static_f64[87]});
        self.scalar_static_f64[91]=p.p52;
        self.scalar_static_bool[7]=(1.0==self.scalar_static_f64[91]);
        self.scalar_static_f64[92]=(if self.scalar_static_bool[7]{1.0}else{0.0});
        self.scalar_static_f64[93]=p.p56;
        self.scalar_static_bool[8]=(self.scalar_static_f64[93]<0.001);
        self.scalar_static_f64[94]=(if self.scalar_static_bool[8]{1.0}else{0.0});
        self.scalar_static_bool[9]=((self.scalar_static_f64[92]!=0.0)&&(self.scalar_static_f64[94]!=0.0));
        self.scalar_static_f64[95]=(if self.scalar_static_bool[9]{1000.0}else{0.0});
        self.scalar_static_bool[10]=(!(self.scalar_static_f64[94]!=0.0));
        self.scalar_static_bool[11]=((self.scalar_static_f64[92]!=0.0)&&self.scalar_static_bool[10]);
        self.scalar_static_f64[96]=p.p277;
        self.scalar_static_f64[97]=(1.0/self.scalar_static_f64[93]);
        self.scalar_static_f64[98]=(self.scalar_static_f64[96]+self.scalar_static_f64[97]);
        self.scalar_static_f64[99]=(if self.scalar_static_bool[11]{self.scalar_static_f64[98]}else{self.scalar_static_f64[95]});
        self.scalar_static_f64[100]=p.p58;
        self.scalar_static_bool[12]=(self.scalar_static_f64[100]<0.001);
        self.scalar_static_f64[101]=(if self.scalar_static_bool[12]{1.0}else{0.0});
        self.scalar_static_bool[13]=((self.scalar_static_f64[92]!=0.0)&&(self.scalar_static_f64[101]!=0.0));
        self.scalar_static_f64[102]=(if self.scalar_static_bool[13]{1000.0}else{0.0});
        self.scalar_static_bool[14]=(!(self.scalar_static_f64[101]!=0.0));
        self.scalar_static_bool[15]=((self.scalar_static_f64[92]!=0.0)&&self.scalar_static_bool[14]);
        self.scalar_static_f64[103]=(1.0/self.scalar_static_f64[100]);
        self.scalar_static_f64[104]=(self.scalar_static_f64[96]+self.scalar_static_f64[103]);
        self.scalar_static_f64[105]=(if self.scalar_static_bool[15]{self.scalar_static_f64[104]}else{self.scalar_static_f64[102]});
        self.scalar_static_f64[106]=p.p57;
        self.scalar_static_bool[16]=(self.scalar_static_f64[106]<0.001);
        self.scalar_static_f64[107]=(if self.scalar_static_bool[16]{1.0}else{0.0});
        self.scalar_static_bool[17]=((self.scalar_static_f64[92]!=0.0)&&(self.scalar_static_f64[107]!=0.0));
        self.scalar_static_f64[108]=(if self.scalar_static_bool[17]{1000.0}else{0.0});
        self.scalar_static_bool[18]=(!(self.scalar_static_f64[107]!=0.0));
        self.scalar_static_bool[19]=((self.scalar_static_f64[92]!=0.0)&&self.scalar_static_bool[18]);
        self.scalar_static_f64[109]=(1.0/self.scalar_static_f64[106]);
        self.scalar_static_f64[110]=(self.scalar_static_f64[96]+self.scalar_static_f64[109]);
        self.scalar_static_f64[111]=(if self.scalar_static_bool[19]{self.scalar_static_f64[110]}else{self.scalar_static_f64[108]});
        self.scalar_static_bool[20]=(!(self.scalar_static_f64[92]!=0.0));
        self.scalar_static_f64[112]=(if self.scalar_static_bool[20]{1000.0}else{self.scalar_static_f64[99]});
        self.scalar_static_f64[113]=(if self.scalar_static_bool[20]{self.scalar_static_f64[112]}else{self.scalar_static_f64[105]});
        self.scalar_static_f64[114]=(if self.scalar_static_bool[20]{self.scalar_static_f64[112]}else{self.scalar_static_f64[111]});
        self.scalar_static_f64[115]=(self.scalar_static_f64[48]/self.scalar_static_f64[54]);
        self.scalar_static_f64[116]=f64::powf(self.scalar_static_f64[31],self.scalar_static_f64[10]);
        self.scalar_static_f64[117]=(self.scalar_static_f64[9]/self.scalar_static_f64[116]);
        ...
        self.scalar_static_f64[120]=f64::powf(self.scalar_static_f64[32],self.scalar_static_f64[8]);
        self.scalar_static_f64[121]=(self.scalar_static_f64[7]/self.scalar_static_f64[120]);
        self.scalar_static_f64[122]=(1.0+self.scalar_static_f64[121]);
        self.scalar_static_f64[123]=(self.scalar_static_f64[119]*self.scalar_static_f64[122]);
        self.scalar_static_f64[124]=(self.scalar_static_f64[17]*self.scalar_static_f64[54]);
        self.scalar_static_f64[125]=f64::powf(self.scalar_static_f64[21],self.scalar_static_f64[11]);
        ...
        self.scalar_static_f64[128]=(self.scalar_static_f64[126]/self.scalar_static_f64[54]);
        self.scalar_static_f64[129]=(self.scalar_static_f64[118]*self.scalar_static_f64[128]);
        self.scalar_static_f64[130]=(self.scalar_static_f64[122]*self.scalar_static_f64[129]);
        self.scalar_static_f64[131]=p.p53;
        self.scalar_static_bool[21]=(0.0==self.scalar_static_f64[131]);
        ...
        self.scalar_static_f64[132]=(if self.scalar_static_bool[23]{1.0}else{0.0});
        self.scalar_static_f64[133]=p.p11;
        self.scalar_static_f64[134]=(self.scalar_static_f64[18]*self.scalar_static_f64[18]);
        self.scalar_static_bool[24]=((self.scalar_static_f64[131]!=0.0)&&(self.scalar_static_f64[132]!=0.0));
        self.scalar_static_bool[25]=(self.scalar_static_f64[131]>0.0);
        ...
        self.scalar_static_f64[135]=(if self.scalar_static_bool[27]{1.0}else{0.0});
        self.scalar_static_bool[28]=((self.scalar_static_f64[131]!=0.0)&&(self.scalar_static_f64[135]!=0.0));
        self.scalar_static_f64[136]=(if self.scalar_static_bool[25]{1.0}else{0.0});
        self.scalar_static_bool[29]=(!(self.scalar_static_f64[136]!=0.0));
        ...
        self.scalar_static_f64[137]=(if self.scalar_static_bool[31]{1.0}else{0.0});
        self.scalar_static_f64[138]=(if self.scalar_static_bool[29]{0.0}else{self.scalar_static_f64[124]});
        self.scalar_static_f64[139]=(-self.scalar_static_f64[90]);
        self.scalar_static_f64[140]=(if (self.scalar_static_f64[137]!=0.0){self.scalar_static_f64[90]}else{0.0});
        self.scalar_static_f64[141]=(if (self.scalar_static_f64[137]!=0.0){self.scalar_static_f64[139]}else{0.0});
        self.scalar_static_f64[142]=(-self.scalar_static_f64[113]);
        self.scalar_static_f64[143]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[142]}else{0.0});
        self.scalar_static_f64[144]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[113]}else{0.0});
        self.scalar_static_f64[145]=(-self.scalar_static_f64[114]);
        self.scalar_static_f64[146]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[145]}else{0.0});
        self.scalar_static_f64[147]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[114]}else{0.0});
        self.scalar_static_f64[148]=(-self.scalar_static_f64[112]);
        self.scalar_static_f64[149]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[112]}else{0.0});
        self.scalar_static_f64[150]=(if (self.scalar_static_f64[91]!=0.0){self.scalar_static_f64[148]}else{0.0});
        self.scalar_static_f64[151]=(if self.scalar_static_bool[29]{10000.0}else{0.0});
    }
    ...
    fn recompute_temperature_static(&mut self, temperature: f64, thermal_voltage: f64) {
        let p = &(*self.params);
        self.scalar_static_f64[152]=(temperature+self.scalar_static_f64[133]);
        self.scalar_static_f64[153]=(if (self.scalar_static_f64[132]!=0.0){self.scalar_static_f64[152]}else{0.0});
        self.scalar_static_f64[154]=(if (self.scalar_static_f64[132]!=0.0){self.scalar_static_f64[153]}else{0.0});
        self.scalar_static_f64[155]=(self.scalar_static_f64[154]-self.scalar_static_f64[18]);
        self.scalar_static_f64[156]=(if (self.scalar_static_f64[132]!=0.0){self.scalar_static_f64[155]}else{0.0});
        self.scalar_static_f64[157]=(self.scalar_static_f64[154]*self.scalar_static_f64[154]);
        self.scalar_static_f64[158]=(self.scalar_static_f64[157]-self.scalar_static_f64[134]);
        self.scalar_static_f64[159]=(if (self.scalar_static_f64[132]!=0.0){self.scalar_static_f64[158]}else{0.0});
        self.scalar_static_f64[160]=(self.scalar_static_f64[5]*self.scalar_static_f64[156]);
        self.scalar_static_f64[161]=(self.scalar_static_f64[48]+self.scalar_static_f64[160]);
        self.scalar_static_f64[162]=(self.scalar_static_f64[6]*self.scalar_static_f64[159]);
        self.scalar_static_f64[163]=(self.scalar_static_f64[161]+self.scalar_static_f64[162]);
        self.scalar_static_f64[164]=(self.scalar_static_f64[130]*self.scalar_static_f64[163]);
        self.scalar_static_f64[165]=(if self.scalar_static_bool[24]{self.scalar_static_f64[164]}else{self.scalar_static_f64[127]});
        self.scalar_static_bool[32]=(self.scalar_static_f64[165]<0.0001);
        self.scalar_static_f64[166]=(if self.scalar_static_bool[32]{1.0}else{0.0});
        self.scalar_static_bool[33]=(self.scalar_static_bool[24]&&(self.scalar_static_f64[166]!=0.0));
        self.scalar_static_f64[167]=(if self.scalar_static_bool[33]{0.0001}else{self.scalar_static_f64[165]});
        self.scalar_static_f64[168]=(if (self.scalar_static_f64[135]!=0.0){self.scalar_static_f64[152]}else{self.scalar_static_f64[153]});
        self.scalar_static_f64[169]=(if (self.scalar_static_f64[135]!=0.0){self.scalar_static_f64[168]}else{self.scalar_static_f64[154]});
        self.scalar_static_f64[170]=(self.scalar_static_f64[169]-self.scalar_static_f64[18]);
        self.scalar_static_f64[171]=(if (self.scalar_static_f64[135]!=0.0){self.scalar_static_f64[170]}else{self.scalar_static_f64[156]});
        self.scalar_static_f64[172]=(self.scalar_static_f64[169]*self.scalar_static_f64[169]);
        self.scalar_static_f64[173]=(self.scalar_static_f64[172]-self.scalar_static_f64[134]);
        self.scalar_static_f64[174]=(if (self.scalar_static_f64[135]!=0.0){self.scalar_static_f64[173]}else{self.scalar_static_f64[159]});
        self.scalar_static_f64[175]=(self.scalar_static_f64[5]*self.scalar_static_f64[171]);
        self.scalar_static_f64[176]=(self.scalar_static_f64[48]+self.scalar_static_f64[175]);
        self.scalar_static_f64[177]=(self.scalar_static_f64[6]*self.scalar_static_f64[174]);
        self.scalar_static_f64[178]=(self.scalar_static_f64[176]+self.scalar_static_f64[177]);
        self.scalar_static_f64[179]=(self.scalar_static_f64[130]*self.scalar_static_f64[178]);
        self.scalar_static_f64[180]=(if self.scalar_static_bool[28]{self.scalar_static_f64[179]}else{self.scalar_static_f64[167]});
        self.scalar_static_bool[34]=(self.scalar_static_f64[180]<0.0001);
        self.scalar_static_f64[181]=(if self.scalar_static_bool[34]{1.0}else{0.0});
        self.scalar_static_bool[35]=(self.scalar_static_bool[28]&&(self.scalar_static_f64[181]!=0.0));
        self.scalar_static_f64[182]=(if self.scalar_static_bool[35]{0.0001}else{self.scalar_static_f64[180]});
        self.scalar_static_bool[36]=(self.scalar_static_f64[182]>0.0001);
        self.scalar_static_f64[183]=(if self.scalar_static_bool[36]{1.0}else{0.0});
        self.scalar_static_bool[37]=((self.scalar_static_f64[136]!=0.0)&&(self.scalar_static_f64[183]!=0.0));
        self.scalar_static_f64[184]=(1.0/self.scalar_static_f64[182]);
        self.scalar_static_f64[185]=(if self.scalar_static_bool[37]{self.scalar_static_f64[184]}else{0.0});
        self.scalar_static_bool[38]=(!(self.scalar_static_f64[183]!=0.0));
        self.scalar_static_bool[39]=((self.scalar_static_f64[136]!=0.0)&&self.scalar_static_bool[38]);
        self.scalar_static_f64[186]=(if self.scalar_static_bool[39]{10000.0}else{self.scalar_static_f64[185]});
        self.scalar_static_f64[187]=(if self.scalar_static_bool[29]{0.0}else{self.scalar_static_f64[186]});
        self.scalar_static_f64[188]=(if (self.scalar_static_f64[136]!=0.0){self.scalar_static_f64[187]}else{0.0});
