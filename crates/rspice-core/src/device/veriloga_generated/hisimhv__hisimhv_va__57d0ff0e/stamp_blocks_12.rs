...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_192(
        ...
        let mut t12: usize = 0;
        while {
            let t10: f64 = (s.v[421] + 1.0);let t11: f64 = if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (s.v[97] <= t10)) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_194(
        ...
        let mut t1d: usize = 0;
        while {
            let t1b: f64 = (s.v[421] + 1.0);let t1c: f64 = if (((s.b[3111] && s.b[3112]) && s.b[3196]) && (s.v[97] <= t1b)) { 1.0 } else { 0.0 };
            t1c != 0.0
        } {
    ...
    if s.b[3215] {
        ...
        s.store_scalar(2623, t1e);
        if s.b[3215] {s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scalar(335, (s.v[188] * s.v[635]));}
    ...
    if s.b[3217] {
        ...
        s.store_scalar(2626, t1f);
        if s.b[3217] {s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scale(335, 412, s.v[635]);}
    ...
    if (((s.b[3222] && s.b[3223]) && s.b[3224]) && s.b[3225]) {
        ...
        s.store_scalar(720, t22);s.b[3226] = (2.0 == 2.0);s.store_scalar(3226, if s.b[3226] { 1.0 } else { 0.0 });
        let (t23,) = {
    if ((((s.b[3222] && s.b[3223]) && s.b[3224]) && (!s.b[3225])) && s.b[3226]) {
        ...
        s.store_scalar(720, t23);s.b[3227] = (2.0 == 4.0);s.store_scalar(3227, if s.b[3227] { 1.0 } else { 0.0 });
        let (t24,) = {
    if (((((s.b[3222] && s.b[3223]) && s.b[3224]) && (!s.b[3225])) && (!s.b[3226])) && s.b[3227]) {
        ...
        s.store_scalar(720, t24);s.b[3228] = (2.0 == 8.0);s.store_scalar(3228, if s.b[3228] { 1.0 } else { 0.0 });
        let (t25,) = {
    ...
    if ((s.b[3222] && s.b[3223]) && s.b[3224]) {
        ...
        while {
            let t29: f64 = if (((s.b[3222] && s.b[3223]) && s.b[3224]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t29 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_198(
        ...
        if (s.b[3233] && s.b[3239]) {s.store_offset(337, 852, 1e-25);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(853, s.v[825], 154, A::ln_offset_div_scaled_inputs(s.ad_value(334), s.v[827], s.ad_value(337), 1.0, 1.0));s.store_exp_scaled_input_ad(854, A::offset(s.ad_value(676), (-1.0)), p.p535);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_200(
        ...
        s.store_scale(346, 874, p.p514);s.store_add_scaled_product_indices(885, 885, 1.0, 346, 860, 1.0);s.b[3257] = (s.v[875] > 0.0);s.store_scalar(3257, if s.b[3257] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 876, p.p514);s.store_add_scaled_product_indices(887, 887, 1.0, 346, 860, 1.0);s.b[3260] = (p.p48 > 0.0);s.store_scalar(3260, if s.b[3260] { 1.0 } else { 0.0 });s.b[3261] = (s.v[877] > 0.0);s.store_scalar(3261, if s.b[3261] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_201(
        ...
        if s.b[3260] {s.store_scale(346, 878, p.p514);s.store_add_scaled_product_indices(889, 889, 1.0, 346, 868, 1.0);}
        ...
        s.store_scale(346, 880, p.p537);s.store_add_scaled_product_indices(886, 886, 1.0, 346, 859, 1.0);s.b[3267] = (s.v[881] > 0.0);s.store_scalar(3267, if s.b[3267] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_202(
        ...
        s.store_scale(346, 882, p.p537);s.store_add_scaled_product_indices(888, 888, 1.0, 346, 859, 1.0);s.b[3270] = (p.p48 > 0.0);s.store_scalar(3270, if s.b[3270] { 1.0 } else { 0.0 });s.b[3271] = (s.v[883] > 0.0);s.store_scalar(3271, if s.b[3271] { 1.0 } else { 0.0 });
        ...
        if s.b[3270] {s.store_scale(346, 884, p.p537);s.store_add_scaled_product_indices(890, 890, 1.0, 346, 867, 1.0);}
    ...
    pub(super) fn stamp_transient_block_204(
        ...
        s.store_scaled_add(862, 886, 888, s.v[365]);s.store_scaled_add(861, 885, 887, s.v[365]);s.b[3300] = (p.p48 > 0.0);s.store_scalar(3300, if s.b[3300] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_206(
        ...
        if s.b[3301] {s.store_offset_sub_from_scalar_ad(781, p.p545, s.ad_value(915), (-1e-7));s.store_scalar(782, ((4.0 * p.p545) * 1e-7));}
        if s.b[3301] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (((s.b[3311] && s.b[3312]) && s.b[3313]) && s.b[3314]) {
        ...
        s.b[3320] = (p.p48 > 0.0);s.store_scalar(3320, if s.b[3320] { 1.0 } else { 0.0 });
        ...
        if ((s.v[81] != 0.0) && s.b[3321]) {s.store_scalar(346, p.p270);s.store_scalar(344, p.p271);s.copy_ad(337, 170);s.store_mul_product3_indices(335, 337, 346, 344, 337, 1.0);s.store_offset_add_ad(336, A::mul3(s.ad_value(253), s.ad_value(127), s.ad_value(346)), A::mul3(s.ad_value(344), s.ad_value(337), s.ad_value(337)), 1e-25);s.store_div(306, 335, 336);}
        if ((s.v[81] != 0.0) && (!s.b[3321])) {s.store_scalar(306, p.p270);}
