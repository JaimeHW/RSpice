...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_117(
        ...
        s.b[2509] = (4.0 == 1.0);s.store_scalar(2509, if s.b[2509] { 1.0 } else { 0.0 });
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((!s.b[1443]) && s.b[2430]) && s.b[2503]) && s.b[2508]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_118(
        ...
        if ((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) {s.copy_ad(88, 2523);s.copy_ad(2545, 993);s.store_offset_add_scaled_inputs3_offset_indices(86, 120, (-1.0), 182, 1.0, 2545, 1.0, s.v[160], p.p455);}
    ...
    pub(super) fn stamp_reactive_block_119(
        ...
        if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) {s.store_exp_ad(230, A::mul_offset_rhs(s.ad_value(154), s.ad_value(2545), (-p.p456)));s.store_scalar(79, 0.0);s.copy_ad(2546, 88);s.store_mul3_affine_lhs(2547, 166, 2524, (0.5 * 9662367879.197212), 0.0, 2524);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 2547);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(2548, 335, 2547);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_120(
        ...
        let mut t4: usize = 0;
        while {
            let t2: f64 = (s.v[421] + 1.0);let t3: f64 = if ((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (s.v[97] <= t2)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_121(
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if (((((!s.b[1443]) && s.b[2519]) && s.b[2568]) && s.b[2569]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
        ...
        if ((!s.b[1443]) && s.b[2519]) {s.store_sqrt_offset_input(2529, 335, (10.0 * 2.220446049250313e-16));s.store_mul(2530, 2528, 2529);s.store_mul_scale_offset_mixed_ai(995, A::div_scaled_inputs(s.ad_value(155), 2.0, s.ad_value(162), 1.0), 2530, p.p454, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_122(
        ...
        if ((!s.b[1443]) && s.b[2519]) {s.store_scaled_mul(46, 995, 333, s.v[632]);s.store_add(134, 136, 46);}
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if ((s.b[2574] && s.b[2575]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
        ...
        if ((!s.b[2580]) && s.b[2581]) {s.store_mul(335, 659, 85);s.store_scale(337, 636, 1.0 / ((s.v[188] * s.v[188])));s.store_scale_ad(338, A::div_from_scalar(2.0, s.ad_value(636)), (s.v[188] * s.v[188]));s.store_add_scaled_inputs_product_indices(339, 335, 1.0, 155, (-1.0), 660, 1438, (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_123(
        ...
        if ((!s.b[2580]) && s.b[2581]) {s.store_offset_mul(340, 338, 339, 1.0);s.store_scaled_offset(341, 338, 1.0, 2.0);}
        ...
        let mut ta: usize = 0;
        while {
            let t9: f64 = if (((((!s.b[2580]) && s.b[2581]) && s.b[2582]) && s.b[2583]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
        ...
        if ((!s.b[2580]) && s.b[2589]) {s.store_sqrt_offset_input(335, 127, 1e-25);s.store_div_from_scalar_scaled_input(337, 1.0, 335, 2.0);s.store_sub_mixed_ia(338, 334, A::scale_offset(s.ad_value(791), ((p.p106) * (p.p105)), p.p105));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_124(
        ...
        if ((!s.b[2580]) && s.b[2589]) {s.store_sqrt_square_offset(782, 338, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 338, 782, 0.5, 0.5);s.store_scaled_add(338, 338, 782, 0.5);}
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((s.b[2595] && s.b[2596]) && s.b[2597]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_126(
        ...
        if s.b[2603] {s.store_sqrt_square_offset(782, 195, ((4.0 * (0.01 / 0.01)) * (0.01 / 0.01)));s.store_offset_scaled_div(339, 195, 782, 0.5, 0.5);s.store_scaled_add(195, 195, 782, 0.5);}
        ...
        if ((!s.b[2619]) && (!s.b[2621])) {s.store_exp(335, 334);s.store_div_from_scalar(337, 1.0, 192);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_127(
        ...
        if ((!s.b[2619]) && (!s.b[2621])) {s.store_scale(336, 337, (s.v[511] * (1.6021918e-19 * s.v[632])));}
        ...
        if (s.b[2627] && s.b[2631]) {s.store_scalar(2625, 1.0);s.store_scalar(2623, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p.p66);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
        ...
        if ((s.b[2629] && (!(s.b[2627] || s.b[2628]))) && s.b[2633]) {s.store_scalar(2625, 1.0);s.store_scalar(2626, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p.p63 + (p.p64 * p.p55)));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        ...
        if ((s.b[2630] && (!((s.b[2627] || s.b[2628]) || s.b[2629]))) && s.b[2638]) {s.store_scalar(2625, 1.0);s.store_sub(395, 734, 735);s.store_sub(396, 733, 735);}
        if (s.v[2625] != 0.0) {s.store_scalar(2646, 0.4);s.store_scalar(2647, 0.0);s.store_scalar(223, 0.0);s.store_scalar(214, 0.0);s.store_scalar(216, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_128(
        ...
        if (s.v[2625] != 0.0) {s.store_scalar(232, 0.0);s.store_scalar(236, 0.0);s.store_scalar(233, 0.0);s.store_scalar(217, 0.0);s.store_scalar(420, 0.0);s.store_scalar(215, 0.0);s.store_scalar(447, 0.0);s.store_scalar(445, 0.0);s.store_scalar(446, 0.0);s.store_scalar(79, (-1.0));s.store_scalar(2648, 0.0);s.store_scalar(2649, 0.0);s.store_mul_scaled_ln_ad_rhs(2644, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(2644), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2625] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        let mut te: usize = 0;
        while {
            let td: f64 = if (((s.v[2625] != 0.0) && (!s.b[2658])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            td != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_131(
        ...
        let mut t12: usize = 0;
        while {
            let t11: f64 = if (((((((s.v[2625] != 0.0) && (!s.b[2665])) && s.b[2669]) && s.b[2671]) && s.b[2672]) && s.b[2673]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
