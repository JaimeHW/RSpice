...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_198(
        ...
        s.store_scalar(713, 0.0);s.b[3334] = (((((p.p31 != 0.0) && (p.p30 != 0.0)) && (s.v[321] == 1.0)) && (s.v[78] == 0.0)) && (s.v[963] == 0.0));s.store_scalar(3334, if s.b[3334] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_199(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((((s.b[3336] && (!s.b[3337])) && s.b[3344]) && s.b[3345]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_200(
        ...
        if ((s.b[3336] && (!s.b[3356])) && (!s.b[3363])) {s.store_scale(781, 799, (0.5 * (2.0 * 1.0 / (p.p262))));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_201(
        ...
        if ((s.b[3336] && (!s.b[3356])) && (!s.b[3363])) {s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
        ...
        if (((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) {s.store_add_scaled_inputs3_indices(781, 597, 1.0, 408, (-p.p440), 408, p.p441);s.store_square(722, 781);s.store_scaled_mul(723, 408, 408, (p.p441 * p.p441));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_scalar(719, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_202(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && (s.v[719] < p.p442)) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
        ...
        s.b[3375] = (p.p442 == 2.0);s.store_scalar(3375, if s.b[3375] { 1.0 } else { 0.0 });
        if ((((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (!s.b[3374])) && s.b[3375]) {s.store_scalar(720, 2.0);}
        s.b[3376] = (p.p442 == 4.0);s.store_scalar(3376, if s.b[3376] { 1.0 } else { 0.0 });
        if (((((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (!s.b[3374])) && (!s.b[3375])) && s.b[3376]) {s.store_scalar(720, 3.0);}
        s.b[3377] = (p.p442 == 8.0);s.store_scalar(3377, if s.b[3377] { 1.0 } else { 0.0 });
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((s.b[3336] && (!s.b[3356])) && s.b[3371]) && s.b[3372]) && s.b[3373]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
        ...
        if (s.b[3336] && (!s.b[3356])) {s.store_offset(334, 334, (10.0 * 2.220446049250313e-16));s.store_sqrt_mul(599, 650, 334);s.store_offset_sub(336, 3352, 3353, p.p137);s.store_sqrt_square_offset(782, 336, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_203(
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3381]) && s.b[3382]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if ((((s.b[3336] && (!s.b[3356])) && s.b[3387]) && s.b[3388]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
        ...
        if ((s.b[3336] && (!s.b[3356])) && s.b[3387]) {s.store_div_from_scalar(726, 1.0, 726);s.store_scaled_mul(780, 781, 726, 1000.0);s.store_div_scaled_product_indices(334, 725, 726, 1000.0, 770, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_204(
        ...
        if ((s.b[3336] && (!s.b[3356])) && s.b[3387]) {s.store_offset(4, 780, (1000000.0 - 1000.0));}
    ...
    pub(super) fn stamp_reactive_block_205(
        ...
        s.b[3409] = (p.p48 > 0.0);s.store_scalar(3409, if s.b[3409] { 1.0 } else { 0.0 });s.b[3413] = (p.p53 > 0.0);s.store_scalar(3413, if s.b[3413] { 1.0 } else { 0.0 });
