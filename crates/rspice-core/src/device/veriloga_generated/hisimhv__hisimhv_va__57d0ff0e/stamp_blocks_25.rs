...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_181(
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && s.b[3179]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (!s.b[3179])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (!s.b[3179])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_182(
        ...
        let mut t4: usize = 0;
        while {
            let t2: f64 = (s.v[421] + 1.0);let t3: f64 = if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (s.v[97] <= t2)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_183(
        ...
        s.b[3196] = (p.p33 == 4.0);s.store_scalar(3196, if s.b[3196] { 1.0 } else { 0.0 });
        ...
        if (((s.b[3111] && s.b[3112]) && s.b[3196]) && s.b[3197]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if (((s.b[3111] && s.b[3112]) && s.b[3196]) && (!s.b[3197])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if (((s.b[3111] && s.b[3112]) && s.b[3196]) && (!s.b[3197])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if ((s.b[3111] && s.b[3112]) && s.b[3196]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_184(
        ...
        let mut t7: usize = 0;
        while {
            let t5: f64 = (s.v[421] + 1.0);let t6: f64 = if (((s.b[3111] && s.b[3112]) && s.b[3196]) && (s.v[97] <= t5)) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_185(
        ...
        s.b[3212] = (p.p55 == 0.0);s.store_scalar(3212, if s.b[3212] { 1.0 } else { 0.0 });s.b[3213] = (p.p50 == 0.0);s.store_scalar(3213, if s.b[3213] { 1.0 } else { 0.0 });
        ...
        if (((s.b[3111] && s.b[3112]) && s.b[3211]) && s.b[3212]) {s.store_sqrt_offset_square_offset(782, 3116, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(3116), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(3116), p.p137), 782, 0.5);}
        ...
        if (((s.b[3111] && s.b[3112]) && s.b[3211]) && s.b[3212]) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_add_scaled_inputs3_indices(781, 407, 1.0, 600, (-1.0), 407, (-0.1));s.store_scaled_mul(782, 407, 407, (4.0 * 0.1));}
        ...
        s.b[3215] = (((p.p36 == 1.0) && (p.p66 > 0.0)) && (s.v[460] == 0.0));s.store_scalar(3215, if s.b[3215] { 1.0 } else { 0.0 });
        if s.b[3215] {s.store_scalar(2623, 1.0);s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scalar(335, (s.v[188] * s.v[635]));}
        s.b[3216] = (s.v[949] == 1.0);s.store_scalar(3216, if s.b[3216] { 1.0 } else { 0.0 });
        if (s.b[3215] && s.b[3216]) {s.store_mul_ad_product_rhs_mixed_ia(338, 289, 335, A::add(s.ad_value(290), s.ad_value(791)));s.store_scale(339, 335, p.p66);s.store_sub_from_scalar(343, 1.2, 87);s.store_add_scaled_products_indices(291, 791, 339, 1.0, 338, 343, (-1.0));}
        if (s.b[3215] && (!s.b[3216])) {s.store_mul_ad_product_rhs_mixed_ia(338, 289, 335, A::add_scaled_inputs3(s.ad_value(290), 1.0, s.ad_value(791), 1.0, s.ad_value(790), -1.0));s.store_scale(339, 335, p.p66);s.store_sub_offset_lhs(343, 790, 1.2, 91);s.store_add_scaled_products_mixed_aiii(291, A::sub(s.ad_value(791), s.ad_value(790)), 339, 1.0, 338, 343, (-1.0));}
        s.b[3217] = (((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] == 0.0));s.store_scalar(3217, if s.b[3217] { 1.0 } else { 0.0 });
        if s.b[3217] {s.store_scalar(2626, 1.0);s.store_scalar(289, s.v[564]);s.store_scalar(290, p.p276);s.store_scale(335, 412, s.v[635]);}
        s.b[3218] = (s.v[949] == 1.0);s.store_scalar(3218, if s.b[3218] { 1.0 } else { 0.0 });
        if (s.b[3217] && s.b[3218]) {s.store_mul_ad_product_rhs_mixed_ia(338, 289, 335, A::add_scaled_inputs3(s.ad_value(290), 1.0, s.ad_value(791), 1.0, s.ad_value(790), -1.0));s.store_scale(339, 335, p.p63);s.store_sub_offset_lhs(343, 790, 1.2, 91);s.store_add_scaled_products_mixed_aiii(292, A::sub(s.ad_value(791), s.ad_value(790)), 339, 1.0, 338, 343, (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_186(
        ...
        if (s.b[3217] && (!s.b[3218])) {s.store_mul_ad_product_rhs_mixed_ia(338, 289, 335, A::add(s.ad_value(290), s.ad_value(791)));s.store_scale(339, 335, p.p63);s.store_sub_from_scalar(343, 1.2, 87);s.store_add_scaled_products_indices(292, 791, 339, 1.0, 338, 343, (-1.0));}
        if s.b[768] {s.store_scalar(295, (s.v[505] * (-s.v[635])));}
        s.b[3219] = (s.v[2623] == 0.0);s.store_scalar(3219, if s.b[3219] { 1.0 } else { 0.0 });
        if ((!s.b[768]) && s.b[3219]) {s.store_scalar(295, (((-s.v[188]) * p.p66) * s.v[635]));}
        ...
        if ((!s.b[769]) && s.b[3220]) {s.store_primal_scale(294, 412, (-(p.p63 * s.v[635])));}
        ...
        if s.b[3221] {s.store_scaled_sub(357, 790, 94, p.p431);s.store_mul(360, 338, 357);s.store_mul(361, 338, 357);}
        if (!s.b[3221]) {s.store_scaled_sub(357, 790, 94, (-p.p431));s.store_mul(362, 338, 357);s.store_mul(363, 338, 357);}
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((s.b[3222] && s.b[3223]) && s.b[3224]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
        ...
        s.b[3231] = (p.p133 != 0.0);s.store_scalar(3231, if s.b[3231] { 1.0 } else { 0.0 });
        if ((!s.b[3230]) && s.b[3231]) {s.store_add_scaled_product_indices(304, 87, 1.0, 303, 162, 1.0);s.store_add_scaled_inputs3_indices(335, 1439, s.v[172], 87, s.v[172], 304, (1.0 - s.v[172]));s.store_mul_scale_offset_mixed_ia(305, 336, A::add_scaled_inputs3(s.ad_value(87), 1.0, s.ad_value(1439), 1.0, s.ad_value(335), -1.0), (-1.0 / (p.p133)), 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_187(
        ...
        s.b[3232] = (p.p134 != 0.0);s.store_scalar(3232, if s.b[3232] { 1.0 } else { 0.0 });
        if ((!s.b[3230]) && s.b[3232]) {s.store_add_scaled_inputs(305, 305, 1.0, 792, s.v[671]);}
        s.store_scalar(300, s.v[670]);s.store_scalar(302, s.v[670]);s.store_scaled_sub(299, 734, 733, s.v[300]);s.store_scale(301, 734, s.v[302]);s.b[3233] = ((p.p53 > 0.0) && (s.v[541] != 0.0));s.store_scalar(3233, if s.b[3233] { 1.0 } else { 0.0 });
        ...
        s.b[3234] = (p.p48 > 0.0);s.store_scalar(3234, if s.b[3234] { 1.0 } else { 0.0 });s.b[3235] = (p.p15 > s.v[632]);s.store_scalar(3235, if s.b[3235] { 1.0 } else { 0.0 });
        if ((s.b[3233] && s.b[3234]) && s.b[3235]) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scale(875, 829, (p.p15 - s.v[632]));s.store_scale(876, 831, (p.p15 - s.v[632]));s.store_scale(877, 836, s.v[632]);s.store_scale(878, 837, s.v[632]);}
        if ((s.b[3233] && s.b[3234]) && (!s.b[3235])) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scalar(875, 0.0);s.store_scalar(876, 0.0);s.store_scale(877, 836, p.p15);s.store_scale(878, 837, p.p15);}
        if (s.b[3233] && (!s.b[3234])) {s.store_scale(873, 828, p.p13);s.store_scale(874, 830, p.p13);s.store_scale(875, 829, p.p15);s.store_scale(876, 831, p.p15);s.store_scalar(877, 0.0);s.store_scalar(878, 0.0);}
    ...
    pub(super) fn stamp_reactive_block_188(
        ...
        s.b[3237] = (p.p48 > 0.0);s.store_scalar(3237, if s.b[3237] { 1.0 } else { 0.0 });s.b[3238] = (p.p16 > s.v[632]);s.store_scalar(3238, if s.b[3238] { 1.0 } else { 0.0 });
        if ((s.b[3233] && s.b[3237]) && s.b[3238]) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scale(881, 829, (p.p16 - s.v[632]));s.store_scale(882, 831, (p.p16 - s.v[632]));s.store_scale(883, 836, s.v[632]);s.store_scale(884, 837, s.v[632]);}
        if ((s.b[3233] && s.b[3237]) && (!s.b[3238])) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scalar(881, 0.0);s.store_scalar(882, 0.0);s.store_scale(883, 836, p.p16);s.store_scale(884, 837, p.p16);}
        if (s.b[3233] && (!s.b[3237])) {s.store_scale(879, 828, p.p14);s.store_scale(880, 830, p.p14);s.store_scale(881, 829, p.p16);s.store_scale(882, 831, p.p16);s.store_scalar(883, 0.0);s.store_scalar(884, 0.0);}
        ...
        if s.b[3233] {s.store_offset_scaled(832, 391, ((p.p481) * ((p.p500 * p.p13))), (p.p500 * p.p13));}
        s.b[3240] = (p.p15 > s.v[632]);s.store_scalar(3240, if s.b[3240] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3240]) {s.store_offset_scaled(833, 391, ((p.p483) * ((p.p501 * (p.p15 - s.v[632])))), (p.p501 * (p.p15 - s.v[632])));s.store_offset_scaled(834, 391, ((p.p485) * ((p.p502 * s.v[632]))), (p.p502 * s.v[632]));}
        if (s.b[3233] && (!s.b[3240])) {s.store_scalar(833, 0.0);s.store_offset_scaled(834, 391, ((p.p485) * ((p.p502 * p.p15))), (p.p502 * p.p15));}
    ...
    pub(super) fn stamp_reactive_block_189(
        ...
        let ctx_temp = ctx.temperature();s.b[3242] = (s.v[833] < 0.0);s.store_scalar(3242, if s.b[3242] { 1.0 } else { 0.0 });
        ...
        if s.b[3233] {s.store_sub_from_scalar_scaled_input(841, p.p506, 391, p.p487);s.store_sub_from_scalar_scaled_input(842, p.p507, 391, p.p489);s.store_sub_from_scalar_scaled_input(843, p.p508, 391, p.p491);}
        s.b[3244] = ((s.v[841] < 0.01) && (p.p13 > 0.0));s.store_scalar(3244, if s.b[3244] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3244]) {s.store_scalar(841, 0.01);}
        s.b[3245] = ((s.v[842] < 0.01) && (p.p15 > s.v[632]));s.store_scalar(3245, if s.b[3245] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3245]) {s.store_scalar(842, 0.01);}
        s.b[3246] = ((s.v[843] < 0.01) && (p.p15 > 0.0));s.store_scalar(3246, if s.b[3246] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3246]) {s.store_scalar(843, 0.01);}
        if s.b[3233] {s.store_offset_scaled(835, 391, ((p.p482) * ((p.p523 * p.p14))), (p.p523 * p.p14));}
        s.b[3247] = (p.p16 > s.v[632]);s.store_scalar(3247, if s.b[3247] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3247]) {s.store_offset_scaled(838, 391, ((p.p484) * ((p.p524 * (p.p16 - s.v[632])))), (p.p524 * (p.p16 - s.v[632])));s.store_offset_scaled(839, 391, ((p.p486) * ((p.p525 * s.v[632]))), (p.p525 * s.v[632]));}
        if (s.b[3233] && (!s.b[3247])) {s.store_scalar(838, 0.0);s.store_offset_scaled(839, 391, ((p.p486) * ((p.p525 * p.p16))), (p.p525 * p.p16));}
        ...
        if s.b[3233] {s.store_sub_from_scalar_scaled_input(844, p.p529, 391, p.p488);s.store_sub_from_scalar_scaled_input(845, p.p530, 391, p.p490);s.store_sub_from_scalar_scaled_input(846, p.p531, 391, p.p492);}
        s.b[3251] = ((s.v[844] < 0.01) && (p.p14 > 0.0));s.store_scalar(3251, if s.b[3251] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3251]) {s.store_scalar(844, 0.01);}
        s.b[3252] = ((s.v[845] < 0.01) && (p.p16 > s.v[632]));s.store_scalar(3252, if s.b[3252] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3252]) {s.store_scalar(845, 0.01);}
        s.b[3253] = ((s.v[846] < 0.01) && (p.p16 > 0.0));s.store_scalar(3253, if s.b[3253] { 1.0 } else { 0.0 });
        if (s.b[3233] && s.b[3253]) {s.store_scalar(846, 0.01);}
        if (!s.b[3233]) {s.store_scalar(387, (ctx_temp + p.p11));}
        s.store_scale(344, 850, p.p511);s.store_scale(343, 849, p.p510);s.b[3254] = (s.v[873] > 0.0);s.store_scalar(3254, if s.b[3254] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 874, p.p514);s.b[3257] = (s.v[875] > 0.0);s.store_scalar(3257, if s.b[3257] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 876, p.p514);s.b[3260] = (p.p48 > 0.0);s.store_scalar(3260, if s.b[3260] { 1.0 } else { 0.0 });s.b[3261] = (s.v[877] > 0.0);s.store_scalar(3261, if s.b[3261] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_190(
        ...
        if s.b[3260] {s.store_scale(346, 878, p.p514);}
        s.store_scale(344, 855, p.p534);s.store_scale(343, 854, p.p533);s.b[3264] = (s.v[879] > 0.0);s.store_scalar(3264, if s.b[3264] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 880, p.p537);s.b[3267] = (s.v[881] > 0.0);s.store_scalar(3267, if s.b[3267] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 882, p.p537);s.b[3270] = (p.p48 > 0.0);s.store_scalar(3270, if s.b[3270] { 1.0 } else { 0.0 });s.b[3271] = (s.v[883] > 0.0);s.store_scalar(3271, if s.b[3271] { 1.0 } else { 0.0 });
        ...
        if s.b[3270] {s.store_scale(346, 884, p.p537);}
        ...
        s.b[3276] = (p.p503 == 0.5);s.store_scalar(3276, if s.b[3276] { 1.0 } else { 0.0 });
        ...
        if (s.b[3274] && s.b[3275]) {s.store_mul_ad_affine_product_rhs(891, 841, s.ad_value(832), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p503)), 0.0);}
        if (s.b[3274] && (!s.b[3275])) {s.copy_ad(335, 832);s.store_div_scaled_inputs_indices(336, 832, p.p503, 841, 1.0);s.store_mul_add_scaled_product_rhs_indices(891, 860, 335, 1.0, 860, 336, 0.5);}
        ...
        s.b[3279] = (p.p504 == 0.5);s.store_scalar(3279, if s.b[3279] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_191(
        ...
        if (s.b[3277] && s.b[3278]) {s.store_mul_ad_affine_product_rhs(893, 842, s.ad_value(833), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p504)), 0.0);}
        if (s.b[3277] && (!s.b[3278])) {s.copy_ad(335, 833);s.store_div_scaled_inputs_indices(336, 833, p.p504, 842, 1.0);s.store_mul_add_scaled_product_rhs_indices(893, 860, 335, 1.0, 860, 336, 0.5);}
        if (!s.b[3277]) {s.store_scalar(893, 0.0);}
        s.b[3280] = (p.p48 > 0.0);s.store_scalar(3280, if s.b[3280] { 1.0 } else { 0.0 });s.b[3281] = (s.v[834] > 0.0);s.store_scalar(3281, if s.b[3281] { 1.0 } else { 0.0 });s.b[3282] = (s.v[868] < 0.0);s.store_scalar(3282, if s.b[3282] { 1.0 } else { 0.0 });
        if ((s.b[3280] && s.b[3281]) && s.b[3282]) {s.store_sub_from_scalar_div_indices(770, 1.0, 868, 843);}
        s.b[3283] = (p.p505 == 0.5);s.store_scalar(3283, if s.b[3283] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3280] && s.b[3281]) && s.b[3282]) {s.store_mul_ad_affine_product_rhs(895, 843, s.ad_value(834), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p505)), 0.0);}
        if ((s.b[3280] && s.b[3281]) && (!s.b[3282])) {s.copy_ad(335, 834);s.store_div_scaled_inputs_indices(336, 834, p.p505, 843, 1.0);s.store_mul_add_scaled_product_rhs_indices(895, 868, 335, 1.0, 868, 336, 0.5);}
        ...
        s.b[3286] = (p.p505 == 0.5);s.store_scalar(3286, if s.b[3286] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[3280]) && s.b[3284]) && s.b[3285]) {s.store_mul_ad_affine_product_rhs(895, 843, s.ad_value(834), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p505)), 0.0);}
        if (((!s.b[3280]) && s.b[3284]) && (!s.b[3285])) {s.copy_ad(335, 834);s.store_div_scaled_inputs_indices(336, 834, p.p505, 843, 1.0);s.store_mul_add_scaled_product_rhs_indices(895, 860, 335, 1.0, 860, 336, 0.5);}
        ...
        s.b[3289] = (p.p526 == 0.5);s.store_scalar(3289, if s.b[3289] { 1.0 } else { 0.0 });
        ...
        if (s.b[3287] && s.b[3288]) {s.store_mul_ad_affine_product_rhs(892, 844, s.ad_value(835), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p526)), 0.0);}
        if (s.b[3287] && (!s.b[3288])) {s.copy_ad(335, 835);s.store_div_scaled_inputs_indices(336, 835, p.p526, 844, 1.0);s.store_mul_add_scaled_product_rhs_indices(892, 859, 335, 1.0, 859, 336, 0.5);}
        ...
        s.b[3292] = (p.p527 == 0.5);s.store_scalar(3292, if s.b[3292] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_192(
        ...
        if (s.b[3290] && s.b[3291]) {s.store_mul_ad_affine_product_rhs(894, 845, s.ad_value(838), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p527)), 0.0);}
        if (s.b[3290] && (!s.b[3291])) {s.copy_ad(335, 838);s.store_div_scaled_inputs_indices(336, 838, p.p527, 845, 1.0);s.store_mul_add_scaled_product_rhs_indices(894, 859, 335, 1.0, 859, 336, 0.5);}
        if (!s.b[3290]) {s.store_scalar(894, 0.0);}
        s.b[3293] = (p.p48 > 0.0);s.store_scalar(3293, if s.b[3293] { 1.0 } else { 0.0 });s.b[3294] = (s.v[839] > 0.0);s.store_scalar(3294, if s.b[3294] { 1.0 } else { 0.0 });s.b[3295] = (s.v[867] < 0.0);s.store_scalar(3295, if s.b[3295] { 1.0 } else { 0.0 });
        if ((s.b[3293] && s.b[3294]) && s.b[3295]) {s.store_sub_from_scalar_div_indices(770, 1.0, 867, 846);}
        s.b[3296] = (p.p528 == 0.5);s.store_scalar(3296, if s.b[3296] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3293] && s.b[3294]) && s.b[3295]) {s.store_mul_ad_affine_product_rhs(896, 846, s.ad_value(839), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p528)), 0.0);}
        if ((s.b[3293] && s.b[3294]) && (!s.b[3295])) {s.copy_ad(335, 839);s.store_div_scaled_inputs_indices(336, 839, p.p528, 846, 1.0);s.store_mul_add_scaled_product_rhs_indices(896, 867, 335, 1.0, 867, 336, 0.5);}
        ...
        s.b[3299] = (p.p528 == 0.5);s.store_scalar(3299, if s.b[3299] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[3293]) && s.b[3297]) && s.b[3298]) {s.store_mul_ad_affine_product_rhs(896, 846, s.ad_value(839), A::sub_from_scalar(1.0, A::mul(s.ad_value(770), s.ad_value(840))), 1.0 / ((1.0 - p.p528)), 0.0);}
        if (((!s.b[3293]) && s.b[3297]) && (!s.b[3298])) {s.copy_ad(335, 839);s.store_div_scaled_inputs_indices(336, 839, p.p528, 846, 1.0);s.store_mul_add_scaled_product_rhs_indices(896, 859, 335, 1.0, 859, 336, 0.5);}
        if ((!s.b[3293]) && (!s.b[3297])) {s.store_scalar(896, 0.0);}
        s.b[3300] = (p.p48 > 0.0);s.store_scalar(3300, if s.b[3300] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_193(
        ...
        s.store_mul_add_scaled_inputs_rhs(935, 155, A::ln(A::div_from_scalar(s.v[903], s.ad_value(907))), s.v[906], A::div_from_scalar(p.p545, s.ad_value(912)), s.v[906]);s.b[3301] = (p.p539 > 0.0);s.store_scalar(3301, if s.b[3301] { 1.0 } else { 0.0 });
        ...
        s.b[3303] = ((p.p542 == 0.0) || (s.v[860] < s.v[934]));s.store_scalar(3303, if s.b[3303] { 1.0 } else { 0.0 });
        if (s.b[3301] && s.b[3303]) {s.store_scale(941, 937, p.p541);}
        if (s.b[3301] && (!s.b[3303])) {s.store_mul_scaled_exp_ad_rhs(941, 937, p.p541, A::mul3_scaled_output(A::sub(s.ad_value(860), s.ad_value(934)), A::sub(s.ad_value(860), s.ad_value(934)), A::exp_scaled_input(A::ln(A::div_from_scalar(1.0, s.ad_value(676))), p.p548), (-p.p542)));}
        if s.b[3301] {
            if (s.v[941] > 1e20) {
        ...
        if s.b[3301] {s.store_mul(939, 907, 941);s.store_scaled_sub(920, 939, 907, (1.6021918e-19 * p.p13));}
        s.b[3304] = (p.p543 > 0.0);s.store_scalar(3304, if s.b[3304] { 1.0 } else { 0.0 });
        if (s.b[3301] && s.b[3304]) {s.store_scale(922, 920, p.p543);s.store_scaled_voltage(924, ctx, nodes, Some(16), None, p.p543);s.store_scaled_sub(926, 924, 922, 1.0 / (p.p543));s.store_scale(928, 924, 1.0 / (p.p543));}
        if (s.b[3301] && (!s.b[3304])) {s.copy_ad(922, 920);s.copy_ad(928, 922);}
        s.b[3305] = ((p.p542 == 0.0) || (s.v[860] < s.v[935]));s.store_scalar(3305, if s.b[3305] { 1.0 } else { 0.0 });
        if (s.b[3301] && s.b[3305]) {s.store_scale(942, 938, p.p541);}
        if (s.b[3301] && (!s.b[3305])) {s.store_mul_scaled_exp_ad_rhs(942, 938, p.p541, A::mul3_scaled_output(A::sub(s.ad_value(860), s.ad_value(935)), A::sub(s.ad_value(860), s.ad_value(935)), A::exp_scaled_input(A::ln(A::div_from_scalar(1.0, s.ad_value(676))), p.p548), (-p.p542)));}
        if s.b[3301] {
            if (s.v[942] > 1e20) {
        ...
        if s.b[3301] {s.store_mul(940, 907, 942);s.store_scaled_sub(921, 940, 907, (1.6021918e-19 * p.p13));}
        s.b[3306] = (p.p543 > 0.0);s.store_scalar(3306, if s.b[3306] { 1.0 } else { 0.0 });
        if (s.b[3301] && s.b[3306]) {s.store_scale(923, 921, p.p543);s.store_scaled_voltage(925, ctx, nodes, Some(17), None, p.p543);s.store_scaled_sub(927, 925, 923, 1.0 / (p.p543));s.store_scale(929, 925, 1.0 / (p.p543));}
        if (s.b[3301] && (!s.b[3306])) {s.copy_ad(923, 921);s.copy_ad(929, 923);}
        if s.b[3301] {s.store_sub_from_scalar(914, p.p506, 860);s.store_sqrt_square_offset(782, 914, ((4.0 * s.v[943]) * s.v[943]));s.store_offset_scaled_div(334, 914, 782, 0.5, 0.5);s.store_scaled_add(914, 914, 782, 0.5);}
        ...
        if s.b[3301] {s.store_sqrt_scaled_input(915, 914, ((2.0 * 1.034943e-10) * 1.0 / ((1.6021918e-19 * s.v[903]))));s.store_offset_sub_from_scalar_ad(781, p.p545, s.ad_value(915), (-1e-7));s.store_scalar(782, ((4.0 * p.p545) * 1e-7));}
        if s.b[3301] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    pub(super) fn stamp_reactive_block_194(
        ...
        if s.b[3301] {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(915, 781, (-0.5), 782, (-0.5), p.p545);}
        s.b[3308] = (p.p546 > 0.0);s.store_scalar(3308, if s.b[3308] { 1.0 } else { 0.0 });
        if (s.b[3301] && s.b[3308]) {s.store_scale(930, 915, p.p546);s.store_scaled_voltage(931, ctx, nodes, Some(18), None, p.p546);s.store_scaled_sub(932, 931, 930, 1.0 / (p.p546));s.store_scale(933, 931, 1.0 / (p.p546));}
        if (s.b[3301] && (!s.b[3308])) {s.copy_ad(930, 915);s.copy_ad(933, 930);}
        if s.b[3301] {s.store_scalar(916, ((-((s.v[903] * p.p13) * 1.6021918e-19)) * p.p545));s.store_mul_ad_product_rhs_mixed_ia(917, 912, 928, A::sub(A::exp(A::div_from_scalar((-p.p545), s.ad_value(912))), A::exp_div_scaled_inputs(s.ad_value(933), -1.0, s.ad_value(912), 1.0)));s.store_mul_ad_product_rhs_mixed_ia(918, 912, 929, A::offset(A::exp_div_scaled_inputs(A::sub_from_scalar(p.p545, s.ad_value(933)), -1.0, s.ad_value(912), 1.0), (-1.0)));s.store_add_scaled_inputs3_indices(919, 916, (-1.0), 917, (-1.0), 918, (-1.0));s.store_add_scaled_inputs(65, 65, 1.0, 919, s.v[365]);}
        s.b[3309] = ((p.p539 > 0.0) && (p.p543 > 0.0));s.store_scalar(3309, if s.b[3309] { 1.0 } else { 0.0 });s.b[3310] = ((p.p539 > 0.0) && (p.p546 > 0.0));s.store_scalar(3310, if s.b[3310] { 1.0 } else { 0.0 });s.b[3311] = (p.p46 == 1.0);s.store_scalar(3311, if s.b[3311] { 1.0 } else { 0.0 });s.b[3312] = ((s.v[486] > 0.0) && (s.v[454] > 0.0));s.store_scalar(3312, if s.b[3312] { 1.0 } else { 0.0 });
        ...
        if (s.b[3311] && s.b[3312]) {s.store_sqrt(340, 340);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_195(
        ...
        if ((s.v[81] != 0.0) && s.b[3321]) {s.store_scalar(346, p.p270);s.store_scalar(344, p.p271);s.copy_ad(337, 170);s.store_mul_product3_indices(335, 337, 346, 344, 337, 1.0);s.store_offset_add_ad(336, A::mul3(s.ad_value(253), s.ad_value(127), s.ad_value(346)), A::mul3(s.ad_value(344), s.ad_value(337), s.ad_value(337)), 1e-25);}
        if (s.v[81] != 0.0) {s.store_scalar(336, s.v[565]);}
        s.b[3322] = ((p.p26 != 0.0) && (s.v[78] == 0.0));s.store_scalar(3322, if s.b[3322] { 1.0 } else { 0.0 });
