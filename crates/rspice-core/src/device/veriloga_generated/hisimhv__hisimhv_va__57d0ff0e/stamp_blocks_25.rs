...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_179(
        ...
        if (s.b[3111] && s.b[3112]) {s.store_scalar(236, 0.0);s.store_scalar(233, 0.0);s.store_scalar(217, 0.0);s.store_scalar(420, 0.0);s.store_scalar(215, 0.0);s.store_scalar(447, 0.0);s.store_scalar(445, 0.0);s.store_scalar(446, 0.0);s.store_scalar(79, (-1.0));s.store_scalar(3122, 0.0);s.store_scalar(3123, 0.0);s.store_mul_scaled_ln_ad_rhs(3118, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(3118), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        ...
        if (s.b[3111] && s.b[3112]) {s.store_div(212, 410, 413);s.store_square(213, 212);s.store_sub_from_scalar(402, s.v[458], 395);s.store_sub_from_scalar(403, (10.0 * 2.220446049250313e-16), 397);s.store_scalar(3114, 0.0);s.store_primal_scale(3115, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((s.b[3111] && s.b[3112]) && (!s.b[3132])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
            ...
            if ((s.b[3111] && s.b[3112]) && (!s.b[3132])) {s.store_scale(229, 229, 1.14200738981568e26);s.store_offset(781, 781, (-60.0));}
        }
        if ((s.b[3111] && s.b[3112]) && (!s.b[3132])) {s.store_mul_exp_rhs(229, 229, 781);s.copy_ad(334, 229);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_180(
        ...
        if ((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) {s.store_offset_scaled(781, 402, (-0.5), (((-0.5)) + ((-1.0))));s.store_scalar(782, (4.0 * 0.5));}
        ...
        if ((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(335, 781, 0.5, 782, 0.5, 0.5);}
        s.b[3133] = (((s.v[402] + s.v[397]) > (-s.v[335])) && (s.v[335] >= 0.0));s.store_scalar(3133, if s.b[3133] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        s.b[3134] = ((((1.0 == 1.0) || (1.0 == 2.0)) || (1.0 == 4.0)) || (1.0 == 8.0));s.store_scalar(3134, if s.b[3134] { 1.0 } else { 0.0 });s.b[3135] = (1.0 == 1.0);s.store_scalar(3135, if s.b[3135] { 1.0 } else { 0.0 });
        if (((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && s.b[3135]) {s.store_scalar(720, 1.0);}
        s.b[3136] = (1.0 == 2.0);s.store_scalar(3136, if s.b[3136] { 1.0 } else { 0.0 });
        if ((((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && (!s.b[3135])) && s.b[3136]) {s.store_scalar(720, 2.0);}
        s.b[3137] = (1.0 == 4.0);s.store_scalar(3137, if s.b[3137] { 1.0 } else { 0.0 });
        if (((((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && (!s.b[3135])) && (!s.b[3136])) && s.b[3137]) {s.store_scalar(720, 3.0);}
        s.b[3138] = (1.0 == 8.0);s.store_scalar(3138, if s.b[3138] { 1.0 } else { 0.0 });
        if ((((((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && (!s.b[3135])) && (!s.b[3136])) && (!s.b[3137])) && s.b[3138]) {s.store_scalar(720, 4.0);}
        if ((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) {s.store_scalar(719, 0.0);}
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
            ...
            if ((((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) && s.b[3134]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if (((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_lhs(780, 781, 335, 726);s.store_div_scaled_product3_indices(334, 335, 725, 726, 1.0, 770, 1.0);s.store_add_scaled_inputs(335, 335, -1.0, 780, 1.0);}
        if (((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && s.b[3133]) {
        }
        if (((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) && (!s.b[3133])) {s.store_add(335, 402, 397);s.store_scalar(334, 1.0);}
        if ((s.b[3111] && s.b[3112]) && (s.v[406] != 0.0)) {s.store_sub(397, 335, 402);s.store_sub_from_scalar(403, (10.0 * 2.220446049250313e-16), 397);}
        s.b[3139] = (s.v[402] < s.v[403]);s.store_scalar(3139, if s.b[3139] { 1.0 } else { 0.0 });
        if ((s.b[3111] && s.b[3112]) && s.b[3139]) {s.store_mul_scaled_ln_ad_rhs(271, 155, 2.0, A::div_from_scalar((-s.v[270]), s.ad_value(212)));s.store_mul_add_rhs(332, 154, 402, 397);s.store_div_scalar_by_product_indices(335, 1.0, 154, 410, 1.0);s.store_mul(333, 335, 413);s.store_offset_scaled(279, 333, (3.0 * 1.414213562373095), 2.0);s.store_mul3_affine_lhs(277, 279, 279, 8.0, 0.0, 279);s.store_sub_from_scalar_scaled_mul_mixed_ia(278, (7.0 * 1.414213562373095), 333, A::offset(s.ad_value(332), (-2.0)), 9.0);s.store_square(276, 278);}
        s.b[3140] = (s.v[277] < (s.v[276] * 1e-8));s.store_scalar(3140, if s.b[3140] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && s.b[3139]) && s.b[3140]) {s.store_div_scaled_inputs_indices(274, 277, 0.5, 278, 1.0);}
        if (((s.b[3111] && s.b[3112]) && s.b[3139]) && (!s.b[3140])) {s.store_sqrt_add(275, 277, 276);s.store_sub(274, 275, 278);}
        if ((s.b[3111] && s.b[3112]) && s.b[3139]) {s.store_powf(273, 274, 0.3333333333333333);s.store_add_scaled_inputs_product_mixed_aiii(272, A::sub_from_scalar(((-4.0) * 1.414213562373095), A::scale(s.ad_value(333), 12.0)), 1.0, 273, 2.0, 273, 273, 1.414213562373095);s.store_div(116, 272, 273);s.store_mul(335, 116, 155);s.store_div(336, 335, 271);s.store_sqrt_square_offset(337, 336, 1.0);s.store_sub_div_lhs_indices(404, 335, 337, 397);s.store_sub(336, 402, 404);s.store_mul(398, 413, 336);s.copy_ad(354, 398);s.copy_ad(3122, 404);}
        s.b[3141] = ((s.v[154] * (s.v[402] + s.v[397])) < (1.0 + (((((10.0 * 2.220446049250313e-16) - 1.0) * s.v[213]) * s.v[156]) / 4.0)));s.store_scalar(3141, if s.b[3141] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3141]) {s.store_add_scaled_product_indices(89, 402, 1.0, 213, 154, 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_181(
        ...
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && (!s.b[3141])) {s.store_offset_div_scaled_offset_numerator(332, A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));}
        if ((s.b[3111] && s.b[3112]) && (!s.b[3139])) {s.store_mul_add_rhs(116, 154, 89, 397);}
        s.b[3142] = (s.v[116] >= 3.0);s.store_scalar(3142, if s.b[3142] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3142]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && (!s.b[3142])) {s.store_scalar(434, ((1.0 / (9.0 * ((2.0) as f64).sqrt())) - ((5.0 + (7.0 * (((-3.0)) as f64).exp())) / (54.0 * (((2.0 + (((-3.0)) as f64).exp())) as f64).sqrt()))));s.store_scalar(435, (((1.0 + (((-3.0)) as f64).exp()) / (2.0 * (((2.0 + (((-3.0)) as f64).exp())) as f64).sqrt())) - (((2.0) as f64).sqrt() / 3.0)));s.store_offset_div_from_scalar_ad(436, 1.0, A::mul(s.ad_value(154), s.ad_value(212)), (1.0 / ((2.0) as f64).sqrt()));s.store_div_scaled_inputs2_indices(437, 402, -1.0, 397, -1.0, 212, 1.0);s.store_add_scaled_inputs3_div_scaled_third_mixed_aaii(441, A::div_scaled_product(A::square(s.ad_value(435)), s.ad_value(435), 1.0, A::mul3_scaled_output(s.ad_value(434), s.ad_value(434), s.ad_value(434), 27.0), 1.0), 1.0, A::div_scaled_product_by_product(s.ad_value(435), s.ad_value(436), 1.0, s.ad_value(434), s.ad_value(434), 6.0), (-1.0), 437, 1.0, 434, 2.0, 1.0);s.store_div_scaled_value_by_product_mixed_aii(440, A::add_scaled_square_product(s.ad_value(435), (-1.0), s.ad_value(434), s.ad_value(436), 3.0), 1.0, 434, 434, 9.0);s.store_sqrt_add_scaled_square_cube_product(339, 441, 1.0, 440, 1.0);s.store_powf_ad(439, A::sub(s.ad_value(339), s.ad_value(441)), 0.3333333333333333);s.store_neg_powf_add_input(438, 441, 339, 0.3333333333333333);s.store_add_scaled_inputs3_div_scaled_third_indices(116, 439, 1.0, 438, 1.0, 435, 1.0, 434, 3.0, -1.0);s.store_add_scaled_product_indices(89, 397, (-1.0), 116, 155, 1.0);}
        s.b[3143] = (p[33] > 0.0);s.store_scalar(3143, if s.b[3143] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) {s.store_offset_add(442, 402, 397, 0.1);s.store_mul(222, 405, 229);s.store_mul(443, 405, 229);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_182(
        ...
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) {s.store_mul(334, 156, 213);s.store_mul(444, 154, 442);s.store_add_scaled_inputs_product_mixed_aaii(447, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), 1.0, A::ln(A::mul(s.ad_value(405), s.ad_value(334))), (-1.0), 154, 397, 1.0);}
        s.b[3144] = (p[33] == 2.0);s.store_scalar(3144, if s.b[3144] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3144]) {s.store_offset_sub(781, 444, 447, (-1.0));s.store_scale(782, 444, 4.0);}
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3144]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(335, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_indices(447, 444, 1.0, 781, (-0.5), 782, (-0.5));}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && (!s.b[3144])) {
            if (s.v[447] <= s.v[444]) {
            } else {
                s.copy_ad(447, 444);
        ...
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) {s.store_sub(444, 444, 447);s.store_add_scaled_inputs(444, 444, 1.0, 154, 0.1);s.store_sub_ad(335, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), A::ln(A::mul(s.ad_value(405), s.ad_value(334))));s.store_add_scaled_product_indices(446, 335, 1.0, 154, 397, 1.0);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) {
            if (s.v[446] >= 0.0) {
            } else {
        ...
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) {s.copy_ad(445, 116);}
        s.b[3145] = (p[33] == 2.0);s.store_scalar(3145, if s.b[3145] { 1.0 } else { 0.0 });s.b[3146] = ((s.v[445] > (s.v[446] - (0.2 * s.v[446]))) && ((0.2 * s.v[446]) >= 0.0));s.store_scalar(3146, if s.b[3146] { 1.0 } else { 0.0 });
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) {s.store_add_scaled_inputs3_indices(781, 445, 1.0, 446, (-1.0), 446, 0.2);s.store_square(722, 781);s.store_scaled_mul(723, 446, 446, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        s.b[3147] = ((((2.0 == 1.0) || (2.0 == 2.0)) || (2.0 == 4.0)) || (2.0 == 8.0));s.store_scalar(3147, if s.b[3147] { 1.0 } else { 0.0 });s.b[3148] = (2.0 == 1.0);s.store_scalar(3148, if s.b[3148] { 1.0 } else { 0.0 });
        if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && s.b[3148]) {s.store_scalar(720, 1.0);}
        s.b[3149] = (2.0 == 2.0);s.store_scalar(3149, if s.b[3149] { 1.0 } else { 0.0 });
        if ((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && (!s.b[3148])) && s.b[3149]) {s.store_scalar(720, 2.0);}
        s.b[3150] = (2.0 == 4.0);s.store_scalar(3150, if s.b[3150] { 1.0 } else { 0.0 });
        if (((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && (!s.b[3148])) && (!s.b[3149])) && s.b[3150]) {s.store_scalar(720, 3.0);}
        s.b[3151] = (2.0 == 8.0);s.store_scalar(3151, if s.b[3151] { 1.0 } else { 0.0 });
        if ((((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && (!s.b[3148])) && (!s.b[3149])) && (!s.b[3150])) && s.b[3151]) {s.store_scalar(720, 4.0);}
        if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) {s.store_scalar(719, 0.0);}
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
            ...
            if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) && s.b[3147]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_affine_lhs(780, 781, 446, 0.2, 0.0, 726);s.store_div_scaled_product3_indices(335, 446, 725, 726, 0.2, 770, 1.0);s.store_add_scaled_inputs3_indices(116, 446, 1.0, 446, (-0.2), 780, 1.0);}
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && s.b[3146]) {
        }
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && (!s.b[3146])) {s.copy_ad(116, 445);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_183(
        ...
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3143]) && s.b[3145]) && (!s.b[3146])) {s.store_scalar(335, 1.0);}
        ...
        s.b[3152] = (p[33] == 1.0);s.store_scalar(3152, if s.b[3152] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) {s.store_add_scaled_product_indices(404, 397, (-1.0), 116, 155, 1.0);}
        s.b[3153] = (s.v[411] > 0.0);s.store_scalar(3153, if s.b[3153] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && s.b[3153]) {s.store_sub_from_scalar(336, p[334], 411);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3153])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p[137]), 782, 0.5);}
        s.b[3154] = (s.v[336] < 0.0);s.store_scalar(3154, if s.b[3154] { 1.0 } else { 0.0 });
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3153])) && s.b[3154]) {s.store_scalar(336, 0.0);s.store_scalar(343, 0.0);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3153])) {s.store_scaled_sqrt_mul(600, 651, 336, p[432]);s.store_sub_from_scalar(336, p[334], 600);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p[334] * 0.01)) * (p[334] * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        s.b[3155] = (s.v[336] < 0.0);s.store_scalar(3155, if s.b[3155] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && s.b[3155]) {s.store_scalar(336, 0.0);s.store_scalar(343, 0.0);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3115, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_add(414, 404, 397);s.store_mul_sub_rhs(333, 419, 414, 418);}
        s.b[3156] = (s.v[333] < 60.0);s.store_scalar(3156, if s.b[3156] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && s.b[3156]) {s.store_exp(335, 333);s.store_exp_mul_scaled_lhs_indices(334, 419, -1.0, 418);s.store_sub(336, 335, 334);s.store_div_ln_offset_lhs(416, 336, 1.0, 419);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && (!s.b[3156])) {s.store_sub(416, 414, 418);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) {s.store_mul(415, 154, 416);}
        s.b[3157] = ((s.v[415] > (s.v[116] / 100.0)) && (s.v[415] > 0.0));s.store_scalar(3157, if s.b[3157] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3152]) && s.b[3157]) {s.store_primal_offset(3121, 3121, 1.0);s.copy_ad(116, 447);}
        if ((s.b[3111] && s.b[3112]) && (!s.b[3139])) {s.store_add_scaled_product_indices(404, 397, (-1.0), 116, 155, 1.0);}
        s.b[3158] = (((s.v[116]) as f64).abs() > 1e-6);s.store_scalar(3158, if s.b[3158] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3158]) {s.store_add_offset_lhs_mixed_ia(335, 116, (-1.0), A::exp_scaled_input(s.ad_value(116), -1.0));s.store_sqrt(336, 335);}
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && (!s.b[3158])) {s.store_mul_scaled_sqrt_ad_rhs(336, 116, 0.7071067811865475, A::sub_from_scalar(1.0, A::scale(s.ad_value(116), 0.3333333333333333)));}
        if ((s.b[3111] && s.b[3112]) && (!s.b[3139])) {s.store_mul(354, 410, 336);s.store_mul_sub_rhs(398, 413, 402, 404);s.store_div(3159, 354, 3115);}
        s.b[3161] = (p[33] == 2.0);s.store_scalar(3161, if s.b[3161] { 1.0 } else { 0.0 });s.b[3162] = ((s.v[3159] > (s.v[386] - (s.v[386] * 0.1))) && ((s.v[386] * 0.1) >= 0.0));s.store_scalar(3162, if s.b[3162] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) {s.store_add_scaled_inputs3_indices(781, 3159, 1.0, 386, (-1.0), 386, 0.1);s.store_square(722, 781);s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        s.b[3163] = ((((2.0 == 1.0) || (2.0 == 2.0)) || (2.0 == 4.0)) || (2.0 == 8.0));s.store_scalar(3163, if s.b[3163] { 1.0 } else { 0.0 });s.b[3164] = (2.0 == 1.0);s.store_scalar(3164, if s.b[3164] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_184(
        ...
        if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && s.b[3164]) {s.store_scalar(720, 1.0);}
        s.b[3165] = (2.0 == 2.0);s.store_scalar(3165, if s.b[3165] { 1.0 } else { 0.0 });
        if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && (!s.b[3164])) && s.b[3165]) {s.store_scalar(720, 2.0);}
        s.b[3166] = (2.0 == 4.0);s.store_scalar(3166, if s.b[3166] { 1.0 } else { 0.0 });
        if ((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && (!s.b[3164])) && (!s.b[3165])) && s.b[3166]) {s.store_scalar(720, 3.0);}
        s.b[3167] = (2.0 == 8.0);s.store_scalar(3167, if s.b[3167] { 1.0 } else { 0.0 });
        if (((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && (!s.b[3164])) && (!s.b[3165])) && (!s.b[3166])) && s.b[3167]) {s.store_scalar(720, 4.0);}
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) {s.store_scalar(719, 0.0);}
        let mut t7: usize = 0;
        while {
            let t6: f64 = if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
            ...
            if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) && s.b[3163]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_affine_lhs(780, 781, 386, 0.1, 0.0, 726);s.store_div_scaled_product3_indices(334, 386, 725, 726, 0.1, 770, 1.0);s.store_add_scaled_inputs3_indices(335, 386, 1.0, 386, (-0.1), 780, 1.0);}
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3162]) {
        }
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && (!s.b[3162])) {s.copy_ad(335, 3159);s.store_scalar(334, 1.0);}
        s.b[3168] = (s.v[334] < 1.0);s.store_scalar(3168, if s.b[3168] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3161]) && s.b[3168]) {s.store_primal_offset(3121, 3121, 2.0);}
        ...
        s.b[3169] = (s.v[3159] >= s.v[386]);s.store_scalar(3169, if s.b[3169] { 1.0 } else { 0.0 });
        if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && (!s.b[3161])) && s.b[3169]) {s.store_primal_offset(3121, 3121, 2.0);}
        s.b[3170] = (s.v[3121] >= 2.0);s.store_scalar(3170, if s.b[3170] { 1.0 } else { 0.0 });
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) {s.copy_ad(3160, 404);s.store_mul(354, 335, 3115);s.store_sub_div_rhs_indices(404, 402, 354, 413);}
        ...
        if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) {s.store_offset_sub(781, 404, 3160, 0.1);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && s.b[3174]) {s.store_scalar(720, 1.0);}
        s.b[3175] = (2.0 == 2.0);s.store_scalar(3175, if s.b[3175] { 1.0 } else { 0.0 });
        if ((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && (!s.b[3174])) && s.b[3175]) {s.store_scalar(720, 2.0);}
        s.b[3176] = (2.0 == 4.0);s.store_scalar(3176, if s.b[3176] { 1.0 } else { 0.0 });
        if (((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && (!s.b[3174])) && (!s.b[3175])) && s.b[3176]) {s.store_scalar(720, 3.0);}
        s.b[3177] = (2.0 == 8.0);s.store_scalar(3177, if s.b[3177] { 1.0 } else { 0.0 });
        if ((((((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && (!s.b[3174])) && (!s.b[3175])) && (!s.b[3176])) && s.b[3177]) {s.store_scalar(720, 4.0);}
        if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) {s.store_scalar(719, 0.0);}
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
            ...
            if ((((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3170]) && s.b[3171]) && s.b[3172]) && s.b[3173]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
    ...
    pub(super) fn stamp_reactive_block_185(
        ...
        if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) {s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3115)), s.ad_value(155)), 2.0);}
    ...
    pub(super) fn stamp_reactive_block_186(
        ...
        let mut tc: usize = 0;
        while {
            let ta: f64 = (s.v[421] + 1.0);let tb: f64 = if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (s.v[97] <= ta)) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
            tc += 1;
            ...
            if ((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && s.b[3192]) {s.store_scalar(97, (s.v[421] + 1.0));}
            ...
            if (((((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) && (!s.b[3192])) && s.b[3194]) {s.store_scalar(79, 1.0);}
            if (((s.b[3111] && s.b[3112]) && (!s.b[3139])) && s.b[3178]) {s.store_primal_offset(97, 97, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_187(
        ...
        if ((s.b[3111] && s.b[3112]) && s.b[3196]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 3122);s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(3115)), s.ad_value(155)), 2.0);}
        ...
        if ((s.b[3111] && s.b[3112]) && s.b[3196]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 3115, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_188(
        ...
        let mut tf: usize = 0;
        while {
            let td: f64 = (s.v[421] + 1.0);let te: f64 = if (((s.b[3111] && s.b[3112]) && s.b[3196]) && (s.v[97] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
            ...
            if (((s.b[3111] && s.b[3112]) && s.b[3196]) && s.b[3207]) {s.store_scalar(97, (s.v[421] + 1.0));}
            ...
            if ((((s.b[3111] && s.b[3112]) && s.b[3196]) && (!s.b[3207])) && s.b[3209]) {s.store_primal_offset(79, 79, 2.0);}
            if ((s.b[3111] && s.b[3112]) && s.b[3196]) {s.store_primal_offset(97, 97, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_189(
        ...
        if s.b[3215] {s.store_scalar(2623, 1.0);s.store_scalar(289, s.v[564]);s.store_scalar(290, p[276]);s.store_scalar(335, (s.v[188] * s.v[635]));}
        ...
        if s.b[3217] {s.store_scalar(2626, 1.0);s.store_scalar(289, s.v[564]);s.store_scalar(290, p[276]);s.store_scale(335, 412, s.v[635]);}
    ...
    pub(super) fn stamp_reactive_block_190(
        ...
        if (((s.b[3222] && s.b[3223]) && s.b[3224]) && s.b[3225]) {s.store_scalar(720, 1.0);}
        s.b[3226] = (2.0 == 2.0);s.store_scalar(3226, if s.b[3226] { 1.0 } else { 0.0 });
        if ((((s.b[3222] && s.b[3223]) && s.b[3224]) && (!s.b[3225])) && s.b[3226]) {s.store_scalar(720, 2.0);}
        s.b[3227] = (2.0 == 4.0);s.store_scalar(3227, if s.b[3227] { 1.0 } else { 0.0 });
        if (((((s.b[3222] && s.b[3223]) && s.b[3224]) && (!s.b[3225])) && (!s.b[3226])) && s.b[3227]) {s.store_scalar(720, 3.0);}
        s.b[3228] = (2.0 == 8.0);s.store_scalar(3228, if s.b[3228] { 1.0 } else { 0.0 });
        if ((((((s.b[3222] && s.b[3223]) && s.b[3224]) && (!s.b[3225])) && (!s.b[3226])) && (!s.b[3227])) && s.b[3228]) {s.store_scalar(720, 4.0);}
        if ((s.b[3222] && s.b[3223]) && s.b[3224]) {s.store_scalar(719, 0.0);}
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((s.b[3222] && s.b[3223]) && s.b[3224]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
            t11 += 1;
            ...
            if ((s.b[3222] && s.b[3223]) && s.b[3224]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if ((!s.b[3230]) && s.b[3231]) {s.store_add_scaled_product_indices(304, 87, 1.0, 303, 162, 1.0);s.store_add_scaled_inputs3_indices(335, 1439, s.v[172], 87, s.v[172], 304, (1.0 - s.v[172]));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_191(
        ...
        if ((!s.b[3230]) && s.b[3231]) {s.store_mul_scale_offset_mixed_ia(305, 336, A::add_scaled_inputs3(s.ad_value(87), 1.0, s.ad_value(1439), 1.0, s.ad_value(335), -1.0), (-1.0 / (p[133])), 0.0);}
        ...
        if (s.b[3233] && s.b[3236]) {s.store_offset(336, 847, 1e-25);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(848, s.v[820], 154, A::ln_offset_div_scaled_inputs(s.ad_value(334), s.v[822], s.ad_value(336), 1.0, 1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_192(
        ...
        if (s.b[3233] && s.b[3236]) {s.store_exp_scaled_input_ad(849, A::offset(s.ad_value(676), (-1.0)), p[512]);s.store_div_from_scalar_div_from_scalar_ad(850, 1.0, s.v[820], s.ad_value(154));s.store_exp_mul(851, 848, 850);}
        ...
        if (s.b[3233] && s.b[3240]) {s.store_offset_scaled(833, 391, ((p[483]) * ((p[501] * (p[15] - s.v[632])))), (p[501] * (p[15] - s.v[632])));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_193(
        ...
        if (s.b[3233] && s.b[3240]) {s.store_offset_scaled(834, 391, ((p[485]) * ((p[502] * s.v[632]))), (p[502] * s.v[632]));}
        ...
        s.store_scale(346, 874, p[514]);s.b[3257] = (s.v[875] > 0.0);s.store_scalar(3257, if s.b[3257] { 1.0 } else { 0.0 });
        ...
        if (s.b[3257] && (!s.b[3258])) {s.copy_ad(335, 851);s.store_mul3_lhs(338, 875, 850, 335);}
        s.store_scale(346, 876, p[514]);s.b[3260] = (p[48] > 0.0);s.store_scalar(3260, if s.b[3260] { 1.0 } else { 0.0 });s.b[3261] = (s.v[877] > 0.0);s.store_scalar(3261, if s.b[3261] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_194(
        ...
        if s.b[3260] {s.store_scale(346, 878, p[514]);}
        ...
        if (s.b[3264] && (!s.b[3265])) {s.copy_ad(335, 856);s.store_mul3_lhs(338, 879, 855, 335);}
        s.store_scale(346, 880, p[537]);s.b[3267] = (s.v[881] > 0.0);s.store_scalar(3267, if s.b[3267] { 1.0 } else { 0.0 });
        ...
        s.store_scale(346, 882, p[537]);s.b[3270] = (p[48] > 0.0);s.store_scalar(3270, if s.b[3270] { 1.0 } else { 0.0 });s.b[3271] = (s.v[883] > 0.0);s.store_scalar(3271, if s.b[3271] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3270] && s.b[3271]) && (!s.b[3272])) {s.copy_ad(335, 856);s.store_mul3_lhs(338, 883, 855, 335);}
        if s.b[3270] {s.store_scale(346, 884, p[537]);}
