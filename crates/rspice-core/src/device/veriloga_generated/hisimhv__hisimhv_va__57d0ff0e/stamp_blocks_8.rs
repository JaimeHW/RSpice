...
impl Instance {
    ...
    if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2396]) && s.b[2397]) && s.b[2398]) {
        ...
        s.store_scalar(720, t2);s.b[2399] = (2.0 == 2.0);s.store_scalar(2399, if s.b[2399] { 1.0 } else { 0.0 });
        let (t3,) = {
    if ((((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2396]) && s.b[2397]) && (!s.b[2398])) && s.b[2399]) {
        ...
        s.store_scalar(720, t3);s.b[2400] = (2.0 == 4.0);s.store_scalar(2400, if s.b[2400] { 1.0 } else { 0.0 });
        let (t4,) = {
    if (((((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2396]) && s.b[2397]) && (!s.b[2398])) && (!s.b[2399])) && s.b[2400]) {
        ...
        s.store_scalar(720, t4);s.b[2401] = (2.0 == 8.0);s.store_scalar(2401, if s.b[2401] { 1.0 } else { 0.0 });
        let (t5,) = {
    ...
    if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2396]) && s.b[2397]) {
        ...
        while {
            let t9: f64 = if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2396]) && s.b[2397]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2402]) && s.b[2403]) && s.b[2404]) {
        ...
        s.store_scalar(720, td);s.b[2405] = (2.0 == 2.0);s.store_scalar(2405, if s.b[2405] { 1.0 } else { 0.0 });
        let (te,) = {
    if ((((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2402]) && s.b[2403]) && (!s.b[2404])) && s.b[2405]) {
        ...
        s.store_scalar(720, te);s.b[2406] = (2.0 == 4.0);s.store_scalar(2406, if s.b[2406] { 1.0 } else { 0.0 });
        let (tf,) = {
    if (((((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2402]) && s.b[2403]) && (!s.b[2404])) && (!s.b[2405])) && s.b[2406]) {
        ...
        s.store_scalar(720, tf);s.b[2407] = (2.0 == 8.0);s.store_scalar(2407, if s.b[2407] { 1.0 } else { 0.0 });
        let (t10,) = {
    ...
    pub(super) fn stamp_transient_block_129(
        ...
        let mut t15: usize = 0;
        while {
            let t14: f64 = if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2395]) && s.b[2402]) && s.b[2403]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t14 != 0.0
        } {
            t15 += 1;
    ...
    if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) {
        ...
        while {
            let t1d: f64 = if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) && (s.v[97] <= 150.0)) { 1.0 } else { 0.0 };
            t1d != 0.0
        } {
            t1e += 1;
    ...
    if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) && (s.v[79] == 0.0)) && s.b[2409]) {
        ...
        (s.v[79],)
            ...
            s.store_scalar(79, t18);s.b[2410] = (s.v[2112] > 0.1);s.store_scalar(2410, if s.b[2410] { 1.0 } else { 0.0 });
    ...
    if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) && s.b[2415]) {
        ...
        s.store_scalar(720, t21);s.b[2416] = (2.0 == 2.0);s.store_scalar(2416, if s.b[2416] { 1.0 } else { 0.0 });
        let (t22,) = {
    if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) && (!s.b[2415])) && s.b[2416]) {
        ...
        s.store_scalar(720, t22);s.b[2417] = (2.0 == 4.0);s.store_scalar(2417, if s.b[2417] { 1.0 } else { 0.0 });
        let (t23,) = {
    if ((((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) && (!s.b[2415])) && (!s.b[2416])) && s.b[2417]) {
        ...
        s.store_scalar(720, t23);s.b[2418] = (2.0 == 8.0);s.store_scalar(2418, if s.b[2418] { 1.0 } else { 0.0 });
        let (t24,) = {
    ...
    if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) {
        ...
        while {
            let t28: f64 = if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) && s.b[2414]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t28 != 0.0
        } {
            t29 += 1;
    ...
    pub(super) fn stamp_transient_block_132(
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2423]) {s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(340, 0.01, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);s.store_sub_from_scalar_ad(335, 1.1, A::add(s.ad_value(2089), s.ad_value(340)));s.store_sqrt_square_offset(782, 335, ((4.0 * 0.05) * 0.05));s.store_offset_scaled_div(334, 335, 782, 0.5, 0.5);s.store_scaled_add(336, 335, 782, 0.5);}
    ...
    if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2427]) {
        ...
        s.store_scalar(78, t2a);s.b[2428] = (s.v[791] < s.v[86]);s.store_scalar(2428, if s.b[2428] { 1.0 } else { 0.0 });
        let (t2c,) = {
    if ((!s.b[1443]) && s.b[2428]) {
        ...
        if ((!s.b[1443]) && s.b[2428]) {s.store_add_scaled_inputs_product_mixed_aiii(272, A::sub_from_scalar(((-4.0) * 1.414213562373095), A::scale(s.ad_value(333), 12.0)), 1.0, 273, 2.0, 273, 273, 1.414213562373095);s.store_div_from_scalar(335, 1.0, 273);s.store_mul(116, 272, 335);s.store_add_scaled_product_indices(167, 1435, 1.0, 116, 155, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_133(
        s: &mut Scratch,
    ) {
        if ((!s.b[1443]) && s.b[2428]) {s.store_sub(335, 167, 1435);s.store_div(336, 335, 271);s.store_sqrt_square_offset(337, 336, 1.0);s.store_add_div_lhs_indices(87, 335, 337, 1435);s.copy_ad(91, 87);s.store_scalar(94, 0.0);s.store_sub(336, 85, 87);s.store_mul(131, 185, 336);s.store_scalar(133, 0.0);s.store_scalar(247, 0.0);s.store_scalar(169, 0.0);s.store_scalar(134, 0.0);s.store_scalar(127, 0.0);}
        let (t2d,) = {
    if ((!s.b[1443]) && s.b[2428]) {
        (1.0,)
    } else {
    ...
    if ((!s.b[1443]) && s.b[2428]) {
        ...
        s.store_scalar(946, t2e);s.b[2430] = (s.v[946] == 0.0);s.store_scalar(2430, if s.b[2430] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_135(
        ...
        let mut t3a: usize = 0;
        while {
            let t38: f64 = (s.v[421] + 1.0);let t39: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[97] <= t38)) { 1.0 } else { 0.0 };
            t39 != 0.0
        } {
            t3a += 1;
    ...
    if (((!s.b[1443]) && s.b[2430]) && s.b[2437]) {
        ...
        (s.v[944],)
            ...
            s.store_scalar(944, t31);s.b[2438] = (s.v[944] == 0.0);s.store_scalar(2438, if s.b[2438] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[1443]) && s.b[2430]) {
        ...
        s.store_scalar(97, t3c);s.b[2442] = (s.v[116] < 5.0);s.store_scalar(2442, if s.b[2442] { 1.0 } else { 0.0 });
        if (((!s.b[1443]) && s.b[2430]) && s.b[2442]) {s.store_offset_square(99, 223, (10.0 * 2.220446049250313e-16));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_136(
        s: &mut Scratch,
    ) {
        if (((!s.b[1443]) && s.b[2430]) && s.b[2442]) {s.store_offset(100, 223, (10.0 * 2.220446049250313e-16));s.store_offset_mul_ad(101, A::square(s.ad_value(223)), s.ad_value(223), (10.0 * 2.220446049250313e-16));}
        let (t3d,) = {
    ...
    if (((!s.b[1443]) && s.b[2430]) && s.b[2447]) {
        ...
        s.store_scalar(947, t43);s.b[2448] = (s.v[947] == 0.0);s.store_scalar(2448, if s.b[2448] { 1.0 } else { 0.0 });s.b[2449] = (s.v[77] == 0.0);s.store_scalar(2449, if s.b[2449] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_138(
        ...
        let mut t50: usize = 0;
        while {
            let t4e: f64 = (40.0 + 1.0);let t4f: f64 = if (((!s.b[1443]) && s.b[2430]) && (s.v[98] <= t4e)) { 1.0 } else { 0.0 };
            t4f != 0.0
        } {
            t50 += 1;
    ...
    if (((!s.b[1443]) && s.b[2430]) && s.b[2454]) {
        ...
        (s.v[945],)
            ...
            s.store_scalar(945, t47);s.b[2455] = (s.v[945] == 0.0);s.store_scalar(2455, if s.b[2455] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[1443]) && s.b[2430]) {
        ...
        s.store_scalar(98, t52);s.b[2459] = (s.v[116] < 5.0);s.store_scalar(2459, if s.b[2459] { 1.0 } else { 0.0 });
    ...
    if (((!s.b[1443]) && s.b[2430]) && s.b[2460]) {
        ...
        s.store_scalar(948, t53);s.b[2461] = (s.v[948] == 0.0);s.store_scalar(2461, if s.b[2461] { 1.0 } else { 0.0 });s.b[2462] = ((s.v[508] < (10.0 * 2.220446049250313e-16)) && (s.v[509] < (10.0 * 2.220446049250313e-16)));s.store_scalar(2462, if s.b[2462] { 1.0 } else { 0.0 });
    ...
    if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && s.b[2465]) {
        ...
        s.store_scalar(720, t56);s.b[2466] = (2.0 == 2.0);s.store_scalar(2466, if s.b[2466] { 1.0 } else { 0.0 });
        let (t57,) = {
    if ((((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && (!s.b[2465])) && s.b[2466]) {
        ...
        s.store_scalar(720, t57);s.b[2467] = (2.0 == 4.0);s.store_scalar(2467, if s.b[2467] { 1.0 } else { 0.0 });
        let (t58,) = {
    if (((((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && (!s.b[2465])) && (!s.b[2466])) && s.b[2467]) {
        ...
        s.store_scalar(720, t58);s.b[2468] = (2.0 == 8.0);s.store_scalar(2468, if s.b[2468] { 1.0 } else { 0.0 });
        let (t59,) = {
    ...
    pub(super) fn stamp_transient_block_140(
        ...
        let mut t5e: usize = 0;
        while {
            let t5d: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2462]) && s.b[2463]) && s.b[2464]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t5d != 0.0
        } {
            t5e += 1;
    ...
    if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && s.b[2471]) {
        ...
        s.store_scalar(720, t61);s.b[2472] = (2.0 == 2.0);s.store_scalar(2472, if s.b[2472] { 1.0 } else { 0.0 });
        let (t62,) = {
    if ((((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && (!s.b[2471])) && s.b[2472]) {
        ...
        s.store_scalar(720, t62);s.b[2473] = (2.0 == 4.0);s.store_scalar(2473, if s.b[2473] { 1.0 } else { 0.0 });
        let (t63,) = {
    if (((((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && (!s.b[2471])) && (!s.b[2472])) && s.b[2473]) {
        ...
        s.store_scalar(720, t63);s.b[2474] = (2.0 == 8.0);s.store_scalar(2474, if s.b[2474] { 1.0 } else { 0.0 });
        let (t64,) = {
    ...
    if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) {
        ...
        while {
            let t68: f64 = if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t68 != 0.0
        } {
            t69 += 1;
    ...
    if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) && s.b[2469]) && s.b[2470]) {
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) {s.store_sub(340, 168, 91);s.store_mul(337, 154, 238);s.store_div_from_scalar(335, 1.0, 337);s.store_mul_ad_product_lhs_mixed_ai(339, A::offset(s.ad_value(94), (10.0 * 2.220446049250313e-16)), 250, 335);s.store_mul(336, 339, 154);s.store_scale(344, 166, 9662367879.197212);}
    }
    #[inline(never)]
    ...
    if (((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && s.b[2476]) {
        ...
        s.store_scalar(720, t6c);s.b[2477] = (4.0 == 2.0);s.store_scalar(2477, if s.b[2477] { 1.0 } else { 0.0 });
        let (t6d,) = {
    if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && (!s.b[2476])) && s.b[2477]) {
        ...
        s.store_scalar(720, t6d);s.b[2478] = (4.0 == 4.0);s.store_scalar(2478, if s.b[2478] { 1.0 } else { 0.0 });
        let (t6e,) = {
    if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && (!s.b[2476])) && (!s.b[2477])) && s.b[2478]) {
        ...
        s.store_scalar(720, t6e);s.b[2479] = (4.0 == 8.0);s.store_scalar(2479, if s.b[2479] { 1.0 } else { 0.0 });
        let (t6f,) = {
    ...
    if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) {
        ...
        while {
            let t73: f64 = if (((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2475]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t73 != 0.0
        } {
            t74 += 1;
    ...
    if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && s.b[2482]) {
        ...
        s.store_scalar(720, t77);s.b[2483] = (2.0 == 2.0);s.store_scalar(2483, if s.b[2483] { 1.0 } else { 0.0 });
        let (t78,) = {
    if (((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && (!s.b[2482])) && s.b[2483]) {
        ...
        s.store_scalar(720, t78);s.b[2484] = (2.0 == 4.0);s.store_scalar(2484, if s.b[2484] { 1.0 } else { 0.0 });
        let (t79,) = {
    if ((((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && (!s.b[2482])) && (!s.b[2483])) && s.b[2484]) {
        ...
        s.store_scalar(720, t79);s.b[2485] = (2.0 == 8.0);s.store_scalar(2485, if s.b[2485] { 1.0 } else { 0.0 });
        let (t7a,) = {
    ...
    if (((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) {
        ...
        while {
            let t7e: f64 = if ((((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2480]) && s.b[2481]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t7e != 0.0
        } {
            t7f += 1;
