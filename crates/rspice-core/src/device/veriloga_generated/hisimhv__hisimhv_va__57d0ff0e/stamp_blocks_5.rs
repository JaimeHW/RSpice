...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_86(
        ...
        while {
            ...
            if (((s.v[2625] != 0.0) && s.b[2964]) && (!s.b[2970])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_scaled_inputs4(2891, s.ad_value(116), 1.0, s.ad_value(415), (-1.0), s.ad_value(334), 1.0, s.ad_value(335), (-1.0));
            ...
            if (((s.v[2625] != 0.0) && s.b[2964]) && s.b[2973]) {
                ...
                s.store_div_scaled_inputs2(217, s.ad_value(2892), 0.5, s.ad_value(215), 0.5, s.ad_value(216), 1.0);
            }
            s.b[2974] = (s.v[2891] > 0.0);
            s.v[2974] = if s.b[2974] { 1.0 } else { 0.0 };
            if ((((s.v[2625] != 0.0) && s.b[2964]) && (!s.b[2973])) && s.b[2974]) {
                s.store_sqrt(216, 2891);
                s.store_div_scaled_inputs(217, s.ad_value(2892), 0.5, s.ad_value(216), 1.0);
            }
            if ((((s.v[2625] != 0.0) && s.b[2964]) && (!s.b[2973])) && (!s.b[2974])) {
                s.store_scalar(216, 0.0);
                s.store_scalar(217, 0.0);
    ...
    if ((s.v[2625] != 0.0) && s.b[2964]) {
        ...
        if (((s.v[2625] != 0.0) && s.b[2979]) && s.b[2980]) {
            s.store_sqrt_offset_ad(782, A::mul_offset_lhs(s.ad_value(2884), p.p137, A::offset(s.ad_value(2884), p.p137)), ((4.0 * 0.1) * 0.1));
