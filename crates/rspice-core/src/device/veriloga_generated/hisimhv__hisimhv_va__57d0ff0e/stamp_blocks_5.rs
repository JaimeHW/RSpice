...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_93(
        ...
        if s.b[3322] {
            ...
            s.store_ad_value(337, A::sub_scaled_inputs(A::div_scaled_inputs(s.ad_value(979), ((-2.0) * 6.241449993689894e18), s.ad_value(170), 1.0), 1.0 / (s.v[635]), s.ad_value(335), 1.0));
        }
