...
impl Instance {
    ...
    if (((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && s.b[2031]) && s.b[2032]) && s.b[2033]) {
        ...
        s.store_scalar(720, tc0);s.b[2034] = (s.v[1914] == 2.0);s.store_scalar(2034, if s.b[2034] { 1.0 } else { 0.0 });
        let (tc1,) = {
    if ((((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && s.b[2031]) && s.b[2032]) && (!s.b[2033])) && s.b[2034]) {
        ...
        s.store_scalar(720, tc1);s.b[2035] = (s.v[1914] == 4.0);s.store_scalar(2035, if s.b[2035] { 1.0 } else { 0.0 });
        let (tc2,) = {
    if (((((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && s.b[2031]) && s.b[2032]) && (!s.b[2033])) && (!s.b[2034])) && s.b[2035]) {
        ...
        s.store_scalar(720, tc2);s.b[2036] = (s.v[1914] == 8.0);s.store_scalar(2036, if s.b[2036] { 1.0 } else { 0.0 });
        let (tc3,) = {
    ...
    if (((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && s.b[2037]) && s.b[2038]) && s.b[2039]) {
        ...
        s.store_scalar(720, td0);s.b[2040] = (s.v[1914] == 2.0);s.store_scalar(2040, if s.b[2040] { 1.0 } else { 0.0 });
        let (td1,) = {
    ...
    if (((((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && s.b[2037]) && s.b[2038]) && (!s.b[2039])) && (!s.b[2040])) && s.b[2041]) {
        ...
        s.store_scalar(720, td2);s.b[2042] = (s.v[1914] == 8.0);s.store_scalar(2042, if s.b[2042] { 1.0 } else { 0.0 });
        let (td3,) = {
    ...
    if ((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && (!s.b[2030])) && (s.v[79] == 0.0)) && s.b[2044]) {
        ...
        (s.v[79],)
            ...
            s.store_scalar(79, tdd);s.b[2045] = (s.v[1882] > 0.1);s.store_scalar(2045, if s.b[2045] { 1.0 } else { 0.0 });
    ...
    if (((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && s.b[2057]) && s.b[2058]) && s.b[2059]) && s.b[2060]) {
        ...
        s.store_scalar(720, te4);s.b[2061] = (2.0 == 2.0);s.store_scalar(2061, if s.b[2061] { 1.0 } else { 0.0 });
        let (te5,) = {
    if ((((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && s.b[2057]) && s.b[2058]) && s.b[2059]) && (!s.b[2060])) && s.b[2061]) {
        ...
        s.store_scalar(720, te5);s.b[2062] = (2.0 == 4.0);s.store_scalar(2062, if s.b[2062] { 1.0 } else { 0.0 });
        let (te6,) = {
    if (((((((s.b[1443] && (s.b[1445] && (!s.b[1444]))) && s.b[2057]) && s.b[2058]) && s.b[2059]) && (!s.b[2060])) && (!s.b[2061])) && s.b[2062]) {
        ...
        s.store_scalar(720, te6);s.b[2063] = (2.0 == 8.0);s.store_scalar(2063, if s.b[2063] { 1.0 } else { 0.0 });
        let (te7,) = {
