...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if (s.b[1289] && s.b[1326]) {s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p[418]), p[418]));s.store_div_from_scalar(795, s.v[570], 334);s.store_offset_scaled(959, 387, p[439], (((((-s.v[764])) * (p[439]))) + (s.v[959])));}
        if (s.b[1289] && s.b[1326]) {
            if (s.v[676] == 0.0) {
                s.store_scalar(335, 0.0);
            } else {
        ...
        if (s.b[1289] && (!s.b[1329])) {s.store_scale(873, 828, p[13]);s.store_scale(874, 830, p[13]);s.store_scale(875, 829, p[15]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_18(
        ...
        if (s.b[1289] && (!s.b[1329])) {s.store_scale(876, 831, p[15]);s.store_scalar(877, 0.0);s.store_scalar(878, 0.0);}
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        if (s.b[1352] && s.b[1355]) {s.store_div_mixed_ia(966, 966, A::powf(s.ad_value(676), p[381]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_21(
        ...
        if (s.b[1352] && s.b[1355]) {s.store_div_mixed_ia(970, 970, A::powf(s.ad_value(676), p[382]));}
    ...
    pub(super) fn stamp_transient_block_26(
        ...
        if s.b[1405] {s.store_scalar(782, ((4.0 * p[334]) * (0.1 * p[334])));}
        if s.b[1405] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if (!s.b[1426]) {s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_mixed_aii(336, A::div_from_scalar(1.0, s.ad_value(338)), 1.0, 781, (-0.5), 782, (-0.5));s.store_offset_scaled(184, 336, p[235], p[237]);s.store_scalar(341, p[235]);}
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if s.b[1430] {s.store_offset_scaled(336, 180, (s.v[467] * 1.0 / (p[140])), s.v[465]);s.store_add_scaled_inputs(337, 336, 1.0, 106, s.v[466]);s.store_offset(178, 106, p[221]);s.store_square(179, 178);s.store_add_scaled_inputs3_mixed_aia(174, A::mul3(s.ad_value(335), s.ad_value(121), s.ad_value(337)), 1.0, 177, 1.0, A::div(s.ad_value(618), s.ad_value(179)), -1.0);}
