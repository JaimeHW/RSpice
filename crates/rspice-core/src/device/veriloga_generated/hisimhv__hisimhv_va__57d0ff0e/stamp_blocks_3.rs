...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            s.copy_ad(134, 135);
            s.store_ad_value(131, A::add_scaled_inputs4(s.ad_value(2098), (-0.5), s.ad_value(2122), ((-1.0) * (-0.5)), s.ad_value(2099), (-0.5), s.ad_value(2123), (-(-0.5))));
    ...
    pub(super) fn stamp_transient_block_55(
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_ad_value(335, A::add_scaled_inputs4(s.ad_value(85), 1.0, s.ad_value(155), 1.0, s.ad_value(87), (-(2.0 * 0.5)), s.ad_value(94), (-0.5)));
    ...
    pub(super) fn stamp_transient_block_60(
        ...
        while {
            ...
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2561])) && (!s.b[2562])) {
                ...
                s.store_sqrt_square_add(216, 223, 214);
                s.store_ad_value(217, A::div_scaled_add_product(s.ad_value(215), 0.5, s.ad_value(2553), s.ad_value(223), (2.0 * 0.5), s.ad_value(216), 1.0));
            }
            if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) {
    ...
    pub(super) fn stamp_transient_block_63(
        ...
        if s.b[2603] {
            ...
            s.store_scaled_offset_ad(336, A::add_scaled_inputs4(s.ad_value(1438), s.v[493], s.ad_value(1440), (-1.0), s.ad_value(122), 1.0, s.ad_value(174), 1.0), (-s.v[492]), (-1.0 / (s.v[187])));
        ...
        if (!s.b[2615]) {
            s.store_ad_value(335, A::add_scaled_inputs4_offset(s.ad_value(196), p.p242, s.ad_value(791), (-1.0), s.ad_value(122), p.p244, s.ad_value(174), p.p244, (p.p243 * p.p242)));
