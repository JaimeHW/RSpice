...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_mul_offset_ad_rhs(2132, 964, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2115), 1.0, A::div_from_scalar(1.0, A::offset(A::div_scaled_product(s.ad_value(254), s.ad_value(2115), 1.0, s.ad_value(973), 1.0), 1.0)), p.p400), 1.0);
    ...
    pub(super) fn stamp_transient_block_57(
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2487]) {
            s.copy_ad(335, 131);
            s.store_ad_value(131, A::add_scaled_product(A::mul_sub_from_scalar_lhs(1.0, s.ad_value(207), s.ad_value(239)), 1.0, s.ad_value(207), s.ad_value(131), 1.0));
        }
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && s.b[2487]) {
            s.copy_ad(335, 133);
            s.store_ad_value(133, A::add_scaled_product(A::mul_sub_from_scalar_lhs(1.0, s.ad_value(207), s.ad_value(238)), 1.0, s.ad_value(207), s.ad_value(133), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_60(
        ...
        while {
            ...
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2557])) && s.b[2559]) {
                ...
                s.store_ad_value(336, A::mul_sub_from_scalar_rhs_scaled_output(A::square(s.ad_value(2550)), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2550), 1.0, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(2550), 1.0, A::scale(s.ad_value(2550), 0.2), 1.0 / (4.0)), 1.0 / (3.0)), 1.0 / (2.0)));
            ...
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2557])) && (!s.b[2559])) {
                ...
                s.store_ad_value(2553, A::div_scaled_product(s.ad_value(154), A::sub(A::sub_from_scalar(1.0, s.ad_value(334)), A::mul_sub_from_scalar_rhs(s.ad_value(2552), 1.0, s.ad_value(335))), 0.5, s.ad_value(223), 1.0));
            }
