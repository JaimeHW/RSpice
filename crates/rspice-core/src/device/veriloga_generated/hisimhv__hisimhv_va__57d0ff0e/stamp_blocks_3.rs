...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_48(
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2297])) {
            ...
            s.store_mul_add_ad_lhs(345, A::add(A::scale(s.ad_value(339), 2.0), A::mul(A::mul(A::scale(s.ad_value(344), 2.0), s.ad_value(340)), s.ad_value(338))), A::mul(s.ad_value(335), s.ad_value(338)), 336);
            s.store_mul(341, 345, 338);
            s.store_scaled_add_ad_lhs(345, A::mul(A::scale(s.ad_value(344), 2.0), s.ad_value(340)), 335, 4.0);
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_add_scaled_ad_lhs(335, A::add(A::div_from_scalar(1.0, A::add(s.ad_value(336), A::scale(A::mul(A::scale(s.ad_value(338), s.v[475]), s.ad_value(252)), 1e-11))), A::mul(s.ad_value(679), s.ad_value(342))), 340, 1.0 / (s.v[479]));
    ...
    pub(super) fn stamp_transient_block_49(
        ...
        while {
            ...
            if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2328])) && (!s.b[2330])) {
                ...
                s.store_mul_sqrt_ad_rhs(2322, 209, A::offset(A::add(A::sub(A::offset(s.ad_value(336), (-1.0)), s.ad_value(335)), A::mul(s.ad_value(210), A::sub(s.ad_value(337), s.ad_value(338)))), 1e-15));
                s.store_div_ad_lhs(339, A::mul(A::scale(s.ad_value(209), 0.5), s.ad_value(209)), 2322);
                s.store_mul_add_ad_rhs(2125, 339, A::sub(A::mul(s.ad_value(154), s.ad_value(336)), s.ad_value(154)), A::mul(s.ad_value(210), A::mul(A::neg(s.ad_value(154)), s.ad_value(337))));
            }
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2328])) {
            ...
            s.store_mul_sqrt_ad_rhs(334, 2152, A::mul(A::scale(s.ad_value(154), 2.0), s.ad_value(2320)));
        ...
        if (((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2328])) && (!s.b[2349])) && s.b[2350]) && s.b[2351]) {
            s.store_scaled_offset_ad(335, A::offset(s.ad_value(332), 1.0), (-500.0), 1.403592217853e217);
        ...
        if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2328])) && (!s.b[2349])) && (!s.b[2350])) {
            ...
            s.store_mul_ad_product_lhs(336, s.ad_value(332), A::offset(A::scale(s.ad_value(332), 0.5), 1.0), 334);
        }
    ...
    pub(super) fn stamp_transient_block_50(
        ...
        if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2328])) && (!s.b[2353])) && (!s.b[2354])) {
            ...
            s.store_sqrt_mul_ad(2147, A::mul(s.ad_value(2136), s.ad_value(155)), A::offset(A::sub(A::exp(s.ad_value(337)), s.ad_value(337)), (-1.0)));
        }
    ...
    pub(super) fn stamp_transient_block_52(
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) {
            s.store_add_ad_rhs(2160, 2159, A::mul(s.ad_value(2134), A::sub_from_scalar(1.0, s.ad_value(337))));
            s.copy_ad(2156, 2160);
            s.store_scalar(79, 0.0);
            s.store_scalar(97, 1.0);
        }
        ...
        while {
            ...
            if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) {
                ...
                s.store_exp(336, 335);
                s.store_sqrt_div_ad(338, A::scale(s.ad_value(2114), 2.0), s.ad_value(154));
            ...
            if (((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2395])) && (s.v[79] == 0.0)) {
                s.store_add_ad_lhs(2100, A::mul(A::neg(s.ad_value(185)), A::sub(s.ad_value(2159), s.ad_value(2156))), 2157);
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(349), s.ad_value(972)), 972, 0.5);
            s.store_square(722, 781);
            s.store_scaled_square(723, 972, ((0.5) * (0.5)));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
            s.store_scalar(719, 0.0);
            s.store_scalar(720, 0.0);
    ...
    pub(super) fn stamp_transient_block_53(
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2413]) {
            s.store_div_from_scalar(726, 1.0, 726);
            s.store_mul_ad_product_lhs(780, s.ad_value(781), A::scale(s.ad_value(972), 0.5), 726);
            s.store_div_ad_lhs(334, A::mul(A::mul(A::scale(s.ad_value(972), 0.5), s.ad_value(725)), s.ad_value(726)), 770);
            s.store_add_ad_lhs(2166, A::sub(s.ad_value(972), A::scale(s.ad_value(972), 0.5)), 780);
        }
        ...
        if ((((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2419])) && (!s.b[2420])) && s.b[2421]) {
            s.store_add_ad_lhs(992, A::ln(A::offset(A::exp(A::sub(s.ad_value(2146), s.ad_value(972))), 1.0)), 972);
        }
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2422]) {
            s.store_div_ad_lhs(2154, A::div(A::sub_from_scalar(p.p408, s.ad_value(2092)), A::scale(s.ad_value(965), 100.0)), 339);
        }

        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && (!s.b[2422])) {
            s.store_scaled_div(2154, 2124, 339, 9662367879.197212);
        }
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_div_from_scalar(254, 1.0, 335);
            s.store_scale(254, 254, 0.0001);
            s.store_div_ad_rhs(2115, 989, A::offset(s.ad_value(162), p.p401));
            ...
            s.store_div_ad_rhs(2169, 334, A::offset(s.ad_value(162), (-p.p402)));
            s.store_div_ad_lhs(335, A::mul(s.ad_value(254), s.ad_value(2169)), 973);
        }
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            ...
            s.store_mul_ad_affine_product_rhs(2132, 964, A::scale(s.ad_value(2115), p.p400), A::sub_from_scalar(1.0, A::div_from_scalar(1.0, A::offset(A::div(A::mul(s.ad_value(254), s.ad_value(2115)), s.ad_value(973)), 1.0))), 1.0, 1.0);
            ...
            s.store_mul_ad_product_lhs(987, A::scale(s.ad_value(335), s.v[632]), s.ad_value(985), 2115);
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2423]) {
            ...
            s.store_offset_mul_ad(782, s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::scale(s.ad_value(781), (1.0 / 5040.0)), (1.0 / 720.0))), (1.0 / 120.0))), (1.0 / 24.0))), (1.0 / 6.0))), (1.0 / 2.0)), 1.0);
            s.store_offset_mul_ad(783, s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::mul(s.ad_value(781), A::offset(A::scale(s.ad_value(781), (1.0 / 840.0)), (1.0 / 144.0))), (1.0 / 30.0))), (1.0 / 8.0))), (1.0 / 3.0)), (1.0 / 2.0));
        ...
        if ((s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) && s.b[2423]) {
            ...
            s.store_sub_ad_lhs(339, A::add(s.ad_value(2089), s.ad_value(340)), 1438);
        ...
        if (s.b[1443] && (s.b[1446] && (!(s.b[1444] || s.b[1445])))) {
            s.copy_ad(134, 135);
            s.store_scaled_sub_ad_lhs(131, A::add(A::sub(s.ad_value(2098), s.ad_value(2122)), s.ad_value(2099)), 2123, (-0.5));
        ...
        if ((!s.b[1443]) && s.b[2428]) {
            ...
            s.store_mul_ad_product_lhs(277, A::scale(s.ad_value(279), 8.0), s.ad_value(279), 279);
    ...
    pub(super) fn stamp_transient_block_54(
        ...
        if ((!s.b[1443]) && s.b[2428]) {
            ...
            s.store_add_ad_lhs(167, A::mul(s.ad_value(116), s.ad_value(155)), 1435);
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            s.store_offset_div_ad(332, A::scale(A::offset(A::mul(s.ad_value(154), A::sub(s.ad_value(85), s.ad_value(1435))), (-1.0)), 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0);
        }
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2431]) && s.b[2432]) {
            ...
            s.store_div_from_scalar_mul_ad(335, 1.0, A::scale(s.ad_value(154), (1.414213562373095 / 108.0)), s.ad_value(212));
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2431]) && s.b[2432]) {
            s.store_add_scaled_ad_lhs(332, A::sub_from_scalar(3.0, A::div(A::scale(s.ad_value(336), 1.259921049894873), A::scale(s.ad_value(339), 3.0))), 339, (1.0 / (3.0 * 1.259921049894873)));
            s.store_add_ad_lhs(89, A::mul(s.ad_value(332), s.ad_value(155)), 1435);
            s.copy_ad(88, 89);
        }
        ...
        while {
            ...
            if (((!s.b[1443]) && s.b[2430]) && s.b[2435]) {
                ...
                s.store_mul_ad_product_lhs(215, A::scale(A::mul(s.ad_value(222), s.ad_value(154)), 2.0), s.ad_value(225), 226);
                s.store_mul_ad_affine_product_rhs(223, 116, s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::scale(s.ad_value(116), 6.36964918866352e-5), (-0.00163730162779191))), 0.0178800506338833)), (-0.117851130197758)), 1.0, 0.707106781186548);
                s.store_offset_mul_ad(224, s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::scale(s.ad_value(116), (5.0 * 6.36964918866352e-5)), (4.0 * (-0.00163730162779191)))), (3.0 * 0.0178800506338833))), (2.0 * (-0.117851130197758))), 0.707106781186548);
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_offset_mul_ad(238, A::mul(s.ad_value(209), s.ad_value(214)), s.ad_value(335), 1e-25);
        }
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_sub_ad_lhs(334, A::sub(s.ad_value(85), s.ad_value(155)), 1438);
    ...
    pub(super) fn stamp_transient_block_55(
        ...
        if (((((!s.b[1443]) && s.b[2430]) && s.b[2448]) && s.b[2449]) && s.b[2450]) {
            s.store_offset_sub_ad(781, A::scale(s.ad_value(96), (1.0 + 0.3)), s.ad_value(790), (-0.03));
        ...
        if (((((!s.b[1443]) && s.b[2430]) && s.b[2448]) && s.b[2449]) && s.b[2450]) {
            s.store_sqrt_square_add(782, 781, 782);
            s.store_offset_scaled_div(335, 781, 782, 0.5, 0.5);
            s.store_sub_scaled_ad_rhs(95, 96, (1.0 + 0.3), A::scale(A::add(s.ad_value(781), s.ad_value(782)), 0.5));
        }
        ...
        while {
            ...
            if (((!s.b[1443]) && s.b[2430]) && s.b[2453]) {
                ...
                s.store_mul_ad_product_lhs(219, A::scale(A::mul(s.ad_value(222), s.ad_value(154)), 2.0), s.ad_value(225), 226);
                s.store_mul_ad_affine_product_rhs(223, 116, s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::scale(s.ad_value(116), 6.36964918866352e-5), (-0.00163730162779191))), 0.0178800506338833)), (-0.117851130197758)), 1.0, 0.707106781186548);
                s.store_offset_mul_ad(224, s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::mul(s.ad_value(116), A::offset(A::scale(s.ad_value(116), (5.0 * 6.36964918866352e-5)), (4.0 * (-0.00163730162779191)))), (3.0 * 0.0178800506338833))), (2.0 * (-0.117851130197758))), 0.707106781186548);
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_offset_mul_ad(335, s.ad_value(258), A::offset(s.ad_value(258), 3.0), 3.0);
            s.store_mul_ad_product_lhs(267, A::scale(s.ad_value(100), 0.6666666666666667), s.ad_value(264), 335);
            s.store_offset_mul_ad(335, s.ad_value(258), A::offset(A::mul(s.ad_value(258), A::offset(A::mul(s.ad_value(258), A::offset(s.ad_value(258), 5.0)), 10.0)), 10.0), 5.0);
            s.store_mul_ad_product_lhs(268, A::mul(A::div_from_scalar(4.0, A::scale(s.ad_value(154), 15.0)), s.ad_value(101)), s.ad_value(265), 335);
    ...
    pub(super) fn stamp_transient_block_56(
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) {
            ...
            s.store_scaled_div(343, 335, 342, 0.5);
        ...
        if ((((!s.b[1443]) && s.b[2430]) && s.b[2461]) && (!s.b[2462])) {
            ...
            s.store_mul(341, 345, 338);
            s.store_scaled_add_ad_lhs(345, A::mul(A::scale(s.ad_value(344), 2.0), s.ad_value(340)), 335, 4.0);
            s.store_mul_ad_product_lhs(335, A::scale(s.ad_value(344), 8.0), s.ad_value(338), 338);
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2461]) {
            ...
            s.store_mul_add_ad_rhs(240, 209, A::mul(s.ad_value(209), A::sub(A::sub_from_scalar(1.5, A::offset(s.ad_value(99), 1.0)), A::mul(A::scale(s.ad_value(154), 0.5), s.ad_value(94)))), A::mul(s.ad_value(185), s.ad_value(336)));
            s.copy_ad(335, 154);
    ...
    pub(super) fn stamp_transient_block_57(
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2461]) {
            ...
            s.store_offset_mul_ad(242, s.ad_value(125), A::offset(s.ad_value(125), 1.0), 1.0);
        }
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2461]) {
            ...
            s.store_scaled_div(246, 244, 245, 0.4);
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_div(337, 339, 338);
            s.store_mul_offset_ad_rhs(251, 337, A::scale(s.ad_value(1438), p.p166), 1.0);
        }
        ...
        if ((!s.b[1443]) && s.b[2430]) {
            ...
            s.store_add_scaled_ad_lhs(335, A::add(A::div_from_scalar(1.0, A::offset(A::scale(s.ad_value(252), (s.v[475] * 1e-11)), s.v[474])), A::mul(s.ad_value(679), s.ad_value(342))), 340, 1.0 / (s.v[479]));
            s.store_div_from_scalar(254, 1.0, 335);
            s.store_scale(254, 254, 0.0001);
            s.store_mul_ad_product_lhs(336, s.ad_value(154), A::offset(s.ad_value(238), 1e-25), 170);
            s.store_div_from_scalar(335, 1.0, 336);
    ...
    pub(super) fn stamp_transient_block_58(
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2495]) {
            ...
            s.store_offset_scaled(338, 1439, p.p285, 1.0);
            s.store_scalar(334, s.v[673]);
            s.store_sub_ad_lhs(339, A::add(s.ad_value(87), s.ad_value(340)), 1438);
            s.store_add_ad_rhs(338, 338, A::mul(A::mul(s.ad_value(1439), s.ad_value(334)), s.ad_value(339)));
            s.store_mul(340, 343, 338);
            s.copy_ad(343, 340);
        }
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2499]) {
            ...
            s.store_scaled_add_ad(368, A::mul(s.ad_value(341), s.ad_value(335)), A::mul(A::scale(s.ad_value(797), s.v[531]), s.ad_value(343)), 1.0 / (s.v[632]));
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2503]) {
            ...
            s.store_mul_ad_product_lhs(339, A::mul(A::scale(A::sub_from_scalar(p.p137, s.ad_value(123)), 2.0), s.ad_value(335)), s.ad_value(336), 338);
            s.store_mul(121, 339, 181);
            s.store_scaled_div(340, 339, 181, 0.5);
            s.store_mul_ad_product_lhs(341, A::mul(A::scale(A::sub_from_scalar(p.p137, s.ad_value(123)), (2.0 * 1.034943e-10)), s.ad_value(336)), s.ad_value(338), 181);
            s.store_mul_ad_product_lhs(342, A::mul(A::scale(s.ad_value(335), (-2.0)), s.ad_value(336)), s.ad_value(338), 181);
            s.store_scalar(338, s.v[496]);
            s.store_scalar(340, s.v[497]);
            s.store_add_ad_rhs(335, 338, A::mul(s.ad_value(340), s.ad_value(1439)));
            s.store_mul(137, 121, 335);
            s.store_sub_from_scalar_ad(335, s.v[498], A::scale(s.ad_value(790), p.p213));
            s.store_add_ad_lhs(138, A::add(A::offset(s.ad_value(1440), (-s.v[160])), s.ad_value(335)), 137);
            ...
            s.store_offset_sub_ad(344, A::offset(A::offset(A::sub(s.ad_value(155), A::mul(s.ad_value(141), s.ad_value(345))), s.v[160]), (-s.v[498])), s.ad_value(137), 1e-25);
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2503]) {
            s.store_sqrt_add_ad(336, A::square(s.ad_value(335)), A::scale(A::mul(A::scale(s.ad_value(334), 4.0), s.ad_value(344)), 0.005));
            s.store_sub_ad_lhs(337, A::add(A::offset(A::offset(A::add(s.ad_value(344), A::scale(A::add(s.ad_value(335), s.ad_value(336)), 0.5)), (-s.v[160])), s.v[498]), s.ad_value(137)), 1438);
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2503]) {
            ...
            s.store_div_from_scalar_add_ad(334, 1.0, s.ad_value(154), A::div_from_scalar(2.0, A::offset(s.ad_value(138), 1e-25)));
            s.store_mul_ln_ad_lhs(147, A::mul(A::div(A::div_from_scalar(1.0, s.ad_value(140)), s.ad_value(141)), A::square(s.ad_value(138))), 334);
            s.store_offset_sub(148, 147, 146, (-0.002));
            s.store_sqrt_add_ad(334, A::square(s.ad_value(148)), A::scale(s.ad_value(147), (4.0 * 0.002)));
    ...
    pub(super) fn stamp_transient_block_59(
        ...
        if (((!s.b[1443]) && s.b[2430]) && s.b[2513]) {
            ...
            s.store_mul_ad_product_lhs(318, A::scale(s.ad_value(155), 2.0), s.ad_value(186), 248);
        ...
        if ((!s.b[1443]) && s.b[2519]) {
            ...
            s.store_offset_sub_ad(2525, A::add(A::offset(s.ad_value(791), (-s.v[160])), s.ad_value(120)), s.ad_value(182), (-p.p455));
            ...
            s.store_scaled_add_ad_lhs(2536, A::sub(s.ad_value(960), s.ad_value(1435)), 781, 0.5);
            s.store_sqrt_div_ad(2520, A::scale(A::mul(A::scale(s.ad_value(2536), ((2.0 * 1.6021918e-19) * 9662367879.197212)), s.ad_value(586)), s.v[489]), A::offset(s.ad_value(586), s.v[489]));
            s.store_mul(2522, 2520, 162);
            s.store_div_ad(993, A::mul(A::scale(s.ad_value(2522), (-0.25)), s.ad_value(2522)), A::add(s.ad_value(790), s.ad_value(2522)));
        }
        ...
        if (((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) {
            s.copy_ad(2539, 993);
            s.copy_ad(2540, 2526);
            s.store_offset_div_ad(332, A::scale(A::offset(A::mul(s.ad_value(154), A::sub(s.ad_value(2525), s.ad_value(2539))), (-1.0)), 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0);
        }
        ...
        if (((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) {
            s.store_add_ad_rhs(89, 2525, A::mul(A::scale(A::mul(s.ad_value(213), s.ad_value(154)), 0.5), A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332)))));
        ...
        if ((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2541]) {
            s.store_add_scaled_ad_lhs(332, A::sub_from_scalar(3.0, A::div(A::scale(s.ad_value(336), 1.259921049894873), A::scale(s.ad_value(339), 3.0))), 339, (1.0 / (3.0 * 1.259921049894873)));
            s.store_add_ad_lhs(89, A::mul(s.ad_value(332), s.ad_value(155)), 2539);
            s.copy_ad(88, 89);
        }
    ...
    pub(super) fn stamp_transient_block_60(
        ...
        if ((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) {
            s.copy_ad(88, 2523);
            s.copy_ad(2545, 993);
            s.store_offset_add_ad(86, A::add(A::sub_from_scalar(s.v[160], s.ad_value(120)), s.ad_value(182)), s.ad_value(2545), p.p455);
        }
        ...
        if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && s.b[2554]) {
            ...
            s.store_div_from_scalar(335, 1.0, 273);
            s.store_mul(116, 272, 335);
            s.store_add_ad_lhs(167, A::mul(s.ad_value(116), s.ad_value(155)), 2545);
        ...
        if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) {
            s.store_exp_ad(230, A::mul(s.ad_value(154), A::offset(s.ad_value(2545), (-p.p456))));
            s.store_scalar(79, 0.0);
            s.copy_ad(2546, 88);
            s.store_scale_ad(2547, A::scale(A::mul(A::mul(s.ad_value(166), s.ad_value(2524)), s.ad_value(2524)), 0.5), 9662367879.197212);
            s.store_sqrt_mul_ad(334, A::scale(s.ad_value(154), 2.0), s.ad_value(2547));
            s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp(A::neg(s.ad_value(334))), 0.5);
        ...
        while {
            ...
            if ((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && s.b[2556]) {
                s.store_exp(335, 333);
                s.store_exp_ad(334, A::mul(A::neg(s.ad_value(2548)), s.ad_value(2547)));
                s.store_sub(336, 335, 334);
                s.store_div_ad_lhs(2551, A::ln(A::offset(s.ad_value(336), 1.0)), 2548);
                s.store_div_ad_rhs(2552, 335, A::offset(s.ad_value(336), 1.0));
            }
            if ((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2556])) {
            ...
            if ((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && s.b[2557]) {
                s.store_sqrt_scaled_ad(334, A::sub_from_scalar(1.0, A::square(s.ad_value(2552))), 0.5);
            ...
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2557])) && s.b[2559]) {
                ...
                s.store_mul_sub_from_scalar_ad_rhs(335, 116, 1.0, A::mul(A::scale(s.ad_value(116), 0.5), A::sub_from_scalar(1.0, A::mul(A::scale(s.ad_value(116), 0.3333333333333333), A::sub_from_scalar(1.0, A::scale(s.ad_value(116), 0.25))))));
                s.store_mul_ad(336, A::scale(A::square(s.ad_value(2550)), 0.5), A::sub_from_scalar(1.0, A::mul(A::scale(s.ad_value(2550), 0.3333333333333333), A::sub_from_scalar(1.0, A::mul(A::scale(s.ad_value(2550), 0.25), A::sub_from_scalar(1.0, A::scale(s.ad_value(2550), 0.2)))))));
                s.store_mul_sub_from_scalar_ad_rhs(337, 2550, 1.0, A::mul(A::scale(s.ad_value(2550), 0.5), A::sub_from_scalar(1.0, A::mul(A::scale(s.ad_value(2550), 0.3333333333333333), A::sub_from_scalar(1.0, A::scale(s.ad_value(2550), 0.25))))));
                s.store_sqrt_sub(223, 334, 336);
                s.store_div_ad_lhs(2553, A::mul(A::scale(s.ad_value(154), 0.5), A::sub(s.ad_value(335), A::mul(s.ad_value(2552), s.ad_value(337)))), 223);
            }
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2557])) && (!s.b[2559])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 2550);
                s.store_sqrt_add_ad(223, A::sub(s.ad_value(116), s.ad_value(2550)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_div_ad_lhs(2553, A::mul(A::scale(s.ad_value(154), 0.5), A::sub(A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(2552), A::sub_from_scalar(1.0, s.ad_value(335))))), 223);
            }
            ...
            if (((((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) && (!s.b[2561])) && (!s.b[2562])) {
                ...
                s.store_exp(228, 117);
                s.store_mul_sub_ad_rhs(214, 210, s.ad_value(228), A::mul(s.ad_value(230), A::offset(s.ad_value(116), 1.0)));
                s.store_mul_ad(215, A::mul(s.ad_value(210), s.ad_value(154)), A::sub(s.ad_value(228), s.ad_value(230)));
                s.store_sqrt_square_add(216, 223, 214);
                s.store_div_ad_lhs(217, A::scale(A::add(A::mul(A::scale(s.ad_value(2553), 2.0), s.ad_value(223)), s.ad_value(215)), 0.5), 216);
            }
            if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) {
                s.store_add_ad(232, A::sub(s.ad_value(2546), s.ad_value(2525)), A::mul(s.ad_value(212), s.ad_value(216)));
        ...
        if ((((!s.b[1443]) && s.b[2519]) && (!s.b[2566])) && (!s.b[2567])) {
            s.store_mul_scaled_ad_rhs(2537, 339, (-0.7071067811865475), A::sqrt(A::offset(A::mul(A::scale(s.ad_value(2535), 0.3333333333333333), A::offset(A::scale(s.ad_value(2535), 0.25), 1.0)), 1.0)));
        }

        if ((!s.b[1443]) && s.b[2519]) {
            s.store_sqrt_square_offset(781, 2537, ((4.0 * 1e-6) * 1e-6));
            s.store_scaled_add(2532, 2537, 781, 0.5);
            s.store_scaled_div(2533, 2532, 586, (1.0 / (1.6021918e-19)));
            s.store_offset(335, 2533, (-p.p452));
            s.store_scale(2534, 2533, 0.01);
            s.store_sqrt_add_ad(781, A::square(s.ad_value(335)), A::mul(A::scale(s.ad_value(2534), 4.0), s.ad_value(2534)));
            s.store_scaled_add(336, 335, 781, 0.5);
            s.store_div_ad_lhs(2531, A::mul(A::div(s.ad_value(336), s.ad_value(2533)), s.ad_value(336)), 2533);
            s.store_add_ad_lhs(994, A::mul(A::sub(s.ad_value(2523), s.ad_value(993)), s.ad_value(2531)), 993);
            s.store_mul_ad(333, A::exp(A::mul(s.ad_value(154), A::sub(s.ad_value(994), A::sub(s.ad_value(960), s.ad_value(1435))))), A::sub_from_scalar(1.0, A::exp(A::mul(A::neg(s.ad_value(154)), s.ad_value(790)))));
        ...
        if (((!s.b[1443]) && s.b[2519]) && s.b[2568]) {
            s.store_sub_ad_lhs(781, A::scale(s.ad_value(154), 0.2), 2521);
            s.store_square(722, 781);
            s.store_scaled_square(723, 154, ((0.2) * (0.2)));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
            s.store_scalar(719, 0.0);
            s.store_scalar(720, 0.0);
    ...
    pub(super) fn stamp_transient_block_61(
        ...
        if (((!s.b[1443]) && s.b[2519]) && s.b[2568]) {
            s.store_div_from_scalar(726, 1.0, 726);
            s.store_mul_ad_product_lhs(780, s.ad_value(781), A::scale(s.ad_value(154), 0.2), 726);
        ...
        if ((!s.b[1443]) && s.b[2519]) {
            ...
            s.store_mul_scaled_ad_lhs(995, A::div(A::scale(s.ad_value(155), 2.0), s.ad_value(162)), 2530, p.p454);
        ...
        if ((!s.b[2580]) && s.b[2581]) {
            ...
            s.store_sub_ad(339, A::sub(s.ad_value(335), s.ad_value(155)), A::mul(s.ad_value(660), s.ad_value(1438)));
        ...
        if ((!s.b[2580]) && s.b[2581]) {
            ...
            s.store_sub_ad(283, A::add(A::scale(s.ad_value(1439), s.v[483]), s.ad_value(109)), A::mul(s.ad_value(336), s.ad_value(282)));
    ...
    pub(super) fn stamp_transient_block_62(
        ...
        if ((!s.b[2580]) && s.b[2581]) {
            ...
            s.store_mul_ad_product_lhs(280, A::mul(s.ad_value(339), s.ad_value(283)), s.ad_value(134), 336);
        ...
        if ((!s.b[2580]) && s.b[2589]) {
            ...
            s.store_mul_ad_product_lhs(340, A::mul(s.ad_value(341), s.ad_value(336)), s.ad_value(338), 338);
            s.store_mul_ad_product_lhs(281, A::mul(s.ad_value(664), s.ad_value(134)), s.ad_value(334), 336);
        }
        ...
        if s.b[2602] {
            ...
            s.store_square(345, 344);
            s.store_mul_sub_ad_rhs(112, 209, A::mul(s.ad_value(104), s.ad_value(336)), A::mul(s.ad_value(101), s.ad_value(335)));
            s.store_mul_scaled_ad_rhs(113, 209, 0.5, A::add(A::mul(A::neg(s.ad_value(103)), s.ad_value(336)), A::mul(s.ad_value(100), s.ad_value(335))));
        ...
        if (s.b[2603] && s.b[2604]) {
            ...
            s.store_sub_scaled_ad_lhs(335, A::add(A::offset(s.ad_value(1440), (-s.v[160])), A::mul(A::scale(A::sub(s.ad_value(120), s.ad_value(182)), s.v[560]), s.ad_value(162))), 191, s.v[515]);
    ...
    pub(super) fn stamp_transient_block_63(
        ...
        if (s.b[2603] && s.b[2604]) {
            ...
            s.store_scaled_square(337, 338, s.v[514]);
        }
        ...
        if s.b[2603] {
            s.store_scaled_offset_ad(195, A::offset(A::neg(A::sub(s.ad_value(791), s.ad_value(792))), s.v[160]), p.p258, 1.0 / (s.v[187]));
            s.store_sqrt_square_offset(782, 195, ((4.0 * (0.01 / 0.01)) * (0.01 / 0.01)));
            s.store_offset_scaled_div(339, 195, 782, 0.5, 0.5);
            s.store_scaled_add(195, 195, 782, 0.5);
        }
        ...
        if (s.b[2603] && (!s.b[2611])) {
            ...
            s.store_mul_ad_product_lhs(202, A::mul(s.ad_value(337), s.ad_value(195)), s.ad_value(195), 336);
        }

        if s.b[2603] {
            s.copy_ad(285, 677);
            s.store_mul(286, 393, 285);
            s.store_scale_ad(336, A::neg(A::offset(A::add(A::add(A::sub(A::scale(s.ad_value(1438), s.v[493]), s.ad_value(1440)), s.ad_value(122)), s.ad_value(174)), (-s.v[492]))), 1.0 / (s.v[187]));
        ...
        if (s.b[2603] && s.b[2613]) {
            s.store_mul_scaled_ad_lhs(284, A::mul(A::scale(s.ad_value(338), 0.25), s.ad_value(335)), 335, 7.38905609893065);
        }
        ...
        if s.b[2614] {
            ...
            s.store_sqrt_add_ad(336, A::square(s.ad_value(335)), A::scale(s.ad_value(790), (4.0 * 1e-5)));
        ...
        if ((!s.b[2615]) && (!s.b[2617])) {
            ...
            s.store_mul_ad_product_lhs(203, A::mul(s.ad_value(336), s.ad_value(197)), s.ad_value(197), 335);
        }
        ...
        if ((!s.b[2619]) && (!s.b[2621])) {
            ...
            s.store_mul_ad_product_lhs(204, A::mul(s.ad_value(336), s.ad_value(198)), s.ad_value(198), 335);
        }
        ...
        s.b[2631] = (((p.p36 == 1.0) && (p.p66 > 0.0)) && (s.v[460] > 0.0));
