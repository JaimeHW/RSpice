...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_60(
        ...
        while {
            ...
            if (((((!s.b[1443]) && s.b[2519]) && (!s.b[2538])) && s.b[2544]) && (!s.b[2554])) {
                s.store_ad_value(232, A::add_scaled_inputs_product(s.ad_value(2546), 1.0, s.ad_value(2525), (-1.0), s.ad_value(212), s.ad_value(216), 1.0));
    ...
    pub(super) fn stamp_transient_block_61(
        ...
        if ((!s.b[2580]) && s.b[2581]) {
            ...
            s.store_ad_value(339, A::add_scaled_inputs_product(s.ad_value(335), 1.0, s.ad_value(155), (-1.0), s.ad_value(660), s.ad_value(1438), (-1.0)));
        ...
        if ((!s.b[2580]) && s.b[2581]) {
            ...
            s.store_ad_value(283, A::add_scaled_inputs_product(s.ad_value(1439), s.v[483], s.ad_value(109), 1.0, s.ad_value(336), s.ad_value(282), (-1.0)));
