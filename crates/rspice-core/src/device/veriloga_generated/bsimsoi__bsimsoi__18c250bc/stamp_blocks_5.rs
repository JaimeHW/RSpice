...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_35(
        ...
        if (p[375] != 0.0) {s.store_mul_scale_offset_indices(850, 822, 212, -1.0, 0.0);s.store_offset_square(851, 850, 0.0002);}
        ...
        if (p[375] != 0.0) {s.store_sub(843, 820, 375);s.store_sqrt_square_offset(1027, 843, 0.0001);s.store_mul(845, 820, 1027);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_36(
        ...
        if (p[375] != 0.0) {s.store_mul_sub_mixed_iaa(848, 855, A::add_scaled_product(s.ad_value(207), 1.0, s.ad_value(846), s.ad_value(1027), 1.0), A::mul3(s.ad_value(847), s.ad_value(1027), s.ad_value(1027)));}
        ...
        if s.b[1341] {s.copy_ad(1076, 1081);s.store_scalar(843, p[396]);s.store_offset_sub(844, 843, 1076, (-p[397]));s.store_sqrt_add_scaled_square_input(846, 844, 1.0, 843, (4.0 * p[397]));s.store_add_scaled_inputs3_indices(1080, 843, 1.0, 844, (-0.5), 846, (-0.5));s.copy_ad(1076, 1080);s.store_scaled_sub(843, 826, 1075, 1.0 / (p[387]));}
    ...
    pub(super) fn stamp_reactive_block_37(
        ...
        s.b[1355] = (((((p[374] != 0.0) && (s.v[37] != 2.0)) && (s.v[399] != 0.0)) && (p[27] > 0.0)) && (s.v[1114] < s.v[1127]));s.store_scalar(1355, if s.b[1355] { 1.0 } else { 0.0 });
        ...
        if s.b[1355] {s.store_scale(854, 854, (p[27] * s.v[345]));}
        s.b[1358] = (s.v[37] != 2.0);s.store_scalar(1358, if s.b[1358] { 1.0 } else { 0.0 });s.b[1359] = (p[44] == 0.0);s.store_scalar(1359, if s.b[1359] { 1.0 } else { 0.0 });s.b[1360] = (s.v[201] <= 0.0);s.store_scalar(1360, if s.b[1360] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_38(
        ...
        s.b[1380] = (p[429] == 0.0);s.store_scalar(1380, if s.b[1380] { 1.0 } else { 0.0 });s.b[1385] = (p[429] == 1.0);s.store_scalar(1385, if s.b[1385] { 1.0 } else { 0.0 });
        ...
        if s.b[1389] {s.store_scale(885, 885, p[3]);s.store_scale(933, 933, p[3]);s.store_scale(78, 78, p[3]);}
