...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_27(
        ...
        s.store_div_scaled_inputs2_mixed_iai(833, 151, 1.0, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(384), s.ad_value(830)), (-1.0), 853, 1.0);s.b[1244] = (s.v[809] > 100.0);s.store_scalar(1244, if s.b[1244] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_28(
        ...
        if (p.p41 != 0.0) {s.store_scaled_offset_ad(965, A::sub_from_scalar((p.p52 - p.p53), A::scale(s.ad_value(912), 0.5)), 0.45, (2.0 * p.p37));s.store_scalar(1109, ((p.p45 * p.p47) / 3.9));s.store_scaled_sub(856, 897, 941, p.p123);}
    ...
    pub(super) fn stamp_reactive_block_31(
        ...
        if ((s.b[1275] && s.b[1277]) && (!s.b[1279])) {s.store_scaled_add_mixed_ia(844, 844, A::sqrt_square_offset(s.ad_value(844), ((4.0 * 0.01) * 0.01)), 0.5);s.store_div_scaled_value_offset_denominator(845, s.ad_value(1151), 1.0, s.ad_value(844), 0.001, 1.0);s.store_square(847, 824);s.store_mul_scale_offset_indices(848, 847, 824, -1.0, 0.0);s.store_offset_add_ad(849, s.ad_value(1152), A::abs(s.ad_value(848)), 1e-9);s.store_offset_add_scaled_inputs(850, A::div(s.ad_value(848), s.ad_value(849)), 0.5, A::sqrt_square_offset(A::div(s.ad_value(848), s.ad_value(849)), ((4.0 * 1e-6) * 1e-6)), 0.5, (-1e-6));}
        ...
        if ((s.b[1275] && s.b[1277]) && (!s.b[1281])) {s.store_scaled_add_mixed_ia(844, 844, A::sqrt_square_offset(s.ad_value(844), ((4.0 * 0.01) * 0.01)), 0.5);s.store_div_scaled_value_offset_denominator(845, s.ad_value(1144), 1.0, s.ad_value(844), 0.001, 1.0);s.store_square(847, 900);s.store_mul_scale_offset_indices(848, 847, 900, -1.0, 0.0);s.store_offset_add_ad(849, s.ad_value(1145), A::abs(s.ad_value(848)), 1e-9);s.store_offset_add_scaled_inputs(850, A::div(s.ad_value(848), s.ad_value(849)), 0.5, A::sqrt_square_offset(A::div(s.ad_value(848), s.ad_value(849)), ((4.0 * 1e-6) * 1e-6)), 0.5, (-1e-6));}
    ...
    pub(super) fn stamp_reactive_block_32(
        ...
        if ((s.b[1275] && (!s.b[1277])) && (!s.b[1283])) {s.store_scaled_add_mixed_ia(844, 844, A::sqrt_square_offset(s.ad_value(844), ((4.0 * 0.01) * 0.01)), 0.5);s.store_div_scaled_value_offset_denominator(845, s.ad_value(1151), 1.0, s.ad_value(844), 0.001, 1.0);s.store_sub(847, 824, 1156);}
        ...
        if ((s.b[1275] && (!s.b[1277])) && (!s.b[1283])) {s.store_exp(849, 848);}
        ...
        if ((s.b[1275] && (!s.b[1277])) && (!s.b[1286])) {s.store_scaled_add_mixed_ia(844, 844, A::sqrt_square_offset(s.ad_value(844), ((4.0 * 0.01) * 0.01)), 0.5);s.store_div_scaled_value_offset_denominator(845, s.ad_value(1144), 1.0, s.ad_value(844), 0.001, 1.0);s.store_sub(847, 900, 1149);}
        ...
        if ((s.b[1275] && (!s.b[1277])) && (!s.b[1286])) {s.store_exp(849, 848);}
        ...
        if (s.b[1275] && (!s.b[1292])) {s.store_mul(843, 974, 947);}
        s.b[1293] = (s.v[948] <= 0.0);s.store_scalar(1293, if s.b[1293] { 1.0 } else { 0.0 });
        if (s.b[1275] && (!s.b[1293])) {s.store_mul(843, 975, 948);}
    ...
    pub(super) fn stamp_reactive_block_33(
        ...
        if ((s.b[1275] && (!s.b[1294])) && (!s.b[1297])) {s.store_neg(854, 854);}
        if (s.b[1275] && (!s.b[1294])) {s.store_mul(846, 974, 951);}
        ...
        if ((s.b[1275] && (!s.b[1302])) && (!s.b[1305])) {s.store_neg(854, 854);}
        if (s.b[1275] && (!s.b[1302])) {s.store_mul(846, 975, 952);}
        ...
        if (s.b[1275] && s.b[1310]) {s.store_scalar(987, 0.0);s.store_scalar(988, 0.0);s.store_scalar(933, 0.0);}
        ...
        if (s.b[1275] && (!s.b[1310])) {s.store_sub_from_scalar(843, 1.0, 351);s.store_mul3_lhs(985, 930, 949, 352);s.store_mul(844, 843, 985);s.store_mul3_lhs(985, 930, 950, 352);s.store_mul(844, 843, 985);s.store_mul3_lhs(986, 930, 949, 353);s.store_mul_ad_product_lhs_mixed_ia(987, 986, A::offset(s.ad_value(983), (-1.0)), 991);s.store_mul3_lhs(986, 930, 950, 353);s.store_mul_ad_product_lhs_mixed_ia(988, 986, A::offset(s.ad_value(984), (-1.0)), 992);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_34(
        ...
        if ((s.b[1275] && (!s.b[1315])) && s.b[1316]) {s.store_mul(846, 974, 953);}
        ...
        if ((s.b[1275] && (!s.b[1315])) && s.b[1321]) {s.store_mul(846, 975, 954);}
        ...
        if ((s.b[1275] && (!s.b[1315])) && (!s.b[1321])) {s.store_mul(846, 975, 954);}
        if (!s.b[1275]) {s.store_scalar(987, 0.0);s.store_scalar(988, 0.0);s.store_scalar(933, 0.0);}
    ...
    pub(super) fn stamp_reactive_block_35(
        ...
        if (p.p375 != 0.0) {s.store_mul_scale_offset_indices(850, 822, 212, -1.0, 0.0);s.store_offset_square(851, 850, 0.0002);}
        ...
        if (p.p375 != 0.0) {s.store_sub(843, 820, 375);s.store_sqrt_square_offset(1027, 843, 0.0001);s.store_mul(845, 820, 1027);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_36(
        ...
        if (p.p375 != 0.0) {s.store_mul_sub_mixed_iaa(848, 855, A::add_scaled_product(s.ad_value(207), 1.0, s.ad_value(846), s.ad_value(1027), 1.0), A::mul3(s.ad_value(847), s.ad_value(1027), s.ad_value(1027)));}
        ...
        if s.b[1341] {s.copy_ad(1076, 1081);s.store_scalar(843, p.p396);s.store_offset_sub(844, 843, 1076, (-p.p397));s.store_sqrt_add_scaled_square_input(846, 844, 1.0, 843, (4.0 * p.p397));s.store_add_scaled_inputs3_indices(1080, 843, 1.0, 844, (-0.5), 846, (-0.5));s.copy_ad(1076, 1080);s.store_scaled_sub(843, 826, 1075, 1.0 / (p.p387));}
    ...
    pub(super) fn stamp_reactive_block_37(
        ...
        s.b[1355] = (((((p.p374 != 0.0) && (s.v[37] != 2.0)) && (s.v[399] != 0.0)) && (p.p27 > 0.0)) && (s.v[1114] < s.v[1127]));s.store_scalar(1355, if s.b[1355] { 1.0 } else { 0.0 });
        ...
        if s.b[1355] {s.store_scale(854, 854, (p.p27 * s.v[345]));}
        s.b[1358] = (s.v[37] != 2.0);s.store_scalar(1358, if s.b[1358] { 1.0 } else { 0.0 });s.b[1359] = (p.p44 == 0.0);s.store_scalar(1359, if s.b[1359] { 1.0 } else { 0.0 });s.b[1360] = (s.v[201] <= 0.0);s.store_scalar(1360, if s.b[1360] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_38(
        ...
        if ((s.b[1358] && (!s.b[1359])) && (!s.b[1365])) {s.copy_ad(843, 885);}
        ...
        s.b[1374] = ((s.v[399] == 0.0) || (s.v[399] == 2.0));s.store_scalar(1374, if s.b[1374] { 1.0 } else { 0.0 });s.b[1375] = (s.v[156] < 0.001);s.store_scalar(1375, if s.b[1375] { 1.0 } else { 0.0 });s.b[1376] = (s.v[50] <= 0.001);s.store_scalar(1376, if s.b[1376] { 1.0 } else { 0.0 });
        ...
        s.b[1380] = (p.p429 == 0.0);s.store_scalar(1380, if s.b[1380] { 1.0 } else { 0.0 });s.b[1385] = (p.p429 == 1.0);s.store_scalar(1385, if s.b[1385] { 1.0 } else { 0.0 });
        if ((!s.b[1380]) && s.b[1385]) {s.store_scalar(887, 0.0);s.store_sub(843, 821, 375);s.store_sqrt_square_offset(844, 843, 0.0001);s.store_scaled_add(1026, 843, 844, 0.5);s.store_offset_mul(843, 183, 1026, 1.0);s.store_mul_scale_offset_indices(844, 818, 184, -1.0, 0.0);s.store_add_scaled_inputs_product_mixed_aiia(845, A::div_from_scalar(1.0, s.ad_value(843)), 1.0, 844, 1.0, 185, A::sub(s.ad_value(897), s.ad_value(941)), 1.0);s.store_add_mixed_ia(846, 845, A::sqrt_square_offset(s.ad_value(845), 0.01));s.store_scale(847, 1096, 0.5);s.store_sub(843, 820, 375);s.store_sqrt_square_offset(844, 843, 0.0001);s.store_scaled_add(1027, 843, 844, 0.5);s.store_offset_mul(843, 183, 1027, 1.0);s.store_mul_scale_offset_indices(844, 817, 184, -1.0, 0.0);s.store_add_scaled_inputs_product_mixed_aiia(845, A::div_from_scalar(1.0, s.ad_value(843)), 1.0, 844, 1.0, 185, A::sub(s.ad_value(897), s.ad_value(941)), 1.0);s.store_add_mixed_ia(846, 845, A::sqrt_square_offset(s.ad_value(845), 0.01));s.store_scale(847, 1095, 0.5);}
        ...
        if s.b[1389] {s.store_scale(885, 885, p.p3);s.store_scale(933, 933, p.p3);s.store_scale(78, 78, p.p3);}
