...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        let ctx_temp = ctx.temperature();s.store_scalar(409, (ctx_temp + p[0]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_scalar(429, (p[126] + 273.15));s.store_scalar(36, p[336]);s.store_scalar(37, p[21]);s.store_scalar(38, p[348]);s.store_scalar(39, p[213]);s.store_scalar(40, p[127]);s.store_scalar(41, p[182]);s.store_scalar(42, p[350]);s.store_scalar(43, p[355]);s.store_scalar(44, p[234]);s.store_scalar(45, p[236]);s.store_scalar(46, p[373]);s.store_scalar(48, p[181]);
    ...
    if ((((!s.b[431]) && (!s.b[456])) && (!s.b[458])) && (!s.b[460])) {
        ...
        s.store_scalar(429, (p[126] + 273.15));
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_add_scaled_inputs3_offset_indices(100, 477, p[534], 478, p[724], 479, p[914], p[73]);s.store_add_scaled_inputs3_offset_indices(197, 477, p[535], 478, p[725], 479, p[915], p[198]);s.store_add_scaled_inputs3_offset_indices(198, 477, p[536], 478, p[726], 479, p[916], p[199]);s.store_add_scaled_inputs3_offset_indices(151, 477, p[537], 478, p[727], 479, p[917], p[125]);
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.copy_ad(153, 138);s.copy_ad(154, 140);s.copy_ad(155, 142);s.store_pow_from_scalar_ad(159, (s.v[328] * 1000000.0), s.ad_value(196));s.store_scalar(157, ((p[14] / (p[3] * (s.v[328] + p[377]))) * p[23]));s.store_scalar(158, ((p[15] * (p[3] * (s.v[328] + p[377]))) / p[23]));s.b[547] = (s.v[38] == 0.0);s.store_scalar(547, if s.b[547] { 1.0 } else { 0.0 });
        ...
        s.store_scalar(345, (((((p[380] / p[376])) as f64).powf(p[379]) / p[376]) / p[376]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_add_scaled_inputs(138, 138, 1.0, 139, s.v[430]);s.store_add_scaled_inputs(140, 140, 1.0, 141, s.v[430]);s.store_add_scaled_inputs(142, 142, 1.0, 143, s.v[430]);s.b[548] = (s.v[144] > 1.0);s.store_scalar(548, if s.b[548] { 1.0 } else { 0.0 });
        ...
        if s.b[549] {s.store_scale(496, 159, p[3]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_9(
        ...
        if s.b[549] {s.store_scale(497, 186, s.v[430]);s.store_add(468, 169, 497);s.store_offset(469, 497, p[140]);}
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        s.b[584] = (s.v[109] > 0.0);s.store_scalar(584, if s.b[584] { 1.0 } else { 0.0 });
        if s.b[584] {
