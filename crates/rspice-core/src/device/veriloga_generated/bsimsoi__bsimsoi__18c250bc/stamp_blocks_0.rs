...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_add_scaled_inputs3_offset_indices(214, 477, p.p487, 478, p.p677, 479, p.p867, p.p409);
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if s.b[1275] {
            s.store_add_scaled_inputs4_indices(934, 926, 1.0, 927, 1.0, 928, 1.0, 929, 1.0);
            s.store_add_scaled_inputs4_indices(935, 922, 1.0, 923, 1.0, 924, 1.0, 925, 1.0);
        }
