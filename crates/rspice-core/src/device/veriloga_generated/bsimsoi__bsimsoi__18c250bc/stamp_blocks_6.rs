...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_0(
        ...
        s.store_scalar(409, (ctx_temp + p.p0));

        s.store_scalar(429, (p.p126 + 273.15));

        s.store_scalar(36, p.p336);

        s.store_scalar(37, p.p21);

        s.store_scalar(38, p.p348);

        s.store_scalar(39, p.p213);

        s.store_scalar(40, p.p127);

        s.store_scalar(41, p.p182);

        s.store_scalar(42, p.p350);

        s.store_scalar(43, p.p355);

        s.store_scalar(44, p.p234);

        s.store_scalar(45, p.p236);

        s.store_scalar(46, p.p373);

        s.store_scalar(48, p.p181);
        ...
        if (p.p41 != 0.0) {
            ...
            s.store_div_scaled_inputs_indices(396, 416, 8.85418e-12, 415, 1.0);
        }
        ...
        s.b[431] = (s.v[37] == 2.0);
        s.store_scalar(431, if s.b[431] { 1.0 } else { 0.0 });
        ...
        s.store_scalar(476, (s.v[409] / s.v[429]));
        ...
        s.store_scalar(50, (p.p16 * p.p349));

        s.store_scalar(474, p.p1);

        s.store_scalar(475, (p.p2 / p.p3));

        s.store_scalar(467, ((s.v[474]) as f64).powf(p.p190));

        s.store_scalar(468, ((s.v[475]) as f64).powf(p.p193));

        s.store_scalar(463, (((p.p188 / s.v[467]) + (p.p191 / s.v[468])) + (p.p194 / (s.v[467] * s.v[468]))));

        s.store_scalar(326, (p.p187 + s.v[463]));

        s.store_scalar(463, (((p.p189 / s.v[467]) + (p.p192 / s.v[468])) + (p.p195 / (s.v[467] * s.v[468]))));

        s.store_scalar(330, (p.p217 + s.v[463]));

        s.store_scalar(215, (p.p410 + s.v[463]));
        ...
        s.store_scalar(469, ((s.v[474]) as f64).powf(p.p202));

        s.store_scalar(470, ((s.v[475]) as f64).powf(p.p205));

        s.store_scalar(464, (((p.p200 / s.v[469]) + (p.p203 / s.v[470])) + (p.p206 / (s.v[469] * s.v[470]))));

        s.store_scalar(325, (p.p197 + s.v[464]));

        s.store_scalar(464, (((p.p201 / s.v[469]) + (p.p204 / s.v[470])) + (p.p207 / (s.v[469] * s.v[470]))));

        s.store_scalar(329, (p.p216 + s.v[464]));

        s.store_scalar(327, (p.p1 - (2.0 * s.v[326])));

        s.store_scalar(328, (((p.p2 / p.p3) - (p.p22 * p.p303)) - ((2.0 - p.p22) * s.v[325])));

        s.store_scalar(348, ((s.v[328] / p.p23) + p.p24));

        s.store_scalar(347, ((s.v[328] / p.p23) + p.p25));

        s.store_scalar(331, (p.p1 - (2.0 * s.v[330])));

        s.store_scalar(332, (((p.p2 / p.p3) - (p.p22 * p.p303)) - ((2.0 - p.p22) * s.v[329])));

        s.store_scalar(349, ((s.v[332] / p.p23) + p.p24));

        s.store_scalar(350, ((s.v[332] / p.p23) + p.p25));

        s.store_scalar(365, ((p.p1 - (2.0 * s.v[330])) - p.p360));

        s.store_scalar(366, (s.v[365] + (2.0 * p.p372)));
        ...
        s.store_scalar(116, p.p88);

        s.store_scalar(117, p.p89);

        s.copy_ad(239, 39);

        s.store_scalar(240, p.p214);

        s.store_scalar(241, p.p215);
    ...
    pub(super) fn stamp_reactive_block_1(
        ...
        s.store_scalar(430, (s.v[476] - 1.0));
        ...
        s.store_scalar(157, ((p.p14 / (p.p3 * (s.v[328] + p.p377))) * p.p23));

        s.store_scalar(158, ((p.p15 * (p.p3 * (s.v[328] + p.p377))) / p.p23));
        ...
        if (!s.b[547]) {
            s.store_div_scaled_inputs_mixed_ia(156, 38, (((p.p17 * p.p378) * (s.v[328] * 1.0 / (p.p23))) * 1.0 / (p.p3)), A::scale_offset(s.ad_value(38), 2.0, (p.p378 * s.v[327])), 1.0);
        }

        s.store_scalar(345, (((((p.p380 / p.p376)) as f64).powf(p.p379) / p.p376) / p.p376));
        ...
        s.store_div_scaled_inputs2_indices(182, 181, 1.0, 186, s.v[430], 159, 1.0);
    ...
    pub(super) fn stamp_reactive_block_2(
        ...
        s.store_scalar(369, (if (p.p37 == 1.0) { p.p1040 } else { p.p1039 }));

        s.store_scalar(370, (if (p.p37 == 1.0) { p.p1042 } else { p.p1041 }));
        ...
        s.store_scalar(369, ((s.v[369] * s.v[368]) * (((s.v[328] / p.p23) * s.v[327]) + (p.p28 / p.p3))));

        s.store_scalar(370, (s.v[370] * (-p.p376)));
        ...
        s.store_ad_value(467, A::exp_div_scaled_inputs(s.ad_value(136), ((-0.5) * s.v[327]), s.ad_value(468), 1.0));

        s.store_add_scaled_product_indices(342, 467, 1.0, 467, 467, 2.0);

        s.store_ad_value(467, A::exp_div_scaled_inputs(s.ad_value(135), ((-0.5) * s.v[327]), s.ad_value(468), 1.0));
        ...
        s.store_scalar(467, ((s.v[474]) as f64).powf(p.p239));
        ...
        s.store_scalar(467, ((s.v[474]) as f64).powf(p.p241));
        ...
        s.store_scalar(483, (1.0 / (p.p232 + (0.5 * s.v[474]))));

        s.store_scalar(484, (1.0 / (p.p233 + (0.5 * s.v[474]))));
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        s.store_scalar(235, (s.v[483] + s.v[484]));
        ...
        s.store_scalar(52, (s.v[392] * p.p8));

        s.store_scale(53, 43, p.p8);

        s.store_scalar(54, (s.v[392] * p.p7));
        ...
        s.store_scalar(61, (p.p131 * p.p11));
        ...
        s.store_scalar(60, (p.p131 * p.p12));
        ...
        s.store_pow_indices(352, 467, 318);
    ...
    pub(super) fn stamp_reactive_block_4(
        ...
        if (!s.b[629]) {
            ...
            s.store_div_scaled_inputs_indices(467, 130, ((-0.5) * p.p54), 509, 1.0);
        }
        ...
        if (!s.b[629]) {
            ...
            s.copy_ad(470, 96);
            s.store_div_scaled_inputs2_mixed_aii(471, A::add_scaled_product(s.ad_value(469), 1.0, s.ad_value(470), s.ad_value(522), 1.0), 1.0, 99, 1.0, 396, 1.0);
        }
        ...
        if (!s.b[629]) {
            ...
            s.store_div_scaled_inputs_indices(467, 133, ((-0.5) * (p.p55 * p.p54)), 510, 1.0);
        }
        ...
        if (!s.b[629]) {
            ...
            s.copy_ad(514, 502);
            s.store_sub_add_scaled_inputs4_lhs_mixed_aiii(507, A::add_scaled_product(A::add_scaled_inputs3(A::add_scaled_product(s.ad_value(408), p.p37, A::add_scaled_products(s.ad_value(376), s.ad_value(514), 1.0, s.ad_value(346), s.ad_value(502), (-1.0)), s.ad_value(518), 1.0), 1.0, s.ad_value(523), (-1.0), s.ad_value(524), -1.0), 1.0, s.ad_value(125), s.ad_value(464), 1.0), 1.0, 520, 1.0, 517, -1.0, 519, -1.0, 521);
            s.store_sub(508, 504, 507);
            s.store_mul(497, 511, 499);
            s.store_div_scaled_product_indices(512, 384, 508, 1.0, 497, 1.0);
            s.store_div_scaled_inputs2_mixed_iai(513, 151, 1.0, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(384), s.ad_value(508)), (-1.0), 497, 1.0);
        }
        ...
        while {
            ...
            if (!s.b[629]) {
                ...
                s.store_div_scaled_inputs2_indices(638, 505, 1.0, 516, 1.0, 464, 1.0);
            }
            if (!s.b[629]) {
        ...
        s.store_div_scaled_inputs_indices(467, 133, ((-0.5) * (s.v[328] * s.v[327])), 464, 1.0);
        ...
        s.store_div_scaled_inputs_indices(467, 130, ((-0.5) * s.v[327]), 464, 1.0);
        ...
        s.store_scalar(64, (((p.p424 * (p.p427 + (((s.v[328] / p.p23) / 3.0) / p.p425))) / ((p.p425 * p.p3) * (p.p1 - p.p428))) + (p.p426 / ((p.p1 * s.v[328]) * p.p3))));
        ...
        if s.b[647] {
            ...
            s.store_div_scaled_inputs_indices(467, 130, s.v[327], 509, 1.0);
        }
        ...
        if s.b[647] {
            ...
            s.store_div_scaled_inputs2_mixed_aii(531, A::add_scaled_product(s.ad_value(464), 1.0, s.ad_value(96), s.ad_value(522), 1.0), 1.0, 99, 1.0, 396, 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_5(
        ...
        if (s.b[647] && s.b[650]) {
            s.store_div_scaled_inputs_indices(470, 396, 3.720075976e-44, 367, 1.0);
        ...
        if ((s.b[647] && (!s.b[650])) && s.b[651]) {
            s.store_div_scaled_inputs_indices(470, 396, 2.688117142e43, 367, 1.0);
            s.store_add_scaled_product_indices(471, 384, 1.0, 470, 529, 1.0);
        }
        ...
        if s.b[647] {
            s.store_div_scaled_inputs_indices(69, 467, 0.6931471805599453, 471, 1.0);
        }
        ...
        if s.b[1159] {
            ...
            s.store_ad_value(843, A::exp_div_scaled_inputs(s.ad_value(136), ((-0.5) * s.v[327]), s.ad_value(844), 1.0));
            s.store_add_scaled_product_indices(1141, 843, 1.0, 843, 843, 2.0);
            s.store_ad_value(843, A::exp_div_scaled_inputs(s.ad_value(135), ((-0.5) * s.v[327]), s.ad_value(844), 1.0));
    ...
    pub(super) fn stamp_reactive_block_7(
        ...
        if ((!s.b[1202]) && s.b[1203]) {
            s.store_div_scaled_inputs_indices(843, 225, (-s.v[327]), 119, 1.0);
        ...
        if ((!s.b[1202]) && (!s.b[1203])) {
            ...
            s.store_div_scaled_inputs_indices(844, 225, (-s.v[327]), 119, 1.0);
            ...
            s.store_div_scaled_inputs_indices(847, 344, 0.5, 393, 1.0);
            s.store_mul_ad_product_rhs_mixed_ia(848, 393, 843, A::add_scaled_inputs3(s.ad_value(942), 1.0, s.ad_value(847), (-1.0), s.ad_value(216), 1.0));
        ...
        if (!s.b[1202]) {
            ...
            s.store_div_scaled_inputs_indices(843, 130, ((-0.5) * s.v[892]), 865, 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_8(
        ...
        if (!s.b[1202]) {
            ...
            s.store_div_scaled_inputs2_mixed_aii(847, A::add_scaled_product(s.ad_value(845), 1.0, s.ad_value(846), s.ad_value(868), 1.0), 1.0, 99, 1.0, 396, 1.0);
        }
        ...
        if (!s.b[1202]) {
            ...
            s.store_div_scaled_inputs_indices(843, 133, ((-0.5) * (s.v[328] * s.v[892])), 866, 1.0);
        }
        ...
        if (!s.b[1202]) {
            ...
            s.store_sub_add_scaled_inputs4_lhs_mixed_aiii(1037, A::add_scaled_product(A::add_scaled_inputs3(A::add_scaled_value_products(s.ad_value(408), p.p37, A::add_scaled_products(s.ad_value(376), s.ad_value(828), 1.0, s.ad_value(405), s.ad_value(943), (-1.0)), s.ad_value(1089), 1.0, s.ad_value(403), s.ad_value(1032), (-1.0)), 1.0, s.ad_value(867), (-1.0), s.ad_value(904), -1.0), 1.0, A::add_scaled_product(s.ad_value(125), 1.0, s.ad_value(126), s.ad_value(1032), 1.0), s.ad_value(870), 1.0), 1.0, 903, 1.0, 873, -1.0, 1090, -1.0, 1091);
            s.store_sub_add_scaled_inputs4_lhs_mixed_aiii(1052, A::add_scaled_product(A::add_scaled_inputs3(A::add_scaled_value_products(s.ad_value(408), p.p37, A::add_scaled_products(s.ad_value(376), s.ad_value(828), 1.0, s.ad_value(405), s.ad_value(943), (-1.0)), s.ad_value(1089), 1.0, s.ad_value(403), s.ad_value(1032), (-1.0)), 1.0, s.ad_value(867), (-1.0), s.ad_value(904), -1.0), 1.0, A::add_scaled_product(s.ad_value(125), 1.0, s.ad_value(126), s.ad_value(1032), 1.0), s.ad_value(870), 1.0), 1.0, 903, 1.0, 1070, -1.0, 1090, -1.0, 1091);
        ...
        if (!s.b[1202]) {
            ...
            s.store_mul_product3_indices(844, 832, 226, 376, 832, 1.0);
        ...
        if ((!s.b[1202]) && (!s.b[1217])) {
            ...
            s.store_mul_add_rhs(846, 845, 822, 217);
            s.store_div_scaled_inputs_indices(847, 344, 0.5, 393, 1.0);
            s.store_mul_ad_product_rhs_mixed_ia(848, 393, 843, A::add_scaled_inputs3(s.ad_value(1035), 1.0, s.ad_value(847), (-1.0), s.ad_value(216), 1.0));
            s.store_mul3_lhs(849, 218, 843, 846);
            s.store_add(1036, 848, 849);
            s.store_scaled_mul(850, 843, 902, s.v[913]);
            s.store_add(1031, 1036, 850);
    ...
    pub(super) fn stamp_reactive_block_9(
        ...
        if ((!s.b[1202]) && (!s.b[1223])) {
            ...
            s.store_mul_add_rhs(846, 845, 822, 217);
            s.store_div_scaled_inputs_indices(847, 344, 0.5, 393, 1.0);
            s.store_mul_ad_product_rhs_mixed_ia(848, 393, 843, A::add_scaled_inputs3(s.ad_value(1050), 1.0, s.ad_value(847), (-1.0), s.ad_value(216), 1.0));
            s.store_mul3_lhs(849, 218, 843, 846);
        ...
        s.store_add_scaled_product_right_sub(963, 828, 1.0, 852, 962, 841, (-1.0));

        s.store_exp_mul_scaled_lhs_indices(843, 382, 2.0, 822);

        s.store_div_scaled_product_offset_denominator(1091, s.ad_value(391), A::offset(s.ad_value(843), (-1.0)), 1.0, s.ad_value(843), 1.0, 1.0);

        s.store_sub_add_scaled_inputs4_lhs_mixed_aiii(829, A::add_scaled_product(A::add_scaled_inputs3(A::add_scaled_value_products(s.ad_value(408), p.p37, A::add_scaled_products(s.ad_value(376), s.ad_value(963), 1.0, s.ad_value(405), s.ad_value(943), (-1.0)), s.ad_value(1089), 1.0, s.ad_value(403), s.ad_value(841), (-1.0)), 1.0, s.ad_value(867), (-1.0), s.ad_value(904), -1.0), 1.0, A::add_scaled_product(s.ad_value(125), 1.0, s.ad_value(126), s.ad_value(841), 1.0), s.ad_value(870), 1.0), 1.0, 903, 1.0, 873, -1.0, 1090, -1.0, 1091);
        ...
        s.store_div_scaled_inputs_indices(843, 130, ((-0.5) * s.v[892]), 1056, 1.0);
        ...
        s.store_div_scaled_inputs2_mixed_aii(847, A::add_scaled_product(s.ad_value(845), 1.0, s.ad_value(846), s.ad_value(1058), 1.0), 1.0, 99, 1.0, 396, 1.0);
        ...
        s.store_div_scaled_inputs_indices(843, 133, ((-0.5) * (s.v[328] * s.v[892])), 1057, 1.0);
    ...
    pub(super) fn stamp_reactive_block_10(
        ...
        s.store_add_scaled_product_right_sub(1072, 1054, 1.0, 852, 1045, 1044, (-1.0));

        s.store_exp_mul_scaled_lhs_indices(843, 382, 2.0, 822);

        s.store_div_scaled_product_offset_denominator(1091, s.ad_value(391), A::offset(s.ad_value(843), (-1.0)), 1.0, s.ad_value(843), 1.0, 1.0);

        s.store_sub_add_scaled_inputs4_lhs_mixed_aiii(1073, A::add_scaled_product(A::add_scaled_inputs3(A::add_scaled_value_products(s.ad_value(408), p.p37, A::add_scaled_products(s.ad_value(376), s.ad_value(1072), 1.0, s.ad_value(405), s.ad_value(943), (-1.0)), s.ad_value(1089), 1.0, s.ad_value(403), s.ad_value(1044), (-1.0)), 1.0, s.ad_value(1067), (-1.0), s.ad_value(1068), -1.0), 1.0, A::add_scaled_product(s.ad_value(125), 1.0, s.ad_value(126), s.ad_value(1044), 1.0), s.ad_value(1066), 1.0), 1.0, 1069, 1.0, 1070, -1.0, 1071, -1.0, 1091);
        ...
        if s.b[1241] {
            ...
            s.store_div_scaled_inputs_indices(843, 130, ((-0.5) * s.v[892]), 1008, 1.0);
        }
        ...
        if s.b[1241] {
            ...
            s.store_div_scaled_inputs_indices(843, 133, ((-0.5) * (s.v[328] * s.v[892])), 1009, 1.0);
        }
        ...
        s.store_div_scaled_inputs2_mixed_iai(833, 151, 1.0, A::mul_sub_from_scalar_lhs(1.0, s.ad_value(384), s.ad_value(830)), (-1.0), 853, 1.0);
        ...
        if (!s.b[1246]) {
            s.store_div_scaled_inputs_indices(852, 385, ((s.v[892]) as f64).sqrt(), 890, 1.0);
        ...
        if ((!s.b[1248]) && (!s.b[1249])) {
            ...
            s.store_mul_ad_product_lhs_mixed_ia(887, 955, A::offset(s.ad_value(843), 0.8), 844);
        }
    ...
    pub(super) fn stamp_reactive_block_12(
        ...
        if ((s.b[1275] && (!s.b[1294])) && s.b[1297]) {
            ...
            s.store_mul_div_scaled_inputs_product_lhs(843, 1087, -1.0, 971, 1.0, 314, 844);
        }
        ...
        if ((s.b[1275] && (!s.b[1302])) && s.b[1305]) {
            s.store_scalar(844, 1000.0);
            s.store_mul_div_scaled_inputs_product_lhs(843, 1088, -1.0, 971, 1.0, 315, 844);
        }
    ...
    pub(super) fn stamp_reactive_block_13(
        ...
        if ((s.b[1275] && (!s.b[1315])) && s.b[1316]) {
            s.store_scalar(844, 1000.0);
            s.store_mul_div_scaled_inputs_product_lhs(843, 1087, -1.0, 932, 1.0, 316, 844);
        }
        ...
        if ((s.b[1275] && (!s.b[1315])) && s.b[1321]) {
            s.store_scalar(844, 1000.0);
            s.store_mul_div_scaled_inputs_product_lhs(843, 1088, -1.0, 932, 1.0, 317, 844);
        }
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if ((s.b[1402] && (!s.b[1403])) && s.b[1409]) {
            s.store_add_product3_rhs_mixed_iia(937, 937, 1116, 376, A::sub(s.ad_value(844), s.ad_value(843)), 1.0);
        }
        ...
        if ((s.b[1402] && (!s.b[1412])) && s.b[1413]) {
            ...
            s.store_mul(846, 843, 845);
            s.store_sub_from_scalar(850, 1.0, 894);
            s.store_add_product3_rhs_mixed_iia(1006, 1006, 1116, 850, A::sub_scaled_inputs(s.ad_value(1130), 0.5, s.ad_value(846), 1.0), 1.0);
        }
