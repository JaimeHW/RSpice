...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if (!s.b[1454]) {
            s.store_ad_value(846, A::div_scaled_product(A::sub_from_scalar(1.0, A::mul(s.ad_value(811), s.ad_value(858))), s.ad_value(815), 1.0, A::sub_from_scalar(1.0, s.ad_value(816)), 1.0));
        }
