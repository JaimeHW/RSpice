...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if s.b[1159] {s.store_scale(850, 235, p[235]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_17(
        ...
        if s.b[1159] {s.store_div(960, 850, 961);s.store_scale(847, 51, p[235]);s.store_div(959, 847, 961);s.store_offset(845, 959, 1.0);s.store_offset(850, 960, 1.0);s.store_div(843, 845, 850);s.store_mul(945, 945, 843);s.store_add_scaled_product_indices(946, 101, 1.0, 102, 430, (-1.0));s.store_offset_mul(845, 45, 959, 1.0);s.store_offset_mul(850, 45, 960, 1.0);s.store_div(843, 845, 850);s.store_mul(946, 946, 843);}
    ...
    pub(super) fn stamp_transient_block_28(
        ...
        if (p[41] != 0.0) {s.store_scaled_offset_ad(965, A::sub_from_scalar((p[52] - p[53]), A::scale(s.ad_value(912), 0.5)), 0.45, (2.0 * p[37]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_29(
        ...
        if (p[41] != 0.0) {s.store_scalar(1109, ((p[45] * p[47]) / 3.9));s.store_scaled_sub(856, 897, 941, p[123]);}
