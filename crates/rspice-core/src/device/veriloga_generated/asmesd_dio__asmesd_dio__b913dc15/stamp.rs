...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        s.store_offset_div_scaled_inputs(46, s.ad_value(45), -1.0, s.ad_value(10), (2.0 * 1.3806226e-23), (1.1150877 / (1.3806226e-23 * (300.15 + 300.15))));
        ...
        if s.b[68] {
            s.store_div_scaled_value_offset_denominator(29, s.ad_value(29), 1.0, A::powf(A::scale(A::abs(A::voltage(ctx, nodes, Some(6), None)), 1.0 / (p.p20)), p.p44), 1.0, 1.0);
        }
