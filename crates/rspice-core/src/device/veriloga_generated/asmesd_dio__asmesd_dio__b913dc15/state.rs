...
pub(crate) const PARAMETER_MODEL_FLAGS: [bool; 52] = [
    true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true,
    true, true, true, true, true, true, true, true, true, true, false, false, true, false, true, true, true, true, true, true,
];
...
pub(crate) type CanonicalModelValues = [f64; 26];
pub struct Instance {
    pub nodes: [usize; 7],
    ...
    pub(crate) canonical_staged: Box<[f64; 33]>,
...
impl Instance {
    ...
    pub const VARIABLE_COUNT: usize = 83;
    pub const DDT_STATE_COUNT: usize = 6;
    pub const IDT_STATE_COUNT: usize = 0;
    pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "32363fc8778fd16ac8f4518c62ffd24d082ecd5896609b942c6bdb7523327310";
