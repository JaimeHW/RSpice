...
pub struct Instance {
    ...
    pub(crate) canonical_reactive: Box<[f64; 40]>,
    pub(crate) canonical_staged: Box<[f64; 31]>,
...
impl Instance {
    ...
    pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "273c28d6edeacc8eca175d01b4c608a567c8c96b57f4fbb831ac81df804e52ca";
