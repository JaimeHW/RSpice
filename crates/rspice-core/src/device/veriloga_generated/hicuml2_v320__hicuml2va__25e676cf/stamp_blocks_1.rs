...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        if (!s.b[394]) {s.store_mul_add_scaled_inputs_rhs_mixed_ia(388, 3, 387, 0.5, A::sqrt_square_offset(s.ad_value(387), p[80]), 0.5);}
        s.store_div(389, 388, 55);s.store_mul(390, 388, 54);s.store_exp_scaled_input_ad(391, A::ln_one_plus_exp(A::scale(A::ln(s.ad_value(389)), p[77])), 1.0 / (p[77]));s.store_div(392, 390, 391);s.store_scaled_sub(393, 388, 55, 1.0 / (p[76]));s.store_mul_scale_offset_mixed_ia(362, 392, A::add_scaled_inputs(s.ad_value(393), 0.5, A::sqrt_square_offset(s.ad_value(393), p[81]), 0.5), 1.0, 1.0);s.copy_ad(348, 352);s.b[395] = ((s.v[357] > 0.0) || (p[85] > 0.0));s.store_scalar(395, if s.b[395] { 1.0 } else { 0.0 });
        if s.b[395] {s.store_scale(396, 352, 0.5);}
        s.b[397] = (p[0] <= 300.0);s.store_scalar(397, if s.b[397] { 1.0 } else { 0.0 });
        if (s.b[395] && s.b[397]) {s.store_add_mixed_ia(348, 396, A::sqrt(A::add_scaled_inputs(A::add_scaled_square_product(s.ad_value(396), 1.0, s.ad_value(357), s.ad_value(350), 1.0), 1.0, s.ad_value(351), p[85])));}
        if (s.b[395] && (!s.b[397])) {s.store_add_mixed_ia(348, 396, A::sqrt(A::add_scaled_inputs3(A::square(s.ad_value(396)), 1.0, A::mul3(s.ad_value(19), s.ad_value(59), s.ad_value(350)), 1.0, s.ad_value(351), p[85])));}
        s.store_div(217, 350, 348);s.store_div(218, 351, 348);s.copy_ad(219, 357);s.store_mul(355, 357, 217);s.b[398] = (p[0] >= 310.0);s.store_scalar(398, if s.b[398] { 1.0 } else { 0.0 });
        if s.b[398] {s.store_mul(359, 19, 59);s.store_mul(358, 359, 217);}
        if (!s.b[398]) {s.store_mul(358, 19, 355);s.store_mul(359, 19, 219);}
        s.store_scalar(354, 0.0);s.b[399] = ((s.v[217] >= (1e-6 * s.v[362])) || (p[0] >= 320.0));s.store_scalar(399, if s.b[399] { 1.0 } else { 0.0 });
        if s.b[399] {s.store_div(96, 217, 362);s.store_mul_mixed_ia(98, 61, A::exp_scaled_input(A::ln(s.ad_value(96)), p[70]));s.store_scaled_mul(97, 98, 217, 1.0 / ((1.0 + p[70])));}
        s.b[400] = (p[83] < (0.05 * (p[75] / p[74])));s.store_scalar(400, if s.b[400] { 1.0 } else { 0.0 });
        if (s.b[399] && s.b[400]) {s.store_scalar(111, 0.0);s.store_scalar(112, 0.0);}
        if (s.b[399] && (!s.b[400])) {s.store_scaled_sub(107, 217, 362, 1.0 / (p[83]));}
        ...
        if (s.b[399] && (!s.b[400])) {s.store_sqrt_square_offset(95, 107, p[84]);s.store_scaled_exp_ad(111, A::div_from_scalar((-2.0), A::add(s.ad_value(107), s.ad_value(95))), p[82]);s.store_div_scaled_inputs_mixed_ia(112, 111, 2.0, A::mul_scaled_lhs(s.ad_value(95), p[83], A::add(s.ad_value(107), s.ad_value(95))), 1.0);}
        if s.b[399] {s.store_mul_scaled_offset_ad_rhs(99, 60, (1.0 - p[73]), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_17(
        ...
        if s.b[399] {s.store_add_product3_rhs_mixed_aii(100, 99, A::mul3_scaled_output(s.ad_value(60), s.ad_value(217), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (1.0 - p[73])), 5, 112, 1.0);s.store_sub_from_scalar_ad(108, 1.0, A::div_from_scalar(1.0, s.ad_value(96)));s.store_scaled_add_mixed_ia(109, 108, A::sqrt_square_offset(s.ad_value(108), p[72]), 1.0 / ((1.0 + (((1.0 + p[72])) as f64).sqrt())));s.store_exp_ad(110, A::mul_offset_lhs(s.ad_value(111), (-p[82]), s.ad_value(5)));s.store_mul_product3_indices(101, 110, 60, 109, 109, 1.0);s.store_mul_add_mixed_iaa(102, 101, A::offset(A::div_from_scalar(2.0, A::mul(s.ad_value(96), A::sqrt_square_offset(s.ad_value(108), p[72]))), 1.0), A::mul3(s.ad_value(5), s.ad_value(217), s.ad_value(112)));}
        s.b[402] = ((((p[115] < 0.01) && (p[116] < 0.01)) && ((s.v[109] * p[115]) < 0.005)) && ((s.v[109] * p[116]) < 0.005));s.store_scalar(402, if s.b[402] { 1.0 } else { 0.0 });
        if (s.b[399] && s.b[402]) {s.store_scaled_mul(105, 101, 217, p[73]);s.store_scale(106, 102, p[73]);}
        if (s.b[399] && (!s.b[402])) {s.store_sub_from_scalar(146, 1.0, 109);s.store_div_scaled_value_by_product_mixed_aai(147, A::mul_sub_from_scalar_rhs(A::offset(s.ad_value(146), (-1.0)), 1.0, s.ad_value(108)), 1.0, A::sqrt_square_offset(s.ad_value(108), p[72]), 217, 1.0);}
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && (!s.b[404])) {s.store_sub_from_scalar_scaled_input(152, p[116], 151, p[115]);s.store_div_scaled_offset_numerator_indices(149, 151, 1.0, (-1.0), 152, 1.0);s.store_offset_scaled(160, 149, p[116], 1.0);s.store_ln(161, 160);s.store_primal_mul(162, 227, 226);s.store_add_scaled_products_mixed_aiai(157, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 226, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(227), s.ad_value(149), 1.0), 149, 1.0);s.store_add_scaled_inputs_product_mixed_aiii(159, A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), 1.0, 162, 1.0, 149, 227, 2.0);s.store_offset_scaled(160, 149, p[115], 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_18(
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && (!s.b[404])) {s.store_ln(161, 160);s.store_primal_mul(162, 228, 225);s.store_add_scaled_products_mixed_aiai(156, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 225, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(228), s.ad_value(149), 1.0), 149, 1.0);s.store_add_scaled_inputs_product_mixed_aiii(158, A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), 1.0, 162, 1.0, 149, 228, 2.0);s.store_div_scaled_inputs2_indices(154, 157, 1.0, 156, (-1.0), 232, 1.0);s.store_mul_product3_mixed_iaii(150, 147, A::div_scaled_inputs(s.ad_value(232), (-2.0), A::square(s.ad_value(152)), 1.0), 151, 231, 1.0);s.store_div_scaled_product_mixed_aii(155, A::sub(s.ad_value(159), s.ad_value(158)), 150, 1.0, 232, 1.0);}
        if ((s.b[399] && (!s.b[402])) && (!s.b[403])) {s.store_div_ad(149, A::sub_from_scalar(1.0, s.ad_value(146)), A::scale_offset(s.ad_value(146), p[115], 1.0));s.store_offset_scaled(153, 149, p[115], 1.0);s.store_div_scaled_product_offset_rhs_mixed_aai(154, A::square(s.ad_value(149)), A::mul_scaled_lhs(s.ad_value(227), 2.0, s.ad_value(149)), 1.0, 1.0, 153, 1.0);s.store_div_scaled_product_mixed_iia(150, 147, 153, -1.0, A::scale_offset(s.ad_value(146), p[115], 1.0), 1.0);s.store_mul_ad_product_lhs_mixed_ia(155, 149, A::offset(A::div_from_scalar(1.0, A::square(s.ad_value(153))), 1.0), 150);}
        if (s.b[399] && (!s.b[402])) {s.store_scaled_mul(166, 60, 110, p[73]);s.store_mul(167, 166, 154);s.store_mul(105, 167, 217);s.store_add_scaled_inputs3_mixed_iaa(106, 167, 1.0, A::mul3(s.ad_value(105), s.ad_value(112), s.ad_value(5)), 1.0, A::mul3(s.ad_value(166), s.ad_value(217), s.ad_value(155)), 1.0);}
        if s.b[399] {s.store_scaled_mul(103, 101, 217, (1.0 - p[73]));s.store_scale(104, 102, (1.0 - p[73]));s.store_add_scaled_product_indices(354, 103, 1.0, 99, 217, 1.0);}
        s.b[405] = (p[0] >= 310.0);s.store_scalar(405, if s.b[405] { 1.0 } else { 0.0 });
        if (s.b[399] && s.b[405]) {s.store_add_scaled_inputs4_indices(355, 355, 1.0, 354, 1.0, 97, 1.0, 105, 1.0);s.store_add_mixed_ai(219, A::add_scaled_inputs4(s.ad_value(219), 1.0, s.ad_value(100), 1.0, s.ad_value(104), 1.0, s.ad_value(98), 1.0), 106);s.store_add_scaled_inputs_products_indices(358, 358, 1.0, 354, p[5], 20, 97, 1.0, 21, 105, 1.0);s.store_add_scaled_value_products_mixed_aiiii(359, A::add_scaled_inputs3(s.ad_value(359), 1.0, s.ad_value(100), p[5], s.ad_value(104), p[5]), 1.0, 20, 98, 1.0, 21, 106, 1.0);}
        ...
        s.store_scale(356, 218, p[85]);s.store_scalar(224, 0.0);s.b[406] = (((p[0] >= 310.0) && (s.v[358] > (1e-5 * s.v[348]))) || ((p[0] <= 300.0) && (s.v[355] > (1e-5 * s.v[348]))));s.store_scalar(406, if s.b[406] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_19(
        ...
        if s.b[406] {s.store_sqrt_ad(355, A::mul3(s.ad_value(357), s.ad_value(217), s.ad_value(358)));s.store_add_scaled_inputs3_indices(348, 352, 1.0, 355, 1.0, 356, p[7]);s.copy_ad(349, 348);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_20(
        ...
        while {
            ...
            s.b[409] = ((s.v[217] >= (1e-6 * s.v[362])) || (p[0] >= 320.0));s.store_scalar(409, if s.b[409] { 1.0 } else { 0.0 });
            if (s.b[406] && s.b[409]) {s.store_div(96, 217, 362);s.store_mul_mixed_ia(98, 61, A::exp_scaled_input(A::ln(s.ad_value(96)), p[70]));s.store_scaled_mul(97, 98, 217, 1.0 / ((1.0 + p[70])));}
            s.b[410] = (p[83] < (0.05 * (p[75] / p[74])));s.store_scalar(410, if s.b[410] { 1.0 } else { 0.0 });
            if ((s.b[406] && s.b[409]) && s.b[410]) {s.store_scalar(111, 0.0);s.store_scalar(112, 0.0);}
            if ((s.b[406] && s.b[409]) && (!s.b[410])) {s.store_scaled_sub(107, 217, 362, 1.0 / (p[83]));}
            ...
            if ((s.b[406] && s.b[409]) && (!s.b[410])) {s.store_sqrt_square_offset(95, 107, p[84]);s.store_scaled_exp_ad(111, A::div_from_scalar((-2.0), A::add(s.ad_value(107), s.ad_value(95))), p[82]);s.store_div_scaled_inputs_mixed_ia(112, 111, 2.0, A::mul_scaled_lhs(s.ad_value(95), p[83], A::add(s.ad_value(107), s.ad_value(95))), 1.0);}
            if (s.b[406] && s.b[409]) {s.store_mul_scaled_offset_ad_rhs(99, 60, (1.0 - p[73]), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (-1.0));s.store_add_product3_rhs_mixed_aii(100, 99, A::mul3_scaled_output(s.ad_value(60), s.ad_value(217), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (1.0 - p[73])), 5, 112, 1.0);s.store_sub_from_scalar_ad(108, 1.0, A::div_from_scalar(1.0, s.ad_value(96)));s.store_scaled_add_mixed_ia(109, 108, A::sqrt_square_offset(s.ad_value(108), p[72]), 1.0 / ((1.0 + (((1.0 + p[72])) as f64).sqrt())));s.store_exp_ad(110, A::mul_offset_lhs(s.ad_value(111), (-p[82]), s.ad_value(5)));s.store_mul_product3_indices(101, 110, 60, 109, 109, 1.0);s.store_mul_add_mixed_iaa(102, 101, A::offset(A::div_from_scalar(2.0, A::mul(s.ad_value(96), A::sqrt_square_offset(s.ad_value(108), p[72]))), 1.0), A::mul3(s.ad_value(5), s.ad_value(217), s.ad_value(112)));}
            s.b[412] = ((((p[115] < 0.01) && (p[116] < 0.01)) && ((s.v[109] * p[115]) < 0.005)) && ((s.v[109] * p[116]) < 0.005));s.store_scalar(412, if s.b[412] { 1.0 } else { 0.0 });
            if ((s.b[406] && s.b[409]) && s.b[412]) {s.store_scaled_mul(105, 101, 217, p[73]);s.store_scale(106, 102, p[73]);}
            if ((s.b[406] && s.b[409]) && (!s.b[412])) {s.store_sub_from_scalar(146, 1.0, 109);s.store_div_scaled_value_by_product_mixed_aai(147, A::mul_sub_from_scalar_rhs(A::offset(s.ad_value(146), (-1.0)), 1.0, s.ad_value(108)), 1.0, A::sqrt_square_offset(s.ad_value(108), p[72]), 217, 1.0);}
            ...
            if ((((s.b[406] && s.b[409]) && (!s.b[412])) && s.b[413]) && (!s.b[414])) {s.store_sub_from_scalar_scaled_input(152, p[116], 151, p[115]);s.store_div_scaled_offset_numerator_indices(149, 151, 1.0, (-1.0), 152, 1.0);s.store_offset_scaled(160, 149, p[116], 1.0);s.store_ln(161, 160);s.store_primal_mul(162, 227, 226);s.store_add_scaled_products_mixed_aiai(157, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 226, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(227), s.ad_value(149), 1.0), 149, 1.0);s.store_add_scaled_inputs_product_mixed_aiii(159, A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), 1.0, 162, 1.0, 149, 227, 2.0);s.store_offset_scaled(160, 149, p[115], 1.0);s.store_ln(161, 160);s.store_primal_mul(162, 228, 225);s.store_add_scaled_products_mixed_aiai(156, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 225, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(228), s.ad_value(149), 1.0), 149, 1.0);s.store_add_scaled_inputs_product_mixed_aiii(158, A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), 1.0, 162, 1.0, 149, 228, 2.0);s.store_div_scaled_inputs2_indices(154, 157, 1.0, 156, (-1.0), 232, 1.0);s.store_mul_product3_mixed_iaii(150, 147, A::div_scaled_inputs(s.ad_value(232), (-2.0), A::square(s.ad_value(152)), 1.0), 151, 231, 1.0);s.store_div_scaled_product_mixed_aii(155, A::sub(s.ad_value(159), s.ad_value(158)), 150, 1.0, 232, 1.0);}
            if (((s.b[406] && s.b[409]) && (!s.b[412])) && (!s.b[413])) {s.store_div_ad(149, A::sub_from_scalar(1.0, s.ad_value(146)), A::scale_offset(s.ad_value(146), p[115], 1.0));s.store_offset_scaled(153, 149, p[115], 1.0);s.store_div_scaled_product_offset_rhs_mixed_aai(154, A::square(s.ad_value(149)), A::mul_scaled_lhs(s.ad_value(227), 2.0, s.ad_value(149)), 1.0, 1.0, 153, 1.0);s.store_div_scaled_product_mixed_iia(150, 147, 153, -1.0, A::scale_offset(s.ad_value(146), p[115], 1.0), 1.0);s.store_mul_ad_product_lhs_mixed_ia(155, 149, A::offset(A::div_from_scalar(1.0, A::square(s.ad_value(153))), 1.0), 150);}
            if ((s.b[406] && s.b[409]) && (!s.b[412])) {s.store_scaled_mul(166, 60, 110, p[73]);s.store_mul(167, 166, 154);s.store_mul(105, 167, 217);s.store_add_scaled_inputs3_mixed_iaa(106, 167, 1.0, A::mul3(s.ad_value(105), s.ad_value(112), s.ad_value(5)), 1.0, A::mul3(s.ad_value(166), s.ad_value(217), s.ad_value(155)), 1.0);}
            if (s.b[406] && s.b[409]) {s.store_scaled_mul(103, 101, 217, (1.0 - p[73]));s.store_scale(104, 102, (1.0 - p[73]));s.store_add_scaled_product_indices(354, 103, 1.0, 99, 217, 1.0);}
            s.b[415] = (p[0] >= 310.0);s.store_scalar(415, if s.b[415] { 1.0 } else { 0.0 });
            ...
            if s.b[406] {s.store_scale(360, 218, (p[7] * p[85]));s.store_div_scaled_inputs(349, A::add_scaled_inputs4(s.ad_value(348), 1.0, s.ad_value(352), -1.0, s.ad_value(358), -1.0, s.ad_value(360), -1.0), -1.0, A::offset(A::div_scaled_add_product(s.ad_value(360), 1.0, s.ad_value(359), s.ad_value(217), 1.0, s.ad_value(348), 1.0), 1.0), 1.0);s.store_abs_scaled_input(407, 348, 0.3);}
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if s.b[406] {s.store_div(217, 350, 348);s.store_div(218, 351, 348);s.copy_ad(219, 357);s.store_mul(355, 357, 217);}
        s.b[418] = (p[0] >= 310.0);s.store_scalar(418, if s.b[418] { 1.0 } else { 0.0 });
        ...
        if s.b[406] {s.store_scalar(354, 0.0);}
        s.b[419] = ((s.v[217] >= (1e-6 * s.v[362])) || (p[0] >= 320.0));s.store_scalar(419, if s.b[419] { 1.0 } else { 0.0 });
        if (s.b[406] && s.b[419]) {s.store_div(96, 217, 362);s.store_mul_mixed_ia(98, 61, A::exp_scaled_input(A::ln(s.ad_value(96)), p[70]));s.store_scaled_mul(97, 98, 217, 1.0 / ((1.0 + p[70])));}
        s.b[420] = (p[83] < (0.05 * (p[75] / p[74])));s.store_scalar(420, if s.b[420] { 1.0 } else { 0.0 });
        if ((s.b[406] && s.b[419]) && s.b[420]) {s.store_scalar(111, 0.0);s.store_scalar(112, 0.0);}
        if ((s.b[406] && s.b[419]) && (!s.b[420])) {s.store_scaled_sub(107, 217, 362, 1.0 / (p[83]));}
        ...
        if ((s.b[406] && s.b[419]) && (!s.b[420])) {s.store_sqrt_square_offset(95, 107, p[84]);s.store_scaled_exp_ad(111, A::div_from_scalar((-2.0), A::add(s.ad_value(107), s.ad_value(95))), p[82]);s.store_div_scaled_inputs_mixed_ia(112, 111, 2.0, A::mul_scaled_lhs(s.ad_value(95), p[83], A::add(s.ad_value(107), s.ad_value(95))), 1.0);}
        if (s.b[406] && s.b[419]) {s.store_mul_scaled_offset_ad_rhs(99, 60, (1.0 - p[73]), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (-1.0));s.store_add_product3_rhs_mixed_aii(100, 99, A::mul3_scaled_output(s.ad_value(60), s.ad_value(217), A::exp(A::mul(s.ad_value(111), s.ad_value(5))), (1.0 - p[73])), 5, 112, 1.0);s.store_sub_from_scalar_ad(108, 1.0, A::div_from_scalar(1.0, s.ad_value(96)));s.store_scaled_add_mixed_ia(109, 108, A::sqrt_square_offset(s.ad_value(108), p[72]), 1.0 / ((1.0 + (((1.0 + p[72])) as f64).sqrt())));s.store_exp_ad(110, A::mul_offset_lhs(s.ad_value(111), (-p[82]), s.ad_value(5)));s.store_mul_product3_indices(101, 110, 60, 109, 109, 1.0);s.store_mul_add_mixed_iaa(102, 101, A::offset(A::div_from_scalar(2.0, A::mul(s.ad_value(96), A::sqrt_square_offset(s.ad_value(108), p[72]))), 1.0), A::mul3(s.ad_value(5), s.ad_value(217), s.ad_value(112)));}
        s.b[422] = ((((p[115] < 0.01) && (p[116] < 0.01)) && ((s.v[109] * p[115]) < 0.005)) && ((s.v[109] * p[116]) < 0.005));s.store_scalar(422, if s.b[422] { 1.0 } else { 0.0 });
        if ((s.b[406] && s.b[419]) && s.b[422]) {s.store_scaled_mul(105, 101, 217, p[73]);s.store_scale(106, 102, p[73]);}
        if ((s.b[406] && s.b[419]) && (!s.b[422])) {s.store_sub_from_scalar(146, 1.0, 109);s.store_div_scaled_value_by_product_mixed_aai(147, A::mul_sub_from_scalar_rhs(A::offset(s.ad_value(146), (-1.0)), 1.0, s.ad_value(108)), 1.0, A::sqrt_square_offset(s.ad_value(108), p[72]), 217, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_22(
        ...
        if (((s.b[406] && s.b[419]) && (!s.b[422])) && (!s.b[423])) {s.store_div_ad(149, A::sub_from_scalar(1.0, s.ad_value(146)), A::scale_offset(s.ad_value(146), p[115], 1.0));s.store_offset_scaled(153, 149, p[115], 1.0);s.store_div_scaled_product_offset_rhs_mixed_aai(154, A::square(s.ad_value(149)), A::mul_scaled_lhs(s.ad_value(227), 2.0, s.ad_value(149)), 1.0, 1.0, 153, 1.0);s.store_div_scaled_product_mixed_iia(150, 147, 153, -1.0, A::scale_offset(s.ad_value(146), p[115], 1.0), 1.0);s.store_mul_ad_product_lhs_mixed_ia(155, 149, A::offset(A::div_from_scalar(1.0, A::square(s.ad_value(153))), 1.0), 150);}
        if ((s.b[406] && s.b[419]) && (!s.b[422])) {s.store_scaled_mul(166, 60, 110, p[73]);s.store_mul(167, 166, 154);s.store_mul(105, 167, 217);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_23(
        ...
        if (s.b[406] && s.b[419]) {s.store_scaled_mul(103, 101, 217, (1.0 - p[73]));s.store_scale(104, 102, (1.0 - p[73]));s.store_add_scaled_product_indices(354, 103, 1.0, 99, 217, 1.0);}
        s.b[425] = (p[0] >= 310.0);s.store_scalar(425, if s.b[425] { 1.0 } else { 0.0 });
        ...
        if s.b[406] {s.store_scale(356, 218, p[85]);}
        s.store_sub(184, 217, 218);s.copy_ad(181, 355);s.copy_ad(182, 356);s.store_mul3_lhs(220, 357, 217, 5);s.store_scaled_mul(221, 218, 5, p[85]);s.store_add_scaled_inputs4_indices(222, 211, p[93], 210, p[93], 220, p[93], 221, p[93]);s.store_mul_voltage_ad(183, s.ad_value(222), ctx, nodes, Some(7), Some(8));s.b[426] = (p[23] > 0.0);s.store_scalar(426, if s.b[426] { 1.0 } else { 0.0 });
        if s.b[426] {s.store_div_scaled_inputs_indices(93, 203, 1.0, 4, p[24]);}
        ...
        s.b[428] = ((p[37] > 0.0) && (s.v[203] < 0.0));s.store_scalar(428, if s.b[428] { 1.0 } else { 0.0 });s.b[429] = ((s.v[33] > 0.0) && (s.v[34] > 0.0));s.store_scalar(429, if s.b[429] { 1.0 } else { 0.0 });
        if (s.b[428] && s.b[429]) {s.store_exp_scaled_input_ad(168, A::ln(A::div(s.ad_value(210), s.ad_value(33))), ((1.0 / p[49]) - 1.0));s.store_div_scaled_product_by_product_indices(166, 67, 203, -1.0, 34, 168, 1.0);s.store_mul_exp_mixed_ia(193, 166, A::mul_scaled_lhs(s.ad_value(68), -1.0, s.ad_value(168)));}
        ...
        s.b[437] = (s.v[431] > 0.0);s.store_scalar(437, if s.b[437] { 1.0 } else { 0.0 });s.b[438] = (p[35] > 0.0);s.store_scalar(438, if s.b[438] { 1.0 } else { 0.0 });
        if ((s.b[430] && s.b[437]) && s.b[438]) {s.store_scalar(441, 0.1);s.store_div(440, 210, 33);s.store_add_scaled_product_indices(439, 217, p[36], 55, 54, p[35]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_24(
        ...
        s.b[443] = (p[34] > 0.0);s.store_scalar(443, if s.b[443] { 1.0 } else { 0.0 });
        if ((s.b[430] && s.b[437]) && s.b[443]) {s.store_sub_from_scalar_scaled_input(444, 1.0, 435, p[34]);s.store_sqrt_square_offset(445, 444, 0.0001);s.store_scaled_add(446, 444, 445, 0.5);s.store_div_scaled_product_indices(244, 217, 435, 1.0, 446, 1.0);}
        ...
        if s.b[447] {s.store_scale(449, 16, (1.0 + p[92]));s.store_add_scaled_inputs3_indices(451, 179, 1.0, 178, 1.0, 355, 1.0);s.store_offset_div(448, 451, 449, 1.0);s.store_scaled_add_mixed_ia(452, 448, A::sqrt_square_offset(s.ad_value(448), 0.01), 0.5);s.store_div(70, 69, 452);}
        s.b[453] = (s.v[185] > 0.0);s.store_scalar(453, if s.b[453] { 1.0 } else { 0.0 });
        if (s.b[447] && s.b[453]) {s.store_mul3_affine_lhs(450, 70, 185, p[91], 0.0, 5);}
        ...
        if (s.b[447] && s.b[455]) {s.store_div_scaled_product_mixed_iaa(70, 70, A::add_scaled_inputs(s.ad_value(179), 1.0, s.ad_value(355), p[94]), 1.0, A::add(s.ad_value(179), s.ad_value(355)), 1.0);}
        if (!s.b[447]) {s.store_scalar(70, 0.0);}
        s.b[456] = (p[18] > 0.0);s.store_scalar(456, if s.b[456] { 1.0 } else { 0.0 });
        if s.b[456] {s.store_div_scaled_inputs_indices(93, 205, 1.0, 4, p[19]);}
    ...
    pub(super) fn stamp_transient_block_25(
        ...
        s.b[458] = (p[20] > 0.0);s.store_scalar(458, if s.b[458] { 1.0 } else { 0.0 });
        if s.b[458] {s.store_div_scaled_inputs_indices(93, 205, 1.0, 4, p[21]);}
        ...
        if s.b[460] {s.store_mul_scale_offset_mixed_ia(137, 30, A::exp_scaled_input(A::ln(s.ad_value(31)), (-1.0 / (p[45]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 205, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));s.store_div(144, 143, 142);s.store_ln_ad(139, A::sub_from_scalar(1.0, A::div(s.ad_value(138), s.ad_value(30))));s.store_mul_mixed_ai(145, A::exp_scaled_input(s.ad_value(139), (-p[45])), 144);s.store_mul_add_mixed_iia(212, 29, 145, A::mul_sub_from_scalar_rhs(s.ad_value(31), 1.0, s.ad_value(144)));s.store_mul_sub_from_scalar_scaled_rhs_scaled_output_mixed_ia(140, 30, 1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p[45])), 1.0, 1.0 / ((1.0 - p[45])));s.store_mul_add_scaled_product_rhs_mixed_iia(180, 29, 140, 1.0, 31, A::sub(s.ad_value(205), s.ad_value(138)), 1.0);}
        if (!s.b[460]) {s.store_scalar(212, 0.0);s.store_scalar(180, 0.0);}
        s.b[461] = ((p[27] > 0.0) && ((s.v[205] < s.v[223]) || (s.v[202] < s.v[223])));s.store_scalar(461, if s.b[461] { 1.0 } else { 0.0 });s.b[464] = (((p[29] == 1.0) && (s.v[29] > 0.0)) && (s.v[30] > 0.0));s.store_scalar(464, if s.b[464] { 1.0 } else { 0.0 });
        if (s.b[461] && s.b[464]) {s.store_exp_scaled_input_ad(462, A::ln(A::div(s.ad_value(212), s.ad_value(29))), (1.0 - (1.0 / p[45])));s.store_mul_ad_affine_product_lhs(463, A::div(s.ad_value(205), s.ad_value(30)), s.ad_value(64), -1.0, 0.0, 462);s.store_mul_mixed_ia(191, 463, A::exp_div_scaled_inputs(s.ad_value(65), -1.0, s.ad_value(462), 1.0));}
        s.b[465] = (((p[29] == 0.0) && (s.v[26] > 0.0)) && (s.v[27] > 0.0));s.store_scalar(465, if s.b[465] { 1.0 } else { 0.0 });
        if ((s.b[461] && (!s.b[464])) && s.b[465]) {s.store_exp_scaled_input_ad(462, A::ln(A::div(s.ad_value(211), s.ad_value(26))), (1.0 - (1.0 / p[41])));s.store_mul_ad_affine_product_lhs(463, A::div(s.ad_value(202), s.ad_value(27)), s.ad_value(64), -1.0, 0.0, 462);s.store_mul_mixed_ia(191, 463, A::exp_div_scaled_inputs(s.ad_value(65), -1.0, s.ad_value(462), 1.0));}
        if ((s.b[461] && (!s.b[464])) && (!s.b[465])) {s.store_scalar(191, 0.0);}
        if (!s.b[461]) {s.store_scalar(191, 0.0);}
        s.store_mul_scale_offset_mixed_ia(192, 66, A::exp_scaled_input(s.ad_value(202), 1.0 / (p[31])), 1.0, (-1.0));s.b[466] = (p[56] < 100.0);s.store_scalar(466, if s.b[466] { 1.0 } else { 0.0 });s.b[467] = (s.v[38] > 0.0);s.store_scalar(467, if s.b[467] { 1.0 } else { 0.0 });
        if (s.b[466] && s.b[467]) {s.store_scalar(113, (p[54] / 4.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_26(
        ...
        if (s.b[466] && s.b[467]) {s.store_sub_from_scalar(114, p[56], 39);s.store_mul_scale_offset_mixed_ia(115, 39, A::exp_scaled_input(A::ln(s.ad_value(40)), (-1.0 / (p[54]))), -1.0, 1.0);s.store_mul(116, 40, 38);s.store_mul_exp_mixed_ia(117, 38, A::mul_offset_lhs(s.ad_value(113), (-p[54]), A::ln(A::div_from_scalar(p[56], s.ad_value(39)))));s.store_mul_sub_lhs(119, 115, 206, 5);}
        ...
        if (s.b[466] && s.b[467]) {s.store_sub(126, 206, 122);s.store_ln_ad(130, A::sub_from_scalar(1.0, A::div(s.ad_value(122), s.ad_value(39))));s.store_ln_ad(131, A::sub_from_scalar(1.0, A::div(s.ad_value(125), s.ad_value(39))));s.store_scalar(132, (1.0 - p[54]));s.store_primal_sub_from_scalar(133, 1.0, 113);s.store_mul_product3_mixed_iiai(134, 124, 38, A::exp_scaled_input(s.ad_value(131), (-p[54])), 121, 1.0);s.store_mul_ad_product_rhs(135, 117, A::exp(A::mul_scaled_rhs(s.ad_value(130), s.ad_value(113), -1.0)), A::sub_from_scalar(1.0, s.ad_value(124)));s.store_mul_scale_offset_indices(136, 116, 121, -1.0, 1.0);s.store_div_mixed_ai(127, A::mul_sub_from_scalar_rhs(s.ad_value(38), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 132);s.store_div_mixed_ai(128, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(130), s.ad_value(133)))), 133);s.store_div_mixed_ai(129, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(133)))), 133);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_27(
        ...
        if ((!s.b[466]) && s.b[470]) {s.store_mul_scale_offset_mixed_ia(137, 39, A::exp_scaled_input(A::ln(s.ad_value(40)), (-1.0 / (p[54]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 206, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));s.store_div(144, 143, 142);s.store_ln_ad(139, A::sub_from_scalar(1.0, A::div(s.ad_value(138), s.ad_value(39))));s.store_mul_mixed_ai(145, A::exp_scaled_input(s.ad_value(139), (-p[54])), 144);s.store_mul_sub_from_scalar_scaled_rhs_scaled_output_mixed_ia(140, 39, 1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p[54])), 1.0, 1.0 / ((1.0 - p[54])));s.store_mul_add_scaled_product_rhs_mixed_iia(42, 38, 140, 1.0, 40, A::sub(s.ad_value(206), s.ad_value(138)), 1.0);}
        if ((!s.b[466]) && (!s.b[470])) {s.store_scalar(42, 0.0);}
        s.b[471] = (p[25] > 0.0);s.store_scalar(471, if s.b[471] { 1.0 } else { 0.0 });
        if s.b[471] {s.store_div_scaled_inputs_indices(93, 206, 1.0, 4, p[26]);}
        ...
        s.b[473] = (p[56] < 100.0);s.store_scalar(473, if s.b[473] { 1.0 } else { 0.0 });s.b[474] = (s.v[37] > 0.0);s.store_scalar(474, if s.b[474] { 1.0 } else { 0.0 });
        if (s.b[473] && s.b[474]) {s.store_scalar(113, (p[54] / 4.0));s.store_sub_from_scalar(114, p[56], 39);s.store_mul_scale_offset_mixed_ia(115, 39, A::exp_scaled_input(A::ln(s.ad_value(40)), (-1.0 / (p[54]))), -1.0, 1.0);s.store_mul(116, 40, 37);s.store_mul_exp_mixed_ia(117, 37, A::mul_offset_lhs(s.ad_value(113), (-p[54]), A::ln(A::div_from_scalar(p[56], s.ad_value(39)))));s.store_mul_sub_lhs(119, 115, 207, 5);}
    ...
    pub(super) fn stamp_transient_block_28(
        ...
        if (s.b[473] && s.b[474]) {s.store_sub(126, 207, 122);s.store_ln_ad(130, A::sub_from_scalar(1.0, A::div(s.ad_value(122), s.ad_value(39))));s.store_ln_ad(131, A::sub_from_scalar(1.0, A::div(s.ad_value(125), s.ad_value(39))));s.store_scalar(132, (1.0 - p[54]));s.store_primal_sub_from_scalar(133, 1.0, 113);s.store_mul_product3_mixed_iiai(134, 124, 37, A::exp_scaled_input(s.ad_value(131), (-p[54])), 121, 1.0);s.store_mul_ad_product_rhs(135, 117, A::exp(A::mul_scaled_rhs(s.ad_value(130), s.ad_value(113), -1.0)), A::sub_from_scalar(1.0, s.ad_value(124)));s.store_mul_scale_offset_indices(136, 116, 121, -1.0, 1.0);s.store_div_mixed_ai(127, A::mul_sub_from_scalar_rhs(s.ad_value(37), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 132);s.store_div_mixed_ai(128, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(130), s.ad_value(133)))), 133);s.store_div_mixed_ai(129, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(133)))), 133);s.store_add_scaled_products_mixed_aiii(41, A::add_scaled_inputs3(s.ad_value(127), 1.0, s.ad_value(128), 1.0, s.ad_value(129), -1.0), 39, 1.0, 116, 126, 1.0);}
        if (s.b[473] && (!s.b[474])) {s.store_scalar(41, 0.0);}
        s.b[477] = (s.v[37] > 0.0);s.store_scalar(477, if s.b[477] { 1.0 } else { 0.0 });
        if ((!s.b[473]) && s.b[477]) {s.store_mul_scale_offset_mixed_ia(137, 39, A::exp_scaled_input(A::ln(s.ad_value(40)), (-1.0 / (p[54]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 207, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));s.store_div(144, 143, 142);s.store_ln_ad(139, A::sub_from_scalar(1.0, A::div(s.ad_value(138), s.ad_value(39))));s.store_mul_mixed_ai(145, A::exp_scaled_input(s.ad_value(139), (-p[54])), 144);s.store_mul_sub_from_scalar_scaled_rhs_scaled_output_mixed_ia(140, 39, 1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p[54])), 1.0, 1.0 / ((1.0 - p[54])));s.store_mul_add_scaled_product_rhs_mixed_iia(41, 37, 140, 1.0, 40, A::sub(s.ad_value(207), s.ad_value(138)), 1.0);}
        if ((!s.b[473]) && (!s.b[477])) {s.store_scalar(41, 0.0);}
        s.b[478] = (p[61] < 100.0);s.store_scalar(478, if s.b[478] { 1.0 } else { 0.0 });s.b[479] = (s.v[46] > 0.0);s.store_scalar(479, if s.b[479] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_29(
        ...
        if (s.b[478] && s.b[479]) {s.store_scalar(113, (p[59] / 4.0));s.store_sub_from_scalar(114, p[61], 47);s.store_mul_scale_offset_mixed_ia(115, 47, A::exp_scaled_input(A::ln(s.ad_value(48)), (-1.0 / (p[59]))), -1.0, 1.0);s.store_mul(116, 48, 46);s.store_mul_exp_mixed_ia(117, 46, A::mul_offset_lhs(s.ad_value(113), (-p[59]), A::ln(A::div_from_scalar(p[61], s.ad_value(47)))));s.store_mul_sub_lhs(119, 115, 208, 5);}
        ...
        if (s.b[478] && s.b[479]) {s.store_sub(126, 208, 122);s.store_ln_ad(130, A::sub_from_scalar(1.0, A::div(s.ad_value(122), s.ad_value(47))));s.store_ln_ad(131, A::sub_from_scalar(1.0, A::div(s.ad_value(125), s.ad_value(47))));s.store_scalar(132, (1.0 - p[59]));s.store_primal_sub_from_scalar(133, 1.0, 113);s.store_mul_product3_mixed_iiai(134, 124, 46, A::exp_scaled_input(s.ad_value(131), (-p[59])), 121, 1.0);s.store_mul_ad_product_rhs(135, 117, A::exp(A::mul_scaled_rhs(s.ad_value(130), s.ad_value(113), -1.0)), A::sub_from_scalar(1.0, s.ad_value(124)));s.store_mul_scale_offset_indices(136, 116, 121, -1.0, 1.0);s.store_div_mixed_ai(127, A::mul_sub_from_scalar_rhs(s.ad_value(46), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 132);s.store_div_mixed_ai(128, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(130), s.ad_value(133)))), 133);s.store_div_mixed_ai(129, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(133)))), 133);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_30(
        ...
        if ((!s.b[478]) && s.b[482]) {s.store_mul_scale_offset_mixed_ia(137, 47, A::exp_scaled_input(A::ln(s.ad_value(48)), (-1.0 / (p[59]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 208, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));s.store_div(144, 143, 142);s.store_ln_ad(139, A::sub_from_scalar(1.0, A::div(s.ad_value(138), s.ad_value(47))));s.store_mul_mixed_ai(145, A::exp_scaled_input(s.ad_value(139), (-p[59])), 144);s.store_mul_sub_from_scalar_scaled_rhs_scaled_output_mixed_ia(140, 47, 1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p[59])), 1.0, 1.0 / ((1.0 - p[59])));s.store_mul_add_scaled_product_rhs_mixed_iia(196, 46, 140, 1.0, 48, A::sub(s.ad_value(208), s.ad_value(138)), 1.0);}
        if ((!s.b[478]) && (!s.b[482])) {s.store_scalar(196, 0.0);}
        s.b[483] = (p[63] > 0.0);s.store_scalar(483, if s.b[483] { 1.0 } else { 0.0 });s.b[484] = (p[65] < 100.0);s.store_scalar(484, if s.b[484] { 1.0 } else { 0.0 });s.b[485] = (s.v[49] > 0.0);s.store_scalar(485, if s.b[485] { 1.0 } else { 0.0 });
        if ((s.b[483] && s.b[484]) && s.b[485]) {s.store_scalar(113, (p[64] / 4.0));s.store_sub_from_scalar(114, p[65], 50);s.store_mul_scale_offset_mixed_ia(115, 50, A::exp_scaled_input(A::ln(s.ad_value(51)), (-1.0 / (p[64]))), -1.0, 1.0);s.store_mul(116, 51, 49);s.store_mul_exp_mixed_ia(117, 49, A::mul_offset_lhs(s.ad_value(113), (-p[64]), A::ln(A::div_from_scalar(p[65], s.ad_value(50)))));s.store_mul_sub_lhs(119, 115, 209, 5);}
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if ((s.b[483] && s.b[484]) && s.b[485]) {s.store_ln_ad(131, A::sub_from_scalar(1.0, A::div(s.ad_value(125), s.ad_value(50))));s.store_scalar(132, (1.0 - p[64]));s.store_primal_sub_from_scalar(133, 1.0, 113);s.store_mul_product3_mixed_iiai(134, 124, 49, A::exp_scaled_input(s.ad_value(131), (-p[64])), 121, 1.0);s.store_mul_ad_product_rhs(135, 117, A::exp(A::mul_scaled_rhs(s.ad_value(130), s.ad_value(113), -1.0)), A::sub_from_scalar(1.0, s.ad_value(124)));s.store_mul_scale_offset_indices(136, 116, 121, -1.0, 1.0);s.store_div_mixed_ai(127, A::mul_sub_from_scalar_rhs(s.ad_value(49), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 132);s.store_div_mixed_ai(128, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(130), s.ad_value(133)))), 133);s.store_div_mixed_ai(129, A::mul_sub_from_scalar_rhs(s.ad_value(117), 1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(133)))), 133);s.store_add_scaled_products_mixed_aiii(197, A::add_scaled_inputs3(s.ad_value(127), 1.0, s.ad_value(128), 1.0, s.ad_value(129), -1.0), 50, 1.0, 116, 126, 1.0);}
        if ((s.b[483] && s.b[484]) && (!s.b[485])) {s.store_scalar(197, 0.0);}
        s.b[488] = (s.v[49] > 0.0);s.store_scalar(488, if s.b[488] { 1.0 } else { 0.0 });
        if ((s.b[483] && (!s.b[484])) && s.b[488]) {s.store_mul_scale_offset_mixed_ia(137, 50, A::exp_scaled_input(A::ln(s.ad_value(51)), (-1.0 / (p[64]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 209, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));s.store_div(144, 143, 142);s.store_ln_ad(139, A::sub_from_scalar(1.0, A::div(s.ad_value(138), s.ad_value(50))));s.store_mul_mixed_ai(145, A::exp_scaled_input(s.ad_value(139), (-p[64])), 144);s.store_mul_sub_from_scalar_scaled_rhs_scaled_output_mixed_ia(140, 50, 1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p[64])), 1.0, 1.0 / ((1.0 - p[64])));s.store_mul_add_scaled_product_rhs_mixed_iia(197, 49, 140, 1.0, 51, A::sub(s.ad_value(209), s.ad_value(138)), 1.0);}
        if ((s.b[483] && (!s.b[484])) && (!s.b[488])) {s.store_scalar(197, 0.0);}
        if (!s.b[483]) {s.store_scale(197, 209, p[62]);}
        s.b[489] = (p[97] > 0.0);s.store_scalar(489, if s.b[489] { 1.0 } else { 0.0 });
        if s.b[489] {s.store_scale(490, 4, p[98]);s.store_limexp_div(491, 206, 490);s.store_limexp_div(492, 208, 490);s.store_mul_sub_rhs(198, 44, 491, 492);}
        s.b[493] = (p[101] > 0.0);s.store_scalar(493, if s.b[493] { 1.0 } else { 0.0 });
        ...
        s.b[494] = (p[99] > 0.0);s.store_scalar(494, if s.b[494] { 1.0 } else { 0.0 });
        if s.b[494] {s.store_div_scaled_inputs_indices(93, 208, 1.0, 4, p[100]);}
