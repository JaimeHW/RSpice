...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if s.b[447] {s.store_scale(449, 16, (1.0 + p[92]));s.store_add_scaled_inputs3_indices(451, 179, 1.0, 178, 1.0, 355, 1.0);s.store_offset_div(448, 451, 449, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(452, 448, 448, 0.01, 0.5);s.store_div(70, 69, 452);}
