...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        s.b[508] = ((p[89] >= p[149]) && (p[89] > 0.0));s.store_scalar(508, if s.b[508] { 1.0 } else { 0.0 });s.b[509] = (p[93] > 0.0);s.store_scalar(509, if s.b[509] { 1.0 } else { 0.0 });s.b[510] = (p[29] == 1.0);s.store_scalar(510, if s.b[510] { 1.0 } else { 0.0 });s.b[511] = ((p[90] >= p[149]) && (p[90] > 0.0));s.store_scalar(511, if s.b[511] { 1.0 } else { 0.0 });s.b[512] = ((p[95] >= p[149]) && (p[95] > 0.0));s.store_scalar(512, if s.b[512] { 1.0 } else { 0.0 });s.b[513] = ((p[96] >= p[149]) && (p[96] > 0.0));s.store_scalar(513, if s.b[513] { 1.0 } else { 0.0 });s.b[514] = (p[0] >= 320.0);s.store_scalar(514, if s.b[514] { 1.0 } else { 0.0 });s.b[515] = (p[99] > 0.0);s.store_scalar(515, if s.b[515] { 1.0 } else { 0.0 });s.b[516] = (p[0] >= 310.0);s.store_scalar(516, if s.b[516] { 1.0 } else { 0.0 });s.b[517] = ((p[102] >= p[149]) && (p[102] > 0.0));s.store_scalar(517, if s.b[517] { 1.0 } else { 0.0 });s.b[518] = (p[103] > 0.0);s.store_scalar(518, if s.b[518] { 1.0 } else { 0.0 });s.b[519] = (((p[141] >= 1.0) && (p[142] >= p[149])) && (p[142] > 0.0));s.store_scalar(519, if s.b[519] { 1.0 } else { 0.0 });s.b[520] = (p[145] > 0.0);s.store_scalar(520, if s.b[520] { 1.0 } else { 0.0 });s.b[525] = ((p[90] >= p[149]) && (p[90] > 0.0));s.store_scalar(525, if s.b[525] { 1.0 } else { 0.0 });s.b[526] = ((p[89] >= p[149]) && (p[89] > 0.0));s.store_scalar(526, if s.b[526] { 1.0 } else { 0.0 });s.b[527] = ((p[96] >= p[149]) && (p[96] > 0.0));s.store_scalar(527, if s.b[527] { 1.0 } else { 0.0 });s.b[528] = ((p[95] >= p[149]) && (p[95] > 0.0));s.store_scalar(528, if s.b[528] { 1.0 } else { 0.0 });s.b[529] = ((p[102] >= p[149]) && (p[102] > 0.0));s.store_scalar(529, if s.b[529] { 1.0 } else { 0.0 });s.b[530] = (p[112] == (-1.0));s.store_scalar(530, if s.b[530] { 1.0 } else { 0.0 });s.b[531] = ((p[95] >= p[149]) && (p[95] > 0.0));s.store_scalar(531, if s.b[531] { 1.0 } else { 0.0 });s.b[532] = (p[0] >= 320.0);s.store_scalar(532, if s.b[532] { 1.0 } else { 0.0 });s.b[533] = ((p[109] == 1.0) && ((p[88] > 0.0) && (p[87] > 0.0)));s.store_scalar(533, if s.b[533] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_34(
        ...
        s.b[539] = (s.v[185] > 0.0);s.store_scalar(539, if s.b[539] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_0(
        ...
        s.store_scalar(174, (p[105] * p[104]));s.store_scalar(173, (p[104] - s.v[174]));s.b[282] = (p[0] <= 300.0);s.store_scalar(282, if s.b[282] { 1.0 } else { 0.0 });
        if s.b[282] {s.store_scalar(223, 0.0);}
        if (!s.b[282]) {s.store_scalar(223, 0.7);}
        s.store_scalar(234, p[86]);s.b[284] = (p[86] != 0.0);s.store_scalar(284, if s.b[284] { 1.0 } else { 0.0 });s.b[285] = (((p[88] == 0.0) && (p[87] == 0.0)) || (p[66] == 0.0));s.store_scalar(285, if s.b[285] { 1.0 } else { 0.0 });
        if (s.b[284] && s.b[285]) {s.store_scalar(234, 0.0);}
        s.b[286] = ((p[115] >= 0.01) || (p[116] >= 0.01));s.store_scalar(286, if s.b[286] { 1.0 } else { 0.0 });
        if s.b[286] {s.store_scalar(232, (0.5 * (p[115] - p[116])));}
        s.b[287] = (p[116] < p[115]);s.store_scalar(287, if s.b[287] { 1.0 } else { 0.0 });
        if (s.b[286] && s.b[287]) {s.store_scalar(229, p[116]);s.store_scalar(230, p[115]);}
        if (s.b[286] && (!s.b[287])) {s.store_scalar(229, p[115]);s.store_scalar(230, p[116]);}
        ...
        if (!s.b[286]) {s.store_scalar(232, 0.0);s.store_scalar(225, 1000000000.0);s.store_scalar(226, 1000000000.0);s.store_scalar(227, 170000000.0);s.store_scalar(228, 170000000.0);s.store_scalar(229, p[116]);s.store_scalar(230, p[115]);s.store_scalar(231, 0.0);}
    ...
    pub(super) fn stamp_reactive_block_1(
        ...
        s.store_scaled_exp_ad(22, A::add_scaled_inputs(s.ad_value(13), p[124], A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p[118]), 1.0), p[14]);s.b[293] = (p[47] > 0.0);s.store_scalar(293, if s.b[293] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_2(
        ...
        s.store_add_scaled_product_mixed_aii(59, A::scale_offset(s.ad_value(14), p[128], 1.0), p[66], 14, 14, (p[129] * p[66]));s.store_scalar(61, p[69]);s.store_scaled_exp_scaled_input(60, 13, (p[130] - 1.0), p[71]);s.b[299] = ((p[37] > 0.0) && (s.v[203] < 0.0));s.store_scalar(299, if s.b[299] { 1.0 } else { 0.0 });
        if s.b[299] {s.store_scalar(67, p[37]);}
        s.b[300] = ((p[47] > 0.0) && (p[48] > 0.0));s.store_scalar(300, if s.b[300] { 1.0 } else { 0.0 });
        if (s.b[299] && s.b[300]) {s.store_div_from_scalar(169, s.v[92], 87);s.store_scale(170, 34, 1.0 / (p[48]));s.store_mul_ad_affine_product_lhs(168, A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p[47]), 0.0, 33);s.store_scaled_mul(67, 168, 170, p[37]);}
        if (!s.b[299]) {s.store_scalar(67, 0.0);}
        s.b[301] = (p[43] > 0.0);s.store_scalar(301, if s.b[301] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        if s.b[301] {s.store_scale_ad(29, A::exp_scaled_input(A::ln(A::div_from_scalar(p[44], s.ad_value(30))), p[45]), p[43]);s.store_scalar(31, ((p[46]) as f64).abs());}
        ...
        s.b[303] = ((p[27] > 0.0) && ((s.v[205] < s.v[223]) || (s.v[202] < s.v[223])));s.store_scalar(303, if s.b[303] { 1.0 } else { 0.0 });
        ...
        s.store_mul(37, 43, 176);s.store_mul(38, 43, 177);s.b[309] = (p[0] <= 300.0);s.store_scalar(309, if s.b[309] { 1.0 } else { 0.0 });s.b[310] = (p[57] > 0.0);s.store_scalar(310, if s.b[310] { 1.0 } else { 0.0 });
        if (s.b[309] && s.b[310]) {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p[58] * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p[58]))));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_4(
        ...
        s.store_scaled_exp_ad(44, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p[119]), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p[97]);s.store_scaled_exp_scaled_input(52, 13, (p[138] - 1.0), p[101]);s.b[314] = (p[63] > 0.0);s.store_scalar(314, if s.b[314] { 1.0 } else { 0.0 });s.b[315] = (p[62] > 0.0);s.store_scalar(315, if s.b[315] { 1.0 } else { 0.0 });
        if (s.b[314] && s.b[315]) {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p[63] * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p[63]))));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_5(
        ...
        s.b[317] = (((p[141] != 0.0) && (p[142] >= p[149])) && (p[142] > 0.0));s.store_scalar(317, if s.b[317] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_6(
        ...
        if s.b[317] {s.store_scaled_exp_ad(22, A::add_scaled_inputs(s.ad_value(13), p[124], A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p[118]), 1.0), p[14]);}
    ...
    pub(super) fn stamp_reactive_block_7(
        ...
        if (s.b[317] && s.b[328]) {s.store_scalar(67, p[37]);}
        s.b[329] = ((p[47] > 0.0) && (p[48] > 0.0));s.store_scalar(329, if s.b[329] { 1.0 } else { 0.0 });
        if ((s.b[317] && s.b[328]) && s.b[329]) {s.store_div_from_scalar(169, s.v[92], 87);s.store_scale(170, 34, 1.0 / (p[48]));s.store_mul_ad_affine_product_lhs(168, A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p[47]), 0.0, 33);s.store_scaled_mul(67, 168, 170, p[37]);}
    ...
    pub(super) fn stamp_reactive_block_9(
        ...
        if s.b[317] {s.store_scaled_exp_ad(44, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p[119]), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p[97]);s.store_scaled_exp_scaled_input(52, 13, (p[138] - 1.0), p[101]);}
    ...
    pub(super) fn stamp_reactive_block_11(
        ...
        if s.b[374] {s.store_scale(375, 4, p[11]);s.store_div_scaled_inputs2_indices(376, 27, 1.0, 202, (-1.0), 375, 1.0);s.store_add_scaled_product_mixed_iia(377, 27, 1.0, 375, A::add(s.ad_value(376), A::sqrt_square_offset(s.ad_value(376), 1.921812)), (-0.5));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_12(
        ...
        if s.b[374] {s.store_mul_scale_offset_mixed_ia(378, 18, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(377), s.ad_value(27)))), p[41]), -1.0, 1.0);}
        ...
        if (!s.b[394]) {s.store_div(387, 363, 3);s.store_mul_add_scaled_inputs_rhs_mixed_ia(388, 3, 387, 0.5, A::sqrt_square_offset(s.ad_value(387), p[80]), 0.5);}
