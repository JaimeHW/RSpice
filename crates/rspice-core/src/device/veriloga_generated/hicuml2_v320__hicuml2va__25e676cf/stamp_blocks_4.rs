...
impl Instance {
    ...
    if ((var_guard233 != 0.0) && (var_guard234 != 0.0)) {
        let eq7_e204_q: f64 = var_qrbi;
        (var_qrbi, var_qrbi_dn0, var_qrbi_dn1, var_qrbi_dn3, var_qrbi_dn4, var_qrbi_dn5, var_qrbi_dn6, var_qrbi_dn7, var_qrbi_dn8, var_qrbi_dn9, eq7_e204_q,)
    } else {
    ...
    if (var_guard258 != 0.0) {
        ...
        let eq65_e532_d_n13: f64 = (eq65_e527 * var_n_w);
    ...
    if (var_guard258 != 0.0) {
        ...
        let eq66_e543_d_n14: f64 = (eq66_e538 * var_n_w);
