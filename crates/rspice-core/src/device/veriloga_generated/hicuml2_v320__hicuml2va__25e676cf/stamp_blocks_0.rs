...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        if s.b[291] {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[77], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(27, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
        ...
        s.store_scaled_exp_ad(22, A::add_scaled_product(s.ad_value(13), p.p124, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p118), p.p14);

        s.store_scaled_exp_ad(24, A::add_scaled_products(s.ad_value(76), s.ad_value(13), 1.0 / (p.p17), s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), (s.v[77] * 1.0 / (p.p17))), p.p16);
        ...
        if s.b[293] {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[78], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(34, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
        ...
        s.store_scaled_exp_ad(32, A::add_scaled_products(s.ad_value(80), s.ad_value(13), 1.0, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p119), p.p23);

        s.store_scaled_sub_from_scalar_ad(16, 2.0, A::exp_scaled_input(A::ln_scaled_input(s.ad_value(27), 1.0 / (p.p40)), p.p41), p.p2);

        s.store_scaled_exp_ad(15, A::add_scaled_product(s.ad_value(13), p.p123, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p117), p.p1);
        ...
        s.store_scaled_exp_ad(19, A::mul_scaled_lhs(s.ad_value(7), p.p125, A::sub_from_scalar(1.0, s.ad_value(12))), p.p3);

        s.store_scaled_exp_ad(20, A::mul_scaled_lhs(s.ad_value(7), (p.p117 - p.p118), A::sub_from_scalar(1.0, s.ad_value(12))), p.p4);

        s.store_scaled_exp_ad(21, A::mul_scaled_lhs(s.ad_value(7), (p.p117 - p.p119), A::sub_from_scalar(1.0, s.ad_value(12))), p.p6);
        ...
        if s.b[297] {
            s.store_scaled_sub_from_scalar_ad(58, 1.0, A::scale(s.ad_value(14), p.p133), p.p79);
        ...
        s.store_ad_value(59, A::add_scaled_product(A::scale_offset(s.ad_value(14), p.p128, 1.0), p.p66, s.ad_value(14), s.ad_value(14), (p.p129 * p.p66)));
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[301] {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[77], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(30, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
        ...
        s.store_scaled_exp_ad(23, A::add_scaled_product(s.ad_value(13), p.p124, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p118), p.p18);

        s.store_scaled_exp_ad(25, A::add_scaled_products(s.ad_value(76), s.ad_value(13), 1.0 / (p.p21), s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), (s.v[77] * 1.0 / (p.p21))), p.p20);
        ...
        if (s.b[303] && s.b[304]) {
            ...
            s.store_mul_ad_lhs(167, A::mul3_scaled_output(s.ad_value(29), A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p.p43)), 170);
            s.store_ad_value(166, A::div_scaled_product(A::div_from_scalar(p.p43, s.ad_value(29)), A::powf(s.ad_value(169), (-1.5)), 1.0, s.ad_value(170), 1.0));
        }
        ...
        if ((s.b[303] && (!s.b[304])) && s.b[305]) {
            ...
            s.store_mul_ad_lhs(167, A::mul3_scaled_output(s.ad_value(26), A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p.p39)), 170);
            s.store_ad_value(166, A::div_scaled_product(A::div_from_scalar(p.p39, s.ad_value(26)), A::powf(s.ad_value(169), (-1.5)), 1.0, s.ad_value(170), 1.0));
        }
        ...
        if s.b[306] {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[78], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(39, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
            s.store_ad_value(43, A::exp_scaled_input(A::ln(A::div_from_scalar(p.p53, s.ad_value(39))), p.p54));
        ...
        s.store_scaled_exp_ad(36, A::add_scaled_products(s.ad_value(81), s.ad_value(13), 1.0, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p119), p.p25);
        ...
        if (s.b[309] && s.b[310]) {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[79], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(47, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
        ...
        s.store_scaled_exp_ad(45, A::add_scaled_products(s.ad_value(82), s.ad_value(13), 1.0, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p120), p.p99);

        s.store_scaled_exp_ad(44, A::add_scaled_products(s.ad_value(82), s.ad_value(13), 1.0, s.ad_value(7), A::sub_from_scalar(1.0, s.ad_value(12)), p.p119), p.p97);
        ...
        if (s.b[314] && s.b[315]) {
            ...
            s.store_sub_ad(165, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(11)), s.v[79], s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));
            s.store_ad_value(50, A::add_scaled_product(s.ad_value(165), 1.0, s.ad_value(4), A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0));
            s.store_scale_ad(49, A::exp_scaled_input(A::ln(A::div_from_scalar(p.p63, s.ad_value(50))), p.p64), p.p62);
            s.store_ad_value(51, A::abs_scaled_input(s.ad_value(163), -1.0));
        }
        ...
        s.store_scaled_mul_ad(201, A::exp_scaled_input(s.ad_value(13), p.p143), A::scale_offset(s.ad_value(14), p.p144, 1.0), p.p142);
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        if s.b[364] {
            s.store_scaled_div(93, 202, 4, (1.0 / (p.p15)));
        }
        ...
        if s.b[364] {
            s.store_mul_ad_affine_product_rhs(185, 22, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if s.b[366] {
            s.store_scaled_div(93, 202, 4, (1.0 / (p.p17)));
        }
        ...
        if s.b[366] {
            s.store_mul_ad_affine_product_rhs(186, 24, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if s.b[368] {
            ...
            s.store_mul_ad_rhs(211, 26, A::add_scaled_product(s.ad_value(145), 1.0, s.ad_value(28), A::sub_from_scalar(1.0, s.ad_value(144)), 1.0));
            s.store_mul_scaled_ad_rhs(140, 27, 1.0 / ((1.0 - p.p41)), A::sub_from_scalar(1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p.p41))));
            s.store_mul_ad_rhs(179, 26, A::add_scaled_product(s.ad_value(140), 1.0, s.ad_value(28), A::sub(s.ad_value(202), s.ad_value(138)), 1.0));
        }
        ...
        if (s.b[369] && s.b[370]) {
            ...
            s.store_mul_exp_ad_rhs(117, 33, A::mul(A::offset(s.ad_value(113), (-p.p49)), A::ln(A::div_from_scalar(p.p51, s.ad_value(34)))));
        ...
        if (s.b[369] && s.b[370]) {
            ...
            s.store_mul_ad_lhs(134, A::mul3(s.ad_value(33), A::exp_scaled_input(s.ad_value(131), (-p.p49)), s.ad_value(121)), 124);
            ...
            s.store_ad_value(210, A::add_scaled_inputs3(s.ad_value(134), 1.0, s.ad_value(135), 1.0, s.ad_value(136), 1.0));
            s.store_ad_value(127, A::div_scaled_product(s.ad_value(33), A::sub_from_scalar(1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 1.0, s.ad_value(132), 1.0));
            ...
            s.store_ad_value(178, A::add_scaled_products(A::add_scaled_inputs3(s.ad_value(127), 1.0, s.ad_value(128), 1.0, s.ad_value(129), -1.0), s.ad_value(34), 1.0, s.ad_value(116), s.ad_value(126), 1.0));
        }
        ...
        if ((!s.b[369]) && s.b[373]) {
            ...
            s.store_mul_ad_rhs(210, 33, A::add_scaled_product(s.ad_value(145), 1.0, s.ad_value(35), A::sub_from_scalar(1.0, s.ad_value(144)), 1.0));
            s.store_mul_scaled_ad_rhs(140, 34, 1.0 / ((1.0 - p.p49)), A::sub_from_scalar(1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p.p49))));
            s.store_mul_ad_rhs(178, 33, A::add_scaled_product(s.ad_value(140), 1.0, s.ad_value(35), A::sub(s.ad_value(203), s.ad_value(138)), 1.0));
        }
        ...
        if s.b[374] {
            ...
            s.store_ad_value(377, A::add_scaled_product(s.ad_value(27), 1.0, s.ad_value(375), A::add(s.ad_value(376), A::sqrt(A::offset(A::square(s.ad_value(376)), 1.921812))), (-0.5)));
        ...
        if (s.b[374] && s.b[379]) {
            s.store_ad_value(346, A::div_scaled_product(s.ad_value(17), A::offset(A::exp(s.ad_value(378)), (-1.0)), 1.0, s.ad_value(378), 1.0));
        }
        ...
        s.store_ad_value(384, A::add_scaled_product(s.ad_value(380), 1.0, s.ad_value(4), s.ad_value(383), (-1.0)));

        s.store_div(385, 383, 382);

        s.store_ad_value(361, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(385)), 2.4, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(384), s.ad_value(34)))), (-p.p49)), s.ad_value(385), 1.0));

        s.store_ad_value(357, A::add_scaled_inputs3(s.ad_value(59), 1.0, A::scaled_offset(A::div_from_scalar(1.0, s.ad_value(361)), (-1.0), p.p67), 1.0, A::scaled_offset(s.ad_value(361), (-1.0), p.p68), 1.0));
        ...
        if s.b[394] {
            ...
            s.store_ad_value(388, A::add_scaled_product(s.ad_value(4), 1.0, s.ad_value(4), A::add(s.ad_value(387), A::sqrt(A::offset(A::square(s.ad_value(387)), 1.921812))), 0.5));
        }
        ...
        s.store_ad_value(391, A::exp_scaled_input(A::ln_one_plus_exp(A::scale(A::ln(s.ad_value(389)), p.p77)), 1.0 / (p.p77)));
        ...
        if (s.b[395] && s.b[397]) {
            s.store_add_ad_rhs(348, 396, A::sqrt(A::add_scaled_inputs(A::add_scaled_product(A::square(s.ad_value(396)), 1.0, s.ad_value(357), s.ad_value(350), 1.0), 1.0, s.ad_value(351), p.p85)));
        }
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if (s.b[399] && (!s.b[400])) {
            s.store_ad_value(112, A::div_scaled_inputs(s.ad_value(111), 2.0, A::mul_scaled_lhs(s.ad_value(95), p.p83, A::add(s.ad_value(107), s.ad_value(95))), 1.0));
        }
        ...
        if s.b[399] {
            ...
            s.store_scaled_add_ad_rhs(109, 108, A::sqrt(A::offset(A::square(s.ad_value(108)), p.p72)), 1.0 / ((1.0 + (((1.0 + p.p72)) as f64).sqrt())));
            s.store_exp_ad(110, A::mul(A::offset(s.ad_value(111), (-p.p82)), s.ad_value(5)));
            s.store_mul_ad_lhs(101, A::mul3(s.ad_value(60), s.ad_value(109), s.ad_value(109)), 110);
        ...
        if (s.b[399] && (!s.b[402])) {
            ...
            s.store_ad_value(147, A::div_scaled_product(A::offset(s.ad_value(146), (-1.0)), A::sub_from_scalar(1.0, s.ad_value(108)), 1.0, A::mul(A::sqrt(A::offset(A::square(s.ad_value(108)), p.p72)), s.ad_value(217)), 1.0));
        }
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && s.b[404]) {
            ...
            s.store_div_ad_lhs(154, A::div(A::sub_scaled_inputs(A::mul3(s.ad_value(230), s.ad_value(149), A::offset(A::mul_scaled_lhs(s.ad_value(230), 0.25, s.ad_value(149)), 0.5)), 2.0, A::ln(s.ad_value(148)), (0.5 * 2.0)), s.ad_value(230)), 230);
            s.store_ad_value(150, A::div_scaled_product(s.ad_value(231), s.ad_value(147), -1.0, A::mul(s.ad_value(151), s.ad_value(230)), 1.0));
            s.store_ad_value(155, A::div_scaled_product3(A::offset(s.ad_value(148), 1.0), s.ad_value(149), s.ad_value(150), 1.0, s.ad_value(148), 1.0));
        }
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && (!s.b[404])) {
            ...
            s.store_ad_value(157, A::add_scaled_product(A::mul3(s.ad_value(161), A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(226)), 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(227), s.ad_value(149), 1.0), s.ad_value(149), 1.0));
            s.store_ad_value(159, A::add_scaled_product(A::add(A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), s.ad_value(162)), 1.0, s.ad_value(149), s.ad_value(227), 2.0));
            s.store_offset_scaled(160, 149, p.p115, 1.0);
            s.store_ln(161, 160);
            s.store_mul(162, 228, 225);
            s.store_ad_value(156, A::add_scaled_product(A::mul3(s.ad_value(161), A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(225)), 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(228), s.ad_value(149), 1.0), s.ad_value(149), 1.0));
            s.store_ad_value(158, A::add_scaled_product(A::add(A::div(A::sub_from_scalar(0.5, s.ad_value(162)), s.ad_value(160)), s.ad_value(162)), 1.0, s.ad_value(149), s.ad_value(228), 2.0));
            s.store_div_ad_lhs(154, A::sub(s.ad_value(157), s.ad_value(156)), 232);
            s.store_mul_ad_lhs(150, A::mul3(A::div_scaled_inputs(s.ad_value(232), (-2.0), A::square(s.ad_value(152)), 1.0), s.ad_value(151), s.ad_value(231)), 147);
            s.store_ad_value(155, A::div_scaled_product(A::sub(s.ad_value(159), s.ad_value(158)), s.ad_value(150), 1.0, s.ad_value(232), 1.0));
        }
        ...
        if ((s.b[399] && (!s.b[402])) && (!s.b[403])) {
            ...
            s.store_ad_value(154, A::div_scaled_product(A::square(s.ad_value(149)), A::offset(A::mul_scaled_lhs(s.ad_value(227), 2.0, s.ad_value(149)), 1.0), 1.0, s.ad_value(153), 1.0));
            s.store_ad_value(150, A::div_scaled_product(s.ad_value(147), s.ad_value(153), -1.0, A::scale_offset(s.ad_value(146), p.p115, 1.0), 1.0));
        ...
        if (s.b[399] && (!s.b[402])) {
            ...
            s.store_ad_value(106, A::add_scaled_inputs3(s.ad_value(167), 1.0, A::mul3(s.ad_value(105), s.ad_value(112), s.ad_value(5)), 1.0, A::mul3(s.ad_value(166), s.ad_value(217), s.ad_value(155)), 1.0));
        }

        if s.b[399] {
            s.store_scaled_mul(103, 101, 217, (1.0 - p.p73));
            s.store_scale(104, 102, (1.0 - p.p73));
            s.store_ad_value(354, A::add_scaled_product(s.ad_value(103), 1.0, s.ad_value(99), s.ad_value(217), 1.0));
        }
        ...
        if (s.b[399] && s.b[405]) {
            s.store_add_ad_lhs(355, A::add_scaled_inputs3(s.ad_value(355), 1.0, s.ad_value(354), 1.0, s.ad_value(97), 1.0), 105);
            s.store_ad_value(219, A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(219), 1.0, s.ad_value(100), 1.0, s.ad_value(104), 1.0), 1.0, s.ad_value(98), 1.0, s.ad_value(106), 1.0));
            s.store_ad_value(358, A::add_scaled_product(A::add_scaled_product(A::add_scaled_inputs(s.ad_value(358), 1.0, s.ad_value(354), p.p5), 1.0, s.ad_value(20), s.ad_value(97), 1.0), 1.0, s.ad_value(21), s.ad_value(105), 1.0));
            s.store_ad_value(359, A::add_scaled_product(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(359), 1.0, s.ad_value(100), p.p5, s.ad_value(104), p.p5), 1.0, s.ad_value(20), s.ad_value(98), 1.0), 1.0, s.ad_value(21), s.ad_value(106), 1.0));
        }

        if (s.b[399] && (!s.b[405])) {
            s.store_ad_value(358, A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(s.ad_value(354), 1.0, s.ad_value(19), s.ad_value(355), 1.0), 1.0, s.ad_value(20), s.ad_value(97), 1.0), 1.0, s.ad_value(21), s.ad_value(105), 1.0));
            s.store_add_ad_lhs(355, A::add_scaled_inputs3(s.ad_value(355), 1.0, s.ad_value(354), 1.0, s.ad_value(97), 1.0), 105);
            s.store_ad_value(359, A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(A::add(s.ad_value(100), s.ad_value(104)), 1.0, s.ad_value(19), s.ad_value(219), 1.0), 1.0, s.ad_value(20), s.ad_value(98), 1.0), 1.0, s.ad_value(21), s.ad_value(106), 1.0));
            s.store_ad_value(219, A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(219), 1.0, s.ad_value(100), 1.0, s.ad_value(104), 1.0), 1.0, s.ad_value(98), 1.0, s.ad_value(106), 1.0));
        }
        ...
        if s.b[406] {
            ...
            s.store_ad_value(348, A::add_scaled_inputs3(s.ad_value(352), 1.0, s.ad_value(355), 1.0, s.ad_value(356), p.p7));
            s.copy_ad(349, 348);
        }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        while {
            ...
            if s.b[406] {
                ...
                s.store_ad_value(349, A::div_scaled_inputs(A::sub(s.ad_value(348), A::add_scaled_inputs3(s.ad_value(352), 1.0, s.ad_value(358), 1.0, s.ad_value(360), 1.0)), -1.0, A::offset(A::div(A::add_scaled_product(s.ad_value(360), 1.0, s.ad_value(359), s.ad_value(217), 1.0), s.ad_value(348)), 1.0), 1.0));
                s.store_ad_value(407, A::abs_scaled_input(s.ad_value(348), 0.3));
            }
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.store_scaled_add_ad_lhs(222, A::add_scaled_inputs3(s.ad_value(211), 1.0, s.ad_value(210), 1.0, s.ad_value(220), 1.0), 221, p.p93);
        ...
        if s.b[426] {
            s.store_scaled_div(93, 203, 4, (1.0 / (p.p24)));
        }
        ...
        if s.b[426] {
            s.store_mul_ad_affine_product_rhs(187, 32, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if (s.b[428] && s.b[429]) {
            s.store_ad_value(168, A::exp_scaled_input(A::ln(A::div(s.ad_value(210), s.ad_value(33))), ((1.0 / p.p49) - 1.0)));
            s.store_ad_value(166, A::div_scaled_product(s.ad_value(67), s.ad_value(203), -1.0, A::mul(s.ad_value(34), s.ad_value(168)), 1.0));
        ...
        if ((s.b[430] && s.b[437]) && s.b[438]) {
            ...
            s.store_ad_value(439, A::add_scaled_product(s.ad_value(217), p.p36, s.ad_value(55), s.ad_value(54), p.p35));
        ...
        if ((s.b[430] && s.b[437]) && s.b[443]) {
            ...
            s.store_ad_value(244, A::div_scaled_product(s.ad_value(217), s.ad_value(435), 1.0, s.ad_value(446), 1.0));
        }
        ...
        if s.b[447] {
            ...
            s.store_ad_value(451, A::add_scaled_inputs3(s.ad_value(179), 1.0, s.ad_value(178), 1.0, s.ad_value(355), 1.0));
            s.store_offset_div(448, 451, 449, 1.0);
            s.store_scaled_add_ad_rhs(452, 448, A::sqrt(A::offset(A::square(s.ad_value(448)), 0.01)), 0.5);
        ...
        if ((s.b[447] && s.b[453]) && (!s.b[454])) {
            s.store_ad_value(70, A::div_scaled_product(s.ad_value(70), A::ln(A::offset(s.ad_value(450), 1.0)), 1.0, s.ad_value(450), 1.0));
        }
        ...
        if (s.b[447] && s.b[455]) {
            s.store_ad_value(70, A::div_scaled_product(s.ad_value(70), A::add_scaled_inputs(s.ad_value(179), 1.0, s.ad_value(355), p.p94), 1.0, A::add(s.ad_value(179), s.ad_value(355)), 1.0));
        }
        ...
        if s.b[456] {
            s.store_scaled_div(93, 205, 4, (1.0 / (p.p19)));
        }
        ...
        if s.b[456] {
            s.store_mul_ad_affine_product_rhs(188, 23, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if s.b[458] {
            s.store_scaled_div(93, 205, 4, (1.0 / (p.p21)));
        }
        ...
        if s.b[458] {
            s.store_mul_ad_affine_product_rhs(189, 25, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if s.b[460] {
            ...
            s.store_mul_ad_rhs(212, 29, A::add_scaled_product(s.ad_value(145), 1.0, s.ad_value(31), A::sub_from_scalar(1.0, s.ad_value(144)), 1.0));
            s.store_mul_scaled_ad_rhs(140, 30, 1.0 / ((1.0 - p.p45)), A::sub_from_scalar(1.0, A::exp_scaled_input(s.ad_value(139), (1.0 - p.p45))));
            s.store_mul_ad_rhs(180, 29, A::add_scaled_product(s.ad_value(140), 1.0, s.ad_value(31), A::sub(s.ad_value(205), s.ad_value(138)), 1.0));
        }
        ...
        if (s.b[461] && s.b[464]) {
            s.store_ad_value(462, A::exp_scaled_input(A::ln(A::div(s.ad_value(212), s.ad_value(29))), (1.0 - (1.0 / p.p45))));
        ...
        if ((s.b[461] && (!s.b[464])) && s.b[465]) {
            s.store_ad_value(462, A::exp_scaled_input(A::ln(A::div(s.ad_value(211), s.ad_value(26))), (1.0 - (1.0 / p.p41))));
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if (s.b[466] && s.b[467]) {
            ...
            s.store_mul_exp_ad_rhs(117, 38, A::mul(A::offset(s.ad_value(113), (-p.p54)), A::ln(A::div_from_scalar(p.p56, s.ad_value(39)))));
        ...
        if (s.b[466] && s.b[467]) {
            ...
            s.store_sub_from_scalar(133, 1.0, 113);
            s.store_mul_ad_lhs(134, A::mul3(s.ad_value(38), A::exp_scaled_input(s.ad_value(131), (-p.p54)), s.ad_value(121)), 124);
            s.store_mul_ad_product_rhs(135, 117, A::exp(A::mul_scaled_rhs(s.ad_value(130), s.ad_value(113), -1.0)), A::sub_from_scalar(1.0, s.ad_value(124)));
            s.store_mul_sub_from_scalar_rhs(136, 116, 1.0, 121);
            s.store_ad_value(127, A::div_scaled_product(s.ad_value(38), A::sub_from_scalar(1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(132)))), 1.0, s.ad_value(132), 1.0));
            s.store_ad_value(128, A::div_scaled_product(s.ad_value(117), A::sub_from_scalar(1.0, A::exp(A::mul(s.ad_value(130), s.ad_value(133)))), 1.0, s.ad_value(133), 1.0));
            s.store_ad_value(129, A::div_scaled_product(s.ad_value(117), A::sub_from_scalar(1.0, A::exp(A::mul(s.ad_value(131), s.ad_value(133)))), 1.0, s.ad_value(133), 1.0));
            s.store_ad_value(42, A::add_scaled_products(A::add_scaled_inputs3(s.ad_value(127), 1.0, s.ad_value(128), 1.0, s.ad_value(129), -1.0), s.ad_value(39), 1.0, s.ad_value(116), s.ad_value(126), 1.0));
        }
        ...
        if ((!s.b[466]) && s.b[470]) {
            ...
            s.store_mul_ad_rhs(42, 38, A::add_scaled_product(s.ad_value(140), 1.0, s.ad_value(40), A::sub(s.ad_value(206), s.ad_value(138)), 1.0));
        }
        ...
        if s.b[471] {
            s.store_scaled_div(93, 206, 4, (1.0 / (p.p26)));
        }
        ...
        if s.b[471] {
            s.store_mul_ad_affine_product_rhs(194, 36, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if s.b[494] {
            s.store_mul_ad_affine_product_rhs(195, 45, s.ad_value(94), A::limexp(s.ad_value(93)), 1.0, (-1.0));
        }
        ...
        if (s.b[496] && s.b[497]) {
            s.store_ad_value(200, A::add_scaled_products(s.ad_value(204), s.ad_value(184), 1.0, A::sub(s.ad_value(34), s.ad_value(203)), s.ad_value(244), 1.0));
        }
        ...
        if ((s.b[496] && (!s.b[497])) && s.b[498]) {
            let assign10660_ad_e12704: A = A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(A::add_scaled_product(A::add_scaled_products(s.ad_value(204), s.ad_value(184), 1.0, A::sub(s.ad_value(34), s.ad_value(203)), s.ad_value(244), 1.0), 1.0, s.ad_value(185), s.ad_value(202), 1.0), 1.0, s.ad_value(187), s.ad_value(203), 1.0), 1.0, s.ad_value(188), s.ad_value(205), 1.0), 1.0, s.ad_value(194), s.ad_value(206), 1.0), 1.0, s.ad_value(195), s.ad_value(208), 1.0);
            s.store_ad_value(200, assign10660_ad_e12704);
        }
        ...
        if s.b[507] {
            ...
            s.store_scaled_div_ad_lhs(237, A::sub(s.ad_value(505), s.ad_value(217)), 219, p.p66);
            s.store_scaled_div_ad_lhs(238, A::sub(s.ad_value(505), s.ad_value(504)), 219, p.p66);
        ...
        s.store_scaled_mul(521, 1, 10, 4.0);

        s.b[525] = ((p.p90 >= p.p149) && (p.p90 > 0.0));
        s.v[525] = if s.b[525] { 1.0 } else { 0.0 };

        s.b[526] = ((p.p89 >= p.p149) && (p.p89 > 0.0));
        s.v[526] = if s.b[526] { 1.0 } else { 0.0 };

        s.b[527] = ((p.p96 >= p.p149) && (p.p96 > 0.0));
        s.v[527] = if s.b[527] { 1.0 } else { 0.0 };

        s.b[528] = ((p.p95 >= p.p149) && (p.p95 > 0.0));
        s.v[528] = if s.b[528] { 1.0 } else { 0.0 };

        s.b[529] = ((p.p102 >= p.p149) && (p.p102 > 0.0));
        s.v[529] = if s.b[529] { 1.0 } else { 0.0 };

        s.store_scaled_powf_ad(523, A::abs(A::add(s.ad_value(185), s.ad_value(188))), p.p111, p.p110);

        s.b[530] = (p.p112 == (-1.0));
        s.v[530] = if s.b[530] { 1.0 } else { 0.0 };

        s.b[531] = ((p.p95 >= p.p149) && (p.p95 > 0.0));
