...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.b[281] = (p.p22 != 0.0);
        s.store_scalar(281, if s.b[281] { 1.0 } else { 0.0 });
    ...
    if s.b[282] {
        ...
        s.store_scalar(223, assign510_e806);
    ...
    if (!s.b[282]) {
        ...
        s.store_scalar(223, assign520_e811);
    ...
    if s.b[283] {
        ...
        s.store_scalar(243, assign550_e823);
    ...
    if (!s.b[283]) {
        ...
        s.store_scalar(243, assign560_e828);
    ...
    if (s.b[284] && s.b[285]) {
        ...
        s.store_scalar(234, assign600_e849);
    ...
    if (s.b[286] && s.b[287]) {
        ...
        s.store_scalar(229, assign640_e873);
    ...
    if (s.b[286] && (!s.b[287])) {
        ...
        s.store_scalar(229, assign660_e886);
    ...
    if (!s.b[286]) {
        ...
        s.store_scalar(229, assign840_e1009);
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        s.b[327] = (s.v[243] == 1.0);
        s.store_scalar(327, if s.b[327] { 1.0 } else { 0.0 });
    ...
    if s.b[406] {
        ...
        (s.v[224],)
            ...
            s.store_scalar(224, assign6470_body87_e8091);
        }
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.b[430] = (s.v[243] == 1.0);
        s.store_scalar(430, if s.b[430] { 1.0 } else { 0.0 });
        ...
        if ((s.b[430] && s.b[437]) && (!s.b[442])) {
            s.store_mul_ad_product_rhs_mixed_ia(435, 63, 431, A::exp_div_scaled_inputs(s.ad_value(432), -1.0, A::mul(s.ad_value(431), s.ad_value(436)), 1.0));
        }
        ...
        if s.b[447] {
            ...
            s.store_add_scaled_inputs3_indices(451, 179, 1.0, 178, 1.0, 355, 1.0);
