...
impl Instance {
    ...
    if (s.b[286] && (!s.b[287])) {
        ...
        if (s.b[286] && (!s.b[288])) {s.store_scalar(225, (1.0 / p[115]));s.store_scalar(226, (1.0 / p[116]));s.store_scalar(227, (p[115] / 6.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_1(
        ...
        if (s.b[286] && (!s.b[288])) {s.store_scalar(228, (p[116] / 6.0));s.store_scalar(231, ((((1.0 + p[115]) / (1.0 + p[116]))) as f64).ln());}
    ...
    if (!s.b[286]) {
        ...
        if s.b[293] {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p[48] * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p[48]))));}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if (s.b[317] && s.b[322]) {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p[48] * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p[48]))));}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if s.b[317] {s.store_scaled_exp_scaled_input(72, 13, p[136], p[96]);s.store_scaled_exp_scaled_input(71, 13, p[135], p[90]);s.store_scaled_exp_scaled_input(73, 13, p[137], p[95]);s.store_mul_scale_offset_mixed_ai(201, A::exp_scaled_input(s.ad_value(13), p[143]), 14, (p[144]) * (p[142]), (1.0) * (p[142]));}
        ...
        if (s.b[369] && s.b[370]) {s.store_scalar(113, (p[49] / 4.0));s.store_sub_from_scalar(114, p[51], 34);s.store_mul_scale_offset_mixed_ia(115, 34, A::exp_scaled_input(A::ln(s.ad_value(35)), (-1.0 / (p[49]))), -1.0, 1.0);s.store_mul(116, 35, 33);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        ...
        if (s.b[369] && s.b[370]) {s.store_mul_exp_mixed_ia(117, 33, A::mul_offset_lhs(s.ad_value(113), (-p[49]), A::ln(A::div_from_scalar(p[51], s.ad_value(34)))));s.store_mul_sub_lhs(119, 115, 203, 5);}
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && (!s.b[404])) {s.store_sub_from_scalar_scaled_input(152, p[116], 151, p[115]);s.store_div_scaled_offset_numerator_indices(149, 151, 1.0, (-1.0), 152, 1.0);s.store_offset_scaled(160, 149, p[116], 1.0);s.store_ln(161, 160);s.store_primal_mul(162, 227, 226);s.store_add_scaled_products_mixed_aiai(157, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 226, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(227), s.ad_value(149), 1.0), 149, 1.0);}
    }
}
