...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_scalar(174, (p.p105 * p.p104));s.store_scalar(173, (p.p104 - s.v[174]));s.b[281] = (p.p22 != 0.0);s.store_scalar(281, if s.b[281] { 1.0 } else { 0.0 });
        if s.b[281] {s.store_scalar(175, (1.0 / p.p22));}
        if (!s.b[281]) {s.store_scalar(175, 0.0);}
        s.b[282] = (p.p0 <= 300.0);s.store_scalar(282, if s.b[282] { 1.0 } else { 0.0 });
        let (t0,) = {
    if s.b[282] {
        (0.0,)
    } else {
    ...
    if (!s.b[282]) {
        ...
        s.store_scalar(223, t1);s.store_scalar(244, 0.0);s.b[283] = ((p.p32 > 0.0) && (p.p47 > 0.0));s.store_scalar(283, if s.b[283] { 1.0 } else { 0.0 });
        let (t2,) = {
    if s.b[283] {
        (1.0,)
    } else {
    ...
    if (!s.b[283]) {
        ...
        s.store_scalar(243, t3);s.store_scalar(234, p.p86);s.b[284] = (p.p86 != 0.0);s.store_scalar(284, if s.b[284] { 1.0 } else { 0.0 });s.b[285] = (((p.p88 == 0.0) && (p.p87 == 0.0)) || (p.p66 == 0.0));s.store_scalar(285, if s.b[285] { 1.0 } else { 0.0 });
        let (t4,) = {
    if (s.b[284] && s.b[285]) {
        (0.0,)
    } else {
        ...
        s.store_scalar(234, t4);s.b[286] = ((p.p115 >= 0.01) || (p.p116 >= 0.01));s.store_scalar(286, if s.b[286] { 1.0 } else { 0.0 });
    ...
    if (s.b[286] && s.b[287]) {
        ...
        if (s.b[286] && s.b[287]) {s.store_scalar(230, p.p115);}
        let (t6,) = {
    if (s.b[286] && (!s.b[287])) {
        (p.p115,)
    } else {
        ...
        if (s.b[286] && (!s.b[287])) {s.store_scalar(230, p.p116);}
        ...
        if (s.b[286] && (!s.b[288])) {s.store_scalar(225, (1.0 / p.p115));s.store_scalar(226, (1.0 / p.p116));s.store_scalar(227, (p.p115 / 6.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_1(
        ...
        if (s.b[286] && (!s.b[288])) {s.store_scalar(228, (p.p116 / 6.0));s.store_scalar(231, ((((1.0 + p.p115) / (1.0 + p.p116))) as f64).ln());}
    ...
    if (!s.b[286]) {
        ...
        if (!s.b[286]) {s.store_scalar(230, p.p115);s.store_scalar(231, 0.0);}
        ...
        s.store_scaled_exp_ad(22, A::add_scaled_inputs(s.ad_value(13), p.p124, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p118), 1.0), p.p14);s.store_scaled_exp_ad(24, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), (s.v[77] * 1.0 / (p.p17))), 1.0, s.ad_value(76), s.ad_value(13), 1.0 / (p.p17)), p.p16);s.b[293] = (p.p47 > 0.0);s.store_scalar(293, if s.b[293] { 1.0 } else { 0.0 });
        if s.b[293] {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p.p48 * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p.p48))));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_2(
        ...
        s.store_add_scaled_product_mixed_aii(59, A::scale_offset(s.ad_value(14), p.p128, 1.0), p.p66, 14, 14, (p.p129 * p.p66));s.store_scalar(61, p.p69);s.store_scaled_exp_scaled_input(60, 13, (p.p130 - 1.0), p.p71);s.b[298] = (s.v[243] == 1.0);s.store_scalar(298, if s.b[298] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_3(
        ...
        if s.b[298] {s.store_scaled_exp_scaled_input(63, 14, p.p139, p.p32);s.store_scaled_exp_scaled_input(62, 14, p.p140, p.p33);}
        if (!s.b[298]) {s.store_scalar(63, p.p32);s.store_scalar(62, p.p33);}
        s.b[299] = ((p.p37 > 0.0) && (s.v[203] < 0.0));s.store_scalar(299, if s.b[299] { 1.0 } else { 0.0 });
        if s.b[299] {s.store_scalar(67, p.p37);s.store_scalar(68, p.p38);}
        s.b[300] = ((p.p47 > 0.0) && (p.p48 > 0.0));s.store_scalar(300, if s.b[300] { 1.0 } else { 0.0 });
        if (s.b[299] && s.b[300]) {s.store_div_from_scalar(169, s.v[92], 87);s.store_scale(170, 34, 1.0 / (p.p48));s.store_mul_ad_affine_product_lhs(168, A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p.p47), 0.0, 33);s.store_scaled_mul(67, 168, 170, p.p37);s.store_div_scalar_by_product_indices(68, p.p38, 168, 169, 1.0);}
        if (!s.b[299]) {s.store_scalar(67, 0.0);s.store_scalar(68, 1.0);}
        s.store_scaled_exp_scaled_input(69, 13, p.p134, p.p89);s.b[301] = (p.p43 > 0.0);s.store_scalar(301, if s.b[301] { 1.0 } else { 0.0 });
        ...
        s.store_scaled_exp_ad(23, A::add_scaled_inputs(s.ad_value(13), p.p124, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p118), 1.0), p.p18);s.store_scaled_exp_ad(25, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), (s.v[77] * 1.0 / (p.p21))), 1.0, s.ad_value(76), s.ad_value(13), 1.0 / (p.p21)), p.p20);s.b[303] = ((p.p27 > 0.0) && ((s.v[205] < s.v[223]) || (s.v[202] < s.v[223])));s.store_scalar(303, if s.b[303] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if s.b[303] {s.store_scale(64, 167, p.p27);s.store_scale(65, 166, p.p28);}
        if (!s.b[303]) {s.store_scalar(64, 0.0);s.store_scalar(65, 1.0);}
        s.store_scale_ad(66, A::exp_scaled_input(A::offset(s.ad_value(27), (-p.p40)), (-1.0 / (p.p31))), p.p30);s.b[306] = (1.0 > 0.0);s.store_scalar(306, if s.b[306] { 1.0 } else { 0.0 });
        ...
        s.store_mul(37, 43, 176);s.store_mul(38, 43, 177);s.store_scaled_exp_ad(36, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p119), 1.0, s.ad_value(81), s.ad_value(13), 1.0), p.p25);s.b[309] = (p.p0 <= 300.0);s.store_scalar(309, if s.b[309] { 1.0 } else { 0.0 });s.b[310] = (p.p57 > 0.0);s.store_scalar(310, if s.b[310] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        s.store_scaled_exp_ad(45, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p120), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p.p99);s.store_scaled_exp_ad(44, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p119), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p.p97);s.store_scaled_exp_scaled_input(52, 13, (p.p138 - 1.0), p.p101);s.b[314] = (p.p63 > 0.0);s.store_scalar(314, if s.b[314] { 1.0 } else { 0.0 });s.b[315] = (p.p62 > 0.0);s.store_scalar(315, if s.b[315] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.store_scaled_exp_scaled_input(72, 13, p.p136, p.p96);s.store_scaled_exp_scaled_input(71, 13, p.p135, p.p90);s.store_scaled_exp_scaled_input(73, 13, p.p137, p.p95);s.store_mul_scale_offset_mixed_ai(201, A::exp_scaled_input(s.ad_value(13), p.p143), 14, (p.p144) * (p.p142), (1.0) * (p.p142));s.b[317] = (((p.p141 != 0.0) && (p.p142 >= p.p149)) && (p.p142 > 0.0));s.store_scalar(317, if s.b[317] { 1.0 } else { 0.0 });
        ...
        if (s.b[317] && s.b[322]) {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p.p48 * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p.p48))));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_7(
        ...
        if (s.b[317] && s.b[322]) {s.store_sub_ad(165, A::add_scaled_product(A::scale_offset(s.ad_value(11), (-s.v[78]), s.v[78]), 1.0, s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));s.store_add_scaled_product_mixed_iia(34, 165, 1.0, 4, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0);s.store_scale_ad(33, A::exp_scaled_input(A::ln(A::div_from_scalar(p.p48, s.ad_value(34))), p.p49), p.p47);s.store_scalar(35, ((p.p50) as f64).abs());}
        ...
        if s.b[317] {s.store_scaled_exp_ad(32, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p119), 1.0, s.ad_value(80), s.ad_value(13), 1.0), p.p23);s.store_offset_scaled_ad(16, A::exp_scaled_input(A::ln_scaled_input(s.ad_value(27), 1.0 / (p.p40)), p.p41), (-p.p2), ((2.0) * (p.p2)));s.store_scaled_exp_ad(15, A::add_scaled_inputs(s.ad_value(13), p.p123, A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p117), 1.0), p.p1);s.store_scaled_exp_scaled_input(18, 13, p.p126, p.p10);}
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if (s.b[317] && s.b[327]) {s.store_scaled_exp_scaled_input(63, 14, p.p139, p.p32);s.store_scaled_exp_scaled_input(62, 14, p.p140, p.p33);}
        if (s.b[317] && (!s.b[327])) {s.store_scalar(63, p.p32);s.store_scalar(62, p.p33);}
        s.b[328] = ((p.p37 > 0.0) && (s.v[203] < 0.0));s.store_scalar(328, if s.b[328] { 1.0 } else { 0.0 });
        if (s.b[317] && s.b[328]) {s.store_scalar(67, p.p37);s.store_scalar(68, p.p38);}
        s.b[329] = ((p.p47 > 0.0) && (p.p48 > 0.0));s.store_scalar(329, if s.b[329] { 1.0 } else { 0.0 });
        if ((s.b[317] && s.b[328]) && s.b[329]) {s.store_div_from_scalar(169, s.v[92], 87);s.store_scale(170, 34, 1.0 / (p.p48));s.store_mul_ad_affine_product_lhs(168, A::sqrt(s.ad_value(169)), s.ad_value(170), 1.0 / (p.p47), 0.0, 33);s.store_scaled_mul(67, 168, 170, p.p37);s.store_div_scalar_by_product_indices(68, p.p38, 168, 169, 1.0);}
        if (s.b[317] && (!s.b[328])) {s.store_scalar(67, 0.0);s.store_scalar(68, 1.0);}
        if s.b[317] {s.store_scaled_exp_scaled_input(69, 13, p.p134, p.p89);}
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[317] && s.b[332]) {s.store_scale(64, 167, p.p27);s.store_scale(65, 166, p.p28);}
        if (s.b[317] && (!s.b[332])) {s.store_scalar(64, 0.0);s.store_scalar(65, 1.0);}
        if s.b[317] {s.store_scale_ad(66, A::exp_scaled_input(A::offset(s.ad_value(27), (-p.p40)), (-1.0 / (p.p31))), p.p30);}
        s.b[335] = (1.0 > 0.0);s.store_scalar(335, if s.b[335] { 1.0 } else { 0.0 });
        if (s.b[317] && s.b[335]) {s.store_primal_mul_scaled_ln_ad_rhs(164, 6, 2.0, A::sub(A::exp_scaled_input(s.ad_value(7), (p.p53 * 0.5)), A::exp_scaled_input(s.ad_value(7), ((-0.5) * p.p53))));s.store_sub_ad(165, A::add_scaled_product(A::scale_offset(s.ad_value(11), (-s.v[78]), s.v[78]), 1.0, s.ad_value(164), s.ad_value(11), 1.0), A::mul3(s.ad_value(76), s.ad_value(4), s.ad_value(13)));s.store_add_scaled_product_mixed_iia(39, 165, 1.0, 4, A::ln_scaled_input(A::offset(A::sqrt(A::scale_offset(A::exp(A::mul_scaled_lhs(s.ad_value(165), -1.0, s.ad_value(5))), 4.0, 1.0)), 1.0), 0.5), 2.0);s.store_exp_scaled_input_ad(43, A::ln(A::div_from_scalar(p.p53, s.ad_value(39))), p.p54);s.store_scalar(40, ((p.p55) as f64).abs());}
        ...
        if s.b[317] {s.store_mul(37, 43, 176);s.store_mul(38, 43, 177);s.store_scaled_exp_ad(36, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p119), 1.0, s.ad_value(81), s.ad_value(13), 1.0), p.p25);}
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if s.b[317] {s.store_scaled_exp_ad(45, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p120), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p.p99);s.store_scaled_exp_ad(44, A::add_scaled_product(A::mul_sub_from_scalar_rhs_scaled_output(s.ad_value(7), 1.0, s.ad_value(12), p.p119), 1.0, s.ad_value(82), s.ad_value(13), 1.0), p.p97);s.store_scaled_exp_scaled_input(52, 13, (p.p138 - 1.0), p.p101);}
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if s.b[317] {s.store_scaled_exp_scaled_input(72, 13, p.p136, p.p96);s.store_scaled_exp_scaled_input(71, 13, p.p135, p.p90);s.store_scaled_exp_scaled_input(73, 13, p.p137, p.p95);s.store_mul_scale_offset_mixed_ai(201, A::exp_scaled_input(s.ad_value(13), p.p143), 14, (p.p144) * (p.p142), (1.0) * (p.p142));}
        ...
        if (s.b[369] && s.b[370]) {s.store_scalar(113, (p.p49 / 4.0));s.store_sub_from_scalar(114, p.p51, 34);s.store_mul_scale_offset_mixed_ia(115, 34, A::exp_scaled_input(A::ln(s.ad_value(35)), (-1.0 / (p.p49))), -1.0, 1.0);s.store_mul(116, 35, 33);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_12(
        ...
        if (s.b[369] && s.b[370]) {s.store_mul_exp_mixed_ia(117, 33, A::mul_offset_lhs(s.ad_value(113), (-p.p49), A::ln(A::div_from_scalar(p.p51, s.ad_value(34)))));s.store_mul_sub_lhs(119, 115, 203, 5);}
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if s.b[374] {s.store_scale(375, 4, p.p11);s.store_div_scaled_inputs2_indices(376, 27, 1.0, 202, (-1.0), 375, 1.0);s.store_add_scaled_product_mixed_iia(377, 27, 1.0, 375, A::add(s.ad_value(376), A::sqrt_square_offset(s.ad_value(376), 1.921812)), (-0.5));s.store_mul_scale_offset_mixed_ia(378, 18, A::exp_scaled_input(A::ln(A::sub_from_scalar(1.0, A::div(s.ad_value(377), s.ad_value(27)))), p.p41), -1.0, 1.0);}
        ...
        if s.b[394] {s.store_mul_sub_lhs(387, 363, 4, 5);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_14(
        ...
        if s.b[394] {s.store_add_scaled_product_mixed_iia(388, 4, 1.0, 4, A::add(s.ad_value(387), A::sqrt_square_offset(s.ad_value(387), 1.921812)), 0.5);}
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if (s.b[399] && (!s.b[402])) {s.store_sub_from_scalar(146, 1.0, 109);s.store_div_scaled_value_by_product_mixed_aai(147, A::mul_sub_from_scalar_rhs(A::offset(s.ad_value(146), (-1.0)), 1.0, s.ad_value(108)), 1.0, A::sqrt_square_offset(s.ad_value(108), p.p72), 217, 1.0);}
        ...
        if (((s.b[399] && (!s.b[402])) && s.b[403]) && (!s.b[404])) {s.store_sub_from_scalar_scaled_input(152, p.p116, 151, p.p115);s.store_div_scaled_offset_numerator_indices(149, 151, 1.0, (-1.0), 152, 1.0);s.store_offset_scaled(160, 149, p.p116, 1.0);s.store_ln(161, 160);s.store_primal_mul(162, 227, 226);s.store_add_scaled_products_mixed_aiai(157, A::mul_sub_from_scalar_rhs(s.ad_value(161), 0.5, s.ad_value(162)), 226, 1.0, A::add_scaled_product(s.ad_value(162), 1.0, s.ad_value(227), s.ad_value(149), 1.0), 149, 1.0);}
    }
}
