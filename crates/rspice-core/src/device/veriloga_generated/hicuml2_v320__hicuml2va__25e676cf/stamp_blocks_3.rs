...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_14(
        ...
        if (s.b[399] && (!s.b[402])) {s.store_div_scaled_value_by_product_mixed_aai(147, A::mul_sub_from_scalar_rhs(A::offset(s.ad_value(146), (-1.0)), 1.0, s.ad_value(108)), 1.0, A::sqrt_square_offset(s.ad_value(108), p[72]), 217, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_19(
        ...
        if (s.b[428] && s.b[429]) {s.store_exp_scaled_input_ad(168, A::ln(A::div(s.ad_value(210), s.ad_value(33))), ((1.0 / p[49]) - 1.0));s.store_div_scaled_product_by_product_indices(166, 67, 203, -1.0, 34, 168, 1.0);}
        ...
        if s.b[460] {s.store_mul_scale_offset_mixed_ia(137, 30, A::exp_scaled_input(A::ln(s.ad_value(31)), (-1.0 / (p[45]))), -1.0, 1.0);s.store_mul_sub_lhs(141, 137, 205, 5);s.store_sqrt_square_offset(142, 141, 1.921812);s.store_scaled_add(143, 141, 142, 0.5);s.store_add_scaled_product_indices(138, 137, 1.0, 4, 143, (-1.0));}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_25(
        ...
        if s.b[489] {s.store_scale(490, 4, p[98]);s.store_limexp_div(491, 206, 490);}
    ...
    pub(super) fn stamp_reactive_block_26(
        ...
        if s.b[507] {s.store_voltage(504, ctx, nodes, Some(10), None);s.store_voltage(505, ctx, nodes, Some(11), None);s.store_scale(239, 504, (p[88] * p[66]));s.store_scale(240, 505, ((p[88] * 0.3333333333333333) * p[66]));s.store_voltage(503, ctx, nodes, Some(12), None);s.store_scale(236, 503, (p[87] * p[66]));s.copy_ad(242, 503);}
        if (!s.b[507]) {s.store_scalar(239, 0.0);s.store_scalar(240, 0.0);s.store_scalar(236, 0.0);}
        s.b[508] = ((p[89] >= p[149]) && (p[89] > 0.0));s.store_scalar(508, if s.b[508] { 1.0 } else { 0.0 });s.b[509] = (p[93] > 0.0);s.store_scalar(509, if s.b[509] { 1.0 } else { 0.0 });s.b[517] = ((p[102] >= p[149]) && (p[102] > 0.0));s.store_scalar(517, if s.b[517] { 1.0 } else { 0.0 });s.b[518] = (p[103] > 0.0);s.store_scalar(518, if s.b[518] { 1.0 } else { 0.0 });s.b[519] = (((p[141] >= 1.0) && (p[142] >= p[149])) && (p[142] > 0.0));s.store_scalar(519, if s.b[519] { 1.0 } else { 0.0 });s.b[520] = (p[145] > 0.0);s.store_scalar(520, if s.b[520] { 1.0 } else { 0.0 });s.b[533] = ((p[109] == 1.0) && ((p[88] > 0.0) && (p[87] > 0.0)));s.store_scalar(533, if s.b[533] { 1.0 } else { 0.0 });s.b[539] = (s.v[185] > 0.0);s.store_scalar(539, if s.b[539] { 1.0 } else { 0.0 });
