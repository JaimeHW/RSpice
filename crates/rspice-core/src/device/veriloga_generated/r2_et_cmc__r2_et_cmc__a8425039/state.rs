...
pub struct Instance {
    ...
    pub(crate) scalar_static_f64: Box<[f64; 66]>,
...
impl Instance {
    ...
    pub const CHECKPOINT_MODEL_IDENTITY: &'static str = "699b81eb87aaeee14850772547fa5a3b15b5093ba9625957d2bec5e8644b8f57";
    ...
    pub fn new(nodes: &[usize]) -> Self {
        ...
        let mut instance = Self {
            ...
            scalar_static_f64: boxed_zero_f64_array::<66>(),
    ...
    fn recompute_instance_static(&mut self) {
        ...
        self.scalar_static_f64[3]=if param_given[11]{1.0}else{0.0};
        self.scalar_static_f64[4]=p.p11;
        ...
        self.scalar_static_f64[8]=p.p16;
        self.scalar_static_f64[9]=(273.15+self.scalar_static_f64[8]);
        self.scalar_static_f64[10]=p.p5;
        self.scalar_static_f64[11]=p.p3;
        self.scalar_static_f64[12]=p.p4;
        self.scalar_static_bool[2]=(((self.scalar_static_f64[11])!=0.0)&&((self.scalar_static_f64[12])!=0.0));
        self.scalar_static_f64[13]=(if self.scalar_static_bool[2]{1.0}else{0.0});
        self.scalar_static_f64[14]=p.p23;
        self.scalar_static_f64[15]=(if ((self.scalar_static_f64[13])!=0.0){self.scalar_static_f64[14]}else{0.0});
        self.scalar_static_bool[3]=(((self.scalar_static_f64[11])!=0.0)||((self.scalar_static_f64[12])!=0.0));
        self.scalar_static_f64[16]=(if self.scalar_static_bool[3]{1.0}else{0.0});
        self.scalar_static_bool[4]=(!((self.scalar_static_f64[13])!=0.0));
        self.scalar_static_bool[5]=(((self.scalar_static_f64[16])!=0.0)&&self.scalar_static_bool[4]);
        self.scalar_static_f64[17]=(self.scalar_static_f64[14]*0.5);
        self.scalar_static_f64[18]=(if self.scalar_static_bool[5]{self.scalar_static_f64[17]}else{self.scalar_static_f64[15]});
        self.scalar_static_bool[6]=(!((self.scalar_static_f64[16])!=0.0));
        self.scalar_static_bool[7]=(self.scalar_static_bool[4]&&self.scalar_static_bool[6]);
        self.scalar_static_f64[19]=(if self.scalar_static_bool[7]{0.0}else{self.scalar_static_f64[18]});
        self.scalar_static_f64[20]=if param_given[1]{1.0}else{0.0};
        self.scalar_static_f64[21]=if param_given[2]{1.0}else{0.0};
        self.scalar_static_bool[8]=(((self.scalar_static_f64[20])!=0.0)&&((self.scalar_static_f64[21])!=0.0));
        self.scalar_static_f64[22]=if param_given[0]{1.0}else{0.0};
        ...
        self.scalar_static_f64[23]=(if self.scalar_static_bool[10]{1.0}else{0.0});
        self.scalar_static_f64[24]=p.p2;
        self.scalar_static_bool[11]=(0.0==self.scalar_static_f64[24]);
        self.scalar_static_f64[25]=p.p1;
        self.scalar_static_bool[12]=(0.0==self.scalar_static_f64[25]);
        ...
        self.scalar_static_bool[14]=(((self.scalar_static_f64[23])!=0.0)&&((self.scalar_static_f64[26])!=0.0));
        self.scalar_static_f64[27]=p.p0;
        self.scalar_static_f64[28]=p.p22;
        self.scalar_static_bool[15]=(!((self.scalar_static_f64[26])!=0.0));
        self.scalar_static_bool[16]=(((self.scalar_static_f64[23])!=0.0)&&self.scalar_static_bool[15]);
        self.scalar_static_f64[29]=p.p17;
        self.scalar_static_f64[30]=(self.scalar_static_f64[29]/self.scalar_static_f64[24]);
        self.scalar_static_bool[17]=(!((self.scalar_static_f64[20])!=0.0));
        self.scalar_static_bool[18]=(((self.scalar_static_f64[21])!=0.0)&&self.scalar_static_bool[17]);
        self.scalar_static_f64[31]=(if self.scalar_static_bool[18]{1.0}else{0.0});
        self.scalar_static_f64[32]=(if self.scalar_static_bool[11]{1.0}else{0.0});
        self.scalar_static_bool[19]=(!((self.scalar_static_f64[23])!=0.0));
        self.scalar_static_bool[20]=(((self.scalar_static_f64[31])!=0.0)&&self.scalar_static_bool[19]);
        self.scalar_static_bool[21]=(((self.scalar_static_f64[32])!=0.0)&&self.scalar_static_bool[20]);
        self.scalar_static_bool[22]=(0.0==self.scalar_static_f64[27]);
        self.scalar_static_f64[33]=(if self.scalar_static_bool[22]{1.0}else{0.0});
        self.scalar_static_bool[23]=(!((self.scalar_static_f64[32])!=0.0));
        self.scalar_static_bool[24]=(self.scalar_static_bool[20]&&self.scalar_static_bool[23]);
        self.scalar_static_bool[25]=(((self.scalar_static_f64[33])!=0.0)&&self.scalar_static_bool[24]);
        self.scalar_static_bool[26]=(!((self.scalar_static_f64[33])!=0.0));
        self.scalar_static_bool[27]=(self.scalar_static_bool[24]&&self.scalar_static_bool[26]);
        self.scalar_static_f64[34]=(self.scalar_static_f64[24]/self.scalar_static_f64[29]);
        self.scalar_static_bool[28]=(!((self.scalar_static_f64[31])!=0.0));
        ...
        self.scalar_static_f64[35]=(if self.scalar_static_bool[12]{1.0}else{0.0});
        self.scalar_static_bool[31]=(self.scalar_static_bool[26]&&self.scalar_static_bool[29]);
        self.scalar_static_bool[32]=(((self.scalar_static_f64[35])!=0.0)&&self.scalar_static_bool[31]);
        self.scalar_static_bool[33]=(!((self.scalar_static_f64[35])!=0.0));
        self.scalar_static_bool[34]=(self.scalar_static_bool[31]&&self.scalar_static_bool[33]);
        self.scalar_static_f64[36]=p.p25;
        self.scalar_static_f64[37]=p.p24;
        self.scalar_static_bool[35]=(!((self.scalar_static_f64[36])!=0.0));
        self.scalar_static_f64[38]=p.p29;
        self.scalar_static_bool[36]=(self.scalar_static_f64[38]>0.0);
        self.scalar_static_f64[39]=p.p27;
        self.scalar_static_bool[37]=(self.scalar_static_f64[39]>0.0);
        self.scalar_static_bool[38]=(self.scalar_static_bool[36]||self.scalar_static_bool[37]);
        self.scalar_static_f64[40]=p.p37;
        self.scalar_static_f64[41]=p.p38;
        self.scalar_static_f64[42]=p.p39;
        self.scalar_static_f64[43]=p.p40;
        self.scalar_static_f64[44]=(0.5*self.scalar_static_f64[42]);
        self.scalar_static_f64[45]=(0.5*self.scalar_static_f64[43]);
        self.scalar_static_f64[46]=p.p41;
        self.scalar_static_f64[47]=p.p42;
        self.scalar_static_f64[48]=p.p44;
        self.scalar_static_f64[49]=p.p45;
        self.scalar_static_f64[50]=p.p46;
        self.scalar_static_f64[51]=p.p47;
        self.scalar_static_f64[52]=p.p48;
        self.scalar_static_f64[53]=p.p49;
        self.scalar_static_f64[54]=p.p7;
        self.scalar_static_f64[55]=p.p35;
        self.scalar_static_f64[56]=(1.0+self.scalar_static_f64[55]);
        self.scalar_static_f64[57]=p.p36;
        self.scalar_static_f64[58]=(self.scalar_static_f64[57]-1.0);
        self.scalar_static_f64[59]=p.p28;
        self.scalar_static_f64[60]=p.p26;
        self.scalar_static_f64[61]=(1.0-self.scalar_static_f64[38]);
        self.scalar_static_f64[62]=(self.scalar_static_f64[61]-self.scalar_static_f64[39]);
        self.scalar_static_bool[39]=(!((self.scalar_static_f64[54])!=0.0));
        self.scalar_static_f64[63]=(if self.scalar_static_bool[39]{1000000.0}else{0.0});
    }
    ...
    fn recompute_temperature_static(&mut self, temperature: f64, thermal_voltage: f64) {
        let p = &(*self.params);
        self.scalar_static_f64[64]=(temperature+self.scalar_static_f64[10]);
        self.scalar_static_f64[65]=(self.scalar_static_f64[64]-273.15);
