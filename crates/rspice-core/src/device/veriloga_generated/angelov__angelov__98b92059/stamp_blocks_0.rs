...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_sub_ad(46, A::add(A::offset(s.ad_value(39), (-p.p10)), A::scale(A::tanh(A::scale(s.ad_value(5), p.p15)), p.p10)), A::mul(A::scale(A::offset(s.ad_value(6), (-p.p21)), p.p22), A::sub(s.ad_value(6), s.ad_value(38))));

        s.store_sub(48, 4, 46);

        s.store_square(49, 48);

        s.store_add_ad(13, A::add(A::mul(s.ad_value(44), s.ad_value(48)), A::scale(s.ad_value(49), p.p12)), A::mul(A::scale(s.ad_value(48), p.p13), s.ad_value(49)));

        s.store_offset_tanh_ad(59, s.ad_value(13), 1.0);

        s.store_offset_tanh_ad(60, A::scale(A::sub(A::limexp(s.ad_value(13)), A::limexp(A::neg(s.ad_value(13)))), 0.5), 1.0);
        ...
        if s.b[86] {
            s.store_mul_ad(81, A::mul(A::mul(s.ad_value(26), s.ad_value(59)), s.ad_value(63)), A::add(A::offset(A::scale(s.ad_value(5), p.p16), 1.0), A::mul(s.ad_value(30), A::limexp(A::sub(s.ad_value(6), s.ad_value(38))))));
        }
        ...
        if (s.b[87] && (!s.b[86])) {
            ...
            s.store_add_scaled_ad_lhs(55, A::add(A::mul(s.ad_value(44), s.ad_value(47)), A::scale(s.ad_value(48), p.p12)), 49, p.p13);
            ...
            s.store_mul_ad(57, A::mul(A::mul(s.ad_value(26), s.ad_value(59)), A::offset(s.ad_value(63), 1.0)), A::add(A::offset(A::mul(s.ad_value(53), s.ad_value(5)), 1.0), A::mul(s.ad_value(30), A::limexp(A::sub(s.ad_value(5), s.ad_value(38))))));
            s.store_offset_scaled(51, 61, p.p17, p.p16);
            s.store_tanh_ad(64, A::mul(s.ad_value(56), s.ad_value(5)));
            s.store_mul_ad(58, A::mul(A::mul(s.ad_value(26), s.ad_value(61)), A::sub_from_scalar(1.0, s.ad_value(64))), A::sub_from_scalar(1.0, A::mul(s.ad_value(51), s.ad_value(5))));
        ...
        if (s.b[88] && (!(s.b[86] || s.b[87]))) {
            s.store_sub(47, 4, 46);
            s.store_square(48, 47);
            s.store_mul_add_ad_rhs(13, 44, A::add(s.ad_value(47), A::scale(s.ad_value(48), p.p12)), A::mul(A::scale(s.ad_value(48), p.p13), s.ad_value(47)));
            s.store_offset_tanh_ad(60, A::scale(A::sub(A::limexp(s.ad_value(13)), A::limexp(A::neg(s.ad_value(13)))), 0.5), 1.0);
            ...
            s.store_mul_ad(81, A::mul(A::mul(s.ad_value(26), s.ad_value(60)), s.ad_value(65)), A::add(A::offset(A::mul(s.ad_value(53), s.ad_value(5)), 1.0), A::mul(s.ad_value(30), A::limexp(A::sub(s.ad_value(6), s.ad_value(38))))));
        }
        ...
        if (s.b[89] && (!((s.b[86] || s.b[87]) || s.b[88]))) {
            ...
            s.store_mul_add_ad_rhs(55, 44, A::add(s.ad_value(49), A::scale(s.ad_value(50), p.p12)), A::mul(A::scale(s.ad_value(49), p.p13), s.ad_value(50)));
            s.store_offset_tanh_ad(60, A::scale(A::sub(A::limexp(s.ad_value(13)), A::limexp(A::neg(s.ad_value(13)))), 0.5), 1.0);
            s.store_offset_tanh_ad(62, A::scale(A::sub(A::limexp(s.ad_value(55)), A::limexp(A::neg(s.ad_value(55)))), 0.5), 1.0);
            s.store_offset_scaled(1, 60, p.p15, p.p14);
            ...
            s.store_mul_ad(57, A::mul(A::mul(s.ad_value(26), s.ad_value(60)), A::offset(s.ad_value(65), 1.0)), A::add(A::offset(A::mul(s.ad_value(54), s.ad_value(5)), 1.0), A::mul(s.ad_value(30), A::limexp(A::sub(s.ad_value(5), s.ad_value(38))))));
            s.store_mul_ad(58, A::mul(A::mul(s.ad_value(26), s.ad_value(62)), A::sub_from_scalar(1.0, s.ad_value(66))), A::sub_from_scalar(1.0, A::mul(s.ad_value(52), s.ad_value(5))));
            s.store_scaled_sub(81, 57, 58, 0.5);
        }
        ...
        if s.b[91] {
            s.store_mul_offset_ad_rhs(36, 29, A::scale(s.ad_value(12), p.p66), 1.0);
            s.store_mul_offset_ad_rhs(35, 28, A::scale(s.ad_value(12), p.p66), 1.0);
        }
        ...
        if s.b[92] {
            s.store_limexp_ad(47, A::mul(s.ad_value(15), A::tanh(A::scale(s.ad_value(42), (-1.0)))));
            s.store_sub(16, 79, 42);
            s.store_sub(17, 80, 42);
        }

        if (!s.b[92]) {
            s.store_limexp_ad(47, A::mul(A::neg(s.ad_value(15)), s.ad_value(42)));
        }
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if s.b[107] {
            ...
            s.store_scaled_offset_ad(112, A::mul(A::mul(A::scale(s.ad_value(59), p.p80), A::abs(s.ad_value(63))), A::offset(A::scale(s.ad_value(5), p.p16), 1.0)), 1.0, (p.p78 + 273.15));
            s.store_mul_scaled_ad_rhs(110, 11, ((p.p84 * 4.0) * 1.3806503e-23), A::sqrt(A::abs(A::add(A::mul(A::div(s.ad_value(112), s.ad_value(11)), s.ad_value(111)), A::mul(A::scale(s.ad_value(111), p.p79), s.ad_value(111))))));
        }
        ...
        if (((s.b[108] && (!s.b[107])) && (p.p0 != 0.0)) && s.b[116]) {
            s.store_div_ad_lhs(114, A::scale(A::mul(A::scale(A::square(s.ad_value(31)), (4.0 * 1.3806503e-23)), s.ad_value(11)), p.p71), 115);
        }
