...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        s.b[1281] = (s.v[533] <= 0.0);s.store_scalar(1281, if s.b[1281] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        s.store_scalar(271, 0.0);s.store_scalar(272, 0.0);s.store_scalar(273, 0.0);s.store_scalar(274, 0.0);s.store_scalar(275, 0.0);s.store_scalar(276, 0.0);s.b[1283] = (p[8] != 0.0);s.store_scalar(1283, if s.b[1283] { 1.0 } else { 0.0 });
        if s.b[1283] {s.store_scalar(256, ((((s.v[30] * 1000000.0)).max(1e-38)) as f64).ln());s.store_scalar(257, ((((s.v[29] * 1000000.0)).max(1e-38)) as f64).ln());s.store_scalar(258, (((p[2]).max(1e-38)) as f64).ln());}
        let (t0,) = {
    if s.b[1283] {
        (5.0,)
    } else {
        ...
        s.store_scalar(259, t0);
        if s.b[1283] {s.store_scalar(268, p[11]);s.store_scalar(270, p[12]);s.store_scalar(269, p[13]);s.store_scalar(266, p[14]);s.store_scalar(267, p[15]);}
        s.b[1284] = ((!param_given[757]) || (!param_given[761]));s.store_scalar(1284, if s.b[1284] { 1.0 } else { 0.0 });
        let (t1,) = {
    if (s.b[1283] && s.b[1284]) {
        ...
        s.store_scalar(259, t1);s.b[1285] = (((!param_given[773]) && (!param_given[774])) || ((!param_given[775]) && (!param_given[776])));s.store_scalar(1285, if s.b[1285] { 1.0 } else { 0.0 });
        let (t2,) = {
    if ((s.b[1283] && (!s.b[1284])) && s.b[1285]) {
        ...
        s.store_scalar(259, t2);s.b[1286] = (p[8] == 2.0);s.store_scalar(1286, if s.b[1286] { 1.0 } else { 0.0 });s.b[1287] = (s.v[259] == 5.0);s.store_scalar(1287, if s.b[1287] { 1.0 } else { 0.0 });
        if ((s.b[1283] && s.b[1286]) && s.b[1287]) {s.store_primal_scaled_limited_exp_ad(262, A::add_scaled_inputs3(s.ad_value(256), p[777], s.ad_value(257), p[778], s.ad_value(258), p[779]), p[773]);s.store_primal_scaled_limited_exp_ad(263, A::add_scaled_inputs3(s.ad_value(256), p[780], s.ad_value(257), p[781], s.ad_value(258), p[782]), p[774]);s.store_primal_div_scaled_product_add_scaled_denominator_indices(267, 262, 263, 1.0, 262, 1.0, 263, 1.0, 1.0);s.store_primal_scaled_limited_exp_ad(264, A::add_scaled_inputs3(s.ad_value(256), p[777], s.ad_value(257), p[778], s.ad_value(258), p[779]), p[775]);s.store_primal_scaled_limited_exp_ad(265, A::add_scaled_inputs3(s.ad_value(256), p[780], s.ad_value(257), p[781], s.ad_value(258), p[782]), p[776]);s.store_primal_div_scaled_product_add_scaled_denominator_indices(266, 264, 265, 1.0, 264, 1.0, 265, 1.0, 1.0);}
        s.b[1288] = ((s.v[259] == 3.0) || (s.v[259] == 5.0));s.store_scalar(1288, if s.b[1288] { 1.0 } else { 0.0 });
        if ((s.b[1283] && s.b[1286]) && s.b[1288]) {s.store_primal_scaled_limited_exp_ad(269, A::add_scaled_inputs3(s.ad_value(256), p[758], s.ad_value(257), p[759], s.ad_value(258), p[760]), p[757]);s.store_primal_scaled_limited_exp_ad(270, A::add_scaled_inputs3(s.ad_value(256), p[762], s.ad_value(257), p[763], s.ad_value(258), p[764]), p[761]);}
        if (s.b[1283] && s.b[1286]) {s.store_primal_scaled_limited_exp_ad(260, A::add_scaled_inputs3(s.ad_value(256), p[766], s.ad_value(257), p[767], s.ad_value(258), p[768]), p[765]);s.store_primal_scaled_limited_exp_ad(261, A::add_scaled_inputs3(s.ad_value(256), p[770], s.ad_value(257), p[771], s.ad_value(258), p[772]), p[769]);s.store_primal_div_scaled_product_add_scaled_denominator_indices(268, 260, 261, 1.0, 260, 1.0, 261, 1.0, 1.0);}
    ...
    pub(super) fn stamp_transient_block_18(
        ...
        s.store_scalar(12, (p[77] * p[77]));s.store_scale(13, 599, p[77]);s.store_square(14, 13);s.store_scaled_limited_exp_scaled_input(298, 603, ((((p[555] / p[77])).max(1e-38)) as f64).ln(), 1.0 / (s.v[12]));s.store_div_mixed_ai(299, A::limited_exp(A::mul(s.ad_value(603), A::ln(A::max_with_scalar(A::div_from_scalar(p[555], s.ad_value(13)), 1e-38)))), 14);s.store_scalar(294, (if (p[39] == 1.0) { 4.97232e-7 } else { 3.42537e-7 }));s.store_scalar(295, (if (p[39] == 1.0) { 745669000000.0 } else { 1166450000000.0 }));s.store_scale(296, 299, (s.v[294] * s.v[29]));s.store_primal_scale(297, 599, ((-s.v[295]) * p[77]));s.store_scale(294, 298, ((s.v[29] * s.v[30]) * s.v[294]));s.store_scalar(295, ((-s.v[295]) * p[77]));s.store_scalar(38, (p[911] + s.v[29]));s.b[1305] = (((p[49] != 0.0) && (p[909] > 0.0)) && (s.v[38] > 0.0));s.store_scalar(1305, if s.b[1305] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        let ctx_temp = ctx.temperature();s.store_scalar(391, (ctx_temp + p[33]));s.b[1307] = (((p[49] != 0.0) && (p[909] > 0.0)) && (s.v[38] > 0.0));s.store_scalar(1307, if s.b[1307] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_26(
        ...
        }, 0.01);s.store_sub_ad(12, A::div(s.ad_value(37), s.ad_value(394)), A::div(s.ad_value(36), s.ad_value(393)));s.store_ln_ad(13, A::max_with_scalar(s.ad_value(395), 1e-38));s.store_limited_exp_scaled_input_ad(15, A::add_scaled_inputs(s.ad_value(12), 1.0, s.ad_value(13), p[895]), 1.0 / (p[725]));s.store_scale(435, 15, p[719]);s.store_scale(436, 15, p[721]);s.store_scale(437, 15, p[723]);s.store_limited_exp_scaled_input_ad(15, A::add_scaled_inputs(s.ad_value(12), 1.0, s.ad_value(13), p[896]), 1.0 / (p[726]));s.store_scale(438, 15, p[720]);s.store_scale(439, 15, p[722]);s.store_scale(440, 15, p[724]);s.store_scaled_limited_exp_ad(441, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[897], s.ad_value(393), 1.0), p[735]);s.store_scaled_limited_exp_ad(443, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[899], s.ad_value(393), 1.0), p[737]);s.store_scaled_limited_exp_ad(445, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[901], s.ad_value(393), 1.0), (p[739] * ((((p[741] / s.v[35])) as f64).sqrt() + 1.0)));s.store_scaled_limited_exp_ad(442, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[898], s.ad_value(393), 1.0), p[736]);s.store_scaled_limited_exp_ad(444, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[900], s.ad_value(393), 1.0), p[738]);s.store_scaled_limited_exp_ad(446, A::div_scaled_product_offset_rhs(s.ad_value(37), s.ad_value(395), (-1.0), p[902], s.ad_value(393), 1.0), (p[740] * ((((p[741] / s.v[35])) as f64).sqrt() + 1.0)));
    ...
    pub(super) fn stamp_transient_block_28(
        ...
        s.b[1320] = (p[9] < 9.0);s.store_scalar(1320, if s.b[1320] { 1.0 } else { 0.0 });s.b[1321] = ((p[2] % 2.0) != 0.0);s.store_scalar(1321, if s.b[1321] { 1.0 } else { 0.0 });
        ...
        if (s.b[1333] && (!(((((((((s.b[1323] || s.b[1324]) || s.b[1325]) || s.b[1326]) || s.b[1327]) || s.b[1328]) || s.b[1329]) || s.b[1330]) || s.b[1331]) || s.b[1332]))) {s.store_scalar(248, (p[2] * s.v[2]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_29(
        ...
        if (s.b[1333] && (!(((((((((s.b[1323] || s.b[1324]) || s.b[1325]) || s.b[1326]) || s.b[1327]) || s.b[1328]) || s.b[1329]) || s.b[1330]) || s.b[1331]) || s.b[1332]))) {s.store_scalar(249, (s.v[1] + ((p[2] - 1.0) * s.v[3])));s.store_scalar(246, (p[2] * s.v[8]));s.store_scalar(247, (s.v[7] + ((p[2] - 1.0) * s.v[9])));}
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if s.b[1345] {s.store_scale(344, 393, p[726]);s.store_scaled_limited_exp_ad(358, A::div_from_scalar((-p[732]), s.ad_value(344)), p[734]);s.store_max_with_scalar_ad(14, A::div_from_scalar(p[728], s.ad_value(342)), 10.0);s.store_sub_offset_lhs(25, 14, 1.0, 358);}
    }
    #[inline(never)]
