...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_48(
        ...
        if ((s.b[1400] && (!s.b[1418])) && s.b[1420]) {s.store_offset_sub_scaled_inputs(17, A::offset(s.ad_value(17), 1.0), 0.5, A::sqrt_square_offset(A::offset(s.ad_value(17), (-1.0)), ((0.25 * p[1108]) * p[1108])), 0.5, (0.25 * p[1108]));s.store_offset(17, 17, (((((0.5 * (((1.0 + ((0.25 * p[1108]) * p[1108]))) as f64).sqrt())) + ((-0.5)))) + ((-(0.25 * p[1108])))));}
    ...
    pub(super) fn stamp_transient_block_51(
        ...
        if s.b[1424] {s.store_mul3_ad_middle(775, A::div_from_scalar(((((p[2] * s.v[33]) * p[1115]) * 8.85418e-12) * p[111]), s.ad_value(229)), 108, A::add_scaled_inputs_product(s.ad_value(764), 1.0, s.ad_value(773), (-1.0), s.ad_value(772), s.ad_value(768), (-2.0)));}
    ...
    pub(super) fn stamp_transient_block_55(
        ...
        s.store_scaled_mul(824, 178, 187, p[28]);s.store_scalar(283, 0.0);s.store_scalar(284, 0.0);s.store_scalar(285, 0.0);s.store_scalar(286, 0.0);s.store_scalar(287, 0.0);s.store_scalar(290, 0.0);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_56(
        ...
        s.store_scalar(291, 0.0);s.b[1459] = ((p[46] != 0.0) || (p[47] != 0.0));s.store_scalar(1459, if s.b[1459] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_61(
        ...
        s.store_mul(312, 423, 250);s.store_mul(315, 424, 300);s.store_scale(318, 428, (s.v[35] * p[2]));s.store_scalar(313, ((0.1) as f64).powf((-p[713])));s.b[1496] = (p[713] == 1.0);s.store_scalar(1496, if s.b[1496] { 1.0 } else { 0.0 });
