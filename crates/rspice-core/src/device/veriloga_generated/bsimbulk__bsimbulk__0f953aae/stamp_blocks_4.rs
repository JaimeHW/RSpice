...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_74(
        ...
        if (s.b[1562] && (!s.b[1574])) {s.store_limited_exp(15, 20);s.store_div_from_scalar(95, 1.0, 94);s.store_add_scaled_inputs3_mixed_iai(16, 15, 2.0, A::ln(A::max_with_scalar(A::mul3_scaled_output(s.ad_value(15), s.ad_value(12), A::add_scaled_product(s.ad_value(94), 2.0, s.ad_value(15), s.ad_value(12), 2.0), 2.0), 1e-38)), p[1137], 13, -1.0);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        if (!s.b[1587]) {s.store_div_mixed_ia(18, 219, A::powf(A::offset(A::powf(A::scale(s.ad_value(219), (-1.0 / (p[692]))), p[693]), 1.0), (1.0 / p[693])));s.store_sqrt_sub_from_scalar_ad(13, 1.0, A::div_scaled_inputs(s.ad_value(18), 4.0, s.ad_value(547), 1.0));s.store_add_scaled_products_mixed_iiia(223, 225, 231, ((-s.v[33]) * p[2]), 545, A::add_scaled_offset_product_rhs(A::add_scaled_inputs3(s.ad_value(231), 1.0, s.ad_value(63), (-1.0), s.ad_value(219), -1.0), 1.0, s.ad_value(547), s.ad_value(13), (-1.0), (-0.5)), ((-s.v[33]) * p[2]));s.store_sqrt_offset_ad(12, A::square(A::offset(A::sub(s.ad_value(232), s.ad_value(63)), 0.02)), (4.0 * 0.02));s.store_add_scaled_inputs3_offset_indices(220, 232, 0.5, 63, ((-1.0) * 0.5), 12, (-0.5), (0.02 * 0.5));s.store_div_mixed_ia(18, 220, A::powf(A::offset(A::powf(A::scale(s.ad_value(220), (-1.0 / (p[690]))), p[691]), 1.0), (1.0 / p[691])));s.store_sqrt_sub_from_scalar_ad(14, 1.0, A::div_scaled_inputs(s.ad_value(18), 4.0, s.ad_value(548), 1.0));s.store_add_scaled_products_mixed_iiia(224, 226, 232, ((-s.v[33]) * p[2]), 546, A::add_scaled_offset_product_rhs(A::add_scaled_inputs3(s.ad_value(232), 1.0, s.ad_value(63), (-1.0), s.ad_value(220), -1.0), 1.0, s.ad_value(548), s.ad_value(14), (-1.0), (-0.5)), ((-s.v[33]) * p[2]));}
