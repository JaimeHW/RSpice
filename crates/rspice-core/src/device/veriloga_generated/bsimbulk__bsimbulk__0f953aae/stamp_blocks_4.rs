...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_64(
        ...
        if (s.b[1484] && (!s.b[1487])) {s.store_div_scaled_value_by_product_indices(12, 307, -1.0, 394, 450, 1.0);s.store_offset_ad(13, A::limited_exp_div_scaled_inputs(s.ad_value(12), p[751], A::sub_from_scalar(p[751], s.ad_value(307)), 1.0), (-1.0));s.store_add_scaled_product_indices(304, 304, 1.0, 14, 13, (-1.0));}
    ...
    pub(super) fn stamp_transient_block_65(
        ...
        if (s.b[1488] && s.b[1489]) {s.store_div_scaled_value_by_product_indices(12, 307, -1.0, 394, 452, 1.0);s.store_offset_ad(13, A::limited_exp_scaled_input(s.ad_value(12), 1000.0), (-1.0));s.store_add_scaled_product_indices(304, 304, 1.0, 446, 13, (-(s.v[35] * p[2])));}
        if (s.b[1488] && (!s.b[1489])) {s.store_div_scaled_value_by_product_indices(12, 307, -1.0, 394, 452, 1.0);s.store_offset_ad(13, A::limited_exp_div_scaled_inputs(s.ad_value(12), p[753], A::sub_from_scalar(p[753], s.ad_value(307)), 1.0), (-1.0));s.store_add_scaled_product_indices(304, 304, 1.0, 446, 13, (-(s.v[35] * p[2])));}
        ...
        if ((s.b[1490] && s.b[1491]) && s.b[1492]) {s.store_div_scaled_value_by_product_indices(12, 309, -1.0, 394, 448, 1.0);s.store_offset_ad(13, A::limited_exp_scaled_input(s.ad_value(12), 1000.0), (-1.0));s.store_sub_mixed_ia(305, 305, A::mul3_scaled_output(s.ad_value(251), s.ad_value(442), s.ad_value(13), p[1128]));}
        if ((s.b[1490] && s.b[1491]) && (!s.b[1492])) {s.store_div_scaled_value_by_product_indices(12, 309, -1.0, 394, 448, 1.0);s.store_offset_ad(13, A::limited_exp_div_scaled_inputs(s.ad_value(12), p[749], A::sub_from_scalar(p[749], s.ad_value(309)), 1.0), (-1.0));s.store_sub_mixed_ia(305, 305, A::mul3_scaled_output(s.ad_value(251), s.ad_value(442), s.ad_value(13), p[1128]));}
        ...
        if ((s.b[1490] && s.b[1493]) && (!s.b[1495])) {s.store_div_scaled_value_by_product_indices(12, 309, -1.0, 394, 450, 1.0);s.store_offset_ad(13, A::limited_exp_div_scaled_inputs(s.ad_value(12), p[751], A::sub_from_scalar(p[751], s.ad_value(309)), 1.0), (-1.0));s.store_add_scaled_product_indices(305, 305, 1.0, 14, 13, (-1.0));}
        s.store_mul(312, 423, 250);s.store_mul(315, 424, 300);s.store_scale(318, 428, (s.v[35] * p[2]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_66(
        ...
        s.store_scalar(313, ((0.1) as f64).powf((-p[713])));s.b[1496] = (p[713] == 1.0);s.store_scalar(1496, if s.b[1496] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_67(
        ...
        if (s.b[1507] && (!s.b[1508])) {s.store_mul_scale_offset_mixed_ai(14, A::offset(s.ad_value(13), (-1.0)), 13, ((5.0 * p[717])) * (s.v[319]), ((((((-1.0)) * ((5.0 * p[717])))) + ((1.0 + p[717])))) * (s.v[319]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_68(
        ...
        if (s.b[1507] && (!s.b[1508])) {s.store_mul_ad_product_rhs_mixed_ia(333, 431, 318, A::add(s.ad_value(14), s.ad_value(320)));}
        ...
        s.store_scale(327, 425, (s.v[35] * p[2]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_69(
        ...
        s.store_scalar(322, ((0.1) as f64).powf((-p[714])));s.b[1513] = (p[714] == 1.0);s.store_scalar(1513, if s.b[1513] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_70(
        ...
        if (s.b[1524] && (!s.b[1525])) {s.store_mul_scale_offset_mixed_ai(14, A::offset(s.ad_value(13), (-1.0)), 13, ((5.0 * p[718])) * (s.v[328]), ((((((-1.0)) * ((5.0 * p[718])))) + ((1.0 + p[718])))) * (s.v[328]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_71(
        ...
        if (s.b[1524] && (!s.b[1525])) {s.store_mul_ad_product_rhs_mixed_ia(337, 434, 327, A::add(s.ad_value(14), s.ad_value(329)));}
        ...
        if s.b[1538] {s.store_powf_scaled_input(13, 481, 1.0000000000000001e-23, p[954]);s.store_powf_ad(14, A::div_from_scalar(300.0, s.ad_value(391)), p[955]);s.store_div_scaled_product_mixed_iai(15, 187, A::voltage(ctx, nodes, Some(11), Some(7)), p[953], 108, 1.0);s.store_scaled_limited_exp_ad(707, A::mul_scaled_lhs(s.ad_value(13), -1.0, s.ad_value(14)), p[948]);s.store_scaled_mul(708, 14, 13, p[949]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_72(
        ...
        if s.b[1538] {s.store_scale_ad(709, A::tanh(A::limited_exp(A::mul_scaled_lhs(s.ad_value(187), p[952], A::add_scaled_inputs3(A::voltage(ctx, nodes, Some(9), Some(11)), 1.0, s.ad_value(857), (-1.0), A::voltage(ctx, nodes, Some(7), Some(11)), -1.0)))), p[951]);s.store_mul_scale_offset(706, A::mul3(A::mul3_scaled_output(s.ad_value(57), s.ad_value(707), A::limited_exp(s.ad_value(15)), (p[2] * s.v[29])), A::limited_exp_scaled_input(s.ad_value(708), (-s.v[30])), A::limited_exp(A::div(s.ad_value(709), s.ad_value(108)))), A::limited_exp_div_scaled_inputs(s.ad_value(76), p[950], s.ad_value(108), 1.0), 1.0, (-1.0));}
        s.store_scale(377, 108, (4.0 * 1.60219e-19));s.store_div_scaled_inputs_indices(360, 502, 2.0, 157, 1.0);s.b[1539] = (p[784] <= 0.0);s.store_scalar(1539, if s.b[1539] { 1.0 } else { 0.0 });
        ...
        if (s.b[1541] && (!s.b[1542])) {s.store_limited_exp_neg_input(15, 14);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_73(
        s: &mut Scratch,
    ) {
        if (s.b[1541] && (!s.b[1542])) {s.store_scale(13, 205, 0.5);s.store_sub_mixed_ai(14, A::sqrt(A::add_scaled_inputs3_offset(s.ad_value(204), 1.0, s.ad_value(15), 1.0, A::square(s.ad_value(13)), 1.0, (-1.0))), 13);s.store_sub_offset_lhs_mixed_ai(715, A::square(s.ad_value(14)), 1.0, 15);}
    ...
    pub(super) fn stamp_transient_block_74(
        ...
        if s.b[1541] {s.store_offset_div_scaled_inputs_sqrt_rhs(718, 713, 1.0, 716, 2.0, 1.0);s.copy_ad(719, 157);s.store_scale(726, 719, (s.v[46] * s.v[29]));s.store_scale(725, 157, (s.v[46] * s.v[29]));s.store_div_scaled_product_by_product_mixed_iiai(720, 188, 746, 1.0, A::mul3_scaled_output(s.ad_value(718), s.ad_value(726), s.ad_value(108), 2.0), 108, 1.0);s.store_div_scaled_product_by_product_mixed_iaai(722, 188, A::sub(s.ad_value(745), s.ad_value(746)), 1.0, A::mul3_scaled_output(s.ad_value(90), s.ad_value(725), s.ad_value(106), 2.0), 106, 1.0);s.store_add_scaled_inputs3_offset_mixed_aii(12, A::square(s.ad_value(717)), 4.0, 717, 4.0, 720, (-4.0), 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_75(
        ...
        if s.b[1541] {s.store_offset_scaled_ad(723, A::sqrt(A::offset(A::add_scaled_inputs3(A::square(s.ad_value(144)), 4.0, s.ad_value(144), 4.0, s.ad_value(722), 4.0), 1.0)), 0.5, (-0.5));}
        ...
        if ((!s.b[1541]) && s.b[1552]) {s.store_primal_sub_from_scalar_scaled_input(361, s.v[30], 359, 2.0);s.store_primal_square(362, 361);s.store_scale(12, 362, (10000000000.0 * s.v[46]));s.store_mul_ad_affine_product_lhs(365, A::mul3_scaled_output(s.ad_value(90), s.ad_value(108), s.ad_value(200), (2.0 * s.v[46])), s.ad_value(628), 6.241457005723417e18, 0.0, 611);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_76(
        ...
        if ((s.b[1556] && (!s.b[1555])) && (!s.b[1557])) {s.store_scaled_add_sqrt_square_offset_rhs(24, 24, 24, ((0.25 * 0.1) * 0.1), 0.5);}
        if (s.b[1556] && (!s.b[1555])) {s.store_mul_div_scaled_inputs_mixed_aii(380, A::add_scaled_product(A::div_scaled_product(s.ad_value(19), s.ad_value(387), 1.0, s.ad_value(15), 12.0), 1.0, s.ad_value(13), s.ad_value(24), 1.0), 12, (p[2] * s.v[29]), 381, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_77(
        ...
        if (s.b[1556] && (!s.b[1555])) {s.store_div_scaled_product3_mixed_aaii(378, A::mul3(s.ad_value(381), s.ad_value(22), s.ad_value(22)), A::add_scaled_inputs3(A::div(s.ad_value(13), s.ad_value(16)), 1.0, A::div(s.ad_value(21), A::mul_scaled_lhs(s.ad_value(16), 60.0, s.ad_value(16))), (-1.0), A::div_scaled_product_by_product(s.ad_value(19), s.ad_value(19), 1.0, s.ad_value(16), s.ad_value(17), 144.0), 1.0), 388, (15.0 * 1.0 / (4.0)), 12, ((p[2] * s.v[29]) * 12.0));s.store_sqrt_mul(384, 377, 380);}
        ...
        s.b[1560] = (p[46] != 0.0);s.store_scalar(1560, if s.b[1560] { 1.0 } else { 0.0 });s.b[1561] = (p[47] != 0.0);s.store_scalar(1561, if s.b[1561] { 1.0 } else { 0.0 });s.copy_ad(60, 59);s.store_scalar(218, 0.0);s.b[1562] = (p[40] == 1.0);s.store_scalar(1562, if s.b[1562] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        if s.b[1562] {s.store_mul3_affine_lhs(130, 90, 108, 2.0, 0.0, 200);}
    }
}
