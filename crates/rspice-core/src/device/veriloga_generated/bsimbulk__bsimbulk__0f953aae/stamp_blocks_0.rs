...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if (s.b[1369] && (!s.b[1371])) {
            s.store_mul_div_scaled_inputs_rhs(17, 138, s.ad_value(13), (-2.0), s.ad_value(14), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        s.store_offset_add_scaled_inputs_mixed_ia(15, 14, 0.5, A::sqrt(A::offset(A::square(s.ad_value(14)), 0.004)), 0.5, (-1.0));
