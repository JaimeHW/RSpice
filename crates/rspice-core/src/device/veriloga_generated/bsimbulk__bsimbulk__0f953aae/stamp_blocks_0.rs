...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.store_ad_value(604, A::add_scaled_inputs3_offset(s.ad_value(476), p.p882, s.ad_value(477), p.p883, s.ad_value(478), p.p884, p.p881));
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_ad_value(601, A::add_scaled_inputs3_offset(s.ad_value(476), p.p621, s.ad_value(477), p.p622, s.ad_value(478), p.p623, p.p551));

        s.store_ad_value(602, A::add_scaled_inputs3_offset(s.ad_value(476), p.p624, s.ad_value(477), p.p625, s.ad_value(478), p.p626, p.p552));

        s.store_ad_value(603, A::add_scaled_inputs3_offset(s.ad_value(476), p.p627, s.ad_value(477), p.p628, s.ad_value(478), p.p629, p.p554));
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        s.store_ad_value(143, A::add_scaled_inputs4(s.ad_value(91), 1.0, s.ad_value(89), (-2.0), s.ad_value(131), (-2.0), A::ln(A::max_with_scalar(A::mul(A::mul3_scaled_output(s.ad_value(131), s.ad_value(90), s.ad_value(126), 2.0), A::add(A::mul3_scaled_output(s.ad_value(131), s.ad_value(90), s.ad_value(126), 2.0), A::div_scaled_value_offset_denominator(s.ad_value(125), 1.0, s.ad_value(90), (-1.0), 1.0))), 1e-38)), -1.0));
    ...
    pub(super) fn stamp_transient_block_14(
        ...
        if (s.b[1424] && s.b[1432]) {
            ...
            s.store_sqrt(96, 20);
            s.store_ad_value(12, A::div_scaled_offset_numerator(A::div_scaled_inputs(s.ad_value(765), 1.0, s.ad_value(96), 2.0), 1.0, 1.0, s.ad_value(765), 1.0));
            s.store_ad_value(13, A::add_scaled_inputs3(s.ad_value(767), 1.0, s.ad_value(766), (-2.0), A::div_scaled_product(s.ad_value(187), A::voltage(ctx, nodes, Some(7), Some(11)), 1.0, s.ad_value(108), 1.0), -1.0));
            s.store_sub_ad_rhs(14, 13, A::ln(A::max_with_scalar(A::mul_scaled_lhs(s.ad_value(12), 4.0, s.ad_value(96)), 1e-38)));
            s.store_scaled_sub_ad(20, A::offset(s.ad_value(14), (-0.201491)), A::sqrt(A::offset(A::mul_offset_rhs(s.ad_value(14), s.ad_value(14), 0.402982), 2.446562)), 0.5);
            s.copy_ad(94, 96);
        }
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if ((s.b[1451] && s.b[1454]) && (!s.b[1455])) {
            ...
            s.store_ad_value(14, A::add_scaled_inputs3_offset(A::add_scaled_product(s.ad_value(183), (-p.p512), s.ad_value(187), A::voltage(ctx, nodes, Some(0), Some(2)), 1.0), 0.5, A::powf(s.ad_value(760), p.p513), ((-p.p514) * 0.5), A::sqrt(A::offset(assign23370_ad_e32293, ((0.25 * 0.05) * 0.05))), 0.5, ((-p.p503) * 0.5)));
        }
