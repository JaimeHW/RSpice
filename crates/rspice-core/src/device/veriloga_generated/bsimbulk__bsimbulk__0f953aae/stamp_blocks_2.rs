...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if (s.b[1467] && (!s.b[1468])) {
            s.store_mul_product3_rhs(18, 17, s.ad_value(559), s.ad_value(13), A::limited_exp_scaled_input(s.ad_value(14), -1.0), s.v[29]);
        }
        ...
        if (s.b[1467] && (!s.b[1470])) {
            s.store_mul_product3_rhs(18, 17, s.ad_value(563), s.ad_value(13), A::limited_exp_scaled_input(s.ad_value(14), -1.0), s.v[29]);
        }
        ...
        if (s.b[1473] && (!s.b[1474])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(306), -1.0, s.ad_value(394), s.ad_value(447), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p748, A::sub_from_scalar(p.p748, s.ad_value(306)), 1.0, (-1.0));
        }
        ...
        if (s.b[1475] && (!s.b[1476])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(306), -1.0, s.ad_value(394), s.ad_value(449), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p750, A::sub_from_scalar(p.p750, s.ad_value(306)), 1.0, (-1.0));
        }
        ...
        if (s.b[1477] && (!s.b[1478])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(306), -1.0, s.ad_value(394), s.ad_value(451), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p752, A::sub_from_scalar(p.p752, s.ad_value(306)), 1.0, (-1.0));
        }
        ...
        if (s.b[1482] && (!s.b[1483])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(307), -1.0, s.ad_value(394), s.ad_value(448), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p749, A::sub_from_scalar(p.p749, s.ad_value(307)), 1.0, (-1.0));
        }
        ...
        if (s.b[1484] && (!s.b[1487])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(307), -1.0, s.ad_value(394), s.ad_value(450), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p751, A::sub_from_scalar(p.p751, s.ad_value(307)), 1.0, (-1.0));
        }
        ...
        if (s.b[1488] && (!s.b[1489])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(307), -1.0, s.ad_value(394), s.ad_value(452), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p753, A::sub_from_scalar(p.p753, s.ad_value(307)), 1.0, (-1.0));
        }
        ...
        if ((s.b[1490] && s.b[1491]) && (!s.b[1492])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(309), -1.0, s.ad_value(394), s.ad_value(448), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p749, A::sub_from_scalar(p.p749, s.ad_value(309)), 1.0, (-1.0));
        }
        ...
        if ((s.b[1490] && s.b[1493]) && (!s.b[1495])) {
            s.store_div_scaled_value_by_product(12, s.ad_value(309), -1.0, s.ad_value(394), s.ad_value(450), 1.0);
            s.store_offset_limited_exp_div_scaled_inputs_mixed_ia(13, 12, p.p751, A::sub_from_scalar(p.p751, s.ad_value(309)), 1.0, (-1.0));
        }
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        if s.b[1588] {
            ...
            s.store_mul_product3_rhs(672, 175, A::mul3_scaled_output(s.ad_value(691), s.ad_value(157), s.ad_value(106), ((2.0 * p.p2) * ((p.p957 * 1.0 / (s.v[30])) * s.v[46]))), s.ad_value(106), A::mul(A::sub(s.ad_value(693), s.ad_value(692)), A::add(A::offset(s.ad_value(693), 1.0), s.ad_value(692))), 1.0);
    ...
    if (s.b[1556] && (!s.b[1555])) {
        ...
        let eq19_node_derivatives: [f64; 17] = [(s.dn[787][0] * ddt_scale), (s.dn[787][1] * ddt_scale), (s.dn[787][2] * ddt_scale), (s.dn[787][3] * ddt_scale), (s.dn[787][4] * ddt_scale), (s.dn[787][5] * ddt_scale), (s.dn[787][6] * ddt_scale), (s.dn[787][7] * ddt_scale), (s.dn[787][8] * ddt_scale), (s.dn[787][9] * ddt_scale), (s.dn[787][10] * ddt_scale), (s.dn[787][11] * ddt_scale), (s.dn[787][12] * ddt_scale), (s.dn[787][13] * ddt_scale), (s.dn[787][14] * ddt_scale), (s.dn[787][15] * ddt_scale), (s.dn[787][16] * ddt_scale)];
        let eq19_branch_derivatives: [f64; 14] = [(s.db[787][0] * ddt_scale), (s.db[787][1] * ddt_scale), (s.db[787][2] * ddt_scale), (s.db[787][3] * ddt_scale), (s.db[787][4] * ddt_scale), (s.db[787][5] * ddt_scale), (s.db[787][6] * ddt_scale), (s.db[787][7] * ddt_scale), (s.db[787][8] * ddt_scale), (s.db[787][9] * ddt_scale), (s.db[787][10] * ddt_scale), (s.db[787][11] * ddt_scale), (s.db[787][12] * ddt_scale), (s.db[787][13] * ddt_scale)];
        stamper.stamp_current_dense_local(
            Some(9),
            Some(11),
        ...
        let eq20_node_derivatives: [f64; 17] = [(s.dn[785][0] * ddt_scale), (s.dn[785][1] * ddt_scale), (s.dn[785][2] * ddt_scale), (s.dn[785][3] * ddt_scale), (s.dn[785][4] * ddt_scale), (s.dn[785][5] * ddt_scale), (s.dn[785][6] * ddt_scale), (s.dn[785][7] * ddt_scale), (s.dn[785][8] * ddt_scale), (s.dn[785][9] * ddt_scale), (s.dn[785][10] * ddt_scale), (s.dn[785][11] * ddt_scale), (s.dn[785][12] * ddt_scale), (s.dn[785][13] * ddt_scale), (s.dn[785][14] * ddt_scale), (s.dn[785][15] * ddt_scale), (s.dn[785][16] * ddt_scale)];
        let eq20_branch_derivatives: [f64; 14] = [(s.db[785][0] * ddt_scale), (s.db[785][1] * ddt_scale), (s.db[785][2] * ddt_scale), (s.db[785][3] * ddt_scale), (s.db[785][4] * ddt_scale), (s.db[785][5] * ddt_scale), (s.db[785][6] * ddt_scale), (s.db[785][7] * ddt_scale), (s.db[785][8] * ddt_scale), (s.db[785][9] * ddt_scale), (s.db[785][10] * ddt_scale), (s.db[785][11] * ddt_scale), (s.db[785][12] * ddt_scale), (s.db[785][13] * ddt_scale)];
        stamper.stamp_current_dense_local(
            Some(7),
            Some(11),
        ...
        let eq21_node_derivatives: [f64; 17] = [(s.dn[786][0] * ddt_scale), (s.dn[786][1] * ddt_scale), (s.dn[786][2] * ddt_scale), (s.dn[786][3] * ddt_scale), (s.dn[786][4] * ddt_scale), (s.dn[786][5] * ddt_scale), (s.dn[786][6] * ddt_scale), (s.dn[786][7] * ddt_scale), (s.dn[786][8] * ddt_scale), (s.dn[786][9] * ddt_scale), (s.dn[786][10] * ddt_scale), (s.dn[786][11] * ddt_scale), (s.dn[786][12] * ddt_scale), (s.dn[786][13] * ddt_scale), (s.dn[786][14] * ddt_scale), (s.dn[786][15] * ddt_scale), (s.dn[786][16] * ddt_scale)];
        let eq21_branch_derivatives: [f64; 14] = [(s.db[786][0] * ddt_scale), (s.db[786][1] * ddt_scale), (s.db[786][2] * ddt_scale), (s.db[786][3] * ddt_scale), (s.db[786][4] * ddt_scale), (s.db[786][5] * ddt_scale), (s.db[786][6] * ddt_scale), (s.db[786][7] * ddt_scale), (s.db[786][8] * ddt_scale), (s.db[786][9] * ddt_scale), (s.db[786][10] * ddt_scale), (s.db[786][11] * ddt_scale), (s.db[786][12] * ddt_scale), (s.db[786][13] * ddt_scale)];
        stamper.stamp_current_dense_local(
            Some(5),
            Some(11),
