...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (s.b[1346] && s.b[1347]) {s.store_mul_div_scaled_inputs_mixed_aii(688, A::sub(s.ad_value(655), s.ad_value(653)), 625, 1.0, 647, 1.0);s.store_mul_div_scaled_inputs_mixed_aia(689, A::sub(s.ad_value(655), s.ad_value(653)), 626, 1.0, A::powf(s.ad_value(647), p[930]), 1.0);s.store_mul_div_scaled_inputs_mixed_aia(690, A::sub(s.ad_value(655), s.ad_value(653)), 627, 1.0, A::powf(s.ad_value(647), p[932]), 1.0);}
        ...
        if ((s.b[1348] && s.b[1349]) && s.b[1350]) {s.store_offset(13, 668, p[23]);s.store_scalar(14, (1.0 / p[947]));s.store_div_from_scalar_scaled_input(669, (p[947] * p[947]), 13, p[23]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_33(
        ...
        if s.b[1352] {s.store_scalar(57, (-1.0));s.store_mul_voltage_ad(66, s.ad_value(187), ctx, nodes, Some(7), Some(11));s.store_mul_voltage_ad(70, s.ad_value(187), ctx, nodes, Some(5), Some(11));s.copy_ad(72, 69);s.store_mul_voltage_ad(68, s.ad_value(187), ctx, nodes, Some(7), Some(11));}
        ...
        s.store_offset_sub_scaled_inputs_indices(76, 13, (2.0 / p[956]), 74, 1.0, (-((2.0 / p[956]) * ((2.0) as f64).ln())));s.store_add_scaled_inputs3_indices(61, 70, (-1.0), 74, (-0.5), 76, (-(-0.5)));s.store_tanh_ad(12, A::div_scaled_inputs(s.ad_value(56), p[1123], s.ad_value(393), 1.0));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_34(
        ...
        s.store_offset_scaled(102, 12, 0.5, 0.5);s.store_sub_from_scalar(103, 1.0, 102);s.b[1353] = (p[44] != 0.0);s.store_scalar(1353, if s.b[1353] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        if (!((((((s.v[70] * s.v[109]) + (2.0 * s.v[88])) + (((s.v[710]).max(1e-38)) as f64).ln()) + (2.0 * s.v[710])) + ((((((2.0 * s.v[90]) / s.v[125]) * ((((2.0 * s.v[710]) * s.v[90]) / s.v[125]) + (2.0 * ((s.v[12]) as f64).sqrt())))).max(1e-38)) as f64).ln()) < ((-10000.0) * 0.001))) {
            let t2: A = A::sqrt(s.ad_value(12));let t3: A = A::ln(A::max_with_scalar(A::mul(A::div_scaled_inputs(s.ad_value(90), 2.0, s.ad_value(125), 1.0), A::add_scaled_inputs(A::div_scaled_inputs(s.ad_value(90), (2.0 * s.v[710]), s.ad_value(125), 1.0), 1.0, t2, 2.0)), 1e-38));s.store_add_scaled_inputs3_offset(711, A::add_scaled_product(s.ad_value(88), 2.0, s.ad_value(70), s.ad_value(109), 1.0), 0.5, t3, 0.5, A::sqrt_square_offset(A::add(A::offset(A::add_scaled_product(s.ad_value(88), 2.0, s.ad_value(70), s.ad_value(109), 1.0), (((((s.v[710]).max(1e-38)) as f64).ln()) + ((2.0 * s.v[710])))), t3), ((4.0 * 0.001) * 0.001)), 0.5, ((((((s.v[710]).max(1e-38)) as f64).ln()) + ((2.0 * s.v[710]))) * 0.5));
        } else {
            if ((((((s.v[70] * s.v[109]) + (2.0 * s.v[88])) + (((s.v[710]).max(1e-38)) as f64).ln()) + (2.0 * s.v[710])) + ((((((2.0 * s.v[90]) / s.v[125]) * ((((2.0 * s.v[710]) * s.v[90]) / s.v[125]) + (2.0 * ((s.v[12]) as f64).sqrt())))).max(1e-38)) as f64).ln()) < ((-10000.0) * 0.001)) {
    ...
    pub(super) fn stamp_transient_block_36(
        ...
        if ((s.b[1359] && (!s.b[1360])) && (!s.b[1361])) {s.store_div_scaled_inputs2_indices(14, 20, 1.0, 16, (-1.0), 17, 1.0);s.store_square(18, 14);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_37(
        s: &mut Scratch,
    ) {
        if ((s.b[1359] && (!s.b[1360])) && (!s.b[1361])) {s.store_limited_exp_ad(15, A::add_scaled_product(s.ad_value(16), 1.0, s.ad_value(17), A::add(A::scale_offset(s.ad_value(14), 0.5, (5.0 / 64.0)), A::mul_sub_from_scalar_rhs(s.ad_value(18), (15.0 / 16.0), A::mul_sub_from_scalar_rhs(s.ad_value(18), 1.25, s.ad_value(18)))), 1.0));}
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        if (!s.b[1359]) {s.store_add_scaled_offset_product_rhs_mixed_iaa(200, 15, 1.0, A::div(s.ad_value(16), s.ad_value(17)), A::div_scaled_product_by_product(s.ad_value(16), s.ad_value(19), 1.0, s.ad_value(17), s.ad_value(17), 2.0), 1.0, (-1.0));}
        ...
        if (!s.b[1366]) {s.store_offset_mul(12, 526, 130, 1.0);s.store_mul_sub_rhs(13, 543, 111, 128);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_39(
        ...
        if (!s.b[1366]) {s.store_add_mixed_ai(14, A::div_from_scalar(1.0, s.ad_value(12)), 13);s.store_add_mixed_ia(15, 14, A::sqrt_square_offset(s.ad_value(14), 0.01));}
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (!s.b[1381]) {s.store_limited_exp(15, 20);s.store_div_from_scalar(95, 1.0, 94);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_43(
        s: &mut Scratch,
    ) {
        if (!s.b[1381]) {s.store_add_scaled_inputs3_mixed_iai(16, 15, 2.0, A::ln(A::max_with_scalar(A::mul3_scaled_output(s.ad_value(15), s.ad_value(12), A::add_scaled_product(s.ad_value(94), 2.0, s.ad_value(15), s.ad_value(12), 2.0), 2.0), 1e-38)), 1.0, 13, -1.0);s.store_add_ad(17, A::offset(A::div_from_scalar(1.0, s.ad_value(15)), 2.0), A::div_scaled_inputs2(s.ad_value(12), 1.0, s.ad_value(95), 1.0, A::add_scaled_product(s.ad_value(94), 1.0, s.ad_value(12), s.ad_value(15), 1.0), 1.0));s.store_sub_div_rhs_indices(15, 15, 16, 17);s.store_add_scaled_inputs3_mixed_iai(16, 15, 2.0, A::ln(A::max_with_scalar(A::mul3_scaled_output(s.ad_value(15), s.ad_value(12), A::add_scaled_product(s.ad_value(94), 2.0, s.ad_value(15), s.ad_value(12), 2.0), 2.0), 1e-38)), 1.0, 13, -1.0);s.store_add_ad(17, A::offset(A::div_from_scalar(1.0, s.ad_value(15)), 2.0), A::div_scaled_inputs2(s.ad_value(12), 1.0, s.ad_value(95), 1.0, A::add_scaled_product(s.ad_value(94), 1.0, s.ad_value(12), s.ad_value(15), 1.0), 1.0));s.store_scaled_mul_ad(18, A::div_scaled_inputs2(s.ad_value(12), 1.0, s.ad_value(95), 1.0, A::add_scaled_product(s.ad_value(94), 1.0, s.ad_value(12), s.ad_value(15), 1.0), 1.0), A::div_scaled_inputs2(s.ad_value(12), 1.0, s.ad_value(95), 1.0, A::add_scaled_product(s.ad_value(94), 1.0, s.ad_value(12), s.ad_value(15), 1.0), 1.0), 1.0);s.store_sub_mixed_ai(19, A::add_scaled_product(A::div_from_scalar(1.0, A::mul3(A::square(s.ad_value(94)), s.ad_value(94), A::add_scaled_product(s.ad_value(94), 1.0, s.ad_value(12), s.ad_value(15), 1.0))), (-1.0), A::div_from_scalar(1.0, s.ad_value(15)), A::div_from_scalar(1.0, s.ad_value(15)), (-1.0)), 18);s.store_add_scaled_offset_product_rhs_mixed_iaa(144, 15, 1.0, A::div(s.ad_value(16), s.ad_value(17)), A::div_scaled_product_by_product(s.ad_value(16), s.ad_value(19), 1.0, s.ad_value(17), s.ad_value(17), 2.0), 1.0, (-1.0));}
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        s.store_sub(167, 74, 139);s.store_add_scaled_inputs(174, 80, 1.0, 106, 2.0);s.b[1388] = (s.v[171] > 0.0);s.store_scalar(1388, if s.b[1388] { 1.0 } else { 0.0 });
        ...
        s.store_offset_div(177, 167, 169, 1.0);s.store_mul(175, 175, 177);
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_47(
        ...
        if s.b[1398] {s.store_scaled_add_mixed_ia(16, 18, A::sqrt_square_offset(s.ad_value(18), 0.01), 0.5);s.store_mul_add_scaled_product_rhs_mixed_iai(242, 408, 240, 1.0, A::add_scaled_product(s.ad_value(528), 1.0, s.ad_value(530), s.ad_value(16), 1.0), 235, 1.0);}
        if (!s.b[1398]) {s.store_offset_mul(12, 526, 80, 1.0);s.store_mul_sub_rhs(13, 543, 111, 128);s.store_add_mixed_ai(14, A::div_from_scalar(1.0, s.ad_value(12)), 13);s.store_scaled_add_mixed_ia(15, 14, A::sqrt_square_offset(s.ad_value(14), 0.01), 0.5);s.store_mul_ad_affine_product_lhs(244, s.ad_value(408), A::add_scaled_product(s.ad_value(533), 1.0, s.ad_value(532), s.ad_value(15), 1.0), p[2], 0.0, 235);s.copy_ad(242, 240);s.copy_ad(241, 239);s.store_offset_product3(245, A::div(s.ad_value(499), A::mul(s.ad_value(162), s.ad_value(159))), s.ad_value(80), s.ad_value(244), ((s.v[46] * s.v[29]) * 1.0 / (s.v[30])), 1.0);}
        ...
        s.store_add_div_rhs_mixed_ia(12, 150, 153, A::add_scaled_product(s.ad_value(80), 1.0, s.ad_value(104), s.ad_value(393), 2.0));s.store_sub(216, 200, 144);s.store_mul3_lhs(13, 12, 216, 216);s.store_offset(14, 13, ((1.0) + ((-0.001))));s.store_offset_add_scaled_inputs_mixed_ia(15, 14, 0.5, A::sqrt_square_offset(s.ad_value(14), 0.004), 0.5, (-1.0));s.store_scaled_offset_ad(154, A::sqrt(A::offset(s.ad_value(15), 1.0)), 1.0, 0.5);s.store_offset_sub_scaled_inputs(154, A::offset(s.ad_value(154), 1.0), 0.5, A::sqrt_square_offset(A::offset(s.ad_value(154), (-1.0)), ((0.25 * 0.01) * 0.01)), 0.5, (0.25 * 0.01));s.store_add(12, 200, 144);s.store_sub(13, 200, 144);s.store_div_add_scaled_inputs_rhs_indices(14, 13, 12, 1.0, 610, 1.0);s.store_mul3_lhs(15, 609, 14, 14);s.store_offset(611, 15, 1.0);
    }
}
