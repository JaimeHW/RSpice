...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        s.store_offset_div_ad(90, s.ad_value(125), A::add(s.ad_value(96), A::sqrt(s.ad_value(12))), 1.0);s.store_scalar(155, (1e-8 / (s.v[47] * p[77])));
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        s.store_div_scaled_product_offset_denominator_mixed_iia(14, 200, 13, (10.0 * p[433]), A::mul(s.ad_value(200), s.ad_value(13)), (10.0 * p[433]), 1.0);s.b[1368] = (s.v[536] < 0.0);s.store_scalar(1368, if s.b[1368] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_46(
        ...
        if (s.b[1400] && s.b[1404]) {s.store_mul(750, 18, 750);s.store_mul3_affine_lhs(19, 762, 235, p[1110], 0.0, 16);s.store_mul(755, 750, 19);let t2: A = A::powf(s.ad_value(757), (4.0 - p[1107]));s.store_div_ad(752, t2, A::add_scaled_inputs(t2, 1.0, A::powf(s.ad_value(755), (4.0 - p[1107])), p[1122]));s.store_powf(17, 752, (1.0 / p[1107]));s.store_div_scaled_product_indices(20, 17, 757, 1.0, 755, 1.0);}
    ...
    pub(super) fn stamp_transient_block_47(
        ...
        if (s.b[1400] && s.b[1412]) {s.store_mul(751, 18, 751);s.store_mul3_affine_lhs(19, 762, 235, p[1112], 0.0, 16);s.store_mul(756, 751, 19);let t3: A = A::powf(s.ad_value(758), (4.0 - p[1107]));s.store_div_ad(752, t3, A::add_scaled_inputs(t3, 1.0, A::powf(s.ad_value(756), (4.0 - p[1107])), p[1122]));s.store_powf(17, 752, (1.0 / p[1107]));s.store_div_scaled_product_indices(20, 17, 758, 1.0, 756, 1.0);}
