...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_47(
        ...
        if s.b[1398] {s.store_scaled_add_sqrt_square_offset_rhs(16, 18, 18, 0.01, 0.5);s.store_mul_add_scaled_product_rhs_mixed_iai(242, 408, 240, 1.0, A::add_scaled_product(s.ad_value(528), 1.0, s.ad_value(530), s.ad_value(16), 1.0), 235, 1.0);}
        if (!s.b[1398]) {s.store_offset_mul(12, 526, 80, 1.0);s.store_mul_sub_rhs(13, 543, 111, 128);s.store_add_mixed_ai(14, A::div_from_scalar(1.0, s.ad_value(12)), 13);s.store_scaled_add_sqrt_square_offset_rhs(15, 14, 14, 0.01, 0.5);s.store_mul_ad_affine_product_lhs(244, s.ad_value(408), A::add_scaled_product(s.ad_value(533), 1.0, s.ad_value(532), s.ad_value(15), 1.0), p[2], 0.0, 235);s.copy_ad(242, 240);s.copy_ad(241, 239);s.store_offset_product3(245, A::div(s.ad_value(499), A::mul(s.ad_value(162), s.ad_value(159))), s.ad_value(80), s.ad_value(244), ((s.v[46] * s.v[29]) * 1.0 / (s.v[30])), 1.0);}
