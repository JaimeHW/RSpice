...
impl Instance {
    ...
    if (p.p52 != 0.0) {
        ...
        s.store_ad_value(1842, A::div_scaled_product_offset_denominator(A::div_from_scalar((1.0 + (s.v[1826] * s.v[1804])), A::scale_offset(s.ad_value(1803), s.v[1826], 1.0)), A::scale_offset(s.ad_value(1896), (s.v[1827] * 1.0 / (s.v[1807])), 1.0), s.v[1818], A::div_scaled_inputs(s.ad_value(1855), s.v[1822], s.ad_value(1808), 1.0), 1.0, 1.0));
