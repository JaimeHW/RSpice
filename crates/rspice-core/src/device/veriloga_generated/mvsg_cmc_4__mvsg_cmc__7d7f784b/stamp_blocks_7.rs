...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_115(
        ...
        if (l.f1fd4 != 0.0) {
            ...
            let (t106, t108, t107,) = {
    if (p[52] != 0.0) {
        let tf8: f64 = (l.f135a / l.f135e);let tf9: f64 = (0.001 / p[53]);let tfa: f64 = (l.f135a / l.f135e);let tfb: f64 = (tf9 * tfa);let tfc: f64 = (tfb).tanh();let tfd: f64 = (tf8 * tfc);
        ...
        let (t103, t105, t104,) = {
            if (p[52] == 0.0) {
                let __rspice_inv_cse_0: f64 = 1.0 / l.f135e;let tfe: f64 = (l.f135a * __rspice_inv_cse_0);let tff: f64 = (l.f135a * __rspice_inv_cse_0);let t100: f64 = (tfe * tff);let t101: f64 = (t100 + p[53]);let t102: f64 = (t101).sqrt();
    ...
    if ((!(l.f1313 > 50.0)) && (!(l.f1313 < t116))) {
        ...
        let t12e: f64 = if p[282] == 1.0 { 1.0 } else { 0.0 };l.f1fdf = t12e;
        if ((l.f1fd4 != 0.0) && (l.f1fdf != 0.0)) {(l.f13d2, l.f13d4, l.f13d5, l.f13d3, ) = (0.0, 0.0, 0.0, 0.0, );(l.f13c5, l.f13c6, ) = (0.0, 0.0, );(l.f13c7, l.f13c8, ) = (0.0, 0.0, );let t12f: f64 = (p[6] * (nv8 - nv13));(l.f13dc, l.f13de, l.f13dd, ) = (t12f, p[6], (-p[6]), );(l.f13d0, l.f13d1, ) = (l.f215b, l.f215c, );l.f13df = p[260];l.f1363 = p[262];l.f139f = 1.0;l.f13cd = p[258];l.f13cb = p[278];l.f13db = p[277];(l.f13d8, l.f13d9, ) = (l.f22f2, l.f22f3, );l.f13e2 = p[0];l.f13ca = p[2];l.f13c3 = 0.0;l.f13c9 = 0.0;l.f13e0 = p[285];l.f1364 = p[286];let t130: f64 = (1.0 - p[255]);let t131: f64 = (t130 * p[284]);l.f13c4 = t131;l.f13cf = p[283];}
    }
    #[inline(never)]
    ...
    if ((!(l.f1389 > 50.0)) && (!(l.f1389 < t1d8))) {
        ...
        if ((l.f1fd4 != 0.0) && (l.f1fdf != 0.0)) {
            ...
            let (t213, t215, t214,) = {
    if (p[52] != 0.0) {
        let t205: f64 = (l.f13dc / l.f13e0);let t206: f64 = (0.001 / p[53]);let t207: f64 = (l.f13dc / l.f13e0);let t208: f64 = (t206 * t207);let t209: f64 = (t208).tanh();let t20a: f64 = (t205 * t209);
        ...
        let (t210, t212, t211,) = {
            if (p[52] == 0.0) {
                let __rspice_inv_cse_0: f64 = 1.0 / l.f13e0;let t20b: f64 = (l.f13dc * __rspice_inv_cse_0);let t20c: f64 = (l.f13dc * __rspice_inv_cse_0);let t20d: f64 = (t20b * t20c);let t20e: f64 = (t20d + p[53]);let t20f: f64 = (t20e).sqrt();
    ...
    pub(super) fn stamp_transient_block_122(
        ...
        if ((l.f1fd4 != 0.0) && (l.f1fdf != 0.0)) {
            ...
            let (t31f, t321, t320,) = {
    if (p[52] != 0.0) {
        let t311: f64 = (l.f145e / l.f1462);let t312: f64 = (0.001 / p[53]);let t313: f64 = (l.f145e / l.f1462);let t314: f64 = (t312 * t313);let t315: f64 = (t314).tanh();let t316: f64 = (t311 * t315);
        ...
        let (t31c, t31e, t31d,) = {
            if (p[52] == 0.0) {
                let __rspice_inv_cse_0: f64 = 1.0 / l.f1462;let t317: f64 = (l.f145e * __rspice_inv_cse_0);let t318: f64 = (l.f145e * __rspice_inv_cse_0);let t319: f64 = (t317 * t318);let t31a: f64 = (t319 + p[53]);let t31b: f64 = (t31a).sqrt();
    ...
    if ((!(l.f1417 > 50.0)) && (!(l.f1417 < t32f))) {
        ...
        let t347: f64 = if p[255] != 0.0 { 1.0 } else { 0.0 };l.f1fea = t347;
        if ((l.f1fd4 != 0.0) && (l.f1fea != 0.0)) {(l.f14d6, l.f14d7, l.f14d8, l.f14d9, ) = (0.0, 0.0, 0.0, 0.0, );(l.f14c9, l.f14ca, ) = (0.0, 0.0, );(l.f14cb, l.f14cc, ) = (0.0, 0.0, );let t348: f64 = (p[6] * (nv8 - nv9));(l.f14e0, l.f14e1, l.f14e2, ) = (t348, p[6], (-p[6]), );(l.f14d4, l.f14d5, ) = (l.f215b, l.f215c, );l.f14e3 = p[260];l.f1467 = p[262];l.f14a3 = p[261];l.f14d1 = p[258];l.f14cf = p[278];l.f14df = p[277];(l.f14dc, l.f14dd, ) = (l.f22f2, l.f22f3, );l.f14e6 = p[0];l.f14ce = p[2];let t349: f64 = (p[255] * p[259]);l.f14c7 = t349;l.f14cd = p[276];l.f14e4 = p[270];l.f1468 = p[271];let t34a: f64 = (p[255] * p[269]);l.f14c8 = t34a;l.f14d3 = p[268];l.f14d0 = p[257];l.f14e5 = p[256];l.f14de = p[6];(l.f14c3, l.f14c4, l.f14c5, l.f14c6, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1465, l.f1466, ) = (0.0, 0.0, );(l.f14da, l.f14db, ) = (0.0, 0.0, );(l.f149f, l.f14a0, l.f14a1, l.f14a2, ) = (0.0, 0.0, 0.0, 0.0, );(l.f14a7, l.f14a8, l.f14a9, l.f14aa, ) = (0.0, 0.0, 0.0, 0.0, );(l.f14ad, l.f14ae, l.f14af, l.f14b0, ) = (0.0, 0.0, 0.0, 0.0, );(l.f14a4, l.f14a5, l.f14a6, ) = (0.0, 0.0, 0.0, );(l.f14bf, l.f14c0, l.f14c1, l.f14c2, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1471, l.f1472, l.f1473, l.f1474, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1477, l.f1478, ) = (0.0, 0.0, );(l.f1469, l.f146a, l.f146b, l.f146c, ) = (0.0, 0.0, 0.0, 0.0, );(l.f146f, l.f1470, ) = (0.0, 0.0, );(l.f149d, l.f149e, ) = (0.0, 0.0, );(l.f1479, l.f147a, l.f147b, l.f147c, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1489, l.f148a, l.f148b, l.f148c, ) = (0.0, 0.0, 0.0, 0.0, );(l.f147d, l.f147e, l.f147f, l.f1480, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1499, l.f149a, l.f149b, l.f149c, ) = (0.0, 0.0, 0.0, 0.0, );(l.f1495, l.f1496, l.f1497, l.f1498, ) = (0.0, 0.0, 0.0, 0.0, );}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_125(
        ...
        if ((l.f1fd4 != 0.0) && (l.f1fea != 0.0)) {
            ...
            let (t42c, t42d, t42e,) = {
    if (p[52] != 0.0) {
        let t41e: f64 = (l.f14e0 / l.f14e4);let t41f: f64 = (0.001 / p[53]);let t420: f64 = (l.f14e0 / l.f14e4);let t421: f64 = (t41f * t420);let t422: f64 = (t421).tanh();let t423: f64 = (t41e * t422);
        ...
        let (t429, t42a, t42b,) = {
            if (p[52] == 0.0) {
                let __rspice_inv_cse_0: f64 = 1.0 / l.f14e4;let t424: f64 = (l.f14e0 * __rspice_inv_cse_0);let t425: f64 = (l.f14e0 * __rspice_inv_cse_0);let t426: f64 = (t424 * t425);let t427: f64 = (t426 + p[53]);let t428: f64 = (t427).sqrt();
