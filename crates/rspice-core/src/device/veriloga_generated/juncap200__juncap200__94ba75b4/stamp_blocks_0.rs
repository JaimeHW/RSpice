...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        if ((s.b[199] && (!s.b[253])) && (!s.b[257])) {
            s.store_div_scaled_product_denominator_ad(235, 224, 234, 1.0, A::add(s.ad_value(224), s.ad_value(234)), 1.0);
            s.store_sqrt_scaled_input_ad(236, A::div(s.ad_value(228), s.ad_value(232)), 0.375);
            s.store_add_scaled_product_indices(237, 231, (-1.0), 229, 232, 2.0);
        ...
        if (((s.b[199] && (!s.b[253])) && (!s.b[263])) && s.b[264]) {
            s.store_sqrt_scaled_input_ad(218, A::sub_from_scalar(p.p18, s.ad_value(216)), s.v[67]);
        }
    ...
    pub(super) fn stamp_transient_block_2(
        ...
        if (((s.b[199] && (!s.b[270])) && (!s.b[280])) && s.b[281]) {
            s.store_sqrt_scaled_input_ad(218, A::sub_from_scalar(p.p19, s.ad_value(216)), s.v[68]);
        }
        ...
        if (((s.b[199] && (!s.b[287])) && (!s.b[297])) && s.b[298]) {
            s.store_sqrt_scaled_input_ad(218, A::sub_from_scalar(p.p20, s.ad_value(216)), s.v[69]);
        }
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if s.b[199] {
            ...
            s.store_add_scaled_offset_product_rhs_mixed_iia(121, 116, 1.0, 161, A::exp_scaled_input(s.ad_value(126), (s.v[9] * s.v[162])), (-1.0), (-1.0));
            s.store_add_scaled_offset_product_rhs_mixed_iia(122, 117, 1.0, 161, A::exp_scaled_input(s.ad_value(127), (s.v[9] * s.v[162])), (-1.0), (-1.0));
        }
        ...
        if (s.b[199] && s.b[528]) {
            s.store_add_scaled_offset_product_rhs_mixed_aia(118, A::add_scaled_offset_product_rhs(s.ad_value(113), 1.0, s.ad_value(161), A::exp_scaled_input(s.ad_value(123), (s.v[9] * s.v[162])), (-1.0), (-1.0)), 1.0, 163, A::exp(A::mul_scaled_lhs(s.ad_value(123), s.v[9], s.ad_value(164))), (-1.0), (-1.0));
            s.store_add_scaled_offset_product_rhs_mixed_aia(119, A::add_scaled_offset_product_rhs(s.ad_value(114), 1.0, s.ad_value(161), A::exp_scaled_input(s.ad_value(124), (s.v[9] * s.v[162])), (-1.0), (-1.0)), 1.0, 163, A::exp(A::mul_scaled_lhs(s.ad_value(124), s.v[9], s.ad_value(164))), (-1.0), (-1.0));
            s.store_add_scaled_offset_product_rhs_mixed_aia(120, A::add_scaled_offset_product_rhs(s.ad_value(115), 1.0, s.ad_value(161), A::exp_scaled_input(s.ad_value(125), (s.v[9] * s.v[162])), (-1.0), (-1.0)), 1.0, 163, A::exp(A::mul_scaled_lhs(s.ad_value(125), s.v[9], s.ad_value(164))), (-1.0), (-1.0));
        }
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if s.b[595] {
            ...
            s.store_div_scaled_product_denominator_ad(598, 547, 153, 2.0, A::add(s.ad_value(554), s.ad_value(556)), 1.0);
        }
        ...
        if ((!s.b[595]) && s.b[605]) {
            ...
            s.store_sub(555, 153, 553);
            s.store_sqrt_square_add(556, 555, 551);
            s.store_div_scaled_product_denominator_ad(558, 547, 153, 2.0, A::add(s.ad_value(554), s.ad_value(556)), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if (((!s.b[595]) && (!s.b[610])) && (!s.b[614])) {
            s.store_div_scaled_product_denominator_ad(583, 572, 582, 1.0, A::add(s.ad_value(572), s.ad_value(582)), 1.0);
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        if (((!s.b[595]) && (!s.b[646])) && s.b[663]) {
            ...
            s.store_sub(555, 153, 553);
            s.store_sqrt_square_add(556, 555, 551);
            s.store_div_scaled_product_denominator_ad(594, 593, 153, 2.0, A::add(s.ad_value(554), s.ad_value(556)), 1.0);
        }
