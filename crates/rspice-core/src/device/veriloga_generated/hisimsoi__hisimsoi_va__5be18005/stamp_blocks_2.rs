...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) && (s.v[168] < s.v[58])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && (!s.b[966])) && (s.v[168] < s.v[58])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        let mut t22: usize = 0;
        while {
            let t21: f64 = if ((s.b[737] && (!s.b[929])) && (s.v[168] <= s.v[58])) { 1.0 } else { 0.0 };
            t21 != 0.0
        } {
            t22 += 1;
            ...
            let mut t11: usize = 0;
            while {
                let t10: f64 = if (((s.b[737] && (!s.b[929])) && (!s.b[1015])) && (s.v[44] >= 60.0)) { 1.0 } else { 0.0 };
                t10 != 0.0
            } {
                t11 += 1;
    ...
    if ((((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) && s.b[1020]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t14);s.b[1021] = (2.0 == 2.0);s.store_scalar(1021, if s.b[1021] { 1.0 } else { 0.0 });
            let (t15,) = {
    if (((((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) && (!s.b[1020])) && s.b[1021]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t15);s.b[1022] = (2.0 == 4.0);s.store_scalar(1022, if s.b[1022] { 1.0 } else { 0.0 });
            let (t16,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) && (!s.b[1020])) && (!s.b[1021])) && s.b[1022]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t16);s.b[1023] = (2.0 == 8.0);s.store_scalar(1023, if s.b[1023] { 1.0 } else { 0.0 });
            let (t17,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) {
        ...
        (s.v[54],)
            ...
            while {
                let t1b: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t1b != 0.0
            } {
                t1c += 1;
    ...
    if ((((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) && s.b[1026]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t1f);s.b[1027] = (2.0 == 2.0);s.store_scalar(1027, if s.b[1027] { 1.0 } else { 0.0 });
            let (t20,) = {
    if (((((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) && (!s.b[1026])) && s.b[1027]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t20);s.b[1028] = (2.0 == 4.0);s.store_scalar(1028, if s.b[1028] { 1.0 } else { 0.0 });
            let (t5,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) && (!s.b[1026])) && (!s.b[1027])) && s.b[1028]) {
        ...
        (s.v[55],)
            ...
            s.store_scalar(55, t5);s.b[1029] = (2.0 == 8.0);s.store_scalar(1029, if s.b[1029] { 1.0 } else { 0.0 });
            let (t6,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) {
        ...
        (s.v[54],)
            ...
            while {
                let ta: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                ta != 0.0
            } {
                tb += 1;
    ...
    if ((s.b[737] && (!s.b[929])) && (!s.b[1030])) {
        ...
        (s.v[408],)
            ...
            s.store_scalar(408, te);s.b[1038] = (s.v[977] < s.v[408]);s.store_scalar(1038, if s.b[1038] { 1.0 } else { 0.0 });
            let (tf,) = {
    ...
    if ((((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) && s.b[1044]) {
        ...
        s.store_scalar(55, t26);s.b[1045] = (2.0 == 2.0);s.store_scalar(1045, if s.b[1045] { 1.0 } else { 0.0 });
        let (t27,) = {
    if (((((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) && (!s.b[1044])) && s.b[1045]) {
        ...
        s.store_scalar(55, t27);s.b[1046] = (2.0 == 4.0);s.store_scalar(1046, if s.b[1046] { 1.0 } else { 0.0 });
        let (t28,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) && (!s.b[1044])) && (!s.b[1045])) && s.b[1046]) {
        ...
        s.store_scalar(55, t28);s.b[1047] = (2.0 == 8.0);s.store_scalar(1047, if s.b[1047] { 1.0 } else { 0.0 });
        let (t29,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) {
        ...
        while {
            let t2d: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t2d != 0.0
        } {
            t2e += 1;
    ...
    if ((((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) && s.b[1051]) {
        ...
        s.store_scalar(55, t31);s.b[1052] = (2.0 == 2.0);s.store_scalar(1052, if s.b[1052] { 1.0 } else { 0.0 });
        let (t32,) = {
    if (((((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) && (!s.b[1051])) && s.b[1052]) {
        ...
        s.store_scalar(55, t32);s.b[1053] = (2.0 == 4.0);s.store_scalar(1053, if s.b[1053] { 1.0 } else { 0.0 });
        let (t33,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) && (!s.b[1051])) && (!s.b[1052])) && s.b[1053]) {
        ...
        s.store_scalar(55, t33);s.b[1054] = (2.0 == 8.0);s.store_scalar(1054, if s.b[1054] { 1.0 } else { 0.0 });
        let (t34,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) {
        ...
        while {
            let t38: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t38 != 0.0
        } {
            t39 += 1;
    ...
    if ((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && s.b[1057]) {
        ...
        s.store_scalar(55, t3c);s.b[1058] = (2.0 == 2.0);s.store_scalar(1058, if s.b[1058] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if (((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (!s.b[1057])) && s.b[1058]) {
        ...
        s.store_scalar(55, t3d);s.b[1059] = (2.0 == 4.0);s.store_scalar(1059, if s.b[1059] { 1.0 } else { 0.0 });
        let (t3e,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (!s.b[1057])) && (!s.b[1058])) && s.b[1059]) {
        ...
        s.store_scalar(55, t3e);s.b[1060] = (2.0 == 8.0);s.store_scalar(1060, if s.b[1060] { 1.0 } else { 0.0 });
        let (t3f,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) {
        ...
        while {
            let t43: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t43 != 0.0
        } {
            t44 += 1;
    ...
    if (!s.b[737]) {
        ...
        s.store_scalar(160, t4a);s.b[1068] = (s.v[158] < s.v[160]);s.store_scalar(1068, if s.b[1068] { 1.0 } else { 0.0 });
        let (t4c,) = {
    if ((!s.b[737]) && s.b[1068]) {
        let t4b: f64 = (-1.0);
        (t4b,)
    ...
    pub(super) fn stamp_transient_block_40(
        ...
        let mut t55: usize = 0;
        while {
            let t53: f64 = (s.v[57] + 1.0);let t54: f64 = if ((!s.b[737]) && (s.v[167] <= t53)) { 1.0 } else { 0.0 };
            t54 != 0.0
        } {
            t55 += 1;
    ...
    if ((!s.b[737]) && s.b[1079]) {
        ...
        (s.v[338],)
            ...
            s.store_scalar(338, t4f);s.b[1080] = (s.v[338] == (-1.0));s.store_scalar(1080, if s.b[1080] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[737]) && s.b[1088]) {
        ...
        s.store_scalar(612, t59);s.b[1089] = (s.v[612] == 0.0);s.store_scalar(1089, if s.b[1089] { 1.0 } else { 0.0 });
    ...
    if (((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && s.b[1099]) {
        ...
        s.store_scalar(55, t5c);s.b[1100] = (4.0 == 2.0);s.store_scalar(1100, if s.b[1100] { 1.0 } else { 0.0 });
        let (t5d,) = {
    if ((((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (!s.b[1099])) && s.b[1100]) {
        ...
        s.store_scalar(55, t5d);s.b[1101] = (4.0 == 4.0);s.store_scalar(1101, if s.b[1101] { 1.0 } else { 0.0 });
        let (t5e,) = {
    if (((((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (!s.b[1099])) && (!s.b[1100])) && s.b[1101]) {
        ...
        s.store_scalar(55, t5e);s.b[1102] = (4.0 == 8.0);s.store_scalar(1102, if s.b[1102] { 1.0 } else { 0.0 });
        let (t5f,) = {
    ...
    if ((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) {
        ...
        while {
            let t63: f64 = if (((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t63 != 0.0
        } {
            t64 += 1;
    ...
    if (((!s.b[737]) && s.b[1089]) && s.b[1104]) {
        ...
        s.store_scalar(430, t65);s.b[1105] = (s.v[144] >= 1.0);s.store_scalar(1105, if s.b[1105] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_43(
        ...
        let mut t6a: usize = 0;
        while {
            let t68: f64 = (s.v[58] + 1.0);let t69: f64 = if (((!s.b[737]) && s.b[1089]) && (s.v[168] <= t68)) { 1.0 } else { 0.0 };
            t69 != 0.0
        } {
            t6a += 1;
    ...
    if ((((!s.b[737]) && s.b[1089]) && s.b[1123]) && s.b[1124]) {
        ...
        s.store_scalar(55, t6d);s.b[1125] = (4.0 == 2.0);s.store_scalar(1125, if s.b[1125] { 1.0 } else { 0.0 });
        let (t6e,) = {
    if (((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (!s.b[1124])) && s.b[1125]) {
        ...
        s.store_scalar(55, t6e);s.b[1126] = (4.0 == 4.0);s.store_scalar(1126, if s.b[1126] { 1.0 } else { 0.0 });
        let (t6f,) = {
    if ((((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (!s.b[1124])) && (!s.b[1125])) && s.b[1126]) {
        ...
        s.store_scalar(55, t6f);s.b[1127] = (4.0 == 8.0);s.store_scalar(1127, if s.b[1127] { 1.0 } else { 0.0 });
        let (t70,) = {
    ...
    if (((!s.b[737]) && s.b[1089]) && s.b[1123]) {
        ...
        while {
            let t74: f64 = if ((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t74 != 0.0
        } {
            t75 += 1;
    ...
    pub(super) fn stamp_transient_block_46(
        ...
        if s.b[1133] {s.store_scalar(438, 0.5);}
        ...
        if s.b[1133] {s.store_add(176, 161, 177);s.store_scalar(1170, (1.034943e-10 / 100.0));s.store_scale(1171, 437, 0.0001);s.store_scale(1172, 436, 0.0001);s.store_div_from_scalar(1161, p[92], 1170);s.store_primal_div_from_scalar(1162, p[93], 1170);s.store_scalar(1163, p[94]);}
    }
    #[inline(never)]
