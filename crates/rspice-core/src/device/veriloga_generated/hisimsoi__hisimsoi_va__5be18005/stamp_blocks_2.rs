...
impl Instance {
    ...
    if (((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (!s.b[1057])) && s.b[1058]) {
        ...
        s.store_scalar(55, t0);s.b[1059] = (2.0 == 4.0);s.store_scalar(1059, if s.b[1059] { 1.0 } else { 0.0 });
        let (t1,) = {
    if ((((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (!s.b[1057])) && (!s.b[1058])) && s.b[1059]) {
        ...
        s.store_scalar(55, t1);s.b[1060] = (2.0 == 8.0);s.store_scalar(1060, if s.b[1060] { 1.0 } else { 0.0 });
        let (t2,) = {
    ...
    if (((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) {
        ...
        while {
            let t6: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;assert!(t7 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) {s.store_sqrt(53, 53);}
            let (t5,) = {
    if (((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) {
    ...
    if (!s.b[737]) {
        ...
        s.store_scalar(160, td);s.b[1068] = (s.v[158] < s.v[160]);s.store_scalar(1068, if s.b[1068] { 1.0 } else { 0.0 });
        let (tf,) = {
    if ((!s.b[737]) && s.b[1068]) {
        let te: f64 = (-1.0);
        (te,)
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        if (!s.b[737]) {s.store_exp_mul(486, 225, 515);s.store_mul(487, 379, 486);}
        let (t10,) = {
    if (!s.b[737]) {
        (0.0,)
    } else {
        ...
        if (!s.b[737]) {s.copy_ad(349, 161);s.store_scale(419, 229, ((p.p237 * (p.p237 * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_34(
        ...
        let mut t18: usize = 0;
        while {
            let t16: f64 = (s.v[57] + 1.0);let t17: f64 = if ((!s.b[737]) && (s.v[167] <= t16)) { 1.0 } else { 0.0 };
            t17 != 0.0
        } {
    ...
    if ((!s.b[737]) && s.b[1079]) {
        ...
        (s.v[338],)
            ...
            s.store_scalar(338, t12);s.b[1080] = (s.v[338] == (-1.0));s.store_scalar(1080, if s.b[1080] { 1.0 } else { 0.0 });
    ...
    if ((!s.b[737]) && s.b[1088]) {
        ...
        if ((!s.b[737]) && s.b[1088]) {s.copy_ad(352, 349);s.copy_ad(162, 161);s.copy_ad(314, 162);}
        let (t1c,) = {
    if ((!s.b[737]) && s.b[1088]) {
        (1.0,)
    } else {
        ...
        s.store_scalar(612, t1c);s.b[1089] = (s.v[612] == 0.0);s.store_scalar(1089, if s.b[1089] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[737]) && s.b[1089]) && s.b[1097]) {s.store_sub(44, 332, 1093);s.store_square(49, 44);s.store_square(50, 332);s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);}
        let (t1d,) = {
    ...
    if (((!s.b[737]) && s.b[1089]) && s.b[1097]) {
        ...
        if (((!s.b[737]) && s.b[1089]) && s.b[1097]) {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if (((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && s.b[1099]) {
        ...
        s.store_scalar(55, t1f);s.b[1100] = (4.0 == 2.0);s.store_scalar(1100, if s.b[1100] { 1.0 } else { 0.0 });
        let (t20,) = {
    if ((((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (!s.b[1099])) && s.b[1100]) {
        ...
        s.store_scalar(55, t20);s.b[1101] = (4.0 == 4.0);s.store_scalar(1101, if s.b[1101] { 1.0 } else { 0.0 });
        let (t21,) = {
    if (((((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (!s.b[1099])) && (!s.b[1100])) && s.b[1101]) {
        ...
        s.store_scalar(55, t21);s.b[1102] = (4.0 == 8.0);s.store_scalar(1102, if s.b[1102] { 1.0 } else { 0.0 });
        let (t22,) = {
    ...
    if ((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) {
        ...
        while {
            let t26: f64 = if (((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
            t27 += 1;assert!(t27 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if ((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) {s.store_sqrt(53, 53);}
            let (t25,) = {
    if ((((!s.b[737]) && s.b[1089]) && s.b[1097]) && s.b[1098]) {
        ...
        if (((!s.b[737]) && s.b[1089]) && s.b[1104]) {s.store_scalar(164, 0.0);s.copy_ad(162, 161);}
        let (t28,) = {
    if (((!s.b[737]) && s.b[1089]) && s.b[1104]) {
        ...
        s.store_scalar(430, t28);s.b[1105] = (s.v[144] >= 1.0);s.store_scalar(1105, if s.b[1105] { 1.0 } else { 0.0 });
        ...
        if (((!s.b[737]) && s.b[1089]) && (!s.b[1104])) {s.copy_ad(164, 165);s.store_add(162, 161, 164);}
        let (t29,) = {
    if (((!s.b[737]) && s.b[1089]) && (!s.b[1104])) {
        (0.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_37(
        ...
        let mut t2d: usize = 0;
        while {
            let t2b: f64 = (s.v[58] + 1.0);let t2c: f64 = if (((!s.b[737]) && s.b[1089]) && (s.v[168] <= t2b)) { 1.0 } else { 0.0 };
            t2c != 0.0
        } {
    ...
    if ((!s.b[737]) && s.b[1089]) {
        ...
        if ((!s.b[737]) && s.b[1089]) {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if ((((!s.b[737]) && s.b[1089]) && s.b[1123]) && s.b[1124]) {
        ...
        s.store_scalar(55, t30);s.b[1125] = (4.0 == 2.0);s.store_scalar(1125, if s.b[1125] { 1.0 } else { 0.0 });
        let (t31,) = {
    if (((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (!s.b[1124])) && s.b[1125]) {
        ...
        s.store_scalar(55, t31);s.b[1126] = (4.0 == 4.0);s.store_scalar(1126, if s.b[1126] { 1.0 } else { 0.0 });
        let (t32,) = {
    if ((((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (!s.b[1124])) && (!s.b[1125])) && s.b[1126]) {
        ...
        s.store_scalar(55, t32);s.b[1127] = (4.0 == 8.0);s.store_scalar(1127, if s.b[1127] { 1.0 } else { 0.0 });
        let (t33,) = {
    ...
    if (((!s.b[737]) && s.b[1089]) && s.b[1123]) {
        ...
        while {
            let t37: f64 = if ((((!s.b[737]) && s.b[1089]) && s.b[1123]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t37 != 0.0
        } {
            t38 += 1;assert!(t38 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((!s.b[737]) && s.b[1089]) && s.b[1123]) {s.store_sqrt(53, 53);}
            let (t36,) = {
    if (((!s.b[737]) && s.b[1089]) && s.b[1123]) {
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        if (s.b[1133] && s.b[1210]) {s.store_sqrt_offset_input(213, 1201, 1e-50);s.store_add_mul_sub_from_scalar_rhs_indices(215, 207, 211, 1.0, 213);s.store_div_from_scalar_add_ad(327, 1.0, s.ad_value(225), A::div_scalar_offset_denominator(2.0, s.ad_value(207), 1e-50, 1.0));s.store_mul_ln_mixed_ia(216, 327, A::mul(A::div_scalar_by_product(1.0, s.ad_value(209), s.ad_value(210), 1.0), A::square(s.ad_value(207))));s.store_div_scaled_value_offset_denominator(1204, s.ad_value(216), 1.0, s.ad_value(207), 1e-50, 1.0);s.store_offset_sub(217, 216, 215, (-0.002));s.store_sqrt_add_scaled_square_input(327, 217, 1.0, 216, (4.0 * 0.002));s.store_add_scaled_inputs3_indices(218, 216, 1.0, 217, (-0.5), 327, (-0.5));s.store_div_from_scalar(1201, 1.0, 327);s.store_mul_exp_mixed_ia(327, 209, A::mul(s.ad_value(225), s.ad_value(218)));s.store_add_offset_lhs_mixed_ai(1202, A::mul(s.ad_value(225), A::sub(s.ad_value(218), s.ad_value(514))), (-1.0), 327);s.store_sqrt_square_offset(44, 1202, ((4.0 * 0.01) * 0.01));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_43(
        ...
        if (s.b[1133] && s.b[1210]) {s.store_offset_add_scaled_inputs_indices(1201, 1202, 0.5, 44, 0.5, (1e-10 * 0.01));}
    ...
    if (((s.b[1133] && s.b[1210]) && s.b[1215]) && s.b[1216]) {
        ...
        s.store_scalar(55, t3b);s.b[1217] = (4.0 == 2.0);s.store_scalar(1217, if s.b[1217] { 1.0 } else { 0.0 });
        let (t3c,) = {
    if ((((s.b[1133] && s.b[1210]) && s.b[1215]) && (!s.b[1216])) && s.b[1217]) {
        ...
        s.store_scalar(55, t3c);s.b[1218] = (4.0 == 4.0);s.store_scalar(1218, if s.b[1218] { 1.0 } else { 0.0 });
        let (t3d,) = {
    if (((((s.b[1133] && s.b[1210]) && s.b[1215]) && (!s.b[1216])) && (!s.b[1217])) && s.b[1218]) {
        ...
        s.store_scalar(55, t3d);s.b[1219] = (4.0 == 8.0);s.store_scalar(1219, if s.b[1219] { 1.0 } else { 0.0 });
        let (t3e,) = {
    ...
    if ((s.b[1133] && s.b[1210]) && s.b[1215]) {
        ...
        while {
            let t42: f64 = if (((s.b[1133] && s.b[1210]) && s.b[1215]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t42 != 0.0
        } {
    ...
    if ((s.b[1133] && s.b[1220]) && (!s.b[1223])) {
        ...
        s.store_scalar(146, t45);s.copy_ad(202, 199);s.store_scalar(204, 0.0);s.b[1224] = ((p.p281 > 0.0) && (p.p285 > 0.0));s.store_scalar(1224, if s.b[1224] { 1.0 } else { 0.0 });
        if s.b[1224] {s.store_scalar(1231, s.v[99]);s.store_scalar(1235, p.p237);s.store_offset_add_scaled_inputs3_offset_indices(1236, 158, 1.0, 185, 1.0, 320, -1.0, (-s.v[123]), (-p.p286));}
        let (t47,) = {
    if s.b[1224] {
        ...
        s.store_scalar(1237, t47);
        if s.b[1224] {s.store_scalar(1239, p.p285);s.store_scalar(1238, p.p283);s.store_scalar(1229, s.v[70]);s.store_mul_ln_mixed_ia(1230, 227, A::div_scaled_product_by_product(s.ad_value(1229), s.ad_value(536), 1.0, s.ad_value(230), s.ad_value(230), 1.0));}
        if s.b[1224] {
            if (p.p43 == 1.0) {
                s.copy_ad(1227, 435);
            } else {
    ...
    if (s.b[1224] && s.b[1253]) {
        ...
        s.store_scalar(144, t49);s.b[1254] = ((s.v[144] == 0.0) || (1.0 != 0.0));s.store_scalar(1254, if s.b[1254] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        if ((s.b[1224] && s.b[1254]) && s.b[1255]) {s.store_add_scaled_inputs_mixed_ai(336, A::sub_from_scalar(3.0, A::div_scaled_inputs(s.ad_value(329), 1.259921049894873, s.ad_value(332), 3.0)), 1.0, 332, (1.0 / (3.0 * 1.259921049894873)));s.store_add_scaled_product_indices(376, 1251, 1.0, 336, 227, 1.0);s.copy_ad(378, 376);}
    ...
    if (((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) && s.b[1263]) {
        ...
        s.store_scalar(55, t4c);s.b[1264] = (2.0 == 2.0);s.store_scalar(1264, if s.b[1264] { 1.0 } else { 0.0 });
        let (t4d,) = {
    if ((((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) && (!s.b[1263])) && s.b[1264]) {
        ...
        s.store_scalar(55, t4d);s.b[1265] = (2.0 == 4.0);s.store_scalar(1265, if s.b[1265] { 1.0 } else { 0.0 });
        let (t4e,) = {
    if (((((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) && (!s.b[1263])) && (!s.b[1264])) && s.b[1265]) {
        ...
        s.store_scalar(55, t4e);s.b[1266] = (2.0 == 8.0);s.store_scalar(1266, if s.b[1266] { 1.0 } else { 0.0 });
        let (t4f,) = {
    ...
    if ((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) {
        ...
        while {
            let t53: f64 = if (((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t53 != 0.0
        } {
    ...
    if (s.b[1224] && s.b[1270]) {
        let t55: f64 = (s.v[123] - s.v[185]);let t56: f64 = (t55 + s.v[320]);let t57: f64 = (t56 + s.v[1271]);let t58: f64 = (t57 + p.p286);
        (t58,)
    } else {
        (s.v[160],)
    }
};
        s.store_scalar(160, t59);s.b[1273] = (s.v[158] < s.v[160]);s.store_scalar(1273, if s.b[1273] { 1.0 } else { 0.0 });
        let (t5b,) = {
    if ((s.b[1224] && s.b[1270]) && s.b[1273]) {
        ...
        if ((s.b[1224] && s.b[1270]) && (!s.b[1273])) {s.store_exp_ad(484, A::mul_offset_rhs(s.ad_value(225), s.ad_value(1271), (-p.p287)));}
        let (t5c,) = {
    if ((s.b[1224] && s.b[1270]) && (!s.b[1273])) {
        (0.0,)
    } else {
        ...
        if ((s.b[1224] && s.b[1270]) && (!s.b[1273])) {s.copy_ad(1272, 378);s.store_scale(419, 229, ((p.p237 * (p.p237 * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
}
