...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_62(
        ...
        while {
            ...
            t2f += 1;
            if t2f > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t2f, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
