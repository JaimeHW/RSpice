...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_15(
        ...
        if ((!s.b[737]) && s.b[1089]) {
            s.store_add_mul_sub_from_scalar_rhs_indices(1096, 159, 1091, 1.0, 1092);
    ...
    pub(super) fn stamp_reactive_block_16(
        ...
        if ((s.b[1133] && s.b[1136]) && (!s.b[1152])) {
            ...
            s.store_mul_sub_scaled_inputs_rhs(316, 326, s.ad_value(1147), 0.5, s.ad_value(1145), 0.5);
        }
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        if s.b[1133] {
            ...
            s.store_div_scaled_inputs_indices(1174, 253, 0.2, 251, 1.0);
        ...
        if ((s.b[1133] && s.b[1196]) && s.b[1198]) {
            s.store_add_scaled_inputs3_indices(1192, 161, 1.0, 1193, 1.0, 172, -1.0);
        }

        if ((s.b[1133] && s.b[1196]) && (!s.b[1198])) {
            s.store_add_scaled_inputs3_indices(1192, 161, 1.0, 1193, 1.0, 350, -1.0);
        }

        if (s.b[1133] && s.b[1196]) {
            s.store_add_product3_rhs_indices(1191, 1191, 173, 1188, 1192, 1.0);
        ...
        if (s.b[1133] && s.b[1210]) {
            ...
            s.store_mul_ad_product_lhs_mixed_ai(1206, A::mul_sub_from_scalar_lhs_scaled_output(p.p69, s.ad_value(233), s.ad_value(324), (2.0 * 1.034943e-10)), 1203, 1205);
            ...
            s.store_add_scaled_inputs3_offset_indices(207, 174, 1.0, 1201, 1.0, 206, 1.0, (-s.v[123]));
        ...
        if (s.b[1133] && s.b[1210]) {
            s.store_sqrt_add_scaled_square_product(1203, 1201, 1.0, 327, 1207, (4.0 * 0.005));
        ...
        if (s.b[1133] && s.b[1210]) {
            ...
            s.store_add_offset_ad_lhs(1202, A::mul(s.ad_value(225), A::sub(s.ad_value(218), s.ad_value(514))), (-1.0), 327);
            s.store_sqrt_square_offset(44, 1202, ((4.0 * 0.01) * 0.01));
            s.store_offset_add_scaled_inputs_indices(1201, 1202, 0.5, 44, 0.5, (1e-10 * 0.01));
        }
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1224] {
            ...
            s.store_offset_add_scaled_inputs3_offset_indices(1236, 158, 1.0, 185, 1.0, 320, -1.0, (-s.v[123]), (-p.p286));
        ...
        if s.b[1224] {
            s.store_add_product3_rhs_mixed_iia(376, 1236, 241, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(336))), 0.5);
        }
    ...
    pub(super) fn stamp_reactive_block_19(
        ...
        if (s.b[1224] && s.b[1270]) {
            s.copy_ad(378, 1234);
            s.copy_ad(1271, 1225);
            s.store_offset_add_scaled_inputs3_offset_indices(160, 185, (-1.0), 320, 1.0, 1271, 1.0, s.v[123], p.p286);
        }
        ...
        if ((s.b[1224] && s.b[1270]) && s.b[1273]) {
            ...
            s.store_div(329, 328, 254);
            s.store_sqrt_square_offset(330, 329, 1.0);
            s.store_add_div_lhs_indices(1234, 328, 330, 1271);
        }
        ...
        if s.b[1224] {
            s.store_mul_sub_scaled_inputs_rhs(332, 225, s.ad_value(1234), -1.0, s.ad_value(1225), -1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        if ((s.b[1224] && (!s.b[1285])) && (!s.b[1286])) {
            s.store_mul_ad_affine_product_rhs(437, 1249, s.ad_value(1250), A::sqrt_scaled_lhs_product_offset(s.ad_value(1250), 0.3333333333333333, A::scale_offset(s.ad_value(1250), 0.25, 1.0), 1.0), (-0.7071067811865475), 0.0);
        }
        ...
        if s.b[1224] {
            s.store_div_scaled_inputs_indices(1247, 1246, 1.0, 536, 1.6021918e-19);
            s.store_sub(328, 1247, 1238);
            s.store_scale(1248, 1247, 0.01);
            s.store_sqrt_add_scaled_square_product(44, 328, 1.0, 1248, 1248, 4.0);
            s.store_add_scaled_inputs3_indices(329, 328, 0.5, 44, 0.5, 1248, 1e-10);
        }
        ...
        if s.b[1224] {
            ...
            s.store_mul_div_scaled_inputs_indices(1240, 1244, 227, 2.0, 1231, 1.0);
            s.store_mul_product3_indices(204, 337, 1240, 1239, 107, 1.0);
        ...
        if (((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && s.b[1310]) {
            ...
            s.store_add_scaled_inputs3_mixed_iia(1307, 173, p.p122, 176, 1.0, A::mul3(s.ad_value(131), s.ad_value(129), s.ad_value(1306)), -1.0);
        ...
        if (((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && (!s.b[1310])) {
            ...
            s.store_div_square_rhs(1298, 545, 323);
            s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1299, 2.0, 545, A::square(s.ad_value(323)));
            s.store_add_scaled_inputs_product_indices(1300, 1296, 1.0, 227, (-1.0), 130, 514, (-1.0));
            s.store_scale(483, 393, (p.p49 * 1.0 / (s.v[89])));
            s.store_add_scaled_product_indices(1300, 1300, 1.0, 130, 483, (-1.0));
        ...
        if ((((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && (!s.b[1310])) && s.b[1313]) {
            s.store_sub_offset_lhs(44, 1303, 1e-50, 1301);
            s.store_square(49, 44);
        ...
        if ((((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && (!s.b[1310])) && s.b[1313]) {
            ...
            s.store_sub_offset_lhs(1301, 1303, 1e-50, 43);
        }
    ...
    pub(super) fn stamp_reactive_block_21(
        ...
        if (((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && (!s.b[1310])) {
            s.store_add_mul_sub_from_scalar_rhs_indices(1306, 1296, 1298, 1.0, 1301);
        ...
        if ((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) {
            ...
            s.store_ad_value(1297, A::exp_div_scaled_inputs(s.ad_value(133), -1.0, s.ad_value(1307), 1.0));
            s.store_mul_product3_indices(263, 1297, 132, 1307, 199, 1.0);
        }
        ...
        if s.b[1320] {
            ...
            s.store_add_scaled_inputs3_indices(44, 231, 1.0, 1324, (-1.0), 231, (-0.01));
        ...
        if s.b[1320] {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_add_scaled_inputs3_indices(1324, 231, 1.0, 44, (-0.5), 45, (-0.5));
            s.store_sqrt_mul_scaled_lhs(1325, 544, ((2.0 * 1.034943e-10) * 1.6021918e-19), 227);
        ...
        if s.b[1320] {
            ...
            s.store_mul_sub_scaled_inputs_rhs(1328, 1325, s.ad_value(1326), -1.0, s.ad_value(1327), -1.0);
        ...
        if s.b[1342] {
            ...
            s.store_mul_add_scaled_products_indices_rhs(1340, 238, 1335, 1338, ((-1.0) * (0.5)), 1332, 328, 0.5);
            s.store_add(1341, 1339, 1340);
            s.store_mul3_lhs(265, 264, 1341, 250);
        }

        s.store_scalar(1359, (s.v[88] * 100.0));

        s.store_scale(1360, 323, 0.0001);

        s.store_scalar(1361, (s.v[97] * 100.0));
        ...
        if ((!s.b[1366]) && s.b[1367]) {
            ...
            s.store_add_scaled_inputs4_offset_indices(1348, 174, 1.0, 185, (p.p216 * s.v[1361]), 320, (-(p.p216 * s.v[1361])), 1358, (-p.p215), (-s.v[123]));
        ...
        if (!s.b[1382]) {
            s.store_add_scaled_inputs4_offset_indices(1375, 157, p.p209, 158, (-1.0), 187, p.p211, 319, p.p211, (p.p210 * p.p209));
    ...
    pub(super) fn stamp_reactive_block_22(
        ...
        if (!s.b[1393]) {
            s.store_add_scaled_inputs3_mixed_aii(1386, A::add_scaled_inputs3_offset(s.ad_value(157), (-p.p209), s.ad_value(158), -1.0, s.ad_value(157), 1.0, ((p.p210) * (p.p209))), 1.0, 187, p.p211, 319, p.p211);
        ...
        if ((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) {
            ...
            s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1431, 2.0, 225, A::ln(s.ad_value(1398)));
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && s.b[1481]) {
            ...
            s.store_sub_from_scalar_scaled_mul_ad_rhs(1436, (7.0 * 1.414213562373095), 1406, A::offset(s.ad_value(1405), (-2.0)), 9.0);
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && s.b[1481]) {
            ...
            s.store_sub_div_lhs_indices(1444, 1399, 1401, 1419);
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) {
            ...
            s.store_sub_div_lhs_indices(1445, 1442, 225, 1419);
            s.store_exp_neg_input(1406, 1442);
            s.store_offset_div_scaled_inputs2_mixed_aia(1405, A::offset(A::mul(s.ad_value(225), A::add(s.ad_value(1430), s.ad_value(1419))), (-1.0)), 4.0, 1406, 4.0, A::mul(s.ad_value(1429), s.ad_value(226)), 1.0, 1.0);
        }
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) {
            s.store_add_product3_rhs_mixed_iia(1445, 1430, 1429, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(1405))), 1.0 / (2.0));
    ...
    pub(super) fn stamp_reactive_block_23(
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1485]) {
            s.store_div_scaled_inputs2_indices(1449, 1430, -1.0, 1419, -1.0, 1428, 1.0);
            s.store_add_scaled_inputs3_div_scaled_third_mixed_aaii(1450, A::div_scaled_product(A::square(s.ad_value(1447)), s.ad_value(1447), 1.0, A::mul3_scaled_output(s.ad_value(1446), s.ad_value(1446), s.ad_value(1446), 27.0), 1.0), 1.0, A::div_scaled_product_by_product(s.ad_value(1447), s.ad_value(1448), 1.0, s.ad_value(1446), s.ad_value(1446), 6.0), (-1.0), 1449, 1.0, 1446, 2.0, 1.0);
            ...
            s.store_sqrt_add_scaled_square_cube_product(1402, 1450, 1.0, 1451, 1.0);
            s.store_powf_ad(1452, A::sub(s.ad_value(1402), s.ad_value(1450)), 0.3333333333333333);
            s.store_neg_powf_add_input(1453, 1450, 1402, 0.3333333333333333);
            s.store_add_scaled_inputs3_div_scaled_third_indices(1405, 1452, 1.0, 1453, 1.0, 1447, 1.0, 1446, 3.0, -1.0);
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) {
            ...
            s.store_add_scaled_inputs3_indices(1458, 1457, 1.0, 44, (-0.5), 45, (-0.5));
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) {
            ...
            s.store_add_scaled_inputs3_indices(1442, 1459, 1.0, 44, (-0.5), 45, (-0.5));
            s.store_sub_div_lhs_indices(1444, 1442, 225, 1419);
            s.store_add_offset_lhs_ad_rhs(1399, 1442, (-1.0), A::exp_scaled_input(s.ad_value(1442), -1.0));
        }
        ...
        while {
            ...
            if (((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) && s.b[1488]) {
                ...
                s.store_mul_product3_indices(1465, 1463, 1470, 225, 1462, 2.0);
                ...
                s.store_div_scaled_inputs2_mixed_aii(1469, A::mul3_scaled_output(s.ad_value(225), s.ad_value(1467), s.ad_value(1466), 2.0), 1.0, 1465, 1.0, 1468, 2.0);
            }
            ...
            if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) {
                ...
                s.store_sub_from_scalar_scaled_mul(1473, (-1.0), 1428, 1469, 1.0);
            }
            ...
            if (((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) && (!s.b[1490])) {
                s.store_div_scaled_inputs_indices(494, 1472, -1.0, 1473, 1.0);
            }
            if (((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) && (!s.b[1490])) {
    ...
    pub(super) fn stamp_reactive_block_25(
        ...
        s.store_scalar(1534, s.v[91]);

        s.store_scalar(1535, (1.0 / s.v[1534]));
        ...
        if (((p.p24 != 0.0) && s.b[1606]) && s.b[1607]) {
            s.store_mul_ad_product_rhs_mixed_ia(1527, 1537, 1524, A::add(s.ad_value(1538), s.ad_value(1539)));
            ...
            s.store_mul_ad_product_rhs_mixed_ia(1527, 1537, 1524, A::add_scaled_inputs3(s.ad_value(1538), 1.0, s.ad_value(1539), 1.0, s.ad_value(157), -1.0));
        ...
        if (((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) {
            ...
            s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1560, 2.0, 225, A::ln(s.ad_value(1523)));
        ...
        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && s.b[1610]) {
            ...
            s.store_sub_from_scalar_scaled_mul_ad_rhs(1565, (7.0 * 1.414213562373095), 1533, A::offset(s.ad_value(1532), (-2.0)), 9.0);
        ...
        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && s.b[1610]) {
            ...
            s.store_sub_div_lhs_indices(1573, 1524, 1526, 1549);
        ...
        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) {
            ...
            s.store_sub_div_lhs_indices(1574, 1571, 225, 1549);
            s.store_exp_neg_input(1533, 1571);
            s.store_offset_div_scaled_inputs2_mixed_aia(1532, A::offset(A::mul(s.ad_value(225), A::add(s.ad_value(1559), s.ad_value(1549))), (-1.0)), 4.0, 1533, 4.0, A::mul(s.ad_value(1558), s.ad_value(226)), 1.0, 1.0);
        }
        ...
        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) {
            s.store_add_product3_rhs_mixed_iia(1574, 1559, 1558, 225, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(1532))), 1.0 / (2.0));
        ...
        if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1614]) {
            ...
            s.store_div_scaled_inputs2_indices(1578, 1559, -1.0, 1549, -1.0, 1557, 1.0);
            s.store_add_scaled_inputs3_div_scaled_third_mixed_aaii(1579, A::div_scaled_product(A::square(s.ad_value(1576)), s.ad_value(1576), 1.0, A::mul3_scaled_output(s.ad_value(1575), s.ad_value(1575), s.ad_value(1575), 27.0), 1.0), 1.0, A::div_scaled_product_by_product(s.ad_value(1576), s.ad_value(1577), 1.0, s.ad_value(1575), s.ad_value(1575), 6.0), (-1.0), 1578, 1.0, 1575, 2.0, 1.0);
            ...
            s.store_sqrt_add_scaled_square_cube_product(1528, 1579, 1.0, 1580, 1.0);
            s.store_powf_ad(1581, A::sub(s.ad_value(1528), s.ad_value(1579)), 0.3333333333333333);
            s.store_neg_powf_add_input(1582, 1579, 1528, 0.3333333333333333);
            s.store_add_scaled_inputs3_div_scaled_third_indices(1532, 1581, 1.0, 1582, 1.0, 1576, 1.0, 1575, 3.0, -1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_26(
        ...
        if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1615]) {
            ...
            s.store_add_scaled_inputs3_indices(1587, 1586, 1.0, 44, (-0.5), 45, (-0.5));
        ...
        if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1615]) {
            ...
            s.store_add_scaled_inputs3_indices(1571, 1588, 1.0, 44, (-0.5), 45, (-0.5));
        }

        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) {
            s.store_sub_div_lhs_indices(1573, 1571, 225, 1549);
            s.store_add_offset_lhs_ad_rhs(1524, 1571, (-1.0), A::exp_scaled_input(s.ad_value(1571), -1.0));
        }
        ...
        while {
            ...
            if ((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) && s.b[1618]) {
                ...
                s.store_mul_product3_indices(1594, 1592, 1599, 225, 1591, 2.0);
                ...
                s.store_div_scaled_inputs2_mixed_aii(1598, A::mul3_scaled_output(s.ad_value(225), s.ad_value(1596), s.ad_value(1595), 2.0), 1.0, 1594, 1.0, 1597, 2.0);
            }
            ...
            if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) {
                ...
                s.store_sub_from_scalar_scaled_mul(1602, (-1.0), 1557, 1598, 1.0);
            }
            ...
            if ((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) && (!s.b[1620])) {
                s.store_div_scaled_inputs_indices(494, 1601, -1.0, 1602, 1.0);
            }
            if ((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) && (!s.b[1620])) {
