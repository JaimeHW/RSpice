...
pub struct Instance {
    ...
    pub(crate) scalar_static_f64: Box<[f64; 44]>,
...
impl Instance {
    ...
    pub fn new(nodes: &[usize]) -> Self {
        ...
        let mut instance = Self {
            ...
            scalar_static_f64: boxed_zero_f64_array::<44>(),
    ...
    fn recompute_instance_static(&mut self) {
        ...
        self.scalar_static_f64[1]=p.p242;
        self.scalar_static_f64[2]=(0.01*self.scalar_static_f64[1]);
        self.scalar_static_f64[3]=p.p232;
        self.scalar_static_f64[4]=(self.scalar_static_f64[3]+273.15);
        self.scalar_static_f64[5]=p.p34;
        self.scalar_static_f64[6]=if param_given[16] { 1.0 } else { 0.0 };
        self.scalar_static_f64[7]=p.p17;
        self.scalar_static_bool[1]=(0.0==self.scalar_static_f64[7]);
        self.scalar_static_f64[8]=(if self.scalar_static_bool[1]{0.0}else{1.0});
        self.scalar_static_f64[9]=p.p16;
        self.scalar_static_f64[10]=(273.15+self.scalar_static_f64[9]);
        self.scalar_static_f64[11]=p.p261;
        self.scalar_static_bool[2]=(1.0==self.scalar_static_f64[11]);
        self.scalar_static_bool[3]=(!self.scalar_static_bool[2]);
        self.scalar_static_f64[12]=p.p262;
        self.scalar_static_bool[4]=(1.0==self.scalar_static_f64[12]);
        self.scalar_static_f64[13]=p.p290;
        self.scalar_static_bool[5]=(self.scalar_static_f64[13]<0.0001);
        self.scalar_static_bool[6]=(self.scalar_static_bool[4]&&self.scalar_static_bool[5]);
        self.scalar_static_f64[14]=(if self.scalar_static_bool[6]{10000.0}else{0.0});
        self.scalar_static_bool[7]=(!self.scalar_static_bool[5]);
        self.scalar_static_bool[8]=(self.scalar_static_bool[4]&&self.scalar_static_bool[7]);
        self.scalar_static_f64[15]=(1.0/self.scalar_static_f64[13]);
        self.scalar_static_f64[16]=(1e-6+self.scalar_static_f64[15]);
        self.scalar_static_f64[17]=(if self.scalar_static_bool[8]{self.scalar_static_f64[16]}else{self.scalar_static_f64[14]});
        self.scalar_static_f64[18]=p.p291;
        self.scalar_static_bool[9]=(self.scalar_static_f64[18]<0.0001);
        self.scalar_static_bool[10]=(self.scalar_static_bool[4]&&self.scalar_static_bool[9]);
        self.scalar_static_f64[19]=(if self.scalar_static_bool[10]{10000.0}else{0.0});
        self.scalar_static_bool[11]=(!self.scalar_static_bool[9]);
        self.scalar_static_bool[12]=(self.scalar_static_bool[4]&&self.scalar_static_bool[11]);
        self.scalar_static_f64[20]=(1.0/self.scalar_static_f64[18]);
        self.scalar_static_f64[21]=(1e-6+self.scalar_static_f64[20]);
        self.scalar_static_f64[22]=(if self.scalar_static_bool[12]{self.scalar_static_f64[21]}else{self.scalar_static_f64[19]});
        self.scalar_static_bool[13]=(!self.scalar_static_bool[0]);
        self.scalar_static_bool[14]=(self.scalar_static_bool[0]&&(self.scalar_static_f64[5]!=0.0));
        self.scalar_static_bool[15]=((self.scalar_static_f64[5]!=0.0)&&self.scalar_static_bool[13]);
        self.scalar_static_f64[23]=p.p38;
        self.scalar_static_bool[16]=(self.scalar_static_f64[23]>0.0);
        self.scalar_static_bool[17]=(self.scalar_static_f64[2]>0.0);
        self.scalar_static_bool[18]=(self.scalar_static_bool[16]&&self.scalar_static_bool[17]);
        self.scalar_static_f64[24]=p.p25;
        self.scalar_static_bool[19]=(1.0==self.scalar_static_f64[24]);
        self.scalar_static_f64[25]=p.p26;
        self.scalar_static_bool[20]=(2.0==self.scalar_static_f64[25]);
        self.scalar_static_bool[21]=(self.scalar_static_bool[19]&&self.scalar_static_bool[20]);
        self.scalar_static_f64[26]=p.p259;
        self.scalar_static_bool[22]=(1.0==self.scalar_static_f64[26]);
        self.scalar_static_f64[27]=p.p270;
        self.scalar_static_bool[23]=(self.scalar_static_f64[1]>0.0);
        self.scalar_static_bool[24]=(self.scalar_static_bool[16]&&self.scalar_static_bool[23]);
        self.scalar_static_f64[28]=p.p37;
        self.scalar_static_bool[25]=(self.scalar_static_bool[21]||(self.scalar_static_f64[28]!=0.0));
        self.scalar_static_bool[26]=(!self.scalar_static_bool[24]);
        self.scalar_static_bool[27]=(self.scalar_static_bool[0]&&(self.scalar_static_f64[11]!=0.0));
        self.scalar_static_bool[28]=(self.scalar_static_bool[0]&&(self.scalar_static_f64[12]!=0.0));
        self.scalar_static_bool[29]=(self.scalar_static_bool[0]&&self.scalar_static_bool[25]);
        self.scalar_static_bool[30]=(self.scalar_static_bool[13]&&(self.scalar_static_f64[28]!=0.0));
        self.scalar_static_f64[29]=(if self.scalar_static_bool[24]{1e-12}else{0.0});
        self.scalar_static_f64[30]=(if self.scalar_static_bool[26]{10000.0}else{0.0});
        self.scalar_static_f64[31]=(-self.scalar_static_f64[22]);
        self.scalar_static_f64[32]=(if self.scalar_static_bool[28]{self.scalar_static_f64[22]}else{0.0});
        self.scalar_static_f64[33]=(if self.scalar_static_bool[28]{self.scalar_static_f64[31]}else{0.0});
        self.scalar_static_f64[34]=(-self.scalar_static_f64[17]);
        self.scalar_static_f64[35]=(if self.scalar_static_bool[28]{self.scalar_static_f64[17]}else{0.0});
        self.scalar_static_f64[36]=(if self.scalar_static_bool[28]{self.scalar_static_f64[34]}else{0.0});
        self.scalar_static_f64[37]=(if self.scalar_static_bool[14]{1e-12}else{0.0});
        self.scalar_static_f64[38]=(if self.scalar_static_bool[29]{1e-12}else{0.0});
        self.scalar_static_f64[39]=(if self.scalar_static_bool[30]{1e-12}else{0.0});
        self.scalar_static_f64[40]=(if self.scalar_static_bool[15]{1e-12}else{0.0});
    }
    ...
    fn recompute_temperature_static(&mut self, temperature: f64, thermal_voltage: f64) {
        let p = &(*self.params);
        self.scalar_static_f64[41]=(if (self.scalar_static_f64[6]!=0.0){self.scalar_static_f64[10]}else{temperature});
        self.scalar_static_f64[42]=(self.scalar_static_f64[7]+self.scalar_static_f64[41]);
        self.scalar_static_f64[43]=(if (self.scalar_static_f64[8]!=0.0){self.scalar_static_f64[42]}else{self.scalar_static_f64[41]});
