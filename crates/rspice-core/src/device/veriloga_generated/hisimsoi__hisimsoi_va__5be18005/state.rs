...
impl Instance {
    ...
    fn recompute_instance_static(&mut self) {
        ...
        let v10: f64 = p.p262;
        self.scalar_v10 = v10;
        let v11: bool = (1.0 == p.p262);
        self.scalar_v11 = v11;
        let v12: f64 = p.p290;
        self.scalar_v12 = v12;
        let v13: bool = (p.p290 < 0.0001);
        self.scalar_v13 = v13;
        let v14: bool = (v11 && v13);
        self.scalar_v14 = v14;
        let v16: f64 = (if v14 { 10000.0 } else { 0.0 });
        self.scalar_v16 = v16;
        let v17: bool = (!v13);
        self.scalar_v17 = v17;
        let v18: bool = (v11 && v17);
        self.scalar_v18 = v18;
        let v19: f64 = (1.0 / p.p290);
        self.scalar_v19 = v19;
        let v20: f64 = (1e-6 + v19);
        self.scalar_v20 = v20;
        let v21: f64 = (if v18 { v20 } else { v16 });
        self.scalar_v21 = v21;
        let v22: f64 = p.p291;
        self.scalar_v22 = v22;
        let v23: bool = (p.p291 < 0.0001);
        self.scalar_v23 = v23;
        let v24: bool = (v11 && v23);
        self.scalar_v24 = v24;
        let v25: f64 = (if v24 { 10000.0 } else { 0.0 });
        self.scalar_v25 = v25;
        let v26: bool = (!v23);
        self.scalar_v26 = v26;
        let v27: bool = (v11 && v26);
        self.scalar_v27 = v27;
        let v28: f64 = (1.0 / p.p291);
        self.scalar_v28 = v28;
        let v29: f64 = (1e-6 + v28);
        self.scalar_v29 = v29;
        let v30: f64 = (if v27 { v29 } else { v25 });
        self.scalar_v30 = v30;
        let v31: bool = (!v3);
        self.scalar_v31 = v31;
        let v33: bool = (v3 && (p.p34 != 0.0));
        self.scalar_v33 = v33;
        let v39: bool = ((p.p34 != 0.0) && v31);
        self.scalar_v39 = v39;
        let v44: f64 = p.p38;
        self.scalar_v44 = v44;
        let v45: bool = (p.p38 > 0.0);
        self.scalar_v45 = v45;
        let v47: f64 = p.p25;
        self.scalar_v47 = v47;
        let v48: bool = (1.0 == p.p25);
        self.scalar_v48 = v48;
        let v49: f64 = p.p26;
        self.scalar_v49 = v49;
        let v50: bool = (2.0 == p.p26);
        self.scalar_v50 = v50;
        let v51: bool = (v48 && v50);
        self.scalar_v51 = v51;
        let v54: bool = (p.p242 > 0.0);
        self.scalar_v54 = v54;
        let v55: bool = (v45 && v54);
        self.scalar_v55 = v55;
        let v56: f64 = p.p37;
        self.scalar_v56 = v56;
        let v57: bool = (v51 || (p.p37 != 0.0));
        self.scalar_v57 = v57;
        let v61: bool = (!v55);
        self.scalar_v61 = v61;
        let v64: bool = (v3 && (p.p262 != 0.0));
        self.scalar_v64 = v64;
        let v81: bool = (v3 && v57);
        self.scalar_v81 = v81;
        let v86: bool = (v31 && (p.p37 != 0.0));
        self.scalar_v86 = v86;
        let v101: f64 = (if v55 { 1e-12 } else { 0.0 });
        self.scalar_v101 = v101;
        let v102: f64 = (if v61 { 10000.0 } else { 0.0 });
        self.scalar_v102 = v102;
        let v103: f64 = (-v30);
        self.scalar_v103 = v103;
        let v104: f64 = (if v64 { v30 } else { 0.0 });
        self.scalar_v104 = v104;
        let v105: f64 = (if v64 { v103 } else { 0.0 });
        self.scalar_v105 = v105;
        let v106: f64 = (-v21);
        self.scalar_v106 = v106;
        let v107: f64 = (if v64 { v21 } else { 0.0 });
        self.scalar_v107 = v107;
        let v108: f64 = (if v64 { v106 } else { 0.0 });
        self.scalar_v108 = v108;
        let v109: f64 = (if v33 { 1e-12 } else { 0.0 });
        self.scalar_v109 = v109;
        let v113: f64 = (if v81 { 1e-12 } else { 0.0 });
        self.scalar_v113 = v113;
        let v115: f64 = (if v86 { 1e-12 } else { 0.0 });
        self.scalar_v115 = v115;
        let v117: f64 = (if v39 { 1e-12 } else { 0.0 });
