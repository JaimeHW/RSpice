...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_61(
        ...
        let mut t3: usize = 0;
        while {
            let t0: f64 = (2.0 * 20.0);let t1: f64 = (t0 + 1.0);let t2: f64 = if (((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1499])) && s.b[1505]) && (s.v[167] <= t1)) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            ...
            if ((((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1499])) && s.b[1505]) && (!s.b[1508])) && s.b[1510]) {s.store_scalar(1415, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_63(
        ...
        if (((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) {s.store_offset_scaled(1549, 1530, -1.0, (-1e-12));s.store_scale(1557, 1556, s.v[1535]);s.store_square(1558, 1557);s.store_sub_from_scalar(1559, s.v[82], 1555);s.store_div_from_scalar(1523, s.v[69], 230);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1560, 2.0, 225, A::ln(s.ad_value(1523)));s.store_neg(1561, 1549);}
    ...
    pub(super) fn stamp_reactive_block_65(
        ...
        if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) {s.store_exp_ad(1590, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1549), -1.0));s.store_scale(1523, 230, 1.0 / (s.v[69]));s.store_square(1584, 1523);s.store_mul(1599, 1584, 1590);s.store_scalar(1546, 0.0);s.store_scalar(1593, 0.0);s.store_scalar(1597, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_66(
        ...
        while {
            ...
            if (((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1610])) && s.b[1617]) && (!s.b[1620])) && s.b[1622]) {s.store_scalar(1546, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_68(
        ...
        if ((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && s.b[1630]) {s.store_square(1566, 1565);}
    ...
    pub(super) fn stamp_reactive_block_70(
        ...
        if (((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1630])) && s.b[1637]) {s.store_exp_ad(1590, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1549), -1.0));s.store_scale(1523, 230, 1.0 / (s.v[69]));s.store_square(1584, 1523);s.store_mul(1599, 1584, 1590);s.store_scalar(1546, 0.0);s.store_scalar(1593, 0.0);s.store_scalar(1597, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_71(
        ...
        let mut tb: usize = 0;
        while {
            let t8: f64 = (2.0 * 20.0);let t9: f64 = (t8 + 1.0);let ta: f64 = if ((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1630])) && s.b[1637]) && (s.v[167] <= t9)) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            ...
            if (((((((p.p24 != 0.0) && s.b[1606]) && (!s.b[1607])) && (!s.b[1630])) && s.b[1637]) && (!s.b[1640])) && s.b[1642]) {s.store_scalar(1546, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_72(
        ...
        if ((p.p24 != 0.0) && s.b[1606]) {s.store_primal_add_scaled_inputs(266, 462, s.v[566], 461, s.v[565]);}
        ...
        if ((p.p24 != 0.0) && s.b[1606]) {s.store_primal_add_scaled_inputs(266, 461, s.v[566], 462, s.v[565]);}
