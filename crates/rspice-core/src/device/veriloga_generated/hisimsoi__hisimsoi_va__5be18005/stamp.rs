...
impl Instance {
    pub fn stamp(&mut self, ctx: &GeneratedEvalContext<'_>, stamper: &mut GeneratedStamper<'_>) {
        ...
        let v67: f64 = nv14;
        let v70: f64 = (v48 * v5);
        let v71: f64 = (if self.scalar_v60 { v70 } else { v2 });
        let v73: f64 = (v48 * v19);
        let v74: f64 = (if self.scalar_v72 { v73 } else { v2 });
        let v79: f64 = nv9;
        let v80: f64 = (v79 - v36);
        let v81: f64 = (self.scalar_v34 * v80);
        let v82: f64 = (if self.scalar_v78 { v81 } else { v2 });
        let v83: f64 = nv8;
        let v84: f64 = (v83 - v36);
        let v85: f64 = (self.scalar_v25 * v84);
        let v86: f64 = (if self.scalar_v78 { v85 } else { v2 });
        let v90: f64 = (v38 * v5);
        let v91: f64 = (if self.scalar_v37 { v90 } else { v2 });
        let v92: f64 = (v39 * v5);
        let v93: f64 = (if self.scalar_v37 { v92 } else { v2 });
        let v96: f64 = (v56 * v5);
        let v97: f64 = (if self.scalar_v95 { v96 } else { v2 });
        let v103: f64 = (if self.scalar_v102 { v96 } else { v2 });
        let v107: f64 = (v43 * v5);
        let v108: f64 = (if self.scalar_v42 { v107 } else { v2 });
        let v109: f64 = (v44 * v5);
        let v110: f64 = (if self.scalar_v42 { v109 } else { v2 });
        let v111: f64 = (if self.scalar_v42 { v92 } else { v2 });
