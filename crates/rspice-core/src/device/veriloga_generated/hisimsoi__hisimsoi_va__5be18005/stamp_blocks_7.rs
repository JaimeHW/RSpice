...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_29(
        ...
        let mut t1a: usize = 0;
        while {
            let t19: f64 = if ((s.b[737] && (!s.b[929])) && (s.v[168] <= s.v[58])) { 1.0 } else { 0.0 };
            t19 != 0.0
        } {
            t1a += 1;
            ...
            let mut t16: usize = 0;
            while {
                let t15: f64 = if (((s.b[737] && (!s.b[929])) && (!s.b[1015])) && (s.v[44] >= 60.0)) { 1.0 } else { 0.0 };
                t15 != 0.0
            } {
                t16 += 1;
            ...
            let mut t18: usize = 0;
            while {
                let t17: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1018]) && s.b[1019]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t17 != 0.0
            } {
                t18 += 1;
            ...
            let mut t14: usize = 0;
            while {
                let t13: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1024]) && s.b[1025]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
                t13 != 0.0
            } {
                t14 += 1;
    ...
    pub(super) fn stamp_reactive_block_30(
        ...
        let mut t1c: usize = 0;
        while {
            let t1b: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1042]) && s.b[1043]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1b != 0.0
        } {
            t1c += 1;
    ...
    pub(super) fn stamp_reactive_block_31(
        ...
        let mut t1e: usize = 0;
        while {
            let t1d: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1049]) && s.b[1050]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1d != 0.0
        } {
            t1e += 1;
        ...
        let mut t20: usize = 0;
        while {
            let t1f: f64 = if ((((s.b[737] && (!s.b[929])) && s.b[1055]) && s.b[1056]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t1f != 0.0
        } {
            t20 += 1;
