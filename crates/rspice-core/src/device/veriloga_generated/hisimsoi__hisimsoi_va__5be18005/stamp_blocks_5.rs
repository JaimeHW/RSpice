...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_80(
        ...
        if s.b[1777] {s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1786), 0.4, 1.8), 1.0, s.ad_value(1786), s.ad_value(1786), 0.1), A::scale_offset(s.ad_value(1786), (-p.p270), p.p270));s.store_div(1790, 1782, 327);s.store_add_mixed_ia(1783, 1783, A::scaled_offset(s.ad_value(429), (-s.v[81]), p.p274));s.store_scalar(1778, (1.0 + (p.p279 / ((s.v[100]) as f64).powf(p.p280))));s.store_scalar(1780, (1.0 + (p.p277 / ((s.v[100]) as f64).powf(p.p278))));s.store_scalar(1779, (1.0 + (p.p275 / ((s.v[109]) as f64).powf(p.p276))));s.store_mul(1789, 1789, 1778);s.store_offset_product3(1790, s.ad_value(1790), s.ad_value(1779), s.ad_value(1780), 1.0, 1e-50);s.store_div(1791, 1785, 1787);s.store_mul(1792, 1789, 1791);}
        ...
        if s.b[1777] {s.store_mul(1793, 1789, 332);s.store_div_from_scalar(328, 1.6021918e-19, 1787);s.store_mul_product3_indices(1795, 1788, 328, 1794, 1793, 1.0);}
        s.b[1803] = (s.v[1795] <= 0.0);s.store_scalar(1803, if s.b[1803] { 1.0 } else { 0.0 });
        if (s.b[1777] && s.b[1803]) {s.store_scalar(1795, 1e-50);}
        if s.b[1777] {s.store_div_from_scalar(1, 1.0, 1795);s.store_div(1, 1, 1796);s.store_add(1, 1, 1784);}
        s.b[1804] = (s.v[1] < 0.0001);s.store_scalar(1804, if s.b[1804] { 1.0 } else { 0.0 });
        if (s.b[1777] && s.b[1804]) {s.store_scalar(1, 0.0001);}
        if s.b[1777] {s.store_scale(5, 1, 1.0 / (s.v[451]));}
    ...
    if s.b[1805] {
        ...
        s.store_scalar(3, t4);s.b[1825] = (s.v[3] == 1.0);s.store_scalar(1825, if s.b[1825] { 1.0 } else { 0.0 });
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1816, (p.p264 / 1e-6));s.store_scalar(1809, p.p266);s.store_scalar(1810, p.p268);s.store_scalar(1811, p.p273);}
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1812, (if (p.p263 > 0.0) { (p.p263 * p.p255) } else { 0.0 }));}
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1815, p.p258);s.store_scaled_voltage(1813, ctx, nodes, Some(7), Some(2), p.p50);}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1816, (p.p59 / 1e-6));s.store_scalar(1809, p.p265);s.store_scalar(1810, p.p267);s.store_scalar(1811, p.p272);}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1812, (if (p.p263 > 0.0) { (p.p263 * p.p256) } else { 0.0 }));}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1815, p.p257);s.store_scaled_voltage(1813, ctx, nodes, Some(0), Some(6), p.p50);}
        if s.b[1805] {s.store_scalar(1822, ((((p.p271 * p.p271) + (p.p56 * p.p56))) as f64).sqrt());s.store_primal_scale(1824, 105, p.p9);s.store_primal_scale(1809, 1809, 0.0001);s.store_primal_scale(1810, 1810, 0.01);s.store_scale(1814, 429, 1.0 / (s.v[81]));s.store_powf(328, 1814, p.p269);s.store_div(1817, 1809, 328);s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1814), 0.4, 1.8), 1.0, s.ad_value(1814), s.ad_value(1814), 0.1), A::scale_offset(s.ad_value(1814), (-p.p270), p.p270));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_81(
        ...
        if s.b[1805] {s.store_div(1818, 1810, 327);s.store_add_mixed_ia(1811, 1811, A::scaled_offset(s.ad_value(429), (-s.v[81]), p.p274));s.store_scalar(1806, (1.0 + (p.p279 / ((s.v[100]) as f64).powf(p.p280))));s.store_scalar(1808, (1.0 + (p.p277 / ((s.v[100]) as f64).powf(p.p278))));s.store_scalar(1807, (1.0 + (p.p275 / ((s.v[109]) as f64).powf(p.p276))));s.store_mul(1817, 1817, 1806);s.store_offset_product3(1818, s.ad_value(1818), s.ad_value(1807), s.ad_value(1808), 1.0, 1e-50);s.store_div(1819, 1813, 1815);s.store_mul(1820, 1817, 1819);}
        ...
        if s.b[1805] {s.store_mul(1821, 1817, 332);s.store_div_from_scalar(328, 1.6021918e-19, 1815);s.store_mul_product3_indices(1823, 1816, 328, 1822, 1821, 1.0);}
        s.b[1831] = (s.v[1823] <= 0.0);s.store_scalar(1831, if s.b[1831] { 1.0 } else { 0.0 });
        if (s.b[1805] && s.b[1831]) {s.store_scalar(1823, 1e-50);}
        if s.b[1805] {s.store_div_from_scalar(1, 1.0, 1823);s.store_div(1, 1, 1824);s.store_add(1, 1, 1812);}
        s.b[1832] = (s.v[1] < 0.0001);s.store_scalar(1832, if s.b[1832] { 1.0 } else { 0.0 });
        if (s.b[1805] && s.b[1832]) {s.store_scalar(1, 0.0001);}
        if s.b[1805] {s.store_scale(4, 1, 1.0 / (s.v[451]));}
        s.b[1833] = (p.p43 == 1.0);s.store_scalar(1833, if s.b[1833] { 1.0 } else { 0.0 });s.b[1834] = (s.v[289] < (1e-15 / 0.0001));s.store_scalar(1834, if s.b[1834] { 1.0 } else { 0.0 });
        if ((s.b[1833] && (s.v[85] != 0.0)) && s.b[1834]) {s.store_scalar(289, (1e-15 / 0.0001));}
        s.b[1835] = (s.v[290] < (1e-15 / 0.0001));s.store_scalar(1835, if s.b[1835] { 1.0 } else { 0.0 });
        if ((s.b[1833] && (s.v[85] != 0.0)) && s.b[1835]) {s.store_scalar(290, (1e-15 / 0.0001));}
        ...
        if (s.b[1833] && (s.v[85] != 0.0)) {s.store_div_scaled_inputs2_indices(582, 580, 1.0, 587, (-1.0), 289, 1.0);s.store_div_scaled_inputs2_indices(583, 581, 1.0, 588, (-1.0), 290, 1.0);s.store_add_scaled_product_indices(584, 473, 1.0, 580, 438, 1.0);s.store_add_mixed_ai(585, A::mul_sub_from_scalar_rhs(s.ad_value(580), 1.0, s.ad_value(438)), 473);s.store_add_scaled_inputs3_indices(586, 580, -1.0, 581, (-1.0), 471, 1.0);}
        if (s.b[1833] && (s.v[85] == 0.0)) {s.store_scalar(582, 0.0);s.store_scalar(583, 0.0);s.store_scalar(584, 0.0);s.store_scalar(585, 0.0);s.store_scalar(586, 0.0);s.store_scalar(581, 0.0);}
        s.b[1836] = (s.v[289] < (1e-15 / 0.0001));s.store_scalar(1836, if s.b[1836] { 1.0 } else { 0.0 });
        if (((!s.b[1833]) && (s.v[85] != 0.0)) && s.b[1836]) {s.store_scalar(289, (1e-15 / 0.0001));}
        s.b[1837] = (s.v[290] < (1e-15 / 0.0001));s.store_scalar(1837, if s.b[1837] { 1.0 } else { 0.0 });
        if (((!s.b[1833]) && (s.v[85] != 0.0)) && s.b[1837]) {s.store_scalar(290, (1e-15 / 0.0001));}
        if ((!s.b[1833]) && (s.v[85] != 0.0)) {s.store_div_scaled_inputs2_indices(574, 584, 1.0, 576, (-1.0), 289, 1.0);s.store_div_scaled_inputs2_indices(575, 585, 1.0, 577, (-1.0), 289, 1.0);s.store_div_scaled_inputs2_indices(583, 581, 1.0, 588, (-1.0), 290, 1.0);s.store_scalar(583, 0.0);s.store_add_scaled_inputs3_indices(586, 584, -1.0, 585, (-1.0), 581, -1.0);}
        if ((!s.b[1833]) && (s.v[85] == 0.0)) {s.store_scalar(574, 0.0);s.store_scalar(575, 0.0);s.store_scalar(583, 0.0);s.store_scalar(584, 0.0);s.store_scalar(585, 0.0);s.store_scalar(586, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_82(
        ...
        if ((!s.b[1833]) && (s.v[85] == 0.0)) {s.store_scalar(581, 0.0);}
        s.copy_ad(0, 4);s.copy_ad(1, 5);s.b[1838] = (s.v[613] == 1.0);s.store_scalar(1838, if s.b[1838] { 1.0 } else { 0.0 });
        if s.b[1838] {s.copy_ad(199, 9);s.copy_ad(263, 557);s.store_scalar(573, 0.0);s.store_add(594, 23, 586);s.store_add(198, 24, 584);s.store_add_scaled_inputs3_indices(554, 23, (-1.0), 24, (-1.0), 25, (-1.0));s.store_add(196, 554, 581);}
        if (!s.b[1838]) {s.store_neg(199, 9);s.copy_ad(573, 557);s.store_scalar(263, 0.0);s.store_add(594, 23, 586);s.store_add(198, 25, 585);s.store_add_scaled_inputs3_indices(554, 23, (-1.0), 24, (-1.0), 25, (-1.0));s.store_add(196, 554, 581);}
        s.copy_ad(307, 13);s.copy_ad(306, 14);s.copy_ad(308, 15);s.copy_ad(311, 11);s.copy_ad(312, 12);s.b[1839] = (p.p43 == 1.0);s.store_scalar(1839, if s.b[1839] { 1.0 } else { 0.0 });
        ...
        if s.b[1840] {s.store_mul(578, 199, 157);s.copy_ad(563, 542);s.store_primal_div_from_scalar(589, 1.0, 541);}
        if (!s.b[1840]) {s.store_scalar(578, 0.0);s.store_scalar(563, 0.0);s.store_scalar(589, 0.0);}
        ...
        s.store_scale(610, 429, (4.0 * 1.3806226e-23));s.b[1848] = (p.p27 == 1.0);s.store_scalar(1848, if s.b[1848] { 1.0 } else { 0.0 });s.copy_ad(438, 439);s.store_mul(615, 610, 598);s.copy_ad(614, 559);
        ...
        s.b[1849] = (p.p27 == 1.0);s.store_scalar(1849, if s.b[1849] { 1.0 } else { 0.0 });s.b[1850] = ((p.p38 > 0.0) && (p.p242 > 0.0));s.store_scalar(1850, if s.b[1850] { 1.0 } else { 0.0 });
        if s.b[1850] {s.copy_ad(595, 578);}
        s.b[1851] = (p.p43 == 1.0);s.store_scalar(1851, if s.b[1851] { 1.0 } else { 0.0 });s.b[1852] = ((p.p37 != 0.0) || ((p.p25 == 1.0) && (p.p26 == 2.0)));s.store_scalar(1852, if s.b[1852] { 1.0 } else { 0.0 });s.b[1853] = (p.p43 == 0.0);s.store_scalar(1853, if s.b[1853] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_1(
        ...
        s.store_scalar(476, 0.0);s.store_scalar(477, 0.0);s.store_scalar(488, 0.0);s.store_scalar(490, 0.0);s.store_scalar(497, 0.0);s.store_scalar(499, 0.0);s.store_scalar(56, ((p.p51 * 10.0) % 10.0));s.store_scalar(57, 200.0);s.store_scalar(58, 200.0);s.store_scalar(86, 0.0);s.store_scalar(475, 0.0);s.store_scalar(378, 0.0);s.store_scalar(369, 0.0);s.store_scalar(203, 0.0);s.store_scalar(161, 0.0);s.store_scalar(515, 0.0);s.store_scalar(73, (p.p52 * 0.01));s.store_scalar(59, (p.p73 / 1e-6));s.store_scalar(60, (p.p104 * 0.01));s.store_scalar(61, (p.p201 / 1e-6));s.store_scalar(65, (p.p240 / 1e-6));s.store_scalar(66, (p.p241 / 1e-6));s.store_scalar(67, (p.p242 * 0.01));s.store_scalar(68, (p.p243 / 0.01));s.store_scalar(69, (p.p59 / 1e-6));s.store_scalar(70, (p.p284 / 1e-6));s.store_scalar(71, (p.p148 / 1e-6));s.store_scalar(72, (p.p198 / 0.0001));s.store_scalar(74, (p.p70 * 0.01));s.store_scalar(75, (if (p.p83 == 0.0) { 0.0 } else { p.p84 }));s.store_scalar(76, (if (p.p83 == 0.0) { 0.0 } else { p.p85 }));s.store_scalar(77, (if (p.p80 == 0.0) { 0.0 } else { p.p81 }));s.store_scalar(78, (if (p.p83 == 0.0) { 0.0 } else { p.p82 }));s.store_scalar(79, (p.p250 * 1000000.0));s.store_scalar(81, (p.p232 + 273.15));s.store_scalar(82, p.p58);s.store_scalar(83, (p.p15 * 100.0));s.store_scalar(84, p.p46);s.store_scalar(85, p.p34);s.store_scalar(80, (if param_given[190] { p.p190 } else { (5000000000.0 / (p.p237 * p.p240)) }));s.b[630] = ((s.v[80] < (2.0 + 0.1)) && (0.1 >= 0.0));s.store_scalar(630, if s.b[630] { 1.0 } else { 0.0 });
        if s.b[630] {s.store_scalar(44, ((2.0 + 0.1) - s.v[80]));s.store_square(49, 44);s.store_scalar(50, (0.1 * 0.1));s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);s.store_scalar(54, 0.0);s.store_scalar(55, 0.0);s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
        s.b[631] = ((((2.0 == 1.0) || (2.0 == 2.0)) || (2.0 == 4.0)) || (2.0 == 8.0));s.store_scalar(631, if s.b[631] { 1.0 } else { 0.0 });s.b[632] = (2.0 == 1.0);s.store_scalar(632, if s.b[632] { 1.0 } else { 0.0 });
        if ((s.b[630] && s.b[631]) && s.b[632]) {s.store_scalar(55, 1.0);}
        s.b[633] = (2.0 == 2.0);s.store_scalar(633, if s.b[633] { 1.0 } else { 0.0 });
        if (((s.b[630] && s.b[631]) && (!s.b[632])) && s.b[633]) {s.store_scalar(55, 2.0);}
        s.b[634] = (2.0 == 4.0);s.store_scalar(634, if s.b[634] { 1.0 } else { 0.0 });
        if ((((s.b[630] && s.b[631]) && (!s.b[632])) && (!s.b[633])) && s.b[634]) {s.store_scalar(55, 3.0);}
        s.b[635] = (2.0 == 8.0);s.store_scalar(635, if s.b[635] { 1.0 } else { 0.0 });
        if (((((s.b[630] && s.b[631]) && (!s.b[632])) && (!s.b[633])) && (!s.b[634])) && s.b[635]) {s.store_scalar(55, 4.0);}
        if (s.b[630] && s.b[631]) {s.store_scalar(54, 0.0);}
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((s.b[630] && s.b[631]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;assert!(t1 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (s.b[630] && s.b[631]) {s.store_sqrt(53, 53);s.store_primal_offset(54, 54, 1.0);}
        }
        if (s.b[630] && (!s.b[631])) {s.store_powf(53, 53, (1.0 / (2.0 * 2.0)));}
        if s.b[630] {s.store_div_from_scalar(53, 1.0, 53);s.store_scaled_mul(43, 44, 53, 0.1);s.store_sub_from_scalar(80, (2.0 + 0.1), 43);}
        if (!s.b[630]) {
        }
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (s.b[641] && (s.v[562] < p.p9)) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;assert!(t3 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if s.b[641] {s.store_add_scaled_inputs3_mixed_iaa(328, 328, 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(562), (p.p12 + s.v[96]), (p.p10 + (0.5 * s.v[96])))), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(562), (p.p12 + s.v[96]), (p.p11 + (0.5 * s.v[96])))), 1.0);s.store_primal_offset(562, 562, 1.0);}
        }
        if s.b[641] {s.store_div_from_scalar(537, (2.0 * p.p9), 328);}
        if (!s.b[641]) {s.store_scalar(537, 0.0);}
        s.b[642] = (s.v[537] > 0.0);s.store_scalar(642, if s.b[642] { 1.0 } else { 0.0 });
        if s.b[642] {s.store_scalar(328, (1.0 / (1.0 + p.p162)));s.store_powf_ad(329, A::div_from_scalar(p.p161, s.ad_value(537)), p.p163);s.store_scalar(330, (((p.p161 / s.v[113])) as f64).powf(p.p163));s.store_div_scaled_product_offset_denominator_mixed_iaa(538, 112, A::offset(A::mul(s.ad_value(328), s.ad_value(329)), 1.0), 1.0, A::mul(s.ad_value(328), s.ad_value(330)), 1.0, 1.0);}
        ...
        if s.b[643] {s.store_scalar(328, (1.0 / (1.0 + p.p165)));s.store_powf_ad(329, A::div_from_scalar(p.p164, s.ad_value(537)), p.p166);s.store_scalar(330, (((p.p164 / s.v[113])) as f64).powf(p.p166));s.store_div_scaled_product_offset_denominator_mixed_iaa(544, 544, A::offset(A::mul(s.ad_value(328), s.ad_value(329)), 1.0), 1.0, A::mul(s.ad_value(328), s.ad_value(330)), 1.0, 1.0);}
        s.b[644] = ((s.v[99] > p.p72) || (p.p72 <= 0.0));s.store_scalar(644, if s.b[644] { 1.0 } else { 0.0 });
        if s.b[644] {s.store_add_scaled_inputs(536, 544, ((s.v[99] - p.p72) * 1.0 / (s.v[99])), 538, (p.p72 * 1.0 / (s.v[99])));}
        if (!s.b[644]) {s.store_add_scaled_inputs3_indices(536, 538, 1.0, 538, ((p.p72 - s.v[99]) * 1.0 / (p.p72)), 544, (-((p.p72 - s.v[99]) * 1.0 / (p.p72))));}
        s.store_scale(229, 536, 1.6021918e-19);s.store_scale(545, 229, 1.034943e-10);s.store_scale(546, 545, 2.0);s.b[645] = ((s.v[99] <= (2.0 * p.p72)) && (p.p72 > 0.0));s.store_scalar(645, if s.b[645] { 1.0 } else { 0.0 });
        if s.b[645] {s.store_add_scaled_inputs4_indices(593, 538, 2.0, 538, (-(s.v[99] * 1.0 / (p.p72))), 544, (-(-(s.v[99] * 1.0 / (p.p72)))), 544, -1.0);s.store_ln_div(548, 593, 544);}
        if (!s.b[645]) {s.store_scalar(548, 0.0);}
        s.store_scaled_ln_scaled_input(232, 536, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));s.store_scaled_ln_scaled_input(236, 544, 1.0 / ((10400000000.0 / 1e-6)), (2.0 / 38.68283));s.store_sqrt_div_from_scalar_ad(549, ((2.0 * 1.034943e-10) / 1.6021918e-19), s.ad_value(536));s.store_scalar(328, ((1.0 + (p.p194 / ((s.v[100]) as f64).powf(p.p195))) * (1.0 + (p.p196 / ((s.v[110]) as f64).powf(p.p197)))));s.store_scalar(44, ((((s.v[328] * s.v[328]) + ((4.0 * 0.001) * 0.001))) as f64).sqrt());s.store_scalar(550, ((0.5 * (s.v[328] + s.v[44])) + (1e-10 * 0.001)));s.b[646] = (s.v[550] < 0.0);s.store_scalar(646, if s.b[646] { 1.0 } else { 0.0 });
        if s.b[646] {s.store_scalar(550, 0.0);}
        s.b[649] = (p.p261 == 1.0);s.store_scalar(649, if s.b[649] { 1.0 } else { 0.0 });
        if s.b[649] {s.store_offset_scaled(327, 107, p.p289, p.p288);}
        s.b[654] = (p.p43 == 1.0);s.store_scalar(654, if s.b[654] { 1.0 } else { 0.0 });
        if (s.b[654] && (p.p24 != 0.0)) {s.store_scalar(533, (if s.b[527] { p.p23 } else { ((p.p20 * p.p9) * p.p19) }));}
        if (s.b[654] && (p.p24 != 0.0)) {s.store_scalar(534, (if s.b[526] { p.p22 } else { ((p.p21 * p.p9) * p.p19) }));}
        if (s.b[654] && (p.p24 != 0.0)) {s.store_scalar(531, 0.0);s.store_scalar(532, 0.0);}
        s.b[655] = ((s.v[533] > 0.0) && s.b[525]);s.store_scalar(655, if s.b[655] { 1.0 } else { 0.0 });
        if ((s.b[654] && (p.p24 != 0.0)) && s.b[655]) {s.store_primal_scale(531, 533, (-p.p294));}
        if ((s.b[654] && (p.p24 != 0.0)) && (!s.b[655])) {s.store_scalar(531, 0.0);}
        s.b[656] = ((s.v[534] > 0.0) && s.b[524]);s.store_scalar(656, if s.b[656] { 1.0 } else { 0.0 });
        if ((s.b[654] && (p.p24 != 0.0)) && s.b[656]) {s.store_primal_scale(532, 534, (-p.p293));s.store_scalar(534, 0.0);}
        if (s.b[654] && (p.p24 == 0.0)) {s.store_scalar(534, 0.0);s.store_scalar(532, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_4(
        ...
        if (s.b[654] && (p.p24 == 0.0)) {s.store_scalar(533, 0.0);s.store_scalar(531, 0.0);}
        if s.b[654] {s.store_scalar(535, (if (p.p19 > s.v[96]) { (0.5 * (p.p19 - s.v[96])) } else { 0.0 }));}
        ...
        if s.b[654] {s.store_primal_add_scaled_inputs(286, 107, 1.0, 518, p.p9);s.store_primal_add_scaled_inputs(285, 107, 1.0, 519, p.p9);s.store_primal_add_scaled_inputs(288, 108, 1.0, 518, p.p9);s.store_primal_add_scaled_inputs(287, 108, 1.0, 519, p.p9);}
        ...
        s.store_scaled_voltage(571, ctx, nodes, Some(6), Some(7), p.p50);s.store_scaled_voltage(572, ctx, nodes, Some(11), Some(7), p.p50);s.store_scaled_voltage(570, ctx, nodes, Some(12), Some(7), p.p50);s.b[659] = (p.p43 == 1.0);s.store_scalar(659, if s.b[659] { 1.0 } else { 0.0 });
        if s.b[659] {s.store_scaled_voltage(590, ctx, nodes, Some(12), Some(6), p.p50);s.store_scaled_voltage(591, ctx, nodes, Some(12), Some(7), p.p50);}
    ...
    pub(super) fn stamp_reactive_block_5(
        ...
        s.store_scaled_mul_ad(230, A::powf(A::scale(s.ad_value(429), 1.0 / (s.v[81])), 1.5), A::exp(A::offset(A::mul_scaled_lhs(s.ad_value(237), (-1.0 / (2.0)), s.ad_value(225)), ((s.v[87] / 2.0) * s.v[114]))), (10400000000.0 / 1e-6));s.store_scaled_sqrt(208, 227, s.v[119]);s.store_square(205, 208);s.store_scaled_square(209, 230, s.v[120]);s.store_scalar(441, (s.v[96] - (2.0 * p.p56)));s.b[668] = (s.v[56] > 3.0);s.store_scalar(668, if s.b[668] { 1.0 } else { 0.0 });
        ...
        s.store_sqrt_mul_ad(228, A::div_from_scalar(1.034943e-10, s.ad_value(229)), s.ad_value(227));s.store_scaled_mul(238, 229, 228, 1.414213562373095);s.b[669] = (p.p43 == 1.0);s.store_scalar(669, if s.b[669] { 1.0 } else { 0.0 });
        ...
        s.store_square(379, 328);s.store_sqrt_scaled_input_ad(444, A::div_scalar_by_product(1.034943e-10, s.ad_value(229), s.ad_value(225), 1.0), 2.0);s.store_div_from_scalar(547, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544);s.store_sqrt_div_scaled_inputs(416, 231, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544, 1.0);s.b[674] = (p.p43 == 1.0);s.store_scalar(674, if s.b[674] { 1.0 } else { 0.0 });
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if ((s.b[676] && s.b[677]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_6(
        ...
        s.copy_ad(157, 152);s.copy_ad(158, 153);s.copy_ad(156, 154);s.store_scalar(144, 0.0);s.store_scalar(619, 0.0);s.store_scalar(620, 0.0);s.store_scalar(621, 0.0);s.store_scalar(622, 0.0);s.store_scalar(623, 0.0);s.store_scalar(624, 0.0);s.store_scalar(425, 0.0);s.store_scalar(426, 0.0);s.store_scalar(427, 0.0);s.store_scalar(428, 0.0);s.store_scalar(167, 0.0);s.store_scalar(168, 0.0);s.store_scaled_mul(682, 155, 157, 0.5);s.store_scale(44, 682, (2.0 * 1.0 / (p.p226)));s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p.p226, 45);s.b[683] = (s.v[175] < 5e-12);s.store_scalar(683, if s.b[683] { 1.0 } else { 0.0 });
        if s.b[683] {s.store_scalar(175, 5e-12);}
        s.store_add(172, 156, 175);s.store_add_scaled_inputs(173, 157, 1.0, 175, 2.0);s.store_add(174, 158, 175);s.b[684] = (p.p43 == 1.0);s.store_scalar(684, if s.b[684] { 1.0 } else { 0.0 });
        ...
        if (!(s.v[45] > 0.0)) {s.store_scalar(45, (-s.v[45]));}
        s.store_sqrt_square_add(45, 44, 45);s.store_offset_add_scaled_inputs_indices(194, 44, 0.5, 45, 0.5, 0.1);s.store_div(685, 157, 194);s.copy_ad(44, 685);s.store_square(45, 44);s.store_mul(46, 45, 44);s.store_square(47, 45);s.store_div_from_scalar_ad(688, 1.0, A::add_scaled_inputs4_offset(s.ad_value(44), 1.0, s.ad_value(45), 1.0, s.ad_value(46), 1.0, s.ad_value(47), 1.0, 1.0));
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_7(
        ...
        s.store_mul_ad_affine_product_lhs(327, A::add_scaled_inputs3_offset(s.ad_value(44), 2.0, s.ad_value(45), 3.0, s.ad_value(46), 4.0, 1.0), s.ad_value(688), -1.0, 0.0, 688);s.store_sub_from_scalar(688, 1.0, 688);s.store_neg(327, 327);s.store_square(326, 688);s.b[696] = (((p.p204 == 0.0) && (p.p206 == 0.0)) || (p.p205 == 0.0));s.store_scalar(696, if s.b[696] { 1.0 } else { 0.0 });
        ...
        if (!s.b[697]) {s.store_add_scaled_inputs3_offset_indices(694, 158, 1.0, 513, (-1.0), 325, -1.0, p.p205);s.store_sqrt_square_offset(44, 694, ((4.0 * 0.0001) * 0.0001));s.store_offset_add_scaled_inputs_indices(690, 694, 0.5, 44, 0.5, (1e-10 * 0.0001));}
        s.b[698] = (s.v[690] < 0.0);s.store_scalar(698, if s.b[698] { 1.0 } else { 0.0 });
        if ((!s.b[697]) && s.b[698]) {s.store_scalar(690, 0.0);}
        if (!s.b[697]) {s.store_div_from_scalar(691, 1.0, 690);s.store_scaled_abs(693, 325, 2.0);s.store_offset_sub_from_scalar_ad(695, s.v[123], s.ad_value(325), p.p205);}
        if (!s.b[697]) {
            if (s.v[695] > s.v[693]) {
                s.copy_ad(692, 695);
            } else {
        ...
        if (!s.b[697]) {s.store_sqrt_square_add(45, 44, 45);s.store_add_scaled_inputs3_mixed_aii(690, A::div_from_scalar(1.0, s.ad_value(692)), 1.0, 44, (-0.5), 45, (-0.5));s.store_offset_scaled(322, 690, p.p204, p.p206);}
        ...
        s.b[700] = ((p.p43 == 1.0) || (s.v[56] < 3.0));s.store_scalar(700, if s.b[700] { 1.0 } else { 0.0 });
        ...
        if s.b[700] {s.store_sqrt_square_add(45, 44, 45);s.store_offset_add_scaled_inputs_indices(435, 44, (-0.5), 45, (-0.5), 0.5);s.store_add_scaled_inputs3_indices(440, 229, (((-p.p237) * p.p237) * 1.0 / ((2.0 * 1.034943e-10))), 231, 1.0, 227, -1.0);s.store_offset_sub(44, 435, 440, (-0.001));s.store_scale(45, 440, (4.0 * 0.001));}
        if s.b[700] {
            if (s.v[45] > 0.0) {
            } else {
                s.store_neg(45, 45);
        ...
        if s.b[702] {s.store_scalar(184, p.p237);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_8(
        ...
        if s.b[714] {s.store_add_scaled_product_mixed_aii(183, A::offset(s.ad_value(236), s.v[123]), 1.0, 709, 324, 1.0);s.store_scale(708, 324, 1.034943e-10);s.store_scalar(711, (1.0 / (p.p72 * p.p72)));s.store_scaled_mul(710, 184, 711, 2.0);s.store_mul_ad_product_rhs_mixed_ia(712, 708, 710, A::sub_from_scalar(p.p69, s.ad_value(233)));s.copy_ad(713, 712);s.store_sub(708, 318, 183);s.store_scalar(707, (s.v[78] / p.p72));s.store_offset_mul(709, 707, 234, p.p80);s.store_scalar(712, s.v[77]);s.store_add_scaled_product_indices(710, 709, 1.0, 712, 173, 1.0);s.store_mul3_lhs(319, 708, 713, 710);}
        if (!s.b[714]) {s.store_scalar(319, 0.0);}
        s.store_scale(715, 184, (1.034943e-10 * 2.0));s.store_mul(716, 324, 715);s.store_sub_from_scalar(717, p.p69, 233);s.store_scalar(718, (s.v[99] - p.p71));s.store_scalar(719, (1.0 / (s.v[718] * s.v[718])));s.store_scaled_mul(721, 716, 717, s.v[719]);s.store_scalar(716, (s.v[76] / s.v[99]));s.store_offset_scaled(719, 234, s.v[716], p.p83);s.store_add_scaled_inputs(720, 719, 1.0, 173, s.v[75]);s.store_mul(187, 721, 720);s.b[725] = (p.p86 > 0.0);s.store_scalar(725, if s.b[725] { 1.0 } else { 0.0 });
        if s.b[725] {s.store_add_scaled_inputs3_offset_indices(722, 237, 1.0, 231, 1.0, 173, p.p87, (-(2.0 * p.p88)));s.store_scalar(723, ((s.v[99] * 0.5) + s.v[74]));s.store_primal_div_from_scalar(724, (p.p86 * p.p237), 723);s.store_mul(188, 722, 724);}
        if (!s.b[725]) {s.store_scalar(188, 0.0);}
        s.copy_ad(726, 324);s.store_div_from_scalar_add_ad(727, 1.0, s.ad_value(323), A::div_from_scalar(s.v[72], s.ad_value(105)));s.store_sub(728, 726, 727);s.store_offset_mul(189, 245, 728, (p.p105 / s.v[109]));s.store_add_scaled_inputs4_offset_indices(185, 187, 1.0, 319, 1.0, 189, 1.0, 188, 1.0, s.v[125]);s.store_sub(182, 318, 185);s.b[732] = (p.p89 == 0.0);s.store_scalar(732, if s.b[732] { 1.0 } else { 0.0 });
        ...
        if (!s.b[733]) {s.copy_ad(729, 174);s.store_scalar(730, s.v[121]);s.store_offset(731, 729, (-p.p90));}
    ...
    pub(super) fn stamp_reactive_block_9(
        ...
        if s.b[737] {s.store_scaled_mul(406, 544, 403, (-1.6021918e-19));s.store_scalar(740, p.p237);s.store_scaled_mul(341, 544, 740, (-1.6021918e-19));s.store_scalar(741, 1.5);s.store_primal_div_from_scalar(738, 1.034943e-10, 740);s.store_primal_div_from_scalar(739, 1.0, 738);s.store_scale(743, 341, (-0.001));s.store_scale(744, 341, (-1e-5));}
        if (s.b[737] && (p.p39 != 0.0)) {s.store_add(475, 172, 342);}
        if (s.b[737] && (p.p39 == 0.0)) {s.store_add(475, 156, 342);}
        ...
        if s.b[737] {s.store_sqrt(747, 747);s.store_add_scaled_product_indices(748, 746, 2.0, 745, 225, 1.0);s.store_scaled_sub(749, 748, 747, 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_10(
        s: &mut ReactiveScratch,
    ) {
        if s.b[737] {s.store_div_ad(750, A::ln(A::div_scaled_product_by_product(s.ad_value(746), s.ad_value(746), 1.0, s.ad_value(745), s.ad_value(239), 1.0)), A::add(s.ad_value(225), A::div_from_scalar(2.0, s.ad_value(746))));}
    ...
    pub(super) fn stamp_reactive_block_11(
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if (s.b[737] && (s.v[167] < s.v[57])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_12(
        ...
        let mut ta: usize = 0;
        while {
            let t9: f64 = if (((s.b[737] && s.b[774]) && s.b[775]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
