...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_80(
        ...
        if s.b[1777] {s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1786), 0.4, 1.8), 1.0, s.ad_value(1786), s.ad_value(1786), 0.1), A::scale_offset(s.ad_value(1786), (-p[270]), p[270]));s.store_div(1790, 1782, 327);s.store_add_mixed_ia(1783, 1783, A::scaled_offset(s.ad_value(429), (-s.v[81]), p[274]));s.store_scalar(1778, (1.0 + (p[279] / ((s.v[100]) as f64).powf(p[280]))));s.store_scalar(1780, (1.0 + (p[277] / ((s.v[100]) as f64).powf(p[278]))));s.store_scalar(1779, (1.0 + (p[275] / ((s.v[109]) as f64).powf(p[276]))));s.store_mul(1789, 1789, 1778);s.store_offset_product3(1790, s.ad_value(1790), s.ad_value(1779), s.ad_value(1780), 1.0, 1e-50);s.store_div(1791, 1785, 1787);s.store_mul(1792, 1789, 1791);}
    ...
    if s.b[1805] {
        ...
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1816, (p[264] / 1e-6));s.store_scalar(1809, p[266]);s.store_scalar(1810, p[268]);s.store_scalar(1811, p[273]);}
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1812, (if (p[263] > 0.0) { (p[263] * p[255]) } else { 0.0 }));}
        if (s.b[1805] && s.b[1825]) {s.store_scalar(1815, p[258]);s.store_scaled_voltage(1813, ctx, nodes, Some(7), Some(2), p[50]);}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1816, (p[59] / 1e-6));s.store_scalar(1809, p[265]);s.store_scalar(1810, p[267]);s.store_scalar(1811, p[272]);}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1812, (if (p[263] > 0.0) { (p[263] * p[256]) } else { 0.0 }));}
        if (s.b[1805] && (!s.b[1825])) {s.store_scalar(1815, p[257]);s.store_scaled_voltage(1813, ctx, nodes, Some(0), Some(6), p[50]);}
        if s.b[1805] {s.store_scalar(1822, ((((p[271] * p[271]) + (p[56] * p[56]))) as f64).sqrt());s.store_primal_scale(1824, 105, p[9]);s.store_primal_scale(1809, 1809, 0.0001);s.store_primal_scale(1810, 1810, 0.01);s.store_scale(1814, 429, 1.0 / (s.v[81]));s.store_powf(328, 1814, p[269]);s.store_div(1817, 1809, 328);s.store_sub_ad(327, A::add_scaled_product(A::scale_offset(s.ad_value(1814), 0.4, 1.8), 1.0, s.ad_value(1814), s.ad_value(1814), 0.1), A::scale_offset(s.ad_value(1814), (-p[270]), p[270]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_81(
        ...
        if s.b[1805] {s.store_div(1818, 1810, 327);s.store_add_mixed_ia(1811, 1811, A::scaled_offset(s.ad_value(429), (-s.v[81]), p[274]));s.store_scalar(1806, (1.0 + (p[279] / ((s.v[100]) as f64).powf(p[280]))));s.store_scalar(1808, (1.0 + (p[277] / ((s.v[100]) as f64).powf(p[278]))));s.store_scalar(1807, (1.0 + (p[275] / ((s.v[109]) as f64).powf(p[276]))));s.store_mul(1817, 1817, 1806);s.store_offset_product3(1818, s.ad_value(1818), s.ad_value(1807), s.ad_value(1808), 1.0, 1e-50);s.store_div(1819, 1813, 1815);s.store_mul(1820, 1817, 1819);}
        ...
        s.b[1833] = (p[43] == 1.0);s.store_scalar(1833, if s.b[1833] { 1.0 } else { 0.0 });s.b[1834] = (s.v[289] < (1e-15 / 0.0001));s.store_scalar(1834, if s.b[1834] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_82(
        ...
        s.copy_ad(307, 13);s.copy_ad(306, 14);s.copy_ad(308, 15);s.copy_ad(311, 11);s.copy_ad(312, 12);s.b[1839] = (p[43] == 1.0);s.store_scalar(1839, if s.b[1839] { 1.0 } else { 0.0 });
        ...
        s.store_scale(610, 429, (4.0 * 1.3806226e-23));s.b[1848] = (p[27] == 1.0);s.store_scalar(1848, if s.b[1848] { 1.0 } else { 0.0 });s.copy_ad(438, 439);s.store_mul(615, 610, 598);s.copy_ad(614, 559);
        ...
        s.b[1849] = (p[27] == 1.0);s.store_scalar(1849, if s.b[1849] { 1.0 } else { 0.0 });s.b[1850] = ((p[38] > 0.0) && (p[242] > 0.0));s.store_scalar(1850, if s.b[1850] { 1.0 } else { 0.0 });
        if s.b[1850] {s.copy_ad(595, 578);}
        s.b[1851] = (p[43] == 1.0);s.store_scalar(1851, if s.b[1851] { 1.0 } else { 0.0 });s.b[1852] = ((p[37] != 0.0) || ((p[25] == 1.0) && (p[26] == 2.0)));s.store_scalar(1852, if s.b[1852] { 1.0 } else { 0.0 });s.b[1853] = (p[43] == 0.0);s.store_scalar(1853, if s.b[1853] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_reactive_block_2(
        ...
        s.store_scalar(101, (p[1] / p[9]));s.store_scalar(102, p[60]);s.store_scalar(103, (if (s.v[56] < 1.0) { 0.0 } else { p[295] }));s.store_scalar(104, (if (s.v[56] < 1.0) { p[60] } else { p[61] }));s.b[636] = (p[43] == 0.0);s.store_scalar(636, if s.b[636] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (s.b[641] && (s.v[562] < p[9])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
        ...
        if (s.b[654] && (p[24] == 0.0)) {s.store_scalar(534, 0.0);s.store_scalar(532, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_4(
        ...
        if (s.b[654] && (p[24] == 0.0)) {s.store_scalar(533, 0.0);s.store_scalar(531, 0.0);}
