...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.store_scalar(518, p[13]);s.store_scalar(519, p[14]);s.store_scalar(520, (p[16] + 273.15));s.store_primal_div_from_scalar_scaled_input(541, s.v[67], 107, s.v[451]);s.store_primal_scale(542, 108, (s.v[451] * s.v[68]));s.b[641] = (((p[10] > 0.0) && (p[11] > 0.0)) && ((p[9] == 1.0) || ((p[9] > 1.0) && (p[12] > 0.0))));s.store_scalar(641, if s.b[641] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        s.store_scalar(328, ((1.0 + (p[194] / ((s.v[100]) as f64).powf(p[195]))) * (1.0 + (p[196] / ((s.v[110]) as f64).powf(p[197])))));s.store_scalar(44, ((((s.v[328] * s.v[328]) + ((4.0 * 0.001) * 0.001))) as f64).sqrt());s.store_scalar(550, ((0.5 * (s.v[328] + s.v[44])) + (1e-10 * 0.001)));s.b[646] = (s.v[550] < 0.0);s.store_scalar(646, if s.b[646] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        let ctx_temp = ctx.temperature();let nv10 = ctx.node_voltage(nodes[10]);s.store_scaled_voltage(571, ctx, nodes, Some(6), Some(7), p[50]);s.store_scaled_voltage(572, ctx, nodes, Some(11), Some(7), p[50]);s.store_scaled_voltage(570, ctx, nodes, Some(12), Some(7), p[50]);s.b[659] = (p[43] == 1.0);s.store_scalar(659, if s.b[659] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        s.store_scaled_mul(682, 155, 157, 0.5);s.store_scale(44, 682, (2.0 * 1.0 / (p[226])));s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p[226], 45);s.b[683] = (s.v[175] < 5e-12);s.store_scalar(683, if s.b[683] { 1.0 } else { 0.0 });
