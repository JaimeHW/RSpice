...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_scalar(390, 0.0);s.store_scalar(392, 0.0);s.store_scalar(393, 0.0);s.store_scalar(401, 0.0);s.store_scalar(376, 0.0);s.store_scalar(436, 0.0);s.store_scalar(437, 0.0);s.store_scalar(438, 0.5);s.store_scalar(439, 0.5);s.store_scalar(447, 0.0);s.store_scalar(476, 0.0);s.store_scalar(477, 0.0);s.store_scalar(592, 0.0);s.store_scalar(576, 0.0);s.store_scalar(577, 0.0);s.store_scalar(587, 0.0);s.store_scalar(588, 0.0);s.store_scalar(488, 0.0);s.store_scalar(490, 0.0);s.store_scalar(497, 0.0);s.store_scalar(499, 0.0);let t0: f64 = (p[51] * 10.0);let t1: f64 = (t0 % 10.0);s.store_scalar(56, t1);s.store_scalar(57, 200.0);s.store_scalar(58, 200.0);s.store_scalar(86, 0.0);s.store_scalar(475, 0.0);s.store_scalar(378, 0.0);s.store_scalar(369, 0.0);s.store_scalar(203, 0.0);s.store_scalar(161, 0.0);s.store_scalar(515, 0.0);s.store_scalar(73, (p[52] * 0.01));s.store_scalar(59, (p[73] / 1e-6));s.store_scalar(60, (p[104] * 0.01));s.store_scalar(61, (p[201] / 1e-6));s.store_scalar(65, (p[240] / 1e-6));s.store_scalar(66, (p[241] / 1e-6));s.store_scalar(67, (p[242] * 0.01));s.store_scalar(68, (p[243] / 0.01));s.store_scalar(69, (p[59] / 1e-6));s.store_scalar(70, (p[284] / 1e-6));s.store_scalar(71, (p[148] / 1e-6));s.store_scalar(72, (p[198] / 0.0001));s.store_scalar(74, (p[70] * 0.01));s.store_scalar(75, (if (p[83] == 0.0) { 0.0 } else { p[84] }));s.store_scalar(76, (if (p[83] == 0.0) { 0.0 } else { p[85] }));s.store_scalar(77, (if (p[80] == 0.0) { 0.0 } else { p[81] }));s.store_scalar(78, (if (p[83] == 0.0) { 0.0 } else { p[82] }));s.store_scalar(79, (p[250] * 1000000.0));s.store_scalar(81, (p[232] + 273.15));s.store_scalar(82, p[58]);s.store_scalar(83, (p[15] * 100.0));s.store_scalar(84, p[46]);s.store_scalar(85, p[34]);s.store_scalar(80, (if param_given[190] { p[190] } else { (5000000000.0 / (p[237] * p[240])) }));s.b[630] = ((s.v[80] < (2.0 + 0.1)) && (0.1 >= 0.0));s.store_scalar(630, if s.b[630] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        s.b[647] = (p[35] == 1.0);s.store_scalar(647, if s.b[647] { 1.0 } else { 0.0 });s.b[648] = (s.v[128] > 0.001);s.store_scalar(648, if s.b[648] { 1.0 } else { 0.0 });
        ...
        if s.b[649] {s.store_offset_scaled(327, 107, p[289], p[288]);s.store_scale(2, 327, 1.0 / (s.v[451]));}
        ...
        s.store_scalar(552, 0.0);s.store_scalar(553, 0.0);s.b[651] = (p[262] == 1.0);s.store_scalar(651, if s.b[651] { 1.0 } else { 0.0 });s.b[652] = (p[290] < 0.0001);s.store_scalar(652, if s.b[652] { 1.0 } else { 0.0 });
        if (s.b[651] && s.b[652]) {s.store_scalar(552, (s.v[451] * 10000.0));}
        if (s.b[651] && (!s.b[652])) {s.store_scalar(552, (s.v[451] * (1e-6 + (1.0 / p[290]))));}
        s.b[653] = (p[291] < 0.0001);s.store_scalar(653, if s.b[653] { 1.0 } else { 0.0 });
        if (s.b[651] && s.b[653]) {s.store_scalar(553, (s.v[451] * 10000.0));}
        if (s.b[651] && (!s.b[653])) {s.store_scalar(553, (s.v[451] * (1e-6 + (1.0 / p[291]))));}
        ...
        if (s.b[654] && (p[24] == 0.0)) {s.store_scalar(534, 0.0);s.store_scalar(532, 0.0);s.store_scalar(533, 0.0);s.store_scalar(531, 0.0);}
    ...
    if (!s.b[660]) {
        ...
        s.store_square(379, 328);s.store_sqrt_scaled_input_ad(444, A::div_scalar_by_product(1.034943e-10, s.ad_value(229), s.ad_value(225), 1.0), 2.0);s.store_div_from_scalar(547, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544);let t12: f64 = (2.0 * 1.034943e-10);let t13: f64 = (t12 / 1.6021918e-19);let t14: f64 = (t13 * s.v[231]);let t15: f64 = (t14 / s.v[544]);let t16: f64 = (t15).sqrt();s.store_scalar(416, t16);s.b[674] = (p[43] == 1.0);s.store_scalar(674, if s.b[674] { 1.0 } else { 0.0 });
    ...
    if (s.b[676] && s.b[677]) {
        ...
        s.copy_ad(157, 152);s.copy_ad(158, 153);s.copy_ad(156, 154);s.store_scalar(144, 0.0);s.store_scalar(619, 0.0);s.store_scalar(620, 0.0);s.store_scalar(621, 0.0);s.store_scalar(622, 0.0);s.store_scalar(623, 0.0);s.store_scalar(624, 0.0);s.store_scalar(425, 0.0);s.store_scalar(426, 0.0);s.store_scalar(427, 0.0);s.store_scalar(428, 0.0);s.store_scalar(167, 0.0);s.store_scalar(168, 0.0);s.store_scaled_mul(682, 155, 157, 0.5);s.store_scale(44, 682, (2.0 * 1.0 / (p[226])));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p[226], 45);s.b[683] = (s.v[175] < 5e-12);s.store_scalar(683, if s.b[683] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        if (!s.b[697]) {s.store_scaled_abs(693, 325, 2.0);s.store_offset_sub_from_scalar_ad(695, s.v[123], s.ad_value(325), p[205]);}
        if (!s.b[697]) {
            if (s.v[695] > s.v[693]) {
                s.copy_ad(692, 695);
            } else {
