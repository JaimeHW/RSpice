...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_0(
        ...
        s.v[625] = if (1.0 == 1.0) { 1.0 } else { 0.0 };

        s.v[629] = if (p.p43 == 0.0) { 1.0 } else { 0.0 };
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.v[647] = if (p.p35 == 1.0) { 1.0 } else { 0.0 };

        s.v[648] = if (s.v[128] > 0.001) { 1.0 } else { 0.0 };
        ...
        s.v[650] = if (s.v[2] < 0.0001) { 1.0 } else { 0.0 };
        ...
        s.v[651] = if (p.p262 == 1.0) { 1.0 } else { 0.0 };

        s.v[652] = if (p.p290 < 0.0001) { 1.0 } else { 0.0 };

        if ((s.v[651] != 0.0) && (s.v[652] != 0.0)) {
        ...
        s.v[653] = if (p.p291 < 0.0001) { 1.0 } else { 0.0 };

        if ((s.v[651] != 0.0) && (s.v[653] != 0.0)) {
