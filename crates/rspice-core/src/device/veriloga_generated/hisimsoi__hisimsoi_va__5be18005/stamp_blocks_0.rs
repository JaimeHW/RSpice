...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_3(
        ...
        s.store_ad_value(193, A::add_scaled_product(s.ad_value(686), 1.0, s.ad_value(685), A::sub_from_scalar(1.0, s.ad_value(688)), 1.0));
        ...
        s.store_div_from_scalar_add_ad(688, 1.0, A::add_scaled_inputs3(A::offset(s.ad_value(44), 1.0), 1.0, s.ad_value(45), 1.0, s.ad_value(46), 1.0), s.ad_value(47));

        s.store_mul_ad_affine_product_lhs(327, A::add_scaled_inputs3(A::scale_offset(s.ad_value(44), 2.0, 1.0), 1.0, s.ad_value(45), 3.0, s.ad_value(46), 4.0), s.ad_value(688), -1.0, 0.0, 688);
        ...
        if (!s.b[697]) {
            s.store_offset_ad(694, A::add_scaled_inputs3(s.ad_value(158), 1.0, s.ad_value(513), (-1.0), s.ad_value(325), -1.0), p.p205);
        ...
        if (!s.b[697]) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(690, A::add_scaled_inputs3(A::div_from_scalar(1.0, s.ad_value(692)), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        ...
        s.store_ad_value(706, A::add_scaled_inputs3(s.ad_value(233), s.v[704], s.ad_value(703), (-0.5), s.ad_value(705), (-0.5)));
        ...
        if s.b[714] {
            s.store_ad_value(183, A::add_scaled_product(A::offset(s.ad_value(236), s.v[123]), 1.0, s.ad_value(709), s.ad_value(324), 1.0));
            ...
            s.store_ad_value(710, A::add_scaled_product(s.ad_value(709), 1.0, s.ad_value(712), s.ad_value(173), 1.0));
        ...
        if s.b[725] {
            s.store_add_scaled_ad_lhs(722, A::offset(A::add(s.ad_value(237), s.ad_value(231)), (-(2.0 * p.p88))), 173, p.p87);
        ...
        if (((!s.b[733]) && (!s.b[734])) && s.b[735]) {
            s.store_offset_mul_ad(320, s.ad_value(731), A::offset(A::mul(s.ad_value(731), A::scale_offset(s.ad_value(731), (1.0 / 27.0), (1.0 / 3.0))), 1.0), 1.0);
        }

        if (((!s.b[733]) && (!s.b[734])) && (!s.b[735])) {
            s.store_offset_mul_ad(320, s.ad_value(731), A::offset(A::mul(s.ad_value(731), A::offset(A::mul(s.ad_value(731), A::scale_offset(s.ad_value(731), 0.148148111111111, 0.0402052934513951)), (1.0 / 3.0))), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if s.b[737] {
            ...
            s.store_neg(746, 475);
            s.store_ad_value(747, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(746)), 4.0, s.ad_value(745), 4.0), (-1.0), A::add_scaled_product(s.ad_value(746), 2.0, s.ad_value(745), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(746), 2.0, s.ad_value(745), s.ad_value(225), 1.0), 1.0));
        }

        if s.b[737] {
            s.store_ad_value(747, {
        ...
        if s.b[737] {
            ...
            s.store_ad_value(748, A::add_scaled_product(s.ad_value(746), 2.0, s.ad_value(745), s.ad_value(225), 1.0));
        ...
        if (s.b[737] && (!s.b[751])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(387, A::add_scaled_inputs3(s.ad_value(750), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }
        ...
        while {
            ...
            if (s.b[737] && s.b[760]) {
                ...
                s.store_mul_scaled_ad_rhs(756, 752, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(754), s.ad_value(753)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(755), (-1.0)), 1.0)));
                s.store_mul_ad(757, A::div_from_scalar(s.v[122], s.ad_value(756)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(754)), 1.0, s.ad_value(239), s.ad_value(755), 1.0));
            }
            ...
            if s.b[737] {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(756)), 1.0, s.ad_value(743), s.ad_value(743), 4.0));
                s.store_offset_scaled_div(759, 756, 45, 0.5, 0.5);
                s.store_ad_value(758, A::add_scaled_inputs3(s.ad_value(756), 0.5, s.ad_value(45), 0.5, s.ad_value(743), 1e-10));
            }
            s.b[762] = (s.v[758] < 0.0);
            ...
            if s.b[737] {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(758), (-1.0), s.ad_value(744), -1.0));
            ...
            if s.b[737] {
                ...
                s.store_ad_value(758, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(759, 759, 757, 335);
                s.store_ad_value(390, A::div_scaled_inputs(A::square(s.ad_value(758)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_div_ad_lhs(391, A::mul_scaled_lhs(s.ad_value(390), 2.0, s.ad_value(759)), 758);
                s.store_sub_ad_rhs(758, 387, A::div(A::add(A::add_scaled_inputs3(s.ad_value(756), 1.0 / (s.v[93]), s.ad_value(387), (-1.0), s.ad_value(475), -1.0), s.ad_value(390)), A::add(A::scale_offset(s.ad_value(757), 1.0 / (s.v[93]), (-1.0)), s.ad_value(391))));
            }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (s.b[737] && s.b[780]) {
            s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(405), 1.0, s.ad_value(403), (-1.0), s.ad_value(740), 1.0));
            s.store_square(49, 44);
        ...
        if (s.b[737] && s.b[780]) {
            ...
            s.store_ad_value(405, A::add_scaled_inputs3(s.ad_value(403), 1.0, s.ad_value(740), (-1.0), s.ad_value(43), 1.0));
        }
        ...
        if s.b[737] {
            ...
            s.store_ad_value(384, A::add_scaled_product(s.ad_value(227), 1.0, s.ad_value(341), s.ad_value(740), ((-0.5) * 9662367879.197212)));
            s.store_ad_value(385, A::add_scaled_product(s.ad_value(384), 1.0, s.ad_value(386), s.ad_value(740), (-9662367879.197212)));
        }
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if ((s.b[737] && (!s.b[786])) && (!s.b[798])) {
            ...
            s.store_neg_ad(328, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(349)), 1.0, s.ad_value(341), s.ad_value(740), (-(1.0 / (2.0) * 9662367879.197212))));
        ...
        while {
            ...
            if (s.b[737] && (!s.b[786])) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(331)), 1.0, s.ad_value(743), s.ad_value(743), 4.0));
                s.store_offset_scaled_div(334, 331, 45, 0.5, 0.5);
                s.store_ad_value(333, A::add_scaled_inputs3(s.ad_value(331), 0.5, s.ad_value(45), 0.5, s.ad_value(743), 1e-10));
            }
            s.b[802] = (s.v[333] < 0.0);
            ...
            if (s.b[737] && (!s.b[786])) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(333), (-1.0), s.ad_value(744), -1.0));
                s.store_scaled_mul(45, 341, 744, (-4.0));
            }
            if (s.b[737] && (!s.b[786])) {
                s.store_ad_value(45, {
            ...
            if (s.b[737] && (!s.b[786])) {
                let assign9530_body27_ad_e8384: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(349), 1.0, s.ad_value(351), (-1.0), s.ad_value(331), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(331), 1.0, s.ad_value(341), 0.5), s.ad_value(740), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(332), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(332), s.ad_value(740), 9662367879.197212), s.ad_value(389)));
        ...
        if (s.b[737] && (!s.b[786])) {
            ...
            s.store_ad_value(350, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(739), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
        ...
        if (((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[829])) {
            ...
            s.store_ad_value(811, A::div_scaled_inputs(A::offset(A::add(A::add_scaled_inputs3(s.ad_value(514), p.p145, s.ad_value(187), 1.0, s.ad_value(319), 1.0), s.ad_value(237)), p.p144), -1.0, s.ad_value(826), 1.0));
            s.store_scalar(562, 0.0);
        }
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        while {
            ...
            if (((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[829])) {
                ...
                s.store_ad_value(815, A::add_scaled_inputs3(s.ad_value(159), 1.0, s.ad_value(175), 1.0, A::add_scaled_product(s.ad_value(395), 1.0, s.ad_value(449), s.ad_value(814), 1.0), -1.0));
            ...
            if (((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[829])) {
                s.store_scaled_sub_from_scalar_ad(818, 1.0, A::mul(A::sqrt(s.ad_value(816)), s.ad_value(816)), p.p143);
                s.store_scaled_div(820, 818, 819, -1.0);
            }
        ...
        if ((((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[847])) && s.b[848]) {
            ...
            s.store_ad_value(839, A::add_scaled_product(A::sub(s.ad_value(835), s.ad_value(227)), 1.0, s.ad_value(130), s.ad_value(514), (-1.0)));
        ...
        if ((((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[847])) && s.b[848]) {
            ...
            s.store_ad_value(845, A::add_scaled_products(s.ad_value(835), s.ad_value(137), 1.0, s.ad_value(837), A::sub_from_scalar(1.0, s.ad_value(840)), 1.0));
            s.store_ad_value(846, A::add_scaled_inputs3(s.ad_value(173), p.p122, s.ad_value(395), 1.0, A::mul3(s.ad_value(131), s.ad_value(129), s.ad_value(845)), -1.0));
        ...
        if ((((s.b[737] && s.b[804]) && s.b[805]) && (!s.b[847])) && (!s.b[848])) {
            s.store_ad_value(845, A::add_scaled_product(s.ad_value(835), 1.0, s.ad_value(837), A::sub_from_scalar(1.0, s.ad_value(840)), 1.0));
            s.store_div_from_scalar_offset_input(836, s.v[100], 131, s.v[100]);
            s.store_ad_value(846, A::add_scaled_product(A::scale_offset(s.ad_value(173), p.p122, s.v[176]), 1.0, s.ad_value(836), s.ad_value(845), (-1.0)));
    ...
    pub(super) fn stamp_transient_block_8(
        ...
        while {
            ...
            if (s.b[737] && s.b[901]) {
                ...
                s.store_ad_value(873, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(357), 1.0));
            }
            s.b[902] = (s.v[867] > 1e-9);
            s.v[902] = if s.b[902] { 1.0 } else { 0.0 };
            if ((s.b[737] && (!s.b[901])) && s.b[902]) {
                s.store_exp(868, 866);
                s.store_mul_scaled_ad_rhs(357, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(866)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(868), s.ad_value(866)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(873, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(868), 1.0), s.v[122]), 357);
            }
            if ((s.b[737] && (!s.b[901])) && (!s.b[902])) {
            ...
            if s.b[737] {
                ...
                s.store_sqrt_ad(870, A::add_scaled_product(A::div(A::square(s.ad_value(361)), A::square(s.ad_value(238))), 1.0, s.ad_value(379), A::add_scaled_inputs3(s.ad_value(871), 1.0, s.ad_value(866), 1.0, s.ad_value(869), -1.0), 2.0));
                s.store_ad_value(900, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(871), 1.0), 2.0), 1.0, s.ad_value(870), 2.0));
            ...
            if (s.b[737] && s.b[904]) {
                ...
                s.store_div_ad_lhs(364, A::div_scaled_inputs(A::mul3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333))), 1.0, s.ad_value(868), 2.0), 742);
                s.store_neg(365, 364);
            }
            ...
            if ((s.b[737] && (!s.b[904])) && s.b[905]) {
                ...
                s.store_div_ad_lhs(364, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), -1.0), 1.0, s.ad_value(868), 2.0), 742);
                s.store_neg(365, 364);
            }
            if ((s.b[737] && (!s.b[904])) && (!s.b[905])) {
            ...
            if (s.b[737] && s.b[906]) {
                ...
                s.store_ad_value(363, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(899), 1.0));
            }
            if (s.b[737] && s.b[906]) {
            }
            if (s.b[737] && (!s.b[906])) {
            ...
            if (s.b[737] && s.b[912]) {
                ...
                s.store_sub_ad_lhs(363, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(361)), 1.0, A::sub(s.ad_value(341), s.ad_value(361)), -1.0), 899);
            }
            if (s.b[737] && s.b[912]) {
            }
            if (s.b[737] && (!s.b[912])) {
            ...
            if (s.b[737] && (!s.b[918])) {
                s.store_ad_value(877, A::add_scaled_product(A::sub(s.ad_value(349), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(357), 1.0, s.ad_value(361), 1.0, s.ad_value(355), 1.0), 1.0, s.ad_value(363), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(867, A::add_scaled_product(s.ad_value(349), 1.0, s.ad_value(739), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
                s.store_mul(869, 739, 873);
                s.store_sub(881, 350, 867);
                s.store_scalar(882, (-1.0));
                s.store_scalar(883, 1.0);
                s.store_neg(884, 869);
                s.store_ad_value(885, A::add_scaled_inputs3(s.ad_value(351), 1.0, s.ad_value(350), (-1.0), s.ad_value(357), (-s.v[94])));
                s.store_scalar(886, (-1.0));
                s.store_sub_from_scalar_ad(887, 1.0, A::scale(s.ad_value(873), s.v[94]));
                s.store_add_ad(888, A::add_scaled_inputs3(A::mul3(s.ad_value(878), s.ad_value(883), s.ad_value(887)), 1.0, A::mul3(s.ad_value(878), s.ad_value(884), s.ad_value(886)), (-1.0), A::mul3(s.ad_value(879), s.ad_value(882), s.ad_value(887)), -1.0), A::mul3(s.ad_value(880), s.ad_value(882), s.ad_value(886)));
                s.store_div_from_scalar_offset_input(889, 1.0, 888, 1e-50);
                s.store_ad_value(890, A::add_scaled_products(s.ad_value(883), s.ad_value(887), 1.0, s.ad_value(884), s.ad_value(886), (-1.0)));
                s.store_ad_value(891, A::add_scaled_products(s.ad_value(880), s.ad_value(886), 1.0, s.ad_value(879), s.ad_value(887), (-1.0)));
                s.store_ad_value(892, A::add_scaled_products(s.ad_value(879), s.ad_value(884), 1.0, s.ad_value(880), s.ad_value(883), (-1.0)));
                s.store_mul_neg_lhs(893, 882, 887);
                s.store_mul(894, 878, 887);
                s.store_ad_value(895, A::add_scaled_products(s.ad_value(880), s.ad_value(882), 1.0, s.ad_value(878), s.ad_value(884), (-1.0)));
                s.store_mul(896, 882, 886);
                s.store_mul_neg_lhs(897, 878, 886);
                s.store_ad_value(898, A::add_scaled_products(s.ad_value(878), s.ad_value(883), 1.0, s.ad_value(879), s.ad_value(882), (-1.0)));
                s.store_mul_scaled_ad_rhs(874, 889, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(890), s.ad_value(877), 1.0, s.ad_value(891), s.ad_value(881), 1.0), 1.0, s.ad_value(892), s.ad_value(885), 1.0));
                s.store_mul_scaled_ad_rhs(875, 889, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(893), s.ad_value(877), 1.0, s.ad_value(894), s.ad_value(881), 1.0), 1.0, s.ad_value(895), s.ad_value(885), 1.0));
                s.store_mul_scaled_ad_rhs(876, 889, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(896), s.ad_value(877), 1.0, s.ad_value(897), s.ad_value(881), 1.0), 1.0, s.ad_value(898), s.ad_value(885), 1.0));
                s.store_abs(867, 874);
            }
            ...
            if ((s.b[737] && (!s.b[918])) && s.b[925]) {
                s.store_mul_div_ad_rhs(874, 874, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(867));
                s.store_mul_div_ad_rhs(875, 875, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(867));
                s.store_mul_div_ad_rhs(876, 876, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(867));
            }
            if (s.b[737] && (!s.b[918])) {
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        if (s.b[737] && (!s.b[929])) {
            ...
            s.store_ad_value(936, A::add_scaled_product(s.ad_value(159), 1.0, s.ad_value(931), A::sub_from_scalar(1.0, s.ad_value(932)), 1.0));
        ...
        if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[954]) {
            s.store_neg(949, 475);
            s.store_ad_value(950, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(949)), 4.0, s.ad_value(948), 4.0), (-1.0), A::add_scaled_product(s.ad_value(949), 2.0, s.ad_value(948), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(949), 2.0, s.ad_value(948), s.ad_value(225), 1.0), 1.0));
        }

        if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[954]) {
            s.store_ad_value(950, {
        ...
        if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[954]) {
            ...
            s.store_ad_value(951, A::add_scaled_product(s.ad_value(949), 2.0, s.ad_value(948), s.ad_value(225), 1.0));
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if (((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[954]) && (!s.b[955])) {
            s.store_sqrt_square_add(45, 44, 45);
            s.store_ad_value(354, A::add_scaled_inputs3(s.ad_value(953), 1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
        }

        if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && (!s.b[954])) {
            s.store_neg_ad(949, A::add_scaled_product(A::sub(s.ad_value(475), s.ad_value(352)), 1.0, s.ad_value(341), s.ad_value(740), (-(1.0 / (2.0) * 9662367879.197212))));
            s.store_ad_value(950, A::add_scaled_product(A::add_scaled_inputs(A::square(s.ad_value(949)), 4.0, s.ad_value(948), 4.0), (-1.0), A::add_scaled_product(s.ad_value(949), 2.0, s.ad_value(948), s.ad_value(225), 1.0), A::add_scaled_product(s.ad_value(949), 2.0, s.ad_value(948), s.ad_value(225), 1.0), 1.0));
        }
        ...
        if (((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) {
            s.store_scaled_div(957, 352, 544, ((2.0 * 1.034943e-10) / 1.6021918e-19));
        }
        ...
        while {
            ...
            if (((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) && s.b[967]) {
                ...
                s.store_mul_scaled_ad_rhs(961, 958, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(960), s.ad_value(959)), (-1.0)), 1.0, s.ad_value(239), A::offset(s.ad_value(957), (-1.0)), 1.0)));
                s.store_mul_ad(962, A::div_from_scalar(s.v[122], s.ad_value(961)), A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(960)), 1.0, s.ad_value(239), s.ad_value(957), 1.0));
            }
            ...
            if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) {
                s.store_sqrt_ad(45, A::add_scaled_product(A::square(s.ad_value(961)), 1.0, s.ad_value(743), s.ad_value(743), 4.0));
                s.store_offset_scaled_div(964, 961, 45, 0.5, 0.5);
                s.store_ad_value(963, A::add_scaled_inputs3(s.ad_value(961), 0.5, s.ad_value(45), 0.5, s.ad_value(743), 1e-10));
            }
            s.b[969] = (s.v[963] < 0.0);
            ...
            if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) {
                s.store_ad_value(44, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(963), (-1.0), s.ad_value(744), -1.0));
                s.store_scaled_mul(45, 341, 744, (-4.0));
            }
            if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) {
                s.store_ad_value(45, {
            ...
            if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && s.b[966]) {
                s.store_sqrt_square_add(45, 44, 45);
                s.store_offset_scaled_div(335, 44, 45, 0.5, 0.5);
                s.store_ad_value(963, A::add_scaled_inputs3(s.ad_value(341), -1.0, s.ad_value(44), (-0.5), s.ad_value(45), (-0.5)));
                s.store_mul3_lhs(964, 964, 962, 335);
                s.store_ad_value(388, A::div_scaled_inputs(A::square(s.ad_value(963)), ((0.5 * 9662367879.197212) * 6.241449993689894e18), s.ad_value(544), 1.0));
                s.store_div_ad_lhs(389, A::mul_scaled_lhs(s.ad_value(388), 2.0, s.ad_value(964)), 963);
                s.store_sub_ad_rhs(963, 354, A::div(A::add(A::add_scaled_inputs3(s.ad_value(961), 1.0 / (s.v[93]), s.ad_value(354), (-1.0), s.ad_value(475), -1.0), s.ad_value(388)), A::add(A::scale_offset(s.ad_value(962), 1.0 / (s.v[93]), (-1.0)), s.ad_value(389))));
            }
        ...
        while {
            ...
            if ((((s.b[737] && (!s.b[929])) && (!s.b[944])) && (!s.b[945])) && (!s.b[966])) {
                let assign12770_body27_ad_e16131: A = A::div(A::add_scaled_inputs3(A::add_scaled_product(A::add_scaled_inputs3(s.ad_value(352), 1.0, s.ad_value(354), (-1.0), s.ad_value(961), 1.0 / (s.v[93])), 1.0, A::add_scaled_inputs(s.ad_value(961), 1.0, s.ad_value(341), 0.5), s.ad_value(740), 9662367879.197212), 1.0, s.ad_value(475), (-1.0), s.ad_value(388), 1.0), A::add(A::add_scaled_product(A::scale_offset(s.ad_value(962), 1.0 / (s.v[93]), (-1.0)), 1.0, s.ad_value(962), s.ad_value(740), 9662367879.197212), s.ad_value(389)));
        ...
        if ((s.b[737] && (!s.b[929])) && s.b[1012]) {
            s.store_ad_value(353, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(739), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(357), 1.0), 1.0));
        }
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        while {
            ...
            if ((s.b[737] && (!s.b[929])) && s.b[1013]) {
                ...
                s.store_ad_value(983, A::div_scaled_inputs(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(360), 1.0));
            }
            s.b[1014] = (s.v[977] > 1e-9);
            s.v[1014] = if s.b[1014] { 1.0 } else { 0.0 };
            if (((s.b[737] && (!s.b[929])) && (!s.b[1013])) && s.b[1014]) {
                s.store_exp(978, 976);
                s.store_mul_scaled_ad_rhs(360, 474, -1.0, A::sqrt(A::add_scaled_product(A::offset(A::add(s.ad_value(327), s.ad_value(976)), (-1.0)), 1.0, s.ad_value(239), A::offset(A::add(s.ad_value(978), s.ad_value(976)), (-1.0)), 1.0)));
                s.store_div_ad_lhs(983, A::add_scaled_product(A::sub_from_scalar(1.0, s.ad_value(327)), s.v[122], s.ad_value(239), A::offset(s.ad_value(978), 1.0), s.v[122]), 360);
            }
            if (((s.b[737] && (!s.b[929])) && (!s.b[1013])) && (!s.b[1014])) {
            ...
            if (s.b[737] && (!s.b[929])) {
                ...
                s.store_sqrt_ad(980, A::add_scaled_product(A::div(A::square(s.ad_value(362)), A::square(s.ad_value(238))), 1.0, s.ad_value(379), A::add_scaled_inputs3(s.ad_value(981), 1.0, s.ad_value(976), 1.0, s.ad_value(979), -1.0), 2.0));
                s.store_ad_value(1010, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(225), s.ad_value(379), A::offset(s.ad_value(981), 1.0), 2.0), 1.0, s.ad_value(980), 2.0));
            ...
            if ((s.b[737] && (!s.b[929])) && s.b[1016]) {
                ...
                s.store_div_ad_lhs(367, A::div_scaled_inputs(A::mul3(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333))), 1.0, s.ad_value(978), 2.0), 742);
                s.store_neg(368, 367);
            }
            ...
            if (((s.b[737] && (!s.b[929])) && (!s.b[1016])) && s.b[1017]) {
                ...
                s.store_div_ad_lhs(367, A::div_scaled_inputs(A::mul3_scaled_output(s.ad_value(238), s.ad_value(225), A::sub_from_scalar(1.0, s.ad_value(333)), -1.0), 1.0, s.ad_value(978), 2.0), 742);
                s.store_neg(368, 367);
            }
            if (((s.b[737] && (!s.b[929])) && (!s.b[1016])) && (!s.b[1017])) {
            ...
            if ((s.b[737] && (!s.b[929])) && s.b[1018]) {
                ...
                s.store_div_ad_lhs(327, A::mul3_scaled_output(s.ad_value(406), s.ad_value(52), s.ad_value(53), -1.0), 48);
                s.store_ad_value(366, A::add_scaled_inputs(A::neg(s.ad_value(406)), -1.0, s.ad_value(1009), 1.0));
            }
            if ((s.b[737] && (!s.b[929])) && s.b[1018]) {
            }
            if ((s.b[737] && (!s.b[929])) && (!s.b[1018])) {
            ...
            if ((s.b[737] && (!s.b[929])) && s.b[1024]) {
                ...
                s.store_sub_ad_lhs(366, A::add_scaled_inputs(A::sub(s.ad_value(341), s.ad_value(362)), 1.0, A::sub(s.ad_value(341), s.ad_value(362)), -1.0), 1009);
            }
            if ((s.b[737] && (!s.b[929])) && s.b[1024]) {
            }
            if ((s.b[737] && (!s.b[929])) && (!s.b[1024])) {
            ...
            if ((s.b[737] && (!s.b[929])) && (!s.b[1030])) {
                s.store_ad_value(987, A::add_scaled_product(A::sub(s.ad_value(352), s.ad_value(178)), 1.0, s.ad_value(324), A::add_scaled_inputs3(A::add_scaled_inputs3(s.ad_value(360), 1.0, s.ad_value(362), 1.0, s.ad_value(358), 1.0), 1.0, s.ad_value(366), 1.0, s.ad_value(393), 1.0), (-1.0)));
                ...
                s.store_ad_value(977, A::add_scaled_product(s.ad_value(352), 1.0, s.ad_value(739), A::add_scaled_inputs(s.ad_value(341), 0.5, s.ad_value(360), 1.0), 1.0));
                s.store_mul(979, 739, 983);
                s.store_sub(991, 353, 977);
                s.store_scalar(992, (-1.0));
                s.store_scalar(993, 1.0);
                s.store_neg(994, 979);
                s.store_ad_value(995, A::add_scaled_inputs3(s.ad_value(354), 1.0, s.ad_value(353), (-1.0), s.ad_value(360), (-s.v[94])));
                s.store_scalar(996, (-1.0));
                s.store_sub_from_scalar_ad(997, 1.0, A::scale(s.ad_value(983), s.v[94]));
                s.store_add_ad(998, A::add_scaled_inputs3(A::mul3(s.ad_value(988), s.ad_value(993), s.ad_value(997)), 1.0, A::mul3(s.ad_value(988), s.ad_value(994), s.ad_value(996)), (-1.0), A::mul3(s.ad_value(989), s.ad_value(992), s.ad_value(997)), -1.0), A::mul3(s.ad_value(990), s.ad_value(992), s.ad_value(996)));
                s.store_div_from_scalar_offset_input(999, 1.0, 998, 1e-50);
                s.store_ad_value(1000, A::add_scaled_products(s.ad_value(993), s.ad_value(997), 1.0, s.ad_value(994), s.ad_value(996), (-1.0)));
                s.store_ad_value(1001, A::add_scaled_products(s.ad_value(990), s.ad_value(996), 1.0, s.ad_value(989), s.ad_value(997), (-1.0)));
                s.store_ad_value(1002, A::add_scaled_products(s.ad_value(989), s.ad_value(994), 1.0, s.ad_value(990), s.ad_value(993), (-1.0)));
                s.store_mul_neg_lhs(1003, 992, 997);
                s.store_mul(1004, 988, 997);
                s.store_ad_value(1005, A::add_scaled_products(s.ad_value(990), s.ad_value(992), 1.0, s.ad_value(988), s.ad_value(994), (-1.0)));
                s.store_mul(1006, 992, 996);
                s.store_mul_neg_lhs(1007, 988, 996);
                s.store_ad_value(1008, A::add_scaled_products(s.ad_value(988), s.ad_value(993), 1.0, s.ad_value(989), s.ad_value(992), (-1.0)));
                s.store_mul_scaled_ad_rhs(984, 999, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1000), s.ad_value(987), 1.0, s.ad_value(1001), s.ad_value(991), 1.0), 1.0, s.ad_value(1002), s.ad_value(995), 1.0));
                s.store_mul_scaled_ad_rhs(985, 999, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1003), s.ad_value(987), 1.0, s.ad_value(1004), s.ad_value(991), 1.0), 1.0, s.ad_value(1005), s.ad_value(995), 1.0));
                s.store_mul_scaled_ad_rhs(986, 999, -1.0, A::add_scaled_product(A::add_scaled_products(s.ad_value(1006), s.ad_value(987), 1.0, s.ad_value(1007), s.ad_value(991), 1.0), 1.0, s.ad_value(1008), s.ad_value(995), 1.0));
                s.store_abs(977, 984);
            }
            ...
            if (((s.b[737] && (!s.b[929])) && (!s.b[1030])) && s.b[1037]) {
                s.store_mul_div_ad_rhs(984, 984, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(977));
                s.store_mul_div_ad_rhs(985, 985, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(977));
                s.store_mul_div_ad_rhs(986, 986, A::div_from_scalar(0.1, s.ad_value(407)), s.ad_value(977));
            }
            if ((s.b[737] && (!s.b[929])) && (!s.b[1030])) {
