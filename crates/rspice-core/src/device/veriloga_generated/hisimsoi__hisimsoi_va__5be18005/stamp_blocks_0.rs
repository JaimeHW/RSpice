...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_1(
        ...
        s.store_scalar(390, 0.0);s.store_scalar(392, 0.0);s.store_scalar(393, 0.0);s.store_scalar(401, 0.0);s.store_scalar(376, 0.0);s.store_scalar(436, 0.0);s.store_scalar(437, 0.0);s.store_scalar(438, 0.5);s.store_scalar(439, 0.5);s.store_scalar(447, 0.0);s.store_scalar(476, 0.0);s.store_scalar(477, 0.0);s.store_scalar(592, 0.0);s.store_scalar(576, 0.0);s.store_scalar(577, 0.0);s.store_scalar(587, 0.0);s.store_scalar(588, 0.0);s.store_scalar(488, 0.0);s.store_scalar(490, 0.0);s.store_scalar(497, 0.0);s.store_scalar(499, 0.0);let t0: f64 = (p.p51 * 10.0);let t1: f64 = (t0 % 10.0);s.store_scalar(56, t1);s.store_scalar(57, 200.0);s.store_scalar(58, 200.0);s.store_scalar(86, 0.0);s.store_scalar(475, 0.0);s.store_scalar(378, 0.0);s.store_scalar(369, 0.0);s.store_scalar(203, 0.0);s.store_scalar(161, 0.0);s.store_scalar(515, 0.0);s.store_scalar(73, (p.p52 * 0.01));s.store_scalar(59, (p.p73 / 1e-6));s.store_scalar(60, (p.p104 * 0.01));s.store_scalar(61, (p.p201 / 1e-6));s.store_scalar(65, (p.p240 / 1e-6));s.store_scalar(66, (p.p241 / 1e-6));s.store_scalar(67, (p.p242 * 0.01));s.store_scalar(68, (p.p243 / 0.01));s.store_scalar(69, (p.p59 / 1e-6));s.store_scalar(70, (p.p284 / 1e-6));s.store_scalar(71, (p.p148 / 1e-6));s.store_scalar(72, (p.p198 / 0.0001));s.store_scalar(74, (p.p70 * 0.01));s.store_scalar(75, (if (p.p83 == 0.0) { 0.0 } else { p.p84 }));s.store_scalar(76, (if (p.p83 == 0.0) { 0.0 } else { p.p85 }));s.store_scalar(77, (if (p.p80 == 0.0) { 0.0 } else { p.p81 }));s.store_scalar(78, (if (p.p83 == 0.0) { 0.0 } else { p.p82 }));s.store_scalar(79, (p.p250 * 1000000.0));s.store_scalar(81, (p.p232 + 273.15));s.store_scalar(82, p.p58);s.store_scalar(83, (p.p15 * 100.0));s.store_scalar(84, p.p46);s.store_scalar(85, p.p34);s.store_scalar(80, (if param_given[190] { p.p190 } else { (5000000000.0 / (p.p237 * p.p240)) }));s.b[630] = ((s.v[80] < (2.0 + 0.1)) && (0.1 >= 0.0));s.store_scalar(630, if s.b[630] { 1.0 } else { 0.0 });
        if s.b[630] {s.store_scalar(44, ((2.0 + 0.1) - s.v[80]));s.store_square(49, 44);s.store_scalar(50, (0.1 * 0.1));s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);}
        let (t2,) = {
    if s.b[630] {
        (0.0,)
    } else {
    ...
    if s.b[630] {
        ...
        if s.b[630] {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if ((s.b[630] && s.b[631]) && s.b[632]) {
        ...
        s.store_scalar(55, t4);s.b[633] = (2.0 == 2.0);s.store_scalar(633, if s.b[633] { 1.0 } else { 0.0 });
        let (t5,) = {
    if (((s.b[630] && s.b[631]) && (!s.b[632])) && s.b[633]) {
        ...
        s.store_scalar(55, t5);s.b[634] = (2.0 == 4.0);s.store_scalar(634, if s.b[634] { 1.0 } else { 0.0 });
        let (t6,) = {
    if ((((s.b[630] && s.b[631]) && (!s.b[632])) && (!s.b[633])) && s.b[634]) {
        ...
        s.store_scalar(55, t6);s.b[635] = (2.0 == 8.0);s.store_scalar(635, if s.b[635] { 1.0 } else { 0.0 });
        let (t7,) = {
    ...
    if (s.b[630] && s.b[631]) {
        ...
        s.store_scalar(87, (p.p55 - (s.v[81] * (9.025e-5 + (s.v[81] * 1e-7)))));s.store_scalar(88, p.p236);s.store_scalar(89, (1.034943e-10 / p.p237));s.store_scalar(90, (1.0 / s.v[89]));s.store_scalar(91, (3.453133e-11 / s.v[88]));s.store_scalar(92, (s.v[88] / 3.453133e-11));s.store_scalar(93, (3.453133e-11 / p.p239));s.store_scalar(94, (p.p239 / 3.453133e-11));s.store_scalar(95, (s.v[94] + s.v[90]));s.store_scalar(96, p.p0);s.store_scalar(97, (s.v[96] - (2.0 * p.p56)));s.store_scalar(98, (s.v[96] - (2.0 * p.p57)));s.store_scalar(99, (if (p.p40 == 0.0) { s.v[96] } else { s.v[97] }));s.store_scalar(100, (s.v[99] * 1000000.0));s.store_scalar(101, (p.p1 / p.p9));s.store_scalar(102, p.p60);s.store_scalar(103, (if (s.v[56] < 1.0) { 0.0 } else { p.p295 }));s.store_scalar(104, (if (s.v[56] < 1.0) { p.p60 } else { p.p61 }));s.b[636] = (p.p43 == 0.0);s.store_scalar(636, if s.b[636] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        let nv10 = ctx.node_voltage(nodes[10]);s.store_scalar(550, ((0.5 * (s.v[328] + s.v[44])) + (1e-10 * 0.001)));s.b[646] = (s.v[550] < 0.0);s.store_scalar(646, if s.b[646] { 1.0 } else { 0.0 });
        if s.b[646] {s.store_scalar(550, 0.0);}
        s.b[647] = (p.p35 == 1.0);s.store_scalar(647, if s.b[647] { 1.0 } else { 0.0 });s.b[648] = (s.v[128] > 0.001);s.store_scalar(648, if s.b[648] { 1.0 } else { 0.0 });
        if (s.b[647] && s.b[648]) {s.store_primal_div_from_scalar(551, s.v[451], 128);}
        if (s.b[647] && (!s.b[648])) {s.store_scalar(551, (s.v[451] * 1000.0));}
        if (!s.b[647]) {s.store_scalar(551, (s.v[451] * 1000.0));}
        s.b[649] = (p.p261 == 1.0);s.store_scalar(649, if s.b[649] { 1.0 } else { 0.0 });
        if s.b[649] {s.store_offset_scaled(327, 107, p.p289, p.p288);s.store_scale(2, 327, 1.0 / (s.v[451]));}
        s.b[650] = (s.v[2] < 0.0001);s.store_scalar(650, if s.b[650] { 1.0 } else { 0.0 });
        if (s.b[649] && s.b[650]) {s.store_scalar(2, 0.0001);}
        if (!s.b[649]) {s.store_scalar(2, 0.0001);}
        s.store_scalar(552, 0.0);s.store_scalar(553, 0.0);s.b[651] = (p.p262 == 1.0);s.store_scalar(651, if s.b[651] { 1.0 } else { 0.0 });s.b[652] = (p.p290 < 0.0001);s.store_scalar(652, if s.b[652] { 1.0 } else { 0.0 });
        if (s.b[651] && s.b[652]) {s.store_scalar(552, (s.v[451] * 10000.0));}
        if (s.b[651] && (!s.b[652])) {s.store_scalar(552, (s.v[451] * (1e-6 + (1.0 / p.p290))));}
        s.b[653] = (p.p291 < 0.0001);s.store_scalar(653, if s.b[653] { 1.0 } else { 0.0 });
        if (s.b[651] && s.b[653]) {s.store_scalar(553, (s.v[451] * 10000.0));}
        if (s.b[651] && (!s.b[653])) {s.store_scalar(553, (s.v[451] * (1e-6 + (1.0 / p.p291))));}
        ...
        if (s.b[654] && (p.p24 == 0.0)) {s.store_scalar(534, 0.0);s.store_scalar(532, 0.0);s.store_scalar(533, 0.0);s.store_scalar(531, 0.0);}
    ...
    if s.b[660] {
        ...
        if s.b[660] {s.store_scalar(461, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_5(
        ...
        if s.b[660] {s.store_scalar(462, 0.0);s.copy_ad(157, 571);s.copy_ad(158, 572);s.copy_ad(156, 570);}
        let (t11,) = {
    if (!s.b[660]) {
        let t10: f64 = (-1.0);
        (t10,)
        ...
        if (!s.b[660]) {s.store_scalar(461, 0.0);s.store_scalar(462, 1.0);s.store_neg(157, 571);s.store_sub(158, 572, 571);s.store_sub(156, 570, 571);}
        ...
        s.store_square(379, 328);s.store_sqrt_scaled_input_ad(444, A::div_scalar_by_product(1.034943e-10, s.ad_value(229), s.ad_value(225), 1.0), 2.0);s.store_div_from_scalar(547, ((2.0 * 1.034943e-10) / 1.6021918e-19), 544);let t12: f64 = (2.0 * 1.034943e-10);let t13: f64 = (t12 / 1.6021918e-19);let t14: f64 = (t13 * s.v[231]);let t15: f64 = (t14 / s.v[544]);let t16: f64 = (t15).sqrt();s.store_scalar(416, t16);s.b[674] = (p.p43 == 1.0);s.store_scalar(674, if s.b[674] { 1.0 } else { 0.0 });
        if s.b[674] {s.store_scalar(141, 0.4);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_6(
        ...
        if s.b[674] {s.store_scalar(140, 0.8);}
        ...
        if s.b[676] {s.store_sub(329, 156, 141);s.store_sub(330, 140, 141);s.store_square(49, 329);s.store_square(50, 330);s.store_scalar(51, 1.0);s.store_scalar(52, 1.0);}
        let (t17,) = {
    if s.b[676] {
        (0.0,)
    } else {
    ...
    if s.b[676] {
        ...
        if s.b[676] {s.store_scalar(48, 0.0);s.store_scalar(53, 0.0);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_mul(51, 51, 49);s.store_mul(52, 52, 50);s.store_add(48, 51, 52);s.copy_ad(53, 48);}
    ...
    if ((s.b[676] && s.b[677]) && s.b[678]) {
        ...
        s.store_scalar(55, t19);s.b[679] = (4.0 == 2.0);s.store_scalar(679, if s.b[679] { 1.0 } else { 0.0 });
        let (t1a,) = {
    if (((s.b[676] && s.b[677]) && (!s.b[678])) && s.b[679]) {
        ...
        s.store_scalar(55, t1a);s.b[680] = (4.0 == 4.0);s.store_scalar(680, if s.b[680] { 1.0 } else { 0.0 });
        let (t1b,) = {
    if ((((s.b[676] && s.b[677]) && (!s.b[678])) && (!s.b[679])) && s.b[680]) {
        ...
        s.store_scalar(55, t1b);s.b[681] = (4.0 == 8.0);s.store_scalar(681, if s.b[681] { 1.0 } else { 0.0 });
        let (t1c,) = {
    ...
    if (s.b[676] && s.b[677]) {
        ...
        s.copy_ad(157, 152);s.copy_ad(158, 153);s.copy_ad(156, 154);s.store_scalar(144, 0.0);s.store_scalar(619, 0.0);s.store_scalar(620, 0.0);s.store_scalar(621, 0.0);s.store_scalar(622, 0.0);s.store_scalar(623, 0.0);s.store_scalar(624, 0.0);s.store_scalar(425, 0.0);s.store_scalar(426, 0.0);s.store_scalar(427, 0.0);s.store_scalar(428, 0.0);s.store_scalar(167, 0.0);s.store_scalar(168, 0.0);s.store_scaled_mul(682, 155, 157, 0.5);s.store_scale(44, 682, (2.0 * 1.0 / (p.p226)));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_offset_mul_offset_rhs_mixed_ia(45, 44, A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul_offset_rhs(s.ad_value(44), A::mul(s.ad_value(44), A::scale_offset(s.ad_value(44), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_div_from_scalar(175, p.p226, 45);s.b[683] = (s.v[175] < 5e-12);s.store_scalar(683, if s.b[683] { 1.0 } else { 0.0 });
    ...
    if (!s.b[696]) {
        ...
        s.store_scalar(148, t23);s.store_sqrt_mul_scaled_lhs(690, 229, (2.0 * 1.034943e-10), 232);s.store_add_scaled_inputs_mixed_ai(325, A::offset(s.ad_value(232), s.v[123]), 1.0, 690, 1.0 / (s.v[91]));s.b[697] = (s.v[148] == 0.0);s.store_scalar(697, if s.b[697] { 1.0 } else { 0.0 });
        ...
        if (!s.b[697]) {s.store_div_from_scalar(691, 1.0, 690);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_8(
        ...
        if (!s.b[697]) {s.store_scaled_abs(693, 325, 2.0);s.store_offset_sub_from_scalar_ad(695, s.v[123], s.ad_value(325), p.p205);}
        if (!s.b[697]) {
            if (s.v[695] > s.v[693]) {
                s.copy_ad(692, 695);
            } else {
        ...
        if ((!s.b[697]) && s.b[699]) {s.store_scalar(322, 0.0);}
        let (t24,) = {
    if ((!s.b[697]) && s.b[699]) {
        (0.0,)
    } else {
    ...
    if (!s.b[732]) {
        ...
        s.store_scalar(147, t27);s.b[733] = (s.v[147] == 0.0);s.store_scalar(733, if s.b[733] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        let mut t31: usize = 0;
        while {
            let t30: f64 = if (s.b[737] && (s.v[167] < s.v[57])) { 1.0 } else { 0.0 };
            t30 != 0.0
        } {
    ...
    if (((s.b[737] && s.b[774]) && s.b[775]) && s.b[776]) {
        ...
        s.store_scalar(55, t36);s.b[777] = (2.0 == 2.0);s.store_scalar(777, if s.b[777] { 1.0 } else { 0.0 });
        let (t37,) = {
    if ((((s.b[737] && s.b[774]) && s.b[775]) && (!s.b[776])) && s.b[777]) {
        ...
        s.store_scalar(55, t37);s.b[778] = (2.0 == 4.0);s.store_scalar(778, if s.b[778] { 1.0 } else { 0.0 });
        let (t38,) = {
    if (((((s.b[737] && s.b[774]) && s.b[775]) && (!s.b[776])) && (!s.b[777])) && s.b[778]) {
        ...
        s.store_scalar(55, t38);s.b[779] = (2.0 == 8.0);s.store_scalar(779, if s.b[779] { 1.0 } else { 0.0 });
        let (t39,) = {
    ...
    if ((s.b[737] && s.b[774]) && s.b[775]) {
        ...
        while {
            let t3d: f64 = if (((s.b[737] && s.b[774]) && s.b[775]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t3d != 0.0
        } {
    ...
    if (((s.b[737] && s.b[780]) && s.b[781]) && s.b[782]) {
        ...
        s.store_scalar(55, t41);s.b[783] = (2.0 == 2.0);s.store_scalar(783, if s.b[783] { 1.0 } else { 0.0 });
        let (t42,) = {
    if ((((s.b[737] && s.b[780]) && s.b[781]) && (!s.b[782])) && s.b[783]) {
        ...
        s.store_scalar(55, t42);s.b[784] = (2.0 == 4.0);s.store_scalar(784, if s.b[784] { 1.0 } else { 0.0 });
        let (t43,) = {
    if (((((s.b[737] && s.b[780]) && s.b[781]) && (!s.b[782])) && (!s.b[783])) && s.b[784]) {
        ...
        s.store_scalar(55, t43);s.b[785] = (2.0 == 8.0);s.store_scalar(785, if s.b[785] { 1.0 } else { 0.0 });
        let (t44,) = {
    ...
    if ((s.b[737] && s.b[780]) && s.b[781]) {
        ...
        while {
            let t48: f64 = if (((s.b[737] && s.b[780]) && s.b[781]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t48 != 0.0
        } {
    ...
    if ((s.b[737] && s.b[780]) && s.b[781]) {
        ...
        let (t4f,) = {
    if s.b[737] {
        let t4a: f64 = (-s.v[341]);let t4b: f64 = (t4a * s.v[740]);let t4c: f64 = (t4b / 2.0);let t4d: f64 = (t4c / 1.034943e-10);let t4e: f64 = (t4d + s.v[227]);
        (t4e,)
    } else {
        (s.v[384],)
    }
        ...
        let (t53,) = {
    if s.b[737] {
        let t50: f64 = (s.v[386] * s.v[740]);let t51: f64 = (t50 / 1.034943e-10);let t52: f64 = (s.v[384] - t51);
        (t52,)
    } else {
        (s.v[385],)
    }
};
        s.store_scalar(385, t53);s.b[786] = (s.v[144] >= 1.0);s.store_scalar(786, if s.b[786] { 1.0 } else { 0.0 });
    ...
    if ((s.b[737] && (!s.b[786])) && (!s.b[789])) {
        ...
        s.store_scalar(339, t57);s.b[790] = ((s.v[158] - s.v[383]) <= s.v[182]);s.store_scalar(790, if s.b[790] { 1.0 } else { 0.0 });
    ...
    if ((((((s.b[737] && (!s.b[786])) && (!s.b[790])) && s.b[791]) && s.b[792]) && s.b[793]) && s.b[794]) {
        ...
        s.store_scalar(55, t5a);s.b[795] = (2.0 == 2.0);s.store_scalar(795, if s.b[795] { 1.0 } else { 0.0 });
        let (t5b,) = {
    if (((((((s.b[737] && (!s.b[786])) && (!s.b[790])) && s.b[791]) && s.b[792]) && s.b[793]) && (!s.b[794])) && s.b[795]) {
        ...
        s.store_scalar(55, t5b);s.b[796] = (2.0 == 4.0);s.store_scalar(796, if s.b[796] { 1.0 } else { 0.0 });
        let (t5c,) = {
    if ((((((((s.b[737] && (!s.b[786])) && (!s.b[790])) && s.b[791]) && s.b[792]) && s.b[793]) && (!s.b[794])) && (!s.b[795])) && s.b[796]) {
        ...
        s.store_scalar(55, t5c);s.b[797] = (2.0 == 8.0);s.store_scalar(797, if s.b[797] { 1.0 } else { 0.0 });
        let (t5d,) = {
    ...
    if (((((s.b[737] && (!s.b[786])) && (!s.b[790])) && s.b[791]) && s.b[792]) && s.b[793]) {
        ...
        while {
            let t61: f64 = if ((((((s.b[737] && (!s.b[786])) && (!s.b[790])) && s.b[791]) && s.b[792]) && s.b[793]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t61 != 0.0
        } {
