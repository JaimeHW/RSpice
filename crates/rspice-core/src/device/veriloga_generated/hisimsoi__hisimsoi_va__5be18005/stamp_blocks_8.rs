...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_45(
        ...
        s.b[1258] = (p.p43 == 0.0);s.store_scalar(1258, if s.b[1258] { 1.0 } else { 0.0 });s.b[1259] = ((s.v[158] - s.v[383]) <= s.v[1252]);s.store_scalar(1259, if s.b[1259] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_46(
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((((s.b[1224] && s.b[1254]) && s.b[1258]) && (!s.b[1259])) && s.b[1260]) && s.b[1261]) && s.b[1262]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
        ...
        if (s.b[1224] && (0.0 != 0.0)) {s.store_offset_scaled(44, 166, (1.0 + 0.3), (((-p.p287)) + ((-0.03))));s.store_scale(45, 166, ((1.0 + 0.3) * (4.0 * 0.03)));}
        if (s.b[1224] && (0.0 != 0.0)) {
            if (s.v[45] > 0.0) {
            } else {
                s.store_neg(45, 45);
        ...
        s.b[1270] = (p.p282 == 1.0);s.store_scalar(1270, if s.b[1270] { 1.0 } else { 0.0 });
        if (s.b[1224] && s.b[1270]) {s.copy_ad(378, 1234);s.copy_ad(1271, 1225);s.store_offset_add_scaled_inputs3_offset_indices(160, 185, (-1.0), 320, 1.0, 1271, 1.0, s.v[123], p.p286);}
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        if ((s.b[1224] && s.b[1270]) && (!s.b[1273])) {s.store_exp_ad(484, A::mul_offset_rhs(s.ad_value(225), s.ad_value(1271), (-p.p287)));s.store_scalar(430, 0.0);s.copy_ad(1272, 378);s.store_scale(419, 229, ((p.p237 * (p.p237 * 0.5)) * 9662367879.197212));s.store_sqrt_mul_scaled_lhs(327, 225, 2.0, 419);s.store_scaled_add_ad(328, A::exp(s.ad_value(327)), A::exp_scaled_input(s.ad_value(327), -1.0), 0.5);s.store_div_ln_lhs(420, 328, 419);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_48(
        ...
        let mut t4: usize = 0;
        while {
            let t2: f64 = (s.v[57] + 1.0);let t3: f64 = if (((s.b[1224] && s.b[1270]) && (!s.b[1273])) && (s.v[167] <= t2)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_49(
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if (((s.b[1224] && s.b[1289]) && s.b[1290]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
        ...
        if s.b[1224] {s.store_sqrt_offset_input(1243, 328, (10.0 * 2.220446049250313e-16));s.store_mul(1244, 1242, 1243);s.store_mul_div_scaled_inputs_indices(1240, 1244, 227, 2.0, 1231, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_50(
        ...
        if s.b[1224] {s.store_mul_product3_indices(204, 337, 1240, 1239, 107, 1.0);s.store_add(199, 202, 204);}
    ...
    pub(super) fn stamp_reactive_block_51(
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if ((((((s.b[1295] && (!s.b[1308])) && (!s.b[1309])) && (!s.b[1310])) && s.b[1313]) && s.b[1314]) && (s.v[54] < s.v[55])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_52(
        ...
        s.store_scalar(1359, (s.v[88] * 100.0));s.store_scale(1360, 323, 0.0001);s.store_scalar(1361, (s.v[97] * 100.0));s.store_primal_scale(1362, 107, 100.0);s.store_scale(1363, 252, 0.01);s.store_scale(1364, 436, 0.0001);s.store_scale(1365, 238, 0.0001);s.b[1366] = (p.p27 == 0.0);s.store_scalar(1366, if s.b[1366] { 1.0 } else { 0.0 });s.b[1367] = (s.v[145] == 0.0);s.store_scalar(1367, if s.b[1367] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_53(
        ...
        if (!s.b[1366]) {s.store_exp_scaled_input(1349, 1347, s.v[1359]);s.store_scale(1347, 158, (1.0 / (s.v[1359]) * 1.0 / (s.v[1359])));s.store_mul(1350, 158, 1347);s.store_scale(1351, 1362, (p.p220 / 1000000.0));s.store_sub(1348, 158, 157);s.store_offset_scaled(1347, 1348, (-p.p221), p.p222);s.store_exp_scaled_input(1349, 1347, s.v[1359]);s.store_scale(1347, 1348, (1.0 / (s.v[1359]) * 1.0 / (s.v[1359])));s.store_mul(1350, 1348, 1347);s.store_scale(1351, 1362, (p.p220 / 1000000.0));s.store_offset_scaled_sub(1357, 513, 158, 1.0 / (s.v[1359]), ((((s.v[123]) + (p.p225))) * (1.0 / (s.v[1359]))));s.store_sqrt_square_offset(44, 1357, ((4.0 * 0.01) * 0.01));s.store_offset_add_scaled_inputs_indices(1357, 1357, 0.5, 44, 0.5, (1e-10 * 0.01));}
        ...
        if ((!s.b[1366]) && (!s.b[1374])) {s.store_exp(1349, 1348);s.store_scale(1350, 1362, (p.p223 * s.v[1361]));}
        ...
        if ((!s.b[1382]) && (!s.b[1384])) {s.store_exp(1375, 1379);s.store_mul_scale_offset_mixed_ia(1376, 107, A::div_from_scalar(p.p207, s.ad_value(302)), 1.6021918e-19, 0.0);}
        if (!s.b[1382]) {s.store_sub(1381, 157, 513);}
        s.b[1385] = (s.v[1381] > 0.0);s.store_scalar(1385, if s.b[1385] { 1.0 } else { 0.0 });
        if ((!s.b[1382]) && s.b[1385]) {s.store_square(1376, 1381);s.store_mul(331, 1376, 1381);s.store_offset(1379, 331, p.p212);}
        ...
        if ((!s.b[1393]) && (!s.b[1395])) {s.store_exp(1386, 1390);s.store_div_from_scalar(1389, 1.0, 302);s.store_scaled_mul(1387, 1389, 107, (p.p207 * 1.6021918e-19));}
        if (!s.b[1393]) {s.store_neg(1392, 513);}
        s.b[1396] = (s.v[1392] > 0.0);s.store_scalar(1396, if s.b[1396] { 1.0 } else { 0.0 });
        if ((!s.b[1393]) && s.b[1396]) {s.store_square(1387, 1392);s.store_mul(331, 1387, 1392);s.store_offset(1390, 331, p.p212);}
        ...
        if (s.b[1397] && (p.p24 != 0.0)) {s.copy_ad(521, 536);s.store_scalar(528, 0.0);}
        ...
        if ((s.b[1397] && (p.p24 != 0.0)) && s.b[1477]) {s.store_primal_scale(522, 533, 0.5);s.store_scalar(523, p.p292);s.store_scalar(528, s.v[525]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_54(
        ...
        if ((s.b[1397] && (p.p24 != 0.0)) && (s.b[1478] && (!s.b[1477]))) {s.store_primal_scale(522, 534, 0.5);s.store_scalar(523, p.p68);s.store_scalar(528, s.v[524]);s.store_scalar(528, 1.0);}
        ...
        if ((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) {s.store_offset_scaled(1419, 1403, -1.0, (-1e-12));s.store_mul(1428, 1427, 1408);s.store_square(1429, 1428);s.store_sub(1430, 1426, 523);s.store_div(1398, 521, 230);s.store_mul_div_from_scalar_lhs_ad_mixed_ia(1431, 2.0, 225, A::ln(s.ad_value(1398)));s.store_neg(1432, 1419);}
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && s.b[1481]) {s.store_powf(1440, 1439, 0.3333333333333333);s.store_add_scaled_inputs_product_mixed_aiii(1441, A::sub_from_scalar(((-4.0) * 1.414213562373095), A::scale(s.ad_value(1406), 12.0)), 1.0, 1440, 2.0, 1440, 1440, 1.414213562373095);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_55(
        ...
        if (((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) {s.store_offset_add(1454, 1430, 1419, 0.1);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_56(
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) {s.store_exp_ad(1461, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1419), -1.0));s.store_div(1398, 230, 521);s.store_square(1455, 1398);s.store_mul(1470, 1455, 1461);s.store_scalar(1415, 0.0);s.store_scalar(167, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_57(
        ...
        let mut tc: usize = 0;
        while {
            let t9: f64 = (2.0 * 20.0);let ta: f64 = (t9 + 1.0);let tb: f64 = if (((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) && (s.v[167] <= ta)) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
            ...
            if ((((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1481])) && s.b[1487]) && (!s.b[1490])) && s.b[1492]) {s.store_scalar(1415, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_58(
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && s.b[1499]) && (!s.b[1500])) {s.store_sqrt_add(1438, 1434, 1437);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_59(
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && s.b[1499]) && (!s.b[1500])) {s.store_add_scaled_offset_product_rhs_mixed_aii(1439, A::offset(s.ad_value(1438), ((-7.0) * 1.414213562373095)), 1.0, 1406, 1405, (-2.0), 9.0);}
    ...
    pub(super) fn stamp_reactive_block_60(
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1499])) && s.b[1503]) {s.store_neg_powf_add_input(1453, 1450, 1402, 0.3333333333333333);s.store_add_scaled_inputs3_div_scaled_third_indices(1405, 1452, 1.0, 1453, 1.0, 1447, 1.0, 1446, 3.0, -1.0);s.store_add_scaled_product_indices(1445, 1419, (-1.0), 1405, 227, 1.0);s.store_mul_add_rhs(1442, 225, 1445, 1419);}
        ...
        if ((((s.b[1397] && (p.p24 != 0.0)) && s.b[1479]) && (!s.b[1499])) && s.b[1505]) {s.store_exp_ad(1461, A::mul_scaled_rhs(s.ad_value(225), s.ad_value(1419), -1.0));s.store_div(1398, 230, 521);s.store_square(1455, 1398);s.store_mul(1470, 1455, 1461);s.store_scalar(1415, 0.0);s.store_scalar(167, 1.0);}
    }
}
