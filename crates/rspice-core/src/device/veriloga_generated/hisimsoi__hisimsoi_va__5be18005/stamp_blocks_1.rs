...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if ((s.v[85] != 0.0) && s.b[1721]) {
            ...
            s.copy_ad(1718, 441);
            s.store_mul_product3_rhs(1719, 1718, s.ad_value(1716), s.ad_value(1717), s.ad_value(1718), 1.0);
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if s.b[1777] {
            ...
            s.store_mul_product3_rhs(1795, 1788, s.ad_value(328), s.ad_value(1794), s.ad_value(1793), 1.0);
        }
        ...
        if s.b[1805] {
            ...
            s.store_mul_product3_rhs(1823, 1816, s.ad_value(328), s.ad_value(1822), s.ad_value(1821), 1.0);
        }
        ...
        s.b[1836] = (s.v[289] < (1e-15 / 0.0001));
        s.v[1836] = if s.b[1836] { 1.0 } else { 0.0 };

        if (((!s.b[1833]) && (s.v[85] != 0.0)) && s.b[1836]) {
            s.store_scalar(289, (1e-15 / 0.0001));
        }

        s.b[1837] = (s.v[290] < (1e-15 / 0.0001));
        s.v[1837] = if s.b[1837] { 1.0 } else { 0.0 };

        if (((!s.b[1833]) && (s.v[85] != 0.0)) && s.b[1837]) {
            s.store_scalar(290, (1e-15 / 0.0001));
        }
