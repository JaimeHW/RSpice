...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_29(
        ...
        if (s.b[1729] && (!s.b[1730])) {
            let assign33570_ad_e48738: A = A::add_scaled_product(A::add(A::div(A::div_from_scalar(1.0, A::add(s.ad_value(1722), s.ad_value(1723))), A::add(s.ad_value(1724), s.ad_value(1723))), A::div_scaled_product3(s.ad_value(1726), s.ad_value(252), s.ad_value(250), 2.0, A::add(s.ad_value(1722), s.ad_value(1723)), 1.0)), 1.0, A::mul3(A::mul3(s.ad_value(1726), s.ad_value(252), s.ad_value(250)), s.ad_value(1726), s.ad_value(252)), s.ad_value(250), 1.0);
