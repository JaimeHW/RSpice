...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_89(
        ...
        if (s.b[3231] && s.b[3234]) {
            ...
            s.store_mul_div_from_scalar_lhs_ad_mixed_ia(848, s.v[820], 154, A::ln(A::offset(A::div_scaled_inputs(s.ad_value(334), s.v[822], s.ad_value(336), 1.0), 1.0)));
        ...
        if (s.b[3231] && s.b[3237]) {
            ...
            s.store_mul_div_from_scalar_lhs_ad_mixed_ia(853, s.v[825], 154, A::ln(A::offset(A::div_scaled_inputs(s.ad_value(334), s.v[827], s.ad_value(337), 1.0), 1.0)));
    ...
    pub(super) fn stamp_reactive_block_92(
        ...
        if s.b[3299] {
            ...
            s.store_mul_ad_product_rhs(917, 912, s.ad_value(928), A::sub(A::exp(A::div_from_scalar((-p.p545), s.ad_value(912))), A::exp_div_scaled_inputs(s.ad_value(933), -1.0, s.ad_value(912), 1.0)));
            s.store_mul_ad_product_rhs(918, 912, s.ad_value(929), A::offset(A::exp_div_scaled_inputs(A::sub_from_scalar(p.p545, s.ad_value(933)), -1.0, s.ad_value(912), 1.0), (-1.0)));
