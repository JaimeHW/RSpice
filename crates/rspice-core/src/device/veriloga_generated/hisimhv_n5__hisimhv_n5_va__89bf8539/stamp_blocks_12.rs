...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_192(
        ...
        if ((s.v[2623] != 0.0) && s.b[2962]) {s.store_exp_ad(229, A::mul_scaled_rhs(s.ad_value(154), s.ad_value(397), -1.0));s.store_div(334, 394, 409);s.store_square(405, 334);s.store_mul(222, 405, 229);s.copy_ad(404, 2888);}
        let (t0,) = {
    if ((s.v[2623] != 0.0) && s.b[2962]) {
        ...
        if ((s.v[2623] != 0.0) && s.b[2962]) {s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2881)), s.ad_value(155)), 2.0);}
        ...
        if (((s.v[2623] != 0.0) && s.b[2962]) && (!s.b[2963])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
        ...
        if ((s.v[2623] != 0.0) && s.b[2962]) {s.copy_ad(386, 336);s.store_mul3_affine_lhs(418, 2881, 386, (0.5 * 9662367879.197212), 0.0, 386);s.store_sqrt_mul_scaled_lhs(334, 154, 2.0, 418);s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);s.store_div_ln_lhs(419, 335, 418);}
        let (t1,) = {
    if ((s.v[2623] != 0.0) && s.b[2962]) {
        (1.0,)
    } else {
    ...
    pub(super) fn stamp_transient_block_193(
        ...
        let mut ta: usize = 0;
        while {
            let t8: f64 = (s.v[421] + 1.0);let t9: f64 = if (((s.v[2623] != 0.0) && s.b[2962]) && (s.v[97] <= t8)) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    pub(super) fn stamp_transient_block_194(
        ...
        if (((s.v[2623] != 0.0) && s.b[2977]) && s.b[2978]) {s.store_sqrt_offset_square_offset(782, 2882, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(2882), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 2882, p[137], 782, 0.5);}
    ...
    if (s.b[2988] && s.b[2992]) {
        ...
        s.store_scalar(2621, tc);
        if (s.b[2988] && s.b[2992]) {s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_195(
        ...
        if (s.b[2988] && s.b[2992]) {s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
    ...
    if ((s.b[2989] && (!s.b[2988])) && s.b[2993]) {
        ...
        s.store_scalar(2623, td);
        if ((s.b[2989] && (!s.b[2988])) && s.b[2993]) {s.store_sub(395, 734, 735);s.store_neg(396, 735);}
    ...
    if ((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) {
        ...
        s.store_scalar(2624, tf);
        if ((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) {s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        ...
        if ((((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) && s.b[2995]) && s.b[2996]) {s.store_sqrt_offset_square_offset(782, 396, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 396, p[137], 782, 0.5);}
    ...
    if ((s.b[2991] && (!((s.b[2988] || s.b[2989]) || s.b[2990]))) && s.b[2999]) {
        ...
        s.store_scalar(2623, t10);
        if ((s.b[2991] && (!((s.b[2988] || s.b[2989]) || s.b[2990]))) && s.b[2999]) {s.store_sub(395, 734, 735);s.store_sub(396, 733, 735);}
        if (s.v[2623] != 0.0) {s.store_scalar(3007, 0.4);}
        let (t11,) = {
    if (s.v[2623] != 0.0) {
        (0.0,)
    } else {
    ...
    if (s.v[2623] != 0.0) {
        ...
        if (s.v[2623] != 0.0) {s.store_scalar(3009, 0.0);s.store_scalar(3010, 0.0);s.store_mul_scaled_ln_ad_rhs(3005, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(3005), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2623] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    if (s.v[2623] != 0.0) {
        ...
        if (s.v[2623] != 0.0) {s.store_scalar(3001, 0.0);s.store_primal_scale(3002, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
        ...
        let mut t19: usize = 0;
        while {
            let t18: f64 = if (((s.v[2623] != 0.0) && (!s.b[3019])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t18 != 0.0
        } {
            t19 += 1;
        ...
        if (((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (t1a,) = {
    ...
    if (((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) {
        ...
        if (((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) {s.store_scalar(770, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_197(
        ...
        if (((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) {s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) && s.b[3022]) {
        ...
        s.store_scalar(720, t1c);s.b[3023] = (1.0 == 2.0);s.store_scalar(3023, if s.b[3023] { 1.0 } else { 0.0 });
        let (t1d,) = {
    if ((((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) && (!s.b[3022])) && s.b[3023]) {
        ...
        s.store_scalar(720, t1d);s.b[3024] = (1.0 == 4.0);s.store_scalar(3024, if s.b[3024] { 1.0 } else { 0.0 });
        let (t1e,) = {
    if (((((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) && (!s.b[3022])) && (!s.b[3023])) && s.b[3024]) {
        ...
        s.store_scalar(720, t1e);s.b[3025] = (1.0 == 8.0);s.store_scalar(3025, if s.b[3025] { 1.0 } else { 0.0 });
        let (t1f,) = {
    ...
    if ((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) {
        ...
        while {
            let t23: f64 = if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t23 != 0.0
        } {
            t24 += 1;
            ...
            if ((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) {s.store_sqrt(726, 726);}
            let (t22,) = {
    if ((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[3020]) && s.b[3021]) {
    ...
    if ((s.v[2623] != 0.0) && (s.v[406] != 0.0)) {
        ...
        s.store_scalar(403, t28);s.b[3026] = (s.v[402] < s.v[403]);s.store_scalar(3026, if s.b[3026] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2623] != 0.0) && (!s.b[3026])) && (!s.b[3028])) {s.store_offset_div_scaled_offset_numerator(332, A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_198(
        ...
        if (((s.v[2623] != 0.0) && (!s.b[3026])) && (!s.b[3028])) {s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));}
        ...
        if (((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3029]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
        ...
        if (((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) {s.store_offset_add(442, 402, 397, 0.1);s.store_mul(222, 405, 229);s.store_mul(443, 405, 229);s.store_mul(334, 156, 213);s.store_mul(444, 154, 442);}
    }
    #[inline(never)]
    ...
    if (((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) && s.b[3032]) && s.b[3033]) && s.b[3034]) && s.b[3035]) {
        ...
        s.store_scalar(720, t2b);s.b[3036] = (2.0 == 2.0);s.store_scalar(3036, if s.b[3036] { 1.0 } else { 0.0 });
        let (t2c,) = {
    if ((((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) && s.b[3032]) && s.b[3033]) && s.b[3034]) && (!s.b[3035])) && s.b[3036]) {
        ...
        s.store_scalar(720, t2c);s.b[3037] = (2.0 == 4.0);s.store_scalar(3037, if s.b[3037] { 1.0 } else { 0.0 });
        let (t2d,) = {
    if (((((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) && s.b[3032]) && s.b[3033]) && s.b[3034]) && (!s.b[3035])) && (!s.b[3036])) && s.b[3037]) {
        ...
        s.store_scalar(720, t2d);s.b[3038] = (2.0 == 8.0);s.store_scalar(3038, if s.b[3038] { 1.0 } else { 0.0 });
        let (t2e,) = {
    ...
    if ((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) && s.b[3032]) && s.b[3033]) && s.b[3034]) {
        ...
        while {
            let t32: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3030]) && s.b[3032]) && s.b[3033]) && s.b[3034]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t32 != 0.0
        } {
            t33 += 1;
    ...
    pub(super) fn stamp_transient_block_200(
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3039]) && (!s.b[3040])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3039]) && s.b[3044]) {
        let t34: f64 = (s.v[3008] + 1.0);
        (t34,)
    } else {
        (s.v[3008],)
    }
};
        s.store_scalar(3008, t35);
    ...
    if ((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) && s.b[3050]) && s.b[3051]) {
        ...
        s.store_scalar(720, t38);s.b[3052] = (2.0 == 2.0);s.store_scalar(3052, if s.b[3052] { 1.0 } else { 0.0 });
        let (t39,) = {
    if (((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) && s.b[3050]) && (!s.b[3051])) && s.b[3052]) {
        ...
        s.store_scalar(720, t39);s.b[3053] = (2.0 == 4.0);s.store_scalar(3053, if s.b[3053] { 1.0 } else { 0.0 });
        let (t3a,) = {
    if ((((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) && s.b[3050]) && (!s.b[3051])) && (!s.b[3052])) && s.b[3053]) {
        ...
        s.store_scalar(720, t3a);s.b[3054] = (2.0 == 8.0);s.store_scalar(3054, if s.b[3054] { 1.0 } else { 0.0 });
        let (t3b,) = {
    ...
    if (((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) && s.b[3050]) {
        ...
        while {
            let t3f: f64 = if ((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) && s.b[3050]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t3f != 0.0
        } {
            t40 += 1;
    ...
    if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3055]) {
        let t41: f64 = (s.v[3008] + 2.0);
        (t41,)
    } else {
        (s.v[3008],)
    }
};
        s.store_scalar(3008, t42);
    ...
    if ((((s.v[2623] != 0.0) && (!s.b[3026])) && (!s.b[3048])) && s.b[3056]) {
        let t43: f64 = (s.v[3008] + 2.0);
        (t43,)
    } else {
        (s.v[3008],)
    }
};
        s.store_scalar(3008, t44);s.b[3057] = (s.v[3008] >= 2.0);s.store_scalar(3057, if s.b[3057] { 1.0 } else { 0.0 });
    ...
    if (((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3057]) && s.b[3058]) && s.b[3059]) && s.b[3060]) && s.b[3061]) {
        ...
        s.store_scalar(720, t47);s.b[3062] = (2.0 == 2.0);s.store_scalar(3062, if s.b[3062] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    ...
    if ((((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3057]) && s.b[3058]) && s.b[3059]) && s.b[3060]) && (!s.b[3061])) && s.b[3062]) {
        ...
        s.store_scalar(720, t48);s.b[3063] = (2.0 == 4.0);s.store_scalar(3063, if s.b[3063] { 1.0 } else { 0.0 });
        let (t49,) = {
    if (((((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3057]) && s.b[3058]) && s.b[3059]) && s.b[3060]) && (!s.b[3061])) && (!s.b[3062])) && s.b[3063]) {
        ...
        s.store_scalar(720, t49);s.b[3064] = (2.0 == 8.0);s.store_scalar(3064, if s.b[3064] { 1.0 } else { 0.0 });
        let (t4a,) = {
    ...
    if ((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3057]) && s.b[3058]) && s.b[3059]) && s.b[3060]) {
        ...
        while {
            let t4e: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3057]) && s.b[3058]) && s.b[3059]) && s.b[3060]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4e != 0.0
        } {
            t4f += 1;
    ...
    if (((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3065]) {
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3065]) && (!s.b[3066])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_transient_block_203(
        ...
        let mut t59: usize = 0;
        while {
            let t57: f64 = (s.v[421] + 1.0);let t58: f64 = if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3065]) && (s.v[97] <= t57)) { 1.0 } else { 0.0 };
            t58 != 0.0
        } {
            t59 += 1;
    ...
    if ((s.v[2623] != 0.0) && s.b[3083]) {
        ...
        if (((s.v[2623] != 0.0) && s.b[3083]) && (!s.b[3084])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 729, p[137], 782, 0.5);}
    ...
    pub(super) fn stamp_transient_block_205(
        ...
        let mut t64: usize = 0;
        while {
            let t62: f64 = (s.v[421] + 1.0);let t63: f64 = if (((s.v[2623] != 0.0) && s.b[3083]) && (s.v[97] <= t62)) { 1.0 } else { 0.0 };
            t63 != 0.0
        } {
            t64 += 1;
    ...
    pub(super) fn stamp_transient_block_206(
        ...
        if (((s.v[2623] != 0.0) && s.b[3098]) && s.b[3099]) {s.store_sqrt_offset_square_offset(782, 3003, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(3003), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_offset_lhs(336, 3003, p[137], 782, 0.5);}
    ...
    if s.b[3109] {
        ...
        s.store_scalar(406, t65);s.b[3110] = (((p[35] == 1.0) && (p[63] > 0.0)) && (s.v[459] > 0.0));s.store_scalar(3110, if s.b[3110] { 1.0 } else { 0.0 });
    ...
    if (s.b[3109] && s.b[3110]) {
        ...
        if ((s.b[3109] && s.b[3110]) && s.b[3124]) {s.store_scalar(3117, p[338]);}
        s.b[3125] = param_given[339];s.store_scalar(3125, if s.b[3125] { 1.0 } else { 0.0 });
        if ((s.b[3109] && s.b[3110]) && s.b[3125]) {s.store_scalar(3118, p[339]);}
        ...
        s.b[3128] = (p[38] == 1.0);s.store_scalar(3128, if s.b[3128] { 1.0 } else { 0.0 });
