...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_96(
        ...
        if (s.b[3398] && s.b[3402]) {
            ...
            s.store_sub_scaled_ad_lhs(781, A::sub(s.ad_value(335), s.ad_value(746)), 740, p.p337);
    ...
    if s.b[3307] {
        ...
        let eq1_branch_derivatives: [f64; 10] = [eq1_e1022_d_b0, eq1_e1022_d_b1, eq1_e1022_d_b2, eq1_e1022_d_b3, eq1_e1022_d_b4, eq1_e1022_d_b5, eq1_e1022_d_b6, eq1_e1022_d_b7, eq1_e1022_d_b8, eq1_e1022_d_b9];
