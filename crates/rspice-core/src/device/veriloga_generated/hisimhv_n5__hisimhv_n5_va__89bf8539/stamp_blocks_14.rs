...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_5(
        ...
        s.store_scalar(450, p[104]);s.store_scalar(451, p[294]);s.store_scalar(452, p[222]);s.store_scalar(453, p[420]);s.store_scalar(365, 1.0);s.b[1006] = (s.v[452] < 0.0);s.store_scalar(1006, if s.b[1006] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_6(
        ...
        s.store_scalar(543, p[96]);s.b[1166] = (s.v[543] < p[95]);s.store_scalar(1166, if s.b[1166] { 1.0 } else { 0.0 });
        if s.b[1166] {s.store_scalar(543, p[95]);}
    ...
    pub(super) fn stamp_reactive_block_7(
        ...
        s.store_scalar(533, (((p[84] + (p[633] / s.v[774])) + (p[721] / s.v[775])) + (p[809] / s.v[776])));s.store_scalar(534, (((p[62] + (p[634] / s.v[774])) + (p[722] / s.v[775])) + (p[810] / s.v[776])));s.store_scalar(535, (((p[59] + (p[635] / s.v[774])) + (p[723] / s.v[775])) + (p[811] / s.v[776])));s.store_scalar(536, (((p[60] + (p[636] / s.v[774])) + (p[724] / s.v[775])) + (p[812] / s.v[776])));s.store_scalar(537, (((p[85] + (p[637] / s.v[774])) + (p[725] / s.v[775])) + (p[813] / s.v[776])));s.store_scalar(538, (((p[82] + (p[638] / s.v[774])) + (p[726] / s.v[775])) + (p[814] / s.v[776])));s.store_scalar(539, (((p[61] + (p[639] / s.v[774])) + (p[727] / s.v[775])) + (p[815] / s.v[776])));s.store_scalar(540, (((p[75] + (p[640] / s.v[774])) + (p[728] / s.v[775])) + (p[816] / s.v[776])));s.store_scalar(541, (((p[80] + (p[641] / s.v[774])) + (p[729] / s.v[775])) + (p[817] / s.v[776])));s.store_scalar(542, (((p[77] + (p[642] / s.v[774])) + (p[730] / s.v[775])) + (p[818] / s.v[776])));s.store_scalar(818, (((p[493] + (p[824] / s.v[774])) + (p[839] / s.v[775])) + (p[854] / s.v[776])));s.store_scalar(819, (((p[494] + (p[825] / s.v[774])) + (p[840] / s.v[775])) + (p[855] / s.v[776])));s.store_scalar(820, (((p[496] + (p[826] / s.v[774])) + (p[841] / s.v[775])) + (p[856] / s.v[776])));s.store_scalar(822, (((p[515] + (p[828] / s.v[774])) + (p[843] / s.v[775])) + (p[858] / s.v[776])));s.store_scalar(823, (((p[516] + (p[829] / s.v[774])) + (p[844] / s.v[775])) + (p[859] / s.v[776])));s.store_scalar(824, (((p[517] + (p[830] / s.v[774])) + (p[845] / s.v[775])) + (p[860] / s.v[776])));s.store_scalar(825, (((p[519] + (p[831] / s.v[774])) + (p[846] / s.v[775])) + (p[861] / s.v[776])));s.store_scalar(827, (((p[538] + (p[833] / s.v[774])) + (p[848] / s.v[775])) + (p[863] / s.v[776])));s.b[1183] = (s.v[963] != 0.0);s.store_scalar(1183, if s.b[1183] { 1.0 } else { 0.0 });
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[342]));s.store_mul_scale_offset_mixed_ia(964, 964, A::div_from_scalar(p[341], s.ad_value(337)), 1.0, 1.0);}
        s.b[1184] = (s.v[964] < 1e21);s.store_scalar(1184, if s.b[1184] { 1.0 } else { 0.0 });
        if (s.b[1183] && s.b[1184]) {s.store_scalar(964, 1e21);}
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[369]));s.store_scaled_offset_ad(973, A::div_from_scalar(p[368], s.ad_value(337)), 1.0, s.v[973]);s.store_scalar(337, ((s.v[576]) as f64).powf(p[362]));s.store_scaled_offset_ad(972, A::div_from_scalar(p[361], s.ad_value(337)), 1.0, p[360]);}
        s.b[1185] = (s.v[972] < 0.0);s.store_scalar(1185, if s.b[1185] { 1.0 } else { 0.0 });
        if (s.b[1183] && s.b[1185]) {s.store_scalar(972, 0.0);}
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[348]));s.store_scaled_offset_ad(966, A::div_from_scalar(p[347], s.ad_value(337)), 1.0, p[346]);}
        s.b[1186] = (s.v[966] < 1.0);s.store_scalar(1186, if s.b[1186] { 1.0 } else { 0.0 });
        if (s.b[1183] && s.b[1186]) {s.store_scalar(966, 1.0);}
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[351]));s.store_scaled_offset_ad(968, A::div_from_scalar(p[350], s.ad_value(337)), 1.0, p[349]);}
        s.b[1187] = (s.v[968] < 0.0);s.store_scalar(1187, if s.b[1187] { 1.0 } else { 0.0 });
        if (s.b[1183] && s.b[1187]) {s.store_scalar(968, 0.0);}
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[357]));s.store_scaled_offset_ad(967, A::div_from_scalar(p[356], s.ad_value(337)), 1.0, p[354]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_8(
        ...
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[359]));s.store_scaled_offset_ad(969, A::div_from_scalar(p[358], s.ad_value(337)), 1.0, p[355]);}
        s.b[1189] = (s.v[969] < 0.0);s.store_scalar(1189, if s.b[1189] { 1.0 } else { 0.0 });
        if (s.b[1183] && s.b[1189]) {s.store_scalar(969, 0.0);}
        if s.b[1183] {s.store_scalar(337, ((s.v[576]) as f64).powf(p[373]));s.store_scaled_offset_ad(974, A::div_from_scalar(p[372], s.ad_value(337)), 1.0, s.v[974]);s.store_scalar(337, ((s.v[576]) as f64).powf(p[375]));s.store_mul_scale_offset_mixed_ia(975, 975, A::div_from_scalar(p[374], s.ad_value(337)), 1.0, 1.0);}
        ...
        s.b[1244] = ((p[40] == 1.0) && (((p[19] > 0.0) && (s.v[459] == 0.0)) || ((p[18] > 0.0) && (s.v[460] == 0.0))));s.store_scalar(1244, if s.b[1244] { 1.0 } else { 0.0 });
        if s.b[1244] {s.store_scalar(449, 0.0);}
        if (!s.b[1244]) {s.store_scalar(449, p[40]);}
        s.b[1245] = (s.v[449] == 1.0);s.store_scalar(1245, if s.b[1245] { 1.0 } else { 0.0 });
        if s.b[1245] {s.store_scalar(75, (if (p[19] > 0.0) { 1.0 } else { 0.0 }));}
        if s.b[1245] {s.store_scalar(76, (if (p[18] > 0.0) { 1.0 } else { 0.0 }));}
        s.b[1246] = ((p[17] == 0.0) || (p[17] == 2.0));s.store_scalar(1246, if s.b[1246] { 1.0 } else { 0.0 });
        if ((!s.b[1245]) && s.b[1246]) {s.store_scalar(75, 0.0);s.store_scalar(76, 0.0);}
        if ((!s.b[1245]) && (!s.b[1246])) {s.store_scalar(335, (((p[130] * p[2]) * p[7]) + (((s.v[530] + s.v[538]) * (((p[67] * s.v[536]) * 1000000.0) + s.v[534])) * (((p[68] * p[100]) * 1000000.0) + p[101]))));}
        if ((!s.b[1245]) && (!s.b[1246])) {s.store_scalar(75, (if (s.v[335] > 0.0) { 1.0 } else { 0.0 }));}
        if ((!s.b[1245]) && (!s.b[1246])) {s.store_scalar(335, (((p[131] * p[3]) * p[7]) + ((s.v[540] * (((p[69] * s.v[536]) * 1000000.0) + s.v[534])) * (((p[70] * p[100]) * 1000000.0) + p[101]))));}
        if ((!s.b[1245]) && (!s.b[1246])) {s.store_scalar(76, (if (s.v[335] > 0.0) { 1.0 } else { 0.0 }));}
        s.store_scalar(571, (p[12] / 1e-6));s.store_scalar(554, (p[73] * 100.0));s.store_scalar(463, (s.v[463] / 1e-6));s.store_scalar(464, (s.v[464] / 1e-6));s.store_scalar(494, (s.v[494] / 1e-6));s.store_scalar(459, (s.v[459] / 1e-6));s.store_scalar(460, (s.v[460] / 1e-6));s.store_scalar(502, (s.v[502] / 100.0));s.store_scalar(499, (s.v[499] / 100.0));s.store_scalar(454, (s.v[454] / 100.0));s.store_scalar(510, (s.v[510] * 10000.0));s.store_scalar(517, (s.v[517] / 100.0));s.store_scalar(518, (s.v[518] * 100.0));s.store_scalar(514, (s.v[514] * 100.0));s.store_scalar(520, (s.v[520] * 100.0));s.store_scalar(491, (s.v[491] * 100.0));s.store_scalar(511, (s.v[511] / 10.0));s.store_scalar(512, (s.v[512] * 100.0));s.store_scalar(522, (s.v[522] / 100.0));s.store_scalar(528, (s.v[528] / 1e-6));s.store_scalar(531, (s.v[531] / 100.0));s.store_scalar(532, (s.v[532] / 100.0));s.store_scalar(533, (s.v[533] / 100.0));s.store_scalar(538, (s.v[538] / 100.0));s.store_scalar(541, (s.v[541] / 100.0));s.store_scalar(458, (-s.v[458]));s.store_scale(973, 973, 0.01);s.store_scalar(81, p[28]);s.b[82] = ((p[133] != 0.0) || (p[134] != 0.0));s.store_scalar(82, if s.b[82] { 1.0 } else { 0.0 });s.b[1248] = (((p[235] == 0.0) && (p[237] == 0.0)) || (p[236] == 0.0));s.store_scalar(1248, if s.b[1248] { 1.0 } else { 0.0 });
        if s.b[1248] {s.store_scalar(765, 0.0);}
        if (!s.b[1248]) {s.store_scalar(765, 1.0);}
        s.store_scalar(581, (s.v[580] * s.v[576]));s.store_scalar(777, (p[289] * 1000000.0));s.store_scalar(616, (s.v[457] - (s.v[764] * (9.025e-5 + (s.v[764] * 1e-7)))));s.store_scalar(617, (8.8541878e-12 * p[267]));s.copy_ad(618, 452);s.b[1249] = (s.v[471] == 0.0);s.store_scalar(1249, if s.b[1249] { 1.0 } else { 0.0 });
        if s.b[1249] {s.store_scalar(615, 0.0);s.store_scalar(642, 0.0);}
        if (!s.b[1249]) {s.store_scalar(615, 1.0);s.store_scalar(642, ((((1.0 + (1.0 / s.v[576]))) as f64).powf(p[153]) * s.v[471]));}
    ...
    pub(super) fn stamp_reactive_block_9(
        ...
        s.store_scalar(589, (2.0 / s.v[335]));s.b[1250] = (((p[8] > 0.0) && (p[9] > 0.0)) && ((p[7] == 1.0) || ((p[7] > 1.0) && (p[10] > 0.0))));s.store_scalar(1250, if s.b[1250] { 1.0 } else { 0.0 });
        if s.b[1250] {s.store_scalar(335, 0.0);s.store_scalar(721, 0.0);}
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (s.b[1250] && (s.v[721] < p[7])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
            ...
            if s.b[1250] {s.store_add_scaled_inputs3_mixed_iaa(335, 335, 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(721), (p[10] + p[0]), (p[8] + (0.5 * p[0])))), 1.0, A::div_from_scalar(1.0, A::scale_offset(s.ad_value(721), (p[10] + p[0]), (p[9] + (0.5 * p[0])))), 1.0);s.store_primal_offset(721, 721, 1.0);}
        }
        if s.b[1250] {s.store_div_from_scalar(588, (2.0 * p[7]), 335);}
        if (!s.b[1250]) {s.store_scalar(588, 0.0);}
        s.store_scalar(773, s.v[528]);s.store_scalar(620, s.v[476]);s.store_scalar(621, s.v[464]);s.store_scalar(622, s.v[463]);s.b[1251] = ((p[32] == 1.0) && s.b[623]);s.store_scalar(1251, if s.b[1251] { 1.0 } else { 0.0 });
        if s.b[1251] {s.store_scalar(620, (s.v[620] * ((p[282] * (((s.v[571]) as f64).ln() - ((s.v[622]) as f64).ln())) + 1.0)));s.store_scalar(621, ((s.v[621] + s.v[571]) - s.v[622]));s.store_scalar(773, ((s.v[773] + s.v[571]) - s.v[622]));s.store_scalar(622, s.v[571]);}
        s.store_scale(573, 620, ((1.0 + (p[162] / ((s.v[580]) as f64).powf(p[163]))) * ((1.0 + (p[164] / ((s.v[576]) as f64).powf(p[165]))) * (1.0 + (p[167] / ((s.v[581]) as f64).powf(p[168]))))));s.b[1253] = (s.v[588] > 0.0);s.store_scalar(1253, if s.b[1253] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_10(
        ...
        s.b[1265] = ((s.v[582] > p[140]) || (p[140] <= 0.0));s.store_scalar(1265, if s.b[1265] { 1.0 } else { 0.0 });
        if s.b[1265] {s.store_add_scaled_inputs(586, 622, ((s.v[582] - p[140]) * 1.0 / (s.v[582])), 585, (p[140] * 1.0 / (s.v[582])));}
        if (!s.b[1265]) {s.store_add_scaled_inputs3_indices(586, 585, 1.0, 585, ((p[140] - s.v[582]) * 1.0 / (p[140])), 622, (-((p[140] - s.v[582]) * 1.0 / (p[140]))));}
        ...
        s.store_add_scaled_product_right_sub(586, 586, 1.0, 336, 773, 622, 1.0 / (s.v[582]));s.store_scale(166, 586, 1.6021918e-19);s.store_scale(636, 166, 1.034943e-10);s.store_scale(637, 636, 2.0);s.b[1266] = ((s.v[582] <= (2.0 * p[140])) && (p[140] > 0.0));s.store_scalar(1266, if s.b[1266] { 1.0 } else { 0.0 });
        if s.b[1266] {s.store_add_scaled_inputs4_indices(587, 585, 2.0, 585, (-(s.v[582] * 1.0 / (p[140]))), 622, (-(-(s.v[582] * 1.0 / (p[140])))), 622, -1.0);s.store_ln_div(638, 587, 622);}
        if (!s.b[1266]) {s.store_scalar(638, 0.0);}
        s.store_scalar(639, (((((2.0 * 1.6021918e-19) * s.v[494]) * 1.034943e-10)) as f64).sqrt());s.store_scalar(640, (1.0 / (s.v[494] * s.v[494])));s.store_scalar(641, ((1.0 + (s.v[542] / ((s.v[576]) as f64).powf(p[231]))) * (1.0 + (p[238] / ((s.v[581]) as f64).powf(p[239])))));s.store_scaled_ln_scaled_input(158, 586, 1.0 / (1.04e16), (2.0 / 38.68283));s.store_scaled_ln_scaled_input(159, 622, 1.0 / (1.04e16), (2.0 / 38.68283));s.b[1267] = (p[51] == 1.0);s.store_scalar(1267, if s.b[1267] { 1.0 } else { 0.0 });
        if s.b[1267] {s.store_scalar(335, (p[5] + (s.v[163] / (3.0 * p[4]))));s.store_scalar(336, (s.v[582] - p[6]));}
        s.b[1269] = (p[130] > 0.0);s.store_scalar(1269, if s.b[1269] { 1.0 } else { 0.0 });
        if s.b[1269] {s.store_scalar(644, (p[130] * p[2]));s.store_scalar(648, (p[130] * p[3]));}
        if (!s.b[1269]) {s.store_scalar(644, 0.0);s.store_scalar(648, 0.0);}
        s.b[1270] = (p[131] > 0.0);s.store_scalar(1270, if s.b[1270] { 1.0 } else { 0.0 });
        if s.b[1270] {s.store_scalar(648, (p[131] * p[3]));}
        ...
        if (s.b[1271] && s.b[1272]) {s.store_scalar(645, (1.0 + (p[309] / ((s.v[581]) as f64).powf(p[310]))));}
        s.b[1273] = (s.v[538] != 0.0);s.store_scalar(1273, if s.b[1273] { 1.0 } else { 0.0 });
        if ((s.b[1271] && s.b[1272]) && s.b[1273]) {s.store_scalar(341, (1.0 + (p[303] / ((s.v[581]) as f64).powf(p[304]))));s.store_scalar(340, ((-p[301]) * ((s.v[576]) as f64).powf(p[302])));}
        ...
        if (s.b[1271] && s.b[1275]) {s.store_scalar(336, (1.0 + (p[307] / ((s.v[581]) as f64).powf(p[308]))));s.store_scalar(335, ((-p[305]) * ((s.v[576]) as f64).powf(p[306])));}
        ...
        if (!s.b[1271]) {s.store_primal_sqrt_square_offset(649, 451, (p[419] * p[419]));s.store_scalar(614, ((((p[419] * p[419]) + (p[97] * p[97]))) as f64).sqrt());s.store_scalar(786, (1.0 + (p[424] / ((s.v[580]) as f64).powf(p[425]))));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_11(
        ...
        if (!s.b[1271]) {s.store_scalar(652, (1.0 + (p[426] / ((s.v[576]) as f64).powf(p[427]))));s.store_scalar(653, (1.0 + (p[428] / ((s.v[576]) as f64).powf(p[429]))));s.store_scalar(654, 1.0);s.store_scalar(645, 0.0);s.store_scalar(646, 0.0);s.store_scalar(647, 0.0);}
        ...
        s.b[1282] = (p[44] == 0.0);s.store_scalar(1282, if s.b[1282] { 1.0 } else { 0.0 });
        if s.b[1282] {s.store_scalar(335, ((p[108] * s.v[576]) + p[109]));}
        s.b[1283] = (s.v[335] < 0.0);s.store_scalar(1283, if s.b[1283] { 1.0 } else { 0.0 });
        if (s.b[1282] && s.b[1283]) {s.store_scalar(335, 0.0);}
        if s.b[1282] {s.store_offset_ad(658, A::div_scaled_value_offset_denominator(s.ad_value(335), p[107], s.ad_value(335), p[107], 1.0), 1.0);}
        if (!s.b[1282]) {s.store_scalar(335, (p[108] * s.v[576]));}
        s.b[1284] = (s.v[335] < 0.0);s.store_scalar(1284, if s.b[1284] { 1.0 } else { 0.0 });
        if ((!s.b[1282]) && s.b[1284]) {s.store_scalar(335, 0.0);}
        if (!s.b[1282]) {s.store_offset_ad(658, A::div_scaled_value_offset_denominator(s.ad_value(335), p[107], s.ad_value(335), p[107], 1.0), ((p[109]) + (1e-25)));}
        ...
        s.store_scalar(523, (if (s.v[523] != 0.0) { (s.v[523] * (1.0 + (p[279] / ((s.v[576]) as f64).powf(p[280])))) } else { 0.0 }));s.store_scalar(670, (((3.453133e-11 / (3.141592653589793 / 2.0)) * s.v[635]) * (((1.0 + (p[225] / p[95]))) as f64).ln()));s.store_scalar(671, (if (p[134] != 0.0) { (((1000000.0 * s.v[635]) * p[134]) / ((s.v[576]) as f64).powf(p[135])) } else { 0.0 }));s.store_scalar(672, (p[283] * ((s.v[576]) as f64).powf((-p[286]))));s.store_scalar(673, (p[290] * ((s.v[576]) as f64).powf((-p[291]))));s.store_scalar(674, (p[287] * (((s.v[576] + s.v[777])) as f64).powf((-p[288]))));s.store_scalar(766, (((s.v[541] / (s.v[365] * s.v[632])) * (1.0 + (p[317] / ((s.v[576]) as f64).powf(p[318])))) * (1.0 + (p[315] / ((s.v[580]) as f64).powf(p[316])))));s.store_scalar(767, (s.v[566] * (s.v[365] * s.v[632])));s.store_scalar(766, (s.v[766] * (1.0 / ((p[7]) as f64).powf(p[327]))));s.store_scalar(675, ((((1.0 / ((p[7]) as f64).powf(p[327])) / (s.v[365] * s.v[632])) * (1.0 + (p[317] / ((s.v[576]) as f64).powf(p[318])))) * (1.0 + (p[315] / ((s.v[580]) as f64).powf(p[316])))));s.b[1287] = ((p[53] == 0.0) || (s.v[541] == 0.0));s.store_scalar(1287, if s.b[1287] { 1.0 } else { 0.0 });
        if s.b[1287] {s.store_scalar(686, 0.0);s.store_scalar(687, 0.0);s.store_scalar(387, (ctx_temp + p[11]));s.copy_ad(388, 387);s.store_offset(387, 387, s.v[732]);s.store_offset(389, 388, (-s.v[764]));s.store_offset_square(390, 388, (-(s.v[764] * s.v[764])));s.store_offset(391, 387, (-s.v[764]));s.store_offset_square(392, 387, (-(s.v[764] * s.v[764])));s.store_scale(676, 387, 1.0 / (s.v[764]));s.store_ln(590, 676);s.store_sub_scaled_inputs_mixed_ai(393, A::sub_from_scalar(s.v[616], A::scale(s.ad_value(391), s.v[455])), 1.0, 392, s.v[456]);s.store_sqrt(677, 393);s.store_div_from_scalar(335, 1.0, 387);s.store_scalar(336, (1.0 / s.v[764]));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_12(
        ...
        if (s.b[1287] && s.b[1288]) {s.store_div_mixed_ia(966, 966, A::powf(s.ad_value(676), p[381]));s.store_div_from_scalar_powf_ad(970, s.v[970], s.ad_value(676), p[382]);}
        ...
        if ((s.b[1287] && (!s.b[1288])) && s.b[1291]) {s.store_div_mixed_ia(966, 966, A::powf(s.ad_value(676), p[381]));s.store_offset_scaled(976, 676, p[365], (((((-1.0)) * (p[365]))) + (p[364])));}
    ...
    pub(super) fn stamp_reactive_block_13(
        ...
        if (s.b[1287] && s.b[1294]) {s.store_mul_div_from_scalar_lhs_ad_mixed_ia(681, (s.v[641] * s.v[454]), 334, A::add_scaled_inputs(A::scale_offset(s.ad_value(389), p[90], 1.0), 1.0, s.ad_value(390), p[91]));}
        if (s.b[1287] && (!s.b[1294])) {s.store_mul_div_from_scalar_lhs_ad_mixed_ia(681, (s.v[641] * s.v[454]), 334, A::add_scaled_inputs(A::scale_offset(s.ad_value(391), p[90], 1.0), 1.0, s.ad_value(392), p[91]));}
        s.b[1296] = (p[39] != 2.0);s.store_scalar(1296, if s.b[1296] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1296]) {s.store_add_scaled_inputs_mixed_ai(682, A::scale_offset(s.ad_value(389), p[324], 1.0), s.v[627], 390, (p[325] * s.v[627]));s.store_add_scaled_inputs_mixed_ai(335, A::scale_offset(s.ad_value(389), p[390], 1.0), 1.0, 390, p[391]);s.store_scale(688, 335, s.v[633]);s.store_scale(689, 335, s.v[634]);}
        if (s.b[1287] && (!s.b[1296])) {s.store_add_scaled_inputs_mixed_ai(682, A::scale_offset(s.ad_value(391), p[324], 1.0), s.v[627], 392, (p[325] * s.v[627]));s.store_add_scaled_inputs_mixed_ai(335, A::scale_offset(s.ad_value(391), p[390], 1.0), 1.0, 392, p[391]);s.store_scale(688, 335, s.v[633]);s.store_scale(689, 335, s.v[634]);}
        ...
        if (s.b[1287] && (p[53] != 0.0)) {s.store_add_scaled_inputs_mixed_ai(766, A::scale_offset(s.ad_value(389), p[328], s.v[541]), s.v[675], 390, (p[329] * s.v[675]));}
        s.b[1304] = (s.v[766] < 0.0001);s.store_scalar(1304, if s.b[1304] { 1.0 } else { 0.0 });
        if ((s.b[1287] && (p[53] != 0.0)) && s.b[1304]) {s.store_scalar(766, 0.0001);}
        if s.b[1287] {s.store_add_scaled_inputs_mixed_ai(336, A::scale_offset(s.ad_value(389), p[330], s.v[529]), 1.0, 390, p[331]);s.store_offset(781, 336, (-0.05));s.store_scalar(782, 0.0);}
        if s.b[1287] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    pub(super) fn stamp_reactive_block_14(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1312]) {s.store_scale(336, 645, ((((p[67] * s.v[536]) * 1000000.0) + s.v[534]) * (((p[68] * p[100]) * 1000000.0) + p[101])));}
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1314]) {s.store_scale(336, 645, ((((p[69] * s.v[536]) * 1000000.0) + s.v[534]) * (((p[70] * p[100]) * 1000000.0) + p[101])));}
        s.b[1315] = (p[39] == 1.0);s.store_scalar(1315, if s.b[1315] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_div_from_scalar(342, (-p[98]), 336);s.store_offset_scaled(337, 342, (p[63] * 1000000.0), ((1.0) + (p[98])));s.store_offset_add_scaled_product_indices(781, 338, (-1.0), 337, 338, 1.0, (-0.01));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_15(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_indices(339, 338, 1.0, 781, 0.5, 782, 0.5);s.store_offset_sub_scaled_inputs_indices(781, 338, (p[98] + 1.0), 339, 1.0, (-5e-5));s.store_scale(782, 338, ((p[98] + 1.0) * (4.0 * 5e-5)));}
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_indices(341, 338, (p[98] + 1.0), 781, (-0.5), 782, (-0.5));s.store_offset_add_scaled_product_indices(781, 341, 1.0, 335, 338, 1.0, (-5e-5));s.store_scalar(782, 0.0);}
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        s.b[1318] = ((p[39] == 0.0) || (p[39] == 1.0));s.store_scalar(1318, if s.b[1318] { 1.0 } else { 0.0 });
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_scaled_add(336, 781, 782, 0.5);}
        s.b[1319] = ((p[39] == 0.0) || (p[39] == 1.0));s.store_scalar(1319, if s.b[1319] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_16(
        ...
        if s.b[1287] {s.store_scaled_sqrt(139, 155, s.v[639]);s.store_square(694, 139);s.store_scaled_square(140, 394, s.v[640]);s.store_offset_scaled(427, 391, p[448], p[447]);s.store_scalar(957, p[193]);}
        ...
        if (s.b[1287] && s.b[1324]) {s.store_div_from_scalar(794, s.v[569], 335);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p[418]), p[418]));s.store_div_from_scalar(795, s.v[570], 334);s.store_offset_scaled(959, 387, p[439], (((((-s.v[764])) * (p[439]))) + (s.v[959])));}
        if (s.b[1287] && s.b[1324]) {
            if (s.v[676] == 0.0) {
                s.store_scalar(335, 0.0);
            } else {
        ...
        if (s.b[1287] && s.b[1324]) {s.store_div_from_scalar(787, s.v[567], 335);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p[417]), p[417]));s.store_div_from_scalar(788, s.v[568], 334);s.store_offset_scaled(956, 387, p[438], (((((-s.v[764])) * (p[438]))) + (s.v[956])));}
    ...
    pub(super) fn stamp_reactive_block_17(
        ...
        s.b[1327] = (p[48] > 0.0);s.store_scalar(1327, if s.b[1327] { 1.0 } else { 0.0 });s.b[1328] = (p[15] > s.v[632]);s.store_scalar(1328, if s.b[1328] { 1.0 } else { 0.0 });
        if ((s.b[1287] && s.b[1327]) && s.b[1328]) {s.store_scale(873, 828, p[13]);s.store_scale(874, 830, p[13]);s.store_scale(875, 829, (p[15] - s.v[632]));s.store_scale(876, 831, (p[15] - s.v[632]));s.store_scale(877, 836, s.v[632]);s.store_scale(878, 837, s.v[632]);}
        if ((s.b[1287] && s.b[1327]) && (!s.b[1328])) {s.store_scale(873, 828, p[13]);s.store_scale(874, 830, p[13]);s.store_scalar(875, 0.0);s.store_scalar(876, 0.0);s.store_scale(877, 836, p[15]);s.store_scale(878, 837, p[15]);}
        if (s.b[1287] && (!s.b[1327])) {s.store_scale(873, 828, p[13]);s.store_scale(874, 830, p[13]);s.store_scale(875, 829, p[15]);s.store_scale(876, 831, p[15]);s.store_scalar(877, 0.0);s.store_scalar(878, 0.0);}
    ...
    pub(super) fn stamp_reactive_block_18(
        ...
        if s.b[1287] {s.store_scale_ad(837, A::exp_scaled_input(A::add_scaled_inputs(A::add_scaled_product(s.ad_value(678), s.v[616], s.ad_value(393), s.ad_value(154), (-1.0)), 1.0, s.ad_value(590), p[532]), 1.0 / (p[521])), p[518]);}
        s.b[1330] = (p[48] > 0.0);s.store_scalar(1330, if s.b[1330] { 1.0 } else { 0.0 });s.b[1331] = (p[16] > s.v[632]);s.store_scalar(1331, if s.b[1331] { 1.0 } else { 0.0 });
        if ((s.b[1287] && s.b[1330]) && s.b[1331]) {s.store_scale(879, 828, p[14]);s.store_scale(880, 830, p[14]);s.store_scale(881, 829, (p[16] - s.v[632]));s.store_scale(882, 831, (p[16] - s.v[632]));s.store_scale(883, 836, s.v[632]);s.store_scale(884, 837, s.v[632]);}
        if ((s.b[1287] && s.b[1330]) && (!s.b[1331])) {s.store_scale(879, 828, p[14]);s.store_scale(880, 830, p[14]);s.store_scalar(881, 0.0);s.store_scalar(882, 0.0);s.store_scale(883, 836, p[16]);s.store_scale(884, 837, p[16]);}
        if (s.b[1287] && (!s.b[1330])) {s.store_scale(879, 828, p[14]);s.store_scale(880, 830, p[14]);s.store_scale(881, 829, p[16]);s.store_scale(882, 831, p[16]);s.store_scalar(883, 0.0);s.store_scalar(884, 0.0);}
        ...
        if s.b[1287] {s.store_offset_scaled(832, 391, ((p[481]) * ((p[500] * p[13]))), (p[500] * p[13]));}
        s.b[1333] = (p[15] > s.v[632]);s.store_scalar(1333, if s.b[1333] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1333]) {s.store_offset_scaled(833, 391, ((p[483]) * ((p[501] * (p[15] - s.v[632])))), (p[501] * (p[15] - s.v[632])));s.store_offset_scaled(834, 391, ((p[485]) * ((p[502] * s.v[632]))), (p[502] * s.v[632]));}
        if (s.b[1287] && (!s.b[1333])) {s.store_scalar(833, 0.0);s.store_offset_scaled(834, 391, ((p[485]) * ((p[502] * p[15]))), (p[502] * p[15]));}
        ...
        if s.b[1287] {s.store_sub_from_scalar_scaled_input(841, p[506], 391, p[487]);s.store_sub_from_scalar_scaled_input(842, p[507], 391, p[489]);s.store_sub_from_scalar_scaled_input(843, p[508], 391, p[491]);}
        s.b[1337] = ((s.v[841] < 0.01) && (p[13] > 0.0));s.store_scalar(1337, if s.b[1337] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1337]) {s.store_scalar(841, 0.01);}
        s.b[1338] = ((s.v[842] < 0.01) && (p[15] > s.v[632]));s.store_scalar(1338, if s.b[1338] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1338]) {s.store_scalar(842, 0.01);}
        s.b[1339] = ((s.v[843] < 0.01) && (p[15] > 0.0));s.store_scalar(1339, if s.b[1339] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1339]) {s.store_scalar(843, 0.01);}
        if s.b[1287] {s.store_offset_scaled(835, 391, ((p[482]) * ((p[523] * p[14]))), (p[523] * p[14]));}
        s.b[1340] = (p[16] > s.v[632]);s.store_scalar(1340, if s.b[1340] { 1.0 } else { 0.0 });
        if (s.b[1287] && s.b[1340]) {s.store_offset_scaled(838, 391, ((p[484]) * ((p[524] * (p[16] - s.v[632])))), (p[524] * (p[16] - s.v[632])));s.store_offset_scaled(839, 391, ((p[486]) * ((p[525] * s.v[632]))), (p[525] * s.v[632]));}
        if (s.b[1287] && (!s.b[1340])) {s.store_scalar(838, 0.0);s.store_offset_scaled(839, 391, ((p[486]) * ((p[525] * p[16]))), (p[525] * p[16]));}
        ...
        if s.b[1287] {s.store_sub_from_scalar_scaled_input(844, p[529], 391, p[488]);s.store_sub_from_scalar_scaled_input(845, p[530], 391, p[490]);s.store_sub_from_scalar_scaled_input(846, p[531], 391, p[492]);}
        s.b[1344] = ((s.v[844] < 0.01) && (p[14] > 0.0));s.store_scalar(1344, if s.b[1344] { 1.0 } else { 0.0 });
