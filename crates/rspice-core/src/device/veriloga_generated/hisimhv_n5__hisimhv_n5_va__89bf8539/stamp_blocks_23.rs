...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_125(
        ...
        if (((!s.b[1441]) && s.b[2517]) && s.b[2566]) {s.store_sub_scaled_inputs(781, 154, 0.2, 2519, 1.0);s.store_square(722, 781);s.store_scaled_mul(723, 154, 154, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && s.b[2568]) {s.store_scalar(720, 1.0);}
        s.b[2569] = (1.0 == 2.0);s.store_scalar(2569, if s.b[2569] { 1.0 } else { 0.0 });
        if ((((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && (!s.b[2568])) && s.b[2569]) {s.store_scalar(720, 2.0);}
        s.b[2570] = (1.0 == 4.0);s.store_scalar(2570, if s.b[2570] { 1.0 } else { 0.0 });
        if (((((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && (!s.b[2568])) && (!s.b[2569])) && s.b[2570]) {s.store_scalar(720, 3.0);}
        s.b[2571] = (1.0 == 8.0);s.store_scalar(2571, if s.b[2571] { 1.0 } else { 0.0 });
        if ((((((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && (!s.b[2568])) && (!s.b[2569])) && (!s.b[2570])) && s.b[2571]) {s.store_scalar(720, 4.0);}
        if ((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) {s.store_scalar(719, 0.0);}
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
            ...
            if ((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if (((!s.b[1441]) && s.b[2517]) && s.b[2566]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_affine_lhs(780, 781, 154, 0.2, 0.0, 726);s.store_div_scaled_product3_indices(334, 154, 725, 726, 0.2, 770, 1.0);s.store_sub_scaled_inputs(335, 154, 0.2, 780, 1.0);}
        if (((!s.b[1441]) && s.b[2517]) && s.b[2566]) {
        }
        if (((!s.b[1441]) && s.b[2517]) && (!s.b[2566])) {s.copy_ad(335, 2519);s.store_scalar(334, 1.0);}
        if ((!s.b[1441]) && s.b[2517]) {s.store_sqrt_offset_input(2527, 335, (10.0 * 2.220446049250313e-16));s.store_mul(2528, 2526, 2527);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_126(
        ...
        if ((!s.b[1441]) && s.b[2517]) {s.store_mul_scale_offset_mixed_ai(995, A::div_scaled_inputs(s.ad_value(155), 2.0, s.ad_value(162), 1.0), 2528, p[454], 0.0);s.store_scaled_mul(46, 995, 333, s.v[632]);s.store_add(134, 136, 46);}
        ...
        if s.b[2572] {s.store_sub_from_scalar(781, ((10.0 * 2.220446049250313e-16) + (10.0 * 2.220446049250313e-16)), 110);s.store_square(722, 781);s.store_scalar(723, ((10.0 * 2.220446049250313e-16) * (10.0 * 2.220446049250313e-16)));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if ((s.b[2572] && s.b[2573]) && s.b[2574]) {s.store_scalar(720, 1.0);}
        s.b[2575] = (2.0 == 2.0);s.store_scalar(2575, if s.b[2575] { 1.0 } else { 0.0 });
        if (((s.b[2572] && s.b[2573]) && (!s.b[2574])) && s.b[2575]) {s.store_scalar(720, 2.0);}
        s.b[2576] = (2.0 == 4.0);s.store_scalar(2576, if s.b[2576] { 1.0 } else { 0.0 });
        if ((((s.b[2572] && s.b[2573]) && (!s.b[2574])) && (!s.b[2575])) && s.b[2576]) {s.store_scalar(720, 3.0);}
        s.b[2577] = (2.0 == 8.0);s.store_scalar(2577, if s.b[2577] { 1.0 } else { 0.0 });
        if (((((s.b[2572] && s.b[2573]) && (!s.b[2574])) && (!s.b[2575])) && (!s.b[2576])) && s.b[2577]) {s.store_scalar(720, 4.0);}
        if (s.b[2572] && s.b[2573]) {s.store_scalar(719, 0.0);}
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((s.b[2572] && s.b[2573]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
            ...
            if (s.b[2572] && s.b[2573]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if s.b[2572] {s.store_div_from_scalar(726, 1.0, 726);s.store_scaled_mul(780, 781, 726, (10.0 * 2.220446049250313e-16));s.store_div_scaled_product_indices(334, 725, 726, (10.0 * 2.220446049250313e-16), 770, 1.0);s.store_sub_from_scalar(110, ((10.0 * 2.220446049250313e-16) + (10.0 * 2.220446049250313e-16)), 780);}
        if s.b[2572] {
        }
        if (!s.b[2572]) {
        }
        ...
        if ((!s.b[2578]) && s.b[2579]) {s.store_mul(335, 659, 85);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_127(
        ...
        if ((!s.b[2578]) && s.b[2579]) {s.store_scale(337, 636, 1.0 / ((s.v[188] * s.v[188])));s.store_scale_ad(338, A::div_from_scalar(2.0, s.ad_value(636)), (s.v[188] * s.v[188]));s.store_add_scaled_inputs_product_indices(339, 335, 1.0, 155, (-1.0), 660, 1436, (-1.0));s.store_offset_mul(340, 338, 339, 1.0);s.store_scaled_offset(341, 338, 1.0, 2.0);}
        s.b[2580] = ((s.v[340] < (1e-6 + s.v[341])) && (s.v[341] >= 0.0));s.store_scalar(2580, if s.b[2580] { 1.0 } else { 0.0 });
        if (((!s.b[2578]) && s.b[2579]) && s.b[2580]) {s.store_sub_offset_lhs(781, 341, 1e-6, 340);s.store_square(722, 781);s.store_square(723, 341);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && s.b[2582]) {s.store_scalar(720, 1.0);}
        s.b[2583] = (4.0 == 2.0);s.store_scalar(2583, if s.b[2583] { 1.0 } else { 0.0 });
        if ((((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && (!s.b[2582])) && s.b[2583]) {s.store_scalar(720, 2.0);}
        s.b[2584] = (4.0 == 4.0);s.store_scalar(2584, if s.b[2584] { 1.0 } else { 0.0 });
        if (((((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && (!s.b[2582])) && (!s.b[2583])) && s.b[2584]) {s.store_scalar(720, 3.0);}
        s.b[2585] = (4.0 == 8.0);s.store_scalar(2585, if s.b[2585] { 1.0 } else { 0.0 });
        if ((((((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && (!s.b[2582])) && (!s.b[2583])) && (!s.b[2584])) && s.b[2585]) {s.store_scalar(720, 4.0);}
        if ((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) {s.store_scalar(719, 0.0);}
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
            ...
            if ((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if (((!s.b[2578]) && s.b[2579]) && s.b[2586]) {s.store_scalar(283, 0.0);s.store_scalar(343, 0.0);}
        ...
        if (((!s.b[2578]) && s.b[2587]) && s.b[2588]) {s.store_scalar(334, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_128(
        ...
        if (((!s.b[2578]) && s.b[2587]) && s.b[2588]) {s.store_scalar(335, 0.0);}
        ...
        if (s.b[2593] && s.b[2594]) {s.store_offset(781, 423, (((-100000.0)) + (50000.0)));s.store_square(722, 781);s.store_scalar(723, (50000.0 * 50000.0));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((s.b[2593] && s.b[2594]) && s.b[2595]) && s.b[2596]) {s.store_scalar(720, 1.0);}
        s.b[2597] = (1.0 == 2.0);s.store_scalar(2597, if s.b[2597] { 1.0 } else { 0.0 });
        if ((((s.b[2593] && s.b[2594]) && s.b[2595]) && (!s.b[2596])) && s.b[2597]) {s.store_scalar(720, 2.0);}
        s.b[2598] = (1.0 == 4.0);s.store_scalar(2598, if s.b[2598] { 1.0 } else { 0.0 });
        if (((((s.b[2593] && s.b[2594]) && s.b[2595]) && (!s.b[2596])) && (!s.b[2597])) && s.b[2598]) {s.store_scalar(720, 3.0);}
        s.b[2599] = (1.0 == 8.0);s.store_scalar(2599, if s.b[2599] { 1.0 } else { 0.0 });
        if ((((((s.b[2593] && s.b[2594]) && s.b[2595]) && (!s.b[2596])) && (!s.b[2597])) && (!s.b[2598])) && s.b[2599]) {s.store_scalar(720, 4.0);}
        if ((s.b[2593] && s.b[2594]) && s.b[2595]) {s.store_scalar(719, 0.0);}
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((s.b[2593] && s.b[2594]) && s.b[2595]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
            ...
            if ((s.b[2593] && s.b[2594]) && s.b[2595]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        if (s.b[2593] && s.b[2594]) {s.store_div_from_scalar(726, 1.0, 726);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_129(
        ...
        if (s.b[2593] && s.b[2594]) {s.store_scaled_mul(780, 781, 726, 50000.0);s.store_div_scaled_product_indices(334, 725, 726, 50000.0, 770, 1.0);s.store_offset(336, 780, (100000.0 - 50000.0));}
    ...
    pub(super) fn stamp_reactive_block_130(
        ...
        if (s.b[2601] && (!s.b[2609])) {s.store_exp(336, 335);s.store_mul_div_from_scalar_lhs_ad_mixed_ai(337, s.v[520], A::square(s.ad_value(195)), 336);s.store_scale(337, 162, (s.v[519] * s.v[632]));}
        ...
        if ((!s.b[2613]) && (!s.b[2615])) {s.store_exp(335, 334);s.store_scale_ad(336, A::div_from_scalar(s.v[511], s.ad_value(192)), (1.6021918e-19 * s.v[632]));}
        if (!s.b[2613]) {s.store_sub(205, 790, 792);}
        s.b[2616] = (s.v[205] > 0.0);s.store_scalar(2616, if s.b[2616] { 1.0 } else { 0.0 });
        if ((!s.b[2613]) && s.b[2616]) {s.store_square(336, 205);s.store_mul(338, 336, 205);s.store_offset(334, 338, 0.5);s.store_div(339, 338, 334);s.store_div_square_rhs_mixed_ai(341, A::add_scaled_products(s.ad_value(336), s.ad_value(334), 3.0, s.ad_value(338), s.ad_value(336), (-3.0)), 334);}
        ...
        if ((!s.b[2617]) && s.b[2618]) {s.store_scalar(198, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_131(
        ...
        if ((!s.b[2617]) && s.b[2618]) {s.store_scalar(339, 0.0);}
        ...
        if ((!s.b[2617]) && (!s.b[2619])) {s.store_exp(335, 334);s.store_div_from_scalar(337, 1.0, 192);s.store_scale(336, 337, (s.v[511] * (1.6021918e-19 * s.v[632])));}
        if (!s.b[2617]) {s.store_neg(206, 792);}
        s.b[2620] = (s.v[206] > 0.0);s.store_scalar(2620, if s.b[2620] { 1.0 } else { 0.0 });
        if ((!s.b[2617]) && s.b[2620]) {s.store_square(336, 206);s.store_mul(338, 336, 206);s.store_offset(334, 338, 0.5);s.store_div(339, 338, 334);s.store_div_square_rhs_mixed_ai(341, A::add_scaled_products(s.ad_value(336), s.ad_value(334), 3.0, s.ad_value(338), s.ad_value(336), (-3.0)), 334);}
        ...
        if (s.b[2625] && s.b[2629]) {s.store_scalar(2623, 1.0);s.store_scalar(2621, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);s.copy_ad(410, 687);s.store_scalar(413, s.v[188]);}
        s.b[2630] = (((((p[36] == 1.0) && (p[66] > 0.0)) && (s.v[460] > 0.0)) && (s.v[526] != 0.0)) && (p[55] != 1.0));s.store_scalar(2630, if s.b[2630] { 1.0 } else { 0.0 });
        if ((s.b[2626] && (!s.b[2625])) && s.b[2630]) {s.store_scalar(2623, 1.0);s.store_sub(395, 734, 735);s.store_neg(396, 735);}
        s.b[2631] = (((p[35] == 1.0) && (p[63] > 0.0)) && (s.v[459] > 0.0));s.store_scalar(2631, if s.b[2631] { 1.0 } else { 0.0 });
        if ((s.b[2627] && (!(s.b[2625] || s.b[2626]))) && s.b[2631]) {s.store_scalar(2623, 1.0);s.store_scalar(2624, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        ...
        if ((s.b[2628] && (!((s.b[2625] || s.b[2626]) || s.b[2627]))) && s.b[2636]) {s.store_scalar(2623, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_132(
        ...
        if (s.v[2623] != 0.0) {s.store_scalar(2644, 0.4);s.store_scalar(2645, 0.0);s.store_scalar(223, 0.0);s.store_scalar(214, 0.0);s.store_scalar(216, 0.0);s.store_scalar(232, 0.0);s.store_scalar(236, 0.0);s.store_scalar(233, 0.0);s.store_scalar(217, 0.0);s.store_scalar(420, 0.0);s.store_scalar(215, 0.0);s.store_scalar(447, 0.0);s.store_scalar(445, 0.0);s.store_scalar(446, 0.0);s.store_scalar(79, (-1.0));s.store_scalar(2646, 0.0);s.store_scalar(2647, 0.0);s.store_mul_scaled_ln_ad_rhs(2642, 155, 2.0, A::div(s.ad_value(409), s.ad_value(394)));s.store_offset_sub_from_scalar_ad(781, 0.8, s.ad_value(2642), (-0.1));s.store_scalar(782, ((4.0 * 0.8) * 0.1));}
        if (s.v[2623] != 0.0) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if (s.v[2623] != 0.0) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_offset_add_scaled_inputs_indices(2643, 781, (-0.5), 782, (-0.5), 0.8);}
        ...
        if (s.v[2623] != 0.0) {s.store_div(212, 410, 413);s.store_square(213, 212);s.store_sub_from_scalar(402, s.v[458], 395);s.store_sub_from_scalar(403, (10.0 * 2.220446049250313e-16), 397);s.store_scalar(2638, 0.0);s.store_primal_scale(2639, 409, 1.6021918e-19);s.store_div(334, 394, 409);s.store_square(405, 334);}
    ...
    pub(super) fn stamp_reactive_block_133(
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if (((s.v[2623] != 0.0) && (!s.b[2656])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
            t9 += 1;
        ...
        if (((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) {s.store_add_scaled_inputs3_indices(781, 402, 1.0, 397, 1.0, 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) && s.b[2659]) {s.store_scalar(720, 1.0);}
        s.b[2660] = (1.0 == 2.0);s.store_scalar(2660, if s.b[2660] { 1.0 } else { 0.0 });
        if ((((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) && (!s.b[2659])) && s.b[2660]) {s.store_scalar(720, 2.0);}
        s.b[2661] = (1.0 == 4.0);s.store_scalar(2661, if s.b[2661] { 1.0 } else { 0.0 });
        if (((((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) && (!s.b[2659])) && (!s.b[2660])) && s.b[2661]) {s.store_scalar(720, 3.0);}
        s.b[2662] = (1.0 == 8.0);s.store_scalar(2662, if s.b[2662] { 1.0 } else { 0.0 });
        if ((((((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) && (!s.b[2659])) && (!s.b[2660])) && (!s.b[2661])) && s.b[2662]) {s.store_scalar(720, 4.0);}
        if ((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) {s.store_scalar(719, 0.0);}
        let mut tb: usize = 0;
        while {
            let ta: f64 = if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
            ...
            if ((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2657]) && s.b[2658]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        s.b[2663] = (s.v[402] < s.v[403]);s.store_scalar(2663, if s.b[2663] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_134(
        ...
        if ((s.v[2623] != 0.0) && s.b[2663]) {s.store_sub(336, 402, 404);s.store_mul(398, 413, 336);s.copy_ad(354, 398);s.copy_ad(2646, 404);}
    ...
    pub(super) fn stamp_reactive_block_135(
        ...
        if (((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) {s.store_add_scaled_inputs3_indices(781, 445, 1.0, 446, (-1.0), 446, 0.2);s.store_square(722, 781);s.store_scaled_mul(723, 446, 446, (0.2 * 0.2));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if (((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) && s.b[2672]) {s.store_scalar(720, 1.0);}
        s.b[2673] = (2.0 == 2.0);s.store_scalar(2673, if s.b[2673] { 1.0 } else { 0.0 });
        if ((((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) && (!s.b[2672])) && s.b[2673]) {s.store_scalar(720, 2.0);}
        s.b[2674] = (2.0 == 4.0);s.store_scalar(2674, if s.b[2674] { 1.0 } else { 0.0 });
        if (((((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) && (!s.b[2672])) && (!s.b[2673])) && s.b[2674]) {s.store_scalar(720, 3.0);}
        s.b[2675] = (2.0 == 8.0);s.store_scalar(2675, if s.b[2675] { 1.0 } else { 0.0 });
        if ((((((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) && (!s.b[2672])) && (!s.b[2673])) && (!s.b[2674])) && s.b[2675]) {s.store_scalar(720, 4.0);}
        if ((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) {s.store_scalar(719, 0.0);}
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
            ...
            if ((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2667]) && s.b[2669]) && s.b[2670]) && s.b[2671]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_136(
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2676]) && (!s.b[2677])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p[137]), 782, 0.5);}
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2676]) && s.b[2681]) {s.store_primal_offset(2645, 2645, 1.0);s.copy_ad(116, 447);}
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2685]) && s.b[2686]) {s.store_add_scaled_inputs3_indices(781, 2683, 1.0, 386, (-1.0), 386, 0.1);s.store_square(722, 781);s.store_scaled_mul(723, 386, 386, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_137(
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2685]) && s.b[2686]) {s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if ((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2685]) && s.b[2686]) && s.b[2687]) && s.b[2688]) {s.store_scalar(720, 1.0);}
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if ((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2685]) && s.b[2686]) && s.b[2687]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2694]) && s.b[2695]) && s.b[2696]) && s.b[2697]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
            t11 += 1;
    ...
    pub(super) fn stamp_reactive_block_138(
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2702]) {s.store_scalar(79, 0.0);s.store_sqrt_scaled_input_ad(982, A::mul(A::div_from_scalar(1.034943e-10, s.ad_value(2639)), s.ad_value(155)), 2.0);}
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2702]) && (!s.b[2703])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p[137]), 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_139(
        ...
        let mut t14: usize = 0;
        while {
            let t12: f64 = (s.v[421] + 1.0);let t13: f64 = if ((((s.v[2623] != 0.0) && (!s.b[2663])) && s.b[2702]) && (s.v[97] <= t12)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
            t14 += 1;
    ...
    pub(super) fn stamp_reactive_block_140(
        ...
        if (((s.v[2623] != 0.0) && s.b[2720]) && (!s.b[2721])) {s.store_sqrt_offset_square_offset(782, 729, p[137], ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p[137], s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p[137]), 782, 0.5);}
