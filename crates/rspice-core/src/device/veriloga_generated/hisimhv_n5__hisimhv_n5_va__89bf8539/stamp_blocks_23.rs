...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_149(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[421] + 1.0);let t1: f64 = if (((s.v[2623] != 0.0) && s.b[2841]) && (s.v[97] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_150(
        ...
        if (s.b[2867] && s.b[2871]) {s.store_scalar(2623, 1.0);s.store_scalar(2621, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p.p66);s.store_scalar(411, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_151(
        ...
        s.b[2872] = (((((p.p36 == 1.0) && (p.p66 > 0.0)) && (s.v[460] > 0.0)) && (s.v[526] != 0.0)) && (p.p55 != 1.0));s.store_scalar(2872, if s.b[2872] { 1.0 } else { 0.0 });
        if ((s.b[2868] && (!s.b[2867])) && s.b[2872]) {s.store_scalar(2623, 1.0);s.store_sub(395, 734, 735);s.store_neg(396, 735);}
        s.b[2873] = (((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] > 0.0));s.store_scalar(2873, if s.b[2873] { 1.0 } else { 0.0 });
        if ((s.b[2869] && (!(s.b[2867] || s.b[2868]))) && s.b[2873]) {s.store_scalar(2623, 1.0);s.store_scalar(2624, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p.p63 + (p.p64 * p.p55)));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        s.b[2874] = (((s.v[407] < 0.0) && (p.p432 > 0.0)) && (p.p55 == 1.0));s.store_scalar(2874, if s.b[2874] { 1.0 } else { 0.0 });
        if (((s.b[2869] && (!(s.b[2867] || s.b[2868]))) && s.b[2873]) && s.b[2874]) {s.store_neg(407, 407);s.store_scalar(335, p.p63);s.store_offset_div_scaled_product_indices(996, 335, 335, 1.0, 651, 1.0, (-p.p137));}
        s.b[2875] = (p.p113 > 0.0);s.store_scalar(2875, if s.b[2875] { 1.0 } else { 0.0 });s.b[2876] = ((s.v[396] == 0.0) || (p.p113 <= 0.0));s.store_scalar(2876, if s.b[2876] { 1.0 } else { 0.0 });
        ...
        if (((((s.b[2869] && (!(s.b[2867] || s.b[2868]))) && s.b[2873]) && s.b[2874]) && s.b[2875]) && (!s.b[2876])) {s.store_mul(784, 783, 396);s.store_offset_powf_ad(781, A::div(s.ad_value(784), s.ad_value(996)), p.p113, 1.0);s.store_powf(782, 781, (1.0 / p.p113));s.store_div_scaled_product_indices(396, 783, 784, 1.0, 782, 1.0);}
        if ((((s.b[2869] && (!(s.b[2867] || s.b[2868]))) && s.b[2873]) && s.b[2874]) && s.b[2875]) {s.store_sqrt_offset_square_offset(782, 396, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(396), p.p137), 782, 0.5);}
        ...
        if ((((s.b[2869] && (!(s.b[2867] || s.b[2868]))) && s.b[2873]) && s.b[2874]) && s.b[2875]) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub(407, 407, 600);}
        s.b[2878] = (((((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] > 0.0)) && (s.v[526] != 0.0)) && (p.p55 != 1.0));s.store_scalar(2878, if s.b[2878] { 1.0 } else { 0.0 });
        ...
        if ((s.v[2623] != 0.0) && s.b[2892]) {s.store_scalar(2885, p.p338);}
        s.b[2893] = param_given[339];s.store_scalar(2893, if s.b[2893] { 1.0 } else { 0.0 });
        if ((s.v[2623] != 0.0) && s.b[2893]) {s.store_scalar(2886, p.p339);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_152(
        ...
        s.b[2896] = (p.p38 == 1.0);s.store_scalar(2896, if s.b[2896] { 1.0 } else { 0.0 });
        ...
        let mut t4: usize = 0;
        while {
            let t3: f64 = if (((s.v[2623] != 0.0) && (!s.b[2898])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_153(
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2899]) && s.b[2900]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2908]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_154(
        ...
        s.b[2909] = (p.p33 > 0.0);s.store_scalar(2909, if s.b[2909] { 1.0 } else { 0.0 });
        ...
        s.b[2910] = (p.p33 == 2.0);s.store_scalar(2910, if s.b[2910] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2909]) {s.store_sub(444, 444, 447);s.store_add_scaled_inputs(444, 444, 1.0, 154, 0.1);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_155(
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2909]) {s.store_sub_ad(335, A::ln(A::add_scaled_square_product(s.ad_value(444), 1.0, s.ad_value(443), s.ad_value(334), 1.0)), A::ln(A::mul(s.ad_value(405), s.ad_value(334))));s.store_add_scaled_product_indices(446, 335, 1.0, 154, 397, 1.0);}
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2909]) {
            if (s.v[446] >= 0.0) {
            } else {
        ...
        s.b[2911] = (p.p33 == 2.0);s.store_scalar(2911, if s.b[2911] { 1.0 } else { 0.0 });s.b[2912] = ((s.v[445] > (s.v[446] - (0.2 * s.v[446]))) && ((0.2 * s.v[446]) >= 0.0));s.store_scalar(2912, if s.b[2912] { 1.0 } else { 0.0 });
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2909]) && s.b[2911]) && s.b[2912]) && s.b[2913]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
        ...
        s.b[2918] = (p.p33 == 1.0);s.store_scalar(2918, if s.b[2918] { 1.0 } else { 0.0 });
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) && s.b[2919]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) && (!s.b[2919])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) && (!s.b[2919])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
        s.b[2921] = (s.v[336] < 0.0);s.store_scalar(2921, if s.b[2921] { 1.0 } else { 0.0 });
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) && s.b[2921]) {s.store_scalar(336, 0.0);s.store_scalar(343, 0.0);}
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2918]) {s.copy_ad(386, 336);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_156(
        ...
        s.b[2927] = (p.p33 == 2.0);s.store_scalar(2927, if s.b[2927] { 1.0 } else { 0.0 });s.b[2928] = ((s.v[2925] > (s.v[386] - (s.v[386] * 0.1))) && ((s.v[386] * 0.1) >= 0.0));s.store_scalar(2928, if s.b[2928] { 1.0 } else { 0.0 });
        ...
        let mut ta: usize = 0;
        while {
            let t9: f64 = if ((((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2927]) && s.b[2928]) && s.b[2929]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_157(
        ...
        s.b[2937] = (p.p33 == 2.0);s.store_scalar(2937, if s.b[2937] { 1.0 } else { 0.0 });s.b[2938] = ((s.v[404] > (s.v[2926] - 0.1)) && (0.1 >= 0.0));s.store_scalar(2938, if s.b[2938] { 1.0 } else { 0.0 });
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2936]) && s.b[2937]) && s.b[2938]) && s.b[2939]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
        ...
        s.b[2944] = (p.p33 == 1.0);s.store_scalar(2944, if s.b[2944] { 1.0 } else { 0.0 });
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2944]) && s.b[2945]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2944]) && (!s.b[2945])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2944]) && (!s.b[2945])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if (((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2944]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_159(
        ...
        let mut tf: usize = 0;
        while {
            let td: f64 = (s.v[421] + 1.0);let te: f64 = if ((((s.v[2623] != 0.0) && (!s.b[2905])) && s.b[2944]) && (s.v[97] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_160(
        ...
        s.b[2962] = (p.p33 == 4.0);s.store_scalar(2962, if s.b[2962] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2623] != 0.0) && s.b[2962]) && s.b[2963]) {s.store_sub_from_scalar(336, p.p334, 411);}
        if (((s.v[2623] != 0.0) && s.b[2962]) && (!s.b[2963])) {s.store_sqrt_offset_square_offset(782, 729, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(729), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(729), p.p137), 782, 0.5);}
        ...
        if (((s.v[2623] != 0.0) && s.b[2962]) && (!s.b[2963])) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub_from_scalar(336, p.p334, 600);}
        if ((s.v[2623] != 0.0) && s.b[2962]) {s.store_sqrt_square_offset(782, 336, ((4.0 * (p.p334 * 0.01)) * (p.p334 * 0.01)));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_161(
        ...
        let mut t12: usize = 0;
        while {
            let t10: f64 = (s.v[421] + 1.0);let t11: f64 = if (((s.v[2623] != 0.0) && s.b[2962]) && (s.v[97] <= t10)) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_162(
        ...
        s.b[2978] = (p.p55 == 0.0);s.store_scalar(2978, if s.b[2978] { 1.0 } else { 0.0 });s.b[2979] = (p.p50 == 0.0);s.store_scalar(2979, if s.b[2979] { 1.0 } else { 0.0 });
        ...
        if (((s.v[2623] != 0.0) && s.b[2977]) && s.b[2978]) {s.store_sqrt_offset_square_offset(782, 2882, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(2882), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(2882), p.p137), 782, 0.5);}
        ...
        if (((s.v[2623] != 0.0) && s.b[2977]) && s.b[2978]) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_add_scaled_inputs3_indices(781, 407, 1.0, 600, (-1.0), 407, (-0.1));s.store_scaled_mul(782, 407, 407, (4.0 * 0.1));}
        ...
        s.b[2981] = (3.0 == 1.0);s.store_scalar(2981, if s.b[2981] { 1.0 } else { 0.0 });s.b[2982] = (3.0 == 2.0);s.store_scalar(2982, if s.b[2982] { 1.0 } else { 0.0 });s.b[2983] = (3.0 == 3.0);s.store_scalar(2983, if s.b[2983] { 1.0 } else { 0.0 });s.b[2984] = (3.0 == 4.0);s.store_scalar(2984, if s.b[2984] { 1.0 } else { 0.0 });s.b[2985] = (p.p55 == 1.0);s.store_scalar(2985, if s.b[2985] { 1.0 } else { 0.0 });
        ...
        s.b[2986] = (p.p55 == 1.0);s.store_scalar(2986, if s.b[2986] { 1.0 } else { 0.0 });
        ...
        s.b[2987] = (p.p430 == 0.0);s.store_scalar(2987, if s.b[2987] { 1.0 } else { 0.0 });
        ...
        s.store_scalar(2623, 0.0);s.b[2988] = (4.0 == 1.0);s.store_scalar(2988, if s.b[2988] { 1.0 } else { 0.0 });s.b[2989] = (4.0 == 2.0);s.store_scalar(2989, if s.b[2989] { 1.0 } else { 0.0 });s.b[2990] = (4.0 == 3.0);s.store_scalar(2990, if s.b[2990] { 1.0 } else { 0.0 });s.b[2991] = (4.0 == 4.0);s.store_scalar(2991, if s.b[2991] { 1.0 } else { 0.0 });s.b[2992] = (((p.p36 == 1.0) && (p.p66 > 0.0)) && (s.v[460] > 0.0));s.store_scalar(2992, if s.b[2992] { 1.0 } else { 0.0 });
        if (s.b[2988] && s.b[2992]) {s.store_scalar(2623, 1.0);s.store_scalar(2621, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p.p66);s.store_scalar(411, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_163(
        ...
        s.b[2993] = (((((p.p36 == 1.0) && (p.p66 > 0.0)) && (s.v[460] > 0.0)) && (s.v[526] != 0.0)) && (p.p55 != 1.0));s.store_scalar(2993, if s.b[2993] { 1.0 } else { 0.0 });
        if ((s.b[2989] && (!s.b[2988])) && s.b[2993]) {s.store_scalar(2623, 1.0);s.store_sub(395, 734, 735);s.store_neg(396, 735);}
        s.b[2994] = (((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] > 0.0));s.store_scalar(2994, if s.b[2994] { 1.0 } else { 0.0 });
        if ((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) {s.store_scalar(2623, 1.0);s.store_scalar(2624, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p.p63 + (p.p64 * p.p55)));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
        s.b[2995] = (((s.v[407] < 0.0) && (p.p432 > 0.0)) && (p.p55 == 1.0));s.store_scalar(2995, if s.b[2995] { 1.0 } else { 0.0 });
        if (((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) && s.b[2995]) {s.store_neg(407, 407);s.store_scalar(335, p.p63);s.store_offset_div_scaled_product_indices(996, 335, 335, 1.0, 651, 1.0, (-p.p137));}
        s.b[2996] = (p.p113 > 0.0);s.store_scalar(2996, if s.b[2996] { 1.0 } else { 0.0 });s.b[2997] = ((s.v[396] == 0.0) || (p.p113 <= 0.0));s.store_scalar(2997, if s.b[2997] { 1.0 } else { 0.0 });
        ...
        if (((((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) && s.b[2995]) && s.b[2996]) && (!s.b[2997])) {s.store_mul(784, 783, 396);s.store_offset_powf_ad(781, A::div(s.ad_value(784), s.ad_value(996)), p.p113, 1.0);s.store_powf(782, 781, (1.0 / p.p113));s.store_div_scaled_product_indices(396, 783, 784, 1.0, 782, 1.0);}
        if ((((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) && s.b[2995]) && s.b[2996]) {s.store_sqrt_offset_square_offset(782, 396, p.p137, ((4.0 * 0.1) * 0.1));s.store_scaled_offset_ad(343, A::div_scaled_offset_numerator(s.ad_value(396), 1.0, p.p137, s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(336, A::offset(s.ad_value(396), p.p137), 782, 0.5);}
        ...
        if ((((s.b[2990] && (!(s.b[2988] || s.b[2989]))) && s.b[2994]) && s.b[2995]) && s.b[2996]) {s.store_scaled_sqrt_mul(600, 651, 336, p.p432);s.store_sub(407, 407, 600);}
        s.b[2999] = (((((p.p35 == 1.0) && (p.p63 > 0.0)) && (s.v[459] > 0.0)) && (s.v[526] != 0.0)) && (p.p55 != 1.0));s.store_scalar(2999, if s.b[2999] { 1.0 } else { 0.0 });
        ...
        if ((s.v[2623] != 0.0) && s.b[3013]) {s.store_scalar(3006, p.p338);}
        s.b[3014] = param_given[339];s.store_scalar(3014, if s.b[3014] { 1.0 } else { 0.0 });
        if ((s.v[2623] != 0.0) && s.b[3014]) {s.store_scalar(3007, p.p339);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_164(
        ...
        s.b[3017] = (p.p38 == 1.0);s.store_scalar(3017, if s.b[3017] { 1.0 } else { 0.0 });
        ...
        let mut t14: usize = 0;
        while {
            let t13: f64 = if (((s.v[2623] != 0.0) && (!s.b[3019])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
