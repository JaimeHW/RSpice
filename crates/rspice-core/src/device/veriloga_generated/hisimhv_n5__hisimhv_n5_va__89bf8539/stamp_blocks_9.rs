...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_46(
        ...
        if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2250])) && s.b[2275]) {
            s.store_offset_sub_ad(338, A::offset(A::exp(A::mul(s.ad_value(154), s.ad_value(336))), (-1.0)), A::mul(s.ad_value(154), s.ad_value(336)), 1e-15);
            s.store_mul_scaled_ad_rhs(2117, 209, -1.0, A::sqrt(s.ad_value(338)));
        }
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
            s.store_offset_sub_ad(338, A::offset(A::exp(A::mul(s.ad_value(154), s.ad_value(336))), (-1.0)), A::mul(s.ad_value(154), s.ad_value(336)), 1e-15);
            s.store_mul_scaled_ad_rhs(2118, 209, -1.0, A::sqrt(s.ad_value(338)));
            s.store_sqrt_offset_ad(782, A::mul(A::neg(A::add(s.ad_value(2117), s.ad_value(2116))), A::neg(A::add(s.ad_value(2117), s.ad_value(2116)))), ((4.0 * (1e-12 * 1e-6)) * (1e-12 * 1e-6)));
            s.store_scaled_offset_ad(335, A::div(A::neg(A::add(s.ad_value(2117), s.ad_value(2116))), s.ad_value(782)), 1.0, 0.5);
            s.store_scaled_add_ad_lhs(2119, A::neg(A::add(s.ad_value(2117), s.ad_value(2116))), 782, 0.5);
        }
        ...
        if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
            ...
            s.store_mul_ad_affine_product_lhs(248, A::neg(s.ad_value(154)), s.ad_value(2119), 0.5, 0.0, 94);
        ...
        if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2295])) && s.b[2302]) {
            s.store_div_from_scalar(726, 1.0, 726);
            s.store_mul_ad_product_lhs(780, s.ad_value(781), A::sub_from_scalar(0.8, s.ad_value(2115)), 726);
        ...
        if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2295])) && s.b[2308]) {
            s.store_offset_sub_ad(781, s.ad_value(168), A::offset(A::add(s.ad_value(109), s.ad_value(790)), (-(10.0 * 2.220446049250313e-16))), (10.0 * 2.220446049250313e-16));
            s.store_square(722, 781);
            s.store_scalar(723, ((10.0 * 2.220446049250313e-16) * (10.0 * 2.220446049250313e-16)));
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
    ...
    pub(super) fn stamp_reactive_block_49(
        ...
        while {
            ...
            if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2326])) && (!s.b[2328])) {
                ...
                s.store_mul_sqrt_ad_rhs(2320, 209, A::offset(A::add(A::sub(A::offset(s.ad_value(336), (-1.0)), s.ad_value(335)), A::mul(s.ad_value(210), A::sub(s.ad_value(337), s.ad_value(338)))), 1e-15));
                s.store_div_ad_lhs(339, A::mul(A::scale(s.ad_value(209), 0.5), s.ad_value(209)), 2320);
                s.store_mul_add_ad_rhs(2123, 339, A::sub(A::mul(s.ad_value(154), s.ad_value(336)), s.ad_value(154)), A::mul(s.ad_value(210), A::mul(A::neg(s.ad_value(154)), s.ad_value(337))));
            }
        ...
        if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2326])) {
            ...
            s.store_mul_sqrt_ad_rhs(334, 2150, A::mul(A::scale(s.ad_value(154), 2.0), s.ad_value(2318)));
    ...
    pub(super) fn stamp_reactive_block_50(
        ...
        if ((((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2326])) && (!s.b[2351])) && (!s.b[2352])) {
            ...
            s.store_sqrt_mul_ad(2145, A::mul(s.ad_value(2134), s.ad_value(155)), A::offset(A::sub(A::exp(s.ad_value(337)), s.ad_value(337)), (-1.0)));
        }
    ...
    pub(super) fn stamp_reactive_block_52(
        ...
        while {
            ...
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2393])) {
                ...
                s.store_exp(336, 335);
                s.store_sqrt_div_ad(338, A::scale(s.ad_value(2112), 2.0), s.ad_value(154));
    ...
    pub(super) fn stamp_reactive_block_53(
        ...
        if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2420])) {
            s.store_scaled_div(2152, 2122, 339, 9662367879.197212);
        }
        ...
        if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
            ...
            s.store_mul_ad_affine_product_rhs(2130, 964, A::scale(s.ad_value(2113), p.p400), A::sub_from_scalar(1.0, A::div_from_scalar(1.0, A::offset(A::div(A::mul(s.ad_value(254), s.ad_value(2113)), s.ad_value(973)), 1.0))), 1.0, 1.0);
            ...
            s.store_mul_ad_product_lhs(987, A::scale(s.ad_value(335), s.v[632]), s.ad_value(985), 2113);
        ...
        if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
            s.copy_ad(134, 135);
            s.store_scaled_sub_ad_lhs(131, A::add(A::sub(s.ad_value(2096), s.ad_value(2120)), s.ad_value(2097)), 2121, (-0.5));
    ...
    pub(super) fn stamp_reactive_block_54(
        ...
        if ((!s.b[1441]) && s.b[2428]) {
            s.store_offset_div_ad(332, A::scale(A::offset(A::mul(s.ad_value(154), A::sub(s.ad_value(85), s.ad_value(1433))), (-1.0)), 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_57(
        ...
        if ((!s.b[1441]) && s.b[2428]) {
            ...
            s.store_div(337, 339, 338);
            s.store_mul_offset_ad_rhs(251, 337, A::scale(s.ad_value(1436), p.p166), 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_59(
        ...
        if ((!s.b[1441]) && s.b[2517]) {
            ...
            s.store_offset_sub_ad(2523, A::add(A::offset(s.ad_value(791), (-s.v[160])), s.ad_value(120)), s.ad_value(182), (-p.p455));
            ...
            s.store_scaled_add_ad_lhs(2534, A::sub(s.ad_value(960), s.ad_value(1433)), 781, 0.5);
            s.store_sqrt_div_ad(2518, A::scale(A::mul(A::scale(s.ad_value(2534), ((2.0 * 1.6021918e-19) * 9662367879.197212)), s.ad_value(586)), s.v[489]), A::offset(s.ad_value(586), s.v[489]));
        ...
        if (((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) {
            s.copy_ad(2537, 993);
            s.copy_ad(2538, 2524);
            s.store_offset_div_ad(332, A::scale(A::offset(A::mul(s.ad_value(154), A::sub(s.ad_value(2523), s.ad_value(2537))), (-1.0)), 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0);
        }
    ...
    pub(super) fn stamp_reactive_block_60(
        ...
        if ((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) {
            s.copy_ad(88, 2521);
            s.copy_ad(2543, 993);
            s.store_offset_add_ad(86, A::add(A::sub_from_scalar(s.v[160], s.ad_value(120)), s.ad_value(182)), s.ad_value(2543), p.p455);
        }
        ...
        if (((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && (!s.b[2552])) {
            ...
            s.store_sqrt_mul_ad(334, A::scale(s.ad_value(154), 2.0), s.ad_value(2545));
        ...
        while {
            ...
            if ((((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && (!s.b[2552])) && s.b[2555]) {
                s.store_sqrt_scaled_ad(334, A::sub_from_scalar(1.0, A::square(s.ad_value(2550))), 0.5);
            ...
            if (((((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && (!s.b[2552])) && (!s.b[2555])) && s.b[2557]) {
                ...
                s.store_mul_sub_from_scalar_ad_rhs(337, 2548, 1.0, A::mul(A::scale(s.ad_value(2548), 0.5), A::sub_from_scalar(1.0, A::mul(A::scale(s.ad_value(2548), 0.3333333333333333), A::sub_from_scalar(1.0, A::scale(s.ad_value(2548), 0.25))))));
            ...
            if (((((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && (!s.b[2552])) && (!s.b[2555])) && (!s.b[2557])) {
                ...
                s.store_sqrt_add_ad(223, A::sub(s.ad_value(116), s.ad_value(2548)), A::sub(s.ad_value(334), s.ad_value(335)));
        ...
        if ((((!s.b[1441]) && s.b[2517]) && (!s.b[2564])) && (!s.b[2565])) {
            s.store_mul_scaled_ad_rhs(2535, 339, (-0.7071067811865475), A::sqrt(A::offset(A::mul(A::scale(s.ad_value(2533), 0.3333333333333333), A::offset(A::scale(s.ad_value(2533), 0.25), 1.0)), 1.0)));
        }

        if ((!s.b[1441]) && s.b[2517]) {
            s.store_sqrt_square_offset(781, 2535, ((4.0 * 1e-6) * 1e-6));
            s.store_scaled_add(2530, 2535, 781, 0.5);
            s.store_scaled_div(2531, 2530, 586, (1.0 / (1.6021918e-19)));
            s.store_offset(335, 2531, (-p.p452));
            s.store_scale(2532, 2531, 0.01);
            s.store_sqrt_add_ad(781, A::square(s.ad_value(335)), A::mul(A::scale(s.ad_value(2532), 4.0), s.ad_value(2532)));
    ...
    pub(super) fn stamp_reactive_block_61(
        ...
        if ((!s.b[1441]) && s.b[2517]) {
            ...
            s.store_mul_scaled_ad_lhs(995, A::div(A::scale(s.ad_value(155), 2.0), s.ad_value(162)), 2528, p.p454);
