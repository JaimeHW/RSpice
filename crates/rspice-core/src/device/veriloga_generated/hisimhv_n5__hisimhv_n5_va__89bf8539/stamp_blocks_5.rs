...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_81(
        ...
        if (((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3039]) {
            s.copy_ad(386, 336);
            s.store_mul_scaled_ad_lhs(418, A::mul(s.ad_value(3002), s.ad_value(386)), 386, (0.5 * 9662367879.197212));
        ...
        if ((((s.v[2623] != 0.0) && (!s.b[3026])) && s.b[3048]) && s.b[3049]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(3046), s.ad_value(386)), 386, 0.1);
            s.store_square(722, 781);
    ...
    pub(super) fn stamp_transient_block_83(
        ...
        while {
            ...
            if (((s.v[2623] != 0.0) && s.b[3083]) && s.b[3089]) {
                ...
                s.store_mul_sub_ad_rhs(3011, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.v[2623] != 0.0) && s.b[3083]) && (!s.b[3089])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3010, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(3011, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
        ...
        if (((s.v[2623] != 0.0) && s.b[3098]) && s.b[3099]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(3003), p.p137), A::offset(s.ad_value(3003), p.p137)), ((4.0 * 0.1) * 0.1));
    ...
    pub(super) fn stamp_transient_block_85(
        ...
        if (((s.b[3109] && s.b[3110]) && (!s.b[3137])) && s.b[3150]) {
            s.copy_ad(386, 336);
            s.store_mul_scaled_ad_lhs(418, A::mul(s.ad_value(3113), s.ad_value(386)), 386, (0.5 * 9662367879.197212));
            s.store_sqrt_ad(334, A::mul_scaled_lhs(s.ad_value(154), 2.0, s.ad_value(418)));
            s.store_scaled_add_ad(335, A::limited_exp(s.ad_value(334)), A::limited_exp_scaled_input(s.ad_value(334), -1.0), 0.5);
            s.store_div_ad_lhs(419, A::ln(s.ad_value(335)), 418);
            s.store_add(414, 404, 397);
        ...
        if ((((s.b[3109] && s.b[3110]) && (!s.b[3137])) && s.b[3159]) && s.b[3160]) {
            s.store_add_scaled_ad_lhs(781, A::sub(s.ad_value(3157), s.ad_value(386)), 386, 0.1);
        }
    ...
    pub(super) fn stamp_transient_block_88(
        ...
        while {
            ...
            if (((s.b[3109] && s.b[3110]) && s.b[3194]) && s.b[3200]) {
                ...
                s.store_mul_sub_ad_rhs(3122, 154, s.ad_value(335), A::mul(s.ad_value(417), s.ad_value(337)));
            }
            if (((s.b[3109] && s.b[3110]) && s.b[3194]) && (!s.b[3200])) {
                s.store_exp_neg_input(334, 116);
                s.store_exp_neg_input(335, 415);
                s.store_add_ad(3121, A::sub(s.ad_value(116), s.ad_value(415)), A::sub(s.ad_value(334), s.ad_value(335)));
                s.store_mul_sub_ad_rhs(3122, 154, A::sub_from_scalar(1.0, s.ad_value(334)), A::mul(s.ad_value(417), A::sub_from_scalar(1.0, s.ad_value(335))));
            }
        ...
        if (((s.b[3109] && s.b[3110]) && s.b[3209]) && s.b[3210]) {
            s.store_sqrt_offset_ad(782, A::mul(A::offset(s.ad_value(3114), p.p137), A::offset(s.ad_value(3114), p.p137)), ((4.0 * 0.1) * 0.1));
    ...
    pub(super) fn stamp_transient_block_89(
        ...
        if ((!s.b[3228]) && s.b[3229]) {
            ...
            s.store_add_scaled_ad_lhs(335, A::add_scaled_inputs(s.ad_value(1437), s.v[172], s.ad_value(87), s.v[172]), 304, (1.0 - s.v[172]));
            s.store_mul_scale_ad_lhs(305, A::sub(A::add(s.ad_value(87), s.ad_value(1437)), s.ad_value(335)), (-1.0 / (p.p133)), 336);
        }
    ...
    pub(super) fn stamp_transient_block_92(
        ...
        if (s.b[3309] && s.b[3310]) {
            ...
            s.store_sub_ad(283, A::add_scaled_inputs(s.ad_value(1437), s.v[488], s.ad_value(109), 1.0), A::mul(s.ad_value(336), s.ad_value(282)));
    ...
    pub(super) fn stamp_transient_block_93(
        ...
        if s.b[3320] {
            ...
            s.store_scaled_add_ad_lhs(339, A::sub(s.ad_value(87), s.ad_value(1433)), 782, 0.5);
        }
        ...
        if s.b[3323] {
            let assign101510_ad_e153691: A = A::add(A::add(A::mul(A::mul(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 3.0, 1.0), 1.0, s.ad_value(334), 6.0), s.ad_value(316)), s.ad_value(316)), A::mul(A::mul(A::add_scaled_inputs(A::scale_offset(s.ad_value(125), 4.0, 3.0), 1.0, s.ad_value(334), 3.0), s.ad_value(316)), s.ad_value(253))), A::mul(A::mul(A::add(A::scale_offset(s.ad_value(125), 3.0, 6.0), s.ad_value(334)), s.ad_value(253)), s.ad_value(253)));
            s.store_div_ad(315, A::mul(A::mul(A::mul_scaled_lhs(s.ad_value(185), s.v[632], s.ad_value(127)), s.ad_value(253)), assign101510_ad_e153691), A::mul(A::mul(A::mul_scaled_lhs(s.ad_value(170), 15.0, A::offset(s.ad_value(125), 1.0)), s.ad_value(314)), s.ad_value(314)));
        }
    ...
    pub(super) fn stamp_transient_block_94(
        ...
        s.b[3348] = ((s.v[5] > p.p444) && (p.p30 != 0.0));
        s.v[3348] = if s.b[3348] { 1.0 } else { 0.0 };

        if ((s.b[3334] && (!s.b[3335])) && s.b[3348]) {
        ...
        if (s.b[3334] && (!s.b[3354])) {
            ...
            s.store_offset_mul_ad(335, s.ad_value(3351), A::sub_from_scalar(p.p410, A::scale(s.ad_value(3351), p.p411)), 1.0);
        ...
        if (s.b[3334] && (!s.b[3354])) {
            ...
            s.store_offset_mul_ad(3353, A::mul(s.ad_value(788), s.ad_value(786)), s.ad_value(652), 1e-25);
            s.copy_ad(594, 453);
    ...
    pub(super) fn stamp_transient_block_95(
        ...
        if (s.b[3334] && (!s.b[3354])) {
            ...
            s.store_mul_ad_product_lhs(739, A::mul(s.ad_value(335), s.ad_value(596)), s.ad_value(3352), 597);
        }
