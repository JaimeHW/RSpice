...
impl Instance {
    ...
    if (p.p40 != 0.0) {
        ...
        s.store_scalar(448, t12);s.store_scalar(450, p.p104);s.store_scalar(451, p.p294);s.store_scalar(452, p.p222);s.store_scalar(453, p.p420);s.store_scalar(365, 1.0);s.b[1006] = (s.v[452] < 0.0);s.store_scalar(1006, if s.b[1006] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        s.store_scalar(822, (((p.p515 + (p.p828 / s.v[774])) + (p.p843 / s.v[775])) + (p.p858 / s.v[776])));s.store_scalar(823, (((p.p516 + (p.p829 / s.v[774])) + (p.p844 / s.v[775])) + (p.p859 / s.v[776])));s.store_scalar(824, (((p.p517 + (p.p830 / s.v[774])) + (p.p845 / s.v[775])) + (p.p860 / s.v[776])));s.store_scalar(825, (((p.p519 + (p.p831 / s.v[774])) + (p.p846 / s.v[775])) + (p.p861 / s.v[776])));s.store_scalar(826, (((p.p536 + (p.p832 / s.v[774])) + (p.p847 / s.v[775])) + (p.p862 / s.v[776])));s.store_scalar(827, (((p.p538 + (p.p833 / s.v[774])) + (p.p848 / s.v[775])) + (p.p863 / s.v[776])));s.b[1183] = (s.v[963] != 0.0);s.store_scalar(1183, if s.b[1183] { 1.0 } else { 0.0 });
    ...
    if (!s.b[1244]) {
        ...
        s.store_scalar(449, t1);s.b[1245] = (s.v[449] == 1.0);s.store_scalar(1245, if s.b[1245] { 1.0 } else { 0.0 });
        let (t3,) = {
    if s.b[1245] {
        let (t2,) = {
            if (p.p19 > 0.0) {
    ...
    if s.b[1245] {
        ...
        s.store_scalar(76, t5);s.b[1246] = ((p.p17 == 0.0) || (p.p17 == 2.0));s.store_scalar(1246, if s.b[1246] { 1.0 } else { 0.0 });
        let (t6,) = {
    ...
    if (!s.b[1248]) {
        ...
        s.store_scalar(765, td);s.store_scalar(581, (s.v[580] * s.v[576]));s.store_scalar(777, (p.p289 * 1000000.0));s.store_scalar(616, (s.v[457] - (s.v[764] * (9.025e-5 + (s.v[764] * 1e-7)))));s.store_scalar(617, (8.8541878e-12 * p.p267));s.copy_ad(618, 452);s.b[1249] = (s.v[471] == 0.0);s.store_scalar(1249, if s.b[1249] { 1.0 } else { 0.0 });
        let (te,) = {
    if s.b[1249] {
        (0.0,)
    } else {
        ...
        if s.b[1249] {s.store_scalar(642, 0.0);}
        let (tf,) = {
    if (!s.b[1249]) {
        (1.0,)
    } else {
        ...
        if (!s.b[1249]) {s.store_scalar(642, ((((1.0 + (1.0 / s.v[576]))) as f64).powf(p.p153) * s.v[471]));}
        s.store_scalar(619, (1.0 + (((s.v[576]) as f64).powf(p.p229) * p.p230)));s.store_scalar(335, ((1.0 / (p.p118 + (0.5 * p.p0))) + (1.0 / (p.p119 + (0.5 * p.p0)))));s.store_scalar(589, (2.0 / s.v[335]));s.b[1250] = (((p.p8 > 0.0) && (p.p9 > 0.0)) && ((p.p7 == 1.0) || ((p.p7 > 1.0) && (p.p10 > 0.0))));s.store_scalar(1250, if s.b[1250] { 1.0 } else { 0.0 });
        if s.b[1250] {s.store_scalar(335, 0.0);s.store_scalar(721, 0.0);}
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (s.b[1250] && (s.v[721] < p.p7)) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
    ...
    pub(super) fn stamp_transient_block_10(
        ...
        if s.b[1267] {s.store_scalar(335, (p.p5 + (s.v[163] / (3.0 * p.p4))));s.store_scalar(336, (s.v[582] - p.p6));s.store_div_scaled_inputs_indices(643, 335, p.p132, 336, (p.p4 * p.p7));}
        s.b[1268] = (s.v[643] > 0.001);s.store_scalar(1268, if s.b[1268] { 1.0 } else { 0.0 });
        if (s.b[1267] && s.b[1268]) {s.store_div_from_scalar(643, s.v[365], 643);}
        if (s.b[1267] && (!s.b[1268])) {s.store_scalar(643, (s.v[365] * 1000.0));}
        if (!s.b[1267]) {s.store_scalar(643, (1.0 / p.p444));}
    ...
    pub(super) fn stamp_transient_block_11(
        ...
        if (!s.b[1271]) {s.store_primal_sqrt_square_offset(649, 451, (p.p419 * p.p419));s.store_scalar(614, ((((p.p419 * p.p419) + (p.p97 * p.p97))) as f64).sqrt());s.store_scalar(786, (1.0 + (p.p424 / ((s.v[580]) as f64).powf(p.p425))));s.store_scalar(652, (1.0 + (p.p426 / ((s.v[576]) as f64).powf(p.p427))));s.store_scalar(653, (1.0 + (p.p428 / ((s.v[576]) as f64).powf(p.p429))));s.store_scalar(654, 1.0);s.store_scalar(645, 0.0);s.store_scalar(646, 0.0);s.store_scalar(647, 0.0);}
        ...
        s.b[1278] = (p.p52 == 1.0);s.store_scalar(1278, if s.b[1278] { 1.0 } else { 0.0 });s.b[1279] = (p.p56 < 0.001);s.store_scalar(1279, if s.b[1279] { 1.0 } else { 0.0 });
        if (s.b[1278] && s.b[1279]) {s.store_scalar(655, (s.v[365] * 1000.0));}
        if (s.b[1278] && (!s.b[1279])) {s.store_scalar(655, (s.v[365] * (p.p277 + (1.0 / p.p56))));}
        s.b[1280] = (p.p58 < 0.001);s.store_scalar(1280, if s.b[1280] { 1.0 } else { 0.0 });
        if (s.b[1278] && s.b[1280]) {s.store_scalar(656, (s.v[365] * 1000.0));}
        if (s.b[1278] && (!s.b[1280])) {s.store_scalar(656, (s.v[365] * (p.p277 + (1.0 / p.p58))));}
        s.b[1281] = (p.p57 < 0.001);s.store_scalar(1281, if s.b[1281] { 1.0 } else { 0.0 });
        if (s.b[1278] && s.b[1281]) {s.store_scalar(657, (s.v[365] * 1000.0));}
        if (s.b[1278] && (!s.b[1281])) {s.store_scalar(657, (s.v[365] * (p.p277 + (1.0 / p.p57))));}
        if (!s.b[1278]) {s.store_scalar(655, (s.v[365] * 1000.0));s.copy_ad(656, 655);s.copy_ad(657, 655);}
    ...
    pub(super) fn stamp_transient_block_12(
        ...
        let ctx_temp = ctx.temperature();s.b[1286] = (s.v[658] < 0.1);s.store_scalar(1286, if s.b[1286] { 1.0 } else { 0.0 });
        ...
        if s.b[1287] {s.store_scalar(686, 0.0);s.store_scalar(687, 0.0);s.store_scalar(387, (ctx_temp + p.p11));s.copy_ad(388, 387);s.store_offset(387, 387, s.v[732]);s.store_offset(389, 388, (-s.v[764]));s.store_offset_square(390, 388, (-(s.v[764] * s.v[764])));s.store_offset(391, 387, (-s.v[764]));s.store_offset_square(392, 387, (-(s.v[764] * s.v[764])));s.store_scale(676, 387, 1.0 / (s.v[764]));s.store_ln(590, 676);s.store_sub_scaled_inputs_mixed_ai(393, A::sub_from_scalar(s.v[616], A::scale(s.ad_value(391), s.v[455])), 1.0, 392, s.v[456]);s.store_sqrt(677, 393);s.store_div_from_scalar(335, 1.0, 387);s.store_scalar(336, (1.0 / s.v[764]));s.store_add_scaled_inputs4_offset_mixed_iiaa(337, 335, p.p260, 336, (-p.p260), A::square(s.ad_value(335)), p.p261, A::square(s.ad_value(336)), (-p.p261), (s.v[616] + p.p259));s.store_sqrt(192, 337);s.store_mul(193, 337, 192);s.store_div_from_scalar_scaled_input(154, 1.6021918e-19, 387, 1.3806226e-23);s.store_div_from_scalar(155, 1.0, 154);s.store_square(156, 154);s.store_scalar(678, (1.6021918e-19 / (1.3806226e-23 * s.v[764])));s.store_scaled_mul_ad(394, A::exp_scaled_input(s.ad_value(590), 1.5), A::exp(A::add_scaled_product(s.ad_value(678), (s.v[616] / 2.0), s.ad_value(393), s.ad_value(154), (-1.0 / (2.0)))), 1.04e16);s.store_exp_scaled_input(335, 590, s.v[480]);s.store_div(679, 335, 573);}
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if (s.b[1287] && s.b[1288]) {s.store_div(977, 335, 971);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p.p379), p.p379));s.store_div(973, 973, 334);}
        ...
        if (s.b[1287] && (!s.b[1296])) {s.store_add_scaled_inputs_mixed_ai(682, A::scale_offset(s.ad_value(391), p.p324, 1.0), s.v[627], 392, (p.p325 * s.v[627]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_14(
        ...
        if (s.b[1287] && (!s.b[1296])) {s.store_add_scaled_inputs_mixed_ai(335, A::scale_offset(s.ad_value(391), p.p390, 1.0), 1.0, 392, p.p391);s.store_scale(688, 335, s.v[633]);s.store_scale(689, 335, s.v[634]);}
    ...
    pub(super) fn stamp_transient_block_15(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_div_from_scalar(342, (-p.p98), 336);s.store_offset_scaled(337, 342, (p.p63 * 1000000.0), ((1.0) + (p.p98)));s.store_offset_add_scaled_product_indices(781, 338, (-1.0), 337, 338, 1.0, (-0.01));s.store_scale(782, 338, (4.0 * 0.01));}
