...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_13(
        ...
        if (s.b[1287] && s.b[1288]) {s.store_div(977, 335, 971);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p[379]), p[379]));s.store_div(973, 973, 334);}
        ...
        if (s.b[1287] && (!s.b[1296])) {s.store_add_scaled_inputs_mixed_ai(682, A::scale_offset(s.ad_value(391), p[324], 1.0), s.v[627], 392, (p[325] * s.v[627]));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_14(
        ...
        if (s.b[1287] && (!s.b[1296])) {s.store_add_scaled_inputs_mixed_ai(335, A::scale_offset(s.ad_value(391), p[390], 1.0), 1.0, 392, p[391]);s.store_scale(688, 335, s.v[633]);s.store_scale(689, 335, s.v[634]);}
