...
impl Instance {
    ...
    if (((s.b[3334] && (!s.b[3354])) && s.b[3379]) && s.b[3380]) {
        ...
        while {
            let t3: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3379]) && s.b[3380]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
            t4 += 1;
    ...
    if ((((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) && s.b[3387]) {
        ...
        s.store_scalar(720, t7);s.b[3388] = (2.0 == 2.0);s.store_scalar(3388, if s.b[3388] { 1.0 } else { 0.0 });
        let (t8,) = {
    if (((((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) && (!s.b[3387])) && s.b[3388]) {
        ...
        s.store_scalar(720, t8);s.b[3389] = (2.0 == 4.0);s.store_scalar(3389, if s.b[3389] { 1.0 } else { 0.0 });
        let (t9,) = {
    if ((((((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) && (!s.b[3387])) && (!s.b[3388])) && s.b[3389]) {
        ...
        s.store_scalar(720, t9);s.b[3390] = (2.0 == 8.0);s.store_scalar(3390, if s.b[3390] { 1.0 } else { 0.0 });
        let (ta,) = {
    ...
    if (((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) {
        ...
        while {
            let te: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
