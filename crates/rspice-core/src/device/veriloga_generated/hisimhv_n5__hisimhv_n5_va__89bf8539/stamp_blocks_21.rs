...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_115(
        ...
        if ((((!s.b[1441]) && s.b[2428]) && s.b[2459]) && (!s.b[2460])) {s.store_div_from_scalar(335, 1.0, 339);s.store_scale(338, 335, 1.034943e-10);s.store_scalar(335, (1.0 - s.v[507]));s.store_add_scaled_inputs_product_indices(168, 790, s.v[507], 87, s.v[507], 335, 91, 1.0);}
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if (((((((!s.b[1441]) && s.b[2428]) && s.b[2459]) && (!s.b[2460])) && s.b[2467]) && s.b[2468]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
    ...
    pub(super) fn stamp_reactive_block_116(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if (((((!s.b[1441]) && s.b[2428]) && s.b[2459]) && s.b[2473]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
            t3 += 1;
    ...
    pub(super) fn stamp_reactive_block_117(
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if ((((((!s.b[1441]) && s.b[2428]) && s.b[2459]) && s.b[2478]) && s.b[2479]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
            t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_118(
        ...
        if ((!s.b[1441]) && s.b[2428]) {s.store_mul_scale_offset_indices(340, 338, 238, 1.0, 1e-25);s.store_mul_ad_product_lhs_mixed_ai(333, A::offset(s.ad_value(94), (10.0 * 2.220446049250313e-16)), 250, 335);s.store_div_scaled_inputs_indices(336, 257, 0.2, 254, 1.0);s.store_div_scaled_inputs_indices(337, 336, -1.0, 254, 1.0);s.store_sqrt_square_sum(255, 333, 336);s.store_div_from_scalar(338, 1.0, 255);s.store_mul(256, 254, 255);s.store_div(335, 256, 257);}
        ...
        if (((!s.b[1441]) && s.b[2428]) && s.b[2495]) {s.store_scale(335, 154, s.v[674]);s.store_mul(336, 185, 335);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_119(
        ...
        if (((!s.b[1441]) && s.b[2428]) && s.b[2495]) {s.store_mul(342, 336, 1437);}
        ...
        if (((!s.b[1441]) && s.b[2428]) && s.b[2501]) {s.store_sqrt_add_scaled_square_product(336, 335, 1.0, 334, 344, (4.0 * 0.005));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_120(
        s: &mut ReactiveScratch,
    ) {
        if (((!s.b[1441]) && s.b[2428]) && s.b[2501]) {s.store_sub_mixed_ai(337, A::add_scaled_inputs4_offset(s.ad_value(344), 1.0, s.ad_value(335), 0.5, s.ad_value(336), 0.5, s.ad_value(137), 1.0, (((-s.v[160])) + (s.v[498]))), 1436);s.store_offset_mul(338, 154, 337, (-1.0));s.store_div_from_scalar(339, 4.0, 143);s.store_offset_mul(335, 338, 339, 1.0);s.store_mul(340, 154, 339);s.store_mul(341, 338, 339);s.store_sqrt_square_offset(782, 335, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(336, 335, 782, 0.5, 0.5);s.store_scaled_add(335, 335, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_121(
        ...
        if (((!s.b[1441]) && s.b[2428]) && s.b[2501]) {s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if (((((!s.b[1441]) && s.b[2428]) && s.b[2501]) && s.b[2506]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
            t7 += 1;
    ...
    pub(super) fn stamp_reactive_block_122(
        ...
        if (((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) {s.copy_ad(2537, 993);s.copy_ad(2538, 2524);s.store_offset_div_scaled_offset_numerator(332, A::mul(s.ad_value(154), A::sub(s.ad_value(2523), s.ad_value(2537))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);}
    ...
    pub(super) fn stamp_reactive_block_123(
        ...
        if (((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && s.b[2552]) {s.store_mul3_affine_lhs(277, 279, 279, 8.0, 0.0, 279);s.store_offset(338, 332, (-2.0));s.store_scaled_mul(339, 333, 338, 9.0);s.store_sub_from_scalar(278, (7.0 * 1.414213562373095), 339);s.store_square(276, 278);}
    ...
    pub(super) fn stamp_reactive_block_124(
        ...
        let mut ta: usize = 0;
        while {
            let t8: f64 = (s.v[421] + 1.0);let t9: f64 = if ((((((!s.b[1441]) && s.b[2517]) && (!s.b[2536])) && s.b[2542]) && (!s.b[2552])) && (s.v[97] <= t8)) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    pub(super) fn stamp_reactive_block_125(
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((((!s.b[1441]) && s.b[2517]) && s.b[2566]) && s.b[2567]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
            tc += 1;
    ...
    pub(super) fn stamp_reactive_block_126(
        ...
        let mut te: usize = 0;
        while {
            let td: f64 = if ((s.b[2572] && s.b[2573]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            td != 0.0
        } {
            te += 1;
    ...
    pub(super) fn stamp_reactive_block_127(
        ...
        let mut t10: usize = 0;
        while {
            let tf: f64 = if (((((!s.b[2578]) && s.b[2579]) && s.b[2580]) && s.b[2581]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tf != 0.0
        } {
            t10 += 1;
    ...
    pub(super) fn stamp_reactive_block_128(
        ...
        let mut t12: usize = 0;
        while {
            let t11: f64 = if (((s.b[2593] && s.b[2594]) && s.b[2595]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
            t12 += 1;
