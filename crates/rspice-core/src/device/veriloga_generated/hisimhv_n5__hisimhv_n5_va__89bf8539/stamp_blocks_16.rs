...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_37(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[421] + 1.0);let t1: f64 = if ((((((s.b[1441] && s.b[1442]) && (!s.b[1576])) && (!s.b[1578])) && (!s.b[1579])) && s.b[1588]) && (s.v[97] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_38(
        ...
        let mut tb: usize = 0;
        while {
            let t9: f64 = (150.0 + 1.0);let ta: f64 = if ((s.b[1441] && s.b[1442]) && (s.v[97] <= t9)) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            ...
            let mut t6: usize = 0;
            while {
                let t5: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t5 != 0.0
            } {
            ...
            let mut t8: usize = 0;
            while {
                let t7: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t7 != 0.0
            } {
            ...
            let mut t4: usize = 0;
            while {
                let t3: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t3 != 0.0
            } {
    ...
    pub(super) fn stamp_reactive_block_39(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_40(
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
        ...
        if (((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) {s.store_sub_from_scalar(781, 0.1, 335);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_41(
        s: &mut ReactiveScratch,
    ) {
        if (((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) {s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
        ...
        let mut t13: usize = 0;
        while {
            let t12: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1635]) && s.b[1636]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t12 != 0.0
        } {
        ...
        if ((s.b[1441] && s.b[1442]) && s.b[1641]) {s.store_sub_from_scalar(781, 0.1, 335);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_42(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[1441] && s.b[1442]) && s.b[1641]) {s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t15: usize = 0;
        while {
            let t14: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t14 != 0.0
        } {
        ...
        let mut t17: usize = 0;
        while {
            let t16: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t16 != 0.0
        } {
        ...
        if ((s.b[1441] && s.b[1442]) && s.b[1653]) {s.store_sub_from_scalar(781, 0.05, 335);s.store_square(722, 781);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_43(
        s: &mut ReactiveScratch,
    ) {
        if ((s.b[1441] && s.b[1442]) && s.b[1653]) {s.store_scalar(723, (0.05 * 0.05));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t19: usize = 0;
        while {
            let t18: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t18 != 0.0
        } {
        ...
        let mut t1b: usize = 0;
        while {
            let t1a: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t1a != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_44(
        ...
        let mut t1d: usize = 0;
        while {
            let t1c: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t1c != 0.0
        } {
        ...
        let mut t1f: usize = 0;
        while {
            let t1e: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t1e != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_45(
        ...
        let mut t21: usize = 0;
        while {
            let t20: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t20 != 0.0
        } {
        ...
        if ((s.b[1441] && s.b[1442]) && s.b[1684]) {s.store_div_square_rhs(336, 1500, 185);s.store_add_scaled_inputs3_offset_indices(334, 85, 1.0, 155, (-1.0), 1436, -1.0, 2.0);s.store_offset_mul_ad(338, A::div_from_scalar(2.0, s.ad_value(336)), s.ad_value(334), 1.0);}
    ...
    pub(super) fn stamp_reactive_block_46(
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) {s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t23: usize = 0;
        while {
            let t22: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t22 != 0.0
        } {
        ...
        let mut t25: usize = 0;
        while {
            let t24: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1691]) && s.b[1692]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t24 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        let mut t27: usize = 0;
        while {
            let t26: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1697]) && s.b[1698]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1703]) {s.store_add_scaled_inputs3_indices(781, 348, 1.0, 1535, (-1.0), 335, 1.0);s.store_square(722, 781);s.store_square(723, 335);s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    pub(super) fn stamp_reactive_block_48(
        ...
        let mut t29: usize = 0;
        while {
            let t28: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1703]) && s.b[1704]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t28 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_49(
        ...
        let mut t30: usize = 0;
        while {
            let t2e: f64 = (150.0 + 1.0);let t2f: f64 = if ((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1710]) && (s.v[97] <= t2e)) { 1.0 } else { 0.0 };
            t2f != 0.0
        } {
            ...
            let mut t2b: usize = 0;
            while {
                let t2a: f64 = if ((((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1710]) && s.b[1711]) && s.b[1712]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t2a != 0.0
            } {
            ...
            let mut t2d: usize = 0;
            while {
                let t2c: f64 = if ((((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1710]) && s.b[1717]) && s.b[1718]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t2c != 0.0
            } {
    ...
    pub(super) fn stamp_reactive_block_51(
        ...
        let mut t33: usize = 0;
        while {
            let t31: f64 = (150.0 + 1.0);let t32: f64 = if (((((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && (!s.b[1729])) && (!s.b[1731])) && s.b[1732]) && s.b[1734]) && (s.v[97] <= t31)) { 1.0 } else { 0.0 };
            t32 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_52(
        ...
        let mut t3c: usize = 0;
        while {
            let t3a: f64 = (150.0 + 1.0);let t3b: f64 = if (((s.b[1441] && s.b[1442]) && (!s.b[1709])) && (s.v[97] <= t3a)) { 1.0 } else { 0.0 };
            t3b != 0.0
        } {
            ...
            let mut t37: usize = 0;
            while {
                let t36: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1741]) && s.b[1742]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t36 != 0.0
            } {
            ...
            let mut t39: usize = 0;
            while {
                let t38: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1747]) && s.b[1748]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t38 != 0.0
            } {
            ...
            let mut t35: usize = 0;
            while {
                let t34: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1709])) && s.b[1754]) && s.b[1755]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t34 != 0.0
            } {
