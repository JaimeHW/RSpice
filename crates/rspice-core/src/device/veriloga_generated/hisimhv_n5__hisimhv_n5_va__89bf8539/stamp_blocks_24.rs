...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_141(
        ...
        let mut t2: usize = 0;
        while {
            let t0: f64 = (s.v[421] + 1.0);let t1: f64 = if (((s.v[2623] != 0.0) && s.b[2720]) && (s.v[97] <= t0)) { 1.0 } else { 0.0 };
            t1 != 0.0
        } {
            t2 += 1;
    ...
    pub(super) fn stamp_reactive_block_142(
        ...
        if (s.b[2746] && s.b[2750]) {s.store_scalar(2623, 1.0);s.store_scalar(2621, 1.0);s.store_sub(395, 731, 728);s.store_neg(396, 728);s.store_scalar(409, s.v[460]);s.store_scalar(407, p[66]);s.store_scalar(411, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_143(
        ...
        if ((s.b[2748] && (!(s.b[2746] || s.b[2747]))) && s.b[2752]) {s.store_scalar(2623, 1.0);s.store_scalar(2624, 1.0);s.store_sub(395, 731, 728);s.store_sub(396, 729, 728);s.store_scalar(409, s.v[459]);s.store_scalar(407, (p[63] + (p[64] * p[55])));s.copy_ad(411, 384);s.copy_ad(410, 686);s.copy_ad(413, 412);s.store_neg(407, 407);}
    ...
    pub(super) fn stamp_reactive_block_144(
        ...
        let mut t4: usize = 0;
        while {
            let t3: f64 = if (((s.v[2623] != 0.0) && (!s.b[2777])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t3 != 0.0
        } {
            t4 += 1;
    ...
    pub(super) fn stamp_reactive_block_145(
        ...
        let mut t6: usize = 0;
        while {
            let t5: f64 = if (((((s.v[2623] != 0.0) && (s.v[406] != 0.0)) && s.b[2778]) && s.b[2779]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t5 != 0.0
        } {
            t6 += 1;
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2787]) {s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_146(
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2787]) {s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);s.store_exp_neg_input(333, 116);s.store_offset_div_scaled_inputs2_mixed_aia(332, A::offset(A::mul(s.ad_value(154), A::add(s.ad_value(402), s.ad_value(397))), (-1.0)), 4.0, 333, 4.0, A::mul(s.ad_value(213), s.ad_value(156)), 1.0, 1.0);s.store_add_product3_rhs_mixed_iia(89, 402, 213, 154, A::sub_from_scalar(1.0, A::sqrt(s.ad_value(332))), 1.0 / (2.0));s.store_mul_add_rhs(116, 154, 89, 397);}
        ...
        if (((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2788]) {s.store_sub(444, 444, 447);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_147(
        ...
        let mut t8: usize = 0;
        while {
            let t7: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2788]) && s.b[2790]) && s.b[2791]) && s.b[2792]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t7 != 0.0
        } {
            t8 += 1;
    ...
    pub(super) fn stamp_reactive_block_148(
        ...
        let mut ta: usize = 0;
        while {
            let t9: f64 = if ((((((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2806]) && s.b[2807]) && s.b[2808]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t9 != 0.0
        } {
            ta += 1;
    ...
    pub(super) fn stamp_reactive_block_149(
        ...
        let mut tc: usize = 0;
        while {
            let tb: f64 = if (((((((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2815]) && s.b[2816]) && s.b[2817]) && s.b[2818]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tb != 0.0
        } {
            tc += 1;
    ...
    pub(super) fn stamp_reactive_block_151(
        ...
        let mut tf: usize = 0;
        while {
            let td: f64 = (s.v[421] + 1.0);let te: f64 = if ((((s.v[2623] != 0.0) && (!s.b[2784])) && s.b[2823]) && (s.v[97] <= td)) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
    ...
    pub(super) fn stamp_reactive_block_153(
        ...
        let mut t12: usize = 0;
        while {
            let t10: f64 = (s.v[421] + 1.0);let t11: f64 = if (((s.v[2623] != 0.0) && s.b[2841]) && (s.v[97] <= t10)) { 1.0 } else { 0.0 };
            t11 != 0.0
        } {
            t12 += 1;
    ...
    pub(super) fn stamp_reactive_block_156(
        ...
        let mut t14: usize = 0;
        while {
            let t13: f64 = if (((s.v[2623] != 0.0) && (!s.b[2898])) && (s.v[781] >= 60.0)) { 1.0 } else { 0.0 };
            t13 != 0.0
        } {
            t14 += 1;
