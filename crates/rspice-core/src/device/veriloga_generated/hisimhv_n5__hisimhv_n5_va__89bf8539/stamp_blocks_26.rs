...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_202(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && (s.v[719] < p[442])) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
    ...
    pub(super) fn stamp_reactive_block_205(
        ...
        s.store_scalar(23, A::ddx_projection(&s.ad_value(18), Some(8), None));s.store_scale(23, 23, p[87]);s.b[3405] = (s.v[949] == 1.0);s.store_scalar(3405, if s.b[3405] { 1.0 } else { 0.0 });
