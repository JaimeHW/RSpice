...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_197(
        ...
        s.b[3326] = (((((p.p31 != 0.0) && (p.p30 != 0.0)) && (s.v[321] == 1.0)) && (s.v[78] == 0.0)) && (s.v[963] == 0.0));s.store_scalar(3326, if s.b[3326] { 1.0 } else { 0.0 });
        ...
        if ((p.p29 != 0.0) && s.b[3328]) {s.store_scalar(572, 0.0);s.store_scalar(334, 0.0);}
        if (p.p29 != 0.0) {s.store_voltage(817, ctx, nodes, Some(14), None);s.store_add_scaled_inputs3_indices(352, 352, 1.0, 816, -1.0, 817, 1.0);s.copy_ad(355, 817);}
        if (p.p29 == 0.0) {s.copy_ad(817, 816);}
        s.b[3329] = (p.p22 > 0.0);s.store_scalar(3329, if s.b[3329] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_198(
        ...
        s.store_scalar(713, 0.0);s.b[3332] = (((((p.p31 != 0.0) && (p.p30 != 0.0)) && (s.v[321] == 1.0)) && (s.v[78] == 0.0)) && (s.v[963] == 0.0));s.store_scalar(3332, if s.b[3332] { 1.0 } else { 0.0 });
        ...
        if s.b[3332] {s.store_mul3_affine_lhs(713, 328, 323, s.v[365], 0.0, 331);}
        if s.b[3332] {
            if (s.v[713] < 0.0) {
        ...
        s.store_scalar(716, 0.0);s.store_scalar(715, 0.0);s.b[3334] = (s.v[449] == 1.0);s.store_scalar(3334, if s.b[3334] { 1.0 } else { 0.0 });s.b[3335] = (s.v[76] == 0.0);s.store_scalar(3335, if s.b[3335] { 1.0 } else { 0.0 });s.b[3336] = ((p.p53 > 0.0) && (s.v[541] != 0.0));s.store_scalar(3336, if s.b[3336] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3334] && (!s.b[3335])) && s.b[3336]) {s.store_div_from_scalar(794, s.v[569], 335);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p.p418), p.p418));s.store_div_from_scalar(795, s.v[570], 334);s.store_add_mixed_ia(959, 959, A::scaled_offset(s.ad_value(387), (-s.v[764]), p.p439));}
        if ((s.b[3334] && (!s.b[3335])) && (!s.b[3336])) {s.store_scalar(387, (ctx_temp + p.p11));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_199(
        ...
        if (s.b[3334] && (!s.b[3335])) {s.store_scalar(164, (s.v[630] * p.p7));s.store_scalar(604, p.p71);s.store_scalar(605, s.v[460]);s.store_mul(606, 794, 653);s.store_offset_product3(607, s.ad_value(795), s.ad_value(786), s.ad_value(652), 1.0, 1e-25);s.store_div(608, 804, 604);s.store_mul(609, 606, 608);}
        ...
        if ((s.b[3334] && (!s.b[3335])) && s.b[3342]) {s.store_sub_from_scalar(781, 1e-25, 613);s.store_square(722, 781);s.store_scalar(723, (1e-25 * 1e-25));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        if ((((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) && s.b[3344]) {s.store_scalar(720, 1.0);}
        s.b[3345] = (2.0 == 2.0);s.store_scalar(3345, if s.b[3345] { 1.0 } else { 0.0 });
        if (((((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) && (!s.b[3344])) && s.b[3345]) {s.store_scalar(720, 2.0);}
        s.b[3346] = (2.0 == 4.0);s.store_scalar(3346, if s.b[3346] { 1.0 } else { 0.0 });
        if ((((((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) && (!s.b[3344])) && (!s.b[3345])) && s.b[3346]) {s.store_scalar(720, 3.0);}
        s.b[3347] = (2.0 == 8.0);s.store_scalar(3347, if s.b[3347] { 1.0 } else { 0.0 });
        if (((((((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) && (!s.b[3344])) && (!s.b[3345])) && (!s.b[3346])) && s.b[3347]) {s.store_scalar(720, 4.0);}
        if (((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) {s.store_scalar(719, 0.0);}
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;assert!(t1 <= Self::MAX_ANALOG_LOOP_ITERATIONS, "generated Verilog-A analog loop exceeded iteration guard");
            if (((s.b[3334] && (!s.b[3335])) && s.b[3342]) && s.b[3343]) {s.store_sqrt(726, 726);s.store_primal_offset(719, 719, 1.0);}
        }
        ...
        s.b[3349] = (s.v[5] < p.p444);s.store_scalar(3349, if s.b[3349] { 1.0 } else { 0.0 });
        if ((s.b[3334] && (!s.b[3335])) && s.b[3349]) {s.store_scalar(5, p.p444);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_200(
        ...
        s.b[3355] = ((p.p53 > 0.0) && (s.v[541] != 0.0));s.store_scalar(3355, if s.b[3355] { 1.0 } else { 0.0 });
        ...
        if ((s.b[3334] && (!s.b[3354])) && s.b[3355]) {s.store_div_from_scalar(787, s.v[567], 335);s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(676), 0.4, 1.8), 1.0, s.ad_value(676), s.ad_value(676), 0.1), A::scale_offset(s.ad_value(676), (-p.p417), p.p417));s.store_div_from_scalar(788, s.v[568], 334);s.store_add_mixed_ia(956, 956, A::scaled_offset(s.ad_value(387), (-s.v[764]), p.p438));}
        ...
        if ((s.b[3334] && (!s.b[3354])) && (!s.b[3355])) {s.store_scalar(387, (ctx_temp + p.p11));}
        if (s.b[3334] && (!s.b[3354])) {s.store_scalar(164, (s.v[630] * p.p7));s.store_scalar(785, (p.p67 + p.p68));s.store_primal_offset(789, 451, 1e-12);s.store_scalar(408, s.v[459]);s.store_offset_ad(335, A::mul_sub_from_scalar_rhs(s.ad_value(3351), p.p410, A::scale(s.ad_value(3351), p.p411)), 1.0);s.store_sqrt_square_offset(782, 335, ((4.0 * 0.1) * 0.1));s.store_offset_scaled_div(336, 335, 782, 0.5, 0.5);s.store_scaled_add(654, 335, 782, 0.5);}
        ...
        if (s.b[3334] && (!s.b[3354])) {s.store_mul3_lhs(593, 787, 653, 654);s.store_offset_product3(3353, s.ad_value(788), s.ad_value(786), s.ad_value(652), 1.0, 1e-25);s.copy_ad(594, 453);s.store_scalar(595, p.p421);s.store_scale(335, 593, 10000.0);s.store_scale(336, 3353, 100.0);}
        s.b[3361] = (s.v[799] < 0.0);s.store_scalar(3361, if s.b[3361] { 1.0 } else { 0.0 });
        if ((s.b[3334] && (!s.b[3354])) && s.b[3361]) {s.store_scale(781, 799, ((-0.5) * (2.0 * 1.0 / (p.p262))));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
        ...
        if ((s.b[3334] && (!s.b[3354])) && (!s.b[3361])) {s.store_scale(781, 799, (0.5 * (2.0 * 1.0 / (p.p262))));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_201(
        ...
        if ((s.b[3334] && (!s.b[3354])) && (!s.b[3361])) {s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
        ...
        s.b[3369] = ((p.p441 > 0.0) && (p.p440 > 1.0));s.store_scalar(3369, if s.b[3369] { 1.0 } else { 0.0 });s.b[3370] = ((s.v[597] > ((s.v[408] * p.p440) - (s.v[408] * p.p441))) && ((s.v[408] * p.p441) >= 0.0));s.store_scalar(3370, if s.b[3370] { 1.0 } else { 0.0 });
        if (((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) {s.store_add_scaled_inputs3_indices(781, 597, 1.0, 408, (-p.p440), 408, p.p441);s.store_square(722, 781);s.store_scaled_mul(723, 408, 408, (p.p441 * p.p441));s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_scalar(719, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_202(
        ...
        let mut t3: usize = 0;
        while {
            let t2: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && (s.v[719] < p.p442)) { 1.0 } else { 0.0 };
            t2 != 0.0
        } {
        ...
        s.b[3371] = ((((p.p442 == 1.0) || (p.p442 == 2.0)) || (p.p442 == 4.0)) || (p.p442 == 8.0));s.store_scalar(3371, if s.b[3371] { 1.0 } else { 0.0 });s.b[3372] = (p.p442 == 1.0);s.store_scalar(3372, if s.b[3372] { 1.0 } else { 0.0 });
        if (((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && s.b[3371]) && s.b[3372]) {s.store_scalar(720, 1.0);}
        s.b[3373] = (p.p442 == 2.0);s.store_scalar(3373, if s.b[3373] { 1.0 } else { 0.0 });
        if ((((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && s.b[3371]) && (!s.b[3372])) && s.b[3373]) {s.store_scalar(720, 2.0);}
        s.b[3374] = (p.p442 == 4.0);s.store_scalar(3374, if s.b[3374] { 1.0 } else { 0.0 });
        if (((((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && s.b[3371]) && (!s.b[3372])) && (!s.b[3373])) && s.b[3374]) {s.store_scalar(720, 3.0);}
        s.b[3375] = (p.p442 == 8.0);s.store_scalar(3375, if s.b[3375] { 1.0 } else { 0.0 });
        ...
        let mut t5: usize = 0;
        while {
            let t4: f64 = if (((((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) && s.b[3371]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t4 != 0.0
        } {
        ...
        if (((s.b[3334] && (!s.b[3354])) && s.b[3369]) && s.b[3370]) {s.store_div_from_scalar(726, 1.0, 726);s.store_mul3_affine_lhs(780, 781, 408, p.p441, 0.0, 726);s.store_div_scaled_product3_indices(334, 408, 725, 726, p.p441, 770, 1.0);s.store_add_scaled_inputs3_indices(336, 408, p.p440, 408, (-p.p441), 780, 1.0);}
        ...
        if (s.b[3334] && (!s.b[3354])) {s.store_offset(334, 334, (10.0 * 2.220446049250313e-16));s.store_sqrt_mul(599, 650, 334);s.store_offset_sub(336, 3350, 3351, p.p137);s.store_sqrt_square_offset(782, 336, ((4.0 * 0.01) * 0.01));s.store_offset_scaled_div(343, 336, 782, 0.5, 0.5);s.store_scaled_add(336, 336, 782, 0.5);}
    ...
    pub(super) fn stamp_reactive_block_203(
        ...
        if (s.b[3334] && (!s.b[3354])) {s.store_div_from_scalar_offset_input(335, 1.6021918e-19, 785, p.p422);s.store_mul_product3_indices(739, 597, 335, 596, 3352, 1.0);}
        ...
        let mut t7: usize = 0;
        while {
            let t6: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3379]) && s.b[3380]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t6 != 0.0
        } {
        ...
        let mut t9: usize = 0;
        while {
            let t8: f64 = if ((((s.b[3334] && (!s.b[3354])) && s.b[3385]) && s.b[3386]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8 != 0.0
        } {
        ...
        if ((s.b[3334] && (!s.b[3354])) && s.b[3385]) {s.store_div_from_scalar(726, 1.0, 726);s.store_scaled_mul(780, 781, 726, 1000.0);s.store_div_scaled_product_indices(334, 725, 726, 1000.0, 770, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_204(
        ...
        if ((s.b[3334] && (!s.b[3354])) && s.b[3385]) {s.store_offset(4, 780, (1000000.0 - 1000.0));}
        if ((s.b[3334] && (!s.b[3354])) && s.b[3385]) {
        }
        if ((s.b[3334] && (!s.b[3354])) && (!s.b[3385])) {
        }
        if ((s.b[3334] && (!s.b[3354])) && (!s.b[3385])) {s.store_scalar(334, 1.0);}
        s.b[3391] = ((p.p54 == 1.0) && ((s.v[459] * (s.v[544] + s.v[459])) > 0.0));s.store_scalar(3391, if s.b[3391] { 1.0 } else { 0.0 });
        if ((s.b[3334] && (!s.b[3354])) && s.b[3391]) {s.store_sub_from_scalar(385, p.p334, 384);s.store_div_scaled_inputs_indices(4, 4, s.v[165], 385, 1.0);}
        if (s.b[3334] && (!s.b[3354])) {s.store_add(4, 4, 644);}
        s.b[3393] = (s.v[4] < p.p444);s.store_scalar(3393, if s.b[3393] { 1.0 } else { 0.0 });
        if ((s.b[3334] && (!s.b[3354])) && s.b[3393]) {s.store_scalar(4, p.p444);}
        if (s.b[3334] && (!s.b[3354])) {s.store_scale(715, 4, 1.0 / (s.v[365]));}
        s.b[3394] = (s.v[4] < p.p444);s.store_scalar(3394, if s.b[3394] { 1.0 } else { 0.0 });
        if ((!s.b[3334]) && s.b[3394]) {s.store_scalar(4, p.p444);}
        s.b[3395] = (s.v[5] < p.p444);s.store_scalar(3395, if s.b[3395] { 1.0 } else { 0.0 });
        if ((!s.b[3334]) && s.b[3395]) {s.store_scalar(5, p.p444);}
        ...
        s.store_add(18, 18, 811);s.store_add(19, 19, 810);s.store_add(741, 741, 812);s.store_add_scaled_inputs3_indices(20, 18, (-1.0), 19, (-1.0), 741, (-1.0));s.copy_ad(299, 703);s.copy_ad(301, 704);s.copy_ad(742, 706);s.copy_ad(743, 705);s.store_add_scaled_inputs3_indices(744, 705, (-1.0), 706, (-1.0), 707, (-1.0));s.b[3398] = (p.p53 > 0.0);s.store_scalar(3398, if s.b[3398] { 1.0 } else { 0.0 });s.b[3399] = (s.v[766] > 0.0001);s.store_scalar(3399, if s.b[3399] { 1.0 } else { 0.0 });
        ...
        s.b[3402] = (p.p53 == 1.0);s.store_scalar(3402, if s.b[3402] { 1.0 } else { 0.0 });
        if (s.b[3398] && s.b[3402]) {s.store_scale(335, 740, p.p433);s.store_add_scaled_inputs3_indices(781, 335, 1.0, 746, (-1.0), 740, (-p.p337));s.store_scaled_mul(782, 335, 740, (4.0 * p.p337));}
    ...
    pub(super) fn stamp_reactive_block_205(
        ...
        s.store_scalar(23, A::ddx_projection(&s.ad_value(18), Some(8), None));s.store_scale(23, 23, p.p87);s.b[3405] = (s.v[949] == 1.0);s.store_scalar(3405, if s.b[3405] { 1.0 } else { 0.0 });
        if s.b[3405] {s.copy_ad(757, 23);}
        if (!s.b[3405]) {s.copy_ad(757, 22);}
        s.b[3407] = (p.p48 > 0.0);s.store_scalar(3407, if s.b[3407] { 1.0 } else { 0.0 });s.b[3411] = (p.p53 > 0.0);s.store_scalar(3411, if s.b[3411] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_equations_block_6(
        ...
        let eq11_e1090: f64 = (p.p87 * s.v[281]);let eq11_value: f64 = eq11_e1090;
        stamper.stamp_current_dense_local(
            Some(0),
            Some(9),
            ...
            &s.db[281],
            (multiplicity) * (p.p87),
        );let eq12_e1093: f64 = (p.p87 * s.v[737]);let eq12_value: f64 = eq12_e1093;
        stamper.stamp_current_dense_local(
            Some(2),
            Some(9),
            ...
            &s.db[737],
            (multiplicity) * (p.p87),
        );let eq13_e1096: f64 = (p.p87 * s.v[862]);let eq13_value: f64 = eq13_e1096;
        stamper.stamp_current_dense_local(
            Some(11),
            Some(2),
            ...
            &s.db[862],
            (multiplicity) * (p.p87),
        );let eq14_e1099: f64 = (p.p87 * s.v[861]);let eq14_value: f64 = eq14_e1099;
        stamper.stamp_current_dense_local(
            Some(10),
            Some(0),
            ...
            &s.db[861],
            (multiplicity) * (p.p87),
        );let eq15_e1102: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 3, s.v[66]);let eq15_e1103: f64 = (p.p87 * eq15_e1102);let eq15_e1103_d_n0: f64 = (p.p87 * (s.dn[66][0] * ddt_scale));let eq15_e1103_d_n1: f64 = (p.p87 * (s.dn[66][1] * ddt_scale));let eq15_e1103_d_n2: f64 = (p.p87 * (s.dn[66][2] * ddt_scale));let eq15_e1103_d_n3: f64 = (p.p87 * (s.dn[66][3] * ddt_scale));let eq15_e1103_d_n4: f64 = (p.p87 * (s.dn[66][4] * ddt_scale));let eq15_e1103_d_n5: f64 = (p.p87 * (s.dn[66][5] * ddt_scale));let eq15_e1103_d_n6: f64 = (p.p87 * (s.dn[66][6] * ddt_scale));let eq15_e1103_d_n7: f64 = (p.p87 * (s.dn[66][7] * ddt_scale));let eq15_e1103_d_n8: f64 = (p.p87 * (s.dn[66][8] * ddt_scale));let eq15_e1103_d_n9: f64 = (p.p87 * (s.dn[66][9] * ddt_scale));let eq15_e1103_d_n10: f64 = (p.p87 * (s.dn[66][10] * ddt_scale));let eq15_e1103_d_n11: f64 = (p.p87 * (s.dn[66][11] * ddt_scale));let eq15_e1103_d_n12: f64 = (p.p87 * (s.dn[66][12] * ddt_scale));let eq15_e1103_d_n13: f64 = (p.p87 * (s.dn[66][13] * ddt_scale));let eq15_e1103_d_n14: f64 = (p.p87 * (s.dn[66][14] * ddt_scale));let eq15_e1103_d_n15: f64 = (p.p87 * (s.dn[66][15] * ddt_scale));let eq15_e1103_d_n16: f64 = (p.p87 * (s.dn[66][16] * ddt_scale));let eq15_e1103_d_n17: f64 = (p.p87 * (s.dn[66][17] * ddt_scale));let eq15_e1103_d_n18: f64 = (p.p87 * (s.dn[66][18] * ddt_scale));let eq15_e1103_d_b0: f64 = (p.p87 * (s.db[66][0] * ddt_scale));let eq15_e1103_d_b1: f64 = (p.p87 * (s.db[66][1] * ddt_scale));let eq15_e1103_d_b2: f64 = (p.p87 * (s.db[66][2] * ddt_scale));let eq15_e1103_d_b3: f64 = (p.p87 * (s.db[66][3] * ddt_scale));let eq15_e1103_d_b4: f64 = (p.p87 * (s.db[66][4] * ddt_scale));let eq15_e1103_d_b5: f64 = (p.p87 * (s.db[66][5] * ddt_scale));let eq15_e1103_d_b6: f64 = (p.p87 * (s.db[66][6] * ddt_scale));let eq15_e1103_d_b7: f64 = (p.p87 * (s.db[66][7] * ddt_scale));let eq15_e1103_d_b8: f64 = (p.p87 * (s.db[66][8] * ddt_scale));let eq15_e1103_d_b9: f64 = (p.p87 * (s.db[66][9] * ddt_scale));let eq15_e1103_d_b10: f64 = (p.p87 * (s.db[66][10] * ddt_scale));let eq15_e1103_d_b11: f64 = (p.p87 * (s.db[66][11] * ddt_scale));let eq15_e1103_d_b12: f64 = (p.p87 * (s.db[66][12] * ddt_scale));let eq15_value: f64 = eq15_e1103;let eq15_node_derivatives: [f64; 19] = [eq15_e1103_d_n0, eq15_e1103_d_n1, eq15_e1103_d_n2, eq15_e1103_d_n3, eq15_e1103_d_n4, eq15_e1103_d_n5, eq15_e1103_d_n6, eq15_e1103_d_n7, eq15_e1103_d_n8, eq15_e1103_d_n9, eq15_e1103_d_n10, eq15_e1103_d_n11, eq15_e1103_d_n12, eq15_e1103_d_n13, eq15_e1103_d_n14, eq15_e1103_d_n15, eq15_e1103_d_n16, eq15_e1103_d_n17, eq15_e1103_d_n18];let eq15_branch_derivatives: [f64; 13] = [eq15_e1103_d_b0, eq15_e1103_d_b1, eq15_e1103_d_b2, eq15_e1103_d_b3, eq15_e1103_d_b4, eq15_e1103_d_b5, eq15_e1103_d_b6, eq15_e1103_d_b7, eq15_e1103_d_b8, eq15_e1103_d_b9, eq15_e1103_d_b10, eq15_e1103_d_b11, eq15_e1103_d_b12];
        stamper.stamp_current_dense_local(
            Some(11),
            Some(2),
            ...
            multiplicity,
        );let eq16_e1106: f64 = eval_ddt(ddt_state_current, ddt_state_previous, ddt_state_older, ddt_state_initialized, ddt_derivative_current, ddt_derivative_previous, ddt_active, ddt_scale, ddt_previous_value_scale, ddt_older_value_scale, ddt_previous_derivative_scale, 4, s.v[65]);let eq16_e1107: f64 = (p.p87 * eq16_e1106);let eq16_e1107_d_n0: f64 = (p.p87 * (s.dn[65][0] * ddt_scale));let eq16_e1107_d_n1: f64 = (p.p87 * (s.dn[65][1] * ddt_scale));let eq16_e1107_d_n2: f64 = (p.p87 * (s.dn[65][2] * ddt_scale));let eq16_e1107_d_n3: f64 = (p.p87 * (s.dn[65][3] * ddt_scale));let eq16_e1107_d_n4: f64 = (p.p87 * (s.dn[65][4] * ddt_scale));let eq16_e1107_d_n5: f64 = (p.p87 * (s.dn[65][5] * ddt_scale));let eq16_e1107_d_n6: f64 = (p.p87 * (s.dn[65][6] * ddt_scale));let eq16_e1107_d_n7: f64 = (p.p87 * (s.dn[65][7] * ddt_scale));let eq16_e1107_d_n8: f64 = (p.p87 * (s.dn[65][8] * ddt_scale));let eq16_e1107_d_n9: f64 = (p.p87 * (s.dn[65][9] * ddt_scale));let eq16_e1107_d_n10: f64 = (p.p87 * (s.dn[65][10] * ddt_scale));let eq16_e1107_d_n11: f64 = (p.p87 * (s.dn[65][11] * ddt_scale));let eq16_e1107_d_n12: f64 = (p.p87 * (s.dn[65][12] * ddt_scale));let eq16_e1107_d_n13: f64 = (p.p87 * (s.dn[65][13] * ddt_scale));let eq16_e1107_d_n14: f64 = (p.p87 * (s.dn[65][14] * ddt_scale));let eq16_e1107_d_n15: f64 = (p.p87 * (s.dn[65][15] * ddt_scale));let eq16_e1107_d_n16: f64 = (p.p87 * (s.dn[65][16] * ddt_scale));let eq16_e1107_d_n17: f64 = (p.p87 * (s.dn[65][17] * ddt_scale));let eq16_e1107_d_n18: f64 = (p.p87 * (s.dn[65][18] * ddt_scale));let eq16_e1107_d_b0: f64 = (p.p87 * (s.db[65][0] * ddt_scale));let eq16_e1107_d_b1: f64 = (p.p87 * (s.db[65][1] * ddt_scale));let eq16_e1107_d_b2: f64 = (p.p87 * (s.db[65][2] * ddt_scale));let eq16_e1107_d_b3: f64 = (p.p87 * (s.db[65][3] * ddt_scale));let eq16_e1107_d_b4: f64 = (p.p87 * (s.db[65][4] * ddt_scale));let eq16_e1107_d_b5: f64 = (p.p87 * (s.db[65][5] * ddt_scale));let eq16_e1107_d_b6: f64 = (p.p87 * (s.db[65][6] * ddt_scale));let eq16_e1107_d_b7: f64 = (p.p87 * (s.db[65][7] * ddt_scale));let eq16_e1107_d_b8: f64 = (p.p87 * (s.db[65][8] * ddt_scale));let eq16_e1107_d_b9: f64 = (p.p87 * (s.db[65][9] * ddt_scale));let eq16_e1107_d_b10: f64 = (p.p87 * (s.db[65][10] * ddt_scale));let eq16_e1107_d_b11: f64 = (p.p87 * (s.db[65][11] * ddt_scale));let eq16_e1107_d_b12: f64 = (p.p87 * (s.db[65][12] * ddt_scale));let eq16_value: f64 = eq16_e1107;let eq16_node_derivatives: [f64; 19] = [eq16_e1107_d_n0, eq16_e1107_d_n1, eq16_e1107_d_n2, eq16_e1107_d_n3, eq16_e1107_d_n4, eq16_e1107_d_n5, eq16_e1107_d_n6, eq16_e1107_d_n7, eq16_e1107_d_n8, eq16_e1107_d_n9, eq16_e1107_d_n10, eq16_e1107_d_n11, eq16_e1107_d_n12, eq16_e1107_d_n13, eq16_e1107_d_n14, eq16_e1107_d_n15, eq16_e1107_d_n16, eq16_e1107_d_n17, eq16_e1107_d_n18];let eq16_branch_derivatives: [f64; 13] = [eq16_e1107_d_b0, eq16_e1107_d_b1, eq16_e1107_d_b2, eq16_e1107_d_b3, eq16_e1107_d_b4, eq16_e1107_d_b5, eq16_e1107_d_b6, eq16_e1107_d_b7, eq16_e1107_d_b8, eq16_e1107_d_b9, eq16_e1107_d_b10, eq16_e1107_d_b11, eq16_e1107_d_b12];
        stamper.stamp_current_dense_local(
            Some(10),
            Some(0),
