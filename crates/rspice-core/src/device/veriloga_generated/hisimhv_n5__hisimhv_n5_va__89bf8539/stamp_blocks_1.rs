...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        if ((s.b[1287] && s.b[1327]) && (!s.b[1328])) {s.store_scale(873, 828, p[13]);s.store_scale(874, 830, p[13]);s.store_scalar(875, 0.0);s.store_scalar(876, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_18(
        ...
        if ((s.b[1287] && s.b[1327]) && (!s.b[1328])) {s.store_scale(877, 836, p[15]);s.store_scale(878, 837, p[15]);}
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        s.b[1345] = ((s.v[845] < 0.01) && (p[16] > s.v[632]));s.store_scalar(1345, if s.b[1345] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if s.b[1350] {s.store_scaled_sqrt(139, 155, s.v[639]);s.store_square(694, 139);s.store_scaled_square(140, 394, s.v[640]);s.store_offset_scaled(427, 391, p[448], p[447]);s.store_scalar(957, p[193]);}
    ...
    if (s.b[1399] && s.b[1402]) {
        ...
        s.store_scalar(74, t2);s.store_scalar(77, 0.0);s.b[1403] = (((s.v[449] == 1.0) && (p[54] == 1.0)) && ((s.v[459] * (s.v[544] + s.v[459])) > 0.0));s.store_scalar(1403, if s.b[1403] { 1.0 } else { 0.0 });
        ...
        if s.b[1403] {s.store_scale(781, 376, (0.5 * (2.0 * 1.0 / (p[262]))));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(108, p[262], 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);}
        ...
        if s.b[1403] {s.store_offset(335, 335, (10.0 * 2.220446049250313e-16));s.store_scalar(334, (s.v[544] / (s.v[459] * (s.v[544] + s.v[459]))));s.store_scale(338, 334, ((2.0 * 1.034943e-10) / 1.6021918e-19));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_26(
        ...
        if s.b[1403] {s.store_offset_sqrt_ad(384, A::mul(s.ad_value(338), s.ad_value(335)), 1e-25);s.store_offset_sub_from_scalar_ad(781, p[334], s.ad_value(384), (-(0.1 * p[334])));s.store_scalar(782, ((4.0 * p[334]) * (0.1 * p[334])));}
        if s.b[1403] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if ((s.b[1407] && s.b[1409]) && s.b[1411]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_offset_scaled_ad(339, A::div_scaled_offset_numerator(s.ad_value(781), 1.0, (-((2.0 * 0.01) * 0.01)), s.ad_value(782), 1.0), (-0.5), 0.5);s.store_add_scaled_inputs3_indices(336, 338, 1.0, 781, 0.5, 782, 0.5);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_27(
        ...
        if ((s.b[1407] && s.b[1409]) && s.b[1411]) {s.store_scale(337, 338, (1.0 + s.v[539]));s.store_offset_sub(781, 337, 336, (-(5e-5 * 0.01)));s.store_scale(782, 337, (4.0 * (5e-5 * 0.01)));}
        if ((s.b[1407] && s.b[1409]) && s.b[1411]) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if ((s.b[1407] && s.b[1409]) && s.b[1416]) {s.store_offset(335, 335, (10.0 * 2.220446049250313e-16));s.store_scalar(334, (s.v[544] / (s.v[459] * (s.v[544] + s.v[459]))));s.store_scale(338, 334, ((2.0 * 1.034943e-10) / 1.6021918e-19));s.store_offset_sqrt_ad(384, A::mul(s.ad_value(338), s.ad_value(335)), 1e-25);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_28(
        ...
        if ((s.b[1407] && s.b[1409]) && s.b[1416]) {s.store_offset_sub_from_scalar_ad(781, p[334], s.ad_value(384), (-(0.1 * p[334])));s.store_scalar(782, ((4.0 * p[334]) * (0.1 * p[334])));}
    ...
    pub(super) fn stamp_transient_block_31(
        ...
        if s.b[1429] {s.store_sqrt_offset_square_offset(782, 182, (-1.0), ((4.0 * 0.05) * 0.05));}
    }
}
