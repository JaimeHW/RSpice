...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        if ((s.b[1287] && (!s.b[1288])) && (!s.b[1291])) {s.store_scalar(961, 0.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_20(
        ...
        if ((s.b[1287] && (!s.b[1288])) && (!s.b[1291])) {s.store_mul_ln_mixed_ia(960, 155, A::div_scaled_value_by_product(s.ad_value(586), s.v[489], s.ad_value(394), s.ad_value(394), 1.0));s.store_scalar(977, 0.0);}
        if s.b[1287] {s.store_mul(680, 638, 155);s.store_scale(335, 387, 1.0 / (s.v[764]));s.store_sub_ad(334, A::add_scaled_product(A::scale_offset(s.ad_value(335), 0.4, 1.8), 1.0, s.ad_value(335), s.ad_value(335), 0.1), A::scale_offset(s.ad_value(335), (-s.v[477]), s.v[477]));}
    ...
    pub(super) fn stamp_transient_block_21(
        ...
        if s.b[1287] {s.store_add_scaled_inputs_mixed_ai(336, A::scale_offset(s.ad_value(389), p[330], s.v[529]), 1.0, 390, p[331]);s.store_offset(781, 336, (-0.05));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_22(
        ...
        if s.b[1287] {s.store_scalar(782, 0.0);}
        if s.b[1287] {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
    ...
    pub(super) fn stamp_transient_block_23(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_scale(338, 646, ((((p[67] * s.v[536]) * 1000000.0) + s.v[534]) * (((p[68] * p[100]) * 1000000.0) + p[101])));s.store_scalar(335, (((1.0 - s.v[535]) * p[63]) * 1000000.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_24(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_scalar(782, ((((p[99] * p[99]) + ((4.0 * (0.0001 * 0.01)) * (0.0001 * 0.01)))) as f64).sqrt());s.store_scaled_offset_ad(334, A::div_from_scalar(p[99], s.ad_value(782)), 1.0, 0.5);s.store_scaled_offset(336, 782, p[99], 0.5);}
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_div_from_scalar(342, (-p[98]), 336);s.store_offset_scaled(337, 342, (p[63] * 1000000.0), ((1.0) + (p[98])));s.store_offset_add_scaled_product_indices(781, 338, (-1.0), 337, 338, 1.0, (-0.01));s.store_scale(782, 338, (4.0 * 0.01));}
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_sqrt_square_add(782, 781, 782);s.store_offset_scaled_div(340, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs3_indices(341, 338, (p[98] + 1.0), 781, (-0.5), 782, (-0.5));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_25(
        ...
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {s.store_offset_add_scaled_product_indices(781, 341, 1.0, 335, 338, 1.0, (-5e-5));s.store_scalar(782, 0.0);}
        if ((s.b[1287] && s.b[1311]) && s.b[1316]) {
            if (s.v[782] > 0.0) {
            } else {
                s.store_neg(782, 782);
        ...
        if s.b[1287] {s.store_scaled_sqrt(139, 155, s.v[639]);s.store_square(694, 139);s.store_scaled_square(140, 394, s.v[640]);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_26(
        ...
        if s.b[1287] {s.store_offset_scaled(427, 391, p[448], p[447]);s.store_scalar(957, p[193]);}
