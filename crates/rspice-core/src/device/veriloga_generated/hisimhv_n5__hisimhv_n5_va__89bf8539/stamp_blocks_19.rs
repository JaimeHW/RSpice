...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_61(
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1823]) && s.b[1824]) {s.store_scale(782, 338, (4.0 * (0.01 * 0.01)));}
        ...
        if (s.b[1441] && (s.b[1443] && (!s.b[1442]))) {s.copy_ad(1853, 960);s.store_scale(1903, 964, 1.6021918e-19);s.store_scale(1882, 964, (1.6021918e-19 * 1.034943e-10));s.store_scale(1902, 622, 1.6021918e-19);s.store_square(1901, 965);s.store_div_from_scalar(1906, (2.0 * 1.034943e-10), 1903);s.store_div_from_scalar(1907, (2.0 * 1.034943e-10), 1902);s.store_div(1900, 964, 622);s.store_div_from_scalar_offset_input(1899, 1.0, 1900, 1.0);s.store_div_square_rhs(1904, 1882, 185);s.store_div_from_scalar(1905, 2.0, 1904);s.store_scalar(1908, 4.0);s.store_scalar(1909, 0.1);s.store_scalar(1910, 0.1);s.store_offset(1911, 961, p[407]);s.store_scalar(1912, 3.0);s.store_scalar(1851, 0.0);s.store_scalar(1852, 0.0);s.store_scalar(1860, 0.0);s.store_scalar(1861, 0.0);s.store_scalar(1893, 0.0);s.store_scalar(1894, 0.0);s.store_scalar(1864, 0.0);s.store_scalar(1866, 0.0);s.store_scalar(1865, 0.0);s.store_scalar(1867, 0.0);s.store_scalar(1837, 0.0);s.store_scalar(1832, 0.0);s.copy_ad(1885, 1433);s.store_offset(85, 85, ((10.0 * 2.220446049250313e-16) * 100000000.0));s.store_div_scaled_product_add_scaled_denominator_indices(962, 1906, 622, 1.0, 964, 1.0, 622, 1.0, 1.0);s.store_sub(335, 1853, 1436);}
        s.b[1915] = ((s.v[335] < 0.1) && (0.1 >= 0.0));s.store_scalar(1915, if s.b[1915] { 1.0 } else { 0.0 });
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1915]) {s.store_sub_from_scalar(781, 0.1, 335);s.store_square(722, 781);s.store_scalar(723, (0.1 * 0.1));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_62(
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1915]) {s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);s.store_scalar(719, 0.0);s.store_scalar(720, 0.0);s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
        ...
        let mut t1: usize = 0;
        while {
            let t0: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1915]) && s.b[1916]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t0 != 0.0
        } {
            t1 += 1;
        ...
        if (s.b[1441] && (s.b[1443] && (!s.b[1442]))) {s.store_sqrt_square_add(782, 781, 782);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_63(
        s: &mut ReactiveScratch,
    ) {
        if (s.b[1441] && (s.b[1443] && (!s.b[1442]))) {s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);s.store_add_scaled_inputs4_indices(1858, 1885, 1.0, 1853, (-1.0), 781, 0.5, 782, 0.5);s.store_div_scaled_product_add_scaled_denominator_indices(1886, 1853, 622, -1.0, 622, 1.0, 964, 1.0, 1.0);s.store_offset_sub(1832, 965, 1833, 1e-15);s.store_scalar(79, 0.0);s.store_scalar(1848, 0.2);s.copy_ad(1851, 1858);s.copy_ad(1854, 1849);s.copy_ad(1856, 1886);s.store_scalar(97, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_64(
        ...
        let mut tb: usize = 0;
        while {
            let ta: f64 = if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (s.v[97] <= 150.0)) { 1.0 } else { 0.0 };
            ta != 0.0
        } {
            tb += 1;
            ...
            let mut t7: usize = 0;
            while {
                let t6: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1923]) && s.b[1924]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t6 != 0.0
            } {
                t7 += 1;
            ...
            let mut t9: usize = 0;
            while {
                let t8: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1929]) && s.b[1930]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t8 != 0.0
            } {
                t9 += 1;
            ...
            let mut t3: usize = 0;
            while {
                let t2: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1936]) && s.b[1937]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t2 != 0.0
            } {
                t3 += 1;
            ...
            let mut t5: usize = 0;
            while {
                let t4: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1942]) && s.b[1943]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t4 != 0.0
            } {
                t5 += 1;
    ...
    pub(super) fn stamp_reactive_block_65(
        ...
        let mut td: usize = 0;
        while {
            let tc: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1954]) && s.b[1955]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc != 0.0
        } {
            td += 1;
    ...
    pub(super) fn stamp_reactive_block_66(
        ...
        let mut tf: usize = 0;
        while {
            let te: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1960]) && s.b[1961]) && s.b[1962]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te != 0.0
        } {
            tf += 1;
    ...
    pub(super) fn stamp_reactive_block_67(
        ...
        let mut t11: usize = 0;
        while {
            let t10: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1960]) && s.b[1967]) && s.b[1968]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t10 != 0.0
        } {
            t11 += 1;
    ...
    pub(super) fn stamp_reactive_block_69(
        ...
        let mut t1b: usize = 0;
        while {
            let t1a: f64 = if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (s.v[97] <= 150.0)) { 1.0 } else { 0.0 };
            t1a != 0.0
        } {
            t1b += 1;
            ...
            let mut t17: usize = 0;
            while {
                let t16: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1974]) && s.b[1975]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t16 != 0.0
            } {
                t17 += 1;
            ...
            let mut t19: usize = 0;
            while {
                let t18: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1980]) && s.b[1981]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t18 != 0.0
            } {
                t19 += 1;
            ...
            let mut t13: usize = 0;
            while {
                let t12: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1987]) && s.b[1988]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t12 != 0.0
            } {
                t13 += 1;
            ...
            let mut t15: usize = 0;
            while {
                let t14: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1993]) && s.b[1994]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t14 != 0.0
            } {
                t15 += 1;
    ...
    pub(super) fn stamp_reactive_block_70(
        ...
        let mut t1d: usize = 0;
        while {
            let t1c: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[2005]) && s.b[2006]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t1c != 0.0
        } {
            t1d += 1;
    ...
    pub(super) fn stamp_reactive_block_71(
        ...
        let mut t1f: usize = 0;
        while {
            let t1e: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[2011]) && s.b[2012]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t1e != 0.0
        } {
            t1f += 1;
    ...
    pub(super) fn stamp_reactive_block_72(
        ...
        let mut t21: usize = 0;
        while {
            let t20: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[2017]) && s.b[2018]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t20 != 0.0
        } {
            t21 += 1;
        ...
        let mut t23: usize = 0;
        while {
            let t22: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && s.b[2029]) && (s.v[719] < s.v[1912])) { 1.0 } else { 0.0 };
            t22 != 0.0
        } {
            t23 += 1;
        ...
        let mut t25: usize = 0;
        while {
            let t24: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && s.b[2029]) && s.b[2030]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t24 != 0.0
        } {
            t25 += 1;
    ...
    pub(super) fn stamp_reactive_block_73(
        ...
        let mut t27: usize = 0;
        while {
            let t26: f64 = if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && s.b[2035]) && (s.v[719] < s.v[1912])) { 1.0 } else { 0.0 };
            t26 != 0.0
        } {
            t27 += 1;
        ...
        let mut t29: usize = 0;
        while {
            let t28: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && s.b[2035]) && s.b[2036]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t28 != 0.0
        } {
            t29 += 1;
    ...
    pub(super) fn stamp_reactive_block_74(
        ...
        let mut t2b: usize = 0;
        while {
            let t2a: f64 = if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && (s.v[97] <= 150.0)) { 1.0 } else { 0.0 };
            t2a != 0.0
        } {
            t2b += 1;
    ...
    pub(super) fn stamp_reactive_block_76(
        ...
        let mut t2d: usize = 0;
        while {
            let t2c: f64 = if (((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[2055]) && s.b[2056]) && s.b[2057]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t2c != 0.0
        } {
            t2d += 1;
