...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_63(
        ...
        if s.b[2601] {
            ...
            s.store_scaled_offset_ad(336, A::add(A::add(A::sub_scaled_inputs(s.ad_value(1436), s.v[493], s.ad_value(1438), 1.0), s.ad_value(122)), s.ad_value(174)), (-s.v[492]), (-1.0 / (s.v[187])));
