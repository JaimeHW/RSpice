...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1952])) && (!s.b[1953])) {
            ...
            s.store_add_scaled_product(1862, s.ad_value(337), 1.0, s.ad_value(209), A::sqrt_scaled_input(s.ad_value(335), -1.0), (-1.0));
        }
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[1954]) {
            s.store_add_scaled_inputs3(781, s.ad_value(1909), 1.0, s.ad_value(1851), -1.0, s.ad_value(1849), 1.0);
    ...
    pub(super) fn stamp_transient_block_33(
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) {
            s.copy_ad(1835, 1834);
            s.copy_ad(1850, 790);
            s.store_add_scaled_inputs3_offset(781, s.ad_value(1851), 1.0, s.ad_value(1850), 1.0, s.ad_value(85), -1.0, (-0.01));
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) {
            ...
            s.store_add_scaled_inputs4(1859, s.ad_value(1851), 1.0, s.ad_value(1850), 1.0, s.ad_value(781), (-0.5), s.ad_value(782), (-0.5));
            s.store_add_scaled_inputs3_offset(781, s.ad_value(1859), 1.0, s.ad_value(1885), -1.0, s.ad_value(1853), 1.0, (-0.01));
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) {
            s.store_sqrt_square_add(782, 781, 782);
            s.store_offset_scaled_div(334, 781, 782, 0.5, 0.5);
            s.store_add_scaled_inputs4(1859, s.ad_value(1885), 1.0, s.ad_value(1853), (-1.0), s.ad_value(781), 0.5, s.ad_value(782), 0.5);
            s.store_mul(212, 209, 186);
            s.store_square(213, 212);
            s.store_offset_ad(332, A::div_scaled_offset_numerator(A::mul(s.ad_value(154), A::sub(s.ad_value(85), s.ad_value(1885))), 4.0, ((-1.0) * 4.0), A::mul(s.ad_value(213), s.ad_value(156)), 1.0), 1.0);
        }
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        while {
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (!s.b[1986])) {
                ...
                s.store_scalar(1838, 1.0);
                s.store_ad_value(1839, A::mul_sub_from_scalar_rhs(A::add_scaled_product(s.ad_value(334), 1.0, A::div(s.ad_value(965), s.ad_value(1829)), s.ad_value(334), (-1.0)), 1.0, s.ad_value(1841)));
            }
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1987]) {
                s.store_add_scaled_inputs3(781, s.ad_value(1837), 1.0, s.ad_value(1850), (-1.0), s.ad_value(1848), 1.0);
                s.store_square(722, 781);
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1987]) {
                ...
                s.store_add_scaled_inputs3(1837, s.ad_value(1850), 1.0, s.ad_value(1848), (-1.0), s.ad_value(780), 1.0);
            }
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[1987]) {
            }
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (!s.b[1987])) {
            ...
            if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) {
                ...
                s.store_add_scaled_inputs3(335, s.ad_value(1857), 1.0, s.ad_value(1885), (-1.0), s.ad_value(1853), 1.0);
            }
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (!s.b[1999])) {
                ...
                s.store_div_scaled_product(339, s.ad_value(209), s.ad_value(209), 0.5, s.ad_value(1861), 1.0);
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (s.v[79] == 0.0)) {
                s.store_add_scaled_inputs3(1868, A::add_scaled_product(s.ad_value(1861), 1.0, s.ad_value(185), A::sub(s.ad_value(85), s.ad_value(1852)), 1.0), 1.0, s.ad_value(1866), 1.0, s.ad_value(1867), 1.0);
    ...
    pub(super) fn stamp_transient_block_35(
        ...
        if ((((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (!s.b[2003])) && (!s.b[2004])) {
            ...
            s.store_add_scaled_product(1863, s.ad_value(337), 1.0, s.ad_value(209), A::sqrt_scaled_input(s.ad_value(335), -1.0), (-1.0));
        }
        ...
        if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && s.b[2005]) {
            s.store_add_scaled_inputs3(781, s.ad_value(1909), 1.0, s.ad_value(1852), -1.0, s.ad_value(1850), 1.0);
            s.store_square(722, 781);
            s.store_square(723, 1909);
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[2017]) {
            s.store_add_scaled_inputs3(781, s.ad_value(1909), 1.0, s.ad_value(109), -1.0, s.ad_value(1849), 1.0);
            s.store_square(722, 781);
            s.store_square(723, 1909);
            s.store_scalar(724, 1.0);
            s.store_scalar(725, 1.0);
    ...
    pub(super) fn stamp_transient_block_36(
        ...
        if ((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) {
            s.store_add_scaled_inputs3_offset(1914, s.ad_value(791), 1.0, s.ad_value(85), (-1.0), s.ad_value(1910), 1.0, (-(s.v[462] - p.p392)));
        ...
        while {
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && (!s.b[2041])) {
                ...
                s.store_div_scaled_product(339, s.ad_value(209), s.ad_value(209), 0.5, s.ad_value(2026), 1.0);
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[2028])) && (s.v[79] == 0.0)) {
                s.store_add_scaled_product(1868, s.ad_value(2026), 1.0, s.ad_value(185), A::sub(s.ad_value(1913), s.ad_value(983)), 1.0);
                s.store_sub(1869, 2027, 185);
                s.store_div_scaled_inputs(1880, s.ad_value(1868), -1.0, s.ad_value(1869), 1.0);
            }
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && s.b[2055]) && s.b[2062]) {
            ...
            s.store_div_scaled_product3(334, s.ad_value(1908), s.ad_value(725), s.ad_value(726), 1.0, s.ad_value(770), 1.0);
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        while {
            ...
            if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
                ...
                s.store_ad_value(2137, A::mul_sub_from_scalar_rhs(A::add_scaled_product(s.ad_value(337), 1.0, A::div(s.ad_value(2129), s.ad_value(2083)), s.ad_value(337), (-1.0)), 1.0, s.ad_value(2138)));
            }
            ...
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && s.b[2219]) {
                ...
                s.store_div_scaled_product3(345, s.ad_value(209), s.ad_value(209), s.ad_value(154), 0.5, s.ad_value(2096), 1.0);
            ...
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (s.v[79] == 0.0)) {
                s.store_add_scaled_product(2098, s.ad_value(2096), 1.0, s.ad_value(185), A::sub(s.ad_value(85), s.ad_value(2087)), 1.0);
                s.store_sub(2099, 2123, 185);
                s.copy_ad(2100, 2125);
                s.store_sub(2101, 2090, 2135);
                s.store_neg(2102, 2136);
                s.store_sub_from_scalar(2103, 1.0, 2137);
                s.store_add_scaled_products(2104, s.ad_value(2099), s.ad_value(2103), 1.0, s.ad_value(2100), s.ad_value(2102), (-1.0));
            }
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (s.v[79] == 0.0)) {
    ...
    pub(super) fn stamp_transient_block_43(
        ...
        while {
            ...
            if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && s.b[2232]) && (s.v[79] == 0.0)) {
                s.store_ad_value(2098, A::add_scaled_offset_product_rhs(s.ad_value(2155), 1.0, s.ad_value(185), A::sub(s.ad_value(2157), s.ad_value(2154)), p.p397, -1.0));
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        while {
            ...
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2250])) {
                ...
                s.store_scalar(2136, 1.0);
                s.store_ad_value(2137, A::mul_sub_from_scalar_rhs(A::add_scaled_product(s.ad_value(337), 1.0, A::div(s.ad_value(2129), s.ad_value(2084)), s.ad_value(337), (-1.0)), 1.0, s.ad_value(2139)));
            }
            ...
            if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2250])) && s.b[2269]) {
                ...
                s.store_div_scaled_product3(345, s.ad_value(209), s.ad_value(209), s.ad_value(154), 0.5, s.ad_value(2097), 1.0);
            ...
            if (((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2250])) && (s.v[79] == 0.0)) {
                s.store_add_scaled_product(2098, s.ad_value(2097), 1.0, s.ad_value(185), A::sub(s.ad_value(85), s.ad_value(2088)), 1.0);
