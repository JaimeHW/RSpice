...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if ((p.p37 != 0.0) && s.b[1439]) {s.store_sub(335, 792, 73);s.store_sub(336, 72, 73);s.store_div(781, 335, 336);s.store_square(782, 781);s.store_mul(783, 782, 781);s.store_square(784, 782);s.store_div_from_scalar_ad(780, 1.0, A::add_scaled_inputs4_offset(s.ad_value(781), 1.0, s.ad_value(782), 1.0, s.ad_value(783), 1.0, s.ad_value(784), 1.0, 1.0));s.store_mul_ad_affine_product_lhs(1434, A::add_scaled_inputs3_offset(s.ad_value(781), 2.0, s.ad_value(782), 3.0, s.ad_value(783), 4.0, 1.0), s.ad_value(780), -1.0, 0.0, 780);s.store_mul_scale_offset_indices(333, 336, 780, -1.0, 1.0);s.store_add_scaled_sub_value_product_indices(334, 1.0, 780, 1.0, 781, 1434, 1.0);s.store_neg(1434, 1434);s.store_add(1433, 73, 333);s.store_div_from_scalar(337, 1.0, 336);s.store_mul(338, 335, 337);s.store_square(339, 338);s.store_add_scaled_product_mixed_aia(341, A::offset(s.ad_value(338), 1.0), 1.0, 339, A::add(A::offset(s.ad_value(338), 1.0), s.ad_value(339)), 1.0);s.store_div_scaled_inputs_product_mixed_aiiia(1434, A::scale_offset(s.ad_value(338), 2.0, 1.0), 1.0, 339, 3.0, 338, 339, 4.0, A::square(s.ad_value(341)), 1.0);}
        if ((p.p37 != 0.0) && (!s.b[1439])) {s.copy_ad(1433, 792);s.store_scalar(1434, 1.0);}
        if (p.p37 == 0.0) {s.copy_ad(1433, 792);s.store_scalar(1434, 1.0);}
        s.store_scaled_mul(335, 1434, 790, 0.5);s.store_scale(781, 335, (2.0 * 1.0 / (p.p262)));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(1435, p.p262, 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);s.b[1440] = (s.v[1435] < 1e-12);s.store_scalar(1440, if s.b[1440] { 1.0 } else { 0.0 });
        if s.b[1440] {s.store_scalar(1435, 1e-12);}
        s.store_add(1436, 1433, 1435);s.store_add_scaled_inputs(1437, 790, 1.0, 1435, 2.0);s.store_add(1438, 791, 1435);s.store_add_scaled_inputs3_offset_indices(85, 791, 1.0, 120, 1.0, 182, -1.0, (-s.v[160]));let t0: f64 = (s.v[160] - s.v[120]);let t1: f64 = (t0 + s.v[182]);let t2: f64 = (t1 + s.v[1433]);s.store_scalar(86, t2);s.b[1441] = (s.v[963] != 0.0);s.store_scalar(1441, if s.b[1441] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_33(
        ...
        s.b[1442] = (p.p42 == 1.0);s.store_scalar(1442, if s.b[1442] { 1.0 } else { 0.0 });s.b[1443] = (p.p42 == 2.0);s.store_scalar(1443, if s.b[1443] { 1.0 } else { 0.0 });s.b[1444] = (p.p42 == 3.0);s.store_scalar(1444, if s.b[1444] { 1.0 } else { 0.0 });
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) {
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_40(
        s: &mut Scratch,
    ) {
        if (((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) {s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) {
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) {s.store_scalar(770, 0.0);s.store_scalar(726, 0.0);s.store_mul(724, 724, 722);s.store_mul(725, 725, 723);s.store_mul(724, 724, 722);}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_45(
        s: &mut Scratch,
    ) {
        if (((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) {s.store_mul(725, 725, 723);s.store_add(770, 724, 725);s.copy_ad(726, 770);}
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) {
        ...
        if (((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) {s.store_sub_from_scalar(781, 2.0, 338);s.store_square(722, 781);s.store_scalar(723, (2.0 * 2.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_47(
        s: &mut Scratch,
    ) {
        if (((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) {s.store_scalar(724, 1.0);s.store_scalar(725, 1.0);}
        let (tf3,) = {
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1691]) && s.b[1692]) && s.b[1693]) {
        ...
        s.store_scalar(720, t100);s.b[1694] = (4.0 == 2.0);s.store_scalar(1694, if s.b[1694] { 1.0 } else { 0.0 });
        let (t101,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1691]) && s.b[1692]) && (!s.b[1693])) && s.b[1694]) {
        ...
        s.store_scalar(720, t101);s.b[1695] = (4.0 == 4.0);s.store_scalar(1695, if s.b[1695] { 1.0 } else { 0.0 });
        let (t102,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1691]) && s.b[1692]) && (!s.b[1693])) && (!s.b[1694])) && s.b[1695]) {
        ...
        s.store_scalar(720, t102);s.b[1696] = (4.0 == 8.0);s.store_scalar(1696, if s.b[1696] { 1.0 } else { 0.0 });
    }
}
