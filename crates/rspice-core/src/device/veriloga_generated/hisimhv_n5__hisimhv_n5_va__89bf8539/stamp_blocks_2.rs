...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_32(
        ...
        if s.b[1429] {s.store_scaled_offset_ad(340, A::div_scaled_offset_numerator(s.ad_value(182), 1.0, (-1.0), s.ad_value(782), 1.0), 1.0, 0.5);s.store_scaled_add_mixed_ai(182, A::offset(s.ad_value(182), (-1.0)), 782, 0.5);}
        ...
        s.store_scaled_mul(335, 1434, 790, 0.5);s.store_scale(781, 335, (2.0 * 1.0 / (p[262])));s.store_offset_mul_offset_rhs_mixed_ia(782, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 5040.0), (1.0 / 720.0))), (1.0 / 120.0)), (1.0 / 24.0)), (1.0 / 6.0)), (1.0 / 2.0), 1.0);s.store_offset_mul_offset_rhs_mixed_ia(783, 781, A::mul_offset_rhs(s.ad_value(781), A::mul_offset_rhs(s.ad_value(781), A::mul(s.ad_value(781), A::scale_offset(s.ad_value(781), (1.0 / 840.0), (1.0 / 144.0))), (1.0 / 30.0)), (1.0 / 8.0)), (1.0 / 3.0), (1.0 / 2.0));s.store_div_from_scalar(1435, p[262], 782);s.store_div_scaled_inputs_square_rhs(336, 783, (-2.0), 782, 1.0);s.b[1440] = (s.v[1435] < 1e-12);s.store_scalar(1440, if s.b[1440] { 1.0 } else { 0.0 });
        if s.b[1440] {s.store_scalar(1435, 1e-12);}
        s.store_add(1436, 1433, 1435);s.store_add_scaled_inputs(1437, 790, 1.0, 1435, 2.0);s.store_add(1438, 791, 1435);s.store_add_scaled_inputs3_offset_indices(85, 791, 1.0, 120, 1.0, 182, -1.0, (-s.v[160]));
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_33(
        ...
        let t0: f64 = (s.v[160] - s.v[120]);let t1: f64 = (t0 + s.v[182]);let t2: f64 = (t1 + s.v[1433]);s.store_scalar(86, t2);s.b[1441] = (s.v[963] != 0.0);s.store_scalar(1441, if s.b[1441] { 1.0 } else { 0.0 });s.b[1442] = (p[42] == 1.0);s.store_scalar(1442, if s.b[1442] { 1.0 } else { 0.0 });s.b[1443] = (p[42] == 2.0);s.store_scalar(1443, if s.b[1443] { 1.0 } else { 0.0 });s.b[1444] = (p[42] == 3.0);s.store_scalar(1444, if s.b[1444] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        let mut t24: usize = 0;
        while {
            let t22: f64 = (150.0 + 1.0);let t23: f64 = if (((s.b[1441] && s.b[1442]) && s.b[1557]) && (s.v[97] <= t22)) { 1.0 } else { 0.0 };
            t23 != 0.0
        } {
            t24 += 1;
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1558]) && s.b[1559]) && s.b[1560]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6);s.b[1561] = (2.0 == 2.0);s.store_scalar(1561, if s.b[1561] { 1.0 } else { 0.0 });
            let (t7,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1558]) && s.b[1559]) && (!s.b[1560])) && s.b[1561]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t7);s.b[1562] = (2.0 == 4.0);s.store_scalar(1562, if s.b[1562] { 1.0 } else { 0.0 });
            let (t8,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1558]) && s.b[1559]) && (!s.b[1560])) && (!s.b[1561])) && s.b[1562]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t8);s.b[1563] = (2.0 == 8.0);s.store_scalar(1563, if s.b[1563] { 1.0 } else { 0.0 });
            let (t9,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1558]) && s.b[1559]) {
        ...
        (s.v[719],)
            ...
            while {
                let td: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1558]) && s.b[1559]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                td != 0.0
            } {
                te += 1;
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1564]) && s.b[1565]) && s.b[1566]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t11);s.b[1567] = (2.0 == 2.0);s.store_scalar(1567, if s.b[1567] { 1.0 } else { 0.0 });
            let (t12,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1564]) && s.b[1565]) && (!s.b[1566])) && s.b[1567]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t12);s.b[1568] = (2.0 == 4.0);s.store_scalar(1568, if s.b[1568] { 1.0 } else { 0.0 });
            let (t13,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1564]) && s.b[1565]) && (!s.b[1566])) && (!s.b[1567])) && s.b[1568]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t13);s.b[1569] = (2.0 == 8.0);s.store_scalar(1569, if s.b[1569] { 1.0 } else { 0.0 });
            let (t14,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1564]) && s.b[1565]) {
        ...
        (s.v[719],)
            ...
            while {
                let t18: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1564]) && s.b[1565]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t18 != 0.0
            } {
                t19 += 1;
    ...
    if ((s.b[1441] && s.b[1442]) && s.b[1557]) {
        ...
        s.store_scalar(1507, t25);s.b[1572] = (s.v[85] > s.v[1464]);s.store_scalar(1572, if s.b[1572] { 1.0 } else { 0.0 });
        let (t26,) = {
    if (((s.b[1441] && s.b[1442]) && s.b[1557]) && s.b[1572]) {
        ...
        s.store_scalar(1477, t26);s.b[1573] = (s.v[85] > s.v[1507]);s.store_scalar(1573, if s.b[1573] { 1.0 } else { 0.0 });
        let (t27,) = {
    ...
    if ((s.b[1441] && s.b[1442]) && s.b[1575]) {
        let t2c: f64 = (-s.v[961]);let t2d: f64 = (t2c + s.v[1433]);let t2e: f64 = (s.v[335]).sqrt();let t2f: f64 = (t2e / s.v[185]);let t30: f64 = (t2d - t2f);
        (t30,)
    } else {
        (s.v[1453],)
    }
};
        s.store_scalar(1453, t31);
        let (t34,) = {
    if ((s.b[1441] && s.b[1442]) && (!s.b[1575])) {
        let t32: f64 = (-s.v[961]);let t33: f64 = (t32 + s.v[1433]);
        (t33,)
    } else {
        (s.v[1453],)
    }
};
        s.store_scalar(1453, t34);s.b[1576] = (s.v[85] > s.v[1464]);s.store_scalar(1576, if s.b[1576] { 1.0 } else { 0.0 });
    ...
    if (((((s.b[1441] && s.b[1442]) && (!s.b[1576])) && (!s.b[1578])) && s.b[1579]) && s.b[1581]) {
        ...
        while {
            let t3e: f64 = (150.0 + 1.0);let t3f: f64 = if ((((((s.b[1441] && s.b[1442]) && (!s.b[1576])) && (!s.b[1578])) && s.b[1579]) && s.b[1581]) && (s.v[97] <= t3e)) { 1.0 } else { 0.0 };
            t3f != 0.0
        } {
            t40 += 1;
    ...
    if (((((s.b[1441] && s.b[1442]) && (!s.b[1576])) && (!s.b[1578])) && (!s.b[1579])) && s.b[1588]) {
        ...
        while {
            let t48: f64 = (s.v[421] + 1.0);let t49: f64 = if ((((((s.b[1441] && s.b[1442]) && (!s.b[1576])) && (!s.b[1578])) && (!s.b[1579])) && s.b[1588]) && (s.v[97] <= t48)) { 1.0 } else { 0.0 };
            t49 != 0.0
        } {
            t4a += 1;
    ...
    pub(super) fn stamp_transient_block_38(
        ...
        let mut t79: usize = 0;
        while {
            let t77: f64 = (150.0 + 1.0);let t78: f64 = if ((s.b[1441] && s.b[1442]) && (s.v[97] <= t77)) { 1.0 } else { 0.0 };
            t78 != 0.0
        } {
            t79 += 1;
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) && s.b[1594]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t62);s.b[1595] = (2.0 == 2.0);s.store_scalar(1595, if s.b[1595] { 1.0 } else { 0.0 });
            let (t63,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) && (!s.b[1594])) && s.b[1595]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t63);s.b[1596] = (2.0 == 4.0);s.store_scalar(1596, if s.b[1596] { 1.0 } else { 0.0 });
            let (t64,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) && (!s.b[1594])) && (!s.b[1595])) && s.b[1596]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t64);s.b[1597] = (2.0 == 8.0);s.store_scalar(1597, if s.b[1597] { 1.0 } else { 0.0 });
            let (t65,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) {
        ...
        (s.v[719],)
            ...
            while {
                let t69: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1592]) && s.b[1593]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t69 != 0.0
            } {
                t6a += 1;
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) && s.b[1600]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6d);s.b[1601] = (2.0 == 2.0);s.store_scalar(1601, if s.b[1601] { 1.0 } else { 0.0 });
            let (t6e,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) && (!s.b[1600])) && s.b[1601]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6e);s.b[1602] = (2.0 == 4.0);s.store_scalar(1602, if s.b[1602] { 1.0 } else { 0.0 });
            let (t6f,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) && (!s.b[1600])) && (!s.b[1601])) && s.b[1602]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t6f);s.b[1603] = (2.0 == 8.0);s.store_scalar(1603, if s.b[1603] { 1.0 } else { 0.0 });
            let (t70,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) {
        ...
        (s.v[719],)
            ...
            while {
                let t74: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1598]) && s.b[1599]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t74 != 0.0
            } {
                t75 += 1;
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) && s.b[1607]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t52);s.b[1608] = (4.0 == 2.0);s.store_scalar(1608, if s.b[1608] { 1.0 } else { 0.0 });
            let (t53,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) && (!s.b[1607])) && s.b[1608]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t53);s.b[1609] = (4.0 == 4.0);s.store_scalar(1609, if s.b[1609] { 1.0 } else { 0.0 });
            let (t54,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) && (!s.b[1607])) && (!s.b[1608])) && s.b[1609]) {
        ...
        (s.v[720],)
            ...
            s.store_scalar(720, t54);s.b[1610] = (4.0 == 8.0);s.store_scalar(1610, if s.b[1610] { 1.0 } else { 0.0 });
            let (t55,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) {
        ...
        (s.v[719],)
            ...
            while {
                let t59: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1605]) && s.b[1606]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
                t59 != 0.0
            } {
                t5a += 1;
                if t5a > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t5a, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) && s.b[1617]) {
        ...
        s.store_scalar(720, t7c);s.b[1618] = (2.0 == 2.0);s.store_scalar(1618, if s.b[1618] { 1.0 } else { 0.0 });
        let (t7d,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) && (!s.b[1617])) && s.b[1618]) {
        ...
        s.store_scalar(720, t7d);s.b[1619] = (2.0 == 4.0);s.store_scalar(1619, if s.b[1619] { 1.0 } else { 0.0 });
        let (t7e,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) && (!s.b[1617])) && (!s.b[1618])) && s.b[1619]) {
        ...
        s.store_scalar(720, t7e);s.b[1620] = (2.0 == 8.0);s.store_scalar(1620, if s.b[1620] { 1.0 } else { 0.0 });
        let (t7f,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) {
        ...
        while {
            let t83: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1614]) && s.b[1615]) && s.b[1616]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t83 != 0.0
        } {
            t84 += 1;
            if t84 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t84, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) && s.b[1624]) {
        ...
        s.store_scalar(720, t87);s.b[1625] = (2.0 == 2.0);s.store_scalar(1625, if s.b[1625] { 1.0 } else { 0.0 });
        let (t88,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) && (!s.b[1624])) && s.b[1625]) {
        ...
        s.store_scalar(720, t88);s.b[1626] = (2.0 == 4.0);s.store_scalar(1626, if s.b[1626] { 1.0 } else { 0.0 });
        let (t89,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) && (!s.b[1624])) && (!s.b[1625])) && s.b[1626]) {
        ...
        s.store_scalar(720, t89);s.b[1627] = (2.0 == 8.0);s.store_scalar(1627, if s.b[1627] { 1.0 } else { 0.0 });
        let (t8a,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) {
        ...
        while {
            let t8e: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1621]) && s.b[1622]) && s.b[1623]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t8e != 0.0
        } {
            t8f += 1;
            if t8f > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t8f, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) && s.b[1631]) {
        ...
        s.store_scalar(720, t92);s.b[1632] = (2.0 == 2.0);s.store_scalar(1632, if s.b[1632] { 1.0 } else { 0.0 });
        let (t93,) = {
    if ((((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) && (!s.b[1631])) && s.b[1632]) {
        ...
        s.store_scalar(720, t93);s.b[1633] = (2.0 == 4.0);s.store_scalar(1633, if s.b[1633] { 1.0 } else { 0.0 });
        let (t94,) = {
    if (((((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) && (!s.b[1631])) && (!s.b[1632])) && s.b[1633]) {
        ...
        s.store_scalar(720, t94);s.b[1634] = (2.0 == 8.0);s.store_scalar(1634, if s.b[1634] { 1.0 } else { 0.0 });
        let (t95,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) {
        ...
        while {
            let t99: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1629]) && s.b[1630]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            t99 != 0.0
        } {
            t9a += 1;
            if t9a > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", t9a, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1635]) && s.b[1636]) && s.b[1637]) {
        ...
        s.store_scalar(720, t9d);s.b[1638] = (2.0 == 2.0);s.store_scalar(1638, if s.b[1638] { 1.0 } else { 0.0 });
        let (t9e,) = {
    ...
    if (((((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1635]) && s.b[1636]) && (!s.b[1637])) && (!s.b[1638])) && s.b[1639]) {
        ...
        s.store_scalar(720, t9f);s.b[1640] = (2.0 == 8.0);s.store_scalar(1640, if s.b[1640] { 1.0 } else { 0.0 });
        let (ta0,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1635]) && s.b[1636]) {
        ...
        while {
            let ta4: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1621])) && s.b[1635]) && s.b[1636]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            ta4 != 0.0
        } {
            ta5 += 1;
            if ta5 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", ta5, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) && s.b[1643]) {
        ...
        s.store_scalar(720, ta8);s.b[1644] = (2.0 == 2.0);s.store_scalar(1644, if s.b[1644] { 1.0 } else { 0.0 });
        let (ta9,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) && (!s.b[1643])) && s.b[1644]) {
        ...
        s.store_scalar(720, ta9);s.b[1645] = (2.0 == 4.0);s.store_scalar(1645, if s.b[1645] { 1.0 } else { 0.0 });
        let (taa,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) && (!s.b[1643])) && (!s.b[1644])) && s.b[1645]) {
        ...
        s.store_scalar(720, taa);s.b[1646] = (2.0 == 8.0);s.store_scalar(1646, if s.b[1646] { 1.0 } else { 0.0 });
        let (tab,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) {
        ...
        while {
            let taf: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1641]) && s.b[1642]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            taf != 0.0
        } {
            tb0 += 1;
            if tb0 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", tb0, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) && s.b[1649]) {
        ...
        s.store_scalar(720, tb3);s.b[1650] = (2.0 == 2.0);s.store_scalar(1650, if s.b[1650] { 1.0 } else { 0.0 });
        let (tb4,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) && (!s.b[1649])) && s.b[1650]) {
        ...
        s.store_scalar(720, tb4);s.b[1651] = (2.0 == 4.0);s.store_scalar(1651, if s.b[1651] { 1.0 } else { 0.0 });
        let (tb5,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) && (!s.b[1649])) && (!s.b[1650])) && s.b[1651]) {
        ...
        s.store_scalar(720, tb5);s.b[1652] = (2.0 == 8.0);s.store_scalar(1652, if s.b[1652] { 1.0 } else { 0.0 });
        let (tb6,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) {
        ...
        while {
            let tba: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1647]) && s.b[1648]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tba != 0.0
        } {
            tbb += 1;
            if tbb > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", tbb, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) && s.b[1655]) {
        ...
        s.store_scalar(720, tbe);s.b[1656] = (2.0 == 2.0);s.store_scalar(1656, if s.b[1656] { 1.0 } else { 0.0 });
        let (tbf,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) && (!s.b[1655])) && s.b[1656]) {
        ...
        s.store_scalar(720, tbf);s.b[1657] = (2.0 == 4.0);s.store_scalar(1657, if s.b[1657] { 1.0 } else { 0.0 });
        let (tc0,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) && (!s.b[1655])) && (!s.b[1656])) && s.b[1657]) {
        ...
        s.store_scalar(720, tc0);s.b[1658] = (2.0 == 8.0);s.store_scalar(1658, if s.b[1658] { 1.0 } else { 0.0 });
        let (tc1,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) {
        ...
        s.store_scalar(719, tc2);let mut tc6: usize = 0;
        while {
            let tc5: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1653]) && s.b[1654]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tc5 != 0.0
        } {
            tc6 += 1;
            if tc6 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", tc6, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) && s.b[1661]) {
        ...
        s.store_scalar(720, tc9);s.b[1662] = (2.0 == 2.0);s.store_scalar(1662, if s.b[1662] { 1.0 } else { 0.0 });
        let (tca,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) && (!s.b[1661])) && s.b[1662]) {
        ...
        s.store_scalar(720, tca);s.b[1663] = (2.0 == 4.0);s.store_scalar(1663, if s.b[1663] { 1.0 } else { 0.0 });
        let (tcb,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) && (!s.b[1661])) && (!s.b[1662])) && s.b[1663]) {
        ...
        s.store_scalar(720, tcb);s.b[1664] = (2.0 == 8.0);s.store_scalar(1664, if s.b[1664] { 1.0 } else { 0.0 });
        let (tcc,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) {
        ...
        while {
            let td0: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1659]) && s.b[1660]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            td0 != 0.0
        } {
            td1 += 1;
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) && s.b[1668]) {
        ...
        s.store_scalar(720, td4);s.b[1669] = (2.0 == 2.0);s.store_scalar(1669, if s.b[1669] { 1.0 } else { 0.0 });
        let (td5,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) && (!s.b[1668])) && s.b[1669]) {
        ...
        s.store_scalar(720, td5);s.b[1670] = (2.0 == 4.0);s.store_scalar(1670, if s.b[1670] { 1.0 } else { 0.0 });
        let (td6,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) && (!s.b[1668])) && (!s.b[1669])) && s.b[1670]) {
        ...
        s.store_scalar(720, td6);s.b[1671] = (2.0 == 8.0);s.store_scalar(1671, if s.b[1671] { 1.0 } else { 0.0 });
        let (td7,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) {
        ...
        while {
            let tdb: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1665]) && s.b[1666]) && s.b[1667]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tdb != 0.0
        } {
            tdc += 1;
    ...
    if (((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) && s.b[1674]) {
        ...
        s.store_scalar(720, tdf);s.b[1675] = (2.0 == 2.0);s.store_scalar(1675, if s.b[1675] { 1.0 } else { 0.0 });
        let (te0,) = {
    if ((((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) && (!s.b[1674])) && s.b[1675]) {
        ...
        s.store_scalar(720, te0);s.b[1676] = (2.0 == 4.0);s.store_scalar(1676, if s.b[1676] { 1.0 } else { 0.0 });
        let (te1,) = {
    if (((((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) && (!s.b[1674])) && (!s.b[1675])) && s.b[1676]) {
        ...
        s.store_scalar(720, te1);s.b[1677] = (2.0 == 8.0);s.store_scalar(1677, if s.b[1677] { 1.0 } else { 0.0 });
        let (te2,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) {
        ...
        while {
            let te6: f64 = if (((((s.b[1441] && s.b[1442]) && (!s.b[1665])) && s.b[1672]) && s.b[1673]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            te6 != 0.0
        } {
            te7 += 1;
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) && s.b[1680]) {
        ...
        s.store_scalar(720, tea);s.b[1681] = (2.0 == 2.0);s.store_scalar(1681, if s.b[1681] { 1.0 } else { 0.0 });
        let (teb,) = {
    if (((((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) && (!s.b[1680])) && s.b[1681]) {
        ...
        s.store_scalar(720, teb);s.b[1682] = (2.0 == 4.0);s.store_scalar(1682, if s.b[1682] { 1.0 } else { 0.0 });
        let (tec,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) && (!s.b[1680])) && (!s.b[1681])) && s.b[1682]) {
        ...
        s.store_scalar(720, tec);s.b[1683] = (2.0 == 8.0);s.store_scalar(1683, if s.b[1683] { 1.0 } else { 0.0 });
        let (ted,) = {
    ...
    if (((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) {
        ...
        while {
            let tf1: f64 = if ((((s.b[1441] && s.b[1442]) && s.b[1678]) && s.b[1679]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tf1 != 0.0
        } {
            tf2 += 1;
            if tf2 > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", tf2, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
    ...
    if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) && s.b[1687]) {
        ...
        s.store_scalar(720, tf5);s.b[1688] = (2.0 == 2.0);s.store_scalar(1688, if s.b[1688] { 1.0 } else { 0.0 });
        let (tf6,) = {
    if ((((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) && (!s.b[1687])) && s.b[1688]) {
        ...
        s.store_scalar(720, tf6);s.b[1689] = (2.0 == 4.0);s.store_scalar(1689, if s.b[1689] { 1.0 } else { 0.0 });
        let (tf7,) = {
    if (((((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) && (!s.b[1687])) && (!s.b[1688])) && s.b[1689]) {
        ...
        s.store_scalar(720, tf7);s.b[1690] = (2.0 == 8.0);s.store_scalar(1690, if s.b[1690] { 1.0 } else { 0.0 });
        let (tf8,) = {
    ...
    if ((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) {
        ...
        while {
            let tfc: f64 = if (((((s.b[1441] && s.b[1442]) && s.b[1684]) && s.b[1685]) && s.b[1686]) && (s.v[719] < s.v[720])) { 1.0 } else { 0.0 };
            tfc != 0.0
        } {
            tfd += 1;
            if tfd > Self::MAX_ANALOG_LOOP_ITERATIONS { ctx.report_analog_loop_limit("transient stamp", tfd, Self::MAX_ANALOG_LOOP_ITERATIONS); break; }
