...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_34(
        ...
        while {
            ...
            if (((s.b[1441] && (s.b[1443] && (!s.b[1442]))) && (!s.b[1973])) && (!s.b[1986])) {
                s.store_add_ad_rhs(1837, 1852, A::div(A::add(s.ad_value(1901), A::mul(s.ad_value(1829), A::sub_scaled_inputs(s.ad_value(1829), 1.0, s.ad_value(965), 2.0))), s.ad_value(1906)));
                s.store_scalar(1838, 1.0);
    ...
    pub(super) fn stamp_transient_block_42(
        ...
        while {
            ...
            if (s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) {
                ...
                s.store_add_ad_rhs(2135, 2087, A::div(A::add(A::square(s.ad_value(2129)), A::mul(s.ad_value(2083), A::sub_scaled_inputs(s.ad_value(2083), 1.0, s.ad_value(2129), 2.0))), s.ad_value(2134)));
    ...
    pub(super) fn stamp_transient_block_45(
        ...
        while {
            ...
            if ((s.b[1441] && (s.b[1444] && (!(s.b[1442] || s.b[1443])))) && (!s.b[2250])) {
                s.store_mul(337, 336, 337);
                s.store_add_ad_rhs(2135, 2088, A::div(A::add(A::square(s.ad_value(2129)), A::mul(s.ad_value(2084), A::sub_scaled_inputs(s.ad_value(2084), 1.0, s.ad_value(2129), 2.0))), s.ad_value(2134)));
                s.store_scalar(2136, 1.0);
