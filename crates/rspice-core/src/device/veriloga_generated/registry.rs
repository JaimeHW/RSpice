...
impl GeneratedBuiltinKind {
    ...
    pub fn evaluate_noise_source(&self, source_index: usize, ctx: &super::GeneratedEvalContext<'_>) -> Result<super::GeneratedNoiseEvaluation, super::GeneratedNoiseEvaluationError> {
        match self {
            ...
            Self::Device2(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device3(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device4(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device5(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device6(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device7(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device8(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device9(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device10(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device11(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device12(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device13(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device14(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device15(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device16(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device17(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device18(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device19(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device20(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device21(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device22(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device23(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device24(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device25(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device26(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device27(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device28(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device29(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device30(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device31(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device32(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device33(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device34(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device35(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device36(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device37(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device38(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device39(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device40(device) => device.evaluate_noise_source(source_index, ctx),
            Self::Device41(device) => device.evaluate_noise_source(source_index, ctx),
        }
    }
