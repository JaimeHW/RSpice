...
impl Instance {
    ...
    if ((s.b[1620] && s.b[1741]) && (!s.b[1755])) {
        ...
        s.store_scalar(104, tc);s.b[1760] = (s.v[4] < s.v[98]);s.store_scalar(1760, if s.b[1760] { 1.0 } else { 0.0 });s.b[1761] = (s.v[214] < s.v[104]);s.store_scalar(1761, if s.b[1761] { 1.0 } else { 0.0 });s.b[1762] = (((s.v[214]) as f64).abs() <= s.v[101]);s.store_scalar(1762, if s.b[1762] { 1.0 } else { 0.0 });
    ...
    if ((s.b[1620] && s.b[1741]) && (!s.b[1755])) {
        ...
        if ((s.b[1620] && s.b[1741]) && (!s.b[1755])) {s.store_scalar(103, 2.0);s.store_scaled_square(35, 96, (0.16666666666666666 * 0.7071067811865475));s.store_offset_ad(24, A::mul_scaled_output(A::scale_offset(s.ad_value(743), 1.0 / (s.v[184]), 1.0), s.ad_value(706), ((1.602176462e-19 * (p.p74 * p.p74)) * 1.0 / ((2.0 * s.v[180])))), p.p294);}
    }
}
