...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_148(
        ...
        s.b[1822] = (s.v[4] < s.v[98]);s.store_scalar(1822, if s.b[1822] { 1.0 } else { 0.0 });s.b[1823] = (s.v[214] < s.v[104]);s.store_scalar(1823, if s.b[1823] { 1.0 } else { 0.0 });s.b[1824] = (((s.v[214]) as f64).abs() <= s.v[101]);s.store_scalar(1824, if s.b[1824] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_152(
        ...
        if ((((s.b[1620] && s.b[1799]) && (!s.b[1817])) && s.b[1822]) && (!s.b[1823])) {s.store_div_scaled_inputs_mixed_ia(122, 120, 2.0, A::add(s.ad_value(119), A::sqrt(A::sub(A::square(s.ad_value(119)), s.ad_value(121)))), 1.0);s.store_add(9, 117, 122);}
