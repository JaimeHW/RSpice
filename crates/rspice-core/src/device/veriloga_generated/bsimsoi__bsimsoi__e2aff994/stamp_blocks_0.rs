...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        s.store_scalar(487, (if (p.p30 == 1.0) { p.p703 } else { p.p702 }));
    ...
    pub(super) fn stamp_transient_block_9(
        ...
        let assign17180_ad_e22731: A = A::sqrt(s.ad_value(167));
        let assign17180_ad_e22737: A = A::ln(A::max_with_scalar(A::mul(A::div_scaled_inputs(s.ad_value(253), 2.0, s.ad_value(294), 1.0), A::add_scaled_inputs(A::div_scaled_inputs(s.ad_value(253), (2.0 * s.v[978]), s.ad_value(294), 1.0), 1.0, assign17180_ad_e22731, 2.0)), 1e-38));
        s.store_add_scaled_inputs3_offset(979, A::add_scaled_product(s.ad_value(251), 2.0, s.ad_value(224), s.ad_value(272), 1.0), 0.5, assign17180_ad_e22737, 0.5, A::sqrt_square_offset(A::add(A::offset(A::add_scaled_product(s.ad_value(251), 2.0, s.ad_value(224), s.ad_value(272), 1.0), (((((s.v[978]).max(1e-38)) as f64).ln()) + ((2.0 * s.v[978])))), assign17180_ad_e22737), ((4.0 * 0.001) * 0.001)), 0.5, ((((((s.v[978]).max(1e-38)) as f64).ln()) + ((2.0 * s.v[978]))) * 0.5));
    ...
    if s.b[1620] {
        ...
        s.store_scalar(126, assign17320_e22929);
    ...
    if s.b[1620] {
        ...
        s.store_scalar(101, assign17800_e23644);
    ...
    if s.b[1620] {
        ...
        s.store_scalar(104, assign17840_e23716);
    ...
    if s.b[1620] {
        ...
        s.store_scalar(102, assign19380_e26721);
    ...
    if (s.b[1620] && (!s.b[1634])) {
        ...
        s.store_scalar(101, assign20740_e29615);
    ...
    if (s.b[1620] && (!s.b[1634])) {
        ...
        s.store_scalar(104, assign20780_e29711);
    ...
    if (s.b[1620] && (!s.b[1634])) {
        ...
        s.store_scalar(102, assign22300_e33112);
