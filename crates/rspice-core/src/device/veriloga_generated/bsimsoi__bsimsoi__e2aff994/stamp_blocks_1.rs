...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_16(
        ...
        let ctx_temp = ctx.temperature();s.b[1545] = (s.v[452] <= p[1347]);s.store_scalar(1545, if s.b[1545] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_17(
        ...
        s.store_mul_scaled_limited_exp_ad_rhs(182, 168, p[107], A::sub(A::div_scaled_inputs(s.ad_value(190), 1.0, s.ad_value(638), 2.0), A::div_scaled_inputs(s.ad_value(190), 1.0, s.ad_value(637), 2.0)));s.b[1564] = (((p[41] != 0.0) && (p[1099] > 0.0)) && (s.v[191] > 0.0));s.store_scalar(1564, if s.b[1564] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_19(
        ...
        s.store_mul_add_scaled_inputs_rhs(657, 778, A::offset(A::sub_from_scalar(1.0, A::mul(s.ad_value(803), s.ad_value(640))), (-1e-6)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(1.0, A::mul(s.ad_value(803), s.ad_value(640))), (-1e-6)), ((4.0 * 0.001) * 0.001)), 0.5);s.b[1583] = (p[35] != 0.0);s.store_scalar(1583, if s.b[1583] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_20(
        ...
        s.store_mul_add_scaled_inputs_rhs(858, 856, A::offset(A::mul(s.ad_value(857), s.ad_value(640)), ((1.0) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::mul(s.ad_value(857), s.ad_value(640)), ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001)), 0.5);s.store_mul_add_scaled_inputs_rhs(861, 859, A::offset(A::mul(s.ad_value(860), s.ad_value(640)), ((1.0) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::mul(s.ad_value(860), s.ad_value(640)), ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001)), 0.5);s.store_mul_add_scaled_inputs_rhs(864, 862, A::offset(A::mul(s.ad_value(863), s.ad_value(640)), ((1.0) + ((-1e-6)))), 0.5, A::sqrt_square_offset(A::offset(A::mul(s.ad_value(863), s.ad_value(640)), ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001)), 0.5);s.store_scaled_add_sqrt_square_offset_ad(666, A::scale_offset(s.ad_value(640), p[1093], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[901]));s.store_scaled_add_sqrt_square_offset_ad(669, A::scale_offset(s.ad_value(640), p[1093], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[902]));s.store_scaled_add_sqrt_square_offset_ad(667, A::scale_offset(s.ad_value(640), p[1094], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[903]));s.store_scaled_add_sqrt_square_offset_ad(670, A::scale_offset(s.ad_value(640), p[1094], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[904]));s.store_scaled_add_sqrt_square_offset_ad(671, A::scale_offset(s.ad_value(640), p[1095], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[905]));s.store_scaled_add_sqrt_square_offset_ad(668, A::scale_offset(s.ad_value(640), p[1095], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[906]));s.store_offset_add_scaled_inputs(672, A::offset(A::sub_from_scalar(p[907], A::scale(s.ad_value(640), p[1096])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[907], A::scale(s.ad_value(640), p[1096])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);
    }
    #[inline(never)]
    pub(super) fn stamp_transient_block_21(
        ...
        s.store_offset_add_scaled_inputs(675, A::offset(A::sub_from_scalar(p[908], A::scale(s.ad_value(640), p[1096])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[908], A::scale(s.ad_value(640), p[1096])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(673, A::offset(A::sub_from_scalar(p[909], A::scale(s.ad_value(640), p[1097])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[909], A::scale(s.ad_value(640), p[1097])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(676, A::offset(A::sub_from_scalar(p[910], A::scale(s.ad_value(640), p[1097])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[910], A::scale(s.ad_value(640), p[1097])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(674, A::offset(A::sub_from_scalar(p[911], A::scale(s.ad_value(640), p[1098])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[911], A::scale(s.ad_value(640), p[1098])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(677, A::offset(A::sub_from_scalar(p[912], A::scale(s.ad_value(640), p[1098])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[912], A::scale(s.ad_value(640), p[1098])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.b[1584] = (p[8] < 9.0);s.store_scalar(1584, if s.b[1584] { 1.0 } else { 0.0 });s.b[1585] = ((p[2] % 2.0) != 0.0);s.store_scalar(1585, if s.b[1585] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_transient_block_24(
        ...
        if (s.b[1608] && s.b[1609]) {s.store_mul_div_scaled_inputs_mixed_aia(957, A::sub(s.ad_value(922), s.ad_value(920)), 851, 1.0, A::powf(s.ad_value(914), p[1120]), 1.0);s.store_mul_div_scaled_inputs_mixed_aia(958, A::sub(s.ad_value(922), s.ad_value(920)), 852, 1.0, A::powf(s.ad_value(914), p[1122]), 1.0);}
    ...
    pub(super) fn stamp_transient_block_25(
        ...
        if s.b[1617] {s.store_scalar(169, ((s.v[5] * s.v[7]) / (s.v[5] + s.v[7])));s.store_mul_add_scaled_inputs3_offset_rhs_indices(170, 227, 718, 1.0, 220, p[266], 218, (-p[267]), 0.0);}
    }
    #[inline(never)]
    ...
    pub(super) fn stamp_transient_block_30(
        ...
        if s.b[1620] {s.store_add_scaled_inputs_product_mixed_aaii(4, A::div_scaled_product(A::scale_offset(s.ad_value(743), 1.0 / (s.v[184]), 1.0), s.ad_value(706), ((1.602176462e-19 * p[74]) * p[74]), s.ad_value(269), (2.0 * s.v[180])), 1.0, A::div_from_scalar(p[294], s.ad_value(269)), 1.0, 3, 216, (-1.0));}
        let (tf,) = {
    if s.b[1620] {
