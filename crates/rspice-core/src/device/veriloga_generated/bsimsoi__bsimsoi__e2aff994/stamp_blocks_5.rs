...
impl Instance {
    ...
    pub(super) fn stamp_transient_equations_block_4(
        ...
        let __rspice_deriv_cse_52: f64 = (__rspice_deriv_cse_0 + (__rspice_deriv_cse_26 * ddt_scale));
        let __rspice_deriv_cse_53: f64 = (__rspice_deriv_cse_1 + (__rspice_deriv_cse_27 * ddt_scale));
        let __rspice_deriv_cse_54: f64 = (__rspice_deriv_cse_2 + (__rspice_deriv_cse_28 * ddt_scale));
        let __rspice_deriv_cse_55: f64 = (__rspice_deriv_cse_3 + (__rspice_deriv_cse_29 * ddt_scale));
        let __rspice_deriv_cse_56: f64 = (__rspice_deriv_cse_4 + (__rspice_deriv_cse_30 * ddt_scale));
        let __rspice_deriv_cse_57: f64 = (__rspice_deriv_cse_5 + (__rspice_deriv_cse_31 * ddt_scale));
        let __rspice_deriv_cse_58: f64 = (__rspice_deriv_cse_6 + (__rspice_deriv_cse_32 * ddt_scale));
        let __rspice_deriv_cse_59: f64 = (__rspice_deriv_cse_7 + (__rspice_deriv_cse_33 * ddt_scale));
        let __rspice_deriv_cse_60: f64 = (__rspice_deriv_cse_8 + (__rspice_deriv_cse_34 * ddt_scale));
        let __rspice_deriv_cse_61: f64 = (__rspice_deriv_cse_9 + (__rspice_deriv_cse_35 * ddt_scale));
        let __rspice_deriv_cse_62: f64 = (__rspice_deriv_cse_10 + (__rspice_deriv_cse_36 * ddt_scale));
        let __rspice_deriv_cse_63: f64 = (__rspice_deriv_cse_11 + (__rspice_deriv_cse_37 * ddt_scale));
        let __rspice_deriv_cse_64: f64 = (__rspice_deriv_cse_12 + (__rspice_deriv_cse_38 * ddt_scale));
        let __rspice_deriv_cse_65: f64 = (__rspice_deriv_cse_13 + (__rspice_deriv_cse_39 * ddt_scale));
        let __rspice_deriv_cse_66: f64 = (__rspice_deriv_cse_14 + (__rspice_deriv_cse_40 * ddt_scale));
        let __rspice_deriv_cse_67: f64 = (__rspice_deriv_cse_15 + (__rspice_deriv_cse_41 * ddt_scale));
        let __rspice_deriv_cse_68: f64 = (__rspice_deriv_cse_16 + (__rspice_deriv_cse_42 * ddt_scale));
        let __rspice_deriv_cse_69: f64 = (__rspice_deriv_cse_17 + (__rspice_deriv_cse_43 * ddt_scale));
        let __rspice_deriv_cse_70: f64 = (__rspice_deriv_cse_18 + (__rspice_deriv_cse_44 * ddt_scale));
        let __rspice_deriv_cse_71: f64 = (__rspice_deriv_cse_19 + (__rspice_deriv_cse_45 * ddt_scale));
        let __rspice_deriv_cse_72: f64 = (__rspice_deriv_cse_20 + (__rspice_deriv_cse_46 * ddt_scale));
        let __rspice_deriv_cse_73: f64 = (__rspice_deriv_cse_21 + (__rspice_deriv_cse_47 * ddt_scale));
        let __rspice_deriv_cse_74: f64 = (__rspice_deriv_cse_22 + (__rspice_deriv_cse_48 * ddt_scale));
        let __rspice_deriv_cse_75: f64 = (__rspice_deriv_cse_23 + (__rspice_deriv_cse_49 * ddt_scale));
        let __rspice_deriv_cse_76: f64 = (__rspice_deriv_cse_24 + (__rspice_deriv_cse_50 * ddt_scale));
        let __rspice_deriv_cse_77: f64 = (__rspice_deriv_cse_25 + (__rspice_deriv_cse_51 * ddt_scale));
