...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_100(
        ...
        if ((s.b[1620] && s.b[1741]) && (!s.b[1755])) {s.store_div_from_scalar_offset_square(54, 1.0, 22, 2.0);s.store_mul_square_lhs(55, 22, 54);s.store_limited_exp(53, 22);s.store_div_from_scalar(56, 1.0, 53);s.store_limited_exp_sub(53, 22, 97);s.store_add_scaled_product_mixed_iaa(57, 53, 1.0, A::limited_exp_scaled_input(s.ad_value(97), -1.0), A::add(A::offset(s.ad_value(22), 1.0), s.ad_value(55)), (-1.0));s.store_add_scaled_product_mixed_iaa(58, 57, (-1.0), A::square(A::sub(s.ad_value(214), s.ad_value(22))), A::div_from_scalar(1.0, s.ad_value(296)), 1.0);s.store_offset_add_scaled_inputs(58, A::offset(s.ad_value(58), (-0.001)), 0.5, A::sqrt_square_offset(A::offset(s.ad_value(58), (-0.001)), ((4.0 * 1e-5) * 1e-5)), 0.5, 0.001);s.store_sqrt(59, 58);s.store_mul_sqrt_mixed_ia(61, 294, A::add(s.ad_value(58), s.ad_value(57)));s.store_div_scaled_product3_mixed_iiia(306, 296, 57, 271, 1.0, A::add_scaled_product(s.ad_value(61), 1.0, s.ad_value(294), s.ad_value(59), 1.0), 1.0);s.store_mul3_lhs(247, 59, 294, 271);s.copy_ad(76, 56);s.copy_ad(78, 57);s.store_scalar(335, (1e-8 / (s.v[200] * p[76])));s.store_mul_add_scaled_inputs_rhs_indices(308, 335, 247, 1.0, 306, s.v[338]);s.store_limited_exp_ad(169, A::mul(s.ad_value(757), A::ln(A::max_with_scalar(A::scaled_offset(A::div(s.ad_value(306), s.ad_value(247)), 1.0, 0.5), 1e-38))));s.store_add_scaled_product(170, A::div(s.ad_value(754), s.ad_value(169)), 1.0, A::add_scaled_product(s.ad_value(750), 1.0, s.ad_value(760), s.ad_value(241), 1.0), A::pow(s.ad_value(308), s.ad_value(651)), 1.0);s.store_offset(171, 170, 1.0);s.store_scaled_add_offset_sqrt_square_offset(309, 171, 1.0, (-1.0), ((0.25 * 0.0015) * 0.0015), 0.5);s.store_primal_div_from_scalar_scaled_ad(448, 1.0, A::pow_from_scalar((s.v[183] * 1000000.0), s.ad_value(771)), p[2]);s.store_add_scaled_inputs3_offset_mixed_iia(273, 298, 0.5, 241, ((-1.0) * 0.5), A::sqrt_square_offset(A::offset(A::sub(s.ad_value(298), s.ad_value(241)), (-0.05)), ((0.25 * 0.1) * 0.1)), 0.5, (0.05 * 0.5));s.store_sqrt(274, 273);}
        s.b[1756] = (p[33] == 1.0);s.store_scalar(1756, if s.b[1756] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_101(
        ...
        if (((s.b[1620] && s.b[1741]) && (!s.b[1755])) && (!s.b[1756])) {s.store_offset_mul(167, 770, 306, 1.0);s.store_mul_sub_rhs(168, 787, 274, 299);s.store_add_mixed_ai(169, A::div_from_scalar(1.0, s.ad_value(167)), 168);s.store_add_mixed_ia(170, 169, A::sqrt_square_offset(s.ad_value(169), 0.01));s.store_mul_ad_affine_product_lhs(456, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2], 0.0, 652);}
        s.b[1757] = (p[33] == 2.0);s.store_scalar(1757, if s.b[1757] { 1.0 } else { 0.0 });
        if ((((s.b[1620] && s.b[1741]) && (!s.b[1755])) && (!s.b[1756])) && s.b[1757]) {s.store_mul_add_mixed_iai(456, 652, A::add_scaled_product(s.ad_value(452), 1.0, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2]), 453);}
        ...
        s.b[1759] = ((p[1349] == 0.0) && (p[1350] == 0.0));s.store_scalar(1759, if s.b[1759] { 1.0 } else { 0.0 });
        if (((s.b[1620] && s.b[1741]) && (!s.b[1755])) && s.b[1759]) {s.store_scalar(1019, 1.0);}
        if (((s.b[1620] && s.b[1741]) && (!s.b[1755])) && (!s.b[1759])) {s.store_div_from_scalar_offset_ad(168, s.v[184], A::sqrt(A::mul(s.ad_value(782), s.ad_value(275))), s.v[184]);s.store_offset_div_scaled_inputs2_mixed_iaa(1019, 168, p[1349], A::mul3_scaled_output(s.ad_value(168), A::powf(s.ad_value(306), p[1351]), s.ad_value(271), p[1350]), (-1.0), A::scale_offset(s.ad_value(241), p[1352], 1.0), 1.0, 1.0);s.store_scaled_add_offset_sqrt_square_offset(1019, 1019, 0.1, (-0.1), ((0.25 * 0.0005) * 0.0005), 0.5);}
    ...
    pub(super) fn stamp_reactive_block_102(
        ...
        if ((s.b[1620] && s.b[1741]) && (!s.b[1755])) {s.store_scale(101, 95, 0.001);s.store_div_scaled_inputs_indices(167, 726, (-s.v[184]), 300, 1.0);s.store_mul_ad_product_rhs(168, 725, A::add_scaled_inputs(A::limited_exp_scaled_input(s.ad_value(167), 0.5), 1.0, A::limited_exp(s.ad_value(167)), 2.0), A::add_scaled_products(s.ad_value(226), s.ad_value(272), 1.0, s.ad_value(724), s.ad_value(272), 1.0));s.store_add_scaled_offset_product_lhs_mixed_aii(4, A::add_scaled_inputs3(A::div_scaled_product(A::scale_offset(s.ad_value(743), 1.0 / (s.v[184]), 1.0), s.ad_value(706), ((1.602176462e-19 * p[74]) * p[74]), s.ad_value(271), (2.0 * s.v[180])), 1.0, A::div_from_scalar(p[294], s.ad_value(271)), 1.0, A::mul3(s.ad_value(3), s.ad_value(216), s.ad_value(727)), -1.0), 1.0, 3, 1.0, 168, 1.0);s.store_add_scaled_product_mixed_iia(104, 4, 1.0, 294, A::sqrt(A::offset(A::add(A::limited_exp_scaled_input(s.ad_value(4), -1.0), s.ad_value(4)), (-1.0))), 1.0);}
