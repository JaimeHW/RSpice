...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_146(
        ...
        s.b[1818] = (p[33] == 1.0);s.store_scalar(1818, if s.b[1818] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_147(
        ...
        if (((s.b[1620] && s.b[1799]) && (!s.b[1817])) && (!s.b[1818])) {s.store_add_mixed_ia(170, 169, A::sqrt_square_offset(s.ad_value(169), 0.01));s.store_mul_ad_affine_product_lhs(456, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2], 0.0, 652);}
        s.b[1819] = (p[33] == 2.0);s.store_scalar(1819, if s.b[1819] { 1.0 } else { 0.0 });
        if ((((s.b[1620] && s.b[1799]) && (!s.b[1817])) && (!s.b[1818])) && s.b[1819]) {s.store_mul_add_mixed_iai(456, 652, A::add_scaled_product(s.ad_value(452), 1.0, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2]), 453);}
        ...
        s.b[1821] = ((p[1349] == 0.0) && (p[1350] == 0.0));s.store_scalar(1821, if s.b[1821] { 1.0 } else { 0.0 });
