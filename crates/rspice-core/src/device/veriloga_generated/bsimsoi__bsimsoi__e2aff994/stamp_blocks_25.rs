...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_167(
        ...
        s.b[1834] = (p[46] == 1.0);s.store_scalar(1834, if s.b[1834] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_168(
        ...
        if (s.b[1620] && s.b[1799]) {s.store_mul_ad_product_lhs(939, A::mul3_scaled_output(s.ad_value(740), s.ad_value(81), s.ad_value(250), ((p[2] * (p[1147] / s.v[184])) * s.v[199])), A::div_scaled_product(s.ad_value(354), s.ad_value(344), 1.0, s.ad_value(458), 1.0), 363);s.store_add(380, 380, 939);}
    ...
    pub(super) fn stamp_reactive_block_171(
        ...
        s.b[1841] = (p[33] == 0.0);s.store_scalar(1841, if s.b[1841] { 1.0 } else { 0.0 });
        if (((!s.b[1620]) && (!s.b[1840])) && s.b[1841]) {s.store_mul_ad_affine_product_lhs(456, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2], 0.0, 652);}
        if (((!s.b[1620]) && (!s.b[1840])) && (!s.b[1841])) {s.store_mul_add_mixed_iai(456, 652, A::add_scaled_product(s.ad_value(452), 1.0, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2]), 453);}
    ...
    pub(super) fn stamp_reactive_block_172(
        ...
        if (!s.b[1620]) {s.store_div_scaled_product_offset_denominator_mixed_iia(169, 400, 168, (10.0 * p[497]), A::mul(s.ad_value(400), s.ad_value(168)), (10.0 * p[497]), 1.0);}
    ...
    pub(super) fn stamp_reactive_block_174(
        ...
        s.b[1852] = ((p[1349] == 0.0) && (p[1350] == 0.0));s.store_scalar(1852, if s.b[1852] { 1.0 } else { 0.0 });
        if ((!s.b[1620]) && s.b[1852]) {s.store_scalar(1019, 1.0);}
        if ((!s.b[1620]) && (!s.b[1852])) {s.store_div_from_scalar_offset_ad(168, s.v[184], A::sqrt(A::mul(s.ad_value(782), s.ad_value(275))), s.v[184]);s.store_offset_div_scaled_inputs2_mixed_iaa(1019, 168, p[1349], A::mul3_scaled_output(s.ad_value(168), A::powf(s.ad_value(400), p[1351]), s.ad_value(269), p[1350]), (-1.0), A::scale_offset(s.ad_value(218), p[1352], 1.0), 1.0, 1.0);s.store_scaled_add_offset_sqrt_square_offset(1019, 1019, 0.1, (-0.1), ((0.25 * 0.0005) * 0.0005), 0.5);}
    ...
    pub(super) fn stamp_reactive_block_177(
        ...
        s.b[1859] = (s.v[785] > 0.0);s.store_scalar(1859, if s.b[1859] { 1.0 } else { 0.0 });s.b[1860] = (p[414] < 0.0);s.store_scalar(1860, if s.b[1860] { 1.0 } else { 0.0 });
        if (((!s.b[1620]) && s.b[1859]) && s.b[1860]) {s.store_div_scaled_value_by_product_mixed_iai(168, 785, 1.0, A::sub_from_scalar(1.0, A::div_scaled_inputs(s.ad_value(243), p[414], s.ad_value(311), 1.0)), 268, 1.0);}
        if (((!s.b[1620]) && s.b[1859]) && (!s.b[1860])) {s.store_div_scaled_product_offset_rhs_mixed_iai(168, 785, A::div_scaled_inputs(s.ad_value(243), p[414], s.ad_value(311), 1.0), 1.0, 1.0, 268, 1.0);}
        ...
        s.b[1861] = (p[414] < 0.0);s.store_scalar(1861, if s.b[1861] { 1.0 } else { 0.0 });
        if (((!s.b[1620]) && (!s.b[1859])) && s.b[1861]) {s.store_div_scaled_value_by_product_mixed_iai(168, 785, 1.0, A::sub_from_scalar(1.0, A::div_scaled_inputs(s.ad_value(243), p[414], s.ad_value(311), 1.0)), 268, 1.0);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_178(
        ...
        if (((!s.b[1620]) && (!s.b[1859])) && (!s.b[1861])) {s.store_div_scaled_product_offset_rhs_mixed_iai(168, 785, A::div_scaled_inputs(s.ad_value(243), p[414], s.ad_value(311), 1.0), 1.0, 1.0, 268, 1.0);}
        ...
        if ((!s.b[1620]) && s.b[1862]) {s.store_scalar(169, (1.0 + (p[433] * s.v[184])));s.store_div_scaled_offset_numerator_mixed_ai(356, A::mul(s.ad_value(169), s.ad_value(168)), 1.0, 1.0, 767, 1.0);s.store_mul(356, 356, 268);}
        ...
        s.b[1867] = (p[33] == 1.0);s.store_scalar(1867, if s.b[1867] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_179(
        ...
        if ((!s.b[1620]) && s.b[1867]) {s.store_add_scaled_product_mixed_aii(173, A::div_from_scalar(1.0, s.ad_value(172)), 1.0, 787, 202, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(171, 173, 173, 0.01, 0.5);s.store_mul_add_scaled_product_rhs_mixed_iai(454, 652, 452, 1.0, A::add_scaled_product(s.ad_value(773), 1.0, s.ad_value(775), s.ad_value(171), 1.0), 448, 1.0);s.store_sub(169, 204, 219);s.store_sqrt_square_offset(170, 169, 0.01);s.store_scaled_add(229, 169, 170, 0.5);s.store_offset_mul(172, 770, 229, 1.0);s.store_add_scaled_product_mixed_aii(173, A::div_from_scalar(1.0, s.ad_value(172)), 1.0, 787, 201, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(171, 173, 173, 0.01, 0.5);s.store_mul_add_scaled_product_rhs_mixed_iai(455, 652, 453, 1.0, A::add_scaled_product(s.ad_value(772), 1.0, s.ad_value(774), s.ad_value(171), 1.0), 448, 1.0);}
        if ((!s.b[1620]) && (!s.b[1867])) {s.store_offset_mul(167, 770, 243, 1.0);s.store_mul_sub_rhs(168, 787, 274, 299);s.store_add_mixed_ai(169, A::div_from_scalar(1.0, s.ad_value(167)), 168);s.store_scaled_add_sqrt_square_offset_rhs(170, 169, 169, 0.01, 0.5);s.store_mul_ad_affine_product_lhs(457, s.ad_value(652), A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), p[2], 0.0, 448);s.copy_ad(455, 453);s.copy_ad(454, 452);s.store_offset_product3(458, A::div(s.ad_value(740), A::mul(s.ad_value(343), s.ad_value(339))), s.ad_value(243), s.ad_value(457), ((s.v[199] * s.v[183]) * 1.0 / (s.v[184])), 1.0);}
        s.b[1868] = (p[33] == 2.0);s.store_scalar(1868, if s.b[1868] { 1.0 } else { 0.0 });
        if (((!s.b[1620]) && (!s.b[1867])) && s.b[1868]) {s.store_mul_add_mixed_iai(457, 652, A::add_scaled_product(s.ad_value(452), 1.0, A::add_scaled_product(s.ad_value(777), 1.0, s.ad_value(776), s.ad_value(170), 1.0), s.ad_value(448), p[2]), 453);s.store_scalar(455, 0.0);s.store_scalar(454, 0.0);s.store_offset_product3(458, A::div(s.ad_value(740), A::mul(s.ad_value(343), s.ad_value(339))), s.ad_value(243), s.ad_value(457), ((s.v[199] * s.v[183]) * 1.0 / (s.v[184])), 1.0);}
