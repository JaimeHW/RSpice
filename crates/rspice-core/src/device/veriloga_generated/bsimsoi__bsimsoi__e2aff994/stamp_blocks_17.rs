...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_47(
        ...
        s.b[1639] = (s.v[4] < s.v[98]);s.store_scalar(1639, if s.b[1639] { 1.0 } else { 0.0 });s.b[1640] = (s.v[214] < s.v[104]);s.store_scalar(1640, if s.b[1640] { 1.0 } else { 0.0 });s.b[1641] = (((s.v[214]) as f64).abs() <= s.v[101]);s.store_scalar(1641, if s.b[1641] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_51(
        ...
        if (((s.b[1620] && (!s.b[1634])) && s.b[1639]) && (!s.b[1640])) {s.store_div_scaled_inputs_mixed_ia(122, 120, 2.0, A::add(s.ad_value(119), A::sqrt(A::sub(A::square(s.ad_value(119)), s.ad_value(121)))), 1.0);s.store_add(9, 117, 122);}
