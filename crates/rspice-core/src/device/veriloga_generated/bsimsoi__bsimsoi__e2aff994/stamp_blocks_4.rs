...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_79(
        ...
        if ((s.b[1620] && (!s.b[1685])) && (!s.b[1690])) {s.store_div_scaled_inputs3_indices(168, 207, -1.0, 895, (-1.0), 219, 1.0, 167, 1.0);s.store_scaled_add_sqrt_square_offset_rhs(168, 168, 168, ((4.0 * 0.01) * 0.01), 0.5);}
    }
}
