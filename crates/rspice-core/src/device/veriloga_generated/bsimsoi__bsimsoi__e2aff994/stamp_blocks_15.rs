...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_20(
        ...
        s.store_scaled_add_sqrt_square_offset_ad(669, A::scale_offset(s.ad_value(640), p[1093], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[902]));s.store_scaled_add_sqrt_square_offset_ad(667, A::scale_offset(s.ad_value(640), p[1094], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[903]));s.store_scaled_add_sqrt_square_offset_ad(670, A::scale_offset(s.ad_value(640), p[1094], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[904]));s.store_scaled_add_sqrt_square_offset_ad(671, A::scale_offset(s.ad_value(640), p[1095], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[905]));s.store_scaled_add_sqrt_square_offset_ad(668, A::scale_offset(s.ad_value(640), p[1095], ((1.0) + ((-1e-6)))), ((4.0 * 0.001) * 0.001), (0.5 * p[906]));s.store_offset_add_scaled_inputs(672, A::offset(A::sub_from_scalar(p[907], A::scale(s.ad_value(640), p[1096])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[907], A::scale(s.ad_value(640), p[1096])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(675, A::offset(A::sub_from_scalar(p[908], A::scale(s.ad_value(640), p[1096])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[908], A::scale(s.ad_value(640), p[1096])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(673, A::offset(A::sub_from_scalar(p[909], A::scale(s.ad_value(640), p[1097])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[909], A::scale(s.ad_value(640), p[1097])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(676, A::offset(A::sub_from_scalar(p[910], A::scale(s.ad_value(640), p[1097])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[910], A::scale(s.ad_value(640), p[1097])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_21(
        ...
        s.store_offset_add_scaled_inputs(674, A::offset(A::sub_from_scalar(p[911], A::scale(s.ad_value(640), p[1098])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[911], A::scale(s.ad_value(640), p[1098])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.store_offset_add_scaled_inputs(677, A::offset(A::sub_from_scalar(p[912], A::scale(s.ad_value(640), p[1098])), (-0.01)), 0.5, A::sqrt_square_offset(A::offset(A::sub_from_scalar(p[912], A::scale(s.ad_value(640), p[1098])), (-0.01)), ((4.0 * 0.001) * 0.001)), 0.5, 0.01);s.b[1584] = (p[8] < 9.0);s.store_scalar(1584, if s.b[1584] { 1.0 } else { 0.0 });s.b[1585] = ((p[2] % 2.0) != 0.0);s.store_scalar(1585, if s.b[1585] { 1.0 } else { 0.0 });
        if (s.b[1584] && s.b[1585]) {s.store_scalar(969, 1.0);s.store_scalar(971, 1.0);s.store_scalar(968, (2.0 * (((p[2] - 1.0) / 2.0)).max(0.0)));s.copy_ad(970, 968);}
        s.b[1586] = (p[6] == 1.0);s.store_scalar(1586, if s.b[1586] { 1.0 } else { 0.0 });
        if ((s.b[1584] && (!s.b[1585])) && s.b[1586]) {s.store_scalar(969, 2.0);s.store_scalar(968, (2.0 * (((p[2] / 2.0) - 1.0)).max(0.0)));s.store_scalar(971, 0.0);s.store_scalar(970, p[2]);}
        if ((s.b[1584] && (!s.b[1585])) && (!s.b[1586])) {s.store_scalar(969, 0.0);s.store_scalar(968, p[2]);s.store_scalar(971, 2.0);s.store_scalar(970, (2.0 * (((p[2] / 2.0) - 1.0)).max(0.0)));}
        s.store_scalar(167, (s.v[449] + s.v[451]));s.store_scalar(168, (s.v[449] + s.v[449]));s.store_scalar(169, (s.v[450] + s.v[450]));s.store_scalar(155, ((s.v[167] + s.v[167]) + s.v[189]));s.store_scalar(156, ((s.v[167] + s.v[167]) + s.v[189]));s.store_scalar(157, s.v[168]);s.store_scalar(158, s.v[168]);s.store_scalar(159, s.v[169]);s.store_scalar(160, s.v[169]);s.store_scalar(161, (s.v[167] * s.v[189]));s.store_scalar(162, (s.v[167] * s.v[189]));s.store_scalar(163, (s.v[449] * s.v[189]));s.store_scalar(164, (s.v[449] * s.v[189]));s.store_scalar(165, (s.v[450] * s.v[189]));s.store_scalar(166, (s.v[450] * s.v[189]));s.b[1587] = (p[8] == 0.0);s.store_scalar(1587, if s.b[1587] { 1.0 } else { 0.0 });s.b[1588] = (p[8] == 1.0);s.store_scalar(1588, if s.b[1588] { 1.0 } else { 0.0 });s.b[1589] = (p[8] == 2.0);s.store_scalar(1589, if s.b[1589] { 1.0 } else { 0.0 });s.b[1590] = (p[8] == 3.0);s.store_scalar(1590, if s.b[1590] { 1.0 } else { 0.0 });s.b[1591] = (p[8] == 4.0);s.store_scalar(1591, if s.b[1591] { 1.0 } else { 0.0 });s.b[1592] = (p[8] == 5.0);s.store_scalar(1592, if s.b[1592] { 1.0 } else { 0.0 });s.b[1593] = (p[8] == 6.0);s.store_scalar(1593, if s.b[1593] { 1.0 } else { 0.0 });s.b[1594] = (p[8] == 7.0);s.store_scalar(1594, if s.b[1594] { 1.0 } else { 0.0 });s.b[1595] = (p[8] == 8.0);s.store_scalar(1595, if s.b[1595] { 1.0 } else { 0.0 });s.b[1596] = (p[8] == 9.0);s.store_scalar(1596, if s.b[1596] { 1.0 } else { 0.0 });s.b[1597] = (p[8] == 10.0);s.store_scalar(1597, if s.b[1597] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_22(
        ...
        if (s.b[1596] && (!((((((((s.b[1587] || s.b[1588]) || s.b[1589]) || s.b[1590]) || s.b[1591]) || s.b[1592]) || s.b[1593]) || s.b[1594]) || s.b[1595]))) {s.store_scalar(461, (s.v[155] + ((p[2] - 1.0) * s.v[157])));s.store_scalar(462, (p[2] * s.v[158]));s.store_scalar(459, (s.v[161] + ((p[2] - 1.0) * s.v[163])));s.store_scalar(460, (p[2] * s.v[164]));}
        if (s.b[1597] && (!(((((((((s.b[1587] || s.b[1588]) || s.b[1589]) || s.b[1590]) || s.b[1591]) || s.b[1592]) || s.b[1593]) || s.b[1594]) || s.b[1595]) || s.b[1596]))) {s.store_scalar(461, (p[2] * s.v[157]));s.store_scalar(462, (s.v[156] + ((p[2] - 1.0) * s.v[158])));s.store_scalar(459, (p[2] * s.v[163]));s.store_scalar(460, (s.v[162] + ((p[2] - 1.0) * s.v[164])));}
        ...
        if s.b[1598] {s.store_scalar(463, ((p[17] * p[50]) * p[49]));}
        ...
        if s.b[1600] {s.store_scalar(464, ((p[18] * p[50]) * p[49]));}
        ...
        s.b[1602] = param_given[19];s.store_scalar(1602, if s.b[1602] { 1.0 } else { 0.0 });s.b[1603] = (p[926] == 0.0);s.store_scalar(1603, if s.b[1603] { 1.0 } else { 0.0 });
        if (s.b[1602] && s.b[1603]) {s.store_scalar(494, (p[19] * p[50]));}
        if (s.b[1602] && (!s.b[1603])) {s.store_scalar(494, (((p[19] * p[50]) - (s.v[189] * p[2]))).max(0.0));}
        ...
        s.b[1605] = param_given[20];s.store_scalar(1605, if s.b[1605] { 1.0 } else { 0.0 });s.b[1606] = (p[926] == 0.0);s.store_scalar(1606, if s.b[1606] { 1.0 } else { 0.0 });
        if (s.b[1605] && s.b[1606]) {s.store_scalar(495, (p[20] * p[50]));}
        if (s.b[1605] && (!s.b[1606])) {s.store_scalar(495, (((p[20] * p[50]) - (s.v[189] * p[2]))).max(0.0));}
        ...
        s.b[1608] = (((p[10] > 0.0) && (p[11] > 0.0)) && ((p[2] == 1.0) || ((p[2] > 1.0) && (p[12] > 0.0))));s.store_scalar(1608, if s.b[1608] { 1.0 } else { 0.0 });
        if s.b[1608] {s.store_scalar(167, ((s.v[261]) as f64).powf(p[1111]));s.store_scalar(910, (s.v[263] + p[1104]));s.store_powf(168, 910, p[1112]);s.store_add_scaled_inputs3(911, A::div_from_scalar(p[1108], s.ad_value(167)), 1.0, A::div_from_scalar(p[1109], s.ad_value(168)), 1.0, A::div_from_scalar(p[1110], A::mul(s.ad_value(167), s.ad_value(168))), 1.0);s.store_offset(912, 911, 1.0);s.store_scalar(167, ((s.v[261]) as f64).powf(p[1117]));s.store_powf(168, 910, p[1118]);s.store_add_scaled_inputs3(913, A::div_from_scalar(p[1114], s.ad_value(167)), 1.0, A::div_from_scalar(p[1115], s.ad_value(168)), 1.0, A::div_from_scalar(p[1116], A::mul(s.ad_value(167), s.ad_value(168))), 1.0);s.store_offset(914, 913, 1.0);s.store_offset(167, 639, (-1.0));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_23(
        ...
        if s.b[1608] {s.store_offset_mul_ad(915, s.ad_value(912), A::scale_offset(s.ad_value(167), p[1107], 1.0), 1e-9);s.store_scalar(929, 0.0);}
        let mut t1: usize = 0;
        while {
        ...
        s.b[1609] = (p[27] == 1.0);s.store_scalar(1609, if s.b[1609] { 1.0 } else { 0.0 });
        if (s.b[1608] && s.b[1609]) {s.store_mul_div_scaled_inputs_mixed_aii(956, A::sub(s.ad_value(922), s.ad_value(920)), 850, 1.0, 914, 1.0);s.store_mul_div_scaled_inputs_mixed_aia(957, A::sub(s.ad_value(922), s.ad_value(920)), 851, 1.0, A::powf(s.ad_value(914), p[1120]), 1.0);s.store_mul_div_scaled_inputs_mixed_aia(958, A::sub(s.ad_value(922), s.ad_value(920)), 852, 1.0, A::powf(s.ad_value(914), p[1122]), 1.0);}
        if s.b[1608] {s.store_add(849, 849, 957);s.store_add(841, 841, 958);}
        if (!s.b[1608]) {s.store_scalar(926, 0.0);s.store_scalar(956, 0.0);}
        s.b[1610] = (p[34] == 1.0);s.store_scalar(1610, if s.b[1610] { 1.0 } else { 0.0 });
        if s.b[1610] {s.store_scalar(935, (p[1] / p[2]));s.store_scalar(936, p[13]);s.store_scalar(937, p[14]);s.store_scalar(938, p[15]);}
        s.b[1611] = (((!param_given[13]) && (!param_given[14])) && (!param_given[15]));s.store_scalar(1611, if s.b[1611] { 1.0 } else { 0.0 });s.b[1612] = (param_given[16] && (p[16] > 0.0));s.store_scalar(1612, if s.b[1612] { 1.0 } else { 0.0 });
        if ((s.b[1610] && s.b[1611]) && s.b[1612]) {s.store_offset(168, 935, p[16]);s.store_scalar(169, (1.0 / p[1137]));s.store_div_from_scalar_scaled_input(936, (p[1137] * p[1137]), 168, p[16]);}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_24(
        ...
        s.store_sub(226, 223, 224);s.store_scale(167, 226, p[1146]);s.b[1614] = (s.v[167] > 80.0);s.store_scalar(1614, if s.b[1614] { 1.0 } else { 0.0 });
        if s.b[1614] {s.copy_ad(168, 167);}
        if (!s.b[1614]) {s.store_ln_ad(168, A::offset(A::limited_exp(s.ad_value(167)), 1.0));}
        s.store_offset_sub_scaled_inputs_indices(227, 168, (2.0 / p[1146]), 226, 1.0, (-((2.0 / p[1146]) * ((2.0) as f64).ln())));s.store_add_scaled_inputs3_indices(218, 224, (-1.0), 226, (-0.5), 227, (-(-0.5)));s.store_add_scaled_inputs3_indices(241, 232, (-1.0), 226, (-0.5), 227, (-(-0.5)));s.store_add_scaled_inputs3_indices(220, 234, 1.0, 227, 0.5, 226, (-0.5));s.store_tanh_ad(167, A::div_scaled_inputs(s.ad_value(205), 0.6, s.ad_value(637), 1.0));s.store_offset_scaled(265, 167, 0.5, 0.5);s.store_sub_from_scalar(266, 1.0, 265);s.b[1615] = (p[35] != 0.0);s.store_scalar(1615, if s.b[1615] { 1.0 } else { 0.0 });
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_25(
        ...
        s.store_scalar(301, ((((s.v[200] * p[74]) * p[76])) as f64).sqrt());s.store_scalar(303, (((p[74] * ((s.v[200] * p[76]) + (0.375 * p[74])))) as f64).sqrt());s.store_scalar(304, (p[74] + (s.v[200] * (p[76] + p[75]))));s.store_add_scaled_inputs4_indices(167, 221, ((p[75] * s.v[200]) * 1.0 / (s.v[304])), 707, ((-(p[75] * s.v[200])) * 1.0 / (s.v[304])), 234, (((p[76] * s.v[200]) + p[74]) * 1.0 / (s.v[304])), 708, ((-((p[76] * s.v[200]) + p[74])) * 1.0 / (s.v[304])));s.store_offset_scaled_ad(168, A::atan(A::add_scaled_product(s.ad_value(721), 1.0, s.ad_value(722), s.ad_value(167), 1.0)), 0.3183098861837907, 0.5);s.store_offset_scaled(302, 168, (s.v[301] - s.v[303]), s.v[303]);s.store_offset_div_scaled_inputs_indices(305, 723, s.v[184], 302, 1.0, 1e-6);s.b[1616] = (s.v[305] < 40.0);s.store_scalar(1616, if s.b[1616] { 1.0 } else { 0.0 });
        ...
        s.store_scalar(5, (s.v[180] / p[74]));s.store_scalar(7, (s.v[181] / p[75]));s.store_add_scaled_inputs3_offset_mixed_iia(273, 298, 0.5, 218, ((-1.0) * 0.5), A::sqrt_square_offset(A::offset(A::sub(s.ad_value(298), s.ad_value(218)), (-0.05)), ((0.25 * 0.1) * 0.1)), 0.5, (0.05 * 0.5));s.store_sqrt(274, 273);s.store_mul(275, 277, 274);s.store_div_from_scalar(260, s.v[180], 275);s.store_add_scaled_inputs_products_indices(276, 709, 1.0, 665, 1.0, 718, 227, 1.0, 719, 218, (-1.0));s.store_offset_scaled(168, 276, 1.0 / (s.v[199]), 1.0);s.b[1617] = (p[29] == 1.0);s.store_scalar(1617, if s.b[1617] { 1.0 } else { 0.0 });
        if s.b[1617] {s.store_scalar(169, ((s.v[5] * s.v[7]) / (s.v[5] + s.v[7])));s.store_mul_add_scaled_inputs3_offset_rhs_indices(170, 227, 718, 1.0, 220, p[266], 218, (-p[267]), 0.0);s.store_add_scaled_inputs_products_mixed_aiiiia(171, A::add_scaled_product(s.ad_value(220), p[268], s.ad_value(220), s.ad_value(220), p[269]), 1.0, 218, (-p[280]), 218, 218, (-p[281]), 955, A::add(A::add_scaled_product(A::add_scaled_value_products3(s.ad_value(714), 1.0, s.ad_value(711), s.ad_value(220), 1.0, s.ad_value(220), s.ad_value(220), p[274], s.ad_value(713), s.ad_value(218), 1.0), 1.0, s.ad_value(218), s.ad_value(218), p[279]), s.ad_value(170)), 1.0);s.store_div_ad(168, A::add_scaled_inputs4_offset(s.ad_value(169), 1.0, s.ad_value(709), 1.0, s.ad_value(665), 1.0, s.ad_value(171), 1.0, s.v[199]), A::offset(s.ad_value(169), s.v[199]));}
    }
    #[inline(never)]
    pub(super) fn stamp_reactive_block_26(
        ...
        s.store_scaled_add_offset_sqrt_square_offset(267, 168, 1.0, (-1.0), ((0.25 * 0.05) * 0.05), 0.5);s.store_mul(269, 267, 271);s.store_div_from_scalar(270, 1.0, 269);s.store_mul_scale_offset_mixed_ia(292, 227, A::add_scaled_product(s.ad_value(732), 1.0, s.ad_value(733), s.ad_value(218), 1.0), -1.0, 0.0);s.store_offset_sub_scaled_inputs_mixed_ia(292, 292, 0.5, A::sqrt_square_offset(s.ad_value(292), ((0.25 * 5e-5) * 5e-5)), 0.5, (0.25 * 5e-5));s.store_mul_scale_offset(293, A::add_scaled_product(A::offset(s.ad_value(679), (p[1077] / s.v[184])), 1.0, s.ad_value(680), s.ad_value(218), 1.0), A::powf(s.ad_value(639), p[1076]), 1.0, (-1.0));s.b[1618] = (s.v[279] > 0.0);s.store_scalar(1618, if s.b[1618] { 1.0 } else { 0.0 });
    ...
    pub(super) fn stamp_reactive_block_27(
        ...
        if s.b[1620] {s.store_scalar(5, (s.v[180] / p[74]));s.store_scalar(7, (s.v[181] / p[75]));s.store_primal_div_scaled_inputs2_indices(3, 7, 1.0, 728, 1.0, 5, 1.0);s.store_scalar(2, (p[76] / p[75]));s.store_div(124, 294, 2);s.store_offset_scaled(125, 124, 0.7071067811865475, 1.0);s.store_scale(126, 125, 1e-7);s.store_scalar(127, (5.0 / 4.0));s.store_div_from_scalar(128, 1.0, 124);s.store_square(129, 124);s.store_div_from_scalar_ad(130, 1.0, A::add_scaled_inputs(s.ad_value(127), 1.0, s.ad_value(124), 0.7324648775608221));}
