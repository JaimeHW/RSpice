...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_125(
        ...
        if s.b[1620] {s.store_scaled_div(167, 243, 607, 1.0 / (s.v[184]));s.store_square(168, 167);s.store_offset_scaled(170, 168, (((p.p1022 * s.v[184])) * (p.p1019)), p.p1019);s.store_offset_scaled(171, 168, (((p.p1023 * s.v[184])) * (p.p1020)), p.p1020);s.store_offset_scaled(172, 168, (((p.p1298 * s.v[184])) * (p.p1297)), p.p1297);s.store_square(633, 172);s.store_square(632, 171);s.copy_ad(345, 343);}
        ...
        s.b[1799] = (p.p27 == 1.0);s.store_scalar(1799, if s.b[1799] { 1.0 } else { 0.0 });
