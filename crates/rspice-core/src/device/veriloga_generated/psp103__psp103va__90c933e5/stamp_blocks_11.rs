...
impl Instance {
    ...
    pub(super) fn stamp_reactive_block_3(
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(155, &AdValue::scale(scratch.ad_value(312), (self.params.cfrdw * 1000000.0)));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(1273, &AdValue::sub_from_scalar(1.0, AdValue::scale(scratch.ad_value(313), ((2.0 * self.params.lintnoi) * 1000000.0))));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(332, &AdValue::offset(AdValue::scale(scratch.ad_value(308), self.params.wedgew), (2.0 * self.params.wedge)));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(163, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.stvfbedgel), self.params.stvfbedgeo), AdValue::scale(scratch.ad_value(314), self.params.stvfbedgew)), AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.stvfbedgelw), scratch.ad_value(314))));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(164, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(AdValue::powf(scratch.ad_value(313), self.params.dphibedgelexp), self.params.dphibedgel), self.params.dphibedgeo), AdValue::scale(scratch.ad_value(314), self.params.dphibedgew)), AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.dphibedgelw), scratch.ad_value(314))));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(165, &AdValue::mul(AdValue::mul(AdValue::scale(AdValue::offset(AdValue::scale(AdValue::powf(scratch.ad_value(313), self.params.nsubedgelexp), self.params.nsubedgel), 1.0), scratch.values[71]), AdValue::offset(AdValue::scale(scratch.ad_value(314), self.params.nsubedgew), 1.0)), AdValue::offset(AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.nsubedgelw), scratch.ad_value(314)), 1.0)));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(166, &AdValue::offset(AdValue::scale(AdValue::powf(scratch.ad_value(313), self.params.ctedgelexp), self.params.ctedgel), self.params.ctedgeo));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(334, &AdValue::offset(AdValue::mul(AdValue::div_from_scalar((self.params.fbetedge * scratch.values[72]), scratch.ad_value(307)), AdValue::sub_from_scalar(1.0, AdValue::exp(AdValue::scale(AdValue::neg(scratch.ad_value(307)), 1.0 / (scratch.values[72]))))), 1.0));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(334, &{
                if (scratch.values[334] > 1e-15) {
                    scratch.ad_value(334)
                } else {
                    AdValue::constant(1e-15)
                }
            });
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(167, &AdValue::mul(AdValue::div(AdValue::scale(scratch.ad_value(332), self.params.uo), AdValue::mul(scratch.ad_value(334), scratch.ad_value(307))), AdValue::offset(AdValue::scale(scratch.ad_value(314), self.params.betedgew), 1.0)));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(169, &AdValue::mul(AdValue::scale(AdValue::powf(scratch.ad_value(313), self.params.psceedgelexp), self.params.psceedgel), AdValue::offset(AdValue::scale(scratch.ad_value(314), self.params.psceedgew), 1.0)));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(172, &AdValue::mul(AdValue::scale(AdValue::powf(scratch.ad_value(313), self.params.cfedgelexp), self.params.cfedgel), AdValue::offset(AdValue::scale(scratch.ad_value(314), self.params.cfedgew), 1.0)));
        }
        ...
        scratch.store_ad(335, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.kvthowel), self.params.kvthoweo), AdValue::scale(scratch.ad_value(314), self.params.kvthowew)), AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.kvthowelw), scratch.ad_value(314))));

        scratch.store_ad(336, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.kuowel), self.params.kuoweo), AdValue::scale(scratch.ad_value(314), self.params.kuowew)), AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.kuowelw), scratch.ad_value(314))));

        scratch.values[1291] = if (scratch.values[1] == 2.0) { 1.0 } else { 0.0 };

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(337, &AdValue::mul(scratch.ad_value(313), scratch.ad_value(314)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(338, &AdValue::scale(scratch.ad_value(307), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(339, &AdValue::scale(scratch.ad_value(308), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(340, &AdValue::mul(scratch.ad_value(338), scratch.ad_value(339)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(341, &AdValue::div(scratch.ad_value(339), scratch.ad_value(338)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(343, &AdValue::scale(scratch.ad_value(309), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(344, &AdValue::scale(scratch.ad_value(310), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(345, &AdValue::mul(scratch.ad_value(343), scratch.ad_value(344)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(342, &AdValue::div_from_scalar(1e-6, scratch.ad_value(309)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(346, &AdValue::div(scratch.ad_value(344), scratch.ad_value(343)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(348, &AdValue::scale(scratch.ad_value(311), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(349, &AdValue::scale(scratch.ad_value(312), 1000000.0));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(350, &AdValue::mul(scratch.ad_value(348), scratch.ad_value(349)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(347, &AdValue::div_from_scalar(1e-6, scratch.ad_value(311)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(351, &AdValue::div(scratch.ad_value(349), scratch.ad_value(348)));
        }
