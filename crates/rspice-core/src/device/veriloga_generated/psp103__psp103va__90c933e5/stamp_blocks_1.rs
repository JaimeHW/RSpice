...
impl Instance {
    ...
    pub(super) fn stamp_transient_block_4(
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(330, &{
                if (scratch.values[1273] > 0.001) {
                    scratch.ad_value(1273)
                } else {
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(331, &AdValue::div_from_scalar(1.0, AdValue::powf(scratch.ad_value(330), self.params.alpnoi)));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(157, &AdValue::mul(AdValue::mul(AdValue::mul(AdValue::scale(scratch.ad_value(103), self.params.fntexcl), scratch.ad_value(103)), scratch.ad_value(314)), scratch.ad_value(314)));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(158, &AdValue::scale(AdValue::mul(AdValue::mul(scratch.ad_value(331), scratch.ad_value(314)), scratch.ad_value(313)), self.params.nfalw));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(159, &AdValue::scale(AdValue::mul(AdValue::mul(scratch.ad_value(331), scratch.ad_value(314)), scratch.ad_value(313)), self.params.nfblw));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(160, &AdValue::scale(AdValue::mul(AdValue::mul(scratch.ad_value(331), scratch.ad_value(314)), scratch.ad_value(313)), self.params.nfclw));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(333, &AdValue::div_from_scalar(1e-6, scratch.ad_value(332)));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(168, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.stbetedgel), self.params.stbetedgeo), AdValue::scale(scratch.ad_value(314), self.params.stbetedgew)), AdValue::mul(AdValue::scale(scratch.ad_value(313), self.params.stbetedgelw), scratch.ad_value(314))));
        }
        ...
        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(176, &AdValue::scale(AdValue::mul(scratch.ad_value(333), scratch.ad_value(313)), self.params.nfaedgelw));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(177, &AdValue::scale(AdValue::mul(scratch.ad_value(333), scratch.ad_value(313)), self.params.nfbedgelw));
        }

        if (scratch.values[1288] != 0.0) {
            scratch.store_ad(178, &AdValue::scale(AdValue::mul(scratch.ad_value(333), scratch.ad_value(313)), self.params.nfcedgelw));
        }
        ...
        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(126, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plalp1), self.params.poalp1), AdValue::scale(scratch.ad_value(314), self.params.pwalp1)), AdValue::scale(scratch.ad_value(337), self.params.plwalp1)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(127, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plalp2), self.params.poalp2), AdValue::scale(scratch.ad_value(314), self.params.pwalp2)), AdValue::scale(scratch.ad_value(337), self.params.plwalp2)));
        }
        ...
        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(129, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.pla1), self.params.poa1), AdValue::scale(scratch.ad_value(314), self.params.pwa1)), AdValue::scale(scratch.ad_value(337), self.params.plwa1)));
        }
    ...
    pub(super) fn stamp_transient_block_5(
        ...
        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(157, &AdValue::mul(AdValue::square(scratch.ad_value(313)), AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plfntexc), self.params.pofntexc), AdValue::scale(scratch.ad_value(314), self.params.pwfntexc)), AdValue::scale(scratch.ad_value(337), self.params.plwfntexc))));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(158, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfa), self.params.ponfa), AdValue::scale(scratch.ad_value(314), self.params.pwnfa)), AdValue::scale(scratch.ad_value(337), self.params.plwnfa)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(159, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfb), self.params.ponfb), AdValue::scale(scratch.ad_value(314), self.params.pwnfb)), AdValue::scale(scratch.ad_value(337), self.params.plwnfb)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(160, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfc), self.params.ponfc), AdValue::scale(scratch.ad_value(314), self.params.pwnfc)), AdValue::scale(scratch.ad_value(337), self.params.plwnfc)));
        }
        ...
        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(168, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plstbetedge), self.params.postbetedge), AdValue::scale(scratch.ad_value(314), self.params.pwstbetedge)), AdValue::scale(scratch.ad_value(337), self.params.plwstbetedge)));
        }
        ...
        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(176, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfaedge), self.params.ponfaedge), AdValue::scale(scratch.ad_value(314), self.params.pwnfaedge)), AdValue::scale(scratch.ad_value(337), self.params.plwnfaedge)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(177, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfbedge), self.params.ponfbedge), AdValue::scale(scratch.ad_value(314), self.params.pwnfbedge)), AdValue::scale(scratch.ad_value(337), self.params.plwnfbedge)));
        }

        if (scratch.values[1291] != 0.0) {
            scratch.store_ad(178, &AdValue::add(AdValue::add(AdValue::offset(AdValue::scale(scratch.ad_value(313), self.params.plnfcedge), self.params.ponfcedge), AdValue::scale(scratch.ad_value(314), self.params.pwnfcedge)), AdValue::scale(scratch.ad_value(337), self.params.plwnfcedge)));
        }
        ...
        if (scratch.values[1292] != 0.0) {
            scratch.store_ad(180, &AdValue::add(AdValue::add(AdValue::div(AdValue::scale(AdValue::add(AdValue::scale(scratch.ad_value(317), (0.3333333333333333 * 1.0 / (scratch.values[24]))), scratch.ad_value(318)), scratch.values[66]), AdValue::scale(scratch.ad_value(316), scratch.values[24])), AdValue::div_from_scalar((scratch.values[69] + scratch.values[70]), AdValue::mul(scratch.ad_value(317), scratch.ad_value(315)))), AdValue::scale(scratch.ad_value(11), self.params.rgo)));
        }

        scratch.values[1293] = if (self.params.swjunasym == 0.0) { 1.0 } else { 0.0 };

        if ((scratch.values[1292] != 0.0) && (scratch.values[1293] != 0.0)) {
    ...
    pub(super) fn stamp_transient_block_6(
        ...
        if (scratch.values[126] > 0.0) {
            scratch.values[242] = scratch.values[126];
            scratch.node_derivatives[242] = scratch.node_derivatives[126];
            scratch.branch_derivatives[242] = scratch.branch_derivatives[126];
        } else {
            scratch.values[242] = 0.0;
        ...
        if (scratch.values[127] > 0.0) {
            scratch.values[243] = scratch.values[127];
            scratch.node_derivatives[243] = scratch.node_derivatives[127];
            scratch.branch_derivatives[243] = scratch.branch_derivatives[127];
        } else {
            scratch.values[243] = 0.0;
        ...
        if (scratch.values[129] > 0.0) {
            scratch.values[245] = scratch.values[129];
            scratch.node_derivatives[245] = scratch.node_derivatives[129];
            scratch.branch_derivatives[245] = scratch.branch_derivatives[129];
        } else {
    ...
    pub(super) fn stamp_transient_block_7(
        ...
        if (scratch.values[157] > 0.0) {
            scratch.values[273] = scratch.values[157];
            scratch.node_derivatives[273] = scratch.node_derivatives[157];
            scratch.branch_derivatives[273] = scratch.branch_derivatives[157];
        } else {
        ...
        if (scratch.values[158] > 0.0) {
            scratch.values[274] = scratch.values[158];
            scratch.node_derivatives[274] = scratch.node_derivatives[158];
            scratch.branch_derivatives[274] = scratch.branch_derivatives[158];
        } else {
        ...
        if (scratch.values[159] > 0.0) {
            scratch.values[275] = scratch.values[159];
            scratch.node_derivatives[275] = scratch.node_derivatives[159];
            scratch.branch_derivatives[275] = scratch.branch_derivatives[159];
        } else {
        ...
        if (scratch.values[160] > 0.0) {
            scratch.values[276] = scratch.values[160];
            scratch.node_derivatives[276] = scratch.node_derivatives[160];
            scratch.branch_derivatives[276] = scratch.branch_derivatives[160];
        } else {
        ...
        if (scratch.values[161] > 0.0) {
            scratch.values[277] = scratch.values[161];
            scratch.node_derivatives[277] = scratch.node_derivatives[161];
            scratch.branch_derivatives[277] = scratch.branch_derivatives[161];
        } else {
        ...
        scratch.values[284] = scratch.values[168];
        scratch.node_derivatives[284] = scratch.node_derivatives[168];
        scratch.branch_derivatives[284] = scratch.branch_derivatives[168];
        ...
        if (scratch.values[175] > 0.0) {
            scratch.values[291] = scratch.values[175];
            scratch.node_derivatives[291] = scratch.node_derivatives[175];
            scratch.branch_derivatives[291] = scratch.branch_derivatives[175];
        } else {
        ...
        if (scratch.values[176] > 0.0) {
            scratch.values[292] = scratch.values[176];
            scratch.node_derivatives[292] = scratch.node_derivatives[176];
            scratch.branch_derivatives[292] = scratch.branch_derivatives[176];
        } else {
        ...
        if (scratch.values[177] > 0.0) {
            scratch.values[293] = scratch.values[177];
            scratch.node_derivatives[293] = scratch.node_derivatives[177];
            scratch.branch_derivatives[293] = scratch.branch_derivatives[177];
        } else {
        ...
        if (scratch.values[178] > 0.0) {
            scratch.values[294] = scratch.values[178];
            scratch.node_derivatives[294] = scratch.node_derivatives[178];
            scratch.branch_derivatives[294] = scratch.branch_derivatives[178];
        } else {
        ...
        if (scratch.values[179] > 0.0) {
            scratch.values[295] = scratch.values[179];
            scratch.node_derivatives[295] = scratch.node_derivatives[179];
            scratch.branch_derivatives[295] = scratch.branch_derivatives[179];
        } else {
        ...
        if (scratch.values[180] > 0.0) {
            scratch.values[296] = scratch.values[180];
            scratch.node_derivatives[296] = scratch.node_derivatives[180];
            scratch.branch_derivatives[296] = scratch.branch_derivatives[180];
        } else {
        ...
        if (scratch.values[181] > 0.0) {
            scratch.values[297] = scratch.values[181];
            scratch.node_derivatives[297] = scratch.node_derivatives[181];
            scratch.branch_derivatives[297] = scratch.branch_derivatives[181];
        } else {
        ...
        if (scratch.values[182] > 0.0) {
            scratch.values[298] = scratch.values[182];
            scratch.node_derivatives[298] = scratch.node_derivatives[182];
            scratch.branch_derivatives[298] = scratch.branch_derivatives[182];
        } else {
        ...
        if (scratch.values[184] > 0.0) {
            scratch.values[299] = scratch.values[184];
            scratch.node_derivatives[299] = scratch.node_derivatives[184];
            scratch.branch_derivatives[299] = scratch.branch_derivatives[184];
        } else {
        ...
        if (scratch.values[185] > 0.0) {
            scratch.values[300] = scratch.values[185];
            scratch.node_derivatives[300] = scratch.node_derivatives[185];
            scratch.branch_derivatives[300] = scratch.branch_derivatives[185];
        } else {
        ...
        if (scratch.values[186] > 0.0) {
            scratch.values[301] = scratch.values[186];
            scratch.node_derivatives[301] = scratch.node_derivatives[186];
            scratch.branch_derivatives[301] = scratch.branch_derivatives[186];
        } else {
        ...
        if (scratch.values[183] > 0.0) {
            scratch.values[302] = scratch.values[183];
            scratch.node_derivatives[302] = scratch.node_derivatives[183];
            scratch.branch_derivatives[302] = scratch.branch_derivatives[183];
        } else {
