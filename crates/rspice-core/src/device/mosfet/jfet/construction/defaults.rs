...
impl Jfet {
    ...
    pub fn njf(name: &str, drain: NodeId, gate: NodeId, source: NodeId) -> Self {
        Self {
            ...
            external_lead_conductances: [0.0; 2],
            ...
            instance_td: None,
            initial_off: false,
            initial_condition_vds: None,
            initial_condition_vgs: None,
    ...
    pub fn enable_hfet_model(mut self) -> Self {
        ...
        self.params.hfet_js = 0.0;
        self.params.hfet_del = 0.04;
        self.params.hfet_klambda = 0.0;
        self.params.hfet_kmu = 0.0;
        self.params.hfet_knmax = 0.0;
        self.params.hfet_kvto = 0.0;
        self.params.hfet_eta1 = 2.0;
        self.params.hfet_d1 = 0.03e-6;
        self.params.hfet_vt1 = Value::NAN;
        self.params.hfet_eta2 = Value::NAN;
        self.params.hfet_d2 = Value::NAN;
        self.params.hfet_vt2 = Value::NAN;
