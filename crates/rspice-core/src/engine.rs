...
pub use hb::{
    ...
    SpectralEnvelopeMissionConfig, SpectralEnvelopeStepping, EnvelopeResult, HbAnalysisResult,
    HbCurrentSpectrum, HbEnvelopeContinuationState, HbEnvelopeStateGuarantee, HbIntegralSpectrum,
    ...
    PnoiseAnalysisResult, PreparedPsp, PspAnalysisResult, PspNoiseCorrelation, QpacAnalysisResult,
...
pub use transient::{
    ...
    netlist_fingerprint, transient_fft_window_coefficient_with_alpha,
    transient_fft_window_coherent_gain, transient_fft_window_coherent_gain_with_alpha,
