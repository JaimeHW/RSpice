...
mod tests {
    ...
    #[test]
    fn test_linear_points_step() {
        let step = StepType::LinearPoints {
            start: 0.0,
            stop: 10.0,
            points: 11,
        };
    ...
    fn test_decade_step() {
        ...
        assert!((values.last().unwrap() - 1000.0).abs() < 1.0);
    }
