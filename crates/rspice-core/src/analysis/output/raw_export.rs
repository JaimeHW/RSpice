...
mod tests {
    ...
    #[test]
    fn test_raw_exporter_creation() {
        let exporter = RawExporter::new_transient("Test Circuit");
        assert_eq!(exporter.num_variables(), 1);
    ...
    fn test_add_variables() {
        ...
        exporter.add_voltage("2");
        exporter.add_current("R1");
        assert_eq!(exporter.num_variables(), 4);
    }
    ...
    fn test_ascii_output() {
        ...
        assert!(output.contains("No. Points: 2"));
