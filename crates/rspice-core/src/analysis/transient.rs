//! Public time-domain result types and directive semantics.
...
/// The event-only-net vocabulary, which lives below every module that
/// names it. See [`crate::event_net`].
pub use crate::event_net::{EventOnlyNetKind, EventTraceSurface, event_only_voltage_refusal};
