...
pub(crate) use vm::{
    lookup_table_interpolate_with_derivative, spice_exp_parameters, spice_waveform_is_periodic,
    spice_waveform_max_tone_cycles, spice_waveform_minimum_interval, spice_waveform_parameters,
};
