...
fn clone_netlist_with_abort(
    ...
    let spectre_mismatch_override = source.spectre_mismatch_override.clone();
    ...
    let control_dispositions = clone_slice(&source.control_dispositions, abort)?;
