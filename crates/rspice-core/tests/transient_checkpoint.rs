    ...
    for level in [11, 12] {
        ...
        let deck = format!(
            "VBIC13 clipped thermal checkpoint\nVc c 0 1.2\nVb b 0 0.5\n\
             ...
             .model vm NPN(LEVEL={level} IS=1e-16 IBEI=1e-18 IBCI=1e-18 RCX=10 RBX=5 RCI=0 RBI=0 AVCX1=0.05 AVCX2=0.3 TAVCX=0.01 GMIN=1n RTH=1000 TCRTH=0.005 TMAXCLIP=100 CTH=1f TNOM=27)\n.temp 27\n.end\n"
        );
        for method in [
            IntegrationMethod::BackwardEuler,
            IntegrationMethod::Trapezoidal,
