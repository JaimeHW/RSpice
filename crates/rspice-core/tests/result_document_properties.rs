...
use rspice_core::execution::result_document::{
    ...
    DcSweepPayload, DeviceParameterSeries, DeviceStateSeries, DigitalStateTag, DigitalStrengthTag,
    DistortionPayload, DistortionProductSeries, DistortionProductTag, EnvelopeCarrierDocument,
    ...
    FftPayload, FftSourceDocument, FftWindowTag, FloquetEvidenceDocument, FloquetOrbitTag,
    FourierPayload, HarmonicBalancePayload, HbReactiveKindTag, HbReactiveSpectrumDocument,
    LogicSample, MonteCarloPayload, MonteCarloVariableStatistics, NamedObservable,
    NamedObservableSeries, NoiseContributionSeries, NoiseMechanismTag, NoisePayload,
    NoiseSourceIdentityDocument, NyquistSample, OperatingPointPayload, PNoiseBandwidth,
    PNoiseContribution, PNoiseContributor, PNoisePayload, PacPayload, PacSidebandDescriptor,
    PoleZeroPayload, PortDocument, PortNoisePayload, PssPayload, ResultAxis, ResultAxisKind,
