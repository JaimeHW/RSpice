//! Native BSIM4 carrier-to-transient continuation, including NQS storage.
...
#[test]
fn bsim4_continuation_preserves_the_carrier_orbit_and_portable_checkpoint() {
    for (nqs, kind, polarity, method) in [
        (0, "NMOS", 1.0, IntegrationMethod::Gear2),
        (1, "PMOS", -1.0, IntegrationMethod::Trapezoidal),
    ] {
        let deck = Netlist::parse(&format!(
            "BSIM4 Envelope\nVDD supply 0 {}\nVIN in 0 SIN({} {} 1G)\nRD supply out 500\nRG in gate 100\nRS source 0 10\nM1 out gate source 0 mm L=.18u W=10u AD=4p AS=4p PD=20u PS=20u M=2 OFF\n.model mm {kind}(LEVEL=54 TOXE=4.1n VTH0={} U0=270 K1=.59 K2=.0026 CAPMOD=2 TRNQSMOD={nqs} RGATEMOD=3 RBODYMOD=2 RDSMOD=1 RSHG=100 ACNQSMOD={nqs} RSH=10 CGDO=7.9e-10 CGSO=6.3e-10 CJ=9.5e-4 CJSW=2.4e-10)\n.options hbint tahb=0\n.end\n",
        ...
        assert_eq!(encoded, "\"exact-bsim4-rlc-mna-v1\"");
